...
public class SupplierBasedAssertTest {
    ...
    throws Exception {
        Assert.assertEquals(SUP, 0.0d, 0.1d, 0.05d);
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_double_failure_3()
    throws Exception {
        Assert.assertEquals(SUP, 0.0d, 1.0d, 0.9d);
    }
    ...
    throws Exception {
        Assert.assertEquals(SUP, 0.0f, 0.1f, 0.05f);
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_float_failure_3()
    throws Exception {
        Assert.assertEquals(SUP, 0.0f, 1.0f, 0.9f);
    }
    ...
    throws Exception {
        Assert.assertThat(SUP, 42, is(23));
    }

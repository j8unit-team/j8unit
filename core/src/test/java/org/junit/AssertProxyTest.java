...
public class AssertProxyTest {
    ...
    throws Exception {
        ...
        AssertProxy.assertArrayEquals(SUP, array, array);
    }
    ...
    throws Exception {
        final boolean[] array = new boolean[] { true, false };
        AssertProxy.assertArrayEquals(SUP, array, new boolean[] {});
    }
    ...
    throws Exception {
        final byte[] array = new byte[] { 0, 1 };
        AssertProxy.assertArrayEquals(SUP, array, new byte[] {});
    }
    ...
    throws Exception {
        final char[] array = new char[] { 0, 1 };
        AssertProxy.assertArrayEquals(SUP, array, new char[] {});
    }
    ...
    throws Exception {
        ...
        AssertProxy.assertArrayEquals(SUP, array, array, 0.0d);
    }
    ...
    throws Exception {
        final double[] array = new double[] { 0.0d, 1.0d };
        AssertProxy.assertArrayEquals(SUP, array, new double[] {}, 0.0d);
    }
    ...
    throws Exception {
        ...
        AssertProxy.assertArrayEquals(SUP, array, array, 0.0f);
    }
    ...
    throws Exception {
        final float[] array = new float[] { 0.0f, 1.0f };
        AssertProxy.assertArrayEquals(SUP, array, new float[] {}, 0.0f);
    }
    ...
    throws Exception {
        final int[] array = new int[] { 0, 1 };
        AssertProxy.assertArrayEquals(SUP, array, new int[] {});
    }
    ...
    throws Exception {
        final long[] array = new long[] { 0l, 1l };
        AssertProxy.assertArrayEquals(SUP, array, new long[] {});
    }
    ...
    throws Exception {
        final Object[] array = new Object[] { "hello", "world" };
        AssertProxy.assertArrayEquals(SUP, array, new Object[] {});
    }
    ...
    throws Exception {
        final short[] array = new short[] { 0, 1 };
        AssertProxy.assertArrayEquals(SUP, array, new short[] {});
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_double()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0.0d, 0.0d);
    }

    @Test
    public void test_assertEquals_double_success()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0.0d, 0.0d, 0.0d);
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_double_failure()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0.0d, 1.0d, 0.0d);
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_float()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0.0f, 0.0f);
    }

    @Test
    public void test_assertEquals_float_success()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0.0f, 0.0f, 0.0f);
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_float_failure()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0.0f, 1.0f, 0.0f);
    }

    @Test
    public void test_assertEquals_long_success()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0l, 0l);
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_long_failure()
    throws Exception {
        AssertProxy.assertEquals(SUP, 0l, 1l);
    }

    @Test
    public void test_assertEquals_Object_success()
    throws Exception {
        AssertProxy.assertEquals(SUP, "hello", "hello");
    }

    @Test(expected = AssertionError.class)
    public void test_assertEquals_Object_failure()
    throws Exception {
        AssertProxy.assertEquals(SUP, "hello", "world");
    }
    ...
    throws Exception {
        final Object[] array = new Object[] { "hello", "world" };
        AssertProxy.assertEquals(SUP, array, array);
    }
    ...
    throws Exception {
        final Object[] array = new Object[] { "hello", "world" };
        AssertProxy.assertEquals(SUP, array, new Object[] {});
    }

    @Test
    public void test_assertFalse_success()
    throws Exception {
        AssertProxy.assertFalse(SUP, false);
    }

    @Test(expected = AssertionError.class)
    public void test_assertFalse_failure()
    throws Exception {
        AssertProxy.assertFalse(SUP, true);
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotEquals_double()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0.0d, 0.0d);
    }

    @Test
    public void test_assertNotEquals_double_success()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0.0d, 1.0d, 0.0d);
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotEquals_double_failure()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0.0d, 0.0d, 0.0d);
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotEquals_float()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0.0f, 0.0f);
    }

    @Test
    public void test_assertNotEquals_float_success()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0.0f, 1.0f, 0.0f);
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotEquals_float_failure()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0.0f, 0.0f, 0.0f);
    }

    @Test
    public void test_assertNotEquals_long_success()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0l, 1l);
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotEquals_long_failure()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, 0l, 0l);
    }

    @Test
    public void test_assertNotEquals_Object_success()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, "hello", "world");
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotEquals_Object_failure()
    throws Exception {
        AssertProxy.assertNotEquals(SUP, "hello", "hello");
    }

    @Test
    public void test_assertNotNull_success()
    throws Exception {
        AssertProxy.assertNotNull(SUP, "hello");
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotNull_failure()
    throws Exception {
        AssertProxy.assertNotNull(SUP, null);
    }

    @Test
    public void test_assertNotSame_success()
    throws Exception {
        AssertProxy.assertNotSame(SUP, "hello", "world");
    }

    @Test(expected = AssertionError.class)
    public void test_assertNotSame_failure()
    throws Exception {
        AssertProxy.assertNotSame(SUP, "hello", "hello");
    }

    @Test
    public void test_assertNull_success()
    throws Exception {
        AssertProxy.assertNull(SUP, null);
    }

    @Test(expected = AssertionError.class)
    public void test_assertNull_failure()
    throws Exception {
        AssertProxy.assertNull(SUP, "hello");
    }

    @Test
    public void test_assertSame_success()
    throws Exception {
        AssertProxy.assertSame(SUP, "hello", "hello");
    }

    @Test(expected = AssertionError.class)
    public void test_assertSame_failure()
    throws Exception {
        AssertProxy.assertSame(SUP, "hello", "world");
    }

    @Test
    public void test_assertTrue_success()
    throws Exception {
        AssertProxy.assertTrue(SUP, true);
    }

    @Test(expected = AssertionError.class)
    public void test_assertTrue_failure()
    throws Exception {
        AssertProxy.assertTrue(SUP, false);
    }

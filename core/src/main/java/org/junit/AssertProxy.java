...
extends org.junit.Assert {
    ...
    protected static void failNotNull(final Supplier<? extends String> message, final Object actual) {
        // TODO: Inline this method
        Assert.fail(Objects.toString(resolve(message), "") + " expected null, but was:<" + actual + ">");
    }

    protected static void failNotSame(final Supplier<? extends String> message, final Object expected, final Object actual) {
        // TODO: Inline this method
        Assert.fail(Objects.toString(resolve(message), "") + " expected same:<" + expected + "> was not:<" + actual + ">");
    }

    protected static void failSame(final Supplier<? extends String> message) {
        // TODO: Inline this method
        Assert.fail(Objects.toString(resolve(message), "") + " expected not same");
    }

    protected static void failNotEquals(final Supplier<? extends String> message, final Object expected, final Object actual) {
        // TODO: Inline this method
        Assert.fail(format(resolve(message), expected, actual));
    }

    protected static void failEquals(final Supplier<? extends String> message, final Object actual) {
        // TODO: Inline this method
    ...
    protected static boolean doubleIsDifferent(final double d1, final double d2, final double delta) {
    ...
    protected static boolean floatIsDifferent(final float f1, final float f2, final float delta) {

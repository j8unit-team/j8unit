...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ByteArrayInputStream} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.io.ByteArrayInputStreamClassTests}).
 */
@RunWith(J8Unit4.class)
public class ByteArrayInputStreamClassTest
implements ByteArrayInputStreamClassTests<ByteArrayInputStream> {

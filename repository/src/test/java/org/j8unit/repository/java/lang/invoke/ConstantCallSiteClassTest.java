...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ConstantCallSite} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.invoke.ConstantCallSiteClassTests}).
 */
@RunWith(J8Unit4.class)
public class ConstantCallSiteClassTest
implements ConstantCallSiteClassTests<ConstantCallSite> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KeyPairGenerator} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.KeyPairGeneratorClassTests}).
 */
@RunWith(J8Unit4.class)
public class KeyPairGeneratorClassTest
implements KeyPairGeneratorClassTests<KeyPairGenerator> {

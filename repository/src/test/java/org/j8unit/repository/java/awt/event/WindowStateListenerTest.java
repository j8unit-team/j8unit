...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link WindowStateListener} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.awt.event.WindowStateListenerTests}).
 */

@RunWith(J8Unit4.class)
public class WindowStateListenerTest
implements WindowStateListenerTests<WindowStateListener> {

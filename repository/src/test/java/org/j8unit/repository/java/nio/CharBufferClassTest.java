...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CharBuffer} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.nio.CharBufferClassTests}).
 */
@RunWith(J8Unit4.class)
public class CharBufferClassTest
implements CharBufferClassTests<CharBuffer> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.CharBuffer]

    @Override
    public Class<CharBuffer> createNewSUT() {

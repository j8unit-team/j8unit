...
implements org.j8unit.repository.java.sql.SQLTimeoutExceptionClassTests<SQLTimeoutException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.sql.SQLTimeoutException]

    @Override
    public Class<SQLTimeoutException> createNewSUT() {
    ...
    public void create_SQLTimeoutException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLTimeoutException sut = null; // = new SQLTimeoutException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLTimeoutException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLTimeoutException sut = null; // = new SQLTimeoutException(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLTimeoutException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLTimeoutException sut = null; // = new SQLTimeoutException(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLTimeoutException_String_String_int_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLTimeoutException sut = null; // = new SQLTimeoutException(String, String, int, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLTimeoutException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLTimeoutException sut = null; // = new SQLTimeoutException(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLTimeoutException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLTimeoutException sut = null; // = new SQLTimeoutException(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLTimeoutException_String_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link URLEncoder} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.net.URLEncoderClassTests}).
 */

@RunWith(J8Unit4.class)
public class URLEncoderClassTest
implements URLEncoderClassTests<URLEncoder> {

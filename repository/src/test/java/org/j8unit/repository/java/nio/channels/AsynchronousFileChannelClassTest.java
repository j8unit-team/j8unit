...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AsynchronousFileChannel} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.nio.channels.AsynchronousFileChannelClassTests}).
 */
@RunWith(J8Unit4.class)
public class AsynchronousFileChannelClassTest
implements AsynchronousFileChannelClassTests<AsynchronousFileChannel> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.AsynchronousFileChannel]

    @Override
    public Class<AsynchronousFileChannel> createNewSUT() {
        return AsynchronousFileChannel.class;
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MissingFormatWidthException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.util.MissingFormatWidthExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class MissingFormatWidthExceptionClassTest
implements MissingFormatWidthExceptionClassTests<MissingFormatWidthException> {

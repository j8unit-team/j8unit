...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MinguoDate} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.time.chrono.MinguoDateClassTests}).
 */
@RunWith(J8Unit4.class)
public class MinguoDateClassTest
implements MinguoDateClassTests<MinguoDate> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.MinguoDate]

    @Override
    public Class<MinguoDate> createNewSUT() {
        return MinguoDate.class;
    }

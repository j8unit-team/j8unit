...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link LocaleServiceProvider} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.util.spi.LocaleServiceProviderTests}).
 */
@RunWith(J8Unit4.class)
public class LocaleServiceProviderTest
implements LocaleServiceProviderTests<LocaleServiceProvider> {

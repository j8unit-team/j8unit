...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RGBImageFilter} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.image.RGBImageFilterClassTests}).
 */

@RunWith(J8Unit4.class)
public class RGBImageFilterClassTest
implements RGBImageFilterClassTests<RGBImageFilter> {

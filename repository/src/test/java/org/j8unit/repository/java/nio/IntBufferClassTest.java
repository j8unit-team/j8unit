...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link IntBuffer} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.nio.IntBufferClassTests}).
 */
@RunWith(J8Unit4.class)
public class IntBufferClassTest
implements IntBufferClassTests<IntBuffer> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.IntBuffer]

    @Override
    public Class<IntBuffer> createNewSUT() {

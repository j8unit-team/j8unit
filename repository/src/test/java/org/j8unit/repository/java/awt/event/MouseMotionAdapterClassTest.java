...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MouseMotionAdapter} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.awt.event.MouseMotionAdapterClassTests}).
 */

@RunWith(J8Unit4.class)
public class MouseMotionAdapterClassTest
implements MouseMotionAdapterClassTests<MouseMotionAdapter> {

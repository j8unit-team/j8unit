...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link VetoableChangeSupport} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.beans.VetoableChangeSupportClassTests}).
 */
@RunWith(J8Unit4.class)
public class VetoableChangeSupportClassTest
implements VetoableChangeSupportClassTests<VetoableChangeSupport> {

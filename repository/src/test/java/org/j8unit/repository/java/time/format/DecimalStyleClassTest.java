...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DecimalStyle} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.time.format.DecimalStyleClassTests}).
 */
@RunWith(J8Unit4.class)
public class DecimalStyleClassTest
implements DecimalStyleClassTests<DecimalStyle> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.format.DecimalStyle]

    @Override
    public Class<DecimalStyle> createNewSUT() {
        return DecimalStyle.class;
    }

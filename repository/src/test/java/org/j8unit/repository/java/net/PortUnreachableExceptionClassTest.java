...
implements org.j8unit.repository.java.net.PortUnreachableExceptionClassTests<PortUnreachableException> {
     ...
     * {@link PortUnreachableException#PortUnreachableException(String) public
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link PortUnreachableException#PortUnreachableException() public java.net.PortUnreachableException()}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.

...
implements ComponentColorModelClassTests<ComponentColorModel> {
    ...
    /**
     * @see ComponentColorModelClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        ComponentColorModelClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AclEntryType} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.nio.file.attribute.AclEntryTypeClassTests}).
 */

@RunWith(J8Unit4.class)
public class AclEntryTypeClassTest
implements AclEntryTypeClassTests<AclEntryType> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.file.attribute.AclEntryType]

    @Override
    public Class<AclEntryType> createNewSUT() {
        return AclEntryType.class;
    }

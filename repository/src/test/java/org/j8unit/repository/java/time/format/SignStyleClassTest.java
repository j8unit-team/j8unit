...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SignStyle} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.time.format.SignStyleClassTests}).
 */
@RunWith(J8Unit4.class)
public class SignStyleClassTest
implements SignStyleClassTests<SignStyle> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.format.SignStyle]

    @Override
    public Class<SignStyle> createNewSUT() {
        return SignStyle.class;
    }

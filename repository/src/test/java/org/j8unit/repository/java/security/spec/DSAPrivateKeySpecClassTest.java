...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DSAPrivateKeySpec} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.spec.DSAPrivateKeySpecClassTests}).
 */

@RunWith(J8Unit4.class)
public class DSAPrivateKeySpecClassTest
implements DSAPrivateKeySpecClassTests<DSAPrivateKeySpec> {

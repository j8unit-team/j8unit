...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Number} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.lang.NumberClassTests}).
 */

@RunWith(J8Unit4.class)
public class NumberClassTest
implements NumberClassTests<Number> {

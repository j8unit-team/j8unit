...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Arc2D} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.geom.Arc2DTests}).
 */

@RunWith(J8Unit4.class)
public class Arc2DTest
implements Arc2DTests<Arc2D> {

    // J8UNIT-MARKER-[BEGIN]-[INSTANCE]-[java.awt.geom.Arc2D]

    @Override
    public Arc2D createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [java.awt.geom.Arc2D], j8unit does not support a generic way to provide instances.");
    }
    ...
    implements FactoryBasedJ8UnitTest<Double>, org.j8unit.repository.java.awt.geom.Arc2DTests.DoubleTests<Double> {
    ...
    implements FactoryBasedJ8UnitTest<Float>, org.j8unit.repository.java.awt.geom.Arc2DTests.FloatTests<Float> {

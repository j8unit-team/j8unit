...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Path} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.nio.file.PathTests}).
 */

@RunWith(J8Unit4.class)
public class PathTest
implements PathTests<Path> {

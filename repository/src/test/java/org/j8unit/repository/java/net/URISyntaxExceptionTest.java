...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link URISyntaxException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.net.URISyntaxExceptionTests}).
 */
@RunWith(J8Unit4.class)
public class URISyntaxExceptionTest
implements URISyntaxExceptionTests<URISyntaxException> {

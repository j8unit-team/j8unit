...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SerializedLambda} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.invoke.SerializedLambdaClassTests}).
 */
@RunWith(J8Unit4.class)
public class SerializedLambdaClassTest
implements SerializedLambdaClassTests<SerializedLambda> {

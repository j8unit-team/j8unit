...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ItemEvent} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.event.ItemEventClassTests}).
 */
@RunWith(J8Unit4.class)
public class ItemEventClassTest
implements ItemEventClassTests<ItemEvent> {

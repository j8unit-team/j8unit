...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AccessControlContext} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.security.AccessControlContextTests}).
 */
@RunWith(J8Unit4.class)
public class AccessControlContextTest
implements AccessControlContextTests<AccessControlContext> {

...
implements org.j8unit.repository.java.awt.geom.CubicCurve2DClassTests<CubicCurve2D> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.geom.CubicCurve2D]

    @Override
    public Class<CubicCurve2D> createNewSUT() {
    ...
    implements org.j8unit.repository.java.awt.geom.CubicCurve2DClassTests.FloatClassTests<Float> {
        ...
        @Test
        @Category(Draft.class)
        public void create_Float_float_float_float_float_float_float_float_float()
        throws Exception {
            // create new instance
    ...
    implements org.j8unit.repository.java.awt.geom.CubicCurve2DClassTests.DoubleClassTests<Double> {
        ...
        @Test
        @Category(Draft.class)
        public void create_Double_double_double_double_double_double_double_double_double()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")

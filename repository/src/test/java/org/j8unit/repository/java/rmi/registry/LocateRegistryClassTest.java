 ...
 * J8Unit test interface {@link org.j8unit.repository.java.rmi.registry.LocateRegistryClassTests}).
 */
...
implements LocateRegistryClassTests<LocateRegistry> {
    ...
    @Override
    public Class<LocateRegistry> createNewSUT() {
        return LocateRegistry.class;
    }

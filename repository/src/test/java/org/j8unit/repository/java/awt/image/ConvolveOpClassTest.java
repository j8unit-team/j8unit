...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ConvolveOp} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.image.ConvolveOpClassTests}).
 */

@RunWith(J8Unit4.class)
public class ConvolveOpClassTest
implements ConvolveOpClassTests<ConvolveOp> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.ConvolveOp]

    @Override
    public Class<ConvolveOp> createNewSUT() {
        return ConvolveOp.class;
    }
    ...
    public void create_ConvolveOp_Kernel()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_ConvolveOp_Kernel_int_RenderingHints()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SecureClassLoader} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.SecureClassLoaderClassTests}).
 */

@RunWith(J8Unit4.class)
public class SecureClassLoaderClassTest
implements SecureClassLoaderClassTests<SecureClassLoader> {

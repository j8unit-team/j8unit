...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link InputMethodHighlight} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.awt.im.InputMethodHighlightClassTests}).
 */

@RunWith(J8Unit4.class)
public class InputMethodHighlightClassTest
implements InputMethodHighlightClassTests<InputMethodHighlight> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.im.InputMethodHighlight]

    @Override
    public Class<InputMethodHighlight> createNewSUT() {
    ...
    public void create_InputMethodHighlight_boolean_int_int_Map()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_InputMethodHighlight_boolean_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

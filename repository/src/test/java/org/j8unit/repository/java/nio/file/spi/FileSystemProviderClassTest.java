...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link FileSystemProvider} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.nio.file.spi.FileSystemProviderClassTests}).
 */

@RunWith(J8Unit4.class)
public class FileSystemProviderClassTest
implements FileSystemProviderClassTests<FileSystemProvider> {
     ...
     * {@link java.nio.file.spi.FileSystemProvider#installedProviders() public static
     * java.util.List<java.nio.file.spi.FileSystemProvider> java.nio.file.spi.FileSystemProvider.installedProviders()}.
     *

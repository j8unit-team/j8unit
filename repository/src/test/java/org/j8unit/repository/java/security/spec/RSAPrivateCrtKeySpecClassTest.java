...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RSAPrivateCrtKeySpec} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.security.spec.RSAPrivateCrtKeySpecClassTests}).
 */

@RunWith(J8Unit4.class)
public class RSAPrivateCrtKeySpecClassTest
implements RSAPrivateCrtKeySpecClassTests<RSAPrivateCrtKeySpec> {

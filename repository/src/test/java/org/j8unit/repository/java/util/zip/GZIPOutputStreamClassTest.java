...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link GZIPOutputStream} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.zip.GZIPOutputStreamClassTests}).
 */

@RunWith(J8Unit4.class)
public class GZIPOutputStreamClassTest
implements GZIPOutputStreamClassTests<GZIPOutputStream> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.zip.GZIPOutputStream]

    @Override
    public Class<GZIPOutputStream> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_GZIPOutputStream_OutputStream()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_GZIPOutputStream_OutputStream_int_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

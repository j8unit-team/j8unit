...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link WindowFocusListener} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.awt.event.WindowFocusListenerTests}).
 */

@RunWith(J8Unit4.class)
public class WindowFocusListenerTest
implements WindowFocusListenerTests<WindowFocusListener> {

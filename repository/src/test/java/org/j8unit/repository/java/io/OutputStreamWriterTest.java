...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link OutputStreamWriter} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.io.OutputStreamWriterTests}).
 */
@RunWith(J8Unit4.class)
public class OutputStreamWriterTest
implements OutputStreamWriterTests<OutputStreamWriter> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ByteArrayOutputStream} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.io.ByteArrayOutputStreamClassTests}).
 */

@RunWith(J8Unit4.class)
public class ByteArrayOutputStreamClassTest
implements ByteArrayOutputStreamClassTests<ByteArrayOutputStream> {

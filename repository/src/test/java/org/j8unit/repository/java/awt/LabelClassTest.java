...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Label} (by simply reusing the J8Unit test
 * interface {@link org.j8unit.repository.java.awt.LabelClassTests}).
 */
@RunWith(J8Unit4.class)
public class LabelClassTest
implements LabelClassTests<Label> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link LogManager} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.logging.LogManagerClassTests}).
 */

@RunWith(J8Unit4.class)
public class LogManagerClassTest
implements LogManagerClassTests<LogManager> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.logging.LogManager]

    @Override
    public Class<LogManager> createNewSUT() {

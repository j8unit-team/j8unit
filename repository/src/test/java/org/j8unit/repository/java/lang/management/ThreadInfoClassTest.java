...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ThreadInfo} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.lang.management.ThreadInfoClassTests}).
 */
@RunWith(J8Unit4.class)
public class ThreadInfoClassTest
implements ThreadInfoClassTests<ThreadInfo> {

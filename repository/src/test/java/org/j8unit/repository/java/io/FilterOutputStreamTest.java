...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link FilterOutputStream} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.io.FilterOutputStreamTests}).
 */

@RunWith(J8Unit4.class)
public class FilterOutputStreamTest
implements FilterOutputStreamTests<FilterOutputStream> {

...
implements org.j8unit.repository.java.awt.image.IndexColorModelClassTests<IndexColorModel> {
    ...
    @Test
    @Category(Draft.class)
    public void create_IndexColorModel_int_int_byteArray_byteArray_byteArray_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final IndexColorModel sut = null; // = new IndexColorModel(int, int, byte[], byte[], byte[], int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_IndexColorModel_int_int_byteArray_int_boolean_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

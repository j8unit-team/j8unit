...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ScrollbarPeer} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.peer.ScrollbarPeerTests}).
 */

@RunWith(J8Unit4.class)
public class ScrollbarPeerTest
implements ScrollbarPeerTests<ScrollbarPeer> {

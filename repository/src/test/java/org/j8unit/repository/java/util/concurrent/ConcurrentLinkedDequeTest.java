...
org.j8unit.repository.java.util.concurrent.ConcurrentLinkedDequeTests<ConcurrentLinkedDeque<E>, E> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(ConcurrentLinkedDeque::new);
    }

    @Parameter(0)
    public Callable<ConcurrentLinkedDeque<E>> sutFactory;

    @Override
    public Callable<ConcurrentLinkedDeque<E>> getSUTFactory() {

...
implements org.j8unit.repository.java.awt.font.TextLayoutClassTests<TextLayout> {
    ...
    @Override
    public Class<TextLayout> createNewSUT() {
        return TextLayout.class;
    }
    ...
    public void create_TextLayout_String_Font_FontRenderContext()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_TextLayout_AttributedCharacterIterator_FontRenderContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_TextLayout_String_Map_FontRenderContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    implements org.j8unit.repository.java.awt.font.TextLayoutClassTests.CaretPolicyClassTests<CaretPolicy> {
        ...
        @Override
        public Class<CaretPolicy> createNewSUT() {
            return CaretPolicy.class;
        }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DecimalFormatSymbols} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.text.DecimalFormatSymbolsClassTests}).
 */

@RunWith(J8Unit4.class)
public class DecimalFormatSymbolsClassTest
implements DecimalFormatSymbolsClassTests<DecimalFormatSymbols> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.text.DecimalFormatSymbols]

    @Override
    public Class<DecimalFormatSymbols> createNewSUT() {
    ...
    public void create_DecimalFormatSymbols_Locale()
    throws Exception {
        // create new instance

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link FileDialog} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.FileDialogClassTests}).
 */
@RunWith(J8Unit4.class)
public class FileDialogClassTest
implements FileDialogClassTests<FileDialog> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.FileDialog]

    @Override
    public Class<FileDialog> createNewSUT() {
    ...
    public void create_FileDialog_Frame_String()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_FileDialog_Frame()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_FileDialog_Dialog_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_FileDialog_Frame_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_FileDialog_Dialog()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_FileDialog_Dialog_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.FileDialog]

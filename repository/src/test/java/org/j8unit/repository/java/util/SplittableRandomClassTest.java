...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SplittableRandom} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.SplittableRandomClassTests}).
 */

@RunWith(J8Unit4.class)
public class SplittableRandomClassTest
implements SplittableRandomClassTests<SplittableRandom> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.SplittableRandom]

    @Override
    public Class<SplittableRandom> createNewSUT() {
        return SplittableRandom.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SplittableRandom_long()
    throws Exception {
        // create new instance

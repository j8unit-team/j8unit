...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CopyOnWriteArrayList} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.CopyOnWriteArrayListClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class CopyOnWriteArrayListClassTest
implements CopyOnWriteArrayListClassTests<CopyOnWriteArrayList> {
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.util.concurrent.CopyOnWriteArrayList#CopyOnWriteArrayList(Object[]) public

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ZipInputStream} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.zip.ZipInputStreamClassTests}).
 */
@RunWith(J8Unit4.class)
public class ZipInputStreamClassTest
implements ZipInputStreamClassTests<ZipInputStream> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link FontFormatException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.awt.FontFormatExceptionTests}).
 */
@RunWith(J8Unit4.class)
public class FontFormatExceptionTest
implements FontFormatExceptionTests<FontFormatException> {

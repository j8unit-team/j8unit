...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link InterruptedException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.lang.InterruptedExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class InterruptedExceptionClassTest
implements InterruptedExceptionClassTests<InterruptedException> {

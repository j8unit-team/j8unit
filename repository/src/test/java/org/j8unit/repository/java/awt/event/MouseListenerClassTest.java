...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MouseListener} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.event.MouseListenerClassTests}).
 */

@RunWith(J8Unit4.class)
public class MouseListenerClassTest
implements MouseListenerClassTests<MouseListener> {

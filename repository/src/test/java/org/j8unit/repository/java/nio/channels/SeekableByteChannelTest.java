...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link SeekableByteChannel} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.nio.channels.SeekableByteChannelTests}).
 */
@RunWith(J8Unit4.class)
public class SeekableByteChannelTest
implements SeekableByteChannelTests<SeekableByteChannel> {

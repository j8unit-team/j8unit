...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link JarOutputStream} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.jar.JarOutputStreamTests}).
 */

@RunWith(J8Unit4.class)
public class JarOutputStreamTest
implements JarOutputStreamTests<JarOutputStream> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PosixFilePermissions} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.nio.file.attribute.PosixFilePermissionsClassTests}).
 */

@RunWith(J8Unit4.class)
public class PosixFilePermissionsClassTest
implements PosixFilePermissionsClassTests<PosixFilePermissions> {
    ...
    throws Exception {
        // write some test for {@link java.nio.file.attribute.PosixFilePermissions#asFileAttribute(java.util.Set)}
    }

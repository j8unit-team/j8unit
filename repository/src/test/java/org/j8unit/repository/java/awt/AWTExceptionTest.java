...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AWTException} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.AWTExceptionTests}).
 */

@RunWith(J8Unit4.class)
public class AWTExceptionTest
implements AWTExceptionTests<AWTException> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PrintStream} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.io.PrintStreamClassTests}).
 */
@RunWith(J8Unit4.class)
public class PrintStreamClassTest
implements PrintStreamClassTests<PrintStream> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.PrintStream]

    @Override
    public Class<PrintStream> createNewSUT() {
    ...
    public void create_PrintStream_OutputStream()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintStream_OutputStream_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintStream_OutputStream_boolean_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintStream_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PrintStream sut = null; // = new PrintStream(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintStream_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PrintStream sut = null; // = new PrintStream(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintStream_File_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintStream_File()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

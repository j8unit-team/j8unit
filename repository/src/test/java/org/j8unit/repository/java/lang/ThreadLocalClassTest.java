...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ThreadLocal} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.ThreadLocalClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class ThreadLocalClassTest
implements ThreadLocalClassTests<ThreadLocal> {

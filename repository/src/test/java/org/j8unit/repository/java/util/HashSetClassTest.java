...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link HashSet} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.HashSetClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class HashSetClassTest
implements HashSetClassTests<HashSet> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.HashSet]

    @Override
    public Class<HashSet> createNewSUT() {
    ...
    public void create_HashSet_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HashSet sut = null; // = new HashSet(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_HashSet_int_float()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HashSet sut = null; // = new HashSet(int, float);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_HashSet_Collection()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

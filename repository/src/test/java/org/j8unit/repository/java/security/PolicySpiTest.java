...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link PolicySpi} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.PolicySpiTests}).
 */
@RunWith(J8Unit4.class)
public class PolicySpiTest
implements PolicySpiTests<PolicySpi> {

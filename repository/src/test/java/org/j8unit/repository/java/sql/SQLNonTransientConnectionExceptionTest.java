...
org.j8unit.repository.java.sql.SQLNonTransientConnectionExceptionTests<SQLNonTransientConnectionException> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(SQLNonTransientConnectionException::new);
    }

    @Parameter(0)
    public Callable<SQLNonTransientConnectionException> sutFactory;

    @Override
    public Callable<SQLNonTransientConnectionException> getSUTFactory() {

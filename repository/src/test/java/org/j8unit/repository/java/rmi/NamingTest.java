...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Naming} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.rmi.NamingTests}).
 */
@RunWith(J8Unit4.class)
public class NamingTest
implements NamingTests<Naming> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ProxySelector} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.net.ProxySelectorTests}).
 */

@RunWith(J8Unit4.class)
public class ProxySelectorTest
implements ProxySelectorTests<ProxySelector> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link EmptyStackException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.EmptyStackExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class EmptyStackExceptionClassTest
implements EmptyStackExceptionClassTests<EmptyStackException> {

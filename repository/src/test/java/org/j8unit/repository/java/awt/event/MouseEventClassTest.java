...
implements org.j8unit.repository.java.awt.event.MouseEventClassTests<MouseEvent> {
    ...
    public void create_MouseEvent_Component_int_long_int_int_int_int_int_int_boolean_int()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_MouseEvent_Component_int_long_int_int_int_int_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_MouseEvent_Component_int_long_int_int_int_int_boolean_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MouseEvent sut = null; // = new MouseEvent(java.awt.Component, int, long, int, int, int, int, boolean,

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Calendar} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.CalendarTests}).
 */

@RunWith(J8Unit4.class)
public class CalendarTest
implements CalendarTests<Calendar> {

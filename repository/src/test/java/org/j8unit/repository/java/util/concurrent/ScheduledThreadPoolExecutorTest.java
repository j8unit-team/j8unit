...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ScheduledThreadPoolExecutor} (by
 * simply reusing the J8Unit test interface
 * {@link org.j8unit.repository.java.util.concurrent.ScheduledThreadPoolExecutorTests}).
 */
@RunWith(J8Unit4.class)
public class ScheduledThreadPoolExecutorTest
implements ScheduledThreadPoolExecutorTests<ScheduledThreadPoolExecutor> {

 ...
 * J8Unit test interface {@link org.j8unit.repository.java.sql.SQLDataExceptionClassTests}).
 */
...
implements SQLDataExceptionClassTests<SQLDataException> {
    ...
    @Override
    public Class<SQLDataException> createNewSUT() {
        return SQLDataException.class;
    }
    ...
    public void create_SQLDataException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLDataException sut = null; // = new SQLDataException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLDataException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLDataException sut = null; // = new SQLDataException(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLDataException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLDataException sut = null; // = new SQLDataException(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLDataException_String_String_int_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLDataException sut = null; // = new SQLDataException(String, String, int, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLDataException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLDataException sut = null; // = new SQLDataException(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLDataException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLDataException sut = null; // = new SQLDataException(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLDataException_String_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

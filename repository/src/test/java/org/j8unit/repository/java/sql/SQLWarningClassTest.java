 ...
 * test interface {@link org.j8unit.repository.java.sql.SQLWarningClassTests}).
 */
...
implements SQLWarningClassTests<SQLWarning> {
    ...
    @Override
    public Class<SQLWarning> createNewSUT() {
        return SQLWarning.class;
    }
    ...
    public void create_SQLWarning_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLWarning sut = null; // = new SQLWarning(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLWarning_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLWarning sut = null; // = new SQLWarning(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLWarning_String_String_int_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLWarning sut = null; // = new SQLWarning(String, String, int, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLWarning_String_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLWarning sut = null; // = new SQLWarning(String, String, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLWarning_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLWarning sut = null; // = new SQLWarning(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLWarning_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLWarning sut = null; // = new SQLWarning(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLWarning_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

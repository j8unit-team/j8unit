...
implements org.j8unit.repository.java.nio.file.PathsClassTests<Paths> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Paths#get(String, String...) public static
    ...
    throws Exception {
        // write some test for {@link Paths#get(String, String...)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Paths#get(URI) public static java.nio.file.Path
    ...
    throws Exception {
        // write some test for {@link Paths#get(URI)}
    }

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ImagingOpException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.awt.image.ImagingOpExceptionTests}).
 */

@RunWith(J8Unit4.class)
public class ImagingOpExceptionTest
implements ImagingOpExceptionTests<ImagingOpException> {

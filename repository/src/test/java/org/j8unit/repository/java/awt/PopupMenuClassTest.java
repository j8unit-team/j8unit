...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PopupMenu} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.PopupMenuClassTests}).
 */

@RunWith(J8Unit4.class)
public class PopupMenuClassTest
implements PopupMenuClassTests<PopupMenu> {

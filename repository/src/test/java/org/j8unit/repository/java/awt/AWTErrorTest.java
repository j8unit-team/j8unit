...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AWTError} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.AWTErrorTests}).
 */
@RunWith(J8Unit4.class)
public class AWTErrorTest
implements AWTErrorTests<AWTError> {

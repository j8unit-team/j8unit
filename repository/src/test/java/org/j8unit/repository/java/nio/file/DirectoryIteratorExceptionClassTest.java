...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DirectoryIteratorException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.nio.file.DirectoryIteratorExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class DirectoryIteratorExceptionClassTest
implements DirectoryIteratorExceptionClassTests<DirectoryIteratorException> {

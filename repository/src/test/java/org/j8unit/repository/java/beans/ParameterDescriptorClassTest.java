...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ParameterDescriptor} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.beans.ParameterDescriptorClassTests}).
 */
@RunWith(J8Unit4.class)
public class ParameterDescriptorClassTest
implements ParameterDescriptorClassTests<ParameterDescriptor> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.beans.ParameterDescriptor]

    @Override
    public Class<ParameterDescriptor> createNewSUT() {

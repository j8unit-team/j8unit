...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BeanDescriptor} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.beans.BeanDescriptorClassTests}).
 */

@RunWith(J8Unit4.class)
public class BeanDescriptorClassTest
implements BeanDescriptorClassTests<BeanDescriptor> {

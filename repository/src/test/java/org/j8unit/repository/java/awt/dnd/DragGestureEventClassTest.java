...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DragGestureEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.dnd.DragGestureEventClassTests}).
 */
@RunWith(J8Unit4.class)
public class DragGestureEventClassTest
implements DragGestureEventClassTests<DragGestureEvent> {

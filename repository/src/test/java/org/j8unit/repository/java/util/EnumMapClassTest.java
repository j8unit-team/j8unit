...
implements org.j8unit.repository.java.util.EnumMapClassTests<EnumMap> {
    ...
    public void create_EnumMap_Class()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final EnumMap sut = null; // = new EnumMap(Class);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_EnumMap_Map()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

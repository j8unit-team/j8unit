...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Activatable} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.rmi.activation.ActivatableClassTests}).
 */

@RunWith(J8Unit4.class)
public class ActivatableClassTest
implements ActivatableClassTests<Activatable> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link LookupOp} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.image.LookupOpClassTests}).
 */
@RunWith(J8Unit4.class)
public class LookupOpClassTest
implements LookupOpClassTests<LookupOp> {

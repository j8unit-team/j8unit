...
implements IllegalFormatCodePointExceptionClassTests<IllegalFormatCodePointException> {
    ...
    @Override
    public Class<IllegalFormatCodePointException> createNewSUT() {
     ...
     * {@link java.util.IllegalFormatCodePointException#IllegalFormatCodePointException(int) public
    ...
    public void create_IllegalFormatCodePointException_int()
    throws Exception {
        // create new instance

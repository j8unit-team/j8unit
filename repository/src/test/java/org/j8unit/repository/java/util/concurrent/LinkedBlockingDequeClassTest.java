...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link LinkedBlockingDeque} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.LinkedBlockingDequeClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class LinkedBlockingDequeClassTest
implements LinkedBlockingDequeClassTests<LinkedBlockingDeque> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.concurrent.LinkedBlockingDeque]

    @Override
    public Class<LinkedBlockingDeque> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_LinkedBlockingDeque_Collection()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_LinkedBlockingDeque_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ArrayDeque} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.ArrayDequeClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class ArrayDequeClassTest
implements ArrayDequeClassTests<ArrayDeque> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.ArrayDeque]

    @Override
    public Class<ArrayDeque> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_ArrayDeque_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ArrayDeque sut = null; // = new ArrayDeque(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ArrayDeque_Collection()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

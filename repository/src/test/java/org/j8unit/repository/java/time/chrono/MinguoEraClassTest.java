...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MinguoEra} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.time.chrono.MinguoEraClassTests}).
 */
@RunWith(J8Unit4.class)
public class MinguoEraClassTest
implements MinguoEraClassTests<MinguoEra> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.MinguoEra]

    @Override
    public Class<MinguoEra> createNewSUT() {
        return MinguoEra.class;
    }

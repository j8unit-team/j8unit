...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AsynchronousChannelProvider} (by simply
 * reusing the J8Unit test interface {@link AsynchronousChannelProviderClassTests}).
 */

@RunWith(J8Unit4.class)
public class AsynchronousChannelProviderClassTest
implements AsynchronousChannelProviderClassTests<AsynchronousChannelProvider> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link RemoteObject} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.rmi.server.RemoteObjectTests}).
 */

@RunWith(J8Unit4.class)
public class RemoteObjectTest
implements RemoteObjectTests<RemoteObject> {

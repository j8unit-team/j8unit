...
implements org.j8unit.repository.java.security.PolicyClassTests<Policy> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link Policy#Policy() public java.security.Policy()}.
     *
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Policy#getInstance(String, Parameters) public static
    ...
    throws Exception {
        // write some test for {@link Policy#getInstance(String, Parameters)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Policy#getInstance(String, Parameters, String)
    ...
    throws Exception {
        // write some test for {@link Policy#getInstance(String, Parameters, String)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Policy#getInstance(String, Parameters, Provider)
     * public static java.security.Policy
    ...
    throws Exception {
        // write some test for {@link Policy#getInstance(String, Parameters, Provider)}
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PKIXCertPathBuilderResult} (by simply
 * reusing the J8Unit test interface {@link PKIXCertPathBuilderResultClassTests}).
 */

@RunWith(J8Unit4.class)
public class PKIXCertPathBuilderResultClassTest
implements PKIXCertPathBuilderResultClassTests<PKIXCertPathBuilderResult> {
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.cert.PKIXCertPathBuilderResult]

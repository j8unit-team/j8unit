...
implements FactoryBasedJ8UnitTest<InterruptedByTimeoutException>, InterruptedByTimeoutExceptionTests<InterruptedByTimeoutException> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(InterruptedByTimeoutException::new);
    }

    @Parameter(0)
    public Callable<InterruptedByTimeoutException> sutFactory;

    @Override
    public Callable<InterruptedByTimeoutException> getSUTFactory() {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AccessDeniedException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.nio.file.AccessDeniedExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class AccessDeniedExceptionClassTest
implements AccessDeniedExceptionClassTests<AccessDeniedException> {

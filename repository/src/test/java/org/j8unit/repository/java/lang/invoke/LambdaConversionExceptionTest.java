...
implements FactoryBasedJ8UnitTest<LambdaConversionException>, org.j8unit.repository.java.lang.invoke.LambdaConversionExceptionTests<LambdaConversionException> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(LambdaConversionException::new);
    }

    @Parameter(0)
    public Callable<LambdaConversionException> sutFactory;

    @Override
    public Callable<LambdaConversionException> getSUTFactory() {

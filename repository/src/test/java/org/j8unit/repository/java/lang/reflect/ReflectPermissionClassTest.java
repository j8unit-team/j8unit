 ...
 * J8Unit test interface {@link org.j8unit.repository.java.lang.reflect.ReflectPermissionClassTests}).
 */
...
implements ReflectPermissionClassTests<ReflectPermission> {
    ...
    @Override
    public Class<ReflectPermission> createNewSUT() {
        return ReflectPermission.class;
    }
    ...
    public void create_ReflectPermission_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ReflectPermission sut = null; // = new ReflectPermission(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ReflectPermission_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

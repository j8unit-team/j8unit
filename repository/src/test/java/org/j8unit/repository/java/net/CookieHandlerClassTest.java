...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CookieHandler} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.net.CookieHandlerClassTests}).
 */

@RunWith(J8Unit4.class)
public class CookieHandlerClassTest
implements CookieHandlerClassTests<CookieHandler> {

...
implements FactoryBasedJ8UnitTest<ClosedSelectorException>, ClosedSelectorExceptionTests<ClosedSelectorException> {
    ...
    public static Iterable<? extends Object> sutData() {
        return testParametersOf(ClosedSelectorException::new);
    }

    @Parameter(0)
    public Callable<ClosedSelectorException> sutFactory;

    @Override
    public Callable<ClosedSelectorException> getSUTFactory() {

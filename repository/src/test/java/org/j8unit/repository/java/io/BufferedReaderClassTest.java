...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BufferedReader} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.io.BufferedReaderClassTests}).
 */
@RunWith(J8Unit4.class)
public class BufferedReaderClassTest
implements BufferedReaderClassTests<BufferedReader> {

...
implements org.j8unit.repository.java.util.concurrent.ConcurrentSkipListMapClassTests<ConcurrentSkipListMap> {
    ...
    @Test
    @Category(Draft.class)
    public void create_ConcurrentSkipListMap_SortedMap()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ConcurrentSkipListMap_Comparator()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

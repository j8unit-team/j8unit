...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Shape} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.ShapeTests}).
 */
@RunWith(J8Unit4.class)
public class ShapeTest
implements ShapeTests<Shape> {

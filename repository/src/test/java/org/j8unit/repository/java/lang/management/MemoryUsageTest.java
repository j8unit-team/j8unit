...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link MemoryUsage} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.management.MemoryUsageTests}).
 */

@RunWith(J8Unit4.class)
public class MemoryUsageTest
implements MemoryUsageTests<MemoryUsage> {

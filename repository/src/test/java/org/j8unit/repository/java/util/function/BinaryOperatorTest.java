...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link BinaryOperator} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.function.BinaryOperatorTests}).
 */
@RunWith(J8Unit4.class)
public class BinaryOperatorTest<T>
implements BinaryOperatorTests<BinaryOperator<T>, T> {

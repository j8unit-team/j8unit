...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link GuardedObject} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.GuardedObjectTests}).
 */
@RunWith(J8Unit4.class)
public class GuardedObjectTest
implements GuardedObjectTests<GuardedObject> {

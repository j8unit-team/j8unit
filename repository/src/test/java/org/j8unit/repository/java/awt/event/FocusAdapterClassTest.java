...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link FocusAdapter} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.event.FocusAdapterClassTests}).
 */

@RunWith(J8Unit4.class)
public class FocusAdapterClassTest
implements FocusAdapterClassTests<FocusAdapter> {

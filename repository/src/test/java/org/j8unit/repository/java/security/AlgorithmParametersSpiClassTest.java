...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AlgorithmParametersSpi} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.security.AlgorithmParametersSpiClassTests}).
 */

@RunWith(J8Unit4.class)
public class AlgorithmParametersSpiClassTest
implements AlgorithmParametersSpiClassTests<AlgorithmParametersSpi> {

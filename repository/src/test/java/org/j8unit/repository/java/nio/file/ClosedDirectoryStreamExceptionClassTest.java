...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ClosedDirectoryStreamException} (by
 * simply reusing the J8Unit test interface {@link ClosedDirectoryStreamExceptionClassTests}).
 */

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ECPublicKeySpec} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.spec.ECPublicKeySpecClassTests}).
 */

@RunWith(J8Unit4.class)
public class ECPublicKeySpecClassTest
implements ECPublicKeySpecClassTests<ECPublicKeySpec> {

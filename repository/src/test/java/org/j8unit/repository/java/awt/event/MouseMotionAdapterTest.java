...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link MouseMotionAdapter} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.awt.event.MouseMotionAdapterTests}).
 */
@RunWith(J8Unit4.class)
public class MouseMotionAdapterTest
implements MouseMotionAdapterTests<MouseMotionAdapter> {

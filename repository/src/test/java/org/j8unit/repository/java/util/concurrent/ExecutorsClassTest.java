...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Executors} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.concurrent.ExecutorsClassTests}).
 */
@RunWith(J8Unit4.class)
public class ExecutorsClassTest
implements ExecutorsClassTests<Executors> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.util.concurrent.Executors#newWorkStealingPool()
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#newWorkStealingPool()}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newWorkStealingPool(int) public static java.util.concurrent.ExecutorService
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#newWorkStealingPool(int)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newCachedThreadPool(java.util.concurrent.ThreadFactory) public static
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.util.concurrent.Executors#newCachedThreadPool()
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#newCachedThreadPool()}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newSingleThreadExecutor(java.util.concurrent.ThreadFactory) public static
     * java.util.concurrent.ExecutorService
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newSingleThreadExecutor() public static
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#newSingleThreadExecutor()}
    }
     ...
     * public static <T> java.util.concurrent.Callable<T>
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newSingleThreadScheduledExecutor() public static
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#newSingleThreadScheduledExecutor()}
    }
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#newScheduledThreadPool(int,
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newScheduledThreadPool(int) public static
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newFixedThreadPool(int) public static java.util.concurrent.ExecutorService
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#newFixedThreadPool(int)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#newFixedThreadPool(int, java.util.concurrent.ThreadFactory) public static
     * java.util.concurrent.ExecutorService
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#callable(java.security.PrivilegedExceptionAction) public static
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#callable(java.security.PrivilegedExceptionAction)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#callable(Runnable, Object) public static <T>
     * java.util.concurrent.Callable<T> java.util.concurrent.Executors.callable(java.lang.Runnable,T)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#callable(Runnable, Object)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.util.concurrent.Executors#callable(Runnable)
     * public static java.util.concurrent.Callable<java.lang.Object>
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#callable(Runnable)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#callable(java.security.PrivilegedAction) public static
     * java.util.concurrent.Callable<java.lang.Object>
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#callable(java.security.PrivilegedAction)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#privilegedThreadFactory() public static java.util.concurrent.ThreadFactory
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#privilegedThreadFactory()}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#privilegedCallable(java.util.concurrent.Callable) public static <T>
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#privilegedCallable(java.util.concurrent.Callable)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.concurrent.Executors#defaultThreadFactory() public static java.util.concurrent.ThreadFactory
    ...
    throws Exception {
        // write some test for {@link java.util.concurrent.Executors#defaultThreadFactory()}
    }

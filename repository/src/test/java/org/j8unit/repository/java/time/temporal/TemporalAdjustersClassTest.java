...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TemporalAdjusters} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.time.temporal.TemporalAdjustersClassTests}).
 */
@RunWith(J8Unit4.class)
public class TemporalAdjustersClassTest
implements TemporalAdjustersClassTests<TemporalAdjusters> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.temporal.TemporalAdjusters]

    @Override
    public Class<TemporalAdjusters> createNewSUT() {
        return TemporalAdjusters.class;
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MemoryImageSource} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.image.MemoryImageSourceClassTests}).
 */
@RunWith(J8Unit4.class)
public class MemoryImageSourceClassTest
implements MemoryImageSourceClassTests<MemoryImageSource> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.MemoryImageSource]

    @Override
    public Class<MemoryImageSource> createNewSUT() {
        return MemoryImageSource.class;
    }
    ...
    public void create_MemoryImageSource_int_int_ColorModel_intArray_int_int_Hashtable()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_MemoryImageSource_int_int_ColorModel_intArray_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MemoryImageSource sut = null; // = new MemoryImageSource(int, int, java.awt.image.ColorModel, int[], int,
    ...
    @Test
    @Category(Draft.class)
    public void create_MemoryImageSource_int_int_ColorModel_byteArray_int_int_Hashtable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_MemoryImageSource_int_int_ColorModel_byteArray_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MemoryImageSource sut = null; // = new MemoryImageSource(int, int, java.awt.image.ColorModel, byte[], int,
    ...
    @Test
    @Category(Draft.class)
    public void create_MemoryImageSource_int_int_intArray_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MemoryImageSource sut = null; // = new MemoryImageSource(int, int, int[], int, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_MemoryImageSource_int_int_intArray_int_int_Hashtable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.image.MemoryImageSource]

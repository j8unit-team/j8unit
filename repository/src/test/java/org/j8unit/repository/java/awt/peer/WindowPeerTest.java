...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link WindowPeer} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.peer.WindowPeerTests}).
 */
@RunWith(J8Unit4.class)
public class WindowPeerTest
implements WindowPeerTests<WindowPeer> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Toolkit} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.ToolkitClassTests}).
 */

@RunWith(J8Unit4.class)
public class ToolkitClassTest
implements ToolkitClassTests<Toolkit> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Toolkit]

    @Override
    public Class<Toolkit> createNewSUT() {

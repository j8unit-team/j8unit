...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link GZIPInputStream} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.zip.GZIPInputStreamClassTests}).
 */
@RunWith(J8Unit4.class)
public class GZIPInputStreamClassTest
implements GZIPInputStreamClassTests<GZIPInputStream> {

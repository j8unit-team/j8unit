...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MemoryUsage} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.management.MemoryUsageClassTests}).
 */

@RunWith(J8Unit4.class)
public class MemoryUsageClassTest
implements MemoryUsageClassTests<MemoryUsage> {

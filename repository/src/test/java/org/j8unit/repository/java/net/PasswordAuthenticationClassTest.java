...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PasswordAuthentication} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.net.PasswordAuthenticationClassTests}).
 */
@RunWith(J8Unit4.class)
public class PasswordAuthenticationClassTest
implements PasswordAuthenticationClassTests<PasswordAuthentication> {

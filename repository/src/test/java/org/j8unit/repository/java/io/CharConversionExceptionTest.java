...
implements FactoryBasedJ8UnitTest<CharConversionException>, CharConversionExceptionTests<CharConversionException> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(CharConversionException::new);
    }

    @Parameter(0)
    public Callable<CharConversionException> sutFactory;

    @Override
    public Callable<CharConversionException> getSUTFactory() {

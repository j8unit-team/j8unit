...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CacheRequest} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.net.CacheRequestTests}).
 */

@RunWith(J8Unit4.class)
public class CacheRequestTest
implements CacheRequestTests<CacheRequest> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MonitorInfo} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.management.MonitorInfoClassTests}).
 */

@RunWith(J8Unit4.class)
public class MonitorInfoClassTest
implements MonitorInfoClassTests<MonitorInfo> {

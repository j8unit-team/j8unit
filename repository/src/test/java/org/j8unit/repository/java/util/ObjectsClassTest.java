...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Objects} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.ObjectsClassTests}).
 */

@RunWith(J8Unit4.class)
public class ObjectsClassTest
implements ObjectsClassTests<Objects> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.Objects]

    @Override
    public Class<Objects> createNewSUT() {

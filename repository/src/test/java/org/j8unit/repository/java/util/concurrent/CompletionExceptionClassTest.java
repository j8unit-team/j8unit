...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CompletionException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.CompletionExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class CompletionExceptionClassTest
implements CompletionExceptionClassTests<CompletionException> {

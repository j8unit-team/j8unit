...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link MemoryMXBean} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.management.MemoryMXBeanTests}).
 */

@RunWith(J8Unit4.class)
public class MemoryMXBeanTest
implements MemoryMXBeanTests<MemoryMXBean> {

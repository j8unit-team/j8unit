...
implements org.j8unit.repository.java.time.OffsetTimeClassTests<OffsetTime> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.OffsetTime]

    @Override
    public Class<OffsetTime> createNewSUT() {
     ...
     * {@link java.time.OffsetTime#ofInstant(java.time.Instant, java.time.ZoneId) public static java.time.OffsetTime
    ...
    throws Exception {
        // write some test for {@link java.time.OffsetTime#ofInstant(java.time.Instant, java.time.ZoneId)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.time.OffsetTime#now() public static
    ...
    throws Exception {
        // write some test for {@link java.time.OffsetTime#now()}
    }
    ...
    throws Exception {
        // write some test for {@link java.time.OffsetTime#now(java.time.Clock)}
    }
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.time.OffsetTime#parse(CharSequence, java.time.format.DateTimeFormatter) public static

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NumberFormatException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.lang.NumberFormatExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class NumberFormatExceptionClassTest
implements NumberFormatExceptionClassTests<NumberFormatException> {

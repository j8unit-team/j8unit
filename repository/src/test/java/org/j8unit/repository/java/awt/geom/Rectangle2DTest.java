 ...
 * J8Unit test interface {@link org.j8unit.repository.java.awt.geom.Rectangle2DTests}).
 */
...
implements Rectangle2DTests<Rectangle2D> {
    ...
    @Override
    public Rectangle2D createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [java.awt.geom.Rectangle2D], j8unit does not support a generic way to provide instances.");
    }

...
implements FactoryBasedJ8UnitTest<UnsupportedEncodingException>, UnsupportedEncodingExceptionTests<UnsupportedEncodingException> {
    ...
    public static Iterable<? extends Object> sutData() {
        return testParametersOf(UnsupportedEncodingException::new);
    }

    @Parameter(0)
    public Callable<UnsupportedEncodingException> sutFactory;

    @Override
    public Callable<UnsupportedEncodingException> getSUTFactory() {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link BiPredicate} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.function.BiPredicateTests}).
 */

@RunWith(J8Unit4.class)
public class BiPredicateTest<T, U>
implements BiPredicateTests<BiPredicate<T, U>, T, U> {

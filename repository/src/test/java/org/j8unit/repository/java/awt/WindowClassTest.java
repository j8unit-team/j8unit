...
implements org.j8unit.repository.java.awt.WindowClassTests<Window> {
    ...
    public void create_Window_Frame()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_Window_Window_GraphicsConfiguration()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PrivilegedActionException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.security.PrivilegedActionExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class PrivilegedActionExceptionClassTest
implements PrivilegedActionExceptionClassTests<PrivilegedActionException> {

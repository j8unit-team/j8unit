...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NonWritableChannelException} (by simply
 * reusing the J8Unit test interface {@link NonWritableChannelExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class NonWritableChannelExceptionClassTest
implements NonWritableChannelExceptionClassTests<NonWritableChannelException> {

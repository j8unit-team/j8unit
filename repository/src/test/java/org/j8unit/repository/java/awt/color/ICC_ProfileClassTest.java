...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ICC_Profile} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.color.ICC_ProfileClassTests}).
 */
@RunWith(J8Unit4.class)
public class ICC_ProfileClassTest
implements ICC_ProfileClassTests<ICC_Profile> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.color.ICC_Profile]

    @Override
    public Class<ICC_Profile> createNewSUT() {
        return ICC_Profile.class;
    }

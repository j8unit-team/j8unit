...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link PathMatcher} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.nio.file.PathMatcherTests}).
 */
@RunWith(J8Unit4.class)
public class PathMatcherTest
implements PathMatcherTests<PathMatcher> {

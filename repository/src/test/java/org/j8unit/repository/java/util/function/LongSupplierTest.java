...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link LongSupplier} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.function.LongSupplierTests}).
 */

@RunWith(J8Unit4.class)
public class LongSupplierTest
implements LongSupplierTests<LongSupplier> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AWTEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.AWTEventTests}).
 */
@RunWith(J8Unit4.class)
public class AWTEventTest
implements AWTEventTests<AWTEvent> {

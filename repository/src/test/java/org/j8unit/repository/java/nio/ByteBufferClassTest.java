...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ByteBuffer} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.nio.ByteBufferClassTests}).
 */
@RunWith(J8Unit4.class)
public class ByteBufferClassTest
implements ByteBufferClassTests<ByteBuffer> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.ByteBuffer]

    @Override
    public Class<ByteBuffer> createNewSUT() {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AtomicReferenceArray} (by simply
...
implements AtomicReferenceArrayTests<AtomicReferenceArray<E>, E> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link VolatileImage} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.image.VolatileImageClassTests}).
 */

@RunWith(J8Unit4.class)
public class VolatileImageClassTest
implements VolatileImageClassTests<VolatileImage> {

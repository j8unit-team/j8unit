...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PSSParameterSpec} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.spec.PSSParameterSpecClassTests}).
 */

@RunWith(J8Unit4.class)
public class PSSParameterSpecClassTest
implements PSSParameterSpecClassTests<PSSParameterSpec> {

...
implements org.j8unit.repository.java.util.concurrent.DelayQueueClassTests<DelayQueue> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link DelayQueue#DelayQueue() public
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link DelayQueue#DelayQueue(Collection) public
    ...
    throws Exception {
        ...
        final DelayQueue sut = null; // = new DelayQueue(Collection);
    }

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ZipOutputStream} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.zip.ZipOutputStreamTests}).
 */
@RunWith(J8Unit4.class)
public class ZipOutputStreamTest
implements ZipOutputStreamTests<ZipOutputStream> {

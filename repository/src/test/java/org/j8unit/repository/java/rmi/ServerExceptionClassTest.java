...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ServerException} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.rmi.ServerExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class ServerExceptionClassTest
implements ServerExceptionClassTests<ServerException> {

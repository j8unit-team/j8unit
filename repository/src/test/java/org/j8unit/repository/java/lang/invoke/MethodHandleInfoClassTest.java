...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MethodHandleInfo} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.invoke.MethodHandleInfoClassTests}).
 */

@RunWith(J8Unit4.class)
public class MethodHandleInfoClassTest
implements MethodHandleInfoClassTests<MethodHandleInfo> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.lang.invoke.MethodHandleInfo]

    @Override
    public Class<MethodHandleInfo> createNewSUT() {
        return MethodHandleInfo.class;
    }

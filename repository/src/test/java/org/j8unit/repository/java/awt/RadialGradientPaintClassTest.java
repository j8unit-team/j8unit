...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RadialGradientPaint} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.awt.RadialGradientPaintClassTests}).
 */
@RunWith(J8Unit4.class)
public class RadialGradientPaintClassTest
implements RadialGradientPaintClassTests<RadialGradientPaint> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.RadialGradientPaint]

    @Override
    public Class<RadialGradientPaint> createNewSUT() {
    ...
    public void create_RadialGradientPaint_float_float_float_floatArray_ColorArray()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_RadialGradientPaint_Rectangle2D_floatArray_ColorArray_CycleMethod()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_RadialGradientPaint_Point2D_float_floatArray_ColorArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_RadialGradientPaint_float_float_float_floatArray_ColorArray_CycleMethod()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final RadialGradientPaint sut = null; // = new RadialGradientPaint(float, float, float, float[],
    ...
    @Test
    @Category(Draft.class)
    public void create_RadialGradientPaint_Point2D_float_floatArray_ColorArray_CycleMethod()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final RadialGradientPaint sut = null; // = new RadialGradientPaint(java.awt.geom.Point2D, float, float[],
    ...
    @Test
    @Category(Draft.class)
    public void create_RadialGradientPaint_float_float_float_float_float_floatArray_ColorArray_CycleMethod()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_RadialGradientPaint_Point2D_float_Point2D_floatArray_ColorArray_CycleMethod()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_RadialGradientPaint_Point2D_float_Point2D_floatArray_ColorArray_CycleMethod_ColorSpaceType_AffineTransform()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final RadialGradientPaint sut = null; // = new RadialGradientPaint(java.awt.geom.Point2D, float,

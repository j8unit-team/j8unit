...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UserPrincipalNotFoundException} (by
 * simply reusing the J8Unit test interface {@link UserPrincipalNotFoundExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class UserPrincipalNotFoundExceptionClassTest
implements UserPrincipalNotFoundExceptionClassTests<UserPrincipalNotFoundException> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UnexpectedException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.rmi.UnexpectedExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class UnexpectedExceptionClassTest
implements UnexpectedExceptionClassTests<UnexpectedException> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link HashMap} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.HashMapClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class HashMapClassTest
implements HashMapClassTests<HashMap> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.HashMap]

    @Override
    public Class<HashMap> createNewSUT() {
    ...
    public void create_HashMap_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HashMap sut = null; // = new HashMap(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_HashMap_Map()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_HashMap_int_float()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HashMap sut = null; // = new HashMap(int, float);
    }

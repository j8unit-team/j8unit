...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link TemporalUnit} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.time.temporal.TemporalUnitTests}).
 */
@RunWith(J8Unit4.class)
public class TemporalUnitTest
implements TemporalUnitTests<TemporalUnit> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AWTEventListenerProxy} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.awt.event.AWTEventListenerProxyClassTests}).
 */
@RunWith(J8Unit4.class)
public class AWTEventListenerProxyClassTest
implements AWTEventListenerProxyClassTests<AWTEventListenerProxy> {

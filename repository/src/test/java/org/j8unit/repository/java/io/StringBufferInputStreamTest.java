...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link StringBufferInputStream} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.io.StringBufferInputStreamTests}).
 */
@RunWith(J8Unit4.class)
@SuppressWarnings("deprecation")
public class StringBufferInputStreamTest
implements StringBufferInputStreamTests<StringBufferInputStream> {

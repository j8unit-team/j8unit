...
implements org.j8unit.repository.java.awt.CheckboxClassTests<Checkbox> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Checkbox]

    @Override
    public Class<Checkbox> createNewSUT() {
    ...
    public void create_Checkbox_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Checkbox sut = null; // = new Checkbox(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_Checkbox_String_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Checkbox sut = null; // = new Checkbox(String, boolean);
    }

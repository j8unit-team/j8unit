...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PKIXReason} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.security.cert.PKIXReasonClassTests}).
 */
@RunWith(J8Unit4.class)
public class PKIXReasonClassTest
implements PKIXReasonClassTests<PKIXReason> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.cert.PKIXReason]

    @Override
    public Class<PKIXReason> createNewSUT() {
        return PKIXReason.class;
    }

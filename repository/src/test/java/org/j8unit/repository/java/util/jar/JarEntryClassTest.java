...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JarEntry} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.jar.JarEntryClassTests}).
 */
@RunWith(J8Unit4.class)
public class JarEntryClassTest
implements JarEntryClassTests<JarEntry> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.jar.JarEntry]

    @Override
    public Class<JarEntry> createNewSUT() {
    ...
    public void create_JarEntry_JarEntry()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_JarEntry_ZipEntry()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_JarEntry_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

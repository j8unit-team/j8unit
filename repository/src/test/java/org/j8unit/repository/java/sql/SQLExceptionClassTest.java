...
implements org.j8unit.repository.java.sql.SQLExceptionClassTests<SQLException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.sql.SQLException]

    @Override
    public Class<SQLException> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLException_String_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLException sut = null; // = new SQLException(String, String, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLException sut = null; // = new SQLException(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

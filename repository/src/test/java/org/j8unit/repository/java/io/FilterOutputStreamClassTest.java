...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link FilterOutputStream} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.io.FilterOutputStreamClassTests}).
 */

@RunWith(J8Unit4.class)
public class FilterOutputStreamClassTest
implements FilterOutputStreamClassTests<FilterOutputStream> {

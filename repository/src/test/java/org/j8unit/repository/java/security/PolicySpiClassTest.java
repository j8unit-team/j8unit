...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PolicySpi} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.security.PolicySpiClassTests}).
 */
@RunWith(J8Unit4.class)
public class PolicySpiClassTest
implements PolicySpiClassTests<PolicySpi> {

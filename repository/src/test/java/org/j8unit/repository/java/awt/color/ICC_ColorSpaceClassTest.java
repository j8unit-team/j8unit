...
implements org.j8unit.repository.java.awt.color.ICC_ColorSpaceClassTests<ICC_ColorSpace> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link ICC_ColorSpace#ICC_ColorSpace(ICC_Profile)
    ...
    throws Exception {
        ...
        final ICC_ColorSpace sut = null; // = new ICC_ColorSpace(ICC_Profile);
    }

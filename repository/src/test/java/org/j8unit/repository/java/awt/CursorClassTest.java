...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Cursor} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.CursorClassTests}).
 */

@RunWith(J8Unit4.class)
public class CursorClassTest
implements CursorClassTests<Cursor> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Cursor]

    @Override
    public Class<Cursor> createNewSUT() {
        return Cursor.class;
    }
    ...
    public void create_Cursor_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Cursor sut = null; // = new Cursor(int);
    }

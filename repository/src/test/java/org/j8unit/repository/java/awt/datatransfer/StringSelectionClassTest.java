...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link StringSelection} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.datatransfer.StringSelectionClassTests}).
 */
@RunWith(J8Unit4.class)
public class StringSelectionClassTest
implements StringSelectionClassTests<StringSelection> {

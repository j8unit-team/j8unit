...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link MouseAdapter} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.event.MouseAdapterTests}).
 */

@RunWith(J8Unit4.class)
public class MouseAdapterTest
implements MouseAdapterTests<MouseAdapter> {

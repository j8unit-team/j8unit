...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RasterFormatException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.awt.image.RasterFormatExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class RasterFormatExceptionClassTest
implements RasterFormatExceptionClassTests<RasterFormatException> {
     ...
     * {@link java.awt.image.RasterFormatException#RasterFormatException(String) public

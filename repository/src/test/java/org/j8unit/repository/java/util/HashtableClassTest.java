 ...
 * test interface {@link org.j8unit.repository.java.util.HashtableClassTests}).
 */
...
implements HashtableClassTests<Hashtable> {
    ...
    @Override
    public Class<Hashtable> createNewSUT() {
    ...
    public void create_Hashtable_Map()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_Hashtable_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Hashtable sut = null; // = new Hashtable(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_Hashtable_int_float()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

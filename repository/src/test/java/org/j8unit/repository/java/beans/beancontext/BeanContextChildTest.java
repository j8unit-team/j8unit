...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link BeanContextChild} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.beans.beancontext.BeanContextChildTests}).
 */

@RunWith(J8Unit4.class)
public class BeanContextChildTest
implements BeanContextChildTests<BeanContextChild> {

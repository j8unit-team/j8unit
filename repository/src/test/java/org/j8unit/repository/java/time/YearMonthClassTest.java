...
implements org.j8unit.repository.java.time.YearMonthClassTests<YearMonth> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.YearMonth]

    @Override
    public Class<YearMonth> createNewSUT() {
     ...
     * {@link java.time.YearMonth#from(java.time.temporal.TemporalAccessor) public static java.time.YearMonth
    ...
    throws Exception {
        // write some test for {@link java.time.YearMonth#from(java.time.temporal.TemporalAccessor)}
    }
    ...
    throws Exception {
        // write some test for {@link java.time.YearMonth#parse(CharSequence)}
    }
    ...
    throws Exception {
        // write some test for {@link java.time.YearMonth#now(java.time.Clock)}
    }
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.time.YearMonth#now() public static
    ...
    throws Exception {
        // write some test for {@link java.time.YearMonth#now()}
    }

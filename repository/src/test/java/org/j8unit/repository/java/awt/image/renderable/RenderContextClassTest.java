...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RenderContext} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.image.renderable.RenderContextClassTests}).
 */

@RunWith(J8Unit4.class)
public class RenderContextClassTest
implements RenderContextClassTests<RenderContext> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.renderable.RenderContext]

    @Override
    public Class<RenderContext> createNewSUT() {
        return RenderContext.class;
    }
    ...
    public void create_RenderContext_AffineTransform()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_RenderContext_AffineTransform_RenderingHints()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_RenderContext_AffineTransform_Shape()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_RenderContext_AffineTransform_Shape_RenderingHints()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final RenderContext sut = null; // = new RenderContext(java.awt.geom.AffineTransform, java.awt.Shape,

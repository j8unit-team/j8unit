...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link IllegalFormatConversionException} (by
 * simply reusing the J8Unit test interface {@link IllegalFormatConversionExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class IllegalFormatConversionExceptionClassTest
implements IllegalFormatConversionExceptionClassTests<IllegalFormatConversionException> {

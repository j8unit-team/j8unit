...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ParameterBlock} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.image.renderable.ParameterBlockClassTests}).
 */

@RunWith(J8Unit4.class)
public class ParameterBlockClassTest
implements ParameterBlockClassTests<ParameterBlock> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.renderable.ParameterBlock]

    @Override
    public Class<ParameterBlock> createNewSUT() {
        return ParameterBlock.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ParameterBlock_Vector_Vector()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ParameterBlock_Vector()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

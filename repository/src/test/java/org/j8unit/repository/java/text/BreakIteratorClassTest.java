...
implements BreakIteratorClassTests<BreakIterator> {
     ...
     * {@link java.text.BreakIterator#getCharacterInstance(java.util.Locale) public static java.text.BreakIterator
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.text.BreakIterator#getWordInstance() public
     * static java.text.BreakIterator java.text.BreakIterator.getWordInstance()}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
    ...
    @Test
    @Category(Draft.class)
    public void test_getWordInstance()
    throws Exception {
        // write some test for {@link java.text.BreakIterator#getWordInstance()}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.text.BreakIterator#getWordInstance(java.util.Locale) public static java.text.BreakIterator
    ...
    @Test
    @Category(Draft.class)
    public void test_getWordInstance_Locale()
    throws Exception {
        // write some test for {@link java.text.BreakIterator#getWordInstance(java.util.Locale)}
    }
    ...
    @Test
    @Category(Draft.class)
    public void test_getLineInstance_Locale()
    throws Exception {
        // write some test for {@link java.text.BreakIterator#getLineInstance(java.util.Locale)}
    }

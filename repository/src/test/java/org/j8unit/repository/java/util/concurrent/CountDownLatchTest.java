...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CountDownLatch} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.CountDownLatchTests}).
 */

@RunWith(J8Unit4.class)
public class CountDownLatchTest
implements CountDownLatchTests<CountDownLatch> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RemoteServer} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.rmi.server.RemoteServerClassTests}).
 */

@RunWith(J8Unit4.class)
public class RemoteServerClassTest
implements RemoteServerClassTests<RemoteServer> {

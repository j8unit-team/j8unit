...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link UserPrincipalNotFoundException} (by
...
implements UserPrincipalNotFoundExceptionTests<UserPrincipalNotFoundException> {

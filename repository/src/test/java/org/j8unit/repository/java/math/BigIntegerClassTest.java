...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BigInteger} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.math.BigIntegerClassTests}).
 */
@RunWith(J8Unit4.class)
public class BigIntegerClassTest
implements BigIntegerClassTests<BigInteger> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.math.BigInteger]

    @Override
    public Class<BigInteger> createNewSUT() {
    ...
    public void create_BigInteger_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigInteger sut = null; // = new BigInteger(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_BigInteger_int_int_Random()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_BigInteger_int_byteArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigInteger sut = null; // = new BigInteger(int, byte[]);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_BigInteger_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

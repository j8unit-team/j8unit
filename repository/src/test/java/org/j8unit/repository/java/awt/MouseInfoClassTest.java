...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MouseInfo} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.awt.MouseInfoClassTests}).
 */
@RunWith(J8Unit4.class)
public class MouseInfoClassTest
implements MouseInfoClassTests<MouseInfo> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.MouseInfo]

    @Override
    public Class<MouseInfo> createNewSUT() {

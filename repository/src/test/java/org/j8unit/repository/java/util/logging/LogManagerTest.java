...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link LogManager} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.logging.LogManagerTests}).
 */
@RunWith(J8Unit4.class)
public class LogManagerTest
implements LogManagerTests<LogManager> {

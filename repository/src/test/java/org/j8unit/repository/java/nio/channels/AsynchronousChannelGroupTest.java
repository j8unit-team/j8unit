...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AsynchronousChannelGroup} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.nio.channels.AsynchronousChannelGroupTests}).
 */
@RunWith(J8Unit4.class)
public class AsynchronousChannelGroupTest
implements AsynchronousChannelGroupTests<AsynchronousChannelGroup> {

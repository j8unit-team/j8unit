...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link FileInputStream} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.io.FileInputStreamClassTests}).
 */
@RunWith(J8Unit4.class)
public class FileInputStreamClassTest
implements FileInputStreamClassTests<FileInputStream> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AlgorithmParameterGeneratorSpi} (by
 * simply reusing the J8Unit test interface {@link AlgorithmParameterGeneratorSpiClassTests}).
 */

@RunWith(J8Unit4.class)
public class AlgorithmParameterGeneratorSpiClassTest
implements AlgorithmParameterGeneratorSpiClassTests<AlgorithmParameterGeneratorSpi> {

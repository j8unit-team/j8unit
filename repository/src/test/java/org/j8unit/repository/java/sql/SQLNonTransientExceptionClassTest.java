...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SQLNonTransientException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.sql.SQLNonTransientExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class SQLNonTransientExceptionClassTest
implements SQLNonTransientExceptionClassTests<SQLNonTransientException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.sql.SQLNonTransientException]

    @Override
    public Class<SQLNonTransientException> createNewSUT() {
        return SQLNonTransientException.class;
    }
    ...
    public void create_SQLNonTransientException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLNonTransientException sut = null; // = new SQLNonTransientException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLNonTransientException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLNonTransientException sut = null; // = new SQLNonTransientException(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLNonTransientException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLNonTransientException sut = null; // = new SQLNonTransientException(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLNonTransientException_String_String_int_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLNonTransientException sut = null; // = new SQLNonTransientException(String, String, int, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLNonTransientException()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLNonTransientException sut = new SQLNonTransientException();
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLNonTransientException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLNonTransientException sut = null; // = new SQLNonTransientException(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLNonTransientException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SQLNonTransientException sut = null; // = new SQLNonTransientException(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_SQLNonTransientException_String_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PushbackInputStream} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.io.PushbackInputStreamClassTests}).
 */
@RunWith(J8Unit4.class)
public class PushbackInputStreamClassTest
implements PushbackInputStreamClassTests<PushbackInputStream> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.PushbackInputStream]

    @Override
    public Class<PushbackInputStream> createNewSUT() {
    ...
    public void create_PushbackInputStream_InputStream_int()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_PushbackInputStream_InputStream()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

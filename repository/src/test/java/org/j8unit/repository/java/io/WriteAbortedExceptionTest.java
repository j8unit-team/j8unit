...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link WriteAbortedException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.io.WriteAbortedExceptionTests}).
 */
@RunWith(J8Unit4.class)
public class WriteAbortedExceptionTest
implements WriteAbortedExceptionTests<WriteAbortedException> {

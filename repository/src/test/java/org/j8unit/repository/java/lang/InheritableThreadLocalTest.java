...
implements FactoryBasedJ8UnitTest<InheritableThreadLocal<T>>, org.j8unit.repository.java.lang.InheritableThreadLocalTests<InheritableThreadLocal<T>, T> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(InheritableThreadLocal::new);
    }

    @Parameter(0)
    public Callable<InheritableThreadLocal<T>> sutFactory;

    @Override
    public Callable<InheritableThreadLocal<T>> getSUTFactory() {

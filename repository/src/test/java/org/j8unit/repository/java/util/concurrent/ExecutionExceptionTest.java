...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ExecutionException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.ExecutionExceptionTests}).
 */
@RunWith(J8Unit4.class)
public class ExecutionExceptionTest
implements ExecutionExceptionTests<ExecutionException> {

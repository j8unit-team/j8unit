...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CertificateRevokedException} (by simply
 * reusing the J8Unit test interface {@link CertificateRevokedExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class CertificateRevokedExceptionClassTest
implements CertificateRevokedExceptionClassTests<CertificateRevokedException> {

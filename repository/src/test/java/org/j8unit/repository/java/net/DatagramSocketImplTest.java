...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link DatagramSocketImpl} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.net.DatagramSocketImplTests}).
 */

@RunWith(J8Unit4.class)
public class DatagramSocketImplTest
implements DatagramSocketImplTests<DatagramSocketImpl> {

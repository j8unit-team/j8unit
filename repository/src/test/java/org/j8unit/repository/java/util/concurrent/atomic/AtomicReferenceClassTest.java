...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AtomicReference} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.atomic.AtomicReferenceClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class AtomicReferenceClassTest
implements AtomicReferenceClassTests<AtomicReference> {

...
implements DataFlavorClassTests<DataFlavor> {
    ...
    public void create_DataFlavor_String_String_ClassLoader()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DataFlavor sut = null; // = new DataFlavor(String, String, ClassLoader);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_DataFlavor_Class_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CacheRequest} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.net.CacheRequestClassTests}).
 */

@RunWith(J8Unit4.class)
public class CacheRequestClassTest
implements CacheRequestClassTests<CacheRequest> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link SoftReference} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.ref.SoftReferenceTests}).
 */
@RunWith(J8Unit4.class)
public class SoftReferenceTest<T>
implements SoftReferenceTests<SoftReference<T>, T> {

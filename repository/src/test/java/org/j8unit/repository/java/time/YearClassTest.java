...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Year} (by simply reusing the J8Unit test
 * interface {@link org.j8unit.repository.java.time.YearClassTests}).
 */
@RunWith(J8Unit4.class)
public class YearClassTest
implements YearClassTests<Year> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.Year]

    @Override
    public Class<Year> createNewSUT() {
        return Year.class;
    }

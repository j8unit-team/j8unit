...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AnnotatedType} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.reflect.AnnotatedTypeClassTests}).
 */

@RunWith(J8Unit4.class)
public class AnnotatedTypeClassTest
implements AnnotatedTypeClassTests<AnnotatedType> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link GregorianCalendar} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.GregorianCalendarClassTests}).
 */

@RunWith(J8Unit4.class)
public class GregorianCalendarClassTest
implements GregorianCalendarClassTests<GregorianCalendar> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.GregorianCalendar]

    @Override
    public Class<GregorianCalendar> createNewSUT() {
     ...
     * {@link java.util.GregorianCalendar#GregorianCalendar(int, int, int) public
    ...
    public void create_GregorianCalendar_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final GregorianCalendar sut = null; // = new GregorianCalendar(int, int, int);
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.util.GregorianCalendar#GregorianCalendar(int, int, int, int, int) public
    ...
    @Test
    @Category(Draft.class)
    public void create_GregorianCalendar_int_int_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final GregorianCalendar sut = null; // = new GregorianCalendar(int, int, int, int, int);
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.util.GregorianCalendar#GregorianCalendar(int, int, int, int, int, int) public
    ...
    @Test
    @Category(Draft.class)
    public void create_GregorianCalendar_int_int_int_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final GregorianCalendar sut = null; // = new GregorianCalendar(int, int, int, int, int, int);
    }
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.util.GregorianCalendar#GregorianCalendar(java.util.Locale) public
    ...
    @Test
    @Category(Draft.class)
    public void create_GregorianCalendar_Locale()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final GregorianCalendar sut = null; // = new GregorianCalendar(java.util.Locale);
    }
     ...
     * {@link java.util.GregorianCalendar#from(java.time.ZonedDateTime) public static java.util.GregorianCalendar
    ...
    @Test
    @Category(Draft.class)
    public void test_from_ZonedDateTime()
    throws Exception {

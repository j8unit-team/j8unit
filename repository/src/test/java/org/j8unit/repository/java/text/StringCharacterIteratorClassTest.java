...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link StringCharacterIterator} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.text.StringCharacterIteratorClassTests}).
 */

@RunWith(J8Unit4.class)
public class StringCharacterIteratorClassTest
implements StringCharacterIteratorClassTests<StringCharacterIterator> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.text.StringCharacterIterator]

    @Override
    public Class<StringCharacterIterator> createNewSUT() {
        return StringCharacterIterator.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_StringCharacterIterator_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_StringCharacterIterator_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

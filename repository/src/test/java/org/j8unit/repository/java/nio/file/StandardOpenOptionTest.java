...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link StandardOpenOption} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.nio.file.StandardOpenOptionTests}).
 */

@RunWith(J8Parameterized.class)
@UseParametersRunnerFactory(J8BlockJUnit4ClassRunnerWithParametersFactory.class)
public class StandardOpenOptionTest
implements StandardOpenOptionTests<StandardOpenOption> {

...
implements AtomicMarkableReferenceClassTests<AtomicMarkableReference> {
    ...
    @Override
    public Class<AtomicMarkableReference> createNewSUT() {
    ...
    public void create_AtomicMarkableReference_Object_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final AtomicMarkableReference sut = null; // = new AtomicMarkableReference(Object, boolean);
    }

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Checksum} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.zip.ChecksumTests}).
 */
@RunWith(J8Unit4.class)
public class ChecksumTest
implements ChecksumTests<Checksum> {

...
implements org.j8unit.repository.java.security.DigestExceptionClassTests<DigestException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.DigestException]

    @Override
    public Class<DigestException> createNewSUT() {
        return DigestException.class;
    }
    ...
    public void create_DigestException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DigestException sut = null; // = new DigestException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_DigestException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DigestException sut = null; // = new DigestException(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_DigestException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DigestException sut = null; // = new DigestException(String);
    }

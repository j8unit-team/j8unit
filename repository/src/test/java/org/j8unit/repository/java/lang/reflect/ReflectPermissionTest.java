...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ReflectPermission} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.lang.reflect.ReflectPermissionTests}).
 */
@RunWith(J8Unit4.class)
public class ReflectPermissionTest
implements ReflectPermissionTests<ReflectPermission> {

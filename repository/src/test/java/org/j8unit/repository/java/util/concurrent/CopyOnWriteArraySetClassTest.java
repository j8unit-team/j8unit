...
implements org.j8unit.repository.java.util.concurrent.CopyOnWriteArraySetClassTests<CopyOnWriteArraySet> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link CopyOnWriteArraySet#CopyOnWriteArraySet()
     ...
     * {@link CopyOnWriteArraySet#CopyOnWriteArraySet(Collection) public
    ...
    throws Exception {
        ...
        final CopyOnWriteArraySet sut = null; // = new CopyOnWriteArraySet(Collection);
    }

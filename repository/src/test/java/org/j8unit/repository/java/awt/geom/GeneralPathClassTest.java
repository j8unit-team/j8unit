...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link GeneralPath} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.geom.GeneralPathClassTests}).
 */

@RunWith(J8Unit4.class)
public class GeneralPathClassTest
implements GeneralPathClassTests<GeneralPath> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.geom.GeneralPath]

    @Override
    public Class<GeneralPath> createNewSUT() {
    ...
    public void create_GeneralPath_Shape()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_GeneralPath_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final GeneralPath sut = null; // = new GeneralPath(int, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_GeneralPath_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final GeneralPath sut = null; // = new GeneralPath(int);
    }

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ComponentEvent} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.awt.event.ComponentEventTests}).
 */

@RunWith(J8Unit4.class)
public class ComponentEventTest
implements ComponentEventTests<ComponentEvent> {

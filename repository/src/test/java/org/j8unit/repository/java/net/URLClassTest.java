...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link URL} (by simply reusing the J8Unit test
 * interface {@link org.j8unit.repository.java.net.URLClassTests}).
 */
@RunWith(J8Unit4.class)
public class URLClassTest
implements URLClassTests<URL> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.net.URL]
    ...
    public void create_URL_URL_String_URLStreamHandler()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_URL_URL_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_URL_String_String_int_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final URL sut = null; // = new URL(String, String, int, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_URL_String_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final URL sut = null; // = new URL(String, String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_URL_String_String_int_String_URLStreamHandler()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

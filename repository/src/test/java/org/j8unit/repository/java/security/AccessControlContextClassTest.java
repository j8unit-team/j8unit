...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AccessControlContext} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.security.AccessControlContextClassTests}).
 */

@RunWith(J8Unit4.class)
public class AccessControlContextClassTest
implements AccessControlContextClassTests<AccessControlContext> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CookieHandler} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.net.CookieHandlerTests}).
 */

@RunWith(J8Unit4.class)
public class CookieHandlerTest
implements CookieHandlerTests<CookieHandler> {

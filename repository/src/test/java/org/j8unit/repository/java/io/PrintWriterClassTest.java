...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PrintWriter} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.io.PrintWriterClassTests}).
 */

@RunWith(J8Unit4.class)
public class PrintWriterClassTest
implements PrintWriterClassTests<PrintWriter> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.PrintWriter]

    @Override
    public Class<PrintWriter> createNewSUT() {
    ...
    public void create_PrintWriter_OutputStream_boolean()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintWriter_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PrintWriter sut = null; // = new PrintWriter(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintWriter_File()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintWriter_File_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintWriter_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PrintWriter sut = null; // = new PrintWriter(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintWriter_Writer()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintWriter_OutputStream()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrintWriter_Writer_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

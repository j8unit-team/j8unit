...
implements org.j8unit.repository.java.rmi.NamingClassTests<Naming> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Naming#lookup(String) public static java.rmi.Remote
    ...
    throws Exception {
        // write some test for {@link Naming#lookup(String)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Naming#bind(String, Remote) public static void
    ...
    throws Exception {
        // write some test for {@link Naming#bind(String, Remote)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Naming#rebind(String, Remote) public static void
    ...
    throws Exception {
        // write some test for {@link Naming#rebind(String, Remote)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Naming#unbind(String) public static void
    ...
    throws Exception {
        // write some test for {@link Naming#unbind(String)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link Naming#list(String) public static java.lang.String[]
    ...
    throws Exception {
        // write some test for {@link Naming#list(String)}
    }

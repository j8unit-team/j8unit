...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PropertyPermission} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.PropertyPermissionClassTests}).
 */

@RunWith(J8Unit4.class)
public class PropertyPermissionClassTest
implements PropertyPermissionClassTests<PropertyPermission> {

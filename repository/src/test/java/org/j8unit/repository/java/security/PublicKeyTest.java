...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link PublicKey} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.PublicKeyTests}).
 */
@RunWith(J8Unit4.class)
public class PublicKeyTest
implements PublicKeyTests<PublicKey> {

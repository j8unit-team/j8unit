...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link WindowEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.event.WindowEventClassTests}).
 */

@RunWith(J8Unit4.class)
public class WindowEventClassTest
implements WindowEventClassTests<WindowEvent> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.event.WindowEvent]

    @Override
    public Class<WindowEvent> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_WindowEvent_Window_int_Window()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

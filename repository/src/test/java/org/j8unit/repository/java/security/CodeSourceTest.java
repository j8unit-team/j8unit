...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CodeSource} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.CodeSourceTests}).
 */
@RunWith(J8Unit4.class)
public class CodeSourceTest
implements CodeSourceTests<CodeSource> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TextHitInfo} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.font.TextHitInfoClassTests}).
 */
@RunWith(J8Unit4.class)
public class TextHitInfoClassTest
implements TextHitInfoClassTests<TextHitInfo> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.font.TextHitInfo]

    @Override
    public Class<TextHitInfo> createNewSUT() {
        return TextHitInfo.class;
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Matcher} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.regex.MatcherClassTests}).
 */
@RunWith(J8Unit4.class)
public class MatcherClassTest
implements MatcherClassTests<Matcher> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ServerException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.rmi.ServerExceptionTests}).
 */
@RunWith(J8Unit4.class)
public class ServerExceptionTest
implements ServerExceptionTests<ServerException> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RMIClassLoader} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.rmi.server.RMIClassLoaderClassTests}).
 */

@RunWith(J8Unit4.class)
public class RMIClassLoaderClassTest
implements RMIClassLoaderClassTests<RMIClassLoader> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.rmi.server.RMIClassLoader]

    @Override
    public Class<RMIClassLoader> createNewSUT() {
        return RMIClassLoader.class;
    }
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.rmi.server.RMIClassLoader#loadProxyClass(String, String[], ClassLoader) public static
     * java.lang.Class<?>

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link HijrahDate} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.time.chrono.HijrahDateClassTests}).
 */

@RunWith(J8Unit4.class)
public class HijrahDateClassTest
implements HijrahDateClassTests<HijrahDate> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.HijrahDate]

    @Override
    public Class<HijrahDate> createNewSUT() {
        return HijrahDate.class;
    }

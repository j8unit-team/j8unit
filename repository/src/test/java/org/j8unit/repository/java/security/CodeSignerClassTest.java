...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CodeSigner} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.security.CodeSignerClassTests}).
 */

@RunWith(J8Unit4.class)
public class CodeSignerClassTest
implements CodeSignerClassTests<CodeSigner> {

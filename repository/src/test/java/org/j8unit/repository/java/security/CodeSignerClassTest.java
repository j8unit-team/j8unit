...
implements org.j8unit.repository.java.security.CodeSignerClassTests<CodeSigner> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link CodeSigner#CodeSigner(CertPath, Timestamp)
    ...
    throws Exception {
        ...
        final CodeSigner sut = null; // = new CodeSigner(CertPath, Timestamp);
    }

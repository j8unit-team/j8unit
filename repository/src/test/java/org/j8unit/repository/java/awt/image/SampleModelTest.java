...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link SampleModel} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.image.SampleModelTests}).
 */

@RunWith(J8Unit4.class)
public class SampleModelTest
implements SampleModelTests<SampleModel> {

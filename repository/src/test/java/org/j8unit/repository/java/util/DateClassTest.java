...
implements org.j8unit.repository.java.util.DateClassTests<Date> {
    ...
    @Test
    @Category(Draft.class)
    public void create_Date_int_int_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Date sut = null; // = new Date(int, int, int, int, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_Date_int_int_int_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Date sut = null; // = new Date(int, int, int, int, int, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_Date_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Date sut = null; // = new Date(String);
    }

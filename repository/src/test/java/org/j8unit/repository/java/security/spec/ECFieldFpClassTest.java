 ...
 * test interface {@link org.j8unit.repository.java.security.spec.ECFieldFpClassTests}).
 */
...
implements ECFieldFpClassTests<ECFieldFp> {
    ...
    @Override
    public Class<ECFieldFp> createNewSUT() {
    ...
    public void create_ECFieldFp_BigInteger()
    throws Exception {
        // create new instance

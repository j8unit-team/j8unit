...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AlgorithmConstraints} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.security.AlgorithmConstraintsTests}).
 */
@RunWith(J8Unit4.class)
public class AlgorithmConstraintsTest
implements AlgorithmConstraintsTests<AlgorithmConstraints> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ConnectIOException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.rmi.ConnectIOExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class ConnectIOExceptionClassTest
implements ConnectIOExceptionClassTests<ConnectIOException> {
     ...
     * {@link java.rmi.ConnectIOException#ConnectIOException(String) public
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.rmi.ConnectIOException#ConnectIOException(String, Exception) public

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JDBCType} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.sql.JDBCTypeClassTests}).
 */
@RunWith(J8Unit4.class)
public class JDBCTypeClassTest
implements JDBCTypeClassTests<JDBCType> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.sql.JDBCType]

    @Override
    public Class<JDBCType> createNewSUT() {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ShutdownChannelGroupException} (by simply
 * reusing the J8Unit test interface {@link ShutdownChannelGroupExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class ShutdownChannelGroupExceptionClassTest
implements ShutdownChannelGroupExceptionClassTests<ShutdownChannelGroupException> {

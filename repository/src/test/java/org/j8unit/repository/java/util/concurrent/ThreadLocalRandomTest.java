...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ThreadLocalRandom} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.ThreadLocalRandomTests}).
 */
@RunWith(J8Unit4.class)
public class ThreadLocalRandomTest
implements ThreadLocalRandomTests<ThreadLocalRandom> {

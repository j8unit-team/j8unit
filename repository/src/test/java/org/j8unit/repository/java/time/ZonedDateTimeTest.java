...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ZonedDateTime} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.time.ZonedDateTimeTests}).
 */

@RunWith(J8Unit4.class)
public class ZonedDateTimeTest
implements ZonedDateTimeTests<ZonedDateTime> {

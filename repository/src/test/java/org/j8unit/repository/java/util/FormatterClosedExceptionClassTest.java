...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link FormatterClosedException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.util.FormatterClosedExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class FormatterClosedExceptionClassTest
implements FormatterClosedExceptionClassTests<FormatterClosedException> {

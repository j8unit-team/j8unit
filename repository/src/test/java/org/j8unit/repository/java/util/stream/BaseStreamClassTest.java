...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BaseStream} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.util.stream.BaseStreamClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class BaseStreamClassTest
implements BaseStreamClassTests<BaseStream> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BufferedOutputStream} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.io.BufferedOutputStreamClassTests}).
 */

@RunWith(J8Unit4.class)
public class BufferedOutputStreamClassTest
implements BufferedOutputStreamClassTests<BufferedOutputStream> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.BufferedOutputStream]

    @Override
    public Class<BufferedOutputStream> createNewSUT() {
        return BufferedOutputStream.class;
    }
    ...
    public void create_BufferedOutputStream_OutputStream()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_BufferedOutputStream_OutputStream_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

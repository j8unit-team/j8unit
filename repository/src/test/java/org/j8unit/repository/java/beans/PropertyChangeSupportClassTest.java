...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PropertyChangeSupport} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.beans.PropertyChangeSupportClassTests}).
 */

@RunWith(J8Unit4.class)
public class PropertyChangeSupportClassTest
implements PropertyChangeSupportClassTests<PropertyChangeSupport> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KeyPair} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.security.KeyPairClassTests}).
 */
@RunWith(J8Unit4.class)
public class KeyPairClassTest
implements KeyPairClassTests<KeyPair> {

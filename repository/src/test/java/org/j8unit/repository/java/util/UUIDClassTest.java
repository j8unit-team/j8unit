...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UUID} (by simply reusing the J8Unit test
 * interface {@link org.j8unit.repository.java.util.UUIDClassTests}).
 */
@RunWith(J8Unit4.class)
public class UUIDClassTest
implements UUIDClassTests<UUID> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DateTimeFormatter} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.time.format.DateTimeFormatterClassTests}).
 */

@RunWith(J8Unit4.class)
public class DateTimeFormatterClassTest
implements DateTimeFormatterClassTests<DateTimeFormatter> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.format.DateTimeFormatter]

    @Override
    public Class<DateTimeFormatter> createNewSUT() {

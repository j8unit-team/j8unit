...
implements org.j8unit.repository.java.net.SocketClassTests<Socket> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.net.Socket]

    @Override
    public Class<Socket> createNewSUT() {
        return Socket.class;
    }
    ...
    public void create_Socket_String_int_InetAddress_int()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_Socket_InetAddress_int_InetAddress_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_Socket_InetAddress_int_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_Socket_Proxy()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_Socket_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Socket sut = null; // = new Socket(String, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_Socket_InetAddress_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

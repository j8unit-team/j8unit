...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PKIXBuilderParameters} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.security.cert.PKIXBuilderParametersClassTests}).
 */

@RunWith(J8Unit4.class)
public class PKIXBuilderParametersClassTest
implements PKIXBuilderParametersClassTests<PKIXBuilderParameters> {

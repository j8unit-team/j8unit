...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TemporalQueries} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.time.temporal.TemporalQueriesClassTests}).
 */

@RunWith(J8Unit4.class)
public class TemporalQueriesClassTest
implements TemporalQueriesClassTests<TemporalQueries> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.temporal.TemporalQueries]

    @Override
    public Class<TemporalQueries> createNewSUT() {
        return TemporalQueries.class;
    }
     ...
     * public static java.time.temporal.TemporalQuery<java.time.chrono.Chronology>
     ...
     * public static java.time.temporal.TemporalQuery<java.time.LocalDate>
     ...
     * public static java.time.temporal.TemporalQuery<java.time.temporal.TemporalUnit>
     ...
     * public static java.time.temporal.TemporalQuery<java.time.LocalTime>
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.time.temporal.TemporalQueries]

 ...
 * J8Unit test interface {@link org.j8unit.repository.java.awt.image.DataBufferByteClassTests}).
 */
...
implements DataBufferByteClassTests<DataBufferByte> {
    ...
    @Override
    public Class<DataBufferByte> createNewSUT() {
        return DataBufferByte.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_DataBufferByte_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DataBufferByte sut = null; // = new DataBufferByte(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_DataBufferByte_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_DataBufferByte_byteArray_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_DataBufferByte_byteArrayArray_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DataBufferByte sut = null; // = new DataBufferByte(byte[][], int);
    ...
    @Test
    @Category(Draft.class)
    public void create_DataBufferByte_byteArrayArray_int_intArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DataBufferByte sut = null; // = new DataBufferByte(byte[][], int, int[]);

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link InputStreamReader} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.io.InputStreamReaderTests}).
 */
@RunWith(J8Unit4.class)
public class InputStreamReaderTest
implements InputStreamReaderTests<InputStreamReader> {

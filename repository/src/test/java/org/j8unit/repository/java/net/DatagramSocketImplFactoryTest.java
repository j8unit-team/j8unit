...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link DatagramSocketImplFactory} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.net.DatagramSocketImplFactoryTests}).
 */

@RunWith(J8Unit4.class)
public class DatagramSocketImplFactoryTest
implements DatagramSocketImplFactoryTests<DatagramSocketImplFactory> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ContainerOrderFocusTraversalPolicy} (by
 * simply reusing the J8Unit test interface {@link ContainerOrderFocusTraversalPolicyClassTests}).
 */
...
implements ContainerOrderFocusTraversalPolicyClassTests<ContainerOrderFocusTraversalPolicy> {
    ...
    @Override
    public Class<ContainerOrderFocusTraversalPolicy> createNewSUT() {
        return ContainerOrderFocusTraversalPolicy.class;
    }

...
implements org.j8unit.repository.java.math.BigDecimalClassTests<BigDecimal> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.math.BigDecimal]

    @Override
    public Class<BigDecimal> createNewSUT() {
    ...
    public void create_BigDecimal_long_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigDecimal sut = null; // = new BigDecimal(long, java.math.MathContext);
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.math.BigDecimal#BigDecimal(String, java.math.MathContext) public
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_String_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigDecimal sut = null; // = new BigDecimal(String, java.math.MathContext);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_double_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link java.math.BigDecimal#BigDecimal(String) public
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigDecimal sut = null; // = new BigDecimal(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_charArray_int_int_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link java.math.BigDecimal#BigDecimal(char[]) public
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_charArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigDecimal sut = null; // = new BigDecimal(char[]);
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.math.BigDecimal#BigDecimal(char[], java.math.MathContext) public
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_charArray_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.math.BigDecimal#BigDecimal(java.math.BigInteger, int, java.math.MathContext) public
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_BigInteger_int_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigDecimal sut = null; // = new BigDecimal(java.math.BigInteger, int, java.math.MathContext);
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.math.BigDecimal#BigDecimal(java.math.BigInteger, java.math.MathContext) public
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_BigInteger_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigDecimal sut = null; // = new BigDecimal(java.math.BigInteger, java.math.MathContext);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.math.BigDecimal#BigDecimal(int, java.math.MathContext) public
    ...
    @Test
    @Category(Draft.class)
    public void create_BigDecimal_int_MathContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BigDecimal sut = null; // = new BigDecimal(int, java.math.MathContext);
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.math.BigDecimal#valueOf(long, int) public
     * static java.math.BigDecimal java.math.BigDecimal.valueOf(long,int)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
    ...
    @Test
    @Category(Draft.class)
    public void test_valueOf_long_int()
    throws Exception {
        // write some test for {@link java.math.BigDecimal#valueOf(long, int)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.math.BigDecimal#valueOf(long) public static
    ...
    throws Exception {
        // write some test for {@link java.math.BigDecimal#valueOf(long)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.math.BigDecimal#valueOf(double) public static

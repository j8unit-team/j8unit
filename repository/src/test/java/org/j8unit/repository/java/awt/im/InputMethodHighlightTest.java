...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link InputMethodHighlight} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.awt.im.InputMethodHighlightTests}).
 */

@RunWith(J8Parameterized.class)
@UseParametersRunnerFactory(J8BlockJUnit4ClassRunnerWithParametersFactory.class)
public class InputMethodHighlightTest
implements InputMethodHighlightTests<InputMethodHighlight> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CertPathValidatorSpi} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.security.cert.CertPathValidatorSpiTests}).
 */
@RunWith(J8Unit4.class)
public class CertPathValidatorSpiTest
implements CertPathValidatorSpiTests<CertPathValidatorSpi> {

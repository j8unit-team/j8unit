...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RSAPrivateKeySpec} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.spec.RSAPrivateKeySpecClassTests}).
 */
@RunWith(J8Unit4.class)
public class RSAPrivateKeySpecClassTest
implements RSAPrivateKeySpecClassTests<RSAPrivateKeySpec> {

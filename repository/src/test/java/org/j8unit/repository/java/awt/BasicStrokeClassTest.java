...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BasicStroke} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.BasicStrokeClassTests}).
 */
@RunWith(J8Unit4.class)
public class BasicStrokeClassTest
implements BasicStrokeClassTests<BasicStroke> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.BasicStroke]

    @Override
    public Class<BasicStroke> createNewSUT() {
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.awt.BasicStroke#BasicStroke(float, int, int) public java.awt.BasicStroke(float,int,int)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
    ...
    @Test
    @Category(Draft.class)
    public void create_BasicStroke_float_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BasicStroke sut = null; // = new BasicStroke(float, int, int);
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ServerRuntimeException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.rmi.ServerRuntimeExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class ServerRuntimeExceptionClassTest
implements ServerRuntimeExceptionClassTests<ServerRuntimeException> {

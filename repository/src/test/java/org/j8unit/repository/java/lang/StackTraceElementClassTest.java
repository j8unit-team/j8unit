...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link StackTraceElement} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.lang.StackTraceElementClassTests}).
 */
@RunWith(J8Unit4.class)
public class StackTraceElementClassTest
implements StackTraceElementClassTests<StackTraceElement> {

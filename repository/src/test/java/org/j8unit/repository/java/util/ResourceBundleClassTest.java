...
implements org.j8unit.repository.java.util.ResourceBundleClassTests<ResourceBundle> {
    ...
    @Override
    public Class<ResourceBundle> createNewSUT() {
        return ResourceBundle.class;
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link java.util.ResourceBundle#ResourceBundle()
    ...
    public void create_ResourceBundle()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public void test_getBundle_String_Locale_ClassLoader()
    throws Exception {
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.util.ResourceBundle#getBundle(String) public
     * static final java.util.ResourceBundle java.util.ResourceBundle.getBundle(java.lang.String)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
    ...
    @Test
    @Category(Draft.class)
    public void test_getBundle_String()
    throws Exception {
        // write some test for {@link java.util.ResourceBundle#getBundle(String)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.ResourceBundle#getBundle(String, java.util.ResourceBundle.Control) public static final
    ...
    @Test
    @Category(Draft.class)
    public void test_getBundle_String_Control()
    throws Exception {
        // write some test for {@link java.util.ResourceBundle#getBundle(String, java.util.ResourceBundle.Control)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.util.ResourceBundle#getBundle(String, java.util.Locale) public static final java.util.ResourceBundle
    ...
    @Test
    @Category(Draft.class)
    public void test_getBundle_String_Locale()
    throws Exception {
    ...
    implements org.j8unit.repository.java.util.ResourceBundleClassTests.ControlClassTests<Control> {
         ...
         * <p>
         * Test method for the hereby targeted method-under-test
         * {@link java.util.ResourceBundle.Control#getControl(java.util.List) public static final
        ...
        @Test
        @Category(Draft.class)
        public void test_getControl_List()
        throws Exception {
            // write some test for {@link java.util.ResourceBundle.Control#getControl(java.util.List)}
        }

        /**
         * <p>
         * Test method for the hereby targeted method-under-test
         * {@link java.util.ResourceBundle.Control#getNoFallbackControl(java.util.List) public static final
        ...
        @Test
        @Category(Draft.class)
        public void test_getNoFallbackControl_List()
        throws Exception {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JapaneseEra} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.time.chrono.JapaneseEraClassTests}).
 */
@RunWith(J8Unit4.class)
public class JapaneseEraClassTest
implements JapaneseEraClassTests<JapaneseEra> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.JapaneseEra]

    @Override
    public Class<JapaneseEra> createNewSUT() {
        return JapaneseEra.class;
    }

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link InterfaceAddress} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.net.InterfaceAddressTests}).
 */
@RunWith(J8Unit4.class)
public class InterfaceAddressTest
implements InterfaceAddressTests<InterfaceAddress> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UnresolvedPermission} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.security.UnresolvedPermissionClassTests}).
 */

@RunWith(J8Unit4.class)
public class UnresolvedPermissionClassTest
implements UnresolvedPermissionClassTests<UnresolvedPermission> {

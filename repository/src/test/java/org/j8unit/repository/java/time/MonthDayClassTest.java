...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MonthDay} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.java.time.MonthDayClassTests}).
 */

@RunWith(J8Unit4.class)
public class MonthDayClassTest
implements MonthDayClassTests<MonthDay> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.MonthDay]

    @Override
    public Class<MonthDay> createNewSUT() {
    ...
    throws Exception {
        // write some test for {@link java.time.MonthDay#now()}
    }
     ...
     * {@link java.time.MonthDay#parse(CharSequence, java.time.format.DateTimeFormatter) public static
    ...
    throws Exception {
        // write some test for {@link java.time.MonthDay#parse(CharSequence, java.time.format.DateTimeFormatter)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.time.MonthDay#parse(CharSequence) public static
    ...
    throws Exception {
        // write some test for {@link java.time.MonthDay#parse(CharSequence)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link java.time.MonthDay#from(java.time.temporal.TemporalAccessor) public static java.time.MonthDay

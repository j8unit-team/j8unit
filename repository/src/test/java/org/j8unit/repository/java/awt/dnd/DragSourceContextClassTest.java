...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DragSourceContext} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.dnd.DragSourceContextClassTests}).
 */

@RunWith(J8Unit4.class)
public class DragSourceContextClassTest
implements DragSourceContextClassTests<DragSourceContext> {

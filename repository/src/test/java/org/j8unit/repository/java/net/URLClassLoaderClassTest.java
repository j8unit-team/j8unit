...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link URLClassLoader} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.net.URLClassLoaderClassTests}).
 */
@RunWith(J8Unit4.class)
public class URLClassLoaderClassTest
implements URLClassLoaderClassTests<URLClassLoader> {

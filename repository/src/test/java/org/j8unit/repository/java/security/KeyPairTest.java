...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link KeyPair} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.security.KeyPairTests}).
 */

@RunWith(J8Unit4.class)
public class KeyPairTest
implements KeyPairTests<KeyPair> {

...
public class InputMethodEventClassTest
implements org.j8unit.repository.java.awt.event.InputMethodEventClassTests<InputMethodEvent> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.event.InputMethodEvent]

    @Override
    public Class<InputMethodEvent> createNewSUT() {
        return InputMethodEvent.class;
    }
    ...
    public void create_InputMethodEvent_Component_int_long_AttributedCharacterIterator_int_TextHitInfo_TextHitInfo()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_InputMethodEvent_Component_int_AttributedCharacterIterator_int_TextHitInfo_TextHitInfo()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

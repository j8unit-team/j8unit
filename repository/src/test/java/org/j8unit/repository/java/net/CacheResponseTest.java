...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CacheResponse} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.net.CacheResponseTests}).
 */

@RunWith(J8Unit4.class)
public class CacheResponseTest
implements CacheResponseTests<CacheResponse> {

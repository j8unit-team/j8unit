...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ECGenParameterSpec} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.security.spec.ECGenParameterSpecClassTests}).
 */
@RunWith(J8Unit4.class)
public class ECGenParameterSpecClassTest
implements ECGenParameterSpecClassTests<ECGenParameterSpec> {

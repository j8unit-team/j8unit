...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RuleBasedCollator} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.text.RuleBasedCollatorClassTests}).
 */
@RunWith(J8Unit4.class)
public class RuleBasedCollatorClassTest
implements RuleBasedCollatorClassTests<RuleBasedCollator> {

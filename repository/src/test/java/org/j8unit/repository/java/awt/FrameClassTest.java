...
implements org.j8unit.repository.java.awt.FrameClassTests<Frame> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Frame]

    @Override
    public Class<Frame> createNewSUT() {
        return Frame.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_Frame_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Frame sut = null; // = new Frame(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_Frame_GraphicsConfiguration()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

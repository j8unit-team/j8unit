 ...
 * {@link org.j8unit.repository.java.security.cert.CertificateEncodingExceptionClassTests}).
 */
...
implements CertificateEncodingExceptionClassTests<CertificateEncodingException> {
    ...
    public void create_CertificateEncodingException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final CertificateEncodingException sut = null; // = new CertificateEncodingException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_CertificateEncodingException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final CertificateEncodingException sut = null; // = new CertificateEncodingException(String, Throwable);
    }

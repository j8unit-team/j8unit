...
implements FactoryBasedJ8UnitTest<ClosedChannelException>, ClosedChannelExceptionTests<ClosedChannelException> {
    ...
    public static Iterable<? extends Object> sutData() {
        return testParametersOf(ClosedChannelException::new);
    }

    @Parameter(0)
    public Callable<ClosedChannelException> sutFactory;

    @Override
    public Callable<ClosedChannelException> getSUTFactory() {
        return this.sutFactory;
    }

    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[java.nio.channels.ClosedChannelException]

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PropertyChangeListenerProxy} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.beans.PropertyChangeListenerProxyClassTests}).
 */

@RunWith(J8Unit4.class)
public class PropertyChangeListenerProxyClassTest
implements PropertyChangeListenerProxyClassTests<PropertyChangeListenerProxy> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link FileSystemException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.java.nio.file.FileSystemExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class FileSystemExceptionClassTest
implements FileSystemExceptionClassTests<FileSystemException> {
     ...
     * {@link java.nio.file.FileSystemException#FileSystemException(String) public
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link java.nio.file.FileSystemException#FileSystemException(String, String, String) public

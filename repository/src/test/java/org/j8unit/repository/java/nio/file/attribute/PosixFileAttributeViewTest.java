...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link PosixFileAttributeView} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.java.nio.file.attribute.PosixFileAttributeViewTests}).
 */

@RunWith(J8Unit4.class)
public class PosixFileAttributeViewTest
implements PosixFileAttributeViewTests<PosixFileAttributeView> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link LockSupport} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.util.concurrent.locks.LockSupportClassTests}).
 */

@RunWith(J8Unit4.class)
public class LockSupportClassTest
implements LockSupportClassTests<LockSupport> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.concurrent.locks.LockSupport]

    @Override
    public Class<LockSupport> createNewSUT() {
        return LockSupport.class;
    }

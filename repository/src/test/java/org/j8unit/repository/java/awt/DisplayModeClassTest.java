...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DisplayMode} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.DisplayModeClassTests}).
 */
@RunWith(J8Unit4.class)
public class DisplayModeClassTest
implements DisplayModeClassTests<DisplayMode> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DropTargetEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.java.awt.dnd.DropTargetEventClassTests}).
 */
@RunWith(J8Unit4.class)
public class DropTargetEventClassTest
implements DropTargetEventClassTests<DropTargetEvent> {

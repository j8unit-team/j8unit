...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CannotProceedHelper} (by simply reusing
 * the J8Unit test interface {@link CannotProceedHelperClassTests}).
 */
...
implements CannotProceedHelperClassTests<CannotProceedHelper> {
    ...
    @Override
    public Class<CannotProceedHelper> createNewSUT() {
        return CannotProceedHelper.class;
    }
    ...
    public void create_CannotProceedHelper()
    throws Exception {

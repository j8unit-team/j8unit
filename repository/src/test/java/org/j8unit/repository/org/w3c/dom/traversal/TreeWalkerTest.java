...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link TreeWalker} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.w3c.dom.traversal.TreeWalkerTests}).
 */

@RunWith(J8Unit4.class)
public class TreeWalkerTest
implements TreeWalkerTests<TreeWalker> {

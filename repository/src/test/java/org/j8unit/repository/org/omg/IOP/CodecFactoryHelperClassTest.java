...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link CodecFactoryHelper} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.org.omg.IOP.CodecFactoryHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class CodecFactoryHelperClassTest
implements CodecFactoryHelperClassTests<CodecFactoryHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.IOP.CodecFactoryHelper]

    @Override
    public Class<CodecFactoryHelper> createNewSUT() {
        return CodecFactoryHelper.class;
    }
    ...
    public void create_CodecFactoryHelper()
    throws Exception {

 ...
 * J8Unit test interface {@link org.j8unit.repository.org.omg.PortableInterceptor.DISCARDINGTests}).
 */
...
implements DISCARDINGTests<DISCARDING> {
    ...
    @Override
    public DISCARDING createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.PortableInterceptor.DISCARDING], j8unit does not support a generic way to provide instances.");
    }

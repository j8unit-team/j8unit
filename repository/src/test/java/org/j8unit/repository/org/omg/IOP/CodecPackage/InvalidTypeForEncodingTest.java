...
implements FactoryBasedJ8UnitTest<InvalidTypeForEncoding>, org.j8unit.repository.org.omg.IOP.CodecPackage.InvalidTypeForEncodingTests<InvalidTypeForEncoding> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(InvalidTypeForEncoding::new);
    }

    @Parameter(0)
    public Callable<InvalidTypeForEncoding> sutFactory;

    @Override
    public Callable<InvalidTypeForEncoding> getSUTFactory() {

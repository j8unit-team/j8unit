...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NamingContextPOA} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CosNaming.NamingContextPOAClassTests}).
 */
@RunWith(J8Unit4.class)
public class NamingContextPOAClassTest
implements NamingContextPOAClassTests<NamingContextPOA> {

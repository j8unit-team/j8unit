...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link WrongPolicy} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.PortableServer.POAPackage.WrongPolicyClassTests}).
 */
@RunWith(J8Unit4.class)
public class WrongPolicyClassTest
implements WrongPolicyClassTests<WrongPolicy> {

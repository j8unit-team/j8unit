...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ORBInitializer} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.org.omg.PortableInterceptor.ORBInitializerTests}).
 */

@RunWith(J8Unit4.class)
public class ORBInitializerTest
implements ORBInitializerTests<ORBInitializer> {

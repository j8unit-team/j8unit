...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link VM_NONE} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.org.omg.CORBA.VM_NONEClassTests}).
 */

@RunWith(J8Unit4.class)
public class VM_NONEClassTest
implements VM_NONEClassTests<VM_NONE> {

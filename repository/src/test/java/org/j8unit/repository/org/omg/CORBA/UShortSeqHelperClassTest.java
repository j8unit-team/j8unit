...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UShortSeqHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.UShortSeqHelperClassTests}).
 */

@RunWith(J8Unit4.class)
public class UShortSeqHelperClassTest
implements UShortSeqHelperClassTests<UShortSeqHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.UShortSeqHelper]

    @Override
    public Class<UShortSeqHelper> createNewSUT() {
        return UShortSeqHelper.class;
    }
    ...
    public void create_UShortSeqHelper()
    throws Exception {

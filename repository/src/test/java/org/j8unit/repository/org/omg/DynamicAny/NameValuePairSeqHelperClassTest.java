 ...
 * reusing the J8Unit test interface {@link org.j8unit.repository.org.omg.DynamicAny.NameValuePairSeqHelperClassTests}).
 */
...
implements NameValuePairSeqHelperClassTests<NameValuePairSeqHelper> {
    ...
    @Override
    public Class<NameValuePairSeqHelper> createNewSUT() {
        return NameValuePairSeqHelper.class;
    }
    ...
    public void create_NameValuePairSeqHelper()
    throws Exception {

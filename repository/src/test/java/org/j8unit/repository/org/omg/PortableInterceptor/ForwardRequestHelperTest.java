...
implements org.j8unit.repository.org.omg.PortableInterceptor.ForwardRequestHelperTests<ForwardRequestHelper> {

    // J8UNIT-MARKER-[BEGIN]-[INSTANCE]-[org.omg.PortableInterceptor.ForwardRequestHelper]

    @Override
    public ForwardRequestHelper createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.PortableInterceptor.ForwardRequestHelper], j8unit does not support a generic way to provide instances.");
    }

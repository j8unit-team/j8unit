...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AdapterManagerIdHelper} (by simply
 * reusing the J8Unit test interface {@link AdapterManagerIdHelperClassTests}).
 */
...
implements AdapterManagerIdHelperClassTests<AdapterManagerIdHelper> {
    ...
    @Override
    public Class<AdapterManagerIdHelper> createNewSUT() {
        return AdapterManagerIdHelper.class;
    }
    ...
    public void create_AdapterManagerIdHelper()
    throws Exception {

...
implements org.j8unit.repository.org.omg.CORBA.BAD_PARAMClassTests<BAD_PARAM> {
     ...
     * {@link BAD_PARAM#BAD_PARAM(String, int, CompletionStatus) public
    ...
    throws Exception {
        ...
        final BAD_PARAM sut = null; // = new BAD_PARAM(String, int, CompletionStatus);
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link BAD_PARAM#BAD_PARAM(int, CompletionStatus)
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BAD_PARAM sut = null; // = new BAD_PARAM(int, CompletionStatus);
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link BAD_PARAM#BAD_PARAM(String) public
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link BAD_PARAM#BAD_PARAM() public

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NoServantHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.PortableServer.POAPackage.NoServantHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class NoServantHelperClassTest
implements NoServantHelperClassTests<NoServantHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.POAPackage.NoServantHelper]

    @Override
    public Class<NoServantHelper> createNewSUT() {
        return NoServantHelper.class;
    }
    ...
    public void create_NoServantHelper()
    throws Exception {

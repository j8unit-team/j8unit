...
implements TRANSACTION_REQUIREDClassTests<TRANSACTION_REQUIRED> {
    ...
    @Override
    public Class<TRANSACTION_REQUIRED> createNewSUT() {
    ...
    public void create_TRANSACTION_REQUIRED_String_int_CompletionStatus()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_TRANSACTION_REQUIRED_int_CompletionStatus()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_TRANSACTION_REQUIRED_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final TRANSACTION_REQUIRED sut = null; // = new TRANSACTION_REQUIRED(String);
    }

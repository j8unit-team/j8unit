...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ObjectHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.ObjectHelperClassTests}).
 */

@RunWith(J8Unit4.class)
public class ObjectHelperClassTest
implements ObjectHelperClassTests<ObjectHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.ObjectHelper]

    @Override
    public Class<ObjectHelper> createNewSUT() {
    ...
    public void create_ObjectHelper()
    throws Exception {

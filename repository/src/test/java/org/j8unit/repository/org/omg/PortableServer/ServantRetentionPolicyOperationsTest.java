...
implements ServantRetentionPolicyOperationsTests<ServantRetentionPolicyOperations> {
    ...
    @Override
    public ServantRetentionPolicyOperations createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.PortableServer.ServantRetentionPolicyOperations], j8unit does not support a generic way to provide instances.");
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ClientRequestInterceptorOperations} (by
 * simply reusing the J8Unit test interface {@link ClientRequestInterceptorOperationsClassTests}).
 */
...
implements ClientRequestInterceptorOperationsClassTests<ClientRequestInterceptorOperations> {
    ...
    @Override
    public Class<ClientRequestInterceptorOperations> createNewSUT() {

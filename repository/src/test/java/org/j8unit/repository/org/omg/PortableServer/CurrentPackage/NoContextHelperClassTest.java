...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NoContextHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.PortableServer.CurrentPackage.NoContextHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class NoContextHelperClassTest
implements NoContextHelperClassTests<NoContextHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.CurrentPackage.NoContextHelper]

    @Override
    public Class<NoContextHelper> createNewSUT() {
        return NoContextHelper.class;
    }
    ...
    public void create_NoContextHelper()
    throws Exception {

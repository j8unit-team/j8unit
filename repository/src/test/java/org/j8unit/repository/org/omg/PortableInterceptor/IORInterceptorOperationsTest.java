...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link IORInterceptorOperations} (by simply
 * reusing the J8Unit test interface {@link IORInterceptorOperationsTests}).
 */

@RunWith(J8Unit4.class)
public class IORInterceptorOperationsTest
implements IORInterceptorOperationsTests<IORInterceptorOperations> {
    ...
    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[org.omg.PortableInterceptor.IORInterceptorOperations]

    // J8UNIT-MARKER-[END]-[INSTANCE]-[org.omg.PortableInterceptor.IORInterceptorOperations]

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link InvalidSlotHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.PortableInterceptor.InvalidSlotHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class InvalidSlotHelperClassTest
implements InvalidSlotHelperClassTests<InvalidSlotHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableInterceptor.InvalidSlotHelper]

    @Override
    public Class<InvalidSlotHelper> createNewSUT() {
        return InvalidSlotHelper.class;
    }
    ...
    public void create_InvalidSlotHelper()
    throws Exception {
     ...
     * org.omg.PortableInterceptor.InvalidSlotHelper.extract(org.omg.CORBA.Any)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.

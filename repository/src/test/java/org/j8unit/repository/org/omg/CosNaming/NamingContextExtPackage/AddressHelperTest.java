...
implements AddressHelperTests<AddressHelper> {
    ...
    @Override
    public AddressHelper createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.CosNaming.NamingContextExtPackage.AddressHelper], j8unit does not support a generic way to provide instances.");
    }

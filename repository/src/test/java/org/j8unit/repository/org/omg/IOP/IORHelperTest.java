...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link IORHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.IOP.IORHelperTests}).
 */
@RunWith(J8Unit4.class)
public class IORHelperTest
implements IORHelperTests<IORHelper> {

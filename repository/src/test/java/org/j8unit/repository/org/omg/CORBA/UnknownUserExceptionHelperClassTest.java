...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UnknownUserExceptionHelper} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.UnknownUserExceptionHelperClassTests}).
 */

@RunWith(J8Unit4.class)
public class UnknownUserExceptionHelperClassTest
implements UnknownUserExceptionHelperClassTests<UnknownUserExceptionHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.UnknownUserExceptionHelper]

    @Override
    public Class<UnknownUserExceptionHelper> createNewSUT() {
        return UnknownUserExceptionHelper.class;
    }
    ...
    public void create_UnknownUserExceptionHelper()
    throws Exception {

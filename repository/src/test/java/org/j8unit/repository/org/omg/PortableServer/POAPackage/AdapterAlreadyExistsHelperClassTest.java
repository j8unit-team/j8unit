...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AdapterAlreadyExistsHelper} (by simply
...
implements AdapterAlreadyExistsHelperClassTests<AdapterAlreadyExistsHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.POAPackage.AdapterAlreadyExistsHelper]

    @Override
    public Class<AdapterAlreadyExistsHelper> createNewSUT() {
        return AdapterAlreadyExistsHelper.class;
    }
    ...
    public void create_AdapterAlreadyExistsHelper()
    throws Exception {

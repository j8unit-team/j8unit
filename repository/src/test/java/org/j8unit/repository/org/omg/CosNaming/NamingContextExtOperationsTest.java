...
implements NamingContextExtOperationsTests<NamingContextExtOperations> {
    ...
    @Override
    public NamingContextExtOperations createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.CosNaming.NamingContextExtOperations], j8unit does not support a generic way to provide instances.");
    }

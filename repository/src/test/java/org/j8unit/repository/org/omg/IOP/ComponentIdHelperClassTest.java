...
implements org.j8unit.repository.org.omg.IOP.ComponentIdHelperClassTests<ComponentIdHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.IOP.ComponentIdHelper]

    @Override
    public Class<ComponentIdHelper> createNewSUT() {
        return ComponentIdHelper.class;
    }
    ...
    public void create_ComponentIdHelper()
    throws Exception {

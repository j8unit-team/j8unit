...
implements org.j8unit.repository.org.omg.CORBA_2_3.portable.InputStreamTests<InputStream> {
    ...
    public InputStream createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.CORBA_2_3.portable.InputStream], j8unit does not support a generic way to provide instances.");
    }

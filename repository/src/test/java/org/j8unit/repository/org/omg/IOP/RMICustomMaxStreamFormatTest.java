 ...
 * reusing the J8Unit test interface {@link org.j8unit.repository.org.omg.IOP.RMICustomMaxStreamFormatTests}).
 */
...
implements RMICustomMaxStreamFormatTests<RMICustomMaxStreamFormat> {
    ...
    @Override
    public RMICustomMaxStreamFormat createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.IOP.RMICustomMaxStreamFormat], j8unit does not support a generic way to provide instances.");
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ServiceDetailHelper} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.ServiceDetailHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class ServiceDetailHelperClassTest
implements ServiceDetailHelperClassTests<ServiceDetailHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.ServiceDetailHelper]

    @Override
    public Class<ServiceDetailHelper> createNewSUT() {
        return ServiceDetailHelper.class;
    }
    ...
    public void create_ServiceDetailHelper()
    throws Exception {

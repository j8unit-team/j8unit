...
implements ObjectReferenceTemplateHolderClassTests<ObjectReferenceTemplateHolder> {
    ...
    @Override
    public Class<ObjectReferenceTemplateHolder> createNewSUT() {
        return ObjectReferenceTemplateHolder.class;
    }
    ...
    public void create_ObjectReferenceTemplateHolder_ObjectReferenceTemplate()
    throws Exception {
        // create new instance

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ObjectReferenceTemplateSeqHelper} (by
 * simply reusing the J8Unit test interface {@link ObjectReferenceTemplateSeqHelperClassTests}).
 */
...
implements ObjectReferenceTemplateSeqHelperClassTests<ObjectReferenceTemplateSeqHelper> {
    ...
    @Override
    public Class<ObjectReferenceTemplateSeqHelper> createNewSUT() {
        return ObjectReferenceTemplateSeqHelper.class;
    }
    ...
    public void create_ObjectReferenceTemplateSeqHelper()
    throws Exception {

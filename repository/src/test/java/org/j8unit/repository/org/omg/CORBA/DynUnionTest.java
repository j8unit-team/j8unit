 ...
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.DynUnionTests}).
 */

@RunWith(J8Unit4.class)
public class DynUnionTest
implements org.j8unit.repository.org.omg.CORBA.DynUnionTests<DynUnion> {

    // J8UNIT-MARKER-[BEGIN]-[INSTANCE]-[org.omg.CORBA.DynUnion]

    @Override
    public DynUnion createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.omg.CORBA.DynUnion], j8unit does not support a generic way to provide instances.");
    }

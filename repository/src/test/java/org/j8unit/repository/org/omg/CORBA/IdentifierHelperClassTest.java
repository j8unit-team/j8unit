...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link IdentifierHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.IdentifierHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class IdentifierHelperClassTest
implements IdentifierHelperClassTests<IdentifierHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.IdentifierHelper]

    @Override
    public Class<IdentifierHelper> createNewSUT() {
        return IdentifierHelper.class;
    }
    ...
    public void create_IdentifierHelper()
    throws Exception {

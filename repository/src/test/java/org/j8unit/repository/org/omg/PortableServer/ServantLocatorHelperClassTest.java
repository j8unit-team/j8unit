...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ServantLocatorHelper} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.org.omg.PortableServer.ServantLocatorHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class ServantLocatorHelperClassTest
implements ServantLocatorHelperClassTests<ServantLocatorHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.ServantLocatorHelper]

    @Override
    public Class<ServantLocatorHelper> createNewSUT() {
        return ServantLocatorHelper.class;
    }
    ...
    public void create_ServantLocatorHelper()
    throws Exception {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link DynArrayOperations} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.org.omg.DynamicAny.DynArrayOperationsTests}).
 */

@RunWith(J8Unit4.class)
public class DynArrayOperationsTest
implements DynArrayOperationsTests<DynArrayOperations> {

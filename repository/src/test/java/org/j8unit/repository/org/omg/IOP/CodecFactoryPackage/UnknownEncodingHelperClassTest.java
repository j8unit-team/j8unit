...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UnknownEncodingHelper} (by simply reusing
 * the J8Unit test interface {@link UnknownEncodingHelperClassTests}).
 */
...
implements UnknownEncodingHelperClassTests<UnknownEncodingHelper> {
    ...
    @Override
    public Class<UnknownEncodingHelper> createNewSUT() {
        return UnknownEncodingHelper.class;
    }
    ...
    public void create_UnknownEncodingHelper()
    throws Exception {

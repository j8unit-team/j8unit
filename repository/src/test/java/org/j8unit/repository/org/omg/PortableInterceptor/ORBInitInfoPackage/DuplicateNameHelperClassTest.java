...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DuplicateNameHelper} (by simply reusing
 * the J8Unit test interface
 * {@link org.j8unit.repository.org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateNameHelperClassTests}).
 */

@RunWith(J8Unit4.class)
public class DuplicateNameHelperClassTest
implements DuplicateNameHelperClassTests<DuplicateNameHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateNameHelper]

    @Override
    public Class<DuplicateNameHelper> createNewSUT() {
        return DuplicateNameHelper.class;
    }
    ...
    public void create_DuplicateNameHelper()
    throws Exception {

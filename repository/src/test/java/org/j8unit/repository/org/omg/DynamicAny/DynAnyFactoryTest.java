...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link DynAnyFactory} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.DynamicAny.DynAnyFactoryTests}).
 */

@RunWith(J8Unit4.class)
public class DynAnyFactoryTest
implements DynAnyFactoryTests<DynAnyFactory> {

...
implements FactoryBasedJ8UnitTest<WrongAdapter>, org.j8unit.repository.org.omg.PortableServer.POAPackage.WrongAdapterTests<WrongAdapter> {
    ...
    @Parameter(0)
    public Callable<WrongAdapter> sutFactory;

    @Override
    public Callable<WrongAdapter> getSUTFactory() {
        return this.sutFactory;
    }

    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[org.omg.PortableServer.POAPackage.WrongAdapter]

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TIMEOUT} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.org.omg.CORBA.TIMEOUTClassTests}).
 */

@RunWith(J8Unit4.class)
public class TIMEOUTClassTest
implements TIMEOUTClassTests<TIMEOUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.TIMEOUT]

    @Override
    public Class<TIMEOUT> createNewSUT() {
    ...
    public void create_TIMEOUT_String_int_CompletionStatus()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_TIMEOUT_int_CompletionStatus()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_TIMEOUT_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final TIMEOUT sut = null; // = new TIMEOUT(String);
    }

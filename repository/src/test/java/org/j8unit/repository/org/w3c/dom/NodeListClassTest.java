...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NodeList} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.org.w3c.dom.NodeListClassTests}).
 */
@RunWith(J8Unit4.class)
public class NodeListClassTest
implements NodeListClassTests<NodeList> {

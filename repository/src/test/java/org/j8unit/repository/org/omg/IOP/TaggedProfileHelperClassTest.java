...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TaggedProfileHelper} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.org.omg.IOP.TaggedProfileHelperClassTests}).
 */

@RunWith(J8Unit4.class)
public class TaggedProfileHelperClassTest
implements TaggedProfileHelperClassTests<TaggedProfileHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.IOP.TaggedProfileHelper]

    @Override
    public Class<TaggedProfileHelper> createNewSUT() {
        return TaggedProfileHelper.class;
    }
    ...
    public void create_TaggedProfileHelper()
    throws Exception {

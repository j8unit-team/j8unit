...
implements FactoryBasedJ8UnitTest<TRANSACTION_REQUIRED>, TRANSACTION_REQUIREDTests<TRANSACTION_REQUIRED> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(TRANSACTION_REQUIRED::new);
    }

    @Parameter(0)
    public Callable<TRANSACTION_REQUIRED> sutFactory;

    @Override
    public Callable<TRANSACTION_REQUIRED> getSUTFactory() {
        return this.sutFactory;
    }

    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[org.omg.CORBA.TRANSACTION_REQUIRED]

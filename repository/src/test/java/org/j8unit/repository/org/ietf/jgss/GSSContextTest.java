...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link GSSContext} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.ietf.jgss.GSSContextTests}).
 */

@RunWith(J8Unit4.class)
public class GSSContextTest
implements GSSContextTests<GSSContext> {

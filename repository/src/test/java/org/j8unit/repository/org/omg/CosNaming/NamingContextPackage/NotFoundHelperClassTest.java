...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NotFoundHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CosNaming.NamingContextPackage.NotFoundHelperClassTests}).
 */

@RunWith(J8Unit4.class)
public class NotFoundHelperClassTest
implements NotFoundHelperClassTests<NotFoundHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CosNaming.NamingContextPackage.NotFoundHelper]

    @Override
    public Class<NotFoundHelper> createNewSUT() {
        return NotFoundHelper.class;
    }
    ...
    public void create_NotFoundHelper()
    throws Exception {
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CosNaming.NamingContextPackage.NotFoundHelper]

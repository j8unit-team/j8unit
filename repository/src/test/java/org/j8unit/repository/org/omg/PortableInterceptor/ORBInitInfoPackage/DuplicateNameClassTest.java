...
implements DuplicateNameClassTests<DuplicateName> {
    ...
    @Override
    public Class<DuplicateName> createNewSUT() {
        return DuplicateName.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_DuplicateName_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DuplicateName sut = null; // = new DuplicateName(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_DuplicateName_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

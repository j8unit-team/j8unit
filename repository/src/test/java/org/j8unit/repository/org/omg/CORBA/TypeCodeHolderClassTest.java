...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TypeCodeHolder} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.TypeCodeHolderClassTests}).
 */
@RunWith(J8Unit4.class)
public class TypeCodeHolderClassTest
implements TypeCodeHolderClassTests<TypeCodeHolder> {

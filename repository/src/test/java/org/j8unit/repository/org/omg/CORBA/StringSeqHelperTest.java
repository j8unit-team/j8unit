...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link StringSeqHelper} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.StringSeqHelperTests}).
 */
@RunWith(J8Unit4.class)
public class StringSeqHelperTest
implements StringSeqHelperTests<StringSeqHelper> {

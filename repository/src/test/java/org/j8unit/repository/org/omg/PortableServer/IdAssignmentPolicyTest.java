...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link IdAssignmentPolicy} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.org.omg.PortableServer.IdAssignmentPolicyTests}).
 */

@RunWith(J8Unit4.class)
public class IdAssignmentPolicyTest
implements IdAssignmentPolicyTests<IdAssignmentPolicy> {

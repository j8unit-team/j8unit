...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BAD_QOS} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.org.omg.CORBA.BAD_QOSClassTests}).
 */

@RunWith(J8Unit4.class)
public class BAD_QOSClassTest
implements BAD_QOSClassTests<BAD_QOS> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.BAD_QOS]

    @Override
    public Class<BAD_QOS> createNewSUT() {
        return BAD_QOS.class;
    }
    ...
    public void create_BAD_QOS_String_int_CompletionStatus()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_BAD_QOS_int_CompletionStatus()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_BAD_QOS_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BAD_QOS sut = null; // = new BAD_QOS(String);
    }

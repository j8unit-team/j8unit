...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link WCharSeqHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.WCharSeqHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class WCharSeqHelperClassTest
implements WCharSeqHelperClassTests<WCharSeqHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.WCharSeqHelper]

    @Override
    public Class<WCharSeqHelper> createNewSUT() {
        return WCharSeqHelper.class;
    }
    ...
    public void create_WCharSeqHelper()
    throws Exception {
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.WCharSeqHelper]

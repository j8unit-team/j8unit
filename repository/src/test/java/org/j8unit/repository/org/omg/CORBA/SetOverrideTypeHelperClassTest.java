...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SetOverrideTypeHelper} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.org.omg.CORBA.SetOverrideTypeHelperClassTests}).
 */
@RunWith(J8Unit4.class)
public class SetOverrideTypeHelperClassTest
implements SetOverrideTypeHelperClassTests<SetOverrideTypeHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.SetOverrideTypeHelper]

    @Override
    public Class<SetOverrideTypeHelper> createNewSUT() {
        return SetOverrideTypeHelper.class;
    }
    ...
    public void create_SetOverrideTypeHelper()
    throws Exception {

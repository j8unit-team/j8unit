 ...
 * reusing the J8Unit test interface {@link org.j8unit.repository.org.w3c.dom.css.DOMImplementationCSSTests}).
 */
...
implements DOMImplementationCSSTests<DOMImplementationCSS> {
    ...
    @Override
    public DOMImplementationCSS createNewSUT() {
        throw new AssumptionViolatedException("Due to the abstract modifier of this type-under-test [org.w3c.dom.css.DOMImplementationCSS], j8unit does not support a generic way to provide instances.");
    }

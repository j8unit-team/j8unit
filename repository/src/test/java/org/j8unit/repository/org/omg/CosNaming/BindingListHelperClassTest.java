...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BindingListHelper} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.org.omg.CosNaming.BindingListHelperClassTests}).
 */

@RunWith(J8Unit4.class)
public class BindingListHelperClassTest
implements BindingListHelperClassTests<BindingListHelper> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CosNaming.BindingListHelper]

    @Override
    public Class<BindingListHelper> createNewSUT() {
        return BindingListHelper.class;
    }
    ...
    public void create_BindingListHelper()
    throws Exception {

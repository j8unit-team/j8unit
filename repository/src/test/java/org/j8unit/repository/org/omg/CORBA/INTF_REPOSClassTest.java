 ...
 * test interface {@link org.j8unit.repository.org.omg.CORBA.INTF_REPOSClassTests}).
 */
...
implements INTF_REPOSClassTests<INTF_REPOS> {
    ...
    @Override
    public Class<INTF_REPOS> createNewSUT() {
    ...
    public void create_INTF_REPOS_String_int_CompletionStatus()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_INTF_REPOS_int_CompletionStatus()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_INTF_REPOS_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final INTF_REPOS sut = null; // = new INTF_REPOS(String);
    }

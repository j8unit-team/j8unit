...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link Patch} (by simply reusing the J8Unit test
 * interface {@link org.j8unit.repository.javax.sound.midi.PatchClassTests}).
 */
@RunWith(J8Unit4.class)
public class PatchClassTest
implements PatchClassTests<Patch> {

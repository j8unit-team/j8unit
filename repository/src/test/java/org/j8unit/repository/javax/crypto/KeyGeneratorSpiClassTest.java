...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KeyGeneratorSpi} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.crypto.KeyGeneratorSpiClassTests}).
 */

@RunWith(J8Unit4.class)
public class KeyGeneratorSpiClassTest
implements KeyGeneratorSpiClassTests<KeyGeneratorSpi> {

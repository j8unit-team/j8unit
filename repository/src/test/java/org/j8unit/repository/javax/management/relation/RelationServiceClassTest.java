...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RelationService} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.relation.RelationServiceClassTests}).
 */

@RunWith(J8Unit4.class)
public class RelationServiceClassTest
implements RelationServiceClassTests<RelationService> {

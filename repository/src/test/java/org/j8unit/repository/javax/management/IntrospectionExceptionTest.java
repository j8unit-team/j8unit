...
implements FactoryBasedJ8UnitTest<IntrospectionException>, IntrospectionExceptionTests<IntrospectionException> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(IntrospectionException::new);
    }

    @Parameter(0)
    public Callable<IntrospectionException> sutFactory;

    @Override
    public Callable<IntrospectionException> getSUTFactory() {

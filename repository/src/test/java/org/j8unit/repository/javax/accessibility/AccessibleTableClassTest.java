...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AccessibleTable} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.accessibility.AccessibleTableClassTests}).
 */
@RunWith(J8Unit4.class)
public class AccessibleTableClassTest
implements AccessibleTableClassTests<AccessibleTable> {

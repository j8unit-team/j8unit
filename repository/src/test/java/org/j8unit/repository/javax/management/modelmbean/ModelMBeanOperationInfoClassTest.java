...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ModelMBeanOperationInfo} (by simply
 * reusing the J8Unit test interface
 * {@link org.j8unit.repository.javax.management.modelmbean.ModelMBeanOperationInfoClassTests}).
 */
@RunWith(J8Unit4.class)
public class ModelMBeanOperationInfoClassTest
implements ModelMBeanOperationInfoClassTests<ModelMBeanOperationInfo> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.modelmbean.ModelMBeanOperationInfo]

    @Override
    public Class<ModelMBeanOperationInfo> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanOperationInfo_ModelMBeanOperationInfo()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanOperationInfo_String_String_MBeanParameterInfoArray_String_int_Descriptor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanOperationInfo_String_String_MBeanParameterInfoArray_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ModelMBeanOperationInfo sut = null; // = new ModelMBeanOperationInfo(String, String,
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanOperationInfo_String_Method_Descriptor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ModelMBeanOperationInfo sut = null; // = new ModelMBeanOperationInfo(String, java.lang.reflect.Method,

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link DocAttribute} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.print.attribute.DocAttributeTests}).
 */
@RunWith(J8Unit4.class)
public class DocAttributeTest
implements DocAttributeTests<DocAttribute> {

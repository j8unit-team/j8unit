...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link UndoableEditEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.event.UndoableEditEventClassTests}).
 */
@RunWith(J8Unit4.class)
public class UndoableEditEventClassTest
implements UndoableEditEventClassTests<UndoableEditEvent> {

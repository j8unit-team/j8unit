...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AttributeSetUtilities} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.print.attribute.AttributeSetUtilitiesClassTests}).
 */

@RunWith(J8Unit4.class)
public class AttributeSetUtilitiesClassTest
implements AttributeSetUtilitiesClassTests<AttributeSetUtilities> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.AttributeSetUtilities]

    @Override
    public Class<AttributeSetUtilities> createNewSUT() {
        return AttributeSetUtilities.class;
    }

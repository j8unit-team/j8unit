...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ComponentUI} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.plaf.ComponentUIClassTests}).
 */

@RunWith(J8Unit4.class)
public class ComponentUIClassTest
implements ComponentUIClassTests<ComponentUI> {

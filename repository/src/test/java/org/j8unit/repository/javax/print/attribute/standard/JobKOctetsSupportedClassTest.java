...
implements JobKOctetsSupportedClassTests<JobKOctetsSupported> {
    ...
    /**
     * @see JobKOctetsSupportedClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        JobKOctetsSupportedClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

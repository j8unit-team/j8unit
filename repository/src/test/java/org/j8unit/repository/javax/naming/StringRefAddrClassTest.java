...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link StringRefAddr} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.naming.StringRefAddrClassTests}).
 */

@RunWith(J8Unit4.class)
public class StringRefAddrClassTest
implements StringRefAddrClassTests<StringRefAddr> {

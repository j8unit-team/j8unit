...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Cipher} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.crypto.CipherTests}).
 */

@RunWith(J8Unit4.class)
public class CipherTest
implements CipherTests<Cipher> {

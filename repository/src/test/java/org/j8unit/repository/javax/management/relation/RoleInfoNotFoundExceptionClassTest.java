...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RoleInfoNotFoundException} (by simply
 * reusing the J8Unit test interface
 * {@link org.j8unit.repository.javax.management.relation.RoleInfoNotFoundExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class RoleInfoNotFoundExceptionClassTest
implements RoleInfoNotFoundExceptionClassTests<RoleInfoNotFoundException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.relation.RoleInfoNotFoundException]

    @Override
    public Class<RoleInfoNotFoundException> createNewSUT() {
        return RoleInfoNotFoundException.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_RoleInfoNotFoundException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

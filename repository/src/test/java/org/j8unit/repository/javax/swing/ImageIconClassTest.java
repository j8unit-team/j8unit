...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ImageIcon} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.swing.ImageIconClassTests}).
 */

@RunWith(J8Unit4.class)
public class ImageIconClassTest
implements ImageIconClassTests<ImageIcon> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.ImageIcon]

    @Override
    public Class<ImageIcon> createNewSUT() {
    ...
    public void create_ImageIcon_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ImageIcon sut = null; // = new ImageIcon(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageIcon_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ImageIcon sut = null; // = new ImageIcon(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageIcon_URL_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageIcon_byteArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ImageIcon sut = null; // = new ImageIcon(byte[]);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageIcon_byteArray_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ImageIcon sut = null; // = new ImageIcon(byte[], String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageIcon_Image()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageIcon_Image_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageIcon_URL()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.ImageIcon]

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link RoleInfo} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.relation.RoleInfoTests}).
 */

@RunWith(J8Unit4.class)
public class RoleInfoTest
implements RoleInfoTests<RoleInfo> {

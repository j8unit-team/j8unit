...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PrintJobEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.print.event.PrintJobEventClassTests}).
 */
@RunWith(J8Unit4.class)
public class PrintJobEventClassTest
implements PrintJobEventClassTests<PrintJobEvent> {

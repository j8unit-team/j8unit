...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link TransformService} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.crypto.dsig.TransformServiceTests}).
 */

@RunWith(J8Unit4.class)
public class TransformServiceTest
implements TransformServiceTests<TransformService> {

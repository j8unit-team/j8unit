...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ConnectionEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.sql.ConnectionEventClassTests}).
 */

@RunWith(J8Unit4.class)
public class ConnectionEventClassTest
implements ConnectionEventClassTests<ConnectionEvent> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Destination} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.print.attribute.standard.DestinationTests}).
 */
@RunWith(J8Unit4.class)
public class DestinationTest
implements DestinationTests<Destination> {

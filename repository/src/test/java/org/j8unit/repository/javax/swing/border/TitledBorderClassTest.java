...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TitledBorder} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.border.TitledBorderClassTests}).
 */

@RunWith(J8Unit4.class)
public class TitledBorderClassTest
implements TitledBorderClassTests<TitledBorder> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.border.TitledBorder]

    @Override
    public Class<TitledBorder> createNewSUT() {
    ...
    public void create_TitledBorder_Border()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_TitledBorder_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final TitledBorder sut = null; // = new TitledBorder(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_TitledBorder_Border_String_int_int_Font_Color()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_TitledBorder_Border_String_int_int_Font()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_TitledBorder_Border_String_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final TitledBorder sut = null; // = new TitledBorder(javax.swing.border.Border, String, int, int);
    ...
    @Test
    @Category(Draft.class)
    public void create_TitledBorder_Border_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.border.TitledBorder]

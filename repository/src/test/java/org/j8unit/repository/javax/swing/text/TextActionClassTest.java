...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TextAction} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.swing.text.TextActionClassTests}).
 */

@RunWith(J8Unit4.class)
public class TextActionClassTest
implements TextActionClassTests<TextAction> {

...
implements FactoryBasedJ8UnitTest<SynthCheckBoxMenuItemUI>, SynthCheckBoxMenuItemUITests<SynthCheckBoxMenuItemUI> {
    ...
    public static Iterable<? extends Object> sutData() {
        return testParametersOf(SynthCheckBoxMenuItemUI::new);
    }

    @Parameter(0)
    public Callable<SynthCheckBoxMenuItemUI> sutFactory;

    @Override
    public Callable<SynthCheckBoxMenuItemUI> getSUTFactory() {

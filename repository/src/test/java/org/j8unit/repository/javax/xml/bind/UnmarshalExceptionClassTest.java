 ...
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.UnmarshalExceptionClassTests}).
 */
...
implements UnmarshalExceptionClassTests<UnmarshalException> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.UnmarshalException]
    ...
    public void create_UnmarshalException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final UnmarshalException sut = null; // = new UnmarshalException(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_UnmarshalException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final UnmarshalException sut = null; // = new UnmarshalException(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_UnmarshalException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final UnmarshalException sut = null; // = new UnmarshalException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_UnmarshalException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final UnmarshalException sut = null; // = new UnmarshalException(String, String);
    }

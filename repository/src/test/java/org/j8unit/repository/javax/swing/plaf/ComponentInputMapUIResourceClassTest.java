...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ComponentInputMapUIResource} (by simply
 * reusing the J8Unit test interface {@link ComponentInputMapUIResourceClassTests}).
 */

@RunWith(J8Unit4.class)
public class ComponentInputMapUIResourceClassTest
implements ComponentInputMapUIResourceClassTests<ComponentInputMapUIResource> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.ComponentInputMapUIResource]

    @Override
    public Class<ComponentInputMapUIResource> createNewSUT() {
        return ComponentInputMapUIResource.class;
    }
    ...
    public void create_ComponentInputMapUIResource_JComponent()
    throws Exception {
        // create new instance

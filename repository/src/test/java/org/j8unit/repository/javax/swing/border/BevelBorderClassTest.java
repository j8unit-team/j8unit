...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BevelBorder} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.border.BevelBorderClassTests}).
 */
@RunWith(J8Unit4.class)
public class BevelBorderClassTest
implements BevelBorderClassTests<BevelBorder> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.border.BevelBorder]

    @Override
    public Class<BevelBorder> createNewSUT() {
    ...
    public void create_BevelBorder_int_Color_Color()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_BevelBorder_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.border.BevelBorder]

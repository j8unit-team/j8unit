...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MBeanPermission} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.MBeanPermissionClassTests}).
 */
@RunWith(J8Unit4.class)
public class MBeanPermissionClassTest
implements MBeanPermissionClassTests<MBeanPermission> {

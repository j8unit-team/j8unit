...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AudioPermission} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.sound.sampled.AudioPermissionClassTests}).
 */

@RunWith(J8Unit4.class)
public class AudioPermissionClassTest
implements AudioPermissionClassTests<AudioPermission> {

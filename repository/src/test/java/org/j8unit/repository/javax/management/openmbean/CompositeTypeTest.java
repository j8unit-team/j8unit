...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CompositeType} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.openmbean.CompositeTypeTests}).
 */

@RunWith(J8Unit4.class)
public class CompositeTypeTest
implements CompositeTypeTests<CompositeType> {

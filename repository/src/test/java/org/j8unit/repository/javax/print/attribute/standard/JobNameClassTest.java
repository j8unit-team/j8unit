...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JobName} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.print.attribute.standard.JobNameClassTests}).
 */
@RunWith(J8Unit4.class)
public class JobNameClassTest
implements JobNameClassTests<JobName> {
    ...
    /**
     * @see JobNameClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without corresponding
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        JobNameClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

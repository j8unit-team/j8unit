...
implements org.j8unit.repository.javax.naming.directory.AttributeInUseExceptionClassTests<AttributeInUseException> {
     ...
     * {@link AttributeInUseException#AttributeInUseException(String) public
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link AttributeInUseException#AttributeInUseException() public javax.naming.directory.AttributeInUseException()}
     * .
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test

...
implements AddressingFeatureClassTests<AddressingFeature> {
    ...
    @Override
    public Class<AddressingFeature> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_AddressingFeature_boolean_boolean_Responses()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_AddressingFeature_boolean_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final AddressingFeature sut = null; // = new AddressingFeature(boolean, boolean);
    ...
    @Test
    @Category(Draft.class)
    public void create_AddressingFeature_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    implements ResponsesClassTests<Responses> {
        ...
        @Override
        public Class<Responses> createNewSUT() {

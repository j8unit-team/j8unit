...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JLayer} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.swing.JLayerClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class JLayerClassTest
implements JLayerClassTests<JLayer> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JLayer]

    @Override
    public Class<JLayer> createNewSUT() {
        return JLayer.class;
    }
    ...
    public void create_JLayer_Component_LayerUI()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_JLayer_Component()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NotificationBroadcasterSupport} (by
 * simply reusing the J8Unit test interface {@link NotificationBroadcasterSupportClassTests}).
 */
...
implements NotificationBroadcasterSupportClassTests<NotificationBroadcasterSupport> {
    ...
    @Override
    public Class<NotificationBroadcasterSupport> createNewSUT() {
        return NotificationBroadcasterSupport.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_NotificationBroadcasterSupport_Executor()
    throws Exception {
        // create new instance

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DOMSignContext} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.crypto.dsig.dom.DOMSignContextClassTests}).
 */

@RunWith(J8Unit4.class)
public class DOMSignContextClassTest
implements DOMSignContextClassTests<DOMSignContext> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.crypto.dsig.dom.DOMSignContext]

    @Override
    public Class<DOMSignContext> createNewSUT() {
        return DOMSignContext.class;
    }
    ...
    public void create_DOMSignContext_KeySelector_Node_Node()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_DOMSignContext_Key_Node()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_DOMSignContext_KeySelector_Node()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DOMSignContext sut = null; // = new DOMSignContext(javax.xml.crypto.KeySelector, org.w3c.dom.Node);
    ...
    @Test
    @Category(Draft.class)
    public void create_DOMSignContext_Key_Node_Node()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

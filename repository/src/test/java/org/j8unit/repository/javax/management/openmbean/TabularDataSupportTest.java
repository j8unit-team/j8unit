...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link TabularDataSupport} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.javax.management.openmbean.TabularDataSupportTests}).
 */

@RunWith(J8Unit4.class)
public class TabularDataSupportTest
implements TabularDataSupportTests<TabularDataSupport> {

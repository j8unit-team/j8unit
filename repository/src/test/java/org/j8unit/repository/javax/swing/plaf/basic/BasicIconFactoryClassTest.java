...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link BasicIconFactory} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.plaf.basic.BasicIconFactoryClassTests}).
 */

@RunWith(J8Unit4.class)
public class BasicIconFactoryClassTest
implements BasicIconFactoryClassTests<BasicIconFactory> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicIconFactory]

    @Override
    public Class<BasicIconFactory> createNewSUT() {
        return BasicIconFactory.class;
    }

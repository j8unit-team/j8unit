...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link InitialContextFactoryBuilder} (by
 * simply reusing the J8Unit test interface {@link InitialContextFactoryBuilderTests}).
 */

@RunWith(J8Unit4.class)
public class InitialContextFactoryBuilderTest
implements InitialContextFactoryBuilderTests<InitialContextFactoryBuilder> {

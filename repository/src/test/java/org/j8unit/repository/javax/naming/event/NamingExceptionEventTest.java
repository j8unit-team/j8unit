...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link NamingExceptionEvent} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.javax.naming.event.NamingExceptionEventTests}).
 */
@RunWith(J8Unit4.class)
public class NamingExceptionEventTest
implements NamingExceptionEventTests<NamingExceptionEvent> {

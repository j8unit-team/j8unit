...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SecretKeyFactorySpi} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.crypto.SecretKeyFactorySpiClassTests}).
 */
@RunWith(J8Unit4.class)
public class SecretKeyFactorySpiClassTest
implements SecretKeyFactorySpiClassTests<SecretKeyFactorySpi> {

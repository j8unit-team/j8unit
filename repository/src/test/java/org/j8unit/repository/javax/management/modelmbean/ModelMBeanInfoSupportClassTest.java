...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ModelMBeanInfoSupport} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.modelmbean.ModelMBeanInfoSupportClassTests}).
 */
@RunWith(J8Unit4.class)
public class ModelMBeanInfoSupportClassTest
implements ModelMBeanInfoSupportClassTests<ModelMBeanInfoSupport> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.modelmbean.ModelMBeanInfoSupport]

    @Override
    public Class<ModelMBeanInfoSupport> createNewSUT() {
        return ModelMBeanInfoSupport.class;
    }
    ...
    public void create_ModelMBeanInfoSupport_ModelMBeanInfo()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanInfoSupport_String_String_ModelMBeanAttributeInfoArray_ModelMBeanConstructorInfoArray_ModelMBeanOperationInfoArray_ModelMBeanNotificationInfoArray_Descriptor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanInfoSupport_String_String_ModelMBeanAttributeInfoArray_ModelMBeanConstructorInfoArray_ModelMBeanOperationInfoArray_ModelMBeanNotificationInfoArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ModelMBeanInfoSupport sut = null; // = new ModelMBeanInfoSupport(String, String,

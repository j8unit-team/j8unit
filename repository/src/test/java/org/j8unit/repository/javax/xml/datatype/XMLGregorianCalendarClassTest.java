...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link XMLGregorianCalendar} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.datatype.XMLGregorianCalendarClassTests}).
 */
@RunWith(J8Unit4.class)
public class XMLGregorianCalendarClassTest
implements XMLGregorianCalendarClassTests<XMLGregorianCalendar> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link X509IssuerSerial} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.crypto.dsig.keyinfo.X509IssuerSerialTests}).
 */
@RunWith(J8Unit4.class)
public class X509IssuerSerialTest
implements X509IssuerSerialTests<X509IssuerSerial> {

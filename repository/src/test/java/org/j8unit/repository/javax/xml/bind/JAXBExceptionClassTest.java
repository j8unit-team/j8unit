...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JAXBException} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.JAXBExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class JAXBExceptionClassTest
implements JAXBExceptionClassTests<JAXBException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.JAXBException]

    @Override
    public Class<JAXBException> createNewSUT() {
        return JAXBException.class;
    }
    ...
    public void create_JAXBException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JAXBException sut = null; // = new JAXBException(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JAXBException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JAXBException sut = null; // = new JAXBException(String, String);
    }

...
implements org.j8unit.repository.javax.swing.plaf.basic.BasicToolBarUIClassTests<BasicToolBarUI> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link BasicToolBarUI#BasicToolBarUI() public
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link BasicToolBarUI#createUI(JComponent) public static
    ...
    throws Exception {
        // write some test for {@link BasicToolBarUI#createUI(JComponent)}
    }
    ...
    implements org.j8unit.repository.javax.swing.plaf.basic.BasicToolBarUIClassTests.DockingListenerClassTests<DockingListener> {
         ...
         * {@link DockingListener#DockingListener(BasicToolBarUI, JToolBar) public
        ...
        throws Exception {
            ...
            final DockingListener sut = null; // = new DockingListener(BasicToolBarUI, JToolBar);
        }

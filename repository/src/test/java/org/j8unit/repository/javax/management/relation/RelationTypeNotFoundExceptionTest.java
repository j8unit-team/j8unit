...
org.j8unit.repository.javax.management.relation.RelationTypeNotFoundExceptionTests<RelationTypeNotFoundException> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(RelationTypeNotFoundException::new);
    }

    @Parameter(0)
    public Callable<RelationTypeNotFoundException> sutFactory;

    @Override
    public Callable<RelationTypeNotFoundException> getSUTFactory() {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SocketFactory} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.net.SocketFactoryClassTests}).
 */

@RunWith(J8Unit4.class)
public class SocketFactoryClassTest
implements SocketFactoryClassTests<SocketFactory> {

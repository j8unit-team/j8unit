...
implements org.j8unit.repository.javax.swing.JEditorPaneClassTests<JEditorPane> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JEditorPane]

    @Override
    public Class<JEditorPane> createNewSUT() {
    ...
    public void create_JEditorPane_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JEditorPane sut = null; // = new JEditorPane(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JEditorPane_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JEditorPane sut = null; // = new JEditorPane(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JEditorPane_URL()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

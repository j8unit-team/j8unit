...
implements org.j8unit.repository.javax.management.remote.TargetedNotificationClassTests<TargetedNotification> {
     ...
     * {@link TargetedNotification#TargetedNotification(Notification, Integer) public
    ...
    throws Exception {
        ...
        final TargetedNotification sut = null; // = new TargetedNotification(Notification, Integer);
    }

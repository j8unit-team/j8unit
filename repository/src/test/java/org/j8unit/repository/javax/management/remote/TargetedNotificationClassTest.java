...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TargetedNotification} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.remote.TargetedNotificationClassTests}).
 */
@RunWith(J8Unit4.class)
public class TargetedNotificationClassTest
implements TargetedNotificationClassTests<TargetedNotification> {

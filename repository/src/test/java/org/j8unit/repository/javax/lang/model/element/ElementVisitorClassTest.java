...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ElementVisitor} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.lang.model.element.ElementVisitorClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class ElementVisitorClassTest
implements ElementVisitorClassTests<ElementVisitor> {

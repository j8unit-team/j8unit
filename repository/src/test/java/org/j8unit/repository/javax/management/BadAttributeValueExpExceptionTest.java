...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link BadAttributeValueExpException} (by
 * simply reusing the J8Unit test interface {@link BadAttributeValueExpExceptionTests}).
 */

@RunWith(J8Unit4.class)
public class BadAttributeValueExpExceptionTest
implements BadAttributeValueExpExceptionTests<BadAttributeValueExpException> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NamingEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.naming.event.NamingEventClassTests}).
 */

@RunWith(J8Unit4.class)
public class NamingEventClassTest
implements NamingEventClassTests<NamingEvent> {

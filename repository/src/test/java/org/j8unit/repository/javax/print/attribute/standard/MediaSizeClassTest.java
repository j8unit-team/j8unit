...
implements MediaSizeClassTests<MediaSize> {
    ...
    @Override
    public Class<MediaSize> createNewSUT() {
    ...
    public void create_MediaSize_float_float_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MediaSize sut = null; // = new MediaSize(float, float, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_MediaSize_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MediaSize sut = null; // = new MediaSize(int, int, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_MediaSize_float_float_int_MediaSizeName()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_MediaSize_int_int_int_MediaSizeName()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

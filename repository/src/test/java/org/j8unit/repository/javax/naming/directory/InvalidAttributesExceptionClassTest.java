...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link InvalidAttributesException} (by simply
 * reusing the J8Unit test interface
 * {@link org.j8unit.repository.javax.naming.directory.InvalidAttributesExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class InvalidAttributesExceptionClassTest
implements InvalidAttributesExceptionClassTests<InvalidAttributesException> {

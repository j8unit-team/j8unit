...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MimeHeader} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.xml.soap.MimeHeaderClassTests}).
 */

@RunWith(J8Unit4.class)
public class MimeHeaderClassTest
implements MimeHeaderClassTests<MimeHeader> {

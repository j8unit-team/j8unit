...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RoleUnresolvedList} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.relation.RoleUnresolvedListClassTests}).
 */

@RunWith(J8Unit4.class)
public class RoleUnresolvedListClassTest
implements RoleUnresolvedListClassTests<RoleUnresolvedList> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.relation.RoleUnresolvedList]

    @Override
    public Class<RoleUnresolvedList> createNewSUT() {
        return RoleUnresolvedList.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_RoleUnresolvedList_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final RoleUnresolvedList sut = null; // = new RoleUnresolvedList(int);
    }

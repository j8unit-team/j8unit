...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link JMXPrincipal} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.remote.JMXPrincipalTests}).
 */
@RunWith(J8Unit4.class)
public class JMXPrincipalTest
implements JMXPrincipalTests<JMXPrincipal> {

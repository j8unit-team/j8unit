...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RefreshFailedException} (by simply
 * reusing the J8Unit test interface {@link RefreshFailedExceptionClassTests}).
 */
...
implements RefreshFailedExceptionClassTests<RefreshFailedException> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.security.auth.RefreshFailedException]

    @Override
    public Class<RefreshFailedException> createNewSUT() {
        return RefreshFailedException.class;
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link javax.security.auth.RefreshFailedException#RefreshFailedException() public
     ...
     * <p>
     * Test method for the hereby targeted constructor-under-test
     * {@link javax.security.auth.RefreshFailedException#RefreshFailedException(String) public
    ...
    @Test
    @Category(Draft.class)
    public void create_RefreshFailedException_String()
    throws Exception {
        // create new instance

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PropertyException} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.PropertyExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class PropertyExceptionClassTest
implements PropertyExceptionClassTests<PropertyException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.PropertyException]

    @Override
    public Class<PropertyException> createNewSUT() {
    ...
    public void create_PropertyException_String_Object()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PropertyException sut = null; // = new PropertyException(String, Object);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PropertyException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PropertyException sut = null; // = new PropertyException(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PropertyException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PropertyException sut = null; // = new PropertyException(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PropertyException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PropertyException sut = null; // = new PropertyException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PropertyException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final PropertyException sut = null; // = new PropertyException(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_PropertyException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

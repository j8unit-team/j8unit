...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MBeanAttributeInfo} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.MBeanAttributeInfoClassTests}).
 */
@RunWith(J8Unit4.class)
public class MBeanAttributeInfoClassTest
implements MBeanAttributeInfoClassTests<MBeanAttributeInfo> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.MBeanAttributeInfo]

    @Override
    public Class<MBeanAttributeInfo> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_MBeanAttributeInfo_String_String_Method_Method()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_MBeanAttributeInfo_String_String_String_boolean_boolean_boolean_Descriptor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MBeanAttributeInfo sut = null; // = new MBeanAttributeInfo(String, String, String, boolean, boolean,

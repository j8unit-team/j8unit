...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SoftBevelBorder} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.border.SoftBevelBorderClassTests}).
 */

@RunWith(J8Unit4.class)
public class SoftBevelBorderClassTest
implements SoftBevelBorderClassTests<SoftBevelBorder> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.border.SoftBevelBorder]

    @Override
    public Class<SoftBevelBorder> createNewSUT() {
    ...
    public void create_SoftBevelBorder_int_Color_Color_Color_Color()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_SoftBevelBorder_int_Color_Color()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_SoftBevelBorder_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

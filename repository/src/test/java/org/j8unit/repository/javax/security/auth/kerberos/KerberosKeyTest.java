...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link KerberosKey} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.security.auth.kerberos.KerberosKeyTests}).
 */

@RunWith(J8Unit4.class)
public class KerberosKeyTest
implements KerberosKeyTests<KerberosKey> {

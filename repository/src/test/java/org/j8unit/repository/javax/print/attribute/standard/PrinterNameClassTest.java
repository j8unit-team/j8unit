...
implements PrinterNameClassTests<PrinterName> {
    ...
    /**
     * @see PrinterNameClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without corresponding
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        PrinterNameClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

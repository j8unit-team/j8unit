...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KeyName} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.xml.crypto.dsig.keyinfo.KeyNameClassTests}).
 */
@RunWith(J8Unit4.class)
public class KeyNameClassTest
implements KeyNameClassTests<KeyName> {

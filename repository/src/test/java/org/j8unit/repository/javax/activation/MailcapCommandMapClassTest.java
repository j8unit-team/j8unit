...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MailcapCommandMap} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.activation.MailcapCommandMapClassTests}).
 */

@RunWith(J8Unit4.class)
public class MailcapCommandMapClassTest
implements MailcapCommandMapClassTests<MailcapCommandMap> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.activation.MailcapCommandMap]

    @Override
    public Class<MailcapCommandMap> createNewSUT() {
        return MailcapCommandMap.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_MailcapCommandMap_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MailcapCommandMap sut = null; // = new MailcapCommandMap(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_MailcapCommandMap_InputStream()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

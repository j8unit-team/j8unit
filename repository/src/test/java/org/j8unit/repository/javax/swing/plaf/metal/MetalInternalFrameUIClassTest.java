...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MetalInternalFrameUI} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.swing.plaf.metal.MetalInternalFrameUIClassTests}).
 */
@RunWith(J8Unit4.class)
public class MetalInternalFrameUIClassTest
implements MetalInternalFrameUIClassTests<MetalInternalFrameUI> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalInternalFrameUI]

    @Override
    public Class<MetalInternalFrameUI> createNewSUT() {
        return MetalInternalFrameUI.class;
    }
    ...
    public void create_MetalInternalFrameUI_JInternalFrame()
    throws Exception {
        // create new instance

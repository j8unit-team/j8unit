...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link JMXAuthenticator} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.remote.JMXAuthenticatorTests}).
 */
@RunWith(J8Unit4.class)
public class JMXAuthenticatorTest
implements JMXAuthenticatorTests<JMXAuthenticator> {

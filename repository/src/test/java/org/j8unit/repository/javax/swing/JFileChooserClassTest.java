...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JFileChooser} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.JFileChooserClassTests}).
 */

@RunWith(J8Unit4.class)
public class JFileChooserClassTest
implements JFileChooserClassTests<JFileChooser> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JFileChooser]

    @Override
    public Class<JFileChooser> createNewSUT() {
    ...
    public void create_JFileChooser_String_FileSystemView()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_JFileChooser_File_FileSystemView()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_JFileChooser_FileSystemView()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_JFileChooser_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JFileChooser sut = null; // = new JFileChooser(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JFileChooser_File()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

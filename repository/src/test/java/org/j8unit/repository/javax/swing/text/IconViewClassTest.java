...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link IconView} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.swing.text.IconViewClassTests}).
 */
@RunWith(J8Unit4.class)
public class IconViewClassTest
implements IconViewClassTests<IconView> {

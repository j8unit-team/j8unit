...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SearchResult} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.naming.directory.SearchResultClassTests}).
 */

@RunWith(J8Unit4.class)
public class SearchResultClassTest
implements SearchResultClassTests<SearchResult> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.naming.directory.SearchResult]

    @Override
    public Class<SearchResult> createNewSUT() {
    ...
    public void create_SearchResult_String_String_Object_Attributes_boolean()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_SearchResult_String_String_Object_Attributes()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SearchResult sut = null; // = new SearchResult(String, String, Object, javax.naming.directory.Attributes);
    ...
    @Test
    @Category(Draft.class)
    public void create_SearchResult_String_Object_Attributes()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_SearchResult_String_Object_Attributes_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final SearchResult sut = null; // = new SearchResult(String, Object, javax.naming.directory.Attributes,

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link XPathFunctionException} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.javax.xml.xpath.XPathFunctionExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class XPathFunctionExceptionClassTest
implements XPathFunctionExceptionClassTests<XPathFunctionException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.xpath.XPathFunctionException]

    @Override
    public Class<XPathFunctionException> createNewSUT() {
        return XPathFunctionException.class;
    }
    ...
    public void create_XPathFunctionException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final XPathFunctionException sut = null; // = new XPathFunctionException(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_XPathFunctionException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TimerNotification} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.timer.TimerNotificationClassTests}).
 */
@RunWith(J8Unit4.class)
public class TimerNotificationClassTest
implements TimerNotificationClassTests<TimerNotification> {

...
implements LayoutStyleClassTests<LayoutStyle> {
    ...
    @Override
    public Class<LayoutStyle> createNewSUT() {
        return LayoutStyle.class;
    }
    ...
    public void create_LayoutStyle()
    throws Exception {
    ...
    implements ComponentPlacementClassTests<ComponentPlacement> {
        ...
        @Override
        public Class<ComponentPlacement> createNewSUT() {
            return ComponentPlacement.class;
        }

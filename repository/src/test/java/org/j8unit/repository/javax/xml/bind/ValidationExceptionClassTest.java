...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ValidationException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.ValidationExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class ValidationExceptionClassTest
implements ValidationExceptionClassTests<ValidationException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.ValidationException]

    @Override
    public Class<ValidationException> createNewSUT() {
    ...
    public void create_ValidationException_String_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ValidationException sut = null; // = new ValidationException(String, String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ValidationException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ValidationException sut = null; // = new ValidationException(String, Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ValidationException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ValidationException sut = null; // = new ValidationException(Throwable);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ValidationException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ValidationException sut = null; // = new ValidationException(String, String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_ValidationException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

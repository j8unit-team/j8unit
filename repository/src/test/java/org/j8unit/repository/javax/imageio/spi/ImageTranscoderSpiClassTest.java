...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ImageTranscoderSpi} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.imageio.spi.ImageTranscoderSpiClassTests}).
 */

@RunWith(J8Unit4.class)
public class ImageTranscoderSpiClassTest
implements ImageTranscoderSpiClassTests<ImageTranscoderSpi> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JAXBContext} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.JAXBContextClassTests}).
 */

@RunWith(J8Unit4.class)
public class JAXBContextClassTest
implements JAXBContextClassTests<JAXBContext> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.JAXBContext]

    @Override
    public Class<JAXBContext> createNewSUT() {

 ...
 * test interface {@link org.j8unit.repository.javax.swing.text.html.parser.TagElementClassTests}).
 */
...
implements TagElementClassTests<TagElement> {
    ...
    @Override
    public Class<TagElement> createNewSUT() {
    ...
    public void create_TagElement_Element_boolean()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_TagElement_Element()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link FocusManager} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.FocusManagerTests}).
 */
@RunWith(J8Unit4.class)
public class FocusManagerTest
implements FocusManagerTests<FocusManager> {

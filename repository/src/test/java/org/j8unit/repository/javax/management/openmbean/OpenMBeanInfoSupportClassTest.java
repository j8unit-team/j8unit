...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link OpenMBeanInfoSupport} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.openmbean.OpenMBeanInfoSupportClassTests}).
 */
@RunWith(J8Unit4.class)
public class OpenMBeanInfoSupportClassTest
implements OpenMBeanInfoSupportClassTests<OpenMBeanInfoSupport> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.openmbean.OpenMBeanInfoSupport]

    @Override
    public Class<OpenMBeanInfoSupport> createNewSUT() {
        return OpenMBeanInfoSupport.class;
    }
    ...
    public void create_OpenMBeanInfoSupport_String_String_OpenMBeanAttributeInfoArray_OpenMBeanConstructorInfoArray_OpenMBeanOperationInfoArray_MBeanNotificationInfoArray_Descriptor()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_OpenMBeanInfoSupport_String_String_OpenMBeanAttributeInfoArray_OpenMBeanConstructorInfoArray_OpenMBeanOperationInfoArray_MBeanNotificationInfoArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final OpenMBeanInfoSupport sut = null; // = new OpenMBeanInfoSupport(String, String,

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NotificationResult} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.remote.NotificationResultClassTests}).
 */

@RunWith(J8Unit4.class)
public class NotificationResultClassTest
implements NotificationResultClassTests<NotificationResult> {

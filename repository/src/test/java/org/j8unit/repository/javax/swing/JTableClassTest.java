...
implements JTableClassTests<JTable> {
    ...
    @Override
    public Class<JTable> createNewSUT() {
        return JTable.class;
    }
    ...
    public void create_JTable_TableModel_TableColumnModel_ListSelectionModel()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_JTable_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JTable sut = null; // = new JTable(int, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JTable_ObjectArrayArray_ObjectArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JTable sut = null; // = new JTable(Object[][], Object[]);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JTable_TableModel()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_JTable_TableModel_TableColumnModel()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JTable sut = null; // = new JTable(javax.swing.table.TableModel, javax.swing.table.TableColumnModel);
    ...
    implements PrintModeClassTests<PrintMode> {
        ...
        @Override
        public Class<PrintMode> createNewSUT() {

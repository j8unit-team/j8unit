...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ServiceMode} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.ws.ServiceModeClassTests}).
 */
@RunWith(J8Unit4.class)
public class ServiceModeClassTest
implements ServiceModeClassTests<ServiceMode> {

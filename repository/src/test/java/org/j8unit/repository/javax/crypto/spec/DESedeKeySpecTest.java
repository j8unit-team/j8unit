...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link DESedeKeySpec} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.crypto.spec.DESedeKeySpecTests}).
 */
@RunWith(J8Unit4.class)
public class DESedeKeySpecTest
implements DESedeKeySpecTests<DESedeKeySpec> {

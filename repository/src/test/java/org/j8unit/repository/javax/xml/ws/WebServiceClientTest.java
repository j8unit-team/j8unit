...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link WebServiceClient} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.ws.WebServiceClientTests}).
 */
@RunWith(J8Unit4.class)
public class WebServiceClientTest
implements WebServiceClientTests<WebServiceClient> {

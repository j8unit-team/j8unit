...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link StringValueExp} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.StringValueExpClassTests}).
 */

@RunWith(J8Unit4.class)
public class StringValueExpClassTest
implements StringValueExpClassTests<StringValueExp> {

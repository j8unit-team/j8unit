...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link EmptyBorder} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.border.EmptyBorderTests}).
 */

@RunWith(J8Unit4.class)
public class EmptyBorderTest
implements EmptyBorderTests<EmptyBorder> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link HTMLFrameHyperlinkEvent} (by simply
 * reusing the J8Unit test interface {@link HTMLFrameHyperlinkEventClassTests}).
 */

@RunWith(J8Unit4.class)
public class HTMLFrameHyperlinkEventClassTest
implements HTMLFrameHyperlinkEventClassTests<HTMLFrameHyperlinkEvent> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.html.HTMLFrameHyperlinkEvent]

    @Override
    public Class<HTMLFrameHyperlinkEvent> createNewSUT() {
        return HTMLFrameHyperlinkEvent.class;
    }
    ...
    public void create_HTMLFrameHyperlinkEvent_Object_EventType_URL_String_Element_InputEvent_String()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_HTMLFrameHyperlinkEvent_Object_EventType_URL_String_Element_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HTMLFrameHyperlinkEvent sut = null; // = new HTMLFrameHyperlinkEvent(Object,
    ...
    @Test
    @Category(Draft.class)
    public void create_HTMLFrameHyperlinkEvent_Object_EventType_URL_Element_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HTMLFrameHyperlinkEvent sut = null; // = new HTMLFrameHyperlinkEvent(Object,
    ...
    @Test
    @Category(Draft.class)
    public void create_HTMLFrameHyperlinkEvent_Object_EventType_URL_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HTMLFrameHyperlinkEvent sut = null; // = new HTMLFrameHyperlinkEvent(Object,
    ...
    @Test
    @Category(Draft.class)
    public void create_HTMLFrameHyperlinkEvent_Object_EventType_URL_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final HTMLFrameHyperlinkEvent sut = null; // = new HTMLFrameHyperlinkEvent(Object,

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link X509KeyManager} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.net.ssl.X509KeyManagerTests}).
 */
@RunWith(J8Unit4.class)
public class X509KeyManagerTest
implements X509KeyManagerTests<X509KeyManager> {

...
implements org.j8unit.repository.javax.accessibility.AccessibleRelationSetClassTests<AccessibleRelationSet> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link AccessibleRelationSet#AccessibleRelationSet()
     ...
     * {@link AccessibleRelationSet#AccessibleRelationSet(AccessibleRelation[]) public
    ...
    throws Exception {
        ...
        final AccessibleRelationSet sut = null; // = new AccessibleRelationSet(AccessibleRelation[]);
    }

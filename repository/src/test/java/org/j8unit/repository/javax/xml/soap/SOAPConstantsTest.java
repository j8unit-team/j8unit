...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link SOAPConstants} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.soap.SOAPConstantsTests}).
 */
@RunWith(J8Unit4.class)
public class SOAPConstantsTest
implements SOAPConstantsTests<SOAPConstants> {

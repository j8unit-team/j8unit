...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link ConnectionEvent} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.sql.ConnectionEventTests}).
 */

@RunWith(J8Unit4.class)
public class ConnectionEventTest
implements ConnectionEventTests<ConnectionEvent> {

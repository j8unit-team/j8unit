...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link SOAPHeader} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.soap.SOAPHeaderTests}).
 */

@RunWith(J8Unit4.class)
public class SOAPHeaderTest
implements SOAPHeaderTests<SOAPHeader> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MidiDeviceProvider} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.sound.midi.spi.MidiDeviceProviderClassTests}).
 */
@RunWith(J8Unit4.class)
public class MidiDeviceProviderClassTest
implements MidiDeviceProviderClassTests<MidiDeviceProvider> {

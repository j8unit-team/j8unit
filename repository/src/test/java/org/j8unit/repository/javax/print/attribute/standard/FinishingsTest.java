...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Finishings} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.print.attribute.standard.FinishingsTests}).
 */

@RunWith(J8Parameterized.class)
@UseParametersRunnerFactory(J8BlockJUnit4ClassRunnerWithParametersFactory.class)
public class FinishingsTest
implements FinishingsTests<Finishings> {

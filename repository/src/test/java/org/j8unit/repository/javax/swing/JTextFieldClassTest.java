...
implements org.j8unit.repository.javax.swing.JTextFieldClassTests<JTextField> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JTextField]

    @Override
    public Class<JTextField> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_JTextField_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JTextField sut = null; // = new JTextField(String, int);
    }

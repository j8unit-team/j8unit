...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link XMLEventFactory} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.stream.XMLEventFactoryTests}).
 */

@RunWith(J8Unit4.class)
public class XMLEventFactoryTest
implements XMLEventFactoryTests<XMLEventFactory> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link OutputDeviceAssigned} (by simply reusing
...
implements OutputDeviceAssignedClassTests<OutputDeviceAssigned> {
    ...
    /**
     * @see OutputDeviceAssignedClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        OutputDeviceAssignedClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

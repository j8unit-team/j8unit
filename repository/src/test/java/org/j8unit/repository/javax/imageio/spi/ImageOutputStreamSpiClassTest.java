...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ImageOutputStreamSpi} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.imageio.spi.ImageOutputStreamSpiClassTests}).
 */
@RunWith(J8Unit4.class)
public class ImageOutputStreamSpiClassTest
implements ImageOutputStreamSpiClassTests<ImageOutputStreamSpi> {

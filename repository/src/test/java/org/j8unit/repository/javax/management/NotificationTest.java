...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Notification} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.NotificationTests}).
 */
@RunWith(J8Unit4.class)
public class NotificationTest
implements NotificationTests<Notification> {

...
implements org.j8unit.repository.javax.swing.JMenuItemClassTests<JMenuItem> {
    ...
    public void create_JMenuItem_Action()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_JMenuItem_Icon()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_JMenuItem_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JMenuItem sut = null; // = new JMenuItem(String, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JMenuItem_String_Icon()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

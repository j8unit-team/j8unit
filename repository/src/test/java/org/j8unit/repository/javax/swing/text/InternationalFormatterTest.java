...
implements FactoryBasedJ8UnitTest<InternationalFormatter>, org.j8unit.repository.javax.swing.text.InternationalFormatterTests<InternationalFormatter> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(InternationalFormatter::new);
    }

    @Parameter(0)
    public Callable<InternationalFormatter> sutFactory;

    @Override
    public Callable<InternationalFormatter> getSUTFactory() {

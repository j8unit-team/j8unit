...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KerberosKey} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.security.auth.kerberos.KerberosKeyClassTests}).
 */

@RunWith(J8Unit4.class)
public class KerberosKeyClassTest
implements KerberosKeyClassTests<KerberosKey> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.security.auth.kerberos.KerberosKey]

    @Override
    public Class<KerberosKey> createNewSUT() {
        return KerberosKey.class;
    }
    ...
    public void create_KerberosKey_KerberosPrincipal_byteArray_int_int()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_KerberosKey_KerberosPrincipal_charArray_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KeyManagerFactory} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.net.ssl.KeyManagerFactoryClassTests}).
 */

@RunWith(J8Unit4.class)
public class KeyManagerFactoryClassTest
implements KeyManagerFactoryClassTests<KeyManagerFactory> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.net.ssl.KeyManagerFactory]

    @Override
    public Class<KeyManagerFactory> createNewSUT() {

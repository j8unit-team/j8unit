...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link EditorKit} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.swing.text.EditorKitClassTests}).
 */

@RunWith(J8Unit4.class)
public class EditorKitClassTest
implements EditorKitClassTests<EditorKit> {

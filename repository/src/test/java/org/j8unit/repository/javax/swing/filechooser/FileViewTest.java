...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link FileView} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.filechooser.FileViewTests}).
 */

@RunWith(J8Unit4.class)
public class FileViewTest
implements FileViewTests<FileView> {

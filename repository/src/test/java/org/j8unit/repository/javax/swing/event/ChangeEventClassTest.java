...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ChangeEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.event.ChangeEventClassTests}).
 */

@RunWith(J8Unit4.class)
public class ChangeEventClassTest
implements ChangeEventClassTests<ChangeEvent> {

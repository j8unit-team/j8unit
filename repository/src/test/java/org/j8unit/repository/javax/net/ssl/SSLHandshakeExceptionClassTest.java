...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SSLHandshakeException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.net.ssl.SSLHandshakeExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class SSLHandshakeExceptionClassTest
implements SSLHandshakeExceptionClassTests<SSLHandshakeException> {

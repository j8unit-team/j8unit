 ...
 * test interface {@link org.j8unit.repository.javax.swing.JCheckBoxClassTests}).
 */
...
implements JCheckBoxClassTests<JCheckBox> {
    ...
    public void create_JCheckBox_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JCheckBox sut = null; // = new JCheckBox(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JCheckBox_String_Icon()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_JCheckBox_String_Icon_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

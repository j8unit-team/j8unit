...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link TransactionalWriter} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.javax.sql.rowset.spi.TransactionalWriterTests}).
 */
@RunWith(J8Unit4.class)
public class TransactionalWriterTest
implements TransactionalWriterTests<TransactionalWriter> {

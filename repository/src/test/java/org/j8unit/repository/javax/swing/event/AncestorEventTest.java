...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link AncestorEvent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.event.AncestorEventTests}).
 */
@RunWith(J8Unit4.class)
public class AncestorEventTest
implements AncestorEventTests<AncestorEvent> {

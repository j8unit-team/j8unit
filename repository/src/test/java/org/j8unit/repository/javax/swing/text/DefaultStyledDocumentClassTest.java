...
implements DefaultStyledDocumentClassTests<DefaultStyledDocument> {
    ...
    @Override
    public Class<DefaultStyledDocument> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_DefaultStyledDocument_StyleContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_DefaultStyledDocument_Content_StyleContext()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

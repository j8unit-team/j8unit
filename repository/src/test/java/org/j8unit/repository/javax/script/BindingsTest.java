...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Bindings} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.script.BindingsTests}).
 */
@RunWith(J8Unit4.class)
public class BindingsTest
implements BindingsTests<Bindings> {

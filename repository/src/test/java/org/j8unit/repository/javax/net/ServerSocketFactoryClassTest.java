...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ServerSocketFactory} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.net.ServerSocketFactoryClassTests}).
 */
@RunWith(J8Unit4.class)
public class ServerSocketFactoryClassTest
implements ServerSocketFactoryClassTests<ServerSocketFactory> {

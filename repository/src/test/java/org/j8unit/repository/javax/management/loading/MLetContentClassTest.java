...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MLetContent} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.loading.MLetContentClassTests}).
 */

@RunWith(J8Unit4.class)
public class MLetContentClassTest
implements MLetContentClassTests<MLetContent> {

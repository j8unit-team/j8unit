...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link TimerMBean} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.timer.TimerMBeanTests}).
 */
@RunWith(J8Unit4.class)
public class TimerMBeanTest
implements TimerMBeanTests<TimerMBean> {

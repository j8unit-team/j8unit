...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JTableHeader} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.table.JTableHeaderClassTests}).
 */
@RunWith(J8Unit4.class)
public class JTableHeaderClassTest
implements JTableHeaderClassTests<JTableHeader> {

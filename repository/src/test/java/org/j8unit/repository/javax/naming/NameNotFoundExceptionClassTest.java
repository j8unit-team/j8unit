...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NameNotFoundException} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.naming.NameNotFoundExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class NameNotFoundExceptionClassTest
implements NameNotFoundExceptionClassTests<NameNotFoundException> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JAXBPermission} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.JAXBPermissionClassTests}).
 */

@RunWith(J8Unit4.class)
public class JAXBPermissionClassTest
implements JAXBPermissionClassTests<JAXBPermission> {

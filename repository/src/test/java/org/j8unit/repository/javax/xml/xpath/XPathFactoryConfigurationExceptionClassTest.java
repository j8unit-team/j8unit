...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link XPathFactoryConfigurationException} (by
 * simply reusing the J8Unit test interface {@link XPathFactoryConfigurationExceptionClassTests}).
 */

@RunWith(J8Unit4.class)
public class XPathFactoryConfigurationExceptionClassTest
implements XPathFactoryConfigurationExceptionClassTests<XPathFactoryConfigurationException> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.xpath.XPathFactoryConfigurationException]

    @Override
    public Class<XPathFactoryConfigurationException> createNewSUT() {
        return XPathFactoryConfigurationException.class;
    }
    ...
    public void create_XPathFactoryConfigurationException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final XPathFactoryConfigurationException sut = null; // = new XPathFactoryConfigurationException(String);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_XPathFactoryConfigurationException_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ImageReaderWriterSpi} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.imageio.spi.ImageReaderWriterSpiClassTests}).
 */

@RunWith(J8Unit4.class)
public class ImageReaderWriterSpiClassTest
implements ImageReaderWriterSpiClassTests<ImageReaderWriterSpi> {

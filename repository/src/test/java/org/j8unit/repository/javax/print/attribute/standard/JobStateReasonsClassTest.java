...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JobStateReasons} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.print.attribute.standard.JobStateReasonsClassTests}).
 */
@RunWith(J8Unit4.class)
public class JobStateReasonsClassTest
implements JobStateReasonsClassTests<JobStateReasons> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.standard.JobStateReasons]

    @Override
    public Class<JobStateReasons> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_JobStateReasons_Collection()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_JobStateReasons_int_float()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JobStateReasons sut = null; // = new JobStateReasons(int, float);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JobStateReasons_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

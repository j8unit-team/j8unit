 ...
 * interface {@link org.j8unit.repository.javax.swing.BoxClassTests}).
 */
...
implements BoxClassTests<Box> {
    ...
    public void create_Box_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Box sut = null; // = new Box(int);
    }
     ...
     * test interface {@link org.j8unit.repository.javax.swing.BoxClassTests.FillerClassTests}).
     */
    ...
    implements FillerClassTests<Filler> {
        ...
        @Override
        public Class<Filler> createNewSUT() {
            return Filler.class;
        }
        ...
        @Test
        @Category(Draft.class)
        public void create_Filler_Dimension_Dimension_Dimension()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DirObjectFactory} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.naming.spi.DirObjectFactoryClassTests}).
 */
@RunWith(J8Unit4.class)
public class DirObjectFactoryClassTest
implements DirObjectFactoryClassTests<DirObjectFactory> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RoleUnresolved} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.relation.RoleUnresolvedClassTests}).
 */
@RunWith(J8Unit4.class)
public class RoleUnresolvedClassTest
implements RoleUnresolvedClassTests<RoleUnresolved> {

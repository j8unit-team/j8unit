...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link InitialContext} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.naming.InitialContextClassTests}).
 */

@RunWith(J8Unit4.class)
public class InitialContextClassTest
implements InitialContextClassTests<InitialContext> {

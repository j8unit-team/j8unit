...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link CompositeData} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.openmbean.CompositeDataTests}).
 */

@RunWith(J8Unit4.class)
public class CompositeDataTest
implements CompositeDataTests<CompositeData> {

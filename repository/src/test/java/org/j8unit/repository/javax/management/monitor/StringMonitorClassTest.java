...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link StringMonitor} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.monitor.StringMonitorClassTests}).
 */
@RunWith(J8Unit4.class)
public class StringMonitorClassTest
implements StringMonitorClassTests<StringMonitor> {

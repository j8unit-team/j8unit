...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MTOMFeature} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.ws.soap.MTOMFeatureClassTests}).
 */

@RunWith(J8Unit4.class)
public class MTOMFeatureClassTest
implements MTOMFeatureClassTests<MTOMFeature> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.ws.soap.MTOMFeature]

    @Override
    public Class<MTOMFeature> createNewSUT() {
     ...
     * {@link javax.xml.ws.soap.MTOMFeature#MTOMFeature(boolean, int) public
    ...
    @Test
    @Category(Draft.class)
    public void create_MTOMFeature_boolean_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MTOMFeature sut = null; // = new MTOMFeature(boolean, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_MTOMFeature_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MTOMFeature sut = null; // = new MTOMFeature(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_MTOMFeature_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

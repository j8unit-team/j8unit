...
implements StyleContextClassTests<StyleContext> {
    ...
    @Override
    public Class<StyleContext> createNewSUT() {
        return StyleContext.class;
    }
    ...
    implements NamedStyleClassTests<NamedStyle> {
        ...
        @Override
        public Class<NamedStyle> createNewSUT() {
        ...
        @Test
        @Category(Draft.class)
        public void create_NamedStyle_StyleContext()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
        ...
        @Test
        @Category(Draft.class)
        public void create_NamedStyle_StyleContext_Style()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
        ...
        @Test
        @Category(Draft.class)
        public void create_NamedStyle_StyleContext_String_Style()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")

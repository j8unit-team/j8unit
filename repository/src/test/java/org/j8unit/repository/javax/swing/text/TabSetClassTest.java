...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TabSet} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.swing.text.TabSetClassTests}).
 */

@RunWith(J8Unit4.class)
public class TabSetClassTest
implements TabSetClassTests<TabSet> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link XmlAnyElement} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.annotation.XmlAnyElementClassTests}).
 */
@RunWith(J8Unit4.class)
public class XmlAnyElementClassTest
implements XmlAnyElementClassTests<XmlAnyElement> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ModelMBeanAttributeInfo} (by simply
 * reusing the J8Unit test interface
 * {@link org.j8unit.repository.javax.management.modelmbean.ModelMBeanAttributeInfoClassTests}).
 */

@RunWith(J8Unit4.class)
public class ModelMBeanAttributeInfoClassTest
implements ModelMBeanAttributeInfoClassTests<ModelMBeanAttributeInfo> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.modelmbean.ModelMBeanAttributeInfo]

    @Override
    public Class<ModelMBeanAttributeInfo> createNewSUT() {
    ...
    public void create_ModelMBeanAttributeInfo_ModelMBeanAttributeInfo()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanAttributeInfo_String_String_String_boolean_boolean_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_ModelMBeanAttributeInfo_String_String_Method_Method_Descriptor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final ModelMBeanAttributeInfo sut = null; // = new ModelMBeanAttributeInfo(String, String,
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.modelmbean.ModelMBeanAttributeInfo]

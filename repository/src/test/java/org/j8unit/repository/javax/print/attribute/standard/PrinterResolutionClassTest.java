...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PrinterResolution} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.print.attribute.standard.PrinterResolutionClassTests}).
 */
@RunWith(J8Unit4.class)
public class PrinterResolutionClassTest
implements PrinterResolutionClassTests<PrinterResolution> {
    ...
    /**
     * @see PrinterResolutionClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        PrinterResolutionClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

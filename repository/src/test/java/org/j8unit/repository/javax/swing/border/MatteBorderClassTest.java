...
public class MatteBorderClassTest
implements org.j8unit.repository.javax.swing.border.MatteBorderClassTests<MatteBorder> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.border.MatteBorder]

    @Override
    public Class<MatteBorder> createNewSUT() {
    ...
    @Test
    @Category(Draft.class)
    public void create_MatteBorder_int_int_int_int_Color()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

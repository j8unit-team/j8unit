 ...
 * J8Unit test interface {@link org.j8unit.repository.javax.sql.rowset.spi.SyncFactoryClassTests}).
 */
...
implements SyncFactoryClassTests<SyncFactory> {
    ...
    @Override
    public Class<SyncFactory> createNewSUT() {
        return SyncFactory.class;
    }
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link javax.sql.rowset.spi.SyncFactory#getRegisteredProviders() public static
     * java.util.Enumeration<javax.sql.rowset.spi.SyncProvider>
     * javax.sql.rowset.spi.SyncFactory.getRegisteredProviders() throws javax.sql.rowset.spi.SyncFactoryException}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.

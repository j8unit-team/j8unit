...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link TreeModelListener} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.swing.event.TreeModelListenerTests}).
 */

@RunWith(J8Unit4.class)
public class TreeModelListenerTest
implements TreeModelListenerTests<TreeModelListener> {

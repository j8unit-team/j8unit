...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JMXConnectorFactory} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.remote.JMXConnectorFactoryClassTests}).
 */

@RunWith(J8Unit4.class)
public class JMXConnectorFactoryClassTest
implements JMXConnectorFactoryClassTests<JMXConnectorFactory> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.remote.JMXConnectorFactory]

    @Override
    public Class<JMXConnectorFactory> createNewSUT() {
        return JMXConnectorFactory.class;
    }

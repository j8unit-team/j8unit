...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link RoleResult} (by simply reusing the J8Unit
 * test interface {@link org.j8unit.repository.javax.management.relation.RoleResultClassTests}).
 */

@RunWith(J8Unit4.class)
public class RoleResultClassTest
implements RoleResultClassTests<RoleResult> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.relation.RoleResult]

    @Override
    public Class<RoleResult> createNewSUT() {
    ...
    public void create_RoleResult_RoleList_RoleUnresolvedList()
    throws Exception {
        // create new instance

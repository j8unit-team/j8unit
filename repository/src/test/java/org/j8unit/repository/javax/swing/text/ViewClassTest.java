...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link View} (by simply reusing the J8Unit test
 * interface {@link org.j8unit.repository.javax.swing.text.ViewClassTests}).
 */
@RunWith(J8Unit4.class)
public class ViewClassTest
implements ViewClassTests<View> {

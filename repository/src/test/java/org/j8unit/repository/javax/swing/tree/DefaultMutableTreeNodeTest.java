...
implements FactoryBasedJ8UnitTest<DefaultMutableTreeNode>, org.j8unit.repository.javax.swing.tree.DefaultMutableTreeNodeTests<DefaultMutableTreeNode> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(DefaultMutableTreeNode::new);
    }

    @Parameter(0)
    public Callable<DefaultMutableTreeNode> sutFactory;

    @Override
    public Callable<DefaultMutableTreeNode> getSUTFactory() {

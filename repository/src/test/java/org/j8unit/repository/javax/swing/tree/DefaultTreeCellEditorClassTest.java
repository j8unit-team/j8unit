...
implements org.j8unit.repository.javax.swing.tree.DefaultTreeCellEditorClassTests<DefaultTreeCellEditor> {
    ...
    @Override
    public Class<DefaultTreeCellEditor> createNewSUT() {
        return DefaultTreeCellEditor.class;
    }
    ...
    public void create_DefaultTreeCellEditor_JTree_DefaultTreeCellRenderer()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_DefaultTreeCellEditor_JTree_DefaultTreeCellRenderer_TreeCellEditor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final DefaultTreeCellEditor sut = null; // = new DefaultTreeCellEditor(javax.swing.JTree,
    ...
    implements org.j8unit.repository.javax.swing.tree.DefaultTreeCellEditorClassTests.EditorContainerClassTests<EditorContainer> {
        ...
        @Override
        public Class<EditorContainer> createNewSUT() {
            return EditorContainer.class;
        }
        ...
        @Test
        @Category(Draft.class)
        public void create_EditorContainer_DefaultTreeCellEditor()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")

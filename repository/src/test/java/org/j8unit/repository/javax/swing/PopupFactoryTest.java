...
implements FactoryBasedJ8UnitTest<PopupFactory>, PopupFactoryTests<PopupFactory> {
    ...
    public static Iterable<? extends Object> sutData() {
        return testParametersOf(PopupFactory::new);
    }

    @Parameter(0)
    public Callable<PopupFactory> sutFactory;

    @Override
    public Callable<PopupFactory> getSUTFactory() {
        return this.sutFactory;
    }

    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[javax.swing.PopupFactory]

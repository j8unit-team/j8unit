...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KeyAgreementSpi} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.crypto.KeyAgreementSpiClassTests}).
 */

@RunWith(J8Unit4.class)
public class KeyAgreementSpiClassTest
implements KeyAgreementSpiClassTests<KeyAgreementSpi> {

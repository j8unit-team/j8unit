...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link Monitor} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.monitor.MonitorTests}).
 */

@RunWith(J8Unit4.class)
public class MonitorTest
implements MonitorTests<Monitor> {

...
implements org.j8unit.repository.javax.swing.plaf.basic.BasicComboPopupClassTests<BasicComboPopup> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicComboPopup]

    @Override
    public Class<BasicComboPopup> createNewSUT() {
        return BasicComboPopup.class;
    }

    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link BasicComboPopup#BasicComboPopup(JComboBox)
    ...
    public void create_BasicComboPopup_JComboBox()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final BasicComboPopup sut = null; // = new BasicComboPopup(JComboBox);
    }
    ...
    implements org.j8unit.repository.javax.swing.plaf.basic.BasicComboPopupClassTests.InvocationKeyHandlerClassTests<InvocationKeyHandler> {
         ...
         * {@link InvocationKeyHandler#InvocationKeyHandler(BasicComboPopup) public
         * javax.swing.plaf.basic.BasicComboPopup$InvocationKeyHandler(javax.swing.plaf.basic.BasicComboPopup)}.
         *
         * Up to now, there is no real implementation of this test method. But with your help at
        ...
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            final InvocationKeyHandler sut = null; // = new InvocationKeyHandler(BasicComboPopup);
        }
    ...
    implements org.j8unit.repository.javax.swing.plaf.basic.BasicComboPopupClassTests.ListDataHandlerClassTests<ListDataHandler> {
         ...
         * <p>
         * Test method for the hereby targeted constructor-under-test
         * {@link ListDataHandler#ListDataHandler(BasicComboPopup) public
         * javax.swing.plaf.basic.BasicComboPopup$ListDataHandler(javax.swing.plaf.basic.BasicComboPopup)}.
         *
         * Up to now, there is no real implementation of this test method. But with your help at
         * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful
         * test methods soon.
        ...
        @Test
        @Category(Draft.class)
        public void create_ListDataHandler_BasicComboPopup()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            final ListDataHandler sut = null; // = new ListDataHandler(BasicComboPopup);
        }

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link GaugeMonitorMBean} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.management.monitor.GaugeMonitorMBeanTests}).
 */

@RunWith(J8Unit4.class)
public class GaugeMonitorMBeanTest
implements GaugeMonitorMBeanTests<GaugeMonitorMBean> {

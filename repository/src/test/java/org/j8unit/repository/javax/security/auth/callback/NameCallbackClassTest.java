...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NameCallback} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.security.auth.callback.NameCallbackClassTests}).
 */
@RunWith(J8Unit4.class)
public class NameCallbackClassTest
implements NameCallbackClassTests<NameCallback> {

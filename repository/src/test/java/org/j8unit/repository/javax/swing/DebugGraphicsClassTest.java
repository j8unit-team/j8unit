...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DebugGraphics} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.DebugGraphicsClassTests}).
 */

@RunWith(J8Unit4.class)
public class DebugGraphicsClassTest
implements DebugGraphicsClassTests<DebugGraphics> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.DebugGraphics]

    @Override
    public Class<DebugGraphics> createNewSUT() {
        return DebugGraphics.class;
    }
    ...
    public void create_DebugGraphics_Graphics()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_DebugGraphics_Graphics_JComponent()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

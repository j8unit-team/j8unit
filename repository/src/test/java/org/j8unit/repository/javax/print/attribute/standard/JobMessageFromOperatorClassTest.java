...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JobMessageFromOperator} (by simply
...
implements JobMessageFromOperatorClassTests<JobMessageFromOperator> {
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.print.attribute.standard.JobMessageFromOperator]

    /**
     * @see JobMessageFromOperatorClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        JobMessageFromOperatorClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

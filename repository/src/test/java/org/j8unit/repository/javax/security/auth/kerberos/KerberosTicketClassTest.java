...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KerberosTicket} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.security.auth.kerberos.KerberosTicketClassTests}).
 */
@RunWith(J8Unit4.class)
public class KerberosTicketClassTest
implements KerberosTicketClassTests<KerberosTicket> {

...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link EndpointContext} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.ws.EndpointContextTests}).
 */
@RunWith(J8Unit4.class)
public class EndpointContextTest
implements EndpointContextTests<EndpointContext> {

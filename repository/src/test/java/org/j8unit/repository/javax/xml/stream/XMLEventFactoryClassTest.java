...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link XMLEventFactory} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.stream.XMLEventFactoryClassTests}).
 */
@RunWith(J8Unit4.class)
public class XMLEventFactoryClassTest
implements XMLEventFactoryClassTests<XMLEventFactory> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.stream.XMLEventFactory]

    @Override
    public Class<XMLEventFactory> createNewSUT() {
        return XMLEventFactory.class;
    }

...
public class PrinterURIClassTest
implements PrinterURIClassTests<PrinterURI> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.standard.PrinterURI]

    @Override
    public Class<PrinterURI> createNewSUT() {
     ...
     * {@link javax.print.attribute.standard.PrinterURI#PrinterURI(java.net.URI) public
    ...
    public void create_PrinterURI_URI()
    throws Exception {
        // create new instance
    ...
    /**
     * @see PrinterURIClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without corresponding
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        PrinterURIClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

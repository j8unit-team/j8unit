...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link XmlEnumValue} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.annotation.XmlEnumValueTests}).
 */
@RunWith(J8Unit4.class)
public class XmlEnumValueTest
implements XmlEnumValueTests<XmlEnumValue> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link KeyAgreement} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.crypto.KeyAgreementClassTests}).
 */

@RunWith(J8Unit4.class)
public class KeyAgreementClassTest
implements KeyAgreementClassTests<KeyAgreement> {

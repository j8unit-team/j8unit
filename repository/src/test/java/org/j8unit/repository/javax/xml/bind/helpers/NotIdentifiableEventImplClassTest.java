...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NotIdentifiableEventImpl} (by simply
 * reusing the J8Unit test interface
 * {@link org.j8unit.repository.javax.xml.bind.helpers.NotIdentifiableEventImplClassTests}).
 */
@RunWith(J8Unit4.class)
public class NotIdentifiableEventImplClassTest
implements NotIdentifiableEventImplClassTests<NotIdentifiableEventImpl> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.helpers.NotIdentifiableEventImpl]

    @Override
    public Class<NotIdentifiableEventImpl> createNewSUT() {
        return NotIdentifiableEventImpl.class;
    }
    ...
    public void create_NotIdentifiableEventImpl_int_String_ValidationEventLocator()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_NotIdentifiableEventImpl_int_String_ValidationEventLocator_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final NotIdentifiableEventImpl sut = null; // = new NotIdentifiableEventImpl(int, String,

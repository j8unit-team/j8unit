...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ModificationItem} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.naming.directory.ModificationItemClassTests}).
 */

@RunWith(J8Unit4.class)
public class ModificationItemClassTest
implements ModificationItemClassTests<ModificationItem> {

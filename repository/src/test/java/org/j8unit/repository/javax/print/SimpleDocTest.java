...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link SimpleDoc} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.print.SimpleDocTests}).
 */

@RunWith(J8Unit4.class)
public class SimpleDocTest
implements SimpleDocTests<SimpleDoc> {

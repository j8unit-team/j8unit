...
implements org.j8unit.repository.javax.xml.datatype.DatatypeFactoryClassTests<DatatypeFactory> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link DatatypeFactory#newInstance(String, ClassLoader)
    ...
    throws Exception {
        // write some test for {@link DatatypeFactory#newInstance(String, ClassLoader)}
    }

    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link DatatypeFactory#newInstance() public static
    ...
    throws Exception {
        // write some test for {@link DatatypeFactory#newInstance()}
    }

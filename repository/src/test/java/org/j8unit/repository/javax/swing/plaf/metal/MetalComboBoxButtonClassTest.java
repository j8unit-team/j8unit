...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link MetalComboBoxButton} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.swing.plaf.metal.MetalComboBoxButtonClassTests}).
 */
@RunWith(J8Unit4.class)
public class MetalComboBoxButtonClassTest
implements MetalComboBoxButtonClassTests<MetalComboBoxButton> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalComboBoxButton]

    @Override
    public Class<MetalComboBoxButton> createNewSUT() {
        return MetalComboBoxButton.class;
    }
    ...
    public void create_MetalComboBoxButton_JComboBox_Icon_boolean_CellRendererPane_JList()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_MetalComboBoxButton_JComboBox_Icon_CellRendererPane_JList()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final MetalComboBoxButton sut = null; // = new MetalComboBoxButton(javax.swing.JComboBox, javax.swing.Icon,

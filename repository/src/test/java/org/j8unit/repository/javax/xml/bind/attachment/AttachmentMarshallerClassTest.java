...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link AttachmentMarshaller} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.bind.attachment.AttachmentMarshallerClassTests}).
 */

@RunWith(J8Unit4.class)
public class AttachmentMarshallerClassTest
implements AttachmentMarshallerClassTests<AttachmentMarshaller> {

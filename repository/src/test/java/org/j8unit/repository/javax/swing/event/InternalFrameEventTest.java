...
/**
 * Specific JUnit test class to proof the instance relevant aspects of type {@link InternalFrameEvent} (by simply
 * reusing the J8Unit test interface {@link org.j8unit.repository.javax.swing.event.InternalFrameEventTests}).
 */

@RunWith(J8Unit4.class)
public class InternalFrameEventTest
implements InternalFrameEventTests<InternalFrameEvent> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link JMXPrincipal} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.remote.JMXPrincipalClassTests}).
 */

@RunWith(J8Unit4.class)
public class JMXPrincipalClassTest
implements JMXPrincipalClassTests<JMXPrincipal> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.remote.JMXPrincipal]

    @Override
    public Class<JMXPrincipal> createNewSUT() {
        return JMXPrincipal.class;
    }
    ...
    public void create_JMXPrincipal_String()
    throws Exception {
        // create new instance

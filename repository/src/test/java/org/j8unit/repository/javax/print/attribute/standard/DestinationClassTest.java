...
implements DestinationClassTests<Destination> {
    ...
    /**
     * @see DestinationClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without corresponding
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        DestinationClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link SynthContext} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.plaf.synth.SynthContextClassTests}).
 */

@RunWith(J8Unit4.class)
public class SynthContextClassTest
implements SynthContextClassTests<SynthContext> {

...
implements InvalidSearchControlsExceptionClassTests<InvalidSearchControlsException> {
    ...
    @Override
    public Class<InvalidSearchControlsException> createNewSUT() {
        return InvalidSearchControlsException.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_InvalidSearchControlsException_String()
    throws Exception {
        // create new instance

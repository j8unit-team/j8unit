...
implements FactoryBasedJ8UnitTest<InvalidRelationServiceException>, InvalidRelationServiceExceptionTests<InvalidRelationServiceException> {
    ...
    public static Iterable<Object[]> sutData() {
        return testParametersOf(InvalidRelationServiceException::new);
    }

    @Parameter(0)
    public Callable<InvalidRelationServiceException> sutFactory;

    @Override
    public Callable<InvalidRelationServiceException> getSUTFactory() {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link NamingException} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.naming.NamingExceptionClassTests}).
 */
@RunWith(J8Unit4.class)
public class NamingExceptionClassTest
implements NamingExceptionClassTests<NamingException> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link OpenMBeanAttributeInfoSupport} (by simply
 * reusing the J8Unit test interface {@link OpenMBeanAttributeInfoSupportClassTests}).
 */

@RunWith(J8Unit4.class)
public class OpenMBeanAttributeInfoSupportClassTest
implements OpenMBeanAttributeInfoSupportClassTests<OpenMBeanAttributeInfoSupport> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.openmbean.OpenMBeanAttributeInfoSupport]

    @Override
    public Class<OpenMBeanAttributeInfoSupport> createNewSUT() {
        return OpenMBeanAttributeInfoSupport.class;
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_OpenMBeanAttributeInfoSupport_String_String_OpenType_boolean_boolean_boolean_Object()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final OpenMBeanAttributeInfoSupport sut = null; // = new OpenMBeanAttributeInfoSupport(String, String,
    ...
    @Test
    @Category(Draft.class)
    public void create_OpenMBeanAttributeInfoSupport_String_String_OpenType_boolean_boolean_boolean_Descriptor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final OpenMBeanAttributeInfoSupport sut = null; // = new OpenMBeanAttributeInfoSupport(String, String,

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DateTimeAtProcessing} (by simply reusing
...
implements DateTimeAtProcessingClassTests<DateTimeAtProcessing> {
    ...
    /**
     * @see DateTimeAtProcessingClassBugs#equalsWithoutHashCode() Overridden {@code #equals(Object)} method without
    ...
    public void wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode() {
        DateTimeAtProcessingClassTests.super.wheneverEqualsIsOverriddenItIsGenerallyNecessaryToOverrideHashCode();
    }

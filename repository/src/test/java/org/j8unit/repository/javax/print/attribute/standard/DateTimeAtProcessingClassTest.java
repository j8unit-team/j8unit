...
implements org.j8unit.repository.javax.print.attribute.standard.DateTimeAtProcessingClassTests<DateTimeAtProcessing> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted constructor-under-test {@link DateTimeAtProcessing#DateTimeAtProcessing(Date)
    ...
    throws Exception {
        ...
        final DateTimeAtProcessing sut = null; // = new DateTimeAtProcessing(Date);
    }

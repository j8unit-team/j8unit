 ...
 * test interface {@link org.j8unit.repository.javax.swing.text.html.parser.EntityClassTests}).
 */
...
implements EntityClassTests<Entity> {
    ...
    public void create_Entity_String_int_charArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final Entity sut = null; // = new Entity(String, int, char[]);
    }

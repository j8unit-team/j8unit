...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link TransformerFactory} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.xml.transform.TransformerFactoryClassTests}).
 */
@RunWith(J8Unit4.class)
public class TransformerFactoryClassTest
implements TransformerFactoryClassTests<TransformerFactory> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.transform.TransformerFactory]

    @Override
    public Class<TransformerFactory> createNewSUT() {
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.transform.TransformerFactory]

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link ImageTypeSpecifier} (by simply reusing
 * the J8Unit test interface {@link org.j8unit.repository.javax.imageio.ImageTypeSpecifierClassTests}).
 */

@RunWith(J8Unit4.class)
public class ImageTypeSpecifierClassTest
implements ImageTypeSpecifierClassTests<ImageTypeSpecifier> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.imageio.ImageTypeSpecifier]

    @Override
    public Class<ImageTypeSpecifier> createNewSUT() {
        return ImageTypeSpecifier.class;
    }
    ...
    public void create_ImageTypeSpecifier_ColorModel_SampleModel()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_ImageTypeSpecifier_RenderedImage()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.imageio.ImageTypeSpecifier]

...
implements org.j8unit.repository.javax.swing.JSliderClassTests<JSlider> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JSlider]

    @Override
    public Class<JSlider> createNewSUT() {
    ...
    public void create_JSlider_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final JSlider sut = null; // = new JSlider(int, int);
    }
    ...
    @Test
    @Category(Draft.class)
    public void create_JSlider_BoundedRangeModel()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

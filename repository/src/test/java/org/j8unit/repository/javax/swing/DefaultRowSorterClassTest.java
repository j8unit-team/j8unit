...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link DefaultRowSorter} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.swing.DefaultRowSorterClassTests}).
 */
@SuppressWarnings("rawtypes")
@RunWith(J8Unit4.class)
public class DefaultRowSorterClassTest
implements DefaultRowSorterClassTests<DefaultRowSorter> {

...
/**
 * Specific JUnit test class to proof the type relevant aspects of type {@link PrivateMLet} (by simply reusing the
 * J8Unit test interface {@link org.j8unit.repository.javax.management.loading.PrivateMLetClassTests}).
 */
@RunWith(J8Unit4.class)
public class PrivateMLetClassTest
implements PrivateMLetClassTests<PrivateMLet> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.loading.PrivateMLet]

    @Override
    public Class<PrivateMLet> createNewSUT() {
        return PrivateMLet.class;
    }
    ...
    public void create_PrivateMLet_URLArray_boolean()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public void create_PrivateMLet_URLArray_ClassLoader_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public void create_PrivateMLet_URLArray_ClassLoader_URLStreamHandlerFactory_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

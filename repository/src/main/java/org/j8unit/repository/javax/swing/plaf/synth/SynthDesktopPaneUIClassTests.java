...
import org.j8unit.repository.javax.swing.plaf.basic.BasicDesktopPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthDesktopPaneUI
 * public class javax.swing.plaf.synth.SynthDesktopPaneUI}.
 *
...
public abstract interface SynthDesktopPaneUIClassTests<SUT extends SynthDesktopPaneUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicDesktopPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthDesktopPaneUI.class!",
                   SynthDesktopPaneUI.class.isAssignableFrom(sut));
    }

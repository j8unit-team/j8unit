 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageWriteParamTests}).
 * </p>
 *
 * <p>
 ...
 * @see ImageWriteParamTests ImageWriteParamTests (The complementary j8unit test interface containing the instance
...
public abstract interface ImageWriteParamClassTests<SUT extends javax.imageio.ImageWriteParam>
extends IIOParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.ImageWriteParam.class!",
                   javax.imageio.ImageWriteParam.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ElementKind public
 * final enum javax.lang.model.element.ElementKind}.
 *
...
public abstract interface ElementKindClassTests<SUT extends ElementKind>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementKind.class!",
                   ElementKind.class.isAssignableFrom(sut));
    }

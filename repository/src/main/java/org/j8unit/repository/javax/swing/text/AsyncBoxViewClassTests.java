 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AsyncBoxViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AsyncBoxViewTests}.
 * </p>
 *
 * @see javax.swing.text.AsyncBoxView class javax.swing.text.AsyncBoxView (the hereby targeted class-under-test class)
 * @see AsyncBoxViewTests AsyncBoxViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.AsyncBoxView.class!",
                   javax.swing.text.AsyncBoxView.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.AsyncBoxView.ChildLocator class
     * javax.swing.text.AsyncBoxView$ChildLocator}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link AsyncBoxViewTests.ChildLocatorTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.text.AsyncBoxView.ChildLocator class javax.swing.text.AsyncBoxView$ChildLocator (the hereby
     *      targeted class-under-test class)
     * @see AsyncBoxViewTests.ChildLocatorTests AsyncBoxViewTests.ChildLocatorTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.AsyncBoxView.ChildLocator.class!",
                       javax.swing.text.AsyncBoxView.ChildLocator.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.text.AsyncBoxView$ChildState}, containing all type relevant aspects (e.&thinsp;g., runtime
     * constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link AsyncBoxViewTests.ChildStateTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.text.AsyncBoxView.ChildState class javax.swing.text.AsyncBoxView$ChildState (the hereby targeted
     *      class-under-test class)
     * @see AsyncBoxViewTests.ChildStateTests AsyncBoxViewTests.ChildStateTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.RunnableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.AsyncBoxView.ChildState.class!",
                       javax.swing.text.AsyncBoxView.ChildState.class.isAssignableFrom(sut));
        }

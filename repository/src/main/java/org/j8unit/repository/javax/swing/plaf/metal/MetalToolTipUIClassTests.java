 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalToolTipUI
 * public class javax.swing.plaf.metal.MetalToolTipUI}.
 *
...
public abstract interface MetalToolTipUIClassTests<SUT extends MetalToolTipUI>
extends BasicToolTipUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalToolTipUI.class!",
                   MetalToolTipUI.class.isAssignableFrom(sut));
    }

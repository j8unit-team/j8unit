 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BorderFactory
...
public abstract interface BorderFactoryClassTests<SUT extends BorderFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BorderFactory.class!",
                   BorderFactory.class.isAssignableFrom(sut));
    }

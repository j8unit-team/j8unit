 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractAction
...
public abstract interface AbstractActionClassTests<SUT extends AbstractAction>
extends ActionClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractAction.class!",
                   AbstractAction.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.DesktopPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicDesktopPaneUI
 * public class javax.swing.plaf.basic.BasicDesktopPaneUI}.
 *
...
public abstract interface BasicDesktopPaneUIClassTests<SUT extends BasicDesktopPaneUI>
extends DesktopPaneUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicDesktopPaneUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicDesktopPaneUI.class!",
                   BasicDesktopPaneUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicDesktopPaneUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.basic.BasicDesktopPaneUI]

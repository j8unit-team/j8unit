...
import org.j8unit.repository.java.awt.datatransfer.TransferableClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataHandler public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataHandlerTests}.
 * </p>
 *
 * <p>
...
public abstract interface DataHandlerClassTests<SUT extends DataHandler>
extends TransferableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataHandler.class!",
                   DataHandler.class.isAssignableFrom(sut));
    }

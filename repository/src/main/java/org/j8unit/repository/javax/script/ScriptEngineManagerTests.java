 ...
 * {@link ScriptEngineManager public class javax.script.ScriptEngineManager}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.script.ScriptEngineManagerClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface ScriptEngineManagerTests<SUT extends ScriptEngineManager>
extends ObjectTests<SUT> {
    ...
    public default void test_setBindings_Bindings()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getEngineByName_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_registerEngineName_String_ScriptEngineFactory()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_registerEngineExtension_String_ScriptEngineFactory()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_registerEngineMimeType_String_ScriptEngineFactory()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getEngineByMimeType_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getEngineByExtension_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link javax.script.ScriptEngineManager#getEngineFactories() public
    ...
    @Test
    @Category(Draft.class)
    public default void test_getBindings()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[javax.script.ScriptEngineManager]

    // J8UNIT-MARKER-[END]-[INSTANCE]-[javax.script.ScriptEngineManager]

...
import org.j8unit.repository.javax.swing.plaf.ScrollPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiScrollPaneUI
 * public class javax.swing.plaf.multi.MultiScrollPaneUI}.
 *
...
public abstract interface MultiScrollPaneUIClassTests<SUT extends MultiScrollPaneUI>
extends ScrollPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiScrollPaneUI.class!",
                   MultiScrollPaneUI.class.isAssignableFrom(sut));
    }

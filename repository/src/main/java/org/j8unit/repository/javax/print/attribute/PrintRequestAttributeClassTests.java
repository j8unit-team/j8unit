 ...
 * javax.print.attribute.PrintRequestAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintRequestAttributeTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PrintRequestAttributeTests}.
 * </p>
 *
 * @see javax.print.attribute.PrintRequestAttribute interface javax.print.attribute.PrintRequestAttribute (the hereby
 *      targeted class-under-test class)
 * @see PrintRequestAttributeTests PrintRequestAttributeTests (The complementary j8unit test interface containing the
...
public abstract interface PrintRequestAttributeClassTests<SUT extends javax.print.attribute.PrintRequestAttribute>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.PrintRequestAttribute.class!",
                   javax.print.attribute.PrintRequestAttribute.class.isAssignableFrom(sut));
    }

...
public abstract interface PrintRequestAttributeClassTests<SUT extends PrintRequestAttribute>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintRequestAttribute.class!",
                   PrintRequestAttribute.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.modelmbean.ModelMBeanInfoSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ModelMBeanInfoSupportTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ModelMBeanInfoSupportTests}.
 * </p>
 *
 * @see javax.management.modelmbean.ModelMBeanInfoSupport class javax.management.modelmbean.ModelMBeanInfoSupport (the
 *      hereby targeted class-under-test class)
 * @see ModelMBeanInfoSupportTests ModelMBeanInfoSupportTests (The complementary j8unit test interface containing the
...
public abstract interface ModelMBeanInfoSupportClassTests<SUT extends javax.management.modelmbean.ModelMBeanInfoSupport>
extends ModelMBeanInfoClassTests<SUT>, org.j8unit.repository.javax.management.MBeanInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.modelmbean.ModelMBeanInfoSupport.class!",
                   javax.management.modelmbean.ModelMBeanInfoSupport.class.isAssignableFrom(sut));
    }

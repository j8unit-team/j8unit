 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PackageElement
 * public abstract interface javax.lang.model.element.PackageElement}.
 *
...
public abstract interface PackageElementClassTests<SUT extends PackageElement>
extends QualifiedNameableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PackageElement.class!",
                   PackageElement.class.isAssignableFrom(sut));
    }

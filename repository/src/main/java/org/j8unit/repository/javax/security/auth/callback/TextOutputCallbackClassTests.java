 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextOutputCallback
...
public abstract interface TextOutputCallbackClassTests<SUT extends TextOutputCallback>
extends CallbackClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextOutputCallback.class!",
                   TextOutputCallback.class.isAssignableFrom(sut));
    }

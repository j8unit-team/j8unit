 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SizeSequence public
...
public abstract interface SizeSequenceClassTests<SUT extends SizeSequence>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SizeSequence.class!",
                   SizeSequence.class.isAssignableFrom(sut));
    }

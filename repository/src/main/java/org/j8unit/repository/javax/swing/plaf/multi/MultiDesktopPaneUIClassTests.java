 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiDesktopPaneUI
 * public class javax.swing.plaf.multi.MultiDesktopPaneUI}.
 *
...
public abstract interface MultiDesktopPaneUIClassTests<SUT extends MultiDesktopPaneUI>
extends DesktopPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiDesktopPaneUI.class!",
                   MultiDesktopPaneUI.class.isAssignableFrom(sut));
    }

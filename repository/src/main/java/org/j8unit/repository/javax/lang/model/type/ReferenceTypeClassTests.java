 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReferenceType
 * public abstract interface javax.lang.model.type.ReferenceType}.
 *
...
public abstract interface ReferenceTypeClassTests<SUT extends ReferenceType>
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReferenceType.class!",
                   ReferenceType.class.isAssignableFrom(sut));
    }

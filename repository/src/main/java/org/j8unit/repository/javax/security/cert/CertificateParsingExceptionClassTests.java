 ...
 * {@link CertificateParsingException public class javax.security.cert.CertificateParsingException}.
 *
...
public abstract interface CertificateParsingExceptionClassTests<SUT extends CertificateParsingException>
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertificateParsingException.class!",
                   CertificateParsingException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiProgressBarUI
 * public class javax.swing.plaf.multi.MultiProgressBarUI}.
 *
...
public abstract interface MultiProgressBarUIClassTests<SUT extends MultiProgressBarUI>
extends ProgressBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiProgressBarUI.class!",
                   MultiProgressBarUI.class.isAssignableFrom(sut));
    }

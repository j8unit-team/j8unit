 ...
 * javax.swing.plaf.metal.MetalComboBoxUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetalComboBoxUITests}).
 * </p>
 *
 * <p>
 ...
 * @see MetalComboBoxUITests MetalComboBoxUITests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.swing.plaf.basic.BasicComboBoxUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalComboBoxUI.class!",
                   javax.swing.plaf.metal.MetalComboBoxUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.metal.MetalComboBoxUI.MetalComboPopup class
     * javax.swing.plaf.metal.MetalComboBoxUI$MetalComboPopup}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link MetalComboBoxUITests.MetalComboPopupTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see MetalComboBoxUITests.MetalComboPopupTests MetalComboBoxUITests.MetalComboPopupTests (The complementary
    ...
    extends org.j8unit.repository.javax.swing.plaf.basic.BasicComboPopupClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalComboBoxUI.MetalComboPopup.class!",
                       javax.swing.plaf.metal.MetalComboBoxUI.MetalComboPopup.class.isAssignableFrom(sut));
        }
     ...
     * class javax.swing.plaf.metal.MetalComboBoxUI$MetalPropertyChangeListener}, containing all type relevant aspects
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link MetalComboBoxUITests.MetalPropertyChangeListenerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see MetalComboBoxUITests.MetalPropertyChangeListenerTests MetalComboBoxUITests.MetalPropertyChangeListenerTests
    ...
    extends org.j8unit.repository.javax.swing.plaf.basic.BasicComboBoxUIClassTests.PropertyChangeHandlerClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalComboBoxUI.MetalPropertyChangeListener.class!",
                       javax.swing.plaf.metal.MetalComboBoxUI.MetalPropertyChangeListener.class.isAssignableFrom(sut));
        }
     ...
     * class javax.swing.plaf.metal.MetalComboBoxUI$MetalComboBoxLayoutManager}, containing all type relevant aspects
     * (e.&thinsp;g., runtime constraints and further type specific requirements). (In addition, the runtime type of
     * this j8unit test interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link MetalComboBoxUITests.MetalComboBoxLayoutManagerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see MetalComboBoxUITests.MetalComboBoxLayoutManagerTests MetalComboBoxUITests.MetalComboBoxLayoutManagerTests
     *      (The complementary j8unit test interface containing the instance relevant test methods)
     *
     * @param SUT
     *            the class' type of the subject-under-test
    ...
    extends org.j8unit.repository.javax.swing.plaf.basic.BasicComboBoxUIClassTests.ComboBoxLayoutManagerClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalComboBoxUI.MetalComboBoxLayoutManager.class!",
                       javax.swing.plaf.metal.MetalComboBoxUI.MetalComboBoxLayoutManager.class.isAssignableFrom(sut));
        }

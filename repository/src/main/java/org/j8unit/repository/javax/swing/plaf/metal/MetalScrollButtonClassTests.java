...
import org.j8unit.repository.javax.swing.plaf.basic.BasicArrowButtonClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalScrollButton
 * public class javax.swing.plaf.metal.MetalScrollButton}.
 *
...
public abstract interface MetalScrollButtonClassTests<SUT extends MetalScrollButton>
extends BasicArrowButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalScrollButton.class!",
                   MetalScrollButton.class.isAssignableFrom(sut));
    }

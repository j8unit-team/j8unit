 ...
 * javax.management.remote.rmi.RMIServerImpl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIServerImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIServerImplTests}.
 * </p>
 *
 * @see javax.management.remote.rmi.RMIServerImpl class javax.management.remote.rmi.RMIServerImpl (the hereby targeted
 *      class-under-test class)
 * @see RMIServerImplTests RMIServerImplTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, RMIServerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIServerImpl.class!",
                   javax.management.remote.rmi.RMIServerImpl.class.isAssignableFrom(sut));
    }

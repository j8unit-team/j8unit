 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIServerImpl
...
public abstract interface RMIServerImplClassTests<SUT extends RMIServerImpl>
extends CloseableClassTests<SUT>, RMIServerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIServerImpl.class!",
                   RMIServerImpl.class.isAssignableFrom(sut));
    }

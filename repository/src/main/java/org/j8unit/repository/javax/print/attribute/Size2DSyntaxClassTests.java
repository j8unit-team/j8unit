 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Size2DSyntax public
 * abstract class javax.print.attribute.Size2DSyntax}.
 *
...
public abstract interface Size2DSyntaxClassTests<SUT extends Size2DSyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Size2DSyntax.class!",
                   Size2DSyntax.class.isAssignableFrom(sut));
    }

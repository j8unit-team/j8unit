...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.OpenMBeanAttributeInfo interface
 * javax.management.openmbean.OpenMBeanAttributeInfo}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenMBeanAttributeInfoTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.management.openmbean.OpenMBeanAttributeInfo interface javax.management.openmbean.OpenMBeanAttributeInfo
 *      (the hereby targeted class-under-test class)
 * @see OpenMBeanAttributeInfoTests OpenMBeanAttributeInfoTests (The complementary j8unit test interface containing the
...
public abstract interface OpenMBeanAttributeInfoClassTests<SUT extends javax.management.openmbean.OpenMBeanAttributeInfo>
extends OpenMBeanParameterInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenMBeanAttributeInfo.class!",
                   javax.management.openmbean.OpenMBeanAttributeInfo.class.isAssignableFrom(sut));
    }

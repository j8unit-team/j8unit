 ...
 * {@link OpenMBeanAttributeInfo public abstract interface javax.management.openmbean.OpenMBeanAttributeInfo}.
 *
...
extends OpenMBeanParameterInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanAttributeInfo.class!",
                   OpenMBeanAttributeInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TerminalFactory
...
public abstract interface TerminalFactoryClassTests<SUT extends TerminalFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TerminalFactory.class!",
                   TerminalFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuBarUI public
 * abstract class javax.swing.plaf.MenuBarUI}.
 *
...
public abstract interface MenuBarUIClassTests<SUT extends MenuBarUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.MenuBarUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuBarUI.class!",
                   MenuBarUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.MenuBarUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.MenuBarUI]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Icon public
 * abstract interface javax.swing.Icon}.
 *
...
public abstract interface IconClassTests<SUT extends Icon>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Icon.class!", Icon.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.xml.bind.annotation.XmlElementDeclTests.GLOBALTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlElementDecl
...
public abstract interface XmlElementDeclClassTests<SUT extends XmlElementDecl>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlElementDecl.class!",
                   XmlElementDecl.class.isAssignableFrom(sut));
    }
     ...
     * {@link GLOBAL public static final class javax.xml.bind.annotation.XmlElementDecl$GLOBAL}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link GLOBALTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface GLOBALClassTests<SUT extends GLOBAL>
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GLOBAL.class!",
                              GLOBAL.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiToolTipUI
 * public class javax.swing.plaf.multi.MultiToolTipUI}.
 *
...
public abstract interface MultiToolTipUIClassTests<SUT extends MultiToolTipUI>
extends ToolTipUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiToolTipUI.class!",
                   MultiToolTipUI.class.isAssignableFrom(sut));
    }

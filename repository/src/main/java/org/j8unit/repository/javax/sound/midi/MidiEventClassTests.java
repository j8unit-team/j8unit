 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiEvent public
...
public abstract interface MidiEventClassTests<SUT extends MidiEvent>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiEvent.class!",
                   MidiEvent.class.isAssignableFrom(sut));
    }

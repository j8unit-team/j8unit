 ...
 * javax.naming.AuthenticationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
extends NamingSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.AuthenticationException.class!",
                   javax.naming.AuthenticationException.class.isAssignableFrom(sut));
    }

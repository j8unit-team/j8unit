 ...
 * javax.swing.plaf.basic.BasicPasswordFieldUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicPasswordFieldUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicPasswordFieldUITests}
 * .
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicPasswordFieldUI class javax.swing.plaf.basic.BasicPasswordFieldUI (the hereby
 *      targeted class-under-test class)
 * @see BasicPasswordFieldUITests BasicPasswordFieldUITests (The complementary j8unit test interface containing the
...
extends BasicTextFieldUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicPasswordFieldUI.class!",
                   javax.swing.plaf.basic.BasicPasswordFieldUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.sound.sampled.FloatControl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FloatControlTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FloatControlTests}.
 * </p>
 *
 * @see javax.sound.sampled.FloatControl class javax.sound.sampled.FloatControl (the hereby targeted class-under-test
 *      class)
 * @see FloatControlTests FloatControlTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.FloatControl.class!",
                   javax.sound.sampled.FloatControl.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.FloatControl.Type class
     * javax.sound.sampled.FloatControl$Type}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link FloatControlTests.TypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see FloatControlTests.TypeTests FloatControlTests.TypeTests (The complementary j8unit test interface containing
    ...
    extends ControlClassTests.TypeClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.FloatControl.Type.class!",
                       javax.sound.sampled.FloatControl.Type.class.isAssignableFrom(sut));
        }

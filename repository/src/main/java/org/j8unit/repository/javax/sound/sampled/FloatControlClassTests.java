 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FloatControl public
 * abstract class javax.sound.sampled.FloatControl}.
 *
...
public abstract interface FloatControlClassTests<SUT extends FloatControl>
extends ControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FloatControl.class!",
                   FloatControl.class.isAssignableFrom(sut));
    }
     ...
     * {@link Type public static class javax.sound.sampled.FloatControl$Type}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

...
import org.j8unit.repository.javax.swing.plaf.basic.BasicTabbedPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthTabbedPaneUI
 * public class javax.swing.plaf.synth.SynthTabbedPaneUI}.
 *
...
public abstract interface SynthTabbedPaneUIClassTests<SUT extends SynthTabbedPaneUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicTabbedPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthTabbedPaneUI.class!",
                   SynthTabbedPaneUI.class.isAssignableFrom(sut));
    }

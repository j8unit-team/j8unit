 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AEADBadTagException
...
public abstract interface AEADBadTagExceptionClassTests<SUT extends AEADBadTagException>
extends BadPaddingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AEADBadTagException.class!",
                   AEADBadTagException.class.isAssignableFrom(sut));
    }

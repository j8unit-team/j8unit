 ...
 * javax.crypto.AEADBadTagException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AEADBadTagExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AEADBadTagExceptionTests}.
 * </p>
 *
 * @see javax.crypto.AEADBadTagException class javax.crypto.AEADBadTagException (the hereby targeted class-under-test
 *      class)
 * @see AEADBadTagExceptionTests AEADBadTagExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface AEADBadTagExceptionClassTests<SUT extends javax.crypto.AEADBadTagException>
extends BadPaddingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.AEADBadTagException.class!",
                   javax.crypto.AEADBadTagException.class.isAssignableFrom(sut));
    }

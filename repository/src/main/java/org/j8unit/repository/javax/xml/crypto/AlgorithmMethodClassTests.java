 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AlgorithmMethod
 * public abstract interface javax.xml.crypto.AlgorithmMethod}.
 *
...
public abstract interface AlgorithmMethodClassTests<SUT extends AlgorithmMethod>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlgorithmMethod.class!",
                   AlgorithmMethod.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLParseException
 * public class javax.management.modelmbean.XMLParseException}.
 *
...
public abstract interface XMLParseExceptionClassTests<SUT extends XMLParseException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLParseException.class!",
                   XMLParseException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OverlayLayout
...
public abstract interface OverlayLayoutClassTests<SUT extends OverlayLayout>
extends LayoutManager2ClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.OverlayLayout]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OverlayLayout.class!",
                   OverlayLayout.class.isAssignableFrom(sut));
    }

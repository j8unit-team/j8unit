 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobPriority public
 * final class javax.print.attribute.standard.JobPriority}.
 *
...
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobPriority.class!",
                   JobPriority.class.isAssignableFrom(sut));
    }

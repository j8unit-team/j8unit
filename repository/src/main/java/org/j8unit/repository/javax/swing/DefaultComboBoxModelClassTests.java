 ...
 * javax.swing.DefaultComboBoxModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultComboBoxModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultComboBoxModelTests}
 * .
 * </p>
 *
 * @see javax.swing.DefaultComboBoxModel class javax.swing.DefaultComboBoxModel (the hereby targeted class-under-test
 *      class)
 * @see DefaultComboBoxModelTests DefaultComboBoxModelTests (The complementary j8unit test interface containing the
...
extends MutableComboBoxModelClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractListModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.DefaultComboBoxModel.class!",
                   javax.swing.DefaultComboBoxModel.class.isAssignableFrom(sut));
    }

...
public abstract interface TimerClassTests<SUT extends javax.management.timer.Timer>
extends TimerMBeanClassTests<SUT>, org.j8unit.repository.javax.management.MBeanRegistrationClassTests<SUT>,
org.j8unit.repository.javax.management.NotificationBroadcasterSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.timer.Timer.class!",
                   javax.management.timer.Timer.class.isAssignableFrom(sut));
    }

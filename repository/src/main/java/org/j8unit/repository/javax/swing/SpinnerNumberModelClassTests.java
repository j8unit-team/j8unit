 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SpinnerNumberModel
 * public class javax.swing.SpinnerNumberModel}.
 *
...
public abstract interface SpinnerNumberModelClassTests<SUT extends SpinnerNumberModel>
extends AbstractSpinnerModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SpinnerNumberModel.class!",
                   SpinnerNumberModel.class.isAssignableFrom(sut));
    }

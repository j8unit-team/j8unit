...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.CanonicalizationMethod interface
 * javax.xml.crypto.dsig.CanonicalizationMethod}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CanonicalizationMethodTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.crypto.dsig.CanonicalizationMethod interface javax.xml.crypto.dsig.CanonicalizationMethod (the hereby
 *      targeted class-under-test class)
 * @see CanonicalizationMethodTests CanonicalizationMethodTests (The complementary j8unit test interface containing the
...
public abstract interface CanonicalizationMethodClassTests<SUT extends javax.xml.crypto.dsig.CanonicalizationMethod>
extends TransformClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.CanonicalizationMethod.class!",
                   javax.xml.crypto.dsig.CanonicalizationMethod.class.isAssignableFrom(sut));
    }

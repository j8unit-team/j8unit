 ...
 * javax.print.AttributeException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AttributeExceptionTests}.
 * </p>
 *
 * @see javax.print.AttributeException interface javax.print.AttributeException (the hereby targeted class-under-test
 *      class)
 * @see AttributeExceptionTests AttributeExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface AttributeExceptionClassTests<SUT extends javax.print.AttributeException>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.AttributeException.class!",
                   javax.print.AttributeException.class.isAssignableFrom(sut));
    }

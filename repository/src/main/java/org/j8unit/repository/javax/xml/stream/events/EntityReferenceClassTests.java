...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.events.EntityReference interface
 * javax.xml.stream.events.EntityReference}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EntityReferenceTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.stream.events.EntityReference interface javax.xml.stream.events.EntityReference (the hereby targeted
 *      class-under-test class)
 * @see EntityReferenceTests EntityReferenceTests (The complementary j8unit test interface containing the instance
...
public abstract interface EntityReferenceClassTests<SUT extends javax.xml.stream.events.EntityReference>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.EntityReference.class!",
                   javax.xml.stream.events.EntityReference.class.isAssignableFrom(sut));
    }

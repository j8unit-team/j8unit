 ...
 * javax.management.RuntimeErrorException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RuntimeErrorExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see RuntimeErrorExceptionTests RuntimeErrorExceptionTests (The complementary j8unit test interface containing the
...
extends JMRuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.RuntimeErrorException.class!",
                   javax.management.RuntimeErrorException.class.isAssignableFrom(sut));
    }

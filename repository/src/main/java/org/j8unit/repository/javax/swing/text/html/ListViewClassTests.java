 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListView public
...
public abstract interface ListViewClassTests<SUT extends ListView>
extends BlockViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListView.class!",
                   ListView.class.isAssignableFrom(sut));
    }

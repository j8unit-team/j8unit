 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListViewTests}.
 * </p>
 *
 * @see javax.swing.text.html.ListView class javax.swing.text.html.ListView (the hereby targeted class-under-test class)
 * @see ListViewTests ListViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ListViewClassTests<SUT extends javax.swing.text.html.ListView>
extends BlockViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.ListView.class!",
                   javax.swing.text.html.ListView.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicTextAreaUI class
 * javax.swing.plaf.basic.BasicTextAreaUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicTextAreaUITests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicTextAreaUITests BasicTextAreaUITests (The complementary j8unit test interface containing the instance
...
public abstract interface BasicTextAreaUIClassTests<SUT extends javax.swing.plaf.basic.BasicTextAreaUI>
extends BasicTextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTextAreaUI.class!",
                   javax.swing.plaf.basic.BasicTextAreaUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.bind.annotation.adapters.CollapsedStringAdapter}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollapsedStringAdapterTests}).
 * </p>
 *
 * <p>
 ...
 * @see CollapsedStringAdapterTests CollapsedStringAdapterTests (The complementary j8unit test interface containing the
...
extends XmlAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.adapters.CollapsedStringAdapter.class!",
                   javax.xml.bind.annotation.adapters.CollapsedStringAdapter.class.isAssignableFrom(sut));
    }

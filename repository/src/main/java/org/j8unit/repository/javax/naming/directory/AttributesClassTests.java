...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.directory.Attributes interface
 * javax.naming.directory.Attributes}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.Attributes.class!",
                   javax.naming.directory.Attributes.class.isAssignableFrom(sut));
    }

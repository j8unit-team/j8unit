 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeCellRenderer
 * public abstract interface javax.swing.tree.TreeCellRenderer}.
 *
...
public abstract interface TreeCellRendererClassTests<SUT extends TreeCellRenderer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeCellRenderer.class!",
                   TreeCellRenderer.class.isAssignableFrom(sut));
    }

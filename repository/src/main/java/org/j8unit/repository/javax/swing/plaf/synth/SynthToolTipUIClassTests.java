...
import org.j8unit.repository.javax.swing.plaf.basic.BasicToolTipUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthToolTipUI
 * public class javax.swing.plaf.synth.SynthToolTipUI}.
 *
...
public abstract interface SynthToolTipUIClassTests<SUT extends SynthToolTipUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicToolTipUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthToolTipUI.class!",
                   SynthToolTipUI.class.isAssignableFrom(sut));
    }

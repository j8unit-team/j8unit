 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoleUnresolvedList
 * public class javax.management.relation.RoleUnresolvedList}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RoleUnresolvedListTests}.
 * </p>
 *
 * <p>
...
public abstract interface RoleUnresolvedListClassTests<SUT extends RoleUnresolvedList>
extends ArrayListClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.relation.RoleUnresolvedList]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleUnresolvedList.class!",
                   RoleUnresolvedList.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.relation.RoleUnresolvedList]

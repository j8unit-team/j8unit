 ...
 * javax.management.relation.RoleUnresolvedList}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RoleUnresolvedListTests}).
 * </p>
 *
 * <p>
 ...
 * @see RoleUnresolvedListTests RoleUnresolvedListTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.ArrayListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RoleUnresolvedList.class!",
                   javax.management.relation.RoleUnresolvedList.class.isAssignableFrom(sut));
    }

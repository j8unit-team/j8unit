...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.xpath.XPathFunctionResolver interface
 * javax.xml.xpath.XPathFunctionResolver}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathFunctionResolverTests}).
 * </p>
 *
 * <p>
 ...
 * {@link XPathFunctionResolverTests}.
 * </p>
 *
 * @see javax.xml.xpath.XPathFunctionResolver interface javax.xml.xpath.XPathFunctionResolver (the hereby targeted
 *      class-under-test class)
 * @see XPathFunctionResolverTests XPathFunctionResolverTests (The complementary j8unit test interface containing the
...
public abstract interface XPathFunctionResolverClassTests<SUT extends javax.xml.xpath.XPathFunctionResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.xpath.XPathFunctionResolver.class!",
                   javax.xml.xpath.XPathFunctionResolver.class.isAssignableFrom(sut));
    }

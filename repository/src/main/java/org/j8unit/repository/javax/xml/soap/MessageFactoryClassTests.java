 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MessageFactory
...
public abstract interface MessageFactoryClassTests<SUT extends MessageFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MessageFactory.class!",
                   MessageFactory.class.isAssignableFrom(sut));
    }

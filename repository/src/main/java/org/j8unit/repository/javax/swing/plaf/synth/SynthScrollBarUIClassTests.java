...
import org.j8unit.repository.javax.swing.plaf.basic.BasicScrollBarUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthScrollBarUI
 * public class javax.swing.plaf.synth.SynthScrollBarUI}.
 *
...
public abstract interface SynthScrollBarUIClassTests<SUT extends SynthScrollBarUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicScrollBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthScrollBarUI.class!",
                   SynthScrollBarUI.class.isAssignableFrom(sut));
    }

...
public abstract interface HashPrintRequestAttributeSetClassTests<SUT extends HashPrintRequestAttributeSet>
extends PrintRequestAttributeSetClassTests<SUT>, HashAttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HashPrintRequestAttributeSet.class!",
                   HashPrintRequestAttributeSet.class.isAssignableFrom(sut));
    }

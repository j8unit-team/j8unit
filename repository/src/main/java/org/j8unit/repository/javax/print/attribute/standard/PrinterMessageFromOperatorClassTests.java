 ...
 * {@link PrinterMessageFromOperator public final class javax.print.attribute.standard.PrinterMessageFromOperator}.
 *
...
public abstract interface PrinterMessageFromOperatorClassTests<SUT extends PrinterMessageFromOperator>
extends PrintServiceAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterMessageFromOperator.class!",
                   PrinterMessageFromOperator.class.isAssignableFrom(sut));
    }

 ...
 * methods is {@link org.j8unit.repository.javax.swing.event.DocumentEventTests}.
 * </p>
 *
 * <p>
...
extends J8UnitTest<SUT>
{
    ...
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends javax.swing.event.DocumentEvent> sut = createNewSUT();
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.javax.swing.event.DocumentEventTests.ElementChangeTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends J8UnitTest<SUT>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends javax.swing.event.DocumentEvent.ElementChange> sut = createNewSUT();
            // assert assignability
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.javax.swing.event.DocumentEventTests.EventTypeTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends javax.swing.event.DocumentEvent.EventType> sut = createNewSUT();
            // assert assignability

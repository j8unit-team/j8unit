...
public abstract interface JMXConnectorServerProviderClassTests<SUT extends JMXConnectorServerProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXConnectorServerProvider.class!",

 ...
 * {@link BadLocationException public class javax.swing.text.BadLocationException}.
 *
 ...
 * {@link BadLocationExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface BadLocationExceptionClassTests<SUT extends BadLocationException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BadLocationException.class!",
                   BadLocationException.class.isAssignableFrom(sut));
    }

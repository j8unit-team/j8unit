 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameParser public
 * abstract interface javax.naming.NameParser}.
 *
...
public abstract interface NameParserClassTests<SUT extends NameParser>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameParser.class!",
                   NameParser.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NameParserTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NameParserTests}.
 * </p>
 *
 * @see javax.naming.NameParser interface javax.naming.NameParser (the hereby targeted class-under-test class)
 * @see NameParserTests NameParserTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NameParserClassTests<SUT extends javax.naming.NameParser>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NameParser.class!",
                   javax.naming.NameParser.class.isAssignableFrom(sut));
    }

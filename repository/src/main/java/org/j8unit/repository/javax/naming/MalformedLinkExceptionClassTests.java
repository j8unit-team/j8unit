...
public abstract interface MalformedLinkExceptionClassTests<SUT extends MalformedLinkException>
extends LinkExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MalformedLinkException.class!",
                   MalformedLinkException.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.MalformedLinkException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MalformedLinkExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MalformedLinkExceptionTests}.
 * </p>
 *
 * @see javax.naming.MalformedLinkException class javax.naming.MalformedLinkException (the hereby targeted
 *      class-under-test class)
 * @see MalformedLinkExceptionTests MalformedLinkExceptionTests (The complementary j8unit test interface containing the
...
extends LinkExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.MalformedLinkException.class!",
                   javax.naming.MalformedLinkException.class.isAssignableFrom(sut));
    }

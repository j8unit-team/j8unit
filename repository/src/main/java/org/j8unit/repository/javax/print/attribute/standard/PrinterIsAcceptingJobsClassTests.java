...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.PrinterIsAcceptingJobs class
 * javax.print.attribute.standard.PrinterIsAcceptingJobs}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterIsAcceptingJobsTests}).
 * </p>
 *
 * <p>
 ...
 * @see PrinterIsAcceptingJobsTests PrinterIsAcceptingJobsTests (The complementary j8unit test interface containing the
...
public abstract interface PrinterIsAcceptingJobsClassTests<SUT extends javax.print.attribute.standard.PrinterIsAcceptingJobs>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterIsAcceptingJobs.class!",
                   javax.print.attribute.standard.PrinterIsAcceptingJobs.class.isAssignableFrom(sut));
    }

...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterIsAcceptingJobs.class!",
                   PrinterIsAcceptingJobs.class.isAssignableFrom(sut));
    }

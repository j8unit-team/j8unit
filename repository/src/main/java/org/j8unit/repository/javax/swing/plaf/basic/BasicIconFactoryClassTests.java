 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicIconFactory
 * public class javax.swing.plaf.basic.BasicIconFactory}.
 *
...
public abstract interface BasicIconFactoryClassTests<SUT extends BasicIconFactory>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicIconFactory]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicIconFactory.class!",
                   BasicIconFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleText
...
public abstract interface AccessibleTextClassTests<SUT extends AccessibleText>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleText.class!",
                   AccessibleText.class.isAssignableFrom(sut));
    }

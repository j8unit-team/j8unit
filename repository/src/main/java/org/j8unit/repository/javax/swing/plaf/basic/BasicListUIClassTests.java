...
import org.j8unit.repository.javax.swing.plaf.ListUIClassTests;
import org.j8unit.repository.javax.swing.plaf.basic.BasicListUITests.ListSelectionHandlerTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicListUI public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicListUITests}.
 * </p>
 *
 * <p>
...
public abstract interface BasicListUIClassTests<SUT extends BasicListUI>
extends ListUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicListUI.class!",
                   BasicListUI.class.isAssignableFrom(sut));
    }
     ...
     * {@link ListSelectionHandlerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ListSelectionHandlerClassTests<SUT extends ListSelectionHandler>
    extends ListSelectionListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListSelectionHandler.class!",
                              ListSelectionHandler.class.isAssignableFrom(sut));
        }
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ListDataHandlerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>

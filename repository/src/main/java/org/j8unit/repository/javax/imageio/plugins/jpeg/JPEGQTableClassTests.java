 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JPEGQTable public
...
public abstract interface JPEGQTableClassTests<SUT extends JPEGQTable>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JPEGQTable.class!",
                   JPEGQTable.class.isAssignableFrom(sut));
    }

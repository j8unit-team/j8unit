 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlTransient public
 * abstract @interface javax.xml.bind.annotation.XmlTransient}.
 *
...
public abstract interface XmlTransientClassTests<SUT extends XmlTransient>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlTransient.class!",
                   XmlTransient.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.bind.annotation.XmlTransient]

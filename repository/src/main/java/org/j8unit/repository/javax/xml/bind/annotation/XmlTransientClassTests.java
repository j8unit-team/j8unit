...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlTransient interface
 * javax.xml.bind.annotation.XmlTransient}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlTransientTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlTransientTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlTransient interface javax.xml.bind.annotation.XmlTransient (the hereby targeted
 *      class-under-test class)
 * @see XmlTransientTests XmlTransientTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XmlTransientClassTests<SUT extends javax.xml.bind.annotation.XmlTransient>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlTransient.class!",
                   javax.xml.bind.annotation.XmlTransient.class.isAssignableFrom(sut));
    }

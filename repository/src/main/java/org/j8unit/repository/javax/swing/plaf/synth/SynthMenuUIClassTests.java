...
import org.j8unit.repository.javax.swing.plaf.basic.BasicMenuUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthMenuUI public
...
public abstract interface SynthMenuUIClassTests<SUT extends SynthMenuUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicMenuUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthMenuUI.class!",
                   SynthMenuUI.class.isAssignableFrom(sut));
    }

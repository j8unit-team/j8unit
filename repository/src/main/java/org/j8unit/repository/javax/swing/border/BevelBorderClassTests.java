 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BevelBorderTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.border.BevelBorder class javax.swing.border.BevelBorder (the hereby targeted class-under-test class)
 * @see BevelBorderTests BevelBorderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BevelBorderClassTests<SUT extends javax.swing.border.BevelBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.BevelBorder.class!",
                   javax.swing.border.BevelBorder.class.isAssignableFrom(sut));
    }

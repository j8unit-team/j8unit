 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalLookAndFeel
 * public class javax.swing.plaf.metal.MetalLookAndFeel}.
 *
...
public abstract interface MetalLookAndFeelClassTests<SUT extends MetalLookAndFeel>
extends BasicLookAndFeelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalLookAndFeel.class!",
                   MetalLookAndFeel.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.PanelUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicPanelUI public
...
public abstract interface BasicPanelUIClassTests<SUT extends BasicPanelUI>
extends PanelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicPanelUI.class!",
                   BasicPanelUI.class.isAssignableFrom(sut));
    }

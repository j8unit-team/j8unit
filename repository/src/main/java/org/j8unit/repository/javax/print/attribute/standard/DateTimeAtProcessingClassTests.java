 ...
 * javax.print.attribute.standard.DateTimeAtProcessing}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTimeAtProcessingTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateTimeAtProcessingTests}
 * .
 * </p>
 *
 ...
 * @see DateTimeAtProcessingTests DateTimeAtProcessingTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.javax.print.attribute.DateTimeSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.DateTimeAtProcessing.class!",
                   javax.print.attribute.standard.DateTimeAtProcessing.class.isAssignableFrom(sut));
    }

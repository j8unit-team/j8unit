...
public abstract interface RelationNotificationClassTests<SUT extends RelationNotification>
extends org.j8unit.repository.javax.management.NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationNotification.class!",
                   RelationNotification.class.isAssignableFrom(sut));
    }

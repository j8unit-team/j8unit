 ...
 * javax.management.relation.RelationNotification}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RelationNotificationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RelationNotificationTests}
 * .
 * </p>
 *
 * @see javax.management.relation.RelationNotification class javax.management.relation.RelationNotification (the hereby
 *      targeted class-under-test class)
 * @see RelationNotificationTests RelationNotificationTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.management.NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationNotification.class!",
                   javax.management.relation.RelationNotification.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link QueryEval public
 * abstract class javax.management.QueryEval}.
 *
...
public abstract interface QueryEvalClassTests<SUT extends QueryEval>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to QueryEval.class!",

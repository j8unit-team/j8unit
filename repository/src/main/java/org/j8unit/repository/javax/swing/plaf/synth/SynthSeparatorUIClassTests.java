 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthSeparatorUI
 * public class javax.swing.plaf.synth.SynthSeparatorUI}.
 *
...
public abstract interface SynthSeparatorUIClassTests<SUT extends SynthSeparatorUI>
...
org.j8unit.repository.javax.swing.plaf.SeparatorUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthSeparatorUI.class!",
                   SynthSeparatorUI.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link javax.xml.crypto.dsig.Reference interface javax.xml.crypto.dsig.Reference}, containing all
...
extends org.j8unit.repository.javax.xml.crypto.URIReferenceTests<SUT>, org.j8unit.repository.javax.xml.crypto.XMLStructureTests<SUT> {
    ...
    public default void test_getCalculatedDigestValue()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getDigestValue()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

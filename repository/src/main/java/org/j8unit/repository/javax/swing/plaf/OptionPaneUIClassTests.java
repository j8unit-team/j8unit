 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OptionPaneUITests}).
 * </p>
 *
 * <p>
 ...
 * @see OptionPaneUITests OptionPaneUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface OptionPaneUIClassTests<SUT extends javax.swing.plaf.OptionPaneUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.OptionPaneUI.class!",
                   javax.swing.plaf.OptionPaneUI.class.isAssignableFrom(sut));
    }

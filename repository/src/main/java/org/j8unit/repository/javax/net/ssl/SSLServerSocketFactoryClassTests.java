...
import org.j8unit.repository.javax.net.ServerSocketFactoryClassTests;
 ...
 * {@link SSLServerSocketFactory public abstract class javax.net.ssl.SSLServerSocketFactory}.
 *
 ...
 * {@link org.j8unit.repository.javax.net.ssl.SSLServerSocketFactoryTests}.
 * </p>
 *
 * <p>
...
public abstract interface SSLServerSocketFactoryClassTests<SUT extends SSLServerSocketFactory>
extends ServerSocketFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLServerSocketFactory.class!",
                   SSLServerSocketFactory.class.isAssignableFrom(sut));
    }

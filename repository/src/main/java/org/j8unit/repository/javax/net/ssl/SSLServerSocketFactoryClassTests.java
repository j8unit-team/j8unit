...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.net.ssl.SSLServerSocketFactory class
 * javax.net.ssl.SSLServerSocketFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLServerSocketFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SSLServerSocketFactoryTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLServerSocketFactory class javax.net.ssl.SSLServerSocketFactory (the hereby targeted
 *      class-under-test class)
 * @see SSLServerSocketFactoryTests SSLServerSocketFactoryTests (The complementary j8unit test interface containing the
...
public abstract interface SSLServerSocketFactoryClassTests<SUT extends javax.net.ssl.SSLServerSocketFactory>
extends org.j8unit.repository.javax.net.ServerSocketFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLServerSocketFactory.class!",
                   javax.net.ssl.SSLServerSocketFactory.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.datatype.XMLGregorianCalendar class
 * javax.xml.datatype.XMLGregorianCalendar}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLGregorianCalendarTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLGregorianCalendarTests}
 * .
 * </p>
 *
 * @see javax.xml.datatype.XMLGregorianCalendar class javax.xml.datatype.XMLGregorianCalendar (the hereby targeted
 *      class-under-test class)
 * @see XMLGregorianCalendarTests XMLGregorianCalendarTests (The complementary j8unit test interface containing the
...
public abstract interface XMLGregorianCalendarClassTests<SUT extends javax.xml.datatype.XMLGregorianCalendar>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.datatype.XMLGregorianCalendar.class!",
                   javax.xml.datatype.XMLGregorianCalendar.class.isAssignableFrom(sut));
    }

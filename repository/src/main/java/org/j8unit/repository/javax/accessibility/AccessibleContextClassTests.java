 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleContext
...
public abstract interface AccessibleContextClassTests<SUT extends AccessibleContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleContext.class!",
                   AccessibleContext.class.isAssignableFrom(sut));
    }

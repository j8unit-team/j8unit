 ...
 * javax.management.openmbean.OpenMBeanOperationInfoSupport}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * {@link OpenMBeanOperationInfoSupportTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.management.openmbean.OpenMBeanOperationInfoSupport class
 *      javax.management.openmbean.OpenMBeanOperationInfoSupport (the hereby targeted class-under-test class)
 * @see OpenMBeanOperationInfoSupportTests OpenMBeanOperationInfoSupportTests (The complementary j8unit test interface
...
extends OpenMBeanOperationInfoClassTests<SUT>, org.j8unit.repository.javax.management.MBeanOperationInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenMBeanOperationInfoSupport.class!",
                   javax.management.openmbean.OpenMBeanOperationInfoSupport.class.isAssignableFrom(sut));
    }

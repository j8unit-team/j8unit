...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.MBeanServerConnection interface
 * javax.management.MBeanServerConnection}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanServerConnectionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MBeanServerConnectionTests}.
 * </p>
 *
 * @see javax.management.MBeanServerConnection interface javax.management.MBeanServerConnection (the hereby targeted
 *      class-under-test class)
 * @see MBeanServerConnectionTests MBeanServerConnectionTests (The complementary j8unit test interface containing the
...
public abstract interface MBeanServerConnectionClassTests<SUT extends javax.management.MBeanServerConnection>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanServerConnection.class!",
                   javax.management.MBeanServerConnection.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoleInfo public
...
public abstract interface RoleInfoClassTests<SUT extends RoleInfo>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleInfo.class!",
                   RoleInfo.class.isAssignableFrom(sut));
    }

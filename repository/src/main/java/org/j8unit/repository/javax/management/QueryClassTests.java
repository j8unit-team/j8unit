 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Query public class
...
public abstract interface QueryClassTests<SUT extends Query>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.Query]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Query.class!", Query.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.Query]

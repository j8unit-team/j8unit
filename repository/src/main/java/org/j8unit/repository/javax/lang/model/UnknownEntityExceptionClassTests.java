...
public abstract interface UnknownEntityExceptionClassTests<SUT extends UnknownEntityException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownEntityException.class!",
                   UnknownEntityException.class.isAssignableFrom(sut));
    }

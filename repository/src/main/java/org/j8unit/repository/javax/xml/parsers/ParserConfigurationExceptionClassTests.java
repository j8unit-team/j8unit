...
public abstract interface ParserConfigurationExceptionClassTests<SUT extends ParserConfigurationException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParserConfigurationException.class!",
                   ParserConfigurationException.class.isAssignableFrom(sut));
    }

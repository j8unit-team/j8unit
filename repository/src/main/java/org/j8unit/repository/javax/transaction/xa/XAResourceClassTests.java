 ...
 * javax.transaction.xa.XAResource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XAResourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XAResourceTests}.
 * </p>
 *
 * @see javax.transaction.xa.XAResource interface javax.transaction.xa.XAResource (the hereby targeted class-under-test
 *      class)
 * @see XAResourceTests XAResourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XAResourceClassTests<SUT extends javax.transaction.xa.XAResource>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.transaction.xa.XAResource.class!",
                   javax.transaction.xa.XAResource.class.isAssignableFrom(sut));
    }

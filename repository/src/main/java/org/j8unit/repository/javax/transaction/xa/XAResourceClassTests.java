 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XAResource public
 * abstract interface javax.transaction.xa.XAResource}.
 *
...
public abstract interface XAResourceClassTests<SUT extends XAResource>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XAResource.class!",
                   XAResource.class.isAssignableFrom(sut));
    }

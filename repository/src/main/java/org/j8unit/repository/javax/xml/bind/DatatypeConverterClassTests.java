 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DatatypeConverter
...
public abstract interface DatatypeConverterClassTests<SUT extends DatatypeConverter>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatatypeConverter.class!",
                   DatatypeConverter.class.isAssignableFrom(sut));
    }

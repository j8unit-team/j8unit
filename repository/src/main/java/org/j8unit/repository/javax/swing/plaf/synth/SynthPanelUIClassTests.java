 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthPanelUI public
...
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicPanelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthPanelUI.class!",
                   SynthPanelUI.class.isAssignableFrom(sut));
    }

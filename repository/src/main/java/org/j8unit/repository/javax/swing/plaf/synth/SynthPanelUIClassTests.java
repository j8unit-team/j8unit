 ...
 * javax.swing.plaf.synth.SynthPanelUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthPanelUITests}).
 * </p>
 *
 * <p>
 ...
 * @see SynthPanelUITests SynthPanelUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.swing.plaf.basic.BasicPanelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthPanelUI.class!",
                   javax.swing.plaf.synth.SynthPanelUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleAttributeSet
 * public class javax.swing.text.SimpleAttributeSet}.
 *
...
public abstract interface SimpleAttributeSetClassTests<SUT extends SimpleAttributeSet>
extends MutableAttributeSetClassTests<SUT>, SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleAttributeSet.class!",
                   SimpleAttributeSet.class.isAssignableFrom(sut));
    }

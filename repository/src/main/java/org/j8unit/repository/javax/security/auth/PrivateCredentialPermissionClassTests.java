 ...
 * javax.security.auth.PrivateCredentialPermission}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see PrivateCredentialPermissionTests PrivateCredentialPermissionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.security.PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.PrivateCredentialPermission.class!",
                   javax.security.auth.PrivateCredentialPermission.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIIIOPServerImpl
 * public class javax.management.remote.rmi.RMIIIOPServerImpl}.
 *
...
public abstract interface RMIIIOPServerImplClassTests<SUT extends RMIIIOPServerImpl>
extends RMIServerImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIIIOPServerImpl.class!",
                   RMIIIOPServerImpl.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.remote.rmi.RMIIIOPServerImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIIIOPServerImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIIIOPServerImplTests}.
 * </p>
 *
 * @see javax.management.remote.rmi.RMIIIOPServerImpl class javax.management.remote.rmi.RMIIIOPServerImpl (the hereby
 *      targeted class-under-test class)
 * @see RMIIIOPServerImplTests RMIIIOPServerImplTests (The complementary j8unit test interface containing the instance
...
extends RMIServerImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIIIOPServerImpl.class!",
                   javax.management.remote.rmi.RMIIIOPServerImpl.class.isAssignableFrom(sut));
    }

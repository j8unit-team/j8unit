 ...
 * javax.print.attribute.PrintJobAttributeSet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintJobAttributeSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintJobAttributeSetTests}
 * .
 * </p>
 *
 * @see javax.print.attribute.PrintJobAttributeSet interface javax.print.attribute.PrintJobAttributeSet (the hereby
 *      targeted class-under-test class)
 * @see PrintJobAttributeSetTests PrintJobAttributeSetTests (The complementary j8unit test interface containing the
...
public abstract interface PrintJobAttributeSetClassTests<SUT extends javax.print.attribute.PrintJobAttributeSet>
extends AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.PrintJobAttributeSet.class!",
                   javax.print.attribute.PrintJobAttributeSet.class.isAssignableFrom(sut));
    }

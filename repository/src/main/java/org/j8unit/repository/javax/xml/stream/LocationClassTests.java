 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocationTests}).
 * </p>
 *
 * <p>
 ...
 * @see LocationTests LocationTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LocationClassTests<SUT extends javax.xml.stream.Location>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.Location.class!",
                   javax.xml.stream.Location.class.isAssignableFrom(sut));
    }

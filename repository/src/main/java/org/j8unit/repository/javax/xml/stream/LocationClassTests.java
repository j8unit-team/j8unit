 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Location public
 * abstract interface javax.xml.stream.Location}.
 *
...
public abstract interface LocationClassTests<SUT extends Location>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Location.class!",

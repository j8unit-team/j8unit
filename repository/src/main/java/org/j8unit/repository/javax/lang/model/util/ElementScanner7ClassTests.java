 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ElementScanner7
...
public abstract interface ElementScanner7ClassTests<SUT extends ElementScanner7>
extends ElementScanner6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementScanner7.class!",
                   ElementScanner7.class.isAssignableFrom(sut));
    }

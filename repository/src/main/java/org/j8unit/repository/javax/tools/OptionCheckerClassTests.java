 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OptionCheckerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OptionCheckerTests}.
 * </p>
 *
 * @see javax.tools.OptionChecker interface javax.tools.OptionChecker (the hereby targeted class-under-test class)
 * @see OptionCheckerTests OptionCheckerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface OptionCheckerClassTests<SUT extends javax.tools.OptionChecker>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.OptionChecker.class!",
                   javax.tools.OptionChecker.class.isAssignableFrom(sut));
    }

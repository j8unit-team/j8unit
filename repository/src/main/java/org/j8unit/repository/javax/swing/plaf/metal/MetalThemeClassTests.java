 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalTheme public
 * abstract class javax.swing.plaf.metal.MetalTheme}.
 *
...
public abstract interface MetalThemeClassTests<SUT extends MetalTheme>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalTheme]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalTheme.class!",
                   MetalTheme.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.metal.MetalTheme]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.metal.MetalTheme]

 ...
 * javax.swing.plaf.basic.BasicButtonListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicButtonListenerTests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicButtonListenerTests BasicButtonListenerTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.beans.PropertyChangeListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicButtonListener.class!",
                   javax.swing.plaf.basic.BasicButtonListener.class.isAssignableFrom(sut));
    }

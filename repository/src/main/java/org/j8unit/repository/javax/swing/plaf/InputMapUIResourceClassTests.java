...
import org.j8unit.repository.javax.swing.InputMapClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMapUIResource
 * public class javax.swing.plaf.InputMapUIResource}.
 *
...
public abstract interface InputMapUIResourceClassTests<SUT extends InputMapUIResource>
extends UIResourceClassTests<SUT>, InputMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMapUIResource.class!",
                   InputMapUIResource.class.isAssignableFrom(sut));
    }

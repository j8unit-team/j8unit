 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GapContent public
...
public abstract interface GapContentClassTests<SUT extends GapContent>
extends ContentClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GapContent.class!",

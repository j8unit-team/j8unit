 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TerminalFactorySpi
 * public abstract class javax.smartcardio.TerminalFactorySpi}.
 *
...
public abstract interface TerminalFactorySpiClassTests<SUT extends TerminalFactorySpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TerminalFactorySpi.class!",
                   TerminalFactorySpi.class.isAssignableFrom(sut));
    }

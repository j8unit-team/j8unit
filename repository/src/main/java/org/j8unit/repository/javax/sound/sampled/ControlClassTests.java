 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Control public
...
public abstract interface ControlClassTests<SUT extends Control>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Control.class!",
     ...
     * {@link Type public static class javax.sound.sampled.Control$Type}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

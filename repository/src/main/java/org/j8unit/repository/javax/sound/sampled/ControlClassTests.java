 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ControlTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ControlTests}.
 * </p>
 *
 * @see javax.sound.sampled.Control class javax.sound.sampled.Control (the hereby targeted class-under-test class)
 * @see ControlTests ControlTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ControlClassTests<SUT extends javax.sound.sampled.Control>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Control.class!",
                   javax.sound.sampled.Control.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.Control.Type class
     * javax.sound.sampled.Control$Type}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link ControlTests.TypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * {@link ControlTests.TypeTests}.
     * </p>
     *
     * @see javax.sound.sampled.Control.Type class javax.sound.sampled.Control$Type (the hereby targeted
     *      class-under-test class)
     * @see ControlTests.TypeTests ControlTests.TypeTests (The complementary j8unit test interface containing the
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface TypeClassTests<SUT extends javax.sound.sampled.Control.Type>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Control.Type.class!",
                       javax.sound.sampled.Control.Type.class.isAssignableFrom(sut));
        }

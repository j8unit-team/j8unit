 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TableModel public
...
public abstract interface TableModelClassTests<SUT extends TableModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableModel.class!",
                   TableModel.class.isAssignableFrom(sut));
    }

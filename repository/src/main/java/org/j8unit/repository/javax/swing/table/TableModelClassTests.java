...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.table.TableModel interface javax.swing.table.TableModel},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TableModelTests}.
 * </p>
 *
 * @see javax.swing.table.TableModel interface javax.swing.table.TableModel (the hereby targeted class-under-test class)
 * @see TableModelTests TableModelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TableModelClassTests<SUT extends javax.swing.table.TableModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.table.TableModel.class!",
                   javax.swing.table.TableModel.class.isAssignableFrom(sut));
    }

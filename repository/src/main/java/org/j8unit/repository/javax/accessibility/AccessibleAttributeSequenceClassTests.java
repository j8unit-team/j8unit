...
public abstract interface AccessibleAttributeSequenceClassTests<SUT extends AccessibleAttributeSequence>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleAttributeSequence.class!",
                   AccessibleAttributeSequence.class.isAssignableFrom(sut));
    }

 ...
 * javax.annotation.processing.ProcessingEnvironment}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProcessingEnvironmentTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ProcessingEnvironmentTests}.
 * </p>
 *
 ...
 * @see ProcessingEnvironmentTests ProcessingEnvironmentTests (The complementary j8unit test interface containing the
...
public abstract interface ProcessingEnvironmentClassTests<SUT extends javax.annotation.processing.ProcessingEnvironment>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.ProcessingEnvironment.class!",
                   javax.annotation.processing.ProcessingEnvironment.class.isAssignableFrom(sut));
    }

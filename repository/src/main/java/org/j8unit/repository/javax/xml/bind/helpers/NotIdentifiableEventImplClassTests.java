 ...
 * javax.xml.bind.helpers.NotIdentifiableEventImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotIdentifiableEventImplTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.bind.helpers.NotIdentifiableEventImpl class javax.xml.bind.helpers.NotIdentifiableEventImpl (the
 *      hereby targeted class-under-test class)
 * @see NotIdentifiableEventImplTests NotIdentifiableEventImplTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.xml.bind.NotIdentifiableEventClassTests<SUT>, ValidationEventImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.helpers.NotIdentifiableEventImpl.class!",
                   javax.xml.bind.helpers.NotIdentifiableEventImpl.class.isAssignableFrom(sut));
    }

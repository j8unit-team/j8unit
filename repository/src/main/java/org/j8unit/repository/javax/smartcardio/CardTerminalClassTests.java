 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CardTerminal public
 * abstract class javax.smartcardio.CardTerminal}.
 *
...
public abstract interface CardTerminalClassTests<SUT extends CardTerminal>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CardTerminal.class!",
                   CardTerminal.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMap public
...
public abstract interface InputMapClassTests<SUT extends InputMap>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMap.class!",
                   InputMap.class.isAssignableFrom(sut));
    }

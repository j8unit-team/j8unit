 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Binding public
...
public abstract interface BindingClassTests<SUT extends Binding>
extends NameClassPairClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Binding.class!",
                   Binding.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.Binding class javax.naming.Binding}, containing all type
...
extends NameClassPairClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.Binding.class!",
                   javax.naming.Binding.class.isAssignableFrom(sut));
    }

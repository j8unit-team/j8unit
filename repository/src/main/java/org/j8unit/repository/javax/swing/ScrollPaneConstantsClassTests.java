 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScrollPaneConstants
 * public abstract interface javax.swing.ScrollPaneConstants}.
 *
...
public abstract interface ScrollPaneConstantsClassTests<SUT extends ScrollPaneConstants>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScrollPaneConstants.class!",
                   ScrollPaneConstants.class.isAssignableFrom(sut));
    }

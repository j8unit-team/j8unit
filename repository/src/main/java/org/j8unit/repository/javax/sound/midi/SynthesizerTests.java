 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link Synthesizer
 * public abstract interface javax.sound.midi.Synthesizer}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.sound.midi.SynthesizerClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface SynthesizerTests<SUT extends Synthesizer>
extends MidiDeviceTests<SUT> {
     ...
     * {@link javax.sound.midi.Synthesizer#unloadAllInstruments(javax.sound.midi.Soundbank) public abstract void
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link javax.sound.midi.Synthesizer#isSoundbankSupported(javax.sound.midi.Soundbank) public abstract boolean
    ...
    @Test
    @Category(Draft.class)
    public default void test_isSoundbankSupported_Soundbank()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_loadInstruments_Soundbank_PatchArray()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link javax.sound.midi.Synthesizer#loadInstrument(javax.sound.midi.Instrument) public abstract boolean
    ...
    @Test
    @Category(Draft.class)
    public default void test_loadInstrument_Instrument()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link javax.sound.midi.Synthesizer#getVoiceStatus() public
     * abstract javax.sound.midi.VoiceStatus[] javax.sound.midi.Synthesizer.getVoiceStatus()}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link javax.sound.midi.Synthesizer#loadAllInstruments(javax.sound.midi.Soundbank) public abstract boolean
    ...
    @Test
    @Category(Draft.class)
    public default void test_remapInstrument_Instrument_Instrument()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link javax.sound.midi.Synthesizer#getLoadedInstruments()
     * public abstract javax.sound.midi.Instrument[] javax.sound.midi.Synthesizer.getLoadedInstruments()}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link javax.sound.midi.Synthesizer#unloadInstrument(javax.sound.midi.Instrument) public abstract void
    ...
    @Test
    @Category(Draft.class)
    public default void test_unloadInstrument_Instrument()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link javax.sound.midi.Synthesizer#getChannels() public
     * abstract javax.sound.midi.MidiChannel[] javax.sound.midi.Synthesizer.getChannels()}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.

...
import org.j8unit.repository.javax.swing.DefaultRowSorterClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TableRowSorter
...
public abstract interface TableRowSorterClassTests<SUT extends TableRowSorter>
extends DefaultRowSorterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableRowSorter.class!",
                   TableRowSorter.class.isAssignableFrom(sut));
    }

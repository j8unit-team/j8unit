 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XidTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XidTests}.
 * </p>
 *
 * @see javax.transaction.xa.Xid interface javax.transaction.xa.Xid (the hereby targeted class-under-test class)
 * @see XidTests XidTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface XidClassTests<SUT extends javax.transaction.xa.Xid>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.transaction.xa.Xid.class!",
                   javax.transaction.xa.Xid.class.isAssignableFrom(sut));
    }

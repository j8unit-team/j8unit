 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ColorChooserUI
 * public abstract class javax.swing.plaf.ColorChooserUI}.
 *
...
public abstract interface ColorChooserUIClassTests<SUT extends ColorChooserUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorChooserUI.class!",
                   ColorChooserUI.class.isAssignableFrom(sut));
    }

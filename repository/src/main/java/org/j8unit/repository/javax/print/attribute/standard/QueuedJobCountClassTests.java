...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.QueuedJobCount class
 * javax.print.attribute.standard.QueuedJobCount}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link QueuedJobCountTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link QueuedJobCountTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.QueuedJobCount class javax.print.attribute.standard.QueuedJobCount (the hereby
 *      targeted class-under-test class)
 * @see QueuedJobCountTests QueuedJobCountTests (The complementary j8unit test interface containing the instance
...
public abstract interface QueuedJobCountClassTests<SUT extends javax.print.attribute.standard.QueuedJobCount>
...
org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.QueuedJobCount.class!",
                   javax.print.attribute.standard.QueuedJobCount.class.isAssignableFrom(sut));
    }

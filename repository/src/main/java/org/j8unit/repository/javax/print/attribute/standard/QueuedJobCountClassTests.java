 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link QueuedJobCount
...
public abstract interface QueuedJobCountClassTests<SUT extends QueuedJobCount>
extends PrintServiceAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to QueuedJobCount.class!",
                   QueuedJobCount.class.isAssignableFrom(sut));
    }

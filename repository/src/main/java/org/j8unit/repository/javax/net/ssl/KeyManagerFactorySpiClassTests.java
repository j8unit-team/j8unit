 ...
 * javax.net.ssl.KeyManagerFactorySpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyManagerFactorySpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyManagerFactorySpiTests}
 * .
 * </p>
 *
 * @see javax.net.ssl.KeyManagerFactorySpi class javax.net.ssl.KeyManagerFactorySpi (the hereby targeted
 *      class-under-test class)
 * @see KeyManagerFactorySpiTests KeyManagerFactorySpiTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.KeyManagerFactorySpi.class!",
                   javax.net.ssl.KeyManagerFactorySpi.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.MutableComboBoxModel interface
 * javax.swing.MutableComboBoxModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MutableComboBoxModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MutableComboBoxModelTests}
 * .
 * </p>
 *
 * @see javax.swing.MutableComboBoxModel interface javax.swing.MutableComboBoxModel (the hereby targeted
 *      class-under-test class)
 * @see MutableComboBoxModelTests MutableComboBoxModelTests (The complementary j8unit test interface containing the
...
public abstract interface MutableComboBoxModelClassTests<SUT extends javax.swing.MutableComboBoxModel>
extends ComboBoxModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.MutableComboBoxModel.class!",
                   javax.swing.MutableComboBoxModel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MessageContext
...
extends MapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MessageContext.class!",
                   MessageContext.class.isAssignableFrom(sut));
    }
     ...
     * {@link Scope public static final enum javax.xml.ws.handler.MessageContext$Scope}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Scope.class!",
                              Scope.class.isAssignableFrom(sut));
        }

 ...
 * javax.xml.ws.handler.MessageContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MessageContextTests}).
 * </p>
 *
 * <p>
 ...
 * @see MessageContextTests MessageContextTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.MapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.MessageContext.class!",
                   javax.xml.ws.handler.MessageContext.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.xml.ws.handler.MessageContext.Scope class
     * javax.xml.ws.handler.MessageContext$Scope}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link MessageContextTests.ScopeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see MessageContextTests.ScopeTests MessageContextTests.ScopeTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.MessageContext.Scope.class!",
                       javax.xml.ws.handler.MessageContext.Scope.class.isAssignableFrom(sut));
        }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PortTests}).
 * </p>
 *
 * <p>
 ...
 * @see PortTests PortTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends LineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Port.class!",
                   javax.sound.sampled.Port.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link PortTests.InfoTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link PortTests.InfoTests}.
     * </p>
     *
     * @see javax.sound.sampled.Port.Info class javax.sound.sampled.Port$Info (the hereby targeted class-under-test
     *      class)
     * @see PortTests.InfoTests PortTests.InfoTests (The complementary j8unit test interface containing the instance
    ...
    extends LineClassTests.InfoClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Port.Info.class!",
                       javax.sound.sampled.Port.Info.class.isAssignableFrom(sut));
        }

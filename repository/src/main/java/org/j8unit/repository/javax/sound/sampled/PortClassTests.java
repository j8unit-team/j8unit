 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Port public
...
extends org.j8unit.repository.javax.sound.sampled.LineClassTests<SUT> {
     ...
     * {@link Info public static class javax.sound.sampled.Port$Info}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link org.j8unit.repository.javax.sound.sampled.PortTests.InfoTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>

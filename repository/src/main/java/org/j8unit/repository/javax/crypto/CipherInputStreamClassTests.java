 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CipherInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CipherInputStreamTests}.
 * </p>
 *
 * @see javax.crypto.CipherInputStream class javax.crypto.CipherInputStream (the hereby targeted class-under-test class)
 * @see CipherInputStreamTests CipherInputStreamTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.CipherInputStream.class!",
                   javax.crypto.CipherInputStream.class.isAssignableFrom(sut));
    }

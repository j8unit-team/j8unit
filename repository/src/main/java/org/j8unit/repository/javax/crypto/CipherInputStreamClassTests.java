...
import org.j8unit.repository.java.io.FilterInputStreamClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CipherInputStream
...
public abstract interface CipherInputStreamClassTests<SUT extends CipherInputStream>
extends FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CipherInputStream.class!",
                   CipherInputStream.class.isAssignableFrom(sut));
    }

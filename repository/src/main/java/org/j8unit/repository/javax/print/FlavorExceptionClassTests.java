 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlavorExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FlavorExceptionTests}.
 * </p>
 *
 * @see javax.print.FlavorException interface javax.print.FlavorException (the hereby targeted class-under-test class)
 * @see FlavorExceptionTests FlavorExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface FlavorExceptionClassTests<SUT extends javax.print.FlavorException>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.FlavorException.class!",
                   javax.print.FlavorException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrivateClassLoader
 * public abstract interface javax.management.loading.PrivateClassLoader}.
 *
...
public abstract interface PrivateClassLoaderClassTests<SUT extends PrivateClassLoader>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrivateClassLoader.class!",
                   PrivateClassLoader.class.isAssignableFrom(sut));
    }

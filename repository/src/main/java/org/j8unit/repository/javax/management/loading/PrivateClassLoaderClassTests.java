 ...
 * javax.management.loading.PrivateClassLoader}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrivateClassLoaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrivateClassLoaderTests}.
 * </p>
 *
 * @see javax.management.loading.PrivateClassLoader interface javax.management.loading.PrivateClassLoader (the hereby
 *      targeted class-under-test class)
 * @see PrivateClassLoaderTests PrivateClassLoaderTests (The complementary j8unit test interface containing the instance
...
public abstract interface PrivateClassLoaderClassTests<SUT extends javax.management.loading.PrivateClassLoader>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.loading.PrivateClassLoader.class!",
                   javax.management.loading.PrivateClassLoader.class.isAssignableFrom(sut));
    }

...
public abstract interface InvalidRelationTypeExceptionClassTests<SUT extends InvalidRelationTypeException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidRelationTypeException.class!",
                   InvalidRelationTypeException.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.relation.InvalidRelationTypeException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidRelationTypeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidRelationTypeExceptionTests InvalidRelationTypeExceptionTests (The complementary j8unit test interface
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.InvalidRelationTypeException.class!",
                   javax.management.relation.InvalidRelationTypeException.class.isAssignableFrom(sut));
    }

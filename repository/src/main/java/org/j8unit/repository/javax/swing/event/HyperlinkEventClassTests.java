 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HyperlinkEvent
 * public class javax.swing.event.HyperlinkEvent}.
 *
...
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HyperlinkEvent.class!",
                   HyperlinkEvent.class.isAssignableFrom(sut));
    }
     ...
     * {@link EventType public static final class javax.swing.event.HyperlinkEvent$EventType}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

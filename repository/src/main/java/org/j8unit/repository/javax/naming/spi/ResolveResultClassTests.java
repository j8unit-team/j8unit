 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResolveResult
...
public abstract interface ResolveResultClassTests<SUT extends ResolveResult>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResolveResult.class!",
                   ResolveResult.class.isAssignableFrom(sut));
    }

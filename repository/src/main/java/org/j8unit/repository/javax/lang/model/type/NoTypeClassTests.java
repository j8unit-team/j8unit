 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NoTypeTests}.
 * </p>
 *
 * @see javax.lang.model.type.NoType interface javax.lang.model.type.NoType (the hereby targeted class-under-test class)
 * @see NoTypeTests NoTypeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface NoTypeClassTests<SUT extends javax.lang.model.type.NoType>
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.NoType.class!",
                   javax.lang.model.type.NoType.class.isAssignableFrom(sut));
    }

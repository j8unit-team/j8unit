 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NoType public
...
public abstract interface NoTypeClassTests<SUT extends NoType>
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoType.class!",
                   NoType.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ElementFilter
...
public abstract interface ElementFilterClassTests<SUT extends ElementFilter>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.lang.model.util.ElementFilter]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementFilter.class!",
                   ElementFilter.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link javax.sound.sampled.FloatControl class javax.sound.sampled.FloatControl}, containing all
...
extends org.j8unit.repository.javax.sound.sampled.ControlTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_shift_float_float_int()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

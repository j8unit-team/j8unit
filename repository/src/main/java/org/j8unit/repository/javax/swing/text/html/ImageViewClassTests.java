...
import org.j8unit.repository.javax.swing.text.ViewClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageView public
...
public abstract interface ImageViewClassTests<SUT extends ImageView>
extends ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageView.class!",
                   ImageView.class.isAssignableFrom(sut));
    }

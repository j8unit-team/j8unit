 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IIOParam public
...
public abstract interface IIOParamClassTests<SUT extends IIOParam>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOParam.class!",
                   IIOParam.class.isAssignableFrom(sut));
    }

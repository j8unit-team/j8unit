...
import org.j8unit.repository.javax.sql.RowSetReaderTests;
...
extends RowSetReaderTests<SUT> {
     ...
     * {@link javax.sql.rowset.spi.XmlReader#readXML(javax.sql.rowset.WebRowSet, java.io.Reader) public abstract void
     * javax.sql.rowset.spi.XmlReader.readXML(javax.sql.rowset.WebRowSet,java.io.Reader) throws java.sql.SQLException}.
     *

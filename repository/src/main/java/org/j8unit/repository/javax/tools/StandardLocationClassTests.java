...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.tools.StandardLocation class javax.tools.StandardLocation},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardLocationTests}).
 * </p>
 *
 * <p>
 ...
 * @see StandardLocationTests StandardLocationTests (The complementary j8unit test interface containing the instance
...
extends JavaFileManagerClassTests.LocationClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.StandardLocation.class!",
                   javax.tools.StandardLocation.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocumentFilterTests}.
 * </p>
 *
 * @see javax.swing.text.DocumentFilter class javax.swing.text.DocumentFilter (the hereby targeted class-under-test
 *      class)
 * @see DocumentFilterTests DocumentFilterTests (The complementary j8unit test interface containing the instance
...
public abstract interface DocumentFilterClassTests<SUT extends javax.swing.text.DocumentFilter>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.DocumentFilter.class!",
                   javax.swing.text.DocumentFilter.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.DocumentFilter.FilterBypass class
     * javax.swing.text.DocumentFilter$FilterBypass}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link DocumentFilterTests.FilterBypassTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see DocumentFilterTests.FilterBypassTests DocumentFilterTests.FilterBypassTests (The complementary j8unit test
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FilterBypassClassTests<SUT extends javax.swing.text.DocumentFilter.FilterBypass>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.DocumentFilter.FilterBypass.class!",
                       javax.swing.text.DocumentFilter.FilterBypass.class.isAssignableFrom(sut));
        }

...
public abstract interface DefaultFormatterFactoryClassTests<SUT extends DefaultFormatterFactory>
extends SerializableClassTests<SUT>, AbstractFormatterFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultFormatterFactory.class!",

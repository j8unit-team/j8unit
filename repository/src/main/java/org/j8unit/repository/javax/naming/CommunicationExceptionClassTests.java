 ...
 * javax.naming.CommunicationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CommunicationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link CommunicationExceptionTests}.
 * </p>
 *
 * @see javax.naming.CommunicationException class javax.naming.CommunicationException (the hereby targeted
 *      class-under-test class)
 * @see CommunicationExceptionTests CommunicationExceptionTests (The complementary j8unit test interface containing the
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.CommunicationException.class!",
                   javax.naming.CommunicationException.class.isAssignableFrom(sut));
    }

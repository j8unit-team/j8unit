 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeModel public
...
public abstract interface TreeModelClassTests<SUT extends TreeModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeModel.class!",
                   TreeModel.class.isAssignableFrom(sut));
    }

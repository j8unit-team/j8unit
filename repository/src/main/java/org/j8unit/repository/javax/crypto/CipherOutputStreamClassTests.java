...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.CipherOutputStream class javax.crypto.CipherOutputStream}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CipherOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CipherOutputStreamTests}.
 * </p>
 *
 * @see javax.crypto.CipherOutputStream class javax.crypto.CipherOutputStream (the hereby targeted class-under-test
 *      class)
 * @see CipherOutputStreamTests CipherOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface CipherOutputStreamClassTests<SUT extends javax.crypto.CipherOutputStream>
extends org.j8unit.repository.java.io.FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.CipherOutputStream.class!",
                   javax.crypto.CipherOutputStream.class.isAssignableFrom(sut));
    }

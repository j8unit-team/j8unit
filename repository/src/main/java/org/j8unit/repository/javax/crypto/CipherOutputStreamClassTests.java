 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CipherOutputStream
...
public abstract interface CipherOutputStreamClassTests<SUT extends CipherOutputStream>
extends FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CipherOutputStream.class!",
                   CipherOutputStream.class.isAssignableFrom(sut));
    }

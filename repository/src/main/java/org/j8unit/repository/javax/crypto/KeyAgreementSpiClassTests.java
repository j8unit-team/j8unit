 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyAgreementSpi
...
public abstract interface KeyAgreementSpiClassTests<SUT extends KeyAgreementSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyAgreementSpi.class!",
                   KeyAgreementSpi.class.isAssignableFrom(sut));
    }

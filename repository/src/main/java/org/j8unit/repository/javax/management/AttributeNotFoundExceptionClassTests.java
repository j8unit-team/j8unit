 ...
 * javax.management.AttributeNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link AttributeNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see AttributeNotFoundExceptionTests AttributeNotFoundExceptionTests (The complementary j8unit test interface
...
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.AttributeNotFoundException.class!",
                   javax.management.AttributeNotFoundException.class.isAssignableFrom(sut));
    }

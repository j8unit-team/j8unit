...
public abstract interface AttributeNotFoundExceptionClassTests<SUT extends AttributeNotFoundException>
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeNotFoundException.class!",
                   AttributeNotFoundException.class.isAssignableFrom(sut));
    }

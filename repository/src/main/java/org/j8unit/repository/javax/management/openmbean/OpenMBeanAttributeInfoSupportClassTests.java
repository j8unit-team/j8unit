...
public abstract interface OpenMBeanAttributeInfoSupportClassTests<SUT extends OpenMBeanAttributeInfoSupport>
...
org.j8unit.repository.javax.management.MBeanAttributeInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanAttributeInfoSupport.class!",
                   OpenMBeanAttributeInfoSupport.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.openmbean.OpenMBeanAttributeInfoSupport]

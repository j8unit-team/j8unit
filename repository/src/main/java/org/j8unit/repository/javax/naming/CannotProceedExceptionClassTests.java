...
public abstract interface CannotProceedExceptionClassTests<SUT extends CannotProceedException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CannotProceedException.class!",
                   CannotProceedException.class.isAssignableFrom(sut));
    }

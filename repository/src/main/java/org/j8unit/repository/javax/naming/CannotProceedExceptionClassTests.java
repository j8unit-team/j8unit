...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.CannotProceedException class
 * javax.naming.CannotProceedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CannotProceedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link CannotProceedExceptionTests}.
 * </p>
 *
 * @see javax.naming.CannotProceedException class javax.naming.CannotProceedException (the hereby targeted
 *      class-under-test class)
 * @see CannotProceedExceptionTests CannotProceedExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface CannotProceedExceptionClassTests<SUT extends javax.naming.CannotProceedException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.CannotProceedException.class!",
                   javax.naming.CannotProceedException.class.isAssignableFrom(sut));
    }

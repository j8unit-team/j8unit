 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiDocTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiDocTests}.
 * </p>
 *
 * @see javax.print.MultiDoc interface javax.print.MultiDoc (the hereby targeted class-under-test class)
 * @see MultiDocTests MultiDocTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MultiDocClassTests<SUT extends javax.print.MultiDoc>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.MultiDoc.class!",
                   javax.print.MultiDoc.class.isAssignableFrom(sut));
    }

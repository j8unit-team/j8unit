 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SignedInfo public
 * abstract interface javax.xml.crypto.dsig.SignedInfo}.
 *
...
public abstract interface SignedInfoClassTests<SUT extends SignedInfo>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignedInfo.class!",
                   SignedInfo.class.isAssignableFrom(sut));
    }

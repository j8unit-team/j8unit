 ...
 * javax.xml.crypto.dsig.SignedInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignedInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignedInfoTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.SignedInfo interface javax.xml.crypto.dsig.SignedInfo (the hereby targeted
 *      class-under-test class)
 * @see SignedInfoTests SignedInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SignedInfoClassTests<SUT extends javax.xml.crypto.dsig.SignedInfo>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.SignedInfo.class!",
                   javax.xml.crypto.dsig.SignedInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UndoableEdit public
...
public abstract interface UndoableEditClassTests<SUT extends UndoableEdit>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UndoableEdit.class!",
                   UndoableEdit.class.isAssignableFrom(sut));
    }

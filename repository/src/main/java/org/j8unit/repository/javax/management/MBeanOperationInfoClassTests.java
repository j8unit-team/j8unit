 ...
 * javax.management.MBeanOperationInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanOperationInfoTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.management.MBeanOperationInfo class javax.management.MBeanOperationInfo (the hereby targeted
 *      class-under-test class)
 * @see MBeanOperationInfoTests MBeanOperationInfoTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanOperationInfo.class!",
                   javax.management.MBeanOperationInfo.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeymapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeymapTests}.
 * </p>
 *
 * @see javax.swing.text.Keymap interface javax.swing.text.Keymap (the hereby targeted class-under-test class)
 * @see KeymapTests KeymapTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface KeymapClassTests<SUT extends javax.swing.text.Keymap>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.Keymap.class!",
                   javax.swing.text.Keymap.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.xml.crypto.dsig.XMLValidateContextClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMValidateContext
 * public class javax.xml.crypto.dsig.dom.DOMValidateContext}.
 *
...
public abstract interface DOMValidateContextClassTests<SUT extends DOMValidateContext>
extends XMLValidateContextClassTests<SUT>, DOMCryptoContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMValidateContext.class!",

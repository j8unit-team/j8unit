 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Certificate public
 * abstract class javax.security.cert.Certificate}.
 *
...
public abstract interface CertificateClassTests<SUT extends Certificate>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Certificate.class!",
                   Certificate.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.text.StyleConstantsTests.CharacterConstantsTests;
import org.j8unit.repository.javax.swing.text.StyleConstantsTests.ColorConstantsTests;
import org.j8unit.repository.javax.swing.text.StyleConstantsTests.FontConstantsTests;
import org.j8unit.repository.javax.swing.text.StyleConstantsTests.ParagraphConstantsTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StyleConstants
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StyleConstantsTests}.
 * </p>
 *
 * <p>
...
public abstract interface StyleConstantsClassTests<SUT extends StyleConstants>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StyleConstants.class!",
                   StyleConstants.class.isAssignableFrom(sut));
    }
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link FontConstantsTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FontConstantsClassTests<SUT extends FontConstants>
    extends FontAttributeClassTests<SUT>, CharacterAttributeClassTests<SUT>, org.j8unit.repository.javax.swing.text.StyleConstantsClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FontConstants.class!",
                              FontConstants.class.isAssignableFrom(sut));
        }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface CharacterConstantsClassTests<SUT extends CharacterConstants>
    extends CharacterAttributeClassTests<SUT>, org.j8unit.repository.javax.swing.text.StyleConstantsClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharacterConstants.class!",
                              CharacterConstants.class.isAssignableFrom(sut));
        }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ParagraphConstantsClassTests<SUT extends ParagraphConstants>
    extends ParagraphAttributeClassTests<SUT>, org.j8unit.repository.javax.swing.text.StyleConstantsClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParagraphConstants.class!",
                              ParagraphConstants.class.isAssignableFrom(sut));
        }
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ColorConstantsTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ColorConstantsClassTests<SUT extends ColorConstants>
    extends ColorAttributeClassTests<SUT>, CharacterAttributeClassTests<SUT>, org.j8unit.repository.javax.swing.text.StyleConstantsClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorConstants.class!",
                              ColorConstants.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintJobEvent
 * public class javax.print.event.PrintJobEvent}.
 *
...
public abstract interface PrintJobEventClassTests<SUT extends PrintJobEvent>
extends PrintEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintJobEvent.class!",
                   PrintJobEvent.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintJobEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintJobEventTests}.
 * </p>
 *
 * @see javax.print.event.PrintJobEvent class javax.print.event.PrintJobEvent (the hereby targeted class-under-test
 *      class)
 * @see PrintJobEventTests PrintJobEventTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PrintJobEventClassTests<SUT extends javax.print.event.PrintJobEvent>
extends PrintEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.event.PrintJobEvent.class!",
                   javax.print.event.PrintJobEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageReaderSpi
 * public abstract class javax.imageio.spi.ImageReaderSpi}.
 *
...
public abstract interface ImageReaderSpiClassTests<SUT extends ImageReaderSpi>
extends ImageReaderWriterSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageReaderSpi.class!",
                   ImageReaderSpi.class.isAssignableFrom(sut));
    }

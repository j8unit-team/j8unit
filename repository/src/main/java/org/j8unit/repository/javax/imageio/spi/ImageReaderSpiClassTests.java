 ...
 * javax.imageio.spi.ImageReaderSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageReaderSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageReaderSpiTests}.
 * </p>
 *
 * @see javax.imageio.spi.ImageReaderSpi class javax.imageio.spi.ImageReaderSpi (the hereby targeted class-under-test
 *      class)
 * @see ImageReaderSpiTests ImageReaderSpiTests (The complementary j8unit test interface containing the instance
...
public abstract interface ImageReaderSpiClassTests<SUT extends javax.imageio.spi.ImageReaderSpi>
extends ImageReaderWriterSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.ImageReaderSpi.class!",
                   javax.imageio.spi.ImageReaderSpi.class.isAssignableFrom(sut));
    }

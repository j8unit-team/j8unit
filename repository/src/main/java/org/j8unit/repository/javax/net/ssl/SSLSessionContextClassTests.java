 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLSessionContext
 * public abstract interface javax.net.ssl.SSLSessionContext}.
 *
...
public abstract interface SSLSessionContextClassTests<SUT extends SSLSessionContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLSessionContext.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.net.ssl.SSLSessionContext interface
 * javax.net.ssl.SSLSessionContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLSessionContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLSessionContextTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLSessionContext interface javax.net.ssl.SSLSessionContext (the hereby targeted class-under-test
 *      class)
 * @see SSLSessionContextTests SSLSessionContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface SSLSessionContextClassTests<SUT extends javax.net.ssl.SSLSessionContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLSessionContext.class!",
                   javax.net.ssl.SSLSessionContext.class.isAssignableFrom(sut));
    }

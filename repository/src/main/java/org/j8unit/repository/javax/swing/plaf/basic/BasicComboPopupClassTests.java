 ...
 * javax.swing.plaf.basic.BasicComboPopup}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicComboPopupTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicComboPopupTests}.
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicComboPopup class javax.swing.plaf.basic.BasicComboPopup (the hereby targeted
 *      class-under-test class)
 * @see BasicComboPopupTests BasicComboPopupTests (The complementary j8unit test interface containing the instance
...
extends ComboPopupClassTests<SUT>, org.j8unit.repository.javax.swing.JPopupMenuClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicComboPopup.class!",
                   javax.swing.plaf.basic.BasicComboPopup.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicComboPopup.ListDataHandler class
     * javax.swing.plaf.basic.BasicComboPopup$ListDataHandler}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link BasicComboPopupTests.ListDataHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicComboPopupTests.ListDataHandlerTests BasicComboPopupTests.ListDataHandlerTests (The complementary
    ...
    extends org.j8unit.repository.javax.swing.event.ListDataListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicComboPopup.ListDataHandler.class!",
                       javax.swing.plaf.basic.BasicComboPopup.ListDataHandler.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.plaf.basic.BasicComboPopup$InvocationKeyHandler}, containing all type relevant aspects (e.&thinsp;g.,
     * runtime constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link BasicComboPopupTests.InvocationKeyHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicComboPopupTests.InvocationKeyHandlerTests BasicComboPopupTests.InvocationKeyHandlerTests (The
    ...
    extends org.j8unit.repository.java.awt.event.KeyAdapterClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicComboPopup.InvocationKeyHandler.class!",
                       javax.swing.plaf.basic.BasicComboPopup.InvocationKeyHandler.class.isAssignableFrom(sut));
        }

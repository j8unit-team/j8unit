 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServerSocketFactory
...
public abstract interface ServerSocketFactoryClassTests<SUT extends ServerSocketFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerSocketFactory.class!",
                   ServerSocketFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeCellEditor
...
public abstract interface TreeCellEditorClassTests<SUT extends TreeCellEditor>
extends CellEditorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeCellEditor.class!",

 ...
 * {@link UnknownAnnotationValueException public class javax.lang.model.element.UnknownAnnotationValueException}.
 *
...
public abstract interface UnknownAnnotationValueExceptionClassTests<SUT extends UnknownAnnotationValueException>
extends UnknownEntityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownAnnotationValueException.class!",
                   UnknownAnnotationValueException.class.isAssignableFrom(sut));
    }

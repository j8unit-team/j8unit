 ...
 * javax.management.ListenerNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see ListenerNotFoundExceptionTests ListenerNotFoundExceptionTests (The complementary j8unit test interface
...
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.ListenerNotFoundException.class!",
                   javax.management.ListenerNotFoundException.class.isAssignableFrom(sut));
    }

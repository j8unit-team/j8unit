 ...
 * javax.net.ssl.SSLPeerUnverifiedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * </p>
 *
 * @see javax.net.ssl.SSLPeerUnverifiedException class javax.net.ssl.SSLPeerUnverifiedException (the hereby targeted
 *      class-under-test class)
 * @see SSLPeerUnverifiedExceptionTests SSLPeerUnverifiedExceptionTests (The complementary j8unit test interface
...
extends SSLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLPeerUnverifiedException.class!",
                   javax.net.ssl.SSLPeerUnverifiedException.class.isAssignableFrom(sut));
    }

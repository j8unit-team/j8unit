 ...
 * {@link JMXConnectorServerMBean public abstract interface javax.management.remote.JMXConnectorServerMBean}.
 *
...
public abstract interface JMXConnectorServerMBeanClassTests<SUT extends JMXConnectorServerMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXConnectorServerMBean.class!",
                   JMXConnectorServerMBean.class.isAssignableFrom(sut));
    }

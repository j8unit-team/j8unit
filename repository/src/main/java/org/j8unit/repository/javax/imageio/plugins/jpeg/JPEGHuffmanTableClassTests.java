 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JPEGHuffmanTable
...
public abstract interface JPEGHuffmanTableClassTests<SUT extends JPEGHuffmanTable>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.imageio.plugins.jpeg.JPEGHuffmanTable]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JPEGHuffmanTable.class!",
                   JPEGHuffmanTable.class.isAssignableFrom(sut));
    }

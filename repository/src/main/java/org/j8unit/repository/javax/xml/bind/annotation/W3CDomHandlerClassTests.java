 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link W3CDomHandler
...
public abstract interface W3CDomHandlerClassTests<SUT extends W3CDomHandler>
extends DomHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to W3CDomHandler.class!",

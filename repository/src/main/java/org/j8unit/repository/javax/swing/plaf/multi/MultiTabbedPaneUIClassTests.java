...
import org.j8unit.repository.javax.swing.plaf.TabbedPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiTabbedPaneUI
 * public class javax.swing.plaf.multi.MultiTabbedPaneUI}.
 *
...
public abstract interface MultiTabbedPaneUIClassTests<SUT extends MultiTabbedPaneUI>
extends TabbedPaneUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.multi.MultiTabbedPaneUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiTabbedPaneUI.class!",
                   MultiTabbedPaneUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.multi.MultiTabbedPaneUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.multi.MultiTabbedPaneUI]

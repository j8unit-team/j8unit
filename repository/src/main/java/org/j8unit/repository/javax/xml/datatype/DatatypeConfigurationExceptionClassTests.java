...
public abstract interface DatatypeConfigurationExceptionClassTests<SUT extends DatatypeConfigurationException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatatypeConfigurationException.class!",

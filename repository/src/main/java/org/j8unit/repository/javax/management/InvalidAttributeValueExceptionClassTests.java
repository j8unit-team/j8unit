 ...
 * javax.management.InvalidAttributeValueException}, containing all type relevant aspects (e.&thinsp;g., runtime
...
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.InvalidAttributeValueException.class!",
                   javax.management.InvalidAttributeValueException.class.isAssignableFrom(sut));
    }

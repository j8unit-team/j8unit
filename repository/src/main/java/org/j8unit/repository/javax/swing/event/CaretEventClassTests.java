...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.CaretEvent class javax.swing.event.CaretEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CaretEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CaretEventTests}.
 * </p>
 *
 * @see javax.swing.event.CaretEvent class javax.swing.event.CaretEvent (the hereby targeted class-under-test class)
 * @see CaretEventTests CaretEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CaretEventClassTests<SUT extends javax.swing.event.CaretEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.CaretEvent.class!",
                   javax.swing.event.CaretEvent.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIORegistryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IIORegistryTests}.
 * </p>
 *
 * @see javax.imageio.spi.IIORegistry class javax.imageio.spi.IIORegistry (the hereby targeted class-under-test class)
 * @see IIORegistryTests IIORegistryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ServiceRegistryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.IIORegistry.class!",
                   javax.imageio.spi.IIORegistry.class.isAssignableFrom(sut));
    }

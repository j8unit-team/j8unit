 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IIORegistry public
 * final class javax.imageio.spi.IIORegistry}.
 *
...
public abstract interface IIORegistryClassTests<SUT extends IIORegistry>
extends ServiceRegistryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIORegistry.class!",
                   IIORegistry.class.isAssignableFrom(sut));
    }

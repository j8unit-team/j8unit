...
import org.j8unit.repository.javax.swing.plaf.basic.BasicTextFieldUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalTextFieldUI
 * public class javax.swing.plaf.metal.MetalTextFieldUI}.
 *
...
public abstract interface MetalTextFieldUIClassTests<SUT extends MetalTextFieldUI>
extends BasicTextFieldUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalTextFieldUI.class!",
                   MetalTextFieldUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPException
 * public class javax.xml.soap.SOAPException}.
 *
...
public abstract interface SOAPExceptionClassTests<SUT extends SOAPException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPException.class!",
                   SOAPException.class.isAssignableFrom(sut));
    }

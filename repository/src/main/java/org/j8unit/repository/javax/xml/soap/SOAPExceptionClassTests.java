 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPExceptionTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPException class javax.xml.soap.SOAPException (the hereby targeted class-under-test class)
 * @see SOAPExceptionTests SOAPExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPException.class!",
                   javax.xml.soap.SOAPException.class.isAssignableFrom(sut));
    }

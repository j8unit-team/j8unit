 ...
 * javax.print.attribute.standard.Sides}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SidesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SidesTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.Sides class javax.print.attribute.standard.Sides (the hereby targeted
 *      class-under-test class)
 * @see SidesTests SidesTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface SidesClassTests<SUT extends javax.print.attribute.standard.Sides>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.Sides.class!",
                   javax.print.attribute.standard.Sides.class.isAssignableFrom(sut));
    }

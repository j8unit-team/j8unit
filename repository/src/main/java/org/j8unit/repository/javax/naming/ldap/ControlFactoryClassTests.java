 ...
 * javax.naming.ldap.ControlFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ControlFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ControlFactoryTests ControlFactoryTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.ControlFactory.class!",
                   javax.naming.ldap.ControlFactory.class.isAssignableFrom(sut));
    }

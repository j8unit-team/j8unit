...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.MenuKeyListener interface
 * javax.swing.event.MenuKeyListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuKeyListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuKeyListenerTests}.
 * </p>
 *
 * @see javax.swing.event.MenuKeyListener interface javax.swing.event.MenuKeyListener (the hereby targeted
 *      class-under-test class)
 * @see MenuKeyListenerTests MenuKeyListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface MenuKeyListenerClassTests<SUT extends javax.swing.event.MenuKeyListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MenuKeyListener.class!",
                   javax.swing.event.MenuKeyListener.class.isAssignableFrom(sut));
    }

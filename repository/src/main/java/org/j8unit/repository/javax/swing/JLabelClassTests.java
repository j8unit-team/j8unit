 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JLabel public class
 * javax.swing.JLabel}.
 *
...
public abstract interface JLabelClassTests<SUT extends JLabel>
extends SwingConstantsClassTests<SUT>, AccessibleClassTests<SUT>, JComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JLabel]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JLabel.class!",
                   JLabel.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JRadioButtonMenuItem class
 * javax.swing.JRadioButtonMenuItem}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JRadioButtonMenuItemTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JRadioButtonMenuItemTests}
 * .
 * </p>
 *
 * @see javax.swing.JRadioButtonMenuItem class javax.swing.JRadioButtonMenuItem (the hereby targeted class-under-test
 *      class)
 * @see JRadioButtonMenuItemTests JRadioButtonMenuItemTests (The complementary j8unit test interface containing the
...
public abstract interface JRadioButtonMenuItemClassTests<SUT extends javax.swing.JRadioButtonMenuItem>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JMenuItemClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JRadioButtonMenuItem.class!",
                   javax.swing.JRadioButtonMenuItem.class.isAssignableFrom(sut));
    }

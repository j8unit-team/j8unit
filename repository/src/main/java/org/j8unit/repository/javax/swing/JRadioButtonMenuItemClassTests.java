...
public abstract interface JRadioButtonMenuItemClassTests<SUT extends JRadioButtonMenuItem>
extends org.j8unit.repository.javax.swing.JMenuItemClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JRadioButtonMenuItem.class!",

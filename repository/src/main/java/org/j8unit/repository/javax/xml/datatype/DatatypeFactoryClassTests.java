 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DatatypeFactory
...
public abstract interface DatatypeFactoryClassTests<SUT extends DatatypeFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatatypeFactory.class!",
                   DatatypeFactory.class.isAssignableFrom(sut));
    }

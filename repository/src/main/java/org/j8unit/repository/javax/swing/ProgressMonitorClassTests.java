 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProgressMonitor
...
public abstract interface ProgressMonitorClassTests<SUT extends ProgressMonitor>
extends AccessibleClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProgressMonitor.class!",
                   ProgressMonitor.class.isAssignableFrom(sut));
    }

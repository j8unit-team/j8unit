 ...
 * {@link RuntimeOperationsException public class javax.management.RuntimeOperationsException}.
 *
...
public abstract interface RuntimeOperationsExceptionClassTests<SUT extends RuntimeOperationsException>
extends JMRuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RuntimeOperationsException.class!",
                   RuntimeOperationsException.class.isAssignableFrom(sut));
    }

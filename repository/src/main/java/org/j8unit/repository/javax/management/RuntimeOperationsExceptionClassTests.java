 ...
 * javax.management.RuntimeOperationsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link RuntimeOperationsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see RuntimeOperationsExceptionTests RuntimeOperationsExceptionTests (The complementary j8unit test interface
...
extends JMRuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.RuntimeOperationsException.class!",
                   javax.management.RuntimeOperationsException.class.isAssignableFrom(sut));
    }

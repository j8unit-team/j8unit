...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicToolBarUI class
 * javax.swing.plaf.basic.BasicToolBarUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicToolBarUITests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicToolBarUITests BasicToolBarUITests (The complementary j8unit test interface containing the instance
...
public abstract interface BasicToolBarUIClassTests<SUT extends javax.swing.plaf.basic.BasicToolBarUI>
extends org.j8unit.repository.javax.swing.SwingConstantsClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.ToolBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicToolBarUI.class!",
                   javax.swing.plaf.basic.BasicToolBarUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicToolBarUI.DockingListener class
     * javax.swing.plaf.basic.BasicToolBarUI$DockingListener}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link BasicToolBarUITests.DockingListenerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicToolBarUITests.DockingListenerTests BasicToolBarUITests.DockingListenerTests (The complementary j8unit
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface DockingListenerClassTests<SUT extends javax.swing.plaf.basic.BasicToolBarUI.DockingListener>
    extends org.j8unit.repository.javax.swing.event.MouseInputListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicToolBarUI.DockingListener.class!",
                       javax.swing.plaf.basic.BasicToolBarUI.DockingListener.class.isAssignableFrom(sut));
        }

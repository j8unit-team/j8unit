 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link QName public class
...
public abstract interface QNameClassTests<SUT extends QName>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to QName.class!", QName.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.bind.attachment.AttachmentMarshaller}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttachmentMarshallerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AttachmentMarshallerTests}
 * .
 * </p>
 *
 * @see javax.xml.bind.attachment.AttachmentMarshaller class javax.xml.bind.attachment.AttachmentMarshaller (the hereby
 *      targeted class-under-test class)
 * @see AttachmentMarshallerTests AttachmentMarshallerTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.attachment.AttachmentMarshaller.class!",
                   javax.xml.bind.attachment.AttachmentMarshaller.class.isAssignableFrom(sut));
    }

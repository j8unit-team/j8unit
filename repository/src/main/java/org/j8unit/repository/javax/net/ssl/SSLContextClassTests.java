 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLContext public
...
public abstract interface SSLContextClassTests<SUT extends SSLContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLContext.class!",
                   SSLContext.class.isAssignableFrom(sut));
    }

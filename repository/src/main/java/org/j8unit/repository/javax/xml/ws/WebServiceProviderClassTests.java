 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebServiceProvider
...
public abstract interface WebServiceProviderClassTests<SUT extends WebServiceProvider>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceProvider.class!",
                   WebServiceProvider.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.WebServiceProvider interface
 * javax.xml.ws.WebServiceProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceProviderTests}.
 * </p>
 *
 * @see javax.xml.ws.WebServiceProvider interface javax.xml.ws.WebServiceProvider (the hereby targeted class-under-test
 *      class)
 * @see WebServiceProviderTests WebServiceProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface WebServiceProviderClassTests<SUT extends javax.xml.ws.WebServiceProvider>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServiceProvider.class!",
                   javax.xml.ws.WebServiceProvider.class.isAssignableFrom(sut));
    }

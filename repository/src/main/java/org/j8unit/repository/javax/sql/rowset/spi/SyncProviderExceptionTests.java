 ...
 * {@link SyncProviderException public class javax.sql.rowset.spi.SyncProviderException}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.sql.rowset.spi.SyncProviderExceptionClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface SyncProviderExceptionTests<SUT extends SyncProviderException>
extends SQLExceptionTests<SUT> {
    ...
    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[javax.sql.rowset.spi.SyncProviderException]

    // J8UNIT-MARKER-[END]-[INSTANCE]-[javax.sql.rowset.spi.SyncProviderException]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingException
...
public abstract interface NamingExceptionClassTests<SUT extends NamingException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingException.class!",
                   NamingException.class.isAssignableFrom(sut));
    }

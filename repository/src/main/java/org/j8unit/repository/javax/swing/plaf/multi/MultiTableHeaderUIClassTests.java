...
import org.j8unit.repository.javax.swing.plaf.TableHeaderUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiTableHeaderUI
 * public class javax.swing.plaf.multi.MultiTableHeaderUI}.
 *
...
public abstract interface MultiTableHeaderUIClassTests<SUT extends MultiTableHeaderUI>
extends TableHeaderUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiTableHeaderUI.class!",
                   MultiTableHeaderUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.event.TableColumnModelEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableColumnModelEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see TableColumnModelEventTests TableColumnModelEventTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TableColumnModelEvent.class!",
                   javax.swing.event.TableColumnModelEvent.class.isAssignableFrom(sut));
    }

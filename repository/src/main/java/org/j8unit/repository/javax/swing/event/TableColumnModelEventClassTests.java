 ...
 * {@link TableColumnModelEvent public class javax.swing.event.TableColumnModelEvent}.
 *
...
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableColumnModelEvent.class!",
                   TableColumnModelEvent.class.isAssignableFrom(sut));
    }

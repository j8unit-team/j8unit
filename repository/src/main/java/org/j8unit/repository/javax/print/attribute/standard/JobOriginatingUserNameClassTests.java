...
public abstract interface JobOriginatingUserNameClassTests<SUT extends JobOriginatingUserName>
extends PrintJobAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobOriginatingUserName.class!",
                   JobOriginatingUserName.class.isAssignableFrom(sut));
    }

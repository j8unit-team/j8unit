 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLSignContext
...
public abstract interface XMLSignContextClassTests<SUT extends XMLSignContext>
extends XMLCryptoContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLSignContext.class!",
                   XMLSignContext.class.isAssignableFrom(sut));
    }

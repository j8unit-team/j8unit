 ...
 * javax.xml.crypto.dsig.XMLSignContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLSignContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLSignContextTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.XMLSignContext interface javax.xml.crypto.dsig.XMLSignContext (the hereby targeted
 *      class-under-test class)
 * @see XMLSignContextTests XMLSignContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface XMLSignContextClassTests<SUT extends javax.xml.crypto.dsig.XMLSignContext>
extends org.j8unit.repository.javax.xml.crypto.XMLCryptoContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.XMLSignContext.class!",
                   javax.xml.crypto.dsig.XMLSignContext.class.isAssignableFrom(sut));
    }

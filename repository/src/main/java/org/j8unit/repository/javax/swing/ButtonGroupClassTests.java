 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ButtonGroup public
...
public abstract interface ButtonGroupClassTests<SUT extends ButtonGroup>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.ButtonGroup]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ButtonGroup.class!",
                   ButtonGroup.class.isAssignableFrom(sut));
    }

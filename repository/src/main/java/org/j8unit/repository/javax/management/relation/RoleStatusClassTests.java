 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoleStatus public
...
public abstract interface RoleStatusClassTests<SUT extends RoleStatus>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleStatus.class!",
                   RoleStatus.class.isAssignableFrom(sut));
    }

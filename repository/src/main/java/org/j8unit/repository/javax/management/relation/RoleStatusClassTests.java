 ...
 * javax.management.relation.RoleStatus}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RoleStatusTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RoleStatusTests}.
 * </p>
 *
 * @see javax.management.relation.RoleStatus class javax.management.relation.RoleStatus (the hereby targeted
 *      class-under-test class)
 * @see RoleStatusTests RoleStatusTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RoleStatus.class!",
                   javax.management.relation.RoleStatus.class.isAssignableFrom(sut));
    }

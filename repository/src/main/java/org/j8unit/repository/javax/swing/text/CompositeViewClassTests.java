...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.text.CompositeView class javax.swing.text.CompositeView},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeViewTests}).
 * </p>
 *
 * <p>
 ...
 * @see CompositeViewTests CompositeViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CompositeViewClassTests<SUT extends javax.swing.text.CompositeView>
extends ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.CompositeView.class!",
                   javax.swing.text.CompositeView.class.isAssignableFrom(sut));
    }

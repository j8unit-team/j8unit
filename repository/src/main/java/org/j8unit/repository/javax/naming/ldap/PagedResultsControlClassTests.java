 ...
 * javax.naming.ldap.PagedResultsControl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PagedResultsControlTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PagedResultsControlTests}.
 * </p>
 *
 * @see javax.naming.ldap.PagedResultsControl class javax.naming.ldap.PagedResultsControl (the hereby targeted
 *      class-under-test class)
 * @see PagedResultsControlTests PagedResultsControlTests (The complementary j8unit test interface containing the
...
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.PagedResultsControl.class!",
                   javax.naming.ldap.PagedResultsControl.class.isAssignableFrom(sut));
    }

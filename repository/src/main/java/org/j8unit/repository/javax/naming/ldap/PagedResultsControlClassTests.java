 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PagedResultsControl
 * public final class javax.naming.ldap.PagedResultsControl}.
 *
...
public abstract interface PagedResultsControlClassTests<SUT extends PagedResultsControl>
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PagedResultsControl.class!",
                   PagedResultsControl.class.isAssignableFrom(sut));
    }

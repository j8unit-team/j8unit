...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.lang.model.util.ElementScanner8 class
 * javax.lang.model.util.ElementScanner8}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ElementScanner8Tests}).
 * </p>
 *
 * <p>
 ...
 * @see ElementScanner8Tests ElementScanner8Tests (The complementary j8unit test interface containing the instance
...
extends ElementScanner7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.util.ElementScanner8.class!",
                   javax.lang.model.util.ElementScanner8.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerialJavaObject
 * public class javax.sql.rowset.serial.SerialJavaObject}.
 *
...
public abstract interface SerialJavaObjectClassTests<SUT extends SerialJavaObject>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerialJavaObject.class!",
                   SerialJavaObject.class.isAssignableFrom(sut));
    }

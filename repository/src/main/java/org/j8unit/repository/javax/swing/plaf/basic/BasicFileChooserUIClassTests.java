 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicFileChooserUI
 * public class javax.swing.plaf.basic.BasicFileChooserUI}.
 *
...
public abstract interface BasicFileChooserUIClassTests<SUT extends BasicFileChooserUI>
extends FileChooserUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicFileChooserUI.class!",

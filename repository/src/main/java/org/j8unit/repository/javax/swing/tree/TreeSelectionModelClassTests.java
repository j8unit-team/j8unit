 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeSelectionModel
 * public abstract interface javax.swing.tree.TreeSelectionModel}.
 *
...
public abstract interface TreeSelectionModelClassTests<SUT extends TreeSelectionModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeSelectionModel.class!",
                   TreeSelectionModel.class.isAssignableFrom(sut));
    }

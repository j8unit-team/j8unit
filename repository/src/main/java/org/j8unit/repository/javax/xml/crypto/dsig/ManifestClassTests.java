 ...
 * javax.xml.crypto.dsig.Manifest}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
...
public abstract interface ManifestClassTests<SUT extends javax.xml.crypto.dsig.Manifest>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.Manifest.class!",
                   javax.xml.crypto.dsig.Manifest.class.isAssignableFrom(sut));
    }

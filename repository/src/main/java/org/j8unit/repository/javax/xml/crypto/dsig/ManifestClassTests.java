 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Manifest public
 * abstract interface javax.xml.crypto.dsig.Manifest}.
 *
...
public abstract interface ManifestClassTests<SUT extends Manifest>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Manifest.class!",
                   Manifest.class.isAssignableFrom(sut));
    }

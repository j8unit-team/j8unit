 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceRegistry
...
public abstract interface ServiceRegistryClassTests<SUT extends ServiceRegistry>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceRegistry.class!",
                   ServiceRegistry.class.isAssignableFrom(sut));
    }
     ...
     * {@link Filter public abstract static interface javax.imageio.spi.ServiceRegistry$Filter}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FilterClassTests<SUT extends Filter>

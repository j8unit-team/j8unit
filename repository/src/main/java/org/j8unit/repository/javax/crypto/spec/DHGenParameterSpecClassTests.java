 ...
 * javax.crypto.spec.DHGenParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DHGenParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DHGenParameterSpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.DHGenParameterSpec class javax.crypto.spec.DHGenParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see DHGenParameterSpecTests DHGenParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.DHGenParameterSpec.class!",
                   javax.crypto.spec.DHGenParameterSpec.class.isAssignableFrom(sut));
    }

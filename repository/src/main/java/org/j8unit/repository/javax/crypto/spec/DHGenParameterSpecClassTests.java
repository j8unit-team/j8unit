 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DHGenParameterSpec
...
public abstract interface DHGenParameterSpecClassTests<SUT extends DHGenParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DHGenParameterSpec.class!",
                   DHGenParameterSpec.class.isAssignableFrom(sut));
    }

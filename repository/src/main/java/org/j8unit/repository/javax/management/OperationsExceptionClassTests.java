 ...
 * javax.management.OperationsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OperationsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OperationsExceptionTests}.
 * </p>
 *
 * @see javax.management.OperationsException class javax.management.OperationsException (the hereby targeted
 *      class-under-test class)
 * @see OperationsExceptionTests OperationsExceptionTests (The complementary j8unit test interface containing the
...
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.OperationsException.class!",
                   javax.management.OperationsException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OperationsException
 * public class javax.management.OperationsException}.
 *
...
public abstract interface OperationsExceptionClassTests<SUT extends OperationsException>
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OperationsException.class!",
                   OperationsException.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.auth.callback.ChoiceCallback}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChoiceCallbackTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChoiceCallbackTests}.
 * </p>
 *
 * @see javax.security.auth.callback.ChoiceCallback class javax.security.auth.callback.ChoiceCallback (the hereby
 *      targeted class-under-test class)
 * @see ChoiceCallbackTests ChoiceCallbackTests (The complementary j8unit test interface containing the instance
...
extends CallbackClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.callback.ChoiceCallback.class!",
                   javax.security.auth.callback.ChoiceCallback.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UtilDelegateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UtilDelegateTests}.
 * </p>
 *
 * @see javax.rmi.CORBA.UtilDelegate interface javax.rmi.CORBA.UtilDelegate (the hereby targeted class-under-test class)
 * @see UtilDelegateTests UtilDelegateTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface UtilDelegateClassTests<SUT extends javax.rmi.CORBA.UtilDelegate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.CORBA.UtilDelegate.class!",
                   javax.rmi.CORBA.UtilDelegate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UtilDelegate public
 * abstract interface javax.rmi.CORBA.UtilDelegate}.
 *
...
public abstract interface UtilDelegateClassTests<SUT extends UtilDelegate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UtilDelegate.class!",
                   UtilDelegate.class.isAssignableFrom(sut));
    }

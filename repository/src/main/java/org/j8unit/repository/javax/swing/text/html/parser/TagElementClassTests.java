 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TagElement public
...
public abstract interface TagElementClassTests<SUT extends TagElement>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TagElement.class!",
                   TagElement.class.isAssignableFrom(sut));
    }

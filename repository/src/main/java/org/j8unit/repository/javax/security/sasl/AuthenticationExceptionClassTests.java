 ...
 * javax.security.sasl.AuthenticationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AuthenticationExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AuthenticationExceptionTests}.
 * </p>
 *
 * @see javax.security.sasl.AuthenticationException class javax.security.sasl.AuthenticationException (the hereby
 *      targeted class-under-test class)
 * @see AuthenticationExceptionTests AuthenticationExceptionTests (The complementary j8unit test interface containing
...
extends SaslExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.AuthenticationException.class!",
                   javax.security.sasl.AuthenticationException.class.isAssignableFrom(sut));
    }

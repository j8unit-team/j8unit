...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.net.ssl.X509TrustManager interface
 * javax.net.ssl.X509TrustManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509TrustManagerTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see X509TrustManagerTests X509TrustManagerTests (The complementary j8unit test interface containing the instance
...
public abstract interface X509TrustManagerClassTests<SUT extends javax.net.ssl.X509TrustManager>
extends TrustManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.X509TrustManager.class!",
                   javax.net.ssl.X509TrustManager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509TrustManager
 * public abstract interface javax.net.ssl.X509TrustManager}.
 *
...
extends TrustManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509TrustManager.class!",
                   X509TrustManager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleBindings
 * public class javax.script.SimpleBindings}.
 *
...
public abstract interface SimpleBindingsClassTests<SUT extends SimpleBindings>
extends BindingsClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleBindings.class!",

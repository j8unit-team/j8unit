 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleBindingsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleBindingsTests}.
 * </p>
 *
 * @see javax.script.SimpleBindings class javax.script.SimpleBindings (the hereby targeted class-under-test class)
 * @see SimpleBindingsTests SimpleBindingsTests (The complementary j8unit test interface containing the instance
...
public abstract interface SimpleBindingsClassTests<SUT extends javax.script.SimpleBindings>
extends BindingsClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.SimpleBindings.class!",
                   javax.script.SimpleBindings.class.isAssignableFrom(sut));
    }

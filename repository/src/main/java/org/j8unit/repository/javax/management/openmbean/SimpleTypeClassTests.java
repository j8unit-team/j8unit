...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.SimpleType class
 * javax.management.openmbean.SimpleType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleTypeTests}.
 * </p>
 *
 * @see javax.management.openmbean.SimpleType class javax.management.openmbean.SimpleType (the hereby targeted
 *      class-under-test class)
 * @see SimpleTypeTests SimpleTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends OpenTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.SimpleType.class!",
                   javax.management.openmbean.SimpleType.class.isAssignableFrom(sut));
    }

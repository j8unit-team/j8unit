 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleType public
 * final class javax.management.openmbean.SimpleType<T>}.
 *
...
public abstract interface SimpleTypeClassTests<SUT extends SimpleType>
extends OpenTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleType.class!",
                   SimpleType.class.isAssignableFrom(sut));
    }

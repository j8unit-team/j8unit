...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.Attribute interface
 * javax.print.attribute.Attribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see AttributeTests AttributeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AttributeClassTests<SUT extends javax.print.attribute.Attribute>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.Attribute.class!",
                   javax.print.attribute.Attribute.class.isAssignableFrom(sut));
    }

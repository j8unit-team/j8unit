 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableHeaderUITests}).
 * </p>
 *
 * <p>
 ...
 * @see TableHeaderUITests TableHeaderUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TableHeaderUIClassTests<SUT extends javax.swing.plaf.TableHeaderUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.TableHeaderUI.class!",
                   javax.swing.plaf.TableHeaderUI.class.isAssignableFrom(sut));
    }

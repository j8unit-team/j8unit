 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TableHeaderUI
 * public abstract class javax.swing.plaf.TableHeaderUI}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TableHeaderUITests}.
 * </p>
 *
 * <p>
...
public abstract interface TableHeaderUIClassTests<SUT extends TableHeaderUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.TableHeaderUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableHeaderUI.class!",
                   TableHeaderUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.TableHeaderUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.TableHeaderUI]

...
import org.j8unit.repository.javax.lang.model.AnnotatedConstructClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeMirror public
 * abstract interface javax.lang.model.type.TypeMirror}.
 *
...
public abstract interface TypeMirrorClassTests<SUT extends TypeMirror>
extends AnnotatedConstructClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeMirror.class!",
                   TypeMirror.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link javax.naming.event.NamingEvent class javax.naming.event.NamingEvent}, containing all instance
 ...
 * @since 0.9.0
 * @see org.j8unit.repository.javax.naming.event.NamingEventClassTests
 */
...
extends org.j8unit.repository.java.util.EventObjectTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getNewBinding()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NullCipherTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NullCipherTests}.
 * </p>
 *
 * @see javax.crypto.NullCipher class javax.crypto.NullCipher (the hereby targeted class-under-test class)
 * @see NullCipherTests NullCipherTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NullCipherClassTests<SUT extends javax.crypto.NullCipher>
extends CipherClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.NullCipher.class!",
                   javax.crypto.NullCipher.class.isAssignableFrom(sut));
    }

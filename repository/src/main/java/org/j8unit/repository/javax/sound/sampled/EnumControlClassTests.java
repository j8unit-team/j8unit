 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EnumControlTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EnumControlTests}.
 * </p>
 *
 * @see javax.sound.sampled.EnumControl class javax.sound.sampled.EnumControl (the hereby targeted class-under-test
 *      class)
 * @see EnumControlTests EnumControlTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.EnumControl.class!",
                   javax.sound.sampled.EnumControl.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.EnumControl.Type class
     * javax.sound.sampled.EnumControl$Type}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link EnumControlTests.TypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see EnumControlTests.TypeTests EnumControlTests.TypeTests (The complementary j8unit test interface containing
    ...
    extends ControlClassTests.TypeClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.EnumControl.Type.class!",
                       javax.sound.sampled.EnumControl.Type.class.isAssignableFrom(sut));
        }

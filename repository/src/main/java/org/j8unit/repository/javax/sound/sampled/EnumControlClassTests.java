 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EnumControl public
 * abstract class javax.sound.sampled.EnumControl}.
 *
...
public abstract interface EnumControlClassTests<SUT extends EnumControl>
extends ControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EnumControl.class!",
                   EnumControl.class.isAssignableFrom(sut));
    }
     ...
     * {@link Type public static class javax.sound.sampled.EnumControl$Type}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * {@link org.j8unit.repository.javax.sound.sampled.EnumControlTests.TypeTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>

 ...
 * javax.accessibility.AccessibleValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleValueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleValueTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleValue interface javax.accessibility.AccessibleValue (the hereby targeted
 *      class-under-test class)
 * @see AccessibleValueTests AccessibleValueTests (The complementary j8unit test interface containing the instance
...
public abstract interface AccessibleValueClassTests<SUT extends javax.accessibility.AccessibleValue>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleValue.class!",
                   javax.accessibility.AccessibleValue.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnnotatedConstruct
 * public abstract interface javax.lang.model.AnnotatedConstruct}.
 *
...
public abstract interface AnnotatedConstructClassTests<SUT extends AnnotatedConstruct>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotatedConstruct.class!",
                   AnnotatedConstruct.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.MXBean interface javax.management.MXBean}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MXBeanTests}.
 * </p>
 *
 * @see javax.management.MXBean interface javax.management.MXBean (the hereby targeted class-under-test class)
 * @see MXBeanTests MXBeanTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MXBean.class!",
                   javax.management.MXBean.class.isAssignableFrom(sut));
    }

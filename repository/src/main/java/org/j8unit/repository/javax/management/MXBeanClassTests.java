 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MXBean public
 * abstract @interface javax.management.MXBean}.
 *
...
public abstract interface MXBeanClassTests<SUT extends MXBean>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MXBean.class!",
                   MXBean.class.isAssignableFrom(sut));
    }

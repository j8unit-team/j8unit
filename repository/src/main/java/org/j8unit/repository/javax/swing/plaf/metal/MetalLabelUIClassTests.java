 ...
 * javax.swing.plaf.metal.MetalLabelUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetalLabelUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MetalLabelUITests}.
 * </p>
 *
 * @see javax.swing.plaf.metal.MetalLabelUI class javax.swing.plaf.metal.MetalLabelUI (the hereby targeted
 *      class-under-test class)
 * @see MetalLabelUITests MetalLabelUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.basic.BasicLabelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalLabelUI.class!",
                   javax.swing.plaf.metal.MetalLabelUI.class.isAssignableFrom(sut));
    }

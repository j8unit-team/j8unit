...
import org.j8unit.repository.javax.swing.plaf.basic.BasicLabelUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalLabelUI public
...
public abstract interface MetalLabelUIClassTests<SUT extends MetalLabelUI>
extends BasicLabelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalLabelUI.class!",
                   MetalLabelUI.class.isAssignableFrom(sut));
    }

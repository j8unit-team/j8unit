 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link View public
...
public abstract interface ViewClassTests<SUT extends View>
extends SwingConstantsClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to View.class!", View.class.isAssignableFrom(sut));
    }

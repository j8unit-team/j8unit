 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Popup public class
 * javax.swing.Popup}.
 *
...
public abstract interface PopupClassTests<SUT extends Popup>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Popup.class!", Popup.class.isAssignableFrom(sut));
    }

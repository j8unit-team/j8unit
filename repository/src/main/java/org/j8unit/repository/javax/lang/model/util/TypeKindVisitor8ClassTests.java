 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeKindVisitor8
 * public class javax.lang.model.util.TypeKindVisitor8<R,P>}.
 *
...
public abstract interface TypeKindVisitor8ClassTests<SUT extends TypeKindVisitor8>
extends TypeKindVisitor7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeKindVisitor8.class!",
                   TypeKindVisitor8.class.isAssignableFrom(sut));
    }

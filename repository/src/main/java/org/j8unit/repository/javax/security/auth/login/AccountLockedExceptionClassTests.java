 ...
 * {@link AccountLockedException public class javax.security.auth.login.AccountLockedException}.
 *
...
public abstract interface AccountLockedExceptionClassTests<SUT extends AccountLockedException>
extends AccountExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccountLockedException.class!",

 ...
 * javax.security.auth.login.AccountLockedException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccountLockedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AccountLockedExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.login.AccountLockedException class javax.security.auth.login.AccountLockedException (the
 *      hereby targeted class-under-test class)
 * @see AccountLockedExceptionTests AccountLockedExceptionTests (The complementary j8unit test interface containing the
...
extends AccountExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.AccountLockedException.class!",
                   javax.security.auth.login.AccountLockedException.class.isAssignableFrom(sut));
    }

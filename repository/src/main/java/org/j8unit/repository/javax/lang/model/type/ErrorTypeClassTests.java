 ...
 * javax.lang.model.type.ErrorType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ErrorTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ErrorTypeTests}.
 * </p>
 *
 * @see javax.lang.model.type.ErrorType interface javax.lang.model.type.ErrorType (the hereby targeted class-under-test
 *      class)
 * @see ErrorTypeTests ErrorTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends DeclaredTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.ErrorType.class!",
                   javax.lang.model.type.ErrorType.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ErrorType public
 * abstract interface javax.lang.model.type.ErrorType}.
 *
...
public abstract interface ErrorTypeClassTests<SUT extends ErrorType>
extends DeclaredTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ErrorType.class!",
                   ErrorType.class.isAssignableFrom(sut));
    }

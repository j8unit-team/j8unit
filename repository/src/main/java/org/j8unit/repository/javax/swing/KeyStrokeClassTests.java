 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyStrokeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyStrokeTests}.
 * </p>
 *
 * @see javax.swing.KeyStroke class javax.swing.KeyStroke (the hereby targeted class-under-test class)
 * @see KeyStrokeTests KeyStrokeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.AWTKeyStrokeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.KeyStroke.class!",
                   javax.swing.KeyStroke.class.isAssignableFrom(sut));
    }

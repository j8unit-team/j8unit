...
import org.j8unit.repository.java.awt.AWTKeyStrokeClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyStroke public
...
public abstract interface KeyStrokeClassTests<SUT extends KeyStroke>
extends AWTKeyStrokeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyStroke.class!",
                   KeyStroke.class.isAssignableFrom(sut));
    }

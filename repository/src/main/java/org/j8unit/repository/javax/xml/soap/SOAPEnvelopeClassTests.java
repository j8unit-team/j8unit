...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.soap.SOAPEnvelope interface javax.xml.soap.SOAPEnvelope},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPEnvelopeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPEnvelopeTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPEnvelope interface javax.xml.soap.SOAPEnvelope (the hereby targeted class-under-test class)
 * @see SOAPEnvelopeTests SOAPEnvelopeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SOAPEnvelopeClassTests<SUT extends javax.xml.soap.SOAPEnvelope>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPEnvelope.class!",
                   javax.xml.soap.SOAPEnvelope.class.isAssignableFrom(sut));
    }

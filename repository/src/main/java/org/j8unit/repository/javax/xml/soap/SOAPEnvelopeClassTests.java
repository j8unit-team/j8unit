 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPEnvelope public
 * abstract interface javax.xml.soap.SOAPEnvelope}.
 *
...
public abstract interface SOAPEnvelopeClassTests<SUT extends SOAPEnvelope>
extends org.j8unit.repository.javax.xml.soap.SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPEnvelope.class!",
                   SOAPEnvelope.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.openmbean.CompositeDataView}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeDataViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompositeDataViewTests}.
 * </p>
 *
 * @see javax.management.openmbean.CompositeDataView interface javax.management.openmbean.CompositeDataView (the hereby
 *      targeted class-under-test class)
 * @see CompositeDataViewTests CompositeDataViewTests (The complementary j8unit test interface containing the instance
...
public abstract interface CompositeDataViewClassTests<SUT extends javax.management.openmbean.CompositeDataView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.CompositeDataView.class!",
                   javax.management.openmbean.CompositeDataView.class.isAssignableFrom(sut));
    }

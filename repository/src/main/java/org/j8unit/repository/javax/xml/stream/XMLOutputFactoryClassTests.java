 ...
 * javax.xml.stream.XMLOutputFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLOutputFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLOutputFactoryTests}.
 * </p>
 *
 * @see javax.xml.stream.XMLOutputFactory class javax.xml.stream.XMLOutputFactory (the hereby targeted class-under-test
 *      class)
 * @see XMLOutputFactoryTests XMLOutputFactoryTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.XMLOutputFactory.class!",
                   javax.xml.stream.XMLOutputFactory.class.isAssignableFrom(sut));
    }

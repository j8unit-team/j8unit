 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLOutputFactory
...
public abstract interface XMLOutputFactoryClassTests<SUT extends XMLOutputFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLOutputFactory.class!",
                   XMLOutputFactory.class.isAssignableFrom(sut));
    }

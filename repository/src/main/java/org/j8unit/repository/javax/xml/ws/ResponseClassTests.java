 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResponseTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ResponseTests}.
 * </p>
 *
 * @see javax.xml.ws.Response interface javax.xml.ws.Response (the hereby targeted class-under-test class)
 * @see ResponseTests ResponseTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.concurrent.FutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.Response.class!",
                   javax.xml.ws.Response.class.isAssignableFrom(sut));
    }

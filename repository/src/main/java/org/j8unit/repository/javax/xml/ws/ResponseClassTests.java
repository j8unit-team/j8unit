...
import org.j8unit.repository.java.util.concurrent.FutureClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Response public
...
public abstract interface ResponseClassTests<SUT extends Response>
extends FutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Response.class!",

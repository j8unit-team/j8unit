...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.remote.JMXConnectionNotification class
 * javax.management.remote.JMXConnectionNotification}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see JMXConnectionNotificationTests JMXConnectionNotificationTests (The complementary j8unit test interface
...
extends org.j8unit.repository.javax.management.NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXConnectionNotification.class!",
                   javax.management.remote.JMXConnectionNotification.class.isAssignableFrom(sut));
    }

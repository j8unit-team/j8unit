 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScriptEngine public
 * abstract interface javax.script.ScriptEngine}.
 *
...
public abstract interface ScriptEngineClassTests<SUT extends ScriptEngine>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScriptEngine.class!",
                   ScriptEngine.class.isAssignableFrom(sut));
    }

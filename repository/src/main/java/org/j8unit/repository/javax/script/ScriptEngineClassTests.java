...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.script.ScriptEngine interface javax.script.ScriptEngine},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScriptEngineTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScriptEngineTests}.
 * </p>
 *
 * @see javax.script.ScriptEngine interface javax.script.ScriptEngine (the hereby targeted class-under-test class)
 * @see ScriptEngineTests ScriptEngineTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ScriptEngineClassTests<SUT extends javax.script.ScriptEngine>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.ScriptEngine.class!",
                   javax.script.ScriptEngine.class.isAssignableFrom(sut));
    }

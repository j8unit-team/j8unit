 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileSystemView
...
public abstract interface FileSystemViewClassTests<SUT extends FileSystemView>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystemView.class!",
                   FileSystemView.class.isAssignableFrom(sut));
    }

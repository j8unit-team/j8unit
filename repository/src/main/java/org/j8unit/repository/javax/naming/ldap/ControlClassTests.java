...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.ldap.Control interface javax.naming.ldap.Control},
 ...
 * </p>
 *
 * @see javax.naming.ldap.Control interface javax.naming.ldap.Control (the hereby targeted class-under-test class)
...
public abstract interface ControlClassTests<SUT extends javax.naming.ldap.Control>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.Control.class!",
                   javax.naming.ldap.Control.class.isAssignableFrom(sut));
    }

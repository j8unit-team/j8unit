...
extends RepositoryClassTests<SUT> {
    ...
    extends RepositoryClassTests<SUT> {
         ...
         * @since 0.9.2
         *
         * @j8unit.aim javax.swing.text.AttributeSet.CharacterAttribute#isAssignableFrom(java.lang.Class)
         */
        @Test
    ...
    extends RepositoryClassTests<SUT> {
         ...
         * @since 0.9.2
         *
         * @j8unit.aim javax.swing.text.AttributeSet.ColorAttribute#isAssignableFrom(java.lang.Class)
         */
        @Test
        public default void testBaseTypeIsAssignableFromCurrentType()
        throws Exception {
    ...
    extends RepositoryClassTests<SUT> {
         ...
         * @since 0.9.2
         *
         * @j8unit.aim javax.swing.text.AttributeSet.FontAttribute#isAssignableFrom(java.lang.Class)
         */
        @Test
        public default void testBaseTypeIsAssignableFromCurrentType()
        throws Exception {
    ...
    extends RepositoryClassTests<SUT> {
         ...
         * @since 0.9.2
         *
         * @j8unit.aim javax.swing.text.AttributeSet.ParagraphAttribute#isAssignableFrom(java.lang.Class)
         */
        @Test
        public default void testBaseTypeIsAssignableFromCurrentType()
        throws Exception {
     ...
     * @since 0.9.2
     *
     * @j8unit.aim javax.swing.text.AttributeSet#isAssignableFrom(java.lang.Class)
     */
    @Test
    public default void testBaseTypeIsAssignableFromCurrentType()
    throws Exception {

 ...
 * {@link UnsupportedAudioFileException public class javax.sound.sampled.UnsupportedAudioFileException}.
 *
...
public abstract interface UnsupportedAudioFileExceptionClassTests<SUT extends UnsupportedAudioFileException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedAudioFileException.class!",
                   UnsupportedAudioFileException.class.isAssignableFrom(sut));
    }

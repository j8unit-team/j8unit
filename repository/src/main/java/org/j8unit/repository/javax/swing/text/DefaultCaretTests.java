...
extends CaretTests<SUT>, FocusListenerTests<SUT>, MouseListenerTests<SUT>, MouseMotionListenerTests<SUT>, RectangleTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getUpdatePolicy()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getMarkBias()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getDotBias()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

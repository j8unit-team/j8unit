 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DHPublicKey public
 * abstract interface javax.crypto.interfaces.DHPublicKey}.
 *
...
public abstract interface DHPublicKeyClassTests<SUT extends DHPublicKey>
extends DHKeyClassTests<SUT>, PublicKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DHPublicKey.class!",
                   DHPublicKey.class.isAssignableFrom(sut));
    }

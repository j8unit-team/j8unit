 ...
 * javax.crypto.interfaces.DHPublicKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DHPublicKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DHPublicKeyTests}.
 * </p>
 *
 * @see javax.crypto.interfaces.DHPublicKey interface javax.crypto.interfaces.DHPublicKey (the hereby targeted
 *      class-under-test class)
 * @see DHPublicKeyTests DHPublicKeyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DHPublicKeyClassTests<SUT extends javax.crypto.interfaces.DHPublicKey>
extends DHKeyClassTests<SUT>, org.j8unit.repository.java.security.PublicKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.interfaces.DHPublicKey.class!",
                   javax.crypto.interfaces.DHPublicKey.class.isAssignableFrom(sut));
    }

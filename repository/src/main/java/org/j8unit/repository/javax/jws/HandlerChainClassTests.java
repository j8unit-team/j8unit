 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HandlerChainTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HandlerChainTests}.
 * </p>
 *
 * @see javax.jws.HandlerChain interface javax.jws.HandlerChain (the hereby targeted class-under-test class)
 * @see HandlerChainTests HandlerChainTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface HandlerChainClassTests<SUT extends javax.jws.HandlerChain>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.HandlerChain.class!",
                   javax.jws.HandlerChain.class.isAssignableFrom(sut));
    }

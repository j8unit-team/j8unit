 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HandlerChain public
 * abstract @interface javax.jws.HandlerChain}.
 *
...
public abstract interface HandlerChainClassTests<SUT extends HandlerChain>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HandlerChain.class!",
                   HandlerChain.class.isAssignableFrom(sut));
    }

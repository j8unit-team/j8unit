...
public abstract interface TransformParameterSpecClassTests<SUT extends TransformParameterSpec>
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransformParameterSpec.class!",
                   TransformParameterSpec.class.isAssignableFrom(sut));
    }

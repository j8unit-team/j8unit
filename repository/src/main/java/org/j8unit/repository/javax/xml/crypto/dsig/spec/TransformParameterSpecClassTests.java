 ...
 * javax.xml.crypto.dsig.spec.TransformParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransformParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 * {@link TransformParameterSpecTests}.
 * </p>
 *
 ...
 * @see TransformParameterSpecTests TransformParameterSpecTests (The complementary j8unit test interface containing the
...
public abstract interface TransformParameterSpecClassTests<SUT extends javax.xml.crypto.dsig.spec.TransformParameterSpec>
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.TransformParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.TransformParameterSpec.class.isAssignableFrom(sut));
    }

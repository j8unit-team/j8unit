 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthComboBoxUI
...
public abstract interface SynthComboBoxUIClassTests<SUT extends SynthComboBoxUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicComboBoxUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthComboBoxUI.class!",
                   SynthComboBoxUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URLDataSource
 * public class javax.activation.URLDataSource}.
 *
...
public abstract interface URLDataSourceClassTests<SUT extends URLDataSource>
extends DataSourceClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLDataSource.class!",

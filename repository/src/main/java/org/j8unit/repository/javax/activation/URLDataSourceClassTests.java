...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.activation.URLDataSource class javax.activation.URLDataSource},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLDataSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URLDataSourceTests}.
 * </p>
 *
 * @see javax.activation.URLDataSource class javax.activation.URLDataSource (the hereby targeted class-under-test class)
 * @see URLDataSourceTests URLDataSourceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface URLDataSourceClassTests<SUT extends javax.activation.URLDataSource>
extends DataSourceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.URLDataSource.class!",
                   javax.activation.URLDataSource.class.isAssignableFrom(sut));
    }

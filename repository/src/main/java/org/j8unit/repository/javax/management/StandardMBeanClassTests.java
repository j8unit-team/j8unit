...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.StandardMBean class javax.management.StandardMBean},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StandardMBeanTests}.
 * </p>
 *
 * @see javax.management.StandardMBean class javax.management.StandardMBean (the hereby targeted class-under-test class)
 * @see StandardMBeanTests StandardMBeanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StandardMBeanClassTests<SUT extends javax.management.StandardMBean>
extends DynamicMBeanClassTests<SUT>, MBeanRegistrationClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.StandardMBean.class!",
                   javax.management.StandardMBean.class.isAssignableFrom(sut));
    }

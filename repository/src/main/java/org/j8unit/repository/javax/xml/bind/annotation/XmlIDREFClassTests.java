...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlIDREF interface
 * javax.xml.bind.annotation.XmlIDREF}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlIDREFTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlIDREFTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlIDREF interface javax.xml.bind.annotation.XmlIDREF (the hereby targeted
 *      class-under-test class)
 * @see XmlIDREFTests XmlIDREFTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlIDREFClassTests<SUT extends javax.xml.bind.annotation.XmlIDREF>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlIDREF.class!",
                   javax.xml.bind.annotation.XmlIDREF.class.isAssignableFrom(sut));
    }

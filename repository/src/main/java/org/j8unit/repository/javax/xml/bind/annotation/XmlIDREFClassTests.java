 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlIDREF public
 * abstract @interface javax.xml.bind.annotation.XmlIDREF}.
 *
...
public abstract interface XmlIDREFClassTests<SUT extends XmlIDREF>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlIDREF.class!",
                   XmlIDREF.class.isAssignableFrom(sut));
    }

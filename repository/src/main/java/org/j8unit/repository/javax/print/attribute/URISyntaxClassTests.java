 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URISyntax public
 * abstract class javax.print.attribute.URISyntax}.
 *
...
public abstract interface URISyntaxClassTests<SUT extends URISyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URISyntax.class!",
                   URISyntax.class.isAssignableFrom(sut));
    }

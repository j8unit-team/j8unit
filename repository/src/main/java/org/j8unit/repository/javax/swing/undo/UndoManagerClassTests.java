 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UndoManagerTests}).
 * </p>
 *
 * <p>
 ...
 * @see UndoManagerTests UndoManagerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface UndoManagerClassTests<SUT extends javax.swing.undo.UndoManager>
extends org.j8unit.repository.javax.swing.event.UndoableEditListenerClassTests<SUT>, CompoundEditClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.undo.UndoManager.class!",
                   javax.swing.undo.UndoManager.class.isAssignableFrom(sut));
    }

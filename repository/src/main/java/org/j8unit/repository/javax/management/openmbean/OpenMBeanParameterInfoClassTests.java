...
public abstract interface OpenMBeanParameterInfoClassTests<SUT extends OpenMBeanParameterInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanParameterInfo.class!",
                   OpenMBeanParameterInfo.class.isAssignableFrom(sut));
    }

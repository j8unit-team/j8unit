...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.OpenMBeanParameterInfo interface
 * javax.management.openmbean.OpenMBeanParameterInfo}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenMBeanParameterInfoTests}).
 * </p>
 *
 * <p>
 ...
 * {@link OpenMBeanParameterInfoTests}.
 * </p>
 *
 * @see javax.management.openmbean.OpenMBeanParameterInfo interface javax.management.openmbean.OpenMBeanParameterInfo
 *      (the hereby targeted class-under-test class)
 * @see OpenMBeanParameterInfoTests OpenMBeanParameterInfoTests (The complementary j8unit test interface containing the
...
public abstract interface OpenMBeanParameterInfoClassTests<SUT extends javax.management.openmbean.OpenMBeanParameterInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenMBeanParameterInfo.class!",
                   javax.management.openmbean.OpenMBeanParameterInfo.class.isAssignableFrom(sut));
    }

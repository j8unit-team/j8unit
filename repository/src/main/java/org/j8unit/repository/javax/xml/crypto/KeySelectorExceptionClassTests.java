 ...
 * {@link KeySelectorExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface KeySelectorExceptionClassTests<SUT extends KeySelectorException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeySelectorException.class!",
                   KeySelectorException.class.isAssignableFrom(sut));
    }

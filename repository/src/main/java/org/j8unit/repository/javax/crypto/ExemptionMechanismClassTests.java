 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExemptionMechanism
...
public abstract interface ExemptionMechanismClassTests<SUT extends ExemptionMechanism>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExemptionMechanism.class!",
                   ExemptionMechanism.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiTextUI public
...
public abstract interface MultiTextUIClassTests<SUT extends MultiTextUI>
extends TextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiTextUI.class!",
                   MultiTextUI.class.isAssignableFrom(sut));
    }

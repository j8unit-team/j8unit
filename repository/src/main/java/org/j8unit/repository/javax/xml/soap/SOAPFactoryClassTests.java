 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPFactory public
 * abstract class javax.xml.soap.SOAPFactory}.
 *
...
public abstract interface SOAPFactoryClassTests<SUT extends SOAPFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPFactory.class!",
                   SOAPFactory.class.isAssignableFrom(sut));
    }

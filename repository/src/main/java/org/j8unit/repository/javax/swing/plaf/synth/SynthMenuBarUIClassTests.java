...
import org.j8unit.repository.javax.swing.plaf.basic.BasicMenuBarUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthMenuBarUI
...
public abstract interface SynthMenuBarUIClassTests<SUT extends SynthMenuBarUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicMenuBarUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.synth.SynthMenuBarUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthMenuBarUI.class!",
                   SynthMenuBarUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthMenuBarUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.synth.SynthMenuBarUI]

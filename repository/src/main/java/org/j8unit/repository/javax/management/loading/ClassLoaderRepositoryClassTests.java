 ...
 * javax.management.loading.ClassLoaderRepository}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassLoaderRepositoryTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ClassLoaderRepositoryTests}.
 * </p>
 *
 * @see javax.management.loading.ClassLoaderRepository interface javax.management.loading.ClassLoaderRepository (the
 *      hereby targeted class-under-test class)
 * @see ClassLoaderRepositoryTests ClassLoaderRepositoryTests (The complementary j8unit test interface containing the
...
public abstract interface ClassLoaderRepositoryClassTests<SUT extends javax.management.loading.ClassLoaderRepository>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.loading.ClassLoaderRepository.class!",
                   javax.management.loading.ClassLoaderRepository.class.isAssignableFrom(sut));
    }

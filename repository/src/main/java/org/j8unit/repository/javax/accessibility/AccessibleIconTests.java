 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleIcon
 ...
 * {@link org.j8unit.repository.javax.accessibility.AccessibleIconClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface AccessibleIconTests<SUT extends AccessibleIcon>
extends RepositoryTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getAccessibleIconDescription()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

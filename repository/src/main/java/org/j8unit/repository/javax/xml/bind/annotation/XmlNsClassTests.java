...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlNs interface
 * javax.xml.bind.annotation.XmlNs}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlNsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlNsTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlNs interface javax.xml.bind.annotation.XmlNs (the hereby targeted class-under-test
 *      class)
 * @see XmlNsTests XmlNsTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface XmlNsClassTests<SUT extends javax.xml.bind.annotation.XmlNs>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlNs.class!",
                   javax.xml.bind.annotation.XmlNs.class.isAssignableFrom(sut));
    }

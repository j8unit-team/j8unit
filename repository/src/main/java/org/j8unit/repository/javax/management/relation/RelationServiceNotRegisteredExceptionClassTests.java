 ...
 * javax.management.relation.RelationServiceNotRegisteredException}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * </p>
 *
 * @see javax.management.relation.RelationServiceNotRegisteredException class
 *      javax.management.relation.RelationServiceNotRegisteredException (the hereby targeted class-under-test class)
 * @see RelationServiceNotRegisteredExceptionTests RelationServiceNotRegisteredExceptionTests (The complementary j8unit
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationServiceNotRegisteredException.class!",
                   javax.management.relation.RelationServiceNotRegisteredException.class.isAssignableFrom(sut));
    }

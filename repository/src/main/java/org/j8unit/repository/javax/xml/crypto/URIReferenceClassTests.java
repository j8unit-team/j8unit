 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URIReferenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URIReferenceTests}.
 * </p>
 *
 * @see javax.xml.crypto.URIReference interface javax.xml.crypto.URIReference (the hereby targeted class-under-test
 *      class)
 * @see URIReferenceTests URIReferenceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface URIReferenceClassTests<SUT extends javax.xml.crypto.URIReference>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.URIReference.class!",
                   javax.xml.crypto.URIReference.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Endpoint public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EndpointTests}.
 * </p>
 *
 * <p>
...
public abstract interface EndpointClassTests<SUT extends Endpoint>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Endpoint.class!",
                   Endpoint.class.isAssignableFrom(sut));
    }

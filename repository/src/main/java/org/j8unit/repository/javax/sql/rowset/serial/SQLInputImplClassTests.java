 ...
 * javax.sql.rowset.serial.SQLInputImpl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLInputImplTests}).
 * </p>
 *
 * <p>
 ...
 * @see SQLInputImplTests SQLInputImplTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.sql.SQLInputClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SQLInputImpl.class!",
                   javax.sql.rowset.serial.SQLInputImpl.class.isAssignableFrom(sut));
    }

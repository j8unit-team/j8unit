 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultRowSorter
...
public abstract interface DefaultRowSorterClassTests<SUT extends DefaultRowSorter>
extends org.j8unit.repository.javax.swing.RowSorterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultRowSorter.class!",
                   DefaultRowSorter.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.DefaultRowSorter]

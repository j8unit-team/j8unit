 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultRowSorterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultRowSorterTests}.
 * </p>
 *
 * @see javax.swing.DefaultRowSorter class javax.swing.DefaultRowSorter (the hereby targeted class-under-test class)
 * @see DefaultRowSorterTests DefaultRowSorterTests (The complementary j8unit test interface containing the instance
...
extends RowSorterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.DefaultRowSorter.class!",
                   javax.swing.DefaultRowSorter.class.isAssignableFrom(sut));
    }

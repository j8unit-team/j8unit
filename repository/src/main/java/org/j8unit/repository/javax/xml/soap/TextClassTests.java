...
public abstract interface TextClassTests<SUT extends javax.xml.soap.Text>
extends NodeClassTests<SUT>, org.j8unit.repository.org.w3c.dom.TextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.Text.class!",
                   javax.xml.soap.Text.class.isAssignableFrom(sut));
    }

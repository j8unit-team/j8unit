 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InternalFrameUI
 * public abstract class javax.swing.plaf.InternalFrameUI}.
 *
...
public abstract interface InternalFrameUIClassTests<SUT extends InternalFrameUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InternalFrameUI.class!",
                   InternalFrameUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractBorder
...
public abstract interface AbstractBorderClassTests<SUT extends AbstractBorder>
extends BorderClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractBorder.class!",
                   AbstractBorder.class.isAssignableFrom(sut));
    }

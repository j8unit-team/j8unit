 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleDocTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleDocTests}.
 * </p>
 *
 * @see javax.print.SimpleDoc class javax.print.SimpleDoc (the hereby targeted class-under-test class)
 * @see SimpleDocTests SimpleDocTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SimpleDocClassTests<SUT extends javax.print.SimpleDoc>
extends DocClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.SimpleDoc.class!",
                   javax.print.SimpleDoc.class.isAssignableFrom(sut));
    }

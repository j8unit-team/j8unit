...
import org.j8unit.repository.javax.swing.JButtonClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalComboBoxButton
 * public class javax.swing.plaf.metal.MetalComboBoxButton}.
 *
...
public abstract interface MetalComboBoxButtonClassTests<SUT extends MetalComboBoxButton>
extends JButtonClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalComboBoxButton]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalComboBoxButton.class!",
                   MetalComboBoxButton.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SoundbankTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SoundbankTests}.
 * </p>
 *
 * @see javax.sound.midi.Soundbank interface javax.sound.midi.Soundbank (the hereby targeted class-under-test class)
 * @see SoundbankTests SoundbankTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SoundbankClassTests<SUT extends javax.sound.midi.Soundbank>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Soundbank.class!",
                   javax.sound.midi.Soundbank.class.isAssignableFrom(sut));
    }

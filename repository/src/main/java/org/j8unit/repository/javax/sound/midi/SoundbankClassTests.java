 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Soundbank public
 * abstract interface javax.sound.midi.Soundbank}.
 *
...
public abstract interface SoundbankClassTests<SUT extends Soundbank>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Soundbank.class!",

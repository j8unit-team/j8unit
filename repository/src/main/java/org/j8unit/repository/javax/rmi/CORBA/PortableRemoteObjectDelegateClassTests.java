 ...
 * javax.rmi.CORBA.PortableRemoteObjectDelegate}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link PortableRemoteObjectDelegateTests}).
 * </p>
 *
 * <p>
 ...
 * @see PortableRemoteObjectDelegateTests PortableRemoteObjectDelegateTests (The complementary j8unit test interface
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.CORBA.PortableRemoteObjectDelegate.class!",
                   javax.rmi.CORBA.PortableRemoteObjectDelegate.class.isAssignableFrom(sut));
    }

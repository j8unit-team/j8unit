...
public abstract interface PortableRemoteObjectDelegateClassTests<SUT extends PortableRemoteObjectDelegate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PortableRemoteObjectDelegate.class!",
                   PortableRemoteObjectDelegate.class.isAssignableFrom(sut));
    }

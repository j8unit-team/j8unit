 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentInputMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentInputMapTests}.
 * </p>
 *
 * @see javax.swing.ComponentInputMap class javax.swing.ComponentInputMap (the hereby targeted class-under-test class)
 * @see ComponentInputMapTests ComponentInputMapTests (The complementary j8unit test interface containing the instance
...
extends InputMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.ComponentInputMap.class!",
                   javax.swing.ComponentInputMap.class.isAssignableFrom(sut));
    }

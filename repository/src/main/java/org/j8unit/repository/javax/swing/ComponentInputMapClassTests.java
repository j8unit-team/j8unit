 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComponentInputMap
 * public class javax.swing.ComponentInputMap}.
 *
...
public abstract interface ComponentInputMapClassTests<SUT extends ComponentInputMap>
extends InputMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentInputMap.class!",
                   ComponentInputMap.class.isAssignableFrom(sut));
    }

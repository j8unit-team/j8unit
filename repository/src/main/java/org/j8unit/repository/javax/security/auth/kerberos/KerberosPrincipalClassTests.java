 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KerberosPrincipal
 * public final class javax.security.auth.kerberos.KerberosPrincipal}.
 *
...
public abstract interface KerberosPrincipalClassTests<SUT extends KerberosPrincipal>
extends PrincipalClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KerberosPrincipal.class!",

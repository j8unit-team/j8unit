 ...
 * javax.xml.bind.SchemaOutputResolver}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SchemaOutputResolverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SchemaOutputResolverTests}
 * .
 * </p>
 *
 * @see javax.xml.bind.SchemaOutputResolver class javax.xml.bind.SchemaOutputResolver (the hereby targeted
 *      class-under-test class)
 * @see SchemaOutputResolverTests SchemaOutputResolverTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.SchemaOutputResolver.class!",
                   javax.xml.bind.SchemaOutputResolver.class.isAssignableFrom(sut));
    }

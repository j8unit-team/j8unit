 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CommandInfo public
...
public abstract interface CommandInfoClassTests<SUT extends CommandInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CommandInfo.class!",
                   CommandInfo.class.isAssignableFrom(sut));
    }

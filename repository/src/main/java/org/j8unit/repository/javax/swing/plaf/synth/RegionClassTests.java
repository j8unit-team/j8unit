 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Region public class
...
public abstract interface RegionClassTests<SUT extends Region>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Region.class!",
                   Region.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.text.html.ObjectView}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectViewTests}.
 * </p>
 *
 * @see javax.swing.text.html.ObjectView class javax.swing.text.html.ObjectView (the hereby targeted class-under-test
 *      class)
 * @see ObjectViewTests ObjectViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.text.ComponentViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.ObjectView.class!",
                   javax.swing.text.html.ObjectView.class.isAssignableFrom(sut));
    }

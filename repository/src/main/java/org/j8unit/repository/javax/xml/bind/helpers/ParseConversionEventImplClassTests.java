 ...
 * javax.xml.bind.helpers.ParseConversionEventImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParseConversionEventImplTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ParseConversionEventImplTests}.
 * </p>
 *
 * @see javax.xml.bind.helpers.ParseConversionEventImpl class javax.xml.bind.helpers.ParseConversionEventImpl (the
 *      hereby targeted class-under-test class)
 * @see ParseConversionEventImplTests ParseConversionEventImplTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.xml.bind.ParseConversionEventClassTests<SUT>, ValidationEventImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.helpers.ParseConversionEventImpl.class!",
                   javax.xml.bind.helpers.ParseConversionEventImpl.class.isAssignableFrom(sut));
    }

 ...
 * javax.net.ssl.SSLSessionBindingEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLSessionBindingEventTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SSLSessionBindingEventTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLSessionBindingEvent class javax.net.ssl.SSLSessionBindingEvent (the hereby targeted
 *      class-under-test class)
 * @see SSLSessionBindingEventTests SSLSessionBindingEventTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLSessionBindingEvent.class!",
                   javax.net.ssl.SSLSessionBindingEvent.class.isAssignableFrom(sut));
    }

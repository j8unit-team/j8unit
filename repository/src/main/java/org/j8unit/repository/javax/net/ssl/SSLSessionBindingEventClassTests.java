...
public abstract interface SSLSessionBindingEventClassTests<SUT extends SSLSessionBindingEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLSessionBindingEvent.class!",
                   SSLSessionBindingEvent.class.isAssignableFrom(sut));
    }

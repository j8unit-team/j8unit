...
public abstract interface DefaultListSelectionModelClassTests<SUT extends DefaultListSelectionModel>
extends ListSelectionModelClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.DefaultListSelectionModel]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultListSelectionModel.class!",
                   DefaultListSelectionModel.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.DefaultListSelectionModel]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.DefaultListSelectionModel]

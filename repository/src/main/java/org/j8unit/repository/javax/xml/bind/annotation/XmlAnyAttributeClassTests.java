...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlAnyAttribute interface
 * javax.xml.bind.annotation.XmlAnyAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlAnyAttributeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlAnyAttributeTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlAnyAttribute interface javax.xml.bind.annotation.XmlAnyAttribute (the hereby
 *      targeted class-under-test class)
 * @see XmlAnyAttributeTests XmlAnyAttributeTests (The complementary j8unit test interface containing the instance
...
public abstract interface XmlAnyAttributeClassTests<SUT extends javax.xml.bind.annotation.XmlAnyAttribute>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlAnyAttribute.class!",
                   javax.xml.bind.annotation.XmlAnyAttribute.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAnyAttribute
 * public abstract @interface javax.xml.bind.annotation.XmlAnyAttribute}.
 *
...
public abstract interface XmlAnyAttributeClassTests<SUT extends XmlAnyAttribute>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAnyAttribute.class!",
                   XmlAnyAttribute.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.plaf.synth.SynthLookAndFeel class
 * javax.swing.plaf.synth.SynthLookAndFeel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthLookAndFeelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthLookAndFeelTests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthLookAndFeel class javax.swing.plaf.synth.SynthLookAndFeel (the hereby targeted
 *      class-under-test class)
 * @see SynthLookAndFeelTests SynthLookAndFeelTests (The complementary j8unit test interface containing the instance
...
public abstract interface SynthLookAndFeelClassTests<SUT extends javax.swing.plaf.synth.SynthLookAndFeel>
extends org.j8unit.repository.javax.swing.plaf.basic.BasicLookAndFeelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthLookAndFeel.class!",
                   javax.swing.plaf.synth.SynthLookAndFeel.class.isAssignableFrom(sut));
    }

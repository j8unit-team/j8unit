...
import org.j8unit.repository.javax.swing.plaf.basic.BasicLookAndFeelClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthLookAndFeel
 * public class javax.swing.plaf.synth.SynthLookAndFeel}.
 *
...
public abstract interface SynthLookAndFeelClassTests<SUT extends SynthLookAndFeel>
extends BasicLookAndFeelClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.synth.SynthLookAndFeel]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthLookAndFeel.class!",
                   SynthLookAndFeel.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthLookAndFeel]

...
public abstract interface StreamPrintServiceFactoryClassTests<SUT extends StreamPrintServiceFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamPrintServiceFactory.class!",
                   StreamPrintServiceFactory.class.isAssignableFrom(sut));
    }

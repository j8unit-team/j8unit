...
public abstract interface SynthPasswordFieldUIClassTests<SUT extends SynthPasswordFieldUI>
extends SynthTextFieldUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthPasswordFieldUI.class!",
                   SynthPasswordFieldUI.class.isAssignableFrom(sut));
    }

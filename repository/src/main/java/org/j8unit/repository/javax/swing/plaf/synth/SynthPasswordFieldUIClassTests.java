 ...
 * javax.swing.plaf.synth.SynthPasswordFieldUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthPasswordFieldUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthPasswordFieldUITests}
 * .
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthPasswordFieldUI class javax.swing.plaf.synth.SynthPasswordFieldUI (the hereby
 *      targeted class-under-test class)
 * @see SynthPasswordFieldUITests SynthPasswordFieldUITests (The complementary j8unit test interface containing the
...
extends SynthTextFieldUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthPasswordFieldUI.class!",
                   javax.swing.plaf.synth.SynthPasswordFieldUI.class.isAssignableFrom(sut));
    }

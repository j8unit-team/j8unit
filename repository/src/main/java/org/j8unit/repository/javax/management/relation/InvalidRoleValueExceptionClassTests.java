...
public abstract interface InvalidRoleValueExceptionClassTests<SUT extends InvalidRoleValueException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidRoleValueException.class!",
                   InvalidRoleValueException.class.isAssignableFrom(sut));
    }

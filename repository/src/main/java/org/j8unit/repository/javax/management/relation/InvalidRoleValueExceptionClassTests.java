 ...
 * javax.management.relation.InvalidRoleValueException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidRoleValueExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidRoleValueExceptionTests InvalidRoleValueExceptionTests (The complementary j8unit test interface
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.InvalidRoleValueException.class!",
                   javax.management.relation.InvalidRoleValueException.class.isAssignableFrom(sut));
    }

...
public abstract interface URIReferenceExceptionClassTests<SUT extends URIReferenceException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URIReferenceException.class!",
                   URIReferenceException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Cipher public class
 * javax.crypto.Cipher}.
 *
...
public abstract interface CipherClassTests<SUT extends Cipher>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Cipher.class!",
                   Cipher.class.isAssignableFrom(sut));
    }

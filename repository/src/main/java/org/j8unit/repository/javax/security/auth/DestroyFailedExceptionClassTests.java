...
public abstract interface DestroyFailedExceptionClassTests<SUT extends DestroyFailedException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DestroyFailedException.class!",
                   DestroyFailedException.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.auth.DestroyFailedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DestroyFailedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link DestroyFailedExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.DestroyFailedException class javax.security.auth.DestroyFailedException (the hereby targeted
 *      class-under-test class)
 * @see DestroyFailedExceptionTests DestroyFailedExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.DestroyFailedException.class!",
                   javax.security.auth.DestroyFailedException.class.isAssignableFrom(sut));
    }

 ...
 * javax.annotation.processing.Filer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilerTests}.
 * </p>
 *
 * @see javax.annotation.processing.Filer interface javax.annotation.processing.Filer (the hereby targeted
 *      class-under-test class)
 * @see FilerTests FilerTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface FilerClassTests<SUT extends javax.annotation.processing.Filer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.Filer.class!",
                   javax.annotation.processing.Filer.class.isAssignableFrom(sut));
    }

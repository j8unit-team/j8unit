 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Filer public
...
public abstract interface FilerClassTests<SUT extends Filer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Filer.class!", Filer.class.isAssignableFrom(sut));
    }

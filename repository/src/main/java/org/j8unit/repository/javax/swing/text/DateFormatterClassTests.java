 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateFormatter
 * public class javax.swing.text.DateFormatter}.
 *
...
public abstract interface DateFormatterClassTests<SUT extends DateFormatter>
extends InternationalFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateFormatter.class!",
                   DateFormatter.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateFormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateFormatterTests}.
 * </p>
 *
 * @see javax.swing.text.DateFormatter class javax.swing.text.DateFormatter (the hereby targeted class-under-test class)
 * @see DateFormatterTests DateFormatterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends InternationalFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.DateFormatter.class!",
                   javax.swing.text.DateFormatter.class.isAssignableFrom(sut));
    }

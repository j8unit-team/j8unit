 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSorter public
 * abstract class javax.swing.RowSorter<M>}.
 *
...
public abstract interface RowSorterClassTests<SUT extends RowSorter>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSorter.class!",
     ...
     * {@link SortKey public static class javax.swing.RowSorter$SortKey}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface SortKeyClassTests<SUT extends SortKey>
    extends ObjectClassTests<SUT> {

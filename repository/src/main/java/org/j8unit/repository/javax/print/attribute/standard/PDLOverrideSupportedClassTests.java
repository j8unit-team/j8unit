 ...
 * {@link PDLOverrideSupportedTests}.
 * </p>
 *
 * <p>
...
public abstract interface PDLOverrideSupportedClassTests<SUT extends PDLOverrideSupported>
extends PrintServiceAttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PDLOverrideSupported.class!",
                   PDLOverrideSupported.class.isAssignableFrom(sut));
    }

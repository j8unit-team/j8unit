...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.PDLOverrideSupported class
 * javax.print.attribute.standard.PDLOverrideSupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PDLOverrideSupportedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PDLOverrideSupportedTests}
 * .
 * </p>
 *
 ...
 * @see PDLOverrideSupportedTests PDLOverrideSupportedTests (The complementary j8unit test interface containing the
...
public abstract interface PDLOverrideSupportedClassTests<SUT extends javax.print.attribute.standard.PDLOverrideSupported>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PDLOverrideSupported.class!",
                   javax.print.attribute.standard.PDLOverrideSupported.class.isAssignableFrom(sut));
    }

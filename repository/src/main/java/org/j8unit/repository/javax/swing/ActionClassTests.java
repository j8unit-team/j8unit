...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.Action interface javax.swing.Action}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.Action interface javax.swing.Action (the hereby targeted class-under-test class)
 * @see ActionTests ActionTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ActionClassTests<SUT extends javax.swing.Action>
extends org.j8unit.repository.java.awt.event.ActionListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.Action.class!",
                   javax.swing.Action.class.isAssignableFrom(sut));
    }

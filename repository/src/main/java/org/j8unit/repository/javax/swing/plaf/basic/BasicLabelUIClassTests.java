...
import org.j8unit.repository.javax.swing.plaf.LabelUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicLabelUI public
...
public abstract interface BasicLabelUIClassTests<SUT extends BasicLabelUI>
extends PropertyChangeListenerClassTests<SUT>, LabelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicLabelUI.class!",
                   BasicLabelUI.class.isAssignableFrom(sut));
    }

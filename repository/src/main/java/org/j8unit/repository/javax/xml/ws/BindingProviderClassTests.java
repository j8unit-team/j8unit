 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BindingProviderTests}.
 * </p>
 *
 * @see javax.xml.ws.BindingProvider interface javax.xml.ws.BindingProvider (the hereby targeted class-under-test class)
 * @see BindingProviderTests BindingProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface BindingProviderClassTests<SUT extends javax.xml.ws.BindingProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.BindingProvider.class!",
                   javax.xml.ws.BindingProvider.class.isAssignableFrom(sut));
    }

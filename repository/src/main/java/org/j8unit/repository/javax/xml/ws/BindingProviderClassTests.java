 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindingProvider
 * public abstract interface javax.xml.ws.BindingProvider}.
 *
...
public abstract interface BindingProviderClassTests<SUT extends BindingProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingProvider.class!",
                   BindingProvider.class.isAssignableFrom(sut));
    }

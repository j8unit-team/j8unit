 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXBIntrospector
...
public abstract interface JAXBIntrospectorClassTests<SUT extends JAXBIntrospector>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXBIntrospector.class!",
                   JAXBIntrospector.class.isAssignableFrom(sut));
    }

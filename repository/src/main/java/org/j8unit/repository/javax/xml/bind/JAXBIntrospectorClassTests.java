 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JAXBIntrospectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JAXBIntrospectorTests}.
 * </p>
 *
 * @see javax.xml.bind.JAXBIntrospector class javax.xml.bind.JAXBIntrospector (the hereby targeted class-under-test
 *      class)
 * @see JAXBIntrospectorTests JAXBIntrospectorTests (The complementary j8unit test interface containing the instance
...
public abstract interface JAXBIntrospectorClassTests<SUT extends javax.xml.bind.JAXBIntrospector>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.JAXBIntrospector.class!",
                   javax.xml.bind.JAXBIntrospector.class.isAssignableFrom(sut));
    }

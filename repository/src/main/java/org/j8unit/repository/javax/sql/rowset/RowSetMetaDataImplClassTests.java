...
import org.j8unit.repository.javax.sql.RowSetMetaDataClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetMetaDataImpl
 * public class javax.sql.rowset.RowSetMetaDataImpl}.
 *
...
public abstract interface RowSetMetaDataImplClassTests<SUT extends RowSetMetaDataImpl>
extends RowSetMetaDataClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetMetaDataImpl.class!",
                   RowSetMetaDataImpl.class.isAssignableFrom(sut));
    }

...
public abstract interface XPathExpressionExceptionClassTests<SUT extends XPathExpressionException>
extends XPathExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathExpressionException.class!",
                   XPathExpressionException.class.isAssignableFrom(sut));
    }

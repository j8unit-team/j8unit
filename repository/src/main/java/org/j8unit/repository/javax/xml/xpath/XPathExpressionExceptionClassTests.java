 ...
 * javax.xml.xpath.XPathExpressionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathExpressionExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link XPathExpressionExceptionTests}.
 * </p>
 *
 * @see javax.xml.xpath.XPathExpressionException class javax.xml.xpath.XPathExpressionException (the hereby targeted
 *      class-under-test class)
 * @see XPathExpressionExceptionTests XPathExpressionExceptionTests (The complementary j8unit test interface containing
...
extends XPathExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.xpath.XPathExpressionException.class!",
                   javax.xml.xpath.XPathExpressionException.class.isAssignableFrom(sut));
    }

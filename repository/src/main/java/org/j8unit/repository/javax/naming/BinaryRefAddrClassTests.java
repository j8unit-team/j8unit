 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BinaryRefAddrTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BinaryRefAddrTests}.
 * </p>
 *
 * @see javax.naming.BinaryRefAddr class javax.naming.BinaryRefAddr (the hereby targeted class-under-test class)
 * @see BinaryRefAddrTests BinaryRefAddrTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends RefAddrClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.BinaryRefAddr.class!",
                   javax.naming.BinaryRefAddr.class.isAssignableFrom(sut));
    }

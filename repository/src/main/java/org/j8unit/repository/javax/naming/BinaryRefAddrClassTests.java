 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BinaryRefAddr
...
public abstract interface BinaryRefAddrClassTests<SUT extends BinaryRefAddr>
extends RefAddrClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.naming.BinaryRefAddr]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BinaryRefAddr.class!",
                   BinaryRefAddr.class.isAssignableFrom(sut));
    }

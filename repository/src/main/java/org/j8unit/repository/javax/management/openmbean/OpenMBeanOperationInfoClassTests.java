 ...
 * javax.management.openmbean.OpenMBeanOperationInfo}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenMBeanOperationInfoTests}).
 * </p>
 *
 * <p>
 ...
 * {@link OpenMBeanOperationInfoTests}.
 * </p>
 *
 * @see javax.management.openmbean.OpenMBeanOperationInfo interface javax.management.openmbean.OpenMBeanOperationInfo
 *      (the hereby targeted class-under-test class)
 * @see OpenMBeanOperationInfoTests OpenMBeanOperationInfoTests (The complementary j8unit test interface containing the
...
public abstract interface OpenMBeanOperationInfoClassTests<SUT extends javax.management.openmbean.OpenMBeanOperationInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenMBeanOperationInfo.class!",
                   javax.management.openmbean.OpenMBeanOperationInfo.class.isAssignableFrom(sut));
    }

...
public abstract interface ActionClassTests<SUT extends javax.xml.ws.Action>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.Action.class!",
                   javax.xml.ws.Action.class.isAssignableFrom(sut));
    }

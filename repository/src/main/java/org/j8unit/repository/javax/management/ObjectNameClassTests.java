 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectNameTests}.
 * </p>
 *
 * @see javax.management.ObjectName class javax.management.ObjectName (the hereby targeted class-under-test class)
 * @see ObjectNameTests ObjectNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, QueryExpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.ObjectName.class!",
                   javax.management.ObjectName.class.isAssignableFrom(sut));
    }

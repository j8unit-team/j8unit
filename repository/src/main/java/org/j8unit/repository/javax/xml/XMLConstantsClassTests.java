 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLConstants public
 * final class javax.xml.XMLConstants}.
 *
...
public abstract interface XMLConstantsClassTests<SUT extends XMLConstants>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLConstants.class!",
                   XMLConstants.class.isAssignableFrom(sut));
    }

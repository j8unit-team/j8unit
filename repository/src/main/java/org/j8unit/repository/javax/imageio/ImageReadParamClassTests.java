 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageReadParam
...
public abstract interface ImageReadParamClassTests<SUT extends ImageReadParam>
extends IIOParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageReadParam.class!",
                   ImageReadParam.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageReadParamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageReadParamTests}.
 * </p>
 *
 * @see javax.imageio.ImageReadParam class javax.imageio.ImageReadParam (the hereby targeted class-under-test class)
 * @see ImageReadParamTests ImageReadParamTests (The complementary j8unit test interface containing the instance
...
public abstract interface ImageReadParamClassTests<SUT extends javax.imageio.ImageReadParam>
extends IIOParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.ImageReadParam.class!",
                   javax.imageio.ImageReadParam.class.isAssignableFrom(sut));
    }

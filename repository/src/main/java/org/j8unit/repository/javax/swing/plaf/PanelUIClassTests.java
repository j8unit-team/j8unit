 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PanelUI public
...
public abstract interface PanelUIClassTests<SUT extends PanelUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PanelUI.class!",
                   PanelUI.class.isAssignableFrom(sut));
    }

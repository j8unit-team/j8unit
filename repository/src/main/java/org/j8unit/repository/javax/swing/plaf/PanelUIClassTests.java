 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PanelUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PanelUITests}.
 * </p>
 *
 * @see javax.swing.plaf.PanelUI class javax.swing.plaf.PanelUI (the hereby targeted class-under-test class)
 * @see PanelUITests PanelUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PanelUIClassTests<SUT extends javax.swing.plaf.PanelUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.PanelUI.class!",
                   javax.swing.plaf.PanelUI.class.isAssignableFrom(sut));
    }

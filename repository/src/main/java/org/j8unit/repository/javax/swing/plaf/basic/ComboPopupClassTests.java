 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComboPopup public
 * abstract interface javax.swing.plaf.basic.ComboPopup}.
 *
...
public abstract interface ComboPopupClassTests<SUT extends ComboPopup>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComboPopup.class!",
                   ComboPopup.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EmptyBorder public
...
public abstract interface EmptyBorderClassTests<SUT extends EmptyBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EmptyBorder.class!",
                   EmptyBorder.class.isAssignableFrom(sut));
    }

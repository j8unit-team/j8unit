 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPMessageHandlers
 * public abstract @interface javax.jws.soap.SOAPMessageHandlers}.
 *
...
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPMessageHandlers.class!",
                   SOAPMessageHandlers.class.isAssignableFrom(sut));
    }

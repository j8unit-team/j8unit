...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.jws.soap.SOAPMessageHandlers interface
 * javax.jws.soap.SOAPMessageHandlers}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPMessageHandlersTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPMessageHandlersTests}.
 * </p>
 *
 * @see javax.jws.soap.SOAPMessageHandlers interface javax.jws.soap.SOAPMessageHandlers (the hereby targeted
 *      class-under-test class)
 * @see SOAPMessageHandlersTests SOAPMessageHandlersTests (The complementary j8unit test interface containing the
...
public abstract interface SOAPMessageHandlersClassTests<SUT extends javax.jws.soap.SOAPMessageHandlers>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.soap.SOAPMessageHandlers.class!",
                   javax.jws.soap.SOAPMessageHandlers.class.isAssignableFrom(sut));
    }

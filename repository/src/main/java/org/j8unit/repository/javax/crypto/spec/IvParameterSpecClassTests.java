 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IvParameterSpec
...
public abstract interface IvParameterSpecClassTests<SUT extends IvParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.crypto.spec.IvParameterSpec]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IvParameterSpec.class!",
                   IvParameterSpec.class.isAssignableFrom(sut));
    }

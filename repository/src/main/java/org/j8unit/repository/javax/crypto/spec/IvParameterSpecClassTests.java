 ...
 * javax.crypto.spec.IvParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IvParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IvParameterSpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.IvParameterSpec class javax.crypto.spec.IvParameterSpec (the hereby targeted class-under-test
 *      class)
 * @see IvParameterSpecTests IvParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.IvParameterSpec.class!",
                   javax.crypto.spec.IvParameterSpec.class.isAssignableFrom(sut));
    }

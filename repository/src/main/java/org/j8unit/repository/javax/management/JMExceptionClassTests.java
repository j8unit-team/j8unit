 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMException public
...
public abstract interface JMExceptionClassTests<SUT extends JMException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMException.class!",
                   JMException.class.isAssignableFrom(sut));
    }

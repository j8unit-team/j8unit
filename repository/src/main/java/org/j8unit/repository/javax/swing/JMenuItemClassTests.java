 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMenuItem public
...
public abstract interface JMenuItemClassTests<SUT extends JMenuItem>
extends AccessibleClassTests<SUT>, MenuElementClassTests<SUT>, AbstractButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMenuItem.class!",

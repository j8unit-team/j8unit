 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScrollPaneUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScrollPaneUITests}.
 * </p>
 *
 * @see javax.swing.plaf.ScrollPaneUI class javax.swing.plaf.ScrollPaneUI (the hereby targeted class-under-test class)
 * @see ScrollPaneUITests ScrollPaneUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ScrollPaneUIClassTests<SUT extends javax.swing.plaf.ScrollPaneUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ScrollPaneUI.class!",
                   javax.swing.plaf.ScrollPaneUI.class.isAssignableFrom(sut));
    }

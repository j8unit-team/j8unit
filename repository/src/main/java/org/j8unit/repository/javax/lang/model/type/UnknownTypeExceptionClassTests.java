 ...
 * {@link UnknownTypeException public class javax.lang.model.type.UnknownTypeException}.
 *
 ...
 * {@link org.j8unit.repository.javax.lang.model.type.UnknownTypeExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface UnknownTypeExceptionClassTests<SUT extends UnknownTypeException>
extends UnknownEntityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownTypeException.class!",
                   UnknownTypeException.class.isAssignableFrom(sut));
    }

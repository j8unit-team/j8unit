 ...
 * javax.swing.event.TreeExpansionEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeExpansionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeExpansionEventTests}.
 * </p>
 *
 * @see javax.swing.event.TreeExpansionEvent class javax.swing.event.TreeExpansionEvent (the hereby targeted
 *      class-under-test class)
 * @see TreeExpansionEventTests TreeExpansionEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TreeExpansionEvent.class!",
                   javax.swing.event.TreeExpansionEvent.class.isAssignableFrom(sut));
    }

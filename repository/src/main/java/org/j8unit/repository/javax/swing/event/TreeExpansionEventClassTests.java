 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeExpansionEvent
 * public class javax.swing.event.TreeExpansionEvent}.
 *
...
public abstract interface TreeExpansionEventClassTests<SUT extends TreeExpansionEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeExpansionEvent.class!",
                   TreeExpansionEvent.class.isAssignableFrom(sut));
    }

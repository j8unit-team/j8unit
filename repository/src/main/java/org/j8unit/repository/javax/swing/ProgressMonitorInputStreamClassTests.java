...
public abstract interface ProgressMonitorInputStreamClassTests<SUT extends ProgressMonitorInputStream>
extends FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProgressMonitorInputStream.class!",
                   ProgressMonitorInputStream.class.isAssignableFrom(sut));
    }

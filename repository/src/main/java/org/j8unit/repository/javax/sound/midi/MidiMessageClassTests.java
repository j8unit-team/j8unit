...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sound.midi.MidiMessage class javax.sound.midi.MidiMessage},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MidiMessageTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MidiMessageTests}.
 * </p>
 *
 * @see javax.sound.midi.MidiMessage class javax.sound.midi.MidiMessage (the hereby targeted class-under-test class)
 * @see MidiMessageTests MidiMessageTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MidiMessageClassTests<SUT extends javax.sound.midi.MidiMessage>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.MidiMessage.class!",
                   javax.sound.midi.MidiMessage.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiMessage public
 * abstract class javax.sound.midi.MidiMessage}.
 *
...
public abstract interface MidiMessageClassTests<SUT extends MidiMessage>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiMessage.class!",
                   MidiMessage.class.isAssignableFrom(sut));
    }

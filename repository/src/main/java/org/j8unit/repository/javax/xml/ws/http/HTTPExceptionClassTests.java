...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.http.HTTPException class javax.xml.ws.http.HTTPException}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTTPExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTTPExceptionTests}.
 * </p>
 *
 * @see javax.xml.ws.http.HTTPException class javax.xml.ws.http.HTTPException (the hereby targeted class-under-test
 *      class)
 * @see HTTPExceptionTests HTTPExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface HTTPExceptionClassTests<SUT extends javax.xml.ws.http.HTTPException>
extends org.j8unit.repository.javax.xml.ws.ProtocolExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.http.HTTPException.class!",
                   javax.xml.ws.http.HTTPException.class.isAssignableFrom(sut));
    }

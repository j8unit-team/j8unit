 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTTPException
...
public abstract interface HTTPExceptionClassTests<SUT extends HTTPException>
extends ProtocolExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTTPException.class!",
                   HTTPException.class.isAssignableFrom(sut));
    }

 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link JavaFileManager
...
extends CloseableTests<SUT>, FlushableTests<SUT>, OptionCheckerTests<SUT> {
     ...
     * public abstract static interface javax.tools.JavaFileManager$Location}.
     * </p>
     *
     * <p>
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects
     * (see {@link org.j8unit.repository.javax.tools.JavaFileManagerClassTests.LocationClassTests}).
     * </p>
     *
     * @param SUT
     *            the type of the subject-under-test

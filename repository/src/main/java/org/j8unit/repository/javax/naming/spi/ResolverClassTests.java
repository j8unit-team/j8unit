 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResolverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ResolverTests}.
 * </p>
 *
 * @see javax.naming.spi.Resolver interface javax.naming.spi.Resolver (the hereby targeted class-under-test class)
 * @see ResolverTests ResolverTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ResolverClassTests<SUT extends javax.naming.spi.Resolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.Resolver.class!",
                   javax.naming.spi.Resolver.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Resolver public
 * abstract interface javax.naming.spi.Resolver}.
 *
...
public abstract interface ResolverClassTests<SUT extends Resolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Resolver.class!",

...
import org.j8unit.repository.javax.swing.plaf.basic.BasicSplitPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthSplitPaneUI
 * public class javax.swing.plaf.synth.SynthSplitPaneUI}.
 *
...
public abstract interface SynthSplitPaneUIClassTests<SUT extends SynthSplitPaneUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicSplitPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthSplitPaneUI.class!",
                   SynthSplitPaneUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthSplitPaneUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.synth.SynthSplitPaneUI]

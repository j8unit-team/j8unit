 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultCaretTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultCaretTests}.
 * </p>
 *
 * @see javax.swing.text.DefaultCaret class javax.swing.text.DefaultCaret (the hereby targeted class-under-test class)
 * @see DefaultCaretTests DefaultCaretTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends CaretClassTests<SUT>, org.j8unit.repository.java.awt.event.FocusListenerClassTests<SUT>,
...
org.j8unit.repository.java.awt.RectangleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.DefaultCaret.class!",
                   javax.swing.text.DefaultCaret.class.isAssignableFrom(sut));
    }

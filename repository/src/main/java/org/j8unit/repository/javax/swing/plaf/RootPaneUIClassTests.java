 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RootPaneUI public
 * abstract class javax.swing.plaf.RootPaneUI}.
 *
...
public abstract interface RootPaneUIClassTests<SUT extends RootPaneUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RootPaneUI.class!",
                   RootPaneUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.RootPaneUI]

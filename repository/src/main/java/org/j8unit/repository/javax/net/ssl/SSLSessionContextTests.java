 ...
 * {@link SSLSessionContext public abstract interface javax.net.ssl.SSLSessionContext}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.net.ssl.SSLSessionContextClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface SSLSessionContextTests<SUT extends SSLSessionContext>

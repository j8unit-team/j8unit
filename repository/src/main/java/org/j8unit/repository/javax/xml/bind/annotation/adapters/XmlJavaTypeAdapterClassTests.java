...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter interface
 * javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlJavaTypeAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlJavaTypeAdapterTests}.
 * </p>
 *
 ...
 * @see XmlJavaTypeAdapterTests XmlJavaTypeAdapterTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.class!",
                   javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.DEFAULT
     * class javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter$DEFAULT}, containing all type relevant aspects
     ...
     * {@link XmlJavaTypeAdapterTests.DEFAULTTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see XmlJavaTypeAdapterTests.DEFAULTTests XmlJavaTypeAdapterTests.DEFAULTTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.DEFAULT.class!",
                       javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.DEFAULT.class.isAssignableFrom(sut));
        }

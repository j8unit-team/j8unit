 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlJavaTypeAdapter
 * public abstract @interface javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter}.
 *
...
public abstract interface XmlJavaTypeAdapterClassTests<SUT extends XmlJavaTypeAdapter>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlJavaTypeAdapter.class!",
                   XmlJavaTypeAdapter.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter]
     ...
     * {@link DEFAULT public static final class javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter$DEFAULT}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter$DEFAULT]

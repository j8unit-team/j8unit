...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT>
{
    ...
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter> sut = createNewSUT();
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.javax.xml.bind.annotation.adapters.XmlJavaTypeAdapterTests.DEFAULTTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT>
    {
        ...
        /**
         * Test method for {@link javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.DEFAULT#DEFAULT() public javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter$DEFAULT()}.
         */
        ...
        public default void create_DEFAULT() throws Exception {
            ...
            javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.DEFAULT sut = null; // = new DEFAULT();
        }

        @Test
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter.DEFAULT> sut = createNewSUT();
            // assert assignability

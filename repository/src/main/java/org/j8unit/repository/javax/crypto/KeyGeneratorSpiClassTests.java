 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyGeneratorSpi
...
public abstract interface KeyGeneratorSpiClassTests<SUT extends KeyGeneratorSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyGeneratorSpi.class!",
                   KeyGeneratorSpi.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.crypto.KeyGeneratorSpi]

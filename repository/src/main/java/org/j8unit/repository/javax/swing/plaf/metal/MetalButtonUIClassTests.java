 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalButtonUI
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MetalButtonUITests}.
 * </p>
 *
 * <p>
...
public abstract interface MetalButtonUIClassTests<SUT extends MetalButtonUI>
extends BasicButtonUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalButtonUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalButtonUI.class!",
                   MetalButtonUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.metal.MetalButtonUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.metal.MetalButtonUI]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicMenuBarUI
...
public abstract interface BasicMenuBarUIClassTests<SUT extends BasicMenuBarUI>
extends MenuBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicMenuBarUI.class!",
                   BasicMenuBarUI.class.isAssignableFrom(sut));
    }

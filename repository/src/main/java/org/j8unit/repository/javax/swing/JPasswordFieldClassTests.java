 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JPasswordFieldTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.JPasswordField class javax.swing.JPasswordField (the hereby targeted class-under-test class)
 * @see JPasswordFieldTests JPasswordFieldTests (The complementary j8unit test interface containing the instance
...
extends JTextFieldClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JPasswordField.class!",
                   javax.swing.JPasswordField.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JPasswordField
 * public class javax.swing.JPasswordField}.
 *
...
extends org.j8unit.repository.javax.swing.JTextFieldClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JPasswordField.class!",
                   JPasswordField.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.JPasswordField]

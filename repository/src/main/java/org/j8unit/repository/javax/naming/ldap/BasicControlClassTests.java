 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicControlTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicControlTests}.
 * </p>
 *
 * @see javax.naming.ldap.BasicControl class javax.naming.ldap.BasicControl (the hereby targeted class-under-test class)
 * @see BasicControlTests BasicControlTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ControlClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.BasicControl.class!",
                   javax.naming.ldap.BasicControl.class.isAssignableFrom(sut));
    }

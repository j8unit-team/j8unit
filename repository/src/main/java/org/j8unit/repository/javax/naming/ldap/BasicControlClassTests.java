 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicControl public
...
public abstract interface BasicControlClassTests<SUT extends BasicControl>
extends ControlClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicControl.class!",
                   BasicControl.class.isAssignableFrom(sut));
    }

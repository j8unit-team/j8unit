 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SyncProvider public
 * abstract class javax.sql.rowset.spi.SyncProvider}.
 *
...
public abstract interface SyncProviderClassTests<SUT extends SyncProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SyncProvider.class!",
                   SyncProvider.class.isAssignableFrom(sut));
    }

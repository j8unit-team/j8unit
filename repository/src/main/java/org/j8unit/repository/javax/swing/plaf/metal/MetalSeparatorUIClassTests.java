 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalSeparatorUI
 * public class javax.swing.plaf.metal.MetalSeparatorUI}.
 *
...
extends BasicSeparatorUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalSeparatorUI.class!",
                   MetalSeparatorUI.class.isAssignableFrom(sut));
    }

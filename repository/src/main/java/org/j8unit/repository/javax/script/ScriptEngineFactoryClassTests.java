 ...
 * javax.script.ScriptEngineFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScriptEngineFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScriptEngineFactoryTests}.
 * </p>
 *
 * @see javax.script.ScriptEngineFactory interface javax.script.ScriptEngineFactory (the hereby targeted
 *      class-under-test class)
 * @see ScriptEngineFactoryTests ScriptEngineFactoryTests (The complementary j8unit test interface containing the
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.ScriptEngineFactory.class!",
                   javax.script.ScriptEngineFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScriptEngineFactory
 * public abstract interface javax.script.ScriptEngineFactory}.
 *
...
public abstract interface ScriptEngineFactoryClassTests<SUT extends ScriptEngineFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScriptEngineFactory.class!",
                   ScriptEngineFactory.class.isAssignableFrom(sut));
    }

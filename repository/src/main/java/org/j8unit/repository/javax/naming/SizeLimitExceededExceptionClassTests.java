 ...
 * {@link SizeLimitExceededException public class javax.naming.SizeLimitExceededException}.
 *
...
public abstract interface SizeLimitExceededExceptionClassTests<SUT extends SizeLimitExceededException>
extends LimitExceededExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SizeLimitExceededException.class!",
                   SizeLimitExceededException.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.SizeLimitExceededException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link SizeLimitExceededExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see SizeLimitExceededExceptionTests SizeLimitExceededExceptionTests (The complementary j8unit test interface
...
extends LimitExceededExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.SizeLimitExceededException.class!",
                   javax.naming.SizeLimitExceededException.class.isAssignableFrom(sut));
    }

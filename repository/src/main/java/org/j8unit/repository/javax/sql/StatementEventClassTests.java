 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StatementEvent
...
public abstract interface StatementEventClassTests<SUT extends StatementEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StatementEvent.class!",
                   StatementEvent.class.isAssignableFrom(sut));
    }

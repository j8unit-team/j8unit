 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StatementEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StatementEventTests}.
 * </p>
 *
 * @see javax.sql.StatementEvent class javax.sql.StatementEvent (the hereby targeted class-under-test class)
 * @see StatementEventTests StatementEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.StatementEvent.class!",
                   javax.sql.StatementEvent.class.isAssignableFrom(sut));
    }

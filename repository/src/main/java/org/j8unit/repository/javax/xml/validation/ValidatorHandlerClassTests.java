...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.validation.ValidatorHandler class
 * javax.xml.validation.ValidatorHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValidatorHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValidatorHandlerTests}.
 * </p>
 *
 * @see javax.xml.validation.ValidatorHandler class javax.xml.validation.ValidatorHandler (the hereby targeted
 *      class-under-test class)
 * @see ValidatorHandlerTests ValidatorHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ValidatorHandlerClassTests<SUT extends javax.xml.validation.ValidatorHandler>
extends org.j8unit.repository.org.xml.sax.ContentHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.validation.ValidatorHandler.class!",
                   javax.xml.validation.ValidatorHandler.class.isAssignableFrom(sut));
    }

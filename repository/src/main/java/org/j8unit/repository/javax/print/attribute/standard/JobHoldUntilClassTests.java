        ...
        org.j8unit.repository.javax.print.attribute.DateTimeSyntaxClassTests<SUT>
{
    ...
    /**
     * Test method for {@link javax.print.attribute.standard.JobHoldUntil#JobHoldUntil(java.util.Date) public javax.print.attribute.standard.JobHoldUntil(java.util.Date)}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_JobHoldUntil_Date() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        javax.print.attribute.standard.JobHoldUntil sut = null; // = new JobHoldUntil(java.util.Date);
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends javax.print.attribute.standard.JobHoldUntil> sut = createNewSUT();

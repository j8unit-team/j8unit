 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobHoldUntil public
 * final class javax.print.attribute.standard.JobHoldUntil}.
 *
...
public abstract interface JobHoldUntilClassTests<SUT extends JobHoldUntil>
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, DateTimeSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobHoldUntil.class!",
                   JobHoldUntil.class.isAssignableFrom(sut));
    }

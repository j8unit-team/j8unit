...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.JobHoldUntil class
 * javax.print.attribute.standard.JobHoldUntil}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobHoldUntilTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobHoldUntilTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.JobHoldUntil class javax.print.attribute.standard.JobHoldUntil (the hereby
 *      targeted class-under-test class)
 * @see JobHoldUntilTests JobHoldUntilTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface JobHoldUntilClassTests<SUT extends javax.print.attribute.standard.JobHoldUntil>
...
org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.DateTimeSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobHoldUntil.class!",
                   javax.print.attribute.standard.JobHoldUntil.class.isAssignableFrom(sut));
    }

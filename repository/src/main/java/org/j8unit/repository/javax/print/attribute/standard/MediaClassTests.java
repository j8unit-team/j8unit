...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.Media class
 * javax.print.attribute.standard.Media}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MediaTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MediaTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.Media class javax.print.attribute.standard.Media (the hereby targeted
 *      class-under-test class)
 * @see MediaTests MediaTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface MediaClassTests<SUT extends javax.print.attribute.standard.Media>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.Media.class!",
                   javax.print.attribute.standard.Media.class.isAssignableFrom(sut));
    }

 ...
 * javax.tools.ForwardingFileObject}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ForwardingFileObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ForwardingFileObjectTests}
 * .
 * </p>
 *
 * @see javax.tools.ForwardingFileObject class javax.tools.ForwardingFileObject (the hereby targeted class-under-test
 *      class)
 * @see ForwardingFileObjectTests ForwardingFileObjectTests (The complementary j8unit test interface containing the
...
public abstract interface ForwardingFileObjectClassTests<SUT extends javax.tools.ForwardingFileObject>
extends FileObjectClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.ForwardingFileObject.class!",
                   javax.tools.ForwardingFileObject.class.isAssignableFrom(sut));
    }

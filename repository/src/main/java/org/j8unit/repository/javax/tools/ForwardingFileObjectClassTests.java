 ...
 * {@link ForwardingFileObjectTests}.
 * </p>
 *
 * <p>
...
public abstract interface ForwardingFileObjectClassTests<SUT extends ForwardingFileObject>
extends FileObjectClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ForwardingFileObject.class!",
                   ForwardingFileObject.class.isAssignableFrom(sut));
    }

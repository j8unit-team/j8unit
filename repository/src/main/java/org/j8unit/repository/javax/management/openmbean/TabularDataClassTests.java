 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TabularData public
 * abstract interface javax.management.openmbean.TabularData}.
 *
...
public abstract interface TabularDataClassTests<SUT extends TabularData>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TabularData.class!",
                   TabularData.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.openmbean.TabularData}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TabularDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TabularDataTests}.
 * </p>
 *
 * @see javax.management.openmbean.TabularData interface javax.management.openmbean.TabularData (the hereby targeted
 *      class-under-test class)
 * @see TabularDataTests TabularDataTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TabularDataClassTests<SUT extends javax.management.openmbean.TabularData>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.TabularData.class!",
                   javax.management.openmbean.TabularData.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EndpointContext
 * public abstract class javax.xml.ws.EndpointContext}.
 *
...
public abstract interface EndpointContextClassTests<SUT extends EndpointContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EndpointContext.class!",
                   EndpointContext.class.isAssignableFrom(sut));
    }

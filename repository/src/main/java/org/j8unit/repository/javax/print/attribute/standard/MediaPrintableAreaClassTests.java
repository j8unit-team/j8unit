...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    /**
     * Test method for
     * {@link javax.print.attribute.standard.MediaPrintableArea#MediaPrintableArea(float,float,float,float,int) public
    ...
    throws Exception {
        ...
        final javax.print.attribute.standard.MediaPrintableArea sut = null; // = new
                                                                            // MediaPrintableArea(float,float,float,float,int);
    }

    /**
     * Test method for {@link javax.print.attribute.standard.MediaPrintableArea#MediaPrintableArea(int,int,int,int,int)
     * public javax.print.attribute.standard.MediaPrintableArea(int,int,int,int,int)}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)

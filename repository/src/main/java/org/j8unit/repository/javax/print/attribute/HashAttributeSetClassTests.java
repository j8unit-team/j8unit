 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HashAttributeSet
 * public class javax.print.attribute.HashAttributeSet}.
 *
...
public abstract interface HashAttributeSetClassTests<SUT extends HashAttributeSet>
extends AttributeSetClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.HashAttributeSet]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HashAttributeSet.class!",
                   HashAttributeSet.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.HashAttributeSet class
 * javax.print.attribute.HashAttributeSet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HashAttributeSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HashAttributeSetTests}.
 * </p>
 *
 * @see javax.print.attribute.HashAttributeSet class javax.print.attribute.HashAttributeSet (the hereby targeted
 *      class-under-test class)
 * @see HashAttributeSetTests HashAttributeSetTests (The complementary j8unit test interface containing the instance
...
extends AttributeSetClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.HashAttributeSet.class!",
                   javax.print.attribute.HashAttributeSet.class.isAssignableFrom(sut));
    }

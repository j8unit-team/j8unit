...
import org.j8unit.repository.javax.swing.plaf.basic.BasicSpinnerUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthSpinnerUI
...
public abstract interface SynthSpinnerUIClassTests<SUT extends SynthSpinnerUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicSpinnerUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthSpinnerUI.class!",
                   SynthSpinnerUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthSpinnerUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.synth.SynthSpinnerUI]

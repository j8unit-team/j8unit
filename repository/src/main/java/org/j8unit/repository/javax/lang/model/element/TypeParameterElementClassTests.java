...
public abstract interface TypeParameterElementClassTests<SUT extends TypeParameterElement>
extends ElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeParameterElement.class!",
                   TypeParameterElement.class.isAssignableFrom(sut));
    }

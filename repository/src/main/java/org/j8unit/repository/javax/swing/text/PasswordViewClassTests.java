 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PasswordViewTests}).
 * </p>
 *
 * <p>
 ...
 * @see PasswordViewTests PasswordViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends FieldViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.PasswordView.class!",
                   javax.swing.text.PasswordView.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RelationService
...
NotificationBroadcasterSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationService.class!",
                   RelationService.class.isAssignableFrom(sut));
    }

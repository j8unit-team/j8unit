...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.ServiceMode interface javax.xml.ws.ServiceMode},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceModeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServiceModeTests}.
 * </p>
 *
 * @see javax.xml.ws.ServiceMode interface javax.xml.ws.ServiceMode (the hereby targeted class-under-test class)
 * @see ServiceModeTests ServiceModeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ServiceModeClassTests<SUT extends javax.xml.ws.ServiceMode>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.ServiceMode.class!",
                   javax.xml.ws.ServiceMode.class.isAssignableFrom(sut));
    }

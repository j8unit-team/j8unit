 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceMode public
 * abstract @interface javax.xml.ws.ServiceMode}.
 *
...
public abstract interface ServiceModeClassTests<SUT extends ServiceMode>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceMode.class!",
                   ServiceMode.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SplitPaneUI public
 * abstract class javax.swing.plaf.SplitPaneUI}.
 *
...
public abstract interface SplitPaneUIClassTests<SUT extends SplitPaneUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SplitPaneUI.class!",
                   SplitPaneUI.class.isAssignableFrom(sut));
    }

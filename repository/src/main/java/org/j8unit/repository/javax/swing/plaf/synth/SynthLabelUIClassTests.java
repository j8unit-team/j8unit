 ...
 * javax.swing.plaf.synth.SynthLabelUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthLabelUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthLabelUITests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthLabelUI class javax.swing.plaf.synth.SynthLabelUI (the hereby targeted
 *      class-under-test class)
 * @see SynthLabelUITests SynthLabelUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SynthUIClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.basic.BasicLabelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthLabelUI.class!",
                   javax.swing.plaf.synth.SynthLabelUI.class.isAssignableFrom(sut));
    }

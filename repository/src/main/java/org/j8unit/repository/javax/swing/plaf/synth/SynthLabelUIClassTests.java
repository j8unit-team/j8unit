 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthLabelUI public
...
public abstract interface SynthLabelUIClassTests<SUT extends SynthLabelUI>
extends org.j8unit.repository.javax.swing.plaf.synth.SynthUIClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.basic.BasicLabelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthLabelUI.class!",
                   SynthLabelUI.class.isAssignableFrom(sut));
    }

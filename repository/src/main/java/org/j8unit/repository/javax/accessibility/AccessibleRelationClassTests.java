 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleRelation
 * public class javax.accessibility.AccessibleRelation}.
 *
...
public abstract interface AccessibleRelationClassTests<SUT extends AccessibleRelation>
extends AccessibleBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleRelation.class!",
                   AccessibleRelation.class.isAssignableFrom(sut));
    }

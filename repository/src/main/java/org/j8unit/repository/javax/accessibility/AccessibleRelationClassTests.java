...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.accessibility.AccessibleRelation class
 * javax.accessibility.AccessibleRelation}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleRelationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleRelationTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleRelation class javax.accessibility.AccessibleRelation (the hereby targeted
 *      class-under-test class)
 * @see AccessibleRelationTests AccessibleRelationTests (The complementary j8unit test interface containing the instance
...
extends AccessibleBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleRelation.class!",
                   javax.accessibility.AccessibleRelation.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocAttribute public
 * abstract interface javax.print.attribute.DocAttribute}.
 *
...
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocAttribute.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.DocAttribute interface
 * javax.print.attribute.DocAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocAttributeTests}).
 * </p>
 *
 * <p>
 ...
 * @see DocAttributeTests DocAttributeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DocAttributeClassTests<SUT extends javax.print.attribute.DocAttribute>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.DocAttribute.class!",
                   javax.print.attribute.DocAttribute.class.isAssignableFrom(sut));
    }

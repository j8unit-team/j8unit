 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToolTipManager
...
public abstract interface ToolTipManagerClassTests<SUT extends ToolTipManager>
extends MouseAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToolTipManager.class!",
                   ToolTipManager.class.isAssignableFrom(sut));
    }

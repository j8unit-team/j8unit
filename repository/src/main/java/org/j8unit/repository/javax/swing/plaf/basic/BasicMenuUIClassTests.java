 ...
 * javax.swing.plaf.basic.BasicMenuUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicMenuUITests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicMenuUITests BasicMenuUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends BasicMenuItemUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicMenuUI.class!",
                   javax.swing.plaf.basic.BasicMenuUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicMenuUI.ChangeHandler class
     * javax.swing.plaf.basic.BasicMenuUI$ChangeHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link BasicMenuUITests.ChangeHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicMenuUITests.ChangeHandlerTests BasicMenuUITests.ChangeHandlerTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.javax.swing.event.ChangeListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicMenuUI.ChangeHandler.class!",
                       javax.swing.plaf.basic.BasicMenuUI.ChangeHandler.class.isAssignableFrom(sut));
        }

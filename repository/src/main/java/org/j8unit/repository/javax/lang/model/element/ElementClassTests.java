 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Element public
 * abstract interface javax.lang.model.element.Element}.
 *
...
extends AnnotatedConstructClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Element.class!",

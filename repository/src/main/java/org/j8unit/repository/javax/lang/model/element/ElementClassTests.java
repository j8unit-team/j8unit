...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.lang.model.element.Element interface
 * javax.lang.model.element.Element}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ElementTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.lang.model.element.Element interface javax.lang.model.element.Element (the hereby targeted
 *      class-under-test class)
 * @see ElementTests ElementTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ElementClassTests<SUT extends javax.lang.model.element.Element>
extends org.j8unit.repository.javax.lang.model.AnnotatedConstructClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.element.Element.class!",
                   javax.lang.model.element.Element.class.isAssignableFrom(sut));
    }

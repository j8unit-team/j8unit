 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintEvent public
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintEvent.class!",
                   PrintEvent.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.DigestMethod interface
 * javax.xml.crypto.dsig.DigestMethod}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DigestMethodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DigestMethodTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.DigestMethod interface javax.xml.crypto.dsig.DigestMethod (the hereby targeted
 *      class-under-test class)
 * @see DigestMethodTests DigestMethodTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DigestMethodClassTests<SUT extends javax.xml.crypto.dsig.DigestMethod>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT>, org.j8unit.repository.javax.xml.crypto.AlgorithmMethodClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.DigestMethod.class!",
                   javax.xml.crypto.dsig.DigestMethod.class.isAssignableFrom(sut));
    }

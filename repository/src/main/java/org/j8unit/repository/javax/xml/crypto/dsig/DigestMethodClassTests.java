 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DigestMethod public
 * abstract interface javax.xml.crypto.dsig.DigestMethod}.
 *
...
public abstract interface DigestMethodClassTests<SUT extends DigestMethod>
extends XMLStructureClassTests<SUT>, AlgorithmMethodClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DigestMethod.class!",
                   DigestMethod.class.isAssignableFrom(sut));
    }

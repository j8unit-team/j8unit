 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicPopupMenuUI
 * public class javax.swing.plaf.basic.BasicPopupMenuUI}.
 *
...
public abstract interface BasicPopupMenuUIClassTests<SUT extends BasicPopupMenuUI>
extends PopupMenuUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicPopupMenuUI.class!",
                   BasicPopupMenuUI.class.isAssignableFrom(sut));
    }

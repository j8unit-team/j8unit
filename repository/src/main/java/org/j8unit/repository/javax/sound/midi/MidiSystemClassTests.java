 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiSystem public
...
public abstract interface MidiSystemClassTests<SUT extends MidiSystem>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiSystem.class!",
                   MidiSystem.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.FileChooserUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiFileChooserUI
 * public class javax.swing.plaf.multi.MultiFileChooserUI}.
 *
...
public abstract interface MultiFileChooserUIClassTests<SUT extends MultiFileChooserUI>
extends FileChooserUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiFileChooserUI.class!",
                   MultiFileChooserUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.multi.MultiFileChooserUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.multi.MultiFileChooserUI]

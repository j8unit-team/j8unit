 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InitialContextTests}).
 * </p>
 *
 * <p>
 ...
 * @see InitialContextTests InitialContextTests (The complementary j8unit test interface containing the instance
...
extends ContextClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.InitialContext.class!",
                   javax.naming.InitialContext.class.isAssignableFrom(sut));
    }

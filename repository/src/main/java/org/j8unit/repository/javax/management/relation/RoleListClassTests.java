...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.relation.RoleList class
 * javax.management.relation.RoleList}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RoleListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RoleListTests}.
 * </p>
 *
 * @see javax.management.relation.RoleList class javax.management.relation.RoleList (the hereby targeted
 *      class-under-test class)
 * @see RoleListTests RoleListTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.ArrayListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RoleList.class!",
                   javax.management.relation.RoleList.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoleList public
...
public abstract interface RoleListClassTests<SUT extends RoleList>
extends ArrayListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleList.class!",
                   RoleList.class.isAssignableFrom(sut));
    }

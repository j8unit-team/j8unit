 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Duration public
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Duration.class!",
                   Duration.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.datatype.Duration]

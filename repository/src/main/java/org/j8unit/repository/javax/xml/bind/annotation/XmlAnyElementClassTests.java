 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAnyElement
 * public abstract @interface javax.xml.bind.annotation.XmlAnyElement}.
 *
...
public abstract interface XmlAnyElementClassTests<SUT extends XmlAnyElement>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAnyElement.class!",
                   XmlAnyElement.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlAnyElement interface
 * javax.xml.bind.annotation.XmlAnyElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlAnyElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlAnyElementTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlAnyElement interface javax.xml.bind.annotation.XmlAnyElement (the hereby targeted
 *      class-under-test class)
 * @see XmlAnyElementTests XmlAnyElementTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XmlAnyElementClassTests<SUT extends javax.xml.bind.annotation.XmlAnyElement>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlAnyElement.class!",
                   javax.xml.bind.annotation.XmlAnyElement.class.isAssignableFrom(sut));
    }

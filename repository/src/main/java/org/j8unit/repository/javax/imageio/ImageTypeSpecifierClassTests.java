 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageTypeSpecifier
...
public abstract interface ImageTypeSpecifierClassTests<SUT extends ImageTypeSpecifier>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageTypeSpecifier.class!",
                   ImageTypeSpecifier.class.isAssignableFrom(sut));
    }

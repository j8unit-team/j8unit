...
public abstract interface DefaultTreeCellRendererClassTests<SUT extends DefaultTreeCellRenderer>
extends TreeCellRendererClassTests<SUT>, JLabelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultTreeCellRenderer.class!",

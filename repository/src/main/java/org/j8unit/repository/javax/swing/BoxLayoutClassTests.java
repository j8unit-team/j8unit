 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BoxLayout public
...
public abstract interface BoxLayoutClassTests<SUT extends BoxLayout>
extends LayoutManager2ClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BoxLayout.class!",
                   BoxLayout.class.isAssignableFrom(sut));
    }

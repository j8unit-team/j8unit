...
public abstract interface PredicateClassTests<SUT extends javax.sql.rowset.Predicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.Predicate.class!",
                   javax.sql.rowset.Predicate.class.isAssignableFrom(sut));
    }

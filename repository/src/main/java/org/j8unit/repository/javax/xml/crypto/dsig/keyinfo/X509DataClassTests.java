 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509Data public
...
public abstract interface X509DataClassTests<SUT extends X509Data>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509Data.class!",
                   X509Data.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.crypto.dsig.keyinfo.X509Data}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509DataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509DataTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.X509Data interface javax.xml.crypto.dsig.keyinfo.X509Data (the hereby targeted
 *      class-under-test class)
 * @see X509DataTests X509DataTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface X509DataClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.X509Data>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.X509Data.class!",
                   javax.xml.crypto.dsig.keyinfo.X509Data.class.isAssignableFrom(sut));
    }

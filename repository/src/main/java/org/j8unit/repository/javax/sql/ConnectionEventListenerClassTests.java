 ...
 * {@link ConnectionEventListener public abstract interface javax.sql.ConnectionEventListener}.
 *
...
public abstract interface ConnectionEventListenerClassTests<SUT extends ConnectionEventListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConnectionEventListener.class!",
                   ConnectionEventListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.sql.ConnectionEventListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConnectionEventListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ConnectionEventListenerTests}.
 * </p>
 *
 * @see javax.sql.ConnectionEventListener interface javax.sql.ConnectionEventListener (the hereby targeted
 *      class-under-test class)
 * @see ConnectionEventListenerTests ConnectionEventListenerTests (The complementary j8unit test interface containing
...
public abstract interface ConnectionEventListenerClassTests<SUT extends javax.sql.ConnectionEventListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.ConnectionEventListener.class!",
                   javax.sql.ConnectionEventListener.class.isAssignableFrom(sut));
    }

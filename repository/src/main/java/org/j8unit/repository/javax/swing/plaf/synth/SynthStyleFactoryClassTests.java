 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthStyleFactory
 * public abstract class javax.swing.plaf.synth.SynthStyleFactory}.
 *
...
public abstract interface SynthStyleFactoryClassTests<SUT extends SynthStyleFactory>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.synth.SynthStyleFactory]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthStyleFactory.class!",
                   SynthStyleFactory.class.isAssignableFrom(sut));
    }

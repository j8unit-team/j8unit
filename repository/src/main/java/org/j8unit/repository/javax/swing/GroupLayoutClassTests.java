 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GroupLayoutTests}).
 * </p>
 *
 * <p>
 ...
 * @see GroupLayoutTests GroupLayoutTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.LayoutManager2ClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.GroupLayout.class!",
                   javax.swing.GroupLayout.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.GroupLayout.ParallelGroup class
     * javax.swing.GroupLayout$ParallelGroup}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link GroupLayoutTests.ParallelGroupTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see GroupLayoutTests.ParallelGroupTests GroupLayoutTests.ParallelGroupTests (The complementary j8unit test
    ...
    extends GroupLayoutClassTests.GroupClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.GroupLayout.ParallelGroup.class!",
                       javax.swing.GroupLayout.ParallelGroup.class.isAssignableFrom(sut));
        }
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link GroupLayoutTests.GroupTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see GroupLayoutTests.GroupTests GroupLayoutTests.GroupTests (The complementary j8unit test interface containing
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.GroupLayout.Group.class!",
                       javax.swing.GroupLayout.Group.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.GroupLayout$Alignment}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link GroupLayoutTests.AlignmentTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class-under-test class)
     * @see GroupLayoutTests.AlignmentTests GroupLayoutTests.AlignmentTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.GroupLayout.Alignment.class!",
                       javax.swing.GroupLayout.Alignment.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.GroupLayout$SequentialGroup}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     * and further type specific requirements). (In addition, the runtime type of this j8unit test interface's generic
     * type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link GroupLayoutTests.SequentialGroupTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class-under-test class)
     * @see GroupLayoutTests.SequentialGroupTests GroupLayoutTests.SequentialGroupTests (The complementary j8unit test
     *      interface containing the instance relevant test methods)
     *
     * @param SUT
     *            the class' type of the subject-under-test
    ...
    extends GroupLayoutClassTests.GroupClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.GroupLayout.SequentialGroup.class!",
                       javax.swing.GroupLayout.SequentialGroup.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToolProvider public
...
public abstract interface ToolProviderClassTests<SUT extends ToolProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToolProvider.class!",
                   ToolProvider.class.isAssignableFrom(sut));
    }

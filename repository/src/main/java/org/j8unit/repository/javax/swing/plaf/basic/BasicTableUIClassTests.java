 ...
 * javax.swing.plaf.basic.BasicTableUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicTableUITests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicTableUI class javax.swing.plaf.basic.BasicTableUI (the hereby targeted
 *      class-under-test class)
 * @see BasicTableUITests BasicTableUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.TableUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTableUI.class!",
                   javax.swing.plaf.basic.BasicTableUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicTableUI.KeyHandler class
     * javax.swing.plaf.basic.BasicTableUI$KeyHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link BasicTableUITests.KeyHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.plaf.basic.BasicTableUI.KeyHandler class javax.swing.plaf.basic.BasicTableUI$KeyHandler (the
     *      hereby targeted class-under-test class)
     * @see BasicTableUITests.KeyHandlerTests BasicTableUITests.KeyHandlerTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.awt.event.KeyListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTableUI.KeyHandler.class!",
                       javax.swing.plaf.basic.BasicTableUI.KeyHandler.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.plaf.basic.BasicTableUI$MouseInputHandler}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link BasicTableUITests.MouseInputHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.plaf.basic.BasicTableUI.MouseInputHandler class
     *      javax.swing.plaf.basic.BasicTableUI$MouseInputHandler (the hereby targeted class-under-test class)
     * @see BasicTableUITests.MouseInputHandlerTests BasicTableUITests.MouseInputHandlerTests (The complementary j8unit
    ...
    extends org.j8unit.repository.javax.swing.event.MouseInputListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTableUI.MouseInputHandler.class!",
                       javax.swing.plaf.basic.BasicTableUI.MouseInputHandler.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.plaf.basic.BasicTableUI$FocusHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
     * constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link BasicTableUITests.FocusHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.plaf.basic.BasicTableUI.FocusHandler class javax.swing.plaf.basic.BasicTableUI$FocusHandler (the
     *      hereby targeted class-under-test class)
     * @see BasicTableUITests.FocusHandlerTests BasicTableUITests.FocusHandlerTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.awt.event.FocusListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTableUI.FocusHandler.class!",
                       javax.swing.plaf.basic.BasicTableUI.FocusHandler.class.isAssignableFrom(sut));
        }

 ...
 * javax.management.MBeanPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see MBeanPermissionTests MBeanPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanPermission.class!",
                   javax.management.MBeanPermission.class.isAssignableFrom(sut));
    }

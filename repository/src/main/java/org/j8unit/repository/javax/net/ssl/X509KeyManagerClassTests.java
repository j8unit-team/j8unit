 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509KeyManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509KeyManagerTests}.
 * </p>
 *
 * @see javax.net.ssl.X509KeyManager interface javax.net.ssl.X509KeyManager (the hereby targeted class-under-test class)
 * @see X509KeyManagerTests X509KeyManagerTests (The complementary j8unit test interface containing the instance
...
extends KeyManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.X509KeyManager.class!",
                   javax.net.ssl.X509KeyManager.class.isAssignableFrom(sut));
    }

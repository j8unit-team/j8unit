 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509KeyManager
 * public abstract interface javax.net.ssl.X509KeyManager}.
 *
...
public abstract interface X509KeyManagerClassTests<SUT extends X509KeyManager>
extends KeyManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509KeyManager.class!",
                   X509KeyManager.class.isAssignableFrom(sut));
    }

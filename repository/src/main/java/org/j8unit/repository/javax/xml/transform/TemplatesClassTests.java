 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Templates public
 * abstract interface javax.xml.transform.Templates}.
 *
...
public abstract interface TemplatesClassTests<SUT extends Templates>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Templates.class!",
                   Templates.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemplatesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemplatesTests}.
 * </p>
 *
 * @see javax.xml.transform.Templates interface javax.xml.transform.Templates (the hereby targeted class-under-test
 *      class)
 * @see TemplatesTests TemplatesTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TemplatesClassTests<SUT extends javax.xml.transform.Templates>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.Templates.class!",
                   javax.xml.transform.Templates.class.isAssignableFrom(sut));
    }

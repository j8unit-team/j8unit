...
public abstract interface NumberOfInterveningJobsClassTests<SUT extends NumberOfInterveningJobs>
extends org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NumberOfInterveningJobs.class!",
                   NumberOfInterveningJobs.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DTDConstants public
 * abstract interface javax.swing.text.html.parser.DTDConstants}.
 *
...
public abstract interface DTDConstantsClassTests<SUT extends DTDConstants>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DTDConstants.class!",
                   DTDConstants.class.isAssignableFrom(sut));
    }

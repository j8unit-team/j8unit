...
import org.j8unit.repository.javax.swing.text.AbstractWriterClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MinimalHTMLWriter
 * public class javax.swing.text.html.MinimalHTMLWriter}.
 *
...
public abstract interface MinimalHTMLWriterClassTests<SUT extends MinimalHTMLWriter>
extends AbstractWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MinimalHTMLWriter.class!",
                   MinimalHTMLWriter.class.isAssignableFrom(sut));
    }

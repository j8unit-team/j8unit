...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.lang.model.type.NullType interface
 * javax.lang.model.type.NullType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NullTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NullTypeTests}.
 * </p>
 *
 * @see javax.lang.model.type.NullType interface javax.lang.model.type.NullType (the hereby targeted class-under-test
 *      class)
 * @see NullTypeTests NullTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ReferenceTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.NullType.class!",
                   javax.lang.model.type.NullType.class.isAssignableFrom(sut));
    }

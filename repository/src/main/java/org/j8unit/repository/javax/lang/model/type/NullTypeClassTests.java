 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NullType public
...
public abstract interface NullTypeClassTests<SUT extends NullType>
extends ReferenceTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NullType.class!",
                   NullType.class.isAssignableFrom(sut));
    }

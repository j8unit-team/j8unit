 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StartTlsResponse
 * public abstract class javax.naming.ldap.StartTlsResponse}.
 *
...
public abstract interface StartTlsResponseClassTests<SUT extends StartTlsResponse>
extends ExtendedResponseClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StartTlsResponse.class!",
                   StartTlsResponse.class.isAssignableFrom(sut));
    }

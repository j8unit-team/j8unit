 ...
 * javax.naming.ldap.StartTlsResponse}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StartTlsResponseTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StartTlsResponseTests}.
 * </p>
 *
 * @see javax.naming.ldap.StartTlsResponse class javax.naming.ldap.StartTlsResponse (the hereby targeted
 *      class-under-test class)
 * @see StartTlsResponseTests StartTlsResponseTests (The complementary j8unit test interface containing the instance
...
public abstract interface StartTlsResponseClassTests<SUT extends javax.naming.ldap.StartTlsResponse>
extends ExtendedResponseClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.StartTlsResponse.class!",
                   javax.naming.ldap.StartTlsResponse.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.JFormattedTextFieldTests.AbstractFormatterFactoryTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JFormattedTextField
...
public abstract interface JFormattedTextFieldClassTests<SUT extends JFormattedTextField>
extends JTextFieldClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JFormattedTextField.class!",
                   JFormattedTextField.class.isAssignableFrom(sut));
    }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface AbstractFormatterClassTests<SUT extends AbstractFormatter>
    extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractFormatter.class!",
                              AbstractFormatter.class.isAssignableFrom(sut));
        }
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link AbstractFormatterFactoryTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface AbstractFormatterFactoryClassTests<SUT extends AbstractFormatterFactory>
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractFormatterFactory.class!",
                              AbstractFormatterFactory.class.isAssignableFrom(sut));
        }

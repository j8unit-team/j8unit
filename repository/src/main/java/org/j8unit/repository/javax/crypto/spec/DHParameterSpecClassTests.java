 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DHParameterSpec
...
public abstract interface DHParameterSpecClassTests<SUT extends DHParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DHParameterSpec.class!",
                   DHParameterSpec.class.isAssignableFrom(sut));
    }

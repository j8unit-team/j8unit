...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.spec.DHParameterSpec class
 * javax.crypto.spec.DHParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DHParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DHParameterSpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.DHParameterSpec class javax.crypto.spec.DHParameterSpec (the hereby targeted class-under-test
 *      class)
 * @see DHParameterSpecTests DHParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.DHParameterSpec.class!",
                   javax.crypto.spec.DHParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SNIHostNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SNIHostNameTests}.
 * </p>
 *
 * @see javax.net.ssl.SNIHostName class javax.net.ssl.SNIHostName (the hereby targeted class-under-test class)
 * @see SNIHostNameTests SNIHostNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SNIServerNameClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SNIHostName.class!",
                   javax.net.ssl.SNIHostName.class.isAssignableFrom(sut));
    }

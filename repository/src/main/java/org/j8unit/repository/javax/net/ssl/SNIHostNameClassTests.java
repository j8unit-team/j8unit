 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SNIHostName public
 * final class javax.net.ssl.SNIHostName}.
 *
...
public abstract interface SNIHostNameClassTests<SUT extends SNIHostName>
extends SNIServerNameClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SNIHostName.class!",
                   SNIHostName.class.isAssignableFrom(sut));
    }

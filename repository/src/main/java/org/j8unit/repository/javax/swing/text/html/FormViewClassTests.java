 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FormView public
...
extends org.j8unit.repository.java.awt.event.ActionListenerClassTests<SUT>, org.j8unit.repository.javax.swing.text.ComponentViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormView.class!",
                   FormView.class.isAssignableFrom(sut));
    }

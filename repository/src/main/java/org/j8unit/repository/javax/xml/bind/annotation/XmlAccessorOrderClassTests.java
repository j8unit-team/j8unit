 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAccessorOrder
 * public abstract @interface javax.xml.bind.annotation.XmlAccessorOrder}.
 *
...
public abstract interface XmlAccessorOrderClassTests<SUT extends XmlAccessorOrder>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAccessorOrder.class!",
                   XmlAccessorOrder.class.isAssignableFrom(sut));
    }

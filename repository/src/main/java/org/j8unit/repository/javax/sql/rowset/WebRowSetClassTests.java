 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebRowSet public
 * abstract interface javax.sql.rowset.WebRowSet}.
 *
...
extends CachedRowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebRowSet.class!",
                   WebRowSet.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.rowset.WebRowSet interface javax.sql.rowset.WebRowSet},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebRowSetTests}).
 * </p>
 *
 * <p>
 ...
 * @see WebRowSetTests WebRowSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends CachedRowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.WebRowSet.class!",
                   javax.sql.rowset.WebRowSet.class.isAssignableFrom(sut));
    }

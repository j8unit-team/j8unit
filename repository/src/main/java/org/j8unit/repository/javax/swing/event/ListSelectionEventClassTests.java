 ...
 * javax.swing.event.ListSelectionEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListSelectionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListSelectionEventTests}.
 * </p>
 *
 * @see javax.swing.event.ListSelectionEvent class javax.swing.event.ListSelectionEvent (the hereby targeted
 *      class-under-test class)
 * @see ListSelectionEventTests ListSelectionEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.ListSelectionEvent.class!",
                   javax.swing.event.ListSelectionEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListSelectionEvent
 * public class javax.swing.event.ListSelectionEvent}.
 *
...
public abstract interface ListSelectionEventClassTests<SUT extends ListSelectionEvent>
extends EventObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.event.ListSelectionEvent]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListSelectionEvent.class!",
                   ListSelectionEvent.class.isAssignableFrom(sut));
    }

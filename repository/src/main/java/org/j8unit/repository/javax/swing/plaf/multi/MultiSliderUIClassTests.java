 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiSliderUI
 * public class javax.swing.plaf.multi.MultiSliderUI}.
 *
...
public abstract interface MultiSliderUIClassTests<SUT extends MultiSliderUI>
extends SliderUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiSliderUI.class!",
                   MultiSliderUI.class.isAssignableFrom(sut));
    }

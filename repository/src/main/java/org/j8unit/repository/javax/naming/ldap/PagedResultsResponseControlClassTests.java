 ...
 * javax.naming.ldap.PagedResultsResponseControl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link PagedResultsResponseControlTests}).
 * </p>
 *
 * <p>
 ...
 * @see PagedResultsResponseControlTests PagedResultsResponseControlTests (The complementary j8unit test interface
...
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.PagedResultsResponseControl.class!",
                   javax.naming.ldap.PagedResultsResponseControl.class.isAssignableFrom(sut));
    }

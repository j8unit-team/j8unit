...
public abstract interface PagedResultsResponseControlClassTests<SUT extends PagedResultsResponseControl>
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PagedResultsResponseControl.class!",
                   PagedResultsResponseControl.class.isAssignableFrom(sut));
    }

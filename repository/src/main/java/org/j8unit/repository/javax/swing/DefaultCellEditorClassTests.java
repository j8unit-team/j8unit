 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultCellEditorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultCellEditorTests}.
 * </p>
 *
 * @see javax.swing.DefaultCellEditor class javax.swing.DefaultCellEditor (the hereby targeted class-under-test class)
 * @see DefaultCellEditorTests DefaultCellEditorTests (The complementary j8unit test interface containing the instance
...
AbstractCellEditorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.DefaultCellEditor.class!",
                   javax.swing.DefaultCellEditor.class.isAssignableFrom(sut));
    }

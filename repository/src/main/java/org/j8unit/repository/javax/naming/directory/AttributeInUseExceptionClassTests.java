 ...
 * {@link AttributeInUseException public class javax.naming.directory.AttributeInUseException}.
 *
...
public abstract interface AttributeInUseExceptionClassTests<SUT extends AttributeInUseException>
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeInUseException.class!",
                   AttributeInUseException.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.directory.AttributeInUseException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeInUseExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AttributeInUseExceptionTests}.
 * </p>
 *
 * @see javax.naming.directory.AttributeInUseException class javax.naming.directory.AttributeInUseException (the hereby
 *      targeted class-under-test class)
 * @see AttributeInUseExceptionTests AttributeInUseExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.AttributeInUseException.class!",
                   javax.naming.directory.AttributeInUseException.class.isAssignableFrom(sut));
    }

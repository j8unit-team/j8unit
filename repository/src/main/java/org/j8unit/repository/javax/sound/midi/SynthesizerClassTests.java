 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthesizerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthesizerTests}.
 * </p>
 *
 * @see javax.sound.midi.Synthesizer interface javax.sound.midi.Synthesizer (the hereby targeted class-under-test class)
 * @see SynthesizerTests SynthesizerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SynthesizerClassTests<SUT extends javax.sound.midi.Synthesizer>
extends MidiDeviceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Synthesizer.class!",
                   javax.sound.midi.Synthesizer.class.isAssignableFrom(sut));
    }

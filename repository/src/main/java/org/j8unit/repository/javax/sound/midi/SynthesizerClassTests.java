 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Synthesizer public
 * abstract interface javax.sound.midi.Synthesizer}.
 *
...
public abstract interface SynthesizerClassTests<SUT extends Synthesizer>
extends MidiDeviceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Synthesizer.class!",
                   Synthesizer.class.isAssignableFrom(sut));
    }

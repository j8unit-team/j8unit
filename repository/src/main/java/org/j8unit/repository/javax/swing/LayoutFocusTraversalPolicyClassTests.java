...
extends SerializableClassTests<SUT>, SortingFocusTraversalPolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LayoutFocusTraversalPolicy.class!",
                   LayoutFocusTraversalPolicy.class.isAssignableFrom(sut));
    }

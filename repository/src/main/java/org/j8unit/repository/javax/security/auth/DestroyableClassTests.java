 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Destroyable public
 * abstract interface javax.security.auth.Destroyable}.
 *
...
public abstract interface DestroyableClassTests<SUT extends Destroyable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Destroyable.class!",
                   Destroyable.class.isAssignableFrom(sut));
    }

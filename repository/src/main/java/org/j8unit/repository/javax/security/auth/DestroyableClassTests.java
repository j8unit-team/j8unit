...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.security.auth.Destroyable interface
 * javax.security.auth.Destroyable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DestroyableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DestroyableTests}.
 * </p>
 *
 * @see javax.security.auth.Destroyable interface javax.security.auth.Destroyable (the hereby targeted class-under-test
 *      class)
 * @see DestroyableTests DestroyableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DestroyableClassTests<SUT extends javax.security.auth.Destroyable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.Destroyable.class!",
                   javax.security.auth.Destroyable.class.isAssignableFrom(sut));
    }

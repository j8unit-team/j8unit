...
public abstract interface AccessibleTextSequenceClassTests<SUT extends AccessibleTextSequence>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleTextSequence.class!",
                   AccessibleTextSequence.class.isAssignableFrom(sut));
    }

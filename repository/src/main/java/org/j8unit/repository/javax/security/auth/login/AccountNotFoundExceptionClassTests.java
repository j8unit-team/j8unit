...
public abstract interface AccountNotFoundExceptionClassTests<SUT extends AccountNotFoundException>
extends AccountExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccountNotFoundException.class!",

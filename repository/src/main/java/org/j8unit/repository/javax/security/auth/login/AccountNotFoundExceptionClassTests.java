 ...
 * javax.security.auth.login.AccountNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccountNotFoundExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AccountNotFoundExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.login.AccountNotFoundException class javax.security.auth.login.AccountNotFoundException (the
 *      hereby targeted class-under-test class)
 * @see AccountNotFoundExceptionTests AccountNotFoundExceptionTests (The complementary j8unit test interface containing
...
extends AccountExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.AccountNotFoundException.class!",
                   javax.security.auth.login.AccountNotFoundException.class.isAssignableFrom(sut));
    }

 ...
 * javax.print.attribute.standard.JobImpressions}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobImpressionsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobImpressionsTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.JobImpressions class javax.print.attribute.standard.JobImpressions (the hereby
 *      targeted class-under-test class)
 * @see JobImpressionsTests JobImpressionsTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobImpressions.class!",
                   javax.print.attribute.standard.JobImpressions.class.isAssignableFrom(sut));
    }

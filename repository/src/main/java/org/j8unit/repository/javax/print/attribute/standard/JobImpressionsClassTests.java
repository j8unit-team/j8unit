 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobImpressions
...
public abstract interface JobImpressionsClassTests<SUT extends JobImpressions>
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobImpressions.class!",
                   JobImpressions.class.isAssignableFrom(sut));
    }

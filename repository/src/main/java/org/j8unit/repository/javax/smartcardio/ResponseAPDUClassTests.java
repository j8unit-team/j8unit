 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResponseAPDU public
 * final class javax.smartcardio.ResponseAPDU}.
 *
...
public abstract interface ResponseAPDUClassTests<SUT extends ResponseAPDU>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResponseAPDU.class!",
                   ResponseAPDU.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.SignatureProperty interface
 * javax.xml.crypto.dsig.SignatureProperty}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignaturePropertyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignaturePropertyTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.SignatureProperty interface javax.xml.crypto.dsig.SignatureProperty (the hereby targeted
 *      class-under-test class)
 * @see SignaturePropertyTests SignaturePropertyTests (The complementary j8unit test interface containing the instance
...
public abstract interface SignaturePropertyClassTests<SUT extends javax.xml.crypto.dsig.SignatureProperty>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.SignatureProperty.class!",
                   javax.xml.crypto.dsig.SignatureProperty.class.isAssignableFrom(sut));
    }

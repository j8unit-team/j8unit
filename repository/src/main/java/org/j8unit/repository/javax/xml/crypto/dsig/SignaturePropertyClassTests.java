 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SignatureProperty
 * public abstract interface javax.xml.crypto.dsig.SignatureProperty}.
 *
...
public abstract interface SignaturePropertyClassTests<SUT extends SignatureProperty>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignatureProperty.class!",
                   SignatureProperty.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TableUITests}.
 * </p>
 *
 * @see javax.swing.plaf.TableUI class javax.swing.plaf.TableUI (the hereby targeted class-under-test class)
 * @see TableUITests TableUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TableUIClassTests<SUT extends javax.swing.plaf.TableUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.TableUI.class!",
                   javax.swing.plaf.TableUI.class.isAssignableFrom(sut));
    }

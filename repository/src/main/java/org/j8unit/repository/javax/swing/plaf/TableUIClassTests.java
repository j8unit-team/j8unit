 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TableUI public
 * abstract class javax.swing.plaf.TableUI}.
 *
...
public abstract interface TableUIClassTests<SUT extends TableUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableUI.class!",
                   TableUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.TableUI]

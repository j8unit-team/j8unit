 ...
 * {@link FileImageInputStreamTests}.
 * </p>
 *
 * <p>
...
public abstract interface FileImageInputStreamClassTests<SUT extends FileImageInputStream>
extends ImageInputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileImageInputStream.class!",
                   FileImageInputStream.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.imageio.stream.FileImageInputStream class
 * javax.imageio.stream.FileImageInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileImageInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileImageInputStreamTests}
 * .
 * </p>
 *
 * @see javax.imageio.stream.FileImageInputStream class javax.imageio.stream.FileImageInputStream (the hereby targeted
 *      class-under-test class)
 * @see FileImageInputStreamTests FileImageInputStreamTests (The complementary j8unit test interface containing the
...
extends ImageInputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.FileImageInputStream.class!",
                   javax.imageio.stream.FileImageInputStream.class.isAssignableFrom(sut));
    }

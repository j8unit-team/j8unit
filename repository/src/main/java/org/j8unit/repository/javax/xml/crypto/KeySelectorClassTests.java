 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeySelectorTests}).
 * </p>
 *
 * <p>
 ...
 * @see KeySelectorTests KeySelectorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeySelectorClassTests<SUT extends javax.xml.crypto.KeySelector>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.KeySelector.class!",
                   javax.xml.crypto.KeySelector.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.xml.crypto.KeySelector.Purpose class
     * javax.xml.crypto.KeySelector$Purpose}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link KeySelectorTests.PurposeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see KeySelectorTests.PurposeTests KeySelectorTests.PurposeTests (The complementary j8unit test interface
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface PurposeClassTests<SUT extends javax.xml.crypto.KeySelector.Purpose>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.KeySelector.Purpose.class!",
                       javax.xml.crypto.KeySelector.Purpose.class.isAssignableFrom(sut));
        }

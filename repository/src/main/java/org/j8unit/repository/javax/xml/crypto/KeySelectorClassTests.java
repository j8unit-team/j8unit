 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeySelector public
 * abstract class javax.xml.crypto.KeySelector}.
 *
...
public abstract interface KeySelectorClassTests<SUT extends KeySelector>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeySelector.class!",
                   KeySelector.class.isAssignableFrom(sut));
    }
     ...
     * {@link Purpose public static class javax.xml.crypto.KeySelector$Purpose}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface PurposeClassTests<SUT extends Purpose>
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Purpose.class!",
                              Purpose.class.isAssignableFrom(sut));
        }

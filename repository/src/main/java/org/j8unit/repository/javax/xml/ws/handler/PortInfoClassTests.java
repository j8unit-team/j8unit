...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.handler.PortInfo interface javax.xml.ws.handler.PortInfo}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PortInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PortInfoTests}.
 * </p>
 *
 * @see javax.xml.ws.handler.PortInfo interface javax.xml.ws.handler.PortInfo (the hereby targeted class-under-test
 *      class)
 * @see PortInfoTests PortInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PortInfoClassTests<SUT extends javax.xml.ws.handler.PortInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.PortInfo.class!",
                   javax.xml.ws.handler.PortInfo.class.isAssignableFrom(sut));
    }

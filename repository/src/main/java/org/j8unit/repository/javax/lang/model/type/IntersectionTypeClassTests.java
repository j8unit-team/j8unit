 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntersectionType
 * public abstract interface javax.lang.model.type.IntersectionType}.
 *
...
public abstract interface IntersectionTypeClassTests<SUT extends IntersectionType>
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntersectionType.class!",
                   IntersectionType.class.isAssignableFrom(sut));
    }

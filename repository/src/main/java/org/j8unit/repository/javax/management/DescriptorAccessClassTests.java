...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.DescriptorAccess interface
 * javax.management.DescriptorAccess}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DescriptorAccessTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DescriptorAccessTests}.
 * </p>
 *
 * @see javax.management.DescriptorAccess interface javax.management.DescriptorAccess (the hereby targeted
 *      class-under-test class)
 * @see DescriptorAccessTests DescriptorAccessTests (The complementary j8unit test interface containing the instance
...
public abstract interface DescriptorAccessClassTests<SUT extends javax.management.DescriptorAccess>
extends DescriptorReadClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.DescriptorAccess.class!",
                   javax.management.DescriptorAccess.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DescriptorAccess
 * public abstract interface javax.management.DescriptorAccess}.
 *
...
public abstract interface DescriptorAccessClassTests<SUT extends DescriptorAccess>
extends DescriptorReadClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DescriptorAccess.class!",
                   DescriptorAccess.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MacSpi public
 * abstract class javax.crypto.MacSpi}.
 *
...
public abstract interface MacSpiClassTests<SUT extends MacSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MacSpi.class!",
                   MacSpi.class.isAssignableFrom(sut));
    }

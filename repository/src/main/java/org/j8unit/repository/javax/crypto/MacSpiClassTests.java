...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.MacSpi class javax.crypto.MacSpi}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MacSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MacSpiTests}.
 * </p>
 *
 * @see javax.crypto.MacSpi class javax.crypto.MacSpi (the hereby targeted class-under-test class)
 * @see MacSpiTests MacSpiTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface MacSpiClassTests<SUT extends javax.crypto.MacSpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.MacSpi.class!",
                   javax.crypto.MacSpi.class.isAssignableFrom(sut));
    }

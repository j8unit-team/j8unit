...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.soap.SOAPBinding interface javax.xml.ws.soap.SOAPBinding}
 ...
 * </p>
 *
 * @see javax.xml.ws.soap.SOAPBinding interface javax.xml.ws.soap.SOAPBinding (the hereby targeted class-under-test
 *      class)
...
public abstract interface SOAPBindingClassTests<SUT extends javax.xml.ws.soap.SOAPBinding>
extends org.j8unit.repository.javax.xml.ws.BindingClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.soap.SOAPBinding.class!",
                   javax.xml.ws.soap.SOAPBinding.class.isAssignableFrom(sut));
    }

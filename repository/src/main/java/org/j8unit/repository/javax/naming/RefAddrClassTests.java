 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RefAddr public
 * abstract class javax.naming.RefAddr}.
 *
...
public abstract interface RefAddrClassTests<SUT extends RefAddr>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RefAddr.class!",
                   RefAddr.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Caret public
...
public abstract interface CaretClassTests<SUT extends Caret>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Caret.class!", Caret.class.isAssignableFrom(sut));
    }

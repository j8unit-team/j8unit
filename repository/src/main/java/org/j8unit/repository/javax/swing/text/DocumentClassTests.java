...
public abstract interface DocumentClassTests<SUT extends javax.swing.text.Document>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.Document.class!",
                   javax.swing.text.Document.class.isAssignableFrom(sut));
    }

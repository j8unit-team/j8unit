...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.URIException interface javax.print.URIException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URIExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URIExceptionTests}.
 * </p>
 *
 * @see javax.print.URIException interface javax.print.URIException (the hereby targeted class-under-test class)
 * @see URIExceptionTests URIExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface URIExceptionClassTests<SUT extends javax.print.URIException>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.URIException.class!",
                   javax.print.URIException.class.isAssignableFrom(sut));
    }

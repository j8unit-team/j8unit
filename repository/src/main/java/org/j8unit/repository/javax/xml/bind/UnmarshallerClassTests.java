 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Unmarshaller public
 * abstract interface javax.xml.bind.Unmarshaller}.
 *
...
public abstract interface UnmarshallerClassTests<SUT extends Unmarshaller>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Unmarshaller.class!",
     ...
     * {@link Listener public abstract static class javax.xml.bind.Unmarshaller$Listener}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

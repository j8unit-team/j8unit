...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.Transformer class javax.xml.transform.Transformer}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransformerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransformerTests}.
 * </p>
 *
 * @see javax.xml.transform.Transformer class javax.xml.transform.Transformer (the hereby targeted class-under-test
 *      class)
 * @see TransformerTests TransformerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TransformerClassTests<SUT extends javax.xml.transform.Transformer>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.Transformer.class!",
                   javax.xml.transform.Transformer.class.isAssignableFrom(sut));
    }

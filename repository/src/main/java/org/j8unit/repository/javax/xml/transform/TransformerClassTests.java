 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Transformer public
 * abstract class javax.xml.transform.Transformer}.
 *
...
public abstract interface TransformerClassTests<SUT extends Transformer>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Transformer.class!",
                   Transformer.class.isAssignableFrom(sut));
    }

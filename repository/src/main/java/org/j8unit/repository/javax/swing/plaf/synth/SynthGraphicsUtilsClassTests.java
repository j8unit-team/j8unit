 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthGraphicsUtils
...
public abstract interface SynthGraphicsUtilsClassTests<SUT extends SynthGraphicsUtils>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.synth.SynthGraphicsUtils]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthGraphicsUtils.class!",
                   SynthGraphicsUtils.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.ws.wsaddressing.W3CEndpointReference}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link W3CEndpointReferenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link W3CEndpointReferenceTests}
 * .
 * </p>
 *
 * @see javax.xml.ws.wsaddressing.W3CEndpointReference class javax.xml.ws.wsaddressing.W3CEndpointReference (the hereby
 *      targeted class-under-test class)
 * @see W3CEndpointReferenceTests W3CEndpointReferenceTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.xml.ws.EndpointReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.wsaddressing.W3CEndpointReference.class!",
                   javax.xml.ws.wsaddressing.W3CEndpointReference.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlEnumValue public
 * abstract @interface javax.xml.bind.annotation.XmlEnumValue}.
 *
...
public abstract interface XmlEnumValueClassTests<SUT extends XmlEnumValue>
extends AnnotationClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.annotation.XmlEnumValue]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlEnumValue.class!",
                   XmlEnumValue.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.bind.annotation.XmlEnumValue]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.xml.bind.annotation.XmlEnumValue]

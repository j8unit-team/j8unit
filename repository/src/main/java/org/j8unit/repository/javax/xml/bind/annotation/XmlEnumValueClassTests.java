...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlEnumValue interface
 * javax.xml.bind.annotation.XmlEnumValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlEnumValueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlEnumValueTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlEnumValue interface javax.xml.bind.annotation.XmlEnumValue (the hereby targeted
 *      class-under-test class)
 * @see XmlEnumValueTests XmlEnumValueTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XmlEnumValueClassTests<SUT extends javax.xml.bind.annotation.XmlEnumValue>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlEnumValue.class!",
                   javax.xml.bind.annotation.XmlEnumValue.class.isAssignableFrom(sut));
    }

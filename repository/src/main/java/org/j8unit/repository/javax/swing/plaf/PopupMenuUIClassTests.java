 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PopupMenuUI public
 * abstract class javax.swing.plaf.PopupMenuUI}.
 *
...
public abstract interface PopupMenuUIClassTests<SUT extends PopupMenuUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PopupMenuUI.class!",
                   PopupMenuUI.class.isAssignableFrom(sut));
    }

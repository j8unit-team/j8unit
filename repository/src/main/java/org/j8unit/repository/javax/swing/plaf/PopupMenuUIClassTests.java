 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PopupMenuUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PopupMenuUITests}.
 * </p>
 *
 * @see javax.swing.plaf.PopupMenuUI class javax.swing.plaf.PopupMenuUI (the hereby targeted class-under-test class)
 * @see PopupMenuUITests PopupMenuUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.PopupMenuUI.class!",
                   javax.swing.plaf.PopupMenuUI.class.isAssignableFrom(sut));
    }

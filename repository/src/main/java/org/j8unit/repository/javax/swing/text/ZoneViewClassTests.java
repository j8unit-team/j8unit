 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZoneView public
...
public abstract interface ZoneViewClassTests<SUT extends ZoneView>
extends BoxViewClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.ZoneView]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZoneView.class!",
                   ZoneView.class.isAssignableFrom(sut));
    }

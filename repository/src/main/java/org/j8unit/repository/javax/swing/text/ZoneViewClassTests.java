 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZoneViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZoneViewTests}.
 * </p>
 *
 * @see javax.swing.text.ZoneView class javax.swing.text.ZoneView (the hereby targeted class-under-test class)
 * @see ZoneViewTests ZoneViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ZoneViewClassTests<SUT extends javax.swing.text.ZoneView>
extends BoxViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.ZoneView.class!",
                   javax.swing.text.ZoneView.class.isAssignableFrom(sut));
    }

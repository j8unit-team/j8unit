 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EndpointReference
...
public abstract interface EndpointReferenceClassTests<SUT extends EndpointReference>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EndpointReference.class!",
                   EndpointReference.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EndpointReferenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EndpointReferenceTests}.
 * </p>
 *
 * @see javax.xml.ws.EndpointReference class javax.xml.ws.EndpointReference (the hereby targeted class-under-test class)
 * @see EndpointReferenceTests EndpointReferenceTests (The complementary j8unit test interface containing the instance
...
public abstract interface EndpointReferenceClassTests<SUT extends javax.xml.ws.EndpointReference>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.EndpointReference.class!",
                   javax.xml.ws.EndpointReference.class.isAssignableFrom(sut));
    }

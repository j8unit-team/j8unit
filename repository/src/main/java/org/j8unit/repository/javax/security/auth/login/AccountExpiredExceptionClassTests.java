 ...
 * javax.security.auth.login.AccountExpiredException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccountExpiredExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AccountExpiredExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.login.AccountExpiredException class javax.security.auth.login.AccountExpiredException (the
 *      hereby targeted class-under-test class)
 * @see AccountExpiredExceptionTests AccountExpiredExceptionTests (The complementary j8unit test interface containing
...
extends AccountExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.AccountExpiredException.class!",
                   javax.security.auth.login.AccountExpiredException.class.isAssignableFrom(sut));
    }

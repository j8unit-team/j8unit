...
public abstract interface AccountExpiredExceptionClassTests<SUT extends AccountExpiredException>
extends AccountExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccountExpiredException.class!",
                   AccountExpiredException.class.isAssignableFrom(sut));
    }

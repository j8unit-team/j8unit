...
import org.j8unit.repository.java.io.InputStreamClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AudioInputStream
 * public class javax.sound.sampled.AudioInputStream}.
 *
...
public abstract interface AudioInputStreamClassTests<SUT extends AudioInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AudioInputStream.class!",

 ...
 * javax.sound.sampled.AudioInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AudioInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AudioInputStreamTests}.
 * </p>
 *
 * @see javax.sound.sampled.AudioInputStream class javax.sound.sampled.AudioInputStream (the hereby targeted
 *      class-under-test class)
 * @see AudioInputStreamTests AudioInputStreamTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.AudioInputStream.class!",
                   javax.sound.sampled.AudioInputStream.class.isAssignableFrom(sut));
    }

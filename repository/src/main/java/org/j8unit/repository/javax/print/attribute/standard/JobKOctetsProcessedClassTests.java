 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobKOctetsProcessed
 * public final class javax.print.attribute.standard.JobKOctetsProcessed}.
 *
...
public abstract interface JobKOctetsProcessedClassTests<SUT extends JobKOctetsProcessed>
extends PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobKOctetsProcessed.class!",
                   JobKOctetsProcessed.class.isAssignableFrom(sut));
    }

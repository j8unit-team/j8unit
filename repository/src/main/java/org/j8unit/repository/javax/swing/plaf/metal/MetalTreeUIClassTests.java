 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalTreeUI public
...
public abstract interface MetalTreeUIClassTests<SUT extends MetalTreeUI>
extends BasicTreeUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalTreeUI.class!",
                   MetalTreeUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JavaFileManager
 * public abstract interface javax.tools.JavaFileManager}.
 *
...
org.j8unit.repository.javax.tools.OptionCheckerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JavaFileManager.class!",
     ...
     * {@link Location public abstract static interface javax.tools.JavaFileManager$Location}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

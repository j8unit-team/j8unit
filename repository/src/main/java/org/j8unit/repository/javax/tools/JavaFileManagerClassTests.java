 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JavaFileManagerTests}).
 * </p>
 *
 * <p>
 ...
 * @see JavaFileManagerTests JavaFileManagerTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.io.FlushableClassTests<SUT>, OptionCheckerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.JavaFileManager.class!",
                   javax.tools.JavaFileManager.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.tools.JavaFileManager.Location interface
     * javax.tools.JavaFileManager$Location}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link JavaFileManagerTests.LocationTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see JavaFileManagerTests.LocationTests JavaFileManagerTests.LocationTests (The complementary j8unit test
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.JavaFileManager.Location.class!",
                       javax.tools.JavaFileManager.Location.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SAXParserFactory
...
public abstract interface SAXParserFactoryClassTests<SUT extends SAXParserFactory>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.parsers.SAXParserFactory]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXParserFactory.class!",
                   SAXParserFactory.class.isAssignableFrom(sut));
    }

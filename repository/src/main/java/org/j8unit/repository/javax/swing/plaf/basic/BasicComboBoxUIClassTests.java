...
import org.j8unit.repository.javax.swing.plaf.ComboBoxUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicComboBoxUI
 * public class javax.swing.plaf.basic.BasicComboBoxUI}.
 *
...
extends ComboBoxUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicComboBoxUI.class!",
                   BasicComboBoxUI.class.isAssignableFrom(sut));
    }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link ItemHandler public class javax.swing.plaf.basic.BasicComboBoxUI$ItemHandler}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends ItemListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ItemHandler.class!",
                              ItemHandler.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link PropertyChangeHandler public class javax.swing.plaf.basic.BasicComboBoxUI$PropertyChangeHandler}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link KeyHandler public class javax.swing.plaf.basic.BasicComboBoxUI$KeyHandler}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link ComboBoxLayoutManager public class javax.swing.plaf.basic.BasicComboBoxUI$ComboBoxLayoutManager}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends LayoutManagerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComboBoxLayoutManager.class!",
                              ComboBoxLayoutManager.class.isAssignableFrom(sut));
        }

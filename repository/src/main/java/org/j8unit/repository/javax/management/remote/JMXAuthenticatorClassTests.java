 ...
 * javax.management.remote.JMXAuthenticator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMXAuthenticatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMXAuthenticatorTests}.
 * </p>
 *
 * @see javax.management.remote.JMXAuthenticator interface javax.management.remote.JMXAuthenticator (the hereby targeted
 *      class-under-test class)
 * @see JMXAuthenticatorTests JMXAuthenticatorTests (The complementary j8unit test interface containing the instance
...
public abstract interface JMXAuthenticatorClassTests<SUT extends javax.management.remote.JMXAuthenticator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXAuthenticator.class!",
                   javax.management.remote.JMXAuthenticator.class.isAssignableFrom(sut));
    }

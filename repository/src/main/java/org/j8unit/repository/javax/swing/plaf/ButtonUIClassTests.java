 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ButtonUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ButtonUITests}.
 * </p>
 *
 * @see javax.swing.plaf.ButtonUI class javax.swing.plaf.ButtonUI (the hereby targeted class-under-test class)
 * @see ButtonUITests ButtonUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ButtonUIClassTests<SUT extends javax.swing.plaf.ButtonUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ButtonUI.class!",
                   javax.swing.plaf.ButtonUI.class.isAssignableFrom(sut));
    }

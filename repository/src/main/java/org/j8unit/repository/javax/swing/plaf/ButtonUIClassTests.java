 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ButtonUI public
 * abstract class javax.swing.plaf.ButtonUI}.
 *
...
public abstract interface ButtonUIClassTests<SUT extends ButtonUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ButtonUI.class!",
                   ButtonUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.ButtonUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.ButtonUI]

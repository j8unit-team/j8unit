...
public abstract interface NotificationFilterSupportClassTests<SUT extends NotificationFilterSupport>
extends org.j8unit.repository.javax.management.NotificationFilterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotificationFilterSupport.class!",
                   NotificationFilterSupport.class.isAssignableFrom(sut));
    }

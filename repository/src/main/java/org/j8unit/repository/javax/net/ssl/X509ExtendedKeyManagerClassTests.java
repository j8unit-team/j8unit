...
extends org.j8unit.repository.javax.net.ssl.X509KeyManagerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509ExtendedKeyManager.class!",
                   X509ExtendedKeyManager.class.isAssignableFrom(sut));
    }

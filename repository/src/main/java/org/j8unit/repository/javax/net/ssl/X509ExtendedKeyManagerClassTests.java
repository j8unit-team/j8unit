 ...
 * javax.net.ssl.X509ExtendedKeyManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509ExtendedKeyManagerTests}).
 * </p>
 *
 * <p>
 ...
 * @see X509ExtendedKeyManagerTests X509ExtendedKeyManagerTests (The complementary j8unit test interface containing the
...
public abstract interface X509ExtendedKeyManagerClassTests<SUT extends javax.net.ssl.X509ExtendedKeyManager>
extends X509KeyManagerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.X509ExtendedKeyManager.class!",
                   javax.net.ssl.X509ExtendedKeyManager.class.isAssignableFrom(sut));
    }

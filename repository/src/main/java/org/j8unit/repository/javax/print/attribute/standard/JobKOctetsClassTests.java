 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobKOctets public
 * final class javax.print.attribute.standard.JobKOctets}.
 *
...
public abstract interface JobKOctetsClassTests<SUT extends JobKOctets>
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobKOctets.class!",
                   JobKOctets.class.isAssignableFrom(sut));
    }

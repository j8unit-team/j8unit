...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.JobKOctets class
 * javax.print.attribute.standard.JobKOctets}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobKOctetsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobKOctetsTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.JobKOctets class javax.print.attribute.standard.JobKOctets (the hereby targeted
 *      class-under-test class)
 * @see JobKOctetsTests JobKOctetsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobKOctets.class!",
                   javax.print.attribute.standard.JobKOctets.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IIOMetadataFormat
 * public abstract interface javax.imageio.metadata.IIOMetadataFormat}.
 *
...
public abstract interface IIOMetadataFormatClassTests<SUT extends IIOMetadataFormat>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOMetadataFormat.class!",
                   IIOMetadataFormat.class.isAssignableFrom(sut));
    }

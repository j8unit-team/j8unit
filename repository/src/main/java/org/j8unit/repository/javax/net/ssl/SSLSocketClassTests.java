...
import org.j8unit.repository.java.net.SocketClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLSocket public
...
public abstract interface SSLSocketClassTests<SUT extends SSLSocket>
extends SocketClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLSocket.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.net.ssl.SSLSocket class javax.net.ssl.SSLSocket}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLSocketTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLSocketTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLSocket class javax.net.ssl.SSLSocket (the hereby targeted class-under-test class)
 * @see SSLSocketTests SSLSocketTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SSLSocketClassTests<SUT extends javax.net.ssl.SSLSocket>
extends org.j8unit.repository.java.net.SocketClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLSocket.class!",
                   javax.net.ssl.SSLSocket.class.isAssignableFrom(sut));
    }

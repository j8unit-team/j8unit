 ...
 * javax.accessibility.AccessibleExtendedTable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleExtendedTableTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AccessibleExtendedTableTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleExtendedTable interface javax.accessibility.AccessibleExtendedTable (the hereby
 *      targeted class-under-test class)
 * @see AccessibleExtendedTableTests AccessibleExtendedTableTests (The complementary j8unit test interface containing
...
public abstract interface AccessibleExtendedTableClassTests<SUT extends javax.accessibility.AccessibleExtendedTable>
extends AccessibleTableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleExtendedTable.class!",
                   javax.accessibility.AccessibleExtendedTable.class.isAssignableFrom(sut));
    }

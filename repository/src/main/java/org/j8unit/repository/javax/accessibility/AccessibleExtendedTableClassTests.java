 ...
 * {@link AccessibleExtendedTable public abstract interface javax.accessibility.AccessibleExtendedTable}.
 *
...
public abstract interface AccessibleExtendedTableClassTests<SUT extends AccessibleExtendedTable>
extends org.j8unit.repository.javax.accessibility.AccessibleTableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleExtendedTable.class!",
                   AccessibleExtendedTable.class.isAssignableFrom(sut));
    }

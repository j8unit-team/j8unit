...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.annotation.processing.Completion interface
 * javax.annotation.processing.Completion}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompletionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompletionTests}.
 * </p>
 *
 * @see javax.annotation.processing.Completion interface javax.annotation.processing.Completion (the hereby targeted
 *      class-under-test class)
 * @see CompletionTests CompletionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CompletionClassTests<SUT extends javax.annotation.processing.Completion>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.Completion.class!",
                   javax.annotation.processing.Completion.class.isAssignableFrom(sut));
    }

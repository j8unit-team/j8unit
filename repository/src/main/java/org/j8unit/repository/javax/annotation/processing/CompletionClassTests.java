 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Completion public
 * abstract interface javax.annotation.processing.Completion}.
 *
...
public abstract interface CompletionClassTests<SUT extends Completion>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Completion.class!",
                   Completion.class.isAssignableFrom(sut));
    }

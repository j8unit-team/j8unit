 ...
 * javax.naming.NoPermissionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoPermissionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see NoPermissionExceptionTests NoPermissionExceptionTests (The complementary j8unit test interface containing the
...
extends NamingSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NoPermissionException.class!",
                   javax.naming.NoPermissionException.class.isAssignableFrom(sut));
    }

...
extends NamingSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoPermissionException.class!",
                   NoPermissionException.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.stream.util.EventReaderDelegate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventReaderDelegateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventReaderDelegateTests}.
 * </p>
 *
 * @see javax.xml.stream.util.EventReaderDelegate class javax.xml.stream.util.EventReaderDelegate (the hereby targeted
 *      class-under-test class)
 * @see EventReaderDelegateTests EventReaderDelegateTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.xml.stream.XMLEventReaderClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.util.EventReaderDelegate.class!",
                   javax.xml.stream.util.EventReaderDelegate.class.isAssignableFrom(sut));
    }

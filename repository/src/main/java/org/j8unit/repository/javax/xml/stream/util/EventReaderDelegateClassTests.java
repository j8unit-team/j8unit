...
import org.j8unit.repository.javax.xml.stream.XMLEventReaderClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventReaderDelegate
 * public class javax.xml.stream.util.EventReaderDelegate}.
 *
...
public abstract interface EventReaderDelegateClassTests<SUT extends EventReaderDelegate>
extends XMLEventReaderClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventReaderDelegate.class!",
                   EventReaderDelegate.class.isAssignableFrom(sut));
    }

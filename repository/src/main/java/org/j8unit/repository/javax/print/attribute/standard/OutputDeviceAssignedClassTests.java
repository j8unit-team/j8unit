 ...
 * javax.print.attribute.standard.OutputDeviceAssigned}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OutputDeviceAssignedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OutputDeviceAssignedTests}
 * .
 * </p>
 *
 ...
 * @see OutputDeviceAssignedTests OutputDeviceAssignedTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.OutputDeviceAssigned.class!",
                   javax.print.attribute.standard.OutputDeviceAssigned.class.isAssignableFrom(sut));
    }

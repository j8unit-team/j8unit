 ...
 * javax.xml.bind.attachment.AttachmentUnmarshaller}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttachmentUnmarshallerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AttachmentUnmarshallerTests}.
 * </p>
 *
 * @see javax.xml.bind.attachment.AttachmentUnmarshaller class javax.xml.bind.attachment.AttachmentUnmarshaller (the
 *      hereby targeted class-under-test class)
 * @see AttachmentUnmarshallerTests AttachmentUnmarshallerTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.attachment.AttachmentUnmarshaller.class!",
                   javax.xml.bind.attachment.AttachmentUnmarshaller.class.isAssignableFrom(sut));
    }

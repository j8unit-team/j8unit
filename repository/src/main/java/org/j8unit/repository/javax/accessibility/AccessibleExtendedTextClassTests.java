...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.accessibility.AccessibleExtendedText interface
 * javax.accessibility.AccessibleExtendedText}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleExtendedTextTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AccessibleExtendedTextTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleExtendedText interface javax.accessibility.AccessibleExtendedText (the hereby
 *      targeted class-under-test class)
 * @see AccessibleExtendedTextTests AccessibleExtendedTextTests (The complementary j8unit test interface containing the
...
public abstract interface AccessibleExtendedTextClassTests<SUT extends javax.accessibility.AccessibleExtendedText>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleExtendedText.class!",
                   javax.accessibility.AccessibleExtendedText.class.isAssignableFrom(sut));
    }

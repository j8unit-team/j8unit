 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerialDatalink
 * public class javax.sql.rowset.serial.SerialDatalink}.
 *
...
public abstract interface SerialDatalinkClassTests<SUT extends SerialDatalink>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerialDatalink.class!",
                   SerialDatalink.class.isAssignableFrom(sut));
    }

 ...
 * javax.sql.rowset.serial.SerialDatalink}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerialDatalinkTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SerialDatalinkTests}.
 * </p>
 *
 * @see javax.sql.rowset.serial.SerialDatalink class javax.sql.rowset.serial.SerialDatalink (the hereby targeted
 *      class-under-test class)
 * @see SerialDatalinkTests SerialDatalinkTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SerialDatalink.class!",
                   javax.sql.rowset.serial.SerialDatalink.class.isAssignableFrom(sut));
    }

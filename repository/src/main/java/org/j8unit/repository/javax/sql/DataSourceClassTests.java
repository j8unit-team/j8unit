...
public abstract interface DataSourceClassTests<SUT extends javax.sql.DataSource>
extends CommonDataSourceClassTests<SUT>, org.j8unit.repository.java.sql.WrapperClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.DataSource.class!",
                   javax.sql.DataSource.class.isAssignableFrom(sut));
    }

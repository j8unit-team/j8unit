...
extends UnmarshallerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractUnmarshallerImpl.class!",
                   AbstractUnmarshallerImpl.class.isAssignableFrom(sut));
    }

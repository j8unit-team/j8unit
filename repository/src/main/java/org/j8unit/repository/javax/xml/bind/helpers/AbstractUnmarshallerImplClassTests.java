 ...
 * javax.xml.bind.helpers.AbstractUnmarshallerImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractUnmarshallerImplTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see AbstractUnmarshallerImplTests AbstractUnmarshallerImplTests (The complementary j8unit test interface containing
...
public abstract interface AbstractUnmarshallerImplClassTests<SUT extends javax.xml.bind.helpers.AbstractUnmarshallerImpl>
extends org.j8unit.repository.javax.xml.bind.UnmarshallerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.helpers.AbstractUnmarshallerImpl.class!",
                   javax.xml.bind.helpers.AbstractUnmarshallerImpl.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthPainter public
 * abstract class javax.swing.plaf.synth.SynthPainter}.
 *
...
public abstract interface SynthPainterClassTests<SUT extends SynthPainter>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthPainter.class!",
                   SynthPainter.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthPainter]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.synth.SynthPainter]

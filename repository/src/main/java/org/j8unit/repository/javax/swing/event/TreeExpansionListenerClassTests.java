 ...
 * {@link TreeExpansionListener public abstract interface javax.swing.event.TreeExpansionListener}.
 *
...
public abstract interface TreeExpansionListenerClassTests<SUT extends TreeExpansionListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeExpansionListener.class!",
                   TreeExpansionListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.event.TreeExpansionListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeExpansionListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link TreeExpansionListenerTests}.
 * </p>
 *
 * @see javax.swing.event.TreeExpansionListener interface javax.swing.event.TreeExpansionListener (the hereby targeted
 *      class-under-test class)
 * @see TreeExpansionListenerTests TreeExpansionListenerTests (The complementary j8unit test interface containing the
...
public abstract interface TreeExpansionListenerClassTests<SUT extends javax.swing.event.TreeExpansionListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TreeExpansionListener.class!",
                   javax.swing.event.TreeExpansionListener.class.isAssignableFrom(sut));
    }

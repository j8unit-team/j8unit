 ...
 * javax.annotation.processing.RoundEnvironment}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RoundEnvironmentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RoundEnvironmentTests}.
 * </p>
 *
 * @see javax.annotation.processing.RoundEnvironment interface javax.annotation.processing.RoundEnvironment (the hereby
 *      targeted class-under-test class)
 * @see RoundEnvironmentTests RoundEnvironmentTests (The complementary j8unit test interface containing the instance
...
public abstract interface RoundEnvironmentClassTests<SUT extends javax.annotation.processing.RoundEnvironment>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.RoundEnvironment.class!",
                   javax.annotation.processing.RoundEnvironment.class.isAssignableFrom(sut));
    }

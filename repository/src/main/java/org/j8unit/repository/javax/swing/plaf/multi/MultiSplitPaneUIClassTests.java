 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiSplitPaneUI
 * public class javax.swing.plaf.multi.MultiSplitPaneUI}.
 *
...
public abstract interface MultiSplitPaneUIClassTests<SUT extends MultiSplitPaneUI>
extends SplitPaneUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.multi.MultiSplitPaneUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiSplitPaneUI.class!",
                   MultiSplitPaneUI.class.isAssignableFrom(sut));
    }

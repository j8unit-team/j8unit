 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicTextPaneUI
 * public class javax.swing.plaf.basic.BasicTextPaneUI}.
 *
...
public abstract interface BasicTextPaneUIClassTests<SUT extends BasicTextPaneUI>
extends org.j8unit.repository.javax.swing.plaf.basic.BasicEditorPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicTextPaneUI.class!",
                   BasicTextPaneUI.class.isAssignableFrom(sut));
    }

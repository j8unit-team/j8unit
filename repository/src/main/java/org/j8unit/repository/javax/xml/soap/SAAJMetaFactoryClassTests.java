 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SAAJMetaFactory
...
public abstract interface SAAJMetaFactoryClassTests<SUT extends SAAJMetaFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAAJMetaFactory.class!",
                   SAAJMetaFactory.class.isAssignableFrom(sut));
    }

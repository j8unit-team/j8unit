 ...
 * javax.naming.OperationNotSupportedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link OperationNotSupportedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see OperationNotSupportedExceptionTests OperationNotSupportedExceptionTests (The complementary j8unit test interface
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.OperationNotSupportedException.class!",
                   javax.naming.OperationNotSupportedException.class.isAssignableFrom(sut));
    }

...
public abstract interface OperationNotSupportedExceptionClassTests<SUT extends OperationNotSupportedException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OperationNotSupportedException.class!",
                   OperationNotSupportedException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.naming.OperationNotSupportedException]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlMimeType public
 * abstract @interface javax.xml.bind.annotation.XmlMimeType}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlMimeTypeTests}.
 * </p>
 *
 * <p>
...
public abstract interface XmlMimeTypeClassTests<SUT extends XmlMimeType>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlMimeType.class!",
                   XmlMimeType.class.isAssignableFrom(sut));
    }

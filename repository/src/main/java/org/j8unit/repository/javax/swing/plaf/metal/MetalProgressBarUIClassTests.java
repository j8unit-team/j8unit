 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalProgressBarUI
 * public class javax.swing.plaf.metal.MetalProgressBarUI}.
 *
...
public abstract interface MetalProgressBarUIClassTests<SUT extends MetalProgressBarUI>
extends BasicProgressBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalProgressBarUI.class!",
                   MetalProgressBarUI.class.isAssignableFrom(sut));
    }

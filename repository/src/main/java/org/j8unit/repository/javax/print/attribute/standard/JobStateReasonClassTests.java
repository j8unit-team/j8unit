...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.JobStateReason class
 * javax.print.attribute.standard.JobStateReason}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobStateReasonTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobStateReasonTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.JobStateReason class javax.print.attribute.standard.JobStateReason (the hereby
 *      targeted class-under-test class)
 * @see JobStateReasonTests JobStateReasonTests (The complementary j8unit test interface containing the instance
...
public abstract interface JobStateReasonClassTests<SUT extends javax.print.attribute.standard.JobStateReason>
extends org.j8unit.repository.javax.print.attribute.AttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobStateReason.class!",
                   javax.print.attribute.standard.JobStateReason.class.isAssignableFrom(sut));
    }

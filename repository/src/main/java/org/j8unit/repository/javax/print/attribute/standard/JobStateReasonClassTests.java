 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobStateReason
...
public abstract interface JobStateReasonClassTests<SUT extends JobStateReason>
extends AttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobStateReason.class!",
                   JobStateReason.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetWriter public
 * abstract interface javax.sql.RowSetWriter}.
 *
...
public abstract interface RowSetWriterClassTests<SUT extends RowSetWriter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetWriter.class!",
                   RowSetWriter.class.isAssignableFrom(sut));
    }

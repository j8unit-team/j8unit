 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetWriterTests}.
 * </p>
 *
 * @see javax.sql.RowSetWriter interface javax.sql.RowSetWriter (the hereby targeted class-under-test class)
 * @see RowSetWriterTests RowSetWriterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RowSetWriterClassTests<SUT extends javax.sql.RowSetWriter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.RowSetWriter.class!",
                   javax.sql.RowSetWriter.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.directory.SchemaViolationException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SchemaViolationExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link SchemaViolationExceptionTests}.
 * </p>
 *
 * @see javax.naming.directory.SchemaViolationException class javax.naming.directory.SchemaViolationException (the
 *      hereby targeted class-under-test class)
 * @see SchemaViolationExceptionTests SchemaViolationExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.SchemaViolationException.class!",
                   javax.naming.directory.SchemaViolationException.class.isAssignableFrom(sut));
    }

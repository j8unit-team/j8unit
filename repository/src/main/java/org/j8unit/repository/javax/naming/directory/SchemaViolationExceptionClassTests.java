...
public abstract interface SchemaViolationExceptionClassTests<SUT extends SchemaViolationException>
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.naming.directory.SchemaViolationException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SchemaViolationException.class!",
                   SchemaViolationException.class.isAssignableFrom(sut));
    }

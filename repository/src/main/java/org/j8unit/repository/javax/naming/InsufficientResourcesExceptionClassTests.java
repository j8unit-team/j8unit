 ...
 * javax.naming.InsufficientResourcesException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link InsufficientResourcesExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.naming.InsufficientResourcesException class javax.naming.InsufficientResourcesException (the hereby
 *      targeted class-under-test class)
 * @see InsufficientResourcesExceptionTests InsufficientResourcesExceptionTests (The complementary j8unit test interface
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.InsufficientResourcesException.class!",
                   javax.naming.InsufficientResourcesException.class.isAssignableFrom(sut));
    }

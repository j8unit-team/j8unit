 ...
 * {@link InsufficientResourcesException public class javax.naming.InsufficientResourcesException}.
 *
...
public abstract interface InsufficientResourcesExceptionClassTests<SUT extends InsufficientResourcesException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InsufficientResourcesException.class!",
                   InsufficientResourcesException.class.isAssignableFrom(sut));
    }

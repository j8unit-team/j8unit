...
public abstract interface ModelMBeanNotificationInfoClassTests<SUT extends ModelMBeanNotificationInfo>
extends org.j8unit.repository.javax.management.DescriptorAccessClassTests<SUT>, org.j8unit.repository.javax.management.MBeanNotificationInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ModelMBeanNotificationInfo.class!",
                   ModelMBeanNotificationInfo.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.modelmbean.ModelMBeanNotificationInfo]

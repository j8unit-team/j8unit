 ...
 * javax.swing.text.MutableAttributeSet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MutableAttributeSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MutableAttributeSetTests}.
 * </p>
 *
 * @see javax.swing.text.MutableAttributeSet interface javax.swing.text.MutableAttributeSet (the hereby targeted
 *      class-under-test class)
 * @see MutableAttributeSetTests MutableAttributeSetTests (The complementary j8unit test interface containing the
...
public abstract interface MutableAttributeSetClassTests<SUT extends javax.swing.text.MutableAttributeSet>
extends AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.MutableAttributeSet.class!",
                   javax.swing.text.MutableAttributeSet.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MutableAttributeSet
 * public abstract interface javax.swing.text.MutableAttributeSet}.
 *
...
public abstract interface MutableAttributeSetClassTests<SUT extends MutableAttributeSet>
extends org.j8unit.repository.javax.swing.text.AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MutableAttributeSet.class!",
                   MutableAttributeSet.class.isAssignableFrom(sut));
    }

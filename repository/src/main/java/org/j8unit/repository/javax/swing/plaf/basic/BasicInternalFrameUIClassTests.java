 ...
 * javax.swing.plaf.basic.BasicInternalFrameUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicInternalFrameUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicInternalFrameUITests}
 * .
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicInternalFrameUI class javax.swing.plaf.basic.BasicInternalFrameUI (the hereby
 *      targeted class-under-test class)
 * @see BasicInternalFrameUITests BasicInternalFrameUITests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.swing.plaf.InternalFrameUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicInternalFrameUI.class!",
                   javax.swing.plaf.basic.BasicInternalFrameUI.class.isAssignableFrom(sut));
    }
     ...
     * javax.swing.plaf.basic.BasicInternalFrameUI$InternalFramePropertyChangeListener}, containing all type relevant
     ...
     * {@link BasicInternalFrameUITests.InternalFramePropertyChangeListenerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicInternalFrameUITests.InternalFramePropertyChangeListenerTests
     *      BasicInternalFrameUITests.InternalFramePropertyChangeListenerTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.beans.PropertyChangeListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicInternalFrameUI.InternalFramePropertyChangeListener.class!",
                       javax.swing.plaf.basic.BasicInternalFrameUI.InternalFramePropertyChangeListener.class.isAssignableFrom(sut));
        }
     ...
     * class javax.swing.plaf.basic.BasicInternalFrameUI$InternalFrameLayout}, containing all type relevant aspects
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link BasicInternalFrameUITests.InternalFrameLayoutTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicInternalFrameUITests.InternalFrameLayoutTests BasicInternalFrameUITests.InternalFrameLayoutTests (The
    ...
    extends org.j8unit.repository.java.awt.LayoutManagerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicInternalFrameUI.InternalFrameLayout.class!",
                       javax.swing.plaf.basic.BasicInternalFrameUI.InternalFrameLayout.class.isAssignableFrom(sut));
        }

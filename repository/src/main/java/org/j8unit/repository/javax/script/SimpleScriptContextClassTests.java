 ...
 * javax.script.SimpleScriptContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleScriptContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleScriptContextTests}.
 * </p>
 *
 * @see javax.script.SimpleScriptContext class javax.script.SimpleScriptContext (the hereby targeted class-under-test
 *      class)
 * @see SimpleScriptContextTests SimpleScriptContextTests (The complementary j8unit test interface containing the
...
public abstract interface SimpleScriptContextClassTests<SUT extends javax.script.SimpleScriptContext>
extends ScriptContextClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.SimpleScriptContext.class!",
                   javax.script.SimpleScriptContext.class.isAssignableFrom(sut));
    }

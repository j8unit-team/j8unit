 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleScriptContext
 * public class javax.script.SimpleScriptContext}.
 *
...
public abstract interface SimpleScriptContextClassTests<SUT extends SimpleScriptContext>
extends ScriptContextClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleScriptContext.class!",

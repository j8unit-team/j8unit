 ...
 * javax.print.attribute.standard.PrinterResolution}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterResolutionTests}).
 * </p>
 *
 * <p>
 ...
 * @see PrinterResolutionTests PrinterResolutionTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.javax.print.attribute.ResolutionSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterResolution.class!",
                   javax.print.attribute.standard.PrinterResolution.class.isAssignableFrom(sut));
    }

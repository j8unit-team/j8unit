        ...
        org.j8unit.repository.javax.print.attribute.ResolutionSyntaxClassTests<SUT>
{
    ...
    /**
     * Test method for {@link javax.print.attribute.standard.PrinterResolution#PrinterResolution(int,int,int) public javax.print.attribute.standard.PrinterResolution(int,int,int)}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_PrinterResolution_int_int_int() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        javax.print.attribute.standard.PrinterResolution sut = null; // = new PrinterResolution(int,int,int);
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends javax.print.attribute.standard.PrinterResolution> sut = createNewSUT();

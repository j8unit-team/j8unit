 ...
 * javax.print.attribute.standard.PrinterResolution}, containing all class relevant test methods (at least the test
...
org.j8unit.repository.javax.print.attribute.ResolutionSyntaxClassTests<SUT> {
    ...
    /**
     * <p>
     * Test method for {@link javax.print.attribute.standard.PrinterResolution#PrinterResolution(int, int, int) public
     ...
     * </p>
     *
     * @j8unit.aim javax.print.attribute.standard.PrinterResolution#PrinterResolution(int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_PrinterResolution_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.print.attribute.standard.PrinterResolution sut = null; // = new PrinterResolution(int, int, int);
    }

    /**
     * @since 0.9.2
     *
     * @j8unit.aim javax.print.attribute.standard.PrinterResolution#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

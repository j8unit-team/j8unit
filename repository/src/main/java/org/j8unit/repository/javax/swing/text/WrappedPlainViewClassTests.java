...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.text.WrappedPlainView class
 * javax.swing.text.WrappedPlainView}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WrappedPlainViewTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see WrappedPlainViewTests WrappedPlainViewTests (The complementary j8unit test interface containing the instance
...
public abstract interface WrappedPlainViewClassTests<SUT extends javax.swing.text.WrappedPlainView>
extends TabExpanderClassTests<SUT>, BoxViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.WrappedPlainView.class!",
                   javax.swing.text.WrappedPlainView.class.isAssignableFrom(sut));
    }

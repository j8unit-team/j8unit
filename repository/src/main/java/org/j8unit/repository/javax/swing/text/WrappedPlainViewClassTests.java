 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WrappedPlainView
 * public class javax.swing.text.WrappedPlainView}.
 *
...
extends TabExpanderClassTests<SUT>, BoxViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WrappedPlainView.class!",
                   WrappedPlainView.class.isAssignableFrom(sut));
    }

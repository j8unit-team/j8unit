 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextUI public
...
public abstract interface TextUIClassTests<SUT extends TextUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.TextUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextUI.class!",
                   TextUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.TextUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.TextUI]

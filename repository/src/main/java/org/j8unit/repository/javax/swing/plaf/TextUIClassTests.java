 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextUITests}.
 * </p>
 *
 * @see javax.swing.plaf.TextUI class javax.swing.plaf.TextUI (the hereby targeted class-under-test class)
 * @see TextUITests TextUITests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface TextUIClassTests<SUT extends javax.swing.plaf.TextUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.TextUI.class!",
                   javax.swing.plaf.TextUI.class.isAssignableFrom(sut));
    }

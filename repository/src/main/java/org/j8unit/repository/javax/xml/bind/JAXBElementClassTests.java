 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXBElement public
 * class javax.xml.bind.JAXBElement<T>}.
 *
...
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXBElement.class!",
                   JAXBElement.class.isAssignableFrom(sut));
    }
     ...
     * {@link GlobalScope public static final class javax.xml.bind.JAXBElement$GlobalScope}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GlobalScope.class!",
                              GlobalScope.class.isAssignableFrom(sut));
        }

...
import org.j8unit.repository.javax.swing.plaf.basic.BasicTreeUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthTreeUI public
...
public abstract interface SynthTreeUIClassTests<SUT extends SynthTreeUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicTreeUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.synth.SynthTreeUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthTreeUI.class!",
                   SynthTreeUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthTreeUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.synth.SynthTreeUI]

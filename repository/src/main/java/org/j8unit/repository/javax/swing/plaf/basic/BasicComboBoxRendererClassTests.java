 ...
 * javax.swing.plaf.basic.BasicComboBoxRenderer}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicComboBoxRendererTests}).
 * </p>
 *
 * <p>
 ...
 * {@link BasicComboBoxRendererTests}.
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicComboBoxRenderer class javax.swing.plaf.basic.BasicComboBoxRenderer (the hereby
 *      targeted class-under-test class)
 * @see BasicComboBoxRendererTests BasicComboBoxRendererTests (The complementary j8unit test interface containing the
...
public abstract interface BasicComboBoxRendererClassTests<SUT extends javax.swing.plaf.basic.BasicComboBoxRenderer>
...
org.j8unit.repository.javax.swing.JLabelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicComboBoxRenderer.class!",
                   javax.swing.plaf.basic.BasicComboBoxRenderer.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicComboBoxRenderer.UIResource class
     * javax.swing.plaf.basic.BasicComboBoxRenderer$UIResource}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link BasicComboBoxRendererTests.UIResourceTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicComboBoxRendererTests.UIResourceTests BasicComboBoxRendererTests.UIResourceTests (The complementary
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface UIResourceClassTests<SUT extends javax.swing.plaf.basic.BasicComboBoxRenderer.UIResource>
    extends org.j8unit.repository.javax.swing.plaf.UIResourceClassTests<SUT>, BasicComboBoxRendererClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicComboBoxRenderer.UIResource.class!",
                       javax.swing.plaf.basic.BasicComboBoxRenderer.UIResource.class.isAssignableFrom(sut));
        }

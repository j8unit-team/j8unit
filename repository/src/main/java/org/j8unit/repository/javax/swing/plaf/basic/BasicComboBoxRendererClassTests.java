...
import org.j8unit.repository.javax.swing.ListCellRendererClassTests;
...
extends ListCellRendererClassTests<SUT>, JLabelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicComboBoxRenderer.class!",
     ...
     * {@link UIResource public static class javax.swing.plaf.basic.BasicComboBoxRenderer$UIResource}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

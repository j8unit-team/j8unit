 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SAXParser public
 * abstract class javax.xml.parsers.SAXParser}.
 *
...
public abstract interface SAXParserClassTests<SUT extends SAXParser>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXParser.class!",
                   SAXParser.class.isAssignableFrom(sut));
    }

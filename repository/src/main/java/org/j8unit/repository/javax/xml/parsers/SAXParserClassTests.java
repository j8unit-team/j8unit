...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.parsers.SAXParser class javax.xml.parsers.SAXParser},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SAXParserTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SAXParserTests}.
 * </p>
 *
 * @see javax.xml.parsers.SAXParser class javax.xml.parsers.SAXParser (the hereby targeted class-under-test class)
 * @see SAXParserTests SAXParserTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SAXParserClassTests<SUT extends javax.xml.parsers.SAXParser>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.parsers.SAXParser.class!",
                   javax.xml.parsers.SAXParser.class.isAssignableFrom(sut));
    }

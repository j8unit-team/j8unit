...
public abstract interface LimitExceededExceptionClassTests<SUT extends LimitExceededException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LimitExceededException.class!",
                   LimitExceededException.class.isAssignableFrom(sut));
    }

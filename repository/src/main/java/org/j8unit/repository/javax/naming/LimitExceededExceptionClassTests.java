 ...
 * javax.naming.LimitExceededException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LimitExceededExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link LimitExceededExceptionTests}.
 * </p>
 *
 * @see javax.naming.LimitExceededException class javax.naming.LimitExceededException (the hereby targeted
 *      class-under-test class)
 * @see LimitExceededExceptionTests LimitExceededExceptionTests (The complementary j8unit test interface containing the
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.LimitExceededException.class!",
                   javax.naming.LimitExceededException.class.isAssignableFrom(sut));
    }

...
public abstract interface SingleSelectionModelClassTests<SUT extends SingleSelectionModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SingleSelectionModel.class!",
                   SingleSelectionModel.class.isAssignableFrom(sut));
    }

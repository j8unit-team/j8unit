 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Entity public final
...
public abstract interface EntityClassTests<SUT extends Entity>
extends DTDConstantsClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.html.parser.Entity]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Entity.class!",

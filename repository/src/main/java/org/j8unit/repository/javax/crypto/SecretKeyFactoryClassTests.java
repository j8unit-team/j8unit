 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecretKeyFactory
...
public abstract interface SecretKeyFactoryClassTests<SUT extends SecretKeyFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecretKeyFactory.class!",
                   SecretKeyFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIServer public
 * abstract interface javax.management.remote.rmi.RMIServer}.
 *
...
public abstract interface RMIServerClassTests<SUT extends RMIServer>
extends RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIServer.class!",
                   RMIServer.class.isAssignableFrom(sut));
    }

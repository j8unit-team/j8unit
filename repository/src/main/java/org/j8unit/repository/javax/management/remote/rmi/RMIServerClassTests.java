 ...
 * javax.management.remote.rmi.RMIServer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIServerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIServerTests}.
 * </p>
 *
 * @see javax.management.remote.rmi.RMIServer interface javax.management.remote.rmi.RMIServer (the hereby targeted
 *      class-under-test class)
 * @see RMIServerTests RMIServerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RMIServerClassTests<SUT extends javax.management.remote.rmi.RMIServer>
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIServer.class!",
                   javax.management.remote.rmi.RMIServer.class.isAssignableFrom(sut));
    }

 ...
 * {@link InitialContextFactoryBuilder public abstract interface javax.naming.spi.InitialContextFactoryBuilder}.
 *
...
public abstract interface InitialContextFactoryBuilderClassTests<SUT extends InitialContextFactoryBuilder>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InitialContextFactoryBuilder.class!",
                   InitialContextFactoryBuilder.class.isAssignableFrom(sut));
    }

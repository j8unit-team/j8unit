 ...
 * javax.naming.spi.InitialContextFactoryBuilder}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InitialContextFactoryBuilderTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.naming.spi.InitialContextFactoryBuilder interface javax.naming.spi.InitialContextFactoryBuilder (the
 *      hereby targeted class-under-test class)
 * @see InitialContextFactoryBuilderTests InitialContextFactoryBuilderTests (The complementary j8unit test interface
...
public abstract interface InitialContextFactoryBuilderClassTests<SUT extends javax.naming.spi.InitialContextFactoryBuilder>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.InitialContextFactoryBuilder.class!",
                   javax.naming.spi.InitialContextFactoryBuilder.class.isAssignableFrom(sut));
    }

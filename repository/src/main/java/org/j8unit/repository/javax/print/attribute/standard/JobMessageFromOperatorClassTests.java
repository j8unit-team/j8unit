 ...
 * javax.print.attribute.standard.JobMessageFromOperator}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobMessageFromOperatorTests}).
 * </p>
 *
 * <p>
 ...
 * @see JobMessageFromOperatorTests JobMessageFromOperatorTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobMessageFromOperator.class!",
                   javax.print.attribute.standard.JobMessageFromOperator.class.isAssignableFrom(sut));
    }

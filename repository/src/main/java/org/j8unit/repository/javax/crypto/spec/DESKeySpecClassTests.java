 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DESKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DESKeySpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.DESKeySpec class javax.crypto.spec.DESKeySpec (the hereby targeted class-under-test class)
 * @see DESKeySpecTests DESKeySpecTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.security.spec.KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.DESKeySpec.class!",
                   javax.crypto.spec.DESKeySpec.class.isAssignableFrom(sut));
    }

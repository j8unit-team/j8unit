...
public abstract interface HTMLFrameHyperlinkEventClassTests<SUT extends HTMLFrameHyperlinkEvent>
extends org.j8unit.repository.javax.swing.event.HyperlinkEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLFrameHyperlinkEvent.class!",
                   HTMLFrameHyperlinkEvent.class.isAssignableFrom(sut));
    }

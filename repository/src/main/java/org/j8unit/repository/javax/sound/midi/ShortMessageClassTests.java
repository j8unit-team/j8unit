 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShortMessageTests}).
 * </p>
 *
 * <p>
 ...
 * @see ShortMessageTests ShortMessageTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends MidiMessageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.ShortMessage.class!",
                   javax.sound.midi.ShortMessage.class.isAssignableFrom(sut));
    }

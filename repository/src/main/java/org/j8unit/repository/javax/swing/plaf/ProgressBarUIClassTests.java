 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProgressBarUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProgressBarUITests}.
 * </p>
 *
 * @see javax.swing.plaf.ProgressBarUI class javax.swing.plaf.ProgressBarUI (the hereby targeted class-under-test class)
 * @see ProgressBarUITests ProgressBarUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ProgressBarUI.class!",
                   javax.swing.plaf.ProgressBarUI.class.isAssignableFrom(sut));
    }

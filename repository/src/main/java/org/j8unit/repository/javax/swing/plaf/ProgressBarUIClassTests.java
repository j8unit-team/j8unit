 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProgressBarUI
...
public abstract interface ProgressBarUIClassTests<SUT extends ProgressBarUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProgressBarUI.class!",
                   ProgressBarUI.class.isAssignableFrom(sut));
    }

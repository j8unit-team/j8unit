 ...
 * javax.print.attribute.standard.OrientationRequested}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OrientationRequestedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OrientationRequestedTests}
 * .
 * </p>
 *
 ...
 * @see OrientationRequestedTests OrientationRequestedTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.OrientationRequested.class!",
                   javax.print.attribute.standard.OrientationRequested.class.isAssignableFrom(sut));
    }

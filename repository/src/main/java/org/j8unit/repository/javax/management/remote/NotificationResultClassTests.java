 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotificationResult
 * public class javax.management.remote.NotificationResult}.
 *
...
public abstract interface NotificationResultClassTests<SUT extends NotificationResult>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotificationResult.class!",
                   NotificationResult.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DetailEntry public
 * abstract interface javax.xml.soap.DetailEntry}.
 *
...
public abstract interface DetailEntryClassTests<SUT extends DetailEntry>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DetailEntry.class!",
                   DetailEntry.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DetailEntryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DetailEntryTests}.
 * </p>
 *
 * @see javax.xml.soap.DetailEntry interface javax.xml.soap.DetailEntry (the hereby targeted class-under-test class)
 * @see DetailEntryTests DetailEntryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DetailEntryClassTests<SUT extends javax.xml.soap.DetailEntry>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.DetailEntry.class!",
                   javax.xml.soap.DetailEntry.class.isAssignableFrom(sut));
    }

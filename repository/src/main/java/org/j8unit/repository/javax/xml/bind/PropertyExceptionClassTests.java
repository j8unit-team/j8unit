 ...
 * javax.xml.bind.PropertyException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.bind.PropertyException class javax.xml.bind.PropertyException (the hereby targeted class-under-test
 *      class)
 * @see PropertyExceptionTests PropertyExceptionTests (The complementary j8unit test interface containing the instance
...
extends JAXBExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.PropertyException.class!",
                   javax.xml.bind.PropertyException.class.isAssignableFrom(sut));
    }

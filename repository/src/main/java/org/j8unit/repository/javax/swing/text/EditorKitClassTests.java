 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EditorKit public
...
public abstract interface EditorKitClassTests<SUT extends EditorKit>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EditorKit.class!",
                   EditorKit.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.text.EditorKit]

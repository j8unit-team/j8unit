 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIConnection
...
public abstract interface RMIConnectionClassTests<SUT extends RMIConnection>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIConnection.class!",
                   RMIConnection.class.isAssignableFrom(sut));
    }

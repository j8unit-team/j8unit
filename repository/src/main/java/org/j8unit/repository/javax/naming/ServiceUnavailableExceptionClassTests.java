 ...
 * {@link ServiceUnavailableException public class javax.naming.ServiceUnavailableException}.
 *
...
public abstract interface ServiceUnavailableExceptionClassTests<SUT extends ServiceUnavailableException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceUnavailableException.class!",
                   ServiceUnavailableException.class.isAssignableFrom(sut));
    }

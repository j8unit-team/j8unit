 ...
 * javax.naming.ServiceUnavailableException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ServiceUnavailableExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ServiceUnavailableExceptionTests ServiceUnavailableExceptionTests (The complementary j8unit test interface
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ServiceUnavailableException.class!",
                   javax.naming.ServiceUnavailableException.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.openmbean.OpenMBeanParameterInfoSupport}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * @see OpenMBeanParameterInfoSupportTests OpenMBeanParameterInfoSupportTests (The complementary j8unit test interface
...
extends OpenMBeanParameterInfoClassTests<SUT>, org.j8unit.repository.javax.management.MBeanParameterInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenMBeanParameterInfoSupport.class!",
                   javax.management.openmbean.OpenMBeanParameterInfoSupport.class.isAssignableFrom(sut));
    }

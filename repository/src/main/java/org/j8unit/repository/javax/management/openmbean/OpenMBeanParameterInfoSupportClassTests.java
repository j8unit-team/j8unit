...
org.j8unit.repository.javax.management.MBeanParameterInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanParameterInfoSupport.class!",
                   OpenMBeanParameterInfoSupport.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.PrintQuality class
 * javax.print.attribute.standard.PrintQuality}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintQualityTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintQualityTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PrintQuality class javax.print.attribute.standard.PrintQuality (the hereby
 *      targeted class-under-test class)
 * @see PrintQualityTests PrintQualityTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PrintQualityClassTests<SUT extends javax.print.attribute.standard.PrintQuality>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrintQuality.class!",
                   javax.print.attribute.standard.PrintQuality.class.isAssignableFrom(sut));
    }

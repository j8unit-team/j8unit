 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintQuality public
...
public abstract interface PrintQualityClassTests<SUT extends PrintQuality>
extends DocAttributeClassTests<SUT>, PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintQuality.class!",
                   PrintQuality.class.isAssignableFrom(sut));
    }

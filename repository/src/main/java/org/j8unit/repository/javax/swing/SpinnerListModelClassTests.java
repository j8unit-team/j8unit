 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SpinnerListModel
 * public class javax.swing.SpinnerListModel}.
 *
...
public abstract interface SpinnerListModelClassTests<SUT extends SpinnerListModel>
extends AbstractSpinnerModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SpinnerListModel.class!",
                   SpinnerListModel.class.isAssignableFrom(sut));
    }

...
public abstract interface ReferenceUriSchemesSupportedClassTests<SUT extends ReferenceUriSchemesSupported>
extends AttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReferenceUriSchemesSupported.class!",
                   ReferenceUriSchemesSupported.class.isAssignableFrom(sut));
    }

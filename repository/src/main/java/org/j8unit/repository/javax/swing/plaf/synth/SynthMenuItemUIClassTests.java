...
import org.j8unit.repository.javax.swing.plaf.basic.BasicMenuItemUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthMenuItemUI
...
public abstract interface SynthMenuItemUIClassTests<SUT extends SynthMenuItemUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicMenuItemUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthMenuItemUI.class!",
                   SynthMenuItemUI.class.isAssignableFrom(sut));
    }

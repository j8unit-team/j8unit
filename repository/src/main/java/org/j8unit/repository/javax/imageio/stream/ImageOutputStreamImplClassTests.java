 ...
 * javax.imageio.stream.ImageOutputStreamImpl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageOutputStreamImplTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.imageio.stream.ImageOutputStreamImpl class javax.imageio.stream.ImageOutputStreamImpl (the hereby targeted
 *      class-under-test class)
 * @see ImageOutputStreamImplTests ImageOutputStreamImplTests (The complementary j8unit test interface containing the
...
public abstract interface ImageOutputStreamImplClassTests<SUT extends javax.imageio.stream.ImageOutputStreamImpl>
extends ImageOutputStreamClassTests<SUT>, ImageInputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.ImageOutputStreamImpl.class!",
                   javax.imageio.stream.ImageOutputStreamImpl.class.isAssignableFrom(sut));
    }

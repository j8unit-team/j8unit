...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.annotation.processing.SupportedOptions interface
 * javax.annotation.processing.SupportedOptions}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SupportedOptionsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SupportedOptionsTests}.
 * </p>
 *
 * @see javax.annotation.processing.SupportedOptions interface javax.annotation.processing.SupportedOptions (the hereby
 *      targeted class-under-test class)
 * @see SupportedOptionsTests SupportedOptionsTests (The complementary j8unit test interface containing the instance
...
public abstract interface SupportedOptionsClassTests<SUT extends javax.annotation.processing.SupportedOptions>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.SupportedOptions.class!",
                   javax.annotation.processing.SupportedOptions.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SupportedOptions
...
public abstract interface SupportedOptionsClassTests<SUT extends SupportedOptions>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SupportedOptions.class!",
                   SupportedOptions.class.isAssignableFrom(sut));
    }

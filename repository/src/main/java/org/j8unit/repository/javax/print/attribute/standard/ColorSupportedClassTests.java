 ...
 * javax.print.attribute.standard.ColorSupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ColorSupportedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ColorSupportedTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.ColorSupported class javax.print.attribute.standard.ColorSupported (the hereby
 *      targeted class-under-test class)
 * @see ColorSupportedTests ColorSupportedTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.ColorSupported.class!",
                   javax.print.attribute.standard.ColorSupported.class.isAssignableFrom(sut));
    }

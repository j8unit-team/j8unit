 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ColorSupported
...
public abstract interface ColorSupportedClassTests<SUT extends ColorSupported>
extends PrintServiceAttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorSupported.class!",
                   ColorSupported.class.isAssignableFrom(sut));
    }

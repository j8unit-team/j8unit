 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComboBoxModelTests}).
 * </p>
 *
 * <p>
 ...
 * @see ComboBoxModelTests ComboBoxModelTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ListModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.ComboBoxModel.class!",
                   javax.swing.ComboBoxModel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComboBoxModel
 * public abstract interface javax.swing.ComboBoxModel<E>}.
 *
...
extends ListModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComboBoxModel.class!",
                   ComboBoxModel.class.isAssignableFrom(sut));
    }

 ...
 * javax.activity.ActivityRequiredException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ActivityRequiredExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ActivityRequiredExceptionTests ActivityRequiredExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activity.ActivityRequiredException.class!",
                   javax.activity.ActivityRequiredException.class.isAssignableFrom(sut));
    }

...
public abstract interface ActivityRequiredExceptionClassTests<SUT extends ActivityRequiredException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivityRequiredException.class!",

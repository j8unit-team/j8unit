...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain javax.security.auth.callback.ConfirmationCallback class
 ...
 * @since 0.9.0
 *
 * @j8unit.aim javax.security.auth.callback.ConfirmationCallback
 */
@FunctionalInterface
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    /**
     * <p>
     * Test method for {@link javax.security.auth.callback.ConfirmationCallback#ConfirmationCallback(int, int, int)
     * public javax.security.auth.callback.ConfirmationCallback(int,int,int)}.
     *
     ...
     * </p>
     *
     * @j8unit.aim javax.security.auth.callback.ConfirmationCallback#ConfirmationCallback(int, int, int)
     */
    ...
    throws Exception {
        ...
        final javax.security.auth.callback.ConfirmationCallback sut = null; // = new ConfirmationCallback(int, int,
                                                                            // int);
    }
     ...
     * <p>
     * Test method for
     * {@link javax.security.auth.callback.ConfirmationCallback#ConfirmationCallback(int, java.lang.String[], int)
     * public javax.security.auth.callback.ConfirmationCallback(int,java.lang.String[],int)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
     * </p>
     *
     * @j8unit.aim javax.security.auth.callback.ConfirmationCallback#ConfirmationCallback(int, java.lang.String[], int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.security.auth.callback.ConfirmationCallback sut = null; // = new ConfirmationCallback(int,
     ...
     * </p>
     *
     * @j8unit.aim javax.security.auth.callback.ConfirmationCallback#ConfirmationCallback(java.lang.String, int, int,
     *             int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    ...
    throws Exception {
        ...
        final javax.security.auth.callback.ConfirmationCallback sut = null; // = new
                                                                            // ConfirmationCallback(java.lang.String,
                                                                            // int, int, int);
    }
     ...
     * </p>
     *
     * @j8unit.aim javax.security.auth.callback.ConfirmationCallback#ConfirmationCallback(java.lang.String, int,
     *             java.lang.String[], int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
     ...
     * @since 0.9.2
     *
     * @j8unit.aim javax.security.auth.callback.ConfirmationCallback#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

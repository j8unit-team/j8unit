 ...
 * {@link ConfirmationCallback public class javax.security.auth.callback.ConfirmationCallback}.
 *
 ...
 * {@link ConfirmationCallbackTests}.
 * </p>
 *
 * <p>
...
public abstract interface ConfirmationCallbackClassTests<SUT extends ConfirmationCallback>
extends CallbackClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConfirmationCallback.class!",

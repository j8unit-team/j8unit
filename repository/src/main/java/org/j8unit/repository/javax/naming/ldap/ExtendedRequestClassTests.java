 ...
 * javax.naming.ldap.ExtendedRequest}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExtendedRequestTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExtendedRequestTests}.
 * </p>
 *
 * @see javax.naming.ldap.ExtendedRequest interface javax.naming.ldap.ExtendedRequest (the hereby targeted
 *      class-under-test class)
 * @see ExtendedRequestTests ExtendedRequestTests (The complementary j8unit test interface containing the instance
...
public abstract interface ExtendedRequestClassTests<SUT extends javax.naming.ldap.ExtendedRequest>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.ExtendedRequest.class!",
                   javax.naming.ldap.ExtendedRequest.class.isAssignableFrom(sut));
    }

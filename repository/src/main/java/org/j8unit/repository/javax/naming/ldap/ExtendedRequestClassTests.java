 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExtendedRequest
 * public abstract interface javax.naming.ldap.ExtendedRequest}.
 *
...
public abstract interface ExtendedRequestClassTests<SUT extends ExtendedRequest>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExtendedRequest.class!",

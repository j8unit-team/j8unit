 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SortControl public
 * final class javax.naming.ldap.SortControl}.
 *
...
public abstract interface SortControlClassTests<SUT extends SortControl>
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SortControl.class!",
                   SortControl.class.isAssignableFrom(sut));
    }

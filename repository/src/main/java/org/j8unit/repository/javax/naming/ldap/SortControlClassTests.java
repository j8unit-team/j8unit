 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SortControlTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SortControlTests}.
 * </p>
 *
 * @see javax.naming.ldap.SortControl class javax.naming.ldap.SortControl (the hereby targeted class-under-test class)
 * @see SortControlTests SortControlTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.SortControl.class!",
                   javax.naming.ldap.SortControl.class.isAssignableFrom(sut));
    }

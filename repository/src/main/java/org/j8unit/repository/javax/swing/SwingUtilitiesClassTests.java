 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SwingUtilities
...
public abstract interface SwingUtilitiesClassTests<SUT extends SwingUtilities>
extends SwingConstantsClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SwingUtilities.class!",
                   SwingUtilities.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlElementRefs
...
public abstract interface XmlElementRefsClassTests<SUT extends XmlElementRefs>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlElementRefs.class!",
                   XmlElementRefs.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlElementRefs interface
 * javax.xml.bind.annotation.XmlElementRefs}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlElementRefsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlElementRefsTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlElementRefs interface javax.xml.bind.annotation.XmlElementRefs (the hereby targeted
 *      class-under-test class)
 * @see XmlElementRefsTests XmlElementRefsTests (The complementary j8unit test interface containing the instance
...
public abstract interface XmlElementRefsClassTests<SUT extends javax.xml.bind.annotation.XmlElementRefs>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlElementRefs.class!",
                   javax.xml.bind.annotation.XmlElementRefs.class.isAssignableFrom(sut));
    }

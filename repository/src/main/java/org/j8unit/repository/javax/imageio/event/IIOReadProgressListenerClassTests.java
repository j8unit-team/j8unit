...
public abstract interface IIOReadProgressListenerClassTests<SUT extends IIOReadProgressListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOReadProgressListener.class!",
                   IIOReadProgressListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.imageio.event.IIOReadProgressListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOReadProgressListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link IIOReadProgressListenerTests}.
 * </p>
 *
 * @see javax.imageio.event.IIOReadProgressListener interface javax.imageio.event.IIOReadProgressListener (the hereby
 *      targeted class-under-test class)
 * @see IIOReadProgressListenerTests IIOReadProgressListenerTests (The complementary j8unit test interface containing
...
public abstract interface IIOReadProgressListenerClassTests<SUT extends javax.imageio.event.IIOReadProgressListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.event.IIOReadProgressListener.class!",
                   javax.imageio.event.IIOReadProgressListener.class.isAssignableFrom(sut));
    }

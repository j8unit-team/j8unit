 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetListenerTests}.
 * </p>
 *
 * @see javax.sql.RowSetListener interface javax.sql.RowSetListener (the hereby targeted class-under-test class)
 * @see RowSetListenerTests RowSetListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface RowSetListenerClassTests<SUT extends javax.sql.RowSetListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.RowSetListener.class!",
                   javax.sql.RowSetListener.class.isAssignableFrom(sut));
    }

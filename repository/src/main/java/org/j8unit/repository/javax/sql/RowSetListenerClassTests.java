 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetListener
 * public abstract interface javax.sql.RowSetListener}.
 *
...
public abstract interface RowSetListenerClassTests<SUT extends RowSetListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetListener.class!",
                   RowSetListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RelationSupport
...
public abstract interface RelationSupportClassTests<SUT extends RelationSupport>
extends RelationSupportMBeanClassTests<SUT>, MBeanRegistrationClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationSupport.class!",

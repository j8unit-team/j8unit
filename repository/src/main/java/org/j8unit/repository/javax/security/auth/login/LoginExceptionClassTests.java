 ...
 * javax.security.auth.login.LoginException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LoginExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LoginExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.login.LoginException class javax.security.auth.login.LoginException (the hereby targeted
 *      class-under-test class)
 * @see LoginExceptionTests LoginExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.LoginException.class!",
                   javax.security.auth.login.LoginException.class.isAssignableFrom(sut));
    }

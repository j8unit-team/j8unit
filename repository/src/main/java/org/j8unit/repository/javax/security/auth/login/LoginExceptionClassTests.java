 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LoginException
...
public abstract interface LoginExceptionClassTests<SUT extends LoginException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LoginException.class!",
                   LoginException.class.isAssignableFrom(sut));
    }

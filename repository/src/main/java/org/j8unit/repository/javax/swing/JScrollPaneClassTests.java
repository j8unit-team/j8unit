 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JScrollPane public
...
public abstract interface JScrollPaneClassTests<SUT extends JScrollPane>
extends ScrollPaneConstantsClassTests<SUT>, AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JScrollPane.class!",
                   JScrollPane.class.isAssignableFrom(sut));
    }

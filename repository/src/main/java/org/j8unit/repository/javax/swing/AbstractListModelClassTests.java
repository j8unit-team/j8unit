 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractListModel
 * public abstract class javax.swing.AbstractListModel<E>}.
 *
...
public abstract interface AbstractListModelClassTests<SUT extends AbstractListModel>
extends ListModelClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.AbstractListModel]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractListModel.class!",
                   AbstractListModel.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.AbstractListModel]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.AbstractListModel]

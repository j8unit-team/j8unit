...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.Box class javax.swing.Box}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BoxTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.Box class javax.swing.Box (the hereby targeted class-under-test class)
 * @see BoxTests BoxTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.Box.class!",
                   javax.swing.Box.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.Box.Filler class javax.swing.Box$Filler}, containing
     * all type relevant aspects (e.&thinsp;g., runtime constraints and further type specific requirements). (In
     * addition, the runtime type of this j8unit test interface's generic type is verified by
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link BoxTests.FillerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link BoxTests.FillerTests}.
     * </p>
     *
     * @see javax.swing.Box.Filler class javax.swing.Box$Filler (the hereby targeted class-under-test class)
     * @see BoxTests.FillerTests BoxTests.FillerTests (The complementary j8unit test interface containing the instance
    ...
    extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.Box.Filler.class!",
                       javax.swing.Box.Filler.class.isAssignableFrom(sut));
        }

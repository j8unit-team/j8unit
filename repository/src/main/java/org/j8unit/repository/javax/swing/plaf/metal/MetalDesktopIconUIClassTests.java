...
import org.j8unit.repository.javax.swing.plaf.basic.BasicDesktopIconUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalDesktopIconUI
 * public class javax.swing.plaf.metal.MetalDesktopIconUI}.
 *
...
public abstract interface MetalDesktopIconUIClassTests<SUT extends MetalDesktopIconUI>
extends BasicDesktopIconUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalDesktopIconUI.class!",
                   MetalDesktopIconUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.smartcardio.CardPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CardPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see CardPermissionTests CardPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.smartcardio.CardPermission.class!",
                   javax.smartcardio.CardPermission.class.isAssignableFrom(sut));
    }

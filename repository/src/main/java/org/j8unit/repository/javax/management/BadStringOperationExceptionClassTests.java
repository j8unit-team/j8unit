...
public abstract interface BadStringOperationExceptionClassTests<SUT extends BadStringOperationException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BadStringOperationException.class!",
                   BadStringOperationException.class.isAssignableFrom(sut));
    }

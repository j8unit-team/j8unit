 ...
 * javax.imageio.spi.ImageInputStreamSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageInputStreamSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageInputStreamSpiTests}.
 * </p>
 *
 * @see javax.imageio.spi.ImageInputStreamSpi class javax.imageio.spi.ImageInputStreamSpi (the hereby targeted
 *      class-under-test class)
 * @see ImageInputStreamSpiTests ImageInputStreamSpiTests (The complementary j8unit test interface containing the
...
extends IIOServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.ImageInputStreamSpi.class!",
                   javax.imageio.spi.ImageInputStreamSpi.class.isAssignableFrom(sut));
    }

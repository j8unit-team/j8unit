 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageInputStreamSpi
 * public abstract class javax.imageio.spi.ImageInputStreamSpi}.
 *
...
public abstract interface ImageInputStreamSpiClassTests<SUT extends ImageInputStreamSpi>
extends IIOServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageInputStreamSpi.class!",
                   ImageInputStreamSpi.class.isAssignableFrom(sut));
    }

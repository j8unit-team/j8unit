 ...
 * javax.xml.stream.events.StartDocument}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StartDocumentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StartDocumentTests}.
 * </p>
 *
 * @see javax.xml.stream.events.StartDocument interface javax.xml.stream.events.StartDocument (the hereby targeted
 *      class-under-test class)
 * @see StartDocumentTests StartDocumentTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.StartDocument.class!",
                   javax.xml.stream.events.StartDocument.class.isAssignableFrom(sut));
    }

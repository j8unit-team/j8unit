 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StartDocument
...
public abstract interface StartDocumentClassTests<SUT extends StartDocument>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StartDocument.class!",
                   StartDocument.class.isAssignableFrom(sut));
    }

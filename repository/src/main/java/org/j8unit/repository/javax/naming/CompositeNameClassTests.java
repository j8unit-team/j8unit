 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompositeName
...
public abstract interface CompositeNameClassTests<SUT extends CompositeName>
extends NameClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompositeName.class!",
                   CompositeName.class.isAssignableFrom(sut));
    }

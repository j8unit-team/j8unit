 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompositeNameTests}.
 * </p>
 *
 * @see javax.naming.CompositeName class javax.naming.CompositeName (the hereby targeted class-under-test class)
 * @see CompositeNameTests CompositeNameTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends NameClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.CompositeName.class!",
                   javax.naming.CompositeName.class.isAssignableFrom(sut));
    }

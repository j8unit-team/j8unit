...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.tools.Tool interface javax.tools.Tool}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToolTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToolTests}.
 * </p>
 *
 * @see javax.tools.Tool interface javax.tools.Tool (the hereby targeted class-under-test class)
 * @see ToolTests ToolTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ToolClassTests<SUT extends javax.tools.Tool>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.Tool.class!",
                   javax.tools.Tool.class.isAssignableFrom(sut));
    }

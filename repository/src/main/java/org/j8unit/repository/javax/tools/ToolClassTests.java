 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Tool public
 * abstract interface javax.tools.Tool}.
 *
...
public abstract interface ToolClassTests<SUT extends Tool>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Tool.class!", Tool.class.isAssignableFrom(sut));
    }

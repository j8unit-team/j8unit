 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JButton public
...
public abstract interface JButtonClassTests<SUT extends JButton>
extends AccessibleClassTests<SUT>, AbstractButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JButton.class!",
                   JButton.class.isAssignableFrom(sut));
    }

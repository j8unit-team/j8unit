...
import org.j8unit.repository.javax.xml.transform.sax.SAXSourceClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXBSource public
...
public abstract interface JAXBSourceClassTests<SUT extends JAXBSource>
extends SAXSourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXBSource.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JAXBSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JAXBSourceTests}.
 * </p>
 *
 * @see javax.xml.bind.util.JAXBSource class javax.xml.bind.util.JAXBSource (the hereby targeted class-under-test class)
 * @see JAXBSourceTests JAXBSourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.transform.sax.SAXSourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.util.JAXBSource.class!",
                   javax.xml.bind.util.JAXBSource.class.isAssignableFrom(sut));
    }

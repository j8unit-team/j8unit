...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.ValidationEventLocator interface
 * javax.xml.bind.ValidationEventLocator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValidationEventLocatorTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ValidationEventLocatorTests}.
 * </p>
 *
 * @see javax.xml.bind.ValidationEventLocator interface javax.xml.bind.ValidationEventLocator (the hereby targeted
 *      class-under-test class)
 * @see ValidationEventLocatorTests ValidationEventLocatorTests (The complementary j8unit test interface containing the
...
public abstract interface ValidationEventLocatorClassTests<SUT extends javax.xml.bind.ValidationEventLocator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.ValidationEventLocator.class!",
                   javax.xml.bind.ValidationEventLocator.class.isAssignableFrom(sut));
    }

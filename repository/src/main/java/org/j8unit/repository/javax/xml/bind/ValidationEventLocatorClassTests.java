 ...
 * {@link ValidationEventLocator public abstract interface javax.xml.bind.ValidationEventLocator}.
 *
...
public abstract interface ValidationEventLocatorClassTests<SUT extends ValidationEventLocator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValidationEventLocator.class!",
                   ValidationEventLocator.class.isAssignableFrom(sut));
    }

 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link DomHandler
 * public abstract interface javax.xml.bind.annotation.DomHandler<ElementT,ResultT>}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.xml.bind.annotation.DomHandlerClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface DomHandlerTests<SUT extends DomHandler<ElementT, ResultT>, ElementT, ResultT extends Result>
extends RepositoryTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getElement_Result()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

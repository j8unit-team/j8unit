 ...
 * javax.naming.NameNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NameNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link NameNotFoundExceptionTests}.
 * </p>
 *
 * @see javax.naming.NameNotFoundException class javax.naming.NameNotFoundException (the hereby targeted
 *      class-under-test class)
 * @see NameNotFoundExceptionTests NameNotFoundExceptionTests (The complementary j8unit test interface containing the
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NameNotFoundException.class!",
                   javax.naming.NameNotFoundException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalToolBarUI
 * public class javax.swing.plaf.metal.MetalToolBarUI}.
 *
...
public abstract interface MetalToolBarUIClassTests<SUT extends MetalToolBarUI>
extends BasicToolBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalToolBarUI.class!",
                   MetalToolBarUI.class.isAssignableFrom(sut));
    }

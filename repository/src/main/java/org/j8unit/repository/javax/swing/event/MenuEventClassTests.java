 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuEvent public
...
public abstract interface MenuEventClassTests<SUT extends MenuEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuEvent.class!",
                   MenuEvent.class.isAssignableFrom(sut));
    }

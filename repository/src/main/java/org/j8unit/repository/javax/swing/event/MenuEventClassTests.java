 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuEventTests}.
 * </p>
 *
 * @see javax.swing.event.MenuEvent class javax.swing.event.MenuEvent (the hereby targeted class-under-test class)
 * @see MenuEventTests MenuEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MenuEventClassTests<SUT extends javax.swing.event.MenuEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MenuEvent.class!",
                   javax.swing.event.MenuEvent.class.isAssignableFrom(sut));
    }

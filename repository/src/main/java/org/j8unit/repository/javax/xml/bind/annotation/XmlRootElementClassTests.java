...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlRootElement interface
 * javax.xml.bind.annotation.XmlRootElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlRootElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlRootElementTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlRootElement interface javax.xml.bind.annotation.XmlRootElement (the hereby targeted
 *      class-under-test class)
 * @see XmlRootElementTests XmlRootElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface XmlRootElementClassTests<SUT extends javax.xml.bind.annotation.XmlRootElement>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlRootElement.class!",
                   javax.xml.bind.annotation.XmlRootElement.class.isAssignableFrom(sut));
    }

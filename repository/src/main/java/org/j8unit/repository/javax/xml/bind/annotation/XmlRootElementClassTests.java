 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlRootElement
 * public abstract @interface javax.xml.bind.annotation.XmlRootElement}.
 *
...
public abstract interface XmlRootElementClassTests<SUT extends XmlRootElement>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlRootElement.class!",
                   XmlRootElement.class.isAssignableFrom(sut));
    }

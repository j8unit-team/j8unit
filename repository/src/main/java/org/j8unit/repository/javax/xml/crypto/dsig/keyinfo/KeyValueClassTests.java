 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyValue public
 * abstract interface javax.xml.crypto.dsig.keyinfo.KeyValue}.
 *
...
public abstract interface KeyValueClassTests<SUT extends KeyValue>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyValue.class!",
                   KeyValue.class.isAssignableFrom(sut));
    }

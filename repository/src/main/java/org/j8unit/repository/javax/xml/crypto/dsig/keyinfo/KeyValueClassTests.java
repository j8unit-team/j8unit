 ...
 * javax.xml.crypto.dsig.keyinfo.KeyValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyValueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyValueTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.KeyValue interface javax.xml.crypto.dsig.keyinfo.KeyValue (the hereby targeted
 *      class-under-test class)
 * @see KeyValueTests KeyValueTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeyValueClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.KeyValue>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.KeyValue.class!",
                   javax.xml.crypto.dsig.keyinfo.KeyValue.class.isAssignableFrom(sut));
    }

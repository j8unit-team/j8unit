 ...
 * javax.tools.StandardJavaFileManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardJavaFileManagerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see StandardJavaFileManagerTests StandardJavaFileManagerTests (The complementary j8unit test interface containing
...
extends JavaFileManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.StandardJavaFileManager.class!",
                   javax.tools.StandardJavaFileManager.class.isAssignableFrom(sut));
    }

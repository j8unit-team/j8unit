 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPMessage public
 * abstract class javax.xml.soap.SOAPMessage}.
 *
...
public abstract interface SOAPMessageClassTests<SUT extends SOAPMessage>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.soap.SOAPMessage]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPMessage.class!",
                   SOAPMessage.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.soap.SOAPMessage]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.xml.soap.SOAPMessage]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JTableHeader public
...
public abstract interface JTableHeaderClassTests<SUT extends JTableHeader>
extends TableColumnModelListenerClassTests<SUT>, AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JTableHeader.class!",
                   JTableHeader.class.isAssignableFrom(sut));
    }

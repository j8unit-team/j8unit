 ...
 * javax.naming.InvalidNameException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidNameExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvalidNameExceptionTests}
 * .
 * </p>
 *
 * @see javax.naming.InvalidNameException class javax.naming.InvalidNameException (the hereby targeted class-under-test
 *      class)
 * @see InvalidNameExceptionTests InvalidNameExceptionTests (The complementary j8unit test interface containing the
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.InvalidNameException.class!",
                   javax.naming.InvalidNameException.class.isAssignableFrom(sut));
    }

...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidNameException.class!",
                   InvalidNameException.class.isAssignableFrom(sut));
    }

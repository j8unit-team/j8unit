 ...
 * javax.sound.midi.MidiUnavailableException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MidiUnavailableExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link MidiUnavailableExceptionTests}.
 * </p>
 *
 * @see javax.sound.midi.MidiUnavailableException class javax.sound.midi.MidiUnavailableException (the hereby targeted
 *      class-under-test class)
 * @see MidiUnavailableExceptionTests MidiUnavailableExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.MidiUnavailableException.class!",
                   javax.sound.midi.MidiUnavailableException.class.isAssignableFrom(sut));
    }

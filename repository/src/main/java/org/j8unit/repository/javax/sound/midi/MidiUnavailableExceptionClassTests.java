...
public abstract interface MidiUnavailableExceptionClassTests<SUT extends MidiUnavailableException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiUnavailableException.class!",
                   MidiUnavailableException.class.isAssignableFrom(sut));
    }

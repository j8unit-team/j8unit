 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebServiceRef
...
public abstract interface WebServiceRefClassTests<SUT extends WebServiceRef>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceRef.class!",
                   WebServiceRef.class.isAssignableFrom(sut));
    }

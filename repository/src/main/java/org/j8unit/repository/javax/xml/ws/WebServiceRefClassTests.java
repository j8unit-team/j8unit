 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceRefTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceRefTests}.
 * </p>
 *
 * @see javax.xml.ws.WebServiceRef interface javax.xml.ws.WebServiceRef (the hereby targeted class-under-test class)
 * @see WebServiceRefTests WebServiceRefTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface WebServiceRefClassTests<SUT extends javax.xml.ws.WebServiceRef>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServiceRef.class!",
                   javax.xml.ws.WebServiceRef.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HyperlinkListener
 * public abstract interface javax.swing.event.HyperlinkListener}.
 *
...
public abstract interface HyperlinkListenerClassTests<SUT extends HyperlinkListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HyperlinkListener.class!",
                   HyperlinkListener.class.isAssignableFrom(sut));
    }

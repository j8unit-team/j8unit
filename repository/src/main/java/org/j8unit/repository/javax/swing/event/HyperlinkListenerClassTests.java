 ...
 * javax.swing.event.HyperlinkListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HyperlinkListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HyperlinkListenerTests}.
 * </p>
 *
 * @see javax.swing.event.HyperlinkListener interface javax.swing.event.HyperlinkListener (the hereby targeted
 *      class-under-test class)
 * @see HyperlinkListenerTests HyperlinkListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface HyperlinkListenerClassTests<SUT extends javax.swing.event.HyperlinkListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.HyperlinkListener.class!",
                   javax.swing.event.HyperlinkListener.class.isAssignableFrom(sut));
    }

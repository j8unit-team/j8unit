 ...
 * javax.swing.plaf.metal.OceanTheme}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OceanThemeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OceanThemeTests}.
 * </p>
 *
 * @see javax.swing.plaf.metal.OceanTheme class javax.swing.plaf.metal.OceanTheme (the hereby targeted class-under-test
 *      class)
 * @see OceanThemeTests OceanThemeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends DefaultMetalThemeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.OceanTheme.class!",
                   javax.swing.plaf.metal.OceanTheme.class.isAssignableFrom(sut));
    }

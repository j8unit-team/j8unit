 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OceanTheme public
...
public abstract interface OceanThemeClassTests<SUT extends OceanTheme>
extends org.j8unit.repository.javax.swing.plaf.metal.DefaultMetalThemeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OceanTheme.class!",
                   OceanTheme.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JDesktopPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JDesktopPaneTests}.
 * </p>
 *
 * @see javax.swing.JDesktopPane class javax.swing.JDesktopPane (the hereby targeted class-under-test class)
 * @see JDesktopPaneTests JDesktopPaneTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JLayeredPaneClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JDesktopPane.class!",
                   javax.swing.JDesktopPane.class.isAssignableFrom(sut));
    }

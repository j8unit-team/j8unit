 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JDesktopPane public
...
public abstract interface JDesktopPaneClassTests<SUT extends JDesktopPane>
extends org.j8unit.repository.javax.swing.JLayeredPaneClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JDesktopPane.class!",
                   JDesktopPane.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.ldap.Rdn class javax.naming.ldap.Rdn}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RdnTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RdnTests}.
 * </p>
 *
 * @see javax.naming.ldap.Rdn class javax.naming.ldap.Rdn (the hereby targeted class-under-test class)
 * @see RdnTests RdnTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.Rdn.class!",
                   javax.naming.ldap.Rdn.class.isAssignableFrom(sut));
    }

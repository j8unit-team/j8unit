 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Rdn public class
...
public abstract interface RdnClassTests<SUT extends Rdn>
extends SerializableClassTests<SUT>, ComparableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Rdn.class!", Rdn.class.isAssignableFrom(sut));
    }

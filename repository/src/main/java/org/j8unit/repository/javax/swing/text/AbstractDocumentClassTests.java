...
import org.j8unit.repository.javax.swing.event.DocumentEventClassTests.ElementChangeClassTests;
import org.j8unit.repository.javax.swing.text.AbstractDocumentTests.AbstractElementTests;
import org.j8unit.repository.javax.swing.text.AbstractDocumentTests.AttributeContextTests;
import org.j8unit.repository.javax.swing.text.AbstractDocumentTests.BranchElementTests;
import org.j8unit.repository.javax.swing.text.AbstractDocumentTests.ContentTests;
import org.j8unit.repository.javax.swing.text.AbstractDocumentTests.DefaultDocumentEventTests;
import org.j8unit.repository.javax.swing.text.AbstractDocumentTests.ElementEditTests;
import org.j8unit.repository.javax.swing.text.AbstractDocumentTests.LeafElementTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractDocument
 * public abstract class javax.swing.text.AbstractDocument}.
 *
...
public abstract interface AbstractDocumentClassTests<SUT extends AbstractDocument>
extends DocumentClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractDocument.class!",
                   AbstractDocument.class.isAssignableFrom(sut));
    }
     ...
     * {@link DefaultDocumentEventTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface DefaultDocumentEventClassTests<SUT extends DefaultDocumentEvent>
    extends DocumentEventClassTests<SUT>, CompoundEditClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultDocumentEvent.class!",
                              DefaultDocumentEvent.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link LeafElement public class javax.swing.text.AbstractDocument$LeafElement}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link LeafElementTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface LeafElementClassTests<SUT extends LeafElement>
    extends org.j8unit.repository.javax.swing.text.AbstractDocumentClassTests.AbstractElementClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LeafElement.class!",
                              LeafElement.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link AbstractElement public abstract class javax.swing.text.AbstractDocument$AbstractElement}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractElementTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface AbstractElementClassTests<SUT extends AbstractElement>
    extends ElementClassTests<SUT>, MutableAttributeSetClassTests<SUT>, SerializableClassTests<SUT>, TreeNodeClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractElement.class!",
                              AbstractElement.class.isAssignableFrom(sut));
        }
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link BranchElementTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface BranchElementClassTests<SUT extends BranchElement>
    extends org.j8unit.repository.javax.swing.text.AbstractDocumentClassTests.AbstractElementClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BranchElement.class!",
                              BranchElement.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link Content public abstract static interface javax.swing.text.AbstractDocument$Content}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ContentTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ContentClassTests<SUT extends Content>
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Content.class!",
                              Content.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link ElementEdit public static class javax.swing.text.AbstractDocument$ElementEdit}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ElementEditTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ElementEditClassTests<SUT extends ElementEdit>
    extends ElementChangeClassTests<SUT>, AbstractUndoableEditClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementEdit.class!",
                              ElementEdit.class.isAssignableFrom(sut));
        }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface AttributeContextClassTests<SUT extends AttributeContext>
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeContext.class!",
                              AttributeContext.class.isAssignableFrom(sut));
        }

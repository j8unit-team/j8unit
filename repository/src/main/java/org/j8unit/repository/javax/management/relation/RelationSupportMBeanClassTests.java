 ...
 * {@link RelationSupportMBean public abstract interface javax.management.relation.RelationSupportMBean}.
 *
...
public abstract interface RelationSupportMBeanClassTests<SUT extends RelationSupportMBean>
extends org.j8unit.repository.javax.management.relation.RelationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationSupportMBean.class!",
                   RelationSupportMBean.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.relation.RelationSupportMBean}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RelationSupportMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RelationSupportMBeanTests}
 * .
 * </p>
 *
 * @see javax.management.relation.RelationSupportMBean interface javax.management.relation.RelationSupportMBean (the
 *      hereby targeted class-under-test class)
 * @see RelationSupportMBeanTests RelationSupportMBeanTests (The complementary j8unit test interface containing the
...
public abstract interface RelationSupportMBeanClassTests<SUT extends javax.management.relation.RelationSupportMBean>
extends RelationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationSupportMBean.class!",
                   javax.management.relation.RelationSupportMBean.class.isAssignableFrom(sut));
    }

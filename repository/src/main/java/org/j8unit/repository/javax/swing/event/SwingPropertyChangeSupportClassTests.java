...
import org.j8unit.repository.java.beans.PropertyChangeSupportClassTests;
...
public abstract interface SwingPropertyChangeSupportClassTests<SUT extends SwingPropertyChangeSupport>
extends PropertyChangeSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SwingPropertyChangeSupport.class!",

 ...
 * javax.swing.event.SwingPropertyChangeSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link SwingPropertyChangeSupportTests}).
 * </p>
 *
 * <p>
 ...
 * @see SwingPropertyChangeSupportTests SwingPropertyChangeSupportTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.beans.PropertyChangeSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.SwingPropertyChangeSupport.class!",
                   javax.swing.event.SwingPropertyChangeSupport.class.isAssignableFrom(sut));
    }

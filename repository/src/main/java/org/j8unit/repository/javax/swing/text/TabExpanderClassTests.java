...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.text.TabExpander interface javax.swing.text.TabExpander},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TabExpanderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TabExpanderTests}.
 * </p>
 *
 * @see javax.swing.text.TabExpander interface javax.swing.text.TabExpander (the hereby targeted class-under-test class)
 * @see TabExpanderTests TabExpanderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TabExpanderClassTests<SUT extends javax.swing.text.TabExpander>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.TabExpander.class!",
                   javax.swing.text.TabExpander.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TabExpander public
 * abstract interface javax.swing.text.TabExpander}.
 *
...
public abstract interface TabExpanderClassTests<SUT extends TabExpander>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TabExpander.class!",
                   TabExpander.class.isAssignableFrom(sut));
    }

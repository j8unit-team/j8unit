 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicAttribute
 * public class javax.naming.directory.BasicAttribute}.
 *
...
public abstract interface BasicAttributeClassTests<SUT extends BasicAttribute>
extends AttributeClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.naming.directory.BasicAttribute]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicAttribute.class!",
                   BasicAttribute.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.naming.directory.BasicAttribute]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.naming.directory.BasicAttribute]

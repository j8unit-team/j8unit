 ...
 * javax.print.attribute.standard.JobKOctetsSupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobKOctetsSupportedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobKOctetsSupportedTests}.
 * </p>
 *
 ...
 * @see JobKOctetsSupportedTests JobKOctetsSupportedTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.javax.print.attribute.SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobKOctetsSupported.class!",
                   javax.print.attribute.standard.JobKOctetsSupported.class.isAssignableFrom(sut));
    }

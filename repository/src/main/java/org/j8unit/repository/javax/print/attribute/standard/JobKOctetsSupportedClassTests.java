 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobKOctetsSupported
 * public final class javax.print.attribute.standard.JobKOctetsSupported}.
 *
...
public abstract interface JobKOctetsSupportedClassTests<SUT extends JobKOctetsSupported>
extends SupportedValuesAttributeClassTests<SUT>, SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobKOctetsSupported.class!",

...
import org.j8unit.repository.java.awt.ColorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ColorUIResource
...
public abstract interface ColorUIResourceClassTests<SUT extends ColorUIResource>
extends UIResourceClassTests<SUT>, ColorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorUIResource.class!",
                   ColorUIResource.class.isAssignableFrom(sut));
    }

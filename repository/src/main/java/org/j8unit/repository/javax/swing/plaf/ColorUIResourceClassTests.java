 ...
 * javax.swing.plaf.ColorUIResource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ColorUIResourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ColorUIResourceTests}.
 * </p>
 *
 * @see javax.swing.plaf.ColorUIResource class javax.swing.plaf.ColorUIResource (the hereby targeted class-under-test
 *      class)
 * @see ColorUIResourceTests ColorUIResourceTests (The complementary j8unit test interface containing the instance
...
extends UIResourceClassTests<SUT>, org.j8unit.repository.java.awt.ColorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ColorUIResource.class!",
                   javax.swing.plaf.ColorUIResource.class.isAssignableFrom(sut));
    }

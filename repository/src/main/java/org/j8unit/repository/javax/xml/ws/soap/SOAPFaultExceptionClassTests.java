 ...
 * javax.xml.ws.soap.SOAPFaultException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPFaultExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPFaultExceptionTests}.
 * </p>
 *
 * @see javax.xml.ws.soap.SOAPFaultException class javax.xml.ws.soap.SOAPFaultException (the hereby targeted
 *      class-under-test class)
 * @see SOAPFaultExceptionTests SOAPFaultExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPFaultExceptionClassTests<SUT extends javax.xml.ws.soap.SOAPFaultException>
extends org.j8unit.repository.javax.xml.ws.ProtocolExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.soap.SOAPFaultException.class!",
                   javax.xml.ws.soap.SOAPFaultException.class.isAssignableFrom(sut));
    }

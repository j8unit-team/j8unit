...
import org.j8unit.repository.javax.xml.ws.ProtocolExceptionClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPFaultException
 * public class javax.xml.ws.soap.SOAPFaultException}.
 *
...
public abstract interface SOAPFaultExceptionClassTests<SUT extends SOAPFaultException>
extends ProtocolExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPFaultException.class!",
                   SOAPFaultException.class.isAssignableFrom(sut));
    }

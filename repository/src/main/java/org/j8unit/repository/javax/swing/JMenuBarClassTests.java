...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JMenuBar class javax.swing.JMenuBar}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMenuBarTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMenuBarTests}.
 * </p>
 *
 * @see javax.swing.JMenuBar class javax.swing.JMenuBar (the hereby targeted class-under-test class)
 * @see JMenuBarTests JMenuBarTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JMenuBarClassTests<SUT extends javax.swing.JMenuBar>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, MenuElementClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JMenuBar.class!",
                   javax.swing.JMenuBar.class.isAssignableFrom(sut));
    }

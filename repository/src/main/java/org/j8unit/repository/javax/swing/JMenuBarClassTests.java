 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMenuBar public
...
public abstract interface JMenuBarClassTests<SUT extends JMenuBar>
extends AccessibleClassTests<SUT>, MenuElementClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMenuBar.class!",

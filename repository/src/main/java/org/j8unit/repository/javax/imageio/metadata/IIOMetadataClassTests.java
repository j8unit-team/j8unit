 ...
 * javax.imageio.metadata.IIOMetadata}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOMetadataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IIOMetadataTests}.
 * </p>
 *
 * @see javax.imageio.metadata.IIOMetadata class javax.imageio.metadata.IIOMetadata (the hereby targeted
 *      class-under-test class)
 * @see IIOMetadataTests IIOMetadataTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IIOMetadataClassTests<SUT extends javax.imageio.metadata.IIOMetadata>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.metadata.IIOMetadata.class!",
                   javax.imageio.metadata.IIOMetadata.class.isAssignableFrom(sut));
    }

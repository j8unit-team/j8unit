 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IIOMetadata public
 * abstract class javax.imageio.metadata.IIOMetadata}.
 *
...
public abstract interface IIOMetadataClassTests<SUT extends IIOMetadata>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOMetadata.class!",
                   IIOMetadata.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.TransformerConfigurationException class
 * javax.xml.transform.TransformerConfigurationException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * </p>
 *
 * @see javax.xml.transform.TransformerConfigurationException class
 *      javax.xml.transform.TransformerConfigurationException (the hereby targeted class-under-test class)
 * @see TransformerConfigurationExceptionTests TransformerConfigurationExceptionTests (The complementary j8unit test
...
public abstract interface TransformerConfigurationExceptionClassTests<SUT extends javax.xml.transform.TransformerConfigurationException>
extends TransformerExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.TransformerConfigurationException.class!",
                   javax.xml.transform.TransformerConfigurationException.class.isAssignableFrom(sut));
    }

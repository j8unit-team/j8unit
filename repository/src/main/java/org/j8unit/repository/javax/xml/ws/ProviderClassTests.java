...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.Provider.class!",
                   javax.xml.ws.Provider.class.isAssignableFrom(sut));
    }

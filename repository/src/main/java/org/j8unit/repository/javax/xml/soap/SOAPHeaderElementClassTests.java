 ...
 * javax.xml.soap.SOAPHeaderElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPHeaderElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPHeaderElementTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPHeaderElement interface javax.xml.soap.SOAPHeaderElement (the hereby targeted
 *      class-under-test class)
 * @see SOAPHeaderElementTests SOAPHeaderElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPHeaderElementClassTests<SUT extends javax.xml.soap.SOAPHeaderElement>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPHeaderElement.class!",
                   javax.xml.soap.SOAPHeaderElement.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPHeaderElement
 * public abstract interface javax.xml.soap.SOAPHeaderElement}.
 *
...
public abstract interface SOAPHeaderElementClassTests<SUT extends SOAPHeaderElement>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPHeaderElement.class!",
                   SOAPHeaderElement.class.isAssignableFrom(sut));
    }

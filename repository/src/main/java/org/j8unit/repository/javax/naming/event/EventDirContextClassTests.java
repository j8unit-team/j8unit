 ...
 * javax.naming.event.EventDirContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventDirContextTests}).
 * </p>
 *
 * <p>
 ...
 * @see EventDirContextTests EventDirContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface EventDirContextClassTests<SUT extends javax.naming.event.EventDirContext>
extends EventContextClassTests<SUT>, org.j8unit.repository.javax.naming.directory.DirContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.event.EventDirContext.class!",
                   javax.naming.event.EventDirContext.class.isAssignableFrom(sut));
    }

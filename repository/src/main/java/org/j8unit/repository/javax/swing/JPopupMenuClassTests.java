 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JPopupMenuTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.JPopupMenu class javax.swing.JPopupMenu (the hereby targeted class-under-test class)
 * @see JPopupMenuTests JPopupMenuTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, MenuElementClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JPopupMenu.class!",
                   javax.swing.JPopupMenu.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JPopupMenu.Separator class
     * javax.swing.JPopupMenu$Separator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link JPopupMenuTests.SeparatorTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.JPopupMenu.Separator class javax.swing.JPopupMenu$Separator (the hereby targeted
     *      class-under-test class)
     * @see JPopupMenuTests.SeparatorTests JPopupMenuTests.SeparatorTests (The complementary j8unit test interface
    ...
    extends JSeparatorClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JPopupMenu.Separator.class!",
                       javax.swing.JPopupMenu.Separator.class.isAssignableFrom(sut));
        }

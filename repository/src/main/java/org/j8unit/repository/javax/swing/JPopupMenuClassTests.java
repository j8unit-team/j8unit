 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JPopupMenu public
...
extends AccessibleClassTests<SUT>, MenuElementClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JPopupMenu.class!",
     ...
     * {@link Separator public static class javax.swing.JPopupMenu$Separator}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

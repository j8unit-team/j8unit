 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CaretListener
 * public abstract interface javax.swing.event.CaretListener}.
 *
...
public abstract interface CaretListenerClassTests<SUT extends CaretListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CaretListener.class!",
                   CaretListener.class.isAssignableFrom(sut));
    }

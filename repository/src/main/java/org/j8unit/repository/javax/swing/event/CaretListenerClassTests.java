...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.CaretListener interface
 * javax.swing.event.CaretListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CaretListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CaretListenerTests}.
 * </p>
 *
 * @see javax.swing.event.CaretListener interface javax.swing.event.CaretListener (the hereby targeted class-under-test
 *      class)
 * @see CaretListenerTests CaretListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CaretListenerClassTests<SUT extends javax.swing.event.CaretListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.CaretListener.class!",
                   javax.swing.event.CaretListener.class.isAssignableFrom(sut));
    }

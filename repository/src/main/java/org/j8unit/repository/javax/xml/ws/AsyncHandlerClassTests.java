 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AsyncHandler public
 * abstract interface javax.xml.ws.AsyncHandler<T>}.
 *
...
public abstract interface AsyncHandlerClassTests<SUT extends AsyncHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsyncHandler.class!",
                   AsyncHandler.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AsyncHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AsyncHandlerTests}.
 * </p>
 *
 * @see javax.xml.ws.AsyncHandler interface javax.xml.ws.AsyncHandler (the hereby targeted class-under-test class)
 * @see AsyncHandlerTests AsyncHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AsyncHandlerClassTests<SUT extends javax.xml.ws.AsyncHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.AsyncHandler.class!",
                   javax.xml.ws.AsyncHandler.class.isAssignableFrom(sut));
    }

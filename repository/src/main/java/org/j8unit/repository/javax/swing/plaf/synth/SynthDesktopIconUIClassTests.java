 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthDesktopIconUI
 * public class javax.swing.plaf.synth.SynthDesktopIconUI}.
 *
...
public abstract interface SynthDesktopIconUIClassTests<SUT extends SynthDesktopIconUI>
extends SynthUIClassTests<SUT>, PropertyChangeListenerClassTests<SUT>, BasicDesktopIconUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthDesktopIconUI.class!",
                   SynthDesktopIconUI.class.isAssignableFrom(sut));
    }

...
public abstract interface FormatConversionProviderClassTests<SUT extends FormatConversionProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormatConversionProvider.class!",
                   FormatConversionProvider.class.isAssignableFrom(sut));
    }

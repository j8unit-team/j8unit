 ...
 * javax.sound.sampled.spi.FormatConversionProvider}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormatConversionProviderTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link FormatConversionProviderTests}.
 * </p>
 *
 * @see javax.sound.sampled.spi.FormatConversionProvider class javax.sound.sampled.spi.FormatConversionProvider (the
 *      hereby targeted class-under-test class)
 * @see FormatConversionProviderTests FormatConversionProviderTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.spi.FormatConversionProvider.class!",
                   javax.sound.sampled.spi.FormatConversionProvider.class.isAssignableFrom(sut));
    }

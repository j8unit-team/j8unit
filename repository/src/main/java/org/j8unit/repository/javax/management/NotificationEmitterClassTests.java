 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotificationEmitter
 * public abstract interface javax.management.NotificationEmitter}.
 *
...
public abstract interface NotificationEmitterClassTests<SUT extends NotificationEmitter>
extends NotificationBroadcasterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotificationEmitter.class!",
                   NotificationEmitter.class.isAssignableFrom(sut));
    }

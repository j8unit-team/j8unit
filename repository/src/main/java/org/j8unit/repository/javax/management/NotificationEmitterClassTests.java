 ...
 * javax.management.NotificationEmitter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotificationEmitterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotificationEmitterTests}.
 * </p>
 *
 * @see javax.management.NotificationEmitter interface javax.management.NotificationEmitter (the hereby targeted
 *      class-under-test class)
 * @see NotificationEmitterTests NotificationEmitterTests (The complementary j8unit test interface containing the
...
public abstract interface NotificationEmitterClassTests<SUT extends javax.management.NotificationEmitter>
extends NotificationBroadcasterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.NotificationEmitter.class!",
                   javax.management.NotificationEmitter.class.isAssignableFrom(sut));
    }

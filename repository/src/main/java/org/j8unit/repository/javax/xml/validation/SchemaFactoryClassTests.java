 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SchemaFactory
...
public abstract interface SchemaFactoryClassTests<SUT extends SchemaFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SchemaFactory.class!",
                   SchemaFactory.class.isAssignableFrom(sut));
    }

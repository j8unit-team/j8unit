...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_Reference_String_RefAddr_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public default void create_Reference_String_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    throws Exception {
        // create new instance
        final Class<? extends javax.naming.Reference> sut = createNewSUT();

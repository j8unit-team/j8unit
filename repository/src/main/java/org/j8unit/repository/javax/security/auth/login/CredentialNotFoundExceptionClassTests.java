...
public abstract interface CredentialNotFoundExceptionClassTests<SUT extends CredentialNotFoundException>
extends org.j8unit.repository.javax.security.auth.login.CredentialExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CredentialNotFoundException.class!",
                   CredentialNotFoundException.class.isAssignableFrom(sut));
    }

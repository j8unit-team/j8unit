 ...
 * javax.security.auth.login.CredentialNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CredentialNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see CredentialNotFoundExceptionTests CredentialNotFoundExceptionTests (The complementary j8unit test interface
...
extends CredentialExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.CredentialNotFoundException.class!",
                   javax.security.auth.login.CredentialNotFoundException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Holder public final
 * class javax.xml.ws.Holder<T>}.
 *
...
public abstract interface HolderClassTests<SUT extends Holder>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Holder.class!",
                   Holder.class.isAssignableFrom(sut));
    }

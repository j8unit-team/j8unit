 ...
 * javax.management.relation.RelationServiceMBean}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RelationServiceMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RelationServiceMBeanTests}
 * .
 * </p>
 *
 * @see javax.management.relation.RelationServiceMBean interface javax.management.relation.RelationServiceMBean (the
 *      hereby targeted class-under-test class)
 * @see RelationServiceMBeanTests RelationServiceMBeanTests (The complementary j8unit test interface containing the
...
public abstract interface RelationServiceMBeanClassTests<SUT extends javax.management.relation.RelationServiceMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationServiceMBean.class!",
                   javax.management.relation.RelationServiceMBean.class.isAssignableFrom(sut));
    }

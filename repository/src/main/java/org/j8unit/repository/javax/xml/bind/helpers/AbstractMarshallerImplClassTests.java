 ...
 * javax.xml.bind.helpers.AbstractMarshallerImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractMarshallerImplTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.bind.helpers.AbstractMarshallerImpl class javax.xml.bind.helpers.AbstractMarshallerImpl (the hereby
 *      targeted class-under-test class)
 * @see AbstractMarshallerImplTests AbstractMarshallerImplTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.xml.bind.MarshallerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.helpers.AbstractMarshallerImpl.class!",
                   javax.xml.bind.helpers.AbstractMarshallerImpl.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.soap.Addressing interface javax.xml.ws.soap.Addressing},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AddressingTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AddressingTests}.
 * </p>
 *
 * @see javax.xml.ws.soap.Addressing interface javax.xml.ws.soap.Addressing (the hereby targeted class-under-test class)
 * @see AddressingTests AddressingTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AddressingClassTests<SUT extends javax.xml.ws.soap.Addressing>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.soap.Addressing.class!",
                   javax.xml.ws.soap.Addressing.class.isAssignableFrom(sut));
    }

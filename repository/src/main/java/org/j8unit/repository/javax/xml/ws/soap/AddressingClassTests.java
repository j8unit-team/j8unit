 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Addressing public
 * abstract @interface javax.xml.ws.soap.Addressing}.
 *
...
public abstract interface AddressingClassTests<SUT extends Addressing>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Addressing.class!",
                   Addressing.class.isAssignableFrom(sut));
    }

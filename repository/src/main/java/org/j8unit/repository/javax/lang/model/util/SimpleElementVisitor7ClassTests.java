 ...
 * {@link SimpleElementVisitor7 public class javax.lang.model.util.SimpleElementVisitor7<R,P>}.
 *
...
public abstract interface SimpleElementVisitor7ClassTests<SUT extends SimpleElementVisitor7>
extends org.j8unit.repository.javax.lang.model.util.SimpleElementVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleElementVisitor7.class!",
                   SimpleElementVisitor7.class.isAssignableFrom(sut));
    }

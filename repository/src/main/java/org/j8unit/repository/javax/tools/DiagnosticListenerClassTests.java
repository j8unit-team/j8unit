 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DiagnosticListener
 * public abstract interface javax.tools.DiagnosticListener<S>}.
 *
...
public abstract interface DiagnosticListenerClassTests<SUT extends DiagnosticListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DiagnosticListener.class!",
                   DiagnosticListener.class.isAssignableFrom(sut));
    }

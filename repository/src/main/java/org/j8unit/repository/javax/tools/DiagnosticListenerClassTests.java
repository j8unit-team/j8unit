...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.tools.DiagnosticListener interface
 * javax.tools.DiagnosticListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DiagnosticListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DiagnosticListenerTests}.
 * </p>
 *
 * @see javax.tools.DiagnosticListener interface javax.tools.DiagnosticListener (the hereby targeted class-under-test
 *      class)
 * @see DiagnosticListenerTests DiagnosticListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DiagnosticListenerClassTests<SUT extends javax.tools.DiagnosticListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.DiagnosticListener.class!",
                   javax.tools.DiagnosticListener.class.isAssignableFrom(sut));
    }

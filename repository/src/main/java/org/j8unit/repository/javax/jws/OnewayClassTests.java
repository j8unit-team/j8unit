 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Oneway public
...
public abstract interface OnewayClassTests<SUT extends Oneway>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Oneway.class!",
                   Oneway.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.jws.Oneway interface javax.jws.Oneway}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OnewayTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OnewayTests}.
 * </p>
 *
 * @see javax.jws.Oneway interface javax.jws.Oneway (the hereby targeted class-under-test class)
 * @see OnewayTests OnewayTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.Oneway.class!",
                   javax.jws.Oneway.class.isAssignableFrom(sut));
    }

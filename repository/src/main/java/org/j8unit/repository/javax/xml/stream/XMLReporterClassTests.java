 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLReporter public
 * abstract interface javax.xml.stream.XMLReporter}.
 *
...
public abstract interface XMLReporterClassTests<SUT extends XMLReporter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLReporter.class!",
                   XMLReporter.class.isAssignableFrom(sut));
    }

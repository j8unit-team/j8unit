 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLReporterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLReporterTests}.
 * </p>
 *
 * @see javax.xml.stream.XMLReporter interface javax.xml.stream.XMLReporter (the hereby targeted class-under-test class)
 * @see XMLReporterTests XMLReporterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XMLReporterClassTests<SUT extends javax.xml.stream.XMLReporter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.XMLReporter.class!",
                   javax.xml.stream.XMLReporter.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.Result interface javax.xml.transform.Result},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResultTests}).
 * </p>
 *
 * <p>
 ...
 * @see ResultTests ResultTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ResultClassTests<SUT extends javax.xml.transform.Result>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.Result.class!",
                   javax.xml.transform.Result.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvokerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvokerTests}.
 * </p>
 *
 * @see javax.xml.ws.spi.Invoker class javax.xml.ws.spi.Invoker (the hereby targeted class-under-test class)
 * @see InvokerTests InvokerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InvokerClassTests<SUT extends javax.xml.ws.spi.Invoker>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.spi.Invoker.class!",
                   javax.xml.ws.spi.Invoker.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Invoker public
...
public abstract interface InvokerClassTests<SUT extends Invoker>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Invoker.class!",
                   Invoker.class.isAssignableFrom(sut));
    }

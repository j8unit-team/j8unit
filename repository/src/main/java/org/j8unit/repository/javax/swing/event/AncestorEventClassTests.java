...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.AncestorEvent class javax.swing.event.AncestorEvent}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AncestorEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AncestorEventTests}.
 * </p>
 *
 * @see javax.swing.event.AncestorEvent class javax.swing.event.AncestorEvent (the hereby targeted class-under-test
 *      class)
 * @see AncestorEventTests AncestorEventTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.AncestorEvent.class!",
                   javax.swing.event.AncestorEvent.class.isAssignableFrom(sut));
    }

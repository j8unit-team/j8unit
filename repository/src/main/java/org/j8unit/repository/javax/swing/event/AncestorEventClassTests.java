 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AncestorEvent
...
public abstract interface AncestorEventClassTests<SUT extends AncestorEvent>
extends AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AncestorEvent.class!",
                   AncestorEvent.class.isAssignableFrom(sut));
    }

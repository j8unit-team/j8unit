 ...
 * javax.imageio.plugins.bmp.BMPImageWriteParam}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BMPImageWriteParamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BMPImageWriteParamTests}.
 * </p>
 *
 * @see javax.imageio.plugins.bmp.BMPImageWriteParam class javax.imageio.plugins.bmp.BMPImageWriteParam (the hereby
 *      targeted class-under-test class)
 * @see BMPImageWriteParamTests BMPImageWriteParamTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.imageio.ImageWriteParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.plugins.bmp.BMPImageWriteParam.class!",
                   javax.imageio.plugins.bmp.BMPImageWriteParam.class.isAssignableFrom(sut));
    }

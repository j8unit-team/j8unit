 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BMPImageWriteParam
 * public class javax.imageio.plugins.bmp.BMPImageWriteParam}.
 *
...
public abstract interface BMPImageWriteParamClassTests<SUT extends BMPImageWriteParam>
extends ImageWriteParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BMPImageWriteParam.class!",

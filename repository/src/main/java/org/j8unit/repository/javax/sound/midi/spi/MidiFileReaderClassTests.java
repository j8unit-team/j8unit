 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiFileReader
...
public abstract interface MidiFileReaderClassTests<SUT extends MidiFileReader>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiFileReader.class!",
                   MidiFileReader.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.sound.midi.spi.MidiFileReader]

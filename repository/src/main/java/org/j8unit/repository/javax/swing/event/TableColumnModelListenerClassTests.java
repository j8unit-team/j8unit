 ...
 * {@link TableColumnModelListener public abstract interface javax.swing.event.TableColumnModelListener}.
 *
 ...
 * {@link org.j8unit.repository.javax.swing.event.TableColumnModelListenerTests}.
 * </p>
 *
 * <p>
...
public abstract interface TableColumnModelListenerClassTests<SUT extends TableColumnModelListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableColumnModelListener.class!",
                   TableColumnModelListener.class.isAssignableFrom(sut));
    }

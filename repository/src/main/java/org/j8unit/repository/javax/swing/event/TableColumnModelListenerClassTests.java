...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.TableColumnModelListener interface
 * javax.swing.event.TableColumnModelListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableColumnModelListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link TableColumnModelListenerTests}.
 * </p>
 *
 * @see javax.swing.event.TableColumnModelListener interface javax.swing.event.TableColumnModelListener (the hereby
 *      targeted class-under-test class)
 * @see TableColumnModelListenerTests TableColumnModelListenerTests (The complementary j8unit test interface containing
...
public abstract interface TableColumnModelListenerClassTests<SUT extends javax.swing.event.TableColumnModelListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TableColumnModelListener.class!",
                   javax.swing.event.TableColumnModelListener.class.isAssignableFrom(sut));
    }

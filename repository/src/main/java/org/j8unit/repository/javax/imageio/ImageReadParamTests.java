 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageReadParam
 * public class javax.imageio.ImageReadParam}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.imageio.ImageReadParamClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface ImageReadParamTests<SUT extends ImageReadParam>
extends IIOParamTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getSourceMaxProgressivePass()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getSourceNumProgressivePasses()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[javax.imageio.ImageReadParam]

    // J8UNIT-MARKER-[END]-[INSTANCE]-[javax.imageio.ImageReadParam]

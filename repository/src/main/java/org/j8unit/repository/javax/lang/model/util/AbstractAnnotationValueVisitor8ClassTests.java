...
public abstract interface AbstractAnnotationValueVisitor8ClassTests<SUT extends AbstractAnnotationValueVisitor8>
extends org.j8unit.repository.javax.lang.model.util.AbstractAnnotationValueVisitor7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractAnnotationValueVisitor8.class!",
                   AbstractAnnotationValueVisitor8.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.XMLEventReader interface
 * javax.xml.stream.XMLEventReader}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLEventReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLEventReaderTests}.
 * </p>
 *
 * @see javax.xml.stream.XMLEventReader interface javax.xml.stream.XMLEventReader (the hereby targeted class-under-test
 *      class)
 * @see XMLEventReaderTests XMLEventReaderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.IteratorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.XMLEventReader.class!",
                   javax.xml.stream.XMLEventReader.class.isAssignableFrom(sut));
    }

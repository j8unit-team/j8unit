...
import org.j8unit.repository.java.util.IteratorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLEventReader
 * public abstract interface javax.xml.stream.XMLEventReader}.
 *
...
public abstract interface XMLEventReaderClassTests<SUT extends XMLEventReader>
extends IteratorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLEventReader.class!",
                   XMLEventReader.class.isAssignableFrom(sut));
    }

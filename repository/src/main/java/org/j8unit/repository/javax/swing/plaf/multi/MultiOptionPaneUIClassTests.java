 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiOptionPaneUI
 * public class javax.swing.plaf.multi.MultiOptionPaneUI}.
 *
...
public abstract interface MultiOptionPaneUIClassTests<SUT extends MultiOptionPaneUI>
extends OptionPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiOptionPaneUI.class!",
                   MultiOptionPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JInternalFrameTests}).
 * </p>
 *
 * <p>
 ...
 * @see JInternalFrameTests JInternalFrameTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, WindowConstantsClassTests<SUT>, RootPaneContainerClassTests<SUT>,
JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JInternalFrame.class!",
                   javax.swing.JInternalFrame.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JInternalFrame.JDesktopIcon class
     * javax.swing.JInternalFrame$JDesktopIcon}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link JInternalFrameTests.JDesktopIconTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see JInternalFrameTests.JDesktopIconTests JInternalFrameTests.JDesktopIconTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JInternalFrame.JDesktopIcon.class!",
                       javax.swing.JInternalFrame.JDesktopIcon.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JInternalFrame
...
extends AccessibleClassTests<SUT>, WindowConstantsClassTests<SUT>, RootPaneContainerClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JInternalFrame.class!",

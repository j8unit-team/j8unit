 ...
 * {@link WebServicePermissionTests}.
 * </p>
 *
 * <p>
...
public abstract interface WebServicePermissionClassTests<SUT extends WebServicePermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServicePermission.class!",
                   WebServicePermission.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.ws.WebServicePermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServicePermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServicePermissionTests}
 * .
 * </p>
 *
 * @see javax.xml.ws.WebServicePermission class javax.xml.ws.WebServicePermission (the hereby targeted class-under-test
 *      class)
 * @see WebServicePermissionTests WebServicePermissionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServicePermission.class!",
                   javax.xml.ws.WebServicePermission.class.isAssignableFrom(sut));
    }

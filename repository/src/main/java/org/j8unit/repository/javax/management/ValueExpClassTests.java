 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueExpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValueExpTests}.
 * </p>
 *
 * @see javax.management.ValueExp interface javax.management.ValueExp (the hereby targeted class-under-test class)
 * @see ValueExpTests ValueExpTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ValueExpClassTests<SUT extends javax.management.ValueExp>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.ValueExp.class!",
                   javax.management.ValueExp.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueExp public
 * abstract interface javax.management.ValueExp}.
 *
...
public abstract interface ValueExpClassTests<SUT extends ValueExp>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueExp.class!",

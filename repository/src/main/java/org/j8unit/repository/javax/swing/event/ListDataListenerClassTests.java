 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListDataListener
 * public abstract interface javax.swing.event.ListDataListener}.
 *
...
public abstract interface ListDataListenerClassTests<SUT extends ListDataListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListDataListener.class!",
                   ListDataListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.event.ListDataListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListDataListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListDataListenerTests}.
 * </p>
 *
 * @see javax.swing.event.ListDataListener interface javax.swing.event.ListDataListener (the hereby targeted
 *      class-under-test class)
 * @see ListDataListenerTests ListDataListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ListDataListenerClassTests<SUT extends javax.swing.event.ListDataListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.ListDataListener.class!",
                   javax.swing.event.ListDataListener.class.isAssignableFrom(sut));
    }

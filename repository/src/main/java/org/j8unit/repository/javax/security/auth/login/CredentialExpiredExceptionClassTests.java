 ...
 * javax.security.auth.login.CredentialExpiredException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CredentialExpiredExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see CredentialExpiredExceptionTests CredentialExpiredExceptionTests (The complementary j8unit test interface
...
extends CredentialExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.CredentialExpiredException.class!",
                   javax.security.auth.login.CredentialExpiredException.class.isAssignableFrom(sut));
    }

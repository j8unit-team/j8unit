 ...
 * {@link CredentialExpiredException public class javax.security.auth.login.CredentialExpiredException}.
 *
...
public abstract interface CredentialExpiredExceptionClassTests<SUT extends CredentialExpiredException>
extends org.j8unit.repository.javax.security.auth.login.CredentialExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CredentialExpiredException.class!",
                   CredentialExpiredException.class.isAssignableFrom(sut));
    }

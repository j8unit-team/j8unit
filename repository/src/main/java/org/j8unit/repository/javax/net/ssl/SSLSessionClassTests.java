 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLSession public
 * abstract interface javax.net.ssl.SSLSession}.
 *
...
public abstract interface SSLSessionClassTests<SUT extends SSLSession>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLSession.class!",
                   SSLSession.class.isAssignableFrom(sut));
    }

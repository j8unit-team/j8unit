 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLSessionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLSessionTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLSession interface javax.net.ssl.SSLSession (the hereby targeted class-under-test class)
 * @see SSLSessionTests SSLSessionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SSLSessionClassTests<SUT extends javax.net.ssl.SSLSession>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLSession.class!",
                   javax.net.ssl.SSLSession.class.isAssignableFrom(sut));
    }

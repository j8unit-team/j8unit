 ...
 * javax.print.attribute.standard.NumberOfDocuments}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NumberOfDocumentsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NumberOfDocumentsTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.NumberOfDocuments class javax.print.attribute.standard.NumberOfDocuments (the
 *      hereby targeted class-under-test class)
 * @see NumberOfDocumentsTests NumberOfDocumentsTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.NumberOfDocuments.class!",
                   javax.print.attribute.standard.NumberOfDocuments.class.isAssignableFrom(sut));
    }

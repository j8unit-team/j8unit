 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NumberOfDocuments
 * public final class javax.print.attribute.standard.NumberOfDocuments}.
 *
...
public abstract interface NumberOfDocumentsClassTests<SUT extends NumberOfDocuments>
extends PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NumberOfDocuments.class!",
                   NumberOfDocuments.class.isAssignableFrom(sut));
    }

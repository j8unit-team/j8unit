 ...
 * {@link SOAPConnectionFactory public abstract class javax.xml.soap.SOAPConnectionFactory}.
 *
...
public abstract interface SOAPConnectionFactoryClassTests<SUT extends SOAPConnectionFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPConnectionFactory.class!",
                   SOAPConnectionFactory.class.isAssignableFrom(sut));
    }

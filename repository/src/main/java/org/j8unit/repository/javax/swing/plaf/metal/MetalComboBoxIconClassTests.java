 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalComboBoxIcon
 * public class javax.swing.plaf.metal.MetalComboBoxIcon}.
 *
...
public abstract interface MetalComboBoxIconClassTests<SUT extends MetalComboBoxIcon>
extends IconClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalComboBoxIcon]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalComboBoxIcon.class!",

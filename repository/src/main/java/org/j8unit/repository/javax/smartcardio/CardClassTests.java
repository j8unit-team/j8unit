 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Card public
...
public abstract interface CardClassTests<SUT extends Card>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Card.class!", Card.class.isAssignableFrom(sut));
    }

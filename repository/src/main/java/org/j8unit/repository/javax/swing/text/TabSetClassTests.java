 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TabSet public class
...
public abstract interface TabSetClassTests<SUT extends TabSet>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TabSet.class!",
                   TabSet.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.text.TabSet]

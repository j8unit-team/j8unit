...
import org.j8unit.repository.java.sql.SQLExceptionClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetWarning
 * public class javax.sql.rowset.RowSetWarning}.
 *
...
public abstract interface RowSetWarningClassTests<SUT extends RowSetWarning>
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetWarning.class!",
                   RowSetWarning.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetWarningTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetWarningTests}.
 * </p>
 *
 * @see javax.sql.rowset.RowSetWarning class javax.sql.rowset.RowSetWarning (the hereby targeted class-under-test class)
 * @see RowSetWarningTests RowSetWarningTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.sql.SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.RowSetWarning.class!",
                   javax.sql.rowset.RowSetWarning.class.isAssignableFrom(sut));
    }

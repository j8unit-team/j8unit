 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXBException
 * public class javax.xml.bind.JAXBException}.
 *
...
public abstract interface JAXBExceptionClassTests<SUT extends JAXBException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXBException.class!",
                   JAXBException.class.isAssignableFrom(sut));
    }

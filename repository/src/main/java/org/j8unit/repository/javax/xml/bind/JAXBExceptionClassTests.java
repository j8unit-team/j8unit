 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JAXBExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JAXBExceptionTests}.
 * </p>
 *
 * @see javax.xml.bind.JAXBException class javax.xml.bind.JAXBException (the hereby targeted class-under-test class)
 * @see JAXBExceptionTests JAXBExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.JAXBException.class!",
                   javax.xml.bind.JAXBException.class.isAssignableFrom(sut));
    }

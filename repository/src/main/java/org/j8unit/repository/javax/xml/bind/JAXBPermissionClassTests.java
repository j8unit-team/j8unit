 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JAXBPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JAXBPermissionTests}.
 * </p>
 *
 * @see javax.xml.bind.JAXBPermission class javax.xml.bind.JAXBPermission (the hereby targeted class-under-test class)
 * @see JAXBPermissionTests JAXBPermissionTests (The complementary j8unit test interface containing the instance
...
public abstract interface JAXBPermissionClassTests<SUT extends javax.xml.bind.JAXBPermission>
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.JAXBPermission.class!",
                   javax.xml.bind.JAXBPermission.class.isAssignableFrom(sut));
    }

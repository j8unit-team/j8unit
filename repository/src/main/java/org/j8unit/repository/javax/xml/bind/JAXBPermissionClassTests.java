 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXBPermission
...
public abstract interface JAXBPermissionClassTests<SUT extends JAXBPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXBPermission.class!",
                   JAXBPermission.class.isAssignableFrom(sut));
    }

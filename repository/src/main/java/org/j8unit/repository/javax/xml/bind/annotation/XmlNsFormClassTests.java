 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlNsForm public
 * final enum javax.xml.bind.annotation.XmlNsForm}.
 *
...
public abstract interface XmlNsFormClassTests<SUT extends XmlNsForm>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlNsForm.class!",
                   XmlNsForm.class.isAssignableFrom(sut));
    }

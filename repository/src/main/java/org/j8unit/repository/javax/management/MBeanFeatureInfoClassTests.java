 ...
 * javax.management.MBeanFeatureInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanFeatureInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanFeatureInfoTests}.
 * </p>
 *
 * @see javax.management.MBeanFeatureInfo class javax.management.MBeanFeatureInfo (the hereby targeted class-under-test
 *      class)
 * @see MBeanFeatureInfoTests MBeanFeatureInfoTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, DescriptorReadClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanFeatureInfo.class!",
                   javax.management.MBeanFeatureInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IIOServiceProvider
 * public abstract class javax.imageio.spi.IIOServiceProvider}.
 *
...
public abstract interface IIOServiceProviderClassTests<SUT extends IIOServiceProvider>
extends RegisterableServiceClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOServiceProvider.class!",
                   IIOServiceProvider.class.isAssignableFrom(sut));
    }

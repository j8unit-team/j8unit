 ...
 * javax.imageio.spi.IIOServiceProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOServiceProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IIOServiceProviderTests}.
 * </p>
 *
 * @see javax.imageio.spi.IIOServiceProvider class javax.imageio.spi.IIOServiceProvider (the hereby targeted
 *      class-under-test class)
 * @see IIOServiceProviderTests IIOServiceProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface IIOServiceProviderClassTests<SUT extends javax.imageio.spi.IIOServiceProvider>
extends RegisterableServiceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.IIOServiceProvider.class!",
                   javax.imageio.spi.IIOServiceProvider.class.isAssignableFrom(sut));
    }

...
public abstract interface PrinterMoreInfoManufacturerClassTests<SUT extends PrinterMoreInfoManufacturer>
extends PrintServiceAttributeClassTests<SUT>, URISyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterMoreInfoManufacturer.class!",
                   PrinterMoreInfoManufacturer.class.isAssignableFrom(sut));
    }

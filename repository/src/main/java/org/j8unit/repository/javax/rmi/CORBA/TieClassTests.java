 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Tie public abstract
...
public abstract interface TieClassTests<SUT extends Tie>
extends InvokeHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Tie.class!", Tie.class.isAssignableFrom(sut));
    }

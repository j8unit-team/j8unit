...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.rmi.CORBA.Tie interface javax.rmi.CORBA.Tie}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TieTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TieTests}.
 * </p>
 *
 * @see javax.rmi.CORBA.Tie interface javax.rmi.CORBA.Tie (the hereby targeted class-under-test class)
 * @see TieTests TieTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface TieClassTests<SUT extends javax.rmi.CORBA.Tie>
extends org.j8unit.repository.org.omg.CORBA.portable.InvokeHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.CORBA.Tie.class!",
                   javax.rmi.CORBA.Tie.class.isAssignableFrom(sut));
    }

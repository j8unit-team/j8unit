 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SNIMatcher public
 * abstract class javax.net.ssl.SNIMatcher}.
 *
...
public abstract interface SNIMatcherClassTests<SUT extends SNIMatcher>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SNIMatcher.class!",
                   SNIMatcher.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SNIMatcherTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SNIMatcherTests}.
 * </p>
 *
 * @see javax.net.ssl.SNIMatcher class javax.net.ssl.SNIMatcher (the hereby targeted class-under-test class)
 * @see SNIMatcherTests SNIMatcherTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SNIMatcherClassTests<SUT extends javax.net.ssl.SNIMatcher>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SNIMatcher.class!",
                   javax.net.ssl.SNIMatcher.class.isAssignableFrom(sut));
    }

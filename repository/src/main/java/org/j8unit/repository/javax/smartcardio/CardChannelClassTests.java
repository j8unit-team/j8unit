 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CardChannel public
 * abstract class javax.smartcardio.CardChannel}.
 *
...
public abstract interface CardChannelClassTests<SUT extends CardChannel>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CardChannel.class!",
                   CardChannel.class.isAssignableFrom(sut));
    }

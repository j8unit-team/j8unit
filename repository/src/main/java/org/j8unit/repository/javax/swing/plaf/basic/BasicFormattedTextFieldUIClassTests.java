...
public abstract interface BasicFormattedTextFieldUIClassTests<SUT extends BasicFormattedTextFieldUI>
extends BasicTextFieldUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicFormattedTextFieldUI.class!",
                   BasicFormattedTextFieldUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicFormattedTextFieldUI]

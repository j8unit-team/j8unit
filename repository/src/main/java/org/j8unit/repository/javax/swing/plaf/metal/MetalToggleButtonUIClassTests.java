...
import org.j8unit.repository.javax.swing.plaf.basic.BasicToggleButtonUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalToggleButtonUI
 * public class javax.swing.plaf.metal.MetalToggleButtonUI}.
 *
...
public abstract interface MetalToggleButtonUIClassTests<SUT extends MetalToggleButtonUI>
extends BasicToggleButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalToggleButtonUI.class!",
                   MetalToggleButtonUI.class.isAssignableFrom(sut));
    }

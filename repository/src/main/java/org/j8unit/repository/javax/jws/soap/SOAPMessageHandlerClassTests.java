...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.jws.soap.SOAPMessageHandler interface
 * javax.jws.soap.SOAPMessageHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPMessageHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPMessageHandlerTests}.
 * </p>
 *
 * @see javax.jws.soap.SOAPMessageHandler interface javax.jws.soap.SOAPMessageHandler (the hereby targeted
 *      class-under-test class)
 * @see SOAPMessageHandlerTests SOAPMessageHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPMessageHandlerClassTests<SUT extends javax.jws.soap.SOAPMessageHandler>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.soap.SOAPMessageHandler.class!",
                   javax.jws.soap.SOAPMessageHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPMessageHandler
 * public abstract @interface javax.jws.soap.SOAPMessageHandler}.
 *
...
public abstract interface SOAPMessageHandlerClassTests<SUT extends SOAPMessageHandler>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPMessageHandler.class!",
                   SOAPMessageHandler.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.plaf.basic.BasicRootPaneUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicRootPaneUITests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicRootPaneUITests BasicRootPaneUITests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.beans.PropertyChangeListenerClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.RootPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicRootPaneUI.class!",
                   javax.swing.plaf.basic.BasicRootPaneUI.class.isAssignableFrom(sut));
    }

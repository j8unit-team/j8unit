 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResponseWrapperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ResponseWrapperTests}.
 * </p>
 *
 * @see javax.xml.ws.ResponseWrapper interface javax.xml.ws.ResponseWrapper (the hereby targeted class-under-test class)
 * @see ResponseWrapperTests ResponseWrapperTests (The complementary j8unit test interface containing the instance
...
public abstract interface ResponseWrapperClassTests<SUT extends javax.xml.ws.ResponseWrapper>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.ResponseWrapper.class!",
                   javax.xml.ws.ResponseWrapper.class.isAssignableFrom(sut));
    }

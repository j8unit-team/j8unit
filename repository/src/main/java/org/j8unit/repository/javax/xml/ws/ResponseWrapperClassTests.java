 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResponseWrapper
...
public abstract interface ResponseWrapperClassTests<SUT extends ResponseWrapper>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResponseWrapper.class!",
                   ResponseWrapper.class.isAssignableFrom(sut));
    }

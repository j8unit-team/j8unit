 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TrustManager public
 * abstract interface javax.net.ssl.TrustManager}.
 *
...
public abstract interface TrustManagerClassTests<SUT extends TrustManager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TrustManager.class!",
                   TrustManager.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TrustManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TrustManagerTests}.
 * </p>
 *
 * @see javax.net.ssl.TrustManager interface javax.net.ssl.TrustManager (the hereby targeted class-under-test class)
 * @see TrustManagerTests TrustManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TrustManagerClassTests<SUT extends javax.net.ssl.TrustManager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.TrustManager.class!",
                   javax.net.ssl.TrustManager.class.isAssignableFrom(sut));
    }

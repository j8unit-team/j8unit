...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.keyinfo.KeyName interface
 * javax.xml.crypto.dsig.keyinfo.KeyName}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyNameTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.KeyName interface javax.xml.crypto.dsig.keyinfo.KeyName (the hereby targeted
 *      class-under-test class)
 * @see KeyNameTests KeyNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeyNameClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.KeyName>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.KeyName.class!",
                   javax.xml.crypto.dsig.keyinfo.KeyName.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyName public
...
public abstract interface KeyNameClassTests<SUT extends KeyName>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyName.class!",
                   KeyName.class.isAssignableFrom(sut));
    }

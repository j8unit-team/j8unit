...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.PrintConversionEvent interface
 * javax.xml.bind.PrintConversionEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintConversionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintConversionEventTests}
 * .
 * </p>
 *
 * @see javax.xml.bind.PrintConversionEvent interface javax.xml.bind.PrintConversionEvent (the hereby targeted
 *      class-under-test class)
 * @see PrintConversionEventTests PrintConversionEventTests (The complementary j8unit test interface containing the
...
public abstract interface PrintConversionEventClassTests<SUT extends javax.xml.bind.PrintConversionEvent>
extends ValidationEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.PrintConversionEvent.class!",
                   javax.xml.bind.PrintConversionEvent.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.javax.xml.bind.ValidationEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintConversionEvent.class!",
                   PrintConversionEvent.class.isAssignableFrom(sut));
    }

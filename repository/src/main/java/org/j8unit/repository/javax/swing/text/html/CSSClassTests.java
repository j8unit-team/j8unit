 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSS public class
...
public abstract interface CSSClassTests<SUT extends CSS>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
     ...
     * {@link Attribute public static final class javax.swing.text.html.CSS$Attribute}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

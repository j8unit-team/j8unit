 ...
 * javax.crypto.BadPaddingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BadPaddingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BadPaddingExceptionTests}.
 * </p>
 *
 * @see javax.crypto.BadPaddingException class javax.crypto.BadPaddingException (the hereby targeted class-under-test
 *      class)
 * @see BadPaddingExceptionTests BadPaddingExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.BadPaddingException.class!",
                   javax.crypto.BadPaddingException.class.isAssignableFrom(sut));
    }

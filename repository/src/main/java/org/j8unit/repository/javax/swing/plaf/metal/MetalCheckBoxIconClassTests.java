 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalCheckBoxIcon
 * public class javax.swing.plaf.metal.MetalCheckBoxIcon}.
 *
...
public abstract interface MetalCheckBoxIconClassTests<SUT extends MetalCheckBoxIcon>
extends IconClassTests<SUT>, UIResourceClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalCheckBoxIcon]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalCheckBoxIcon.class!",
                   MetalCheckBoxIcon.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.metal.MetalCheckBoxIcon]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.metal.MetalCheckBoxIcon]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleAction
 * public abstract interface javax.accessibility.AccessibleAction}.
 *
...
public abstract interface AccessibleActionClassTests<SUT extends AccessibleAction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleAction.class!",
                   AccessibleAction.class.isAssignableFrom(sut));
    }

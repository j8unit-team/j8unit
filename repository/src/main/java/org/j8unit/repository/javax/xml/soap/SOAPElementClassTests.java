 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPElement public
 * abstract interface javax.xml.soap.SOAPElement}.
 *
...
extends NodeClassTests<SUT>, ElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPElement.class!",
                   SOAPElement.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPElementTests}).
 * </p>
 *
 * <p>
 ...
 * @see SOAPElementTests SOAPElementTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SOAPElementClassTests<SUT extends javax.xml.soap.SOAPElement>
extends NodeClassTests<SUT>, org.j8unit.repository.org.w3c.dom.ElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPElement.class!",
                   javax.xml.soap.SOAPElement.class.isAssignableFrom(sut));
    }

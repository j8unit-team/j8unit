 ...
 * javax.sql.rowset.serial.SerialException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerialExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SerialExceptionTests}.
 * </p>
 *
 * @see javax.sql.rowset.serial.SerialException class javax.sql.rowset.serial.SerialException (the hereby targeted
 *      class-under-test class)
 * @see SerialExceptionTests SerialExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.sql.SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SerialException.class!",
                   javax.sql.rowset.serial.SerialException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerialException
 * public class javax.sql.rowset.serial.SerialException}.
 *
...
public abstract interface SerialExceptionClassTests<SUT extends SerialException>
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerialException.class!",
                   SerialException.class.isAssignableFrom(sut));
    }

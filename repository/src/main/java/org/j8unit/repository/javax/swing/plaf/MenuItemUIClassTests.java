 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuItemUI public
 * abstract class javax.swing.plaf.MenuItemUI}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuItemUITests}.
 * </p>
 *
 * <p>
...
public abstract interface MenuItemUIClassTests<SUT extends MenuItemUI>
extends ButtonUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.MenuItemUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuItemUI.class!",
                   MenuItemUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.MenuItemUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.MenuItemUI]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuItemUITests}).
 * </p>
 *
 * <p>
 ...
 * @see MenuItemUITests MenuItemUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MenuItemUIClassTests<SUT extends javax.swing.plaf.MenuItemUI>
extends ButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.MenuItemUI.class!",
                   javax.swing.plaf.MenuItemUI.class.isAssignableFrom(sut));
    }

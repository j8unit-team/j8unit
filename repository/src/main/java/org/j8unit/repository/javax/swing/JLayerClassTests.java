 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JLayer public final
 * class javax.swing.JLayer<V>}.
 *
...
public abstract interface JLayerClassTests<SUT extends JLayer>
extends ScrollableClassTests<SUT>, PropertyChangeListenerClassTests<SUT>, AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JLayer.class!",

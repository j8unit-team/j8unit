...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JList class javax.swing.JList}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JListTests}.
 * </p>
 *
 * @see javax.swing.JList class javax.swing.JList (the hereby targeted class-under-test class)
 * @see JListTests JListTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends ScrollableClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JList.class!",
                   javax.swing.JList.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JList.DropLocation class
     * javax.swing.JList$DropLocation}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link JListTests.DropLocationTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see JListTests.DropLocationTests JListTests.DropLocationTests (The complementary j8unit test interface
    ...
    extends TransferHandlerClassTests.DropLocationClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JList.DropLocation.class!",
                       javax.swing.JList.DropLocation.class.isAssignableFrom(sut));
        }

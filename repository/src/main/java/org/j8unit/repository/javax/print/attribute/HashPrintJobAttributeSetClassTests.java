...
public abstract interface HashPrintJobAttributeSetClassTests<SUT extends HashPrintJobAttributeSet>
extends PrintJobAttributeSetClassTests<SUT>, HashAttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HashPrintJobAttributeSet.class!",
                   HashPrintJobAttributeSet.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.print.attribute.HashPrintJobAttributeSet]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.print.attribute.HashPrintJobAttributeSet]

 ...
 * javax.swing.event.TableModelEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableModelEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TableModelEventTests}.
 * </p>
 *
 * @see javax.swing.event.TableModelEvent class javax.swing.event.TableModelEvent (the hereby targeted class-under-test
 *      class)
 * @see TableModelEventTests TableModelEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TableModelEvent.class!",
                   javax.swing.event.TableModelEvent.class.isAssignableFrom(sut));
    }

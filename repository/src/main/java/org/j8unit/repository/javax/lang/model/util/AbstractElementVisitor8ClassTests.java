 ...
 * {@link AbstractElementVisitor8 public abstract class javax.lang.model.util.AbstractElementVisitor8<R,P>}.
 *
...
public abstract interface AbstractElementVisitor8ClassTests<SUT extends AbstractElementVisitor8>
extends org.j8unit.repository.javax.lang.model.util.AbstractElementVisitor7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractElementVisitor8.class!",
                   AbstractElementVisitor8.class.isAssignableFrom(sut));
    }

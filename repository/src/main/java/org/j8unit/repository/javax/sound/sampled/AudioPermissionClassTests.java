 ...
 * javax.sound.sampled.AudioPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AudioPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AudioPermissionTests}.
 * </p>
 *
 * @see javax.sound.sampled.AudioPermission class javax.sound.sampled.AudioPermission (the hereby targeted
 *      class-under-test class)
 * @see AudioPermissionTests AudioPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.AudioPermission.class!",
                   javax.sound.sampled.AudioPermission.class.isAssignableFrom(sut));
    }

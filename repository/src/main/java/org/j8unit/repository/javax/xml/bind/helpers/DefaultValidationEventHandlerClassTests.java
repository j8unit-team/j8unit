...
import org.j8unit.repository.javax.xml.bind.ValidationEventHandlerClassTests;
...
public abstract interface DefaultValidationEventHandlerClassTests<SUT extends DefaultValidationEventHandler>
extends ValidationEventHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultValidationEventHandler.class!",
                   DefaultValidationEventHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputVerifier
 * public abstract class javax.swing.InputVerifier}.
 *
...
public abstract interface InputVerifierClassTests<SUT extends InputVerifier>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.InputVerifier]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputVerifier.class!",
                   InputVerifier.class.isAssignableFrom(sut));
    }

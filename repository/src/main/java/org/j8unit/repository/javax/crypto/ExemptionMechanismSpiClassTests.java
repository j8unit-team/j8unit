...
public abstract interface ExemptionMechanismSpiClassTests<SUT extends ExemptionMechanismSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExemptionMechanismSpi.class!",
                   ExemptionMechanismSpi.class.isAssignableFrom(sut));
    }

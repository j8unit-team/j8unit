 ...
 * javax.crypto.ExemptionMechanismSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExemptionMechanismSpiTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ExemptionMechanismSpiTests}.
 * </p>
 *
 * @see javax.crypto.ExemptionMechanismSpi class javax.crypto.ExemptionMechanismSpi (the hereby targeted
 *      class-under-test class)
 * @see ExemptionMechanismSpiTests ExemptionMechanismSpiTests (The complementary j8unit test interface containing the
...
public abstract interface ExemptionMechanismSpiClassTests<SUT extends javax.crypto.ExemptionMechanismSpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.ExemptionMechanismSpi.class!",
                   javax.crypto.ExemptionMechanismSpi.class.isAssignableFrom(sut));
    }

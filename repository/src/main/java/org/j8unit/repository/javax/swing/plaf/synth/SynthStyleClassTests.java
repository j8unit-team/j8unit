 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthStyle public
 * abstract class javax.swing.plaf.synth.SynthStyle}.
 *
...
public abstract interface SynthStyleClassTests<SUT extends SynthStyle>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthStyle.class!",
                   SynthStyle.class.isAssignableFrom(sut));
    }

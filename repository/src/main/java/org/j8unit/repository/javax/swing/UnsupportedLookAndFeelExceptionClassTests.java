...
public abstract interface UnsupportedLookAndFeelExceptionClassTests<SUT extends UnsupportedLookAndFeelException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedLookAndFeelException.class!",
                   UnsupportedLookAndFeelException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TabularType public
...
public abstract interface TabularTypeClassTests<SUT extends TabularType>
extends OpenTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TabularType.class!",
                   TabularType.class.isAssignableFrom(sut));
    }

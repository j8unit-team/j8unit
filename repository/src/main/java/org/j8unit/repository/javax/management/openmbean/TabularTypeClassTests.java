 ...
 * javax.management.openmbean.TabularType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TabularTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TabularTypeTests}.
 * </p>
 *
 * @see javax.management.openmbean.TabularType class javax.management.openmbean.TabularType (the hereby targeted
 *      class-under-test class)
 * @see TabularTypeTests TabularTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends OpenTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.TabularType.class!",
                   javax.management.openmbean.TabularType.class.isAssignableFrom(sut));
    }

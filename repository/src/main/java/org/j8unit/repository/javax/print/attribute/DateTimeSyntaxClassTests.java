 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateTimeSyntax
...
public abstract interface DateTimeSyntaxClassTests<SUT extends DateTimeSyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateTimeSyntax.class!",
                   DateTimeSyntax.class.isAssignableFrom(sut));
    }

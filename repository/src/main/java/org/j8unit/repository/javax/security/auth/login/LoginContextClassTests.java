 ...
 * javax.security.auth.login.LoginContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LoginContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LoginContextTests}.
 * </p>
 *
 * @see javax.security.auth.login.LoginContext class javax.security.auth.login.LoginContext (the hereby targeted
 *      class-under-test class)
 * @see LoginContextTests LoginContextTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.LoginContext.class!",
                   javax.security.auth.login.LoginContext.class.isAssignableFrom(sut));
    }

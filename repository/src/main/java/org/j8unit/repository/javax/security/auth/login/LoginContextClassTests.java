 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LoginContext public
...
public abstract interface LoginContextClassTests<SUT extends LoginContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LoginContext.class!",
                   LoginContext.class.isAssignableFrom(sut));
    }

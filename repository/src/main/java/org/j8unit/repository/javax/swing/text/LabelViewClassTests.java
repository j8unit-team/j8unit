 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LabelView public
...
public abstract interface LabelViewClassTests<SUT extends LabelView>
extends GlyphViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LabelView.class!",
                   LabelView.class.isAssignableFrom(sut));
    }

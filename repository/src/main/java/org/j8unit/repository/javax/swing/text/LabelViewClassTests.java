 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LabelViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LabelViewTests}.
 * </p>
 *
 * @see javax.swing.text.LabelView class javax.swing.text.LabelView (the hereby targeted class-under-test class)
 * @see LabelViewTests LabelViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LabelViewClassTests<SUT extends javax.swing.text.LabelView>
extends TabableViewClassTests<SUT>, GlyphViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.LabelView.class!",
                   javax.swing.text.LabelView.class.isAssignableFrom(sut));
    }

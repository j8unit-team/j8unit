 ...
 * javax.security.auth.callback.LanguageCallback}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LanguageCallbackTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LanguageCallbackTests}.
 * </p>
 *
 * @see javax.security.auth.callback.LanguageCallback class javax.security.auth.callback.LanguageCallback (the hereby
 *      targeted class-under-test class)
 * @see LanguageCallbackTests LanguageCallbackTests (The complementary j8unit test interface containing the instance
...
public abstract interface LanguageCallbackClassTests<SUT extends javax.security.auth.callback.LanguageCallback>
extends CallbackClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.callback.LanguageCallback.class!",
                   javax.security.auth.callback.LanguageCallback.class.isAssignableFrom(sut));
    }

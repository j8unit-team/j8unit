 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LanguageCallback
...
public abstract interface LanguageCallbackClassTests<SUT extends LanguageCallback>
extends CallbackClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LanguageCallback.class!",
                   LanguageCallback.class.isAssignableFrom(sut));
    }

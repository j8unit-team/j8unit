 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XPathException
...
public abstract interface XPathExceptionClassTests<SUT extends XPathException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathException.class!",
                   XPathException.class.isAssignableFrom(sut));
    }

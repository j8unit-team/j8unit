...
public abstract interface ListSelectionListenerClassTests<SUT extends ListSelectionListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListSelectionListener.class!",
                   ListSelectionListener.class.isAssignableFrom(sut));
    }

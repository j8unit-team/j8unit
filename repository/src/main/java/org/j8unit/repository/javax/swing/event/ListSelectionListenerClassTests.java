 ...
 * javax.swing.event.ListSelectionListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListSelectionListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ListSelectionListenerTests}.
 * </p>
 *
 * @see javax.swing.event.ListSelectionListener interface javax.swing.event.ListSelectionListener (the hereby targeted
 *      class-under-test class)
 * @see ListSelectionListenerTests ListSelectionListenerTests (The complementary j8unit test interface containing the
...
public abstract interface ListSelectionListenerClassTests<SUT extends javax.swing.event.ListSelectionListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.ListSelectionListener.class!",
                   javax.swing.event.ListSelectionListener.class.isAssignableFrom(sut));
    }

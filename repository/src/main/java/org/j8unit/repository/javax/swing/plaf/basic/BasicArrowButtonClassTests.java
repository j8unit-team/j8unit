 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicArrowButton
 * public class javax.swing.plaf.basic.BasicArrowButton}.
 *
...
public abstract interface BasicArrowButtonClassTests<SUT extends BasicArrowButton>
extends JButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicArrowButton.class!",
                   BasicArrowButton.class.isAssignableFrom(sut));
    }

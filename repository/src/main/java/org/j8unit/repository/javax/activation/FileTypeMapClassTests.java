 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileTypeMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileTypeMapTests}.
 * </p>
 *
 * @see javax.activation.FileTypeMap class javax.activation.FileTypeMap (the hereby targeted class-under-test class)
 * @see FileTypeMapTests FileTypeMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileTypeMapClassTests<SUT extends javax.activation.FileTypeMap>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.FileTypeMap.class!",
                   javax.activation.FileTypeMap.class.isAssignableFrom(sut));
    }

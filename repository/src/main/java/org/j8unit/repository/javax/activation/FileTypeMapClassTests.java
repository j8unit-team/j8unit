 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileTypeMap public
 * abstract class javax.activation.FileTypeMap}.
 *
...
public abstract interface FileTypeMapClassTests<SUT extends FileTypeMap>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileTypeMap.class!",
                   FileTypeMap.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlSchemaType
...
public abstract interface XmlSchemaTypeClassTests<SUT extends XmlSchemaType>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlSchemaType.class!",
     ...
     * {@link DEFAULT public static final class javax.xml.bind.annotation.XmlSchemaType$DEFAULT}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.annotation.XmlSchemaType$DEFAULT]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *

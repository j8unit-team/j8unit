 ...
 * {@link org.j8unit.repository.javax.xml.ws.handler.LogicalMessageContextTests}.
 * </p>
 *
 * <p>
...
public abstract interface LogicalMessageContextClassTests<SUT extends LogicalMessageContext>
extends MessageContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LogicalMessageContext.class!",
                   LogicalMessageContext.class.isAssignableFrom(sut));
    }

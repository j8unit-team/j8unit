 ...
 * javax.xml.ws.handler.LogicalMessageContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LogicalMessageContextTests}).
 * </p>
 *
 * <p>
 ...
 * {@link LogicalMessageContextTests}.
 * </p>
 *
 * @see javax.xml.ws.handler.LogicalMessageContext interface javax.xml.ws.handler.LogicalMessageContext (the hereby
 *      targeted class-under-test class)
 * @see LogicalMessageContextTests LogicalMessageContextTests (The complementary j8unit test interface containing the
...
extends MessageContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.LogicalMessageContext.class!",
                   javax.xml.ws.handler.LogicalMessageContext.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.plaf.basic.BasicSplitPaneDivider}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicSplitPaneDividerTests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicSplitPaneDividerTests BasicSplitPaneDividerTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.beans.PropertyChangeListenerClassTests<SUT>, org.j8unit.repository.java.awt.ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicSplitPaneDivider.class!",
                   javax.swing.plaf.basic.BasicSplitPaneDivider.class.isAssignableFrom(sut));
    }

...
extends PropertyChangeListenerClassTests<SUT>, ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicSplitPaneDivider.class!",
                   BasicSplitPaneDivider.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.sasl.RealmChoiceCallback}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RealmChoiceCallbackTests}).
 * </p>
 *
 * <p>
 ...
 * @see RealmChoiceCallbackTests RealmChoiceCallbackTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.security.auth.callback.ChoiceCallbackClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.RealmChoiceCallback.class!",
                   javax.security.sasl.RealmChoiceCallback.class.isAssignableFrom(sut));
    }

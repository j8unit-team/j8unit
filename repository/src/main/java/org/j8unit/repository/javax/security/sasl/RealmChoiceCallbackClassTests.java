 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RealmChoiceCallback
 * public class javax.security.sasl.RealmChoiceCallback}.
 *
...
extends ChoiceCallbackClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RealmChoiceCallback.class!",
                   RealmChoiceCallback.class.isAssignableFrom(sut));
    }

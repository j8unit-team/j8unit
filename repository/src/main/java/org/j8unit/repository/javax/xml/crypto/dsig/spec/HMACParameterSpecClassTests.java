 ...
 * javax.xml.crypto.dsig.spec.HMACParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HMACParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HMACParameterSpecTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.spec.HMACParameterSpec class javax.xml.crypto.dsig.spec.HMACParameterSpec (the hereby
 *      targeted class-under-test class)
 * @see HMACParameterSpecTests HMACParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends SignatureMethodParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.HMACParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.HMACParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HMACParameterSpec
 * public final class javax.xml.crypto.dsig.spec.HMACParameterSpec}.
 *
...
public abstract interface HMACParameterSpecClassTests<SUT extends HMACParameterSpec>
extends org.j8unit.repository.javax.xml.crypto.dsig.spec.SignatureMethodParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HMACParameterSpec.class!",
                   HMACParameterSpec.class.isAssignableFrom(sut));
    }

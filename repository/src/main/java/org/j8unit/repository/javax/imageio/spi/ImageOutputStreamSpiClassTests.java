 ...
 * javax.imageio.spi.ImageOutputStreamSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageOutputStreamSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageOutputStreamSpiTests}
 * .
 * </p>
 *
 * @see javax.imageio.spi.ImageOutputStreamSpi class javax.imageio.spi.ImageOutputStreamSpi (the hereby targeted
 *      class-under-test class)
 * @see ImageOutputStreamSpiTests ImageOutputStreamSpiTests (The complementary j8unit test interface containing the
...
extends IIOServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.ImageOutputStreamSpi.class!",
                   javax.imageio.spi.ImageOutputStreamSpi.class.isAssignableFrom(sut));
    }

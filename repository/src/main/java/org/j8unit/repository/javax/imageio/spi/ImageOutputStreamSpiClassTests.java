...
public abstract interface ImageOutputStreamSpiClassTests<SUT extends ImageOutputStreamSpi>
extends IIOServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageOutputStreamSpi.class!",
                   ImageOutputStreamSpi.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.imageio.spi.ImageOutputStreamSpi]

 ...
 * javax.swing.plaf.DimensionUIResource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DimensionUIResourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DimensionUIResourceTests}.
 * </p>
 *
 * @see javax.swing.plaf.DimensionUIResource class javax.swing.plaf.DimensionUIResource (the hereby targeted
 *      class-under-test class)
 * @see DimensionUIResourceTests DimensionUIResourceTests (The complementary j8unit test interface containing the
...
extends UIResourceClassTests<SUT>, org.j8unit.repository.java.awt.DimensionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.DimensionUIResource.class!",
                   javax.swing.plaf.DimensionUIResource.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.awt.DimensionClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DimensionUIResource
 * public class javax.swing.plaf.DimensionUIResource}.
 *
...
public abstract interface DimensionUIResourceClassTests<SUT extends DimensionUIResource>
extends UIResourceClassTests<SUT>, DimensionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DimensionUIResource.class!",
                   DimensionUIResource.class.isAssignableFrom(sut));
    }

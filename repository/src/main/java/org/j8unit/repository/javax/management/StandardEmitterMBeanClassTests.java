 ...
 * {@link StandardEmitterMBean public class javax.management.StandardEmitterMBean}.
 *
...
extends NotificationEmitterClassTests<SUT>, StandardMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StandardEmitterMBean.class!",
                   StandardEmitterMBean.class.isAssignableFrom(sut));
    }

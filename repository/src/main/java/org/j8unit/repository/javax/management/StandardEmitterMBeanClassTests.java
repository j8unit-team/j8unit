...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.StandardEmitterMBean class
 * javax.management.StandardEmitterMBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardEmitterMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StandardEmitterMBeanTests}
 * .
 * </p>
 *
 * @see javax.management.StandardEmitterMBean class javax.management.StandardEmitterMBean (the hereby targeted
 *      class-under-test class)
 * @see StandardEmitterMBeanTests StandardEmitterMBeanTests (The complementary j8unit test interface containing the
...
public abstract interface StandardEmitterMBeanClassTests<SUT extends javax.management.StandardEmitterMBean>
extends NotificationEmitterClassTests<SUT>, StandardMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.StandardEmitterMBean.class!",
                   javax.management.StandardEmitterMBean.class.isAssignableFrom(sut));
    }

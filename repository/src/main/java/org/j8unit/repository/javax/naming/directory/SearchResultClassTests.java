 ...
 * javax.naming.directory.SearchResult}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SearchResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SearchResultTests}.
 * </p>
 *
 * @see javax.naming.directory.SearchResult class javax.naming.directory.SearchResult (the hereby targeted
 *      class-under-test class)
 * @see SearchResultTests SearchResultTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.naming.BindingClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.SearchResult.class!",
                   javax.naming.directory.SearchResult.class.isAssignableFrom(sut));
    }

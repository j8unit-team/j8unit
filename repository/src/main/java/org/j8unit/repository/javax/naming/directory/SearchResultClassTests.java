...
import org.j8unit.repository.javax.naming.BindingClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SearchResult public
...
public abstract interface SearchResultClassTests<SUT extends SearchResult>
extends BindingClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SearchResult.class!",
                   SearchResult.class.isAssignableFrom(sut));
    }

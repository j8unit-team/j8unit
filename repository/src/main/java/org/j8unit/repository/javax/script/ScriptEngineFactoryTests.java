 ...
 * {@link ScriptEngineFactory public abstract interface javax.script.ScriptEngineFactory}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.script.ScriptEngineFactoryClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface ScriptEngineFactoryTests<SUT extends ScriptEngineFactory>
extends RepositoryTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getLanguageName()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getOutputStatement_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getProgram_StringArray()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

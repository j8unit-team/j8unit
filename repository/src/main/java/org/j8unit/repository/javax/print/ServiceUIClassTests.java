 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServiceUITests}.
 * </p>
 *
 * @see javax.print.ServiceUI class javax.print.ServiceUI (the hereby targeted class-under-test class)
 * @see ServiceUITests ServiceUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.ServiceUI.class!",
                   javax.print.ServiceUI.class.isAssignableFrom(sut));
    }

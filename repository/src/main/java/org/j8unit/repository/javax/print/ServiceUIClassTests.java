 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceUI public
...
public abstract interface ServiceUIClassTests<SUT extends ServiceUI>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceUI.class!",
                   ServiceUI.class.isAssignableFrom(sut));
    }

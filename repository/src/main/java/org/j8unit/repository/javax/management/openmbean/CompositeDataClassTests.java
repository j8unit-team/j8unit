 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompositeData
 * public abstract interface javax.management.openmbean.CompositeData}.
 *
...
public abstract interface CompositeDataClassTests<SUT extends CompositeData>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompositeData.class!",
                   CompositeData.class.isAssignableFrom(sut));
    }

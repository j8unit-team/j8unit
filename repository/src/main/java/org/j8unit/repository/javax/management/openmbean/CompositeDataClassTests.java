...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.CompositeData interface
 * javax.management.openmbean.CompositeData}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompositeDataTests}.
 * </p>
 *
 * @see javax.management.openmbean.CompositeData interface javax.management.openmbean.CompositeData (the hereby targeted
 *      class-under-test class)
 * @see CompositeDataTests CompositeDataTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CompositeDataClassTests<SUT extends javax.management.openmbean.CompositeData>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.CompositeData.class!",
                   javax.management.openmbean.CompositeData.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PlainViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PlainViewTests}.
 * </p>
 *
 * @see javax.swing.text.PlainView class javax.swing.text.PlainView (the hereby targeted class-under-test class)
 * @see PlainViewTests PlainViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends TabExpanderClassTests<SUT>, ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.PlainView.class!",
                   javax.swing.text.PlainView.class.isAssignableFrom(sut));
    }

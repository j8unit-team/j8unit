 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PlainView public
...
public abstract interface PlainViewClassTests<SUT extends PlainView>
extends org.j8unit.repository.javax.swing.text.TabExpanderClassTests<SUT>, org.j8unit.repository.javax.swing.text.ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PlainView.class!",
                   PlainView.class.isAssignableFrom(sut));
    }

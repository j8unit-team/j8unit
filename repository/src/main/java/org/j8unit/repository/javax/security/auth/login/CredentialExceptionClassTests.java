 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CredentialException
 * public class javax.security.auth.login.CredentialException}.
 *
...
public abstract interface CredentialExceptionClassTests<SUT extends CredentialException>
extends LoginExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CredentialException.class!",
                   CredentialException.class.isAssignableFrom(sut));
    }

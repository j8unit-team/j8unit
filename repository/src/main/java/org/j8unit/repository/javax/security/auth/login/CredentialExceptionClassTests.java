 ...
 * javax.security.auth.login.CredentialException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CredentialExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CredentialExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.login.CredentialException class javax.security.auth.login.CredentialException (the hereby
 *      targeted class-under-test class)
 * @see CredentialExceptionTests CredentialExceptionTests (The complementary j8unit test interface containing the
...
extends LoginExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.CredentialException.class!",
                   javax.security.auth.login.CredentialException.class.isAssignableFrom(sut));
    }

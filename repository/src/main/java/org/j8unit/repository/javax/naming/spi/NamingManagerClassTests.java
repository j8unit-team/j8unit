...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.spi.NamingManager class javax.naming.spi.NamingManager},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingManagerTests}.
 * </p>
 *
 * @see javax.naming.spi.NamingManager class javax.naming.spi.NamingManager (the hereby targeted class-under-test class)
 * @see NamingManagerTests NamingManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NamingManagerClassTests<SUT extends javax.naming.spi.NamingManager>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.NamingManager.class!",
                   javax.naming.spi.NamingManager.class.isAssignableFrom(sut));
    }

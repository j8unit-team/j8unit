 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingManager
...
public abstract interface NamingManagerClassTests<SUT extends NamingManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingManager.class!",
                   NamingManager.class.isAssignableFrom(sut));
    }

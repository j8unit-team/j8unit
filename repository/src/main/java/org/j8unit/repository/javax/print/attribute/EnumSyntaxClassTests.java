 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EnumSyntax public
 * abstract class javax.print.attribute.EnumSyntax}.
 *
...
public abstract interface EnumSyntaxClassTests<SUT extends EnumSyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EnumSyntax.class!",
                   EnumSyntax.class.isAssignableFrom(sut));
    }

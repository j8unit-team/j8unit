...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.EnumSyntax class
 * javax.print.attribute.EnumSyntax}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EnumSyntaxTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EnumSyntaxTests}.
 * </p>
 *
 * @see javax.print.attribute.EnumSyntax class javax.print.attribute.EnumSyntax (the hereby targeted class-under-test
 *      class)
 * @see EnumSyntaxTests EnumSyntaxTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface EnumSyntaxClassTests<SUT extends javax.print.attribute.EnumSyntax>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.EnumSyntax.class!",
                   javax.print.attribute.EnumSyntax.class.isAssignableFrom(sut));
    }

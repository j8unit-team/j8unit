...
public abstract interface ValidationEventCollectorClassTests<SUT extends ValidationEventCollector>
extends ValidationEventHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValidationEventCollector.class!",
                   ValidationEventCollector.class.isAssignableFrom(sut));
    }

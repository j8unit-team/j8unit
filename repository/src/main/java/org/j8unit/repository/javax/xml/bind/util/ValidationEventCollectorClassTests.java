 ...
 * javax.xml.bind.util.ValidationEventCollector}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValidationEventCollectorTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ValidationEventCollectorTests}.
 * </p>
 *
 * @see javax.xml.bind.util.ValidationEventCollector class javax.xml.bind.util.ValidationEventCollector (the hereby
 *      targeted class-under-test class)
 * @see ValidationEventCollectorTests ValidationEventCollectorTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.xml.bind.ValidationEventHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.util.ValidationEventCollector.class!",
                   javax.xml.bind.util.ValidationEventCollector.class.isAssignableFrom(sut));
    }

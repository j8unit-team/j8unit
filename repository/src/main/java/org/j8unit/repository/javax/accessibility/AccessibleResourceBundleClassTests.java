...
import org.j8unit.repository.java.util.ListResourceBundleClassTests;
 ...
 * {@link AccessibleResourceBundle public class javax.accessibility.AccessibleResourceBundle}.
 *
...
public abstract interface AccessibleResourceBundleClassTests<SUT extends AccessibleResourceBundle>
extends ListResourceBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleResourceBundle.class!",
                   AccessibleResourceBundle.class.isAssignableFrom(sut));
    }

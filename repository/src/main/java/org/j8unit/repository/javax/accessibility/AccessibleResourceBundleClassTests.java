 ...
 * javax.accessibility.AccessibleResourceBundle}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleResourceBundleTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AccessibleResourceBundleTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleResourceBundle class javax.accessibility.AccessibleResourceBundle (the hereby
 *      targeted class-under-test class)
 * @see AccessibleResourceBundleTests AccessibleResourceBundleTests (The complementary j8unit test interface containing
...
public abstract interface AccessibleResourceBundleClassTests<SUT extends javax.accessibility.AccessibleResourceBundle>
extends org.j8unit.repository.java.util.ListResourceBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleResourceBundle.class!",
                   javax.accessibility.AccessibleResourceBundle.class.isAssignableFrom(sut));
    }

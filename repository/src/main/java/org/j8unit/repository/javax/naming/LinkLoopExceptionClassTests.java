 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkLoopException
 * public class javax.naming.LinkLoopException}.
 *
...
public abstract interface LinkLoopExceptionClassTests<SUT extends LinkLoopException>
extends LinkExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkLoopException.class!",

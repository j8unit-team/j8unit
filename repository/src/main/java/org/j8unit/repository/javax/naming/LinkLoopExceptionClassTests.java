 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkLoopExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkLoopExceptionTests}.
 * </p>
 *
 * @see javax.naming.LinkLoopException class javax.naming.LinkLoopException (the hereby targeted class-under-test class)
 * @see LinkLoopExceptionTests LinkLoopExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface LinkLoopExceptionClassTests<SUT extends javax.naming.LinkLoopException>
extends LinkExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.LinkLoopException.class!",
                   javax.naming.LinkLoopException.class.isAssignableFrom(sut));
    }

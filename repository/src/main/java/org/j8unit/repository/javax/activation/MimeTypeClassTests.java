...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.activation.MimeType class javax.activation.MimeType}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MimeTypeTests}).
 * </p>
 *
 * <p>
 ...
 * @see MimeTypeTests MimeTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MimeTypeClassTests<SUT extends javax.activation.MimeType>
extends org.j8unit.repository.java.io.ExternalizableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.MimeType.class!",
                   javax.activation.MimeType.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.NotCompliantMBeanException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link NotCompliantMBeanExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see NotCompliantMBeanExceptionTests NotCompliantMBeanExceptionTests (The complementary j8unit test interface
...
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.NotCompliantMBeanException.class!",
                   javax.management.NotCompliantMBeanException.class.isAssignableFrom(sut));
    }

 ...
 * {@link NotCompliantMBeanException public class javax.management.NotCompliantMBeanException}.
 *
...
public abstract interface NotCompliantMBeanExceptionClassTests<SUT extends NotCompliantMBeanException>
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotCompliantMBeanException.class!",
                   NotCompliantMBeanException.class.isAssignableFrom(sut));
    }

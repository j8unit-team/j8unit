 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Sequencer public
 * abstract interface javax.sound.midi.Sequencer}.
 *
...
extends MidiDeviceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Sequencer.class!",
                   Sequencer.class.isAssignableFrom(sut));
    }
     ...
     * {@link SyncMode public static class javax.sound.midi.Sequencer$SyncMode}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SyncMode.class!",
                              SyncMode.class.isAssignableFrom(sut));
        }

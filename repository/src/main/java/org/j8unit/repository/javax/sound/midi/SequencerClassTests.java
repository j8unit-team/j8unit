...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sound.midi.Sequencer interface javax.sound.midi.Sequencer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SequencerTests}).
 * </p>
 *
 * <p>
 ...
 * @see SequencerTests SequencerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends MidiDeviceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Sequencer.class!",
                   javax.sound.midi.Sequencer.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.midi.Sequencer.SyncMode class
     * javax.sound.midi.Sequencer$SyncMode}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link SequencerTests.SyncModeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see SequencerTests.SyncModeTests SequencerTests.SyncModeTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Sequencer.SyncMode.class!",
                       javax.sound.midi.Sequencer.SyncMode.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicMenuItemUI
 * public class javax.swing.plaf.basic.BasicMenuItemUI}.
 *
...
public abstract interface BasicMenuItemUIClassTests<SUT extends BasicMenuItemUI>
extends MenuItemUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicMenuItemUI.class!",
                   BasicMenuItemUI.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.awt.AdjustableClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JScrollBar public
...
public abstract interface JScrollBarClassTests<SUT extends JScrollBar>
extends AdjustableClassTests<SUT>, AccessibleClassTests<SUT>, JComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JScrollBar]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JScrollBar.class!",
                   JScrollBar.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.JScrollBar]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.JScrollBar]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JScrollBarTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JScrollBarTests}.
 * </p>
 *
 * @see javax.swing.JScrollBar class javax.swing.JScrollBar (the hereby targeted class-under-test class)
 * @see JScrollBarTests JScrollBarTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JScrollBarClassTests<SUT extends javax.swing.JScrollBar>
...
JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JScrollBar.class!",
                   javax.swing.JScrollBar.class.isAssignableFrom(sut));
    }

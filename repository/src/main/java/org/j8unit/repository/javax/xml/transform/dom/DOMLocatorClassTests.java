 ...
 * javax.xml.transform.dom.DOMLocator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMLocatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DOMLocatorTests}.
 * </p>
 *
 * @see javax.xml.transform.dom.DOMLocator interface javax.xml.transform.dom.DOMLocator (the hereby targeted
 *      class-under-test class)
 * @see DOMLocatorTests DOMLocatorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DOMLocatorClassTests<SUT extends javax.xml.transform.dom.DOMLocator>
extends org.j8unit.repository.javax.xml.transform.SourceLocatorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.dom.DOMLocator.class!",
                   javax.xml.transform.dom.DOMLocator.class.isAssignableFrom(sut));
    }

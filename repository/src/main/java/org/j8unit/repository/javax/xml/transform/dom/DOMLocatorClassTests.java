...
import org.j8unit.repository.javax.xml.transform.SourceLocatorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMLocator public
 * abstract interface javax.xml.transform.dom.DOMLocator}.
 *
...
public abstract interface DOMLocatorClassTests<SUT extends DOMLocator>
extends SourceLocatorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMLocator.class!",
                   DOMLocator.class.isAssignableFrom(sut));
    }

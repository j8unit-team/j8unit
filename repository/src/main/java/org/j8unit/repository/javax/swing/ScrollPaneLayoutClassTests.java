 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScrollPaneLayout
 * public class javax.swing.ScrollPaneLayout}.
 *
...
extends LayoutManagerClassTests<SUT>, ScrollPaneConstantsClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScrollPaneLayout.class!",
                   ScrollPaneLayout.class.isAssignableFrom(sut));
    }
     ...
     * {@link UIResource public static class javax.swing.ScrollPaneLayout$UIResource}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

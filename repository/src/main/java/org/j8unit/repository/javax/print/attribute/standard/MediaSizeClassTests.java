...
import org.j8unit.repository.javax.print.attribute.standard.MediaSizeTests.EngineeringTests;
import org.j8unit.repository.javax.print.attribute.standard.MediaSizeTests.ISOTests;
import org.j8unit.repository.javax.print.attribute.standard.MediaSizeTests.JISTests;
import org.j8unit.repository.javax.print.attribute.standard.MediaSizeTests.NATests;
import org.j8unit.repository.javax.print.attribute.standard.MediaSizeTests.OtherTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MediaSize public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MediaSizeTests}.
 * </p>
 *
 * <p>
...
extends AttributeClassTests<SUT>, Size2DSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MediaSize.class!",
                   MediaSize.class.isAssignableFrom(sut));
    }
     ...
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ISO
     * public static final class javax.print.attribute.standard.MediaSize$ISO}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ISOTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ISO.class!",
                              ISO.class.isAssignableFrom(sut));
        }
     ...
     * <p>
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NA
     * public static final class javax.print.attribute.standard.MediaSize$NA}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link NATests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NA.class!",
                              NA.class.isAssignableFrom(sut));
        }
     ...
     * <p>
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JIS
     * public static final class javax.print.attribute.standard.MediaSize$JIS}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link JISTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JIS.class!",
                              JIS.class.isAssignableFrom(sut));
        }
     ...
     * {@link Engineering public static final class javax.print.attribute.standard.MediaSize$Engineering}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link EngineeringTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Engineering.class!",
                              Engineering.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link Other public static final class javax.print.attribute.standard.MediaSize$Other}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link OtherTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Other.class!",
                              Other.class.isAssignableFrom(sut));
        }

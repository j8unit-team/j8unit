 ...
 * javax.management.MBeanNotificationInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanNotificationInfoTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MBeanNotificationInfoTests}.
 * </p>
 *
 * @see javax.management.MBeanNotificationInfo class javax.management.MBeanNotificationInfo (the hereby targeted
 *      class-under-test class)
 * @see MBeanNotificationInfoTests MBeanNotificationInfoTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanNotificationInfo.class!",
                   javax.management.MBeanNotificationInfo.class.isAssignableFrom(sut));
    }

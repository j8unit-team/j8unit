 ...
 * {@link MBeanNotificationInfo public class javax.management.MBeanNotificationInfo}.
 *
...
public abstract interface MBeanNotificationInfoClassTests<SUT extends MBeanNotificationInfo>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.javax.management.MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanNotificationInfo.class!",
                   MBeanNotificationInfo.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.MBeanNotificationInfo]

 ...
 * {@link PrintServiceAttributeListener public abstract interface javax.print.event.PrintServiceAttributeListener}.
 *
...
public abstract interface PrintServiceAttributeListenerClassTests<SUT extends PrintServiceAttributeListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintServiceAttributeListener.class!",
                   PrintServiceAttributeListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.print.event.PrintServiceAttributeListener}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link PrintServiceAttributeListenerTests}).
 * </p>
 *
 * <p>
 ...
 * @see PrintServiceAttributeListenerTests PrintServiceAttributeListenerTests (The complementary j8unit test interface
...
public abstract interface PrintServiceAttributeListenerClassTests<SUT extends javax.print.event.PrintServiceAttributeListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.event.PrintServiceAttributeListener.class!",
                   javax.print.event.PrintServiceAttributeListener.class.isAssignableFrom(sut));
    }

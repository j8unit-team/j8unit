 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentationToolTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see DocumentationToolTests DocumentationToolTests (The complementary j8unit test interface containing the instance
...
extends ToolClassTests<SUT>, OptionCheckerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.DocumentationTool.class!",
                   javax.tools.DocumentationTool.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.tools.DocumentationTool.Location class
     * javax.tools.DocumentationTool$Location}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link DocumentationToolTests.LocationTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see DocumentationToolTests.LocationTests DocumentationToolTests.LocationTests (The complementary j8unit test
    ...
    extends JavaFileManagerClassTests.LocationClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.DocumentationTool.Location.class!",
                       javax.tools.DocumentationTool.Location.class.isAssignableFrom(sut));
        }
     ...
     * javax.tools.DocumentationTool$DocumentationTask}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link DocumentationToolTests.DocumentationTaskTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see DocumentationToolTests.DocumentationTaskTests DocumentationToolTests.DocumentationTaskTests (The
    ...
    extends org.j8unit.repository.java.util.concurrent.CallableClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.DocumentationTool.DocumentationTask.class!",
                       javax.tools.DocumentationTool.DocumentationTask.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentationTool
 * public abstract interface javax.tools.DocumentationTool}.
 *
...
public abstract interface DocumentationToolClassTests<SUT extends DocumentationTool>
extends org.j8unit.repository.javax.tools.ToolClassTests<SUT>, org.j8unit.repository.javax.tools.OptionCheckerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentationTool.class!",
     ...
     * {@link Location public static final enum javax.tools.DocumentationTool$Location}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface LocationClassTests<SUT extends Location>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface DocumentationTaskClassTests<SUT extends DocumentationTask>

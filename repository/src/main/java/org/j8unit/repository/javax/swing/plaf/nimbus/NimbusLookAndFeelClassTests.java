...
import org.j8unit.repository.javax.swing.plaf.synth.SynthLookAndFeelClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NimbusLookAndFeel
 * public class javax.swing.plaf.nimbus.NimbusLookAndFeel}.
 *
...
public abstract interface NimbusLookAndFeelClassTests<SUT extends NimbusLookAndFeel>
extends SynthLookAndFeelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NimbusLookAndFeel.class!",
                   NimbusLookAndFeel.class.isAssignableFrom(sut));
    }

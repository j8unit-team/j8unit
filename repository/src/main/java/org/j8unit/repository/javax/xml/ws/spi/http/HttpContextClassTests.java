...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.spi.http.HttpContext class
 * javax.xml.ws.spi.http.HttpContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HttpContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HttpContextTests}.
 * </p>
 *
 * @see javax.xml.ws.spi.http.HttpContext class javax.xml.ws.spi.http.HttpContext (the hereby targeted class-under-test
 *      class)
 * @see HttpContextTests HttpContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface HttpContextClassTests<SUT extends javax.xml.ws.spi.http.HttpContext>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.spi.http.HttpContext.class!",
                   javax.xml.ws.spi.http.HttpContext.class.isAssignableFrom(sut));
    }

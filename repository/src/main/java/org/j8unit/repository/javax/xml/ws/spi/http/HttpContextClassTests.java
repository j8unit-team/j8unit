 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HttpContext public
 * abstract class javax.xml.ws.spi.http.HttpContext}.
 *
...
public abstract interface HttpContextClassTests<SUT extends HttpContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HttpContext.class!",
                   HttpContext.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.PersistentMBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PersistentMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PersistentMBeanTests}.
 * </p>
 *
 * @see javax.management.PersistentMBean interface javax.management.PersistentMBean (the hereby targeted
 *      class-under-test class)
 * @see PersistentMBeanTests PersistentMBeanTests (The complementary j8unit test interface containing the instance
...
public abstract interface PersistentMBeanClassTests<SUT extends javax.management.PersistentMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.PersistentMBean.class!",
                   javax.management.PersistentMBean.class.isAssignableFrom(sut));
    }

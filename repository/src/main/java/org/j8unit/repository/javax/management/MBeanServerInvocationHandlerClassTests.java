 ...
 * javax.management.MBeanServerInvocationHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see MBeanServerInvocationHandlerTests MBeanServerInvocationHandlerTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.reflect.InvocationHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanServerInvocationHandler.class!",
                   javax.management.MBeanServerInvocationHandler.class.isAssignableFrom(sut));
    }

...
extends InvocationHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerInvocationHandler.class!",
                   MBeanServerInvocationHandler.class.isAssignableFrom(sut));
    }

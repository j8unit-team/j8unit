 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HttpExchange public
 * abstract class javax.xml.ws.spi.http.HttpExchange}.
 *
...
public abstract interface HttpExchangeClassTests<SUT extends HttpExchange>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.ws.spi.http.HttpExchange]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HttpExchange.class!",
                   HttpExchange.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.ws.spi.http.HttpExchange]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.xml.ws.spi.http.HttpExchange]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPFault public
 * abstract interface javax.xml.soap.SOAPFault}.
 *
...
public abstract interface SOAPFaultClassTests<SUT extends SOAPFault>
extends SOAPBodyElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPFault.class!",
                   SOAPFault.class.isAssignableFrom(sut));
    }

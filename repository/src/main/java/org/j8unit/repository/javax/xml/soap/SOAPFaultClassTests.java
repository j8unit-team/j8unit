...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.soap.SOAPFault interface javax.xml.soap.SOAPFault},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPFaultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPFaultTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPFault interface javax.xml.soap.SOAPFault (the hereby targeted class-under-test class)
 * @see SOAPFaultTests SOAPFaultTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SOAPFaultClassTests<SUT extends javax.xml.soap.SOAPFault>
extends SOAPBodyElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPFault.class!",
                   javax.xml.soap.SOAPFault.class.isAssignableFrom(sut));
    }

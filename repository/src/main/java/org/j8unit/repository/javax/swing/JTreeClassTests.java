...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JTree class javax.swing.JTree}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JTreeTests}).
 * </p>
 *
 * <p>
 ...
 * @see JTreeTests JTreeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends ScrollableClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JTree.class!",
                   javax.swing.JTree.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JTree.DropLocation class
     * javax.swing.JTree$DropLocation}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link JTreeTests.DropLocationTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see JTreeTests.DropLocationTests JTreeTests.DropLocationTests (The complementary j8unit test interface
    ...
    extends TransferHandlerClassTests.DropLocationClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JTree.DropLocation.class!",
                       javax.swing.JTree.DropLocation.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.JTree$DynamicUtilTreeNode}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link JTreeTests.DynamicUtilTreeNodeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see JTreeTests.DynamicUtilTreeNodeTests JTreeTests.DynamicUtilTreeNodeTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.javax.swing.tree.DefaultMutableTreeNodeClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JTree.DynamicUtilTreeNode.class!",
                       javax.swing.JTree.DynamicUtilTreeNode.class.isAssignableFrom(sut));
        }

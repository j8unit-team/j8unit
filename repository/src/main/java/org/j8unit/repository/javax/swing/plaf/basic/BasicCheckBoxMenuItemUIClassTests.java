...
public abstract interface BasicCheckBoxMenuItemUIClassTests<SUT extends BasicCheckBoxMenuItemUI>
extends BasicMenuItemUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicCheckBoxMenuItemUI.class!",
                   BasicCheckBoxMenuItemUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicSpinnerUI
...
public abstract interface BasicSpinnerUIClassTests<SUT extends BasicSpinnerUI>
extends SpinnerUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicSpinnerUI.class!",
                   BasicSpinnerUI.class.isAssignableFrom(sut));
    }

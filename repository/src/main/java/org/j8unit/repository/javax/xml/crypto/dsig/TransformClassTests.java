 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Transform public
 * abstract interface javax.xml.crypto.dsig.Transform}.
 *
...
extends XMLStructureClassTests<SUT>, AlgorithmMethodClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Transform.class!",
                   Transform.class.isAssignableFrom(sut));
    }

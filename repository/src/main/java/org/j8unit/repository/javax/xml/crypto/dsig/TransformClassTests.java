 ...
 * javax.xml.crypto.dsig.Transform}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransformTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see TransformTests TransformTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TransformClassTests<SUT extends javax.xml.crypto.dsig.Transform>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT>, org.j8unit.repository.javax.xml.crypto.AlgorithmMethodClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.Transform.class!",
                   javax.xml.crypto.dsig.Transform.class.isAssignableFrom(sut));
    }

...
public abstract interface NoInitialContextExceptionClassTests<SUT extends NoInitialContextException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoInitialContextException.class!",
                   NoInitialContextException.class.isAssignableFrom(sut));
    }

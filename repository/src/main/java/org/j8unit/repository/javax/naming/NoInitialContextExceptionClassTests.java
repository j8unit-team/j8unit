 ...
 * javax.naming.NoInitialContextException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link NoInitialContextExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see NoInitialContextExceptionTests NoInitialContextExceptionTests (The complementary j8unit test interface
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NoInitialContextException.class!",
                   javax.naming.NoInitialContextException.class.isAssignableFrom(sut));
    }

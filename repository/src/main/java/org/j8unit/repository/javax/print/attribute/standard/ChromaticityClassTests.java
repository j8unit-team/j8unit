...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.Chromaticity class
 * javax.print.attribute.standard.Chromaticity}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChromaticityTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChromaticityTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.Chromaticity class javax.print.attribute.standard.Chromaticity (the hereby
 *      targeted class-under-test class)
 * @see ChromaticityTests ChromaticityTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ChromaticityClassTests<SUT extends javax.print.attribute.standard.Chromaticity>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.Chromaticity.class!",
                   javax.print.attribute.standard.Chromaticity.class.isAssignableFrom(sut));
    }

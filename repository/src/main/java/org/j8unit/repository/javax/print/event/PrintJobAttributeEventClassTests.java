 ...
 * javax.print.event.PrintJobAttributeEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintJobAttributeEventTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PrintJobAttributeEventTests}.
 * </p>
 *
 * @see javax.print.event.PrintJobAttributeEvent class javax.print.event.PrintJobAttributeEvent (the hereby targeted
 *      class-under-test class)
 * @see PrintJobAttributeEventTests PrintJobAttributeEventTests (The complementary j8unit test interface containing the
...
extends PrintEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.event.PrintJobAttributeEvent.class!",
                   javax.print.event.PrintJobAttributeEvent.class.isAssignableFrom(sut));
    }

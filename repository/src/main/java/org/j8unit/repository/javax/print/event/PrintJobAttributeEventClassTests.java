...
public abstract interface PrintJobAttributeEventClassTests<SUT extends PrintJobAttributeEvent>
extends PrintEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintJobAttributeEvent.class!",

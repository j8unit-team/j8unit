 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextInputCallback
...
public abstract interface TextInputCallbackClassTests<SUT extends TextInputCallback>
extends CallbackClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextInputCallback.class!",
                   TextInputCallback.class.isAssignableFrom(sut));
    }

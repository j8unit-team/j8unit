 ...
 * javax.sql.rowset.spi.SyncFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SyncFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SyncFactoryTests}.
 * </p>
 *
 * @see javax.sql.rowset.spi.SyncFactory class javax.sql.rowset.spi.SyncFactory (the hereby targeted class-under-test
 *      class)
 * @see SyncFactoryTests SyncFactoryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.spi.SyncFactory.class!",
                   javax.sql.rowset.spi.SyncFactory.class.isAssignableFrom(sut));
    }

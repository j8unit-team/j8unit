...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.DialogTypeSelection class
 * javax.print.attribute.standard.DialogTypeSelection}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DialogTypeSelectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DialogTypeSelectionTests}.
 * </p>
 *
 ...
 * @see DialogTypeSelectionTests DialogTypeSelectionTests (The complementary j8unit test interface containing the
...
public abstract interface DialogTypeSelectionClassTests<SUT extends javax.print.attribute.standard.DialogTypeSelection>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.DialogTypeSelection.class!",
                   javax.print.attribute.standard.DialogTypeSelection.class.isAssignableFrom(sut));
    }

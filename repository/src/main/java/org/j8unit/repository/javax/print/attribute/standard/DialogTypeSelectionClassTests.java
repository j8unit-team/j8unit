 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DialogTypeSelection
 * public final class javax.print.attribute.standard.DialogTypeSelection}.
 *
...
public abstract interface DialogTypeSelectionClassTests<SUT extends DialogTypeSelection>
extends PrintRequestAttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DialogTypeSelection.class!",
                   DialogTypeSelection.class.isAssignableFrom(sut));
    }

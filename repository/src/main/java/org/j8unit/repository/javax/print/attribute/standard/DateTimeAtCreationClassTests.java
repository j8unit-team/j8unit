 ...
 * javax.print.attribute.standard.DateTimeAtCreation}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTimeAtCreationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateTimeAtCreationTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.DateTimeAtCreation class javax.print.attribute.standard.DateTimeAtCreation (the
 *      hereby targeted class-under-test class)
 * @see DateTimeAtCreationTests DateTimeAtCreationTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.javax.print.attribute.DateTimeSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.DateTimeAtCreation.class!",
                   javax.print.attribute.standard.DateTimeAtCreation.class.isAssignableFrom(sut));
    }

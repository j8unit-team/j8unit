 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateTimeAtCreation
 * public final class javax.print.attribute.standard.DateTimeAtCreation}.
 *
...
public abstract interface DateTimeAtCreationClassTests<SUT extends DateTimeAtCreation>
extends PrintJobAttributeClassTests<SUT>, DateTimeSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateTimeAtCreation.class!",
                   DateTimeAtCreation.class.isAssignableFrom(sut));
    }

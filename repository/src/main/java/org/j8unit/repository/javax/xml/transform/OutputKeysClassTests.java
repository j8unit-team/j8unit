...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.OutputKeys class javax.xml.transform.OutputKeys},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OutputKeysTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OutputKeysTests}.
 * </p>
 *
 * @see javax.xml.transform.OutputKeys class javax.xml.transform.OutputKeys (the hereby targeted class-under-test class)
 * @see OutputKeysTests OutputKeysTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface OutputKeysClassTests<SUT extends javax.xml.transform.OutputKeys>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.OutputKeys.class!",
                   javax.xml.transform.OutputKeys.class.isAssignableFrom(sut));
    }

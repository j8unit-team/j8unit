 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OutputKeys public
...
public abstract interface OutputKeysClassTests<SUT extends OutputKeys>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OutputKeys.class!",
                   OutputKeys.class.isAssignableFrom(sut));
    }

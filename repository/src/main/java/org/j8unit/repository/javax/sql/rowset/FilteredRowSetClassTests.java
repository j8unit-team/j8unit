 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilteredRowSet
...
public abstract interface FilteredRowSetClassTests<SUT extends FilteredRowSet>
extends WebRowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilteredRowSet.class!",
                   FilteredRowSet.class.isAssignableFrom(sut));
    }

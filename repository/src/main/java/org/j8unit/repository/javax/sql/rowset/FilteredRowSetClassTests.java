 ...
 * javax.sql.rowset.FilteredRowSet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilteredRowSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilteredRowSetTests}.
 * </p>
 *
 * @see javax.sql.rowset.FilteredRowSet interface javax.sql.rowset.FilteredRowSet (the hereby targeted class-under-test
 *      class)
 * @see FilteredRowSetTests FilteredRowSetTests (The complementary j8unit test interface containing the instance
...
public abstract interface FilteredRowSetClassTests<SUT extends javax.sql.rowset.FilteredRowSet>
extends WebRowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.FilteredRowSet.class!",
                   javax.sql.rowset.FilteredRowSet.class.isAssignableFrom(sut));
    }

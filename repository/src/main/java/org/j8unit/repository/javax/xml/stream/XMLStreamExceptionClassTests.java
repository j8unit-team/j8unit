 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLStreamException
 * public class javax.xml.stream.XMLStreamException}.
 *
...
public abstract interface XMLStreamExceptionClassTests<SUT extends XMLStreamException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLStreamException.class!",
                   XMLStreamException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JSlider public
...
public abstract interface JSliderClassTests<SUT extends JSlider>
extends SwingConstantsClassTests<SUT>, AccessibleClassTests<SUT>, JComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JSlider]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JSlider.class!",

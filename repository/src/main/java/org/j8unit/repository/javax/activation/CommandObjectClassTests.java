 ...
 * javax.activation.CommandObject}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CommandObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CommandObjectTests}.
 * </p>
 *
 * @see javax.activation.CommandObject interface javax.activation.CommandObject (the hereby targeted class-under-test
 *      class)
 * @see CommandObjectTests CommandObjectTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CommandObjectClassTests<SUT extends javax.activation.CommandObject>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.CommandObject.class!",
                   javax.activation.CommandObject.class.isAssignableFrom(sut));
    }

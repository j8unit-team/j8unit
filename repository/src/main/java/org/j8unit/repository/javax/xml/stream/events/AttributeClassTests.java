 ...
 * javax.xml.stream.events.Attribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
public abstract interface AttributeClassTests<SUT extends javax.xml.stream.events.Attribute>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.Attribute.class!",
                   javax.xml.stream.events.Attribute.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TimerNotification
 * public class javax.management.timer.TimerNotification}.
 *
...
public abstract interface TimerNotificationClassTests<SUT extends TimerNotification>
extends NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimerNotification.class!",
                   TimerNotification.class.isAssignableFrom(sut));
    }

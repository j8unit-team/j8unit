 ...
 * javax.management.timer.TimerNotification}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimerNotificationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TimerNotificationTests}.
 * </p>
 *
 * @see javax.management.timer.TimerNotification class javax.management.timer.TimerNotification (the hereby targeted
 *      class-under-test class)
 * @see TimerNotificationTests TimerNotificationTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.management.NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.timer.TimerNotification.class!",
                   javax.management.timer.TimerNotification.class.isAssignableFrom(sut));
    }

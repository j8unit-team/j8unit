...
public abstract interface RuntimeMBeanExceptionClassTests<SUT extends RuntimeMBeanException>
extends JMRuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RuntimeMBeanException.class!",
                   RuntimeMBeanException.class.isAssignableFrom(sut));
    }

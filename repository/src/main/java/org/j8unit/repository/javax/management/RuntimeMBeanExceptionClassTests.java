...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.RuntimeMBeanException class
 * javax.management.RuntimeMBeanException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RuntimeMBeanExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RuntimeMBeanExceptionTests}.
 * </p>
 *
 * @see javax.management.RuntimeMBeanException class javax.management.RuntimeMBeanException (the hereby targeted
 *      class-under-test class)
 * @see RuntimeMBeanExceptionTests RuntimeMBeanExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface RuntimeMBeanExceptionClassTests<SUT extends javax.management.RuntimeMBeanException>
extends JMRuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.RuntimeMBeanException.class!",
                   javax.management.RuntimeMBeanException.class.isAssignableFrom(sut));
    }

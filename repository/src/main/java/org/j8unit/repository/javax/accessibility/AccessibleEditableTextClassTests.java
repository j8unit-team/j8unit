...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.accessibility.AccessibleEditableText interface
 * javax.accessibility.AccessibleEditableText}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleEditableTextTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AccessibleEditableTextTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleEditableText interface javax.accessibility.AccessibleEditableText (the hereby
 *      targeted class-under-test class)
 * @see AccessibleEditableTextTests AccessibleEditableTextTests (The complementary j8unit test interface containing the
...
extends AccessibleTextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleEditableText.class!",
                   javax.accessibility.AccessibleEditableText.class.isAssignableFrom(sut));
    }

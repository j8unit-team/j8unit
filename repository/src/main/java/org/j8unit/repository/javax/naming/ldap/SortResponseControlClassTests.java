...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.ldap.SortResponseControl class
 * javax.naming.ldap.SortResponseControl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SortResponseControlTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SortResponseControlTests}.
 * </p>
 *
 * @see javax.naming.ldap.SortResponseControl class javax.naming.ldap.SortResponseControl (the hereby targeted
 *      class-under-test class)
 * @see SortResponseControlTests SortResponseControlTests (The complementary j8unit test interface containing the
...
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.SortResponseControl.class!",
                   javax.naming.ldap.SortResponseControl.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SortResponseControl
 * public final class javax.naming.ldap.SortResponseControl}.
 *
...
public abstract interface SortResponseControlClassTests<SUT extends SortResponseControl>
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SortResponseControl.class!",
                   SortResponseControl.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.management.NotificationFilterSupportTests;
 ...
 * {@link MBeanServerNotificationFilterClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface MBeanServerNotificationFilterTests<SUT extends MBeanServerNotificationFilter>
extends NotificationFilterSupportTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_disableObjectName_ObjectName()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

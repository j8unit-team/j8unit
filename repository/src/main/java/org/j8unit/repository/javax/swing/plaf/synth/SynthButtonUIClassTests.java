 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthButtonUI
...
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthButtonUI.class!",
                   SynthButtonUI.class.isAssignableFrom(sut));
    }

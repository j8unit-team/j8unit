 ...
 * javax.swing.plaf.synth.SynthButtonUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthButtonUITests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthButtonUI class javax.swing.plaf.synth.SynthButtonUI (the hereby targeted
 *      class-under-test class)
 * @see SynthButtonUITests SynthButtonUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.swing.plaf.basic.BasicButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthButtonUI.class!",
                   javax.swing.plaf.synth.SynthButtonUI.class.isAssignableFrom(sut));
    }

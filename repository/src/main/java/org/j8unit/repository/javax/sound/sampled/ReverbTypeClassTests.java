 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReverbType public
...
public abstract interface ReverbTypeClassTests<SUT extends ReverbType>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReverbType.class!",
                   ReverbType.class.isAssignableFrom(sut));
    }

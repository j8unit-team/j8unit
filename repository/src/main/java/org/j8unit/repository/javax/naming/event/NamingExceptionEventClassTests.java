 ...
 * {@link NamingExceptionEvent public class javax.naming.event.NamingExceptionEvent}.
 *
...
public abstract interface NamingExceptionEventClassTests<SUT extends NamingExceptionEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingExceptionEvent.class!",
                   NamingExceptionEvent.class.isAssignableFrom(sut));
    }

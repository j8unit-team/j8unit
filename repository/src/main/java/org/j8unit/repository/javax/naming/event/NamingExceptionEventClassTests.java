 ...
 * javax.naming.event.NamingExceptionEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingExceptionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingExceptionEventTests}
 * .
 * </p>
 *
 * @see javax.naming.event.NamingExceptionEvent class javax.naming.event.NamingExceptionEvent (the hereby targeted
 *      class-under-test class)
 * @see NamingExceptionEventTests NamingExceptionEventTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.event.NamingExceptionEvent.class!",
                   javax.naming.event.NamingExceptionEvent.class.isAssignableFrom(sut));
    }

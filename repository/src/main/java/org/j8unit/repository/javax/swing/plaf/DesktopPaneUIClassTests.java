 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DesktopPaneUI
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DesktopPaneUITests}.
 * </p>
 *
 * <p>
...
public abstract interface DesktopPaneUIClassTests<SUT extends DesktopPaneUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DesktopPaneUI.class!",
                   DesktopPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DesktopPaneUITests}).
 * </p>
 *
 * <p>
 ...
 * @see DesktopPaneUITests DesktopPaneUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DesktopPaneUIClassTests<SUT extends javax.swing.plaf.DesktopPaneUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.DesktopPaneUI.class!",
                   javax.swing.plaf.DesktopPaneUI.class.isAssignableFrom(sut));
    }

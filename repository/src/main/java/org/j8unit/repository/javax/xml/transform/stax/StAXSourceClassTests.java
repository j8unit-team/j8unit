 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StAXSource public
...
public abstract interface StAXSourceClassTests<SUT extends StAXSource>
extends SourceClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.transform.stax.StAXSource]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StAXSource.class!",
                   StAXSource.class.isAssignableFrom(sut));
    }

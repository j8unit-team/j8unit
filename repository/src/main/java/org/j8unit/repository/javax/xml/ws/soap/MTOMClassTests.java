 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MTOMTests}).
 * </p>
 *
 * <p>
 ...
 * @see MTOMTests MTOMTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface MTOMClassTests<SUT extends javax.xml.ws.soap.MTOM>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.soap.MTOM.class!",
                   javax.xml.ws.soap.MTOM.class.isAssignableFrom(sut));
    }

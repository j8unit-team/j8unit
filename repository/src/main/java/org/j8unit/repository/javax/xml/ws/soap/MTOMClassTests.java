 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MTOM public
 * abstract @interface javax.xml.ws.soap.MTOM}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MTOMTests}.
 * </p>
 *
 * <p>
...
public abstract interface MTOMClassTests<SUT extends MTOM>
extends AnnotationClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.ws.soap.MTOM]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MTOM.class!", MTOM.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.ws.soap.MTOM]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.xml.ws.soap.MTOM]

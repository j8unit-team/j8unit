...
public abstract interface IIOWriteWarningListenerClassTests<SUT extends IIOWriteWarningListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOWriteWarningListener.class!",
                   IIOWriteWarningListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.imageio.event.IIOWriteWarningListener interface
 * javax.imageio.event.IIOWriteWarningListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOWriteWarningListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link IIOWriteWarningListenerTests}.
 * </p>
 *
 * @see javax.imageio.event.IIOWriteWarningListener interface javax.imageio.event.IIOWriteWarningListener (the hereby
 *      targeted class-under-test class)
 * @see IIOWriteWarningListenerTests IIOWriteWarningListenerTests (The complementary j8unit test interface containing
...
public abstract interface IIOWriteWarningListenerClassTests<SUT extends javax.imageio.event.IIOWriteWarningListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.event.IIOWriteWarningListener.class!",
                   javax.imageio.event.IIOWriteWarningListener.class.isAssignableFrom(sut));
    }

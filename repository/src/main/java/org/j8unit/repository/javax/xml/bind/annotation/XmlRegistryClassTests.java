...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlRegistry interface
 * javax.xml.bind.annotation.XmlRegistry}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlRegistryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlRegistryTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlRegistry interface javax.xml.bind.annotation.XmlRegistry (the hereby targeted
 *      class-under-test class)
 * @see XmlRegistryTests XmlRegistryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlRegistryClassTests<SUT extends javax.xml.bind.annotation.XmlRegistry>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlRegistry.class!",
                   javax.xml.bind.annotation.XmlRegistry.class.isAssignableFrom(sut));
    }

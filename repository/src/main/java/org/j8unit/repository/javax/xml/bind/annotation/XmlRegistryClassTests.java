 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlRegistry public
 * abstract @interface javax.xml.bind.annotation.XmlRegistry}.
 *
...
public abstract interface XmlRegistryClassTests<SUT extends XmlRegistry>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlRegistry.class!",
                   XmlRegistry.class.isAssignableFrom(sut));
    }

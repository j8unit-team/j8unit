 ...
 * javax.security.auth.spi.LoginModule}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LoginModuleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LoginModuleTests}.
 * </p>
 *
 * @see javax.security.auth.spi.LoginModule interface javax.security.auth.spi.LoginModule (the hereby targeted
 *      class-under-test class)
 * @see LoginModuleTests LoginModuleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LoginModuleClassTests<SUT extends javax.security.auth.spi.LoginModule>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.spi.LoginModule.class!",
                   javax.security.auth.spi.LoginModule.class.isAssignableFrom(sut));
    }

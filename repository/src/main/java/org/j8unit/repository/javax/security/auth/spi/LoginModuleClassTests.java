 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LoginModule public
 * abstract interface javax.security.auth.spi.LoginModule}.
 *
...
public abstract interface LoginModuleClassTests<SUT extends LoginModule>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LoginModule.class!",
                   LoginModule.class.isAssignableFrom(sut));
    }

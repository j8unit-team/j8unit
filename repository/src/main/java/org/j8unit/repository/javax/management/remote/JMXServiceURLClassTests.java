 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMXServiceURL
...
public abstract interface JMXServiceURLClassTests<SUT extends JMXServiceURL>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXServiceURL.class!",
                   JMXServiceURL.class.isAssignableFrom(sut));
    }

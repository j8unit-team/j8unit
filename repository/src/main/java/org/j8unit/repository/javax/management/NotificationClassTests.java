 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotificationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotificationTests}.
 * </p>
 *
 * @see javax.management.Notification class javax.management.Notification (the hereby targeted class-under-test class)
 * @see NotificationTests NotificationTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.Notification.class!",
                   javax.management.Notification.class.isAssignableFrom(sut));
    }

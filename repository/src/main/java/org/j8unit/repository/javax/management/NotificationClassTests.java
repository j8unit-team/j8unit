 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Notification public
...
public abstract interface NotificationClassTests<SUT extends Notification>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Notification.class!",
                   Notification.class.isAssignableFrom(sut));
    }

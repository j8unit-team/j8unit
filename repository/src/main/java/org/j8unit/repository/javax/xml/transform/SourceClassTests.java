...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.Source interface javax.xml.transform.Source},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SourceTests}.
 * </p>
 *
 * @see javax.xml.transform.Source interface javax.xml.transform.Source (the hereby targeted class-under-test class)
 * @see SourceTests SourceTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface SourceClassTests<SUT extends javax.xml.transform.Source>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.Source.class!",
                   javax.xml.transform.Source.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Source public
 * abstract interface javax.xml.transform.Source}.
 *
...
public abstract interface SourceClassTests<SUT extends Source>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Source.class!",
                   Source.class.isAssignableFrom(sut));
    }

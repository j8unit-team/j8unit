 ...
 * javax.management.relation.InvalidRoleInfoException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidRoleInfoExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link InvalidRoleInfoExceptionTests}.
 * </p>
 *
 * @see javax.management.relation.InvalidRoleInfoException class javax.management.relation.InvalidRoleInfoException (the
 *      hereby targeted class-under-test class)
 * @see InvalidRoleInfoExceptionTests InvalidRoleInfoExceptionTests (The complementary j8unit test interface containing
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.InvalidRoleInfoException.class!",
                   javax.management.relation.InvalidRoleInfoException.class.isAssignableFrom(sut));
    }

...
public abstract interface InvalidRoleInfoExceptionClassTests<SUT extends InvalidRoleInfoException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidRoleInfoException.class!",
                   InvalidRoleInfoException.class.isAssignableFrom(sut));
    }

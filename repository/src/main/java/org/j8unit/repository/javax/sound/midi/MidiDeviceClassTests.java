 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiDevice public
 * abstract interface javax.sound.midi.MidiDevice}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MidiDeviceTests}.
 * </p>
 *
 * <p>
...
extends AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiDevice.class!",
     ...
     * {@link Info public static class javax.sound.midi.MidiDevice$Info}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

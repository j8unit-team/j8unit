 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JTabbedPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JTabbedPaneTests}.
 * </p>
 *
 * @see javax.swing.JTabbedPane class javax.swing.JTabbedPane (the hereby targeted class-under-test class)
 * @see JTabbedPaneTests JTabbedPaneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
SwingConstantsClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JTabbedPane.class!",
                   javax.swing.JTabbedPane.class.isAssignableFrom(sut));
    }

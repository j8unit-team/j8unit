 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JTabbedPane public
...
public abstract interface JTabbedPaneClassTests<SUT extends JTabbedPane>
extends AccessibleClassTests<SUT>, SwingConstantsClassTests<SUT>, JComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JTabbedPane]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JTabbedPane.class!",

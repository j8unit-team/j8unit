 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMXConnectorFactory
 * public class javax.management.remote.JMXConnectorFactory}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMXConnectorFactoryTests}.
 * </p>
 *
 * <p>
...
public abstract interface JMXConnectorFactoryClassTests<SUT extends JMXConnectorFactory>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.remote.JMXConnectorFactory]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXConnectorFactory.class!",
                   JMXConnectorFactory.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.remote.JMXConnectorFactory]

 ...
 * javax.crypto.interfaces.DHPrivateKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DHPrivateKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DHPrivateKeyTests}.
 * </p>
 *
 * @see javax.crypto.interfaces.DHPrivateKey interface javax.crypto.interfaces.DHPrivateKey (the hereby targeted
 *      class-under-test class)
 * @see DHPrivateKeyTests DHPrivateKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DHPrivateKeyClassTests<SUT extends javax.crypto.interfaces.DHPrivateKey>
extends DHKeyClassTests<SUT>, org.j8unit.repository.java.security.PrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.interfaces.DHPrivateKey.class!",
                   javax.crypto.interfaces.DHPrivateKey.class.isAssignableFrom(sut));
    }

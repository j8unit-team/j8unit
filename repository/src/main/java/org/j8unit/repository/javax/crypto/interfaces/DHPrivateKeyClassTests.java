 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DHPrivateKey public
 * abstract interface javax.crypto.interfaces.DHPrivateKey}.
 *
...
public abstract interface DHPrivateKeyClassTests<SUT extends DHPrivateKey>
extends DHKeyClassTests<SUT>, PrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DHPrivateKey.class!",

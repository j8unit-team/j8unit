...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.monitor.GaugeMonitorMBean interface
 * javax.management.monitor.GaugeMonitorMBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GaugeMonitorMBeanTests}).
 * </p>
 *
 * <p>
 ...
 * @see GaugeMonitorMBeanTests GaugeMonitorMBeanTests (The complementary j8unit test interface containing the instance
...
public abstract interface GaugeMonitorMBeanClassTests<SUT extends javax.management.monitor.GaugeMonitorMBean>
extends MonitorMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.GaugeMonitorMBean.class!",
                   javax.management.monitor.GaugeMonitorMBean.class.isAssignableFrom(sut));
    }

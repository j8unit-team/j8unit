 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GaugeMonitorMBean
 * public abstract interface javax.management.monitor.GaugeMonitorMBean}.
 *
...
extends org.j8unit.repository.javax.management.monitor.MonitorMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GaugeMonitorMBean.class!",
                   GaugeMonitorMBean.class.isAssignableFrom(sut));
    }

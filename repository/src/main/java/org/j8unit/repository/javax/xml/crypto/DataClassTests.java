 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Data public
...
public abstract interface DataClassTests<SUT extends Data>
extends RepositoryClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.crypto.Data]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Data.class!", Data.class.isAssignableFrom(sut));
    }

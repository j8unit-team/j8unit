 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataTests}.
 * </p>
 *
 * @see javax.xml.crypto.Data interface javax.xml.crypto.Data (the hereby targeted class-under-test class)
 * @see DataTests DataTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DataClassTests<SUT extends javax.xml.crypto.Data>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.Data.class!",
                   javax.xml.crypto.Data.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SpinnerModel public
...
public abstract interface SpinnerModelClassTests<SUT extends SpinnerModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SpinnerModel.class!",

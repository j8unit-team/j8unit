 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExecutableElement
 * public abstract interface javax.lang.model.element.ExecutableElement}.
 *
...
public abstract interface ExecutableElementClassTests<SUT extends ExecutableElement>
extends ParameterizableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExecutableElement.class!",
                   ExecutableElement.class.isAssignableFrom(sut));
    }

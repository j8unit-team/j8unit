 ...
 * javax.management.openmbean.KeyAlreadyExistsException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link KeyAlreadyExistsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see KeyAlreadyExistsExceptionTests KeyAlreadyExistsExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.KeyAlreadyExistsException.class!",
                   javax.management.openmbean.KeyAlreadyExistsException.class.isAssignableFrom(sut));
    }

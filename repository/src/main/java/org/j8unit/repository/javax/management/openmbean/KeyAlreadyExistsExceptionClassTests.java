...
public abstract interface KeyAlreadyExistsExceptionClassTests<SUT extends KeyAlreadyExistsException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyAlreadyExistsException.class!",
                   KeyAlreadyExistsException.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.remote.MBeanServerForwarder}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanServerForwarderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanServerForwarderTests}
 * .
 * </p>
 *
 * @see javax.management.remote.MBeanServerForwarder interface javax.management.remote.MBeanServerForwarder (the hereby
 *      targeted class-under-test class)
 * @see MBeanServerForwarderTests MBeanServerForwarderTests (The complementary j8unit test interface containing the
...
public abstract interface MBeanServerForwarderClassTests<SUT extends javax.management.remote.MBeanServerForwarder>
extends org.j8unit.repository.javax.management.MBeanServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.MBeanServerForwarder.class!",
                   javax.management.remote.MBeanServerForwarder.class.isAssignableFrom(sut));
    }

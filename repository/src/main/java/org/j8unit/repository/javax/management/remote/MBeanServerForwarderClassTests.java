...
import org.j8unit.repository.javax.management.MBeanServerClassTests;
...
public abstract interface MBeanServerForwarderClassTests<SUT extends MBeanServerForwarder>
extends MBeanServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerForwarder.class!",
                   MBeanServerForwarder.class.isAssignableFrom(sut));
    }

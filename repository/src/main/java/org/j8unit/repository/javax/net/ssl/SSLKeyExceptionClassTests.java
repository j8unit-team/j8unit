 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLKeyException
...
public abstract interface SSLKeyExceptionClassTests<SUT extends SSLKeyException>
extends SSLExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.net.ssl.SSLKeyException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLKeyException.class!",
                   SSLKeyException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLKeyExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLKeyExceptionTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLKeyException class javax.net.ssl.SSLKeyException (the hereby targeted class-under-test class)
 * @see SSLKeyExceptionTests SSLKeyExceptionTests (The complementary j8unit test interface containing the instance
...
extends SSLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLKeyException.class!",
                   javax.net.ssl.SSLKeyException.class.isAssignableFrom(sut));
    }

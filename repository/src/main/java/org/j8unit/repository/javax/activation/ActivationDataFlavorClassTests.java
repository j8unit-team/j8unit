 ...
 * javax.activation.ActivationDataFlavor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationDataFlavorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActivationDataFlavorTests}
 * .
 * </p>
 *
 * @see javax.activation.ActivationDataFlavor class javax.activation.ActivationDataFlavor (the hereby targeted
 *      class-under-test class)
 * @see ActivationDataFlavorTests ActivationDataFlavorTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.awt.datatransfer.DataFlavorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.ActivationDataFlavor.class!",
                   javax.activation.ActivationDataFlavor.class.isAssignableFrom(sut));
    }

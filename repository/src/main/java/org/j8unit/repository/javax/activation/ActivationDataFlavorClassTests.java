...
import org.j8unit.repository.java.awt.datatransfer.DataFlavorClassTests;
 ...
 * {@link ActivationDataFlavor public class javax.activation.ActivationDataFlavor}.
 *
...
public abstract interface ActivationDataFlavorClassTests<SUT extends ActivationDataFlavor>
extends DataFlavorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationDataFlavor.class!",
                   ActivationDataFlavor.class.isAssignableFrom(sut));
    }

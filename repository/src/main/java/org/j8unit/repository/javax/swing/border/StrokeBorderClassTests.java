 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StrokeBorder public
...
public abstract interface StrokeBorderClassTests<SUT extends StrokeBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StrokeBorder.class!",
                   StrokeBorder.class.isAssignableFrom(sut));
    }

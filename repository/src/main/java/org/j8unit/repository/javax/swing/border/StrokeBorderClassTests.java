 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StrokeBorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StrokeBorderTests}.
 * </p>
 *
 * @see javax.swing.border.StrokeBorder class javax.swing.border.StrokeBorder (the hereby targeted class-under-test
 *      class)
 * @see StrokeBorderTests StrokeBorderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StrokeBorderClassTests<SUT extends javax.swing.border.StrokeBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.StrokeBorder.class!",
                   javax.swing.border.StrokeBorder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RepaintManager
...
public abstract interface RepaintManagerClassTests<SUT extends RepaintManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RepaintManager.class!",
                   RepaintManager.class.isAssignableFrom(sut));
    }

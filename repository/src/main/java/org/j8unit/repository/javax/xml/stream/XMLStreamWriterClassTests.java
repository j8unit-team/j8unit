 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLStreamWriter
...
public abstract interface XMLStreamWriterClassTests<SUT extends XMLStreamWriter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLStreamWriter.class!",
                   XMLStreamWriter.class.isAssignableFrom(sut));
    }

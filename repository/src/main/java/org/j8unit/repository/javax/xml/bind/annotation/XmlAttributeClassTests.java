 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAttribute public
 * abstract @interface javax.xml.bind.annotation.XmlAttribute}.
 *
...
public abstract interface XmlAttributeClassTests<SUT extends XmlAttribute>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAttribute.class!",
                   XmlAttribute.class.isAssignableFrom(sut));
    }

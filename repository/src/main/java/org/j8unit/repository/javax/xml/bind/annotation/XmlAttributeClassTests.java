...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlAttribute interface
 * javax.xml.bind.annotation.XmlAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlAttributeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlAttributeTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlAttribute interface javax.xml.bind.annotation.XmlAttribute (the hereby targeted
 *      class-under-test class)
 * @see XmlAttributeTests XmlAttributeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XmlAttributeClassTests<SUT extends javax.xml.bind.annotation.XmlAttribute>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlAttribute.class!",
                   javax.xml.bind.annotation.XmlAttribute.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DHKey public
...
public abstract interface DHKeyClassTests<SUT extends DHKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DHKey.class!", DHKey.class.isAssignableFrom(sut));
    }

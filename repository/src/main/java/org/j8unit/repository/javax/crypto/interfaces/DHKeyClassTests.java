...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.interfaces.DHKey interface javax.crypto.interfaces.DHKey}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DHKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DHKeyTests}.
 * </p>
 *
 * @see javax.crypto.interfaces.DHKey interface javax.crypto.interfaces.DHKey (the hereby targeted class-under-test
 *      class)
 * @see DHKeyTests DHKeyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DHKeyClassTests<SUT extends javax.crypto.interfaces.DHKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.interfaces.DHKey.class!",
                   javax.crypto.interfaces.DHKey.class.isAssignableFrom(sut));
    }

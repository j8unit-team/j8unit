 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicTableHeaderUI
 * public class javax.swing.plaf.basic.BasicTableHeaderUI}.
 *
...
public abstract interface BasicTableHeaderUIClassTests<SUT extends BasicTableHeaderUI>
extends TableHeaderUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicTableHeaderUI.class!",
                   BasicTableHeaderUI.class.isAssignableFrom(sut));
    }
     ...
     * {@link MouseInputHandler public class javax.swing.plaf.basic.BasicTableHeaderUI$MouseInputHandler}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

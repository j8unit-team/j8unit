...
import org.j8unit.repository.javax.net.SocketFactoryClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLSocketFactory
...
public abstract interface SSLSocketFactoryClassTests<SUT extends SSLSocketFactory>
extends SocketFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLSocketFactory.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLSocketFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLSocketFactoryTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLSocketFactory class javax.net.ssl.SSLSocketFactory (the hereby targeted class-under-test class)
 * @see SSLSocketFactoryTests SSLSocketFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface SSLSocketFactoryClassTests<SUT extends javax.net.ssl.SSLSocketFactory>
extends org.j8unit.repository.javax.net.SocketFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLSocketFactory.class!",
                   javax.net.ssl.SSLSocketFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TableColumn public
...
public abstract interface TableColumnClassTests<SUT extends TableColumn>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.table.TableColumn]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableColumn.class!",
                   TableColumn.class.isAssignableFrom(sut));
    }

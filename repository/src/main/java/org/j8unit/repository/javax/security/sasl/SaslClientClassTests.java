 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SaslClient public
 * abstract interface javax.security.sasl.SaslClient}.
 *
...
public abstract interface SaslClientClassTests<SUT extends SaslClient>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SaslClient.class!",
                   SaslClient.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.sasl.SaslClient}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SaslClientTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SaslClientTests}.
 * </p>
 *
 * @see javax.security.sasl.SaslClient interface javax.security.sasl.SaslClient (the hereby targeted class-under-test
 *      class)
 * @see SaslClientTests SaslClientTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SaslClientClassTests<SUT extends javax.security.sasl.SaslClient>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.SaslClient.class!",
                   javax.security.sasl.SaslClient.class.isAssignableFrom(sut));
    }

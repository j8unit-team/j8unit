 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ViewFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ViewFactoryTests}.
 * </p>
 *
 * @see javax.swing.text.ViewFactory interface javax.swing.text.ViewFactory (the hereby targeted class-under-test class)
 * @see ViewFactoryTests ViewFactoryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ViewFactoryClassTests<SUT extends javax.swing.text.ViewFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.ViewFactory.class!",
                   javax.swing.text.ViewFactory.class.isAssignableFrom(sut));
    }

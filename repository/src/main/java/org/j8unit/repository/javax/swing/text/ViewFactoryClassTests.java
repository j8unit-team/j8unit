 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ViewFactory public
...
public abstract interface ViewFactoryClassTests<SUT extends ViewFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ViewFactory.class!",

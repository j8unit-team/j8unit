 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameClassPair
...
public abstract interface NameClassPairClassTests<SUT extends NameClassPair>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.naming.NameClassPair]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameClassPair.class!",
                   NameClassPair.class.isAssignableFrom(sut));
    }

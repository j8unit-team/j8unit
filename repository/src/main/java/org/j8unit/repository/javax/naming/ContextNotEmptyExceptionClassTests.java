 ...
 * {@link ContextNotEmptyException public class javax.naming.ContextNotEmptyException}.
 *
...
public abstract interface ContextNotEmptyExceptionClassTests<SUT extends ContextNotEmptyException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContextNotEmptyException.class!",
                   ContextNotEmptyException.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.ContextNotEmptyException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContextNotEmptyExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ContextNotEmptyExceptionTests}.
 * </p>
 *
 * @see javax.naming.ContextNotEmptyException class javax.naming.ContextNotEmptyException (the hereby targeted
 *      class-under-test class)
 * @see ContextNotEmptyExceptionTests ContextNotEmptyExceptionTests (The complementary j8unit test interface containing
...
public abstract interface ContextNotEmptyExceptionClassTests<SUT extends javax.naming.ContextNotEmptyException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ContextNotEmptyException.class!",
                   javax.naming.ContextNotEmptyException.class.isAssignableFrom(sut));
    }

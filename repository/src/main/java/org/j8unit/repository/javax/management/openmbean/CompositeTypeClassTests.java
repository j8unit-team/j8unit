 ...
 * javax.management.openmbean.CompositeType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompositeTypeTests}.
 * </p>
 *
 * @see javax.management.openmbean.CompositeType class javax.management.openmbean.CompositeType (the hereby targeted
 *      class-under-test class)
 * @see CompositeTypeTests CompositeTypeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends OpenTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.CompositeType.class!",
                   javax.management.openmbean.CompositeType.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompositeType
 * public class javax.management.openmbean.CompositeType}.
 *
...
public abstract interface CompositeTypeClassTests<SUT extends CompositeType>
extends OpenTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompositeType.class!",
                   CompositeType.class.isAssignableFrom(sut));
    }

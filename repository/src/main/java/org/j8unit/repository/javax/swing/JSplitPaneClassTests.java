 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JSplitPane public
...
public abstract interface JSplitPaneClassTests<SUT extends JSplitPane>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JSplitPane.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JSplitPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JSplitPaneTests}.
 * </p>
 *
 * @see javax.swing.JSplitPane class javax.swing.JSplitPane (the hereby targeted class-under-test class)
 * @see JSplitPaneTests JSplitPaneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JSplitPaneClassTests<SUT extends javax.swing.JSplitPane>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JSplitPane.class!",
                   javax.swing.JSplitPane.class.isAssignableFrom(sut));
    }

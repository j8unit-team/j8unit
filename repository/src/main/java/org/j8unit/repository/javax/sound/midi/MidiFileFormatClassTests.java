...
/**
 * <p>
 * Test class for {@link javax.sound.midi.MidiFileFormat class javax.sound.midi.MidiFileFormat}, containing all class
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.sound.midi.MidiFileFormat sut = null; // = new MidiFileFormat(int,float,int,int,long,java.util.Map);
    }
    ...
    throws Exception {
        // create new instance
        final Class<? extends javax.sound.midi.MidiFileFormat> sut = createNewSUT();

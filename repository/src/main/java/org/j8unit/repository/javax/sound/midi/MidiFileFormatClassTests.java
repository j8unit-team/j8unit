 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiFileFormat
 * public class javax.sound.midi.MidiFileFormat}.
 *
...
public abstract interface MidiFileFormatClassTests<SUT extends MidiFileFormat>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiFileFormat.class!",
                   MidiFileFormat.class.isAssignableFrom(sut));
    }

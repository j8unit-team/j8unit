 ...
 * javax.management.monitor.MonitorSettingException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MonitorSettingExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link MonitorSettingExceptionTests}.
 * </p>
 *
 * @see javax.management.monitor.MonitorSettingException class javax.management.monitor.MonitorSettingException (the
 *      hereby targeted class-under-test class)
 * @see MonitorSettingExceptionTests MonitorSettingExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.management.JMRuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.MonitorSettingException.class!",
                   javax.management.monitor.MonitorSettingException.class.isAssignableFrom(sut));
    }

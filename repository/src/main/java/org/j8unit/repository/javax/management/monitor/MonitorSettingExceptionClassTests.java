...
import org.j8unit.repository.javax.management.JMRuntimeExceptionClassTests;
...
public abstract interface MonitorSettingExceptionClassTests<SUT extends MonitorSettingException>
extends JMRuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MonitorSettingException.class!",

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebEndpoint public
 * abstract @interface javax.xml.ws.WebEndpoint}.
 *
...
public abstract interface WebEndpointClassTests<SUT extends WebEndpoint>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebEndpoint.class!",
                   WebEndpoint.class.isAssignableFrom(sut));
    }

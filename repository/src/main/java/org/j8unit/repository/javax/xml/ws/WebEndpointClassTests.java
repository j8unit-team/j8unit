 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebEndpointTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebEndpointTests}.
 * </p>
 *
 * @see javax.xml.ws.WebEndpoint interface javax.xml.ws.WebEndpoint (the hereby targeted class-under-test class)
 * @see WebEndpointTests WebEndpointTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WebEndpointClassTests<SUT extends javax.xml.ws.WebEndpoint>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebEndpoint.class!",
                   javax.xml.ws.WebEndpoint.class.isAssignableFrom(sut));
    }

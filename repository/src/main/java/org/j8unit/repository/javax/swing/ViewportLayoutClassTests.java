 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ViewportLayout
...
public abstract interface ViewportLayoutClassTests<SUT extends ViewportLayout>
extends LayoutManagerClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ViewportLayout.class!",

 ...
 * javax.swing.text.InternationalFormatter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InternationalFormatterTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InternationalFormatterTests}.
 * </p>
 *
 * @see javax.swing.text.InternationalFormatter class javax.swing.text.InternationalFormatter (the hereby targeted
 *      class-under-test class)
 * @see InternationalFormatterTests InternationalFormatterTests (The complementary j8unit test interface containing the
...
extends DefaultFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.InternationalFormatter.class!",
                   javax.swing.text.InternationalFormatter.class.isAssignableFrom(sut));
    }

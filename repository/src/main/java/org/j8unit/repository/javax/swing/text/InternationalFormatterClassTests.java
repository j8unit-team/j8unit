...
public abstract interface InternationalFormatterClassTests<SUT extends InternationalFormatter>
extends DefaultFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InternationalFormatter.class!",
                   InternationalFormatter.class.isAssignableFrom(sut));
    }

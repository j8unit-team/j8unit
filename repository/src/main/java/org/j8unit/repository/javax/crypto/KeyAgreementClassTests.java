 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyAgreement public
...
public abstract interface KeyAgreementClassTests<SUT extends KeyAgreement>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyAgreement.class!",
                   KeyAgreement.class.isAssignableFrom(sut));
    }

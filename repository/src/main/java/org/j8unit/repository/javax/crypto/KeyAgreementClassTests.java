 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyAgreementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyAgreementTests}.
 * </p>
 *
 * @see javax.crypto.KeyAgreement class javax.crypto.KeyAgreement (the hereby targeted class-under-test class)
 * @see KeyAgreementTests KeyAgreementTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.KeyAgreement.class!",
                   javax.crypto.KeyAgreement.class.isAssignableFrom(sut));
    }

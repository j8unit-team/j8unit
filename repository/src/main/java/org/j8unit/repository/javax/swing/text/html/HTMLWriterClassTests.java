 ...
 * javax.swing.text.html.HTMLWriter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTMLWriterTests}.
 * </p>
 *
 * @see javax.swing.text.html.HTMLWriter class javax.swing.text.html.HTMLWriter (the hereby targeted class-under-test
 *      class)
 * @see HTMLWriterTests HTMLWriterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.text.AbstractWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.HTMLWriter.class!",
                   javax.swing.text.html.HTMLWriter.class.isAssignableFrom(sut));
    }

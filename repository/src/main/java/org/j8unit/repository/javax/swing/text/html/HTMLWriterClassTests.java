 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLWriter public
...
public abstract interface HTMLWriterClassTests<SUT extends HTMLWriter>
extends AbstractWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLWriter.class!",
                   HTMLWriter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JLayeredPane public
...
public abstract interface JLayeredPaneClassTests<SUT extends JLayeredPane>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JLayeredPane.class!",
                   JLayeredPane.class.isAssignableFrom(sut));
    }

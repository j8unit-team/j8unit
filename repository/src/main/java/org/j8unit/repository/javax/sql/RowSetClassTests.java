...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.RowSet interface javax.sql.RowSet}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetTests}.
 * </p>
 *
 * @see javax.sql.RowSet interface javax.sql.RowSet (the hereby targeted class-under-test class)
 * @see RowSetTests RowSetTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.sql.ResultSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.RowSet.class!",
                   javax.sql.RowSet.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.sql.ResultSetClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSet public
...
public abstract interface RowSetClassTests<SUT extends RowSet>
extends ResultSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSet.class!",
                   RowSet.class.isAssignableFrom(sut));
    }

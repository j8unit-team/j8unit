 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Receiver public
 * abstract interface javax.sound.midi.Receiver}.
 *
...
public abstract interface ReceiverClassTests<SUT extends Receiver>
extends AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Receiver.class!",
                   Receiver.class.isAssignableFrom(sut));
    }

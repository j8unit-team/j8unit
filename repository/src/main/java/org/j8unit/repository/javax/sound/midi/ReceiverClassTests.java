 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReceiverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReceiverTests}.
 * </p>
 *
 * @see javax.sound.midi.Receiver interface javax.sound.midi.Receiver (the hereby targeted class-under-test class)
 * @see ReceiverTests ReceiverTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ReceiverClassTests<SUT extends javax.sound.midi.Receiver>
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Receiver.class!",
                   javax.sound.midi.Receiver.class.isAssignableFrom(sut));
    }

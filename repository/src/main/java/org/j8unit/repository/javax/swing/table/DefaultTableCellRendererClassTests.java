...
extends TableCellRendererClassTests<SUT>, JLabelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultTableCellRenderer.class!",
                   DefaultTableCellRenderer.class.isAssignableFrom(sut));
    }
     ...
     * {@link UIResource public static class javax.swing.table.DefaultTableCellRenderer$UIResource}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

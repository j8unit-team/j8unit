 ...
 * javax.swing.table.DefaultTableCellRenderer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultTableCellRendererTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.table.DefaultTableCellRenderer class javax.swing.table.DefaultTableCellRenderer (the hereby targeted
 *      class-under-test class)
 * @see DefaultTableCellRendererTests DefaultTableCellRendererTests (The complementary j8unit test interface containing
...
extends TableCellRendererClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.javax.swing.JLabelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.table.DefaultTableCellRenderer.class!",
                   javax.swing.table.DefaultTableCellRenderer.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.table.DefaultTableCellRenderer.UIResource class
     * javax.swing.table.DefaultTableCellRenderer$UIResource}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link DefaultTableCellRendererTests.UIResourceTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.table.DefaultTableCellRenderer.UIResource class
     *      javax.swing.table.DefaultTableCellRenderer$UIResource (the hereby targeted class-under-test class)
     * @see DefaultTableCellRendererTests.UIResourceTests DefaultTableCellRendererTests.UIResourceTests (The
    ...
    extends org.j8unit.repository.javax.swing.plaf.UIResourceClassTests<SUT>, DefaultTableCellRendererClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.table.DefaultTableCellRenderer.UIResource.class!",
                       javax.swing.table.DefaultTableCellRenderer.UIResource.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlSeeAlso public
 * abstract @interface javax.xml.bind.annotation.XmlSeeAlso}.
 *
...
public abstract interface XmlSeeAlsoClassTests<SUT extends XmlSeeAlso>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlSeeAlso.class!",
                   XmlSeeAlso.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlSeeAlso interface
 * javax.xml.bind.annotation.XmlSeeAlso}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlSeeAlsoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlSeeAlsoTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlSeeAlso interface javax.xml.bind.annotation.XmlSeeAlso (the hereby targeted
 *      class-under-test class)
 * @see XmlSeeAlsoTests XmlSeeAlsoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlSeeAlsoClassTests<SUT extends javax.xml.bind.annotation.XmlSeeAlso>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlSeeAlso.class!",
                   javax.xml.bind.annotation.XmlSeeAlso.class.isAssignableFrom(sut));
    }

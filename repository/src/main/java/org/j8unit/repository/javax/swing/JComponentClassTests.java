 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JComponent public
...
extends ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JComponent.class!",
                   JComponent.class.isAssignableFrom(sut));
    }
    ...
    extends AccessibleExtendedComponentClassTests<SUT>, SerializableClassTests<SUT>, AccessibleContextClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleJComponent.class!",
                              AccessibleJComponent.class.isAssignableFrom(sut));
        }

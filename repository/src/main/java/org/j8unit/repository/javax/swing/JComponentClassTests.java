...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JComponent class javax.swing.JComponent}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JComponentTests}).
 * </p>
 *
 * <p>
 ...
 * @see JComponentTests JComponentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.awt.ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JComponent.class!",
                   javax.swing.JComponent.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JComponent.AccessibleJComponent class
     * javax.swing.JComponent$AccessibleJComponent}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link JComponentTests.AccessibleJComponentTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see JComponentTests.AccessibleJComponentTests JComponentTests.AccessibleJComponentTests (The complementary
    ...
    org.j8unit.repository.javax.accessibility.AccessibleComponentClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleContextClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JComponent.AccessibleJComponent.class!",
                       javax.swing.JComponent.AccessibleJComponent.class.isAssignableFrom(sut));
        }

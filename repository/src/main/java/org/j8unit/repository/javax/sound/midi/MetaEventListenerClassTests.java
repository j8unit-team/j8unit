 ...
 * javax.sound.midi.MetaEventListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetaEventListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MetaEventListenerTests}.
 * </p>
 *
 * @see javax.sound.midi.MetaEventListener interface javax.sound.midi.MetaEventListener (the hereby targeted
 *      class-under-test class)
 * @see MetaEventListenerTests MetaEventListenerTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.MetaEventListener.class!",
                   javax.sound.midi.MetaEventListener.class.isAssignableFrom(sut));
    }

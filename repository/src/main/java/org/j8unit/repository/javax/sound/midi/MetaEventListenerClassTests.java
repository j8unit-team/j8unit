 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetaEventListener
 * public abstract interface javax.sound.midi.MetaEventListener}.
 *
...
public abstract interface MetaEventListenerClassTests<SUT extends MetaEventListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetaEventListener.class!",
                   MetaEventListener.class.isAssignableFrom(sut));
    }

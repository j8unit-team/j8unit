...
/**
 * <p>
 * Test class for {@link javax.rmi.CORBA.ValueHandler interface javax.rmi.CORBA.ValueHandler}, containing all instance
...
extends J8UnitTest<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_isCustomMarshaled_Class()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

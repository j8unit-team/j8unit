 ...
 * {@link EncryptedPrivateKeyInfo public class javax.crypto.EncryptedPrivateKeyInfo}.
 *
...
public abstract interface EncryptedPrivateKeyInfoClassTests<SUT extends EncryptedPrivateKeyInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EncryptedPrivateKeyInfo.class!",
                   EncryptedPrivateKeyInfo.class.isAssignableFrom(sut));
    }

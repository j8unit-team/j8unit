 ...
 * javax.crypto.EncryptedPrivateKeyInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EncryptedPrivateKeyInfoTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link EncryptedPrivateKeyInfoTests}.
 * </p>
 *
 * @see javax.crypto.EncryptedPrivateKeyInfo class javax.crypto.EncryptedPrivateKeyInfo (the hereby targeted
 *      class-under-test class)
 * @see EncryptedPrivateKeyInfoTests EncryptedPrivateKeyInfoTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.EncryptedPrivateKeyInfo.class!",
                   javax.crypto.EncryptedPrivateKeyInfo.class.isAssignableFrom(sut));
    }

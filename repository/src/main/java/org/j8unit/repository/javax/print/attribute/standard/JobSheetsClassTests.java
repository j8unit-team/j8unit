...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.JobSheets class
 * javax.print.attribute.standard.JobSheets}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobSheetsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobSheetsTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.JobSheets class javax.print.attribute.standard.JobSheets (the hereby targeted
 *      class-under-test class)
 * @see JobSheetsTests JobSheetsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JobSheetsClassTests<SUT extends javax.print.attribute.standard.JobSheets>
...
org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobSheets.class!",
                   javax.print.attribute.standard.JobSheets.class.isAssignableFrom(sut));
    }

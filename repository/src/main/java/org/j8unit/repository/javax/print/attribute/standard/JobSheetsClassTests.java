 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobSheets public
...
public abstract interface JobSheetsClassTests<SUT extends JobSheets>
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobSheets.class!",
                   JobSheets.class.isAssignableFrom(sut));
    }

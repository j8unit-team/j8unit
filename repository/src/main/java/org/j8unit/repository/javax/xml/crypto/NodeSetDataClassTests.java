 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NodeSetDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NodeSetDataTests}.
 * </p>
 *
 * @see javax.xml.crypto.NodeSetData interface javax.xml.crypto.NodeSetData (the hereby targeted class-under-test class)
 * @see NodeSetDataTests NodeSetDataTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends DataClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.NodeSetData.class!",
                   javax.xml.crypto.NodeSetData.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NodeSetData public
 * abstract interface javax.xml.crypto.NodeSetData}.
 *
...
public abstract interface NodeSetDataClassTests<SUT extends NodeSetData>
extends DataClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NodeSetData.class!",
                   NodeSetData.class.isAssignableFrom(sut));
    }

...
public abstract interface AccessibleExtendedComponentClassTests<SUT extends AccessibleExtendedComponent>
extends org.j8unit.repository.javax.accessibility.AccessibleComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleExtendedComponent.class!",
                   AccessibleExtendedComponent.class.isAssignableFrom(sut));
    }

 ...
 * javax.accessibility.AccessibleExtendedComponent}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AccessibleExtendedComponentTests}).
 * </p>
 *
 * <p>
 ...
 * @see AccessibleExtendedComponentTests AccessibleExtendedComponentTests (The complementary j8unit test interface
...
extends AccessibleComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleExtendedComponent.class!",
                   javax.accessibility.AccessibleExtendedComponent.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.MBeanRegistrationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link MBeanRegistrationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see MBeanRegistrationExceptionTests MBeanRegistrationExceptionTests (The complementary j8unit test interface
...
extends MBeanExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanRegistrationException.class!",
                   javax.management.MBeanRegistrationException.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.sql.ClobClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerialClob public
...
public abstract interface SerialClobClassTests<SUT extends SerialClob>
extends ClobClassTests<SUT>, SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerialClob.class!",
                   SerialClob.class.isAssignableFrom(sut));
    }

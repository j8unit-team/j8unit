 ...
 * javax.sql.rowset.serial.SerialClob}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerialClobTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SerialClobTests}.
 * </p>
 *
 * @see javax.sql.rowset.serial.SerialClob class javax.sql.rowset.serial.SerialClob (the hereby targeted
 *      class-under-test class)
 * @see SerialClobTests SerialClobTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SerialClobClassTests<SUT extends javax.sql.rowset.serial.SerialClob>
...
org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SerialClob.class!",
                   javax.sql.rowset.serial.SerialClob.class.isAssignableFrom(sut));
    }

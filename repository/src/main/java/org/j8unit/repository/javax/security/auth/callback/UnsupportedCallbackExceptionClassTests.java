 ...
 * {@link UnsupportedCallbackException public class javax.security.auth.callback.UnsupportedCallbackException}.
 *
...
public abstract interface UnsupportedCallbackExceptionClassTests<SUT extends UnsupportedCallbackException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedCallbackException.class!",
                   UnsupportedCallbackException.class.isAssignableFrom(sut));
    }

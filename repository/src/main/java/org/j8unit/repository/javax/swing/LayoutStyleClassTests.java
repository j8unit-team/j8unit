 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LayoutStyle public
 * abstract class javax.swing.LayoutStyle}.
 *
...
public abstract interface LayoutStyleClassTests<SUT extends LayoutStyle>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LayoutStyle.class!",
                   LayoutStyle.class.isAssignableFrom(sut));
    }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ComponentPlacementClassTests<SUT extends ComponentPlacement>
    extends EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentPlacement.class!",
                              ComponentPlacement.class.isAssignableFrom(sut));
        }

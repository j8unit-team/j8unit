 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalFileChooserUI
 * public class javax.swing.plaf.metal.MetalFileChooserUI}.
 *
...
public abstract interface MetalFileChooserUIClassTests<SUT extends MetalFileChooserUI>
extends BasicFileChooserUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalFileChooserUI.class!",
                   MetalFileChooserUI.class.isAssignableFrom(sut));
    }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FilterComboBoxRendererClassTests<SUT extends FilterComboBoxRenderer>
    extends DefaultListCellRendererClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilterComboBoxRenderer.class!",
                              FilterComboBoxRenderer.class.isAssignableFrom(sut));
        }

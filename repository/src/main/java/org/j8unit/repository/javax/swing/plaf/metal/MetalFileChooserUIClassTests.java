...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.plaf.metal.MetalFileChooserUI class
 * javax.swing.plaf.metal.MetalFileChooserUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetalFileChooserUITests}).
 * </p>
 *
 * <p>
 ...
 * @see MetalFileChooserUITests MetalFileChooserUITests (The complementary j8unit test interface containing the instance
...
public abstract interface MetalFileChooserUIClassTests<SUT extends javax.swing.plaf.metal.MetalFileChooserUI>
extends org.j8unit.repository.javax.swing.plaf.basic.BasicFileChooserUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalFileChooserUI.class!",
                   javax.swing.plaf.metal.MetalFileChooserUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.metal.MetalFileChooserUI.FilterComboBoxRenderer
     * class javax.swing.plaf.metal.MetalFileChooserUI$FilterComboBoxRenderer}, containing all type relevant aspects
     ...
     * {@link MetalFileChooserUITests.FilterComboBoxRendererTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see MetalFileChooserUITests.FilterComboBoxRendererTests MetalFileChooserUITests.FilterComboBoxRendererTests (The
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FilterComboBoxRendererClassTests<SUT extends javax.swing.plaf.metal.MetalFileChooserUI.FilterComboBoxRenderer>
    extends org.j8unit.repository.javax.swing.DefaultListCellRendererClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalFileChooserUI.FilterComboBoxRenderer.class!",
                       javax.swing.plaf.metal.MetalFileChooserUI.FilterComboBoxRenderer.class.isAssignableFrom(sut));
        }

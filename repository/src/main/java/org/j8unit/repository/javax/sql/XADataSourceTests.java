 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link XADataSource
 * public abstract interface javax.sql.XADataSource}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.sql.XADataSourceClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface XADataSourceTests<SUT extends XADataSource>
extends org.j8unit.repository.javax.sql.CommonDataSourceTests<SUT> {
    ...
    public default void test_getXAConnection_String_String()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getXAConnection()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

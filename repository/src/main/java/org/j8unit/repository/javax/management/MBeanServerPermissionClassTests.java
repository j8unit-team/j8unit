 ...
 * javax.management.MBeanServerPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanServerPermissionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MBeanServerPermissionTests}.
 * </p>
 *
 * @see javax.management.MBeanServerPermission class javax.management.MBeanServerPermission (the hereby targeted
 *      class-under-test class)
 * @see MBeanServerPermissionTests MBeanServerPermissionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanServerPermission.class!",
                   javax.management.MBeanServerPermission.class.isAssignableFrom(sut));
    }

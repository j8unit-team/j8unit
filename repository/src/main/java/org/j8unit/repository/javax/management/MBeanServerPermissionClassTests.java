...
public abstract interface MBeanServerPermissionClassTests<SUT extends MBeanServerPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerPermission.class!",
                   MBeanServerPermission.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DatatypeConstants
...
public abstract interface DatatypeConstantsClassTests<SUT extends DatatypeConstants>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatatypeConstants.class!",
                   DatatypeConstants.class.isAssignableFrom(sut));
    }
     ...
     * {@link Field public static final class javax.xml.datatype.DatatypeConstants$Field}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

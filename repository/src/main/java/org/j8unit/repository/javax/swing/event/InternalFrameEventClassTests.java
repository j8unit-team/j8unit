 ...
 * javax.swing.event.InternalFrameEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InternalFrameEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see InternalFrameEventTests InternalFrameEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.InternalFrameEvent.class!",
                   javax.swing.event.InternalFrameEvent.class.isAssignableFrom(sut));
    }

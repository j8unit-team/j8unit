 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InternalFrameEvent
 * public class javax.swing.event.InternalFrameEvent}.
 *
...
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InternalFrameEvent.class!",
                   InternalFrameEvent.class.isAssignableFrom(sut));
    }

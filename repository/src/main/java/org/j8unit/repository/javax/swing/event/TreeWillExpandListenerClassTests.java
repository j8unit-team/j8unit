...
public abstract interface TreeWillExpandListenerClassTests<SUT extends TreeWillExpandListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeWillExpandListener.class!",
                   TreeWillExpandListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.event.TreeWillExpandListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeWillExpandListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link TreeWillExpandListenerTests}.
 * </p>
 *
 * @see javax.swing.event.TreeWillExpandListener interface javax.swing.event.TreeWillExpandListener (the hereby targeted
 *      class-under-test class)
 * @see TreeWillExpandListenerTests TreeWillExpandListenerTests (The complementary j8unit test interface containing the
...
public abstract interface TreeWillExpandListenerClassTests<SUT extends javax.swing.event.TreeWillExpandListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TreeWillExpandListener.class!",
                   javax.swing.event.TreeWillExpandListener.class.isAssignableFrom(sut));
    }

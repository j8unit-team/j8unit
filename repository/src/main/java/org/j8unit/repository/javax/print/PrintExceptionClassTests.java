 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintException
...
public abstract interface PrintExceptionClassTests<SUT extends PrintException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintException.class!",
                   PrintException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintExceptionTests}.
 * </p>
 *
 * @see javax.print.PrintException class javax.print.PrintException (the hereby targeted class-under-test class)
 * @see PrintExceptionTests PrintExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface PrintExceptionClassTests<SUT extends javax.print.PrintException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.PrintException.class!",
                   javax.print.PrintException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleIcon
 * public abstract interface javax.accessibility.AccessibleIcon}.
 *
...
public abstract interface AccessibleIconClassTests<SUT extends AccessibleIcon>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleIcon.class!",
                   AccessibleIcon.class.isAssignableFrom(sut));
    }

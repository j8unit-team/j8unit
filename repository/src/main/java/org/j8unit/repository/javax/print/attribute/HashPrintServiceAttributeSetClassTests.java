...
public abstract interface HashPrintServiceAttributeSetClassTests<SUT extends HashPrintServiceAttributeSet>
...
org.j8unit.repository.javax.print.attribute.HashAttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HashPrintServiceAttributeSet.class!",
                   HashPrintServiceAttributeSet.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProtocolException
 * public class javax.xml.ws.ProtocolException}.
 *
...
extends WebServiceExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProtocolException.class!",
                   ProtocolException.class.isAssignableFrom(sut));
    }

...
extends WebServiceExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.ProtocolException.class!",
                   javax.xml.ws.ProtocolException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMXConnectorServer
 * public abstract class javax.management.remote.JMXConnectorServer}.
 *
...
public abstract interface JMXConnectorServerClassTests<SUT extends JMXConnectorServer>
extends JMXConnectorServerMBeanClassTests<SUT>, MBeanRegistrationClassTests<SUT>, JMXAddressableClassTests<SUT>, NotificationBroadcasterSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXConnectorServer.class!",

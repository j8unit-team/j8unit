...
org.j8unit.repository.javax.management.NotificationBroadcasterSupportClassTests<SUT> {
    ...
    public default void create_JMXConnectorServer()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.management.remote.JMXConnectorServer sut = null; // = new JMXConnectorServer();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_JMXConnectorServer_MBeanServer()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.management.remote.JMXConnectorServer sut = null; // = new

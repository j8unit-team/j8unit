 ...
 * javax.management.remote.JMXConnectorServer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMXConnectorServerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMXConnectorServerTests}.
 * </p>
 *
 * @see javax.management.remote.JMXConnectorServer class javax.management.remote.JMXConnectorServer (the hereby targeted
 *      class-under-test class)
 * @see JMXConnectorServerTests JMXConnectorServerTests (The complementary j8unit test interface containing the instance
...
extends JMXConnectorServerMBeanClassTests<SUT>, org.j8unit.repository.javax.management.MBeanRegistrationClassTests<SUT>, JMXAddressableClassTests<SUT>,
org.j8unit.repository.javax.management.NotificationBroadcasterSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXConnectorServer.class!",
                   javax.management.remote.JMXConnectorServer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MixerProvider
...
public abstract interface MixerProviderClassTests<SUT extends MixerProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MixerProvider.class!",
                   MixerProvider.class.isAssignableFrom(sut));
    }

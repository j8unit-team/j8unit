 ...
 * javax.sound.sampled.spi.MixerProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MixerProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MixerProviderTests}.
 * </p>
 *
 * @see javax.sound.sampled.spi.MixerProvider class javax.sound.sampled.spi.MixerProvider (the hereby targeted
 *      class-under-test class)
 * @see MixerProviderTests MixerProviderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MixerProviderClassTests<SUT extends javax.sound.sampled.spi.MixerProvider>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.spi.MixerProvider.class!",
                   javax.sound.sampled.spi.MixerProvider.class.isAssignableFrom(sut));
    }

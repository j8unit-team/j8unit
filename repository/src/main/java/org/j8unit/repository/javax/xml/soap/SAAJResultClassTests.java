...
import org.j8unit.repository.javax.xml.transform.dom.DOMResultClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SAAJResult public
...
public abstract interface SAAJResultClassTests<SUT extends SAAJResult>
extends DOMResultClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAAJResult.class!",
                   SAAJResult.class.isAssignableFrom(sut));
    }

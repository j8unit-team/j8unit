 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SAAJResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SAAJResultTests}.
 * </p>
 *
 * @see javax.xml.soap.SAAJResult class javax.xml.soap.SAAJResult (the hereby targeted class-under-test class)
 * @see SAAJResultTests SAAJResultTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.transform.dom.DOMResultClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SAAJResult.class!",
                   javax.xml.soap.SAAJResult.class.isAssignableFrom(sut));
    }

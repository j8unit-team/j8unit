...
extends DescriptorAccessClassTests<SUT>, MBeanOperationInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ModelMBeanOperationInfo.class!",
                   ModelMBeanOperationInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalScrollPaneUI
 * public class javax.swing.plaf.metal.MetalScrollPaneUI}.
 *
...
public abstract interface MetalScrollPaneUIClassTests<SUT extends MetalScrollPaneUI>
extends BasicScrollPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalScrollPaneUI.class!",
                   MetalScrollPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.sound.midi.MidiDeviceTransmitter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MidiDeviceTransmitterTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MidiDeviceTransmitterTests}.
 * </p>
 *
 * @see javax.sound.midi.MidiDeviceTransmitter interface javax.sound.midi.MidiDeviceTransmitter (the hereby targeted
 *      class-under-test class)
 * @see MidiDeviceTransmitterTests MidiDeviceTransmitterTests (The complementary j8unit test interface containing the
...
extends TransmitterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.MidiDeviceTransmitter.class!",
                   javax.sound.midi.MidiDeviceTransmitter.class.isAssignableFrom(sut));
    }

 ...
 * {@link MidiDeviceTransmitter public abstract interface javax.sound.midi.MidiDeviceTransmitter}.
 *
...
public abstract interface MidiDeviceTransmitterClassTests<SUT extends MidiDeviceTransmitter>
extends TransmitterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiDeviceTransmitter.class!",
                   MidiDeviceTransmitter.class.isAssignableFrom(sut));
    }

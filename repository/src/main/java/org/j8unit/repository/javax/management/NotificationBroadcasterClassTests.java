 ...
 * javax.management.NotificationBroadcaster}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotificationBroadcasterTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NotificationBroadcasterTests}.
 * </p>
 *
 * @see javax.management.NotificationBroadcaster interface javax.management.NotificationBroadcaster (the hereby targeted
 *      class-under-test class)
 * @see NotificationBroadcasterTests NotificationBroadcasterTests (The complementary j8unit test interface containing
...
public abstract interface NotificationBroadcasterClassTests<SUT extends javax.management.NotificationBroadcaster>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.NotificationBroadcaster.class!",
                   javax.management.NotificationBroadcaster.class.isAssignableFrom(sut));
    }

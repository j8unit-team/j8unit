 ...
 * {@link NotificationBroadcaster public abstract interface javax.management.NotificationBroadcaster}.
 *
...
public abstract interface NotificationBroadcasterClassTests<SUT extends NotificationBroadcaster>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotificationBroadcaster.class!",
                   NotificationBroadcaster.class.isAssignableFrom(sut));
    }

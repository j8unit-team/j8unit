 ...
 * javax.security.auth.kerberos.DelegationPermission}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DelegationPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DelegationPermissionTests}
 * .
 * </p>
 *
 * @see javax.security.auth.kerberos.DelegationPermission class javax.security.auth.kerberos.DelegationPermission (the
 *      hereby targeted class-under-test class)
 * @see DelegationPermissionTests DelegationPermissionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.kerberos.DelegationPermission.class!",
                   javax.security.auth.kerberos.DelegationPermission.class.isAssignableFrom(sut));
    }

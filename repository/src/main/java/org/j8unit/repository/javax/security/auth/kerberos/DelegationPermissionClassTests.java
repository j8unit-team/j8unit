 ...
 * {@link DelegationPermission public final class javax.security.auth.kerberos.DelegationPermission}.
 *
 ...
 * {@link DelegationPermissionTests}.
 * </p>
 *
 * <p>
...
public abstract interface DelegationPermissionClassTests<SUT extends DelegationPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DelegationPermission.class!",
                   DelegationPermission.class.isAssignableFrom(sut));
    }

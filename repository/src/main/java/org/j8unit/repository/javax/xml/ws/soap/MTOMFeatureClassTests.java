 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MTOMFeatureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MTOMFeatureTests}.
 * </p>
 *
 * @see javax.xml.ws.soap.MTOMFeature class javax.xml.ws.soap.MTOMFeature (the hereby targeted class-under-test class)
 * @see MTOMFeatureTests MTOMFeatureTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MTOMFeatureClassTests<SUT extends javax.xml.ws.soap.MTOMFeature>
extends org.j8unit.repository.javax.xml.ws.WebServiceFeatureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.soap.MTOMFeature.class!",
                   javax.xml.ws.soap.MTOMFeature.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MTOMFeature public
 * final class javax.xml.ws.soap.MTOMFeature}.
 *
...
public abstract interface MTOMFeatureClassTests<SUT extends MTOMFeature>
extends WebServiceFeatureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MTOMFeature.class!",

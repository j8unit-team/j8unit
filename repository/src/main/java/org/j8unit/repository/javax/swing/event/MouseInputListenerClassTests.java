 ...
 * javax.swing.event.MouseInputListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseInputListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseInputListenerTests}.
 * </p>
 *
 * @see javax.swing.event.MouseInputListener interface javax.swing.event.MouseInputListener (the hereby targeted
 *      class-under-test class)
 * @see MouseInputListenerTests MouseInputListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface MouseInputListenerClassTests<SUT extends javax.swing.event.MouseInputListener>
extends org.j8unit.repository.java.awt.event.MouseListenerClassTests<SUT>, org.j8unit.repository.java.awt.event.MouseMotionListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MouseInputListener.class!",
                   javax.swing.event.MouseInputListener.class.isAssignableFrom(sut));
    }

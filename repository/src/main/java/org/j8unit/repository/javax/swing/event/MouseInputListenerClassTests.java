 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseInputListener
 * public abstract interface javax.swing.event.MouseInputListener}.
 *
...
public abstract interface MouseInputListenerClassTests<SUT extends MouseInputListener>
extends MouseListenerClassTests<SUT>, MouseMotionListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseInputListener.class!",
                   MouseInputListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.text.html.BlockView class javax.swing.text.html.BlockView}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BlockViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BlockViewTests}.
 * </p>
 *
 * @see javax.swing.text.html.BlockView class javax.swing.text.html.BlockView (the hereby targeted class-under-test
 *      class)
 * @see BlockViewTests BlockViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BlockViewClassTests<SUT extends javax.swing.text.html.BlockView>
extends org.j8unit.repository.javax.swing.text.BoxViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.BlockView.class!",
                   javax.swing.text.html.BlockView.class.isAssignableFrom(sut));
    }

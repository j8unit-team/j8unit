...
import org.j8unit.repository.javax.swing.text.BoxViewClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BlockView public
...
public abstract interface BlockViewClassTests<SUT extends BlockView>
extends BoxViewClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.html.BlockView]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BlockView.class!",
                   BlockView.class.isAssignableFrom(sut));
    }

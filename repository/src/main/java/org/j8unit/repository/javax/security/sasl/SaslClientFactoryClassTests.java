...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.security.sasl.SaslClientFactory interface
 * javax.security.sasl.SaslClientFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SaslClientFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SaslClientFactoryTests}.
 * </p>
 *
 * @see javax.security.sasl.SaslClientFactory interface javax.security.sasl.SaslClientFactory (the hereby targeted
 *      class-under-test class)
 * @see SaslClientFactoryTests SaslClientFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface SaslClientFactoryClassTests<SUT extends javax.security.sasl.SaslClientFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.SaslClientFactory.class!",
                   javax.security.sasl.SaslClientFactory.class.isAssignableFrom(sut));
    }

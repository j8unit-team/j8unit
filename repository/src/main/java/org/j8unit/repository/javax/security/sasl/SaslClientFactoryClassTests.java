 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SaslClientFactory
 * public abstract interface javax.security.sasl.SaslClientFactory}.
 *
...
public abstract interface SaslClientFactoryClassTests<SUT extends SaslClientFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SaslClientFactory.class!",
                   SaslClientFactory.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.soap.Name interface javax.xml.soap.Name}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NameTests}).
 * </p>
 *
 * <p>
 ...
 * @see NameTests NameTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.Name.class!",
                   javax.xml.soap.Name.class.isAssignableFrom(sut));
    }

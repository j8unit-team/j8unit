...
extends ListCellRendererClassTests<SUT>, JLabelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultListCellRenderer.class!",
     ...
     * {@link UIResource public static class javax.swing.DefaultListCellRenderer$UIResource}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

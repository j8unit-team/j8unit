...
import org.j8unit.repository.javax.swing.plaf.SpinnerUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiSpinnerUI
...
public abstract interface MultiSpinnerUIClassTests<SUT extends MultiSpinnerUI>
extends SpinnerUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.multi.MultiSpinnerUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiSpinnerUI.class!",
                   MultiSpinnerUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.multi.MultiSpinnerUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.multi.MultiSpinnerUI]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiComboBoxUI
...
public abstract interface MultiComboBoxUIClassTests<SUT extends MultiComboBoxUI>
extends ComboBoxUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiComboBoxUI.class!",
                   MultiComboBoxUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TimerMBean public
 * abstract interface javax.management.timer.TimerMBean}.
 *
...
public abstract interface TimerMBeanClassTests<SUT extends TimerMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimerMBean.class!",

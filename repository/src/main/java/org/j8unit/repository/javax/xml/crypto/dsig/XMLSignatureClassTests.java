 ...
 * javax.xml.crypto.dsig.XMLSignature}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLSignatureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLSignatureTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.XMLSignature interface javax.xml.crypto.dsig.XMLSignature (the hereby targeted
 *      class-under-test class)
 * @see XMLSignatureTests XMLSignatureTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.XMLSignature.class!",
                   javax.xml.crypto.dsig.XMLSignature.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.XMLSignature.SignatureValue interface
     * javax.xml.crypto.dsig.XMLSignature$SignatureValue}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link XMLSignatureTests.SignatureValueTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see XMLSignatureTests.SignatureValueTests XMLSignatureTests.SignatureValueTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.XMLSignature.SignatureValue.class!",
                       javax.xml.crypto.dsig.XMLSignature.SignatureValue.class.isAssignableFrom(sut));
        }

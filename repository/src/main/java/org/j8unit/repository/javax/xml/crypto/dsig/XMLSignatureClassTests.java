...
import org.j8unit.repository.javax.xml.crypto.dsig.XMLSignatureTests.SignatureValueTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLSignature public
 * abstract interface javax.xml.crypto.dsig.XMLSignature}.
 *
...
public abstract interface XMLSignatureClassTests<SUT extends XMLSignature>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLSignature.class!",
                   XMLSignature.class.isAssignableFrom(sut));
    }
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link SignatureValueTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface SignatureValueClassTests<SUT extends SignatureValue>
    extends XMLStructureClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignatureValue.class!",
                              SignatureValue.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NestingKind public
 * final enum javax.lang.model.element.NestingKind}.
 *
...
public abstract interface NestingKindClassTests<SUT extends NestingKind>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NestingKind.class!",
                   NestingKind.class.isAssignableFrom(sut));
    }

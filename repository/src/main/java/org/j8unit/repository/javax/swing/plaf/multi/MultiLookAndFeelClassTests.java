 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiLookAndFeel
 * public class javax.swing.plaf.multi.MultiLookAndFeel}.
 *
...
public abstract interface MultiLookAndFeelClassTests<SUT extends MultiLookAndFeel>
extends LookAndFeelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiLookAndFeel.class!",
                   MultiLookAndFeel.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.spec.DESedeKeySpec class javax.crypto.spec.DESedeKeySpec}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DESedeKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DESedeKeySpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.DESedeKeySpec class javax.crypto.spec.DESedeKeySpec (the hereby targeted class-under-test
 *      class)
 * @see DESedeKeySpecTests DESedeKeySpecTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DESedeKeySpecClassTests<SUT extends javax.crypto.spec.DESedeKeySpec>
extends org.j8unit.repository.java.security.spec.KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.DESedeKeySpec.class!",
                   javax.crypto.spec.DESedeKeySpec.class.isAssignableFrom(sut));
    }

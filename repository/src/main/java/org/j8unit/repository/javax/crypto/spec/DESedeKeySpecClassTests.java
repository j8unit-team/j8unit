 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DESedeKeySpec
...
public abstract interface DESedeKeySpecClassTests<SUT extends DESedeKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DESedeKeySpec.class!",
                   DESedeKeySpec.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.ws.WebServiceException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceExceptionTests}.
 * </p>
 *
 * @see javax.xml.ws.WebServiceException class javax.xml.ws.WebServiceException (the hereby targeted class-under-test
 *      class)
 * @see WebServiceExceptionTests WebServiceExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServiceException.class!",
                   javax.xml.ws.WebServiceException.class.isAssignableFrom(sut));
    }

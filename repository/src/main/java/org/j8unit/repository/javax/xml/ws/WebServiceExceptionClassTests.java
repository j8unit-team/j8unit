 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebServiceException
 * public class javax.xml.ws.WebServiceException}.
 *
...
public abstract interface WebServiceExceptionClassTests<SUT extends WebServiceException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceException.class!",
                   WebServiceException.class.isAssignableFrom(sut));
    }

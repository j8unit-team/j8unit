 ...
 * javax.swing.plaf.multi.MultiLabelUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiLabelUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiLabelUITests}.
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiLabelUI class javax.swing.plaf.multi.MultiLabelUI (the hereby targeted
 *      class-under-test class)
 * @see MultiLabelUITests MultiLabelUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.LabelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiLabelUI.class!",
                   javax.swing.plaf.multi.MultiLabelUI.class.isAssignableFrom(sut));
    }

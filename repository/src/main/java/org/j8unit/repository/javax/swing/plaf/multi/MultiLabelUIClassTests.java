 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiLabelUI public
...
public abstract interface MultiLabelUIClassTests<SUT extends MultiLabelUI>
extends LabelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiLabelUI.class!",
                   MultiLabelUI.class.isAssignableFrom(sut));
    }

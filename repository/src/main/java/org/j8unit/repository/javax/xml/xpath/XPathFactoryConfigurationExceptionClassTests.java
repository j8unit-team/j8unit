 ...
 * {@link XPathFactoryConfigurationException public class javax.xml.xpath.XPathFactoryConfigurationException}.
 *
...
public abstract interface XPathFactoryConfigurationExceptionClassTests<SUT extends XPathFactoryConfigurationException>
extends XPathExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathFactoryConfigurationException.class!",
                   XPathFactoryConfigurationException.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.text.StyleContextTests.NamedStyleTests;
import org.j8unit.repository.javax.swing.text.StyleContextTests.SmallAttributeSetTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StyleContext public
...
public abstract interface StyleContextClassTests<SUT extends StyleContext>
extends SerializableClassTests<SUT>, AttributeContextClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StyleContext.class!",
                   StyleContext.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.text.StyleContext]
     ...
     * {@link NamedStyle public class javax.swing.text.StyleContext$NamedStyle}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link NamedStyleTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface NamedStyleClassTests<SUT extends NamedStyle>
    extends StyleClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamedStyle.class!",
                              NamedStyle.class.isAssignableFrom(sut));
        }

        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.text.StyleContext$NamedStyle]
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface SmallAttributeSetClassTests<SUT extends SmallAttributeSet>
    extends AttributeSetClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SmallAttributeSet.class!",
                              SmallAttributeSet.class.isAssignableFrom(sut));
        }

        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.text.StyleContext$SmallAttributeSet]

 ...
 * javax.crypto.ExemptionMechanismException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ExemptionMechanismExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ExemptionMechanismExceptionTests ExemptionMechanismExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.ExemptionMechanismException.class!",
                   javax.crypto.ExemptionMechanismException.class.isAssignableFrom(sut));
    }

...
public abstract interface ExemptionMechanismExceptionClassTests<SUT extends ExemptionMechanismException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExemptionMechanismException.class!",
                   ExemptionMechanismException.class.isAssignableFrom(sut));
    }

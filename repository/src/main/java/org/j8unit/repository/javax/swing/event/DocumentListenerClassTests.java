 ...
 * javax.swing.event.DocumentListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocumentListenerTests}.
 * </p>
 *
 * @see javax.swing.event.DocumentListener interface javax.swing.event.DocumentListener (the hereby targeted
 *      class-under-test class)
 * @see DocumentListenerTests DocumentListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DocumentListenerClassTests<SUT extends javax.swing.event.DocumentListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.DocumentListener.class!",
                   javax.swing.event.DocumentListener.class.isAssignableFrom(sut));
    }

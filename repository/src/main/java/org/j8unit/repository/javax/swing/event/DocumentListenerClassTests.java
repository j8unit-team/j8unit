 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentListener
 * public abstract interface javax.swing.event.DocumentListener}.
 *
...
public abstract interface DocumentListenerClassTests<SUT extends DocumentListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentListener.class!",
                   DocumentListener.class.isAssignableFrom(sut));
    }

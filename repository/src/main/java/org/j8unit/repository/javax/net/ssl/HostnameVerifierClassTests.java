 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HostnameVerifier
 * public abstract interface javax.net.ssl.HostnameVerifier}.
 *
...
public abstract interface HostnameVerifierClassTests<SUT extends HostnameVerifier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HostnameVerifier.class!",

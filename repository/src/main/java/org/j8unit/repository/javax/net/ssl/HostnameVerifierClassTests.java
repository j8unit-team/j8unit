 ...
 * javax.net.ssl.HostnameVerifier}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HostnameVerifierTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HostnameVerifierTests}.
 * </p>
 *
 * @see javax.net.ssl.HostnameVerifier interface javax.net.ssl.HostnameVerifier (the hereby targeted class-under-test
 *      class)
 * @see HostnameVerifierTests HostnameVerifierTests (The complementary j8unit test interface containing the instance
...
public abstract interface HostnameVerifierClassTests<SUT extends javax.net.ssl.HostnameVerifier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.HostnameVerifier.class!",
                   javax.net.ssl.HostnameVerifier.class.isAssignableFrom(sut));
    }

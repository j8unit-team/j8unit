...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.AttributeSet interface
 * javax.print.attribute.AttributeSet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeSetTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.print.attribute.AttributeSet interface javax.print.attribute.AttributeSet (the hereby targeted
 *      class-under-test class)
 * @see AttributeSetTests AttributeSetTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AttributeSetClassTests<SUT extends javax.print.attribute.AttributeSet>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.AttributeSet.class!",
                   javax.print.attribute.AttributeSet.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiPanelUI public
...
public abstract interface MultiPanelUIClassTests<SUT extends MultiPanelUI>
extends PanelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiPanelUI.class!",
                   MultiPanelUI.class.isAssignableFrom(sut));
    }

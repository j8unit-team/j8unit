 ...
 * javax.swing.plaf.multi.MultiPanelUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiPanelUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiPanelUITests}.
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiPanelUI class javax.swing.plaf.multi.MultiPanelUI (the hereby targeted
 *      class-under-test class)
 * @see MultiPanelUITests MultiPanelUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.PanelUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiPanelUI.class!",
                   javax.swing.plaf.multi.MultiPanelUI.class.isAssignableFrom(sut));
    }

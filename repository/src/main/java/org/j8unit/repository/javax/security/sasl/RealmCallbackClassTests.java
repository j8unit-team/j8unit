 ...
 * javax.security.sasl.RealmCallback}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RealmCallbackTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RealmCallbackTests}.
 * </p>
 *
 * @see javax.security.sasl.RealmCallback class javax.security.sasl.RealmCallback (the hereby targeted class-under-test
 *      class)
 * @see RealmCallbackTests RealmCallbackTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.security.auth.callback.TextInputCallbackClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.RealmCallback.class!",
                   javax.security.sasl.RealmCallback.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.security.auth.callback.TextInputCallbackClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RealmCallback
...
public abstract interface RealmCallbackClassTests<SUT extends RealmCallback>
extends TextInputCallbackClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.security.sasl.RealmCallback]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RealmCallback.class!",

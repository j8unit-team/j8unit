 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLContextSpiTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.net.ssl.SSLContextSpi class javax.net.ssl.SSLContextSpi (the hereby targeted class-under-test class)
 * @see SSLContextSpiTests SSLContextSpiTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SSLContextSpiClassTests<SUT extends javax.net.ssl.SSLContextSpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLContextSpi.class!",
                   javax.net.ssl.SSLContextSpi.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLContextSpi
...
public abstract interface SSLContextSpiClassTests<SUT extends SSLContextSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLContextSpi.class!",
                   SSLContextSpi.class.isAssignableFrom(sut));
    }

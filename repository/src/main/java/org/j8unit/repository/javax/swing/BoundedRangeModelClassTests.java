 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BoundedRangeModel
 * public abstract interface javax.swing.BoundedRangeModel}.
 *
...
public abstract interface BoundedRangeModelClassTests<SUT extends BoundedRangeModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BoundedRangeModel.class!",
                   BoundedRangeModel.class.isAssignableFrom(sut));
    }

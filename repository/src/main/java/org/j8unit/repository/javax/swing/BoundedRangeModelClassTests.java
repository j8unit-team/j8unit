...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.BoundedRangeModel interface javax.swing.BoundedRangeModel}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BoundedRangeModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BoundedRangeModelTests}.
 * </p>
 *
 * @see javax.swing.BoundedRangeModel interface javax.swing.BoundedRangeModel (the hereby targeted class-under-test
 *      class)
 * @see BoundedRangeModelTests BoundedRangeModelTests (The complementary j8unit test interface containing the instance
...
public abstract interface BoundedRangeModelClassTests<SUT extends javax.swing.BoundedRangeModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.BoundedRangeModel.class!",
                   javax.swing.BoundedRangeModel.class.isAssignableFrom(sut));
    }

 ...
 * {@link FactoryConfigurationError public class javax.xml.parsers.FactoryConfigurationError}.
 *
...
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FactoryConfigurationError.class!",
                   FactoryConfigurationError.class.isAssignableFrom(sut));
    }

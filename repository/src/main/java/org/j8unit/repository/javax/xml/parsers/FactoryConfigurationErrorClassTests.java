 ...
 * javax.xml.parsers.FactoryConfigurationError}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
...
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.parsers.FactoryConfigurationError.class!",
                   javax.xml.parsers.FactoryConfigurationError.class.isAssignableFrom(sut));
    }

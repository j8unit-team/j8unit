 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UIResourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UIResourceTests}.
 * </p>
 *
 * @see javax.swing.plaf.UIResource interface javax.swing.plaf.UIResource (the hereby targeted class-under-test class)
 * @see UIResourceTests UIResourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface UIResourceClassTests<SUT extends javax.swing.plaf.UIResource>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.UIResource.class!",
                   javax.swing.plaf.UIResource.class.isAssignableFrom(sut));
    }

 ...
 * javax.activity.ActivityCompletedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ActivityCompletedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ActivityCompletedExceptionTests ActivityCompletedExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activity.ActivityCompletedException.class!",
                   javax.activity.ActivityCompletedException.class.isAssignableFrom(sut));
    }

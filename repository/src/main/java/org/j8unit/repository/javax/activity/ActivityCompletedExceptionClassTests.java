...
public abstract interface ActivityCompletedExceptionClassTests<SUT extends ActivityCompletedException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivityCompletedException.class!",
                   ActivityCompletedException.class.isAssignableFrom(sut));
    }

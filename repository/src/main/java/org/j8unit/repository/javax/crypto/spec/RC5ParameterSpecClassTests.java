 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RC5ParameterSpec
...
public abstract interface RC5ParameterSpecClassTests<SUT extends RC5ParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RC5ParameterSpec.class!",
                   RC5ParameterSpec.class.isAssignableFrom(sut));
    }

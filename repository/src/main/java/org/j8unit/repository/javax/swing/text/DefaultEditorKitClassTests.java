...
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.BeepActionTests;
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.CopyActionTests;
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.CutActionTests;
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.DefaultKeyTypedActionTests;
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.InsertBreakActionTests;
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.InsertContentActionTests;
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.InsertTabActionTests;
import org.j8unit.repository.javax.swing.text.DefaultEditorKitTests.PasteActionTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultEditorKit
 * public class javax.swing.text.DefaultEditorKit}.
 *
...
extends EditorKitClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultEditorKit.class!",
                   DefaultEditorKit.class.isAssignableFrom(sut));
    }
     ...
     * {@link PasteAction public static class javax.swing.text.DefaultEditorKit$PasteAction}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link PasteActionTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PasteAction.class!",
                              PasteAction.class.isAssignableFrom(sut));
        }
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InsertContentAction.class!",
                              InsertContentAction.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link CopyAction public static class javax.swing.text.DefaultEditorKit$CopyAction}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link CopyActionTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CopyAction.class!",
                              CopyAction.class.isAssignableFrom(sut));
        }
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link InsertTabActionTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InsertTabAction.class!",
                              InsertTabAction.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link BeepAction public static class javax.swing.text.DefaultEditorKit$BeepAction}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link BeepActionTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeepAction.class!",
                              BeepAction.class.isAssignableFrom(sut));
        }
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link DefaultKeyTypedActionTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultKeyTypedAction.class!",
                              DefaultKeyTypedAction.class.isAssignableFrom(sut));
        }
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link CutAction public static class javax.swing.text.DefaultEditorKit$CutAction}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link CutActionTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CutAction.class!",
                              CutAction.class.isAssignableFrom(sut));
        }
    ...
    extends TextActionClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InsertBreakAction.class!",
                              InsertBreakAction.class.isAssignableFrom(sut));
        }

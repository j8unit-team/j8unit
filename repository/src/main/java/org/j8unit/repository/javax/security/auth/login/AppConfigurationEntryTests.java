...
public abstract interface AppConfigurationEntryTests<SUT extends AppConfigurationEntry>
extends ObjectTests<SUT> {
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface LoginModuleControlFlagTests<SUT extends LoginModuleControlFlag>
    extends ObjectTests<SUT> {

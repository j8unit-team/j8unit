 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ArrayType public
 * abstract interface javax.lang.model.type.ArrayType}.
 *
...
extends ReferenceTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ArrayType.class!",
                   ArrayType.class.isAssignableFrom(sut));
    }

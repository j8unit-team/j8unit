 ...
 * javax.lang.model.type.ArrayType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ArrayTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ArrayTypeTests}.
 * </p>
 *
 * @see javax.lang.model.type.ArrayType interface javax.lang.model.type.ArrayType (the hereby targeted class-under-test
 *      class)
 * @see ArrayTypeTests ArrayTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ArrayTypeClassTests<SUT extends javax.lang.model.type.ArrayType>
extends ReferenceTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.ArrayType.class!",
                   javax.lang.model.type.ArrayType.class.isAssignableFrom(sut));
    }

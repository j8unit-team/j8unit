 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageTranscoder
...
public abstract interface ImageTranscoderClassTests<SUT extends ImageTranscoder>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageTranscoder.class!",
                   ImageTranscoder.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageTranscoderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageTranscoderTests}.
 * </p>
 *
 * @see javax.imageio.ImageTranscoder interface javax.imageio.ImageTranscoder (the hereby targeted class-under-test
 *      class)
 * @see ImageTranscoderTests ImageTranscoderTests (The complementary j8unit test interface containing the instance
...
public abstract interface ImageTranscoderClassTests<SUT extends javax.imageio.ImageTranscoder>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.ImageTranscoder.class!",
                   javax.imageio.ImageTranscoder.class.isAssignableFrom(sut));
    }

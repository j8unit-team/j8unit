 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageIcon public
...
public abstract interface ImageIconClassTests<SUT extends ImageIcon>
extends IconClassTests<SUT>, SerializableClassTests<SUT>, AccessibleClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageIcon.class!",
                   ImageIcon.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.basic.BasicInternalFrameUIClassTests;
 ...
 * {@link MetalInternalFrameUI public class javax.swing.plaf.metal.MetalInternalFrameUI}.
 *
...
public abstract interface MetalInternalFrameUIClassTests<SUT extends MetalInternalFrameUI>
extends BasicInternalFrameUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalInternalFrameUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalInternalFrameUI.class!",
                   MetalInternalFrameUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.metal.MetalInternalFrameUI]

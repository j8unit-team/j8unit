 ...
 * javax.swing.plaf.metal.MetalInternalFrameUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetalInternalFrameUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MetalInternalFrameUITests}
 * .
 * </p>
 *
 * @see javax.swing.plaf.metal.MetalInternalFrameUI class javax.swing.plaf.metal.MetalInternalFrameUI (the hereby
 *      targeted class-under-test class)
 * @see MetalInternalFrameUITests MetalInternalFrameUITests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.swing.plaf.basic.BasicInternalFrameUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalInternalFrameUI.class!",
                   javax.swing.plaf.metal.MetalInternalFrameUI.class.isAssignableFrom(sut));
    }

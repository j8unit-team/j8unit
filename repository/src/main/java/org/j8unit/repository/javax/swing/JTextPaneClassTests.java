 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JTextPane public
...
public abstract interface JTextPaneClassTests<SUT extends JTextPane>
extends JEditorPaneClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JTextPane.class!",
                   JTextPane.class.isAssignableFrom(sut));
    }

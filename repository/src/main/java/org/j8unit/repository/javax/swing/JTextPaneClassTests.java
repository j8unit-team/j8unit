 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JTextPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JTextPaneTests}.
 * </p>
 *
 * @see javax.swing.JTextPane class javax.swing.JTextPane (the hereby targeted class-under-test class)
 * @see JTextPaneTests JTextPaneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends JEditorPaneClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JTextPane.class!",
                   javax.swing.JTextPane.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompoundName public
...
public abstract interface CompoundNameClassTests<SUT extends CompoundName>
extends NameClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompoundName.class!",
                   CompoundName.class.isAssignableFrom(sut));
    }

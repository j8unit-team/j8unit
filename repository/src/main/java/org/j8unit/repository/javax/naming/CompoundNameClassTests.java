 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompoundNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompoundNameTests}.
 * </p>
 *
 * @see javax.naming.CompoundName class javax.naming.CompoundName (the hereby targeted class-under-test class)
 * @see CompoundNameTests CompoundNameTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends NameClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.CompoundName.class!",
                   javax.naming.CompoundName.class.isAssignableFrom(sut));
    }

...
public abstract interface RelationTypeNotFoundExceptionClassTests<SUT extends RelationTypeNotFoundException>
extends org.j8unit.repository.javax.management.relation.RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationTypeNotFoundException.class!",
                   RelationTypeNotFoundException.class.isAssignableFrom(sut));
    }

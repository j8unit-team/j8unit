 ...
 * javax.management.relation.RelationTypeNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see RelationTypeNotFoundExceptionTests RelationTypeNotFoundExceptionTests (The complementary j8unit test interface
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationTypeNotFoundException.class!",
                   javax.management.relation.RelationTypeNotFoundException.class.isAssignableFrom(sut));
    }

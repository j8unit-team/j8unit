 ...
 * {@link LineUnavailableException public class javax.sound.sampled.LineUnavailableException}.
 *
...
public abstract interface LineUnavailableExceptionClassTests<SUT extends LineUnavailableException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineUnavailableException.class!",
                   LineUnavailableException.class.isAssignableFrom(sut));
    }

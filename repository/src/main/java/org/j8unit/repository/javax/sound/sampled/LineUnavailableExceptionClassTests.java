 ...
 * javax.sound.sampled.LineUnavailableException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LineUnavailableExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link LineUnavailableExceptionTests}.
 * </p>
 *
 * @see javax.sound.sampled.LineUnavailableException class javax.sound.sampled.LineUnavailableException (the hereby
 *      targeted class-under-test class)
 * @see LineUnavailableExceptionTests LineUnavailableExceptionTests (The complementary j8unit test interface containing
...
public abstract interface LineUnavailableExceptionClassTests<SUT extends javax.sound.sampled.LineUnavailableException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.LineUnavailableException.class!",
                   javax.sound.sampled.LineUnavailableException.class.isAssignableFrom(sut));
    }

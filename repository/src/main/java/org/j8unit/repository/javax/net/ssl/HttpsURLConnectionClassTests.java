...
import org.j8unit.repository.java.net.HttpURLConnectionClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HttpsURLConnection
...
public abstract interface HttpsURLConnectionClassTests<SUT extends HttpsURLConnection>
extends HttpURLConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HttpsURLConnection.class!",
                   HttpsURLConnection.class.isAssignableFrom(sut));
    }

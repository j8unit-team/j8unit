 ...
 * javax.net.ssl.HttpsURLConnection}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HttpsURLConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HttpsURLConnectionTests}.
 * </p>
 *
 * @see javax.net.ssl.HttpsURLConnection class javax.net.ssl.HttpsURLConnection (the hereby targeted class-under-test
 *      class)
 * @see HttpsURLConnectionTests HttpsURLConnectionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.net.HttpURLConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.HttpsURLConnection.class!",
                   javax.net.ssl.HttpsURLConnection.class.isAssignableFrom(sut));
    }

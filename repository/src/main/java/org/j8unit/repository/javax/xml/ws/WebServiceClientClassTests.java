...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.WebServiceClient interface javax.xml.ws.WebServiceClient}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceClientTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceClientTests}.
 * </p>
 *
 * @see javax.xml.ws.WebServiceClient interface javax.xml.ws.WebServiceClient (the hereby targeted class-under-test
 *      class)
 * @see WebServiceClientTests WebServiceClientTests (The complementary j8unit test interface containing the instance
...
public abstract interface WebServiceClientClassTests<SUT extends javax.xml.ws.WebServiceClient>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServiceClient.class!",
                   javax.xml.ws.WebServiceClient.class.isAssignableFrom(sut));
    }

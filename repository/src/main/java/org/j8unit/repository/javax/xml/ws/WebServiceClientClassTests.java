 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebServiceClient
...
public abstract interface WebServiceClientClassTests<SUT extends WebServiceClient>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceClient.class!",
                   WebServiceClient.class.isAssignableFrom(sut));
    }

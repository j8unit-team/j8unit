 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TabularDataSupport
 * public class javax.management.openmbean.TabularDataSupport}.
 *
...
public abstract interface TabularDataSupportClassTests<SUT extends TabularDataSupport>
extends TabularDataClassTests<SUT>, MapClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TabularDataSupport.class!",
                   TabularDataSupport.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.TabularDataSupport class
 * javax.management.openmbean.TabularDataSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TabularDataSupportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TabularDataSupportTests}.
 * </p>
 *
 * @see javax.management.openmbean.TabularDataSupport class javax.management.openmbean.TabularDataSupport (the hereby
 *      targeted class-under-test class)
 * @see TabularDataSupportTests TabularDataSupportTests (The complementary j8unit test interface containing the instance
...
extends TabularDataClassTests<SUT>, org.j8unit.repository.java.util.MapClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>,
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.TabularDataSupport.class!",
                   javax.management.openmbean.TabularDataSupport.class.isAssignableFrom(sut));
    }

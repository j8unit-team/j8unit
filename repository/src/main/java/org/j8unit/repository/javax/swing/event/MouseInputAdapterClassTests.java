 ...
 * javax.swing.event.MouseInputAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseInputAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseInputAdapterTests}.
 * </p>
 *
 * @see javax.swing.event.MouseInputAdapter class javax.swing.event.MouseInputAdapter (the hereby targeted
 *      class-under-test class)
 * @see MouseInputAdapterTests MouseInputAdapterTests (The complementary j8unit test interface containing the instance
...
public abstract interface MouseInputAdapterClassTests<SUT extends javax.swing.event.MouseInputAdapter>
extends MouseInputListenerClassTests<SUT>, org.j8unit.repository.java.awt.event.MouseAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MouseInputAdapter.class!",
                   javax.swing.event.MouseInputAdapter.class.isAssignableFrom(sut));
    }

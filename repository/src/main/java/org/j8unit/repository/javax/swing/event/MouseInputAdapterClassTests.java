 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseInputAdapter
 * public abstract class javax.swing.event.MouseInputAdapter}.
 *
...
public abstract interface MouseInputAdapterClassTests<SUT extends MouseInputAdapter>
extends MouseInputListenerClassTests<SUT>, MouseAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseInputAdapter.class!",
                   MouseInputAdapter.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.naming.NameClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LdapName public
...
public abstract interface LdapNameClassTests<SUT extends LdapName>
extends NameClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LdapName.class!",
                   LdapName.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LdapNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LdapNameTests}.
 * </p>
 *
 * @see javax.naming.ldap.LdapName class javax.naming.ldap.LdapName (the hereby targeted class-under-test class)
 * @see LdapNameTests LdapNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.naming.NameClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.LdapName.class!",
                   javax.naming.ldap.LdapName.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JRadioButton public
...
public abstract interface JRadioButtonClassTests<SUT extends JRadioButton>
extends JToggleButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JRadioButton.class!",
                   JRadioButton.class.isAssignableFrom(sut));
    }

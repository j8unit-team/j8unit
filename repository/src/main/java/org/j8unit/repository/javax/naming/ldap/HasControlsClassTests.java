 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HasControlsTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see HasControlsTests HasControlsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface HasControlsClassTests<SUT extends javax.naming.ldap.HasControls>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.HasControls.class!",
                   javax.naming.ldap.HasControls.class.isAssignableFrom(sut));
    }

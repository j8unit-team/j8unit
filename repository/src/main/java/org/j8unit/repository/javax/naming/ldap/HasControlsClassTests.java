 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HasControls public
 * abstract interface javax.naming.ldap.HasControls}.
 *
...
public abstract interface HasControlsClassTests<SUT extends HasControls>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HasControls.class!",

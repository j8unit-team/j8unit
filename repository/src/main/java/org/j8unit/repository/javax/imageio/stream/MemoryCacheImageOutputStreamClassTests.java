 ...
 * javax.imageio.stream.MemoryCacheImageOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link MemoryCacheImageOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see MemoryCacheImageOutputStreamTests MemoryCacheImageOutputStreamTests (The complementary j8unit test interface
...
extends ImageOutputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.MemoryCacheImageOutputStream.class!",
                   javax.imageio.stream.MemoryCacheImageOutputStream.class.isAssignableFrom(sut));
    }

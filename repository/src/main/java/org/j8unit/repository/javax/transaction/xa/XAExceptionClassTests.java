 ...
 * javax.transaction.xa.XAException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XAExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XAExceptionTests}.
 * </p>
 *
 * @see javax.transaction.xa.XAException class javax.transaction.xa.XAException (the hereby targeted class-under-test
 *      class)
 * @see XAExceptionTests XAExceptionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XAExceptionClassTests<SUT extends javax.transaction.xa.XAException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.transaction.xa.XAException.class!",
                   javax.transaction.xa.XAException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MutableTreeNode
 * public abstract interface javax.swing.tree.MutableTreeNode}.
 *
...
public abstract interface MutableTreeNodeClassTests<SUT extends MutableTreeNode>
extends org.j8unit.repository.javax.swing.tree.TreeNodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MutableTreeNode.class!",
                   MutableTreeNode.class.isAssignableFrom(sut));
    }

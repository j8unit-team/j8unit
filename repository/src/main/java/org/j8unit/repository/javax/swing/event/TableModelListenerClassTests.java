 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TableModelListener
 * public abstract interface javax.swing.event.TableModelListener}.
 *
...
public abstract interface TableModelListenerClassTests<SUT extends TableModelListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableModelListener.class!",
                   TableModelListener.class.isAssignableFrom(sut));
    }

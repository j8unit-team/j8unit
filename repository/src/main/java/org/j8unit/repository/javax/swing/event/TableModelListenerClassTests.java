...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.TableModelListener interface
 * javax.swing.event.TableModelListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableModelListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TableModelListenerTests}.
 * </p>
 *
 * @see javax.swing.event.TableModelListener interface javax.swing.event.TableModelListener (the hereby targeted
 *      class-under-test class)
 * @see TableModelListenerTests TableModelListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface TableModelListenerClassTests<SUT extends javax.swing.event.TableModelListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TableModelListener.class!",
                   javax.swing.event.TableModelListener.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.ViewportUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicViewportUI
 * public class javax.swing.plaf.basic.BasicViewportUI}.
 *
...
public abstract interface BasicViewportUIClassTests<SUT extends BasicViewportUI>
extends ViewportUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicViewportUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicViewportUI.class!",
                   BasicViewportUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicViewportUI]

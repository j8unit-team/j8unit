 ...
 * javax.imageio.spi.ImageTranscoderSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageTranscoderSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageTranscoderSpiTests}.
 * </p>
 *
 * @see javax.imageio.spi.ImageTranscoderSpi class javax.imageio.spi.ImageTranscoderSpi (the hereby targeted
 *      class-under-test class)
 * @see ImageTranscoderSpiTests ImageTranscoderSpiTests (The complementary j8unit test interface containing the instance
...
extends IIOServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.ImageTranscoderSpi.class!",
                   javax.imageio.spi.ImageTranscoderSpi.class.isAssignableFrom(sut));
    }

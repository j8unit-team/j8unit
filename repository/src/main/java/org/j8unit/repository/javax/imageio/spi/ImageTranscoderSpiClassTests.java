 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageTranscoderSpi
 * public abstract class javax.imageio.spi.ImageTranscoderSpi}.
 *
...
public abstract interface ImageTranscoderSpiClassTests<SUT extends ImageTranscoderSpi>
extends IIOServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageTranscoderSpi.class!",
                   ImageTranscoderSpi.class.isAssignableFrom(sut));
    }

...
public abstract interface StreamReaderDelegateClassTests<SUT extends StreamReaderDelegate>
extends org.j8unit.repository.javax.xml.stream.XMLStreamReaderClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamReaderDelegate.class!",
                   StreamReaderDelegate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalRootPaneUI
...
public abstract interface MetalRootPaneUIClassTests<SUT extends MetalRootPaneUI>
extends BasicRootPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalRootPaneUI.class!",
                   MetalRootPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.transform.SourceLocator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SourceLocatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SourceLocatorTests}.
 * </p>
 *
 * @see javax.xml.transform.SourceLocator interface javax.xml.transform.SourceLocator (the hereby targeted
 *      class-under-test class)
 * @see SourceLocatorTests SourceLocatorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SourceLocatorClassTests<SUT extends javax.xml.transform.SourceLocator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.SourceLocator.class!",
                   javax.xml.transform.SourceLocator.class.isAssignableFrom(sut));
    }

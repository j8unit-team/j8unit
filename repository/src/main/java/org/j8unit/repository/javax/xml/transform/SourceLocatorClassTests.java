 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SourceLocator
...
public abstract interface SourceLocatorClassTests<SUT extends SourceLocator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SourceLocator.class!",
                   SourceLocator.class.isAssignableFrom(sut));
    }

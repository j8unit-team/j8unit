 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListSelectionModel
 * public abstract interface javax.swing.ListSelectionModel}.
 *
...
public abstract interface ListSelectionModelClassTests<SUT extends ListSelectionModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListSelectionModel.class!",
                   ListSelectionModel.class.isAssignableFrom(sut));
    }

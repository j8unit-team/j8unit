 ...
 * javax.activation.DataContentHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataContentHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataContentHandlerTests}.
 * </p>
 *
 * @see javax.activation.DataContentHandler interface javax.activation.DataContentHandler (the hereby targeted
 *      class-under-test class)
 * @see DataContentHandlerTests DataContentHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DataContentHandlerClassTests<SUT extends javax.activation.DataContentHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.DataContentHandler.class!",
                   javax.activation.DataContentHandler.class.isAssignableFrom(sut));
    }

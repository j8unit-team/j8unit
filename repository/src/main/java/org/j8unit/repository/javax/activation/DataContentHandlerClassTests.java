 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataContentHandler
 * public abstract interface javax.activation.DataContentHandler}.
 *
...
public abstract interface DataContentHandlerClassTests<SUT extends DataContentHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataContentHandler.class!",
                   DataContentHandler.class.isAssignableFrom(sut));
    }

...
public abstract interface DatatypeConverterInterfaceClassTests<SUT extends DatatypeConverterInterface>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatatypeConverterInterface.class!",
                   DatatypeConverterInterface.class.isAssignableFrom(sut));
    }

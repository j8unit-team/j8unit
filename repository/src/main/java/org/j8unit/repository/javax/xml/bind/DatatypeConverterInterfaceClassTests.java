 ...
 * javax.xml.bind.DatatypeConverterInterface}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link DatatypeConverterInterfaceTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.bind.DatatypeConverterInterface interface javax.xml.bind.DatatypeConverterInterface (the hereby
 *      targeted class-under-test class)
 * @see DatatypeConverterInterfaceTests DatatypeConverterInterfaceTests (The complementary j8unit test interface
...
public abstract interface DatatypeConverterInterfaceClassTests<SUT extends javax.xml.bind.DatatypeConverterInterface>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.DatatypeConverterInterface.class!",
                   javax.xml.bind.DatatypeConverterInterface.class.isAssignableFrom(sut));
    }

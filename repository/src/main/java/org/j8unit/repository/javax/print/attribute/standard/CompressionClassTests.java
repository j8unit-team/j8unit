 ...
 * javax.print.attribute.standard.Compression}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompressionTests}).
 * </p>
 *
 * <p>
 ...
 * @see CompressionTests CompressionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CompressionClassTests<SUT extends javax.print.attribute.standard.Compression>
extends org.j8unit.repository.javax.print.attribute.DocAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.Compression.class!",
                   javax.print.attribute.standard.Compression.class.isAssignableFrom(sut));
    }

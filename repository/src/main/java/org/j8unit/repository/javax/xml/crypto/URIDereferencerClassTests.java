 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URIDereferencer
...
public abstract interface URIDereferencerClassTests<SUT extends URIDereferencer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URIDereferencer.class!",
                   URIDereferencer.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.crypto.URIDereferencer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URIDereferencerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URIDereferencerTests}.
 * </p>
 *
 * @see javax.xml.crypto.URIDereferencer interface javax.xml.crypto.URIDereferencer (the hereby targeted
 *      class-under-test class)
 * @see URIDereferencerTests URIDereferencerTests (The complementary j8unit test interface containing the instance
...
public abstract interface URIDereferencerClassTests<SUT extends javax.xml.crypto.URIDereferencer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.URIDereferencer.class!",
                   javax.xml.crypto.URIDereferencer.class.isAssignableFrom(sut));
    }

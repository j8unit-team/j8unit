 ...
 * javax.naming.AuthenticationNotSupportedException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AuthenticationNotSupportedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see AuthenticationNotSupportedExceptionTests AuthenticationNotSupportedExceptionTests (The complementary j8unit test
...
extends NamingSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.AuthenticationNotSupportedException.class!",
                   javax.naming.AuthenticationNotSupportedException.class.isAssignableFrom(sut));
    }

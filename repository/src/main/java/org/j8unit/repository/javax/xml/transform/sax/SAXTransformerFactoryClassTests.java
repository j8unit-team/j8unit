...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.sax.SAXTransformerFactory class
 * javax.xml.transform.sax.SAXTransformerFactory}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SAXTransformerFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SAXTransformerFactoryTests}.
 * </p>
 *
 * @see javax.xml.transform.sax.SAXTransformerFactory class javax.xml.transform.sax.SAXTransformerFactory (the hereby
 *      targeted class-under-test class)
 * @see SAXTransformerFactoryTests SAXTransformerFactoryTests (The complementary j8unit test interface containing the
...
public abstract interface SAXTransformerFactoryClassTests<SUT extends javax.xml.transform.sax.SAXTransformerFactory>
extends org.j8unit.repository.javax.xml.transform.TransformerFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.sax.SAXTransformerFactory.class!",
                   javax.xml.transform.sax.SAXTransformerFactory.class.isAssignableFrom(sut));
    }

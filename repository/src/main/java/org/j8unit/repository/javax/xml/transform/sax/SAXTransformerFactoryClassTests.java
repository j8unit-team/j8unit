...
import org.j8unit.repository.javax.xml.transform.TransformerFactoryClassTests;
 ...
 * {@link SAXTransformerFactory public abstract class javax.xml.transform.sax.SAXTransformerFactory}.
 *
...
public abstract interface SAXTransformerFactoryClassTests<SUT extends SAXTransformerFactory>
extends TransformerFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXTransformerFactory.class!",

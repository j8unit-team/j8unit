...
import org.j8unit.repository.javax.swing.plaf.basic.BasicProgressBarUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthProgressBarUI
 * public class javax.swing.plaf.synth.SynthProgressBarUI}.
 *
...
public abstract interface SynthProgressBarUIClassTests<SUT extends SynthProgressBarUI>
extends SynthUIClassTests<SUT>, PropertyChangeListenerClassTests<SUT>, BasicProgressBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthProgressBarUI.class!",
                   SynthProgressBarUI.class.isAssignableFrom(sut));
    }

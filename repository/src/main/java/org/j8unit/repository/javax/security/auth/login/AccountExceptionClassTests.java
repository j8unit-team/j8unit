 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccountException
 * public class javax.security.auth.login.AccountException}.
 *
...
public abstract interface AccountExceptionClassTests<SUT extends AccountException>
extends LoginExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccountException.class!",
                   AccountException.class.isAssignableFrom(sut));
    }

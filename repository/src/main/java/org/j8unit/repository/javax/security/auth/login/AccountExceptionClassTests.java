 ...
 * javax.security.auth.login.AccountException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccountExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccountExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.login.AccountException class javax.security.auth.login.AccountException (the hereby targeted
 *      class-under-test class)
 * @see AccountExceptionTests AccountExceptionTests (The complementary j8unit test interface containing the instance
...
extends LoginExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.AccountException.class!",
                   javax.security.auth.login.AccountException.class.isAssignableFrom(sut));
    }

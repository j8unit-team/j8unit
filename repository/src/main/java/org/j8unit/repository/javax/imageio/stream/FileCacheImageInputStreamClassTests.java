...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.imageio.stream.FileCacheImageInputStream class
 * javax.imageio.stream.FileCacheImageInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link FileCacheImageInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileCacheImageInputStreamTests FileCacheImageInputStreamTests (The complementary j8unit test interface
...
public abstract interface FileCacheImageInputStreamClassTests<SUT extends javax.imageio.stream.FileCacheImageInputStream>
extends ImageInputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.FileCacheImageInputStream.class!",
                   javax.imageio.stream.FileCacheImageInputStream.class.isAssignableFrom(sut));
    }

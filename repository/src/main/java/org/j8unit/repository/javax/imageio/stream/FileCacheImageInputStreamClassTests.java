 ...
 * {@link FileCacheImageInputStream public class javax.imageio.stream.FileCacheImageInputStream}.
 *
...
public abstract interface FileCacheImageInputStreamClassTests<SUT extends FileCacheImageInputStream>
extends ImageInputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileCacheImageInputStream.class!",

 ...
 * javax.management.openmbean.ArrayType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
extends OpenTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.ArrayType.class!",
                   javax.management.openmbean.ArrayType.class.isAssignableFrom(sut));
    }

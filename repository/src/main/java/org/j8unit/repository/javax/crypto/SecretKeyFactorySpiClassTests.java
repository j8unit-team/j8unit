 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecretKeyFactorySpi
...
public abstract interface SecretKeyFactorySpiClassTests<SUT extends SecretKeyFactorySpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecretKeyFactorySpi.class!",
                   SecretKeyFactorySpi.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.crypto.SecretKeyFactorySpi]

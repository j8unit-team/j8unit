 ...
 * javax.crypto.SecretKeyFactorySpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecretKeyFactorySpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecretKeyFactorySpiTests}.
 * </p>
 *
 * @see javax.crypto.SecretKeyFactorySpi class javax.crypto.SecretKeyFactorySpi (the hereby targeted class-under-test
 *      class)
 * @see SecretKeyFactorySpiTests SecretKeyFactorySpiTests (The complementary j8unit test interface containing the
...
public abstract interface SecretKeyFactorySpiClassTests<SUT extends javax.crypto.SecretKeyFactorySpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.SecretKeyFactorySpi.class!",
                   javax.crypto.SecretKeyFactorySpi.class.isAssignableFrom(sut));
    }

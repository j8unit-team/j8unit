 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebServiceFeature
...
public abstract interface WebServiceFeatureClassTests<SUT extends WebServiceFeature>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceFeature.class!",
                   WebServiceFeature.class.isAssignableFrom(sut));
    }

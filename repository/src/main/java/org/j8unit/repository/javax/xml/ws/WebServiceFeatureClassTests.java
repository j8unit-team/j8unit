 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceFeatureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceFeatureTests}.
 * </p>
 *
 * @see javax.xml.ws.WebServiceFeature class javax.xml.ws.WebServiceFeature (the hereby targeted class-under-test class)
 * @see WebServiceFeatureTests WebServiceFeatureTests (The complementary j8unit test interface containing the instance
...
public abstract interface WebServiceFeatureClassTests<SUT extends javax.xml.ws.WebServiceFeature>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServiceFeature.class!",
                   javax.xml.ws.WebServiceFeature.class.isAssignableFrom(sut));
    }

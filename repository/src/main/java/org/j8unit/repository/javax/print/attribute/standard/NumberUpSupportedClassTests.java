 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NumberUpSupported
 * public final class javax.print.attribute.standard.NumberUpSupported}.
 *
...
extends SupportedValuesAttributeClassTests<SUT>, SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NumberUpSupported.class!",
                   NumberUpSupported.class.isAssignableFrom(sut));
    }

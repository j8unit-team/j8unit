 ...
 * javax.print.attribute.standard.NumberUpSupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NumberUpSupportedTests}).
 * </p>
 *
 * <p>
 ...
 * @see NumberUpSupportedTests NumberUpSupportedTests (The complementary j8unit test interface containing the instance
...
public abstract interface NumberUpSupportedClassTests<SUT extends javax.print.attribute.standard.NumberUpSupported>
...
org.j8unit.repository.javax.print.attribute.SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.NumberUpSupported.class!",
                   javax.print.attribute.standard.NumberUpSupported.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.directory.InvalidAttributeIdentifierException}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * {@link InvalidAttributeIdentifierExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidAttributeIdentifierExceptionTests InvalidAttributeIdentifierExceptionTests (The complementary j8unit test
...
public abstract interface InvalidAttributeIdentifierExceptionClassTests<SUT extends javax.naming.directory.InvalidAttributeIdentifierException>
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.InvalidAttributeIdentifierException.class!",
                   javax.naming.directory.InvalidAttributeIdentifierException.class.isAssignableFrom(sut));
    }

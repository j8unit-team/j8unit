 ...
 * {@link InvalidAttributeIdentifierException public class javax.naming.directory.InvalidAttributeIdentifierException}.
 *
...
public abstract interface InvalidAttributeIdentifierExceptionClassTests<SUT extends InvalidAttributeIdentifierException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidAttributeIdentifierException.class!",
                   InvalidAttributeIdentifierException.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.text.rtf.RTFEditorKit}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RTFEditorKitTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RTFEditorKitTests}.
 * </p>
 *
 * @see javax.swing.text.rtf.RTFEditorKit class javax.swing.text.rtf.RTFEditorKit (the hereby targeted class-under-test
 *      class)
 * @see RTFEditorKitTests RTFEditorKitTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.text.StyledEditorKitClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.rtf.RTFEditorKit.class!",
                   javax.swing.text.rtf.RTFEditorKit.class.isAssignableFrom(sut));
    }

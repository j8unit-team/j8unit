 ...
 * javax.xml.stream.events.ProcessingInstruction}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProcessingInstructionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ProcessingInstructionTests}.
 * </p>
 *
 * @see javax.xml.stream.events.ProcessingInstruction interface javax.xml.stream.events.ProcessingInstruction (the
 *      hereby targeted class-under-test class)
 * @see ProcessingInstructionTests ProcessingInstructionTests (The complementary j8unit test interface containing the
...
public abstract interface ProcessingInstructionClassTests<SUT extends javax.xml.stream.events.ProcessingInstruction>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.ProcessingInstruction.class!",
                   javax.xml.stream.events.ProcessingInstruction.class.isAssignableFrom(sut));
    }

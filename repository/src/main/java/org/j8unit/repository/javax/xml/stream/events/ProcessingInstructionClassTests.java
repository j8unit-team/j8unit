...
public abstract interface ProcessingInstructionClassTests<SUT extends ProcessingInstruction>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProcessingInstruction.class!",
                   ProcessingInstruction.class.isAssignableFrom(sut));
    }

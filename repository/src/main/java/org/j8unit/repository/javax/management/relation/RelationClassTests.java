 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Relation public
 * abstract interface javax.management.relation.Relation}.
 *
...
public abstract interface RelationClassTests<SUT extends Relation>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Relation.class!",

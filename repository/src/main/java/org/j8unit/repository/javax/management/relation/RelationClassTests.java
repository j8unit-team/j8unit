...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.relation.Relation interface
 * javax.management.relation.Relation}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RelationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RelationTests}.
 * </p>
 *
 * @see javax.management.relation.Relation interface javax.management.relation.Relation (the hereby targeted
 *      class-under-test class)
 * @see RelationTests RelationTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RelationClassTests<SUT extends javax.management.relation.Relation>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.Relation.class!",
                   javax.management.relation.Relation.class.isAssignableFrom(sut));
    }

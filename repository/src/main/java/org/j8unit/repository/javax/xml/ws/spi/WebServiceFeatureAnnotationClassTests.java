 ...
 * javax.xml.ws.spi.WebServiceFeatureAnnotation}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see WebServiceFeatureAnnotationTests WebServiceFeatureAnnotationTests (The complementary j8unit test interface
...
public abstract interface WebServiceFeatureAnnotationClassTests<SUT extends javax.xml.ws.spi.WebServiceFeatureAnnotation>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.spi.WebServiceFeatureAnnotation.class!",
                   javax.xml.ws.spi.WebServiceFeatureAnnotation.class.isAssignableFrom(sut));
    }

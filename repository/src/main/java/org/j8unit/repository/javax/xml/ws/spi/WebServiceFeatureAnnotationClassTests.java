 ...
 * {@link WebServiceFeatureAnnotation public abstract @interface javax.xml.ws.spi.WebServiceFeatureAnnotation}.
 *
...
public abstract interface WebServiceFeatureAnnotationClassTests<SUT extends WebServiceFeatureAnnotation>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceFeatureAnnotation.class!",
                   WebServiceFeatureAnnotation.class.isAssignableFrom(sut));
    }

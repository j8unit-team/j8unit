 ...
 * javax.management.monitor.StringMonitor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringMonitorTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.management.monitor.StringMonitor class javax.management.monitor.StringMonitor (the hereby targeted
 *      class-under-test class)
 * @see StringMonitorTests StringMonitorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StringMonitorClassTests<SUT extends javax.management.monitor.StringMonitor>
extends StringMonitorMBeanClassTests<SUT>, MonitorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.StringMonitor.class!",
                   javax.management.monitor.StringMonitor.class.isAssignableFrom(sut));
    }

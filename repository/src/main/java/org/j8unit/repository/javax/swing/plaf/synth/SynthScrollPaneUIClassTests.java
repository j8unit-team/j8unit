...
import org.j8unit.repository.javax.swing.plaf.basic.BasicScrollPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthScrollPaneUI
 * public class javax.swing.plaf.synth.SynthScrollPaneUI}.
 *
...
public abstract interface SynthScrollPaneUIClassTests<SUT extends SynthScrollPaneUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicScrollPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthScrollPaneUI.class!",
                   SynthScrollPaneUI.class.isAssignableFrom(sut));
    }

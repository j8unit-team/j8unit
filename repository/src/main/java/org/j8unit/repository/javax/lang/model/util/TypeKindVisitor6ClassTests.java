 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeKindVisitor6
 * public class javax.lang.model.util.TypeKindVisitor6<R,P>}.
 *
...
public abstract interface TypeKindVisitor6ClassTests<SUT extends TypeKindVisitor6>
extends SimpleTypeVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeKindVisitor6.class!",

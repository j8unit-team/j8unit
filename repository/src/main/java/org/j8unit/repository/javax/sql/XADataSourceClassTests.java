 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XADataSource public
 * abstract interface javax.sql.XADataSource}.
 *
...
extends CommonDataSourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XADataSource.class!",

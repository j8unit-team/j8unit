 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XADataSourceTests}).
 * </p>
 *
 * <p>
 ...
 * @see XADataSourceTests XADataSourceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XADataSourceClassTests<SUT extends javax.sql.XADataSource>
extends CommonDataSourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.XADataSource.class!",
                   javax.sql.XADataSource.class.isAssignableFrom(sut));
    }

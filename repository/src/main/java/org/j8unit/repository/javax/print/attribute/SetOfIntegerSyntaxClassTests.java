 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SetOfIntegerSyntax
 * public abstract class javax.print.attribute.SetOfIntegerSyntax}.
 *
...
public abstract interface SetOfIntegerSyntaxClassTests<SUT extends SetOfIntegerSyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SetOfIntegerSyntax.class!",
                   SetOfIntegerSyntax.class.isAssignableFrom(sut));
    }

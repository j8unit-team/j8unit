 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterState public
 * final class javax.print.attribute.standard.PrinterState}.
 *
...
public abstract interface PrinterStateClassTests<SUT extends PrinterState>
extends PrintServiceAttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterState.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.PrinterState class
 * javax.print.attribute.standard.PrinterState}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterStateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterStateTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PrinterState class javax.print.attribute.standard.PrinterState (the hereby
 *      targeted class-under-test class)
 * @see PrinterStateTests PrinterStateTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PrinterStateClassTests<SUT extends javax.print.attribute.standard.PrinterState>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterState.class!",
                   javax.print.attribute.standard.PrinterState.class.isAssignableFrom(sut));
    }

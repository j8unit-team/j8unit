 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LdapContext public
 * abstract interface javax.naming.ldap.LdapContext}.
 *
...
public abstract interface LdapContextClassTests<SUT extends LdapContext>
extends DirContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LdapContext.class!",
                   LdapContext.class.isAssignableFrom(sut));
    }

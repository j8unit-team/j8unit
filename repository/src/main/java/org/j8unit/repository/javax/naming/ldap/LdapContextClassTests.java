 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LdapContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LdapContextTests}.
 * </p>
 *
 * @see javax.naming.ldap.LdapContext interface javax.naming.ldap.LdapContext (the hereby targeted class-under-test
 *      class)
 * @see LdapContextTests LdapContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LdapContextClassTests<SUT extends javax.naming.ldap.LdapContext>
extends org.j8unit.repository.javax.naming.directory.DirContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.LdapContext.class!",
                   javax.naming.ldap.LdapContext.class.isAssignableFrom(sut));
    }

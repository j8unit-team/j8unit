 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Util public class
...
public abstract interface UtilClassTests<SUT extends Util>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Util.class!", Util.class.isAssignableFrom(sut));
    }

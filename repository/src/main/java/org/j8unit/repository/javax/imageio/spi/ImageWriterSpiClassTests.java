 ...
 * javax.imageio.spi.ImageWriterSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageWriterSpiTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ImageWriterSpiTests ImageWriterSpiTests (The complementary j8unit test interface containing the instance
...
extends ImageReaderWriterSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.ImageWriterSpi.class!",
                   javax.imageio.spi.ImageWriterSpi.class.isAssignableFrom(sut));
    }

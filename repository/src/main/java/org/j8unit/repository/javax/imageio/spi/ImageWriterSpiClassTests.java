 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageWriterSpi
 * public abstract class javax.imageio.spi.ImageWriterSpi}.
 *
...
extends org.j8unit.repository.javax.imageio.spi.ImageReaderWriterSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageWriterSpi.class!",
                   ImageWriterSpi.class.isAssignableFrom(sut));
    }

 ...
 * javax.net.ssl.CertPathTrustManagerParameters}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CertPathTrustManagerParametersTests}).
 * </p>
 *
 * <p>
 ...
 * @see CertPathTrustManagerParametersTests CertPathTrustManagerParametersTests (The complementary j8unit test interface
...
extends ManagerFactoryParametersClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.CertPathTrustManagerParameters.class!",
                   javax.net.ssl.CertPathTrustManagerParameters.class.isAssignableFrom(sut));
    }

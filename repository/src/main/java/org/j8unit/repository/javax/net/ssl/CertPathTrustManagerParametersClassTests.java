 ...
 * {@link CertPathTrustManagerParameters public class javax.net.ssl.CertPathTrustManagerParameters}.
 *
...
public abstract interface CertPathTrustManagerParametersClassTests<SUT extends CertPathTrustManagerParameters>
extends org.j8unit.repository.javax.net.ssl.ManagerFactoryParametersClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathTrustManagerParameters.class!",
                   CertPathTrustManagerParameters.class.isAssignableFrom(sut));
    }

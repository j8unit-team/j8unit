...
public abstract interface DefaultBoundedRangeModelClassTests<SUT extends DefaultBoundedRangeModel>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultBoundedRangeModel.class!",
                   DefaultBoundedRangeModel.class.isAssignableFrom(sut));
    }

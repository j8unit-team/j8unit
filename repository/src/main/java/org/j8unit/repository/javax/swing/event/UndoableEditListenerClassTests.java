 ...
 * {@link UndoableEditListener public abstract interface javax.swing.event.UndoableEditListener}.
 *
 ...
 * {@link UndoableEditListenerTests}.
 * </p>
 *
 * <p>
...
public abstract interface UndoableEditListenerClassTests<SUT extends UndoableEditListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UndoableEditListener.class!",
                   UndoableEditListener.class.isAssignableFrom(sut));
    }

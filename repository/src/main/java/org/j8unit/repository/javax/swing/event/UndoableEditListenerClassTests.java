 ...
 * javax.swing.event.UndoableEditListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UndoableEditListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UndoableEditListenerTests}
 * .
 * </p>
 *
 * @see javax.swing.event.UndoableEditListener interface javax.swing.event.UndoableEditListener (the hereby targeted
 *      class-under-test class)
 * @see UndoableEditListenerTests UndoableEditListenerTests (The complementary j8unit test interface containing the
...
public abstract interface UndoableEditListenerClassTests<SUT extends javax.swing.event.UndoableEditListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.UndoableEditListener.class!",
                   javax.swing.event.UndoableEditListener.class.isAssignableFrom(sut));
    }

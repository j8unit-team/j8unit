 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Resources public
 * abstract @interface javax.annotation.Resources}.
 *
...
public abstract interface ResourcesClassTests<SUT extends Resources>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Resources.class!",
                   Resources.class.isAssignableFrom(sut));
    }

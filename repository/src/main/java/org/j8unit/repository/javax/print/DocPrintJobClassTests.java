...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.DocPrintJob interface javax.print.DocPrintJob}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocPrintJobTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocPrintJobTests}.
 * </p>
 *
 * @see javax.print.DocPrintJob interface javax.print.DocPrintJob (the hereby targeted class-under-test class)
 * @see DocPrintJobTests DocPrintJobTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DocPrintJobClassTests<SUT extends javax.print.DocPrintJob>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.DocPrintJob.class!",
                   javax.print.DocPrintJob.class.isAssignableFrom(sut));
    }

 ...
 * javax.crypto.spec.DHPublicKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DHPublicKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DHPublicKeySpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.DHPublicKeySpec class javax.crypto.spec.DHPublicKeySpec (the hereby targeted class-under-test
 *      class)
 * @see DHPublicKeySpecTests DHPublicKeySpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.DHPublicKeySpec.class!",
                   javax.crypto.spec.DHPublicKeySpec.class.isAssignableFrom(sut));
    }

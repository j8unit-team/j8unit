 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DHPublicKeySpec
...
public abstract interface DHPublicKeySpecClassTests<SUT extends DHPublicKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DHPublicKeySpec.class!",
                   DHPublicKeySpec.class.isAssignableFrom(sut));
    }

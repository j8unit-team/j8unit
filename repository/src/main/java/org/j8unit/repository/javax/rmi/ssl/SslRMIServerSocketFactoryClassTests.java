...
import org.j8unit.repository.java.rmi.server.RMIServerSocketFactoryClassTests;
 ...
 * {@link SslRMIServerSocketFactory public class javax.rmi.ssl.SslRMIServerSocketFactory}.
 *
 ...
 * {@link SslRMIServerSocketFactoryTests}.
 * </p>
 *
 * <p>
...
public abstract interface SslRMIServerSocketFactoryClassTests<SUT extends SslRMIServerSocketFactory>
extends RMIServerSocketFactoryClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SslRMIServerSocketFactory.class!",
                   SslRMIServerSocketFactory.class.isAssignableFrom(sut));
    }

 ...
 * javax.rmi.ssl.SslRMIServerSocketFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * @see SslRMIServerSocketFactoryTests SslRMIServerSocketFactoryTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.rmi.server.RMIServerSocketFactoryClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.ssl.SslRMIServerSocketFactory.class!",
                   javax.rmi.ssl.SslRMIServerSocketFactory.class.isAssignableFrom(sut));
    }

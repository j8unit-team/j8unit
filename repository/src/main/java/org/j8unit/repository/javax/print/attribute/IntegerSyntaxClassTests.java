 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntegerSyntax
 * public abstract class javax.print.attribute.IntegerSyntax}.
 *
...
public abstract interface IntegerSyntaxClassTests<SUT extends IntegerSyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntegerSyntax.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.IntegerSyntax class
 * javax.print.attribute.IntegerSyntax}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntegerSyntaxTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntegerSyntaxTests}.
 * </p>
 *
 * @see javax.print.attribute.IntegerSyntax class javax.print.attribute.IntegerSyntax (the hereby targeted
 *      class-under-test class)
 * @see IntegerSyntaxTests IntegerSyntaxTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface IntegerSyntaxClassTests<SUT extends javax.print.attribute.IntegerSyntax>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.IntegerSyntax.class!",
                   javax.print.attribute.IntegerSyntax.class.isAssignableFrom(sut));
    }

...
public abstract interface ValidationEventHandlerClassTests<SUT extends ValidationEventHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValidationEventHandler.class!",
                   ValidationEventHandler.class.isAssignableFrom(sut));
    }

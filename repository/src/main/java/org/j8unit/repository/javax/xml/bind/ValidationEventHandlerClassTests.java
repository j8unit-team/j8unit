 ...
 * javax.xml.bind.ValidationEventHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValidationEventHandlerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ValidationEventHandlerTests}.
 * </p>
 *
 * @see javax.xml.bind.ValidationEventHandler interface javax.xml.bind.ValidationEventHandler (the hereby targeted
 *      class-under-test class)
 * @see ValidationEventHandlerTests ValidationEventHandlerTests (The complementary j8unit test interface containing the
...
public abstract interface ValidationEventHandlerClassTests<SUT extends javax.xml.bind.ValidationEventHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.ValidationEventHandler.class!",
                   javax.xml.bind.ValidationEventHandler.class.isAssignableFrom(sut));
    }

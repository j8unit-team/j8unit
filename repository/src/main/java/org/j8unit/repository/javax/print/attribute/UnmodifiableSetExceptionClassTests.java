 ...
 * {@link UnmodifiableSetException public class javax.print.attribute.UnmodifiableSetException}.
 *
...
public abstract interface UnmodifiableSetExceptionClassTests<SUT extends UnmodifiableSetException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.UnmodifiableSetException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnmodifiableSetException.class!",
                   UnmodifiableSetException.class.isAssignableFrom(sut));
    }

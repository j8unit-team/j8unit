 ...
 * javax.print.attribute.UnmodifiableSetException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnmodifiableSetExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link UnmodifiableSetExceptionTests}.
 * </p>
 *
 * @see javax.print.attribute.UnmodifiableSetException class javax.print.attribute.UnmodifiableSetException (the hereby
 *      targeted class-under-test class)
 * @see UnmodifiableSetExceptionTests UnmodifiableSetExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.UnmodifiableSetException.class!",
                   javax.print.attribute.UnmodifiableSetException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractButton
...
public abstract interface AbstractButtonClassTests<SUT extends AbstractButton>
extends ItemSelectableClassTests<SUT>, SwingConstantsClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractButton.class!",
                   AbstractButton.class.isAssignableFrom(sut));
    }

...
public abstract interface ColorChooserComponentFactoryClassTests<SUT extends ColorChooserComponentFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorChooserComponentFactory.class!",
                   ColorChooserComponentFactory.class.isAssignableFrom(sut));
    }

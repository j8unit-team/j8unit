 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebFault public
 * abstract @interface javax.xml.ws.WebFault}.
 *
...
public abstract interface WebFaultClassTests<SUT extends WebFault>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebFault.class!",
                   WebFault.class.isAssignableFrom(sut));
    }

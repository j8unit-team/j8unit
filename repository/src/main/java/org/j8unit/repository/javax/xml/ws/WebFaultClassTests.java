 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebFaultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebFaultTests}.
 * </p>
 *
 * @see javax.xml.ws.WebFault interface javax.xml.ws.WebFault (the hereby targeted class-under-test class)
 * @see WebFaultTests WebFaultTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WebFaultClassTests<SUT extends javax.xml.ws.WebFault>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebFault.class!",
                   javax.xml.ws.WebFault.class.isAssignableFrom(sut));
    }

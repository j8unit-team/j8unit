 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiTableUI public
...
public abstract interface MultiTableUIClassTests<SUT extends MultiTableUI>
extends TableUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiTableUI.class!",
                   MultiTableUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.plaf.multi.MultiTableUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiTableUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiTableUITests}.
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiTableUI class javax.swing.plaf.multi.MultiTableUI (the hereby targeted
 *      class-under-test class)
 * @see MultiTableUITests MultiTableUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MultiTableUIClassTests<SUT extends javax.swing.plaf.multi.MultiTableUI>
extends org.j8unit.repository.javax.swing.plaf.TableUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiTableUI.class!",
                   javax.swing.plaf.multi.MultiTableUI.class.isAssignableFrom(sut));
    }

...
public abstract interface ManageReferralControlClassTests<SUT extends ManageReferralControl>
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ManageReferralControl.class!",
                   ManageReferralControl.class.isAssignableFrom(sut));
    }

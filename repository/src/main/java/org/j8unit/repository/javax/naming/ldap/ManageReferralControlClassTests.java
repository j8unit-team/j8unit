 ...
 * javax.naming.ldap.ManageReferralControl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ManageReferralControlTests}).
 * </p>
 *
 * <p>
 ...
 * @see ManageReferralControlTests ManageReferralControlTests (The complementary j8unit test interface containing the
...
public abstract interface ManageReferralControlClassTests<SUT extends javax.naming.ldap.ManageReferralControl>
extends BasicControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.ManageReferralControl.class!",
                   javax.naming.ldap.ManageReferralControl.class.isAssignableFrom(sut));
    }

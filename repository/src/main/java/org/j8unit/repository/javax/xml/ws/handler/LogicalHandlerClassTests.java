 ...
 * javax.xml.ws.handler.LogicalHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LogicalHandlerTests}).
 * </p>
 *
 * <p>
 ...
 * @see LogicalHandlerTests LogicalHandlerTests (The complementary j8unit test interface containing the instance
...
extends HandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.LogicalHandler.class!",
                   javax.xml.ws.handler.LogicalHandler.class.isAssignableFrom(sut));
    }

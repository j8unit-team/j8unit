 ...
 * javax.sound.sampled.spi.AudioFileReader}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AudioFileReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AudioFileReaderTests}.
 * </p>
 *
 * @see javax.sound.sampled.spi.AudioFileReader class javax.sound.sampled.spi.AudioFileReader (the hereby targeted
 *      class-under-test class)
 * @see AudioFileReaderTests AudioFileReaderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.spi.AudioFileReader.class!",
                   javax.sound.sampled.spi.AudioFileReader.class.isAssignableFrom(sut));
    }

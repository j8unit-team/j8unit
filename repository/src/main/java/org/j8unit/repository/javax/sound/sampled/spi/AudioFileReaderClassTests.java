 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AudioFileReader
 * public abstract class javax.sound.sampled.spi.AudioFileReader}.
 *
...
public abstract interface AudioFileReaderClassTests<SUT extends AudioFileReader>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AudioFileReader.class!",
                   AudioFileReader.class.isAssignableFrom(sut));
    }

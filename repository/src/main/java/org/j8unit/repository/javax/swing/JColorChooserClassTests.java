 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JColorChooserTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JColorChooserTests}.
 * </p>
 *
 * @see javax.swing.JColorChooser class javax.swing.JColorChooser (the hereby targeted class-under-test class)
 * @see JColorChooserTests JColorChooserTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JColorChooser.class!",
                   javax.swing.JColorChooser.class.isAssignableFrom(sut));
    }

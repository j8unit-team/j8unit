 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JColorChooser
...
public abstract interface JColorChooserClassTests<SUT extends JColorChooser>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JColorChooser.class!",
                   JColorChooser.class.isAssignableFrom(sut));
    }

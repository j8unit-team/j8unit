...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.soap.Node interface javax.xml.soap.Node}, containing all
...
public abstract interface NodeClassTests<SUT extends javax.xml.soap.Node>
extends org.j8unit.repository.org.w3c.dom.NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.Node.class!",
                   javax.xml.soap.Node.class.isAssignableFrom(sut));
    }

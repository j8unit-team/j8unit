...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.NotificationListener interface
 * javax.management.NotificationListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotificationListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotificationListenerTests}
 * .
 * </p>
 *
 * @see javax.management.NotificationListener interface javax.management.NotificationListener (the hereby targeted
 *      class-under-test class)
 * @see NotificationListenerTests NotificationListenerTests (The complementary j8unit test interface containing the
...
public abstract interface NotificationListenerClassTests<SUT extends javax.management.NotificationListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.NotificationListener.class!",
                   javax.management.NotificationListener.class.isAssignableFrom(sut));
    }

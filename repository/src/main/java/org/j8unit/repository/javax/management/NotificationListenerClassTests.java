...
public abstract interface NotificationListenerClassTests<SUT extends NotificationListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotificationListener.class!",
                   NotificationListener.class.isAssignableFrom(sut));
    }

...
public abstract interface PrintJobAttributeListenerClassTests<SUT extends PrintJobAttributeListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintJobAttributeListener.class!",
                   PrintJobAttributeListener.class.isAssignableFrom(sut));
    }

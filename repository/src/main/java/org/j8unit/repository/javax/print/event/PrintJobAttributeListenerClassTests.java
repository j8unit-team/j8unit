 ...
 * javax.print.event.PrintJobAttributeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see PrintJobAttributeListenerTests PrintJobAttributeListenerTests (The complementary j8unit test interface
...
public abstract interface PrintJobAttributeListenerClassTests<SUT extends javax.print.event.PrintJobAttributeListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.event.PrintJobAttributeListener.class!",
                   javax.print.event.PrintJobAttributeListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.OpenMBeanInfo interface
 * javax.management.openmbean.OpenMBeanInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenMBeanInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OpenMBeanInfoTests}.
 * </p>
 *
 * @see javax.management.openmbean.OpenMBeanInfo interface javax.management.openmbean.OpenMBeanInfo (the hereby targeted
 *      class-under-test class)
 * @see OpenMBeanInfoTests OpenMBeanInfoTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface OpenMBeanInfoClassTests<SUT extends javax.management.openmbean.OpenMBeanInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenMBeanInfo.class!",
                   javax.management.openmbean.OpenMBeanInfo.class.isAssignableFrom(sut));
    }

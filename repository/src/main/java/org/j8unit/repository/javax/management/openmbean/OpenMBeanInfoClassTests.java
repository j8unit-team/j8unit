 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OpenMBeanInfo
...
public abstract interface OpenMBeanInfoClassTests<SUT extends OpenMBeanInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanInfo.class!",
                   OpenMBeanInfo.class.isAssignableFrom(sut));
    }

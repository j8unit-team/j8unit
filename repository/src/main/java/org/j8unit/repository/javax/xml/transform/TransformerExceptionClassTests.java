 ...
 * {@link TransformerException public class javax.xml.transform.TransformerException}.
 *
...
public abstract interface TransformerExceptionClassTests<SUT extends TransformerException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransformerException.class!",
                   TransformerException.class.isAssignableFrom(sut));
    }

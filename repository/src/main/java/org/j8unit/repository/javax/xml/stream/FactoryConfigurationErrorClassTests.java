 ...
 * javax.xml.stream.FactoryConfigurationError}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link FactoryConfigurationErrorTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.stream.FactoryConfigurationError class javax.xml.stream.FactoryConfigurationError (the hereby targeted
 *      class-under-test class)
 * @see FactoryConfigurationErrorTests FactoryConfigurationErrorTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.FactoryConfigurationError.class!",
                   javax.xml.stream.FactoryConfigurationError.class.isAssignableFrom(sut));
    }

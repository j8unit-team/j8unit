...
import org.j8unit.repository.javax.lang.model.UnknownEntityExceptionClassTests;
...
public abstract interface UnknownElementExceptionClassTests<SUT extends UnknownElementException>
extends UnknownEntityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownElementException.class!",
                   UnknownElementException.class.isAssignableFrom(sut));
    }

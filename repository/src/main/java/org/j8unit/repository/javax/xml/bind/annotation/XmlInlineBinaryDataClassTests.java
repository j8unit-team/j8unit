 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlInlineBinaryData
 * public abstract @interface javax.xml.bind.annotation.XmlInlineBinaryData}.
 *
...
public abstract interface XmlInlineBinaryDataClassTests<SUT extends XmlInlineBinaryData>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlInlineBinaryData.class!",
                   XmlInlineBinaryData.class.isAssignableFrom(sut));
    }

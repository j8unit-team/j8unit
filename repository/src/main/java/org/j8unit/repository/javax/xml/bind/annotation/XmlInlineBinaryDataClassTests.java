...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlInlineBinaryData interface
 * javax.xml.bind.annotation.XmlInlineBinaryData}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlInlineBinaryDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlInlineBinaryDataTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlInlineBinaryData interface javax.xml.bind.annotation.XmlInlineBinaryData (the
 *      hereby targeted class-under-test class)
 * @see XmlInlineBinaryDataTests XmlInlineBinaryDataTests (The complementary j8unit test interface containing the
...
public abstract interface XmlInlineBinaryDataClassTests<SUT extends javax.xml.bind.annotation.XmlInlineBinaryData>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlInlineBinaryData.class!",
                   javax.xml.bind.annotation.XmlInlineBinaryData.class.isAssignableFrom(sut));
    }

...
public abstract interface SimpleAnnotationValueVisitor8ClassTests<SUT extends SimpleAnnotationValueVisitor8>
extends SimpleAnnotationValueVisitor7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleAnnotationValueVisitor8.class!",
                   SimpleAnnotationValueVisitor8.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XPath public
 * abstract interface javax.xml.xpath.XPath}.
 *
...
public abstract interface XPathClassTests<SUT extends XPath>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPath.class!", XPath.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XPathTests}.
 * </p>
 *
 * @see javax.xml.xpath.XPath interface javax.xml.xpath.XPath (the hereby targeted class-under-test class)
 * @see XPathTests XPathTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface XPathClassTests<SUT extends javax.xml.xpath.XPath>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.xpath.XPath.class!",
                   javax.xml.xpath.XPath.class.isAssignableFrom(sut));
    }

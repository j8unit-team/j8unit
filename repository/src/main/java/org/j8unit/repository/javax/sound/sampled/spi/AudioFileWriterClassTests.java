 ...
 * javax.sound.sampled.spi.AudioFileWriter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AudioFileWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AudioFileWriterTests}.
 * </p>
 *
 * @see javax.sound.sampled.spi.AudioFileWriter class javax.sound.sampled.spi.AudioFileWriter (the hereby targeted
 *      class-under-test class)
 * @see AudioFileWriterTests AudioFileWriterTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.spi.AudioFileWriter.class!",
                   javax.sound.sampled.spi.AudioFileWriter.class.isAssignableFrom(sut));
    }

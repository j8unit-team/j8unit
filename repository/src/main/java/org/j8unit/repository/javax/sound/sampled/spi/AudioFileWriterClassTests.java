 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AudioFileWriter
...
public abstract interface AudioFileWriterClassTests<SUT extends AudioFileWriter>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.sound.sampled.spi.AudioFileWriter]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AudioFileWriter.class!",
                   AudioFileWriter.class.isAssignableFrom(sut));
    }

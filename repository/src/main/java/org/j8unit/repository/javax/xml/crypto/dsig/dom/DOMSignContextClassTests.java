 ...
 * javax.xml.crypto.dsig.dom.DOMSignContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMSignContextTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.crypto.dsig.dom.DOMSignContext class javax.xml.crypto.dsig.dom.DOMSignContext (the hereby targeted
 *      class-under-test class)
 * @see DOMSignContextTests DOMSignContextTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.xml.crypto.dsig.XMLSignContextClassTests<SUT>, org.j8unit.repository.javax.xml.crypto.dom.DOMCryptoContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.dom.DOMSignContext.class!",
                   javax.xml.crypto.dsig.dom.DOMSignContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMSignContext
...
extends XMLSignContextClassTests<SUT>, DOMCryptoContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMSignContext.class!",
                   DOMSignContext.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.auth.kerberos.KerberosTicket}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KerberosTicketTests}).
 * </p>
 *
 * <p>
 ...
 * @see KerberosTicketTests KerberosTicketTests (The complementary j8unit test interface containing the instance
...
public abstract interface KerberosTicketClassTests<SUT extends javax.security.auth.kerberos.KerberosTicket>
...
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.kerberos.KerberosTicket.class!",
                   javax.security.auth.kerberos.KerberosTicket.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KerberosTicket
...
extends DestroyableClassTests<SUT>, RefreshableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KerberosTicket.class!",
                   KerberosTicket.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.net.ServerSocketClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLServerSocket
...
public abstract interface SSLServerSocketClassTests<SUT extends SSLServerSocket>
extends ServerSocketClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLServerSocket.class!",
                   SSLServerSocket.class.isAssignableFrom(sut));
    }

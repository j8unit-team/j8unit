 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLServerSocketTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLServerSocketTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLServerSocket class javax.net.ssl.SSLServerSocket (the hereby targeted class-under-test class)
 * @see SSLServerSocketTests SSLServerSocketTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.net.ServerSocketClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLServerSocket.class!",
                   javax.net.ssl.SSLServerSocket.class.isAssignableFrom(sut));
    }

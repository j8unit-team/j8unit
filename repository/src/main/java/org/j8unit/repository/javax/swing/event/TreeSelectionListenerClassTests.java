...
public abstract interface TreeSelectionListenerClassTests<SUT extends TreeSelectionListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeSelectionListener.class!",
                   TreeSelectionListener.class.isAssignableFrom(sut));
    }

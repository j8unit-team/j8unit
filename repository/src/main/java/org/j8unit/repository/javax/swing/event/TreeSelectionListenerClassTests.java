...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.TreeSelectionListener interface
 * javax.swing.event.TreeSelectionListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeSelectionListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link TreeSelectionListenerTests}.
 * </p>
 *
 * @see javax.swing.event.TreeSelectionListener interface javax.swing.event.TreeSelectionListener (the hereby targeted
 *      class-under-test class)
 * @see TreeSelectionListenerTests TreeSelectionListenerTests (The complementary j8unit test interface containing the
...
public abstract interface TreeSelectionListenerClassTests<SUT extends javax.swing.event.TreeSelectionListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TreeSelectionListener.class!",
                   javax.swing.event.TreeSelectionListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.lang.model.util.Elements interface
 * javax.lang.model.util.Elements}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ElementsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ElementsTests}.
 * </p>
 *
 * @see javax.lang.model.util.Elements interface javax.lang.model.util.Elements (the hereby targeted class-under-test
 *      class)
 * @see ElementsTests ElementsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ElementsClassTests<SUT extends javax.lang.model.util.Elements>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.util.Elements.class!",
                   javax.lang.model.util.Elements.class.isAssignableFrom(sut));
    }

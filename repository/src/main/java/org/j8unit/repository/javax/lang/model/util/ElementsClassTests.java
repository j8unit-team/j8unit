 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Elements public
...
public abstract interface ElementsClassTests<SUT extends Elements>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Elements.class!",
                   Elements.class.isAssignableFrom(sut));
    }

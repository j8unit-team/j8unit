 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ButtonModel public
...
public abstract interface ButtonModelClassTests<SUT extends ButtonModel>
extends ItemSelectableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ButtonModel.class!",
                   ButtonModel.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.ButtonModel interface javax.swing.ButtonModel}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ButtonModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ButtonModelTests}.
 * </p>
 *
 * @see javax.swing.ButtonModel interface javax.swing.ButtonModel (the hereby targeted class-under-test class)
 * @see ButtonModelTests ButtonModelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ButtonModelClassTests<SUT extends javax.swing.ButtonModel>
extends org.j8unit.repository.java.awt.ItemSelectableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.ButtonModel.class!",
                   javax.swing.ButtonModel.class.isAssignableFrom(sut));
    }

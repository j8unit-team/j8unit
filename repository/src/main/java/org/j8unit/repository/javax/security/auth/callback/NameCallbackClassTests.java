 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameCallback public
...
public abstract interface NameCallbackClassTests<SUT extends NameCallback>
extends CallbackClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameCallback.class!",
                   NameCallback.class.isAssignableFrom(sut));
    }

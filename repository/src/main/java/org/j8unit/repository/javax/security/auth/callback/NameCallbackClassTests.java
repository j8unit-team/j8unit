...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.security.auth.callback.NameCallback class
 * javax.security.auth.callback.NameCallback}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NameCallbackTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NameCallbackTests}.
 * </p>
 *
 * @see javax.security.auth.callback.NameCallback class javax.security.auth.callback.NameCallback (the hereby targeted
 *      class-under-test class)
 * @see NameCallbackTests NameCallbackTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NameCallbackClassTests<SUT extends javax.security.auth.callback.NameCallback>
extends CallbackClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.callback.NameCallback.class!",
                   javax.security.auth.callback.NameCallback.class.isAssignableFrom(sut));
    }

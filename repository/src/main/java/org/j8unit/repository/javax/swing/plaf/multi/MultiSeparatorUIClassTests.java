 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiSeparatorUI
 * public class javax.swing.plaf.multi.MultiSeparatorUI}.
 *
...
public abstract interface MultiSeparatorUIClassTests<SUT extends MultiSeparatorUI>
extends SeparatorUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiSeparatorUI.class!",
                   MultiSeparatorUI.class.isAssignableFrom(sut));
    }

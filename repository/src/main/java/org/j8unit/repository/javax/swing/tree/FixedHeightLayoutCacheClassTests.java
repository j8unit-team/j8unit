...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.tree.FixedHeightLayoutCache class
 * javax.swing.tree.FixedHeightLayoutCache}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FixedHeightLayoutCacheTests}).
 * </p>
 *
 * <p>
 ...
 * {@link FixedHeightLayoutCacheTests}.
 * </p>
 *
 * @see javax.swing.tree.FixedHeightLayoutCache class javax.swing.tree.FixedHeightLayoutCache (the hereby targeted
 *      class-under-test class)
 * @see FixedHeightLayoutCacheTests FixedHeightLayoutCacheTests (The complementary j8unit test interface containing the
...
extends AbstractLayoutCacheClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.tree.FixedHeightLayoutCache.class!",
                   javax.swing.tree.FixedHeightLayoutCache.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.auth.login.ConfigurationSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConfigurationSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConfigurationSpiTests}.
 * </p>
 *
 * @see javax.security.auth.login.ConfigurationSpi class javax.security.auth.login.ConfigurationSpi (the hereby targeted
 *      class-under-test class)
 * @see ConfigurationSpiTests ConfigurationSpiTests (The complementary j8unit test interface containing the instance
...
public abstract interface ConfigurationSpiClassTests<SUT extends javax.security.auth.login.ConfigurationSpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.ConfigurationSpi.class!",
                   javax.security.auth.login.ConfigurationSpi.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ConfigurationSpi
 * public abstract class javax.security.auth.login.ConfigurationSpi}.
 *
...
public abstract interface ConfigurationSpiClassTests<SUT extends ConfigurationSpi>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.security.auth.login.ConfigurationSpi]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConfigurationSpi.class!",
                   ConfigurationSpi.class.isAssignableFrom(sut));
    }

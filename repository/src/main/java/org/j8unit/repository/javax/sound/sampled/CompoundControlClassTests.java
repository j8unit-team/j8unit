 ...
 * javax.sound.sampled.CompoundControl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompoundControlTests}).
 * </p>
 *
 * <p>
 ...
 * @see CompoundControlTests CompoundControlTests (The complementary j8unit test interface containing the instance
...
public abstract interface CompoundControlClassTests<SUT extends javax.sound.sampled.CompoundControl>
extends ControlClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.CompoundControl.class!",
                   javax.sound.sampled.CompoundControl.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.CompoundControl.Type class
     * javax.sound.sampled.CompoundControl$Type}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link CompoundControlTests.TypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class-under-test class)
     * @see CompoundControlTests.TypeTests CompoundControlTests.TypeTests (The complementary j8unit test interface
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface TypeClassTests<SUT extends javax.sound.sampled.CompoundControl.Type>
    extends ControlClassTests.TypeClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.CompoundControl.Type.class!",
                       javax.sound.sampled.CompoundControl.Type.class.isAssignableFrom(sut));
        }

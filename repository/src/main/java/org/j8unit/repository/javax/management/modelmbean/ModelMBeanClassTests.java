...
import org.j8unit.repository.javax.management.DynamicMBeanClassTests;
import org.j8unit.repository.javax.management.PersistentMBeanClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ModelMBean public
 * abstract interface javax.management.modelmbean.ModelMBean}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ModelMBeanTests}.
 * </p>
 *
 * <p>
...
public abstract interface ModelMBeanClassTests<SUT extends ModelMBean>
extends DynamicMBeanClassTests<SUT>, PersistentMBeanClassTests<SUT>, ModelMBeanNotificationBroadcasterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ModelMBean.class!",

 ...
 * javax.management.modelmbean.ModelMBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ModelMBeanTests}).
 * </p>
 *
 * <p>
 ...
 * @see ModelMBeanTests ModelMBeanTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
ModelMBeanNotificationBroadcasterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.modelmbean.ModelMBean.class!",
                   javax.management.modelmbean.ModelMBean.class.isAssignableFrom(sut));
    }

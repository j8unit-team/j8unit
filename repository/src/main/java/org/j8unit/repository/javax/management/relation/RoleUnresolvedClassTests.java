 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoleUnresolved
...
public abstract interface RoleUnresolvedClassTests<SUT extends RoleUnresolved>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleUnresolved.class!",
                   RoleUnresolved.class.isAssignableFrom(sut));
    }

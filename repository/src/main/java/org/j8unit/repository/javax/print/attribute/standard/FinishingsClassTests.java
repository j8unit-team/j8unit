...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.Finishings class
 * javax.print.attribute.standard.Finishings}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FinishingsTests}).
 * </p>
 *
 * <p>
 ...
 * @see FinishingsTests FinishingsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FinishingsClassTests<SUT extends javax.print.attribute.standard.Finishings>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.Finishings.class!",
                   javax.print.attribute.standard.Finishings.class.isAssignableFrom(sut));
    }

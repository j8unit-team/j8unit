 ...
 * javax.naming.spi.ObjectFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectFactoryTests}.
 * </p>
 *
 * @see javax.naming.spi.ObjectFactory interface javax.naming.spi.ObjectFactory (the hereby targeted class-under-test
 *      class)
 * @see ObjectFactoryTests ObjectFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ObjectFactoryClassTests<SUT extends javax.naming.spi.ObjectFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.ObjectFactory.class!",
                   javax.naming.spi.ObjectFactory.class.isAssignableFrom(sut));
    }

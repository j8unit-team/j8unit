...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.PrintService interface javax.print.PrintService},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintServiceTests}.
 * </p>
 *
 * @see javax.print.PrintService interface javax.print.PrintService (the hereby targeted class-under-test class)
 * @see PrintServiceTests PrintServiceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PrintServiceClassTests<SUT extends javax.print.PrintService>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.PrintService.class!",
                   javax.print.PrintService.class.isAssignableFrom(sut));
    }

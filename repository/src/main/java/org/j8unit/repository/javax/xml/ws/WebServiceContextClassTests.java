...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.WebServiceContext interface
 * javax.xml.ws.WebServiceContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceContextTests}.
 * </p>
 *
 * @see javax.xml.ws.WebServiceContext interface javax.xml.ws.WebServiceContext (the hereby targeted class-under-test
 *      class)
 * @see WebServiceContextTests WebServiceContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface WebServiceContextClassTests<SUT extends javax.xml.ws.WebServiceContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServiceContext.class!",
                   javax.xml.ws.WebServiceContext.class.isAssignableFrom(sut));
    }

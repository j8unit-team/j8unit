 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebServiceContext
 * public abstract interface javax.xml.ws.WebServiceContext}.
 *
...
public abstract interface WebServiceContextClassTests<SUT extends WebServiceContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceContext.class!",
                   WebServiceContext.class.isAssignableFrom(sut));
    }

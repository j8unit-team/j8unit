 ...
 * javax.xml.crypto.dsig.spec.C14NMethodParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link C14NMethodParameterSpecTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see C14NMethodParameterSpecTests C14NMethodParameterSpecTests (The complementary j8unit test interface containing
...
public abstract interface C14NMethodParameterSpecClassTests<SUT extends javax.xml.crypto.dsig.spec.C14NMethodParameterSpec>
extends TransformParameterSpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.C14NMethodParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.C14NMethodParameterSpec.class.isAssignableFrom(sut));
    }

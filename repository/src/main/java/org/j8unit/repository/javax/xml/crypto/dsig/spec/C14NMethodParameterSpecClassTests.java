...
public abstract interface C14NMethodParameterSpecClassTests<SUT extends C14NMethodParameterSpec>
extends org.j8unit.repository.javax.xml.crypto.dsig.spec.TransformParameterSpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to C14NMethodParameterSpec.class!",
                   C14NMethodParameterSpec.class.isAssignableFrom(sut));
    }

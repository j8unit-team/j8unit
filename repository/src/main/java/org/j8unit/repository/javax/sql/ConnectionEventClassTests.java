 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ConnectionEvent
...
public abstract interface ConnectionEventClassTests<SUT extends ConnectionEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConnectionEvent.class!",
                   ConnectionEvent.class.isAssignableFrom(sut));
    }

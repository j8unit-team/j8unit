 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConnectionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConnectionEventTests}.
 * </p>
 *
 * @see javax.sql.ConnectionEvent class javax.sql.ConnectionEvent (the hereby targeted class-under-test class)
 * @see ConnectionEventTests ConnectionEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.ConnectionEvent.class!",
                   javax.sql.ConnectionEvent.class.isAssignableFrom(sut));
    }

 ...
 * {@link MBeanTrustPermissionTests}.
 * </p>
 *
 * <p>
...
public abstract interface MBeanTrustPermissionClassTests<SUT extends MBeanTrustPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanTrustPermission.class!",
                   MBeanTrustPermission.class.isAssignableFrom(sut));
    }

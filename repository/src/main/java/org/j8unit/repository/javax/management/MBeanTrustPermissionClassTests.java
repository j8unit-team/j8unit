 ...
 * javax.management.MBeanTrustPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanTrustPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanTrustPermissionTests}
 * .
 * </p>
 *
 * @see javax.management.MBeanTrustPermission class javax.management.MBeanTrustPermission (the hereby targeted
 *      class-under-test class)
 * @see MBeanTrustPermissionTests MBeanTrustPermissionTests (The complementary j8unit test interface containing the
...
public abstract interface MBeanTrustPermissionClassTests<SUT extends javax.management.MBeanTrustPermission>
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanTrustPermission.class!",
                   javax.management.MBeanTrustPermission.class.isAssignableFrom(sut));
    }

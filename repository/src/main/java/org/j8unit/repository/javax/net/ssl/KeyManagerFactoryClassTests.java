 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyManagerFactory
...
public abstract interface KeyManagerFactoryClassTests<SUT extends KeyManagerFactory>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.net.ssl.KeyManagerFactory]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyManagerFactory.class!",
                   KeyManagerFactory.class.isAssignableFrom(sut));
    }

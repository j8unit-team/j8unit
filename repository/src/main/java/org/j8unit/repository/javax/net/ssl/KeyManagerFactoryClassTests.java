 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyManagerFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyManagerFactoryTests}.
 * </p>
 *
 * @see javax.net.ssl.KeyManagerFactory class javax.net.ssl.KeyManagerFactory (the hereby targeted class-under-test
 *      class)
 * @see KeyManagerFactoryTests KeyManagerFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface KeyManagerFactoryClassTests<SUT extends javax.net.ssl.KeyManagerFactory>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.KeyManagerFactory.class!",
                   javax.net.ssl.KeyManagerFactory.class.isAssignableFrom(sut));
    }

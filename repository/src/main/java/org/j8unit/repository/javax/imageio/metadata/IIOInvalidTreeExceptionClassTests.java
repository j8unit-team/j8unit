...
import org.j8unit.repository.javax.imageio.IIOExceptionClassTests;
...
public abstract interface IIOInvalidTreeExceptionClassTests<SUT extends IIOInvalidTreeException>
extends IIOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOInvalidTreeException.class!",
                   IIOInvalidTreeException.class.isAssignableFrom(sut));
    }

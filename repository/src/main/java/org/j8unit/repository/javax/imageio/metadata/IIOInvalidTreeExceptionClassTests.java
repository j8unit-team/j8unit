 ...
 * javax.imageio.metadata.IIOInvalidTreeException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOInvalidTreeExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link IIOInvalidTreeExceptionTests}.
 * </p>
 *
 * @see javax.imageio.metadata.IIOInvalidTreeException class javax.imageio.metadata.IIOInvalidTreeException (the hereby
 *      targeted class-under-test class)
 * @see IIOInvalidTreeExceptionTests IIOInvalidTreeExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.imageio.IIOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.metadata.IIOInvalidTreeException.class!",
                   javax.imageio.metadata.IIOInvalidTreeException.class.isAssignableFrom(sut));
    }

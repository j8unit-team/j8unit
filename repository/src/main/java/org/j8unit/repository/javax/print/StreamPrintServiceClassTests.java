 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamPrintServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamPrintServiceTests}.
 * </p>
 *
 * @see javax.print.StreamPrintService class javax.print.StreamPrintService (the hereby targeted class-under-test class)
 * @see StreamPrintServiceTests StreamPrintServiceTests (The complementary j8unit test interface containing the instance
...
public abstract interface StreamPrintServiceClassTests<SUT extends javax.print.StreamPrintService>
extends PrintServiceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.StreamPrintService.class!",
                   javax.print.StreamPrintService.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StreamPrintService
 * public abstract class javax.print.StreamPrintService}.
 *
...
public abstract interface StreamPrintServiceClassTests<SUT extends StreamPrintService>
extends PrintServiceClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamPrintService.class!",
                   StreamPrintService.class.isAssignableFrom(sut));
    }

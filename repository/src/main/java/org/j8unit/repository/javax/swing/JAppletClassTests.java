...
import org.j8unit.repository.java.applet.AppletClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JApplet public
...
public abstract interface JAppletClassTests<SUT extends JApplet>
extends RootPaneContainerClassTests<SUT>, AppletClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JApplet.class!",
                   JApplet.class.isAssignableFrom(sut));
    }

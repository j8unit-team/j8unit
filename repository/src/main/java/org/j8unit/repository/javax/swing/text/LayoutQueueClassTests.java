 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LayoutQueue public
...
public abstract interface LayoutQueueClassTests<SUT extends LayoutQueue>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.LayoutQueue]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LayoutQueue.class!",
                   LayoutQueue.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LayoutQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LayoutQueueTests}.
 * </p>
 *
 * @see javax.swing.text.LayoutQueue class javax.swing.text.LayoutQueue (the hereby targeted class-under-test class)
 * @see LayoutQueueTests LayoutQueueTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.LayoutQueue.class!",
                   javax.swing.text.LayoutQueue.class.isAssignableFrom(sut));
    }

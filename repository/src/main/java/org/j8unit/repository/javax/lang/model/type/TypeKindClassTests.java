 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeKind public
...
public abstract interface TypeKindClassTests<SUT extends TypeKind>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeKind.class!",
                   TypeKind.class.isAssignableFrom(sut));
    }

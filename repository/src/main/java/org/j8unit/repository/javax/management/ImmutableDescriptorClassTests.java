 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImmutableDescriptor
 * public class javax.management.ImmutableDescriptor}.
 *
...
public abstract interface ImmutableDescriptorClassTests<SUT extends ImmutableDescriptor>
extends DescriptorClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImmutableDescriptor.class!",
                   ImmutableDescriptor.class.isAssignableFrom(sut));
    }

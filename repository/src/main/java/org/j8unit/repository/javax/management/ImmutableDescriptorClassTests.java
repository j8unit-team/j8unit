 ...
 * javax.management.ImmutableDescriptor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImmutableDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImmutableDescriptorTests}.
 * </p>
 *
 * @see javax.management.ImmutableDescriptor class javax.management.ImmutableDescriptor (the hereby targeted
 *      class-under-test class)
 * @see ImmutableDescriptorTests ImmutableDescriptorTests (The complementary j8unit test interface containing the
...
extends DescriptorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.ImmutableDescriptor.class!",
                   javax.management.ImmutableDescriptor.class.isAssignableFrom(sut));
    }

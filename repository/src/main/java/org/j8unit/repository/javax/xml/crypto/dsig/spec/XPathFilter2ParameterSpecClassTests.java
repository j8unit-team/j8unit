 ...
 * javax.xml.crypto.dsig.spec.XPathFilter2ParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link XPathFilter2ParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.crypto.dsig.spec.XPathFilter2ParameterSpec class javax.xml.crypto.dsig.spec.XPathFilter2ParameterSpec
 *      (the hereby targeted class-under-test class)
 * @see XPathFilter2ParameterSpecTests XPathFilter2ParameterSpecTests (The complementary j8unit test interface
...
public abstract interface XPathFilter2ParameterSpecClassTests<SUT extends javax.xml.crypto.dsig.spec.XPathFilter2ParameterSpec>
extends TransformParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.XPathFilter2ParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.XPathFilter2ParameterSpec.class.isAssignableFrom(sut));
    }

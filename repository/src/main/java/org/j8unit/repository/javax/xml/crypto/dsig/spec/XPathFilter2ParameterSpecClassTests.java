 ...
 * {@link XPathFilter2ParameterSpec public final class javax.xml.crypto.dsig.spec.XPathFilter2ParameterSpec}.
 *
...
public abstract interface XPathFilter2ParameterSpecClassTests<SUT extends XPathFilter2ParameterSpec>
extends TransformParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathFilter2ParameterSpec.class!",
                   XPathFilter2ParameterSpec.class.isAssignableFrom(sut));
    }

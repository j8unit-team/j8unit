 ...
 * javax.management.ReflectionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReflectionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReflectionExceptionTests}.
 * </p>
 *
 * @see javax.management.ReflectionException class javax.management.ReflectionException (the hereby targeted
 *      class-under-test class)
 * @see ReflectionExceptionTests ReflectionExceptionTests (The complementary j8unit test interface containing the
...
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.ReflectionException.class!",
                   javax.management.ReflectionException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReflectionException
 * public class javax.management.ReflectionException}.
 *
...
public abstract interface ReflectionExceptionClassTests<SUT extends ReflectionException>
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReflectionException.class!",
                   ReflectionException.class.isAssignableFrom(sut));
    }

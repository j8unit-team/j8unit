 ...
 * {@link DigestMethodParameterSpec public abstract interface javax.xml.crypto.dsig.spec.DigestMethodParameterSpec}.
 *
...
public abstract interface DigestMethodParameterSpecClassTests<SUT extends DigestMethodParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.crypto.dsig.spec.DigestMethodParameterSpec]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DigestMethodParameterSpec.class!",
                   DigestMethodParameterSpec.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.crypto.dsig.spec.DigestMethodParameterSpec]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.xml.crypto.dsig.spec.DigestMethodParameterSpec]

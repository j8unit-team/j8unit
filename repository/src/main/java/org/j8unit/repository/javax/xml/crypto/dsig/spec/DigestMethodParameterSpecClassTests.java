...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.spec.DigestMethodParameterSpec interface
 * javax.xml.crypto.dsig.spec.DigestMethodParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link DigestMethodParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 * @see DigestMethodParameterSpecTests DigestMethodParameterSpecTests (The complementary j8unit test interface
...
public abstract interface DigestMethodParameterSpecClassTests<SUT extends javax.xml.crypto.dsig.spec.DigestMethodParameterSpec>
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.DigestMethodParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.DigestMethodParameterSpec.class.isAssignableFrom(sut));
    }

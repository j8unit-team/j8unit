 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiFileWriter
...
public abstract interface MidiFileWriterClassTests<SUT extends MidiFileWriter>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiFileWriter.class!",
                   MidiFileWriter.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JToolBar class javax.swing.JToolBar}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JToolBarTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.JToolBar class javax.swing.JToolBar (the hereby targeted class-under-test class)
 * @see JToolBarTests JToolBarTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SwingConstantsClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JToolBar.class!",
                   javax.swing.JToolBar.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JToolBar.Separator class
     * javax.swing.JToolBar$Separator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link JToolBarTests.SeparatorTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.JToolBar.Separator class javax.swing.JToolBar$Separator (the hereby targeted class-under-test
     *      class)
     * @see JToolBarTests.SeparatorTests JToolBarTests.SeparatorTests (The complementary j8unit test interface
    ...
    extends JSeparatorClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JToolBar.Separator.class!",
                       javax.swing.JToolBar.Separator.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JToolBar public
...
org.j8unit.repository.javax.swing.JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JToolBar.class!",
                   JToolBar.class.isAssignableFrom(sut));
    }
     ...
     * {@link Separator public static class javax.swing.JToolBar$Separator}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

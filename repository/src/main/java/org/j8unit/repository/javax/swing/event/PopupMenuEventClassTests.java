 ...
 * javax.swing.event.PopupMenuEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PopupMenuEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PopupMenuEventTests}.
 * </p>
 *
 * @see javax.swing.event.PopupMenuEvent class javax.swing.event.PopupMenuEvent (the hereby targeted class-under-test
 *      class)
 * @see PopupMenuEventTests PopupMenuEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.PopupMenuEvent.class!",
                   javax.swing.event.PopupMenuEvent.class.isAssignableFrom(sut));
    }

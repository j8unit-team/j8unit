 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PopupMenuEvent
...
public abstract interface PopupMenuEventClassTests<SUT extends PopupMenuEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PopupMenuEvent.class!",
                   PopupMenuEvent.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.transform.sax.TransformerHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransformerHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransformerHandlerTests}.
 * </p>
 *
 * @see javax.xml.transform.sax.TransformerHandler interface javax.xml.transform.sax.TransformerHandler (the hereby
 *      targeted class-under-test class)
 * @see TransformerHandlerTests TransformerHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface TransformerHandlerClassTests<SUT extends javax.xml.transform.sax.TransformerHandler>
extends org.j8unit.repository.org.xml.sax.ContentHandlerClassTests<SUT>, org.j8unit.repository.org.xml.sax.ext.LexicalHandlerClassTests<SUT>,
org.j8unit.repository.org.xml.sax.DTDHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.sax.TransformerHandler.class!",
                   javax.xml.transform.sax.TransformerHandler.class.isAssignableFrom(sut));
    }

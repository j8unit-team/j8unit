...
extends org.j8unit.repository.javax.lang.model.util.AbstractTypeVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractTypeVisitor7.class!",
                   AbstractTypeVisitor7.class.isAssignableFrom(sut));
    }

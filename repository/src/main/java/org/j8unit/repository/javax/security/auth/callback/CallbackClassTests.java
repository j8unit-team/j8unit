 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Callback public
...
public abstract interface CallbackClassTests<SUT extends Callback>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Callback.class!",
                   Callback.class.isAssignableFrom(sut));
    }

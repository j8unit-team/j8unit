 ...
 * javax.security.auth.callback.Callback}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CallbackTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CallbackTests}.
 * </p>
 *
 * @see javax.security.auth.callback.Callback interface javax.security.auth.callback.Callback (the hereby targeted
 *      class-under-test class)
 * @see CallbackTests CallbackTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CallbackClassTests<SUT extends javax.security.auth.callback.Callback>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.callback.Callback.class!",
                   javax.security.auth.callback.Callback.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LogicalMessage
 * public abstract interface javax.xml.ws.LogicalMessage}.
 *
...
public abstract interface LogicalMessageClassTests<SUT extends LogicalMessage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LogicalMessage.class!",
                   LogicalMessage.class.isAssignableFrom(sut));
    }

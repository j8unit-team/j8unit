...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.LogicalMessage interface javax.xml.ws.LogicalMessage},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LogicalMessageTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LogicalMessageTests}.
 * </p>
 *
 * @see javax.xml.ws.LogicalMessage interface javax.xml.ws.LogicalMessage (the hereby targeted class-under-test class)
 * @see LogicalMessageTests LogicalMessageTests (The complementary j8unit test interface containing the instance
...
public abstract interface LogicalMessageClassTests<SUT extends javax.xml.ws.LogicalMessage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.LogicalMessage.class!",
                   javax.xml.ws.LogicalMessage.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.soap.SOAPElementFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPElementFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPElementFactoryTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPElementFactory class javax.xml.soap.SOAPElementFactory (the hereby targeted class-under-test
 *      class)
 * @see SOAPElementFactoryTests SOAPElementFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPElementFactoryClassTests<SUT extends javax.xml.soap.SOAPElementFactory>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPElementFactory.class!",
                   javax.xml.soap.SOAPElementFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPElementFactory
...
public abstract interface SOAPElementFactoryClassTests<SUT extends SOAPElementFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPElementFactory.class!",
                   SOAPElementFactory.class.isAssignableFrom(sut));
    }

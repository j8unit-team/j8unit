 ...
 * </p>
 *
 * @see javax.management.AttributeList class javax.management.AttributeList (the hereby targeted class-under-test class)
...
public abstract interface AttributeListClassTests<SUT extends javax.management.AttributeList>
extends org.j8unit.repository.java.util.ArrayListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.AttributeList.class!",
                   javax.management.AttributeList.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeySelectorResult
 * public abstract interface javax.xml.crypto.KeySelectorResult}.
 *
...
public abstract interface KeySelectorResultClassTests<SUT extends KeySelectorResult>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeySelectorResult.class!",
                   KeySelectorResult.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.KeySelectorResult interface
 * javax.xml.crypto.KeySelectorResult}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeySelectorResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeySelectorResultTests}.
 * </p>
 *
 * @see javax.xml.crypto.KeySelectorResult interface javax.xml.crypto.KeySelectorResult (the hereby targeted
 *      class-under-test class)
 * @see KeySelectorResultTests KeySelectorResultTests (The complementary j8unit test interface containing the instance
...
public abstract interface KeySelectorResultClassTests<SUT extends javax.xml.crypto.KeySelectorResult>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.KeySelectorResult.class!",
                   javax.xml.crypto.KeySelectorResult.class.isAssignableFrom(sut));
    }

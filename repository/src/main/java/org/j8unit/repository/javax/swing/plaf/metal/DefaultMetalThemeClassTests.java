 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultMetalTheme
 * public class javax.swing.plaf.metal.DefaultMetalTheme}.
 *
...
public abstract interface DefaultMetalThemeClassTests<SUT extends DefaultMetalTheme>
extends MetalThemeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultMetalTheme.class!",
                   DefaultMetalTheme.class.isAssignableFrom(sut));
    }

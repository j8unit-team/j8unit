 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileChooserUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileChooserUITests}.
 * </p>
 *
 * @see javax.swing.plaf.FileChooserUI class javax.swing.plaf.FileChooserUI (the hereby targeted class-under-test class)
 * @see FileChooserUITests FileChooserUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface FileChooserUIClassTests<SUT extends javax.swing.plaf.FileChooserUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.FileChooserUI.class!",
                   javax.swing.plaf.FileChooserUI.class.isAssignableFrom(sut));
    }

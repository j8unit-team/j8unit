 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileChooserUI
...
public abstract interface FileChooserUIClassTests<SUT extends FileChooserUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.FileChooserUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileChooserUI.class!",
                   FileChooserUI.class.isAssignableFrom(sut));
    }

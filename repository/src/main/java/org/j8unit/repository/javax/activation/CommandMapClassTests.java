 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CommandMap public
 * abstract class javax.activation.CommandMap}.
 *
...
public abstract interface CommandMapClassTests<SUT extends CommandMap>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CommandMap.class!",
                   CommandMap.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.stream.events.NotationDeclaration}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotationDeclarationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotationDeclarationTests}.
 * </p>
 *
 * @see javax.xml.stream.events.NotationDeclaration interface javax.xml.stream.events.NotationDeclaration (the hereby
 *      targeted class-under-test class)
 * @see NotationDeclarationTests NotationDeclarationTests (The complementary j8unit test interface containing the
...
public abstract interface NotationDeclarationClassTests<SUT extends javax.xml.stream.events.NotationDeclaration>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.NotationDeclaration.class!",
                   javax.xml.stream.events.NotationDeclaration.class.isAssignableFrom(sut));
    }

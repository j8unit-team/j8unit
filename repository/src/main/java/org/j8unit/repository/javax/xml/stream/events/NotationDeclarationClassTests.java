 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotationDeclaration
 * public abstract interface javax.xml.stream.events.NotationDeclaration}.
 *
...
public abstract interface NotationDeclarationClassTests<SUT extends NotationDeclaration>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotationDeclaration.class!",
                   NotationDeclaration.class.isAssignableFrom(sut));
    }

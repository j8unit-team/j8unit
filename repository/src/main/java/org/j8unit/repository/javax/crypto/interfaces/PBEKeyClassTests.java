 ...
 * javax.crypto.interfaces.PBEKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PBEKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PBEKeyTests}.
 * </p>
 *
 * @see javax.crypto.interfaces.PBEKey interface javax.crypto.interfaces.PBEKey (the hereby targeted class-under-test
 *      class)
 * @see PBEKeyTests PBEKeyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface PBEKeyClassTests<SUT extends javax.crypto.interfaces.PBEKey>
extends org.j8unit.repository.javax.crypto.SecretKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.interfaces.PBEKey.class!",
                   javax.crypto.interfaces.PBEKey.class.isAssignableFrom(sut));
    }

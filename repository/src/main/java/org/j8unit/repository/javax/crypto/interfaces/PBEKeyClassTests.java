 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PBEKey public
 * abstract interface javax.crypto.interfaces.PBEKey}.
 *
...
public abstract interface PBEKeyClassTests<SUT extends PBEKey>
extends SecretKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PBEKey.class!",
                   PBEKey.class.isAssignableFrom(sut));
    }

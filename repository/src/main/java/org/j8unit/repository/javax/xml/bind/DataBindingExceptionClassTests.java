 ...
 * javax.xml.bind.DataBindingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBindingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataBindingExceptionTests}
 * .
 * </p>
 *
 * @see javax.xml.bind.DataBindingException class javax.xml.bind.DataBindingException (the hereby targeted
 *      class-under-test class)
 * @see DataBindingExceptionTests DataBindingExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.DataBindingException.class!",
                   javax.xml.bind.DataBindingException.class.isAssignableFrom(sut));
    }

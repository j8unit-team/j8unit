 ...
 * {@link DataBindingException public class javax.xml.bind.DataBindingException}.
 *
 ...
 * {@link DataBindingExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface DataBindingExceptionClassTests<SUT extends DataBindingException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBindingException.class!",
                   DataBindingException.class.isAssignableFrom(sut));
    }

 ...
 * javax.tools.ForwardingJavaFileManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link ForwardingJavaFileManagerTests}).
 * </p>
 *
 * <p>
 ...
 * @see ForwardingJavaFileManagerTests ForwardingJavaFileManagerTests (The complementary j8unit test interface
...
public abstract interface ForwardingJavaFileManagerClassTests<SUT extends javax.tools.ForwardingJavaFileManager>
extends JavaFileManagerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.ForwardingJavaFileManager.class!",
                   javax.tools.ForwardingJavaFileManager.class.isAssignableFrom(sut));
    }

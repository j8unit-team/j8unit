...
public abstract interface ForwardingJavaFileManagerClassTests<SUT extends ForwardingJavaFileManager>
extends JavaFileManagerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ForwardingJavaFileManager.class!",
                   ForwardingJavaFileManager.class.isAssignableFrom(sut));
    }

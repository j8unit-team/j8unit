 ...
 * {@link CardNotPresentException public class javax.smartcardio.CardNotPresentException}.
 *
...
public abstract interface CardNotPresentExceptionClassTests<SUT extends CardNotPresentException>
extends CardExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CardNotPresentException.class!",

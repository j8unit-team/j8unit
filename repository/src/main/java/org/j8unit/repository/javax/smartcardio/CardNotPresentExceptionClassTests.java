 ...
 * javax.smartcardio.CardNotPresentException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CardNotPresentExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link CardNotPresentExceptionTests}.
 * </p>
 *
 * @see javax.smartcardio.CardNotPresentException class javax.smartcardio.CardNotPresentException (the hereby targeted
 *      class-under-test class)
 * @see CardNotPresentExceptionTests CardNotPresentExceptionTests (The complementary j8unit test interface containing
...
public abstract interface CardNotPresentExceptionClassTests<SUT extends javax.smartcardio.CardNotPresentException>
extends CardExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.smartcardio.CardNotPresentException.class!",
                   javax.smartcardio.CardNotPresentException.class.isAssignableFrom(sut));
    }

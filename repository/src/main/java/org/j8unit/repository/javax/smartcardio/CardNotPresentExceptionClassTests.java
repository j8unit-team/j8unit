...
extends org.j8unit.repository.javax.smartcardio.CardExceptionClassTests<SUT> {
    ...
    public default void create_CardNotPresentException_String()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public default void create_CardNotPresentException_String_Throwable()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.smartcardio.CardNotPresentException sut = null; // = new
    ...
    throws Exception {
        // create new instance
        final Class<? extends javax.smartcardio.CardNotPresentException> sut = createNewSUT();

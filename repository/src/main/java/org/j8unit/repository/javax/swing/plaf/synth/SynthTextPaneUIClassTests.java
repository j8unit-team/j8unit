 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthTextPaneUI
 * public class javax.swing.plaf.synth.SynthTextPaneUI}.
 *
...
public abstract interface SynthTextPaneUIClassTests<SUT extends SynthTextPaneUI>
extends org.j8unit.repository.javax.swing.plaf.synth.SynthEditorPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthTextPaneUI.class!",
                   SynthTextPaneUI.class.isAssignableFrom(sut));
    }

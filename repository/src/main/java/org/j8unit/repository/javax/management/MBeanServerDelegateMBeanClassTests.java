 ...
 * {@link MBeanServerDelegateMBean public abstract interface javax.management.MBeanServerDelegateMBean}.
 *
...
public abstract interface MBeanServerDelegateMBeanClassTests<SUT extends MBeanServerDelegateMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerDelegateMBean.class!",
                   MBeanServerDelegateMBean.class.isAssignableFrom(sut));
    }

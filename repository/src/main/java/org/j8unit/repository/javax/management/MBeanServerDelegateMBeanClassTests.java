 ...
 * javax.management.MBeanServerDelegateMBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanServerDelegateMBeanTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link MBeanServerDelegateMBeanTests}.
 * </p>
 *
 * @see javax.management.MBeanServerDelegateMBean interface javax.management.MBeanServerDelegateMBean (the hereby
 *      targeted class-under-test class)
 * @see MBeanServerDelegateMBeanTests MBeanServerDelegateMBeanTests (The complementary j8unit test interface containing
...
public abstract interface MBeanServerDelegateMBeanClassTests<SUT extends javax.management.MBeanServerDelegateMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanServerDelegateMBean.class!",
                   javax.management.MBeanServerDelegateMBean.class.isAssignableFrom(sut));
    }

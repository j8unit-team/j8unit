 ...
 * javax.annotation.processing.FilerException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilerExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilerExceptionTests}.
 * </p>
 *
 * @see javax.annotation.processing.FilerException class javax.annotation.processing.FilerException (the hereby targeted
 *      class-under-test class)
 * @see FilerExceptionTests FilerExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.FilerException.class!",
                   javax.annotation.processing.FilerException.class.isAssignableFrom(sut));
    }

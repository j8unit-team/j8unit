 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilerException
...
public abstract interface FilerExceptionClassTests<SUT extends FilerException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilerException.class!",
                   FilerException.class.isAssignableFrom(sut));
    }

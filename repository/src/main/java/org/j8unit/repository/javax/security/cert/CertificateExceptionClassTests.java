 ...
 * javax.security.cert.CertificateException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertificateExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertificateExceptionTests}
 * .
 * </p>
 *
 * @see javax.security.cert.CertificateException class javax.security.cert.CertificateException (the hereby targeted
 *      class-under-test class)
 * @see CertificateExceptionTests CertificateExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.cert.CertificateException.class!",
                   javax.security.cert.CertificateException.class.isAssignableFrom(sut));
    }

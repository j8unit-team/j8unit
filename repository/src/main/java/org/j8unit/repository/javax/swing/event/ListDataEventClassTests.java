 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListDataEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListDataEventTests}.
 * </p>
 *
 * @see javax.swing.event.ListDataEvent class javax.swing.event.ListDataEvent (the hereby targeted class-under-test
 *      class)
 * @see ListDataEventTests ListDataEventTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.ListDataEvent.class!",
                   javax.swing.event.ListDataEvent.class.isAssignableFrom(sut));
    }

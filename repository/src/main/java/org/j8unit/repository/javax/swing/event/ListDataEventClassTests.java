 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListDataEvent
 * public class javax.swing.event.ListDataEvent}.
 *
...
public abstract interface ListDataEventClassTests<SUT extends ListDataEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListDataEvent.class!",
                   ListDataEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HashDocAttributeSet
 * public class javax.print.attribute.HashDocAttributeSet}.
 *
...
public abstract interface HashDocAttributeSetClassTests<SUT extends HashDocAttributeSet>
...
org.j8unit.repository.javax.print.attribute.HashAttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HashDocAttributeSet.class!",

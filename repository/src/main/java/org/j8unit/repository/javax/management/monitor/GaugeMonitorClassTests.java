 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GaugeMonitor public
...
public abstract interface GaugeMonitorClassTests<SUT extends GaugeMonitor>
extends GaugeMonitorMBeanClassTests<SUT>, MonitorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GaugeMonitor.class!",
                   GaugeMonitor.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.monitor.GaugeMonitor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GaugeMonitorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GaugeMonitorTests}.
 * </p>
 *
 * @see javax.management.monitor.GaugeMonitor class javax.management.monitor.GaugeMonitor (the hereby targeted
 *      class-under-test class)
 * @see GaugeMonitorTests GaugeMonitorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface GaugeMonitorClassTests<SUT extends javax.management.monitor.GaugeMonitor>
extends GaugeMonitorMBeanClassTests<SUT>, MonitorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.GaugeMonitor.class!",
                   javax.management.monitor.GaugeMonitor.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DirObjectFactory
 * public abstract interface javax.naming.spi.DirObjectFactory}.
 *
...
public abstract interface DirObjectFactoryClassTests<SUT extends DirObjectFactory>
extends ObjectFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirObjectFactory.class!",
                   DirObjectFactory.class.isAssignableFrom(sut));
    }

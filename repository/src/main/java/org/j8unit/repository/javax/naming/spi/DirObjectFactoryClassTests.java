 ...
 * javax.naming.spi.DirObjectFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DirObjectFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DirObjectFactoryTests}.
 * </p>
 *
 * @see javax.naming.spi.DirObjectFactory interface javax.naming.spi.DirObjectFactory (the hereby targeted
 *      class-under-test class)
 * @see DirObjectFactoryTests DirObjectFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface DirObjectFactoryClassTests<SUT extends javax.naming.spi.DirObjectFactory>
extends ObjectFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.DirObjectFactory.class!",
                   javax.naming.spi.DirObjectFactory.class.isAssignableFrom(sut));
    }

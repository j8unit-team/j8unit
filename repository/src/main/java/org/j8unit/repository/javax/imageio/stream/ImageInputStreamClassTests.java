 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageInputStream
 * public abstract interface javax.imageio.stream.ImageInputStream}.
 *
...
public abstract interface ImageInputStreamClassTests<SUT extends ImageInputStream>
extends org.j8unit.repository.java.io.DataInputClassTests<SUT>, org.j8unit.repository.java.io.CloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageInputStream.class!",
                   ImageInputStream.class.isAssignableFrom(sut));
    }

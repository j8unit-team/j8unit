...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.Referenceable interface javax.naming.Referenceable},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReferenceableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReferenceableTests}.
 * </p>
 *
 * @see javax.naming.Referenceable interface javax.naming.Referenceable (the hereby targeted class-under-test class)
 * @see ReferenceableTests ReferenceableTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ReferenceableClassTests<SUT extends javax.naming.Referenceable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.Referenceable.class!",
                   javax.naming.Referenceable.class.isAssignableFrom(sut));
    }

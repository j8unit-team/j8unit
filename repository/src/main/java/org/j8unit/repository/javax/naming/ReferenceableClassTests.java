 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Referenceable
...
public abstract interface ReferenceableClassTests<SUT extends Referenceable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Referenceable.class!",
                   Referenceable.class.isAssignableFrom(sut));
    }

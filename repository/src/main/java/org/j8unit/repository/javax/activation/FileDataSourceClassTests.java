 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileDataSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileDataSourceTests}.
 * </p>
 *
 * @see javax.activation.FileDataSource class javax.activation.FileDataSource (the hereby targeted class-under-test
 *      class)
 * @see FileDataSourceTests FileDataSourceTests (The complementary j8unit test interface containing the instance
...
extends DataSourceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.FileDataSource.class!",
                   javax.activation.FileDataSource.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ViewportUI public
 * abstract class javax.swing.plaf.ViewportUI}.
 *
...
public abstract interface ViewportUIClassTests<SUT extends ViewportUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ViewportUI.class!",
                   ViewportUI.class.isAssignableFrom(sut));
    }

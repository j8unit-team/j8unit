...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.accessibility.AccessibleKeyBinding interface
 * javax.accessibility.AccessibleKeyBinding}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleKeyBindingTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleKeyBindingTests}
 * .
 * </p>
 *
 * @see javax.accessibility.AccessibleKeyBinding interface javax.accessibility.AccessibleKeyBinding (the hereby targeted
 *      class-under-test class)
 * @see AccessibleKeyBindingTests AccessibleKeyBindingTests (The complementary j8unit test interface containing the
...
public abstract interface AccessibleKeyBindingClassTests<SUT extends javax.accessibility.AccessibleKeyBinding>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleKeyBinding.class!",
                   javax.accessibility.AccessibleKeyBinding.class.isAssignableFrom(sut));
    }

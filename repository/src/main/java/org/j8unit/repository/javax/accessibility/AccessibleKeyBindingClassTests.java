 ...
 * {@link AccessibleKeyBinding public abstract interface javax.accessibility.AccessibleKeyBinding}.
 *
...
public abstract interface AccessibleKeyBindingClassTests<SUT extends AccessibleKeyBinding>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleKeyBinding.class!",
                   AccessibleKeyBinding.class.isAssignableFrom(sut));
    }

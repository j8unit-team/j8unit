 ...
 * javax.naming.NameAlreadyBoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link NameAlreadyBoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see NameAlreadyBoundExceptionTests NameAlreadyBoundExceptionTests (The complementary j8unit test interface
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NameAlreadyBoundException.class!",
                   javax.naming.NameAlreadyBoundException.class.isAssignableFrom(sut));
    }

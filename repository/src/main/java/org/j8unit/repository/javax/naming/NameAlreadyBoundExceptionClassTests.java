 ...
 * {@link NameAlreadyBoundException public class javax.naming.NameAlreadyBoundException}.
 *
...
public abstract interface NameAlreadyBoundExceptionClassTests<SUT extends NameAlreadyBoundException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameAlreadyBoundException.class!",
                   NameAlreadyBoundException.class.isAssignableFrom(sut));
    }

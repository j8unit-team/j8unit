 ...
 * {@link SSLProtocolException public class javax.net.ssl.SSLProtocolException}.
 *
 ...
 * {@link SSLProtocolExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface SSLProtocolExceptionClassTests<SUT extends SSLProtocolException>
extends SSLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLProtocolException.class!",
                   SSLProtocolException.class.isAssignableFrom(sut));
    }

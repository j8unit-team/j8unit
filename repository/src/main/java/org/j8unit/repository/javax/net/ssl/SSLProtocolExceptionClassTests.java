 ...
 * javax.net.ssl.SSLProtocolException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLProtocolExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLProtocolExceptionTests}
 * .
 * </p>
 *
 * @see javax.net.ssl.SSLProtocolException class javax.net.ssl.SSLProtocolException (the hereby targeted
 *      class-under-test class)
 * @see SSLProtocolExceptionTests SSLProtocolExceptionTests (The complementary j8unit test interface containing the
...
extends SSLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLProtocolException.class!",
                   javax.net.ssl.SSLProtocolException.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.ServiceNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceNotFoundExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ServiceNotFoundExceptionTests}.
 * </p>
 *
 * @see javax.management.ServiceNotFoundException class javax.management.ServiceNotFoundException (the hereby targeted
 *      class-under-test class)
 * @see ServiceNotFoundExceptionTests ServiceNotFoundExceptionTests (The complementary j8unit test interface containing
...
public abstract interface ServiceNotFoundExceptionClassTests<SUT extends javax.management.ServiceNotFoundException>
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.ServiceNotFoundException.class!",
                   javax.management.ServiceNotFoundException.class.isAssignableFrom(sut));
    }

...
public abstract interface ServiceNotFoundExceptionClassTests<SUT extends ServiceNotFoundException>
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceNotFoundException.class!",
                   ServiceNotFoundException.class.isAssignableFrom(sut));
    }

 ...
 * {@link ObjectChangeListenerTests}.
 * </p>
 *
 * <p>
...
public abstract interface ObjectChangeListenerClassTests<SUT extends ObjectChangeListener>
extends NamingListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectChangeListener.class!",
                   ObjectChangeListener.class.isAssignableFrom(sut));
    }

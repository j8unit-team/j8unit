 ...
 * javax.naming.event.ObjectChangeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectChangeListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectChangeListenerTests}
 * .
 * </p>
 *
 * @see javax.naming.event.ObjectChangeListener interface javax.naming.event.ObjectChangeListener (the hereby targeted
 *      class-under-test class)
 * @see ObjectChangeListenerTests ObjectChangeListenerTests (The complementary j8unit test interface containing the
...
extends NamingListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.event.ObjectChangeListener.class!",
                   javax.naming.event.ObjectChangeListener.class.isAssignableFrom(sut));
    }

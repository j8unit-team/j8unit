 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageOutputStream
 * public abstract interface javax.imageio.stream.ImageOutputStream}.
 *
...
extends ImageInputStreamClassTests<SUT>, DataOutputClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageOutputStream.class!",
                   ImageOutputStream.class.isAssignableFrom(sut));
    }

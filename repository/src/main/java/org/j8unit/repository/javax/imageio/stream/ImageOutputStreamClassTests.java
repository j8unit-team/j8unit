...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.imageio.stream.ImageOutputStream interface
 * javax.imageio.stream.ImageOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see ImageOutputStreamTests ImageOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface ImageOutputStreamClassTests<SUT extends javax.imageio.stream.ImageOutputStream>
extends ImageInputStreamClassTests<SUT>, org.j8unit.repository.java.io.DataOutputClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.ImageOutputStream.class!",
                   javax.imageio.stream.ImageOutputStream.class.isAssignableFrom(sut));
    }

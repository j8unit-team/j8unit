 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultHighlighter
 * public class javax.swing.text.DefaultHighlighter}.
 *
...
public abstract interface DefaultHighlighterClassTests<SUT extends DefaultHighlighter>
extends LayeredHighlighterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultHighlighter.class!",
                   DefaultHighlighter.class.isAssignableFrom(sut));
    }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface DefaultHighlightPainterClassTests<SUT extends DefaultHighlightPainter>
    extends LayerPainterClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultHighlightPainter.class!",
                              DefaultHighlightPainter.class.isAssignableFrom(sut));
        }

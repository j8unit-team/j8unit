 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResolutionSyntax
 * public abstract class javax.print.attribute.ResolutionSyntax}.
 *
...
public abstract interface ResolutionSyntaxClassTests<SUT extends ResolutionSyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResolutionSyntax.class!",
                   ResolutionSyntax.class.isAssignableFrom(sut));
    }

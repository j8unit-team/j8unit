 ...
 * methods is {@link org.j8unit.repository.javax.print.attribute.ResolutionSyntaxTests}.
 * </p>
 *
 * <p>
        ...
        org.j8unit.repository.java.lang.ObjectClassTests<SUT>
{
    ...
    /**
     * Test method for {@link javax.print.attribute.ResolutionSyntax#ResolutionSyntax(int,int,int) public javax.print.attribute.ResolutionSyntax(int,int,int)}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ResolutionSyntax_int_int_int() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        javax.print.attribute.ResolutionSyntax sut = null; // = new ResolutionSyntax(int,int,int);
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends javax.print.attribute.ResolutionSyntax> sut = createNewSUT();

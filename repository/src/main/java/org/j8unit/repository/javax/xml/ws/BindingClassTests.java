...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.Binding interface javax.xml.ws.Binding}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BindingTests}.
 * </p>
 *
 * @see javax.xml.ws.Binding interface javax.xml.ws.Binding (the hereby targeted class-under-test class)
 * @see BindingTests BindingTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BindingClassTests<SUT extends javax.xml.ws.Binding>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.Binding.class!",
                   javax.xml.ws.Binding.class.isAssignableFrom(sut));
    }

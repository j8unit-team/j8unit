 ...
 * javax.xml.crypto.dsig.keyinfo.X509IssuerSerial}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509IssuerSerialTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509IssuerSerialTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.X509IssuerSerial interface javax.xml.crypto.dsig.keyinfo.X509IssuerSerial (the
 *      hereby targeted class-under-test class)
 * @see X509IssuerSerialTests X509IssuerSerialTests (The complementary j8unit test interface containing the instance
...
public abstract interface X509IssuerSerialClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.X509IssuerSerial>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.X509IssuerSerial.class!",
                   javax.xml.crypto.dsig.keyinfo.X509IssuerSerial.class.isAssignableFrom(sut));
    }

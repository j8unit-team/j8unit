 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509IssuerSerial
 * public abstract interface javax.xml.crypto.dsig.keyinfo.X509IssuerSerial}.
 *
...
public abstract interface X509IssuerSerialClassTests<SUT extends X509IssuerSerial>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509IssuerSerial.class!",
                   X509IssuerSerial.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.sql.RefClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerialRef public
...
public abstract interface SerialRefClassTests<SUT extends SerialRef>
extends RefClassTests<SUT>, SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.sql.rowset.serial.SerialRef]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerialRef.class!",

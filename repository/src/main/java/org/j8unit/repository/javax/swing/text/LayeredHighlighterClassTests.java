 ...
 * javax.swing.text.LayeredHighlighter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LayeredHighlighterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LayeredHighlighterTests}.
 * </p>
 *
 * @see javax.swing.text.LayeredHighlighter class javax.swing.text.LayeredHighlighter (the hereby targeted
 *      class-under-test class)
 * @see LayeredHighlighterTests LayeredHighlighterTests (The complementary j8unit test interface containing the instance
...
extends HighlighterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.LayeredHighlighter.class!",
                   javax.swing.text.LayeredHighlighter.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.LayeredHighlighter.LayerPainter class
     * javax.swing.text.LayeredHighlighter$LayerPainter}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link LayeredHighlighterTests.LayerPainterTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see LayeredHighlighterTests.LayerPainterTests LayeredHighlighterTests.LayerPainterTests (The complementary
    ...
    extends HighlighterClassTests.HighlightPainterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.LayeredHighlighter.LayerPainter.class!",
                       javax.swing.text.LayeredHighlighter.LayerPainter.class.isAssignableFrom(sut));
        }

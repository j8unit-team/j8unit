 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicTextFieldUI
 * public class javax.swing.plaf.basic.BasicTextFieldUI}.
 *
...
public abstract interface BasicTextFieldUIClassTests<SUT extends BasicTextFieldUI>
extends BasicTextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicTextFieldUI.class!",
                   BasicTextFieldUI.class.isAssignableFrom(sut));
    }

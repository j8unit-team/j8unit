 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MBeanException
...
public abstract interface MBeanExceptionClassTests<SUT extends MBeanException>
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanException.class!",
                   MBeanException.class.isAssignableFrom(sut));
    }

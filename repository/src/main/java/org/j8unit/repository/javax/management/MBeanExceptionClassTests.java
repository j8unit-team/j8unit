 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanExceptionTests}.
 * </p>
 *
 * @see javax.management.MBeanException class javax.management.MBeanException (the hereby targeted class-under-test
 *      class)
 * @see MBeanExceptionTests MBeanExceptionTests (The complementary j8unit test interface containing the instance
...
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanException.class!",
                   javax.management.MBeanException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentParser
...
public abstract interface DocumentParserClassTests<SUT extends DocumentParser>
extends org.j8unit.repository.javax.swing.text.html.parser.ParserClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentParser.class!",
                   DocumentParser.class.isAssignableFrom(sut));
    }

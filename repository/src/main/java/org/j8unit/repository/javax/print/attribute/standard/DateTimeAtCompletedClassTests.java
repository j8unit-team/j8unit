...
import org.j8unit.repository.javax.print.attribute.DateTimeSyntaxClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateTimeAtCompleted
 * public final class javax.print.attribute.standard.DateTimeAtCompleted}.
 *
...
public abstract interface DateTimeAtCompletedClassTests<SUT extends DateTimeAtCompleted>
extends PrintJobAttributeClassTests<SUT>, DateTimeSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateTimeAtCompleted.class!",
                   DateTimeAtCompleted.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.DateTimeAtCompleted class
 * javax.print.attribute.standard.DateTimeAtCompleted}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTimeAtCompletedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateTimeAtCompletedTests}.
 * </p>
 *
 ...
 * @see DateTimeAtCompletedTests DateTimeAtCompletedTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.javax.print.attribute.DateTimeSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.DateTimeAtCompleted.class!",
                   javax.print.attribute.standard.DateTimeAtCompleted.class.isAssignableFrom(sut));
    }

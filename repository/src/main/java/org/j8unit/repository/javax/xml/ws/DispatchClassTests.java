 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DispatchTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DispatchTests}.
 * </p>
 *
 * @see javax.xml.ws.Dispatch interface javax.xml.ws.Dispatch (the hereby targeted class-under-test class)
 * @see DispatchTests DispatchTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DispatchClassTests<SUT extends javax.xml.ws.Dispatch>
extends BindingProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.Dispatch.class!",
                   javax.xml.ws.Dispatch.class.isAssignableFrom(sut));
    }

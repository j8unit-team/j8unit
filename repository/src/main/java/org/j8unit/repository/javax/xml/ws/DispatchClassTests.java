 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Dispatch public
 * abstract interface javax.xml.ws.Dispatch<T>}.
 *
...
public abstract interface DispatchClassTests<SUT extends Dispatch>
extends org.j8unit.repository.javax.xml.ws.BindingProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Dispatch.class!",
                   Dispatch.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.spec.PBEKeySpec class javax.crypto.spec.PBEKeySpec},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PBEKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PBEKeySpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.PBEKeySpec class javax.crypto.spec.PBEKeySpec (the hereby targeted class-under-test class)
 * @see PBEKeySpecTests PBEKeySpecTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.security.spec.KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.PBEKeySpec.class!",
                   javax.crypto.spec.PBEKeySpec.class.isAssignableFrom(sut));
    }

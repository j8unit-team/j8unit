 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PBEKeySpec public
...
public abstract interface PBEKeySpecClassTests<SUT extends PBEKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PBEKeySpec.class!",
                   PBEKeySpec.class.isAssignableFrom(sut));
    }

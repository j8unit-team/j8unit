 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Border public
 * abstract interface javax.swing.border.Border}.
 *
...
public abstract interface BorderClassTests<SUT extends Border>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Border.class!",
                   Border.class.isAssignableFrom(sut));
    }

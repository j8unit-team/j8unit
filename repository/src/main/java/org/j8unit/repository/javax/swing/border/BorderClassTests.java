 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BorderTests}.
 * </p>
 *
 * @see javax.swing.border.Border interface javax.swing.border.Border (the hereby targeted class-under-test class)
 * @see BorderTests BorderTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface BorderClassTests<SUT extends javax.swing.border.Border>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.Border.class!",
                   javax.swing.border.Border.class.isAssignableFrom(sut));
    }

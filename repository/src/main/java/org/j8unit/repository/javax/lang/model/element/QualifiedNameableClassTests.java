 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link QualifiedNameable
 * public abstract interface javax.lang.model.element.QualifiedNameable}.
 *
...
public abstract interface QualifiedNameableClassTests<SUT extends QualifiedNameable>
extends ElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to QualifiedNameable.class!",
                   QualifiedNameable.class.isAssignableFrom(sut));
    }

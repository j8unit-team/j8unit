 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyManagerTests}.
 * </p>
 *
 * @see javax.net.ssl.KeyManager interface javax.net.ssl.KeyManager (the hereby targeted class-under-test class)
 * @see KeyManagerTests KeyManagerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeyManagerClassTests<SUT extends javax.net.ssl.KeyManager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.KeyManager.class!",
                   javax.net.ssl.KeyManager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyManager public
 * abstract interface javax.net.ssl.KeyManager}.
 *
...
public abstract interface KeyManagerClassTests<SUT extends KeyManager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyManager.class!",
                   KeyManager.class.isAssignableFrom(sut));
    }

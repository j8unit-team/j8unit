 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLEventConsumer
 * public abstract interface javax.xml.stream.util.XMLEventConsumer}.
 *
...
public abstract interface XMLEventConsumerClassTests<SUT extends XMLEventConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLEventConsumer.class!",
                   XMLEventConsumer.class.isAssignableFrom(sut));
    }

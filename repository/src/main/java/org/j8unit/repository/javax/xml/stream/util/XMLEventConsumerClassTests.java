...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.util.XMLEventConsumer interface
 * javax.xml.stream.util.XMLEventConsumer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLEventConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLEventConsumerTests}.
 * </p>
 *
 * @see javax.xml.stream.util.XMLEventConsumer interface javax.xml.stream.util.XMLEventConsumer (the hereby targeted
 *      class-under-test class)
 * @see XMLEventConsumerTests XMLEventConsumerTests (The complementary j8unit test interface containing the instance
...
public abstract interface XMLEventConsumerClassTests<SUT extends javax.xml.stream.util.XMLEventConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.util.XMLEventConsumer.class!",
                   javax.xml.stream.util.XMLEventConsumer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.events.EndDocument interface
 * javax.xml.stream.events.EndDocument}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EndDocumentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EndDocumentTests}.
 * </p>
 *
 * @see javax.xml.stream.events.EndDocument interface javax.xml.stream.events.EndDocument (the hereby targeted
 *      class-under-test class)
 * @see EndDocumentTests EndDocumentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface EndDocumentClassTests<SUT extends javax.xml.stream.events.EndDocument>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.EndDocument.class!",
                   javax.xml.stream.events.EndDocument.class.isAssignableFrom(sut));
    }

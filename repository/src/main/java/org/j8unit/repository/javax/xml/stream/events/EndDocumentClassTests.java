 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EndDocument public
 * abstract interface javax.xml.stream.events.EndDocument}.
 *
...
public abstract interface EndDocumentClassTests<SUT extends EndDocument>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EndDocument.class!",

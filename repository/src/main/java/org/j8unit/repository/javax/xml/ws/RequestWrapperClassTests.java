...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.RequestWrapper interface javax.xml.ws.RequestWrapper},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RequestWrapperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RequestWrapperTests}.
 * </p>
 *
 * @see javax.xml.ws.RequestWrapper interface javax.xml.ws.RequestWrapper (the hereby targeted class-under-test class)
 * @see RequestWrapperTests RequestWrapperTests (The complementary j8unit test interface containing the instance
...
public abstract interface RequestWrapperClassTests<SUT extends javax.xml.ws.RequestWrapper>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.RequestWrapper.class!",
                   javax.xml.ws.RequestWrapper.class.isAssignableFrom(sut));
    }

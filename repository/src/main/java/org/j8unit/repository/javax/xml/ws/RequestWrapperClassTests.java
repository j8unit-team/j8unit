 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RequestWrapper
...
public abstract interface RequestWrapperClassTests<SUT extends RequestWrapper>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RequestWrapper.class!",
                   RequestWrapper.class.isAssignableFrom(sut));
    }

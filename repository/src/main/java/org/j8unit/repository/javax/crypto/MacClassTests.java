...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.Mac class javax.crypto.Mac}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MacTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MacTests}.
 * </p>
 *
 * @see javax.crypto.Mac class javax.crypto.Mac (the hereby targeted class-under-test class)
 * @see MacTests MacTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.Mac.class!",
                   javax.crypto.Mac.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SpinnerDateModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SpinnerDateModelTests}.
 * </p>
 *
 * @see javax.swing.SpinnerDateModel class javax.swing.SpinnerDateModel (the hereby targeted class-under-test class)
 * @see SpinnerDateModelTests SpinnerDateModelTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractSpinnerModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.SpinnerDateModel.class!",
                   javax.swing.SpinnerDateModel.class.isAssignableFrom(sut));
    }

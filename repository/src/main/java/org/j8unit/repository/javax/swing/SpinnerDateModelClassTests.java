 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SpinnerDateModel
 * public class javax.swing.SpinnerDateModel}.
 *
...
public abstract interface SpinnerDateModelClassTests<SUT extends SpinnerDateModel>
extends AbstractSpinnerModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SpinnerDateModel.class!",
                   SpinnerDateModel.class.isAssignableFrom(sut));
    }

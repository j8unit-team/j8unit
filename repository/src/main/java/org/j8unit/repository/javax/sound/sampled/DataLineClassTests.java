 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataLineTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataLineTests}.
 * </p>
 *
 * @see javax.sound.sampled.DataLine interface javax.sound.sampled.DataLine (the hereby targeted class-under-test class)
 * @see DataLineTests DataLineTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends LineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.DataLine.class!",
                   javax.sound.sampled.DataLine.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.DataLine.Info class
     * javax.sound.sampled.DataLine$Info}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link DataLineTests.InfoTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * {@link DataLineTests.InfoTests}.
     * </p>
     *
     * @see javax.sound.sampled.DataLine.Info class javax.sound.sampled.DataLine$Info (the hereby targeted
     *      class-under-test class)
     * @see DataLineTests.InfoTests DataLineTests.InfoTests (The complementary j8unit test interface containing the
    ...
    extends LineClassTests.InfoClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.DataLine.Info.class!",
                       javax.sound.sampled.DataLine.Info.class.isAssignableFrom(sut));
        }

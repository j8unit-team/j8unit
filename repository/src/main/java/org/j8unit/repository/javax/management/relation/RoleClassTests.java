 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Role public class
...
public abstract interface RoleClassTests<SUT extends Role>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Role.class!", Role.class.isAssignableFrom(sut));
    }

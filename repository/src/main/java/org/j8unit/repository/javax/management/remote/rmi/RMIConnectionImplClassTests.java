 ...
 * javax.management.remote.rmi.RMIConnectionImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIConnectionImplTests}).
 * </p>
 *
 * <p>
 ...
 * @see RMIConnectionImplTests RMIConnectionImplTests (The complementary j8unit test interface containing the instance
...
extends RMIConnectionClassTests<SUT>, org.j8unit.repository.java.rmi.server.UnreferencedClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIConnectionImpl.class!",
                   javax.management.remote.rmi.RMIConnectionImpl.class.isAssignableFrom(sut));
    }

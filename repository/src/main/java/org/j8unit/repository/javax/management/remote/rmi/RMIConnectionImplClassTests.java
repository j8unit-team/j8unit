 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIConnectionImpl
 * public class javax.management.remote.rmi.RMIConnectionImpl}.
 *
...
extends RMIConnectionClassTests<SUT>, UnreferencedClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIConnectionImpl.class!",
                   RMIConnectionImpl.class.isAssignableFrom(sut));
    }

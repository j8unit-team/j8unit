 ...
 * {@link AttributeChangeNotification public class javax.management.AttributeChangeNotification}.
 *
...
public abstract interface AttributeChangeNotificationClassTests<SUT extends AttributeChangeNotification>
extends NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeChangeNotification.class!",
                   AttributeChangeNotification.class.isAssignableFrom(sut));
    }

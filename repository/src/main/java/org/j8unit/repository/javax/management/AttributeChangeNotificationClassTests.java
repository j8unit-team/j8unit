...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.AttributeChangeNotification class
 * javax.management.AttributeChangeNotification}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AttributeChangeNotificationTests}).
 * </p>
 *
 * <p>
 ...
 * @see AttributeChangeNotificationTests AttributeChangeNotificationTests (The complementary j8unit test interface
...
public abstract interface AttributeChangeNotificationClassTests<SUT extends javax.management.AttributeChangeNotification>
extends NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.AttributeChangeNotification.class!",
                   javax.management.AttributeChangeNotification.class.isAssignableFrom(sut));
    }

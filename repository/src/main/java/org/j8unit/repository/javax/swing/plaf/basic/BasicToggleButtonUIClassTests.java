 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicToggleButtonUI
 * public class javax.swing.plaf.basic.BasicToggleButtonUI}.
 *
...
public abstract interface BasicToggleButtonUIClassTests<SUT extends BasicToggleButtonUI>
extends BasicButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicToggleButtonUI.class!",
                   BasicToggleButtonUI.class.isAssignableFrom(sut));
    }

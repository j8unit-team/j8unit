 ...
 * javax.swing.plaf.basic.BasicToggleButtonUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicToggleButtonUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicToggleButtonUITests}.
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicToggleButtonUI class javax.swing.plaf.basic.BasicToggleButtonUI (the hereby targeted
 *      class-under-test class)
 * @see BasicToggleButtonUITests BasicToggleButtonUITests (The complementary j8unit test interface containing the
...
extends BasicButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicToggleButtonUI.class!",
                   javax.swing.plaf.basic.BasicToggleButtonUI.class.isAssignableFrom(sut));
    }

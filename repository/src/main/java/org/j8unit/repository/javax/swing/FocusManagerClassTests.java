 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FocusManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FocusManagerTests}.
 * </p>
 *
 * @see javax.swing.FocusManager class javax.swing.FocusManager (the hereby targeted class-under-test class)
 * @see FocusManagerTests FocusManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface FocusManagerClassTests<SUT extends javax.swing.FocusManager>
extends org.j8unit.repository.java.awt.DefaultKeyboardFocusManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.FocusManager.class!",
                   javax.swing.FocusManager.class.isAssignableFrom(sut));
    }

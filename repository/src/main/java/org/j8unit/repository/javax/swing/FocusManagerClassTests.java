...
import org.j8unit.repository.java.awt.DefaultKeyboardFocusManagerClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FocusManager public
...
public abstract interface FocusManagerClassTests<SUT extends FocusManager>
extends DefaultKeyboardFocusManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FocusManager.class!",
                   FocusManager.class.isAssignableFrom(sut));
    }

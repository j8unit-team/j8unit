 ...
 * javax.swing.text.html.FormSubmitEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormSubmitEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see FormSubmitEventTests FormSubmitEventTests (The complementary j8unit test interface containing the instance
...
extends HTMLFrameHyperlinkEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.FormSubmitEvent.class!",
                   javax.swing.text.html.FormSubmitEvent.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.html.FormSubmitEvent.MethodType class
     * javax.swing.text.html.FormSubmitEvent$MethodType}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link FormSubmitEventTests.MethodTypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see FormSubmitEventTests.MethodTypeTests FormSubmitEventTests.MethodTypeTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.FormSubmitEvent.MethodType.class!",
                       javax.swing.text.html.FormSubmitEvent.MethodType.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FormSubmitEvent
...
extends HTMLFrameHyperlinkEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormSubmitEvent.class!",
                   FormSubmitEvent.class.isAssignableFrom(sut));
    }
     ...
     * {@link MethodType public static final enum javax.swing.text.html.FormSubmitEvent$MethodType}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MethodType.class!",
                              MethodType.class.isAssignableFrom(sut));
        }

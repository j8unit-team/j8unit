 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Mixer public
...
public abstract interface MixerClassTests<SUT extends Mixer>
extends LineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Mixer.class!", Mixer.class.isAssignableFrom(sut));
    }
     ...
     * {@link Info public static class javax.sound.sampled.Mixer$Info}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

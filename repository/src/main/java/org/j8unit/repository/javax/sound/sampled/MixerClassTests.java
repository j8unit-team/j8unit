...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sound.sampled.Mixer interface javax.sound.sampled.Mixer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MixerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MixerTests}.
 * </p>
 *
 * @see javax.sound.sampled.Mixer interface javax.sound.sampled.Mixer (the hereby targeted class-under-test class)
 * @see MixerTests MixerTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends LineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Mixer.class!",
                   javax.sound.sampled.Mixer.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.Mixer.Info class
     * javax.sound.sampled.Mixer$Info}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link MixerTests.InfoTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link MixerTests.InfoTests}.
     * </p>
     *
     * @see javax.sound.sampled.Mixer.Info class javax.sound.sampled.Mixer$Info (the hereby targeted class-under-test
     *      class)
     * @see MixerTests.InfoTests MixerTests.InfoTests (The complementary j8unit test interface containing the instance
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Mixer.Info.class!",
                       javax.sound.sampled.Mixer.Info.class.isAssignableFrom(sut));
        }

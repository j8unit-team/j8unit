 ...
 * javax.swing.AbstractSpinnerModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractSpinnerModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractSpinnerModelTests}
 * .
 * </p>
 *
 * @see javax.swing.AbstractSpinnerModel class javax.swing.AbstractSpinnerModel (the hereby targeted class-under-test
 *      class)
 * @see AbstractSpinnerModelTests AbstractSpinnerModelTests (The complementary j8unit test interface containing the
...
extends SpinnerModelClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.AbstractSpinnerModel.class!",
                   javax.swing.AbstractSpinnerModel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TabStop public
...
public abstract interface TabStopClassTests<SUT extends TabStop>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TabStop.class!",
                   TabStop.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.cert.CertificateEncodingException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CertificateEncodingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see CertificateEncodingExceptionTests CertificateEncodingExceptionTests (The complementary j8unit test interface
...
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.cert.CertificateEncodingException.class!",
                   javax.security.cert.CertificateEncodingException.class.isAssignableFrom(sut));
    }

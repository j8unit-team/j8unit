 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Scrollable public
...
public abstract interface ScrollableClassTests<SUT extends Scrollable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Scrollable.class!",
                   Scrollable.class.isAssignableFrom(sut));
    }

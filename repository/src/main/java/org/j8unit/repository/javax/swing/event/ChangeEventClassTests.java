 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChangeEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChangeEventTests}.
 * </p>
 *
 * @see javax.swing.event.ChangeEvent class javax.swing.event.ChangeEvent (the hereby targeted class-under-test class)
 * @see ChangeEventTests ChangeEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.ChangeEvent.class!",
                   javax.swing.event.ChangeEvent.class.isAssignableFrom(sut));
    }

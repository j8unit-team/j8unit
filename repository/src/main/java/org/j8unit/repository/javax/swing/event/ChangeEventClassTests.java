 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChangeEvent public
...
public abstract interface ChangeEventClassTests<SUT extends ChangeEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChangeEvent.class!",
                   ChangeEvent.class.isAssignableFrom(sut));
    }

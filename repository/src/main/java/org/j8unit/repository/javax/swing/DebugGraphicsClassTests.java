 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DebugGraphicsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DebugGraphicsTests}.
 * </p>
 *
 * @see javax.swing.DebugGraphics class javax.swing.DebugGraphics (the hereby targeted class-under-test class)
 * @see DebugGraphicsTests DebugGraphicsTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.GraphicsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.DebugGraphics.class!",
                   javax.swing.DebugGraphics.class.isAssignableFrom(sut));
    }

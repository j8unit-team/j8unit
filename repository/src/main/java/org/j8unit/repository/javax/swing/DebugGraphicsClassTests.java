...
import org.j8unit.repository.java.awt.GraphicsClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DebugGraphics
...
public abstract interface DebugGraphicsClassTests<SUT extends DebugGraphics>
extends GraphicsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DebugGraphics.class!",
                   DebugGraphics.class.isAssignableFrom(sut));
    }

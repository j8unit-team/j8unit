 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPConnectionTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPConnection class javax.xml.soap.SOAPConnection (the hereby targeted class-under-test class)
 * @see SOAPConnectionTests SOAPConnectionTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPConnectionClassTests<SUT extends javax.xml.soap.SOAPConnection>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPConnection.class!",
                   javax.xml.soap.SOAPConnection.class.isAssignableFrom(sut));
    }

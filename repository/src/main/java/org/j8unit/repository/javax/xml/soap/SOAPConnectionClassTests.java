 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPConnection
 * public abstract class javax.xml.soap.SOAPConnection}.
 *
...
public abstract interface SOAPConnectionClassTests<SUT extends SOAPConnection>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPConnection.class!",
                   SOAPConnection.class.isAssignableFrom(sut));
    }

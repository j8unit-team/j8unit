 ...
 * javax.naming.directory.NoSuchAttributeException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchAttributeExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NoSuchAttributeExceptionTests}.
 * </p>
 *
 * @see javax.naming.directory.NoSuchAttributeException class javax.naming.directory.NoSuchAttributeException (the
 *      hereby targeted class-under-test class)
 * @see NoSuchAttributeExceptionTests NoSuchAttributeExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.NoSuchAttributeException.class!",
                   javax.naming.directory.NoSuchAttributeException.class.isAssignableFrom(sut));
    }

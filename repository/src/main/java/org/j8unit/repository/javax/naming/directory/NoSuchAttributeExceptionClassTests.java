...
public abstract interface NoSuchAttributeExceptionClassTests<SUT extends NoSuchAttributeException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchAttributeException.class!",
                   NoSuchAttributeException.class.isAssignableFrom(sut));
    }

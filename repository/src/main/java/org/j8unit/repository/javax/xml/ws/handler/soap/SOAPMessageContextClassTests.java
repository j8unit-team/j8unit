...
import org.j8unit.repository.javax.xml.ws.handler.MessageContextClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPMessageContext
 * public abstract interface javax.xml.ws.handler.soap.SOAPMessageContext}.
 *
...
public abstract interface SOAPMessageContextClassTests<SUT extends SOAPMessageContext>
extends MessageContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPMessageContext.class!",
                   SOAPMessageContext.class.isAssignableFrom(sut));
    }

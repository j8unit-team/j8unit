...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.handler.soap.SOAPMessageContext interface
 * javax.xml.ws.handler.soap.SOAPMessageContext}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPMessageContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPMessageContextTests}.
 * </p>
 *
 * @see javax.xml.ws.handler.soap.SOAPMessageContext interface javax.xml.ws.handler.soap.SOAPMessageContext (the hereby
 *      targeted class-under-test class)
 * @see SOAPMessageContextTests SOAPMessageContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPMessageContextClassTests<SUT extends javax.xml.ws.handler.soap.SOAPMessageContext>
extends org.j8unit.repository.javax.xml.ws.handler.MessageContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.soap.SOAPMessageContext.class!",
                   javax.xml.ws.handler.soap.SOAPMessageContext.class.isAssignableFrom(sut));
    }

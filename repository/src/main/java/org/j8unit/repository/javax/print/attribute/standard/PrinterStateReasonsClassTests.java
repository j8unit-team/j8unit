...
import org.j8unit.repository.java.util.HashMapClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterStateReasons
 * public final class javax.print.attribute.standard.PrinterStateReasons}.
 *
...
public abstract interface PrinterStateReasonsClassTests<SUT extends PrinterStateReasons>
extends PrintServiceAttributeClassTests<SUT>, HashMapClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.standard.PrinterStateReasons]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterStateReasons.class!",
                   PrinterStateReasons.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintServiceLookup
...
public abstract interface PrintServiceLookupClassTests<SUT extends PrintServiceLookup>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintServiceLookup.class!",
                   PrintServiceLookup.class.isAssignableFrom(sut));
    }

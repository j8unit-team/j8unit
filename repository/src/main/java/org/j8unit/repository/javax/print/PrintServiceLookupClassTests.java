 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintServiceLookupTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintServiceLookupTests}.
 * </p>
 *
 * @see javax.print.PrintServiceLookup class javax.print.PrintServiceLookup (the hereby targeted class-under-test class)
 * @see PrintServiceLookupTests PrintServiceLookupTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.PrintServiceLookup.class!",
                   javax.print.PrintServiceLookup.class.isAssignableFrom(sut));
    }

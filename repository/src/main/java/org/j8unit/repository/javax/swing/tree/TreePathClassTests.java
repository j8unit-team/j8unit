 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreePath public
...
public abstract interface TreePathClassTests<SUT extends TreePath>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreePath.class!",
                   TreePath.class.isAssignableFrom(sut));
    }

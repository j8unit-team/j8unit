 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlSchema public
 * abstract @interface javax.xml.bind.annotation.XmlSchema}.
 *
...
public abstract interface XmlSchemaClassTests<SUT extends XmlSchema>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlSchema.class!",
                   XmlSchema.class.isAssignableFrom(sut));
    }

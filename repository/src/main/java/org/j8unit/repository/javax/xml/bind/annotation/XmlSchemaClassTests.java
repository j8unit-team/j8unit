 ...
 * javax.xml.bind.annotation.XmlSchema}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlSchemaTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlSchemaTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlSchema interface javax.xml.bind.annotation.XmlSchema (the hereby targeted
 *      class-under-test class)
 * @see XmlSchemaTests XmlSchemaTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlSchemaClassTests<SUT extends javax.xml.bind.annotation.XmlSchema>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlSchema.class!",
                   javax.xml.bind.annotation.XmlSchema.class.isAssignableFrom(sut));
    }

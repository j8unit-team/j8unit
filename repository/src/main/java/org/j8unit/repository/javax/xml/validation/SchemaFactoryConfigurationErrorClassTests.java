...
public abstract interface SchemaFactoryConfigurationErrorClassTests<SUT extends SchemaFactoryConfigurationError>
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SchemaFactoryConfigurationError.class!",
                   SchemaFactoryConfigurationError.class.isAssignableFrom(sut));
    }

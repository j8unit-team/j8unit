 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Validator public
 * abstract interface javax.xml.bind.Validator}.
 *
...
public abstract interface ValidatorClassTests<SUT extends Validator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Validator.class!",
                   Validator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceUIFactory
 * public abstract class javax.print.ServiceUIFactory}.
 *
...
public abstract interface ServiceUIFactoryClassTests<SUT extends ServiceUIFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceUIFactory.class!",
                   ServiceUIFactory.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceUIFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServiceUIFactoryTests}.
 * </p>
 *
 * @see javax.print.ServiceUIFactory class javax.print.ServiceUIFactory (the hereby targeted class-under-test class)
 * @see ServiceUIFactoryTests ServiceUIFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface ServiceUIFactoryClassTests<SUT extends javax.print.ServiceUIFactory>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.ServiceUIFactory.class!",
                   javax.print.ServiceUIFactory.class.isAssignableFrom(sut));
    }

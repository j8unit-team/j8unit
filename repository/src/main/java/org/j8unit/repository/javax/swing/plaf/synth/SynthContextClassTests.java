 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthContext public
...
public abstract interface SynthContextClassTests<SUT extends SynthContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthContext.class!",
                   SynthContext.class.isAssignableFrom(sut));
    }

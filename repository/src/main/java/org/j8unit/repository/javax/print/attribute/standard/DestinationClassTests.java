 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Destination public
 * final class javax.print.attribute.standard.Destination}.
 *
...
extends PrintJobAttributeClassTests<SUT>, PrintRequestAttributeClassTests<SUT>, URISyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Destination.class!",
                   Destination.class.isAssignableFrom(sut));
    }

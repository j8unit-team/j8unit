...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.annotation.processing.AbstractProcessor class
 * javax.annotation.processing.AbstractProcessor}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractProcessorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractProcessorTests}.
 * </p>
 *
 * @see javax.annotation.processing.AbstractProcessor class javax.annotation.processing.AbstractProcessor (the hereby
 *      targeted class-under-test class)
 * @see AbstractProcessorTests AbstractProcessorTests (The complementary j8unit test interface containing the instance
...
public abstract interface AbstractProcessorClassTests<SUT extends javax.annotation.processing.AbstractProcessor>
extends ProcessorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.AbstractProcessor.class!",
                   javax.annotation.processing.AbstractProcessor.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractProcessor
 * public abstract class javax.annotation.processing.AbstractProcessor}.
 *
...
public abstract interface AbstractProcessorClassTests<SUT extends AbstractProcessor>
extends org.j8unit.repository.javax.annotation.processing.ProcessorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractProcessor.class!",
                   AbstractProcessor.class.isAssignableFrom(sut));
    }

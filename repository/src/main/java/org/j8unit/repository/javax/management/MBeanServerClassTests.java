 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanServerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanServerTests}.
 * </p>
 *
 * @see javax.management.MBeanServer interface javax.management.MBeanServer (the hereby targeted class-under-test class)
 * @see MBeanServerTests MBeanServerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MBeanServerClassTests<SUT extends javax.management.MBeanServer>
extends MBeanServerConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanServer.class!",
                   javax.management.MBeanServer.class.isAssignableFrom(sut));
    }

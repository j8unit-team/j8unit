 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MBeanServer public
 * abstract interface javax.management.MBeanServer}.
 *
...
public abstract interface MBeanServerClassTests<SUT extends MBeanServer>
extends MBeanServerConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServer.class!",
                   MBeanServer.class.isAssignableFrom(sut));
    }

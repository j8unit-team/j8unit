 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMRuntimeException
 * public class javax.management.JMRuntimeException}.
 *
...
public abstract interface JMRuntimeExceptionClassTests<SUT extends JMRuntimeException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMRuntimeException.class!",
                   JMRuntimeException.class.isAssignableFrom(sut));
    }

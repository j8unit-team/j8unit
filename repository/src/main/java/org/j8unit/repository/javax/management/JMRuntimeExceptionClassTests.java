 ...
 * javax.management.JMRuntimeException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMRuntimeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMRuntimeExceptionTests}.
 * </p>
 *
 * @see javax.management.JMRuntimeException class javax.management.JMRuntimeException (the hereby targeted
 *      class-under-test class)
 * @see JMRuntimeExceptionTests JMRuntimeExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.JMRuntimeException.class!",
                   javax.management.JMRuntimeException.class.isAssignableFrom(sut));
    }

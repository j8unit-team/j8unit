...
import org.j8unit.repository.javax.xml.stream.XMLStreamConstantsClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLEvent public
...
public abstract interface XMLEventClassTests<SUT extends XMLEvent>
extends XMLStreamConstantsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLEvent.class!",
                   XMLEvent.class.isAssignableFrom(sut));
    }

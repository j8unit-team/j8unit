...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.events.XMLEvent interface
 * javax.xml.stream.events.XMLEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLEventTests}.
 * </p>
 *
 * @see javax.xml.stream.events.XMLEvent interface javax.xml.stream.events.XMLEvent (the hereby targeted
 *      class-under-test class)
 * @see XMLEventTests XMLEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XMLEventClassTests<SUT extends javax.xml.stream.events.XMLEvent>
extends org.j8unit.repository.javax.xml.stream.XMLStreamConstantsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.XMLEvent.class!",
                   javax.xml.stream.events.XMLEvent.class.isAssignableFrom(sut));
    }

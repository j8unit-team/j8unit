 ...
 * javax.naming.directory.AttributeModificationException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AttributeModificationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see AttributeModificationExceptionTests AttributeModificationExceptionTests (The complementary j8unit test interface
...
public abstract interface AttributeModificationExceptionClassTests<SUT extends javax.naming.directory.AttributeModificationException>
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.AttributeModificationException.class!",
                   javax.naming.directory.AttributeModificationException.class.isAssignableFrom(sut));
    }

 ...
 * {@link AttributeModificationException public class javax.naming.directory.AttributeModificationException}.
 *
...
public abstract interface AttributeModificationExceptionClassTests<SUT extends AttributeModificationException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeModificationException.class!",
                   AttributeModificationException.class.isAssignableFrom(sut));
    }

...
public abstract interface AttributeChangeNotificationFilterClassTests<SUT extends AttributeChangeNotificationFilter>
extends org.j8unit.repository.javax.management.NotificationFilterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.AttributeChangeNotificationFilter]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeChangeNotificationFilter.class!",
                   AttributeChangeNotificationFilter.class.isAssignableFrom(sut));
    }

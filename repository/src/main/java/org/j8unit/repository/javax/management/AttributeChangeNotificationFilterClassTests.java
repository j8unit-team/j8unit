 ...
 * javax.management.AttributeChangeNotificationFilter}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AttributeChangeNotificationFilterTests}).
 * </p>
 *
 * <p>
 ...
 * @see AttributeChangeNotificationFilterTests AttributeChangeNotificationFilterTests (The complementary j8unit test
...
extends NotificationFilterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.AttributeChangeNotificationFilter.class!",
                   javax.management.AttributeChangeNotificationFilter.class.isAssignableFrom(sut));
    }

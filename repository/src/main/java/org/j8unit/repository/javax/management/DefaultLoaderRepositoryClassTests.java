 ...
 * {@link DefaultLoaderRepository public class javax.management.DefaultLoaderRepository}.
 *
...
public abstract interface DefaultLoaderRepositoryClassTests<SUT extends DefaultLoaderRepository>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultLoaderRepository.class!",
                   DefaultLoaderRepository.class.isAssignableFrom(sut));
    }

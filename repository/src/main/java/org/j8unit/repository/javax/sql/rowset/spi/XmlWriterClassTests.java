 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlWriter public
 * abstract interface javax.sql.rowset.spi.XmlWriter}.
 *
...
public abstract interface XmlWriterClassTests<SUT extends XmlWriter>
extends RowSetWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlWriter.class!",

 ...
 * javax.sql.rowset.spi.XmlWriter}, containing all class relevant test methods (at least the test methods of accessible
 * constructors and of accessible {@code static} methods). The counterpart J8Unit test interface containing the instance
 * relevant test methods is {@link org.j8unit.repository.javax.sql.rowset.spi.XmlWriterTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.javax.sql.RowSetWriterClassTests<SUT> {
     ...
     * @since 0.9.2
     *
     * @j8unit.aim javax.sql.rowset.spi.XmlWriter#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

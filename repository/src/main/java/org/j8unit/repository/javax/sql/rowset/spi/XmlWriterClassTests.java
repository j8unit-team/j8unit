 ...
 * javax.sql.rowset.spi.XmlWriter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlWriterTests}.
 * </p>
 *
 * @see javax.sql.rowset.spi.XmlWriter interface javax.sql.rowset.spi.XmlWriter (the hereby targeted class-under-test
 *      class)
 * @see XmlWriterTests XmlWriterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlWriterClassTests<SUT extends javax.sql.rowset.spi.XmlWriter>
extends org.j8unit.repository.javax.sql.RowSetWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.spi.XmlWriter.class!",
                   javax.sql.rowset.spi.XmlWriter.class.isAssignableFrom(sut));
    }

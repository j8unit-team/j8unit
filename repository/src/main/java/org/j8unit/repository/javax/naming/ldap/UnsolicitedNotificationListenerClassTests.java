...
extends org.j8unit.repository.javax.naming.event.NamingListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsolicitedNotificationListener.class!",
                   UnsolicitedNotificationListener.class.isAssignableFrom(sut));
    }

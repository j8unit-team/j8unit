 ...
 * javax.naming.ldap.UnsolicitedNotificationListener}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see UnsolicitedNotificationListenerTests UnsolicitedNotificationListenerTests (The complementary j8unit test
...
public abstract interface UnsolicitedNotificationListenerClassTests<SUT extends javax.naming.ldap.UnsolicitedNotificationListener>
extends org.j8unit.repository.javax.naming.event.NamingListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.UnsolicitedNotificationListener.class!",
                   javax.naming.ldap.UnsolicitedNotificationListener.class.isAssignableFrom(sut));
    }

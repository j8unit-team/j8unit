 ...
 * javax.swing.text.ChangedCharSetException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChangedCharSetExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ChangedCharSetExceptionTests}.
 * </p>
 *
 * @see javax.swing.text.ChangedCharSetException class javax.swing.text.ChangedCharSetException (the hereby targeted
 *      class-under-test class)
 * @see ChangedCharSetExceptionTests ChangedCharSetExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.ChangedCharSetException.class!",
                   javax.swing.text.ChangedCharSetException.class.isAssignableFrom(sut));
    }

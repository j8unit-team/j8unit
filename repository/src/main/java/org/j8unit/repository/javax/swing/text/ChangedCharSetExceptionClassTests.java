...
public abstract interface ChangedCharSetExceptionClassTests<SUT extends ChangedCharSetException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChangedCharSetException.class!",
                   ChangedCharSetException.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.javax.management.MBeanFeatureInfoClassTests<SUT> {
    ...
    public default void create_MBeanAttributeInfo_String_String_Method_Method()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public default void create_MBeanAttributeInfo_String_String_String_boolean_boolean_boolean_Descriptor()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.management.MBeanAttributeInfo sut = null; // = new MBeanAttributeInfo(java.lang.String,

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MBeanAttributeInfo
 * public class javax.management.MBeanAttributeInfo}.
 *
...
public abstract interface MBeanAttributeInfoClassTests<SUT extends MBeanAttributeInfo>
extends CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.MBeanAttributeInfo]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanAttributeInfo.class!",
                   MBeanAttributeInfo.class.isAssignableFrom(sut));
    }

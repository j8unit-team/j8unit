 ...
 * javax.management.MBeanAttributeInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanAttributeInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanAttributeInfoTests}.
 * </p>
 *
 * @see javax.management.MBeanAttributeInfo class javax.management.MBeanAttributeInfo (the hereby targeted
 *      class-under-test class)
 * @see MBeanAttributeInfoTests MBeanAttributeInfoTests (The complementary j8unit test interface containing the instance
...
public abstract interface MBeanAttributeInfoClassTests<SUT extends javax.management.MBeanAttributeInfo>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanAttributeInfo.class!",
                   javax.management.MBeanAttributeInfo.class.isAssignableFrom(sut));
    }

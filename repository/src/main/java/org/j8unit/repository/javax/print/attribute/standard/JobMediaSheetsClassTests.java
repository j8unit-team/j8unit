...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.JobMediaSheets class
 * javax.print.attribute.standard.JobMediaSheets}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobMediaSheetsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobMediaSheetsTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.JobMediaSheets class javax.print.attribute.standard.JobMediaSheets (the hereby
 *      targeted class-under-test class)
 * @see JobMediaSheetsTests JobMediaSheetsTests (The complementary j8unit test interface containing the instance
...
public abstract interface JobMediaSheetsClassTests<SUT extends javax.print.attribute.standard.JobMediaSheets>
...
org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobMediaSheets.class!",
                   javax.print.attribute.standard.JobMediaSheets.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobMediaSheets
...
public abstract interface JobMediaSheetsClassTests<SUT extends JobMediaSheets>
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobMediaSheets.class!",

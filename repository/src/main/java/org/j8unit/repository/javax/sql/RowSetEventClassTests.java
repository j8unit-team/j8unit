 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetEventTests}.
 * </p>
 *
 * @see javax.sql.RowSetEvent class javax.sql.RowSetEvent (the hereby targeted class-under-test class)
 * @see RowSetEventTests RowSetEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RowSetEventClassTests<SUT extends javax.sql.RowSetEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.RowSetEvent.class!",
                   javax.sql.RowSetEvent.class.isAssignableFrom(sut));
    }

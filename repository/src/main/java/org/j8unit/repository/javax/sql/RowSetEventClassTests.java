 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetEvent public
...
public abstract interface RowSetEventClassTests<SUT extends RowSetEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetEvent.class!",
                   RowSetEvent.class.isAssignableFrom(sut));
    }

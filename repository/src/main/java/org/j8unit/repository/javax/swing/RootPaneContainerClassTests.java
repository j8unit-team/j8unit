 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RootPaneContainer
 * public abstract interface javax.swing.RootPaneContainer}.
 *
...
public abstract interface RootPaneContainerClassTests<SUT extends RootPaneContainer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RootPaneContainer.class!",
                   RootPaneContainer.class.isAssignableFrom(sut));
    }

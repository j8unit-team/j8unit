 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link QueryExpTests}).
 * </p>
 *
 * <p>
 ...
 * @see QueryExpTests QueryExpTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface QueryExpClassTests<SUT extends javax.management.QueryExp>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.QueryExp.class!",
                   javax.management.QueryExp.class.isAssignableFrom(sut));
    }

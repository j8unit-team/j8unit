 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link QueryExp public
 * abstract interface javax.management.QueryExp}.
 *
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to QueryExp.class!",
                   QueryExp.class.isAssignableFrom(sut));
    }

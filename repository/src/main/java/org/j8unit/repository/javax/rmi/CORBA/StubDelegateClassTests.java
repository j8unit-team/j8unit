 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StubDelegate public
 * abstract interface javax.rmi.CORBA.StubDelegate}.
 *
...
public abstract interface StubDelegateClassTests<SUT extends StubDelegate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StubDelegate.class!",

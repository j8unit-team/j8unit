...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.rmi.CORBA.StubDelegate interface javax.rmi.CORBA.StubDelegate},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StubDelegateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StubDelegateTests}.
 * </p>
 *
 * @see javax.rmi.CORBA.StubDelegate interface javax.rmi.CORBA.StubDelegate (the hereby targeted class-under-test class)
 * @see StubDelegateTests StubDelegateTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StubDelegateClassTests<SUT extends javax.rmi.CORBA.StubDelegate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.CORBA.StubDelegate.class!",
                   javax.rmi.CORBA.StubDelegate.class.isAssignableFrom(sut));
    }

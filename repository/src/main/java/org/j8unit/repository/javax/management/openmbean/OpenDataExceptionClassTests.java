 ...
 * javax.management.openmbean.OpenDataException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenDataExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OpenDataExceptionTests}.
 * </p>
 *
 * @see javax.management.openmbean.OpenDataException class javax.management.openmbean.OpenDataException (the hereby
 *      targeted class-under-test class)
 * @see OpenDataExceptionTests OpenDataExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.management.JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenDataException.class!",
                   javax.management.openmbean.OpenDataException.class.isAssignableFrom(sut));
    }

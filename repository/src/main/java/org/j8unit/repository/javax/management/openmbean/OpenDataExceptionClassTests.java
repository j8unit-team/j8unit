...
import org.j8unit.repository.javax.management.JMExceptionClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OpenDataException
 * public class javax.management.openmbean.OpenDataException}.
 *
...
public abstract interface OpenDataExceptionClassTests<SUT extends OpenDataException>
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenDataException.class!",
                   OpenDataException.class.isAssignableFrom(sut));
    }

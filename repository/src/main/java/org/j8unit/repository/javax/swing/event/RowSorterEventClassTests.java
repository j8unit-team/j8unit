 ...
 * javax.swing.event.RowSorterEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSorterEventTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.event.RowSorterEvent class javax.swing.event.RowSorterEvent (the hereby targeted class-under-test
 *      class)
 * @see RowSorterEventTests RowSorterEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.RowSorterEvent.class!",
                   javax.swing.event.RowSorterEvent.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.event.RowSorterEvent.Type class
     * javax.swing.event.RowSorterEvent$Type}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link RowSorterEventTests.TypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.event.RowSorterEvent.Type class javax.swing.event.RowSorterEvent$Type (the hereby targeted
     *      class-under-test class)
     * @see RowSorterEventTests.TypeTests RowSorterEventTests.TypeTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.RowSorterEvent.Type.class!",
                       javax.swing.event.RowSorterEvent.Type.class.isAssignableFrom(sut));
        }

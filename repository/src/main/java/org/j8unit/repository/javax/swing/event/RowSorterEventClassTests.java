 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSorterEvent
...
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSorterEvent.class!",
                   RowSorterEvent.class.isAssignableFrom(sut));
    }
     ...
     * {@link Type public static final enum javax.swing.event.RowSorterEvent$Type}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

 ...
 * javax.lang.model.type.MirroredTypeException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MirroredTypeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see MirroredTypeExceptionTests MirroredTypeExceptionTests (The complementary j8unit test interface containing the
...
extends MirroredTypesExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.MirroredTypeException.class!",
                   javax.lang.model.type.MirroredTypeException.class.isAssignableFrom(sut));
    }

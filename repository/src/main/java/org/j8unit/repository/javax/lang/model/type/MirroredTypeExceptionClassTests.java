 ...
 * {@link MirroredTypeException public class javax.lang.model.type.MirroredTypeException}.
 *
...
extends MirroredTypesExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MirroredTypeException.class!",
                   MirroredTypeException.class.isAssignableFrom(sut));
    }

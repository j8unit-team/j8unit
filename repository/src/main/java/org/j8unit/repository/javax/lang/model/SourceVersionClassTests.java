 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SourceVersion
...
public abstract interface SourceVersionClassTests<SUT extends SourceVersion>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SourceVersion.class!",
                   SourceVersion.class.isAssignableFrom(sut));
    }

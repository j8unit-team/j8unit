...
import org.j8unit.repository.javax.xml.ws.handler.HandlerClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPHandler public
 * abstract interface javax.xml.ws.handler.soap.SOAPHandler<T>}.
 *
...
public abstract interface SOAPHandlerClassTests<SUT extends SOAPHandler>
extends HandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPHandler.class!",
                   SOAPHandler.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.ws.handler.soap.SOAPHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPHandlerTests}.
 * </p>
 *
 * @see javax.xml.ws.handler.soap.SOAPHandler interface javax.xml.ws.handler.soap.SOAPHandler (the hereby targeted
 *      class-under-test class)
 * @see SOAPHandlerTests SOAPHandlerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.ws.handler.HandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.soap.SOAPHandler.class!",
                   javax.xml.ws.handler.soap.SOAPHandler.class.isAssignableFrom(sut));
    }

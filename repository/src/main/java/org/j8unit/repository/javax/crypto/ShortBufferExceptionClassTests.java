 ...
 * javax.crypto.ShortBufferException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShortBufferExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ShortBufferExceptionTests}
 * .
 * </p>
 *
 * @see javax.crypto.ShortBufferException class javax.crypto.ShortBufferException (the hereby targeted class-under-test
 *      class)
 * @see ShortBufferExceptionTests ShortBufferExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.ShortBufferException.class!",
                   javax.crypto.ShortBufferException.class.isAssignableFrom(sut));
    }

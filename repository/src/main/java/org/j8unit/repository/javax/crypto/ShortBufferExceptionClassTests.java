...
public abstract interface ShortBufferExceptionClassTests<SUT extends ShortBufferException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ShortBufferException.class!",
                   ShortBufferException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExpandVetoException
 * public class javax.swing.tree.ExpandVetoException}.
 *
...
public abstract interface ExpandVetoExceptionClassTests<SUT extends ExpandVetoException>
extends ExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.tree.ExpandVetoException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExpandVetoException.class!",
                   ExpandVetoException.class.isAssignableFrom(sut));
    }

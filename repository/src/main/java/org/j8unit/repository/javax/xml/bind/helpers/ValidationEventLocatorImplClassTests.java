 ...
 * javax.xml.bind.helpers.ValidationEventLocatorImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see ValidationEventLocatorImplTests ValidationEventLocatorImplTests (The complementary j8unit test interface
...
extends org.j8unit.repository.javax.xml.bind.ValidationEventLocatorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.helpers.ValidationEventLocatorImpl.class!",
                   javax.xml.bind.helpers.ValidationEventLocatorImpl.class.isAssignableFrom(sut));
    }

...
extends ValidationEventLocatorClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValidationEventLocatorImpl.class!",
                   ValidationEventLocatorImpl.class.isAssignableFrom(sut));
    }

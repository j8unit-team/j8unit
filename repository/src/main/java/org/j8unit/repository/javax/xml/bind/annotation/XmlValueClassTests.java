 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlValue public
 * abstract @interface javax.xml.bind.annotation.XmlValue}.
 *
...
public abstract interface XmlValueClassTests<SUT extends XmlValue>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlValue.class!",
                   XmlValue.class.isAssignableFrom(sut));
    }

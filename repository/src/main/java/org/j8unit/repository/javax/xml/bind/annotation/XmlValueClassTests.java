 ...
 * javax.xml.bind.annotation.XmlValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlValueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlValueTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlValue interface javax.xml.bind.annotation.XmlValue (the hereby targeted
 *      class-under-test class)
 * @see XmlValueTests XmlValueTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlValueClassTests<SUT extends javax.xml.bind.annotation.XmlValue>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlValue.class!",
                   javax.xml.bind.annotation.XmlValue.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TabbedPaneUITests}).
 * </p>
 *
 * <p>
 ...
 * @see TabbedPaneUITests TabbedPaneUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TabbedPaneUIClassTests<SUT extends javax.swing.plaf.TabbedPaneUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.TabbedPaneUI.class!",
                   javax.swing.plaf.TabbedPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAccessorType
...
public abstract interface XmlAccessorTypeClassTests<SUT extends XmlAccessorType>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAccessorType.class!",
                   XmlAccessorType.class.isAssignableFrom(sut));
    }

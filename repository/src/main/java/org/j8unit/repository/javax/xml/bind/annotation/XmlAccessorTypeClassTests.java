...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlAccessorType interface
 * javax.xml.bind.annotation.XmlAccessorType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlAccessorTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlAccessorTypeTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlAccessorType interface javax.xml.bind.annotation.XmlAccessorType (the hereby
 *      targeted class-under-test class)
 * @see XmlAccessorTypeTests XmlAccessorTypeTests (The complementary j8unit test interface containing the instance
...
public abstract interface XmlAccessorTypeClassTests<SUT extends javax.xml.bind.annotation.XmlAccessorType>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlAccessorType.class!",
                   javax.xml.bind.annotation.XmlAccessorType.class.isAssignableFrom(sut));
    }

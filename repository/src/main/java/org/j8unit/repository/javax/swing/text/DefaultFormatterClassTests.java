 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultFormatter
 * public class javax.swing.text.DefaultFormatter}.
 *
...
public abstract interface DefaultFormatterClassTests<SUT extends DefaultFormatter>
extends CloneableClassTests<SUT>, AbstractFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultFormatter.class!",
                   DefaultFormatter.class.isAssignableFrom(sut));
    }

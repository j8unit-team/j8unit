 ...
 * javax.swing.text.DefaultFormatter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultFormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultFormatterTests}.
 * </p>
 *
 * @see javax.swing.text.DefaultFormatter class javax.swing.text.DefaultFormatter (the hereby targeted class-under-test
 *      class)
 * @see DefaultFormatterTests DefaultFormatterTests (The complementary j8unit test interface containing the instance
...
public abstract interface DefaultFormatterClassTests<SUT extends javax.swing.text.DefaultFormatter>
...
org.j8unit.repository.javax.swing.JFormattedTextFieldClassTests.AbstractFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.DefaultFormatter.class!",
                   javax.swing.text.DefaultFormatter.class.isAssignableFrom(sut));
    }

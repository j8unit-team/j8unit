 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TitledBorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TitledBorderTests}.
 * </p>
 *
 * @see javax.swing.border.TitledBorder class javax.swing.border.TitledBorder (the hereby targeted class-under-test
 *      class)
 * @see TitledBorderTests TitledBorderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TitledBorderClassTests<SUT extends javax.swing.border.TitledBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.TitledBorder.class!",
                   javax.swing.border.TitledBorder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TitledBorder public
...
public abstract interface TitledBorderClassTests<SUT extends TitledBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TitledBorder.class!",
                   TitledBorder.class.isAssignableFrom(sut));
    }

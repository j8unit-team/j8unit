...
public abstract interface SubjectDelegationPermissionClassTests<SUT extends SubjectDelegationPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SubjectDelegationPermission.class!",
                   SubjectDelegationPermission.class.isAssignableFrom(sut));
    }

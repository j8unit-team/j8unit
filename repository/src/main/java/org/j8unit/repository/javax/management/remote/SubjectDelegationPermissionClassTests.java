 ...
 * javax.management.remote.SubjectDelegationPermission}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link SubjectDelegationPermissionTests}).
 * </p>
 *
 * <p>
 ...
 * @see SubjectDelegationPermissionTests SubjectDelegationPermissionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.SubjectDelegationPermission.class!",
                   javax.management.remote.SubjectDelegationPermission.class.isAssignableFrom(sut));
    }

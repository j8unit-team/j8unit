 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SysexMessageTests}).
 * </p>
 *
 * <p>
 ...
 * @see SysexMessageTests SysexMessageTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SysexMessageClassTests<SUT extends javax.sound.midi.SysexMessage>
extends MidiMessageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.SysexMessage.class!",
                   javax.sound.midi.SysexMessage.class.isAssignableFrom(sut));
    }

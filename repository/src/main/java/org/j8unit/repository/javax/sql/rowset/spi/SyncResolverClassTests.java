 ...
 * javax.sql.rowset.spi.SyncResolver}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SyncResolverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SyncResolverTests}.
 * </p>
 *
 * @see javax.sql.rowset.spi.SyncResolver interface javax.sql.rowset.spi.SyncResolver (the hereby targeted
 *      class-under-test class)
 * @see SyncResolverTests SyncResolverTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SyncResolverClassTests<SUT extends javax.sql.rowset.spi.SyncResolver>
extends org.j8unit.repository.javax.sql.RowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.spi.SyncResolver.class!",
                   javax.sql.rowset.spi.SyncResolver.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.sql.RowSetClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SyncResolver public
 * abstract interface javax.sql.rowset.spi.SyncResolver}.
 *
...
public abstract interface SyncResolverClassTests<SUT extends SyncResolver>
extends RowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SyncResolver.class!",
                   SyncResolver.class.isAssignableFrom(sut));
    }

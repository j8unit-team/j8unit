 ...
 * javax.lang.model.type.UnionType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnionTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnionTypeTests}.
 * </p>
 *
 * @see javax.lang.model.type.UnionType interface javax.lang.model.type.UnionType (the hereby targeted class-under-test
 *      class)
 * @see UnionTypeTests UnionTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface UnionTypeClassTests<SUT extends javax.lang.model.type.UnionType>
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.UnionType.class!",
                   javax.lang.model.type.UnionType.class.isAssignableFrom(sut));
    }

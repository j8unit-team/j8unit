 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnionType public
 * abstract interface javax.lang.model.type.UnionType}.
 *
...
public abstract interface UnionTypeClassTests<SUT extends UnionType>
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnionType.class!",
                   UnionType.class.isAssignableFrom(sut));
    }

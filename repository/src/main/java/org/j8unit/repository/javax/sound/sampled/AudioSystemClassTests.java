 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AudioSystem public
...
public abstract interface AudioSystemClassTests<SUT extends AudioSystem>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AudioSystem.class!",
                   AudioSystem.class.isAssignableFrom(sut));
    }

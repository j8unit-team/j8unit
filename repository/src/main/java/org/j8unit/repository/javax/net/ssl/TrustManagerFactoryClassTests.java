 ...
 * javax.net.ssl.TrustManagerFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TrustManagerFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TrustManagerFactoryTests}.
 * </p>
 *
 * @see javax.net.ssl.TrustManagerFactory class javax.net.ssl.TrustManagerFactory (the hereby targeted class-under-test
 *      class)
 * @see TrustManagerFactoryTests TrustManagerFactoryTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.TrustManagerFactory.class!",
                   javax.net.ssl.TrustManagerFactory.class.isAssignableFrom(sut));
    }

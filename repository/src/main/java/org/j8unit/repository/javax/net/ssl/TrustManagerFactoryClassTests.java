 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TrustManagerFactory
...
public abstract interface TrustManagerFactoryClassTests<SUT extends TrustManagerFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TrustManagerFactory.class!",
                   TrustManagerFactory.class.isAssignableFrom(sut));
    }

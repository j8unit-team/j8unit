...
public abstract interface HandlerClassTests<SUT extends javax.xml.ws.handler.Handler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.Handler.class!",
                   javax.xml.ws.handler.Handler.class.isAssignableFrom(sut));
    }

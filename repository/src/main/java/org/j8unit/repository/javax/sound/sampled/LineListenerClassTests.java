 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LineListener public
 * abstract interface javax.sound.sampled.LineListener}.
 *
...
public abstract interface LineListenerClassTests<SUT extends LineListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineListener.class!",
                   LineListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sound.sampled.LineListener interface
 * javax.sound.sampled.LineListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LineListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LineListenerTests}.
 * </p>
 *
 * @see javax.sound.sampled.LineListener interface javax.sound.sampled.LineListener (the hereby targeted
 *      class-under-test class)
 * @see LineListenerTests LineListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LineListenerClassTests<SUT extends javax.sound.sampled.LineListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.LineListener.class!",
                   javax.sound.sampled.LineListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActionMap public
...
public abstract interface ActionMapClassTests<SUT extends ActionMap>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActionMap.class!",
                   ActionMap.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.ActionMap]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Line public
...
extends AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Line.class!", Line.class.isAssignableFrom(sut));
    }
     ...
     * {@link Info public static class javax.sound.sampled.Line$Info}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LineTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.sound.sampled.Line interface javax.sound.sampled.Line (the hereby targeted class-under-test class)
 * @see LineTests LineTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Line.class!",
                   javax.sound.sampled.Line.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link LineTests.InfoTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link LineTests.InfoTests}.
     * </p>
     *
     * @see javax.sound.sampled.Line.Info class javax.sound.sampled.Line$Info (the hereby targeted class-under-test
     *      class)
     * @see LineTests.InfoTests LineTests.InfoTests (The complementary j8unit test interface containing the instance
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Line.Info.class!",
                       javax.sound.sampled.Line.Info.class.isAssignableFrom(sut));
        }

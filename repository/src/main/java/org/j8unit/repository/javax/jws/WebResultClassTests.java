 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebResultTests}.
 * </p>
 *
 * @see javax.jws.WebResult interface javax.jws.WebResult (the hereby targeted class-under-test class)
 * @see WebResultTests WebResultTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.WebResult.class!",
                   javax.jws.WebResult.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebResult public
 * abstract @interface javax.jws.WebResult}.
 *
...
public abstract interface WebResultClassTests<SUT extends WebResult>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebResult.class!",
                   WebResult.class.isAssignableFrom(sut));
    }

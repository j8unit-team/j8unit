...
public abstract interface X500PrivateCredentialClassTests<SUT extends X500PrivateCredential>
extends DestroyableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X500PrivateCredential.class!",
                   X500PrivateCredential.class.isAssignableFrom(sut));
    }

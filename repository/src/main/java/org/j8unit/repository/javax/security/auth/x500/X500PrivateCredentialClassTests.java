 ...
 * javax.security.auth.x500.X500PrivateCredential}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X500PrivateCredentialTests}).
 * </p>
 *
 * <p>
 ...
 * {@link X500PrivateCredentialTests}.
 * </p>
 *
 * @see javax.security.auth.x500.X500PrivateCredential class javax.security.auth.x500.X500PrivateCredential (the hereby
 *      targeted class-under-test class)
 * @see X500PrivateCredentialTests X500PrivateCredentialTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.security.auth.DestroyableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.x500.X500PrivateCredential.class!",
                   javax.security.auth.x500.X500PrivateCredential.class.isAssignableFrom(sut));
    }

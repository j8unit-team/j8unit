 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Reference public
 * abstract interface javax.xml.crypto.dsig.Reference}.
 *
...
public abstract interface ReferenceClassTests<SUT extends Reference>
extends URIReferenceClassTests<SUT>, XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Reference.class!",
                   Reference.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.crypto.dsig.Reference}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
...
extends org.j8unit.repository.javax.xml.crypto.URIReferenceClassTests<SUT>, org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.Reference.class!",
                   javax.xml.crypto.dsig.Reference.class.isAssignableFrom(sut));
    }

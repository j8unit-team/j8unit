 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PooledConnection
 * public abstract interface javax.sql.PooledConnection}.
 *
...
public abstract interface PooledConnectionClassTests<SUT extends PooledConnection>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PooledConnection.class!",

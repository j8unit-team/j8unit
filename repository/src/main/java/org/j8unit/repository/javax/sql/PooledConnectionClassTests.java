...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.PooledConnection interface javax.sql.PooledConnection},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PooledConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PooledConnectionTests}.
 * </p>
 *
 * @see javax.sql.PooledConnection interface javax.sql.PooledConnection (the hereby targeted class-under-test class)
 * @see PooledConnectionTests PooledConnectionTests (The complementary j8unit test interface containing the instance
...
public abstract interface PooledConnectionClassTests<SUT extends javax.sql.PooledConnection>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.PooledConnection.class!",
                   javax.sql.PooledConnection.class.isAssignableFrom(sut));
    }

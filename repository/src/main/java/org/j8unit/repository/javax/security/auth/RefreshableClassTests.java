 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Refreshable public
 * abstract interface javax.security.auth.Refreshable}.
 *
...
public abstract interface RefreshableClassTests<SUT extends Refreshable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Refreshable.class!",
                   Refreshable.class.isAssignableFrom(sut));
    }

 ...
 * javax.security.auth.Refreshable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RefreshableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RefreshableTests}.
 * </p>
 *
 * @see javax.security.auth.Refreshable interface javax.security.auth.Refreshable (the hereby targeted class-under-test
 *      class)
 * @see RefreshableTests RefreshableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RefreshableClassTests<SUT extends javax.security.auth.Refreshable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.Refreshable.class!",
                   javax.security.auth.Refreshable.class.isAssignableFrom(sut));
    }

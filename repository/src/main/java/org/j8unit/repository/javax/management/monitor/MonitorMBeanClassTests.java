 ...
 * javax.management.monitor.MonitorMBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MonitorMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MonitorMBeanTests}.
 * </p>
 *
 * @see javax.management.monitor.MonitorMBean interface javax.management.monitor.MonitorMBean (the hereby targeted
 *      class-under-test class)
 * @see MonitorMBeanTests MonitorMBeanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MonitorMBeanClassTests<SUT extends javax.management.monitor.MonitorMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.MonitorMBean.class!",
                   javax.management.monitor.MonitorMBean.class.isAssignableFrom(sut));
    }

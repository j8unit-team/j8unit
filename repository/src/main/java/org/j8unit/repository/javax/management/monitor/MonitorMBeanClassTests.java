 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MonitorMBean public
 * abstract interface javax.management.monitor.MonitorMBean}.
 *
...
public abstract interface MonitorMBeanClassTests<SUT extends MonitorMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MonitorMBean.class!",
                   MonitorMBean.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CachedRowSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CachedRowSetTests}.
 * </p>
 *
 * @see javax.sql.rowset.CachedRowSet interface javax.sql.rowset.CachedRowSet (the hereby targeted class-under-test
 *      class)
 * @see CachedRowSetTests CachedRowSetTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CachedRowSetClassTests<SUT extends javax.sql.rowset.CachedRowSet>
extends org.j8unit.repository.javax.sql.RowSetClassTests<SUT>, JoinableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.CachedRowSet.class!",
                   javax.sql.rowset.CachedRowSet.class.isAssignableFrom(sut));
    }

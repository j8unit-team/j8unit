 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CachedRowSet public
 * abstract interface javax.sql.rowset.CachedRowSet}.
 *
...
public abstract interface CachedRowSetClassTests<SUT extends CachedRowSet>
extends RowSetClassTests<SUT>, JoinableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CachedRowSet.class!",

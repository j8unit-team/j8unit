...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.accessibility.Accessible interface
 * javax.accessibility.Accessible}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleTests}.
 * </p>
 *
 * @see javax.accessibility.Accessible interface javax.accessibility.Accessible (the hereby targeted class-under-test
 *      class)
 * @see AccessibleTests AccessibleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AccessibleClassTests<SUT extends javax.accessibility.Accessible>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.Accessible.class!",
                   javax.accessibility.Accessible.class.isAssignableFrom(sut));
    }

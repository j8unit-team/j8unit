 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Accessible public
...
public abstract interface AccessibleClassTests<SUT extends Accessible>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Accessible.class!",
                   Accessible.class.isAssignableFrom(sut));
    }

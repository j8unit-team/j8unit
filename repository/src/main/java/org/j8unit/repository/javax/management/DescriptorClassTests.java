 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Descriptor public
 * abstract interface javax.management.Descriptor}.
 *
...
public abstract interface DescriptorClassTests<SUT extends Descriptor>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Descriptor.class!",
                   Descriptor.class.isAssignableFrom(sut));
    }

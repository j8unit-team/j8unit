...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.Descriptor interface javax.management.Descriptor},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DescriptorTests}.
 * </p>
 *
 * @see javax.management.Descriptor interface javax.management.Descriptor (the hereby targeted class-under-test class)
 * @see DescriptorTests DescriptorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DescriptorClassTests<SUT extends javax.management.Descriptor>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.Descriptor.class!",
                   javax.management.Descriptor.class.isAssignableFrom(sut));
    }

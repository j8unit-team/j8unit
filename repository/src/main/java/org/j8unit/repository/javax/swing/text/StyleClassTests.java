...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.text.Style interface javax.swing.text.Style}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StyleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StyleTests}.
 * </p>
 *
 * @see javax.swing.text.Style interface javax.swing.text.Style (the hereby targeted class-under-test class)
 * @see StyleTests StyleTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface StyleClassTests<SUT extends javax.swing.text.Style>
extends MutableAttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.Style.class!",
                   javax.swing.text.Style.class.isAssignableFrom(sut));
    }

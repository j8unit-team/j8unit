 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileView public
...
public abstract interface FileViewClassTests<SUT extends FileView>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileView.class!",
                   FileView.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.filechooser.FileView]

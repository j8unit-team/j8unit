 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ATR public final
 * class javax.smartcardio.ATR}.
 *
...
public abstract interface ATRClassTests<SUT extends ATR>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ATR.class!", ATR.class.isAssignableFrom(sut));
    }

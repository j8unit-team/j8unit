...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.keyinfo.KeyInfo interface
 * javax.xml.crypto.dsig.keyinfo.KeyInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyInfoTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.KeyInfo interface javax.xml.crypto.dsig.keyinfo.KeyInfo (the hereby targeted
 *      class-under-test class)
 * @see KeyInfoTests KeyInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeyInfoClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.KeyInfo>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.KeyInfo.class!",
                   javax.xml.crypto.dsig.keyinfo.KeyInfo.class.isAssignableFrom(sut));
    }

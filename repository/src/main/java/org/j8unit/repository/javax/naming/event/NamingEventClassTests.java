 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingEvent public
...
public abstract interface NamingEventClassTests<SUT extends NamingEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingEvent.class!",
                   NamingEvent.class.isAssignableFrom(sut));
    }

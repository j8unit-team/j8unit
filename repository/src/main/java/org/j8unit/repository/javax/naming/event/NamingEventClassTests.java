...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.event.NamingEvent class javax.naming.event.NamingEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingEventTests}.
 * </p>
 *
 * @see javax.naming.event.NamingEvent class javax.naming.event.NamingEvent (the hereby targeted class-under-test class)
 * @see NamingEventTests NamingEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NamingEventClassTests<SUT extends javax.naming.event.NamingEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.event.NamingEvent.class!",
                   javax.naming.event.NamingEvent.class.isAssignableFrom(sut));
    }

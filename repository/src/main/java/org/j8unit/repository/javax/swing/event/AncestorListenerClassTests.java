 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AncestorListener
 * public abstract interface javax.swing.event.AncestorListener}.
 *
...
public abstract interface AncestorListenerClassTests<SUT extends AncestorListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AncestorListener.class!",
                   AncestorListener.class.isAssignableFrom(sut));
    }

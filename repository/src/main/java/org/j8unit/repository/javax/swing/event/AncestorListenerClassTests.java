...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.AncestorListener interface
 * javax.swing.event.AncestorListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AncestorListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AncestorListenerTests}.
 * </p>
 *
 * @see javax.swing.event.AncestorListener interface javax.swing.event.AncestorListener (the hereby targeted
 *      class-under-test class)
 * @see AncestorListenerTests AncestorListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface AncestorListenerClassTests<SUT extends javax.swing.event.AncestorListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.AncestorListener.class!",
                   javax.swing.event.AncestorListener.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PainterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PainterTests}.
 * </p>
 *
 * @see javax.swing.Painter interface javax.swing.Painter (the hereby targeted class-under-test class)
 * @see PainterTests PainterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.Painter.class!",
                   javax.swing.Painter.class.isAssignableFrom(sut));
    }

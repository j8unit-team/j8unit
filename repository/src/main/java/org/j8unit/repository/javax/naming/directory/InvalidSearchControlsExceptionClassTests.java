 ...
 * javax.naming.directory.InvalidSearchControlsException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidSearchControlsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidSearchControlsExceptionTests InvalidSearchControlsExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.InvalidSearchControlsException.class!",
                   javax.naming.directory.InvalidSearchControlsException.class.isAssignableFrom(sut));
    }

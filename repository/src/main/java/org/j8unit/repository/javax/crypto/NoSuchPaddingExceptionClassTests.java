...
public abstract interface NoSuchPaddingExceptionClassTests<SUT extends NoSuchPaddingException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchPaddingException.class!",

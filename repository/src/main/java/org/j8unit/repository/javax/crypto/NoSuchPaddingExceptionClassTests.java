 ...
 * javax.crypto.NoSuchPaddingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchPaddingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link NoSuchPaddingExceptionTests}.
 * </p>
 *
 * @see javax.crypto.NoSuchPaddingException class javax.crypto.NoSuchPaddingException (the hereby targeted
 *      class-under-test class)
 * @see NoSuchPaddingExceptionTests NoSuchPaddingExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.NoSuchPaddingException.class!",
                   javax.crypto.NoSuchPaddingException.class.isAssignableFrom(sut));
    }

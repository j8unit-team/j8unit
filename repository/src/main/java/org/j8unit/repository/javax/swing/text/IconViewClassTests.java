 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IconView public
...
public abstract interface IconViewClassTests<SUT extends IconView>
extends ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IconView.class!",
                   IconView.class.isAssignableFrom(sut));
    }

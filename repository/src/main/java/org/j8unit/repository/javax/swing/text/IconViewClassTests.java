 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IconViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IconViewTests}.
 * </p>
 *
 * @see javax.swing.text.IconView class javax.swing.text.IconView (the hereby targeted class-under-test class)
 * @see IconViewTests IconViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.IconView.class!",
                   javax.swing.text.IconView.class.isAssignableFrom(sut));
    }

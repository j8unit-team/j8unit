...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.imageio.event.IIOWriteProgressListener interface
 * javax.imageio.event.IIOWriteProgressListener}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOWriteProgressListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see IIOWriteProgressListenerTests IIOWriteProgressListenerTests (The complementary j8unit test interface containing
...
public abstract interface IIOWriteProgressListenerClassTests<SUT extends javax.imageio.event.IIOWriteProgressListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.event.IIOWriteProgressListener.class!",
                   javax.imageio.event.IIOWriteProgressListener.class.isAssignableFrom(sut));
    }

 ...
 * {@link IIOWriteProgressListener public abstract interface javax.imageio.event.IIOWriteProgressListener}.
 *
...
public abstract interface IIOWriteProgressListenerClassTests<SUT extends IIOWriteProgressListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOWriteProgressListener.class!",
                   IIOWriteProgressListener.class.isAssignableFrom(sut));
    }

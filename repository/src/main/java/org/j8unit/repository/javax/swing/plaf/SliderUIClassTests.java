 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SliderUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SliderUITests}.
 * </p>
 *
 * @see javax.swing.plaf.SliderUI class javax.swing.plaf.SliderUI (the hereby targeted class-under-test class)
 * @see SliderUITests SliderUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SliderUIClassTests<SUT extends javax.swing.plaf.SliderUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.SliderUI.class!",
                   javax.swing.plaf.SliderUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SliderUI public
...
public abstract interface SliderUIClassTests<SUT extends SliderUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SliderUI.class!",
                   SliderUI.class.isAssignableFrom(sut));
    }

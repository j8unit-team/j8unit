 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlElement public
 * abstract @interface javax.xml.bind.annotation.XmlElement}.
 *
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlElement.class!",
                   XmlElement.class.isAssignableFrom(sut));
    }
     ...
     * {@link DEFAULT public static final class javax.xml.bind.annotation.XmlElement$DEFAULT}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

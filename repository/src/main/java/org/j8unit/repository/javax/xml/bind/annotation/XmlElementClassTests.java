 ...
 * javax.xml.bind.annotation.XmlElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlElementTests}).
 * </p>
 *
 * <p>
 ...
 * @see XmlElementTests XmlElementTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlElement.class!",
                   javax.xml.bind.annotation.XmlElement.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlElement.DEFAULT class
     * javax.xml.bind.annotation.XmlElement$DEFAULT}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link XmlElementTests.DEFAULTTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see XmlElementTests.DEFAULTTests XmlElementTests.DEFAULTTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlElement.DEFAULT.class!",
                       javax.xml.bind.annotation.XmlElement.DEFAULT.class.isAssignableFrom(sut));
        }

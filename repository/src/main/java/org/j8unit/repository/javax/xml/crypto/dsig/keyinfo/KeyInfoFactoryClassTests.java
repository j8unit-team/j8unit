 ...
 * javax.xml.crypto.dsig.keyinfo.KeyInfoFactory}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyInfoFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyInfoFactoryTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.KeyInfoFactory class javax.xml.crypto.dsig.keyinfo.KeyInfoFactory (the hereby
 *      targeted class-under-test class)
 * @see KeyInfoFactoryTests KeyInfoFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface KeyInfoFactoryClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.KeyInfoFactory>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.KeyInfoFactory.class!",
                   javax.xml.crypto.dsig.keyinfo.KeyInfoFactory.class.isAssignableFrom(sut));
    }

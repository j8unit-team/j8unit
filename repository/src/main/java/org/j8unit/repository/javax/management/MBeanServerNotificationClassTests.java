 ...
 * javax.management.MBeanServerNotification}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanServerNotificationTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link MBeanServerNotificationTests}.
 * </p>
 *
 * @see javax.management.MBeanServerNotification class javax.management.MBeanServerNotification (the hereby targeted
 *      class-under-test class)
 * @see MBeanServerNotificationTests MBeanServerNotificationTests (The complementary j8unit test interface containing
...
extends NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanServerNotification.class!",
                   javax.management.MBeanServerNotification.class.isAssignableFrom(sut));
    }

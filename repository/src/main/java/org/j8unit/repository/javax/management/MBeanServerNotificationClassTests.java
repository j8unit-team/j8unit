 ...
 * {@link MBeanServerNotification public class javax.management.MBeanServerNotification}.
 *
...
public abstract interface MBeanServerNotificationClassTests<SUT extends MBeanServerNotification>
extends NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerNotification.class!",
                   MBeanServerNotification.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiDesktopIconUI
 * public class javax.swing.plaf.multi.MultiDesktopIconUI}.
 *
...
public abstract interface MultiDesktopIconUIClassTests<SUT extends MultiDesktopIconUI>
extends DesktopIconUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiDesktopIconUI.class!",
                   MultiDesktopIconUI.class.isAssignableFrom(sut));
    }

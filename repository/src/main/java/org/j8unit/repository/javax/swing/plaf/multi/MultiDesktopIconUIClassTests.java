 ...
 * javax.swing.plaf.multi.MultiDesktopIconUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiDesktopIconUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiDesktopIconUITests}.
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiDesktopIconUI class javax.swing.plaf.multi.MultiDesktopIconUI (the hereby targeted
 *      class-under-test class)
 * @see MultiDesktopIconUITests MultiDesktopIconUITests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.swing.plaf.DesktopIconUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiDesktopIconUI.class!",
                   javax.swing.plaf.multi.MultiDesktopIconUI.class.isAssignableFrom(sut));
    }

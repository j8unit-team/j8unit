 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPHeader public
 * abstract interface javax.xml.soap.SOAPHeader}.
 *
...
public abstract interface SOAPHeaderClassTests<SUT extends SOAPHeader>
extends org.j8unit.repository.javax.xml.soap.SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPHeader.class!",
                   SOAPHeader.class.isAssignableFrom(sut));
    }

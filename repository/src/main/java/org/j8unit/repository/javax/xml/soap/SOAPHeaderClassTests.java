 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPHeaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPHeaderTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPHeader interface javax.xml.soap.SOAPHeader (the hereby targeted class-under-test class)
 * @see SOAPHeaderTests SOAPHeaderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SOAPHeaderClassTests<SUT extends javax.xml.soap.SOAPHeader>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPHeader.class!",
                   javax.xml.soap.SOAPHeader.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.table.DefaultTableModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultTableModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultTableModelTests}.
 * </p>
 *
 * @see javax.swing.table.DefaultTableModel class javax.swing.table.DefaultTableModel (the hereby targeted
 *      class-under-test class)
 * @see DefaultTableModelTests DefaultTableModelTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractTableModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.table.DefaultTableModel.class!",
                   javax.swing.table.DefaultTableModel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultTableModel
 * public class javax.swing.table.DefaultTableModel}.
 *
...
public abstract interface DefaultTableModelClassTests<SUT extends DefaultTableModel>
extends AbstractTableModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultTableModel.class!",
                   DefaultTableModel.class.isAssignableFrom(sut));
    }

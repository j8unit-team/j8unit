 ...
 * javax.lang.model.element.TypeElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeElementTests}).
 * </p>
 *
 * <p>
 ...
 * @see TypeElementTests TypeElementTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ElementClassTests<SUT>, ParameterizableClassTests<SUT>, QualifiedNameableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.element.TypeElement.class!",
                   javax.lang.model.element.TypeElement.class.isAssignableFrom(sut));
    }

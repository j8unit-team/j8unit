 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeElement public
 * abstract interface javax.lang.model.element.TypeElement}.
 *
...
extends ParameterizableClassTests<SUT>, QualifiedNameableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeElement.class!",

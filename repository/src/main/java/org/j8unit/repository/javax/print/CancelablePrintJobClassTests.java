 ...
 * javax.print.CancelablePrintJob}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CancelablePrintJobTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.print.CancelablePrintJob interface javax.print.CancelablePrintJob (the hereby targeted class-under-test
 *      class)
 * @see CancelablePrintJobTests CancelablePrintJobTests (The complementary j8unit test interface containing the instance
...
public abstract interface CancelablePrintJobClassTests<SUT extends javax.print.CancelablePrintJob>
extends DocPrintJobClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.CancelablePrintJob.class!",
                   javax.print.CancelablePrintJob.class.isAssignableFrom(sut));
    }

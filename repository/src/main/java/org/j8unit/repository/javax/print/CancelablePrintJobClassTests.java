 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CancelablePrintJob
 * public abstract interface javax.print.CancelablePrintJob}.
 *
...
extends org.j8unit.repository.javax.print.DocPrintJobClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CancelablePrintJob.class!",

...
public abstract interface InterruptedNamingExceptionClassTests<SUT extends InterruptedNamingException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InterruptedNamingException.class!",
                   InterruptedNamingException.class.isAssignableFrom(sut));
    }

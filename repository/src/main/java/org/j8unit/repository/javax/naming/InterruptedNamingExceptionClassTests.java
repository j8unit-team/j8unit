 ...
 * javax.naming.InterruptedNamingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link InterruptedNamingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InterruptedNamingExceptionTests InterruptedNamingExceptionTests (The complementary j8unit test interface
...
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.InterruptedNamingException.class!",
                   javax.naming.InterruptedNamingException.class.isAssignableFrom(sut));
    }

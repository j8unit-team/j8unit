 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Instrument public
 * abstract class javax.sound.midi.Instrument}.
 *
...
extends SoundbankResourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Instrument.class!",
                   Instrument.class.isAssignableFrom(sut));
    }

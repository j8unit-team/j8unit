 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InstrumentTests}).
 * </p>
 *
 * <p>
 ...
 * @see InstrumentTests InstrumentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InstrumentClassTests<SUT extends javax.sound.midi.Instrument>
extends SoundbankResourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Instrument.class!",
                   javax.sound.midi.Instrument.class.isAssignableFrom(sut));
    }

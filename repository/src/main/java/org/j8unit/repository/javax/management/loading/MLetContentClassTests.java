 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MLetContent public
...
public abstract interface MLetContentClassTests<SUT extends MLetContent>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MLetContent.class!",
                   MLetContent.class.isAssignableFrom(sut));
    }

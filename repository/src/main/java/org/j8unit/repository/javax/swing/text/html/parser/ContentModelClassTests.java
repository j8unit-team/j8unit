 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ContentModel public
 * final class javax.swing.text.html.parser.ContentModel}.
 *
...
public abstract interface ContentModelClassTests<SUT extends ContentModel>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContentModel.class!",
                   ContentModel.class.isAssignableFrom(sut));
    }

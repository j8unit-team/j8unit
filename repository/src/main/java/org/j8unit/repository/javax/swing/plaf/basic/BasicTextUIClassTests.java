 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicTextUI public
 * abstract class javax.swing.plaf.basic.BasicTextUI}.
 *
...
extends org.j8unit.repository.javax.swing.text.ViewFactoryClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.TextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicTextUI.class!",
                   BasicTextUI.class.isAssignableFrom(sut));
    }
     ...
     * {@link BasicCaret public static class javax.swing.plaf.basic.BasicTextUI$BasicCaret}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends org.j8unit.repository.javax.swing.plaf.UIResourceClassTests<SUT>, org.j8unit.repository.javax.swing.text.DefaultCaretClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicCaret.class!",
                              BasicCaret.class.isAssignableFrom(sut));
        }
    ...
    extends org.j8unit.repository.javax.swing.plaf.UIResourceClassTests<SUT>, org.j8unit.repository.javax.swing.text.DefaultHighlighterClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicHighlighter.class!",
                              BasicHighlighter.class.isAssignableFrom(sut));
        }

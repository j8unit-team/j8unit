 ...
 * javax.swing.plaf.basic.BasicTextUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicTextUITests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicTextUITests BasicTextUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.text.ViewFactoryClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.TextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTextUI.class!",
                   javax.swing.plaf.basic.BasicTextUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicTextUI.BasicHighlighter class
     * javax.swing.plaf.basic.BasicTextUI$BasicHighlighter}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link BasicTextUITests.BasicHighlighterTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicTextUITests.BasicHighlighterTests BasicTextUITests.BasicHighlighterTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.javax.swing.plaf.UIResourceClassTests<SUT>, org.j8unit.repository.javax.swing.text.DefaultHighlighterClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTextUI.BasicHighlighter.class!",
                       javax.swing.plaf.basic.BasicTextUI.BasicHighlighter.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.plaf.basic.BasicTextUI$BasicCaret}, containing all type relevant aspects (e.&thinsp;g., runtime
     * constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link BasicTextUITests.BasicCaretTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicTextUITests.BasicCaretTests BasicTextUITests.BasicCaretTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.javax.swing.plaf.UIResourceClassTests<SUT>, org.j8unit.repository.javax.swing.text.DefaultCaretClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicTextUI.BasicCaret.class!",
                       javax.swing.plaf.basic.BasicTextUI.BasicCaret.class.isAssignableFrom(sut));
        }

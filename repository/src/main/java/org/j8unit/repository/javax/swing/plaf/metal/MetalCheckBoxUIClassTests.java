 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalCheckBoxUI
 * public class javax.swing.plaf.metal.MetalCheckBoxUI}.
 *
...
public abstract interface MetalCheckBoxUIClassTests<SUT extends MetalCheckBoxUI>
extends org.j8unit.repository.javax.swing.plaf.metal.MetalRadioButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalCheckBoxUI.class!",
                   MetalCheckBoxUI.class.isAssignableFrom(sut));
    }

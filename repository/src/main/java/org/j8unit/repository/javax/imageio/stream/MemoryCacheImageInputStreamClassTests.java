 ...
 * javax.imageio.stream.MemoryCacheImageInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link MemoryCacheImageInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.imageio.stream.MemoryCacheImageInputStream class javax.imageio.stream.MemoryCacheImageInputStream (the
 *      hereby targeted class-under-test class)
 * @see MemoryCacheImageInputStreamTests MemoryCacheImageInputStreamTests (The complementary j8unit test interface
...
public abstract interface MemoryCacheImageInputStreamClassTests<SUT extends javax.imageio.stream.MemoryCacheImageInputStream>
extends ImageInputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.MemoryCacheImageInputStream.class!",
                   javax.imageio.stream.MemoryCacheImageInputStream.class.isAssignableFrom(sut));
    }

...
public abstract interface MemoryCacheImageInputStreamClassTests<SUT extends MemoryCacheImageInputStream>
extends org.j8unit.repository.javax.imageio.stream.ImageInputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryCacheImageInputStream.class!",
                   MemoryCacheImageInputStream.class.isAssignableFrom(sut));
    }

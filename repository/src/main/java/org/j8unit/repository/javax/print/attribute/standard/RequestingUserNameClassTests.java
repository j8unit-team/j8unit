 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RequestingUserName
 * public final class javax.print.attribute.standard.RequestingUserName}.
 *
...
public abstract interface RequestingUserNameClassTests<SUT extends RequestingUserName>
extends PrintRequestAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RequestingUserName.class!",
                   RequestingUserName.class.isAssignableFrom(sut));
    }

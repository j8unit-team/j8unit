...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.RequestingUserName class
 * javax.print.attribute.standard.RequestingUserName}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RequestingUserNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RequestingUserNameTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.RequestingUserName class javax.print.attribute.standard.RequestingUserName (the
 *      hereby targeted class-under-test class)
 * @see RequestingUserNameTests RequestingUserNameTests (The complementary j8unit test interface containing the instance
...
public abstract interface RequestingUserNameClassTests<SUT extends javax.print.attribute.standard.RequestingUserName>
...
org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.RequestingUserName.class!",
                   javax.print.attribute.standard.RequestingUserName.class.isAssignableFrom(sut));
    }

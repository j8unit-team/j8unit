 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiTreeUI public
...
public abstract interface MultiTreeUIClassTests<SUT extends MultiTreeUI>
extends TreeUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiTreeUI.class!",

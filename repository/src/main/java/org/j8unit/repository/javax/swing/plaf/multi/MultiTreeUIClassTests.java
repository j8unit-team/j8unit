 ...
 * javax.swing.plaf.multi.MultiTreeUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiTreeUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiTreeUITests}.
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiTreeUI class javax.swing.plaf.multi.MultiTreeUI (the hereby targeted
 *      class-under-test class)
 * @see MultiTreeUITests MultiTreeUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.TreeUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiTreeUI.class!",
                   javax.swing.plaf.multi.MultiTreeUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SealedObject public
...
public abstract interface SealedObjectClassTests<SUT extends SealedObject>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.crypto.SealedObject]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SealedObject.class!",
                   SealedObject.class.isAssignableFrom(sut));
    }

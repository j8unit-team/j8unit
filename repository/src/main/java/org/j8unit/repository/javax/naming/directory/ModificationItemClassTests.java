 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ModificationItem
 * public class javax.naming.directory.ModificationItem}.
 *
...
public abstract interface ModificationItemClassTests<SUT extends ModificationItem>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ModificationItem.class!",
                   ModificationItem.class.isAssignableFrom(sut));
    }

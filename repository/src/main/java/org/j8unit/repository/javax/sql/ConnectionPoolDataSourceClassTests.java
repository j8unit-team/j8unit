 ...
 * {@link ConnectionPoolDataSource public abstract interface javax.sql.ConnectionPoolDataSource}.
 *
...
public abstract interface ConnectionPoolDataSourceClassTests<SUT extends ConnectionPoolDataSource>
extends CommonDataSourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConnectionPoolDataSource.class!",
                   ConnectionPoolDataSource.class.isAssignableFrom(sut));
    }

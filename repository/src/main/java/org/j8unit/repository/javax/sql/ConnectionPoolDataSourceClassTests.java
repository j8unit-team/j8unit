 ...
 * javax.sql.ConnectionPoolDataSource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConnectionPoolDataSourceTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ConnectionPoolDataSourceTests}.
 * </p>
 *
 * @see javax.sql.ConnectionPoolDataSource interface javax.sql.ConnectionPoolDataSource (the hereby targeted
 *      class-under-test class)
 * @see ConnectionPoolDataSourceTests ConnectionPoolDataSourceTests (The complementary j8unit test interface containing
...
public abstract interface ConnectionPoolDataSourceClassTests<SUT extends javax.sql.ConnectionPoolDataSource>
extends CommonDataSourceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.ConnectionPoolDataSource.class!",
                   javax.sql.ConnectionPoolDataSource.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.xml.transform.SourceClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StreamSource public
...
public abstract interface StreamSourceClassTests<SUT extends StreamSource>
extends SourceClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamSource.class!",
                   StreamSource.class.isAssignableFrom(sut));
    }

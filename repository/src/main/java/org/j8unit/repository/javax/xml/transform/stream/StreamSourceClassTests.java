...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.stream.StreamSource class
 * javax.xml.transform.stream.StreamSource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamSourceTests}.
 * </p>
 *
 * @see javax.xml.transform.stream.StreamSource class javax.xml.transform.stream.StreamSource (the hereby targeted
 *      class-under-test class)
 * @see StreamSourceTests StreamSourceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.transform.SourceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.stream.StreamSource.class!",
                   javax.xml.transform.stream.StreamSource.class.isAssignableFrom(sut));
    }

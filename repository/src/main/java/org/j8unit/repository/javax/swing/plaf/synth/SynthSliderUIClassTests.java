 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthSliderUI
...
public abstract interface SynthSliderUIClassTests<SUT extends SynthSliderUI>
...
org.j8unit.repository.javax.swing.plaf.basic.BasicSliderUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthSliderUI.class!",
                   SynthSliderUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthSliderUI]

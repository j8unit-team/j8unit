 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NavigationFilter
 * public class javax.swing.text.NavigationFilter}.
 *
...
public abstract interface NavigationFilterClassTests<SUT extends NavigationFilter>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NavigationFilter.class!",
                   NavigationFilter.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.text.NavigationFilter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NavigationFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NavigationFilterTests}.
 * </p>
 *
 * @see javax.swing.text.NavigationFilter class javax.swing.text.NavigationFilter (the hereby targeted class-under-test
 *      class)
 * @see NavigationFilterTests NavigationFilterTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.NavigationFilter.class!",
                   javax.swing.text.NavigationFilter.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.NavigationFilter.FilterBypass class
     * javax.swing.text.NavigationFilter$FilterBypass}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link NavigationFilterTests.FilterBypassTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see NavigationFilterTests.FilterBypassTests NavigationFilterTests.FilterBypassTests (The complementary j8unit
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.NavigationFilter.FilterBypass.class!",
                       javax.swing.text.NavigationFilter.FilterBypass.class.isAssignableFrom(sut));
        }

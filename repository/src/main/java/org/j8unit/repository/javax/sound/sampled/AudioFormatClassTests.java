 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AudioFormatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AudioFormatTests}.
 * </p>
 *
 * @see javax.sound.sampled.AudioFormat class javax.sound.sampled.AudioFormat (the hereby targeted class-under-test
 *      class)
 * @see AudioFormatTests AudioFormatTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.AudioFormat.class!",
                   javax.sound.sampled.AudioFormat.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.AudioFormat.Encoding class
     * javax.sound.sampled.AudioFormat$Encoding}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link AudioFormatTests.EncodingTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.sound.sampled.AudioFormat.Encoding class javax.sound.sampled.AudioFormat$Encoding (the hereby targeted
     *      class-under-test class)
     * @see AudioFormatTests.EncodingTests AudioFormatTests.EncodingTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.AudioFormat.Encoding.class!",
                       javax.sound.sampled.AudioFormat.Encoding.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AudioFormat public
...
public abstract interface AudioFormatClassTests<SUT extends AudioFormat>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AudioFormat.class!",
     ...
     * {@link Encoding public static class javax.sound.sampled.AudioFormat$Encoding}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface EncodingClassTests<SUT extends Encoding>
    extends ObjectClassTests<SUT> {

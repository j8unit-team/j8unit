 ...
 * javax.script.ScriptEngineManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScriptEngineManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScriptEngineManagerTests}.
 * </p>
 *
 * @see javax.script.ScriptEngineManager class javax.script.ScriptEngineManager (the hereby targeted class-under-test
 *      class)
 * @see ScriptEngineManagerTests ScriptEngineManagerTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.ScriptEngineManager.class!",
                   javax.script.ScriptEngineManager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScriptEngineManager
 * public class javax.script.ScriptEngineManager}.
 *
...
public abstract interface ScriptEngineManagerClassTests<SUT extends ScriptEngineManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScriptEngineManager.class!",
                   ScriptEngineManager.class.isAssignableFrom(sut));
    }

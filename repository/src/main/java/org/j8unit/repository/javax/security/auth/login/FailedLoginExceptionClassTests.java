 ...
 * javax.security.auth.login.FailedLoginException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FailedLoginExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FailedLoginExceptionTests}
 * .
 * </p>
 *
 * @see javax.security.auth.login.FailedLoginException class javax.security.auth.login.FailedLoginException (the hereby
 *      targeted class-under-test class)
 * @see FailedLoginExceptionTests FailedLoginExceptionTests (The complementary j8unit test interface containing the
...
extends LoginExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.login.FailedLoginException.class!",
                   javax.security.auth.login.FailedLoginException.class.isAssignableFrom(sut));
    }

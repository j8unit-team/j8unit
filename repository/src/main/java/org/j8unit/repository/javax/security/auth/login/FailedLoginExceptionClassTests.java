...
public abstract interface FailedLoginExceptionClassTests<SUT extends FailedLoginException>
extends LoginExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FailedLoginException.class!",
                   FailedLoginException.class.isAssignableFrom(sut));
    }

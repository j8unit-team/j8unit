 ...
 * javax.print.attribute.DocAttributeSet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocAttributeSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocAttributeSetTests}.
 * </p>
 *
 * @see javax.print.attribute.DocAttributeSet interface javax.print.attribute.DocAttributeSet (the hereby targeted
 *      class-under-test class)
 * @see DocAttributeSetTests DocAttributeSetTests (The complementary j8unit test interface containing the instance
...
public abstract interface DocAttributeSetClassTests<SUT extends javax.print.attribute.DocAttributeSet>
extends AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.DocAttributeSet.class!",
                   javax.print.attribute.DocAttributeSet.class.isAssignableFrom(sut));
    }

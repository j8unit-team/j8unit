 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocAttributeSet
...
public abstract interface DocAttributeSetClassTests<SUT extends DocAttributeSet>
extends AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocAttributeSet.class!",
                   DocAttributeSet.class.isAssignableFrom(sut));
    }

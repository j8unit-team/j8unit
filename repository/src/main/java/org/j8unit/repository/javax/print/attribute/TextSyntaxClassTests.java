...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.TextSyntax class
 * javax.print.attribute.TextSyntax}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextSyntaxTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextSyntaxTests}.
 * </p>
 *
 * @see javax.print.attribute.TextSyntax class javax.print.attribute.TextSyntax (the hereby targeted class-under-test
 *      class)
 * @see TextSyntaxTests TextSyntaxTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TextSyntaxClassTests<SUT extends javax.print.attribute.TextSyntax>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.TextSyntax.class!",
                   javax.print.attribute.TextSyntax.class.isAssignableFrom(sut));
    }

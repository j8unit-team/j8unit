 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextSyntax public
 * abstract class javax.print.attribute.TextSyntax}.
 *
...
public abstract interface TextSyntaxClassTests<SUT extends TextSyntax>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextSyntax.class!",
                   TextSyntax.class.isAssignableFrom(sut));
    }

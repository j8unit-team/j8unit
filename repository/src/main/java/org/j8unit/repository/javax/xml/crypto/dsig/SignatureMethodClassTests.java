...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.SignatureMethod interface
 * javax.xml.crypto.dsig.SignatureMethod}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignatureMethodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignatureMethodTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.SignatureMethod interface javax.xml.crypto.dsig.SignatureMethod (the hereby targeted
 *      class-under-test class)
 * @see SignatureMethodTests SignatureMethodTests (The complementary j8unit test interface containing the instance
...
public abstract interface SignatureMethodClassTests<SUT extends javax.xml.crypto.dsig.SignatureMethod>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT>, org.j8unit.repository.javax.xml.crypto.AlgorithmMethodClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.SignatureMethod.class!",
                   javax.xml.crypto.dsig.SignatureMethod.class.isAssignableFrom(sut));
    }

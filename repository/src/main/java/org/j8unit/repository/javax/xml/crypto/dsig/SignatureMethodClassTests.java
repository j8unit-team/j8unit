 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SignatureMethod
 * public abstract interface javax.xml.crypto.dsig.SignatureMethod}.
 *
...
public abstract interface SignatureMethodClassTests<SUT extends SignatureMethod>
extends XMLStructureClassTests<SUT>, AlgorithmMethodClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignatureMethod.class!",
                   SignatureMethod.class.isAssignableFrom(sut));
    }

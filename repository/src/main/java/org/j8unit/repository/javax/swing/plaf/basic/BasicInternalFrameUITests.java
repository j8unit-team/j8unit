...
import org.j8unit.repository.javax.swing.plaf.basic.BasicInternalFrameUIClassTests.InternalFrameLayoutClassTests;
import org.j8unit.repository.javax.swing.plaf.basic.BasicInternalFrameUIClassTests.InternalFramePropertyChangeListenerClassTests;
 ...
 * {@link BasicInternalFrameUIClassTests}).
 * </p>
 *
 * @param SUT
...
extends InternalFrameUITests<SUT> {
     ...
     * (see {@link InternalFramePropertyChangeListenerClassTests}).
     * </p>
     *
     * @param SUT
     *            the type of the subject-under-test
     ...
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects
     * (see {@link InternalFrameLayoutClassTests}).
     * </p>
     *
     * @param SUT
     *            the type of the subject-under-test

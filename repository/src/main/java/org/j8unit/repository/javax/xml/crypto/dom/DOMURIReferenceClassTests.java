...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dom.DOMURIReference interface
 * javax.xml.crypto.dom.DOMURIReference}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMURIReferenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DOMURIReferenceTests}.
 * </p>
 *
 * @see javax.xml.crypto.dom.DOMURIReference interface javax.xml.crypto.dom.DOMURIReference (the hereby targeted
 *      class-under-test class)
 * @see DOMURIReferenceTests DOMURIReferenceTests (The complementary j8unit test interface containing the instance
...
public abstract interface DOMURIReferenceClassTests<SUT extends javax.xml.crypto.dom.DOMURIReference>
extends org.j8unit.repository.javax.xml.crypto.URIReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dom.DOMURIReference.class!",
                   javax.xml.crypto.dom.DOMURIReference.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.xml.crypto.URIReferenceClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMURIReference
...
public abstract interface DOMURIReferenceClassTests<SUT extends DOMURIReference>
extends URIReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMURIReference.class!",
                   DOMURIReference.class.isAssignableFrom(sut));
    }

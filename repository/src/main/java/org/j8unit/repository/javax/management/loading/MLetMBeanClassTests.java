 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MLetMBean public
 * abstract interface javax.management.loading.MLetMBean}.
 *
...
public abstract interface MLetMBeanClassTests<SUT extends MLetMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MLetMBean.class!",
                   MLetMBean.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXB public final
...
public abstract interface JAXBClassTests<SUT extends JAXB>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXB.class!", JAXB.class.isAssignableFrom(sut));
    }

...
public abstract interface XPathFilterParameterSpecClassTests<SUT extends XPathFilterParameterSpec>
extends org.j8unit.repository.javax.xml.crypto.dsig.spec.TransformParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathFilterParameterSpec.class!",
                   XPathFilterParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.transform.stream.StreamResult}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamResultTests}.
 * </p>
 *
 * @see javax.xml.transform.stream.StreamResult class javax.xml.transform.stream.StreamResult (the hereby targeted
 *      class-under-test class)
 * @see StreamResultTests StreamResultTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.transform.ResultClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.stream.StreamResult.class!",
                   javax.xml.transform.stream.StreamResult.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.xml.transform.ResultClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StreamResult public
...
public abstract interface StreamResultClassTests<SUT extends StreamResult>
extends ResultClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.transform.stream.StreamResult]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamResult.class!",
                   StreamResult.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain javax.smartcardio.CommandAPDU class javax.smartcardio.CommandAPDU},
 * containing all class relevant test methods (at least the test methods of accessible constructors and of accessible
 * {@code static} methods). The counterpart J8Unit test interface containing the instance relevant test methods is
 * {@link org.j8unit.repository.javax.smartcardio.CommandAPDUTests}.
 * </p>
 *
 * <p>
 ...
 * @since 0.9.0
 *
 * @j8unit.aim javax.smartcardio.CommandAPDU
 */
@FunctionalInterface
@Category(J8UnitRepository.class)
public abstract interface CommandAPDUClassTests<SUT extends javax.smartcardio.CommandAPDU>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(byte[])
     */
    ...
    /**
     * <p>
     * Test method for {@link javax.smartcardio.CommandAPDU#CommandAPDU(byte[], int, int) public
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(byte[], int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_CommandAPDU_byteArray_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    /**
     * <p>
     * Test method for {@link javax.smartcardio.CommandAPDU#CommandAPDU(java.nio.ByteBuffer) public
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(java.nio.ByteBuffer)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_CommandAPDU_ByteBuffer()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.smartcardio.CommandAPDU sut = null; // = new CommandAPDU(java.nio.ByteBuffer);
    }

    /**
     * <p>
     * Test method for {@link javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int) public
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_CommandAPDU_int_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int, byte[])
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int, byte[], int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int, byte[], int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    /**
     * <p>
     * Test method for {@link javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int, byte[], int, int, int)
     * public javax.smartcardio.CommandAPDU(int,int,int,int,byte[],int,int,int)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int, byte[], int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#CommandAPDU(int, int, int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim javax.smartcardio.CommandAPDU#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CommandAPDU public
 * final class javax.smartcardio.CommandAPDU}.
 *
...
public abstract interface CommandAPDUClassTests<SUT extends CommandAPDU>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CommandAPDU.class!",
                   CommandAPDU.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicSeparatorUI
 * public class javax.swing.plaf.basic.BasicSeparatorUI}.
 *
...
extends SeparatorUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicSeparatorUI.class!",
                   BasicSeparatorUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.plaf.basic.BasicSeparatorUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicSeparatorUITests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicSeparatorUITests BasicSeparatorUITests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.swing.plaf.SeparatorUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicSeparatorUI.class!",
                   javax.swing.plaf.basic.BasicSeparatorUI.class.isAssignableFrom(sut));
    }

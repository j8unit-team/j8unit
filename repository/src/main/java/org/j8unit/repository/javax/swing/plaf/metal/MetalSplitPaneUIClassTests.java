 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalSplitPaneUI
 * public class javax.swing.plaf.metal.MetalSplitPaneUI}.
 *
...
public abstract interface MetalSplitPaneUIClassTests<SUT extends MetalSplitPaneUI>
extends BasicSplitPaneUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.metal.MetalSplitPaneUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalSplitPaneUI.class!",
                   MetalSplitPaneUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.metal.MetalSplitPaneUI]

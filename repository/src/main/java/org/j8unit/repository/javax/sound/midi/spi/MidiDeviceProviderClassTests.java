 ...
 * javax.sound.midi.spi.MidiDeviceProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MidiDeviceProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MidiDeviceProviderTests}.
 * </p>
 *
 * @see javax.sound.midi.spi.MidiDeviceProvider class javax.sound.midi.spi.MidiDeviceProvider (the hereby targeted
 *      class-under-test class)
 * @see MidiDeviceProviderTests MidiDeviceProviderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.spi.MidiDeviceProvider.class!",
                   javax.sound.midi.spi.MidiDeviceProvider.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiDeviceProvider
 * public abstract class javax.sound.midi.spi.MidiDeviceProvider}.
 *
...
public abstract interface MidiDeviceProviderClassTests<SUT extends MidiDeviceProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiDeviceProvider.class!",

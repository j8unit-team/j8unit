 ...
 * javax.print.attribute.standard.NumberUp}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NumberUpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NumberUpTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.NumberUp class javax.print.attribute.standard.NumberUp (the hereby targeted
 *      class-under-test class)
 * @see NumberUpTests NumberUpTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.NumberUp.class!",
                   javax.print.attribute.standard.NumberUp.class.isAssignableFrom(sut));
    }

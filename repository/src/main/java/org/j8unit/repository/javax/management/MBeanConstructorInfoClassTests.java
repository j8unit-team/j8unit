 ...
 * javax.management.MBeanConstructorInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanConstructorInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanConstructorInfoTests}
 * .
 * </p>
 *
 * @see javax.management.MBeanConstructorInfo class javax.management.MBeanConstructorInfo (the hereby targeted
 *      class-under-test class)
 * @see MBeanConstructorInfoTests MBeanConstructorInfoTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanConstructorInfo.class!",
                   javax.management.MBeanConstructorInfo.class.isAssignableFrom(sut));
    }

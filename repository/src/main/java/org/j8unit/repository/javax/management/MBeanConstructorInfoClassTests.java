 ...
 * {@link MBeanConstructorInfoTests}.
 * </p>
 *
 * <p>
...
public abstract interface MBeanConstructorInfoClassTests<SUT extends MBeanConstructorInfo>
extends CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanConstructorInfo.class!",
                   MBeanConstructorInfo.class.isAssignableFrom(sut));
    }

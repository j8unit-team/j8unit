 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterLocation
...
public abstract interface PrinterLocationClassTests<SUT extends PrinterLocation>
extends PrintServiceAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterLocation.class!",
                   PrinterLocation.class.isAssignableFrom(sut));
    }

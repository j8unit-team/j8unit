 ...
 * javax.print.attribute.standard.PrinterLocation}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterLocationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterLocationTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PrinterLocation class javax.print.attribute.standard.PrinterLocation (the hereby
 *      targeted class-under-test class)
 * @see PrinterLocationTests PrinterLocationTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterLocation.class!",
                   javax.print.attribute.standard.PrinterLocation.class.isAssignableFrom(sut));
    }

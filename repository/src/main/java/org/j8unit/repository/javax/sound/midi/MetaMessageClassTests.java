 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetaMessageTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MetaMessageTests}.
 * </p>
 *
 * @see javax.sound.midi.MetaMessage class javax.sound.midi.MetaMessage (the hereby targeted class-under-test class)
 * @see MetaMessageTests MetaMessageTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MetaMessageClassTests<SUT extends javax.sound.midi.MetaMessage>
extends MidiMessageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.MetaMessage.class!",
                   javax.sound.midi.MetaMessage.class.isAssignableFrom(sut));
    }

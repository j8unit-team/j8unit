 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetaMessage public
...
public abstract interface MetaMessageClassTests<SUT extends MetaMessage>
extends MidiMessageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetaMessage.class!",
                   MetaMessage.class.isAssignableFrom(sut));
    }

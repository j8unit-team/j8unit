...
extends org.j8unit.repository.javax.sound.midi.MidiMessageClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim javax.sound.midi.MetaMessage#MetaMessage()
     */
     ...
     * </p>
     *
     * @j8unit.aim javax.sound.midi.MetaMessage#MetaMessage(int, byte[], int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_MetaMessage_int_byteArray_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * @since 0.9.2
     *
     * @j8unit.aim javax.sound.midi.MetaMessage#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

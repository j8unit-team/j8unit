 ...
 * javax.swing.undo.CannotUndoException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CannotUndoExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CannotUndoExceptionTests}.
 * </p>
 *
 * @see javax.swing.undo.CannotUndoException class javax.swing.undo.CannotUndoException (the hereby targeted
 *      class-under-test class)
 * @see CannotUndoExceptionTests CannotUndoExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.undo.CannotUndoException.class!",
                   javax.swing.undo.CannotUndoException.class.isAssignableFrom(sut));
    }

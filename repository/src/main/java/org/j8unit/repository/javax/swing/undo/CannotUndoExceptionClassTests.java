 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CannotUndoException
 * public class javax.swing.undo.CannotUndoException}.
 *
...
public abstract interface CannotUndoExceptionClassTests<SUT extends CannotUndoException>
extends RuntimeExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.undo.CannotUndoException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CannotUndoException.class!",
                   CannotUndoException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.undo.CannotUndoException]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.undo.CannotUndoException]

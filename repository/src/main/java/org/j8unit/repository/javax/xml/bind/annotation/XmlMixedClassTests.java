...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlMixed interface
 * javax.xml.bind.annotation.XmlMixed}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlMixedTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlMixed interface javax.xml.bind.annotation.XmlMixed (the hereby targeted
 *      class-under-test class)
 * @see XmlMixedTests XmlMixedTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlMixedClassTests<SUT extends javax.xml.bind.annotation.XmlMixed>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlMixed.class!",
                   javax.xml.bind.annotation.XmlMixed.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiListUI public
...
public abstract interface MultiListUIClassTests<SUT extends MultiListUI>
extends ListUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiListUI.class!",
                   MultiListUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.plaf.multi.MultiListUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiListUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiListUITests}.
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiListUI class javax.swing.plaf.multi.MultiListUI (the hereby targeted
 *      class-under-test class)
 * @see MultiListUITests MultiListUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.ListUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiListUI.class!",
                   javax.swing.plaf.multi.MultiListUI.class.isAssignableFrom(sut));
    }

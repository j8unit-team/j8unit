 ...
 * javax.swing.event.TreeSelectionEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeSelectionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeSelectionEventTests}.
 * </p>
 *
 * @see javax.swing.event.TreeSelectionEvent class javax.swing.event.TreeSelectionEvent (the hereby targeted
 *      class-under-test class)
 * @see TreeSelectionEventTests TreeSelectionEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TreeSelectionEvent.class!",
                   javax.swing.event.TreeSelectionEvent.class.isAssignableFrom(sut));
    }

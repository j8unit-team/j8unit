 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeSelectionEvent
 * public class javax.swing.event.TreeSelectionEvent}.
 *
...
public abstract interface TreeSelectionEventClassTests<SUT extends TreeSelectionEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeSelectionEvent.class!",
                   TreeSelectionEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompiledScript
 * public abstract class javax.script.CompiledScript}.
 *
...
public abstract interface CompiledScriptClassTests<SUT extends CompiledScript>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompiledScript.class!",
                   CompiledScript.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RC2ParameterSpec
...
public abstract interface RC2ParameterSpecClassTests<SUT extends RC2ParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RC2ParameterSpec.class!",
                   RC2ParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * javax.crypto.spec.RC2ParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RC2ParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RC2ParameterSpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.RC2ParameterSpec class javax.crypto.spec.RC2ParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see RC2ParameterSpecTests RC2ParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.RC2ParameterSpec.class!",
                   javax.crypto.spec.RC2ParameterSpec.class.isAssignableFrom(sut));
    }

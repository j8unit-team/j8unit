 ...
 * javax.net.ssl.TrustManagerFactorySpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TrustManagerFactorySpiTests}).
 * </p>
 *
 * <p>
 ...
 * {@link TrustManagerFactorySpiTests}.
 * </p>
 *
 * @see javax.net.ssl.TrustManagerFactorySpi class javax.net.ssl.TrustManagerFactorySpi (the hereby targeted
 *      class-under-test class)
 * @see TrustManagerFactorySpiTests TrustManagerFactorySpiTests (The complementary j8unit test interface containing the
...
public abstract interface TrustManagerFactorySpiClassTests<SUT extends javax.net.ssl.TrustManagerFactorySpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.TrustManagerFactorySpi.class!",
                   javax.net.ssl.TrustManagerFactorySpi.class.isAssignableFrom(sut));
    }

...
public abstract interface TrustManagerFactorySpiClassTests<SUT extends TrustManagerFactorySpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TrustManagerFactorySpi.class!",
                   TrustManagerFactorySpi.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIServerImpl_Stub
 * public final class javax.management.remote.rmi.RMIServerImpl_Stub}.
 *
...
public abstract interface RMIServerImpl_StubClassTests<SUT extends RMIServerImpl_Stub>
extends RMIServerClassTests<SUT>, RemoteStubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIServerImpl_Stub.class!",
                   RMIServerImpl_Stub.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.remote.rmi.RMIServerImpl_Stub]

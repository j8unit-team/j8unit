 ...
 * javax.management.remote.rmi.RMIServerImpl_Stub}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIServerImpl_StubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIServerImpl_StubTests}.
 * </p>
 *
 * @see javax.management.remote.rmi.RMIServerImpl_Stub class javax.management.remote.rmi.RMIServerImpl_Stub (the hereby
 *      targeted class-under-test class)
 * @see RMIServerImpl_StubTests RMIServerImpl_StubTests (The complementary j8unit test interface containing the instance
...
public abstract interface RMIServerImpl_StubClassTests<SUT extends javax.management.remote.rmi.RMIServerImpl_Stub>
extends RMIServerClassTests<SUT>, org.j8unit.repository.java.rmi.server.RemoteStubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIServerImpl_Stub.class!",
                   javax.management.remote.rmi.RMIServerImpl_Stub.class.isAssignableFrom(sut));
    }

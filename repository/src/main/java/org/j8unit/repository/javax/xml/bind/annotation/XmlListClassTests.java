...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlList interface
 * javax.xml.bind.annotation.XmlList}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlListTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlList interface javax.xml.bind.annotation.XmlList (the hereby targeted
 *      class-under-test class)
 * @see XmlListTests XmlListTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlListClassTests<SUT extends javax.xml.bind.annotation.XmlList>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlList.class!",
                   javax.xml.bind.annotation.XmlList.class.isAssignableFrom(sut));
    }

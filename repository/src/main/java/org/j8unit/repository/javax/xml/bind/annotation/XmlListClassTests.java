 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlList public
 * abstract @interface javax.xml.bind.annotation.XmlList}.
 *
...
public abstract interface XmlListClassTests<SUT extends XmlList>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlList.class!",
                   XmlList.class.isAssignableFrom(sut));
    }

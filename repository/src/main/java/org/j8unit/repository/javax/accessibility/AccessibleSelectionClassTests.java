...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.accessibility.AccessibleSelection interface
 * javax.accessibility.AccessibleSelection}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleSelectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleSelectionTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleSelection interface javax.accessibility.AccessibleSelection (the hereby targeted
 *      class-under-test class)
 * @see AccessibleSelectionTests AccessibleSelectionTests (The complementary j8unit test interface containing the
...
public abstract interface AccessibleSelectionClassTests<SUT extends javax.accessibility.AccessibleSelection>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleSelection.class!",
                   javax.accessibility.AccessibleSelection.class.isAssignableFrom(sut));
    }

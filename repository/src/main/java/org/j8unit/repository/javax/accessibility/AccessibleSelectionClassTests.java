 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleSelection
 * public abstract interface javax.accessibility.AccessibleSelection}.
 *
...
public abstract interface AccessibleSelectionClassTests<SUT extends AccessibleSelection>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleSelection.class!",
                   AccessibleSelection.class.isAssignableFrom(sut));
    }

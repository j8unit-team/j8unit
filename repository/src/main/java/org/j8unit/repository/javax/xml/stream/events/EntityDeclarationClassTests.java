...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.events.EntityDeclaration interface
 * javax.xml.stream.events.EntityDeclaration}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EntityDeclarationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EntityDeclarationTests}.
 * </p>
 *
 * @see javax.xml.stream.events.EntityDeclaration interface javax.xml.stream.events.EntityDeclaration (the hereby
 *      targeted class-under-test class)
 * @see EntityDeclarationTests EntityDeclarationTests (The complementary j8unit test interface containing the instance
...
public abstract interface EntityDeclarationClassTests<SUT extends javax.xml.stream.events.EntityDeclaration>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.EntityDeclaration.class!",
                   javax.xml.stream.events.EntityDeclaration.class.isAssignableFrom(sut));
    }

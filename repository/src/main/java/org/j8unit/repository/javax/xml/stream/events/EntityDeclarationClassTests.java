 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EntityDeclaration
 * public abstract interface javax.xml.stream.events.EntityDeclaration}.
 *
...
public abstract interface EntityDeclarationClassTests<SUT extends EntityDeclaration>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EntityDeclaration.class!",
                   EntityDeclaration.class.isAssignableFrom(sut));
    }

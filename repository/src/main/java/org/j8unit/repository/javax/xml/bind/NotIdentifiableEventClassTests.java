...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.NotIdentifiableEvent interface
 * javax.xml.bind.NotIdentifiableEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotIdentifiableEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotIdentifiableEventTests}
 * .
 * </p>
 *
 * @see javax.xml.bind.NotIdentifiableEvent interface javax.xml.bind.NotIdentifiableEvent (the hereby targeted
 *      class-under-test class)
 * @see NotIdentifiableEventTests NotIdentifiableEventTests (The complementary j8unit test interface containing the
...
public abstract interface NotIdentifiableEventClassTests<SUT extends javax.xml.bind.NotIdentifiableEvent>
extends ValidationEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.NotIdentifiableEvent.class!",
                   javax.xml.bind.NotIdentifiableEvent.class.isAssignableFrom(sut));
    }

 ...
 * {@link NotIdentifiableEvent public abstract interface javax.xml.bind.NotIdentifiableEvent}.
 *
...
public abstract interface NotIdentifiableEventClassTests<SUT extends NotIdentifiableEvent>
extends org.j8unit.repository.javax.xml.bind.ValidationEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotIdentifiableEvent.class!",
                   NotIdentifiableEvent.class.isAssignableFrom(sut));
    }

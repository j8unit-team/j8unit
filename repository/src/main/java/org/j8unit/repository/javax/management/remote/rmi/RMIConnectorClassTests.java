 ...
 * javax.management.remote.rmi.RMIConnector}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIConnectorTests}).
 * </p>
 *
 * <p>
 ...
 * @see RMIConnectorTests RMIConnectorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.management.remote.JMXAddressableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIConnector.class!",
                   javax.management.remote.rmi.RMIConnector.class.isAssignableFrom(sut));
    }

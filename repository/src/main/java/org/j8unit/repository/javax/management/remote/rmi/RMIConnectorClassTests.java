 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIConnector public
...
org.j8unit.repository.javax.management.remote.JMXAddressableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIConnector.class!",
                   RMIConnector.class.isAssignableFrom(sut));
    }

 ...
 * javax.sound.sampled.TargetDataLine}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TargetDataLineTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TargetDataLineTests}.
 * </p>
 *
 * @see javax.sound.sampled.TargetDataLine interface javax.sound.sampled.TargetDataLine (the hereby targeted
 *      class-under-test class)
 * @see TargetDataLineTests TargetDataLineTests (The complementary j8unit test interface containing the instance
...
public abstract interface TargetDataLineClassTests<SUT extends javax.sound.sampled.TargetDataLine>
extends DataLineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.TargetDataLine.class!",
                   javax.sound.sampled.TargetDataLine.class.isAssignableFrom(sut));
    }

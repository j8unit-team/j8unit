 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TargetDataLine
 * public abstract interface javax.sound.sampled.TargetDataLine}.
 *
...
public abstract interface TargetDataLineClassTests<SUT extends TargetDataLine>
extends DataLineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TargetDataLine.class!",

 ...
 * javax.naming.ldap.InitialLdapContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InitialLdapContextTests}).
 * </p>
 *
 * <p>
 ...
 * @see InitialLdapContextTests InitialLdapContextTests (The complementary j8unit test interface containing the instance
...
extends LdapContextClassTests<SUT>, org.j8unit.repository.javax.naming.directory.InitialDirContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.InitialLdapContext.class!",
                   javax.naming.ldap.InitialLdapContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InitialLdapContext
 * public class javax.naming.ldap.InitialLdapContext}.
 *
...
extends org.j8unit.repository.javax.naming.ldap.LdapContextClassTests<SUT>, org.j8unit.repository.javax.naming.directory.InitialDirContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InitialLdapContext.class!",
                   InitialLdapContext.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link javax.naming.ldap.InitialLdapContext class javax.naming.ldap.InitialLdapContext}, containing
...
extends org.j8unit.repository.javax.naming.ldap.LdapContextClassTests<SUT>, org.j8unit.repository.javax.naming.directory.InitialDirContextClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.naming.ldap.InitialLdapContext sut = null; // = new
                                                               // InitialLdapContext(java.util.Hashtable,javax.naming.ldap.Control[]);
    }
    ...
    throws Exception {
        // create new instance
        final Class<? extends javax.naming.ldap.InitialLdapContext> sut = createNewSUT();

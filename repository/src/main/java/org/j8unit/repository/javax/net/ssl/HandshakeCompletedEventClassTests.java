 ...
 * javax.net.ssl.HandshakeCompletedEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HandshakeCompletedEventTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link HandshakeCompletedEventTests}.
 * </p>
 *
 * @see javax.net.ssl.HandshakeCompletedEvent class javax.net.ssl.HandshakeCompletedEvent (the hereby targeted
 *      class-under-test class)
 * @see HandshakeCompletedEventTests HandshakeCompletedEventTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.HandshakeCompletedEvent.class!",
                   javax.net.ssl.HandshakeCompletedEvent.class.isAssignableFrom(sut));
    }

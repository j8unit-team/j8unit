 ...
 * {@link HandshakeCompletedEvent public class javax.net.ssl.HandshakeCompletedEvent}.
 *
...
public abstract interface HandshakeCompletedEventClassTests<SUT extends HandshakeCompletedEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HandshakeCompletedEvent.class!",
                   HandshakeCompletedEvent.class.isAssignableFrom(sut));
    }

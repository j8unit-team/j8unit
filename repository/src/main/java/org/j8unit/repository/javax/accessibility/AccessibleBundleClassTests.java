 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleBundle
 * public abstract class javax.accessibility.AccessibleBundle}.
 *
...
public abstract interface AccessibleBundleClassTests<SUT extends AccessibleBundle>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleBundle.class!",
                   AccessibleBundle.class.isAssignableFrom(sut));
    }

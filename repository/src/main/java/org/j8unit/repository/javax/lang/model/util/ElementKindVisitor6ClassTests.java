 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ElementKindVisitor6
 * public class javax.lang.model.util.ElementKindVisitor6<R,P>}.
 *
...
public abstract interface ElementKindVisitor6ClassTests<SUT extends ElementKindVisitor6>
extends org.j8unit.repository.javax.lang.model.util.SimpleElementVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementKindVisitor6.class!",
                   ElementKindVisitor6.class.isAssignableFrom(sut));
    }

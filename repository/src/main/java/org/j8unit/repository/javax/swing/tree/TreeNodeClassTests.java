 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeNodeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeNodeTests}.
 * </p>
 *
 * @see javax.swing.tree.TreeNode interface javax.swing.tree.TreeNode (the hereby targeted class-under-test class)
 * @see TreeNodeTests TreeNodeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TreeNodeClassTests<SUT extends javax.swing.tree.TreeNode>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.tree.TreeNode.class!",
                   javax.swing.tree.TreeNode.class.isAssignableFrom(sut));
    }

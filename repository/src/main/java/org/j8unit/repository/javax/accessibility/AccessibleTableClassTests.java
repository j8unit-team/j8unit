 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleTable
...
public abstract interface AccessibleTableClassTests<SUT extends AccessibleTable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleTable.class!",
                   AccessibleTable.class.isAssignableFrom(sut));
    }

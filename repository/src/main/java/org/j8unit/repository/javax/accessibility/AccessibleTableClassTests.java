 ...
 * javax.accessibility.AccessibleTable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleTableTests}).
 * </p>
 *
 * <p>
 ...
 * @see AccessibleTableTests AccessibleTableTests (The complementary j8unit test interface containing the instance
...
public abstract interface AccessibleTableClassTests<SUT extends javax.accessibility.AccessibleTable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleTable.class!",
                   javax.accessibility.AccessibleTable.class.isAssignableFrom(sut));
    }

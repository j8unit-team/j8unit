...
public abstract interface SimpleElementVisitor6ClassTests<SUT extends SimpleElementVisitor6>
extends org.j8unit.repository.javax.lang.model.util.AbstractElementVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleElementVisitor6.class!",
                   SimpleElementVisitor6.class.isAssignableFrom(sut));
    }

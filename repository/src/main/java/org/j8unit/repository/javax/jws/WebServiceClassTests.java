 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceTests}.
 * </p>
 *
 * @see javax.jws.WebService interface javax.jws.WebService (the hereby targeted class-under-test class)
 * @see WebServiceTests WebServiceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WebServiceClassTests<SUT extends javax.jws.WebService>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.WebService.class!",
                   javax.jws.WebService.class.isAssignableFrom(sut));
    }

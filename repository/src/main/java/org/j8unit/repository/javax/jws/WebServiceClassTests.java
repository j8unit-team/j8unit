 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebService public
 * abstract @interface javax.jws.WebService}.
 *
...
public abstract interface WebServiceClassTests<SUT extends WebService>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebService.class!",
                   WebService.class.isAssignableFrom(sut));
    }

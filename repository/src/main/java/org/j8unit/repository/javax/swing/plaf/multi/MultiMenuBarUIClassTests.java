...
import org.j8unit.repository.javax.swing.plaf.MenuBarUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiMenuBarUI
...
public abstract interface MultiMenuBarUIClassTests<SUT extends MultiMenuBarUI>
extends MenuBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiMenuBarUI.class!",
                   MultiMenuBarUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlElementWrapper
 * public abstract @interface javax.xml.bind.annotation.XmlElementWrapper}.
 *
...
public abstract interface XmlElementWrapperClassTests<SUT extends XmlElementWrapper>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlElementWrapper.class!",
                   XmlElementWrapper.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlElementWrapper interface
 * javax.xml.bind.annotation.XmlElementWrapper}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlElementWrapperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlElementWrapperTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlElementWrapper interface javax.xml.bind.annotation.XmlElementWrapper (the hereby
 *      targeted class-under-test class)
 * @see XmlElementWrapperTests XmlElementWrapperTests (The complementary j8unit test interface containing the instance
...
public abstract interface XmlElementWrapperClassTests<SUT extends javax.xml.bind.annotation.XmlElementWrapper>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlElementWrapper.class!",
                   javax.xml.bind.annotation.XmlElementWrapper.class.isAssignableFrom(sut));
    }

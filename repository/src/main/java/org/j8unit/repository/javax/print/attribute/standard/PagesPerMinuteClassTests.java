 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PagesPerMinute
 * public final class javax.print.attribute.standard.PagesPerMinute}.
 *
...
public abstract interface PagesPerMinuteClassTests<SUT extends PagesPerMinute>
extends PrintServiceAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PagesPerMinute.class!",
                   PagesPerMinute.class.isAssignableFrom(sut));
    }

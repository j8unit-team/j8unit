 ...
 * javax.print.attribute.standard.PagesPerMinute}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PagesPerMinuteTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PagesPerMinuteTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PagesPerMinute class javax.print.attribute.standard.PagesPerMinute (the hereby
 *      targeted class-under-test class)
 * @see PagesPerMinuteTests PagesPerMinuteTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PagesPerMinute.class!",
                   javax.print.attribute.standard.PagesPerMinute.class.isAssignableFrom(sut));
    }

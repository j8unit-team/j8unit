 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JEditorPane public
...
public abstract interface JEditorPaneClassTests<SUT extends JEditorPane>
extends JTextComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JEditorPane]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JEditorPane.class!",
                   JEditorPane.class.isAssignableFrom(sut));
    }

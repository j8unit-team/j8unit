 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JEditorPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JEditorPaneTests}.
 * </p>
 *
 * @see javax.swing.JEditorPane class javax.swing.JEditorPane (the hereby targeted class-under-test class)
 * @see JEditorPaneTests JEditorPaneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.text.JTextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JEditorPane.class!",
                   javax.swing.JEditorPane.class.isAssignableFrom(sut));
    }

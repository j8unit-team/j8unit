 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DirectoryManager
 * public class javax.naming.spi.DirectoryManager}.
 *
...
extends NamingManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirectoryManager.class!",
                   DirectoryManager.class.isAssignableFrom(sut));
    }

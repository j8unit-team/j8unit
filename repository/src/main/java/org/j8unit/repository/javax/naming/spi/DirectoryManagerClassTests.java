 ...
 * javax.naming.spi.DirectoryManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DirectoryManagerTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see DirectoryManagerTests DirectoryManagerTests (The complementary j8unit test interface containing the instance
...
extends NamingManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.DirectoryManager.class!",
                   javax.naming.spi.DirectoryManager.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.tools.ForwardingJavaFileObject class
 * javax.tools.ForwardingJavaFileObject}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ForwardingJavaFileObjectTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ForwardingJavaFileObjectTests}.
 * </p>
 *
 * @see javax.tools.ForwardingJavaFileObject class javax.tools.ForwardingJavaFileObject (the hereby targeted
 *      class-under-test class)
 * @see ForwardingJavaFileObjectTests ForwardingJavaFileObjectTests (The complementary j8unit test interface containing
...
extends JavaFileObjectClassTests<SUT>, ForwardingFileObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.ForwardingJavaFileObject.class!",
                   javax.tools.ForwardingJavaFileObject.class.isAssignableFrom(sut));
    }

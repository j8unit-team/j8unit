...
public abstract interface ForwardingJavaFileObjectClassTests<SUT extends ForwardingJavaFileObject>
extends JavaFileObjectClassTests<SUT>, ForwardingFileObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ForwardingJavaFileObject.class!",
                   ForwardingJavaFileObject.class.isAssignableFrom(sut));
    }

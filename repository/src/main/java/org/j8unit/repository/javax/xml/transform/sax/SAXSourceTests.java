 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link SAXSource
 ...
 * {@link org.j8unit.repository.javax.xml.transform.sax.SAXSourceClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface SAXSourceTests<SUT extends SAXSource>
extends SourceTests<SUT>, ObjectTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_setInputSource_InputSource()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_setXMLReader_XMLReader()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

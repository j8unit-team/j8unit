 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractWriter
...
public abstract interface AbstractWriterClassTests<SUT extends AbstractWriter>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractWriter.class!",
                   AbstractWriter.class.isAssignableFrom(sut));
    }

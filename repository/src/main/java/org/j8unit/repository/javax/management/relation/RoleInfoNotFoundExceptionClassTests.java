...
public abstract interface RoleInfoNotFoundExceptionClassTests<SUT extends RoleInfoNotFoundException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleInfoNotFoundException.class!",
                   RoleInfoNotFoundException.class.isAssignableFrom(sut));
    }

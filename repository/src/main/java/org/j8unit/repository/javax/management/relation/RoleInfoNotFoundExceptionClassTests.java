...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.relation.RoleInfoNotFoundException class
 * javax.management.relation.RoleInfoNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link RoleInfoNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see RoleInfoNotFoundExceptionTests RoleInfoNotFoundExceptionTests (The complementary j8unit test interface
...
public abstract interface RoleInfoNotFoundExceptionClassTests<SUT extends javax.management.relation.RoleInfoNotFoundException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RoleInfoNotFoundException.class!",
                   javax.management.relation.RoleInfoNotFoundException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlElementRef
 * public abstract @interface javax.xml.bind.annotation.XmlElementRef}.
 *
...
public abstract interface XmlElementRefClassTests<SUT extends XmlElementRef>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlElementRef.class!",
                   XmlElementRef.class.isAssignableFrom(sut));
    }
     ...
     * {@link DEFAULT public static final class javax.xml.bind.annotation.XmlElementRef$DEFAULT}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AddressingFeature
 * public final class javax.xml.ws.soap.AddressingFeature}.
 *
...
extends WebServiceFeatureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AddressingFeature.class!",
     ...
     * {@link Responses public static final enum javax.xml.ws.soap.AddressingFeature$Responses}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

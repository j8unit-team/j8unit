 ...
 * javax.xml.ws.soap.AddressingFeature}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AddressingFeatureTests}).
 * </p>
 *
 * <p>
 ...
 * @see AddressingFeatureTests AddressingFeatureTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.xml.ws.WebServiceFeatureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.soap.AddressingFeature.class!",
                   javax.xml.ws.soap.AddressingFeature.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.xml.ws.soap.AddressingFeature.Responses class
     * javax.xml.ws.soap.AddressingFeature$Responses}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link AddressingFeatureTests.ResponsesTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see AddressingFeatureTests.ResponsesTests AddressingFeatureTests.ResponsesTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.soap.AddressingFeature.Responses.class!",
                       javax.xml.ws.soap.AddressingFeature.Responses.class.isAssignableFrom(sut));
        }

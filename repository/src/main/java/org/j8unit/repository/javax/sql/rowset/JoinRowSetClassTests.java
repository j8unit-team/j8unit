 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JoinRowSet public
 * abstract interface javax.sql.rowset.JoinRowSet}.
 *
...
public abstract interface JoinRowSetClassTests<SUT extends JoinRowSet>
extends WebRowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JoinRowSet.class!",

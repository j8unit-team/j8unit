 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JoinRowSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JoinRowSetTests}.
 * </p>
 *
 * @see javax.sql.rowset.JoinRowSet interface javax.sql.rowset.JoinRowSet (the hereby targeted class-under-test class)
 * @see JoinRowSetTests JoinRowSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JoinRowSetClassTests<SUT extends javax.sql.rowset.JoinRowSet>
extends WebRowSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.JoinRowSet.class!",
                   javax.sql.rowset.JoinRowSet.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sound.sampled.SourceDataLine interface
 * javax.sound.sampled.SourceDataLine}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SourceDataLineTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SourceDataLineTests}.
 * </p>
 *
 * @see javax.sound.sampled.SourceDataLine interface javax.sound.sampled.SourceDataLine (the hereby targeted
 *      class-under-test class)
 * @see SourceDataLineTests SourceDataLineTests (The complementary j8unit test interface containing the instance
...
extends DataLineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.SourceDataLine.class!",
                   javax.sound.sampled.SourceDataLine.class.isAssignableFrom(sut));
    }

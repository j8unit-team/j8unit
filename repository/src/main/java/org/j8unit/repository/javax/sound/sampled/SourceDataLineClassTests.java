 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SourceDataLine
...
public abstract interface SourceDataLineClassTests<SUT extends SourceDataLine>
extends DataLineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SourceDataLine.class!",
                   SourceDataLine.class.isAssignableFrom(sut));
    }

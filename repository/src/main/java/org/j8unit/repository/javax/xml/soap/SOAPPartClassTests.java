...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.soap.SOAPPart class javax.xml.soap.SOAPPart}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPPartTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPPartTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPPart class javax.xml.soap.SOAPPart (the hereby targeted class-under-test class)
 * @see SOAPPartTests SOAPPartTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SOAPPartClassTests<SUT extends javax.xml.soap.SOAPPart>
extends org.j8unit.repository.org.w3c.dom.DocumentClassTests<SUT>, NodeClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPPart.class!",
                   javax.xml.soap.SOAPPart.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FaultAction public
 * abstract @interface javax.xml.ws.FaultAction}.
 *
...
public abstract interface FaultActionClassTests<SUT extends FaultAction>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FaultAction.class!",
                   FaultAction.class.isAssignableFrom(sut));
    }

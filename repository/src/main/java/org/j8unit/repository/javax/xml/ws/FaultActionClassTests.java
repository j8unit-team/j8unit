...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.FaultAction interface javax.xml.ws.FaultAction},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FaultActionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FaultActionTests}.
 * </p>
 *
 * @see javax.xml.ws.FaultAction interface javax.xml.ws.FaultAction (the hereby targeted class-under-test class)
 * @see FaultActionTests FaultActionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FaultActionClassTests<SUT extends javax.xml.ws.FaultAction>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.FaultAction.class!",
                   javax.xml.ws.FaultAction.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Track public class
...
public abstract interface TrackClassTests<SUT extends Track>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Track.class!", Track.class.isAssignableFrom(sut));
    }

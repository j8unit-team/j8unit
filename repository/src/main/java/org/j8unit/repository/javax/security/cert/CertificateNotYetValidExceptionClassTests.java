 ...
 * javax.security.cert.CertificateNotYetValidException}, containing all type relevant aspects (e.&thinsp;g., runtime
...
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.cert.CertificateNotYetValidException.class!",
                   javax.security.cert.CertificateNotYetValidException.class.isAssignableFrom(sut));
    }

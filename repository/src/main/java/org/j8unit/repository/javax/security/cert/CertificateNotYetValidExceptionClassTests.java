 ...
 * {@link CertificateNotYetValidException public class javax.security.cert.CertificateNotYetValidException}.
 *
...
public abstract interface CertificateNotYetValidExceptionClassTests<SUT extends CertificateNotYetValidException>
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertificateNotYetValidException.class!",
                   CertificateNotYetValidException.class.isAssignableFrom(sut));
    }

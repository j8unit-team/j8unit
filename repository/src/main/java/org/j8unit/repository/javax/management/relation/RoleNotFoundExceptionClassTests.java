 ...
 * {@link RoleNotFoundException public class javax.management.relation.RoleNotFoundException}.
 *
...
public abstract interface RoleNotFoundExceptionClassTests<SUT extends RoleNotFoundException>
extends org.j8unit.repository.javax.management.relation.RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleNotFoundException.class!",
                   RoleNotFoundException.class.isAssignableFrom(sut));
    }

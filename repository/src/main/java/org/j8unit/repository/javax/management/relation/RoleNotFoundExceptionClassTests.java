 ...
 * javax.management.relation.RoleNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RoleNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RoleNotFoundExceptionTests}.
 * </p>
 *
 * @see javax.management.relation.RoleNotFoundException class javax.management.relation.RoleNotFoundException (the
 *      hereby targeted class-under-test class)
 * @see RoleNotFoundExceptionTests RoleNotFoundExceptionTests (The complementary j8unit test interface containing the
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RoleNotFoundException.class!",
                   javax.management.relation.RoleNotFoundException.class.isAssignableFrom(sut));
    }

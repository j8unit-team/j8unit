 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultMenuLayout
 * public class javax.swing.plaf.basic.DefaultMenuLayout}.
 *
...
public abstract interface DefaultMenuLayoutClassTests<SUT extends DefaultMenuLayout>
extends org.j8unit.repository.javax.swing.plaf.UIResourceClassTests<SUT>, org.j8unit.repository.javax.swing.BoxLayoutClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultMenuLayout.class!",
                   DefaultMenuLayout.class.isAssignableFrom(sut));
    }

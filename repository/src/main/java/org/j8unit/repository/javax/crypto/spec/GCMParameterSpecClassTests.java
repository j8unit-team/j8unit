 ...
 * javax.crypto.spec.GCMParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GCMParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GCMParameterSpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.GCMParameterSpec class javax.crypto.spec.GCMParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see GCMParameterSpecTests GCMParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.GCMParameterSpec.class!",
                   javax.crypto.spec.GCMParameterSpec.class.isAssignableFrom(sut));
    }

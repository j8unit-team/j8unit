 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GCMParameterSpec
...
public abstract interface GCMParameterSpecClassTests<SUT extends GCMParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GCMParameterSpec.class!",

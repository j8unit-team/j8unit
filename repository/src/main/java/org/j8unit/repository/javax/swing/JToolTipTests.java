...
/**
 * <p>
 * Test class for {@link javax.swing.JToolTip class javax.swing.JToolTip}, containing all instance relevant test methods
...
extends org.j8unit.repository.javax.accessibility.AccessibleTests<SUT>, org.j8unit.repository.javax.swing.JComponentTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getTipText()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_setComponent_JComponent()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link javax.swing.JToolTip#setTipText(java.lang.String) public void
    ...
    @Test
    @Category(Draft.class)
    public default void test_setTipText_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

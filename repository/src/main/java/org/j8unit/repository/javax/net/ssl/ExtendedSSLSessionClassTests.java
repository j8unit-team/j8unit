 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExtendedSSLSession
...
public abstract interface ExtendedSSLSessionClassTests<SUT extends ExtendedSSLSession>
extends SSLSessionClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExtendedSSLSession.class!",

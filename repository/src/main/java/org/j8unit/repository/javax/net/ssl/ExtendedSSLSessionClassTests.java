 ...
 * javax.net.ssl.ExtendedSSLSession}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExtendedSSLSessionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExtendedSSLSessionTests}.
 * </p>
 *
 * @see javax.net.ssl.ExtendedSSLSession class javax.net.ssl.ExtendedSSLSession (the hereby targeted class-under-test
 *      class)
 * @see ExtendedSSLSessionTests ExtendedSSLSessionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ExtendedSSLSessionClassTests<SUT extends javax.net.ssl.ExtendedSSLSession>
extends SSLSessionClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.ExtendedSSLSession.class!",
                   javax.net.ssl.ExtendedSSLSession.class.isAssignableFrom(sut));
    }

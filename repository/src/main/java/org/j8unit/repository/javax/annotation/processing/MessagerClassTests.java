 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Messager public
...
public abstract interface MessagerClassTests<SUT extends Messager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Messager.class!",
                   Messager.class.isAssignableFrom(sut));
    }

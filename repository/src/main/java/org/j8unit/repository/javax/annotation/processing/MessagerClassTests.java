 ...
 * javax.annotation.processing.Messager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MessagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MessagerTests}.
 * </p>
 *
 * @see javax.annotation.processing.Messager interface javax.annotation.processing.Messager (the hereby targeted
 *      class-under-test class)
 * @see MessagerTests MessagerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MessagerClassTests<SUT extends javax.annotation.processing.Messager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.Messager.class!",
                   javax.annotation.processing.Messager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterStateReason
 * public class javax.print.attribute.standard.PrinterStateReason}.
 *
...
public abstract interface PrinterStateReasonClassTests<SUT extends PrinterStateReason>
extends AttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterStateReason.class!",
                   PrinterStateReason.class.isAssignableFrom(sut));
    }

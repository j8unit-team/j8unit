 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JAXBContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JAXBContextTests}.
 * </p>
 *
 * @see javax.xml.bind.JAXBContext class javax.xml.bind.JAXBContext (the hereby targeted class-under-test class)
 * @see JAXBContextTests JAXBContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.JAXBContext.class!",
                   javax.xml.bind.JAXBContext.class.isAssignableFrom(sut));
    }

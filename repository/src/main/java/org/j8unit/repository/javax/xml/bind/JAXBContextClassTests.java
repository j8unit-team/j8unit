 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXBContext public
...
public abstract interface JAXBContextClassTests<SUT extends JAXBContext>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.bind.JAXBContext]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXBContext.class!",
                   JAXBContext.class.isAssignableFrom(sut));
    }

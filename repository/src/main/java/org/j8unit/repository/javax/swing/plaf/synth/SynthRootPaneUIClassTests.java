 ...
 * javax.swing.plaf.synth.SynthRootPaneUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthRootPaneUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthRootPaneUITests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthRootPaneUI class javax.swing.plaf.synth.SynthRootPaneUI (the hereby targeted
 *      class-under-test class)
 * @see SynthRootPaneUITests SynthRootPaneUITests (The complementary j8unit test interface containing the instance
...
extends SynthUIClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.basic.BasicRootPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthRootPaneUI.class!",
                   javax.swing.plaf.synth.SynthRootPaneUI.class.isAssignableFrom(sut));
    }

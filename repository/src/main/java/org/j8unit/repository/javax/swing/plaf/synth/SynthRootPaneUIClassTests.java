...
import org.j8unit.repository.javax.swing.plaf.basic.BasicRootPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthRootPaneUI
...
public abstract interface SynthRootPaneUIClassTests<SUT extends SynthRootPaneUI>
extends SynthUIClassTests<SUT>, BasicRootPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthRootPaneUI.class!",
                   SynthRootPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IconUIResource
...
public abstract interface IconUIResourceClassTests<SUT extends IconUIResource>
extends IconClassTests<SUT>, UIResourceClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IconUIResource.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JavaFileObjectTests}).
 * </p>
 *
 * <p>
 ...
 * @see JavaFileObjectTests JavaFileObjectTests (The complementary j8unit test interface containing the instance
...
extends FileObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.JavaFileObject.class!",
                   javax.tools.JavaFileObject.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.tools.JavaFileObject.Kind class
     * javax.tools.JavaFileObject$Kind}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link JavaFileObjectTests.KindTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see JavaFileObjectTests.KindTests JavaFileObjectTests.KindTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.JavaFileObject.Kind.class!",
                       javax.tools.JavaFileObject.Kind.class.isAssignableFrom(sut));
        }

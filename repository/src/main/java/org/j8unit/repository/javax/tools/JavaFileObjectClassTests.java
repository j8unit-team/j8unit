 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JavaFileObject
...
extends FileObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JavaFileObject.class!",
                   JavaFileObject.class.isAssignableFrom(sut));
    }
     ...
     * {@link Kind public static final enum javax.tools.JavaFileObject$Kind}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

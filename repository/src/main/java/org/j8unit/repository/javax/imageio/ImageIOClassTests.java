 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageIO public
...
public abstract interface ImageIOClassTests<SUT extends ImageIO>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageIO.class!",
                   ImageIO.class.isAssignableFrom(sut));
    }

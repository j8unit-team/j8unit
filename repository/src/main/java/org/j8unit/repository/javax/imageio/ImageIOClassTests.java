 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageIOTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageIOTests}.
 * </p>
 *
 * @see javax.imageio.ImageIO class javax.imageio.ImageIO (the hereby targeted class-under-test class)
 * @see ImageIOTests ImageIOTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.ImageIO.class!",
                   javax.imageio.ImageIO.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SAXSource public
...
public abstract interface SAXSourceClassTests<SUT extends SAXSource>
extends SourceClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXSource.class!",
                   SAXSource.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.transform.sax.SAXSource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SAXSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SAXSourceTests}.
 * </p>
 *
 * @see javax.xml.transform.sax.SAXSource class javax.xml.transform.sax.SAXSource (the hereby targeted class-under-test
 *      class)
 * @see SAXSourceTests SAXSourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.transform.SourceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.sax.SAXSource.class!",
                   javax.xml.transform.sax.SAXSource.class.isAssignableFrom(sut));
    }

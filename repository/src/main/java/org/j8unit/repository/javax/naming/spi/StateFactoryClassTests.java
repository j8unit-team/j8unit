 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StateFactory public
 * abstract interface javax.naming.spi.StateFactory}.
 *
...
public abstract interface StateFactoryClassTests<SUT extends StateFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StateFactory.class!",

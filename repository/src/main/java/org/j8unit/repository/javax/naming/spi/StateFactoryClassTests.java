 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StateFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StateFactoryTests}.
 * </p>
 *
 * @see javax.naming.spi.StateFactory interface javax.naming.spi.StateFactory (the hereby targeted class-under-test
 *      class)
 * @see StateFactoryTests StateFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StateFactoryClassTests<SUT extends javax.naming.spi.StateFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.StateFactory.class!",
                   javax.naming.spi.StateFactory.class.isAssignableFrom(sut));
    }

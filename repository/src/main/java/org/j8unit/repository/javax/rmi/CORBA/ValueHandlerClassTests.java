...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.rmi.CORBA.ValueHandler interface javax.rmi.CORBA.ValueHandler},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValueHandlerTests}.
 * </p>
 *
 * @see javax.rmi.CORBA.ValueHandler interface javax.rmi.CORBA.ValueHandler (the hereby targeted class-under-test class)
 * @see ValueHandlerTests ValueHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ValueHandlerClassTests<SUT extends javax.rmi.CORBA.ValueHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.CORBA.ValueHandler.class!",
                   javax.rmi.CORBA.ValueHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueHandler public
 * abstract interface javax.rmi.CORBA.ValueHandler}.
 *
...
public abstract interface ValueHandlerClassTests<SUT extends ValueHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueHandler.class!",

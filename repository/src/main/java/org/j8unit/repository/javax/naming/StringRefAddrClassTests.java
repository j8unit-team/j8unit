 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringRefAddr
 * public class javax.naming.StringRefAddr}.
 *
...
public abstract interface StringRefAddrClassTests<SUT extends StringRefAddr>
extends RefAddrClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringRefAddr.class!",

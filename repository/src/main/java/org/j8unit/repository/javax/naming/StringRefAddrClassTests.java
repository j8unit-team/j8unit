 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringRefAddrTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringRefAddrTests}.
 * </p>
 *
 * @see javax.naming.StringRefAddr class javax.naming.StringRefAddr (the hereby targeted class-under-test class)
 * @see StringRefAddrTests StringRefAddrTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends RefAddrClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.StringRefAddr.class!",
                   javax.naming.StringRefAddr.class.isAssignableFrom(sut));
    }

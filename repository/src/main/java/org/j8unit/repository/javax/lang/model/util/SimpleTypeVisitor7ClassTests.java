 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleTypeVisitor7
 * public class javax.lang.model.util.SimpleTypeVisitor7<R,P>}.
 *
...
public abstract interface SimpleTypeVisitor7ClassTests<SUT extends SimpleTypeVisitor7>
extends SimpleTypeVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleTypeVisitor7.class!",
                   SimpleTypeVisitor7.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MidiDeviceReceiver
 * public abstract interface javax.sound.midi.MidiDeviceReceiver}.
 *
...
public abstract interface MidiDeviceReceiverClassTests<SUT extends MidiDeviceReceiver>
extends ReceiverClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MidiDeviceReceiver.class!",
                   MidiDeviceReceiver.class.isAssignableFrom(sut));
    }

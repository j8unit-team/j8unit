 ...
 * javax.sound.midi.MidiDeviceReceiver}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MidiDeviceReceiverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MidiDeviceReceiverTests}.
 * </p>
 *
 * @see javax.sound.midi.MidiDeviceReceiver interface javax.sound.midi.MidiDeviceReceiver (the hereby targeted
 *      class-under-test class)
 * @see MidiDeviceReceiverTests MidiDeviceReceiverTests (The complementary j8unit test interface containing the instance
...
public abstract interface MidiDeviceReceiverClassTests<SUT extends javax.sound.midi.MidiDeviceReceiver>
extends ReceiverClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.MidiDeviceReceiver.class!",
                   javax.sound.midi.MidiDeviceReceiver.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.directory.InvalidAttributeValueException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidAttributeValueExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidAttributeValueExceptionTests InvalidAttributeValueExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.InvalidAttributeValueException.class!",
                   javax.naming.directory.InvalidAttributeValueException.class.isAssignableFrom(sut));
    }

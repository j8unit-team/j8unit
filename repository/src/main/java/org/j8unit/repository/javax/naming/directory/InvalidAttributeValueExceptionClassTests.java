...
public abstract interface InvalidAttributeValueExceptionClassTests<SUT extends InvalidAttributeValueException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidAttributeValueException.class!",
                   InvalidAttributeValueException.class.isAssignableFrom(sut));
    }

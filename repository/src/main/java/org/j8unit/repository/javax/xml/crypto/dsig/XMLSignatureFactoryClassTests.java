 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLSignatureFactory
 * public abstract class javax.xml.crypto.dsig.XMLSignatureFactory}.
 *
...
public abstract interface XMLSignatureFactoryClassTests<SUT extends XMLSignatureFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLSignatureFactory.class!",
                   XMLSignatureFactory.class.isAssignableFrom(sut));
    }

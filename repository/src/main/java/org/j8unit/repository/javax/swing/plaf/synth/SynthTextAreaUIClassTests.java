 ...
 * javax.swing.plaf.synth.SynthTextAreaUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthTextAreaUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthTextAreaUITests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthTextAreaUI class javax.swing.plaf.synth.SynthTextAreaUI (the hereby targeted
 *      class-under-test class)
 * @see SynthTextAreaUITests SynthTextAreaUITests (The complementary j8unit test interface containing the instance
...
extends SynthUIClassTests<SUT>, org.j8unit.repository.javax.swing.plaf.basic.BasicTextAreaUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthTextAreaUI.class!",
                   javax.swing.plaf.synth.SynthTextAreaUI.class.isAssignableFrom(sut));
    }

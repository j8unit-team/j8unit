...
import org.j8unit.repository.javax.swing.plaf.basic.BasicTextAreaUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthTextAreaUI
...
public abstract interface SynthTextAreaUIClassTests<SUT extends SynthTextAreaUI>
extends SynthUIClassTests<SUT>, BasicTextAreaUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthTextAreaUI.class!",
                   SynthTextAreaUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Diagnostic public
 * abstract interface javax.tools.Diagnostic<S>}.
 *
...
public abstract interface DiagnosticClassTests<SUT extends Diagnostic>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Diagnostic.class!",
     ...
     * {@link Kind public static final enum javax.tools.Diagnostic$Kind}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * {@link org.j8unit.repository.javax.tools.DiagnosticTests.KindTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.tools.Diagnostic interface javax.tools.Diagnostic}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DiagnosticTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DiagnosticTests}.
 * </p>
 *
 * @see javax.tools.Diagnostic interface javax.tools.Diagnostic (the hereby targeted class-under-test class)
 * @see DiagnosticTests DiagnosticTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DiagnosticClassTests<SUT extends javax.tools.Diagnostic>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.Diagnostic.class!",
                   javax.tools.Diagnostic.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.tools.Diagnostic.Kind class javax.tools.Diagnostic$Kind},
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link DiagnosticTests.KindTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * {@link DiagnosticTests.KindTests}.
     * </p>
     *
     * @see javax.tools.Diagnostic.Kind class javax.tools.Diagnostic$Kind (the hereby targeted class-under-test class)
     * @see DiagnosticTests.KindTests DiagnosticTests.KindTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.Diagnostic.Kind.class!",
                       javax.tools.Diagnostic.Kind.class.isAssignableFrom(sut));
        }

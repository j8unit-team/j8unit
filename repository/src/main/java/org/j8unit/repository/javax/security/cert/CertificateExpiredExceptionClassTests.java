...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.security.cert.CertificateExpiredException class
 * javax.security.cert.CertificateExpiredException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CertificateExpiredExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.security.cert.CertificateExpiredException class javax.security.cert.CertificateExpiredException (the
 *      hereby targeted class-under-test class)
 * @see CertificateExpiredExceptionTests CertificateExpiredExceptionTests (The complementary j8unit test interface
...
public abstract interface CertificateExpiredExceptionClassTests<SUT extends javax.security.cert.CertificateExpiredException>
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.cert.CertificateExpiredException.class!",
                   javax.security.cert.CertificateExpiredException.class.isAssignableFrom(sut));
    }

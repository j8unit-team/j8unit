 ...
 * {@link InstanceNotFoundException public class javax.management.InstanceNotFoundException}.
 *
...
public abstract interface InstanceNotFoundExceptionClassTests<SUT extends InstanceNotFoundException>
extends org.j8unit.repository.javax.management.OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InstanceNotFoundException.class!",
                   InstanceNotFoundException.class.isAssignableFrom(sut));
    }

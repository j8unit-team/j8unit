 ...
 * javax.management.InstanceNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link InstanceNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InstanceNotFoundExceptionTests InstanceNotFoundExceptionTests (The complementary j8unit test interface
...
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.InstanceNotFoundException.class!",
                   javax.management.InstanceNotFoundException.class.isAssignableFrom(sut));
    }

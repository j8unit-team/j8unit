 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MaskFormatter
...
extends DefaultFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MaskFormatter.class!",
                   MaskFormatter.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MaskFormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MaskFormatterTests}.
 * </p>
 *
 * @see javax.swing.text.MaskFormatter class javax.swing.text.MaskFormatter (the hereby targeted class-under-test class)
 * @see MaskFormatterTests MaskFormatterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MaskFormatterClassTests<SUT extends javax.swing.text.MaskFormatter>
extends DefaultFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.MaskFormatter.class!",
                   javax.swing.text.MaskFormatter.class.isAssignableFrom(sut));
    }

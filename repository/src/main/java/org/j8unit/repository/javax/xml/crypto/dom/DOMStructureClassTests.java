 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMStructure public
...
public abstract interface DOMStructureClassTests<SUT extends DOMStructure>
extends XMLStructureClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMStructure.class!",
                   DOMStructure.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.crypto.dom.DOMStructure}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMStructureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DOMStructureTests}.
 * </p>
 *
 * @see javax.xml.crypto.dom.DOMStructure class javax.xml.crypto.dom.DOMStructure (the hereby targeted class-under-test
 *      class)
 * @see DOMStructureTests DOMStructureTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dom.DOMStructure.class!",
                   javax.xml.crypto.dom.DOMStructure.class.isAssignableFrom(sut));
    }

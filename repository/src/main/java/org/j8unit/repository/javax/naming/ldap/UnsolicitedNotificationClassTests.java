...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.ldap.UnsolicitedNotification interface
 * javax.naming.ldap.UnsolicitedNotification}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnsolicitedNotificationTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see UnsolicitedNotificationTests UnsolicitedNotificationTests (The complementary j8unit test interface containing
...
extends ExtendedResponseClassTests<SUT>, HasControlsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.UnsolicitedNotification.class!",
                   javax.naming.ldap.UnsolicitedNotification.class.isAssignableFrom(sut));
    }

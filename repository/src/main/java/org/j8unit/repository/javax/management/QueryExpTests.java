 ...
 * non-{@code static} methods) of {@linkplain javax.management.QueryExp interface javax.management.QueryExp}. The
 * complementary j8unit test interface containing the class relevant aspects is {@link QueryExpClassTests}.
 * </p>
 *
 * @see javax.management.QueryExp interface javax.management.QueryExp (the hereby targeted class-under-test class)
 * @see QueryExpClassTests QueryExpClassTests (the complementary j8unit test interface containing the class relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableTests<SUT> {
     ...
     * </p>
     *
     * @see javax.management.QueryExp#apply(javax.management.ObjectName) public abstract boolean
     *      javax.management.QueryExp.apply(javax.management.ObjectName) throws
     ...
     * </p>
     *
     * @see javax.management.QueryExp#setMBeanServer(javax.management.MBeanServer) public abstract void
     *      javax.management.QueryExp.setMBeanServer(javax.management.MBeanServer) (the hereby targeted
     *      method-under-test)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnnotationValue
 * public abstract interface javax.lang.model.element.AnnotationValue}.
 *
...
public abstract interface AnnotationValueClassTests<SUT extends AnnotationValue>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotationValue.class!",
                   AnnotationValue.class.isAssignableFrom(sut));
    }

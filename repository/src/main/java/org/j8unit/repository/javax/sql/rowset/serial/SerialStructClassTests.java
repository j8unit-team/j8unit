 ...
 * javax.sql.rowset.serial.SerialStruct}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerialStructTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SerialStructTests}.
 * </p>
 *
 * @see javax.sql.rowset.serial.SerialStruct class javax.sql.rowset.serial.SerialStruct (the hereby targeted
 *      class-under-test class)
 * @see SerialStructTests SerialStructTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SerialStruct.class!",
                   javax.sql.rowset.serial.SerialStruct.class.isAssignableFrom(sut));
    }

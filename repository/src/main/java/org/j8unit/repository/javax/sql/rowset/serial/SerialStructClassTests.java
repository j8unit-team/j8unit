 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerialStruct public
...
public abstract interface SerialStructClassTests<SUT extends SerialStruct>
...
org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerialStruct.class!",
                   SerialStruct.class.isAssignableFrom(sut));
    }

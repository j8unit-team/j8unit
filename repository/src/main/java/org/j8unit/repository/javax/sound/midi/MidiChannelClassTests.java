 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MidiChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MidiChannelTests}.
 * </p>
 *
 * @see javax.sound.midi.MidiChannel interface javax.sound.midi.MidiChannel (the hereby targeted class-under-test class)
 * @see MidiChannelTests MidiChannelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MidiChannelClassTests<SUT extends javax.sound.midi.MidiChannel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.MidiChannel.class!",
                   javax.sound.midi.MidiChannel.class.isAssignableFrom(sut));
    }

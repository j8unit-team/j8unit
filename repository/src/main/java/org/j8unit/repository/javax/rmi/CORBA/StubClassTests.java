 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Stub public
...
public abstract interface StubClassTests<SUT extends Stub>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.org.omg.CORBA_2_3.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Stub.class!", Stub.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.rmi.CORBA.Stub class javax.rmi.CORBA.Stub}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StubTests}.
 * </p>
 *
 * @see javax.rmi.CORBA.Stub class javax.rmi.CORBA.Stub (the hereby targeted class-under-test class)
 * @see StubTests StubTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface StubClassTests<SUT extends javax.rmi.CORBA.Stub>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.org.omg.CORBA_2_3.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.CORBA.Stub.class!",
                   javax.rmi.CORBA.Stub.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.bind.annotation.adapters.NormalizedStringAdapter}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NormalizedStringAdapterTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NormalizedStringAdapterTests}.
 * </p>
 *
 ...
 * @see NormalizedStringAdapterTests NormalizedStringAdapterTests (The complementary j8unit test interface containing
...
extends XmlAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.adapters.NormalizedStringAdapter.class!",
                   javax.xml.bind.annotation.adapters.NormalizedStringAdapter.class.isAssignableFrom(sut));
    }

...
public abstract interface NormalizedStringAdapterClassTests<SUT extends NormalizedStringAdapter>
extends XmlAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NormalizedStringAdapter.class!",
                   NormalizedStringAdapter.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.naming.ReferralExceptionClassTests;
 ...
 * {@link LdapReferralException public abstract class javax.naming.ldap.LdapReferralException}.
 *
...
public abstract interface LdapReferralExceptionClassTests<SUT extends LdapReferralException>
extends ReferralExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LdapReferralException.class!",

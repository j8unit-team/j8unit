 ...
 * javax.naming.ldap.LdapReferralException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LdapReferralExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link LdapReferralExceptionTests}.
 * </p>
 *
 * @see javax.naming.ldap.LdapReferralException class javax.naming.ldap.LdapReferralException (the hereby targeted
 *      class-under-test class)
 * @see LdapReferralExceptionTests LdapReferralExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface LdapReferralExceptionClassTests<SUT extends javax.naming.ldap.LdapReferralException>
extends org.j8unit.repository.javax.naming.ReferralExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.LdapReferralException.class!",
                   javax.naming.ldap.LdapReferralException.class.isAssignableFrom(sut));
    }

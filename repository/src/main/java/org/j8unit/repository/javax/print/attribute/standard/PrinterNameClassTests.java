 ...
 * javax.print.attribute.standard.PrinterName}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterNameTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PrinterName class javax.print.attribute.standard.PrinterName (the hereby targeted
 *      class-under-test class)
 * @see PrinterNameTests PrinterNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterName.class!",
                   javax.print.attribute.standard.PrinterName.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterName public
 * final class javax.print.attribute.standard.PrinterName}.
 *
...
public abstract interface PrinterNameClassTests<SUT extends PrinterName>
extends PrintServiceAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterName.class!",
                   PrinterName.class.isAssignableFrom(sut));
    }

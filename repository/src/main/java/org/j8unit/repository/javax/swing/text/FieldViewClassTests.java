 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FieldView public
...
public abstract interface FieldViewClassTests<SUT extends FieldView>
extends org.j8unit.repository.javax.swing.text.PlainViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FieldView.class!",
                   FieldView.class.isAssignableFrom(sut));
    }

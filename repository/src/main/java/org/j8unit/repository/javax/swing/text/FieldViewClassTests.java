 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FieldViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FieldViewTests}.
 * </p>
 *
 * @see javax.swing.text.FieldView class javax.swing.text.FieldView (the hereby targeted class-under-test class)
 * @see FieldViewTests FieldViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends PlainViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.FieldView.class!",
                   javax.swing.text.FieldView.class.isAssignableFrom(sut));
    }

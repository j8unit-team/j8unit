 ...
 * javax.management.relation.RelationTypeSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RelationTypeSupportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RelationTypeSupportTests}.
 * </p>
 *
 * @see javax.management.relation.RelationTypeSupport class javax.management.relation.RelationTypeSupport (the hereby
 *      targeted class-under-test class)
 * @see RelationTypeSupportTests RelationTypeSupportTests (The complementary j8unit test interface containing the
...
public abstract interface RelationTypeSupportClassTests<SUT extends javax.management.relation.RelationTypeSupport>
extends RelationTypeClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationTypeSupport.class!",
                   javax.management.relation.RelationTypeSupport.class.isAssignableFrom(sut));
    }

 ...
 * javax.net.ssl.ManagerFactoryParameters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ManagerFactoryParametersTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ManagerFactoryParametersTests}.
 * </p>
 *
 * @see javax.net.ssl.ManagerFactoryParameters interface javax.net.ssl.ManagerFactoryParameters (the hereby targeted
 *      class-under-test class)
 * @see ManagerFactoryParametersTests ManagerFactoryParametersTests (The complementary j8unit test interface containing
...
public abstract interface ManagerFactoryParametersClassTests<SUT extends javax.net.ssl.ManagerFactoryParameters>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.ManagerFactoryParameters.class!",
                   javax.net.ssl.ManagerFactoryParameters.class.isAssignableFrom(sut));
    }

...
public abstract interface ManagerFactoryParametersClassTests<SUT extends ManagerFactoryParameters>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ManagerFactoryParameters.class!",

 ...
 * javax.xml.xpath.XPathExpression}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathExpressionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XPathExpressionTests}.
 * </p>
 *
 * @see javax.xml.xpath.XPathExpression interface javax.xml.xpath.XPathExpression (the hereby targeted class-under-test
 *      class)
 * @see XPathExpressionTests XPathExpressionTests (The complementary j8unit test interface containing the instance
...
public abstract interface XPathExpressionClassTests<SUT extends javax.xml.xpath.XPathExpression>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.xpath.XPathExpression.class!",
                   javax.xml.xpath.XPathExpression.class.isAssignableFrom(sut));
    }

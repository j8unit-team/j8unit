 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XPathExpression
 * public abstract interface javax.xml.xpath.XPathExpression}.
 *
...
public abstract interface XPathExpressionClassTests<SUT extends XPathExpression>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathExpression.class!",
                   XPathExpression.class.isAssignableFrom(sut));
    }

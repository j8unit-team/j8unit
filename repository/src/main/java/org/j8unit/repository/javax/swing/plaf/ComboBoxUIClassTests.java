 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComboBoxUI public
 * abstract class javax.swing.plaf.ComboBoxUI}.
 *
...
public abstract interface ComboBoxUIClassTests<SUT extends ComboBoxUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComboBoxUI.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComboBoxUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComboBoxUITests}.
 * </p>
 *
 * @see javax.swing.plaf.ComboBoxUI class javax.swing.plaf.ComboBoxUI (the hereby targeted class-under-test class)
 * @see ComboBoxUITests ComboBoxUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ComboBoxUI.class!",
                   javax.swing.plaf.ComboBoxUI.class.isAssignableFrom(sut));
    }

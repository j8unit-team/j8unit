 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetInternal
 * public abstract interface javax.sql.RowSetInternal}.
 *
...
public abstract interface RowSetInternalClassTests<SUT extends RowSetInternal>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetInternal.class!",
                   RowSetInternal.class.isAssignableFrom(sut));
    }

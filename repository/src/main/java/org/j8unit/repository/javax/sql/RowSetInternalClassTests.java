...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.RowSetInternal interface javax.sql.RowSetInternal},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetInternalTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetInternalTests}.
 * </p>
 *
 * @see javax.sql.RowSetInternal interface javax.sql.RowSetInternal (the hereby targeted class-under-test class)
 * @see RowSetInternalTests RowSetInternalTests (The complementary j8unit test interface containing the instance
...
public abstract interface RowSetInternalClassTests<SUT extends javax.sql.RowSetInternal>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.RowSetInternal.class!",
                   javax.sql.RowSetInternal.class.isAssignableFrom(sut));
    }

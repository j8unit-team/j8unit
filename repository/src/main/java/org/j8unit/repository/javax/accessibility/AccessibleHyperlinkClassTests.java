 ...
 * javax.accessibility.AccessibleHyperlink}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleHyperlinkTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleHyperlinkTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleHyperlink class javax.accessibility.AccessibleHyperlink (the hereby targeted
 *      class-under-test class)
 * @see AccessibleHyperlinkTests AccessibleHyperlinkTests (The complementary j8unit test interface containing the
...
extends AccessibleActionClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleHyperlink.class!",
                   javax.accessibility.AccessibleHyperlink.class.isAssignableFrom(sut));
    }

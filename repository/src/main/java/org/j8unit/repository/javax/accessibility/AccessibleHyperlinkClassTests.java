 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleHyperlink
 * public abstract class javax.accessibility.AccessibleHyperlink}.
 *
...
public abstract interface AccessibleHyperlinkClassTests<SUT extends AccessibleHyperlink>
extends org.j8unit.repository.javax.accessibility.AccessibleActionClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleHyperlink.class!",
                   AccessibleHyperlink.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.accessibility.AccessibleHyperlink]

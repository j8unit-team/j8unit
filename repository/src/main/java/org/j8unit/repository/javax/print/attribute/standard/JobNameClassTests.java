 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobName public
...
public abstract interface JobNameClassTests<SUT extends JobName>
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobName.class!",
                   JobName.class.isAssignableFrom(sut));
    }

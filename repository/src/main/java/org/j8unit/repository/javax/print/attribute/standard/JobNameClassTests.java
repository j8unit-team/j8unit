 ...
 * javax.print.attribute.standard.JobName}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobNameTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.JobName class javax.print.attribute.standard.JobName (the hereby targeted
 *      class-under-test class)
 * @see JobNameTests JobNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobName.class!",
                   javax.print.attribute.standard.JobName.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.basic.BasicListUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthListUI public
...
public abstract interface SynthListUIClassTests<SUT extends SynthListUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicListUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthListUI.class!",
                   SynthListUI.class.isAssignableFrom(sut));
    }

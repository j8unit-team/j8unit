 ...
 * javax.swing.plaf.synth.SynthListUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthListUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthListUITests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthListUI class javax.swing.plaf.synth.SynthListUI (the hereby targeted
 *      class-under-test class)
 * @see SynthListUITests SynthListUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.swing.plaf.basic.BasicListUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthListUI.class!",
                   javax.swing.plaf.synth.SynthListUI.class.isAssignableFrom(sut));
    }

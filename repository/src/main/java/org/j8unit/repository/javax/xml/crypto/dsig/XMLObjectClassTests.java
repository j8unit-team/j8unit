 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLObject public
 * abstract interface javax.xml.crypto.dsig.XMLObject}.
 *
...
public abstract interface XMLObjectClassTests<SUT extends XMLObject>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLObject.class!",
                   XMLObject.class.isAssignableFrom(sut));
    }

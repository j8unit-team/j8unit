 ...
 * javax.xml.crypto.dsig.XMLObject}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLObjectTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.XMLObject interface javax.xml.crypto.dsig.XMLObject (the hereby targeted class-under-test
 *      class)
 * @see XMLObjectTests XMLObjectTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XMLObjectClassTests<SUT extends javax.xml.crypto.dsig.XMLObject>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.XMLObject.class!",
                   javax.xml.crypto.dsig.XMLObject.class.isAssignableFrom(sut));
    }

...
public abstract interface MimeTypeParameterListClassTests<SUT extends MimeTypeParameterList>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MimeTypeParameterList.class!",
                   MimeTypeParameterList.class.isAssignableFrom(sut));
    }

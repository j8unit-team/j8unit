 ...
 * javax.swing.event.MenuListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuListenerTests}.
 * </p>
 *
 * @see javax.swing.event.MenuListener interface javax.swing.event.MenuListener (the hereby targeted class-under-test
 *      class)
 * @see MenuListenerTests MenuListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MenuListenerClassTests<SUT extends javax.swing.event.MenuListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MenuListener.class!",
                   javax.swing.event.MenuListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuListener public
...
public abstract interface MenuListenerClassTests<SUT extends MenuListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuListener.class!",
                   MenuListener.class.isAssignableFrom(sut));
    }

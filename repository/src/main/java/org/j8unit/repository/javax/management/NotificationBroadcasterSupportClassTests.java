...
public abstract interface NotificationBroadcasterSupportClassTests<SUT extends NotificationBroadcasterSupport>
extends NotificationEmitterClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotificationBroadcasterSupport.class!",
                   NotificationBroadcasterSupport.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.javax.management.NotificationEmitterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_NotificationBroadcasterSupport_Executor_MBeanNotificationInfoArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.management.NotificationBroadcasterSupport sut = null; // = new
    ...
    @Test
    @Category(Draft.class)
    public default void create_NotificationBroadcasterSupport_MBeanNotificationInfoArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.management.NotificationBroadcasterSupport sut = null; // = new

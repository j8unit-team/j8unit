 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PasswordCallback
...
public abstract interface PasswordCallbackClassTests<SUT extends PasswordCallback>
extends CallbackClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PasswordCallback.class!",
                   PasswordCallback.class.isAssignableFrom(sut));
    }

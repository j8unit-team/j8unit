 ...
 * javax.security.auth.callback.PasswordCallback}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PasswordCallbackTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PasswordCallbackTests}.
 * </p>
 *
 * @see javax.security.auth.callback.PasswordCallback class javax.security.auth.callback.PasswordCallback (the hereby
 *      targeted class-under-test class)
 * @see PasswordCallbackTests PasswordCallbackTests (The complementary j8unit test interface containing the instance
...
extends CallbackClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.callback.PasswordCallback.class!",
                   javax.security.auth.callback.PasswordCallback.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JCheckBoxMenuItem
 * public class javax.swing.JCheckBoxMenuItem}.
 *
...
public abstract interface JCheckBoxMenuItemClassTests<SUT extends JCheckBoxMenuItem>
extends JMenuItemClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JCheckBoxMenuItem.class!",

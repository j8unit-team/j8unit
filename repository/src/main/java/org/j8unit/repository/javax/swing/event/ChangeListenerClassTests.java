 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChangeListener
 * public abstract interface javax.swing.event.ChangeListener}.
 *
...
public abstract interface ChangeListenerClassTests<SUT extends ChangeListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChangeListener.class!",
                   ChangeListener.class.isAssignableFrom(sut));
    }

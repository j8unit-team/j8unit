 ...
 * javax.swing.event.ChangeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChangeListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChangeListenerTests}.
 * </p>
 *
 * @see javax.swing.event.ChangeListener interface javax.swing.event.ChangeListener (the hereby targeted
 *      class-under-test class)
 * @see ChangeListenerTests ChangeListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ChangeListenerClassTests<SUT extends javax.swing.event.ChangeListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.ChangeListener.class!",
                   javax.swing.event.ChangeListener.class.isAssignableFrom(sut));
    }

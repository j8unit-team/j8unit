 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventFilterTests}.
 * </p>
 *
 * @see javax.xml.stream.EventFilter interface javax.xml.stream.EventFilter (the hereby targeted class-under-test class)
 * @see EventFilterTests EventFilterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface EventFilterClassTests<SUT extends javax.xml.stream.EventFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.EventFilter.class!",
                   javax.xml.stream.EventFilter.class.isAssignableFrom(sut));
    }

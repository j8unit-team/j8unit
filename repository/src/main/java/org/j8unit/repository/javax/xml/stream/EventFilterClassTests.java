 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventFilter public
 * abstract interface javax.xml.stream.EventFilter}.
 *
...
public abstract interface EventFilterClassTests<SUT extends EventFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventFilter.class!",

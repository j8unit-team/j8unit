 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Transmitter public
 * abstract interface javax.sound.midi.Transmitter}.
 *
...
public abstract interface TransmitterClassTests<SUT extends Transmitter>
extends AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Transmitter.class!",
                   Transmitter.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransmitterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransmitterTests}.
 * </p>
 *
 * @see javax.sound.midi.Transmitter interface javax.sound.midi.Transmitter (the hereby targeted class-under-test class)
 * @see TransmitterTests TransmitterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TransmitterClassTests<SUT extends javax.sound.midi.Transmitter>
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Transmitter.class!",
                   javax.sound.midi.Transmitter.class.isAssignableFrom(sut));
    }

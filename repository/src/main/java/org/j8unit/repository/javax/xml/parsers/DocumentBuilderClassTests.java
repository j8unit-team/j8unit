 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentBuilder
...
public abstract interface DocumentBuilderClassTests<SUT extends DocumentBuilder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentBuilder.class!",
                   DocumentBuilder.class.isAssignableFrom(sut));
    }

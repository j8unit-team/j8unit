 ...
 * javax.transaction.TransactionRequiredException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link TransactionRequiredExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see TransactionRequiredExceptionTests TransactionRequiredExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.transaction.TransactionRequiredException.class!",
                   javax.transaction.TransactionRequiredException.class.isAssignableFrom(sut));
    }

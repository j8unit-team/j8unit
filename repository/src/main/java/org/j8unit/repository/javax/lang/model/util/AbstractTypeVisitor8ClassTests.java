...
public abstract interface AbstractTypeVisitor8ClassTests<SUT extends AbstractTypeVisitor8>
extends org.j8unit.repository.javax.lang.model.util.AbstractTypeVisitor7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractTypeVisitor8.class!",
                   AbstractTypeVisitor8.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JoinableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JoinableTests}.
 * </p>
 *
 * @see javax.sql.rowset.Joinable interface javax.sql.rowset.Joinable (the hereby targeted class-under-test class)
 * @see JoinableTests JoinableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JoinableClassTests<SUT extends javax.sql.rowset.Joinable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.Joinable.class!",
                   javax.sql.rowset.Joinable.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Joinable public
...
public abstract interface JoinableClassTests<SUT extends Joinable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Joinable.class!",
                   Joinable.class.isAssignableFrom(sut));
    }

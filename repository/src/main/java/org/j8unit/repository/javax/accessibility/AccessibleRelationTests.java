...
extends org.j8unit.repository.javax.accessibility.AccessibleBundleTests<SUT> {
    ...
    /**
     * <p>
     * Test method for {@link javax.accessibility.AccessibleRelation#setTarget(java.lang.Object) public void
    ...
    @Test
    @Category(Draft.class)
    public default void test_setTarget_Object()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_setTarget_ObjectArray()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

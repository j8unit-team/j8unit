 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebMethodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebMethodTests}.
 * </p>
 *
 * @see javax.jws.WebMethod interface javax.jws.WebMethod (the hereby targeted class-under-test class)
 * @see WebMethodTests WebMethodTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WebMethodClassTests<SUT extends javax.jws.WebMethod>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.WebMethod.class!",
                   javax.jws.WebMethod.class.isAssignableFrom(sut));
    }

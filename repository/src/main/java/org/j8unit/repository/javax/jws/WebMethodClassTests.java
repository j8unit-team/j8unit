 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebMethod public
 * abstract @interface javax.jws.WebMethod}.
 *
...
public abstract interface WebMethodClassTests<SUT extends WebMethod>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebMethod.class!",
                   WebMethod.class.isAssignableFrom(sut));
    }

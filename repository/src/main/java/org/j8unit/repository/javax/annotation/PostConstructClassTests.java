 ...
 * javax.annotation.PostConstruct}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PostConstructTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PostConstructTests}.
 * </p>
 *
 * @see javax.annotation.PostConstruct interface javax.annotation.PostConstruct (the hereby targeted class-under-test
 *      class)
 * @see PostConstructTests PostConstructTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PostConstructClassTests<SUT extends javax.annotation.PostConstruct>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.PostConstruct.class!",
                   javax.annotation.PostConstruct.class.isAssignableFrom(sut));
    }

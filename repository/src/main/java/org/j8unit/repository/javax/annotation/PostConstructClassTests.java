 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PostConstruct
...
public abstract interface PostConstructClassTests<SUT extends PostConstruct>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PostConstruct.class!",
                   PostConstruct.class.isAssignableFrom(sut));
    }

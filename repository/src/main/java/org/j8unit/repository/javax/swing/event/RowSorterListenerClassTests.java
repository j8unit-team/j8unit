...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.RowSorterListener interface
 * javax.swing.event.RowSorterListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSorterListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSorterListenerTests}.
 * </p>
 *
 * @see javax.swing.event.RowSorterListener interface javax.swing.event.RowSorterListener (the hereby targeted
 *      class-under-test class)
 * @see RowSorterListenerTests RowSorterListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface RowSorterListenerClassTests<SUT extends javax.swing.event.RowSorterListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.RowSorterListener.class!",
                   javax.swing.event.RowSorterListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSorterListener
 * public abstract interface javax.swing.event.RowSorterListener}.
 *
...
public abstract interface RowSorterListenerClassTests<SUT extends RowSorterListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSorterListener.class!",
                   RowSorterListener.class.isAssignableFrom(sut));
    }

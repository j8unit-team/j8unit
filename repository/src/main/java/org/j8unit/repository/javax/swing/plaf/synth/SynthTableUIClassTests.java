...
import org.j8unit.repository.javax.swing.plaf.basic.BasicTableUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthTableUI public
...
public abstract interface SynthTableUIClassTests<SUT extends SynthTableUI>
extends SynthUIClassTests<SUT>, PropertyChangeListenerClassTests<SUT>, BasicTableUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthTableUI.class!",
                   SynthTableUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.synth.SynthTableUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.synth.SynthTableUI]

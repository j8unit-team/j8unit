...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.accessibility.AccessibleHypertext interface
 * javax.accessibility.AccessibleHypertext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleHypertextTests}).
 * </p>
 *
 * <p>
 ...
 * @see AccessibleHypertextTests AccessibleHypertextTests (The complementary j8unit test interface containing the
...
public abstract interface AccessibleHypertextClassTests<SUT extends javax.accessibility.AccessibleHypertext>
extends AccessibleTextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleHypertext.class!",
                   javax.accessibility.AccessibleHypertext.class.isAssignableFrom(sut));
    }

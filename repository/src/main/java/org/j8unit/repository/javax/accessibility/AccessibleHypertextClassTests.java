 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleHypertext
 * public abstract interface javax.accessibility.AccessibleHypertext}.
 *
...
extends AccessibleTextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleHypertext.class!",
                   AccessibleHypertext.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.basic.BasicToolBarUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthToolBarUI
...
public abstract interface SynthToolBarUIClassTests<SUT extends SynthToolBarUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicToolBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthToolBarUI.class!",
                   SynthToolBarUI.class.isAssignableFrom(sut));
    }

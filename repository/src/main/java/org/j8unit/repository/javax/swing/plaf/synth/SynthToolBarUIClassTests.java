 ...
 * javax.swing.plaf.synth.SynthToolBarUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthToolBarUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthToolBarUITests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthToolBarUI class javax.swing.plaf.synth.SynthToolBarUI (the hereby targeted
 *      class-under-test class)
 * @see SynthToolBarUITests SynthToolBarUITests (The complementary j8unit test interface containing the instance
...
public abstract interface SynthToolBarUIClassTests<SUT extends javax.swing.plaf.synth.SynthToolBarUI>
...
org.j8unit.repository.javax.swing.plaf.basic.BasicToolBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthToolBarUI.class!",
                   javax.swing.plaf.synth.SynthToolBarUI.class.isAssignableFrom(sut));
    }

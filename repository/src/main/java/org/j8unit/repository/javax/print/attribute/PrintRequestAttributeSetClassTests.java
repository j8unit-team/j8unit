...
public abstract interface PrintRequestAttributeSetClassTests<SUT extends PrintRequestAttributeSet>
extends org.j8unit.repository.javax.print.attribute.AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintRequestAttributeSet.class!",

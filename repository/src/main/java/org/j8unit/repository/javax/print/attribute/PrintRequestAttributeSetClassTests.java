...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.PrintRequestAttributeSet interface
 * javax.print.attribute.PrintRequestAttributeSet}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintRequestAttributeSetTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link PrintRequestAttributeSetTests}.
 * </p>
 *
 * @see javax.print.attribute.PrintRequestAttributeSet interface javax.print.attribute.PrintRequestAttributeSet (the
 *      hereby targeted class-under-test class)
 * @see PrintRequestAttributeSetTests PrintRequestAttributeSetTests (The complementary j8unit test interface containing
...
public abstract interface PrintRequestAttributeSetClassTests<SUT extends javax.print.attribute.PrintRequestAttributeSet>
extends AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.PrintRequestAttributeSet.class!",
                   javax.print.attribute.PrintRequestAttributeSet.class.isAssignableFrom(sut));
    }

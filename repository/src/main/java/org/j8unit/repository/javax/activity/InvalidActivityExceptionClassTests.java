...
public abstract interface InvalidActivityExceptionClassTests<SUT extends InvalidActivityException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidActivityException.class!",
                   InvalidActivityException.class.isAssignableFrom(sut));
    }

 ...
 * javax.activity.InvalidActivityException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidActivityExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link InvalidActivityExceptionTests}.
 * </p>
 *
 * @see javax.activity.InvalidActivityException class javax.activity.InvalidActivityException (the hereby targeted
 *      class-under-test class)
 * @see InvalidActivityExceptionTests InvalidActivityExceptionTests (The complementary j8unit test interface containing
...
public abstract interface InvalidActivityExceptionClassTests<SUT extends javax.activity.InvalidActivityException>
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activity.InvalidActivityException.class!",
                   javax.activity.InvalidActivityException.class.isAssignableFrom(sut));
    }

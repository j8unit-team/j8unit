 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvocableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvocableTests}.
 * </p>
 *
 * @see javax.script.Invocable interface javax.script.Invocable (the hereby targeted class-under-test class)
 * @see InvocableTests InvocableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InvocableClassTests<SUT extends javax.script.Invocable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.Invocable.class!",
                   javax.script.Invocable.class.isAssignableFrom(sut));
    }

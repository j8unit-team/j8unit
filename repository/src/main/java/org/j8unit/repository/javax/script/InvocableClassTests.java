 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Invocable public
 * abstract interface javax.script.Invocable}.
 *
...
public abstract interface InvocableClassTests<SUT extends Invocable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Invocable.class!",

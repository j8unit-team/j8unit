 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PopupFactory public
...
public abstract interface PopupFactoryClassTests<SUT extends PopupFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PopupFactory.class!",
                   PopupFactory.class.isAssignableFrom(sut));
    }

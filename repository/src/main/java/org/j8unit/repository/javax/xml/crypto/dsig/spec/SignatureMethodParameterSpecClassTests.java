 ...
 * javax.xml.crypto.dsig.spec.SignatureMethodParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see SignatureMethodParameterSpecTests SignatureMethodParameterSpecTests (The complementary j8unit test interface
...
public abstract interface SignatureMethodParameterSpecClassTests<SUT extends javax.xml.crypto.dsig.spec.SignatureMethodParameterSpec>
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.SignatureMethodParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.SignatureMethodParameterSpec.class.isAssignableFrom(sut));
    }

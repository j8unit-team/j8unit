...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.spi.ObjectFactoryBuilder interface
 * javax.naming.spi.ObjectFactoryBuilder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectFactoryBuilderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectFactoryBuilderTests}
 * .
 * </p>
 *
 * @see javax.naming.spi.ObjectFactoryBuilder interface javax.naming.spi.ObjectFactoryBuilder (the hereby targeted
 *      class-under-test class)
 * @see ObjectFactoryBuilderTests ObjectFactoryBuilderTests (The complementary j8unit test interface containing the
...
public abstract interface ObjectFactoryBuilderClassTests<SUT extends javax.naming.spi.ObjectFactoryBuilder>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.ObjectFactoryBuilder.class!",
                   javax.naming.spi.ObjectFactoryBuilder.class.isAssignableFrom(sut));
    }

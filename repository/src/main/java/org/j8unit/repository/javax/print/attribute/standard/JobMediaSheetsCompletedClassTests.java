...
public abstract interface JobMediaSheetsCompletedClassTests<SUT extends JobMediaSheetsCompleted>
extends PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobMediaSheetsCompleted.class!",
                   JobMediaSheetsCompleted.class.isAssignableFrom(sut));
    }

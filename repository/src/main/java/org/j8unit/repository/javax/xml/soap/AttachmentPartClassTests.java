 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttachmentPartTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AttachmentPartTests}.
 * </p>
 *
 * @see javax.xml.soap.AttachmentPart class javax.xml.soap.AttachmentPart (the hereby targeted class-under-test class)
 * @see AttachmentPartTests AttachmentPartTests (The complementary j8unit test interface containing the instance
...
public abstract interface AttachmentPartClassTests<SUT extends javax.xml.soap.AttachmentPart>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.AttachmentPart.class!",
                   javax.xml.soap.AttachmentPart.class.isAssignableFrom(sut));
    }

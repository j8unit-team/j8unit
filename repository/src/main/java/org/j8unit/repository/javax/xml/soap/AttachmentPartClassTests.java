 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AttachmentPart
...
public abstract interface AttachmentPartClassTests<SUT extends AttachmentPart>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttachmentPart.class!",
                   AttachmentPart.class.isAssignableFrom(sut));
    }

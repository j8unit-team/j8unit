...
import org.j8unit.repository.java.util.EnumerationClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingEnumeration
 * public abstract interface javax.naming.NamingEnumeration<T>}.
 *
...
public abstract interface NamingEnumerationClassTests<SUT extends NamingEnumeration>
extends EnumerationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingEnumeration.class!",
                   NamingEnumeration.class.isAssignableFrom(sut));
    }

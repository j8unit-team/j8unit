 ...
 * javax.naming.NamingEnumeration}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingEnumerationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingEnumerationTests}.
 * </p>
 *
 * @see javax.naming.NamingEnumeration interface javax.naming.NamingEnumeration (the hereby targeted class-under-test
 *      class)
 * @see NamingEnumerationTests NamingEnumerationTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EnumerationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NamingEnumeration.class!",
                   javax.naming.NamingEnumeration.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLResolver public
 * abstract interface javax.xml.stream.XMLResolver}.
 *
...
public abstract interface XMLResolverClassTests<SUT extends XMLResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLResolver.class!",
                   XMLResolver.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLResolverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLResolverTests}.
 * </p>
 *
 * @see javax.xml.stream.XMLResolver interface javax.xml.stream.XMLResolver (the hereby targeted class-under-test class)
 * @see XMLResolverTests XMLResolverTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XMLResolverClassTests<SUT extends javax.xml.stream.XMLResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.XMLResolver.class!",
                   javax.xml.stream.XMLResolver.class.isAssignableFrom(sut));
    }

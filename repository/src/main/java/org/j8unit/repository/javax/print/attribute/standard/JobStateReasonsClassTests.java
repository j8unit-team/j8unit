 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JobStateReasons
 * public final class javax.print.attribute.standard.JobStateReasons}.
 *
...
extends PrintJobAttributeClassTests<SUT>, HashSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobStateReasons.class!",
                   JobStateReasons.class.isAssignableFrom(sut));
    }

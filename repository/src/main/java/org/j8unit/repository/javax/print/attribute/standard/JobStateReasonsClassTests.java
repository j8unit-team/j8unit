 ...
 * javax.print.attribute.standard.JobStateReasons}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobStateReasonsTests}).
 * </p>
 *
 * <p>
 ...
 * @see JobStateReasonsTests JobStateReasonsTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.java.util.HashSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobStateReasons.class!",
                   javax.print.attribute.standard.JobStateReasons.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BoxView public
...
public abstract interface BoxViewClassTests<SUT extends BoxView>
extends CompositeViewClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.BoxView]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BoxView.class!",
                   BoxView.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BoxViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BoxViewTests}.
 * </p>
 *
 * @see javax.swing.text.BoxView class javax.swing.text.BoxView (the hereby targeted class-under-test class)
 * @see BoxViewTests BoxViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BoxViewClassTests<SUT extends javax.swing.text.BoxView>
extends CompositeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.BoxView.class!",
                   javax.swing.text.BoxView.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLEventWriter
...
extends org.j8unit.repository.javax.xml.stream.util.XMLEventConsumerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLEventWriter.class!",
                   XMLEventWriter.class.isAssignableFrom(sut));
    }

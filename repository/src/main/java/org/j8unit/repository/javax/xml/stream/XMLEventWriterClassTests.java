 ...
 * javax.xml.stream.XMLEventWriter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLEventWriterTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see XMLEventWriterTests XMLEventWriterTests (The complementary j8unit test interface containing the instance
...
public abstract interface XMLEventWriterClassTests<SUT extends javax.xml.stream.XMLEventWriter>
extends org.j8unit.repository.javax.xml.stream.util.XMLEventConsumerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.XMLEventWriter.class!",
                   javax.xml.stream.XMLEventWriter.class.isAssignableFrom(sut));
    }

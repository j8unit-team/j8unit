...
import org.j8unit.repository.javax.swing.SpringLayoutTests.ConstraintsTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SpringLayout public
...
public abstract interface SpringLayoutClassTests<SUT extends SpringLayout>
extends LayoutManager2ClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SpringLayout.class!",
                   SpringLayout.class.isAssignableFrom(sut));
    }
     ...
     * {@link Constraints public static class javax.swing.SpringLayout$Constraints}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ConstraintsTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ConstraintsClassTests<SUT extends Constraints>
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Constraints.class!",
                              Constraints.class.isAssignableFrom(sut));
        }

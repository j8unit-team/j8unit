...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.directory.Attribute interface
 * javax.naming.directory.Attribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
public abstract interface AttributeClassTests<SUT extends javax.naming.directory.Attribute>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.Attribute.class!",
                   javax.naming.directory.Attribute.class.isAssignableFrom(sut));
    }

...
public abstract interface ParseConversionEventClassTests<SUT extends ParseConversionEvent>
extends ValidationEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParseConversionEvent.class!",
                   ParseConversionEvent.class.isAssignableFrom(sut));
    }

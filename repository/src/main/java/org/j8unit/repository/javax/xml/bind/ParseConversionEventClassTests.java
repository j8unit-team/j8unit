...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.ParseConversionEvent interface
 * javax.xml.bind.ParseConversionEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParseConversionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParseConversionEventTests}
 * .
 * </p>
 *
 * @see javax.xml.bind.ParseConversionEvent interface javax.xml.bind.ParseConversionEvent (the hereby targeted
 *      class-under-test class)
 * @see ParseConversionEventTests ParseConversionEventTests (The complementary j8unit test interface containing the
...
public abstract interface ParseConversionEventClassTests<SUT extends javax.xml.bind.ParseConversionEvent>
extends ValidationEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.ParseConversionEvent.class!",
                   javax.xml.bind.ParseConversionEvent.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PatchTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PatchTests}.
 * </p>
 *
 * @see javax.sound.midi.Patch class javax.sound.midi.Patch (the hereby targeted class-under-test class)
 * @see PatchTests PatchTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.Patch.class!",
                   javax.sound.midi.Patch.class.isAssignableFrom(sut));
    }

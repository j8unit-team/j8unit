...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.rowset.spi.XmlReader interface
 * javax.sql.rowset.spi.XmlReader}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlReaderTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see XmlReaderTests XmlReaderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlReaderClassTests<SUT extends javax.sql.rowset.spi.XmlReader>
extends org.j8unit.repository.javax.sql.RowSetReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.spi.XmlReader.class!",
                   javax.sql.rowset.spi.XmlReader.class.isAssignableFrom(sut));
    }

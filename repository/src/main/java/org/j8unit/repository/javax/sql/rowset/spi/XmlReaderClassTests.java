...
import org.j8unit.repository.javax.sql.RowSetReaderClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlReader public
 * abstract interface javax.sql.rowset.spi.XmlReader}.
 *
...
public abstract interface XmlReaderClassTests<SUT extends XmlReader>
extends RowSetReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlReader.class!",
                   XmlReader.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JRootPane class javax.swing.JRootPane}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JRootPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JRootPaneTests}.
 * </p>
 *
 * @see javax.swing.JRootPane class javax.swing.JRootPane (the hereby targeted class-under-test class)
 * @see JRootPaneTests JRootPaneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JRootPaneClassTests<SUT extends javax.swing.JRootPane>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JRootPane.class!",
                   javax.swing.JRootPane.class.isAssignableFrom(sut));
    }

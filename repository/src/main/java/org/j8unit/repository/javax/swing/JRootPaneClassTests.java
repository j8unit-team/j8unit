 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JRootPane public
...
public abstract interface JRootPaneClassTests<SUT extends JRootPane>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JRootPane]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JRootPane.class!",
                   JRootPane.class.isAssignableFrom(sut));
    }

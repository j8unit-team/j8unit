...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.net.ssl.SNIServerName class javax.net.ssl.SNIServerName},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SNIServerNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SNIServerNameTests}.
 * </p>
 *
 * @see javax.net.ssl.SNIServerName class javax.net.ssl.SNIServerName (the hereby targeted class-under-test class)
 * @see SNIServerNameTests SNIServerNameTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SNIServerNameClassTests<SUT extends javax.net.ssl.SNIServerName>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SNIServerName.class!",
                   javax.net.ssl.SNIServerName.class.isAssignableFrom(sut));
    }

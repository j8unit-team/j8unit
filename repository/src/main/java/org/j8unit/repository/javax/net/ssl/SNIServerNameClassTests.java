 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SNIServerName
...
public abstract interface SNIServerNameClassTests<SUT extends SNIServerName>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SNIServerName.class!",
                   SNIServerName.class.isAssignableFrom(sut));
    }

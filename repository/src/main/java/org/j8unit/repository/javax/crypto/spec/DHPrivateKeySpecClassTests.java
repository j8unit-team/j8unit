 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DHPrivateKeySpec
...
public abstract interface DHPrivateKeySpecClassTests<SUT extends DHPrivateKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DHPrivateKeySpec.class!",
                   DHPrivateKeySpec.class.isAssignableFrom(sut));
    }

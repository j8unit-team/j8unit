 ...
 * javax.crypto.spec.DHPrivateKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DHPrivateKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DHPrivateKeySpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.DHPrivateKeySpec class javax.crypto.spec.DHPrivateKeySpec (the hereby targeted
 *      class-under-test class)
 * @see DHPrivateKeySpecTests DHPrivateKeySpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.DHPrivateKeySpec.class!",
                   javax.crypto.spec.DHPrivateKeySpec.class.isAssignableFrom(sut));
    }

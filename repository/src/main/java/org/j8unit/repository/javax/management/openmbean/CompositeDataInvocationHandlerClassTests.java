...
public abstract interface CompositeDataInvocationHandlerClassTests<SUT extends CompositeDataInvocationHandler>
extends InvocationHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompositeDataInvocationHandler.class!",
                   CompositeDataInvocationHandler.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.stream.events.Comment}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CommentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CommentTests}.
 * </p>
 *
 * @see javax.xml.stream.events.Comment interface javax.xml.stream.events.Comment (the hereby targeted class-under-test
 *      class)
 * @see CommentTests CommentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CommentClassTests<SUT extends javax.xml.stream.events.Comment>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.Comment.class!",
                   javax.xml.stream.events.Comment.class.isAssignableFrom(sut));
    }

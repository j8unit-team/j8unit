...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.activation.DataSource interface javax.activation.DataSource},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataSourceTests}).
 * </p>
 *
 * <p>
 ...
 * @see DataSourceTests DataSourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DataSourceClassTests<SUT extends javax.activation.DataSource>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.DataSource.class!",
                   javax.activation.DataSource.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataSource public
 * abstract interface javax.activation.DataSource}.
 *
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataSource.class!",
                   DataSource.class.isAssignableFrom(sut));
    }

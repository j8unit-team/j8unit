 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicEditorPaneUI
 * public class javax.swing.plaf.basic.BasicEditorPaneUI}.
 *
...
public abstract interface BasicEditorPaneUIClassTests<SUT extends BasicEditorPaneUI>
extends BasicTextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicEditorPaneUI.class!",
                   BasicEditorPaneUI.class.isAssignableFrom(sut));
    }

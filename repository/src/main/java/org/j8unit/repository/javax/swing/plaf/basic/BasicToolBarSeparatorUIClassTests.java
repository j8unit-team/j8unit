...
public abstract interface BasicToolBarSeparatorUIClassTests<SUT extends BasicToolBarSeparatorUI>
extends BasicSeparatorUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicToolBarSeparatorUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicToolBarSeparatorUI.class!",
                   BasicToolBarSeparatorUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicToolBarSeparatorUI]

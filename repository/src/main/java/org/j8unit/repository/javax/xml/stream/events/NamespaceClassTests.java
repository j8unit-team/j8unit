 ...
 * javax.xml.stream.events.Namespace}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamespaceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamespaceTests}.
 * </p>
 *
 * @see javax.xml.stream.events.Namespace interface javax.xml.stream.events.Namespace (the hereby targeted
 *      class-under-test class)
 * @see NamespaceTests NamespaceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NamespaceClassTests<SUT extends javax.xml.stream.events.Namespace>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.Namespace.class!",
                   javax.xml.stream.events.Namespace.class.isAssignableFrom(sut));
    }

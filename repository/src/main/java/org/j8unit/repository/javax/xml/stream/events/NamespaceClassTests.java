 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Namespace public
 * abstract interface javax.xml.stream.events.Namespace}.
 *
...
public abstract interface NamespaceClassTests<SUT extends Namespace>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Namespace.class!",
                   Namespace.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WindowConstants
 * public abstract interface javax.swing.WindowConstants}.
 *
...
public abstract interface WindowConstantsClassTests<SUT extends WindowConstants>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WindowConstants.class!",
                   WindowConstants.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.MenuItemUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiMenuItemUI
...
public abstract interface MultiMenuItemUIClassTests<SUT extends MultiMenuItemUI>
extends MenuItemUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.multi.MultiMenuItemUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiMenuItemUI.class!",
                   MultiMenuItemUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.multi.MultiMenuItemUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.multi.MultiMenuItemUI]

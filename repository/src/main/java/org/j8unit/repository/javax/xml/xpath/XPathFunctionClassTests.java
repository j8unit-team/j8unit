 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XPathFunction
 * public abstract interface javax.xml.xpath.XPathFunction}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XPathFunctionTests}.
 * </p>
 *
 * <p>
...
public abstract interface XPathFunctionClassTests<SUT extends XPathFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathFunction.class!",
                   XPathFunction.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.xpath.XPathFunction]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.xml.xpath.XPathFunction]

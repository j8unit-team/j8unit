 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see XPathFunctionTests XPathFunctionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XPathFunctionClassTests<SUT extends javax.xml.xpath.XPathFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.xpath.XPathFunction.class!",
                   javax.xml.xpath.XPathFunction.class.isAssignableFrom(sut));
    }

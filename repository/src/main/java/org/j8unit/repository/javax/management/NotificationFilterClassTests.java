 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotificationFilter
 * public abstract interface javax.management.NotificationFilter}.
 *
...
public abstract interface NotificationFilterClassTests<SUT extends NotificationFilter>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotificationFilter.class!",
                   NotificationFilter.class.isAssignableFrom(sut));
    }

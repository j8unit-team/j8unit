...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.NotificationFilter interface
 * javax.management.NotificationFilter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotificationFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotificationFilterTests}.
 * </p>
 *
 * @see javax.management.NotificationFilter interface javax.management.NotificationFilter (the hereby targeted
 *      class-under-test class)
 * @see NotificationFilterTests NotificationFilterTests (The complementary j8unit test interface containing the instance
...
public abstract interface NotificationFilterClassTests<SUT extends javax.management.NotificationFilter>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.NotificationFilter.class!",
                   javax.management.NotificationFilter.class.isAssignableFrom(sut));
    }

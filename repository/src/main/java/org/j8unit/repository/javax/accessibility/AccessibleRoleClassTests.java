 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleRole
...
public abstract interface AccessibleRoleClassTests<SUT extends AccessibleRole>
extends AccessibleBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleRole.class!",
                   AccessibleRole.class.isAssignableFrom(sut));
    }

 ...
 * javax.accessibility.AccessibleRole}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleRoleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleRoleTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleRole class javax.accessibility.AccessibleRole (the hereby targeted
 *      class-under-test class)
 * @see AccessibleRoleTests AccessibleRoleTests (The complementary j8unit test interface containing the instance
...
public abstract interface AccessibleRoleClassTests<SUT extends javax.accessibility.AccessibleRole>
extends AccessibleBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleRole.class!",
                   javax.accessibility.AccessibleRole.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.text.StyledDocument}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StyledDocumentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StyledDocumentTests}.
 * </p>
 *
 * @see javax.swing.text.StyledDocument interface javax.swing.text.StyledDocument (the hereby targeted class-under-test
 *      class)
 * @see StyledDocumentTests StyledDocumentTests (The complementary j8unit test interface containing the instance
...
public abstract interface StyledDocumentClassTests<SUT extends javax.swing.text.StyledDocument>
extends DocumentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.StyledDocument.class!",
                   javax.swing.text.StyledDocument.class.isAssignableFrom(sut));
    }

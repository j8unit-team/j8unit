 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StyledDocument
...
public abstract interface StyledDocumentClassTests<SUT extends StyledDocument>
extends DocumentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StyledDocument.class!",
                   StyledDocument.class.isAssignableFrom(sut));
    }

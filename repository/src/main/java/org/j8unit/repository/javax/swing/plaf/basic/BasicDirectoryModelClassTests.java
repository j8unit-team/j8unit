...
import org.j8unit.repository.javax.swing.AbstractListModelClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicDirectoryModel
 * public class javax.swing.plaf.basic.BasicDirectoryModel}.
 *
...
public abstract interface BasicDirectoryModelClassTests<SUT extends BasicDirectoryModel>
extends PropertyChangeListenerClassTests<SUT>, AbstractListModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicDirectoryModel.class!",
                   BasicDirectoryModel.class.isAssignableFrom(sut));
    }

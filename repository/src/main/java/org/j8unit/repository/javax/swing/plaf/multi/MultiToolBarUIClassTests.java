 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiToolBarUI
...
public abstract interface MultiToolBarUIClassTests<SUT extends MultiToolBarUI>
extends ToolBarUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.multi.MultiToolBarUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiToolBarUI.class!",
                   MultiToolBarUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.transform.ErrorListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ErrorListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ErrorListenerTests}.
 * </p>
 *
 * @see javax.xml.transform.ErrorListener interface javax.xml.transform.ErrorListener (the hereby targeted
 *      class-under-test class)
 * @see ErrorListenerTests ErrorListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ErrorListenerClassTests<SUT extends javax.xml.transform.ErrorListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.ErrorListener.class!",
                   javax.xml.transform.ErrorListener.class.isAssignableFrom(sut));
    }

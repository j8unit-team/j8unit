 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ErrorListener
...
public abstract interface ErrorListenerClassTests<SUT extends ErrorListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ErrorListener.class!",
                   ErrorListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.MalformedObjectNameException class
 * javax.management.MalformedObjectNameException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link MalformedObjectNameExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see MalformedObjectNameExceptionTests MalformedObjectNameExceptionTests (The complementary j8unit test interface
...
public abstract interface MalformedObjectNameExceptionClassTests<SUT extends javax.management.MalformedObjectNameException>
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MalformedObjectNameException.class!",
                   javax.management.MalformedObjectNameException.class.isAssignableFrom(sut));
    }

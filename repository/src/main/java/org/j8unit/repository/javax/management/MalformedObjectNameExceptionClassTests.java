 ...
 * {@link MalformedObjectNameException public class javax.management.MalformedObjectNameException}.
 *
...
public abstract interface MalformedObjectNameExceptionClassTests<SUT extends MalformedObjectNameException>
extends org.j8unit.repository.javax.management.OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MalformedObjectNameException.class!",
                   MalformedObjectNameException.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.relation.RelationType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RelationTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RelationTypeTests}.
 * </p>
 *
 * @see javax.management.relation.RelationType interface javax.management.relation.RelationType (the hereby targeted
 *      class-under-test class)
 * @see RelationTypeTests RelationTypeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RelationTypeClassTests<SUT extends javax.management.relation.RelationType>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationType.class!",
                   javax.management.relation.RelationType.class.isAssignableFrom(sut));
    }

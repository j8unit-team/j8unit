 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RelationType public
 * abstract interface javax.management.relation.RelationType}.
 *
...
public abstract interface RelationTypeClassTests<SUT extends RelationType>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationType.class!",
                   RelationType.class.isAssignableFrom(sut));
    }

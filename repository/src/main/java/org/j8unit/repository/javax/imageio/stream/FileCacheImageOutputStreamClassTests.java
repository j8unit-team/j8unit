 ...
 * javax.imageio.stream.FileCacheImageOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link FileCacheImageOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileCacheImageOutputStreamTests FileCacheImageOutputStreamTests (The complementary j8unit test interface
...
extends ImageOutputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.FileCacheImageOutputStream.class!",
                   javax.imageio.stream.FileCacheImageOutputStream.class.isAssignableFrom(sut));
    }

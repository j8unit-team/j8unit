...
public abstract interface FileCacheImageOutputStreamClassTests<SUT extends FileCacheImageOutputStream>
extends ImageOutputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileCacheImageOutputStream.class!",
                   FileCacheImageOutputStream.class.isAssignableFrom(sut));
    }

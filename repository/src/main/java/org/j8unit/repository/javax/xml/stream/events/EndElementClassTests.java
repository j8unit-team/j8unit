 ...
 * javax.xml.stream.events.EndElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EndElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EndElementTests}.
 * </p>
 *
 * @see javax.xml.stream.events.EndElement interface javax.xml.stream.events.EndElement (the hereby targeted
 *      class-under-test class)
 * @see EndElementTests EndElementTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface EndElementClassTests<SUT extends javax.xml.stream.events.EndElement>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.EndElement.class!",
                   javax.xml.stream.events.EndElement.class.isAssignableFrom(sut));
    }

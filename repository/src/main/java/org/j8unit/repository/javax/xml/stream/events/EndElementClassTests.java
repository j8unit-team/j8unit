 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EndElement public
 * abstract interface javax.xml.stream.events.EndElement}.
 *
...
public abstract interface EndElementClassTests<SUT extends EndElement>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EndElement.class!",
                   EndElement.class.isAssignableFrom(sut));
    }

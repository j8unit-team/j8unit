 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PBEParameterSpec
...
public abstract interface PBEParameterSpecClassTests<SUT extends PBEParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PBEParameterSpec.class!",
                   PBEParameterSpec.class.isAssignableFrom(sut));
    }

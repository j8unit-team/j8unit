 ...
 * javax.crypto.spec.PBEParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PBEParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PBEParameterSpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.PBEParameterSpec class javax.crypto.spec.PBEParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see PBEParameterSpecTests PBEParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.PBEParameterSpec.class!",
                   javax.crypto.spec.PBEParameterSpec.class.isAssignableFrom(sut));
    }

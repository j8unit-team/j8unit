 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLException public
...
public abstract interface SSLExceptionClassTests<SUT extends SSLException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLException.class!",
                   SSLException.class.isAssignableFrom(sut));
    }

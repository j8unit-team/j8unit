 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLExceptionTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLException class javax.net.ssl.SSLException (the hereby targeted class-under-test class)
 * @see SSLExceptionTests SSLExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLException.class!",
                   javax.net.ssl.SSLException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TableViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TableViewTests}.
 * </p>
 *
 * @see javax.swing.text.TableView class javax.swing.text.TableView (the hereby targeted class-under-test class)
 * @see TableViewTests TableViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends BoxViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.TableView.class!",
                   javax.swing.text.TableView.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.TableView.TableCell class
     * javax.swing.text.TableView$TableCell}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link TableViewTests.TableCellTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.text.TableView.TableCell class javax.swing.text.TableView$TableCell (the hereby targeted
     *      class-under-test class)
     * @see TableViewTests.TableCellTests TableViewTests.TableCellTests (The complementary j8unit test interface
    ...
    extends BoxViewClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.TableView.TableCell.class!",
                       javax.swing.text.TableView.TableCell.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.text.TableView$TableRow}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link TableViewTests.TableRowTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.text.TableView.TableRow class javax.swing.text.TableView$TableRow (the hereby targeted
     *      class-under-test class)
     * @see TableViewTests.TableRowTests TableViewTests.TableRowTests (The complementary j8unit test interface
     *      containing the instance relevant test methods)
     *
     * @param SUT
     *            the class' type of the subject-under-test
    ...
    extends BoxViewClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.TableView.TableRow.class!",
                       javax.swing.text.TableView.TableRow.class.isAssignableFrom(sut));
        }

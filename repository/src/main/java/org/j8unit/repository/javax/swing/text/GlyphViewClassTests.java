 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GlyphView public
...
public abstract interface GlyphViewClassTests<SUT extends GlyphView>
...
org.j8unit.repository.javax.swing.text.ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GlyphView.class!",
                   GlyphView.class.isAssignableFrom(sut));
    }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface GlyphPainterClassTests<SUT extends GlyphPainter>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GlyphPainter.class!",
                              GlyphPainter.class.isAssignableFrom(sut));
        }

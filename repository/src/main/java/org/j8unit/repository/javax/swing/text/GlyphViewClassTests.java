...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.text.GlyphView class javax.swing.text.GlyphView},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GlyphViewTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.text.GlyphView class javax.swing.text.GlyphView (the hereby targeted class-under-test class)
 * @see GlyphViewTests GlyphViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends TabableViewClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.GlyphView.class!",
                   javax.swing.text.GlyphView.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.GlyphView.GlyphPainter class
     * javax.swing.text.GlyphView$GlyphPainter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link GlyphViewTests.GlyphPainterTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.text.GlyphView.GlyphPainter class javax.swing.text.GlyphView$GlyphPainter (the hereby targeted
     *      class-under-test class)
     * @see GlyphViewTests.GlyphPainterTests GlyphViewTests.GlyphPainterTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.GlyphView.GlyphPainter.class!",
                       javax.swing.text.GlyphView.GlyphPainter.class.isAssignableFrom(sut));
        }

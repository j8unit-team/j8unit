 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MBeanServerFactory
...
public abstract interface MBeanServerFactoryClassTests<SUT extends MBeanServerFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerFactory.class!",
                   MBeanServerFactory.class.isAssignableFrom(sut));
    }

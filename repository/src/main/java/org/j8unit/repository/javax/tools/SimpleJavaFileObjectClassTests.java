 ...
 * javax.tools.SimpleJavaFileObject}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleJavaFileObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleJavaFileObjectTests}
 * .
 * </p>
 *
 * @see javax.tools.SimpleJavaFileObject class javax.tools.SimpleJavaFileObject (the hereby targeted class-under-test
 *      class)
 * @see SimpleJavaFileObjectTests SimpleJavaFileObjectTests (The complementary j8unit test interface containing the
...
public abstract interface SimpleJavaFileObjectClassTests<SUT extends javax.tools.SimpleJavaFileObject>
extends JavaFileObjectClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.SimpleJavaFileObject.class!",
                   javax.tools.SimpleJavaFileObject.class.isAssignableFrom(sut));
    }

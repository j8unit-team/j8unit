...
import org.j8unit.repository.java.awt.WindowClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JWindow public
...
public abstract interface JWindowClassTests<SUT extends JWindow>
extends RootPaneContainerClassTests<SUT>, WindowClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JWindow]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JWindow.class!",
                   JWindow.class.isAssignableFrom(sut));
    }

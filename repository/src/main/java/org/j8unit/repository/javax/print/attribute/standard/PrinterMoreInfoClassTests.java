 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterMoreInfo
...
public abstract interface PrinterMoreInfoClassTests<SUT extends PrinterMoreInfo>
extends PrintServiceAttributeClassTests<SUT>, URISyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterMoreInfo.class!",
                   PrinterMoreInfo.class.isAssignableFrom(sut));
    }

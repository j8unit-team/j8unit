...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.PrinterMoreInfo class
 * javax.print.attribute.standard.PrinterMoreInfo}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterMoreInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterMoreInfoTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PrinterMoreInfo class javax.print.attribute.standard.PrinterMoreInfo (the hereby
 *      targeted class-under-test class)
 * @see PrinterMoreInfoTests PrinterMoreInfoTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.print.attribute.PrintServiceAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.URISyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterMoreInfo.class!",
                   javax.print.attribute.standard.PrinterMoreInfo.class.isAssignableFrom(sut));
    }

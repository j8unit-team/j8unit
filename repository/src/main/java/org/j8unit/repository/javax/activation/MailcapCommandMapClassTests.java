 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MailcapCommandMap
 * public class javax.activation.MailcapCommandMap}.
 *
...
public abstract interface MailcapCommandMapClassTests<SUT extends MailcapCommandMap>
extends CommandMapClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.activation.MailcapCommandMap]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MailcapCommandMap.class!",
                   MailcapCommandMap.class.isAssignableFrom(sut));
    }

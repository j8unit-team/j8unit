 ...
 * javax.activation.MailcapCommandMap}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MailcapCommandMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MailcapCommandMapTests}.
 * </p>
 *
 * @see javax.activation.MailcapCommandMap class javax.activation.MailcapCommandMap (the hereby targeted
 *      class-under-test class)
 * @see MailcapCommandMapTests MailcapCommandMapTests (The complementary j8unit test interface containing the instance
...
extends CommandMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.MailcapCommandMap.class!",
                   javax.activation.MailcapCommandMap.class.isAssignableFrom(sut));
    }

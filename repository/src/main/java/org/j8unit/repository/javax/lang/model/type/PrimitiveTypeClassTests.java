 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrimitiveType
 * public abstract interface javax.lang.model.type.PrimitiveType}.
 *
...
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrimitiveType.class!",
                   PrimitiveType.class.isAssignableFrom(sut));
    }

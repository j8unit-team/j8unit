 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DescriptorKey
...
public abstract interface DescriptorKeyClassTests<SUT extends DescriptorKey>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DescriptorKey.class!",
                   DescriptorKey.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.DescriptorKey]

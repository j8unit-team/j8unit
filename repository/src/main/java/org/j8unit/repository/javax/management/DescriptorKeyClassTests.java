...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.DescriptorKey interface
 * javax.management.DescriptorKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DescriptorKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DescriptorKeyTests}.
 * </p>
 *
 * @see javax.management.DescriptorKey interface javax.management.DescriptorKey (the hereby targeted class-under-test
 *      class)
 * @see DescriptorKeyTests DescriptorKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DescriptorKeyClassTests<SUT extends javax.management.DescriptorKey>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.DescriptorKey.class!",
                   javax.management.DescriptorKey.class.isAssignableFrom(sut));
    }

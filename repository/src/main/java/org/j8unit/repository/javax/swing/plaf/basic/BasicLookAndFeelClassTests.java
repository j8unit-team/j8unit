...
import org.j8unit.repository.javax.swing.LookAndFeelClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicLookAndFeel
 * public abstract class javax.swing.plaf.basic.BasicLookAndFeel}.
 *
...
public abstract interface BasicLookAndFeelClassTests<SUT extends BasicLookAndFeel>
extends SerializableClassTests<SUT>, LookAndFeelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicLookAndFeel.class!",
                   BasicLookAndFeel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MBeanRegistration
 * public abstract interface javax.management.MBeanRegistration}.
 *
...
public abstract interface MBeanRegistrationClassTests<SUT extends MBeanRegistration>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanRegistration.class!",
                   MBeanRegistration.class.isAssignableFrom(sut));
    }

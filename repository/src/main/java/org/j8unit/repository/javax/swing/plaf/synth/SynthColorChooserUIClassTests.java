...
import org.j8unit.repository.javax.swing.plaf.basic.BasicColorChooserUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthColorChooserUI
 * public class javax.swing.plaf.synth.SynthColorChooserUI}.
 *
...
public abstract interface SynthColorChooserUIClassTests<SUT extends SynthColorChooserUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicColorChooserUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthColorChooserUI.class!",
                   SynthColorChooserUI.class.isAssignableFrom(sut));
    }

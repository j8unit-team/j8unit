...
import org.j8unit.repository.javax.security.auth.callback.CallbackClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AuthorizeCallback
 * public class javax.security.sasl.AuthorizeCallback}.
 *
...
public abstract interface AuthorizeCallbackClassTests<SUT extends AuthorizeCallback>
extends CallbackClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AuthorizeCallback.class!",

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLCryptoContext
 * public abstract interface javax.xml.crypto.XMLCryptoContext}.
 *
...
public abstract interface XMLCryptoContextClassTests<SUT extends XMLCryptoContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLCryptoContext.class!",
                   XMLCryptoContext.class.isAssignableFrom(sut));
    }

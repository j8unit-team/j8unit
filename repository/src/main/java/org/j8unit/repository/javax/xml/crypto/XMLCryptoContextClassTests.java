 ...
 * javax.xml.crypto.XMLCryptoContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLCryptoContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLCryptoContextTests}.
 * </p>
 *
 * @see javax.xml.crypto.XMLCryptoContext interface javax.xml.crypto.XMLCryptoContext (the hereby targeted
 *      class-under-test class)
 * @see XMLCryptoContextTests XMLCryptoContextTests (The complementary j8unit test interface containing the instance
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.XMLCryptoContext.class!",
                   javax.xml.crypto.XMLCryptoContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DiagnosticCollector
 * public final class javax.tools.DiagnosticCollector<S>}.
 *
...
public abstract interface DiagnosticCollectorClassTests<SUT extends DiagnosticCollector>
extends DiagnosticListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DiagnosticCollector.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DiagnosticCollectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DiagnosticCollectorTests}.
 * </p>
 *
 * @see javax.tools.DiagnosticCollector class javax.tools.DiagnosticCollector (the hereby targeted class-under-test
 *      class)
 * @see DiagnosticCollectorTests DiagnosticCollectorTests (The complementary j8unit test interface containing the
...
extends DiagnosticListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.DiagnosticCollector.class!",
                   javax.tools.DiagnosticCollector.class.isAssignableFrom(sut));
    }

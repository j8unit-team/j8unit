...
/**
 * <p>
 * Test class for {@link javax.management.ObjectName class javax.management.ObjectName}, containing all instance
...
extends org.j8unit.repository.java.lang.ComparableTests<SUT, javax.management.ObjectName>, org.j8unit.repository.javax.management.QueryExpTests<SUT>,
org.j8unit.repository.java.lang.ObjectTests<SUT> {
    ...
    public default void test_compareTo_ObjectName()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getCanonicalKeyPropertyListString()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_isDomainPattern()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_isPattern()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getKeyPropertyList()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link javax.management.ObjectName#getKeyProperty(java.lang.String) public java.lang.String
    ...
    @Test
    @Category(Draft.class)
    public default void test_getKeyProperty_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_isPropertyValuePattern()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link javax.management.ObjectName#isPropertyValuePattern(java.lang.String) public boolean
    ...
    @Test
    @Category(Draft.class)
    public default void test_isPropertyValuePattern_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_isPropertyPattern()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link javax.management.ObjectName#equals(java.lang.Object) public boolean
    ...
    @Test
    @Category(Draft.class)
    public default void test_isPropertyListPattern()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getKeyPropertyListString()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

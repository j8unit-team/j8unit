...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.XMLStreamReader interface
 * javax.xml.stream.XMLStreamReader}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLStreamReaderTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.stream.XMLStreamReader interface javax.xml.stream.XMLStreamReader (the hereby targeted
 *      class-under-test class)
 * @see XMLStreamReaderTests XMLStreamReaderTests (The complementary j8unit test interface containing the instance
...
public abstract interface XMLStreamReaderClassTests<SUT extends javax.xml.stream.XMLStreamReader>
extends XMLStreamConstantsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.XMLStreamReader.class!",
                   javax.xml.stream.XMLStreamReader.class.isAssignableFrom(sut));
    }

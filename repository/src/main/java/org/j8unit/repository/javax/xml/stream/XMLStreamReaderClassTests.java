 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLStreamReader
...
extends XMLStreamConstantsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLStreamReader.class!",
                   XMLStreamReader.class.isAssignableFrom(sut));
    }

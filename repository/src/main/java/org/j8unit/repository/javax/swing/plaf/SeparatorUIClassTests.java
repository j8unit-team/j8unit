 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SeparatorUI public
 * abstract class javax.swing.plaf.SeparatorUI}.
 *
...
public abstract interface SeparatorUIClassTests<SUT extends SeparatorUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SeparatorUI.class!",
                   SeparatorUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.SeparatorUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.SeparatorUI]

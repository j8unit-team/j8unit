 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SeparatorUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SeparatorUITests}.
 * </p>
 *
 * @see javax.swing.plaf.SeparatorUI class javax.swing.plaf.SeparatorUI (the hereby targeted class-under-test class)
 * @see SeparatorUITests SeparatorUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SeparatorUIClassTests<SUT extends javax.swing.plaf.SeparatorUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.SeparatorUI.class!",
                   javax.swing.plaf.SeparatorUI.class.isAssignableFrom(sut));
    }

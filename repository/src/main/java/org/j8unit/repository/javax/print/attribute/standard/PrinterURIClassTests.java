 ...
 * javax.print.attribute.standard.PrinterURI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterURITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterURITests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PrinterURI class javax.print.attribute.standard.PrinterURI (the hereby targeted
 *      class-under-test class)
 * @see PrinterURITests PrinterURITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PrinterURIClassTests<SUT extends javax.print.attribute.standard.PrinterURI>
extends org.j8unit.repository.javax.print.attribute.PrintServiceAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.URISyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterURI.class!",
                   javax.print.attribute.standard.PrinterURI.class.isAssignableFrom(sut));
    }

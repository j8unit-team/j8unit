 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterURI public
 * final class javax.print.attribute.standard.PrinterURI}.
 *
...
public abstract interface PrinterURIClassTests<SUT extends PrinterURI>
extends PrintServiceAttributeClassTests<SUT>, URISyntaxClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.standard.PrinterURI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterURI.class!",
                   PrinterURI.class.isAssignableFrom(sut));
    }

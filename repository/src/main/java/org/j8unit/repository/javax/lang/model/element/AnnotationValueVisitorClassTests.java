...
public abstract interface AnnotationValueVisitorClassTests<SUT extends AnnotationValueVisitor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotationValueVisitor.class!",
                   AnnotationValueVisitor.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.monitor.CounterMonitorMBean}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CounterMonitorMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CounterMonitorMBeanTests}.
 * </p>
 *
 * @see javax.management.monitor.CounterMonitorMBean interface javax.management.monitor.CounterMonitorMBean (the hereby
 *      targeted class-under-test class)
 * @see CounterMonitorMBeanTests CounterMonitorMBeanTests (The complementary j8unit test interface containing the
...
public abstract interface CounterMonitorMBeanClassTests<SUT extends javax.management.monitor.CounterMonitorMBean>
extends MonitorMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.CounterMonitorMBean.class!",
                   javax.management.monitor.CounterMonitorMBean.class.isAssignableFrom(sut));
    }

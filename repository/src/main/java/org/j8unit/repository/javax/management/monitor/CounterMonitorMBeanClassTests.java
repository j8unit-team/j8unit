 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CounterMonitorMBean
 * public abstract interface javax.management.monitor.CounterMonitorMBean}.
 *
...
public abstract interface CounterMonitorMBeanClassTests<SUT extends CounterMonitorMBean>
extends MonitorMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CounterMonitorMBean.class!",

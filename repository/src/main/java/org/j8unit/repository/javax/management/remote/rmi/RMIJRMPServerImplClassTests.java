...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.remote.rmi.RMIJRMPServerImpl class
 * javax.management.remote.rmi.RMIJRMPServerImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIJRMPServerImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIJRMPServerImplTests}.
 * </p>
 *
 * @see javax.management.remote.rmi.RMIJRMPServerImpl class javax.management.remote.rmi.RMIJRMPServerImpl (the hereby
 *      targeted class-under-test class)
 * @see RMIJRMPServerImplTests RMIJRMPServerImplTests (The complementary j8unit test interface containing the instance
...
public abstract interface RMIJRMPServerImplClassTests<SUT extends javax.management.remote.rmi.RMIJRMPServerImpl>
extends RMIServerImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIJRMPServerImpl.class!",
                   javax.management.remote.rmi.RMIJRMPServerImpl.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIJRMPServerImpl
 * public class javax.management.remote.rmi.RMIJRMPServerImpl}.
 *
...
public abstract interface RMIJRMPServerImplClassTests<SUT extends RMIJRMPServerImpl>
extends RMIServerImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIJRMPServerImpl.class!",

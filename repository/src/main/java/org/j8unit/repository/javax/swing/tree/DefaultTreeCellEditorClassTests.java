 ...
 * javax.swing.tree.DefaultTreeCellEditor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultTreeCellEditorTests}).
 * </p>
 *
 * <p>
 ...
 * @see DefaultTreeCellEditorTests DefaultTreeCellEditorTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.awt.event.ActionListenerClassTests<SUT>, TreeCellEditorClassTests<SUT>,
org.j8unit.repository.javax.swing.event.TreeSelectionListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.tree.DefaultTreeCellEditor.class!",
                   javax.swing.tree.DefaultTreeCellEditor.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.tree.DefaultTreeCellEditor.EditorContainer class
     * javax.swing.tree.DefaultTreeCellEditor$EditorContainer}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link DefaultTreeCellEditorTests.EditorContainerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see DefaultTreeCellEditorTests.EditorContainerTests DefaultTreeCellEditorTests.EditorContainerTests (The
    ...
    extends org.j8unit.repository.java.awt.ContainerClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.tree.DefaultTreeCellEditor.EditorContainer.class!",
                       javax.swing.tree.DefaultTreeCellEditor.EditorContainer.class.isAssignableFrom(sut));
        }
     ...
     * javax.swing.tree.DefaultTreeCellEditor$DefaultTextField}, containing all type relevant aspects (e.&thinsp;g.,
     * runtime constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link DefaultTreeCellEditorTests.DefaultTextFieldTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see DefaultTreeCellEditorTests.DefaultTextFieldTests DefaultTreeCellEditorTests.DefaultTextFieldTests (The
     *      complementary j8unit test interface containing the instance relevant test methods)
     *
     * @param SUT
     *            the class' type of the subject-under-test
    ...
    extends org.j8unit.repository.javax.swing.JTextFieldClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.tree.DefaultTreeCellEditor.DefaultTextField.class!",
                       javax.swing.tree.DefaultTreeCellEditor.DefaultTextField.class.isAssignableFrom(sut));
        }

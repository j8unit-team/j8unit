 ...
 * javax.xml.crypto.dsig.spec.ExcC14NParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExcC14NParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExcC14NParameterSpecTests}
 * .
 * </p>
 *
 * @see javax.xml.crypto.dsig.spec.ExcC14NParameterSpec class javax.xml.crypto.dsig.spec.ExcC14NParameterSpec (the
 *      hereby targeted class-under-test class)
 * @see ExcC14NParameterSpecTests ExcC14NParameterSpecTests (The complementary j8unit test interface containing the
...
extends C14NMethodParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.ExcC14NParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.ExcC14NParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * {@link ExcC14NParameterSpec public final class javax.xml.crypto.dsig.spec.ExcC14NParameterSpec}.
 *
...
public abstract interface ExcC14NParameterSpecClassTests<SUT extends ExcC14NParameterSpec>
extends C14NMethodParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExcC14NParameterSpec.class!",

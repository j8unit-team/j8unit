 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SwingWorkerTests}).
 * </p>
 *
 * <p>
 ...
 * @see SwingWorkerTests SwingWorkerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.concurrent.RunnableFutureClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.SwingWorker.class!",
                   javax.swing.SwingWorker.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.SwingWorker.StateValue class
     * javax.swing.SwingWorker$StateValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link SwingWorkerTests.StateValueTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see SwingWorkerTests.StateValueTests SwingWorkerTests.StateValueTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.SwingWorker.StateValue.class!",
                       javax.swing.SwingWorker.StateValue.class.isAssignableFrom(sut));
        }

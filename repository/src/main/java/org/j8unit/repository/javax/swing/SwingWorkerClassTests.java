 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SwingWorker public
 * abstract class javax.swing.SwingWorker<T,V>}.
 *
...
extends RunnableFutureClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SwingWorker.class!",
     ...
     * {@link StateValue public static final enum javax.swing.SwingWorker$StateValue}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

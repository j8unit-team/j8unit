 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetFactory
 * public abstract interface javax.sql.rowset.RowSetFactory}.
 *
...
public abstract interface RowSetFactoryClassTests<SUT extends RowSetFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetFactory.class!",
                   RowSetFactory.class.isAssignableFrom(sut));
    }

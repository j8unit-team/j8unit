 ...
 * javax.sql.rowset.RowSetFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetFactoryTests}.
 * </p>
 *
 * @see javax.sql.rowset.RowSetFactory interface javax.sql.rowset.RowSetFactory (the hereby targeted class-under-test
 *      class)
 * @see RowSetFactoryTests RowSetFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RowSetFactoryClassTests<SUT extends javax.sql.rowset.RowSetFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.RowSetFactory.class!",
                   javax.sql.rowset.RowSetFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OctetStreamData
 * public class javax.xml.crypto.OctetStreamData}.
 *
...
public abstract interface OctetStreamDataClassTests<SUT extends OctetStreamData>
extends DataClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OctetStreamData.class!",

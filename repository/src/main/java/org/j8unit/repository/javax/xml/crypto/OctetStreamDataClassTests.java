...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.OctetStreamData class
 * javax.xml.crypto.OctetStreamData}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OctetStreamDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OctetStreamDataTests}.
 * </p>
 *
 * @see javax.xml.crypto.OctetStreamData class javax.xml.crypto.OctetStreamData (the hereby targeted class-under-test
 *      class)
 * @see OctetStreamDataTests OctetStreamDataTests (The complementary j8unit test interface containing the instance
...
public abstract interface OctetStreamDataClassTests<SUT extends javax.xml.crypto.OctetStreamData>
extends DataClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.OctetStreamData.class!",
                   javax.xml.crypto.OctetStreamData.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MatteBorder public
...
public abstract interface MatteBorderClassTests<SUT extends MatteBorder>
extends EmptyBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MatteBorder.class!",
                   MatteBorder.class.isAssignableFrom(sut));
    }

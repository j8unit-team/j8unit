 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MatteBorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MatteBorderTests}.
 * </p>
 *
 * @see javax.swing.border.MatteBorder class javax.swing.border.MatteBorder (the hereby targeted class-under-test class)
 * @see MatteBorderTests MatteBorderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends EmptyBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.MatteBorder.class!",
                   javax.swing.border.MatteBorder.class.isAssignableFrom(sut));
    }

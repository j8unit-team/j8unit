 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JComboBoxTests}).
 * </p>
 *
 * <p>
 ...
 * @see JComboBoxTests JComboBoxTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JComboBox.class!",
                   javax.swing.JComboBox.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JComboBox.KeySelectionManager interface
     * javax.swing.JComboBox$KeySelectionManager}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link JComboBoxTests.KeySelectionManagerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see JComboBoxTests.KeySelectionManagerTests JComboBoxTests.KeySelectionManagerTests (The complementary j8unit
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JComboBox.KeySelectionManager.class!",
                       javax.swing.JComboBox.KeySelectionManager.class.isAssignableFrom(sut));
        }

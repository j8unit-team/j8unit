 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CellEditor public
 * abstract interface javax.swing.CellEditor}.
 *
...
public abstract interface CellEditorClassTests<SUT extends CellEditor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CellEditor.class!",
                   CellEditor.class.isAssignableFrom(sut));
    }

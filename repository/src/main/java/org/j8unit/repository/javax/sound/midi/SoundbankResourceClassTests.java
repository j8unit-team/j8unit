 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SoundbankResource
 * public abstract class javax.sound.midi.SoundbankResource}.
 *
...
public abstract interface SoundbankResourceClassTests<SUT extends SoundbankResource>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SoundbankResource.class!",
                   SoundbankResource.class.isAssignableFrom(sut));
    }

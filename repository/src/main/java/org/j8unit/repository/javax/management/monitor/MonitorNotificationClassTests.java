 ...
 * javax.management.monitor.MonitorNotification}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MonitorNotificationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MonitorNotificationTests}.
 * </p>
 *
 * @see javax.management.monitor.MonitorNotification class javax.management.monitor.MonitorNotification (the hereby
 *      targeted class-under-test class)
 * @see MonitorNotificationTests MonitorNotificationTests (The complementary j8unit test interface containing the
...
public abstract interface MonitorNotificationClassTests<SUT extends javax.management.monitor.MonitorNotification>
extends org.j8unit.repository.javax.management.NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.MonitorNotification.class!",
                   javax.management.monitor.MonitorNotification.class.isAssignableFrom(sut));
    }

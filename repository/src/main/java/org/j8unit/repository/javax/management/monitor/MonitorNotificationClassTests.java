 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MonitorNotification
 * public class javax.management.monitor.MonitorNotification}.
 *
...
public abstract interface MonitorNotificationClassTests<SUT extends MonitorNotification>
extends NotificationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MonitorNotification.class!",
                   MonitorNotification.class.isAssignableFrom(sut));
    }

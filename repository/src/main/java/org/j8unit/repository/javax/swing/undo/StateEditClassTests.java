 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StateEdit public
...
public abstract interface StateEditClassTests<SUT extends StateEdit>
extends AbstractUndoableEditClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.undo.StateEdit]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StateEdit.class!",
                   StateEdit.class.isAssignableFrom(sut));
    }

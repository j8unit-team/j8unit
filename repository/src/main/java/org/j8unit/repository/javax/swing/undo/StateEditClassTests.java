 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StateEditTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StateEditTests}.
 * </p>
 *
 * @see javax.swing.undo.StateEdit class javax.swing.undo.StateEdit (the hereby targeted class-under-test class)
 * @see StateEditTests StateEditTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends AbstractUndoableEditClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.undo.StateEdit.class!",
                   javax.swing.undo.StateEdit.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.soap.Detail interface javax.xml.soap.Detail}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DetailTests}).
 * </p>
 *
 * <p>
 ...
 * @see DetailTests DetailTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DetailClassTests<SUT extends javax.xml.soap.Detail>
extends SOAPFaultElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.Detail.class!",
                   javax.xml.soap.Detail.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.ActionMapClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActionMapUIResource
 * public class javax.swing.plaf.ActionMapUIResource}.
 *
...
public abstract interface ActionMapUIResourceClassTests<SUT extends ActionMapUIResource>
extends UIResourceClassTests<SUT>, ActionMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActionMapUIResource.class!",
                   ActionMapUIResource.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.ActionMapUIResource]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.ActionMapUIResource]

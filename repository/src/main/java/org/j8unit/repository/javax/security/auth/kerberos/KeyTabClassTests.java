 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyTab public final
...
public abstract interface KeyTabClassTests<SUT extends KeyTab>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyTab.class!",
                   KeyTab.class.isAssignableFrom(sut));
    }

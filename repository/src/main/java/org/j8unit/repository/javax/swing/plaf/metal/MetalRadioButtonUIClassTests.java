 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalRadioButtonUI
 * public class javax.swing.plaf.metal.MetalRadioButtonUI}.
 *
...
extends org.j8unit.repository.javax.swing.plaf.basic.BasicRadioButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalRadioButtonUI.class!",
                   MetalRadioButtonUI.class.isAssignableFrom(sut));
    }

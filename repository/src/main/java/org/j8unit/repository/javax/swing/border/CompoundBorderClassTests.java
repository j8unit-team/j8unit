 ...
 * javax.swing.border.CompoundBorder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompoundBorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompoundBorderTests}.
 * </p>
 *
 * @see javax.swing.border.CompoundBorder class javax.swing.border.CompoundBorder (the hereby targeted class-under-test
 *      class)
 * @see CompoundBorderTests CompoundBorderTests (The complementary j8unit test interface containing the instance
...
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.CompoundBorder.class!",
                   javax.swing.border.CompoundBorder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompoundBorder
...
public abstract interface CompoundBorderClassTests<SUT extends CompoundBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompoundBorder.class!",
                   CompoundBorder.class.isAssignableFrom(sut));
    }

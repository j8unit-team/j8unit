 ...
 * javax.swing.text.html.parser.AttributeList}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeListTests}).
 * </p>
 *
 * <p>
 ...
 * @see AttributeListTests AttributeListTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends DTDConstantsClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.parser.AttributeList.class!",
                   javax.swing.text.html.parser.AttributeList.class.isAssignableFrom(sut));
    }

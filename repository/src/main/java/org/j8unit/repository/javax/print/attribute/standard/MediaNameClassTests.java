...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.MediaName class
 * javax.print.attribute.standard.MediaName}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MediaNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MediaNameTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.MediaName class javax.print.attribute.standard.MediaName (the hereby targeted
 *      class-under-test class)
 * @see MediaNameTests MediaNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MediaNameClassTests<SUT extends javax.print.attribute.standard.MediaName>
extends org.j8unit.repository.javax.print.attribute.AttributeClassTests<SUT>, MediaClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.MediaName.class!",
                   javax.print.attribute.standard.MediaName.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MediaName public
...
public abstract interface MediaNameClassTests<SUT extends MediaName>
extends org.j8unit.repository.javax.print.attribute.standard.MediaClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MediaName.class!",

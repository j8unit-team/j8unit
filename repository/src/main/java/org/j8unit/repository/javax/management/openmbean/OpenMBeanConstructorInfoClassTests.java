...
public abstract interface OpenMBeanConstructorInfoClassTests<SUT extends OpenMBeanConstructorInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanConstructorInfo.class!",
                   OpenMBeanConstructorInfo.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.plaf.basic.BasicComboBoxEditorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalComboBoxEditor
 * public class javax.swing.plaf.metal.MetalComboBoxEditor}.
 *
...
public abstract interface MetalComboBoxEditorClassTests<SUT extends MetalComboBoxEditor>
extends BasicComboBoxEditorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalComboBoxEditor.class!",
                   MetalComboBoxEditor.class.isAssignableFrom(sut));
    }
     ...
     * {@link UIResource public static class javax.swing.plaf.metal.MetalComboBoxEditor$UIResource}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

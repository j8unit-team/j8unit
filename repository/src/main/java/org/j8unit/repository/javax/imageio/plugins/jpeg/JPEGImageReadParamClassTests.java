...
import org.j8unit.repository.javax.imageio.ImageReadParamClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JPEGImageReadParam
 * public class javax.imageio.plugins.jpeg.JPEGImageReadParam}.
 *
...
public abstract interface JPEGImageReadParamClassTests<SUT extends JPEGImageReadParam>
extends ImageReadParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JPEGImageReadParam.class!",
                   JPEGImageReadParam.class.isAssignableFrom(sut));
    }

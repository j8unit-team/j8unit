 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UndoableEditSupport
 * public class javax.swing.undo.UndoableEditSupport}.
 *
...
public abstract interface UndoableEditSupportClassTests<SUT extends UndoableEditSupport>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.undo.UndoableEditSupport]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UndoableEditSupport.class!",
                   UndoableEditSupport.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMCryptoContext
 * public class javax.xml.crypto.dom.DOMCryptoContext}.
 *
...
public abstract interface DOMCryptoContextClassTests<SUT extends DOMCryptoContext>
extends XMLCryptoContextClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMCryptoContext.class!",
                   DOMCryptoContext.class.isAssignableFrom(sut));
    }

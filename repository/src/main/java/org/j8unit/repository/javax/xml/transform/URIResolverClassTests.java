 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URIResolver public
 * abstract interface javax.xml.transform.URIResolver}.
 *
...
public abstract interface URIResolverClassTests<SUT extends URIResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URIResolver.class!",
                   URIResolver.class.isAssignableFrom(sut));
    }

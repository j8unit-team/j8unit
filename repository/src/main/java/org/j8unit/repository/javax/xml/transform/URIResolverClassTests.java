 ...
 * javax.xml.transform.URIResolver}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URIResolverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URIResolverTests}.
 * </p>
 *
 * @see javax.xml.transform.URIResolver interface javax.xml.transform.URIResolver (the hereby targeted class-under-test
 *      class)
 * @see URIResolverTests URIResolverTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface URIResolverClassTests<SUT extends javax.xml.transform.URIResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.URIResolver.class!",
                   javax.xml.transform.URIResolver.class.isAssignableFrom(sut));
    }

...
public abstract interface BasicRadioButtonMenuItemUIClassTests<SUT extends BasicRadioButtonMenuItemUI>
extends BasicMenuItemUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicRadioButtonMenuItemUI.class!",
                   BasicRadioButtonMenuItemUI.class.isAssignableFrom(sut));
    }

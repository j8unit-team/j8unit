...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.Service class javax.xml.ws.Service}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.ws.Service class javax.xml.ws.Service (the hereby targeted class-under-test class)
 * @see ServiceTests ServiceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.Service.class!",
                   javax.xml.ws.Service.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceTests.ModeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * {@link ServiceTests.ModeTests}.
     * </p>
     *
     * @see javax.xml.ws.Service.Mode class javax.xml.ws.Service$Mode (the hereby targeted class-under-test class)
     * @see ServiceTests.ModeTests ServiceTests.ModeTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.Service.Mode.class!",
                       javax.xml.ws.Service.Mode.class.isAssignableFrom(sut));
        }

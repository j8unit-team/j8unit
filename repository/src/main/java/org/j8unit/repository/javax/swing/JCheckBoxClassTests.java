 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JCheckBox public
...
public abstract interface JCheckBoxClassTests<SUT extends JCheckBox>
extends JToggleButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JCheckBox.class!",
                   JCheckBox.class.isAssignableFrom(sut));
    }

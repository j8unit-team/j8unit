 ...
 * javax.swing.text.html.InlineView}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InlineViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InlineViewTests}.
 * </p>
 *
 * @see javax.swing.text.html.InlineView class javax.swing.text.html.InlineView (the hereby targeted class-under-test
 *      class)
 * @see InlineViewTests InlineViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.text.LabelViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.html.InlineView.class!",
                   javax.swing.text.html.InlineView.class.isAssignableFrom(sut));
    }

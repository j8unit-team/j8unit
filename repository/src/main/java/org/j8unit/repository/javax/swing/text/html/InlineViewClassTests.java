...
import org.j8unit.repository.javax.swing.text.LabelViewClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InlineView public
...
public abstract interface InlineViewClassTests<SUT extends InlineView>
extends LabelViewClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.html.InlineView]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InlineView.class!",
                   InlineView.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.text.html.InlineView]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.text.html.InlineView]

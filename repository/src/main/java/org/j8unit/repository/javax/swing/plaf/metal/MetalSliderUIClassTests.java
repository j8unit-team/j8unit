 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalSliderUI
...
extends org.j8unit.repository.javax.swing.plaf.basic.BasicSliderUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalSliderUI.class!",
                   MetalSliderUI.class.isAssignableFrom(sut));
    }

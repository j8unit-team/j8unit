 ...
 * javax.swing.plaf.metal.MetalSliderUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetalSliderUITests}).
 * </p>
 *
 * <p>
 ...
 * @see MetalSliderUITests MetalSliderUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.basic.BasicSliderUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalSliderUI.class!",
                   javax.swing.plaf.metal.MetalSliderUI.class.isAssignableFrom(sut));
    }

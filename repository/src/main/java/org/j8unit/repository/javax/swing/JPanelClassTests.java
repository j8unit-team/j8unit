...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JPanel class javax.swing.JPanel}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JPanelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JPanelTests}.
 * </p>
 *
 * @see javax.swing.JPanel class javax.swing.JPanel (the hereby targeted class-under-test class)
 * @see JPanelTests JPanelTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface JPanelClassTests<SUT extends javax.swing.JPanel>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JPanel.class!",
                   javax.swing.JPanel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JPanel public class
 * javax.swing.JPanel}.
 *
...
public abstract interface JPanelClassTests<SUT extends JPanel>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JPanel.class!",
                   JPanel.class.isAssignableFrom(sut));
    }

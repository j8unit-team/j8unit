 ...
 * javax.annotation.processing.Processor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProcessorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProcessorTests}.
 * </p>
 *
 * @see javax.annotation.processing.Processor interface javax.annotation.processing.Processor (the hereby targeted
 *      class-under-test class)
 * @see ProcessorTests ProcessorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ProcessorClassTests<SUT extends javax.annotation.processing.Processor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.Processor.class!",
                   javax.annotation.processing.Processor.class.isAssignableFrom(sut));
    }

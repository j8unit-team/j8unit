 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Processor public
 * abstract interface javax.annotation.processing.Processor}.
 *
...
public abstract interface ProcessorClassTests<SUT extends Processor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Processor.class!",
                   Processor.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalScrollBarUI
 * public class javax.swing.plaf.metal.MetalScrollBarUI}.
 *
...
public abstract interface MetalScrollBarUIClassTests<SUT extends MetalScrollBarUI>
extends BasicScrollBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalScrollBarUI.class!",
                   MetalScrollBarUI.class.isAssignableFrom(sut));
    }

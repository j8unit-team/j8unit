...
import org.j8unit.repository.java.awt.DialogClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JDialog public
...
public abstract interface JDialogClassTests<SUT extends JDialog>
extends WindowConstantsClassTests<SUT>, RootPaneContainerClassTests<SUT>, DialogClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JDialog.class!",

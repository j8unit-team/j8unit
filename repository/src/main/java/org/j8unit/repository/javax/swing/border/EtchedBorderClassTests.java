 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EtchedBorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EtchedBorderTests}.
 * </p>
 *
 * @see javax.swing.border.EtchedBorder class javax.swing.border.EtchedBorder (the hereby targeted class-under-test
 *      class)
 * @see EtchedBorderTests EtchedBorderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.EtchedBorder.class!",
                   javax.swing.border.EtchedBorder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EtchedBorder public
...
public abstract interface EtchedBorderClassTests<SUT extends EtchedBorder>
extends AbstractBorderClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.border.EtchedBorder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EtchedBorder.class!",
                   EtchedBorder.class.isAssignableFrom(sut));
    }

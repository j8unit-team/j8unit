 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GrayFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GrayFilterTests}.
 * </p>
 *
 * @see javax.swing.GrayFilter class javax.swing.GrayFilter (the hereby targeted class-under-test class)
 * @see GrayFilterTests GrayFilterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.image.RGBImageFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.GrayFilter.class!",
                   javax.swing.GrayFilter.class.isAssignableFrom(sut));
    }

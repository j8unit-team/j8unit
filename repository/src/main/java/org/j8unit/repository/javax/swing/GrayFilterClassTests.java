...
import org.j8unit.repository.java.awt.image.RGBImageFilterClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GrayFilter public
...
public abstract interface GrayFilterClassTests<SUT extends GrayFilter>
extends RGBImageFilterClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.GrayFilter]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GrayFilter.class!",

 ...
 * javax.naming.directory.InvalidAttributesException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see InvalidAttributesExceptionTests InvalidAttributesExceptionTests (The complementary j8unit test interface
...
public abstract interface InvalidAttributesExceptionClassTests<SUT extends javax.naming.directory.InvalidAttributesException>
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.InvalidAttributesException.class!",
                   javax.naming.directory.InvalidAttributesException.class.isAssignableFrom(sut));
    }

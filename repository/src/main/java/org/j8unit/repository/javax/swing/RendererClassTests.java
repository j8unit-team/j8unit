 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RendererTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RendererTests}.
 * </p>
 *
 * @see javax.swing.Renderer interface javax.swing.Renderer (the hereby targeted class-under-test class)
 * @see RendererTests RendererTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RendererClassTests<SUT extends javax.swing.Renderer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.Renderer.class!",
                   javax.swing.Renderer.class.isAssignableFrom(sut));
    }

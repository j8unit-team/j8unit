 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Renderer public
 * abstract interface javax.swing.Renderer}.
 *
...
public abstract interface RendererClassTests<SUT extends Renderer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Renderer.class!",
                   Renderer.class.isAssignableFrom(sut));
    }

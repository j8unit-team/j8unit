 ...
 * {@link InvalidSearchFilterException public class javax.naming.directory.InvalidSearchFilterException}.
 *
...
public abstract interface InvalidSearchFilterExceptionClassTests<SUT extends InvalidSearchFilterException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidSearchFilterException.class!",
                   InvalidSearchFilterException.class.isAssignableFrom(sut));
    }

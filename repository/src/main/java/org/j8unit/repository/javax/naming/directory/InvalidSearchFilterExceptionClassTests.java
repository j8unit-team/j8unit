 ...
 * javax.naming.directory.InvalidSearchFilterException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidSearchFilterExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidSearchFilterExceptionTests InvalidSearchFilterExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.javax.naming.NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.InvalidSearchFilterException.class!",
                   javax.naming.directory.InvalidSearchFilterException.class.isAssignableFrom(sut));
    }

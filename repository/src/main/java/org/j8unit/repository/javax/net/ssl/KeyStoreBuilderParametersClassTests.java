 ...
 * {@link KeyStoreBuilderParameters public class javax.net.ssl.KeyStoreBuilderParameters}.
 *
...
public abstract interface KeyStoreBuilderParametersClassTests<SUT extends KeyStoreBuilderParameters>
extends org.j8unit.repository.javax.net.ssl.ManagerFactoryParametersClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyStoreBuilderParameters.class!",
                   KeyStoreBuilderParameters.class.isAssignableFrom(sut));
    }

 ...
 * javax.net.ssl.KeyStoreBuilderParameters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link KeyStoreBuilderParametersTests}).
 * </p>
 *
 * <p>
 ...
 * @see KeyStoreBuilderParametersTests KeyStoreBuilderParametersTests (The complementary j8unit test interface
...
extends ManagerFactoryParametersClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.KeyStoreBuilderParameters.class!",
                   javax.net.ssl.KeyStoreBuilderParameters.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecretKeyTests}).
 * </p>
 *
 * <p>
 ...
 * @see SecretKeyTests SecretKeyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SecretKeyClassTests<SUT extends javax.crypto.SecretKey>
extends org.j8unit.repository.java.security.KeyClassTests<SUT>, org.j8unit.repository.javax.security.auth.DestroyableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.SecretKey.class!",
                   javax.crypto.SecretKey.class.isAssignableFrom(sut));
    }

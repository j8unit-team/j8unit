 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecretKey public
 * abstract interface javax.crypto.SecretKey}.
 *
...
extends KeyClassTests<SUT>, DestroyableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecretKey.class!",

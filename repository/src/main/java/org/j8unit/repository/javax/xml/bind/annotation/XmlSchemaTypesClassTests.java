 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlSchemaTypes
...
public abstract interface XmlSchemaTypesClassTests<SUT extends XmlSchemaTypes>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlSchemaTypes.class!",
                   XmlSchemaTypes.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlSchemaTypes interface
 * javax.xml.bind.annotation.XmlSchemaTypes}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlSchemaTypesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlSchemaTypesTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlSchemaTypes interface javax.xml.bind.annotation.XmlSchemaTypes (the hereby targeted
 *      class-under-test class)
 * @see XmlSchemaTypesTests XmlSchemaTypesTests (The complementary j8unit test interface containing the instance
...
public abstract interface XmlSchemaTypesClassTests<SUT extends javax.xml.bind.annotation.XmlSchemaTypes>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlSchemaTypes.class!",
                   javax.xml.bind.annotation.XmlSchemaTypes.class.isAssignableFrom(sut));
    }

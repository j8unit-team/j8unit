 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectInstance
...
public abstract interface ObjectInstanceClassTests<SUT extends ObjectInstance>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectInstance.class!",
                   ObjectInstance.class.isAssignableFrom(sut));
    }

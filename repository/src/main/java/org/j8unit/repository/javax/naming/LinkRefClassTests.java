...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.LinkRef class javax.naming.LinkRef}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkRefTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkRefTests}.
 * </p>
 *
 * @see javax.naming.LinkRef class javax.naming.LinkRef (the hereby targeted class-under-test class)
 * @see LinkRefTests LinkRefTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.LinkRef.class!",
                   javax.naming.LinkRef.class.isAssignableFrom(sut));
    }

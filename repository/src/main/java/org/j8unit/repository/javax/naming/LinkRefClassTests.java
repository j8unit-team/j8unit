 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkRef public
...
public abstract interface LinkRefClassTests<SUT extends LinkRef>
extends ReferenceClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.naming.LinkRef]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkRef.class!",
                   LinkRef.class.isAssignableFrom(sut));
    }

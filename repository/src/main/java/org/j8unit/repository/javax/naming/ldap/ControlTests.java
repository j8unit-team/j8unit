 ...
 * non-{@code static} methods) of {@linkplain javax.naming.ldap.Control interface javax.naming.ldap.Control}. The
...
extends org.j8unit.repository.java.io.SerializableTests<SUT> {
     ...
     * </p>
     *
     * @see javax.naming.ldap.Control#getID() public abstract java.lang.String javax.naming.ldap.Control.getID() (the
     ...
     * </p>
     *
     * @see javax.naming.ldap.Control#isCritical() public abstract boolean javax.naming.ldap.Control.isCritical() (the
     *      hereby targeted method-under-test)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
     ...
     * </p>
     *
     * @see javax.naming.ldap.Control#getEncodedValue() public abstract byte[]
     *      javax.naming.ldap.Control.getEncodedValue() (the hereby targeted method-under-test)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)

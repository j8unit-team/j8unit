 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Binder public
...
public abstract interface BinderClassTests<SUT extends Binder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Binder.class!",
                   Binder.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BinderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BinderTests}.
 * </p>
 *
 * @see javax.xml.bind.Binder class javax.xml.bind.Binder (the hereby targeted class-under-test class)
 * @see BinderTests BinderTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.Binder.class!",
                   javax.xml.bind.Binder.class.isAssignableFrom(sut));
    }

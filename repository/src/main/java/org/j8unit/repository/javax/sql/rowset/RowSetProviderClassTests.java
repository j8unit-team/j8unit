 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetProvider
...
public abstract interface RowSetProviderClassTests<SUT extends RowSetProvider>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.sql.rowset.RowSetProvider]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetProvider.class!",
                   RowSetProvider.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetProviderTests}.
 * </p>
 *
 * @see javax.sql.rowset.RowSetProvider class javax.sql.rowset.RowSetProvider (the hereby targeted class-under-test
 *      class)
 * @see RowSetProviderTests RowSetProviderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.RowSetProvider.class!",
                   javax.sql.rowset.RowSetProvider.class.isAssignableFrom(sut));
    }

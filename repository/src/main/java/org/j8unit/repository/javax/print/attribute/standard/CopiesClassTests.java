 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Copies public final
...
public abstract interface CopiesClassTests<SUT extends Copies>
extends PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Copies.class!",
                   Copies.class.isAssignableFrom(sut));
    }

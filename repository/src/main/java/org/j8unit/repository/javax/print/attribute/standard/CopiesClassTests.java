...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.Copies class
 * javax.print.attribute.standard.Copies}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CopiesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CopiesTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.Copies class javax.print.attribute.standard.Copies (the hereby targeted
 *      class-under-test class)
 * @see CopiesTests CopiesTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.print.attribute.PrintJobAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.Copies.class!",
                   javax.print.attribute.standard.Copies.class.isAssignableFrom(sut));
    }

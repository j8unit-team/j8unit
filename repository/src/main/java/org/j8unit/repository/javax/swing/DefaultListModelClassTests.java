 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultListModel
 * public class javax.swing.DefaultListModel<E>}.
 *
...
public abstract interface DefaultListModelClassTests<SUT extends DefaultListModel>
extends AbstractListModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultListModel.class!",
                   DefaultListModel.class.isAssignableFrom(sut));
    }

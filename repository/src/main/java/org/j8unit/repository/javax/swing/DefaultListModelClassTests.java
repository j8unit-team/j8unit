...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.DefaultListModel class javax.swing.DefaultListModel},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultListModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultListModelTests}.
 * </p>
 *
 * @see javax.swing.DefaultListModel class javax.swing.DefaultListModel (the hereby targeted class-under-test class)
 * @see DefaultListModelTests DefaultListModelTests (The complementary j8unit test interface containing the instance
...
extends AbstractListModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.DefaultListModel.class!",
                   javax.swing.DefaultListModel.class.isAssignableFrom(sut));
    }

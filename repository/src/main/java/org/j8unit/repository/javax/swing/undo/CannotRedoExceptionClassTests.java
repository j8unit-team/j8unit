 ...
 * javax.swing.undo.CannotRedoException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CannotRedoExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CannotRedoExceptionTests}.
 * </p>
 *
 * @see javax.swing.undo.CannotRedoException class javax.swing.undo.CannotRedoException (the hereby targeted
 *      class-under-test class)
 * @see CannotRedoExceptionTests CannotRedoExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.undo.CannotRedoException.class!",
                   javax.swing.undo.CannotRedoException.class.isAssignableFrom(sut));
    }

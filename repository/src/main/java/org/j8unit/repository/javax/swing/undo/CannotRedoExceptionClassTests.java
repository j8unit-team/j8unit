 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CannotRedoException
 * public class javax.swing.undo.CannotRedoException}.
 *
...
public abstract interface CannotRedoExceptionClassTests<SUT extends CannotRedoException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CannotRedoException.class!",
                   CannotRedoException.class.isAssignableFrom(sut));
    }

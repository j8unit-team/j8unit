 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ColorSelectionModel
 * public abstract interface javax.swing.colorchooser.ColorSelectionModel}.
 *
...
public abstract interface ColorSelectionModelClassTests<SUT extends ColorSelectionModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorSelectionModel.class!",
                   ColorSelectionModel.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.awt.FontClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FontUIResource
...
public abstract interface FontUIResourceClassTests<SUT extends FontUIResource>
extends UIResourceClassTests<SUT>, FontClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FontUIResource.class!",
                   FontUIResource.class.isAssignableFrom(sut));
    }

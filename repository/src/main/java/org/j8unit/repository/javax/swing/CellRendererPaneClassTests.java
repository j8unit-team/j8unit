 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CellRendererPane
...
public abstract interface CellRendererPaneClassTests<SUT extends CellRendererPane>
extends AccessibleClassTests<SUT>, ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CellRendererPane.class!",
                   CellRendererPane.class.isAssignableFrom(sut));
    }

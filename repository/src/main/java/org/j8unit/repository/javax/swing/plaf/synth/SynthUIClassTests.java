 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthUI public
...
public abstract interface SynthUIClassTests<SUT extends SynthUI>
extends SynthConstantsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthUI.class!",
                   SynthUI.class.isAssignableFrom(sut));
    }

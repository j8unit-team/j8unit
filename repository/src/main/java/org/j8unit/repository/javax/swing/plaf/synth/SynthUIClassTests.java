 ...
 * javax.swing.plaf.synth.SynthUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthUITests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthUI interface javax.swing.plaf.synth.SynthUI (the hereby targeted class-under-test
 *      class)
 * @see SynthUITests SynthUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SynthUIClassTests<SUT extends javax.swing.plaf.synth.SynthUI>
extends SynthConstantsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthUI.class!",
                   javax.swing.plaf.synth.SynthUI.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowMapperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowMapperTests}.
 * </p>
 *
 * @see javax.swing.tree.RowMapper interface javax.swing.tree.RowMapper (the hereby targeted class-under-test class)
 * @see RowMapperTests RowMapperTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RowMapperClassTests<SUT extends javax.swing.tree.RowMapper>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.tree.RowMapper.class!",
                   javax.swing.tree.RowMapper.class.isAssignableFrom(sut));
    }

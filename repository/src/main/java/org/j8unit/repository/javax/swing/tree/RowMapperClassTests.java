 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowMapper public
 * abstract interface javax.swing.tree.RowMapper}.
 *
...
public abstract interface RowMapperClassTests<SUT extends RowMapper>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowMapper.class!",
                   RowMapper.class.isAssignableFrom(sut));
    }

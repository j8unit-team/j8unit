 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextAction public
...
extends org.j8unit.repository.javax.swing.AbstractActionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextAction.class!",
                   TextAction.class.isAssignableFrom(sut));
    }

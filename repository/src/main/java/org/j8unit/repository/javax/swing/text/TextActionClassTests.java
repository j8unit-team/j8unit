 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextActionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.text.TextAction class javax.swing.text.TextAction (the hereby targeted class-under-test class)
 * @see TextActionTests TextActionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.AbstractActionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.TextAction.class!",
                   javax.swing.text.TextAction.class.isAssignableFrom(sut));
    }

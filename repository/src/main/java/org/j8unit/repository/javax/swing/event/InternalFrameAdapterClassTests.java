 ...
 * javax.swing.event.InternalFrameAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InternalFrameAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InternalFrameAdapterTests}
 * .
 * </p>
 *
 * @see javax.swing.event.InternalFrameAdapter class javax.swing.event.InternalFrameAdapter (the hereby targeted
 *      class-under-test class)
 * @see InternalFrameAdapterTests InternalFrameAdapterTests (The complementary j8unit test interface containing the
...
extends InternalFrameListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.InternalFrameAdapter.class!",
                   javax.swing.event.InternalFrameAdapter.class.isAssignableFrom(sut));
    }

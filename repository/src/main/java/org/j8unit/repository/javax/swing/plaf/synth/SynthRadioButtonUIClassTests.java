 ...
 * javax.swing.plaf.synth.SynthRadioButtonUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthRadioButtonUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynthRadioButtonUITests}.
 * </p>
 *
 * @see javax.swing.plaf.synth.SynthRadioButtonUI class javax.swing.plaf.synth.SynthRadioButtonUI (the hereby targeted
 *      class-under-test class)
 * @see SynthRadioButtonUITests SynthRadioButtonUITests (The complementary j8unit test interface containing the instance
...
extends SynthToggleButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthRadioButtonUI.class!",
                   javax.swing.plaf.synth.SynthRadioButtonUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthRadioButtonUI
 * public class javax.swing.plaf.synth.SynthRadioButtonUI}.
 *
...
public abstract interface SynthRadioButtonUIClassTests<SUT extends SynthRadioButtonUI>
extends SynthToggleButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthRadioButtonUI.class!",
                   SynthRadioButtonUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.event.TreeModelListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeModelListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeModelListenerTests}.
 * </p>
 *
 * @see javax.swing.event.TreeModelListener interface javax.swing.event.TreeModelListener (the hereby targeted
 *      class-under-test class)
 * @see TreeModelListenerTests TreeModelListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface TreeModelListenerClassTests<SUT extends javax.swing.event.TreeModelListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TreeModelListener.class!",
                   javax.swing.event.TreeModelListener.class.isAssignableFrom(sut));
    }

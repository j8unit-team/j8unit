 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeModelListener
 * public abstract interface javax.swing.event.TreeModelListener}.
 *
...
public abstract interface TreeModelListenerClassTests<SUT extends TreeModelListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeModelListener.class!",
                   TreeModelListener.class.isAssignableFrom(sut));
    }

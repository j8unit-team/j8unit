...
/**
 * <p>
 * Test class for {@link javax.management.monitor.Monitor class javax.management.monitor.Monitor},
 * containing all class relevant test methods (at least the test methods of accessible constructors and
 * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
 * methods is {@link org.j8unit.repository.javax.management.monitor.MonitorTests}.
 * </p>
 *
 * <p>
        ...
        org.j8unit.repository.javax.management.NotificationBroadcasterSupportClassTests<SUT>
{
    ...
    public default void create_Monitor() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        javax.management.monitor.Monitor sut = null; // = new Monitor();
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends javax.management.monitor.Monitor> sut = createNewSUT();

 ...
 * javax.management.monitor.Monitor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MonitorTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see MonitorTests MonitorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MonitorClassTests<SUT extends javax.management.monitor.Monitor>
extends MonitorMBeanClassTests<SUT>, org.j8unit.repository.javax.management.MBeanRegistrationClassTests<SUT>,
org.j8unit.repository.javax.management.NotificationBroadcasterSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.Monitor.class!",
                   javax.management.monitor.Monitor.class.isAssignableFrom(sut));
    }

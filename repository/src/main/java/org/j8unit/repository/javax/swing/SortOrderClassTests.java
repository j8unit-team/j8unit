 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SortOrder public
 * final enum javax.swing.SortOrder}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SortOrderTests}.
 * </p>
 *
 * <p>
...
public abstract interface SortOrderClassTests<SUT extends SortOrder>
extends EnumClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.SortOrder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SortOrder.class!",
                   SortOrder.class.isAssignableFrom(sut));
    }

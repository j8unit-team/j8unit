 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CardExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CardExceptionTests}.
 * </p>
 *
 * @see javax.smartcardio.CardException class javax.smartcardio.CardException (the hereby targeted class-under-test
 *      class)
 * @see CardExceptionTests CardExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.smartcardio.CardException.class!",
                   javax.smartcardio.CardException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CardException
...
public abstract interface CardExceptionClassTests<SUT extends CardException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CardException.class!",
                   CardException.class.isAssignableFrom(sut));
    }

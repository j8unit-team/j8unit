 ...
 * javax.security.cert.X509Certificate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
extends CertificateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.cert.X509Certificate.class!",
                   javax.security.cert.X509Certificate.class.isAssignableFrom(sut));
    }

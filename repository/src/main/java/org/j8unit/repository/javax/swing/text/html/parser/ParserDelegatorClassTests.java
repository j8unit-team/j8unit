 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParserDelegator
...
public abstract interface ParserDelegatorClassTests<SUT extends ParserDelegator>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.javax.swing.text.html.HTMLEditorKitClassTests.ParserClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParserDelegator.class!",
                   ParserDelegator.class.isAssignableFrom(sut));
    }

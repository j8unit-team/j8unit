...
import org.j8unit.repository.java.sql.SQLOutputClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLOutputImpl
...
public abstract interface SQLOutputImplClassTests<SUT extends SQLOutputImpl>
extends SQLOutputClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLOutputImpl.class!",
                   SQLOutputImpl.class.isAssignableFrom(sut));
    }

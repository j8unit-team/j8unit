 ...
 * javax.sql.rowset.serial.SQLOutputImpl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLOutputImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLOutputImplTests}.
 * </p>
 *
 * @see javax.sql.rowset.serial.SQLOutputImpl class javax.sql.rowset.serial.SQLOutputImpl (the hereby targeted
 *      class-under-test class)
 * @see SQLOutputImplTests SQLOutputImplTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.sql.SQLOutputClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SQLOutputImpl.class!",
                   javax.sql.rowset.serial.SQLOutputImpl.class.isAssignableFrom(sut));
    }

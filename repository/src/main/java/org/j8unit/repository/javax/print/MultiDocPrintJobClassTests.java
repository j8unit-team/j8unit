 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiDocPrintJob
 * public abstract interface javax.print.MultiDocPrintJob}.
 *
...
extends DocPrintJobClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiDocPrintJob.class!",
                   MultiDocPrintJob.class.isAssignableFrom(sut));
    }

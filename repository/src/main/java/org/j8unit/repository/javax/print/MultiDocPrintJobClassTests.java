 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiDocPrintJobTests}).
 * </p>
 *
 * <p>
 ...
 * @see MultiDocPrintJobTests MultiDocPrintJobTests (The complementary j8unit test interface containing the instance
...
public abstract interface MultiDocPrintJobClassTests<SUT extends javax.print.MultiDocPrintJob>
extends DocPrintJobClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.MultiDocPrintJob.class!",
                   javax.print.MultiDocPrintJob.class.isAssignableFrom(sut));
    }

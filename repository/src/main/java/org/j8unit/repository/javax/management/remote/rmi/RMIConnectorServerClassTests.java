...
extends org.j8unit.repository.javax.management.remote.JMXConnectorServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        @SuppressWarnings("unused")
        final javax.management.remote.rmi.RMIConnectorServer sut = null; // = new
                                                                         // RMIConnectorServer(javax.management.remote.JMXServiceURL,java.util.Map,javax.management.MBeanServer);
    }
    ...
    throws Exception {
        // create new instance
        final Class<? extends javax.management.remote.rmi.RMIConnectorServer> sut = createNewSUT();

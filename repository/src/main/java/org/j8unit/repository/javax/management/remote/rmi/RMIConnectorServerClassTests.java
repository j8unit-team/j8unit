...
import org.j8unit.repository.javax.management.remote.JMXConnectorServerClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIConnectorServer
 * public class javax.management.remote.rmi.RMIConnectorServer}.
 *
...
public abstract interface RMIConnectorServerClassTests<SUT extends RMIConnectorServer>
extends JMXConnectorServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIConnectorServer.class!",
                   RMIConnectorServer.class.isAssignableFrom(sut));
    }

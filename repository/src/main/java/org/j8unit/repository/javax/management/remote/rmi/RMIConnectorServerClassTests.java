 ...
 * javax.management.remote.rmi.RMIConnectorServer}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIConnectorServerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIConnectorServerTests}.
 * </p>
 *
 * @see javax.management.remote.rmi.RMIConnectorServer class javax.management.remote.rmi.RMIConnectorServer (the hereby
 *      targeted class-under-test class)
 * @see RMIConnectorServerTests RMIConnectorServerTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.management.remote.JMXConnectorServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIConnectorServer.class!",
                   javax.management.remote.rmi.RMIConnectorServer.class.isAssignableFrom(sut));
    }

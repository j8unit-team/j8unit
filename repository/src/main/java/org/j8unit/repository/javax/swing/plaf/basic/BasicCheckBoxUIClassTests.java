 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicCheckBoxUI
 * public class javax.swing.plaf.basic.BasicCheckBoxUI}.
 *
...
public abstract interface BasicCheckBoxUIClassTests<SUT extends BasicCheckBoxUI>
extends BasicRadioButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicCheckBoxUI.class!",
                   BasicCheckBoxUI.class.isAssignableFrom(sut));
    }

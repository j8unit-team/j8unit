...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.UnmarshallerHandler interface
 * javax.xml.bind.UnmarshallerHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnmarshallerHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnmarshallerHandlerTests}.
 * </p>
 *
 * @see javax.xml.bind.UnmarshallerHandler interface javax.xml.bind.UnmarshallerHandler (the hereby targeted
 *      class-under-test class)
 * @see UnmarshallerHandlerTests UnmarshallerHandlerTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.xml.sax.ContentHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.UnmarshallerHandler.class!",
                   javax.xml.bind.UnmarshallerHandler.class.isAssignableFrom(sut));
    }

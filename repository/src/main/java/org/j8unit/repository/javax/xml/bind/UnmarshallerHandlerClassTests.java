 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnmarshallerHandler
 * public abstract interface javax.xml.bind.UnmarshallerHandler}.
 *
...
public abstract interface UnmarshallerHandlerClassTests<SUT extends UnmarshallerHandler>
extends ContentHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnmarshallerHandler.class!",
                   UnmarshallerHandler.class.isAssignableFrom(sut));
    }

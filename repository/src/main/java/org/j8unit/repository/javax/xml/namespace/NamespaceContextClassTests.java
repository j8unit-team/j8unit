 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamespaceContext
 * public abstract interface javax.xml.namespace.NamespaceContext}.
 *
...
public abstract interface NamespaceContextClassTests<SUT extends NamespaceContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamespaceContext.class!",
                   NamespaceContext.class.isAssignableFrom(sut));
    }

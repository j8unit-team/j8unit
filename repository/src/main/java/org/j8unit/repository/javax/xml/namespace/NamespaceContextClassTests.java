 ...
 * javax.xml.namespace.NamespaceContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamespaceContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamespaceContextTests}.
 * </p>
 *
 * @see javax.xml.namespace.NamespaceContext interface javax.xml.namespace.NamespaceContext (the hereby targeted
 *      class-under-test class)
 * @see NamespaceContextTests NamespaceContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface NamespaceContextClassTests<SUT extends javax.xml.namespace.NamespaceContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.namespace.NamespaceContext.class!",
                   javax.xml.namespace.NamespaceContext.class.isAssignableFrom(sut));
    }

 ...
 * javax.activation.MimetypesFileTypeMap}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MimetypesFileTypeMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MimetypesFileTypeMapTests}
 * .
 * </p>
 *
 * @see javax.activation.MimetypesFileTypeMap class javax.activation.MimetypesFileTypeMap (the hereby targeted
 *      class-under-test class)
 * @see MimetypesFileTypeMapTests MimetypesFileTypeMapTests (The complementary j8unit test interface containing the
...
extends FileTypeMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.MimetypesFileTypeMap.class!",
                   javax.activation.MimetypesFileTypeMap.class.isAssignableFrom(sut));
    }

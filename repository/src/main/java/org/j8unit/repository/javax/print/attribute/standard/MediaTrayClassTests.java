 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MediaTray public
 ...
 * {@link org.j8unit.repository.javax.print.attribute.standard.MediaTrayTests}.
 * </p>
 *
 * <p>
...
public abstract interface MediaTrayClassTests<SUT extends MediaTray>
extends org.j8unit.repository.javax.print.attribute.standard.MediaClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MediaTray.class!",
                   MediaTray.class.isAssignableFrom(sut));
    }

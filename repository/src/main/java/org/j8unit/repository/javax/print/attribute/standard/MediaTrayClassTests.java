...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.MediaTray class
 * javax.print.attribute.standard.MediaTray}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MediaTrayTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MediaTrayTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.MediaTray class javax.print.attribute.standard.MediaTray (the hereby targeted
 *      class-under-test class)
 * @see MediaTrayTests MediaTrayTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.print.attribute.AttributeClassTests<SUT>, MediaClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.MediaTray.class!",
                   javax.print.attribute.standard.MediaTray.class.isAssignableFrom(sut));
    }

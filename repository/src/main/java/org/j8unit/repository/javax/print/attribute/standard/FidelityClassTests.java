 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Fidelity public
...
public abstract interface FidelityClassTests<SUT extends Fidelity>
...
org.j8unit.repository.javax.print.attribute.PrintRequestAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Fidelity.class!",
                   Fidelity.class.isAssignableFrom(sut));
    }

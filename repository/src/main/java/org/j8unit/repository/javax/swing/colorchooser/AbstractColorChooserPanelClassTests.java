...
extends JPanelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractColorChooserPanel.class!",
                   AbstractColorChooserPanel.class.isAssignableFrom(sut));
    }

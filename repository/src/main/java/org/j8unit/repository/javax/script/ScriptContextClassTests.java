...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.script.ScriptContext interface javax.script.ScriptContext},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScriptContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScriptContextTests}.
 * </p>
 *
 * @see javax.script.ScriptContext interface javax.script.ScriptContext (the hereby targeted class-under-test class)
 * @see ScriptContextTests ScriptContextTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ScriptContextClassTests<SUT extends javax.script.ScriptContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.ScriptContext.class!",
                   javax.script.ScriptContext.class.isAssignableFrom(sut));
    }

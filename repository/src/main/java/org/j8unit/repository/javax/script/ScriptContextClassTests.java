 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScriptContext
...
public abstract interface ScriptContextClassTests<SUT extends ScriptContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScriptContext.class!",
                   ScriptContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMXAddressable
...
public abstract interface JMXAddressableClassTests<SUT extends JMXAddressable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXAddressable.class!",

 ...
 * javax.management.remote.JMXAddressable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMXAddressableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMXAddressableTests}.
 * </p>
 *
 * @see javax.management.remote.JMXAddressable interface javax.management.remote.JMXAddressable (the hereby targeted
 *      class-under-test class)
 * @see JMXAddressableTests JMXAddressableTests (The complementary j8unit test interface containing the instance
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXAddressable.class!",
                   javax.management.remote.JMXAddressable.class.isAssignableFrom(sut));
    }

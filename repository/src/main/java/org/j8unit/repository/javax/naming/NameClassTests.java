...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.Name interface javax.naming.Name}, containing all type
...
org.j8unit.repository.java.lang.ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.Name.class!",
                   javax.naming.Name.class.isAssignableFrom(sut));
    }

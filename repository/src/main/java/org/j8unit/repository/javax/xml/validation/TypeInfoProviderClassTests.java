...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.validation.TypeInfoProvider class
 * javax.xml.validation.TypeInfoProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeInfoProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TypeInfoProviderTests}.
 * </p>
 *
 * @see javax.xml.validation.TypeInfoProvider class javax.xml.validation.TypeInfoProvider (the hereby targeted
 *      class-under-test class)
 * @see TypeInfoProviderTests TypeInfoProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface TypeInfoProviderClassTests<SUT extends javax.xml.validation.TypeInfoProvider>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.validation.TypeInfoProvider.class!",
                   javax.xml.validation.TypeInfoProvider.class.isAssignableFrom(sut));
    }

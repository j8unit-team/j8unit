 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeInfoProvider
...
public abstract interface TypeInfoProviderClassTests<SUT extends TypeInfoProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeInfoProvider.class!",
                   TypeInfoProvider.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileObjectTests}.
 * </p>
 *
 * @see javax.tools.FileObject interface javax.tools.FileObject (the hereby targeted class-under-test class)
 * @see FileObjectTests FileObjectTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileObjectClassTests<SUT extends javax.tools.FileObject>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.tools.FileObject.class!",
                   javax.tools.FileObject.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileObject public
 * abstract interface javax.tools.FileObject}.
 *
...
public abstract interface FileObjectClassTests<SUT extends FileObject>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileObject.class!",
                   FileObject.class.isAssignableFrom(sut));
    }

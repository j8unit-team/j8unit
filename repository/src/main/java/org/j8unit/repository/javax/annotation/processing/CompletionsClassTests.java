 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Completions public
...
public abstract interface CompletionsClassTests<SUT extends Completions>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Completions.class!",
                   Completions.class.isAssignableFrom(sut));
    }

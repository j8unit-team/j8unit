 ...
 * {@link PrintServiceAttribute public abstract interface javax.print.attribute.PrintServiceAttribute}.
 *
...
public abstract interface PrintServiceAttributeClassTests<SUT extends PrintServiceAttribute>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintServiceAttribute.class!",
                   PrintServiceAttribute.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.PrintServiceAttribute interface
 * javax.print.attribute.PrintServiceAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintServiceAttributeTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PrintServiceAttributeTests}.
 * </p>
 *
 * @see javax.print.attribute.PrintServiceAttribute interface javax.print.attribute.PrintServiceAttribute (the hereby
 *      targeted class-under-test class)
 * @see PrintServiceAttributeTests PrintServiceAttributeTests (The complementary j8unit test interface containing the
...
public abstract interface PrintServiceAttributeClassTests<SUT extends javax.print.attribute.PrintServiceAttribute>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.PrintServiceAttribute.class!",
                   javax.print.attribute.PrintServiceAttribute.class.isAssignableFrom(sut));
    }

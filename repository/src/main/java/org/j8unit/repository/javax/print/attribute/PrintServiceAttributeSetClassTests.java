 ...
 * javax.print.attribute.PrintServiceAttributeSet}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintServiceAttributeSetTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link PrintServiceAttributeSetTests}.
 * </p>
 *
 * @see javax.print.attribute.PrintServiceAttributeSet interface javax.print.attribute.PrintServiceAttributeSet (the
 *      hereby targeted class-under-test class)
 * @see PrintServiceAttributeSetTests PrintServiceAttributeSetTests (The complementary j8unit test interface containing
...
public abstract interface PrintServiceAttributeSetClassTests<SUT extends javax.print.attribute.PrintServiceAttributeSet>
extends AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.PrintServiceAttributeSet.class!",
                   javax.print.attribute.PrintServiceAttributeSet.class.isAssignableFrom(sut));
    }

 ...
 * {@link PrintServiceAttributeSet public abstract interface javax.print.attribute.PrintServiceAttributeSet}.
 *
...
public abstract interface PrintServiceAttributeSetClassTests<SUT extends PrintServiceAttributeSet>
extends org.j8unit.repository.javax.print.attribute.AttributeSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintServiceAttributeSet.class!",
                   PrintServiceAttributeSet.class.isAssignableFrom(sut));
    }

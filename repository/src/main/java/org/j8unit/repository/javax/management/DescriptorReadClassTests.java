 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DescriptorRead
 * public abstract interface javax.management.DescriptorRead}.
 *
...
public abstract interface DescriptorReadClassTests<SUT extends DescriptorRead>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DescriptorRead.class!",
                   DescriptorRead.class.isAssignableFrom(sut));
    }

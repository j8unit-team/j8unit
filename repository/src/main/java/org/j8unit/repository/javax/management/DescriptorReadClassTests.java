 ...
 * javax.management.DescriptorRead}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DescriptorReadTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DescriptorReadTests}.
 * </p>
 *
 * @see javax.management.DescriptorRead interface javax.management.DescriptorRead (the hereby targeted class-under-test
 *      class)
 * @see DescriptorReadTests DescriptorReadTests (The complementary j8unit test interface containing the instance
...
public abstract interface DescriptorReadClassTests<SUT extends javax.management.DescriptorRead>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.DescriptorRead.class!",
                   javax.management.DescriptorRead.class.isAssignableFrom(sut));
    }

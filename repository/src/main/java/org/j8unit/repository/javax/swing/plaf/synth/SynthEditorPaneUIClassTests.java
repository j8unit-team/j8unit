...
import org.j8unit.repository.javax.swing.plaf.basic.BasicEditorPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthEditorPaneUI
 * public class javax.swing.plaf.synth.SynthEditorPaneUI}.
 *
...
public abstract interface SynthEditorPaneUIClassTests<SUT extends SynthEditorPaneUI>
extends SynthUIClassTests<SUT>, BasicEditorPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthEditorPaneUI.class!",
                   SynthEditorPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.MBeanServerDelegate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanServerDelegateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanServerDelegateTests}.
 * </p>
 *
 * @see javax.management.MBeanServerDelegate class javax.management.MBeanServerDelegate (the hereby targeted
 *      class-under-test class)
 * @see MBeanServerDelegateTests MBeanServerDelegateTests (The complementary j8unit test interface containing the
...
extends MBeanServerDelegateMBeanClassTests<SUT>, NotificationEmitterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanServerDelegate.class!",
                   javax.management.MBeanServerDelegate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MBeanServerDelegate
 * public class javax.management.MBeanServerDelegate}.
 *
...
public abstract interface MBeanServerDelegateClassTests<SUT extends MBeanServerDelegate>
extends MBeanServerDelegateMBeanClassTests<SUT>, NotificationEmitterClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerDelegate.class!",

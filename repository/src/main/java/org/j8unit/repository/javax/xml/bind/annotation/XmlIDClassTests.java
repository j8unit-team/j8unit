...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlID interface
 * javax.xml.bind.annotation.XmlID}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlIDTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlIDTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlID interface javax.xml.bind.annotation.XmlID (the hereby targeted class-under-test
 *      class)
 * @see XmlIDTests XmlIDTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface XmlIDClassTests<SUT extends javax.xml.bind.annotation.XmlID>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlID.class!",
                   javax.xml.bind.annotation.XmlID.class.isAssignableFrom(sut));
    }

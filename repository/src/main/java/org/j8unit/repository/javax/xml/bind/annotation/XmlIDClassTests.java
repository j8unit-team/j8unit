 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlID public
...
public abstract interface XmlIDClassTests<SUT extends XmlID>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlID.class!", XmlID.class.isAssignableFrom(sut));
    }

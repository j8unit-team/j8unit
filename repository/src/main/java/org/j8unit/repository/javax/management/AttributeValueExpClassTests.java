 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AttributeValueExp
 * public class javax.management.AttributeValueExp}.
 *
...
public abstract interface AttributeValueExpClassTests<SUT extends AttributeValueExp>
extends ValueExpClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeValueExp.class!",
                   AttributeValueExp.class.isAssignableFrom(sut));
    }

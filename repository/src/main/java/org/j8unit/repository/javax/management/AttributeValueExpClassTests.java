...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.AttributeValueExp class
 * javax.management.AttributeValueExp}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeValueExpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AttributeValueExpTests}.
 * </p>
 *
 * @see javax.management.AttributeValueExp class javax.management.AttributeValueExp (the hereby targeted
 *      class-under-test class)
 * @see AttributeValueExpTests AttributeValueExpTests (The complementary j8unit test interface containing the instance
...
public abstract interface AttributeValueExpClassTests<SUT extends javax.management.AttributeValueExp>
extends ValueExpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.AttributeValueExp.class!",
                   javax.management.AttributeValueExp.class.isAssignableFrom(sut));
    }

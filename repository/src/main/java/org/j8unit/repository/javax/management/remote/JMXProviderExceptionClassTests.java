 ...
 * javax.management.remote.JMXProviderException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMXProviderExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMXProviderExceptionTests}
 * .
 * </p>
 *
 * @see javax.management.remote.JMXProviderException class javax.management.remote.JMXProviderException (the hereby
 *      targeted class-under-test class)
 * @see JMXProviderExceptionTests JMXProviderExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface JMXProviderExceptionClassTests<SUT extends javax.management.remote.JMXProviderException>
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXProviderException.class!",
                   javax.management.remote.JMXProviderException.class.isAssignableFrom(sut));
    }

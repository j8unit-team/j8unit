 ...
 * {@link JMXProviderException public class javax.management.remote.JMXProviderException}.
 *
...
public abstract interface JMXProviderExceptionClassTests<SUT extends JMXProviderException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXProviderException.class!",
                   JMXProviderException.class.isAssignableFrom(sut));
    }

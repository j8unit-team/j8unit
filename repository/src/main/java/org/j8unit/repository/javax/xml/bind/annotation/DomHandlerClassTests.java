 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DomHandler public
 * abstract interface javax.xml.bind.annotation.DomHandler<ElementT,ResultT>}.
 *
...
public abstract interface DomHandlerClassTests<SUT extends DomHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DomHandler.class!",

 ...
 * javax.xml.bind.annotation.DomHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DomHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DomHandlerTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.DomHandler interface javax.xml.bind.annotation.DomHandler (the hereby targeted
 *      class-under-test class)
 * @see DomHandlerTests DomHandlerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.DomHandler.class!",
                   javax.xml.bind.annotation.DomHandler.class.isAssignableFrom(sut));
    }

 ...
 * javax.print.attribute.standard.JobImpressionsSupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobImpressionsSupportedTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link JobImpressionsSupportedTests}.
 * </p>
 *
 ...
 * @see JobImpressionsSupportedTests JobImpressionsSupportedTests (The complementary j8unit test interface containing
...
org.j8unit.repository.javax.print.attribute.SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobImpressionsSupported.class!",
                   javax.print.attribute.standard.JobImpressionsSupported.class.isAssignableFrom(sut));
    }

...
public abstract interface JobImpressionsSupportedClassTests<SUT extends JobImpressionsSupported>
extends SupportedValuesAttributeClassTests<SUT>, SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobImpressionsSupported.class!",
                   JobImpressionsSupported.class.isAssignableFrom(sut));
    }

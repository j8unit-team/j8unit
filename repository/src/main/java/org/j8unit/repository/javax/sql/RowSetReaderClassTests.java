 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetReader public
 * abstract interface javax.sql.RowSetReader}.
 *
...
public abstract interface RowSetReaderClassTests<SUT extends RowSetReader>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetReader.class!",
                   RowSetReader.class.isAssignableFrom(sut));
    }

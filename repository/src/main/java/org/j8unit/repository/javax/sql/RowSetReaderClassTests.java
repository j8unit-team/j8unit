...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.RowSetReader interface javax.sql.RowSetReader}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetReaderTests}.
 * </p>
 *
 * @see javax.sql.RowSetReader interface javax.sql.RowSetReader (the hereby targeted class-under-test class)
 * @see RowSetReaderTests RowSetReaderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RowSetReaderClassTests<SUT extends javax.sql.RowSetReader>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.RowSetReader.class!",
                   javax.sql.RowSetReader.class.isAssignableFrom(sut));
    }

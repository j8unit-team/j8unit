 ...
 * javax.security.auth.callback.CallbackHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CallbackHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CallbackHandlerTests}.
 * </p>
 *
 * @see javax.security.auth.callback.CallbackHandler interface javax.security.auth.callback.CallbackHandler (the hereby
 *      targeted class-under-test class)
 * @see CallbackHandlerTests CallbackHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface CallbackHandlerClassTests<SUT extends javax.security.auth.callback.CallbackHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.callback.CallbackHandler.class!",
                   javax.security.auth.callback.CallbackHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CallbackHandler
 * public abstract interface javax.security.auth.callback.CallbackHandler}.
 *
...
public abstract interface CallbackHandlerClassTests<SUT extends CallbackHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CallbackHandler.class!",
                   CallbackHandler.class.isAssignableFrom(sut));
    }

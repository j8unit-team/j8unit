 ...
 * javax.xml.ws.spi.http.HttpHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HttpHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HttpHandlerTests}.
 * </p>
 *
 * @see javax.xml.ws.spi.http.HttpHandler class javax.xml.ws.spi.http.HttpHandler (the hereby targeted class-under-test
 *      class)
 * @see HttpHandlerTests HttpHandlerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.spi.http.HttpHandler.class!",
                   javax.xml.ws.spi.http.HttpHandler.class.isAssignableFrom(sut));
    }

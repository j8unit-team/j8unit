 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HttpHandler public
 * abstract class javax.xml.ws.spi.http.HttpHandler}.
 *
...
public abstract interface HttpHandlerClassTests<SUT extends HttpHandler>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.ws.spi.http.HttpHandler]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HttpHandler.class!",
                   HttpHandler.class.isAssignableFrom(sut));
    }

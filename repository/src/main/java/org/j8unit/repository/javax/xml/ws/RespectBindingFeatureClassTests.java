 ...
 * javax.xml.ws.RespectBindingFeature}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RespectBindingFeatureTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RespectBindingFeatureTests}.
 * </p>
 *
 * @see javax.xml.ws.RespectBindingFeature class javax.xml.ws.RespectBindingFeature (the hereby targeted
 *      class-under-test class)
 * @see RespectBindingFeatureTests RespectBindingFeatureTests (The complementary j8unit test interface containing the
...
extends WebServiceFeatureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.RespectBindingFeature.class!",
                   javax.xml.ws.RespectBindingFeature.class.isAssignableFrom(sut));
    }

...
public abstract interface RespectBindingFeatureClassTests<SUT extends RespectBindingFeature>
extends WebServiceFeatureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RespectBindingFeature.class!",
                   RespectBindingFeature.class.isAssignableFrom(sut));
    }

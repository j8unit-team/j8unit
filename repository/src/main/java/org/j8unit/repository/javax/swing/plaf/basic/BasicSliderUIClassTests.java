...
import javax.swing.plaf.basic.BasicSliderUI.FocusHandler;
...
import org.j8unit.repository.javax.swing.event.MouseInputAdapterClassTests;
import org.j8unit.repository.javax.swing.plaf.SliderUIClassTests;
import org.j8unit.repository.javax.swing.plaf.basic.BasicSliderUITests.ActionScrollerTests;
import org.j8unit.repository.javax.swing.plaf.basic.BasicSliderUITests.ScrollListenerTests;
import org.j8unit.repository.javax.swing.plaf.basic.BasicSliderUITests.TrackListenerTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicSliderUI
 * public class javax.swing.plaf.basic.BasicSliderUI}.
 *
...
extends SliderUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicSliderUI.class!",
                   BasicSliderUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI]
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ActionScrollerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends AbstractActionClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$ActionScroller]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActionScroller.class!",
                              ActionScroller.class.isAssignableFrom(sut));
        }

        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$ActionScroller]

        // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$ActionScroller]
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link PropertyChangeHandler public class javax.swing.plaf.basic.BasicSliderUI$PropertyChangeHandler}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends PropertyChangeListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$PropertyChangeHandler]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$PropertyChangeHandler]

        // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$PropertyChangeHandler]
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link ScrollListener public class javax.swing.plaf.basic.BasicSliderUI$ScrollListener}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ScrollListenerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends ActionListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$ScrollListener]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScrollListener.class!",
                              ScrollListener.class.isAssignableFrom(sut));
        }

        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$ScrollListener]
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link TrackListenerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends MouseInputAdapterClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TrackListener.class!",
                              TrackListener.class.isAssignableFrom(sut));
        }

        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$TrackListener]
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link ChangeHandler public class javax.swing.plaf.basic.BasicSliderUI$ChangeHandler}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ChangeHandlerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    extends ChangeListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$ChangeHandler]
    ...
    extends FocusListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$FocusHandler]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$FocusHandler]

        // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$FocusHandler]
    ...
    extends ComponentAdapterClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicSliderUI$ComponentHandler]

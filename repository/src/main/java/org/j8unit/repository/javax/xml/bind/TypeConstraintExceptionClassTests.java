 ...
 * javax.xml.bind.TypeConstraintException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeConstraintExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link TypeConstraintExceptionTests}.
 * </p>
 *
 * @see javax.xml.bind.TypeConstraintException class javax.xml.bind.TypeConstraintException (the hereby targeted
 *      class-under-test class)
 * @see TypeConstraintExceptionTests TypeConstraintExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.TypeConstraintException.class!",
                   javax.xml.bind.TypeConstraintException.class.isAssignableFrom(sut));
    }

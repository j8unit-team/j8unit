 ...
 * {@link TypeConstraintException public class javax.xml.bind.TypeConstraintException}.
 *
...
public abstract interface TypeConstraintExceptionClassTests<SUT extends TypeConstraintException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeConstraintException.class!",
                   TypeConstraintException.class.isAssignableFrom(sut));
    }

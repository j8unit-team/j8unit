 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TabableView public
 * abstract interface javax.swing.text.TabableView}.
 *
...
public abstract interface TabableViewClassTests<SUT extends TabableView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TabableView.class!",
                   TabableView.class.isAssignableFrom(sut));
    }

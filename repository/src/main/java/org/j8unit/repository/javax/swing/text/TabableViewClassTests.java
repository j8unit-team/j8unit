 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TabableViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TabableViewTests}.
 * </p>
 *
 * @see javax.swing.text.TabableView interface javax.swing.text.TabableView (the hereby targeted class-under-test class)
 * @see TabableViewTests TabableViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TabableViewClassTests<SUT extends javax.swing.text.TabableView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.TabableView.class!",
                   javax.swing.text.TabableView.class.isAssignableFrom(sut));
    }

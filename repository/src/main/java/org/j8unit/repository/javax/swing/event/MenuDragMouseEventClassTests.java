 ...
 * javax.swing.event.MenuDragMouseEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuDragMouseEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuDragMouseEventTests}.
 * </p>
 *
 * @see javax.swing.event.MenuDragMouseEvent class javax.swing.event.MenuDragMouseEvent (the hereby targeted
 *      class-under-test class)
 * @see MenuDragMouseEventTests MenuDragMouseEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.awt.event.MouseEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MenuDragMouseEvent.class!",
                   javax.swing.event.MenuDragMouseEvent.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.awt.event.MouseEventClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuDragMouseEvent
 * public class javax.swing.event.MenuDragMouseEvent}.
 *
...
public abstract interface MenuDragMouseEventClassTests<SUT extends MenuDragMouseEvent>
extends MouseEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuDragMouseEvent.class!",
                   MenuDragMouseEvent.class.isAssignableFrom(sut));
    }

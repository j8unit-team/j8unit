 ...
 * javax.xml.bind.helpers.PrintConversionEventImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintConversionEventImplTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link PrintConversionEventImplTests}.
 * </p>
 *
 * @see javax.xml.bind.helpers.PrintConversionEventImpl class javax.xml.bind.helpers.PrintConversionEventImpl (the
 *      hereby targeted class-under-test class)
 * @see PrintConversionEventImplTests PrintConversionEventImplTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.javax.xml.bind.PrintConversionEventClassTests<SUT>, ValidationEventImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.helpers.PrintConversionEventImpl.class!",
                   javax.xml.bind.helpers.PrintConversionEventImpl.class.isAssignableFrom(sut));
    }

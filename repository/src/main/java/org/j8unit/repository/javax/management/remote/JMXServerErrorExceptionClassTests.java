 ...
 * javax.management.remote.JMXServerErrorException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMXServerErrorExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link JMXServerErrorExceptionTests}.
 * </p>
 *
 * @see javax.management.remote.JMXServerErrorException class javax.management.remote.JMXServerErrorException (the
 *      hereby targeted class-under-test class)
 * @see JMXServerErrorExceptionTests JMXServerErrorExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXServerErrorException.class!",
                   javax.management.remote.JMXServerErrorException.class.isAssignableFrom(sut));
    }

...
public abstract interface JMXServerErrorExceptionClassTests<SUT extends JMXServerErrorException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXServerErrorException.class!",
                   JMXServerErrorException.class.isAssignableFrom(sut));
    }

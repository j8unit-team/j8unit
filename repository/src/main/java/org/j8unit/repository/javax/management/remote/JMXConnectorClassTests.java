 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JMXConnector public
 * abstract interface javax.management.remote.JMXConnector}.
 *
...
public abstract interface JMXConnectorClassTests<SUT extends JMXConnector>
extends CloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXConnector.class!",
                   JMXConnector.class.isAssignableFrom(sut));
    }

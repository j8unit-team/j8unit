 ...
 * javax.management.remote.JMXConnector}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMXConnectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMXConnectorTests}.
 * </p>
 *
 * @see javax.management.remote.JMXConnector interface javax.management.remote.JMXConnector (the hereby targeted
 *      class-under-test class)
 * @see JMXConnectorTests JMXConnectorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface JMXConnectorClassTests<SUT extends javax.management.remote.JMXConnector>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXConnector.class!",
                   javax.management.remote.JMXConnector.class.isAssignableFrom(sut));
    }

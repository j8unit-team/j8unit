 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLParameters
...
public abstract interface SSLParametersClassTests<SUT extends SSLParameters>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLParameters.class!",
                   SSLParameters.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.java.lang.annotation.AnnotationTests<SUT> {
    ...
    /**
     * <p>
     * Test class for {@link javax.xml.bind.annotation.XmlElementDecl$GLOBAL class
     * javax.xml.bind.annotation.XmlElementDecl$GLOBAL}, containing all instance relevant test methods (i.&thinsp;e.,
    ...
    @Test
    @Category(Draft.class)
    public default void test_scope()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_substitutionHeadName()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_substitutionHeadNamespace()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

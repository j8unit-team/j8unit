 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAdapter public
...
public abstract interface XmlAdapterClassTests<SUT extends XmlAdapter>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAdapter.class!",
                   XmlAdapter.class.isAssignableFrom(sut));
    }

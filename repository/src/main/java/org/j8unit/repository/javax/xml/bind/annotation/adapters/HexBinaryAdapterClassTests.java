 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HexBinaryAdapter
 * public final class javax.xml.bind.annotation.adapters.HexBinaryAdapter}.
 *
...
extends XmlAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HexBinaryAdapter.class!",
                   HexBinaryAdapter.class.isAssignableFrom(sut));
    }

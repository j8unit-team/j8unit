 ...
 * javax.xml.bind.annotation.adapters.HexBinaryAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HexBinaryAdapterTests}).
 * </p>
 *
 * <p>
 ...
 * @see HexBinaryAdapterTests HexBinaryAdapterTests (The complementary j8unit test interface containing the instance
...
extends XmlAdapterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.adapters.HexBinaryAdapter.class!",
                   javax.xml.bind.annotation.adapters.HexBinaryAdapter.class.isAssignableFrom(sut));
    }

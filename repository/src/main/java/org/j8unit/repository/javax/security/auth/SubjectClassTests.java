 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Subject public
 * final class javax.security.auth.Subject}.
 *
...
public abstract interface SubjectClassTests<SUT extends Subject>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Subject.class!",
                   Subject.class.isAssignableFrom(sut));
    }

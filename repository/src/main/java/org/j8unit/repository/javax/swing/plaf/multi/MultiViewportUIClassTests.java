 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiViewportUI
...
public abstract interface MultiViewportUIClassTests<SUT extends MultiViewportUI>
extends ViewportUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiViewportUI.class!",
                   MultiViewportUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventContext public
 * abstract interface javax.naming.event.EventContext}.
 *
...
extends org.j8unit.repository.javax.naming.ContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventContext.class!",
                   EventContext.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.event.EventContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventContextTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.naming.event.EventContext interface javax.naming.event.EventContext (the hereby targeted class-under-test
 *      class)
 * @see EventContextTests EventContextTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface EventContextClassTests<SUT extends javax.naming.event.EventContext>
extends org.j8unit.repository.javax.naming.ContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.event.EventContext.class!",
                   javax.naming.event.EventContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SpinnerUI public
 * abstract class javax.swing.plaf.SpinnerUI}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SpinnerUITests}.
 * </p>
 *
 * <p>
...
public abstract interface SpinnerUIClassTests<SUT extends SpinnerUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.SpinnerUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SpinnerUI.class!",
                   SpinnerUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.SpinnerUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.SpinnerUI]

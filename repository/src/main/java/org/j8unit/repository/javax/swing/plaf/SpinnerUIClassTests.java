 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SpinnerUITests}).
 * </p>
 *
 * <p>
 ...
 * @see SpinnerUITests SpinnerUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SpinnerUIClassTests<SUT extends javax.swing.plaf.SpinnerUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.SpinnerUI.class!",
                   javax.swing.plaf.SpinnerUI.class.isAssignableFrom(sut));
    }

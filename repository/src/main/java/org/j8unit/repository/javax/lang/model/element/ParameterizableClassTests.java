 ...
 * javax.lang.model.element.Parameterizable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParameterizableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParameterizableTests}.
 * </p>
 *
 * @see javax.lang.model.element.Parameterizable interface javax.lang.model.element.Parameterizable (the hereby targeted
 *      class-under-test class)
 * @see ParameterizableTests ParameterizableTests (The complementary j8unit test interface containing the instance
...
public abstract interface ParameterizableClassTests<SUT extends javax.lang.model.element.Parameterizable>
extends ElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.element.Parameterizable.class!",
                   javax.lang.model.element.Parameterizable.class.isAssignableFrom(sut));
    }

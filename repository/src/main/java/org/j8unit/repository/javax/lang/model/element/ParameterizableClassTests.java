 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Parameterizable
...
public abstract interface ParameterizableClassTests<SUT extends Parameterizable>
extends ElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Parameterizable.class!",
                   Parameterizable.class.isAssignableFrom(sut));
    }

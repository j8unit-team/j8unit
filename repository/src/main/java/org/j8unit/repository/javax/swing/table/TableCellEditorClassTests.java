...
import org.j8unit.repository.javax.swing.CellEditorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TableCellEditor
...
public abstract interface TableCellEditorClassTests<SUT extends TableCellEditor>
extends CellEditorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TableCellEditor.class!",
                   TableCellEditor.class.isAssignableFrom(sut));
    }

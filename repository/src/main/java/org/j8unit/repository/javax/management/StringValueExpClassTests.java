 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringValueExp
 * public class javax.management.StringValueExp}.
 *
...
public abstract interface StringValueExpClassTests<SUT extends StringValueExp>
extends ValueExpClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringValueExp.class!",

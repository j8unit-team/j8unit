 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringValueExpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringValueExpTests}.
 * </p>
 *
 * @see javax.management.StringValueExp class javax.management.StringValueExp (the hereby targeted class-under-test
 *      class)
 * @see StringValueExpTests StringValueExpTests (The complementary j8unit test interface containing the instance
...
extends ValueExpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.StringValueExp.class!",
                   javax.management.StringValueExp.class.isAssignableFrom(sut));
    }

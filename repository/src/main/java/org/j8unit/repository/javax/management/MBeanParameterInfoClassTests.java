 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MBeanParameterInfo
 * public class javax.management.MBeanParameterInfo}.
 *
...
public abstract interface MBeanParameterInfoClassTests<SUT extends MBeanParameterInfo>
extends CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanParameterInfo.class!",
                   MBeanParameterInfo.class.isAssignableFrom(sut));
    }

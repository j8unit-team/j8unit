 ...
 * javax.management.MBeanParameterInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MBeanParameterInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MBeanParameterInfoTests}.
 * </p>
 *
 * @see javax.management.MBeanParameterInfo class javax.management.MBeanParameterInfo (the hereby targeted
 *      class-under-test class)
 * @see MBeanParameterInfoTests MBeanParameterInfoTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, MBeanFeatureInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.MBeanParameterInfo.class!",
                   javax.management.MBeanParameterInfo.class.isAssignableFrom(sut));
    }

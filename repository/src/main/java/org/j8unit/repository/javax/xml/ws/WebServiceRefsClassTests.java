...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.WebServiceRefs interface javax.xml.ws.WebServiceRefs},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebServiceRefsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WebServiceRefsTests}.
 * </p>
 *
 * @see javax.xml.ws.WebServiceRefs interface javax.xml.ws.WebServiceRefs (the hereby targeted class-under-test class)
 * @see WebServiceRefsTests WebServiceRefsTests (The complementary j8unit test interface containing the instance
...
public abstract interface WebServiceRefsClassTests<SUT extends javax.xml.ws.WebServiceRefs>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.WebServiceRefs.class!",
                   javax.xml.ws.WebServiceRefs.class.isAssignableFrom(sut));
    }

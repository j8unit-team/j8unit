 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebServiceRefs
...
public abstract interface WebServiceRefsClassTests<SUT extends WebServiceRefs>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebServiceRefs.class!",
                   WebServiceRefs.class.isAssignableFrom(sut));
    }

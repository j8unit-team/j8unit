 ...
 * javax.sound.midi.ControllerEventListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ControllerEventListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ControllerEventListenerTests}.
 * </p>
 *
 * @see javax.sound.midi.ControllerEventListener interface javax.sound.midi.ControllerEventListener (the hereby targeted
 *      class-under-test class)
 * @see ControllerEventListenerTests ControllerEventListenerTests (The complementary j8unit test interface containing
...
public abstract interface ControllerEventListenerClassTests<SUT extends javax.sound.midi.ControllerEventListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.midi.ControllerEventListener.class!",
                   javax.sound.midi.ControllerEventListener.class.isAssignableFrom(sut));
    }

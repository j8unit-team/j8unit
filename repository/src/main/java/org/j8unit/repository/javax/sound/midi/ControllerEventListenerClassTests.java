...
public abstract interface ControllerEventListenerClassTests<SUT extends ControllerEventListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ControllerEventListener.class!",
                   ControllerEventListener.class.isAssignableFrom(sut));
    }

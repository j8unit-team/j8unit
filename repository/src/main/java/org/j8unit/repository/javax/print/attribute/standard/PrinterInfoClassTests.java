 ...
 * javax.print.attribute.standard.PrinterInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterInfoTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.PrinterInfo class javax.print.attribute.standard.PrinterInfo (the hereby targeted
 *      class-under-test class)
 * @see PrinterInfoTests PrinterInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PrinterInfo.class!",
                   javax.print.attribute.standard.PrinterInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterInfo public
 * final class javax.print.attribute.standard.PrinterInfo}.
 *
...
public abstract interface PrinterInfoClassTests<SUT extends PrinterInfo>
extends PrintServiceAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterInfo.class!",
                   PrinterInfo.class.isAssignableFrom(sut));
    }

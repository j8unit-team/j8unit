...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.MultiDocPrintService interface
 * javax.print.MultiDocPrintService}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiDocPrintServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiDocPrintServiceTests}
 * .
 * </p>
 *
 * @see javax.print.MultiDocPrintService interface javax.print.MultiDocPrintService (the hereby targeted
 *      class-under-test class)
 * @see MultiDocPrintServiceTests MultiDocPrintServiceTests (The complementary j8unit test interface containing the
...
public abstract interface MultiDocPrintServiceClassTests<SUT extends javax.print.MultiDocPrintService>
extends PrintServiceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.MultiDocPrintService.class!",
                   javax.print.MultiDocPrintService.class.isAssignableFrom(sut));
    }

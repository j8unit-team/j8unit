...
public abstract interface MultiDocPrintServiceClassTests<SUT extends MultiDocPrintService>
extends org.j8unit.repository.javax.print.PrintServiceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiDocPrintService.class!",
                   MultiDocPrintService.class.isAssignableFrom(sut));
    }

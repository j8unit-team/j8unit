...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.annotation.processing.SupportedSourceVersion interface
 * javax.annotation.processing.SupportedSourceVersion}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SupportedSourceVersionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SupportedSourceVersionTests}.
 * </p>
 *
 * @see javax.annotation.processing.SupportedSourceVersion interface javax.annotation.processing.SupportedSourceVersion
 *      (the hereby targeted class-under-test class)
 * @see SupportedSourceVersionTests SupportedSourceVersionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.SupportedSourceVersion.class!",
                   javax.annotation.processing.SupportedSourceVersion.class.isAssignableFrom(sut));
    }

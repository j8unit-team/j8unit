 ...
 * {@link SupportedSourceVersion public abstract @interface javax.annotation.processing.SupportedSourceVersion}.
 *
...
public abstract interface SupportedSourceVersionClassTests<SUT extends SupportedSourceVersion>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SupportedSourceVersion.class!",
                   SupportedSourceVersion.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DeclaredType public
 * abstract interface javax.lang.model.type.DeclaredType}.
 *
...
public abstract interface DeclaredTypeClassTests<SUT extends DeclaredType>
extends ReferenceTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DeclaredType.class!",
                   DeclaredType.class.isAssignableFrom(sut));
    }

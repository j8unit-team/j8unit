 ...
 * javax.lang.model.type.DeclaredType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DeclaredTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DeclaredTypeTests}.
 * </p>
 *
 * @see javax.lang.model.type.DeclaredType interface javax.lang.model.type.DeclaredType (the hereby targeted
 *      class-under-test class)
 * @see DeclaredTypeTests DeclaredTypeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DeclaredTypeClassTests<SUT extends javax.lang.model.type.DeclaredType>
extends ReferenceTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.DeclaredType.class!",
                   javax.lang.model.type.DeclaredType.class.isAssignableFrom(sut));
    }

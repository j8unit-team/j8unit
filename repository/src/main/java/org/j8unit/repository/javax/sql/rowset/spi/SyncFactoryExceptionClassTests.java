 ...
 * {@link SyncFactoryExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface SyncFactoryExceptionClassTests<SUT extends SyncFactoryException>
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SyncFactoryException.class!",
                   SyncFactoryException.class.isAssignableFrom(sut));
    }

 ...
 * javax.sql.rowset.spi.SyncFactoryException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SyncFactoryExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SyncFactoryExceptionTests}
 * .
 * </p>
 *
 * @see javax.sql.rowset.spi.SyncFactoryException class javax.sql.rowset.spi.SyncFactoryException (the hereby targeted
 *      class-under-test class)
 * @see SyncFactoryExceptionTests SyncFactoryExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.sql.SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.spi.SyncFactoryException.class!",
                   javax.sql.rowset.spi.SyncFactoryException.class.isAssignableFrom(sut));
    }

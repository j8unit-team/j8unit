...
public abstract interface IllegalBlockSizeExceptionClassTests<SUT extends IllegalBlockSizeException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalBlockSizeException.class!",
                   IllegalBlockSizeException.class.isAssignableFrom(sut));
    }

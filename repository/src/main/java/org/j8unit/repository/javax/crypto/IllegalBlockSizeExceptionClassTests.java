 ...
 * javax.crypto.IllegalBlockSizeException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IllegalBlockSizeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalBlockSizeExceptionTests IllegalBlockSizeExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.IllegalBlockSizeException.class!",
                   javax.crypto.IllegalBlockSizeException.class.isAssignableFrom(sut));
    }

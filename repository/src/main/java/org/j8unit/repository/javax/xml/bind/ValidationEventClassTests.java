...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.ValidationEvent interface
 * javax.xml.bind.ValidationEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValidationEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValidationEventTests}.
 * </p>
 *
 * @see javax.xml.bind.ValidationEvent interface javax.xml.bind.ValidationEvent (the hereby targeted class-under-test
 *      class)
 * @see ValidationEventTests ValidationEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface ValidationEventClassTests<SUT extends javax.xml.bind.ValidationEvent>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.ValidationEvent.class!",
                   javax.xml.bind.ValidationEvent.class.isAssignableFrom(sut));
    }

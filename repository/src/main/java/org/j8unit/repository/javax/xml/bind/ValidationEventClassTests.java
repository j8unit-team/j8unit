 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValidationEvent
 * public abstract interface javax.xml.bind.ValidationEvent}.
 *
...
public abstract interface ValidationEventClassTests<SUT extends ValidationEvent>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValidationEvent.class!",
                   ValidationEvent.class.isAssignableFrom(sut));
    }

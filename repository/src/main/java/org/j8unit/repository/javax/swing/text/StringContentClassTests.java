 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringContent
...
public abstract interface StringContentClassTests<SUT extends StringContent>
extends ContentClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringContent.class!",
                   StringContent.class.isAssignableFrom(sut));
    }

 ...
 * javax.print.attribute.standard.PagesPerMinuteColor}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PagesPerMinuteColorTests}).
 * </p>
 *
 * <p>
 ...
 * @see PagesPerMinuteColorTests PagesPerMinuteColorTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PagesPerMinuteColor.class!",
                   javax.print.attribute.standard.PagesPerMinuteColor.class.isAssignableFrom(sut));
    }

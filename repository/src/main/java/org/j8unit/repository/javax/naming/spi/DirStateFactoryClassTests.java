 ...
 * javax.naming.spi.DirStateFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DirStateFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * @see DirStateFactoryTests DirStateFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface DirStateFactoryClassTests<SUT extends javax.naming.spi.DirStateFactory>
extends StateFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.DirStateFactory.class!",
                   javax.naming.spi.DirStateFactory.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.naming.spi.DirStateFactory.Result class
     * javax.naming.spi.DirStateFactory$Result}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link DirStateFactoryTests.ResultTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class-under-test class)
     * @see DirStateFactoryTests.ResultTests DirStateFactoryTests.ResultTests (The complementary j8unit test interface
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ResultClassTests<SUT extends javax.naming.spi.DirStateFactory.Result>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.DirStateFactory.Result.class!",
                       javax.naming.spi.DirStateFactory.Result.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DirStateFactory
...
extends StateFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirStateFactory.class!",
     ...
     * {@link Result public static class javax.naming.spi.DirStateFactory$Result}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

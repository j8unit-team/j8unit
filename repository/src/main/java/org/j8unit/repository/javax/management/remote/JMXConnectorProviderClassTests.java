...
public abstract interface JMXConnectorProviderClassTests<SUT extends JMXConnectorProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JMXConnectorProvider.class!",
                   JMXConnectorProvider.class.isAssignableFrom(sut));
    }

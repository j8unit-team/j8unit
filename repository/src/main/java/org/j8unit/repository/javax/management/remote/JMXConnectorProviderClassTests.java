 ...
 * javax.management.remote.JMXConnectorProvider}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JMXConnectorProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JMXConnectorProviderTests}
 * .
 * </p>
 *
 * @see javax.management.remote.JMXConnectorProvider interface javax.management.remote.JMXConnectorProvider (the hereby
 *      targeted class-under-test class)
 * @see JMXConnectorProviderTests JMXConnectorProviderTests (The complementary j8unit test interface containing the
...
public abstract interface JMXConnectorProviderClassTests<SUT extends javax.management.remote.JMXConnectorProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.JMXConnectorProvider.class!",
                   javax.management.remote.JMXConnectorProvider.class.isAssignableFrom(sut));
    }

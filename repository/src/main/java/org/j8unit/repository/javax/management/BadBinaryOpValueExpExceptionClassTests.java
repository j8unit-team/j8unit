...
public abstract interface BadBinaryOpValueExpExceptionClassTests<SUT extends BadBinaryOpValueExpException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BadBinaryOpValueExpException.class!",
                   BadBinaryOpValueExpException.class.isAssignableFrom(sut));
    }

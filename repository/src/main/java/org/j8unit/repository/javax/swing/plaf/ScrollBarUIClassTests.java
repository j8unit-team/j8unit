 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScrollBarUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScrollBarUITests}.
 * </p>
 *
 * @see javax.swing.plaf.ScrollBarUI class javax.swing.plaf.ScrollBarUI (the hereby targeted class-under-test class)
 * @see ScrollBarUITests ScrollBarUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ScrollBarUI.class!",
                   javax.swing.plaf.ScrollBarUI.class.isAssignableFrom(sut));
    }

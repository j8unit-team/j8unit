 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScrollBarUI public
 * abstract class javax.swing.plaf.ScrollBarUI}.
 *
...
public abstract interface ScrollBarUIClassTests<SUT extends ScrollBarUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.ScrollBarUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScrollBarUI.class!",
                   ScrollBarUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.ScrollBarUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.ScrollBarUI]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringMonitorMBean
 * public abstract interface javax.management.monitor.StringMonitorMBean}.
 *
...
public abstract interface StringMonitorMBeanClassTests<SUT extends StringMonitorMBean>
extends MonitorMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringMonitorMBean.class!",
                   StringMonitorMBean.class.isAssignableFrom(sut));
    }

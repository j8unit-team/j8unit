 ...
 * javax.management.monitor.StringMonitorMBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringMonitorMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringMonitorMBeanTests}.
 * </p>
 *
 * @see javax.management.monitor.StringMonitorMBean interface javax.management.monitor.StringMonitorMBean (the hereby
 *      targeted class-under-test class)
 * @see StringMonitorMBeanTests StringMonitorMBeanTests (The complementary j8unit test interface containing the instance
...
public abstract interface StringMonitorMBeanClassTests<SUT extends javax.management.monitor.StringMonitorMBean>
extends MonitorMBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.StringMonitorMBean.class!",
                   javax.management.monitor.StringMonitorMBean.class.isAssignableFrom(sut));
    }

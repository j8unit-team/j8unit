...
import org.j8unit.repository.javax.management.DescriptorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DescriptorSupport
 * public class javax.management.modelmbean.DescriptorSupport}.
 *
...
public abstract interface DescriptorSupportClassTests<SUT extends DescriptorSupport>
extends DescriptorClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DescriptorSupport.class!",
                   DescriptorSupport.class.isAssignableFrom(sut));
    }

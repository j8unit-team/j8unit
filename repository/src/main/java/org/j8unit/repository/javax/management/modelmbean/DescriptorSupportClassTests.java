 ...
 * javax.management.modelmbean.DescriptorSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DescriptorSupportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DescriptorSupportTests}.
 * </p>
 *
 * @see javax.management.modelmbean.DescriptorSupport class javax.management.modelmbean.DescriptorSupport (the hereby
 *      targeted class-under-test class)
 * @see DescriptorSupportTests DescriptorSupportTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.management.DescriptorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.modelmbean.DescriptorSupport.class!",
                   javax.management.modelmbean.DescriptorSupport.class.isAssignableFrom(sut));
    }

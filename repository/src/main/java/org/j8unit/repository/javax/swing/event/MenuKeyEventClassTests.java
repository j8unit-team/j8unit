...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.MenuKeyEvent class javax.swing.event.MenuKeyEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuKeyEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuKeyEventTests}.
 * </p>
 *
 * @see javax.swing.event.MenuKeyEvent class javax.swing.event.MenuKeyEvent (the hereby targeted class-under-test class)
 * @see MenuKeyEventTests MenuKeyEventTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MenuKeyEventClassTests<SUT extends javax.swing.event.MenuKeyEvent>
extends org.j8unit.repository.java.awt.event.KeyEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MenuKeyEvent.class!",
                   javax.swing.event.MenuKeyEvent.class.isAssignableFrom(sut));
    }

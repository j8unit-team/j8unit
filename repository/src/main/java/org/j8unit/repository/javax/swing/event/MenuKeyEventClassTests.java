...
import org.j8unit.repository.java.awt.event.KeyEventClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuKeyEvent public
...
public abstract interface MenuKeyEventClassTests<SUT extends MenuKeyEvent>
extends KeyEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuKeyEvent.class!",
                   MenuKeyEvent.class.isAssignableFrom(sut));
    }

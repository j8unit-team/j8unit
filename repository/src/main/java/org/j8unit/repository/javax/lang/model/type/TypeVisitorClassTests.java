 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeVisitor public
 * abstract interface javax.lang.model.type.TypeVisitor<R,P>}.
 *
...
public abstract interface TypeVisitorClassTests<SUT extends TypeVisitor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeVisitor.class!",
                   TypeVisitor.class.isAssignableFrom(sut));
    }

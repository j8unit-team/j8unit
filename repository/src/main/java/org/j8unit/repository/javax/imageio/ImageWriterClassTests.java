 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageWriter public
 * abstract class javax.imageio.ImageWriter}.
 *
...
public abstract interface ImageWriterClassTests<SUT extends ImageWriter>
extends ImageTranscoderClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageWriter.class!",
                   ImageWriter.class.isAssignableFrom(sut));
    }

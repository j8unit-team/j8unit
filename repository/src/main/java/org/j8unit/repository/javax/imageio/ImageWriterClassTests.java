 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageWriterTests}.
 * </p>
 *
 * @see javax.imageio.ImageWriter class javax.imageio.ImageWriter (the hereby targeted class-under-test class)
 * @see ImageWriterTests ImageWriterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ImageWriterClassTests<SUT extends javax.imageio.ImageWriter>
extends ImageTranscoderClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.ImageWriter.class!",
                   javax.imageio.ImageWriter.class.isAssignableFrom(sut));
    }

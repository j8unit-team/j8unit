 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLEngineTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SSLEngineTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLEngine class javax.net.ssl.SSLEngine (the hereby targeted class-under-test class)
 * @see SSLEngineTests SSLEngineTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SSLEngineClassTests<SUT extends javax.net.ssl.SSLEngine>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLEngine.class!",
                   javax.net.ssl.SSLEngine.class.isAssignableFrom(sut));
    }

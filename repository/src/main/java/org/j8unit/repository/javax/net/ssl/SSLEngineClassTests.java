 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SSLEngine public
 * abstract class javax.net.ssl.SSLEngine}.
 *
...
public abstract interface SSLEngineClassTests<SUT extends SSLEngine>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLEngine.class!",
                   SSLEngine.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.imageio.event.IIOReadWarningListener interface
 * javax.imageio.event.IIOReadWarningListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOReadWarningListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link IIOReadWarningListenerTests}.
 * </p>
 *
 * @see javax.imageio.event.IIOReadWarningListener interface javax.imageio.event.IIOReadWarningListener (the hereby
 *      targeted class-under-test class)
 * @see IIOReadWarningListenerTests IIOReadWarningListenerTests (The complementary j8unit test interface containing the
...
public abstract interface IIOReadWarningListenerClassTests<SUT extends javax.imageio.event.IIOReadWarningListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.event.IIOReadWarningListener.class!",
                   javax.imageio.event.IIOReadWarningListener.class.isAssignableFrom(sut));
    }

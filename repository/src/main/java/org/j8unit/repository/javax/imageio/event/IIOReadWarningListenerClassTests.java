 ...
 * {@link IIOReadWarningListener public abstract interface javax.imageio.event.IIOReadWarningListener}.
 *
 ...
 * {@link org.j8unit.repository.javax.imageio.event.IIOReadWarningListenerTests}.
 * </p>
 *
 * <p>
...
public abstract interface IIOReadWarningListenerClassTests<SUT extends IIOReadWarningListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOReadWarningListener.class!",
                   IIOReadWarningListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterMakeAndModel
 * public final class javax.print.attribute.standard.PrinterMakeAndModel}.
 *
...
public abstract interface PrinterMakeAndModelClassTests<SUT extends PrinterMakeAndModel>
extends PrintServiceAttributeClassTests<SUT>, TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterMakeAndModel.class!",

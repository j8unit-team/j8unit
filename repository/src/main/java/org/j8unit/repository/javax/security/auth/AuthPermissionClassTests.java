...
/**
 * <p>
 * Test class for {@link javax.security.auth.AuthPermission class javax.security.auth.AuthPermission}, containing all
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final javax.security.auth.AuthPermission sut = null; // = new AuthPermission(java.lang.String,java.lang.String);
    }
    ...
    throws Exception {
        // create new instance
        final Class<? extends javax.security.auth.AuthPermission> sut = createNewSUT();

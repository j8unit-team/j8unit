 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AuthPermission
...
public abstract interface AuthPermissionClassTests<SUT extends AuthPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AuthPermission.class!",
                   AuthPermission.class.isAssignableFrom(sut));
    }

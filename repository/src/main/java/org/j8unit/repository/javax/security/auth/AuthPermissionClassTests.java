 ...
 * javax.security.auth.AuthPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AuthPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AuthPermissionTests}.
 * </p>
 *
 * @see javax.security.auth.AuthPermission class javax.security.auth.AuthPermission (the hereby targeted
 *      class-under-test class)
 * @see AuthPermissionTests AuthPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.AuthPermission.class!",
                   javax.security.auth.AuthPermission.class.isAssignableFrom(sut));
    }

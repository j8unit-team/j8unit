...
import org.j8unit.repository.javax.swing.plaf.DesktopIconUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicDesktopIconUI
 * public class javax.swing.plaf.basic.BasicDesktopIconUI}.
 *
...
public abstract interface BasicDesktopIconUIClassTests<SUT extends BasicDesktopIconUI>
extends DesktopIconUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicDesktopIconUI.class!",

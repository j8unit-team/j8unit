 ...
 * javax.swing.plaf.basic.BasicDesktopIconUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicDesktopIconUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicDesktopIconUITests}.
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicDesktopIconUI class javax.swing.plaf.basic.BasicDesktopIconUI (the hereby targeted
 *      class-under-test class)
 * @see BasicDesktopIconUITests BasicDesktopIconUITests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.swing.plaf.DesktopIconUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicDesktopIconUI.class!",
                   javax.swing.plaf.basic.BasicDesktopIconUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicDesktopIconUI.MouseInputHandler class
     * javax.swing.plaf.basic.BasicDesktopIconUI$MouseInputHandler}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link BasicDesktopIconUITests.MouseInputHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see BasicDesktopIconUITests.MouseInputHandlerTests BasicDesktopIconUITests.MouseInputHandlerTests (The
    ...
    extends org.j8unit.repository.javax.swing.event.MouseInputAdapterClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicDesktopIconUI.MouseInputHandler.class!",
                       javax.swing.plaf.basic.BasicDesktopIconUI.MouseInputHandler.class.isAssignableFrom(sut));
        }

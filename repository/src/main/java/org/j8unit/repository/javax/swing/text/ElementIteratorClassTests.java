...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.text.ElementIterator class
 * javax.swing.text.ElementIterator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ElementIteratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ElementIteratorTests}.
 * </p>
 *
 * @see javax.swing.text.ElementIterator class javax.swing.text.ElementIterator (the hereby targeted class-under-test
 *      class)
 * @see ElementIteratorTests ElementIteratorTests (The complementary j8unit test interface containing the instance
...
public abstract interface ElementIteratorClassTests<SUT extends javax.swing.text.ElementIterator>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.ElementIterator.class!",
                   javax.swing.text.ElementIterator.class.isAssignableFrom(sut));
    }

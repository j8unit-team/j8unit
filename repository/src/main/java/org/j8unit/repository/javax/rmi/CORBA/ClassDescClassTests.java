 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ClassDesc public
...
public abstract interface ClassDescClassTests<SUT extends ClassDesc>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassDesc.class!",
                   ClassDesc.class.isAssignableFrom(sut));
    }

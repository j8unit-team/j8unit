 ...
 * {@link SSLSessionBindingListener public abstract interface javax.net.ssl.SSLSessionBindingListener}.
 *
...
public abstract interface SSLSessionBindingListenerClassTests<SUT extends SSLSessionBindingListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLSessionBindingListener.class!",
                   SSLSessionBindingListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.net.ssl.SSLSessionBindingListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link SSLSessionBindingListenerTests}).
 * </p>
 *
 * <p>
 ...
 * @see SSLSessionBindingListenerTests SSLSessionBindingListenerTests (The complementary j8unit test interface
...
public abstract interface SSLSessionBindingListenerClassTests<SUT extends javax.net.ssl.SSLSessionBindingListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLSessionBindingListener.class!",
                   javax.net.ssl.SSLSessionBindingListener.class.isAssignableFrom(sut));
    }

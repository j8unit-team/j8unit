 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StreamFilter public
 * abstract interface javax.xml.stream.StreamFilter}.
 *
...
public abstract interface StreamFilterClassTests<SUT extends StreamFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamFilter.class!",

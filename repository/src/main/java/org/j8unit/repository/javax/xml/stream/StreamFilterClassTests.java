 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamFilterTests}.
 * </p>
 *
 * @see javax.xml.stream.StreamFilter interface javax.xml.stream.StreamFilter (the hereby targeted class-under-test
 *      class)
 * @see StreamFilterTests StreamFilterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StreamFilterClassTests<SUT extends javax.xml.stream.StreamFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.StreamFilter.class!",
                   javax.xml.stream.StreamFilter.class.isAssignableFrom(sut));
    }

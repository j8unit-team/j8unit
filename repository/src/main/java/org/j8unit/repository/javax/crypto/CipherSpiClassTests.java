 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CipherSpi public
 * abstract class javax.crypto.CipherSpi}.
 *
...
public abstract interface CipherSpiClassTests<SUT extends CipherSpi>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.crypto.CipherSpi]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CipherSpi.class!",
                   CipherSpi.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.crypto.CipherSpi]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.crypto.CipherSpi]

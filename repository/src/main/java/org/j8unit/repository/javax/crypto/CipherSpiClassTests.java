...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.crypto.CipherSpi class javax.crypto.CipherSpi}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CipherSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CipherSpiTests}.
 * </p>
 *
 * @see javax.crypto.CipherSpi class javax.crypto.CipherSpi (the hereby targeted class-under-test class)
 * @see CipherSpiTests CipherSpiTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CipherSpiClassTests<SUT extends javax.crypto.CipherSpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.CipherSpi.class!",
                   javax.crypto.CipherSpi.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.annotation.PreDestroy interface javax.annotation.PreDestroy},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PreDestroyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PreDestroyTests}.
 * </p>
 *
 * @see javax.annotation.PreDestroy interface javax.annotation.PreDestroy (the hereby targeted class-under-test class)
 * @see PreDestroyTests PreDestroyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PreDestroyClassTests<SUT extends javax.annotation.PreDestroy>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.PreDestroy.class!",
                   javax.annotation.PreDestroy.class.isAssignableFrom(sut));
    }

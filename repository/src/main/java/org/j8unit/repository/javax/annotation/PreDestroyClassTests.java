 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PreDestroy public
 * abstract @interface javax.annotation.PreDestroy}.
 *
...
public abstract interface PreDestroyClassTests<SUT extends PreDestroy>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PreDestroy.class!",
                   PreDestroy.class.isAssignableFrom(sut));
    }

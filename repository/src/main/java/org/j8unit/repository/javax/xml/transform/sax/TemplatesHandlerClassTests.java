 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemplatesHandler
 * public abstract interface javax.xml.transform.sax.TemplatesHandler}.
 *
...
public abstract interface TemplatesHandlerClassTests<SUT extends TemplatesHandler>
extends ContentHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemplatesHandler.class!",
                   TemplatesHandler.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.transform.sax.TemplatesHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemplatesHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemplatesHandlerTests}.
 * </p>
 *
 * @see javax.xml.transform.sax.TemplatesHandler interface javax.xml.transform.sax.TemplatesHandler (the hereby targeted
 *      class-under-test class)
 * @see TemplatesHandlerTests TemplatesHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface TemplatesHandlerClassTests<SUT extends javax.xml.transform.sax.TemplatesHandler>
extends org.j8unit.repository.org.xml.sax.ContentHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.sax.TemplatesHandler.class!",
                   javax.xml.transform.sax.TemplatesHandler.class.isAssignableFrom(sut));
    }

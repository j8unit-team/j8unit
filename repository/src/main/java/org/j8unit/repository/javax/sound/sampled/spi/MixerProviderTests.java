 ...
 * non-{@code static} methods) of {@linkplain javax.sound.sampled.spi.MixerProvider class
 * javax.sound.sampled.spi.MixerProvider}. The complementary j8unit test interface containing the class relevant aspects
 * is {@link MixerProviderClassTests}.
 * </p>
 *
 * @see javax.sound.sampled.spi.MixerProvider class javax.sound.sampled.spi.MixerProvider (the hereby targeted
 *      class-under-test class)
 * @see MixerProviderClassTests MixerProviderClassTests (the complementary j8unit test interface containing the class
...
extends org.j8unit.repository.java.lang.ObjectTests<SUT> {
     ...
     * </p>
     *
     * @see javax.sound.sampled.spi.MixerProvider#getMixerInfo() public abstract javax.sound.sampled.Mixer$Info[]
     *      javax.sound.sampled.spi.MixerProvider.getMixerInfo() (the hereby targeted method-under-test)
     */
     ...
     * </p>
     *
     * @see javax.sound.sampled.spi.MixerProvider#isMixerSupported(javax.sound.sampled.Mixer.Info) public boolean
     *      javax.sound.sampled.spi.MixerProvider.isMixerSupported(javax.sound.sampled.Mixer$Info) (the hereby targeted
     *      method-under-test)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
     ...
     * </p>
     *
     * @see javax.sound.sampled.spi.MixerProvider#getMixer(javax.sound.sampled.Mixer.Info) public abstract

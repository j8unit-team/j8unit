...
import org.j8unit.repository.javax.swing.plaf.ProgressBarUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicProgressBarUI
 * public class javax.swing.plaf.basic.BasicProgressBarUI}.
 *
...
public abstract interface BasicProgressBarUIClassTests<SUT extends BasicProgressBarUI>
extends ProgressBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicProgressBarUI.class!",
                   BasicProgressBarUI.class.isAssignableFrom(sut));
    }
     ...
     * {@link ChangeHandler public class javax.swing.plaf.basic.BasicProgressBarUI$ChangeHandler}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompilableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompilableTests}.
 * </p>
 *
 * @see javax.script.Compilable interface javax.script.Compilable (the hereby targeted class-under-test class)
 * @see CompilableTests CompilableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CompilableClassTests<SUT extends javax.script.Compilable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.Compilable.class!",
                   javax.script.Compilable.class.isAssignableFrom(sut));
    }

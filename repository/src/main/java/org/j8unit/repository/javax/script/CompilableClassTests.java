 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Compilable public
 * abstract interface javax.script.Compilable}.
 *
...
public abstract interface CompilableClassTests<SUT extends Compilable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Compilable.class!",
                   Compilable.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NumberFormatter
 * public class javax.swing.text.NumberFormatter}.
 *
...
public abstract interface NumberFormatterClassTests<SUT extends NumberFormatter>
extends InternationalFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NumberFormatter.class!",
                   NumberFormatter.class.isAssignableFrom(sut));
    }

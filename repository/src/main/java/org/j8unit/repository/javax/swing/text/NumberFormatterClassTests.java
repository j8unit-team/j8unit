 ...
 * javax.swing.text.NumberFormatter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NumberFormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NumberFormatterTests}.
 * </p>
 *
 * @see javax.swing.text.NumberFormatter class javax.swing.text.NumberFormatter (the hereby targeted class-under-test
 *      class)
 * @see NumberFormatterTests NumberFormatterTests (The complementary j8unit test interface containing the instance
...
extends InternationalFormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.NumberFormatter.class!",
                   javax.swing.text.NumberFormatter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicAttributes
...
public abstract interface BasicAttributesClassTests<SUT extends BasicAttributes>
extends AttributesClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicAttributes.class!",
                   BasicAttributes.class.isAssignableFrom(sut));
    }

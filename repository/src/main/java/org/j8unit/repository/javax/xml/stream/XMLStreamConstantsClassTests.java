 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLStreamConstants
 * public abstract interface javax.xml.stream.XMLStreamConstants}.
 *
...
public abstract interface XMLStreamConstantsClassTests<SUT extends XMLStreamConstants>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLStreamConstants.class!",
                   XMLStreamConstants.class.isAssignableFrom(sut));
    }

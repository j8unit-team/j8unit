 ...
 * javax.imageio.metadata.IIOMetadataFormatImpl}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOMetadataFormatImplTests}).
 * </p>
 *
 * <p>
 ...
 * {@link IIOMetadataFormatImplTests}.
 * </p>
 *
 * @see javax.imageio.metadata.IIOMetadataFormatImpl class javax.imageio.metadata.IIOMetadataFormatImpl (the hereby
 *      targeted class-under-test class)
 * @see IIOMetadataFormatImplTests IIOMetadataFormatImplTests (The complementary j8unit test interface containing the
...
extends IIOMetadataFormatClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.metadata.IIOMetadataFormatImpl.class!",
                   javax.imageio.metadata.IIOMetadataFormatImpl.class.isAssignableFrom(sut));
    }

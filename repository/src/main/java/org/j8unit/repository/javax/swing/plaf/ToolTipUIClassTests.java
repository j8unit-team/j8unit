 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToolTipUI public
 * abstract class javax.swing.plaf.ToolTipUI}.
 *
...
public abstract interface ToolTipUIClassTests<SUT extends ToolTipUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.ToolTipUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToolTipUI.class!",
                   ToolTipUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.ToolTipUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.ToolTipUI]

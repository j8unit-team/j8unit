...
import org.j8unit.repository.javax.swing.plaf.OptionPaneUIClassTests;
import org.j8unit.repository.javax.swing.plaf.basic.BasicOptionPaneUITests.ButtonActionListenerTests;
import org.j8unit.repository.javax.swing.plaf.basic.BasicOptionPaneUITests.ButtonAreaLayoutTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicOptionPaneUI
 * public class javax.swing.plaf.basic.BasicOptionPaneUI}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicOptionPaneUITests}.
 * </p>
 *
 * <p>
...
public abstract interface BasicOptionPaneUIClassTests<SUT extends BasicOptionPaneUI>
extends OptionPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicOptionPaneUI.class!",
                   BasicOptionPaneUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicOptionPaneUI]
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ButtonAreaLayoutClassTests<SUT extends ButtonAreaLayout>
    extends LayoutManagerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ButtonAreaLayout.class!",
                              ButtonAreaLayout.class.isAssignableFrom(sut));
        }
    ...
    extends PropertyChangeListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicOptionPaneUI$PropertyChangeHandler]
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link ButtonActionListenerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ButtonActionListenerClassTests<SUT extends ButtonActionListener>
    extends ActionListenerClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ButtonActionListener.class!",
                              ButtonActionListener.class.isAssignableFrom(sut));
        }

        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.basic.BasicOptionPaneUI$ButtonActionListener]

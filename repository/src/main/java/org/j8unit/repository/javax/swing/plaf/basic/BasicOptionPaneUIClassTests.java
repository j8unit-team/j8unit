 ...
 * javax.swing.plaf.basic.BasicOptionPaneUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicOptionPaneUITests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.plaf.basic.BasicOptionPaneUI class javax.swing.plaf.basic.BasicOptionPaneUI (the hereby targeted
 *      class-under-test class)
 * @see BasicOptionPaneUITests BasicOptionPaneUITests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.swing.plaf.OptionPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicOptionPaneUI.class!",
                   javax.swing.plaf.basic.BasicOptionPaneUI.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.plaf.basic.BasicOptionPaneUI.ButtonAreaLayout class
     * javax.swing.plaf.basic.BasicOptionPaneUI$ButtonAreaLayout}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link BasicOptionPaneUITests.ButtonAreaLayoutTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.plaf.basic.BasicOptionPaneUI.ButtonAreaLayout class
     *      javax.swing.plaf.basic.BasicOptionPaneUI$ButtonAreaLayout (the hereby targeted class-under-test class)
     * @see BasicOptionPaneUITests.ButtonAreaLayoutTests BasicOptionPaneUITests.ButtonAreaLayoutTests (The complementary
    ...
    extends org.j8unit.repository.java.awt.LayoutManagerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicOptionPaneUI.ButtonAreaLayout.class!",
                       javax.swing.plaf.basic.BasicOptionPaneUI.ButtonAreaLayout.class.isAssignableFrom(sut));
        }
     ...
     * class javax.swing.plaf.basic.BasicOptionPaneUI$ButtonActionListener}, containing all type relevant aspects
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link BasicOptionPaneUITests.ButtonActionListenerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.plaf.basic.BasicOptionPaneUI.ButtonActionListener class
     *      javax.swing.plaf.basic.BasicOptionPaneUI$ButtonActionListener (the hereby targeted class-under-test class)
     * @see BasicOptionPaneUITests.ButtonActionListenerTests BasicOptionPaneUITests.ButtonActionListenerTests (The
    ...
    extends org.j8unit.repository.java.awt.event.ActionListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicOptionPaneUI.ButtonActionListener.class!",
                       javax.swing.plaf.basic.BasicOptionPaneUI.ButtonActionListener.class.isAssignableFrom(sut));
        }
     ...
     * class javax.swing.plaf.basic.BasicOptionPaneUI$PropertyChangeHandler}, containing all type relevant aspects
     * (e.&thinsp;g., runtime constraints and further type specific requirements). (In addition, the runtime type of
     * this j8unit test interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link BasicOptionPaneUITests.PropertyChangeHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.plaf.basic.BasicOptionPaneUI.PropertyChangeHandler class
     *      javax.swing.plaf.basic.BasicOptionPaneUI$PropertyChangeHandler (the hereby targeted class-under-test class)
     * @see BasicOptionPaneUITests.PropertyChangeHandlerTests BasicOptionPaneUITests.PropertyChangeHandlerTests (The
     *      complementary j8unit test interface containing the instance relevant test methods)
     *
     * @param SUT
     *            the class' type of the subject-under-test
    ...
    extends org.j8unit.repository.java.beans.PropertyChangeListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.basic.BasicOptionPaneUI.PropertyChangeHandler.class!",
                       javax.swing.plaf.basic.BasicOptionPaneUI.PropertyChangeHandler.class.isAssignableFrom(sut));
        }

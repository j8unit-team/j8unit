 ...
 * {@link MenuDragMouseListener public abstract interface javax.swing.event.MenuDragMouseListener}.
 *
...
public abstract interface MenuDragMouseListenerClassTests<SUT extends MenuDragMouseListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuDragMouseListener.class!",
                   MenuDragMouseListener.class.isAssignableFrom(sut));
    }

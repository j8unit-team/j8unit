...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.MenuDragMouseListener interface
 * javax.swing.event.MenuDragMouseListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuDragMouseListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MenuDragMouseListenerTests}.
 * </p>
 *
 * @see javax.swing.event.MenuDragMouseListener interface javax.swing.event.MenuDragMouseListener (the hereby targeted
 *      class-under-test class)
 * @see MenuDragMouseListenerTests MenuDragMouseListenerTests (The complementary j8unit test interface containing the
...
public abstract interface MenuDragMouseListenerClassTests<SUT extends javax.swing.event.MenuDragMouseListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.MenuDragMouseListener.class!",
                   javax.swing.event.MenuDragMouseListener.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.ConfigurationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConfigurationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ConfigurationExceptionTests}.
 * </p>
 *
 * @see javax.naming.ConfigurationException class javax.naming.ConfigurationException (the hereby targeted
 *      class-under-test class)
 * @see ConfigurationExceptionTests ConfigurationExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ConfigurationExceptionClassTests<SUT extends javax.naming.ConfigurationException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ConfigurationException.class!",
                   javax.naming.ConfigurationException.class.isAssignableFrom(sut));
    }

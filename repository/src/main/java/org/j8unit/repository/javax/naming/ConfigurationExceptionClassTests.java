 ...
 * {@link ConfigurationException public class javax.naming.ConfigurationException}.
 *
...
public abstract interface ConfigurationExceptionClassTests<SUT extends ConfigurationException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConfigurationException.class!",

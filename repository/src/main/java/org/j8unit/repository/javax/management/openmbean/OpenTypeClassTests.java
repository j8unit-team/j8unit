...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.OpenType class
 * javax.management.openmbean.OpenType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OpenTypeTests}.
 * </p>
 *
 * @see javax.management.openmbean.OpenType class javax.management.openmbean.OpenType (the hereby targeted
 *      class-under-test class)
 * @see OpenTypeTests OpenTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface OpenTypeClassTests<SUT extends javax.management.openmbean.OpenType>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenType.class!",
                   javax.management.openmbean.OpenType.class.isAssignableFrom(sut));
    }

 ...
 * javax.net.ssl.SSLHandshakeException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SSLHandshakeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SSLHandshakeExceptionTests}.
 * </p>
 *
 * @see javax.net.ssl.SSLHandshakeException class javax.net.ssl.SSLHandshakeException (the hereby targeted
 *      class-under-test class)
 * @see SSLHandshakeExceptionTests SSLHandshakeExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface SSLHandshakeExceptionClassTests<SUT extends javax.net.ssl.SSLHandshakeException>
extends SSLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.SSLHandshakeException.class!",
                   javax.net.ssl.SSLHandshakeException.class.isAssignableFrom(sut));
    }

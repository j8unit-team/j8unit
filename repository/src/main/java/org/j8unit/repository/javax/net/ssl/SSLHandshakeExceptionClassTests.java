...
public abstract interface SSLHandshakeExceptionClassTests<SUT extends SSLHandshakeException>
extends SSLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SSLHandshakeException.class!",
                   SSLHandshakeException.class.isAssignableFrom(sut));
    }

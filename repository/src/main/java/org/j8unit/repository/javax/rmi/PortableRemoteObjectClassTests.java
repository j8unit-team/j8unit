 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PortableRemoteObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PortableRemoteObjectTests}
 * .
 * </p>
 *
 * @see javax.rmi.PortableRemoteObject class javax.rmi.PortableRemoteObject (the hereby targeted class-under-test class)
 * @see PortableRemoteObjectTests PortableRemoteObjectTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.PortableRemoteObject.class!",
                   javax.rmi.PortableRemoteObject.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CommonDataSource
 * public abstract interface javax.sql.CommonDataSource}.
 *
...
public abstract interface CommonDataSourceClassTests<SUT extends CommonDataSource>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CommonDataSource.class!",
                   CommonDataSource.class.isAssignableFrom(sut));
    }

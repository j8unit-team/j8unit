...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.CommonDataSource interface javax.sql.CommonDataSource},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CommonDataSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CommonDataSourceTests}.
 * </p>
 *
 * @see javax.sql.CommonDataSource interface javax.sql.CommonDataSource (the hereby targeted class-under-test class)
 * @see CommonDataSourceTests CommonDataSourceTests (The complementary j8unit test interface containing the instance
...
public abstract interface CommonDataSourceClassTests<SUT extends javax.sql.CommonDataSource>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.CommonDataSource.class!",
                   javax.sql.CommonDataSource.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.event.NamespaceChangeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamespaceChangeListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NamespaceChangeListenerTests}.
 * </p>
 *
 * @see javax.naming.event.NamespaceChangeListener interface javax.naming.event.NamespaceChangeListener (the hereby
 *      targeted class-under-test class)
 * @see NamespaceChangeListenerTests NamespaceChangeListenerTests (The complementary j8unit test interface containing
...
public abstract interface NamespaceChangeListenerClassTests<SUT extends javax.naming.event.NamespaceChangeListener>
extends NamingListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.event.NamespaceChangeListener.class!",
                   javax.naming.event.NamespaceChangeListener.class.isAssignableFrom(sut));
    }

 ...
 * {@link NamespaceChangeListener public abstract interface javax.naming.event.NamespaceChangeListener}.
 *
 ...
 * {@link org.j8unit.repository.javax.naming.event.NamespaceChangeListenerTests}.
 * </p>
 *
 * <p>
...
public abstract interface NamespaceChangeListenerClassTests<SUT extends NamespaceChangeListener>
extends NamingListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamespaceChangeListener.class!",
                   NamespaceChangeListener.class.isAssignableFrom(sut));
    }

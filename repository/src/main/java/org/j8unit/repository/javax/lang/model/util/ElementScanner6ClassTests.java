 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ElementScanner6
 * public class javax.lang.model.util.ElementScanner6<R,P>}.
 *
...
public abstract interface ElementScanner6ClassTests<SUT extends ElementScanner6>
extends org.j8unit.repository.javax.lang.model.util.AbstractElementVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementScanner6.class!",
                   ElementScanner6.class.isAssignableFrom(sut));
    }

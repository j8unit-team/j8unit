...
extends org.j8unit.repository.javax.print.attribute.AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SupportedValuesAttribute.class!",
                   SupportedValuesAttribute.class.isAssignableFrom(sut));
    }

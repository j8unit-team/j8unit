 ...
 * javax.print.attribute.SupportedValuesAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SupportedValuesAttributeTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see SupportedValuesAttributeTests SupportedValuesAttributeTests (The complementary j8unit test interface containing
...
public abstract interface SupportedValuesAttributeClassTests<SUT extends javax.print.attribute.SupportedValuesAttribute>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.SupportedValuesAttribute.class!",
                   javax.print.attribute.SupportedValuesAttribute.class.isAssignableFrom(sut));
    }

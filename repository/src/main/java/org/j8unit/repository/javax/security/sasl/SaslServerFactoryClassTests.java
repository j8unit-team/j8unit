 ...
 * javax.security.sasl.SaslServerFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SaslServerFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SaslServerFactoryTests}.
 * </p>
 *
 * @see javax.security.sasl.SaslServerFactory interface javax.security.sasl.SaslServerFactory (the hereby targeted
 *      class-under-test class)
 * @see SaslServerFactoryTests SaslServerFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface SaslServerFactoryClassTests<SUT extends javax.security.sasl.SaslServerFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.SaslServerFactory.class!",
                   javax.security.sasl.SaslServerFactory.class.isAssignableFrom(sut));
    }

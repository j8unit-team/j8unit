 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SaslServerFactory
 * public abstract interface javax.security.sasl.SaslServerFactory}.
 *
...
public abstract interface SaslServerFactoryClassTests<SUT extends SaslServerFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SaslServerFactory.class!",

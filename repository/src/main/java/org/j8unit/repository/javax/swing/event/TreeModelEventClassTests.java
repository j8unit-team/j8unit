 ...
 * javax.swing.event.TreeModelEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeModelEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeModelEventTests}.
 * </p>
 *
 * @see javax.swing.event.TreeModelEvent class javax.swing.event.TreeModelEvent (the hereby targeted class-under-test
 *      class)
 * @see TreeModelEventTests TreeModelEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.TreeModelEvent.class!",
                   javax.swing.event.TreeModelEvent.class.isAssignableFrom(sut));
    }

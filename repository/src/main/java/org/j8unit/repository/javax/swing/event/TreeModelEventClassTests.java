 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeModelEvent
...
public abstract interface TreeModelEventClassTests<SUT extends TreeModelEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeModelEvent.class!",
                   TreeModelEvent.class.isAssignableFrom(sut));
    }

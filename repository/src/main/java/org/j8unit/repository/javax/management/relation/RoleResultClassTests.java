 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoleResult public
...
public abstract interface RoleResultClassTests<SUT extends RoleResult>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.relation.RoleResult]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoleResult.class!",
                   RoleResult.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IIOByteBuffer
...
public abstract interface IIOByteBufferClassTests<SUT extends IIOByteBuffer>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOByteBuffer.class!",
                   IIOByteBuffer.class.isAssignableFrom(sut));
    }

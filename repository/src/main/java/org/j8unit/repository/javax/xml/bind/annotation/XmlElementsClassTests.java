 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlElements public
 * abstract @interface javax.xml.bind.annotation.XmlElements}.
 *
...
public abstract interface XmlElementsClassTests<SUT extends XmlElements>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlElements.class!",
                   XmlElements.class.isAssignableFrom(sut));
    }

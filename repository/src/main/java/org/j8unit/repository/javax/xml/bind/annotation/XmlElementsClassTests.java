 ...
 * javax.xml.bind.annotation.XmlElements}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlElementsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlElementsTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlElements interface javax.xml.bind.annotation.XmlElements (the hereby targeted
 *      class-under-test class)
 * @see XmlElementsTests XmlElementsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlElementsClassTests<SUT extends javax.xml.bind.annotation.XmlElements>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlElements.class!",
                   javax.xml.bind.annotation.XmlElements.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicGraphicsUtils
...
public abstract interface BasicGraphicsUtilsClassTests<SUT extends BasicGraphicsUtils>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicGraphicsUtils.class!",
                   BasicGraphicsUtils.class.isAssignableFrom(sut));
    }

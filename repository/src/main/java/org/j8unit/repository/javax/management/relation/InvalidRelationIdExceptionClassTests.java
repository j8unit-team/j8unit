 ...
 * {@link InvalidRelationIdException public class javax.management.relation.InvalidRelationIdException}.
 *
...
public abstract interface InvalidRelationIdExceptionClassTests<SUT extends InvalidRelationIdException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidRelationIdException.class!",
                   InvalidRelationIdException.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.relation.InvalidRelationIdException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidRelationIdExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidRelationIdExceptionTests InvalidRelationIdExceptionTests (The complementary j8unit test interface
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.InvalidRelationIdException.class!",
                   javax.management.relation.InvalidRelationIdException.class.isAssignableFrom(sut));
    }

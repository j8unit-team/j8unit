 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPBodyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPBodyTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPBody interface javax.xml.soap.SOAPBody (the hereby targeted class-under-test class)
 * @see SOAPBodyTests SOAPBodyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SOAPBodyClassTests<SUT extends javax.xml.soap.SOAPBody>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPBody.class!",
                   javax.xml.soap.SOAPBody.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPBody public
...
public abstract interface SOAPBodyClassTests<SUT extends SOAPBody>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPBody.class!",
                   SOAPBody.class.isAssignableFrom(sut));
    }

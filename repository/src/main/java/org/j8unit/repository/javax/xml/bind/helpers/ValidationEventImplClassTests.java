...
import org.j8unit.repository.javax.xml.bind.ValidationEventClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValidationEventImpl
 * public class javax.xml.bind.helpers.ValidationEventImpl}.
 *
...
public abstract interface ValidationEventImplClassTests<SUT extends ValidationEventImpl>
extends ValidationEventClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValidationEventImpl.class!",
                   ValidationEventImpl.class.isAssignableFrom(sut));
    }

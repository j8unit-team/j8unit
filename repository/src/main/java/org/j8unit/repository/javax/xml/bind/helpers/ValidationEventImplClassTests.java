 ...
 * javax.xml.bind.helpers.ValidationEventImpl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValidationEventImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValidationEventImplTests}.
 * </p>
 *
 * @see javax.xml.bind.helpers.ValidationEventImpl class javax.xml.bind.helpers.ValidationEventImpl (the hereby targeted
 *      class-under-test class)
 * @see ValidationEventImplTests ValidationEventImplTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.xml.bind.ValidationEventClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.helpers.ValidationEventImpl.class!",
                   javax.xml.bind.helpers.ValidationEventImpl.class.isAssignableFrom(sut));
    }

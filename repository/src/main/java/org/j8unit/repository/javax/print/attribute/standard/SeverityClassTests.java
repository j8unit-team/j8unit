 ...
 * javax.print.attribute.standard.Severity}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SeverityTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SeverityTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.Severity class javax.print.attribute.standard.Severity (the hereby targeted
 *      class-under-test class)
 * @see SeverityTests SeverityTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SeverityClassTests<SUT extends javax.print.attribute.standard.Severity>
extends org.j8unit.repository.javax.print.attribute.AttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.Severity.class!",
                   javax.print.attribute.standard.Severity.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Severity public
 * final class javax.print.attribute.standard.Severity}.
 *
...
public abstract interface SeverityClassTests<SUT extends Severity>
extends AttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Severity.class!",
                   Severity.class.isAssignableFrom(sut));
    }

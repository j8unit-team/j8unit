...
public abstract interface PartialResultExceptionClassTests<SUT extends PartialResultException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PartialResultException.class!",
                   PartialResultException.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.PartialResultException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PartialResultExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PartialResultExceptionTests}.
 * </p>
 *
 * @see javax.naming.PartialResultException class javax.naming.PartialResultException (the hereby targeted
 *      class-under-test class)
 * @see PartialResultExceptionTests PartialResultExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface PartialResultExceptionClassTests<SUT extends javax.naming.PartialResultException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.PartialResultException.class!",
                   javax.naming.PartialResultException.class.isAssignableFrom(sut));
    }

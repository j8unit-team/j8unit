 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindingType public
 * abstract @interface javax.xml.ws.BindingType}.
 *
...
public abstract interface BindingTypeClassTests<SUT extends BindingType>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingType.class!",

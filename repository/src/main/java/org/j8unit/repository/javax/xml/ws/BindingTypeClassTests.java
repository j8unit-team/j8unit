...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.ws.BindingType interface javax.xml.ws.BindingType},
...
public abstract interface BindingTypeClassTests<SUT extends javax.xml.ws.BindingType>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.BindingType.class!",
                   javax.xml.ws.BindingType.class.isAssignableFrom(sut));
    }

 ...
 * javax.script.AbstractScriptEngine}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractScriptEngineTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractScriptEngineTests}
 * .
 * </p>
 *
 * @see javax.script.AbstractScriptEngine class javax.script.AbstractScriptEngine (the hereby targeted class-under-test
 *      class)
 * @see AbstractScriptEngineTests AbstractScriptEngineTests (The complementary j8unit test interface containing the
...
extends ScriptEngineClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.AbstractScriptEngine.class!",
                   javax.script.AbstractScriptEngine.class.isAssignableFrom(sut));
    }

...
public abstract interface AbstractScriptEngineClassTests<SUT extends AbstractScriptEngine>
extends ScriptEngineClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractScriptEngine.class!",
                   AbstractScriptEngine.class.isAssignableFrom(sut));
    }

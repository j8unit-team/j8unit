 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IIOParamController
 * public abstract interface javax.imageio.IIOParamController}.
 *
...
public abstract interface IIOParamControllerClassTests<SUT extends IIOParamController>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOParamController.class!",
                   IIOParamController.class.isAssignableFrom(sut));
    }

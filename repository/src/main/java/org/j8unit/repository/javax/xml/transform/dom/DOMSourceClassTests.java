 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMSource public
...
public abstract interface DOMSourceClassTests<SUT extends DOMSource>
extends SourceClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.transform.dom.DOMSource]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMSource.class!",
                   DOMSource.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.transform.dom.DOMSource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DOMSourceTests}.
 * </p>
 *
 * @see javax.xml.transform.dom.DOMSource class javax.xml.transform.dom.DOMSource (the hereby targeted class-under-test
 *      class)
 * @see DOMSourceTests DOMSourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.xml.transform.SourceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.dom.DOMSource.class!",
                   javax.xml.transform.dom.DOMSource.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.event.InternalFrameListener interface
 * javax.swing.event.InternalFrameListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InternalFrameListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InternalFrameListenerTests}.
 * </p>
 *
 * @see javax.swing.event.InternalFrameListener interface javax.swing.event.InternalFrameListener (the hereby targeted
 *      class-under-test class)
 * @see InternalFrameListenerTests InternalFrameListenerTests (The complementary j8unit test interface containing the
...
public abstract interface InternalFrameListenerClassTests<SUT extends javax.swing.event.InternalFrameListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.InternalFrameListener.class!",
                   javax.swing.event.InternalFrameListener.class.isAssignableFrom(sut));
    }

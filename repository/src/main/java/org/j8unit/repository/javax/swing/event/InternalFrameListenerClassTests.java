 ...
 * {@link InternalFrameListener public abstract interface javax.swing.event.InternalFrameListener}.
 *
...
public abstract interface InternalFrameListenerClassTests<SUT extends InternalFrameListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InternalFrameListener.class!",
                   InternalFrameListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.crypto.XMLStructure interface javax.xml.crypto.XMLStructure}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLStructureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLStructureTests}.
 * </p>
 *
 * @see javax.xml.crypto.XMLStructure interface javax.xml.crypto.XMLStructure (the hereby targeted class-under-test
 *      class)
 * @see XMLStructureTests XMLStructureTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XMLStructureClassTests<SUT extends javax.xml.crypto.XMLStructure>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.XMLStructure.class!",
                   javax.xml.crypto.XMLStructure.class.isAssignableFrom(sut));
    }

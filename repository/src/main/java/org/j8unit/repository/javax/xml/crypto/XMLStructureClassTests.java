 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLStructure public
 * abstract interface javax.xml.crypto.XMLStructure}.
 *
...
public abstract interface XMLStructureClassTests<SUT extends XMLStructure>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLStructure.class!",
                   XMLStructure.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.security.DomainCombinerClassTests;
 ...
 * {@link SubjectDomainCombiner public class javax.security.auth.SubjectDomainCombiner}.
 *
...
public abstract interface SubjectDomainCombinerClassTests<SUT extends SubjectDomainCombiner>
extends DomainCombinerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SubjectDomainCombiner.class!",
                   SubjectDomainCombiner.class.isAssignableFrom(sut));
    }

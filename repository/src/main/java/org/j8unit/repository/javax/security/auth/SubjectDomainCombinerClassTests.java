 ...
 * javax.security.auth.SubjectDomainCombiner}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SubjectDomainCombinerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SubjectDomainCombinerTests}.
 * </p>
 *
 * @see javax.security.auth.SubjectDomainCombiner class javax.security.auth.SubjectDomainCombiner (the hereby targeted
 *      class-under-test class)
 * @see SubjectDomainCombinerTests SubjectDomainCombinerTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.DomainCombinerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.SubjectDomainCombiner.class!",
                   javax.security.auth.SubjectDomainCombiner.class.isAssignableFrom(sut));
    }

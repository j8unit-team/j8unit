...
public abstract interface FileImageOutputStreamClassTests<SUT extends FileImageOutputStream>
extends ImageOutputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileImageOutputStream.class!",
                   FileImageOutputStream.class.isAssignableFrom(sut));
    }

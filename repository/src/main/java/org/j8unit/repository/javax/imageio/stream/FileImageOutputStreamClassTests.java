 ...
 * javax.imageio.stream.FileImageOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileImageOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * {@link FileImageOutputStreamTests}.
 * </p>
 *
 * @see javax.imageio.stream.FileImageOutputStream class javax.imageio.stream.FileImageOutputStream (the hereby targeted
 *      class-under-test class)
 * @see FileImageOutputStreamTests FileImageOutputStreamTests (The complementary j8unit test interface containing the
...
extends ImageOutputStreamImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.stream.FileImageOutputStream.class!",
                   javax.imageio.stream.FileImageOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RespectBindingTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RespectBindingTests}.
 * </p>
 *
 * @see javax.xml.ws.RespectBinding interface javax.xml.ws.RespectBinding (the hereby targeted class-under-test class)
 * @see RespectBindingTests RespectBindingTests (The complementary j8unit test interface containing the instance
...
public abstract interface RespectBindingClassTests<SUT extends javax.xml.ws.RespectBinding>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.RespectBinding.class!",
                   javax.xml.ws.RespectBinding.class.isAssignableFrom(sut));
    }

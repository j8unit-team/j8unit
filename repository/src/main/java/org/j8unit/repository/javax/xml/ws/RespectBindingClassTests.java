 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RespectBinding
...
public abstract interface RespectBindingClassTests<SUT extends RespectBinding>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RespectBinding.class!",
                   RespectBinding.class.isAssignableFrom(sut));
    }

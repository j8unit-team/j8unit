...
public abstract interface TransactionRolledbackExceptionClassTests<SUT extends TransactionRolledbackException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransactionRolledbackException.class!",
                   TransactionRolledbackException.class.isAssignableFrom(sut));
    }

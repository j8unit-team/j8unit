 ...
 * javax.transaction.TransactionRolledbackException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link TransactionRolledbackExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see TransactionRolledbackExceptionTests TransactionRolledbackExceptionTests (The complementary j8unit test interface
...
public abstract interface TransactionRolledbackExceptionClassTests<SUT extends javax.transaction.TransactionRolledbackException>
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.transaction.TransactionRolledbackException.class!",
                   javax.transaction.TransactionRolledbackException.class.isAssignableFrom(sut));
    }

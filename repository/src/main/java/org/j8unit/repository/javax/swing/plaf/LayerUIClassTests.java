 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LayerUI public
...
public abstract interface LayerUIClassTests<SUT extends LayerUI>
extends SerializableClassTests<SUT>, ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LayerUI.class!",
                   LayerUI.class.isAssignableFrom(sut));
    }

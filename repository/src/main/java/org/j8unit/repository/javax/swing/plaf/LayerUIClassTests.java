 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LayerUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LayerUITests}.
 * </p>
 *
 * @see javax.swing.plaf.LayerUI class javax.swing.plaf.LayerUI (the hereby targeted class-under-test class)
 * @see LayerUITests LayerUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.LayerUI.class!",
                   javax.swing.plaf.LayerUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicColorChooserUI
 * public class javax.swing.plaf.basic.BasicColorChooserUI}.
 *
...
public abstract interface BasicColorChooserUIClassTests<SUT extends BasicColorChooserUI>
extends ColorChooserUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicColorChooserUI.class!",
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link PropertyHandlerTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>

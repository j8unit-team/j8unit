...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.plaf.TreeUI class javax.swing.plaf.TreeUI}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeUITests}.
 * </p>
 *
 * @see javax.swing.plaf.TreeUI class javax.swing.plaf.TreeUI (the hereby targeted class-under-test class)
 * @see TreeUITests TreeUITests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface TreeUIClassTests<SUT extends javax.swing.plaf.TreeUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.TreeUI.class!",
                   javax.swing.plaf.TreeUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeUI public
...
public abstract interface TreeUIClassTests<SUT extends TreeUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeUI.class!",
                   TreeUI.class.isAssignableFrom(sut));
    }

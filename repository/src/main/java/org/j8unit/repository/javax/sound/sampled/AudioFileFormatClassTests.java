 ...
 * javax.sound.sampled.AudioFileFormat}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AudioFileFormatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AudioFileFormatTests}.
 * </p>
 *
 * @see javax.sound.sampled.AudioFileFormat class javax.sound.sampled.AudioFileFormat (the hereby targeted
 *      class-under-test class)
 * @see AudioFileFormatTests AudioFileFormatTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.AudioFileFormat.class!",
                   javax.sound.sampled.AudioFileFormat.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.AudioFileFormat.Type class
     * javax.sound.sampled.AudioFileFormat$Type}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link AudioFileFormatTests.TypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.sound.sampled.AudioFileFormat.Type class javax.sound.sampled.AudioFileFormat$Type (the hereby targeted
     *      class-under-test class)
     * @see AudioFileFormatTests.TypeTests AudioFileFormatTests.TypeTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.AudioFileFormat.Type.class!",
                       javax.sound.sampled.AudioFileFormat.Type.class.isAssignableFrom(sut));
        }

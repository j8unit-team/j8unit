 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AudioFileFormat
 * public class javax.sound.sampled.AudioFileFormat}.
 *
...
public abstract interface AudioFileFormatClassTests<SUT extends AudioFileFormat>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AudioFileFormat.class!",
                   AudioFileFormat.class.isAssignableFrom(sut));
    }
     ...
     * {@link Type public static class javax.sound.sampled.AudioFileFormat$Type}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends ObjectClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.sound.sampled.AudioFileFormat$Type]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.sound.sampled.AudioFileFormat$Type]

        // J8UNIT-MARKER-[END]-[CLASS]-[javax.sound.sampled.AudioFileFormat$Type]

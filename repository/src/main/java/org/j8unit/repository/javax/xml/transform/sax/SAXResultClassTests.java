 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SAXResult public
...
public abstract interface SAXResultClassTests<SUT extends SAXResult>
extends ResultClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXResult.class!",
                   SAXResult.class.isAssignableFrom(sut));
    }

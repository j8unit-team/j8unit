 ...
 * javax.xml.transform.sax.SAXResult}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SAXResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SAXResultTests}.
 * </p>
 *
 * @see javax.xml.transform.sax.SAXResult class javax.xml.transform.sax.SAXResult (the hereby targeted class-under-test
 *      class)
 * @see SAXResultTests SAXResultTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SAXResultClassTests<SUT extends javax.xml.transform.sax.SAXResult>
extends org.j8unit.repository.javax.xml.transform.ResultClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.sax.SAXResult.class!",
                   javax.xml.transform.sax.SAXResult.class.isAssignableFrom(sut));
    }

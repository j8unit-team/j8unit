 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DirContext public
 * abstract interface javax.naming.directory.DirContext}.
 *
...
public abstract interface DirContextClassTests<SUT extends DirContext>
extends ContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirContext.class!",
                   DirContext.class.isAssignableFrom(sut));
    }

 ...
 * javax.naming.directory.DirContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DirContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DirContextTests}.
 * </p>
 *
 * @see javax.naming.directory.DirContext interface javax.naming.directory.DirContext (the hereby targeted
 *      class-under-test class)
 * @see DirContextTests DirContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DirContextClassTests<SUT extends javax.naming.directory.DirContext>
extends org.j8unit.repository.javax.naming.ContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.directory.DirContext.class!",
                   javax.naming.directory.DirContext.class.isAssignableFrom(sut));
    }

 ...
 * javax.sql.rowset.spi.SyncProviderException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SyncProviderExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SyncProviderExceptionTests}.
 * </p>
 *
 * @see javax.sql.rowset.spi.SyncProviderException class javax.sql.rowset.spi.SyncProviderException (the hereby targeted
 *      class-under-test class)
 * @see SyncProviderExceptionTests SyncProviderExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.sql.SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.spi.SyncProviderException.class!",
                   javax.sql.rowset.spi.SyncProviderException.class.isAssignableFrom(sut));
    }

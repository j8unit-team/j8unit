...
public abstract interface SyncProviderExceptionClassTests<SUT extends SyncProviderException>
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SyncProviderException.class!",
                   SyncProviderException.class.isAssignableFrom(sut));
    }

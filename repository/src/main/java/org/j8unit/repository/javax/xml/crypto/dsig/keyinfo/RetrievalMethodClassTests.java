 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RetrievalMethod
...
public abstract interface RetrievalMethodClassTests<SUT extends RetrievalMethod>
extends URIReferenceClassTests<SUT>, XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RetrievalMethod.class!",

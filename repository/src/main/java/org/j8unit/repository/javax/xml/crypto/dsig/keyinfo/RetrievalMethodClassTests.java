 ...
 * javax.xml.crypto.dsig.keyinfo.RetrievalMethod}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RetrievalMethodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RetrievalMethodTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.RetrievalMethod interface javax.xml.crypto.dsig.keyinfo.RetrievalMethod (the
 *      hereby targeted class-under-test class)
 * @see RetrievalMethodTests RetrievalMethodTests (The complementary j8unit test interface containing the instance
...
public abstract interface RetrievalMethodClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.RetrievalMethod>
extends org.j8unit.repository.javax.xml.crypto.URIReferenceClassTests<SUT>, org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.RetrievalMethod.class!",
                   javax.xml.crypto.dsig.keyinfo.RetrievalMethod.class.isAssignableFrom(sut));
    }

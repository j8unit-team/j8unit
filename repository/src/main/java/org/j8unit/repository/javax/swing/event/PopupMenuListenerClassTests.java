 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PopupMenuListener
 * public abstract interface javax.swing.event.PopupMenuListener}.
 *
...
public abstract interface PopupMenuListenerClassTests<SUT extends PopupMenuListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PopupMenuListener.class!",
                   PopupMenuListener.class.isAssignableFrom(sut));
    }

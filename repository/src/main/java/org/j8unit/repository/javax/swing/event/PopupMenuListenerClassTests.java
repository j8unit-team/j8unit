 ...
 * javax.swing.event.PopupMenuListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PopupMenuListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PopupMenuListenerTests}.
 * </p>
 *
 * @see javax.swing.event.PopupMenuListener interface javax.swing.event.PopupMenuListener (the hereby targeted
 *      class-under-test class)
 * @see PopupMenuListenerTests PopupMenuListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface PopupMenuListenerClassTests<SUT extends javax.swing.event.PopupMenuListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.PopupMenuListener.class!",
                   javax.swing.event.PopupMenuListener.class.isAssignableFrom(sut));
    }

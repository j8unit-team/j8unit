 ...
 * javax.print.event.PrintServiceAttributeEvent}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link PrintServiceAttributeEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see PrintServiceAttributeEventTests PrintServiceAttributeEventTests (The complementary j8unit test interface
...
extends PrintEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.event.PrintServiceAttributeEvent.class!",
                   javax.print.event.PrintServiceAttributeEvent.class.isAssignableFrom(sut));
    }

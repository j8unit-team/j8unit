 ...
 * {@link PrintServiceAttributeEvent public class javax.print.event.PrintServiceAttributeEvent}.
 *
...
public abstract interface PrintServiceAttributeEventClassTests<SUT extends PrintServiceAttributeEvent>
extends PrintEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintServiceAttributeEvent.class!",
                   PrintServiceAttributeEvent.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParagraphViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParagraphViewTests}.
 * </p>
 *
 * @see javax.swing.text.ParagraphView class javax.swing.text.ParagraphView (the hereby targeted class-under-test class)
 * @see ParagraphViewTests ParagraphViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends TabExpanderClassTests<SUT>, FlowViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.ParagraphView.class!",
                   javax.swing.text.ParagraphView.class.isAssignableFrom(sut));
    }

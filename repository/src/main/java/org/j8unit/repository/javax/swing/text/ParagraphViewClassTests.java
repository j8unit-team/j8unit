 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParagraphView
 * public class javax.swing.text.ParagraphView}.
 *
...
public abstract interface ParagraphViewClassTests<SUT extends ParagraphView>
extends org.j8unit.repository.javax.swing.text.TabExpanderClassTests<SUT>, org.j8unit.repository.javax.swing.text.FlowViewClassTests<SUT> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.text.ParagraphView]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParagraphView.class!",
                   ParagraphView.class.isAssignableFrom(sut));
    }

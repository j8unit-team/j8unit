 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XPathConstants
...
public abstract interface XPathConstantsClassTests<SUT extends XPathConstants>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.xml.xpath.XPathConstants]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathConstants.class!",
                   XPathConstants.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.xpath.XPathConstants]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.xml.xpath.XPathConstants]

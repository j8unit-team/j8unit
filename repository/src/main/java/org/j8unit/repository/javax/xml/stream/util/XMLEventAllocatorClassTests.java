 ...
 * javax.xml.stream.util.XMLEventAllocator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLEventAllocatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLEventAllocatorTests}.
 * </p>
 *
 * @see javax.xml.stream.util.XMLEventAllocator interface javax.xml.stream.util.XMLEventAllocator (the hereby targeted
 *      class-under-test class)
 * @see XMLEventAllocatorTests XMLEventAllocatorTests (The complementary j8unit test interface containing the instance
...
public abstract interface XMLEventAllocatorClassTests<SUT extends javax.xml.stream.util.XMLEventAllocator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.util.XMLEventAllocator.class!",
                   javax.xml.stream.util.XMLEventAllocator.class.isAssignableFrom(sut));
    }

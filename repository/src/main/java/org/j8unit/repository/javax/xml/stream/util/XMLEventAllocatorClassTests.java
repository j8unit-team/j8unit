 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLEventAllocator
 * public abstract interface javax.xml.stream.util.XMLEventAllocator}.
 *
...
public abstract interface XMLEventAllocatorClassTests<SUT extends XMLEventAllocator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLEventAllocator.class!",
                   XMLEventAllocator.class.isAssignableFrom(sut));
    }

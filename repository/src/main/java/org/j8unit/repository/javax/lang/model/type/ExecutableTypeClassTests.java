 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExecutableType
 * public abstract interface javax.lang.model.type.ExecutableType}.
 *
...
public abstract interface ExecutableTypeClassTests<SUT extends ExecutableType>
extends TypeMirrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExecutableType.class!",
                   ExecutableType.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.openmbean.InvalidKeyException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidKeyExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidKeyExceptionTests InvalidKeyExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.InvalidKeyException.class!",
                   javax.management.openmbean.InvalidKeyException.class.isAssignableFrom(sut));
    }

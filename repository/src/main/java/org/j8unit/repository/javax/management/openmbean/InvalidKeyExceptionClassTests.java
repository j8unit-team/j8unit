 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidKeyException
 * public class javax.management.openmbean.InvalidKeyException}.
 *
...
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidKeyException.class!",
                   InvalidKeyException.class.isAssignableFrom(sut));
    }

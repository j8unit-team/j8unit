 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SizeRequirements
 * public class javax.swing.SizeRequirements}.
 *
...
public abstract interface SizeRequirementsClassTests<SUT extends SizeRequirements>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SizeRequirements.class!",
                   SizeRequirements.class.isAssignableFrom(sut));
    }

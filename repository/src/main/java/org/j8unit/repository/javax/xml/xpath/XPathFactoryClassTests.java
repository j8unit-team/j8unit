 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XPathFactory public
 * abstract class javax.xml.xpath.XPathFactory}.
 *
...
public abstract interface XPathFactoryClassTests<SUT extends XPathFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathFactory.class!",
                   XPathFactory.class.isAssignableFrom(sut));
    }

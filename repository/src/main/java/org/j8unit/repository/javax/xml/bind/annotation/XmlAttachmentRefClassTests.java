 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAttachmentRef
 * public abstract @interface javax.xml.bind.annotation.XmlAttachmentRef}.
 *
...
public abstract interface XmlAttachmentRefClassTests<SUT extends XmlAttachmentRef>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAttachmentRef.class!",
                   XmlAttachmentRef.class.isAssignableFrom(sut));
    }

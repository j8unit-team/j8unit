 ...
 * javax.xml.bind.annotation.XmlAttachmentRef}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlAttachmentRefTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlAttachmentRefTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlAttachmentRef interface javax.xml.bind.annotation.XmlAttachmentRef (the hereby
 *      targeted class-under-test class)
 * @see XmlAttachmentRefTests XmlAttachmentRefTests (The complementary j8unit test interface containing the instance
...
public abstract interface XmlAttachmentRefClassTests<SUT extends javax.xml.bind.annotation.XmlAttachmentRef>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlAttachmentRef.class!",
                   javax.xml.bind.annotation.XmlAttachmentRef.class.isAssignableFrom(sut));
    }

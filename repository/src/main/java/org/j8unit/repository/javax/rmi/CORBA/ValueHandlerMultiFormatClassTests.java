 ...
 * javax.rmi.CORBA.ValueHandlerMultiFormat}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueHandlerMultiFormatTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ValueHandlerMultiFormatTests}.
 * </p>
 *
 * @see javax.rmi.CORBA.ValueHandlerMultiFormat interface javax.rmi.CORBA.ValueHandlerMultiFormat (the hereby targeted
 *      class-under-test class)
 * @see ValueHandlerMultiFormatTests ValueHandlerMultiFormatTests (The complementary j8unit test interface containing
...
public abstract interface ValueHandlerMultiFormatClassTests<SUT extends javax.rmi.CORBA.ValueHandlerMultiFormat>
extends ValueHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.rmi.CORBA.ValueHandlerMultiFormat.class!",
                   javax.rmi.CORBA.ValueHandlerMultiFormat.class.isAssignableFrom(sut));
    }

...
public abstract interface ValueHandlerMultiFormatClassTests<SUT extends ValueHandlerMultiFormat>
extends ValueHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueHandlerMultiFormat.class!",
                   ValueHandlerMultiFormat.class.isAssignableFrom(sut));
    }

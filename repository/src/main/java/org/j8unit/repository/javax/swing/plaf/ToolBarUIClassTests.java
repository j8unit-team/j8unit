 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToolBarUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToolBarUITests}.
 * </p>
 *
 * @see javax.swing.plaf.ToolBarUI class javax.swing.plaf.ToolBarUI (the hereby targeted class-under-test class)
 * @see ToolBarUITests ToolBarUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ToolBarUI.class!",
                   javax.swing.plaf.ToolBarUI.class.isAssignableFrom(sut));
    }

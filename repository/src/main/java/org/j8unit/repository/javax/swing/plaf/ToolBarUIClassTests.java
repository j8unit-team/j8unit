 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToolBarUI public
 * abstract class javax.swing.plaf.ToolBarUI}.
 *
...
public abstract interface ToolBarUIClassTests<SUT extends ToolBarUI>
extends ComponentUIClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.ToolBarUI]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToolBarUI.class!",
                   ToolBarUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.plaf.ToolBarUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.plaf.ToolBarUI]

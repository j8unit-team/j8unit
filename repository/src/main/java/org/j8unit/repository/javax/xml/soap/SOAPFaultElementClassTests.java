 ...
 * javax.xml.soap.SOAPFaultElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPFaultElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPFaultElementTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPFaultElement interface javax.xml.soap.SOAPFaultElement (the hereby targeted class-under-test
 *      class)
 * @see SOAPFaultElementTests SOAPFaultElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPFaultElementClassTests<SUT extends javax.xml.soap.SOAPFaultElement>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPFaultElement.class!",
                   javax.xml.soap.SOAPFaultElement.class.isAssignableFrom(sut));
    }

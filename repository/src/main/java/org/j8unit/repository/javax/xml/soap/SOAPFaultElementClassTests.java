 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPFaultElement
 * public abstract interface javax.xml.soap.SOAPFaultElement}.
 *
...
public abstract interface SOAPFaultElementClassTests<SUT extends SOAPFaultElement>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPFaultElement.class!",
                   SOAPFaultElement.class.isAssignableFrom(sut));
    }

...
public abstract interface FileNameExtensionFilterClassTests<SUT extends FileNameExtensionFilter>
extends org.j8unit.repository.javax.swing.filechooser.FileFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileNameExtensionFilter.class!",
                   FileNameExtensionFilter.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.management.NotificationBroadcasterClassTests;
...
public abstract interface ModelMBeanNotificationBroadcasterClassTests<SUT extends ModelMBeanNotificationBroadcaster>
extends NotificationBroadcasterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ModelMBeanNotificationBroadcaster.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.events.Characters interface
 * javax.xml.stream.events.Characters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharactersTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharactersTests}.
 * </p>
 *
 * @see javax.xml.stream.events.Characters interface javax.xml.stream.events.Characters (the hereby targeted
 *      class-under-test class)
 * @see CharactersTests CharactersTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CharactersClassTests<SUT extends javax.xml.stream.events.Characters>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.Characters.class!",
                   javax.xml.stream.events.Characters.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Characters public
 * abstract interface javax.xml.stream.events.Characters}.
 *
...
public abstract interface CharactersClassTests<SUT extends Characters>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Characters.class!",
                   Characters.class.isAssignableFrom(sut));
    }

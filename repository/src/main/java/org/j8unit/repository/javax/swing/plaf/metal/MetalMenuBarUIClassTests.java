 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MetalMenuBarUI
...
public abstract interface MetalMenuBarUIClassTests<SUT extends MetalMenuBarUI>
extends BasicMenuBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MetalMenuBarUI.class!",
                   MetalMenuBarUI.class.isAssignableFrom(sut));
    }

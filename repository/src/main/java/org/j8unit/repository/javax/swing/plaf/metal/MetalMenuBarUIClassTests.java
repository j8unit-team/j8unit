 ...
 * javax.swing.plaf.metal.MetalMenuBarUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MetalMenuBarUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MetalMenuBarUITests}.
 * </p>
 *
 * @see javax.swing.plaf.metal.MetalMenuBarUI class javax.swing.plaf.metal.MetalMenuBarUI (the hereby targeted
 *      class-under-test class)
 * @see MetalMenuBarUITests MetalMenuBarUITests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.swing.plaf.basic.BasicMenuBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.metal.MetalMenuBarUI.class!",
                   javax.swing.plaf.metal.MetalMenuBarUI.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.xml.ws.BindingClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTTPBinding public
 * abstract interface javax.xml.ws.http.HTTPBinding}.
 *
...
public abstract interface HTTPBindingClassTests<SUT extends HTTPBinding>
extends BindingClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTTPBinding.class!",
                   HTTPBinding.class.isAssignableFrom(sut));
    }

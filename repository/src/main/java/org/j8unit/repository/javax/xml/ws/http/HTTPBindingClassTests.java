 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTTPBindingTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTTPBindingTests}.
 * </p>
 *
 * @see javax.xml.ws.http.HTTPBinding interface javax.xml.ws.http.HTTPBinding (the hereby targeted class-under-test
 *      class)
 * @see HTTPBindingTests HTTPBindingTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface HTTPBindingClassTests<SUT extends javax.xml.ws.http.HTTPBinding>
extends org.j8unit.repository.javax.xml.ws.BindingClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.http.HTTPBinding.class!",
                   javax.xml.ws.http.HTTPBinding.class.isAssignableFrom(sut));
    }

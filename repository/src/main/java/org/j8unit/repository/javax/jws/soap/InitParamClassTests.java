 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InitParam public
 * abstract @interface javax.jws.soap.InitParam}.
 *
...
public abstract interface InitParamClassTests<SUT extends InitParam>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InitParam.class!",
                   InitParam.class.isAssignableFrom(sut));
    }

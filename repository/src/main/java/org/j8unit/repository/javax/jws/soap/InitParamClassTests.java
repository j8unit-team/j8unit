 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InitParamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InitParamTests}.
 * </p>
 *
 * @see javax.jws.soap.InitParam interface javax.jws.soap.InitParam (the hereby targeted class-under-test class)
 * @see InitParamTests InitParamTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InitParamClassTests<SUT extends javax.jws.soap.InitParam>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.soap.InitParam.class!",
                   javax.jws.soap.InitParam.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.swing.ComboBoxEditorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicComboBoxEditor
 * public class javax.swing.plaf.basic.BasicComboBoxEditor}.
 *
...
public abstract interface BasicComboBoxEditorClassTests<SUT extends BasicComboBoxEditor>
extends ComboBoxEditorClassTests<SUT>, FocusListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicComboBoxEditor.class!",
                   BasicComboBoxEditor.class.isAssignableFrom(sut));
    }
     ...
     * {@link UIResource public static class javax.swing.plaf.basic.BasicComboBoxEditor$UIResource}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

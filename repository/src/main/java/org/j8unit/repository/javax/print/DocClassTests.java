...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.Doc interface javax.print.Doc}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocTests}.
 * </p>
 *
 * @see javax.print.Doc interface javax.print.Doc (the hereby targeted class-under-test class)
 * @see DocTests DocTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DocClassTests<SUT extends javax.print.Doc>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.Doc.class!",
                   javax.print.Doc.class.isAssignableFrom(sut));
    }

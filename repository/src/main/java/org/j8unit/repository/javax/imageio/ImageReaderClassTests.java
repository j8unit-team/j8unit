 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageReader public
 * abstract class javax.imageio.ImageReader}.
 *
...
public abstract interface ImageReaderClassTests<SUT extends ImageReader>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageReader.class!",
                   ImageReader.class.isAssignableFrom(sut));
    }

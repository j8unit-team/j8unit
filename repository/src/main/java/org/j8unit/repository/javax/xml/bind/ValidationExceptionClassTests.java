 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValidationException
 * public class javax.xml.bind.ValidationException}.
 *
...
public abstract interface ValidationExceptionClassTests<SUT extends ValidationException>
extends JAXBExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValidationException.class!",
                   ValidationException.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.bind.ValidationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValidationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValidationExceptionTests}.
 * </p>
 *
 * @see javax.xml.bind.ValidationException class javax.xml.bind.ValidationException (the hereby targeted
 *      class-under-test class)
 * @see ValidationExceptionTests ValidationExceptionTests (The complementary j8unit test interface containing the
...
extends JAXBExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.ValidationException.class!",
                   javax.xml.bind.ValidationException.class.isAssignableFrom(sut));
    }

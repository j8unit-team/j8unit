 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MimeHeaders public
...
public abstract interface MimeHeadersClassTests<SUT extends MimeHeaders>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MimeHeaders.class!",
                   MimeHeaders.class.isAssignableFrom(sut));
    }

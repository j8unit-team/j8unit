...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.Context interface javax.naming.Context}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ContextTests}.
 * </p>
 *
 * @see javax.naming.Context interface javax.naming.Context (the hereby targeted class-under-test class)
 * @see ContextTests ContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ContextClassTests<SUT extends javax.naming.Context>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.Context.class!",
                   javax.naming.Context.class.isAssignableFrom(sut));
    }

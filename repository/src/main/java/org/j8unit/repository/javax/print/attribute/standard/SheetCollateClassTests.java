 ...
 * javax.print.attribute.standard.SheetCollate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SheetCollateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SheetCollateTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.SheetCollate class javax.print.attribute.standard.SheetCollate (the hereby
 *      targeted class-under-test class)
 * @see SheetCollateTests SheetCollateTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SheetCollateClassTests<SUT extends javax.print.attribute.standard.SheetCollate>
...
org.j8unit.repository.javax.print.attribute.EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.SheetCollate.class!",
                   javax.print.attribute.standard.SheetCollate.class.isAssignableFrom(sut));
    }

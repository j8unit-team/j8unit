 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SheetCollate public
 * final class javax.print.attribute.standard.SheetCollate}.
 *
...
public abstract interface SheetCollateClassTests<SUT extends SheetCollate>
extends DocAttributeClassTests<SUT>, PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, EnumSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SheetCollate.class!",
                   SheetCollate.class.isAssignableFrom(sut));
    }

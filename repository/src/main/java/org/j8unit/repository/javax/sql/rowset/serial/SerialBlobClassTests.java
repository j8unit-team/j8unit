 ...
 * javax.sql.rowset.serial.SerialBlob}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerialBlobTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SerialBlobTests}.
 * </p>
 *
 * @see javax.sql.rowset.serial.SerialBlob class javax.sql.rowset.serial.SerialBlob (the hereby targeted
 *      class-under-test class)
 * @see SerialBlobTests SerialBlobTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SerialBlobClassTests<SUT extends javax.sql.rowset.serial.SerialBlob>
extends org.j8unit.repository.java.sql.BlobClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SerialBlob.class!",
                   javax.sql.rowset.serial.SerialBlob.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.DesktopManager interface javax.swing.DesktopManager},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DesktopManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DesktopManagerTests}.
 * </p>
 *
 * @see javax.swing.DesktopManager interface javax.swing.DesktopManager (the hereby targeted class-under-test class)
 * @see DesktopManagerTests DesktopManagerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DesktopManagerClassTests<SUT extends javax.swing.DesktopManager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.DesktopManager.class!",
                   javax.swing.DesktopManager.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.CompositeDataSupport class
 * javax.management.openmbean.CompositeDataSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeDataSupportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompositeDataSupportTests}
 * .
 * </p>
 *
 * @see javax.management.openmbean.CompositeDataSupport class javax.management.openmbean.CompositeDataSupport (the
 *      hereby targeted class-under-test class)
 * @see CompositeDataSupportTests CompositeDataSupportTests (The complementary j8unit test interface containing the
...
public abstract interface CompositeDataSupportClassTests<SUT extends javax.management.openmbean.CompositeDataSupport>
extends CompositeDataClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.CompositeDataSupport.class!",
                   javax.management.openmbean.CompositeDataSupport.class.isAssignableFrom(sut));
    }

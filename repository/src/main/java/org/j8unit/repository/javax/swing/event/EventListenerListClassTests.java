 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventListenerList
 * public class javax.swing.event.EventListenerList}.
 *
...
public abstract interface EventListenerListClassTests<SUT extends EventListenerList>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventListenerList.class!",
                   EventListenerList.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.plaf.multi.MultiButtonUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiButtonUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiButtonUITests}.
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiButtonUI class javax.swing.plaf.multi.MultiButtonUI (the hereby targeted
 *      class-under-test class)
 * @see MultiButtonUITests MultiButtonUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.swing.plaf.ButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiButtonUI.class!",
                   javax.swing.plaf.multi.MultiButtonUI.class.isAssignableFrom(sut));
    }

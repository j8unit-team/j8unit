...
import org.j8unit.repository.javax.swing.plaf.ButtonUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiButtonUI
...
public abstract interface MultiButtonUIClassTests<SUT extends MultiButtonUI>
extends ButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiButtonUI.class!",
                   MultiButtonUI.class.isAssignableFrom(sut));
    }

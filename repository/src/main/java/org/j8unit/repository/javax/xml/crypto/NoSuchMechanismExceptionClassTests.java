 ...
 * javax.xml.crypto.NoSuchMechanismException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchMechanismExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NoSuchMechanismExceptionTests}.
 * </p>
 *
 * @see javax.xml.crypto.NoSuchMechanismException class javax.xml.crypto.NoSuchMechanismException (the hereby targeted
 *      class-under-test class)
 * @see NoSuchMechanismExceptionTests NoSuchMechanismExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.NoSuchMechanismException.class!",
                   javax.xml.crypto.NoSuchMechanismException.class.isAssignableFrom(sut));
    }

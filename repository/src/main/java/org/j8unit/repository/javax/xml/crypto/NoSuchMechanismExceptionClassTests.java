 ...
 * {@link NoSuchMechanismException public class javax.xml.crypto.NoSuchMechanismException}.
 *
 ...
 * {@link org.j8unit.repository.javax.xml.crypto.NoSuchMechanismExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface NoSuchMechanismExceptionClassTests<SUT extends NoSuchMechanismException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchMechanismException.class!",
                   NoSuchMechanismException.class.isAssignableFrom(sut));
    }

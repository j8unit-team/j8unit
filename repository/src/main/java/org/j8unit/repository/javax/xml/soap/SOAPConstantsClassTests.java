 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPConstantsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPConstantsTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPConstants interface javax.xml.soap.SOAPConstants (the hereby targeted class-under-test class)
 * @see SOAPConstantsTests SOAPConstantsTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SOAPConstantsClassTests<SUT extends javax.xml.soap.SOAPConstants>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPConstants.class!",
                   javax.xml.soap.SOAPConstants.class.isAssignableFrom(sut));
    }

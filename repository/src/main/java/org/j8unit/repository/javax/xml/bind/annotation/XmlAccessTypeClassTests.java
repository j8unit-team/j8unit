 ...
 * javax.xml.bind.annotation.XmlAccessType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlAccessTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlAccessTypeTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlAccessType class javax.xml.bind.annotation.XmlAccessType (the hereby targeted
 *      class-under-test class)
 * @see XmlAccessTypeTests XmlAccessTypeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlAccessType.class!",
                   javax.xml.bind.annotation.XmlAccessType.class.isAssignableFrom(sut));
    }

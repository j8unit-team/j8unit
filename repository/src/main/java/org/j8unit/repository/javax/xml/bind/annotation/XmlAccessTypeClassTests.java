 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAccessType
 * public final enum javax.xml.bind.annotation.XmlAccessType}.
 *
...
public abstract interface XmlAccessTypeClassTests<SUT extends XmlAccessType>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAccessType.class!",
                   XmlAccessType.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.rowset.serial.SerialArray class
 * javax.sql.rowset.serial.SerialArray}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerialArrayTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SerialArrayTests}.
 * </p>
 *
 * @see javax.sql.rowset.serial.SerialArray class javax.sql.rowset.serial.SerialArray (the hereby targeted
 *      class-under-test class)
 * @see SerialArrayTests SerialArrayTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SerialArrayClassTests<SUT extends javax.sql.rowset.serial.SerialArray>
extends org.j8unit.repository.java.sql.ArrayClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.serial.SerialArray.class!",
                   javax.sql.rowset.serial.SerialArray.class.isAssignableFrom(sut));
    }

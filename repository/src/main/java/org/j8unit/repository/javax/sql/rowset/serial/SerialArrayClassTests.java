...
import org.j8unit.repository.java.sql.ArrayClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerialArray public
...
public abstract interface SerialArrayClassTests<SUT extends SerialArray>
extends ArrayClassTests<SUT>, SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerialArray.class!",
                   SerialArray.class.isAssignableFrom(sut));
    }

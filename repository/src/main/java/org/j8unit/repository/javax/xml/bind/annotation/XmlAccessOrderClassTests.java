 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlAccessOrder
 * public final enum javax.xml.bind.annotation.XmlAccessOrder}.
 *
...
public abstract interface XmlAccessOrderClassTests<SUT extends XmlAccessOrder>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlAccessOrder.class!",
                   XmlAccessOrder.class.isAssignableFrom(sut));
    }

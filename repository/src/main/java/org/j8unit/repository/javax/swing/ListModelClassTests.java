...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.ListModel interface javax.swing.ListModel}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListModelTests}.
 * </p>
 *
 * @see javax.swing.ListModel interface javax.swing.ListModel (the hereby targeted class-under-test class)
 * @see ListModelTests ListModelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ListModelClassTests<SUT extends javax.swing.ListModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.ListModel.class!",
                   javax.swing.ListModel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListModel public
 * abstract interface javax.swing.ListModel<E>}.
 *
...
public abstract interface ListModelClassTests<SUT extends ListModel>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListModel.class!",
                   ListModel.class.isAssignableFrom(sut));
    }

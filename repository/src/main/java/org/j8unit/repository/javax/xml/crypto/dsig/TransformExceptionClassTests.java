 ...
 * javax.xml.crypto.dsig.TransformException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransformExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransformExceptionTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.TransformException class javax.xml.crypto.dsig.TransformException (the hereby targeted
 *      class-under-test class)
 * @see TransformExceptionTests TransformExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.TransformException.class!",
                   javax.xml.crypto.dsig.TransformException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TransformException
 * public class javax.xml.crypto.dsig.TransformException}.
 *
...
public abstract interface TransformExceptionClassTests<SUT extends TransformException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransformException.class!",
                   TransformException.class.isAssignableFrom(sut));
    }

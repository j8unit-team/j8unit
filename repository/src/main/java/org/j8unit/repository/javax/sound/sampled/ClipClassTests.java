 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Clip public
...
public abstract interface ClipClassTests<SUT extends Clip>
extends DataLineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Clip.class!", Clip.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClipTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClipTests}.
 * </p>
 *
 * @see javax.sound.sampled.Clip interface javax.sound.sampled.Clip (the hereby targeted class-under-test class)
 * @see ClipTests ClipTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ClipClassTests<SUT extends javax.sound.sampled.Clip>
extends DataLineClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.Clip.class!",
                   javax.sound.sampled.Clip.class.isAssignableFrom(sut));
    }

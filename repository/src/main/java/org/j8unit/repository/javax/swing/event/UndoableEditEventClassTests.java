 ...
 * javax.swing.event.UndoableEditEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UndoableEditEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UndoableEditEventTests}.
 * </p>
 *
 * @see javax.swing.event.UndoableEditEvent class javax.swing.event.UndoableEditEvent (the hereby targeted
 *      class-under-test class)
 * @see UndoableEditEventTests UndoableEditEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.UndoableEditEvent.class!",
                   javax.swing.event.UndoableEditEvent.class.isAssignableFrom(sut));
    }

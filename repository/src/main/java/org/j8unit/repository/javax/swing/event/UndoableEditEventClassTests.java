 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UndoableEditEvent
 * public class javax.swing.event.UndoableEditEvent}.
 *
...
public abstract interface UndoableEditEventClassTests<SUT extends UndoableEditEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UndoableEditEvent.class!",

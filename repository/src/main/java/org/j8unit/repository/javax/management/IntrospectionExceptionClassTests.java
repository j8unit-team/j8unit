 ...
 * javax.management.IntrospectionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntrospectionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link IntrospectionExceptionTests}.
 * </p>
 *
 * @see javax.management.IntrospectionException class javax.management.IntrospectionException (the hereby targeted
 *      class-under-test class)
 * @see IntrospectionExceptionTests IntrospectionExceptionTests (The complementary j8unit test interface containing the
...
extends OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.IntrospectionException.class!",
                   javax.management.IntrospectionException.class.isAssignableFrom(sut));
    }

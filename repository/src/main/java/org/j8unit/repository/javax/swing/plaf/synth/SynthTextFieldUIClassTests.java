 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthTextFieldUI
 * public class javax.swing.plaf.synth.SynthTextFieldUI}.
 *
...
public abstract interface SynthTextFieldUIClassTests<SUT extends SynthTextFieldUI>
extends SynthUIClassTests<SUT>, BasicTextFieldUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthTextFieldUI.class!",
                   SynthTextFieldUI.class.isAssignableFrom(sut));
    }

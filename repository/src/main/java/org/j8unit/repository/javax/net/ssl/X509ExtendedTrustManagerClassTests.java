 ...
 * javax.net.ssl.X509ExtendedTrustManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509ExtendedTrustManagerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link X509ExtendedTrustManagerTests}.
 * </p>
 *
 * @see javax.net.ssl.X509ExtendedTrustManager class javax.net.ssl.X509ExtendedTrustManager (the hereby targeted
 *      class-under-test class)
 * @see X509ExtendedTrustManagerTests X509ExtendedTrustManagerTests (The complementary j8unit test interface containing
...
extends X509TrustManagerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.X509ExtendedTrustManager.class!",
                   javax.net.ssl.X509ExtendedTrustManager.class.isAssignableFrom(sut));
    }

 ...
 * {@link X509ExtendedTrustManager public abstract class javax.net.ssl.X509ExtendedTrustManager}.
 *
...
public abstract interface X509ExtendedTrustManagerClassTests<SUT extends X509ExtendedTrustManager>
extends org.j8unit.repository.javax.net.ssl.X509TrustManagerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509ExtendedTrustManager.class!",
                   X509ExtendedTrustManager.class.isAssignableFrom(sut));
    }

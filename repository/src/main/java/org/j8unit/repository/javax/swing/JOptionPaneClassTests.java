...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JOptionPane class javax.swing.JOptionPane}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JOptionPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JOptionPaneTests}.
 * </p>
 *
 * @see javax.swing.JOptionPane class javax.swing.JOptionPane (the hereby targeted class-under-test class)
 * @see JOptionPaneTests JOptionPaneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JOptionPane.class!",
                   javax.swing.JOptionPane.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JOptionPane public
...
public abstract interface JOptionPaneClassTests<SUT extends JOptionPane>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JOptionPane.class!",

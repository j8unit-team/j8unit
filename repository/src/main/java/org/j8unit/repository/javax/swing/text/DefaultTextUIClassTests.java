 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultTextUITests}).
 * </p>
 *
 * <p>
 ...
 * @see DefaultTextUITests DefaultTextUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DefaultTextUIClassTests<SUT extends javax.swing.text.DefaultTextUI>
extends org.j8unit.repository.javax.swing.plaf.basic.BasicTextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.DefaultTextUI.class!",
                   javax.swing.text.DefaultTextUI.class.isAssignableFrom(sut));
    }

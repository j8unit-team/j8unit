...
import org.j8unit.repository.javax.swing.plaf.basic.BasicTextUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultTextUI
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultTextUITests}.
 * </p>
 *
 * <p>
...
public abstract interface DefaultTextUIClassTests<SUT extends DefaultTextUI>
extends BasicTextUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultTextUI.class!",
                   DefaultTextUI.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.text.DefaultTextUI]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.text.DefaultTextUI]

...
public abstract interface OpenMBeanConstructorInfoSupportClassTests<SUT extends OpenMBeanConstructorInfoSupport>
extends OpenMBeanConstructorInfoClassTests<SUT>, MBeanConstructorInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanConstructorInfoSupport.class!",
                   OpenMBeanConstructorInfoSupport.class.isAssignableFrom(sut));
    }

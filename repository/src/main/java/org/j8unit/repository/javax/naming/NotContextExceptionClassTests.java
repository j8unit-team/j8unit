...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.NotContextException class
 * javax.naming.NotContextException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotContextExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotContextExceptionTests}.
 * </p>
 *
 * @see javax.naming.NotContextException class javax.naming.NotContextException (the hereby targeted class-under-test
 *      class)
 * @see NotContextExceptionTests NotContextExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface NotContextExceptionClassTests<SUT extends javax.naming.NotContextException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NotContextException.class!",
                   javax.naming.NotContextException.class.isAssignableFrom(sut));
    }

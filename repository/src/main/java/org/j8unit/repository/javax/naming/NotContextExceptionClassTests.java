 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotContextException
 * public class javax.naming.NotContextException}.
 *
...
public abstract interface NotContextExceptionClassTests<SUT extends NotContextException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotContextException.class!",
                   NotContextException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MediaSizeName
 * public class javax.print.attribute.standard.MediaSizeName}.
 *
...
public abstract interface MediaSizeNameClassTests<SUT extends MediaSizeName>
extends org.j8unit.repository.javax.print.attribute.standard.MediaClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MediaSizeName.class!",
                   MediaSizeName.class.isAssignableFrom(sut));
    }

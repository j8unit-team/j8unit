 ...
 * javax.print.attribute.standard.MediaSizeName}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MediaSizeNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MediaSizeNameTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.MediaSizeName class javax.print.attribute.standard.MediaSizeName (the hereby
 *      targeted class-under-test class)
 * @see MediaSizeNameTests MediaSizeNameTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MediaSizeNameClassTests<SUT extends javax.print.attribute.standard.MediaSizeName>
extends MediaClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.MediaSizeName.class!",
                   javax.print.attribute.standard.MediaSizeName.class.isAssignableFrom(sut));
    }

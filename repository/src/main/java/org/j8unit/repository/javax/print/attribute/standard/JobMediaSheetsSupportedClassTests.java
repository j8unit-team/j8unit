...
public abstract interface JobMediaSheetsSupportedClassTests<SUT extends JobMediaSheetsSupported>
extends SupportedValuesAttributeClassTests<SUT>, SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobMediaSheetsSupported.class!",
                   JobMediaSheetsSupported.class.isAssignableFrom(sut));
    }

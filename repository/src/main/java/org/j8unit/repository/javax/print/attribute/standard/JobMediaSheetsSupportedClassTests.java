 ...
 * javax.print.attribute.standard.JobMediaSheetsSupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobMediaSheetsSupportedTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link JobMediaSheetsSupportedTests}.
 * </p>
 *
 ...
 * @see JobMediaSheetsSupportedTests JobMediaSheetsSupportedTests (The complementary j8unit test interface containing
...
org.j8unit.repository.javax.print.attribute.SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobMediaSheetsSupported.class!",
                   javax.print.attribute.standard.JobMediaSheetsSupported.class.isAssignableFrom(sut));
    }

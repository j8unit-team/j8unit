...
import org.j8unit.repository.javax.swing.plaf.basic.BasicOptionPaneUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthOptionPaneUI
 * public class javax.swing.plaf.synth.SynthOptionPaneUI}.
 *
...
public abstract interface SynthOptionPaneUIClassTests<SUT extends SynthOptionPaneUI>
extends PropertyChangeListenerClassTests<SUT>, SynthUIClassTests<SUT>, BasicOptionPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthOptionPaneUI.class!",
                   SynthOptionPaneUI.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompoundEditTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompoundEditTests}.
 * </p>
 *
 * @see javax.swing.undo.CompoundEdit class javax.swing.undo.CompoundEdit (the hereby targeted class-under-test class)
 * @see CompoundEditTests CompoundEditTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CompoundEditClassTests<SUT extends javax.swing.undo.CompoundEdit>
extends AbstractUndoableEditClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.undo.CompoundEdit.class!",
                   javax.swing.undo.CompoundEdit.class.isAssignableFrom(sut));
    }

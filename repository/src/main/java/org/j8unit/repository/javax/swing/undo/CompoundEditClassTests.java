 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompoundEdit public
...
public abstract interface CompoundEditClassTests<SUT extends CompoundEdit>
extends AbstractUndoableEditClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompoundEdit.class!",

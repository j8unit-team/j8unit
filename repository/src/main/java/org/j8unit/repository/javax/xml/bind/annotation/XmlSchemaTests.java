 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlSchema
 * public abstract @interface javax.xml.bind.annotation.XmlSchema}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.javax.xml.bind.annotation.XmlSchemaClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface XmlSchemaTests<SUT extends XmlSchema>
extends org.j8unit.repository.java.lang.annotation.AnnotationTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_attributeFormDefault()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_xmlns()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StartElement public
 * abstract interface javax.xml.stream.events.StartElement}.
 *
...
public abstract interface StartElementClassTests<SUT extends StartElement>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StartElement.class!",
                   StartElement.class.isAssignableFrom(sut));
    }

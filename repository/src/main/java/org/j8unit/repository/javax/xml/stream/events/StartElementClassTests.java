...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.stream.events.StartElement interface
 * javax.xml.stream.events.StartElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StartElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StartElementTests}.
 * </p>
 *
 * @see javax.xml.stream.events.StartElement interface javax.xml.stream.events.StartElement (the hereby targeted
 *      class-under-test class)
 * @see StartElementTests StartElementTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StartElementClassTests<SUT extends javax.xml.stream.events.StartElement>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.StartElement.class!",
                   javax.xml.stream.events.StartElement.class.isAssignableFrom(sut));
    }

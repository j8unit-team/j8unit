 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CopiesSupported
 * public final class javax.print.attribute.standard.CopiesSupported}.
 *
...
public abstract interface CopiesSupportedClassTests<SUT extends CopiesSupported>
extends SupportedValuesAttributeClassTests<SUT>, SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CopiesSupported.class!",
                   CopiesSupported.class.isAssignableFrom(sut));
    }

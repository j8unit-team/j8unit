 ...
 * javax.print.attribute.standard.CopiesSupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CopiesSupportedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CopiesSupportedTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.CopiesSupported class javax.print.attribute.standard.CopiesSupported (the hereby
 *      targeted class-under-test class)
 * @see CopiesSupportedTests CopiesSupportedTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.javax.print.attribute.SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.CopiesSupported.class!",
                   javax.print.attribute.standard.CopiesSupported.class.isAssignableFrom(sut));
    }

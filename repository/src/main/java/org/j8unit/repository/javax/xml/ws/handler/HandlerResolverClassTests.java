 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HandlerResolver
 * public abstract interface javax.xml.ws.handler.HandlerResolver}.
 *
...
public abstract interface HandlerResolverClassTests<SUT extends HandlerResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HandlerResolver.class!",
                   HandlerResolver.class.isAssignableFrom(sut));
    }

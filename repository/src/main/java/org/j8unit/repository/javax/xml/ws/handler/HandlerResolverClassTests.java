 ...
 * javax.xml.ws.handler.HandlerResolver}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HandlerResolverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HandlerResolverTests}.
 * </p>
 *
 * @see javax.xml.ws.handler.HandlerResolver interface javax.xml.ws.handler.HandlerResolver (the hereby targeted
 *      class-under-test class)
 * @see HandlerResolverTests HandlerResolverTests (The complementary j8unit test interface containing the instance
...
public abstract interface HandlerResolverClassTests<SUT extends javax.xml.ws.handler.HandlerResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.handler.HandlerResolver.class!",
                   javax.xml.ws.handler.HandlerResolver.class.isAssignableFrom(sut));
    }

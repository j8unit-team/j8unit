 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyGeneratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyGeneratorTests}.
 * </p>
 *
 * @see javax.crypto.KeyGenerator class javax.crypto.KeyGenerator (the hereby targeted class-under-test class)
 * @see KeyGeneratorTests KeyGeneratorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.KeyGenerator.class!",
                   javax.crypto.KeyGenerator.class.isAssignableFrom(sut));
    }

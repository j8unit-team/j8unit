 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyGenerator public
...
public abstract interface KeyGeneratorClassTests<SUT extends KeyGenerator>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyGenerator.class!",
                   KeyGenerator.class.isAssignableFrom(sut));
    }

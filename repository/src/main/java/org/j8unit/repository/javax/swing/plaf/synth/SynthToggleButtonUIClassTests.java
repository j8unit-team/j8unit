 ...
 * javax.swing.plaf.synth.SynthToggleButtonUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynthToggleButtonUITests}).
 * </p>
 *
 * <p>
 ...
 * @see SynthToggleButtonUITests SynthToggleButtonUITests (The complementary j8unit test interface containing the
...
public abstract interface SynthToggleButtonUIClassTests<SUT extends javax.swing.plaf.synth.SynthToggleButtonUI>
extends SynthButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.synth.SynthToggleButtonUI.class!",
                   javax.swing.plaf.synth.SynthToggleButtonUI.class.isAssignableFrom(sut));
    }

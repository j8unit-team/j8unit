 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynthToggleButtonUI
 * public class javax.swing.plaf.synth.SynthToggleButtonUI}.
 *
...
extends SynthButtonUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthToggleButtonUI.class!",
                   SynthToggleButtonUI.class.isAssignableFrom(sut));
    }

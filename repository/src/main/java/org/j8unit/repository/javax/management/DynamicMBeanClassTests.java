 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynamicMBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynamicMBeanTests}.
 * </p>
 *
 * @see javax.management.DynamicMBean interface javax.management.DynamicMBean (the hereby targeted class-under-test
 *      class)
 * @see DynamicMBeanTests DynamicMBeanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DynamicMBeanClassTests<SUT extends javax.management.DynamicMBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.DynamicMBean.class!",
                   javax.management.DynamicMBean.class.isAssignableFrom(sut));
    }

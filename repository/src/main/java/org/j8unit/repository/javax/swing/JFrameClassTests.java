 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JFrame public class
 * javax.swing.JFrame}.
 *
...
extends WindowConstantsClassTests<SUT>, RootPaneContainerClassTests<SUT>, FrameClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JFrame.class!",

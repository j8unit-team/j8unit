...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.JFrame class javax.swing.JFrame}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JFrameTests}).
 * </p>
 *
 * <p>
 ...
 * @see JFrameTests JFrameTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.awt.FrameClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JFrame.class!",
                   javax.swing.JFrame.class.isAssignableFrom(sut));
    }

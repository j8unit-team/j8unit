...
public abstract interface IIOReadUpdateListenerClassTests<SUT extends IIOReadUpdateListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IIOReadUpdateListener.class!",
                   IIOReadUpdateListener.class.isAssignableFrom(sut));
    }

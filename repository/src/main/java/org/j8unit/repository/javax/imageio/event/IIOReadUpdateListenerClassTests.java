...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.imageio.event.IIOReadUpdateListener interface
 * javax.imageio.event.IIOReadUpdateListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOReadUpdateListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link IIOReadUpdateListenerTests}.
 * </p>
 *
 * @see javax.imageio.event.IIOReadUpdateListener interface javax.imageio.event.IIOReadUpdateListener (the hereby
 *      targeted class-under-test class)
 * @see IIOReadUpdateListenerTests IIOReadUpdateListenerTests (The complementary j8unit test interface containing the
...
public abstract interface IIOReadUpdateListenerClassTests<SUT extends javax.imageio.event.IIOReadUpdateListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.event.IIOReadUpdateListener.class!",
                   javax.imageio.event.IIOReadUpdateListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentName public
 * final class javax.print.attribute.standard.DocumentName}.
 *
...
public abstract interface DocumentNameClassTests<SUT extends DocumentName>
extends org.j8unit.repository.javax.print.attribute.DocAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentName.class!",
                   DocumentName.class.isAssignableFrom(sut));
    }

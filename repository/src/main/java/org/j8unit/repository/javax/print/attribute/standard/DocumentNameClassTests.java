 ...
 * javax.print.attribute.standard.DocumentName}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentNameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocumentNameTests}.
 * </p>
 *
 * @see javax.print.attribute.standard.DocumentName class javax.print.attribute.standard.DocumentName (the hereby
 *      targeted class-under-test class)
 * @see DocumentNameTests DocumentNameTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.print.attribute.DocAttributeClassTests<SUT>, org.j8unit.repository.javax.print.attribute.TextSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.DocumentName.class!",
                   javax.print.attribute.standard.DocumentName.class.isAssignableFrom(sut));
    }

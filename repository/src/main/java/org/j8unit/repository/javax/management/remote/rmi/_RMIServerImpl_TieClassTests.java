 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _RMIServerImpl_Tie
 * public class javax.management.remote.rmi._RMIServerImpl_Tie}.
 *
...
extends TieClassTests<SUT>, ObjectImplClassTests<SUT> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.management.remote.rmi._RMIServerImpl_Tie]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _RMIServerImpl_Tie.class!",
                   _RMIServerImpl_Tie.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.management.remote.rmi._RMIServerImpl_Tie]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.management.remote.rmi._RMIServerImpl_Tie]

 ...
 * javax.xml.xpath.XPathFunctionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathFunctionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link XPathFunctionExceptionTests}.
 * </p>
 *
 * @see javax.xml.xpath.XPathFunctionException class javax.xml.xpath.XPathFunctionException (the hereby targeted
 *      class-under-test class)
 * @see XPathFunctionExceptionTests XPathFunctionExceptionTests (The complementary j8unit test interface containing the
...
extends XPathExpressionExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.xpath.XPathFunctionException.class!",
                   javax.xml.xpath.XPathFunctionException.class.isAssignableFrom(sut));
    }

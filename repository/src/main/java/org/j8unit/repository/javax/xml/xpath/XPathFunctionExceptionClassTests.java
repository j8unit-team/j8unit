 ...
 * {@link XPathFunctionException public class javax.xml.xpath.XPathFunctionException}.
 *
...
public abstract interface XPathFunctionExceptionClassTests<SUT extends XPathFunctionException>
extends org.j8unit.repository.javax.xml.xpath.XPathExpressionExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathFunctionException.class!",
                   XPathFunctionException.class.isAssignableFrom(sut));
    }

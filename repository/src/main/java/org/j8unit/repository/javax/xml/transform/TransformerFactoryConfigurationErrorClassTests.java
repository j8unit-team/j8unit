 ...
 * {@link TransformerFactoryConfigurationError public class javax.xml.transform.TransformerFactoryConfigurationError}.
 *
...
public abstract interface TransformerFactoryConfigurationErrorClassTests<SUT extends TransformerFactoryConfigurationError>
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransformerFactoryConfigurationError.class!",
                   TransformerFactoryConfigurationError.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.transform.TransformerFactoryConfigurationError class
 * javax.xml.transform.TransformerFactoryConfigurationError}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * {@link TransformerFactoryConfigurationErrorTests}).
 * </p>
 *
 * <p>
 ...
 * @see TransformerFactoryConfigurationErrorTests TransformerFactoryConfigurationErrorTests (The complementary j8unit
...
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.TransformerFactoryConfigurationError.class!",
                   javax.xml.transform.TransformerFactoryConfigurationError.class.isAssignableFrom(sut));
    }

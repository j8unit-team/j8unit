 ...
 * javax.naming.ldap.StartTlsRequest}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StartTlsRequestTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StartTlsRequestTests}.
 * </p>
 *
 * @see javax.naming.ldap.StartTlsRequest class javax.naming.ldap.StartTlsRequest (the hereby targeted class-under-test
 *      class)
 * @see StartTlsRequestTests StartTlsRequestTests (The complementary j8unit test interface containing the instance
...
public abstract interface StartTlsRequestClassTests<SUT extends javax.naming.ldap.StartTlsRequest>
extends ExtendedRequestClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.StartTlsRequest.class!",
                   javax.naming.ldap.StartTlsRequest.class.isAssignableFrom(sut));
    }

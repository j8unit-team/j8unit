 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StartTlsRequest
 * public class javax.naming.ldap.StartTlsRequest}.
 *
...
public abstract interface StartTlsRequestClassTests<SUT extends StartTlsRequest>
extends ExtendedRequestClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StartTlsRequest.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.attribute.standard.JobPrioritySupported class
 * javax.print.attribute.standard.JobPrioritySupported}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JobPrioritySupportedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JobPrioritySupportedTests}
 * .
 * </p>
 *
 ...
 * @see JobPrioritySupportedTests JobPrioritySupportedTests (The complementary j8unit test interface containing the
...
public abstract interface JobPrioritySupportedClassTests<SUT extends javax.print.attribute.standard.JobPrioritySupported>
...
org.j8unit.repository.javax.print.attribute.IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.JobPrioritySupported.class!",
                   javax.print.attribute.standard.JobPrioritySupported.class.isAssignableFrom(sut));
    }

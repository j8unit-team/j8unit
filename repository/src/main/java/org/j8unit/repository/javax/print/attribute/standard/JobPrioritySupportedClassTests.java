 ...
 * {@link JobPrioritySupported public final class javax.print.attribute.standard.JobPrioritySupported}.
 *
 ...
 * {@link JobPrioritySupportedTests}.
 * </p>
 *
 * <p>
...
public abstract interface JobPrioritySupportedClassTests<SUT extends JobPrioritySupported>
extends SupportedValuesAttributeClassTests<SUT>, IntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JobPrioritySupported.class!",
                   JobPrioritySupported.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X500Principal
...
public abstract interface X500PrincipalClassTests<SUT extends X500Principal>
extends PrincipalClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X500Principal.class!",
                   X500Principal.class.isAssignableFrom(sut));
    }

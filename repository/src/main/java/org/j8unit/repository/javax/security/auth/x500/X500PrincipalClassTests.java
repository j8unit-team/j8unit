 ...
 * javax.security.auth.x500.X500Principal}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X500PrincipalTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X500PrincipalTests}.
 * </p>
 *
 * @see javax.security.auth.x500.X500Principal class javax.security.auth.x500.X500Principal (the hereby targeted
 *      class-under-test class)
 * @see X500PrincipalTests X500PrincipalTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.x500.X500Principal.class!",
                   javax.security.auth.x500.X500Principal.class.isAssignableFrom(sut));
    }

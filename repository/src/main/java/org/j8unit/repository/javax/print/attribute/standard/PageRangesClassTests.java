 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PageRanges public
 * final class javax.print.attribute.standard.PageRanges}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PageRangesTests}.
 * </p>
 *
 * <p>
...
public abstract interface PageRangesClassTests<SUT extends PageRanges>
extends DocAttributeClassTests<SUT>, PrintRequestAttributeClassTests<SUT>, PrintJobAttributeClassTests<SUT>, SetOfIntegerSyntaxClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.print.attribute.standard.PageRanges]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PageRanges.class!",
                   PageRanges.class.isAssignableFrom(sut));
    }

 ...
 * javax.print.attribute.standard.PageRanges}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PageRangesTests}).
 * </p>
 *
 * <p>
 ...
 * @see PageRangesTests PageRangesTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.javax.print.attribute.SetOfIntegerSyntaxClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.standard.PageRanges.class!",
                   javax.print.attribute.standard.PageRanges.class.isAssignableFrom(sut));
    }

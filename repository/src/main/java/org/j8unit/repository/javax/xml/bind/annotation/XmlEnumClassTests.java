 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlEnum public
...
public abstract interface XmlEnumClassTests<SUT extends XmlEnum>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlEnum.class!",
                   XmlEnum.class.isAssignableFrom(sut));
    }

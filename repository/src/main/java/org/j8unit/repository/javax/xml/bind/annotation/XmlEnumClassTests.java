...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.XmlEnum interface
 * javax.xml.bind.annotation.XmlEnum}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlEnumTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlEnumTests}.
 * </p>
 *
 * @see javax.xml.bind.annotation.XmlEnum interface javax.xml.bind.annotation.XmlEnum (the hereby targeted
 *      class-under-test class)
 * @see XmlEnumTests XmlEnumTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XmlEnumClassTests<SUT extends javax.xml.bind.annotation.XmlEnum>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.XmlEnum.class!",
                   javax.xml.bind.annotation.XmlEnum.class.isAssignableFrom(sut));
    }

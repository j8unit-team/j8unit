 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WebParam public
...
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WebParam.class!",
                   WebParam.class.isAssignableFrom(sut));
    }
     ...
     * {@link Mode public static final enum javax.jws.WebParam$Mode}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

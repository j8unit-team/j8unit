...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.jws.WebParam interface javax.jws.WebParam}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WebParamTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.jws.WebParam interface javax.jws.WebParam (the hereby targeted class-under-test class)
 * @see WebParamTests WebParamTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.WebParam.class!",
                   javax.jws.WebParam.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link WebParamTests.ModeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * {@link WebParamTests.ModeTests}.
     * </p>
     *
     * @see javax.jws.WebParam.Mode class javax.jws.WebParam$Mode (the hereby targeted class-under-test class)
     * @see WebParamTests.ModeTests WebParamTests.ModeTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.jws.WebParam.Mode.class!",
                       javax.jws.WebParam.Mode.class.isAssignableFrom(sut));
        }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JViewportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JViewportTests}.
 * </p>
 *
 * @see javax.swing.JViewport class javax.swing.JViewport (the hereby targeted class-under-test class)
 * @see JViewportTests JViewportTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JViewportClassTests<SUT extends javax.swing.JViewport>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JViewport.class!",
                   javax.swing.JViewport.class.isAssignableFrom(sut));
    }

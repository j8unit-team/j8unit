 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JViewport public
...
public abstract interface JViewportClassTests<SUT extends JViewport>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JViewport]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JViewport.class!",
                   JViewport.class.isAssignableFrom(sut));
    }

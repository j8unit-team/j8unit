...
public abstract interface InvalidRelationServiceExceptionClassTests<SUT extends InvalidRelationServiceException>
extends org.j8unit.repository.javax.management.relation.RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidRelationServiceException.class!",
                   InvalidRelationServiceException.class.isAssignableFrom(sut));
    }

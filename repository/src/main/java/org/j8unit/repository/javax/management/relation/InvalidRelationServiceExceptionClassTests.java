 ...
 * javax.management.relation.InvalidRelationServiceException}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * {@link InvalidRelationServiceExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidRelationServiceExceptionTests InvalidRelationServiceExceptionTests (The complementary j8unit test
...
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.InvalidRelationServiceException.class!",
                   javax.management.relation.InvalidRelationServiceException.class.isAssignableFrom(sut));
    }

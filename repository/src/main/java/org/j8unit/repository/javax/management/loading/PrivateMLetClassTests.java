 ...
 * javax.management.loading.PrivateMLet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrivateMLetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrivateMLetTests}.
 * </p>
 *
 * @see javax.management.loading.PrivateMLet class javax.management.loading.PrivateMLet (the hereby targeted
 *      class-under-test class)
 * @see PrivateMLetTests PrivateMLetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends PrivateClassLoaderClassTests<SUT>, MLetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.loading.PrivateMLet.class!",
                   javax.management.loading.PrivateMLet.class.isAssignableFrom(sut));
    }

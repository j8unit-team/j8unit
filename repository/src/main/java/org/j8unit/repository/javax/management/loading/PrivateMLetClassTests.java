 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrivateMLet public
...
public abstract interface PrivateMLetClassTests<SUT extends PrivateMLet>
extends PrivateClassLoaderClassTests<SUT>, MLetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrivateMLet.class!",
                   PrivateMLet.class.isAssignableFrom(sut));
    }

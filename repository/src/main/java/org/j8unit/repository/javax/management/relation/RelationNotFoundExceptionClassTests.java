...
public abstract interface RelationNotFoundExceptionClassTests<SUT extends RelationNotFoundException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationNotFoundException.class!",
                   RelationNotFoundException.class.isAssignableFrom(sut));
    }

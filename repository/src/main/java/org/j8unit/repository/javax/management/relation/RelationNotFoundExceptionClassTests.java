 ...
 * javax.management.relation.RelationNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link RelationNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see RelationNotFoundExceptionTests RelationNotFoundExceptionTests (The complementary j8unit test interface
...
public abstract interface RelationNotFoundExceptionClassTests<SUT extends javax.management.relation.RelationNotFoundException>
extends RelationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationNotFoundException.class!",
                   javax.management.relation.RelationNotFoundException.class.isAssignableFrom(sut));
    }

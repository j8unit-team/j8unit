 ...
 * javax.security.sasl.SaslException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SaslExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SaslExceptionTests}.
 * </p>
 *
 * @see javax.security.sasl.SaslException class javax.security.sasl.SaslException (the hereby targeted class-under-test
 *      class)
 * @see SaslExceptionTests SaslExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.SaslException.class!",
                   javax.security.sasl.SaslException.class.isAssignableFrom(sut));
    }

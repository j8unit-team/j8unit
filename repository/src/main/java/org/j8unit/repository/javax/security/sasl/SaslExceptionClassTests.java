 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SaslException
...
public abstract interface SaslExceptionClassTests<SUT extends SaslException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SaslException.class!",
                   SaslException.class.isAssignableFrom(sut));
    }

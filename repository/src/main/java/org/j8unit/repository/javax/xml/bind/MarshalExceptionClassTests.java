...
public abstract interface MarshalExceptionClassTests<SUT extends javax.xml.bind.MarshalException>
extends JAXBExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.MarshalException.class!",
                   javax.xml.bind.MarshalException.class.isAssignableFrom(sut));
    }

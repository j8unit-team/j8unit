 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MarshalException
 * public class javax.xml.bind.MarshalException}.
 *
...
extends JAXBExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MarshalException.class!",
                   MarshalException.class.isAssignableFrom(sut));
    }

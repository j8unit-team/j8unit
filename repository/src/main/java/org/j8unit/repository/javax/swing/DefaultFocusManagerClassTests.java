 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultFocusManager
...
public abstract interface DefaultFocusManagerClassTests<SUT extends DefaultFocusManager>
extends FocusManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultFocusManager.class!",
                   DefaultFocusManager.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultFocusManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefaultFocusManagerTests}.
 * </p>
 *
 * @see javax.swing.DefaultFocusManager class javax.swing.DefaultFocusManager (the hereby targeted class-under-test
 *      class)
 * @see DefaultFocusManagerTests DefaultFocusManagerTests (The complementary j8unit test interface containing the
...
extends FocusManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.DefaultFocusManager.class!",
                   javax.swing.DefaultFocusManager.class.isAssignableFrom(sut));
    }

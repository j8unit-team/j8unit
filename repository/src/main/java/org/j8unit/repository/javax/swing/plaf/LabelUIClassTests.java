 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LabelUI public
...
public abstract interface LabelUIClassTests<SUT extends LabelUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LabelUI.class!",
                   LabelUI.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LabelUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LabelUITests}.
 * </p>
 *
 * @see javax.swing.plaf.LabelUI class javax.swing.plaf.LabelUI (the hereby targeted class-under-test class)
 * @see LabelUITests LabelUITests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LabelUIClassTests<SUT extends javax.swing.plaf.LabelUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.LabelUI.class!",
                   javax.swing.plaf.LabelUI.class.isAssignableFrom(sut));
    }

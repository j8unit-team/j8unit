...
import org.j8unit.repository.javax.swing.plaf.synth.SynthStyleClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NimbusStyle public
 * final class javax.swing.plaf.nimbus.NimbusStyle}.
 *
...
public abstract interface NimbusStyleClassTests<SUT extends NimbusStyle>
extends SynthStyleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NimbusStyle.class!",
                   NimbusStyle.class.isAssignableFrom(sut));
    }

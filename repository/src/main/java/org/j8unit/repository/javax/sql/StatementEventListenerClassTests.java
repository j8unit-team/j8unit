 ...
 * javax.sql.StatementEventListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StatementEventListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link StatementEventListenerTests}.
 * </p>
 *
 * @see javax.sql.StatementEventListener interface javax.sql.StatementEventListener (the hereby targeted
 *      class-under-test class)
 * @see StatementEventListenerTests StatementEventListenerTests (The complementary j8unit test interface containing the
...
public abstract interface StatementEventListenerClassTests<SUT extends javax.sql.StatementEventListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.StatementEventListener.class!",
                   javax.sql.StatementEventListener.class.isAssignableFrom(sut));
    }

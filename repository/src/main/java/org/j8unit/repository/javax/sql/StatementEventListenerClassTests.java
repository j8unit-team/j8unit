 ...
 * {@link StatementEventListener public abstract interface javax.sql.StatementEventListener}.
 *
...
public abstract interface StatementEventListenerClassTests<SUT extends StatementEventListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StatementEventListener.class!",
                   StatementEventListener.class.isAssignableFrom(sut));
    }

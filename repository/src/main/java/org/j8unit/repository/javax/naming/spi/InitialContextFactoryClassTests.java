...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.spi.InitialContextFactory interface
 * javax.naming.spi.InitialContextFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InitialContextFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InitialContextFactoryTests}.
 * </p>
 *
 * @see javax.naming.spi.InitialContextFactory interface javax.naming.spi.InitialContextFactory (the hereby targeted
 *      class-under-test class)
 * @see InitialContextFactoryTests InitialContextFactoryTests (The complementary j8unit test interface containing the
...
public abstract interface InitialContextFactoryClassTests<SUT extends javax.naming.spi.InitialContextFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.spi.InitialContextFactory.class!",
                   javax.naming.spi.InitialContextFactory.class.isAssignableFrom(sut));
    }

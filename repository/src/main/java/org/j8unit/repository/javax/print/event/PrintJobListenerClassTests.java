...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.print.event.PrintJobListener interface
 * javax.print.event.PrintJobListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintJobListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintJobListenerTests}.
 * </p>
 *
 * @see javax.print.event.PrintJobListener interface javax.print.event.PrintJobListener (the hereby targeted
 *      class-under-test class)
 * @see PrintJobListenerTests PrintJobListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface PrintJobListenerClassTests<SUT extends javax.print.event.PrintJobListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.event.PrintJobListener.class!",
                   javax.print.event.PrintJobListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropMode public
...
public abstract interface DropModeClassTests<SUT extends DropMode>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropMode.class!",
                   DropMode.class.isAssignableFrom(sut));
    }

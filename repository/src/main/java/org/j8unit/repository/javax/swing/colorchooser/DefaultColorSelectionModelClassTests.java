...
public abstract interface DefaultColorSelectionModelClassTests<SUT extends DefaultColorSelectionModel>
extends ColorSelectionModelClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultColorSelectionModel.class!",

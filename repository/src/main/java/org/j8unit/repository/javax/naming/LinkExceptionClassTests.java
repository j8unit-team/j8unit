...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.LinkException class javax.naming.LinkException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkExceptionTests}.
 * </p>
 *
 * @see javax.naming.LinkException class javax.naming.LinkException (the hereby targeted class-under-test class)
 * @see LinkExceptionTests LinkExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LinkExceptionClassTests<SUT extends javax.naming.LinkException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.LinkException.class!",
                   javax.naming.LinkException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkException
 * public class javax.naming.LinkException}.
 *
...
public abstract interface LinkExceptionClassTests<SUT extends LinkException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkException.class!",
                   LinkException.class.isAssignableFrom(sut));
    }

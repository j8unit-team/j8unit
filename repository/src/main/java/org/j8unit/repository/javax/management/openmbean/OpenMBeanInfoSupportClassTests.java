...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.openmbean.OpenMBeanInfoSupport class
 * javax.management.openmbean.OpenMBeanInfoSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenMBeanInfoSupportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OpenMBeanInfoSupportTests}
 * .
 * </p>
 *
 * @see javax.management.openmbean.OpenMBeanInfoSupport class javax.management.openmbean.OpenMBeanInfoSupport (the
 *      hereby targeted class-under-test class)
 * @see OpenMBeanInfoSupportTests OpenMBeanInfoSupportTests (The complementary j8unit test interface containing the
...
extends OpenMBeanInfoClassTests<SUT>, org.j8unit.repository.javax.management.MBeanInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.openmbean.OpenMBeanInfoSupport.class!",
                   javax.management.openmbean.OpenMBeanInfoSupport.class.isAssignableFrom(sut));
    }

 ...
 * {@link OpenMBeanInfoSupportTests}.
 * </p>
 *
 * <p>
...
public abstract interface OpenMBeanInfoSupportClassTests<SUT extends OpenMBeanInfoSupport>
extends OpenMBeanInfoClassTests<SUT>, MBeanInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenMBeanInfoSupport.class!",
                   OpenMBeanInfoSupport.class.isAssignableFrom(sut));
    }

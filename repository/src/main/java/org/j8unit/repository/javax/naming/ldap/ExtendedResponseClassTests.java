 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExtendedResponse
 * public abstract interface javax.naming.ldap.ExtendedResponse}.
 *
...
public abstract interface ExtendedResponseClassTests<SUT extends ExtendedResponse>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExtendedResponse.class!",
                   ExtendedResponse.class.isAssignableFrom(sut));
    }

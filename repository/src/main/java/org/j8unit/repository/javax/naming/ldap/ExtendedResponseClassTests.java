...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.ldap.ExtendedResponse interface
 * javax.naming.ldap.ExtendedResponse}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExtendedResponseTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExtendedResponseTests}.
 * </p>
 *
 * @see javax.naming.ldap.ExtendedResponse interface javax.naming.ldap.ExtendedResponse (the hereby targeted
 *      class-under-test class)
 * @see ExtendedResponseTests ExtendedResponseTests (The complementary j8unit test interface containing the instance
...
public abstract interface ExtendedResponseClassTests<SUT extends javax.naming.ldap.ExtendedResponse>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.ExtendedResponse.class!",
                   javax.naming.ldap.ExtendedResponse.class.isAssignableFrom(sut));
    }

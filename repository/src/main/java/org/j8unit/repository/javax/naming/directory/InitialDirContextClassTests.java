...
import org.j8unit.repository.javax.naming.InitialContextClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InitialDirContext
 * public class javax.naming.directory.InitialDirContext}.
 *
...
public abstract interface InitialDirContextClassTests<SUT extends InitialDirContext>
extends DirContextClassTests<SUT>, InitialContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InitialDirContext.class!",
                   InitialDirContext.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.naming.directory.InitialDirContext]

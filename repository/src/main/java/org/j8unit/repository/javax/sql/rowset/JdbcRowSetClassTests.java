 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JdbcRowSet public
 * abstract interface javax.sql.rowset.JdbcRowSet}.
 *
...
public abstract interface JdbcRowSetClassTests<SUT extends JdbcRowSet>
extends RowSetClassTests<SUT>, JoinableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JdbcRowSet.class!",
                   JdbcRowSet.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.rowset.JdbcRowSet interface javax.sql.rowset.JdbcRowSet},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JdbcRowSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JdbcRowSetTests}.
 * </p>
 *
 * @see javax.sql.rowset.JdbcRowSet interface javax.sql.rowset.JdbcRowSet (the hereby targeted class-under-test class)
 * @see JdbcRowSetTests JdbcRowSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JdbcRowSetClassTests<SUT extends javax.sql.rowset.JdbcRowSet>
extends org.j8unit.repository.javax.sql.RowSetClassTests<SUT>, JoinableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.JdbcRowSet.class!",
                   javax.sql.rowset.JdbcRowSet.class.isAssignableFrom(sut));
    }

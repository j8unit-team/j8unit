 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OAEPParameterSpec
...
public abstract interface OAEPParameterSpecClassTests<SUT extends OAEPParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OAEPParameterSpec.class!",
                   OAEPParameterSpec.class.isAssignableFrom(sut));
    }

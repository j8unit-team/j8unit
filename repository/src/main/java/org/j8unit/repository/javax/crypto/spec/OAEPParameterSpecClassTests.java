 ...
 * javax.crypto.spec.OAEPParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OAEPParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OAEPParameterSpecTests}.
 * </p>
 *
 * @see javax.crypto.spec.OAEPParameterSpec class javax.crypto.spec.OAEPParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see OAEPParameterSpecTests OAEPParameterSpecTests (The complementary j8unit test interface containing the instance
...
public abstract interface OAEPParameterSpecClassTests<SUT extends javax.crypto.spec.OAEPParameterSpec>
extends org.j8unit.repository.java.security.spec.AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.OAEPParameterSpec.class!",
                   javax.crypto.spec.OAEPParameterSpec.class.isAssignableFrom(sut));
    }

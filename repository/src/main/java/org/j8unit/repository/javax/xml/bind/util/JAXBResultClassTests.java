...
import org.j8unit.repository.javax.xml.transform.sax.SAXResultClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JAXBResult public
...
public abstract interface JAXBResultClassTests<SUT extends JAXBResult>
extends SAXResultClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JAXBResult.class!",
                   JAXBResult.class.isAssignableFrom(sut));
    }

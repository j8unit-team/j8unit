...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.util.JAXBResult class javax.xml.bind.util.JAXBResult},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JAXBResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JAXBResultTests}.
 * </p>
 *
 * @see javax.xml.bind.util.JAXBResult class javax.xml.bind.util.JAXBResult (the hereby targeted class-under-test class)
 * @see JAXBResultTests JAXBResultTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JAXBResultClassTests<SUT extends javax.xml.bind.util.JAXBResult>
extends org.j8unit.repository.javax.xml.transform.sax.SAXResultClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.util.JAXBResult.class!",
                   javax.xml.bind.util.JAXBResult.class.isAssignableFrom(sut));
    }

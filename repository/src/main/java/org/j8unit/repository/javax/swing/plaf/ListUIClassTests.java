 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListUITests}.
 * </p>
 *
 * @see javax.swing.plaf.ListUI class javax.swing.plaf.ListUI (the hereby targeted class-under-test class)
 * @see ListUITests ListUITests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ListUIClassTests<SUT extends javax.swing.plaf.ListUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.ListUI.class!",
                   javax.swing.plaf.ListUI.class.isAssignableFrom(sut));
    }

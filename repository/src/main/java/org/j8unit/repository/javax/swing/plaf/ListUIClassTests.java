 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListUI public
 * abstract class javax.swing.plaf.ListUI}.
 *
...
public abstract interface ListUIClassTests<SUT extends ListUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListUI.class!",
                   ListUI.class.isAssignableFrom(sut));
    }

 ...
 * {@link NamingSecurityException public abstract class javax.naming.NamingSecurityException}.
 *
...
public abstract interface NamingSecurityExceptionClassTests<SUT extends NamingSecurityException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingSecurityException.class!",
                   NamingSecurityException.class.isAssignableFrom(sut));
    }

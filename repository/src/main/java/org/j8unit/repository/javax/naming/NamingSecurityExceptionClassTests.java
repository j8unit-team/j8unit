 ...
 * javax.naming.NamingSecurityException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingSecurityExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NamingSecurityExceptionTests}.
 * </p>
 *
 * @see javax.naming.NamingSecurityException class javax.naming.NamingSecurityException (the hereby targeted
 *      class-under-test class)
 * @see NamingSecurityExceptionTests NamingSecurityExceptionTests (The complementary j8unit test interface containing
...
public abstract interface NamingSecurityExceptionClassTests<SUT extends javax.naming.NamingSecurityException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.NamingSecurityException.class!",
                   javax.naming.NamingSecurityException.class.isAssignableFrom(sut));
    }

 ...
 * {@link XSLTTransformParameterSpec public final class javax.xml.crypto.dsig.spec.XSLTTransformParameterSpec}.
 *
...
public abstract interface XSLTTransformParameterSpecClassTests<SUT extends XSLTTransformParameterSpec>
extends TransformParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XSLTTransformParameterSpec.class!",
                   XSLTTransformParameterSpec.class.isAssignableFrom(sut));
    }

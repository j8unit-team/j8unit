 ...
 * javax.xml.crypto.dsig.spec.XSLTTransformParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link XSLTTransformParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 * @see XSLTTransformParameterSpecTests XSLTTransformParameterSpecTests (The complementary j8unit test interface
...
extends TransformParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.XSLTTransformParameterSpec.class!",
                   javax.xml.crypto.dsig.spec.XSLTTransformParameterSpec.class.isAssignableFrom(sut));
    }

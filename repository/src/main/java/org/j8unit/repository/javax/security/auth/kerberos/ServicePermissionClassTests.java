 ...
 * javax.security.auth.kerberos.ServicePermission}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServicePermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServicePermissionTests}.
 * </p>
 *
 * @see javax.security.auth.kerberos.ServicePermission class javax.security.auth.kerberos.ServicePermission (the hereby
 *      targeted class-under-test class)
 * @see ServicePermissionTests ServicePermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.security.PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.kerberos.ServicePermission.class!",
                   javax.security.auth.kerberos.ServicePermission.class.isAssignableFrom(sut));
    }

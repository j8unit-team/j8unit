 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServicePermission
 * public final class javax.security.auth.kerberos.ServicePermission}.
 *
...
public abstract interface ServicePermissionClassTests<SUT extends ServicePermission>
extends PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServicePermission.class!",
                   ServicePermission.class.isAssignableFrom(sut));
    }

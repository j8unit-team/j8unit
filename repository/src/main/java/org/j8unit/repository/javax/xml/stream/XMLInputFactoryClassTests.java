 ...
 * javax.xml.stream.XMLInputFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLInputFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLInputFactoryTests}.
 * </p>
 *
 * @see javax.xml.stream.XMLInputFactory class javax.xml.stream.XMLInputFactory (the hereby targeted class-under-test
 *      class)
 * @see XMLInputFactoryTests XMLInputFactoryTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.XMLInputFactory.class!",
                   javax.xml.stream.XMLInputFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLInputFactory
...
public abstract interface XMLInputFactoryClassTests<SUT extends XMLInputFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLInputFactory.class!",
                   XMLInputFactory.class.isAssignableFrom(sut));
    }

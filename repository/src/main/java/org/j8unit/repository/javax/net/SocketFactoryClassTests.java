 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketFactory
...
public abstract interface SocketFactoryClassTests<SUT extends SocketFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketFactory.class!",
                   SocketFactory.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.net.SocketFactory]

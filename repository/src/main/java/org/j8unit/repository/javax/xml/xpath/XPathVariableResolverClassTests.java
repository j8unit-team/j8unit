...
public abstract interface XPathVariableResolverClassTests<SUT extends XPathVariableResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathVariableResolver.class!",
                   XPathVariableResolver.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.xpath.XPathVariableResolver}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathVariableResolverTests}).
 * </p>
 *
 * <p>
 ...
 * {@link XPathVariableResolverTests}.
 * </p>
 *
 * @see javax.xml.xpath.XPathVariableResolver interface javax.xml.xpath.XPathVariableResolver (the hereby targeted
 *      class-under-test class)
 * @see XPathVariableResolverTests XPathVariableResolverTests (The complementary j8unit test interface containing the
...
public abstract interface XPathVariableResolverClassTests<SUT extends javax.xml.xpath.XPathVariableResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.xpath.XPathVariableResolver.class!",
                   javax.xml.xpath.XPathVariableResolver.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.javax.imageio.ImageWriteParamClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JPEGImageWriteParam
 * public class javax.imageio.plugins.jpeg.JPEGImageWriteParam}.
 *
...
public abstract interface JPEGImageWriteParamClassTests<SUT extends JPEGImageWriteParam>
extends ImageWriteParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JPEGImageWriteParam.class!",
                   JPEGImageWriteParam.class.isAssignableFrom(sut));
    }

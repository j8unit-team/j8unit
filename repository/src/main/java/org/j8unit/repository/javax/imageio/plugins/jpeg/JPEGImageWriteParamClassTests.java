 ...
 * javax.imageio.plugins.jpeg.JPEGImageWriteParam}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JPEGImageWriteParamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JPEGImageWriteParamTests}.
 * </p>
 *
 * @see javax.imageio.plugins.jpeg.JPEGImageWriteParam class javax.imageio.plugins.jpeg.JPEGImageWriteParam (the hereby
 *      targeted class-under-test class)
 * @see JPEGImageWriteParamTests JPEGImageWriteParamTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.imageio.ImageWriteParamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.plugins.jpeg.JPEGImageWriteParam.class!",
                   javax.imageio.plugins.jpeg.JPEGImageWriteParam.class.isAssignableFrom(sut));
    }

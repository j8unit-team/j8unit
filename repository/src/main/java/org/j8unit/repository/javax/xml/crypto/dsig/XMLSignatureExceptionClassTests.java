 ...
 * {@link XMLSignatureException public class javax.xml.crypto.dsig.XMLSignatureException}.
 *
...
public abstract interface XMLSignatureExceptionClassTests<SUT extends XMLSignatureException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLSignatureException.class!",
                   XMLSignatureException.class.isAssignableFrom(sut));
    }

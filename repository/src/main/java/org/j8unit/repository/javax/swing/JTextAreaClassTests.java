 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JTextAreaTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JTextAreaTests}.
 * </p>
 *
 * @see javax.swing.JTextArea class javax.swing.JTextArea (the hereby targeted class-under-test class)
 * @see JTextAreaTests JTextAreaTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JTextAreaClassTests<SUT extends javax.swing.JTextArea>
extends org.j8unit.repository.javax.swing.text.JTextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JTextArea.class!",
                   javax.swing.JTextArea.class.isAssignableFrom(sut));
    }

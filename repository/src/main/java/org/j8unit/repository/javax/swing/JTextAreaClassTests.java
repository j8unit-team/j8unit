 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JTextArea public
...
public abstract interface JTextAreaClassTests<SUT extends JTextArea>
extends JTextComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.JTextArea]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JTextArea.class!",
                   JTextArea.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.swing.JTextArea]

    // J8UNIT-MARKER-[END]-[CLASS]-[javax.swing.JTextArea]

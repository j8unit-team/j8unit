...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.border.LineBorder class javax.swing.border.LineBorder},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LineBorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LineBorderTests}.
 * </p>
 *
 * @see javax.swing.border.LineBorder class javax.swing.border.LineBorder (the hereby targeted class-under-test class)
 * @see LineBorderTests LineBorderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LineBorderClassTests<SUT extends javax.swing.border.LineBorder>
extends AbstractBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.LineBorder.class!",
                   javax.swing.border.LineBorder.class.isAssignableFrom(sut));
    }

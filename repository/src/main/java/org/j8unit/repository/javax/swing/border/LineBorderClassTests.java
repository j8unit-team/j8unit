 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LineBorder public
...
public abstract interface LineBorderClassTests<SUT extends LineBorder>
extends AbstractBorderClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.border.LineBorder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineBorder.class!",

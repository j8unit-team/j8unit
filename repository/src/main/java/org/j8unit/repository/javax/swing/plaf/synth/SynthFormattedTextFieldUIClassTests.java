 ...
 * {@link SynthFormattedTextFieldUI public class javax.swing.plaf.synth.SynthFormattedTextFieldUI}.
 *
...
public abstract interface SynthFormattedTextFieldUIClassTests<SUT extends SynthFormattedTextFieldUI>
extends SynthTextFieldUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthFormattedTextFieldUI.class!",
                   SynthFormattedTextFieldUI.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XmlJavaTypeAdapters
 * public abstract @interface javax.xml.bind.annotation.adapters.XmlJavaTypeAdapters}.
 *
...
public abstract interface XmlJavaTypeAdaptersClassTests<SUT extends XmlJavaTypeAdapters>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XmlJavaTypeAdapters.class!",
                   XmlJavaTypeAdapters.class.isAssignableFrom(sut));
    }

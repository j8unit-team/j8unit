...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.xml.bind.annotation.adapters.XmlJavaTypeAdapters interface
 * javax.xml.bind.annotation.adapters.XmlJavaTypeAdapters}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XmlJavaTypeAdaptersTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XmlJavaTypeAdaptersTests}.
 * </p>
 *
 ...
 * @see XmlJavaTypeAdaptersTests XmlJavaTypeAdaptersTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.annotation.adapters.XmlJavaTypeAdapters.class!",
                   javax.xml.bind.annotation.adapters.XmlJavaTypeAdapters.class.isAssignableFrom(sut));
    }

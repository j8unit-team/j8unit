...
import org.j8unit.repository.javax.swing.plaf.ColorChooserUIClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiColorChooserUI
 * public class javax.swing.plaf.multi.MultiColorChooserUI}.
 *
...
public abstract interface MultiColorChooserUIClassTests<SUT extends MultiColorChooserUI>
extends ColorChooserUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiColorChooserUI.class!",
                   MultiColorChooserUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.transaction.InvalidTransactionException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidTransactionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.transaction.InvalidTransactionException class javax.transaction.InvalidTransactionException (the hereby
 *      targeted class-under-test class)
 * @see InvalidTransactionExceptionTests InvalidTransactionExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.transaction.InvalidTransactionException.class!",
                   javax.transaction.InvalidTransactionException.class.isAssignableFrom(sut));
    }

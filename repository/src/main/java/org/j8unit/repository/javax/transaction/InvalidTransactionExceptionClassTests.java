 ...
 * {@link org.j8unit.repository.javax.transaction.InvalidTransactionExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface InvalidTransactionExceptionClassTests<SUT extends InvalidTransactionException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidTransactionException.class!",
                   InvalidTransactionException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FlowView public
 * abstract class javax.swing.text.FlowView}.
 *
...
extends BoxViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FlowView.class!",
     ...
     * {@link FlowStrategy public static class javax.swing.text.FlowView$FlowStrategy}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

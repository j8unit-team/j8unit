 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlowViewTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.text.FlowView class javax.swing.text.FlowView (the hereby targeted class-under-test class)
 * @see FlowViewTests FlowViewTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends BoxViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.FlowView.class!",
                   javax.swing.text.FlowView.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.FlowView.FlowStrategy class
     * javax.swing.text.FlowView$FlowStrategy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link FlowViewTests.FlowStrategyTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.text.FlowView.FlowStrategy class javax.swing.text.FlowView$FlowStrategy (the hereby targeted
     *      class-under-test class)
     * @see FlowViewTests.FlowStrategyTests FlowViewTests.FlowStrategyTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.FlowView.FlowStrategy.class!",
                       javax.swing.text.FlowView.FlowStrategy.class.isAssignableFrom(sut));
        }

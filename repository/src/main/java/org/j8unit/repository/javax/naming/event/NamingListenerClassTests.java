 ...
 * javax.naming.event.NamingListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingListenerTests}.
 * </p>
 *
 * @see javax.naming.event.NamingListener interface javax.naming.event.NamingListener (the hereby targeted
 *      class-under-test class)
 * @see NamingListenerTests NamingListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface NamingListenerClassTests<SUT extends javax.naming.event.NamingListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.event.NamingListener.class!",
                   javax.naming.event.NamingListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingListener
 * public abstract interface javax.naming.event.NamingListener}.
 *
...
public abstract interface NamingListenerClassTests<SUT extends NamingListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingListener.class!",
                   NamingListener.class.isAssignableFrom(sut));
    }

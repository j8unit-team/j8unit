 ...
 * javax.naming.TimeLimitExceededException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link TimeLimitExceededExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see TimeLimitExceededExceptionTests TimeLimitExceededExceptionTests (The complementary j8unit test interface
...
extends LimitExceededExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.TimeLimitExceededException.class!",
                   javax.naming.TimeLimitExceededException.class.isAssignableFrom(sut));
    }

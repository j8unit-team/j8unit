 ...
 * {@link TimeLimitExceededException public class javax.naming.TimeLimitExceededException}.
 *
...
public abstract interface TimeLimitExceededExceptionClassTests<SUT extends TimeLimitExceededException>
extends LimitExceededExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimeLimitExceededException.class!",
                   TimeLimitExceededException.class.isAssignableFrom(sut));
    }

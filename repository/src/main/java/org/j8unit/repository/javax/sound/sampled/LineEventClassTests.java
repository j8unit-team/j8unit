...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sound.sampled.LineEvent class javax.sound.sampled.LineEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LineEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LineEventTests}.
 * </p>
 *
 * @see javax.sound.sampled.LineEvent class javax.sound.sampled.LineEvent (the hereby targeted class-under-test class)
 * @see LineEventTests LineEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LineEventClassTests<SUT extends javax.sound.sampled.LineEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.LineEvent.class!",
                   javax.sound.sampled.LineEvent.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.sound.sampled.LineEvent.Type class
     * javax.sound.sampled.LineEvent$Type}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link LineEventTests.TypeTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * {@link LineEventTests.TypeTests}.
     * </p>
     *
     * @see javax.sound.sampled.LineEvent.Type class javax.sound.sampled.LineEvent$Type (the hereby targeted
     *      class-under-test class)
     * @see LineEventTests.TypeTests LineEventTests.TypeTests (The complementary j8unit test interface containing the
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface TypeClassTests<SUT extends javax.sound.sampled.LineEvent.Type>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sound.sampled.LineEvent.Type.class!",
                       javax.sound.sampled.LineEvent.Type.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LineEvent public
...
public abstract interface LineEventClassTests<SUT extends LineEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineEvent.class!",
                   LineEvent.class.isAssignableFrom(sut));
    }
     ...
     * {@link Type public static class javax.sound.sampled.LineEvent$Type}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

 ...
 * javax.activation.UnsupportedDataTypeException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UnsupportedDataTypeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnsupportedDataTypeExceptionTests UnsupportedDataTypeExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.activation.UnsupportedDataTypeException.class!",
                   javax.activation.UnsupportedDataTypeException.class.isAssignableFrom(sut));
    }

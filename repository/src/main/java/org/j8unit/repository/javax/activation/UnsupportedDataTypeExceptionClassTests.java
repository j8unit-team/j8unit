...
public abstract interface UnsupportedDataTypeExceptionClassTests<SUT extends UnsupportedDataTypeException>
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedDataTypeException.class!",
                   UnsupportedDataTypeException.class.isAssignableFrom(sut));
    }

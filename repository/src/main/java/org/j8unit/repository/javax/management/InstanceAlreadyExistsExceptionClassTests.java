 ...
 * {@link InstanceAlreadyExistsException public class javax.management.InstanceAlreadyExistsException}.
 *
...
public abstract interface InstanceAlreadyExistsExceptionClassTests<SUT extends InstanceAlreadyExistsException>
extends org.j8unit.repository.javax.management.OperationsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InstanceAlreadyExistsException.class!",
                   InstanceAlreadyExistsException.class.isAssignableFrom(sut));
    }

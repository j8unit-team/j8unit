 ...
 * javax.xml.transform.TransformerFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransformerFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransformerFactoryTests}.
 * </p>
 *
 * @see javax.xml.transform.TransformerFactory class javax.xml.transform.TransformerFactory (the hereby targeted
 *      class-under-test class)
 * @see TransformerFactoryTests TransformerFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface TransformerFactoryClassTests<SUT extends javax.xml.transform.TransformerFactory>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.transform.TransformerFactory.class!",
                   javax.xml.transform.TransformerFactory.class.isAssignableFrom(sut));
    }

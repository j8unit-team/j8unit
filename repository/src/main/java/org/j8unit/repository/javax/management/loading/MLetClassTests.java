...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.management.loading.MLet class javax.management.loading.MLet},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MLetTests}).
 * </p>
 *
 * <p>
 ...
 * @see MLetTests MLetTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends MLetMBeanClassTests<SUT>, org.j8unit.repository.javax.management.MBeanRegistrationClassTests<SUT>,
org.j8unit.repository.java.io.ExternalizableClassTests<SUT>, org.j8unit.repository.java.net.URLClassLoaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.loading.MLet.class!",
                   javax.management.loading.MLet.class.isAssignableFrom(sut));
    }

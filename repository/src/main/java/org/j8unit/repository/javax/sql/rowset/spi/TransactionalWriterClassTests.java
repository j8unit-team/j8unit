...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.sql.rowset.spi.TransactionalWriter interface
 * javax.sql.rowset.spi.TransactionalWriter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransactionalWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransactionalWriterTests}.
 * </p>
 *
 * @see javax.sql.rowset.spi.TransactionalWriter interface javax.sql.rowset.spi.TransactionalWriter (the hereby targeted
 *      class-under-test class)
 * @see TransactionalWriterTests TransactionalWriterTests (The complementary j8unit test interface containing the
...
public abstract interface TransactionalWriterClassTests<SUT extends javax.sql.rowset.spi.TransactionalWriter>
extends org.j8unit.repository.javax.sql.RowSetWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.rowset.spi.TransactionalWriter.class!",
                   javax.sql.rowset.spi.TransactionalWriter.class.isAssignableFrom(sut));
    }

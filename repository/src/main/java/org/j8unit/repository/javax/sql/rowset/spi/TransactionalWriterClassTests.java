...
import org.j8unit.repository.javax.sql.RowSetWriterClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TransactionalWriter
 * public abstract interface javax.sql.rowset.spi.TransactionalWriter}.
 *
...
public abstract interface TransactionalWriterClassTests<SUT extends TransactionalWriter>
extends RowSetWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransactionalWriter.class!",
                   TransactionalWriter.class.isAssignableFrom(sut));
    }

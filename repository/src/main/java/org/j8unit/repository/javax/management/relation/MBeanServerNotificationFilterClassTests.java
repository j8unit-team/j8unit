 ...
 * javax.management.relation.MBeanServerNotificationFilter}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link MBeanServerNotificationFilterTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.management.relation.MBeanServerNotificationFilter class
 *      javax.management.relation.MBeanServerNotificationFilter (the hereby targeted class-under-test class)
 * @see MBeanServerNotificationFilterTests MBeanServerNotificationFilterTests (The complementary j8unit test interface
...
extends org.j8unit.repository.javax.management.NotificationFilterSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.MBeanServerNotificationFilter.class!",
                   javax.management.relation.MBeanServerNotificationFilter.class.isAssignableFrom(sut));
    }

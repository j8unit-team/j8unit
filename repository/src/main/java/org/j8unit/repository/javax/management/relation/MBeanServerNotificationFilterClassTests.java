...
import org.j8unit.repository.javax.management.NotificationFilterSupportClassTests;
 ...
 * {@link MBeanServerNotificationFilter public class javax.management.relation.MBeanServerNotificationFilter}.
 *
...
public abstract interface MBeanServerNotificationFilterClassTests<SUT extends MBeanServerNotificationFilter>
extends NotificationFilterSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MBeanServerNotificationFilter.class!",
                   MBeanServerNotificationFilter.class.isAssignableFrom(sut));
    }

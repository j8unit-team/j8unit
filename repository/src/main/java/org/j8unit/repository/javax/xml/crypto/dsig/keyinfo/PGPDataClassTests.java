 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PGPData public
 * abstract interface javax.xml.crypto.dsig.keyinfo.PGPData}.
 *
...
public abstract interface PGPDataClassTests<SUT extends PGPData>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PGPData.class!",
                   PGPData.class.isAssignableFrom(sut));
    }

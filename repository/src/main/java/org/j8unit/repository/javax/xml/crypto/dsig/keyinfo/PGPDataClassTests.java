 ...
 * javax.xml.crypto.dsig.keyinfo.PGPData}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PGPDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PGPDataTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.keyinfo.PGPData interface javax.xml.crypto.dsig.keyinfo.PGPData (the hereby targeted
 *      class-under-test class)
 * @see PGPDataTests PGPDataTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PGPDataClassTests<SUT extends javax.xml.crypto.dsig.keyinfo.PGPData>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.keyinfo.PGPData.class!",
                   javax.xml.crypto.dsig.keyinfo.PGPData.class.isAssignableFrom(sut));
    }

 ...
 * {@link UnsolicitedNotificationEvent public class javax.naming.ldap.UnsolicitedNotificationEvent}.
 *
...
public abstract interface UnsolicitedNotificationEventClassTests<SUT extends UnsolicitedNotificationEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsolicitedNotificationEvent.class!",
                   UnsolicitedNotificationEvent.class.isAssignableFrom(sut));
    }

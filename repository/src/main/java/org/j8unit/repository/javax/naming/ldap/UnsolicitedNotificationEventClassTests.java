 ...
 * javax.naming.ldap.UnsolicitedNotificationEvent}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UnsolicitedNotificationEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnsolicitedNotificationEventTests UnsolicitedNotificationEventTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ldap.UnsolicitedNotificationEvent.class!",
                   javax.naming.ldap.UnsolicitedNotificationEvent.class.isAssignableFrom(sut));
    }

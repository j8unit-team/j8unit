...
public abstract interface HandshakeCompletedListenerClassTests<SUT extends HandshakeCompletedListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HandshakeCompletedListener.class!",
                   HandshakeCompletedListener.class.isAssignableFrom(sut));
    }

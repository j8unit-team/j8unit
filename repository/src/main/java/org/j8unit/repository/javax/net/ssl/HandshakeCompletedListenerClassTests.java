 ...
 * javax.net.ssl.HandshakeCompletedListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link HandshakeCompletedListenerTests}).
 * </p>
 *
 * <p>
 ...
 * @see HandshakeCompletedListenerTests HandshakeCompletedListenerTests (The complementary j8unit test interface
...
public abstract interface HandshakeCompletedListenerClassTests<SUT extends javax.net.ssl.HandshakeCompletedListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.HandshakeCompletedListener.class!",
                   javax.net.ssl.HandshakeCompletedListener.class.isAssignableFrom(sut));
    }

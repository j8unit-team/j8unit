 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JToggleButtonTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.swing.JToggleButton class javax.swing.JToggleButton (the hereby targeted class-under-test class)
 * @see JToggleButtonTests JToggleButtonTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, AbstractButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JToggleButton.class!",
                   javax.swing.JToggleButton.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.JToggleButton.ToggleButtonModel class
     * javax.swing.JToggleButton$ToggleButtonModel}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link JToggleButtonTests.ToggleButtonModelTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see javax.swing.JToggleButton.ToggleButtonModel class javax.swing.JToggleButton$ToggleButtonModel (the hereby
     *      targeted class-under-test class)
     * @see JToggleButtonTests.ToggleButtonModelTests JToggleButtonTests.ToggleButtonModelTests (The complementary
    ...
    extends DefaultButtonModelClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JToggleButton.ToggleButtonModel.class!",
                       javax.swing.JToggleButton.ToggleButtonModel.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JToggleButton
 * public class javax.swing.JToggleButton}.
 *
...
extends AccessibleClassTests<SUT>, AbstractButtonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JToggleButton.class!",
     ...
     * {@link ToggleButtonModel public static class javax.swing.JToggleButton$ToggleButtonModel}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

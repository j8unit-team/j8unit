 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentViewTests}.
 * </p>
 *
 * @see javax.swing.text.ComponentView class javax.swing.text.ComponentView (the hereby targeted class-under-test class)
 * @see ComponentViewTests ComponentViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.ComponentView.class!",
                   javax.swing.text.ComponentView.class.isAssignableFrom(sut));
    }

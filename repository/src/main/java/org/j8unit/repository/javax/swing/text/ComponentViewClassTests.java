 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComponentView
...
public abstract interface ComponentViewClassTests<SUT extends ComponentView>
extends ViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentView.class!",
                   ComponentView.class.isAssignableFrom(sut));
    }

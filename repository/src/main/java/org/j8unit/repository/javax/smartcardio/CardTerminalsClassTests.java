...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.smartcardio.CardTerminals class javax.smartcardio.CardTerminals}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CardTerminalsTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see CardTerminalsTests CardTerminalsTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.smartcardio.CardTerminals.class!",
                   javax.smartcardio.CardTerminals.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.smartcardio.CardTerminals.State class
     * javax.smartcardio.CardTerminals$State}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link CardTerminalsTests.StateTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see CardTerminalsTests.StateTests CardTerminalsTests.StateTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.smartcardio.CardTerminals.State.class!",
                       javax.smartcardio.CardTerminals.State.class.isAssignableFrom(sut));
        }

...
public abstract interface SimpleElementVisitor8ClassTests<SUT extends SimpleElementVisitor8>
extends org.j8unit.repository.javax.lang.model.util.SimpleElementVisitor7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleElementVisitor8.class!",
                   SimpleElementVisitor8.class.isAssignableFrom(sut));
    }

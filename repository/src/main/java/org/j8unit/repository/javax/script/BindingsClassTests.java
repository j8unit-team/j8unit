...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.script.Bindings interface javax.script.Bindings}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BindingsTests}.
 * </p>
 *
 * @see javax.script.Bindings interface javax.script.Bindings (the hereby targeted class-under-test class)
 * @see BindingsTests BindingsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.MapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.script.Bindings.class!",
                   javax.script.Bindings.class.isAssignableFrom(sut));
    }

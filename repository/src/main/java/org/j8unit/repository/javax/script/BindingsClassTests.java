 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Bindings public
...
public abstract interface BindingsClassTests<SUT extends Bindings>
extends MapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Bindings.class!",
                   Bindings.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TransformService
 * public abstract class javax.xml.crypto.dsig.TransformService}.
 *
...
public abstract interface TransformServiceClassTests<SUT extends TransformService>
extends TransformClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransformService.class!",

 ...
 * javax.xml.crypto.dsig.TransformService}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransformServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransformServiceTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.TransformService class javax.xml.crypto.dsig.TransformService (the hereby targeted
 *      class-under-test class)
 * @see TransformServiceTests TransformServiceTests (The complementary j8unit test interface containing the instance
...
public abstract interface TransformServiceClassTests<SUT extends javax.xml.crypto.dsig.TransformService>
extends TransformClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.TransformService.class!",
                   javax.xml.crypto.dsig.TransformService.class.isAssignableFrom(sut));
    }

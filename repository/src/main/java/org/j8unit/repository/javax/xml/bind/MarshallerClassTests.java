 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Marshaller public
 * abstract interface javax.xml.bind.Marshaller}.
 *
...
public abstract interface MarshallerClassTests<SUT extends Marshaller>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Marshaller.class!",
                   Marshaller.class.isAssignableFrom(sut));
    }
     ...
     * {@link Listener public abstract static class javax.xml.bind.Marshaller$Listener}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

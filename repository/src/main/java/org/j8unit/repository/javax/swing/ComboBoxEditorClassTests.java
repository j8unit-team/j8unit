 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComboBoxEditor
 * public abstract interface javax.swing.ComboBoxEditor}.
 *
...
public abstract interface ComboBoxEditorClassTests<SUT extends ComboBoxEditor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComboBoxEditor.class!",
                   ComboBoxEditor.class.isAssignableFrom(sut));
    }

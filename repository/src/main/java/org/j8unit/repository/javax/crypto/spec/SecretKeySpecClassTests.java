...
import org.j8unit.repository.java.security.spec.KeySpecClassTests;
import org.j8unit.repository.javax.crypto.SecretKeyClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecretKeySpec
...
public abstract interface SecretKeySpecClassTests<SUT extends SecretKeySpec>
extends KeySpecClassTests<SUT>, SecretKeyClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecretKeySpec.class!",
                   SecretKeySpec.class.isAssignableFrom(sut));
    }

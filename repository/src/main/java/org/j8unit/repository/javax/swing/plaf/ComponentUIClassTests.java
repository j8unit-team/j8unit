 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComponentUI public
...
public abstract interface ComponentUIClassTests<SUT extends ComponentUI>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentUI.class!",
                   ComponentUI.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.event.CellEditorListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CellEditorListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CellEditorListenerTests}.
 * </p>
 *
 * @see javax.swing.event.CellEditorListener interface javax.swing.event.CellEditorListener (the hereby targeted
 *      class-under-test class)
 * @see CellEditorListenerTests CellEditorListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface CellEditorListenerClassTests<SUT extends javax.swing.event.CellEditorListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.event.CellEditorListener.class!",
                   javax.swing.event.CellEditorListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CellEditorListener
 * public abstract interface javax.swing.event.CellEditorListener}.
 *
...
public abstract interface CellEditorListenerClassTests<SUT extends CellEditorListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CellEditorListener.class!",
                   CellEditorListener.class.isAssignableFrom(sut));
    }

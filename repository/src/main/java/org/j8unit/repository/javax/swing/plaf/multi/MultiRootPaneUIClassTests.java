 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiRootPaneUI
 * public class javax.swing.plaf.multi.MultiRootPaneUI}.
 *
...
public abstract interface MultiRootPaneUIClassTests<SUT extends MultiRootPaneUI>
extends org.j8unit.repository.javax.swing.plaf.RootPaneUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiRootPaneUI.class!",
                   MultiRootPaneUI.class.isAssignableFrom(sut));
    }

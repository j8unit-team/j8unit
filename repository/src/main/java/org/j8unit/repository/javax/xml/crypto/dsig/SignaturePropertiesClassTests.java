 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SignatureProperties
 * public abstract interface javax.xml.crypto.dsig.SignatureProperties}.
 *
...
public abstract interface SignaturePropertiesClassTests<SUT extends SignatureProperties>
extends XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignatureProperties.class!",
                   SignatureProperties.class.isAssignableFrom(sut));
    }

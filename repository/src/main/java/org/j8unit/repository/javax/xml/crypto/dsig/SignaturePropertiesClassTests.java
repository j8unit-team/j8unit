 ...
 * javax.xml.crypto.dsig.SignatureProperties}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignaturePropertiesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignaturePropertiesTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.SignatureProperties interface javax.xml.crypto.dsig.SignatureProperties (the hereby
 *      targeted class-under-test class)
 * @see SignaturePropertiesTests SignaturePropertiesTests (The complementary j8unit test interface containing the
...
public abstract interface SignaturePropertiesClassTests<SUT extends javax.xml.crypto.dsig.SignatureProperties>
extends org.j8unit.repository.javax.xml.crypto.XMLStructureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.SignatureProperties.class!",
                   javax.xml.crypto.dsig.SignatureProperties.class.isAssignableFrom(sut));
    }

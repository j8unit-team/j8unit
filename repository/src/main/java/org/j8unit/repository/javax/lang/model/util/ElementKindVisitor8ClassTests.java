 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ElementKindVisitor8
 * public class javax.lang.model.util.ElementKindVisitor8<R,P>}.
 *
...
public abstract interface ElementKindVisitor8ClassTests<SUT extends ElementKindVisitor8>
extends org.j8unit.repository.javax.lang.model.util.ElementKindVisitor7ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementKindVisitor8.class!",
                   ElementKindVisitor8.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultButtonModel
...
public abstract interface DefaultButtonModelClassTests<SUT extends DefaultButtonModel>
extends ButtonModelClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultButtonModel.class!",
                   DefaultButtonModel.class.isAssignableFrom(sut));
    }

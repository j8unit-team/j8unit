 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IIOExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IIOExceptionTests}.
 * </p>
 *
 * @see javax.imageio.IIOException class javax.imageio.IIOException (the hereby targeted class-under-test class)
 * @see IIOExceptionTests IIOExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.IIOException.class!",
                   javax.imageio.IIOException.class.isAssignableFrom(sut));
    }

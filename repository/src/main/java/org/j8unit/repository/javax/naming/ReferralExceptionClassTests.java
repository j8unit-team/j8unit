...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.naming.ReferralException class javax.naming.ReferralException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReferralExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReferralExceptionTests}.
 * </p>
 *
 * @see javax.naming.ReferralException class javax.naming.ReferralException (the hereby targeted class-under-test class)
 * @see ReferralExceptionTests ReferralExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ReferralExceptionClassTests<SUT extends javax.naming.ReferralException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.naming.ReferralException.class!",
                   javax.naming.ReferralException.class.isAssignableFrom(sut));
    }

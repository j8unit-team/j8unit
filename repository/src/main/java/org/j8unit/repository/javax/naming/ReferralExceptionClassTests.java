 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReferralException
 * public abstract class javax.naming.ReferralException}.
 *
...
public abstract interface ReferralExceptionClassTests<SUT extends ReferralException>
extends NamingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReferralException.class!",

 ...
 * javax.accessibility.AccessibleState}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleStateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleStateTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleState class javax.accessibility.AccessibleState (the hereby targeted
 *      class-under-test class)
 * @see AccessibleStateTests AccessibleStateTests (The complementary j8unit test interface containing the instance
...
public abstract interface AccessibleStateClassTests<SUT extends javax.accessibility.AccessibleState>
extends AccessibleBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleState.class!",
                   javax.accessibility.AccessibleState.class.isAssignableFrom(sut));
    }

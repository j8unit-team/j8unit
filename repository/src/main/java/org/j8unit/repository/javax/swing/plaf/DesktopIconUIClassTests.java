 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DesktopIconUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DesktopIconUITests}.
 * </p>
 *
 * @see javax.swing.plaf.DesktopIconUI class javax.swing.plaf.DesktopIconUI (the hereby targeted class-under-test class)
 * @see DesktopIconUITests DesktopIconUITests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DesktopIconUIClassTests<SUT extends javax.swing.plaf.DesktopIconUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.DesktopIconUI.class!",
                   javax.swing.plaf.DesktopIconUI.class.isAssignableFrom(sut));
    }

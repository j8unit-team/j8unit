 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DesktopIconUI
 * public abstract class javax.swing.plaf.DesktopIconUI}.
 *
...
public abstract interface DesktopIconUIClassTests<SUT extends DesktopIconUI>
extends ComponentUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DesktopIconUI.class!",
                   DesktopIconUI.class.isAssignableFrom(sut));
    }

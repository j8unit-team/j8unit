 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DTDTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DTDTests}.
 * </p>
 *
 * @see javax.xml.stream.events.DTD interface javax.xml.stream.events.DTD (the hereby targeted class-under-test class)
 * @see DTDTests DTDTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DTDClassTests<SUT extends javax.xml.stream.events.DTD>
extends XMLEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.stream.events.DTD.class!",
                   javax.xml.stream.events.DTD.class.isAssignableFrom(sut));
    }

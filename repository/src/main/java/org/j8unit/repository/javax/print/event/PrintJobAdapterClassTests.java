 ...
 * javax.print.event.PrintJobAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintJobAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintJobAdapterTests}.
 * </p>
 *
 * @see javax.print.event.PrintJobAdapter class javax.print.event.PrintJobAdapter (the hereby targeted class-under-test
 *      class)
 * @see PrintJobAdapterTests PrintJobAdapterTests (The complementary j8unit test interface containing the instance
...
extends PrintJobListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.event.PrintJobAdapter.class!",
                   javax.print.event.PrintJobAdapter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintJobAdapter
...
public abstract interface PrintJobAdapterClassTests<SUT extends PrintJobAdapter>
extends org.j8unit.repository.javax.print.event.PrintJobListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintJobAdapter.class!",
                   PrintJobAdapter.class.isAssignableFrom(sut));
    }

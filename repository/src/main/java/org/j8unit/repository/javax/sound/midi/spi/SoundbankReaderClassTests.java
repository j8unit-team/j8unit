 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SoundbankReader
 * public abstract class javax.sound.midi.spi.SoundbankReader}.
 *
...
public abstract interface SoundbankReaderClassTests<SUT extends SoundbankReader>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SoundbankReader.class!",
                   SoundbankReader.class.isAssignableFrom(sut));
    }

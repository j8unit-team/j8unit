 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleTypeVisitor6
 * public class javax.lang.model.util.SimpleTypeVisitor6<R,P>}.
 *
...
public abstract interface SimpleTypeVisitor6ClassTests<SUT extends SimpleTypeVisitor6>
extends AbstractTypeVisitor6ClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleTypeVisitor6.class!",
                   SimpleTypeVisitor6.class.isAssignableFrom(sut));
    }

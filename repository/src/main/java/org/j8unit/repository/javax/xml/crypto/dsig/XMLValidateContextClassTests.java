 ...
 * javax.xml.crypto.dsig.XMLValidateContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLValidateContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLValidateContextTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.XMLValidateContext interface javax.xml.crypto.dsig.XMLValidateContext (the hereby targeted
 *      class-under-test class)
 * @see XMLValidateContextTests XMLValidateContextTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.xml.crypto.XMLCryptoContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.XMLValidateContext.class!",
                   javax.xml.crypto.dsig.XMLValidateContext.class.isAssignableFrom(sut));
    }

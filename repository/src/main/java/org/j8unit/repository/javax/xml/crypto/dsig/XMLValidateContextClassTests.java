...
import org.j8unit.repository.javax.xml.crypto.XMLCryptoContextClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLValidateContext
 * public abstract interface javax.xml.crypto.dsig.XMLValidateContext}.
 *
...
public abstract interface XMLValidateContextClassTests<SUT extends XMLValidateContext>
extends XMLCryptoContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLValidateContext.class!",
                   XMLValidateContext.class.isAssignableFrom(sut));
    }

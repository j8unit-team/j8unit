 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PlainDocument
 * public class javax.swing.text.PlainDocument}.
 *
...
public abstract interface PlainDocumentClassTests<SUT extends PlainDocument>
extends AbstractDocumentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PlainDocument.class!",
                   PlainDocument.class.isAssignableFrom(sut));
    }

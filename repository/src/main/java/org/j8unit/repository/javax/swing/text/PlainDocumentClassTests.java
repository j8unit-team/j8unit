 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PlainDocumentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PlainDocumentTests}.
 * </p>
 *
 * @see javax.swing.text.PlainDocument class javax.swing.text.PlainDocument (the hereby targeted class-under-test class)
 * @see PlainDocumentTests PlainDocumentTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends AbstractDocumentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.PlainDocument.class!",
                   javax.swing.text.PlainDocument.class.isAssignableFrom(sut));
    }

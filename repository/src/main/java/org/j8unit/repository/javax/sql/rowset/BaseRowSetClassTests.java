 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BaseRowSet public
 * abstract class javax.sql.rowset.BaseRowSet}.
 *
...
public abstract interface BaseRowSetClassTests<SUT extends BaseRowSet>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BaseRowSet.class!",
                   BaseRowSet.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.ws.spi.ServiceDelegate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceDelegateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServiceDelegateTests}.
 * </p>
 *
 * @see javax.xml.ws.spi.ServiceDelegate class javax.xml.ws.spi.ServiceDelegate (the hereby targeted class-under-test
 *      class)
 * @see ServiceDelegateTests ServiceDelegateTests (The complementary j8unit test interface containing the instance
...
public abstract interface ServiceDelegateClassTests<SUT extends javax.xml.ws.spi.ServiceDelegate>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.ws.spi.ServiceDelegate.class!",
                   javax.xml.ws.spi.ServiceDelegate.class.isAssignableFrom(sut));
    }

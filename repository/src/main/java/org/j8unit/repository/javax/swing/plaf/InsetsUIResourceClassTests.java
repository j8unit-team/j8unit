...
import org.j8unit.repository.java.awt.InsetsClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InsetsUIResource
 * public class javax.swing.plaf.InsetsUIResource}.
 *
...
public abstract interface InsetsUIResourceClassTests<SUT extends InsetsUIResource>
extends UIResourceClassTests<SUT>, InsetsClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.plaf.InsetsUIResource]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InsetsUIResource.class!",
                   InsetsUIResource.class.isAssignableFrom(sut));
    }

 ...
 * javax.swing.plaf.InsetsUIResource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InsetsUIResourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InsetsUIResourceTests}.
 * </p>
 *
 * @see javax.swing.plaf.InsetsUIResource class javax.swing.plaf.InsetsUIResource (the hereby targeted class-under-test
 *      class)
 * @see InsetsUIResourceTests InsetsUIResourceTests (The complementary j8unit test interface containing the instance
...
extends UIResourceClassTests<SUT>, org.j8unit.repository.java.awt.InsetsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.InsetsUIResource.class!",
                   javax.swing.plaf.InsetsUIResource.class.isAssignableFrom(sut));
    }

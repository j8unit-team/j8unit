 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MimeHeader public
...
public abstract interface MimeHeaderClassTests<SUT extends MimeHeader>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MimeHeader.class!",
                   MimeHeader.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[javax.xml.soap.MimeHeader]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MimeHeaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MimeHeaderTests}.
 * </p>
 *
 * @see javax.xml.soap.MimeHeader class javax.xml.soap.MimeHeader (the hereby targeted class-under-test class)
 * @see MimeHeaderTests MimeHeaderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.MimeHeader.class!",
                   javax.xml.soap.MimeHeader.class.isAssignableFrom(sut));
    }

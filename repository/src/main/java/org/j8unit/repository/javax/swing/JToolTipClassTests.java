 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JToolTip public
...
public abstract interface JToolTipClassTests<SUT extends JToolTip>
extends AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JToolTip.class!",
                   JToolTip.class.isAssignableFrom(sut));
    }

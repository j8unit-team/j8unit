 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintJobAttribute
 * public abstract interface javax.print.attribute.PrintJobAttribute}.
 *
...
public abstract interface PrintJobAttributeClassTests<SUT extends PrintJobAttribute>
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintJobAttribute.class!",
                   PrintJobAttribute.class.isAssignableFrom(sut));
    }

 ...
 * javax.print.attribute.PrintJobAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintJobAttributeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintJobAttributeTests}.
 * </p>
 *
 * @see javax.print.attribute.PrintJobAttribute interface javax.print.attribute.PrintJobAttribute (the hereby targeted
 *      class-under-test class)
 * @see PrintJobAttributeTests PrintJobAttributeTests (The complementary j8unit test interface containing the instance
...
extends AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.print.attribute.PrintJobAttribute.class!",
                   javax.print.attribute.PrintJobAttribute.class.isAssignableFrom(sut));
    }

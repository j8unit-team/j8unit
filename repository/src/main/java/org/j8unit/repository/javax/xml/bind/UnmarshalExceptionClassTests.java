 ...
 * javax.xml.bind.UnmarshalException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnmarshalExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see javax.xml.bind.UnmarshalException class javax.xml.bind.UnmarshalException (the hereby targeted class-under-test
 *      class)
 * @see UnmarshalExceptionTests UnmarshalExceptionTests (The complementary j8unit test interface containing the instance
...
extends JAXBExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.bind.UnmarshalException.class!",
                   javax.xml.bind.UnmarshalException.class.isAssignableFrom(sut));
    }

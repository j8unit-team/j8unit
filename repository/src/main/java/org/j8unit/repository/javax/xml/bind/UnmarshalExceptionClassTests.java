 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnmarshalException
 * public class javax.xml.bind.UnmarshalException}.
 *
...
extends org.j8unit.repository.javax.xml.bind.JAXBExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnmarshalException.class!",
                   UnmarshalException.class.isAssignableFrom(sut));
    }

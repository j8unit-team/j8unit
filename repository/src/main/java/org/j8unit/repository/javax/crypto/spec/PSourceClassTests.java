 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PSourceTests}).
 * </p>
 *
 * <p>
 ...
 * @see PSourceTests PSourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.PSource.class!",
                   javax.crypto.spec.PSource.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.crypto.spec.PSource.PSpecified class
     * javax.crypto.spec.PSource$PSpecified}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link PSourceTests.PSpecifiedTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see PSourceTests.PSpecifiedTests PSourceTests.PSpecifiedTests (The complementary j8unit test interface
    ...
    extends PSourceClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.crypto.spec.PSource.PSpecified.class!",
                       javax.crypto.spec.PSource.PSpecified.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CounterMonitor
...
public abstract interface CounterMonitorClassTests<SUT extends CounterMonitor>
extends CounterMonitorMBeanClassTests<SUT>, MonitorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CounterMonitor.class!",

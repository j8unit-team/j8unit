 ...
 * javax.management.monitor.CounterMonitor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CounterMonitorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CounterMonitorTests}.
 * </p>
 *
 * @see javax.management.monitor.CounterMonitor class javax.management.monitor.CounterMonitor (the hereby targeted
 *      class-under-test class)
 * @see CounterMonitorTests CounterMonitorTests (The complementary j8unit test interface containing the instance
...
public abstract interface CounterMonitorClassTests<SUT extends javax.management.monitor.CounterMonitor>
extends CounterMonitorMBeanClassTests<SUT>, MonitorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.monitor.CounterMonitor.class!",
                   javax.management.monitor.CounterMonitor.class.isAssignableFrom(sut));
    }

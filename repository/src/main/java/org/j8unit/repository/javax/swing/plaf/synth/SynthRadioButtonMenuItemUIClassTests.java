 ...
 * {@link SynthRadioButtonMenuItemUI public class javax.swing.plaf.synth.SynthRadioButtonMenuItemUI}.
 *
...
public abstract interface SynthRadioButtonMenuItemUIClassTests<SUT extends SynthRadioButtonMenuItemUI>
extends SynthMenuItemUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynthRadioButtonMenuItemUI.class!",
                   SynthRadioButtonMenuItemUI.class.isAssignableFrom(sut));
    }

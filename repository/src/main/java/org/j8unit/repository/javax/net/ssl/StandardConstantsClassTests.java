 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardConstantsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StandardConstantsTests}.
 * </p>
 *
 * @see javax.net.ssl.StandardConstants class javax.net.ssl.StandardConstants (the hereby targeted class-under-test
 *      class)
 * @see StandardConstantsTests StandardConstantsTests (The complementary j8unit test interface containing the instance
...
public abstract interface StandardConstantsClassTests<SUT extends javax.net.ssl.StandardConstants>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.net.ssl.StandardConstants.class!",
                   javax.net.ssl.StandardConstants.class.isAssignableFrom(sut));
    }

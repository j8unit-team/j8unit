 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StandardConstants
...
public abstract interface StandardConstantsClassTests<SUT extends StandardConstants>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StandardConstants.class!",
                   StandardConstants.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleComponent
 * public abstract interface javax.accessibility.AccessibleComponent}.
 *
...
public abstract interface AccessibleComponentClassTests<SUT extends AccessibleComponent>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleComponent.class!",
                   AccessibleComponent.class.isAssignableFrom(sut));
    }

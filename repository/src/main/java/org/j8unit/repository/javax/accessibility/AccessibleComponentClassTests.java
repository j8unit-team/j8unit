 ...
 * javax.accessibility.AccessibleComponent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleComponentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleComponentTests}.
 * </p>
 *
 * @see javax.accessibility.AccessibleComponent interface javax.accessibility.AccessibleComponent (the hereby targeted
 *      class-under-test class)
 * @see AccessibleComponentTests AccessibleComponentTests (The complementary j8unit test interface containing the
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.accessibility.AccessibleComponent.class!",
                   javax.accessibility.AccessibleComponent.class.isAssignableFrom(sut));
    }

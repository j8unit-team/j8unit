 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JTextFieldTests}).
 * </p>
 *
 * <p>
 ...
 * @see JTextFieldTests JTextFieldTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SwingConstantsClassTests<SUT>, org.j8unit.repository.javax.swing.text.JTextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JTextField.class!",
                   javax.swing.JTextField.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JTextField public
...
extends SwingConstantsClassTests<SUT>, JTextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JTextField.class!",
                   JTextField.class.isAssignableFrom(sut));
    }

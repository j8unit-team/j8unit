 ...
 * javax.security.auth.RefreshFailedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RefreshFailedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RefreshFailedExceptionTests}.
 * </p>
 *
 * @see javax.security.auth.RefreshFailedException class javax.security.auth.RefreshFailedException (the hereby targeted
 *      class-under-test class)
 * @see RefreshFailedExceptionTests RefreshFailedExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.auth.RefreshFailedException.class!",
                   javax.security.auth.RefreshFailedException.class.isAssignableFrom(sut));
    }

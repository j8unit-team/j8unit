...
public abstract interface RefreshFailedExceptionClassTests<SUT extends RefreshFailedException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RefreshFailedException.class!",
                   RefreshFailedException.class.isAssignableFrom(sut));
    }

 ...
 * javax.xml.soap.SOAPBodyElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SOAPBodyElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SOAPBodyElementTests}.
 * </p>
 *
 * @see javax.xml.soap.SOAPBodyElement interface javax.xml.soap.SOAPBodyElement (the hereby targeted class-under-test
 *      class)
 * @see SOAPBodyElementTests SOAPBodyElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface SOAPBodyElementClassTests<SUT extends javax.xml.soap.SOAPBodyElement>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.soap.SOAPBodyElement.class!",
                   javax.xml.soap.SOAPBodyElement.class.isAssignableFrom(sut));
    }

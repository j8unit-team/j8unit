 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SOAPBodyElement
...
public abstract interface SOAPBodyElementClassTests<SUT extends SOAPBodyElement>
extends SOAPElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SOAPBodyElement.class!",
                   SOAPBodyElement.class.isAssignableFrom(sut));
    }

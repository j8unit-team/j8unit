 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SaslServer public
 * abstract interface javax.security.sasl.SaslServer}.
 *
...
public abstract interface SaslServerClassTests<SUT extends SaslServer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SaslServer.class!",
                   SaslServer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.security.sasl.SaslServer interface
 * javax.security.sasl.SaslServer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SaslServerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SaslServerTests}.
 * </p>
 *
 * @see javax.security.sasl.SaslServer interface javax.security.sasl.SaslServer (the hereby targeted class-under-test
 *      class)
 * @see SaslServerTests SaslServerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SaslServerClassTests<SUT extends javax.security.sasl.SaslServer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.security.sasl.SaslServer.class!",
                   javax.security.sasl.SaslServer.class.isAssignableFrom(sut));
    }

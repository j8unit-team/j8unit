 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMResult public
...
public abstract interface DOMResultClassTests<SUT extends DOMResult>
extends ResultClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMResult.class!",
                   DOMResult.class.isAssignableFrom(sut));
    }

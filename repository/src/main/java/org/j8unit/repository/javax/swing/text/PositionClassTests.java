 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PositionTests}).
 * </p>
 *
 * <p>
 ...
 * @see PositionTests PositionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.Position.class!",
                   javax.swing.text.Position.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.swing.text.Position.Bias class
     * javax.swing.text.Position$Bias}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link PositionTests.BiasTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * {@link PositionTests.BiasTests}.
     * </p>
     *
     * @see javax.swing.text.Position.Bias class javax.swing.text.Position$Bias (the hereby targeted class-under-test
     *      class)
     * @see PositionTests.BiasTests PositionTests.BiasTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.text.Position.Bias.class!",
                       javax.swing.text.Position.Bias.class.isAssignableFrom(sut));
        }

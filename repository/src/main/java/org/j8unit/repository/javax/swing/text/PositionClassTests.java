 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Position public
...
public abstract interface PositionClassTests<SUT extends Position>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Position.class!",
                   Position.class.isAssignableFrom(sut));
    }
     ...
     * {@link Bias public static final class javax.swing.text.Position$Bias}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Bias.class!",
                              Bias.class.isAssignableFrom(sut));
        }

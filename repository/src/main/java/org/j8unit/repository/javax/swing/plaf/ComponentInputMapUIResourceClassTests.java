...
extends UIResourceClassTests<SUT>, ComponentInputMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentInputMapUIResource.class!",
                   ComponentInputMapUIResource.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JSeparatorTests}).
 * </p>
 *
 * <p>
 ...
 * @see JSeparatorTests JSeparatorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SwingConstantsClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, JComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.JSeparator.class!",
                   javax.swing.JSeparator.class.isAssignableFrom(sut));
    }

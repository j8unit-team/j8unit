 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KerberosKey public
...
public abstract interface KerberosKeyClassTests<SUT extends KerberosKey>
extends org.j8unit.repository.javax.crypto.SecretKeyClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KerberosKey.class!",
                   KerberosKey.class.isAssignableFrom(sut));
    }

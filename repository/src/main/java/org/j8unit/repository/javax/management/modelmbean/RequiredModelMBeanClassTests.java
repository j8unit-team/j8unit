 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RequiredModelMBean
...
extends ModelMBeanClassTests<SUT>, MBeanRegistrationClassTests<SUT>, NotificationEmitterClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RequiredModelMBean.class!",
                   RequiredModelMBean.class.isAssignableFrom(sut));
    }

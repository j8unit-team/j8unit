 ...
 * javax.annotation.processing.SupportedAnnotationTypes}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SupportedAnnotationTypesTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link SupportedAnnotationTypesTests}.
 * </p>
 *
 * @see javax.annotation.processing.SupportedAnnotationTypes interface
 *      javax.annotation.processing.SupportedAnnotationTypes (the hereby targeted class-under-test class)
 * @see SupportedAnnotationTypesTests SupportedAnnotationTypesTests (The complementary j8unit test interface containing
...
public abstract interface SupportedAnnotationTypesClassTests<SUT extends javax.annotation.processing.SupportedAnnotationTypes>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.annotation.processing.SupportedAnnotationTypes.class!",
                   javax.annotation.processing.SupportedAnnotationTypes.class.isAssignableFrom(sut));
    }

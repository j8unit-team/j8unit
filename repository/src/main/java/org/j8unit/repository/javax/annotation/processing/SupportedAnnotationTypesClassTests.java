 ...
 * {@link SupportedAnnotationTypes public abstract @interface javax.annotation.processing.SupportedAnnotationTypes}.
 *
...
public abstract interface SupportedAnnotationTypesClassTests<SUT extends SupportedAnnotationTypes>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SupportedAnnotationTypes.class!",
                   SupportedAnnotationTypes.class.isAssignableFrom(sut));
    }

...
extends RMIConnectionClassTests<SUT>, RemoteStubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIConnectionImpl_Stub.class!",
                   RMIConnectionImpl_Stub.class.isAssignableFrom(sut));
    }

 ...
 * javax.management.remote.rmi.RMIConnectionImpl_Stub}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIConnectionImpl_StubTests}).
 * </p>
 *
 * <p>
 ...
 * @see RMIConnectionImpl_StubTests RMIConnectionImpl_StubTests (The complementary j8unit test interface containing the
...
extends RMIConnectionClassTests<SUT>, org.j8unit.repository.java.rmi.server.RemoteStubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.remote.rmi.RMIConnectionImpl_Stub.class!",
                   javax.management.remote.rmi.RMIConnectionImpl_Stub.class.isAssignableFrom(sut));
    }

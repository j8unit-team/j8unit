 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XPathType public
...
public abstract interface XPathTypeClassTests<SUT extends XPathType>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XPathType.class!",
                   XPathType.class.isAssignableFrom(sut));
    }
     ...
     * {@link Filter public static class javax.xml.crypto.dsig.spec.XPathType$Filter}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

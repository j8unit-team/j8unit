 ...
 * javax.xml.crypto.dsig.spec.XPathType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XPathTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XPathTypeTests}.
 * </p>
 *
 * @see javax.xml.crypto.dsig.spec.XPathType class javax.xml.crypto.dsig.spec.XPathType (the hereby targeted
 *      class-under-test class)
 * @see XPathTypeTests XPathTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.XPathType.class!",
                   javax.xml.crypto.dsig.spec.XPathType.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain javax.xml.crypto.dsig.spec.XPathType.Filter class
     * javax.xml.crypto.dsig.spec.XPathType$Filter}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link XPathTypeTests.FilterTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see XPathTypeTests.FilterTests XPathTypeTests.FilterTests (The complementary j8unit test interface containing
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.xml.crypto.dsig.spec.XPathType.Filter.class!",
                       javax.xml.crypto.dsig.spec.XPathType.Filter.class.isAssignableFrom(sut));
        }

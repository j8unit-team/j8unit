 ...
 * {@link ImageReaderWriterSpiTests}.
 * </p>
 *
 * <p>
...
public abstract interface ImageReaderWriterSpiClassTests<SUT extends ImageReaderWriterSpi>
extends IIOServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageReaderWriterSpi.class!",
                   ImageReaderWriterSpi.class.isAssignableFrom(sut));
    }

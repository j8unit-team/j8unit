 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuElement public
...
public abstract interface MenuElementClassTests<SUT extends MenuElement>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuElement.class!",
                   MenuElement.class.isAssignableFrom(sut));
    }

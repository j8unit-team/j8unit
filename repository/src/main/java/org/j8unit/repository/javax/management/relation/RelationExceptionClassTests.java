 ...
 * javax.management.relation.RelationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RelationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RelationExceptionTests}.
 * </p>
 *
 * @see javax.management.relation.RelationException class javax.management.relation.RelationException (the hereby
 *      targeted class-under-test class)
 * @see RelationExceptionTests RelationExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.javax.management.JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.management.relation.RelationException.class!",
                   javax.management.relation.RelationException.class.isAssignableFrom(sut));
    }

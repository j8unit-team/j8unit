 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RelationException
 * public class javax.management.relation.RelationException}.
 *
...
public abstract interface RelationExceptionClassTests<SUT extends RelationException>
extends JMExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RelationException.class!",
                   RelationException.class.isAssignableFrom(sut));
    }

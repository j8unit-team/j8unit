 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RegisterableService
 * public abstract interface javax.imageio.spi.RegisterableService}.
 *
...
public abstract interface RegisterableServiceClassTests<SUT extends RegisterableService>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RegisterableService.class!",
                   RegisterableService.class.isAssignableFrom(sut));
    }

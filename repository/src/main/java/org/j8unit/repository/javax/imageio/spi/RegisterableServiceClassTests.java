 ...
 * javax.imageio.spi.RegisterableService}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RegisterableServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RegisterableServiceTests}.
 * </p>
 *
 * @see javax.imageio.spi.RegisterableService interface javax.imageio.spi.RegisterableService (the hereby targeted
 *      class-under-test class)
 * @see RegisterableServiceTests RegisterableServiceTests (The complementary j8unit test interface containing the
...
public abstract interface RegisterableServiceClassTests<SUT extends javax.imageio.spi.RegisterableService>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.imageio.spi.RegisterableService.class!",
                   javax.imageio.spi.RegisterableService.class.isAssignableFrom(sut));
    }

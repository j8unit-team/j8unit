 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowSetMetaDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowSetMetaDataTests}.
 * </p>
 *
 * @see javax.sql.RowSetMetaData interface javax.sql.RowSetMetaData (the hereby targeted class-under-test class)
 * @see RowSetMetaDataTests RowSetMetaDataTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.sql.ResultSetMetaDataClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.RowSetMetaData.class!",
                   javax.sql.RowSetMetaData.class.isAssignableFrom(sut));
    }

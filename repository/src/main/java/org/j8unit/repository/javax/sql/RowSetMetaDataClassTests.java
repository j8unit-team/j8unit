...
import org.j8unit.repository.java.sql.ResultSetMetaDataClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RowSetMetaData
...
public abstract interface RowSetMetaDataClassTests<SUT extends RowSetMetaData>
extends ResultSetMetaDataClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RowSetMetaData.class!",
                   RowSetMetaData.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain javax.swing.border.SoftBevelBorder class
 * javax.swing.border.SoftBevelBorder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SoftBevelBorderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SoftBevelBorderTests}.
 * </p>
 *
 * @see javax.swing.border.SoftBevelBorder class javax.swing.border.SoftBevelBorder (the hereby targeted
 *      class-under-test class)
 * @see SoftBevelBorderTests SoftBevelBorderTests (The complementary j8unit test interface containing the instance
...
extends BevelBorderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.border.SoftBevelBorder.class!",
                   javax.swing.border.SoftBevelBorder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SoftBevelBorder
 * public class javax.swing.border.SoftBevelBorder}.
 *
...
public abstract interface SoftBevelBorderClassTests<SUT extends SoftBevelBorder>
extends BevelBorderClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[javax.swing.border.SoftBevelBorder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SoftBevelBorder.class!",
                   SoftBevelBorder.class.isAssignableFrom(sut));
    }

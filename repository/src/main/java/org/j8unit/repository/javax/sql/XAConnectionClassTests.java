 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XAConnection public
 * abstract interface javax.sql.XAConnection}.
 *
...
public abstract interface XAConnectionClassTests<SUT extends XAConnection>
extends PooledConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XAConnection.class!",

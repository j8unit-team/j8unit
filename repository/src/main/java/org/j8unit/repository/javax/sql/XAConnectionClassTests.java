 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XAConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XAConnectionTests}.
 * </p>
 *
 * @see javax.sql.XAConnection interface javax.sql.XAConnection (the hereby targeted class-under-test class)
 * @see XAConnectionTests XAConnectionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XAConnectionClassTests<SUT extends javax.sql.XAConnection>
extends PooledConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.sql.XAConnection.class!",
                   javax.sql.XAConnection.class.isAssignableFrom(sut));
    }

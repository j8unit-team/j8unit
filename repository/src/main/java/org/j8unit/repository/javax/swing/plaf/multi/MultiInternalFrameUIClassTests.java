 ...
 * javax.swing.plaf.multi.MultiInternalFrameUI}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultiInternalFrameUITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultiInternalFrameUITests}
 * .
 * </p>
 *
 * @see javax.swing.plaf.multi.MultiInternalFrameUI class javax.swing.plaf.multi.MultiInternalFrameUI (the hereby
 *      targeted class-under-test class)
 * @see MultiInternalFrameUITests MultiInternalFrameUITests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.javax.swing.plaf.InternalFrameUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.swing.plaf.multi.MultiInternalFrameUI.class!",
                   javax.swing.plaf.multi.MultiInternalFrameUI.class.isAssignableFrom(sut));
    }

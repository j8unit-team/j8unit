...
extends org.j8unit.repository.javax.swing.plaf.InternalFrameUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiInternalFrameUI.class!",
                   MultiInternalFrameUI.class.isAssignableFrom(sut));
    }

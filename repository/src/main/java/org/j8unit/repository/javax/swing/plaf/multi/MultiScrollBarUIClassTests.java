 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultiScrollBarUI
 * public class javax.swing.plaf.multi.MultiScrollBarUI}.
 *
...
public abstract interface MultiScrollBarUIClassTests<SUT extends MultiScrollBarUI>
extends org.j8unit.repository.javax.swing.plaf.ScrollBarUIClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiScrollBarUI.class!",
                   MultiScrollBarUI.class.isAssignableFrom(sut));
    }

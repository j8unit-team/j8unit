 ...
 * javax.lang.model.type.TypeVariable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeVariableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TypeVariableTests}.
 * </p>
 *
 * @see javax.lang.model.type.TypeVariable interface javax.lang.model.type.TypeVariable (the hereby targeted
 *      class-under-test class)
 * @see TypeVariableTests TypeVariableTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TypeVariableClassTests<SUT extends javax.lang.model.type.TypeVariable>
extends ReferenceTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to javax.lang.model.type.TypeVariable.class!",
                   javax.lang.model.type.TypeVariable.class.isAssignableFrom(sut));
    }

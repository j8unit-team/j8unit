 ...
 * java.util.concurrent.ThreadPoolExecutor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadPoolExecutorTests}).
 * </p>
 *
 * <p>
 ...
 * @see ThreadPoolExecutorTests ThreadPoolExecutorTests (The complementary j8unit test interface containing the instance
...
extends AbstractExecutorServiceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ThreadPoolExecutor.class!",
                   java.util.concurrent.ThreadPoolExecutor.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.concurrent.ThreadPoolExecutor.CallerRunsPolicy class
     * java.util.concurrent.ThreadPoolExecutor$CallerRunsPolicy}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link ThreadPoolExecutorTests.CallerRunsPolicyTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ThreadPoolExecutorTests.CallerRunsPolicyTests ThreadPoolExecutorTests.CallerRunsPolicyTests (The
    ...
    extends RejectedExecutionHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ThreadPoolExecutor.CallerRunsPolicy.class!",
                       java.util.concurrent.ThreadPoolExecutor.CallerRunsPolicy.class.isAssignableFrom(sut));
        }
     ...
     * java.util.concurrent.ThreadPoolExecutor$DiscardPolicy}, containing all type relevant aspects (e.&thinsp;g.,
     * runtime constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link ThreadPoolExecutorTests.DiscardPolicyTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ThreadPoolExecutorTests.DiscardPolicyTests ThreadPoolExecutorTests.DiscardPolicyTests (The complementary
    ...
    extends RejectedExecutionHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ThreadPoolExecutor.DiscardPolicy.class!",
                       java.util.concurrent.ThreadPoolExecutor.DiscardPolicy.class.isAssignableFrom(sut));
        }
     ...
     * java.util.concurrent.ThreadPoolExecutor$DiscardOldestPolicy}, containing all type relevant aspects (e.&thinsp;g.,
     * runtime constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link ThreadPoolExecutorTests.DiscardOldestPolicyTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ThreadPoolExecutorTests.DiscardOldestPolicyTests ThreadPoolExecutorTests.DiscardOldestPolicyTests (The
     *      complementary j8unit test interface containing the instance relevant test methods)
     *
     * @param SUT
     *            the class' type of the subject-under-test
    ...
    extends RejectedExecutionHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ThreadPoolExecutor.DiscardOldestPolicy.class!",
                       java.util.concurrent.ThreadPoolExecutor.DiscardOldestPolicy.class.isAssignableFrom(sut));
        }
     ...
     * java.util.concurrent.ThreadPoolExecutor$AbortPolicy}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link ThreadPoolExecutorTests.AbortPolicyTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ThreadPoolExecutorTests.AbortPolicyTests ThreadPoolExecutorTests.AbortPolicyTests (The complementary j8unit
    ...
    extends RejectedExecutionHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ThreadPoolExecutor.AbortPolicy.class!",
                       java.util.concurrent.ThreadPoolExecutor.AbortPolicy.class.isAssignableFrom(sut));
        }

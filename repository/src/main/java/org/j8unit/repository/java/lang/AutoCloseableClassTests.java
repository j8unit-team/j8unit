...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain AutoCloseable interface java.lang.AutoCloseable}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AutoCloseableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AutoCloseableTests}.
 * </p>
 *
 * @see AutoCloseable interface java.lang.AutoCloseable (the hereby targeted class-under-test class)
 * @see AutoCloseableTests AutoCloseableTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AutoCloseableClassTests<SUT extends AutoCloseable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AutoCloseable.class!",
                   AutoCloseable.class.isAssignableFrom(sut));
    }

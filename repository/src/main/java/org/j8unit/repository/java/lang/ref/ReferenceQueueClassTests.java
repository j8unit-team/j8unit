 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReferenceQueue
...
public abstract interface ReferenceQueueClassTests<SUT extends ReferenceQueue>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReferenceQueue.class!",
                   ReferenceQueue.class.isAssignableFrom(sut));
    }

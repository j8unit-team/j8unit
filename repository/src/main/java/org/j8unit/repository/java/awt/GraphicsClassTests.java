 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Graphics public
...
public abstract interface GraphicsClassTests<SUT extends Graphics>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Graphics.class!",
                   Graphics.class.isAssignableFrom(sut));
    }

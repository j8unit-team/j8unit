 ...
 * java.security.cert.CertificateFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertificateFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertificateFactoryTests}.
 * </p>
 *
 * @see java.security.cert.CertificateFactory class java.security.cert.CertificateFactory (the hereby targeted
 *      class-under-test class)
 * @see CertificateFactoryTests CertificateFactoryTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateFactory.class!",
                   java.security.cert.CertificateFactory.class.isAssignableFrom(sut));
    }

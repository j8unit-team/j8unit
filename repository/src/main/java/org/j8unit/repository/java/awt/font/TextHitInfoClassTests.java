 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextHitInfo public
 * final class java.awt.font.TextHitInfo}.
 *
...
public abstract interface TextHitInfoClassTests<SUT extends TextHitInfo>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.font.TextHitInfo]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextHitInfo.class!",
                   TextHitInfo.class.isAssignableFrom(sut));
    }

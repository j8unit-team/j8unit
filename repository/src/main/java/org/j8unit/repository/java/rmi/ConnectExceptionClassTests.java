 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ConnectException
 * public class java.rmi.ConnectException}.
 *
...
public abstract interface ConnectExceptionClassTests<SUT extends ConnectException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConnectException.class!",

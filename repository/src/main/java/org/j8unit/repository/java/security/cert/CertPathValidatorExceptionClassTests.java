 ...
 * java.security.cert.CertPathValidatorException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see CertPathValidatorExceptionTests CertPathValidatorExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathValidatorException.class!",
                   java.security.cert.CertPathValidatorException.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.security.cert.CertPathValidatorException.Reason interface
     * java.security.cert.CertPathValidatorException$Reason}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link CertPathValidatorExceptionTests.ReasonTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see CertPathValidatorExceptionTests.ReasonTests CertPathValidatorExceptionTests.ReasonTests (The complementary
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathValidatorException.Reason.class!",
                       java.security.cert.CertPathValidatorException.Reason.class.isAssignableFrom(sut));
        }
     ...
     * java.security.cert.CertPathValidatorException$BasicReason}, containing all type relevant aspects (e.&thinsp;g.,
     * runtime constraints and further type specific requirements). (In addition, the runtime type of this j8unit test
     * interface's generic type is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link CertPathValidatorExceptionTests.BasicReasonTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see CertPathValidatorExceptionTests.BasicReasonTests CertPathValidatorExceptionTests.BasicReasonTests (The
    ...
    extends CertPathValidatorExceptionClassTests.ReasonClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathValidatorException.BasicReason.class!",
                       java.security.cert.CertPathValidatorException.BasicReason.class.isAssignableFrom(sut));
        }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Float class java.lang.Float}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FloatTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see Float class java.lang.Float (the hereby targeted class-under-test class)
 * @see FloatTests FloatTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface FloatClassTests<SUT extends Float>
extends ComparableClassTests<SUT>, NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Float.class!", Float.class.isAssignableFrom(sut));
    }

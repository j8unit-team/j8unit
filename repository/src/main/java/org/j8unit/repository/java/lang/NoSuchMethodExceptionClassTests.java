...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain NoSuchMethodException class java.lang.NoSuchMethodException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchMethodExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link NoSuchMethodExceptionTests}.
 * </p>
 *
 * @see NoSuchMethodException class java.lang.NoSuchMethodException (the hereby targeted class-under-test class)
 * @see NoSuchMethodExceptionTests NoSuchMethodExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface NoSuchMethodExceptionClassTests<SUT extends NoSuchMethodException>
extends ReflectiveOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchMethodException.class!",
                   NoSuchMethodException.class.isAssignableFrom(sut));
    }

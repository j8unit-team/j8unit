...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.RowId interface java.sql.RowId}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowIdTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowIdTests}.
 * </p>
 *
 * @see java.sql.RowId interface java.sql.RowId (the hereby targeted class-under-test class)
 * @see RowIdTests RowIdTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface RowIdClassTests<SUT extends java.sql.RowId>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.RowId.class!",
                   java.sql.RowId.class.isAssignableFrom(sut));
    }

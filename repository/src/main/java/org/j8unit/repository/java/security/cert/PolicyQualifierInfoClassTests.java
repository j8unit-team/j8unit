 ...
 * java.security.cert.PolicyQualifierInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyQualifierInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PolicyQualifierInfoTests}.
 * </p>
 *
 * @see java.security.cert.PolicyQualifierInfo class java.security.cert.PolicyQualifierInfo (the hereby targeted
 *      class-under-test class)
 * @see PolicyQualifierInfoTests PolicyQualifierInfoTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PolicyQualifierInfo.class!",
                   java.security.cert.PolicyQualifierInfo.class.isAssignableFrom(sut));
    }

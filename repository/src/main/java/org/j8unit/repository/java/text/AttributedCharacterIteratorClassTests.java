 ...
 * {@link AttributedCharacterIterator public abstract interface java.text.AttributedCharacterIterator}.
 *
...
extends CharacterIteratorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributedCharacterIterator.class!",
                   AttributedCharacterIterator.class.isAssignableFrom(sut));
    }
     ...
     * {@link Attribute public static class java.text.AttributedCharacterIterator$Attribute}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

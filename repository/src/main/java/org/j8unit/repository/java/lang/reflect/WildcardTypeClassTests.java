...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.WildcardType interface
 * java.lang.reflect.WildcardType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WildcardTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WildcardTypeTests}.
 * </p>
 *
 * @see java.lang.reflect.WildcardType interface java.lang.reflect.WildcardType (the hereby targeted class-under-test
 *      class)
 * @see WildcardTypeTests WildcardTypeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface WildcardTypeClassTests<SUT extends java.lang.reflect.WildcardType>
extends TypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.WildcardType.class!",
                   java.lang.reflect.WildcardType.class.isAssignableFrom(sut));
    }

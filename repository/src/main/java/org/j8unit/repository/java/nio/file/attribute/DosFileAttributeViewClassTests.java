 ...
 * {@link DosFileAttributeView public abstract interface java.nio.file.attribute.DosFileAttributeView}.
 *
...
public abstract interface DosFileAttributeViewClassTests<SUT extends DosFileAttributeView>
extends BasicFileAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DosFileAttributeView.class!",
                   DosFileAttributeView.class.isAssignableFrom(sut));
    }

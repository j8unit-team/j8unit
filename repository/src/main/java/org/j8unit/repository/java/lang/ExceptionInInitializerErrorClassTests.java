...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ExceptionInInitializerError class
 * java.lang.ExceptionInInitializerError}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link ExceptionInInitializerErrorTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ExceptionInInitializerErrorTests ExceptionInInitializerErrorTests (The complementary j8unit test interface
...
public abstract interface ExceptionInInitializerErrorClassTests<SUT extends ExceptionInInitializerError>
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExceptionInInitializerError.class!",
                   ExceptionInInitializerError.class.isAssignableFrom(sut));
    }

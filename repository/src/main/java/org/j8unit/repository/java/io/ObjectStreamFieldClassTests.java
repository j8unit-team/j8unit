 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectStreamFieldTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectStreamFieldTests}.
 * </p>
 *
 * @see java.io.ObjectStreamField class java.io.ObjectStreamField (the hereby targeted class-under-test class)
 * @see ObjectStreamFieldTests ObjectStreamFieldTests (The complementary j8unit test interface containing the instance
...
public abstract interface ObjectStreamFieldClassTests<SUT extends java.io.ObjectStreamField>
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectStreamField.class!",
                   java.io.ObjectStreamField.class.isAssignableFrom(sut));
    }

 ...
 * java.security.cert.CertificateNotYetValidException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CertificateNotYetValidExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.security.cert.CertificateNotYetValidException class java.security.cert.CertificateNotYetValidException (the
 *      hereby targeted class-under-test class)
 * @see CertificateNotYetValidExceptionTests CertificateNotYetValidExceptionTests (The complementary j8unit test
...
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateNotYetValidException.class!",
                   java.security.cert.CertificateNotYetValidException.class.isAssignableFrom(sut));
    }

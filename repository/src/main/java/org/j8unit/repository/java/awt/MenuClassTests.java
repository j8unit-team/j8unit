...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Menu class java.awt.Menu}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuTests}).
 * </p>
 *
 * <p>
 ...
 * @see MenuTests MenuTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface MenuClassTests<SUT extends java.awt.Menu>
extends MenuContainerClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, MenuItemClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Menu.class!",
                   java.awt.Menu.class.isAssignableFrom(sut));
    }

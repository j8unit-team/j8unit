 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleBuffer
 ...
 * {@link org.j8unit.repository.java.nio.DoubleBufferClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface DoubleBufferTests<SUT extends DoubleBuffer>
extends org.j8unit.repository.java.lang.ComparableTests<SUT, DoubleBuffer>, org.j8unit.repository.java.nio.BufferTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_compareTo_DoubleBuffer()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_get_doubleArray()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

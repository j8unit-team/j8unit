...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ArithmeticException class java.lang.ArithmeticException}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ArithmeticExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ArithmeticExceptionTests}.
 * </p>
 *
 * @see ArithmeticException class java.lang.ArithmeticException (the hereby targeted class-under-test class)
 * @see ArithmeticExceptionTests ArithmeticExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ArithmeticExceptionClassTests<SUT extends ArithmeticException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ArithmeticException.class!",

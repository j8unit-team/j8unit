 ...
 * java.util.function.LongToIntFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongToIntFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongToIntFunctionTests}.
 * </p>
 *
 * @see java.util.function.LongToIntFunction interface java.util.function.LongToIntFunction (the hereby targeted
 *      class-under-test class)
 * @see LongToIntFunctionTests LongToIntFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface LongToIntFunctionClassTests<SUT extends java.util.function.LongToIntFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongToIntFunction.class!",
                   java.util.function.LongToIntFunction.class.isAssignableFrom(sut));
    }

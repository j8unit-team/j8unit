 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongToIntFunction
 * public abstract interface java.util.function.LongToIntFunction}.
 *
...
public abstract interface LongToIntFunctionClassTests<SUT extends LongToIntFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongToIntFunction.class!",
                   LongToIntFunction.class.isAssignableFrom(sut));
    }

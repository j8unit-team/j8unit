...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.AnnotatedTypeVariable interface
 * java.lang.reflect.AnnotatedTypeVariable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AnnotatedTypeVariableTests}).
 * </p>
 *
 * <p>
 ...
 * @see AnnotatedTypeVariableTests AnnotatedTypeVariableTests (The complementary j8unit test interface containing the
...
public abstract interface AnnotatedTypeVariableClassTests<SUT extends java.lang.reflect.AnnotatedTypeVariable>
extends AnnotatedTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.AnnotatedTypeVariable.class!",
                   java.lang.reflect.AnnotatedTypeVariable.class.isAssignableFrom(sut));
    }

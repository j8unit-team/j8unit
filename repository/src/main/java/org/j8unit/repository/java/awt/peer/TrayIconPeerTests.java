 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link TrayIconPeer
 * public abstract interface java.awt.peer.TrayIconPeer}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.awt.peer.TrayIconPeerClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface TrayIconPeerTests<SUT extends TrayIconPeer>
extends RepositoryTests<SUT> {
    ...
    public default void test_showPopupMenu_int_int()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_displayMessage_String_String_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_updateImage()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

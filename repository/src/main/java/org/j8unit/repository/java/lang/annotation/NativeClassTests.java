 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Native public
...
public abstract interface NativeClassTests<SUT extends Native>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Native.class!",
                   Native.class.isAssignableFrom(sut));
    }

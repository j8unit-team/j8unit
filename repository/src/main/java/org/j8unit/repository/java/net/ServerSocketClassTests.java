 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServerSocket public
...
public abstract interface ServerSocketClassTests<SUT extends ServerSocket>
extends CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerSocket.class!",
                   ServerSocket.class.isAssignableFrom(sut));
    }

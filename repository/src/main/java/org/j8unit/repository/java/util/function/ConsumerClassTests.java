 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Consumer public
...
public abstract interface ConsumerClassTests<SUT extends Consumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Consumer.class!",
                   Consumer.class.isAssignableFrom(sut));
    }

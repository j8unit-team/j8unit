...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.Consumer interface java.util.function.Consumer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConsumerTests}.
 * </p>
 *
 * @see java.util.function.Consumer interface java.util.function.Consumer (the hereby targeted class-under-test class)
 * @see ConsumerTests ConsumerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ConsumerClassTests<SUT extends java.util.function.Consumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.Consumer.class!",
                   java.util.function.Consumer.class.isAssignableFrom(sut));
    }

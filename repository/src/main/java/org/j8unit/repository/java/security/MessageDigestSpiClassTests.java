 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MessageDigestSpi
...
public abstract interface MessageDigestSpiClassTests<SUT extends MessageDigestSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MessageDigestSpi.class!",
                   MessageDigestSpi.class.isAssignableFrom(sut));
    }

 ...
 * java.rmi.server.UnicastRemoteObject}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnicastRemoteObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnicastRemoteObjectTests}.
 * </p>
 *
 * @see java.rmi.server.UnicastRemoteObject class java.rmi.server.UnicastRemoteObject (the hereby targeted
 *      class-under-test class)
 * @see UnicastRemoteObjectTests UnicastRemoteObjectTests (The complementary j8unit test interface containing the
...
public abstract interface UnicastRemoteObjectClassTests<SUT extends java.rmi.server.UnicastRemoteObject>
extends RemoteServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.UnicastRemoteObject.class!",
                   java.rmi.server.UnicastRemoteObject.class.isAssignableFrom(sut));
    }

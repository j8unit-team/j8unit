 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnicastRemoteObject
...
public abstract interface UnicastRemoteObjectClassTests<SUT extends UnicastRemoteObject>
extends RemoteServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnicastRemoteObject.class!",
                   UnicastRemoteObject.class.isAssignableFrom(sut));
    }

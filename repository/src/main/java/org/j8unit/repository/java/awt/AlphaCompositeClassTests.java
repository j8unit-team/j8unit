 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AlphaComposite
 * public final class java.awt.AlphaComposite}.
 *
...
public abstract interface AlphaCompositeClassTests<SUT extends AlphaComposite>
extends CompositeClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlphaComposite.class!",
                   AlphaComposite.class.isAssignableFrom(sut));
    }

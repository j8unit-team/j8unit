 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputStreamReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InputStreamReaderTests}.
 * </p>
 *
 * @see java.io.InputStreamReader class java.io.InputStreamReader (the hereby targeted class-under-test class)
 * @see InputStreamReaderTests InputStreamReaderTests (The complementary j8unit test interface containing the instance
...
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.InputStreamReader.class!",
                   java.io.InputStreamReader.class.isAssignableFrom(sut));
    }

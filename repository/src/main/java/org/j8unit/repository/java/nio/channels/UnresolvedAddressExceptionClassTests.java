 ...
 * {@link UnresolvedAddressException public class java.nio.channels.UnresolvedAddressException}.
 *
...
public abstract interface UnresolvedAddressExceptionClassTests<SUT extends UnresolvedAddressException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnresolvedAddressException.class!",
                   UnresolvedAddressException.class.isAssignableFrom(sut));
    }

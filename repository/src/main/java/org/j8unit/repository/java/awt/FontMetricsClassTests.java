 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FontMetrics public
...
public abstract interface FontMetricsClassTests<SUT extends FontMetrics>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FontMetrics.class!",
                   FontMetrics.class.isAssignableFrom(sut));
    }

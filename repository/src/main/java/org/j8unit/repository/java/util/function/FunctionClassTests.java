 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Function public
 * abstract interface java.util.function.Function<T,R>}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FunctionTests}.
 * </p>
 *
 * <p>
...
public abstract interface FunctionClassTests<SUT extends Function>
extends RepositoryClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.function.Function]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Function.class!",
                   Function.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.function.Function]

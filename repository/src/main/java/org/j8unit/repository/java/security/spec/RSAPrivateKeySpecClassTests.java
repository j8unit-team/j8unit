 ...
 * java.security.spec.RSAPrivateKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAPrivateKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 * @see RSAPrivateKeySpecTests RSAPrivateKeySpecTests (The complementary j8unit test interface containing the instance
...
extends KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.RSAPrivateKeySpec.class!",
                   java.security.spec.RSAPrivateKeySpec.class.isAssignableFrom(sut));
    }

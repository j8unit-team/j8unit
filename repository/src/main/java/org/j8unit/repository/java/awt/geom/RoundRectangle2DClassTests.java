 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoundRectangle2D
 * public abstract class java.awt.geom.RoundRectangle2D}.
 *
...
extends org.j8unit.repository.java.awt.geom.RectangularShapeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoundRectangle2D.class!",
                   RoundRectangle2D.class.isAssignableFrom(sut));
    }
     ...
     * {@link Float public static class java.awt.geom.RoundRectangle2D$Float}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link Double public static class java.awt.geom.RoundRectangle2D$Double}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

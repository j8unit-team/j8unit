...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain UnsupportedOperationException class
 * java.lang.UnsupportedOperationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link UnsupportedOperationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see UnsupportedOperationException class java.lang.UnsupportedOperationException (the hereby targeted
 *      class-under-test class)
 * @see UnsupportedOperationExceptionTests UnsupportedOperationExceptionTests (The complementary j8unit test interface
...
public abstract interface UnsupportedOperationExceptionClassTests<SUT extends UnsupportedOperationException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedOperationException.class!",
                   UnsupportedOperationException.class.isAssignableFrom(sut));
    }

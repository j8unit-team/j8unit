 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link PipedWriter
 ...
 * {@link org.j8unit.repository.java.io.PipedWriterClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface PipedWriterTests<SUT extends PipedWriter>
extends WriterTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_connect_PipedReader()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECField public
 * abstract interface java.security.spec.ECField}.
 *
...
public abstract interface ECFieldClassTests<SUT extends ECField>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECField.class!",
                   ECField.class.isAssignableFrom(sut));
    }

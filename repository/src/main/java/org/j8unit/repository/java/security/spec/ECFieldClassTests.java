...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.spec.ECField interface java.security.spec.ECField},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECFieldTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECFieldTests}.
 * </p>
 *
 * @see java.security.spec.ECField interface java.security.spec.ECField (the hereby targeted class-under-test class)
 * @see ECFieldTests ECFieldTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ECFieldClassTests<SUT extends java.security.spec.ECField>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECField.class!",
                   java.security.spec.ECField.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Cloneable interface java.lang.Cloneable}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CloneableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CloneableTests}.
 * </p>
 *
 * @see Cloneable interface java.lang.Cloneable (the hereby targeted class-under-test class)
 * @see CloneableTests CloneableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CloneableClassTests<SUT extends Cloneable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Cloneable.class!",

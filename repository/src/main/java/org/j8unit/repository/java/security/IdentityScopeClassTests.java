 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IdentityScopeTests}).
 * </p>
 *
 * <p>
 ...
 * @see IdentityScopeTests IdentityScopeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends IdentityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.IdentityScope.class!",
                   java.security.IdentityScope.class.isAssignableFrom(sut));
    }

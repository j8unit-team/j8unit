 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IdentityScope
...
extends org.j8unit.repository.java.security.IdentityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdentityScope.class!",
                   IdentityScope.class.isAssignableFrom(sut));
    }

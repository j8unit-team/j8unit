 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ElementType public
 * final enum java.lang.annotation.ElementType}.
 *
...
public abstract interface ElementTypeClassTests<SUT extends ElementType>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementType.class!",
                   ElementType.class.isAssignableFrom(sut));
    }

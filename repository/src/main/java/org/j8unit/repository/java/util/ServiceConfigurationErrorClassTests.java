 ...
 * java.util.ServiceConfigurationError}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link ServiceConfigurationErrorTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.ServiceConfigurationError class java.util.ServiceConfigurationError (the hereby targeted
 *      class-under-test class)
 * @see ServiceConfigurationErrorTests ServiceConfigurationErrorTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ServiceConfigurationError.class!",
                   java.util.ServiceConfigurationError.class.isAssignableFrom(sut));
    }

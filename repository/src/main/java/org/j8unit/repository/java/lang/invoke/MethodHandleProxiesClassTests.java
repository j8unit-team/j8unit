 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MethodHandleProxies
 * public class java.lang.invoke.MethodHandleProxies}.
 *
...
public abstract interface MethodHandleProxiesClassTests<SUT extends MethodHandleProxies>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MethodHandleProxies.class!",
                   MethodHandleProxies.class.isAssignableFrom(sut));
    }

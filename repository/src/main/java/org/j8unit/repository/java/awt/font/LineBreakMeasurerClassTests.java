 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LineBreakMeasurer
...
public abstract interface LineBreakMeasurerClassTests<SUT extends LineBreakMeasurer>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineBreakMeasurer.class!",
                   LineBreakMeasurer.class.isAssignableFrom(sut));
    }

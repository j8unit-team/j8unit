...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain UnknownError class java.lang.UnknownError}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnknownErrorTests}.
 * </p>
 *
 * @see UnknownError class java.lang.UnknownError (the hereby targeted class-under-test class)
 * @see UnknownErrorTests UnknownErrorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface UnknownErrorClassTests<SUT extends UnknownError>
extends VirtualMachineErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownError.class!",
                   UnknownError.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ClassCircularityError class java.lang.ClassCircularityError},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassCircularityErrorTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ClassCircularityErrorTests}.
 * </p>
 *
 * @see ClassCircularityError class java.lang.ClassCircularityError (the hereby targeted class-under-test class)
 * @see ClassCircularityErrorTests ClassCircularityErrorTests (The complementary j8unit test interface containing the
...
public abstract interface ClassCircularityErrorClassTests<SUT extends ClassCircularityError>
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassCircularityError.class!",
                   ClassCircularityError.class.isAssignableFrom(sut));
    }

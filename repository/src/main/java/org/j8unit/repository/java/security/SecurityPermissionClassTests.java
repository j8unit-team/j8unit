 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecurityPermission
...
public abstract interface SecurityPermissionClassTests<SUT extends SecurityPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecurityPermission.class!",
                   SecurityPermission.class.isAssignableFrom(sut));
    }

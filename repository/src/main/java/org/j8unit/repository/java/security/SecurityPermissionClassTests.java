 ...
 * java.security.SecurityPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecurityPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecurityPermissionTests}.
 * </p>
 *
 * @see java.security.SecurityPermission class java.security.SecurityPermission (the hereby targeted class-under-test
 *      class)
 * @see SecurityPermissionTests SecurityPermissionTests (The complementary j8unit test interface containing the instance
...
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.SecurityPermission.class!",
                   java.security.SecurityPermission.class.isAssignableFrom(sut));
    }

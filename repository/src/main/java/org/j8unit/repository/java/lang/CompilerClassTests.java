...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Compiler class java.lang.Compiler}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompilerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompilerTests}.
 * </p>
 *
 * @see Compiler class java.lang.Compiler (the hereby targeted class-under-test class)
 * @see CompilerTests CompilerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CompilerClassTests<SUT extends Compiler>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Compiler.class!",

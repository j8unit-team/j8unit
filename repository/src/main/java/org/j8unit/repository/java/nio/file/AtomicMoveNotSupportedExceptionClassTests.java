 ...
 * java.nio.file.AtomicMoveNotSupportedException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AtomicMoveNotSupportedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see AtomicMoveNotSupportedExceptionTests AtomicMoveNotSupportedExceptionTests (The complementary j8unit test
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.AtomicMoveNotSupportedException.class!",
                   java.nio.file.AtomicMoveNotSupportedException.class.isAssignableFrom(sut));
    }

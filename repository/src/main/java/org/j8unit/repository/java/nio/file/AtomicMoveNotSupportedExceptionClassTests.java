...
public abstract interface AtomicMoveNotSupportedExceptionClassTests<SUT extends AtomicMoveNotSupportedException>
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicMoveNotSupportedException.class!",
                   AtomicMoveNotSupportedException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Paths public final
...
public abstract interface PathsClassTests<SUT extends Paths>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Paths.class!", Paths.class.isAssignableFrom(sut));
    }

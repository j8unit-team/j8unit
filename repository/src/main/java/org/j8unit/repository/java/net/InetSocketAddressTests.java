...
/**
 * <p>
 * Test class for {@link java.net.InetSocketAddress class java.net.InetSocketAddress}, containing all instance relevant
 ...
 * @since 0.9.0
 * @see org.j8unit.repository.java.net.InetSocketAddressClassTests
 */
@FunctionalInterface
@Category(J8UnitRepository.class)
public abstract interface InetSocketAddressTests<SUT extends java.net.InetSocketAddress>
extends org.j8unit.repository.java.net.SocketAddressTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_isUnresolved()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

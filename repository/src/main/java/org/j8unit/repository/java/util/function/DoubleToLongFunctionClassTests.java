...
public abstract interface DoubleToLongFunctionClassTests<SUT extends DoubleToLongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleToLongFunction.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.DoubleToLongFunction interface
 * java.util.function.DoubleToLongFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleToLongFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleToLongFunctionTests}
 * .
 * </p>
 *
 * @see java.util.function.DoubleToLongFunction interface java.util.function.DoubleToLongFunction (the hereby targeted
 *      class-under-test class)
 * @see DoubleToLongFunctionTests DoubleToLongFunctionTests (The complementary j8unit test interface containing the
...
public abstract interface DoubleToLongFunctionClassTests<SUT extends java.util.function.DoubleToLongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoubleToLongFunction.class!",
                   java.util.function.DoubleToLongFunction.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.SocketChannel class java.nio.channels.SocketChannel}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketChannelTests}.
 * </p>
 *
 * @see java.nio.channels.SocketChannel class java.nio.channels.SocketChannel (the hereby targeted class-under-test
 *      class)
 * @see SocketChannelTests SocketChannelTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SocketChannelClassTests<SUT extends java.nio.channels.SocketChannel>
extends ByteChannelClassTests<SUT>, ScatteringByteChannelClassTests<SUT>, GatheringByteChannelClassTests<SUT>, NetworkChannelClassTests<SUT>,
org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.SocketChannel.class!",
                   java.nio.channels.SocketChannel.class.isAssignableFrom(sut));
    }

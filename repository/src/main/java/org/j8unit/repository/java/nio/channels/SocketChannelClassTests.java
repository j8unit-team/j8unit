 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketChannel
...
public abstract interface SocketChannelClassTests<SUT extends SocketChannel>
...
AbstractSelectableChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketChannel.class!",

 ...
 * java.net.UnknownServiceException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownServiceExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link UnknownServiceExceptionTests}.
 * </p>
 *
 * @see java.net.UnknownServiceException class java.net.UnknownServiceException (the hereby targeted class-under-test
 *      class)
 * @see UnknownServiceExceptionTests UnknownServiceExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.UnknownServiceException.class!",
                   java.net.UnknownServiceException.class.isAssignableFrom(sut));
    }

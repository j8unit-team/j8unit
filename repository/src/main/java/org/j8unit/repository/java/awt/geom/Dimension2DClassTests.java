 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Dimension2D public
 * abstract class java.awt.geom.Dimension2D}.
 *
...
public abstract interface Dimension2DClassTests<SUT extends Dimension2D>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Dimension2D.class!",
                   Dimension2D.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Modifier public
...
public abstract interface ModifierClassTests<SUT extends Modifier>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.lang.reflect.Modifier]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Modifier.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.RowIdLifetime class java.sql.RowIdLifetime}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RowIdLifetimeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RowIdLifetimeTests}.
 * </p>
 *
 * @see java.sql.RowIdLifetime class java.sql.RowIdLifetime (the hereby targeted class-under-test class)
 * @see RowIdLifetimeTests RowIdLifetimeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RowIdLifetimeClassTests<SUT extends java.sql.RowIdLifetime>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.RowIdLifetime.class!",
                   java.sql.RowIdLifetime.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.BeanInfo interface java.beans.BeanInfo}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BeanInfoTests}.
 * </p>
 *
 * @see java.beans.BeanInfo interface java.beans.BeanInfo (the hereby targeted class-under-test class)
 * @see BeanInfoTests BeanInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BeanInfoClassTests<SUT extends java.beans.BeanInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.BeanInfo.class!",
                   java.beans.BeanInfo.class.isAssignableFrom(sut));
    }

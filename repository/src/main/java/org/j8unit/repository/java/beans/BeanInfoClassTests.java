 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanInfo public
 * abstract interface java.beans.BeanInfo}.
 *
...
public abstract interface BeanInfoClassTests<SUT extends BeanInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanInfo.class!",

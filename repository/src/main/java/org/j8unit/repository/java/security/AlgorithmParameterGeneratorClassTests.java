...
public abstract interface AlgorithmParameterGeneratorClassTests<SUT extends AlgorithmParameterGenerator>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlgorithmParameterGenerator.class!",
                   AlgorithmParameterGenerator.class.isAssignableFrom(sut));
    }

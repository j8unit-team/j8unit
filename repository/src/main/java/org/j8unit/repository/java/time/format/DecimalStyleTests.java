 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link DecimalStyle
 ...
 * {@link org.j8unit.repository.java.time.format.DecimalStyleClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface DecimalStyleTests<SUT extends DecimalStyle>
extends ObjectTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_withNegativeSign_char()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_withPositiveSign_char()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

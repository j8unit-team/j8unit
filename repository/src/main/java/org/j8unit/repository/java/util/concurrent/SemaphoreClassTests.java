...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.Semaphore class java.util.concurrent.Semaphore},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SemaphoreTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SemaphoreTests}.
 * </p>
 *
 * @see java.util.concurrent.Semaphore class java.util.concurrent.Semaphore (the hereby targeted class-under-test class)
 * @see SemaphoreTests SemaphoreTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SemaphoreClassTests<SUT extends java.util.concurrent.Semaphore>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Semaphore.class!",
                   java.util.concurrent.Semaphore.class.isAssignableFrom(sut));
    }

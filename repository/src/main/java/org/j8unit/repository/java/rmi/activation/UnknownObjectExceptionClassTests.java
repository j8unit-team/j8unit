 ...
 * {@link UnknownObjectException public class java.rmi.activation.UnknownObjectException}.
 *
...
extends org.j8unit.repository.java.rmi.activation.ActivationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownObjectException.class!",
                   UnknownObjectException.class.isAssignableFrom(sut));
    }

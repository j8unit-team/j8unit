 ...
 * java.rmi.activation.UnknownObjectException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownObjectExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnknownObjectExceptionTests UnknownObjectExceptionTests (The complementary j8unit test interface containing the
...
extends ActivationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.UnknownObjectException.class!",
                   java.rmi.activation.UnknownObjectException.class.isAssignableFrom(sut));
    }

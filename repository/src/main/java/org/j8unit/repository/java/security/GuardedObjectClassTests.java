 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GuardedObject
...
public abstract interface GuardedObjectClassTests<SUT extends GuardedObject>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GuardedObject.class!",
                   GuardedObject.class.isAssignableFrom(sut));
    }

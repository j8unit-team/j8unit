 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Canvas public class
 * java.awt.Canvas}.
 *
...
public abstract interface CanvasClassTests<SUT extends Canvas>
extends AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Canvas.class!",

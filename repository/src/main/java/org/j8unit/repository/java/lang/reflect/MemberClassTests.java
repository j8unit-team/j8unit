...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.Member interface java.lang.reflect.Member},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MemberTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MemberTests}.
 * </p>
 *
 * @see java.lang.reflect.Member interface java.lang.reflect.Member (the hereby targeted class-under-test class)
 * @see MemberTests MemberTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface MemberClassTests<SUT extends java.lang.reflect.Member>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.Member.class!",
                   java.lang.reflect.Member.class.isAssignableFrom(sut));
    }

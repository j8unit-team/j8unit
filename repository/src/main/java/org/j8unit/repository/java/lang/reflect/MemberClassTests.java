 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Member public
 * abstract interface java.lang.reflect.Member}.
 *
...
public abstract interface MemberClassTests<SUT extends Member>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Member.class!",
                   Member.class.isAssignableFrom(sut));
    }

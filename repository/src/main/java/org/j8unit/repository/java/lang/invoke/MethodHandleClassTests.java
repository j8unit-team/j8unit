 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MethodHandle public
 * abstract class java.lang.invoke.MethodHandle}.
 *
...
public abstract interface MethodHandleClassTests<SUT extends MethodHandle>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MethodHandle.class!",
                   MethodHandle.class.isAssignableFrom(sut));
    }

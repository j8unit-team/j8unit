 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DomainCombiner
...
public abstract interface DomainCombinerClassTests<SUT extends DomainCombiner>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DomainCombiner.class!",
                   DomainCombiner.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnnotatedArrayType
 * public abstract interface java.lang.reflect.AnnotatedArrayType}.
 *
...
extends AnnotatedTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotatedArrayType.class!",
                   AnnotatedArrayType.class.isAssignableFrom(sut));
    }

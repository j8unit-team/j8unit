 ...
 * java.lang.reflect.AnnotatedArrayType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AnnotatedArrayTypeTests}).
 * </p>
 *
 * <p>
 ...
 * @see AnnotatedArrayTypeTests AnnotatedArrayTypeTests (The complementary j8unit test interface containing the instance
...
public abstract interface AnnotatedArrayTypeClassTests<SUT extends java.lang.reflect.AnnotatedArrayType>
extends AnnotatedTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.AnnotatedArrayType.class!",
                   java.lang.reflect.AnnotatedArrayType.class.isAssignableFrom(sut));
    }

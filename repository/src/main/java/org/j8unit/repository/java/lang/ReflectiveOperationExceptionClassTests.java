...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ReflectiveOperationException class
 * java.lang.ReflectiveOperationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link ReflectiveOperationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see ReflectiveOperationException class java.lang.ReflectiveOperationException (the hereby targeted class-under-test
 *      class)
 * @see ReflectiveOperationExceptionTests ReflectiveOperationExceptionTests (The complementary j8unit test interface
...
public abstract interface ReflectiveOperationExceptionClassTests<SUT extends ReflectiveOperationException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReflectiveOperationException.class!",
                   ReflectiveOperationException.class.isAssignableFrom(sut));
    }

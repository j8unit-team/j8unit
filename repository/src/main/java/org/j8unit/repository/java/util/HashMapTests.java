 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link HashMap public
 ...
 * {@link org.j8unit.repository.java.util.HashMapClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface HashMapTests<SUT extends HashMap<K, V>, K, V>
extends CloneableTests<SUT>, SerializableTests<SUT>, AbstractMapTests<SUT, K, V> {

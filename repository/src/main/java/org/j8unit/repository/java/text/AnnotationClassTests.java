...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.Annotation class java.text.Annotation}, containing all type
...
public abstract interface AnnotationClassTests<SUT extends java.text.Annotation>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.Annotation.class!",
                   java.text.Annotation.class.isAssignableFrom(sut));
    }

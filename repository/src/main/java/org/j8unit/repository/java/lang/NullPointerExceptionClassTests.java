...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain NullPointerException class java.lang.NullPointerException}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NullPointerExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NullPointerExceptionTests}
 * .
 * </p>
 *
 * @see NullPointerException class java.lang.NullPointerException (the hereby targeted class-under-test class)
 * @see NullPointerExceptionTests NullPointerExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface NullPointerExceptionClassTests<SUT extends NullPointerException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NullPointerException.class!",
                   NullPointerException.class.isAssignableFrom(sut));
    }

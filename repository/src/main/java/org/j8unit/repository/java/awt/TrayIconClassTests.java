...
import org.j8unit.repository.java.awt.TrayIconTests.MessageTypeTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TrayIcon public
...
public abstract interface TrayIconClassTests<SUT extends TrayIcon>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TrayIcon.class!",
                   TrayIcon.class.isAssignableFrom(sut));
    }
     ...
     * {@link MessageType public static final enum java.awt.TrayIcon$MessageType}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link MessageTypeTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface MessageTypeClassTests<SUT extends MessageType>
    extends EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MessageType.class!",
                              MessageType.class.isAssignableFrom(sut));
        }

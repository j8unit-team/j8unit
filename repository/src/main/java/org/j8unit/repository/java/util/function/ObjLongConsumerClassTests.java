...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.ObjLongConsumer interface
 * java.util.function.ObjLongConsumer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjLongConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjLongConsumerTests}.
 * </p>
 *
 * @see java.util.function.ObjLongConsumer interface java.util.function.ObjLongConsumer (the hereby targeted
 *      class-under-test class)
 * @see ObjLongConsumerTests ObjLongConsumerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ObjLongConsumerClassTests<SUT extends java.util.function.ObjLongConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ObjLongConsumer.class!",
                   java.util.function.ObjLongConsumer.class.isAssignableFrom(sut));
    }

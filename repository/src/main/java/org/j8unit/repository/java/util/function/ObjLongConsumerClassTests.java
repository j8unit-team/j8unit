 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjLongConsumer
 * public abstract interface java.util.function.ObjLongConsumer<T>}.
 *
...
public abstract interface ObjLongConsumerClassTests<SUT extends ObjLongConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjLongConsumer.class!",
                   ObjLongConsumer.class.isAssignableFrom(sut));
    }

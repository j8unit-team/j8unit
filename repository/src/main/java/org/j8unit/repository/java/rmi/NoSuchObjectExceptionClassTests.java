 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchObjectExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see NoSuchObjectExceptionTests NoSuchObjectExceptionTests (The complementary j8unit test interface containing the
...
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.NoSuchObjectException.class!",
                   java.rmi.NoSuchObjectException.class.isAssignableFrom(sut));
    }

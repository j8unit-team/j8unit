 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MembershipKey
...
public abstract interface MembershipKeyClassTests<SUT extends MembershipKey>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MembershipKey.class!",
                   MembershipKey.class.isAssignableFrom(sut));
    }

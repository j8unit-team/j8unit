...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.MembershipKey class java.nio.channels.MembershipKey}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MembershipKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MembershipKeyTests}.
 * </p>
 *
 * @see java.nio.channels.MembershipKey class java.nio.channels.MembershipKey (the hereby targeted class-under-test
 *      class)
 * @see MembershipKeyTests MembershipKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MembershipKeyClassTests<SUT extends java.nio.channels.MembershipKey>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.MembershipKey.class!",
                   java.nio.channels.MembershipKey.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.Instant class java.time.Instant}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InstantTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InstantTests}.
 * </p>
 *
 * @see java.time.Instant class java.time.Instant (the hereby targeted class-under-test class)
 * @see InstantTests InstantTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.Instant.class!",
                   java.time.Instant.class.isAssignableFrom(sut));
    }

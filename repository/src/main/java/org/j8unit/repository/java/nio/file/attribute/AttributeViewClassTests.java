 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AttributeView
...
public abstract interface AttributeViewClassTests<SUT extends AttributeView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeView.class!",
                   AttributeView.class.isAssignableFrom(sut));
    }

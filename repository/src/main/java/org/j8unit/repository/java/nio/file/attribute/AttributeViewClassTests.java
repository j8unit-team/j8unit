...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.attribute.AttributeView interface
 * java.nio.file.attribute.AttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AttributeViewTests}.
 * </p>
 *
 * @see java.nio.file.attribute.AttributeView interface java.nio.file.attribute.AttributeView (the hereby targeted
 *      class-under-test class)
 * @see AttributeViewTests AttributeViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AttributeViewClassTests<SUT extends java.nio.file.attribute.AttributeView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.AttributeView.class!",
                   java.nio.file.attribute.AttributeView.class.isAssignableFrom(sut));
    }

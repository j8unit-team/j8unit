...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.prefs.NodeChangeEvent#NodeChangeEvent(java.util.prefs.Preferences,
     *             java.util.prefs.Preferences)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_NodeChangeEvent_Preferences_Preferences()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.prefs.NodeChangeEvent sut = null; // = new NodeChangeEvent(java.util.prefs.Preferences,
                                                          // java.util.prefs.Preferences);
    }
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.prefs.NodeChangeEvent#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

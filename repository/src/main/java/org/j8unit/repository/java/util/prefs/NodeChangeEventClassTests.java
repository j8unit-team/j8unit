 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NodeChangeEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NodeChangeEventTests}.
 * </p>
 *
 * @see java.util.prefs.NodeChangeEvent class java.util.prefs.NodeChangeEvent (the hereby targeted class-under-test
 *      class)
 * @see NodeChangeEventTests NodeChangeEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.NodeChangeEvent.class!",
                   java.util.prefs.NodeChangeEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NodeChangeEvent
...
public abstract interface NodeChangeEventClassTests<SUT extends NodeChangeEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NodeChangeEvent.class!",
                   NodeChangeEvent.class.isAssignableFrom(sut));
    }

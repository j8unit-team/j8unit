...
extends VetoableChangeListenerClassTests<SUT>, EventListenerProxyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VetoableChangeListenerProxy.class!",
                   VetoableChangeListenerProxy.class.isAssignableFrom(sut));
    }

 ...
 * java.beans.VetoableChangeListenerProxy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * @see VetoableChangeListenerProxyTests VetoableChangeListenerProxyTests (The complementary j8unit test interface
...
extends VetoableChangeListenerClassTests<SUT>, org.j8unit.repository.java.util.EventListenerProxyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.VetoableChangeListenerProxy.class!",
                   java.beans.VetoableChangeListenerProxy.class.isAssignableFrom(sut));
    }

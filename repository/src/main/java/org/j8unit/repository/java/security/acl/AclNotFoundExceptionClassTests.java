 ...
 * {@link AclNotFoundException public class java.security.acl.AclNotFoundException}.
 *
...
public abstract interface AclNotFoundExceptionClassTests<SUT extends AclNotFoundException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AclNotFoundException.class!",
                   AclNotFoundException.class.isAssignableFrom(sut));
    }

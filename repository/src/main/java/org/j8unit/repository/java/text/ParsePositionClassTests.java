 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParsePosition
...
public abstract interface ParsePositionClassTests<SUT extends ParsePosition>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParsePosition.class!",
                   ParsePosition.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.ParsePosition class java.text.ParsePosition}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParsePositionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParsePositionTests}.
 * </p>
 *
 * @see java.text.ParsePosition class java.text.ParsePosition (the hereby targeted class-under-test class)
 * @see ParsePositionTests ParsePositionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ParsePositionClassTests<SUT extends java.text.ParsePosition>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.ParsePosition.class!",
                   java.text.ParsePosition.class.isAssignableFrom(sut));
    }

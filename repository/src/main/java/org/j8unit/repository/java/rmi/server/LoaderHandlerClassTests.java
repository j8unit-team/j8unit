 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LoaderHandler
...
public abstract interface LoaderHandlerClassTests<SUT extends LoaderHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LoaderHandler.class!",
                   LoaderHandler.class.isAssignableFrom(sut));
    }

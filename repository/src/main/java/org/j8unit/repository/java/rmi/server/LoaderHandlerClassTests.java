 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LoaderHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LoaderHandlerTests}.
 * </p>
 *
 * @see java.rmi.server.LoaderHandler interface java.rmi.server.LoaderHandler (the hereby targeted class-under-test
 *      class)
 * @see LoaderHandlerTests LoaderHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LoaderHandlerClassTests<SUT extends java.rmi.server.LoaderHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.LoaderHandler.class!",
                   java.rmi.server.LoaderHandler.class.isAssignableFrom(sut));
    }

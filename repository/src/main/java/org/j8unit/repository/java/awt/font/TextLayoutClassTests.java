 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextLayout public
 * final class java.awt.font.TextLayout}.
 *
...
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextLayout.class!",
     ...
     * {@link CaretPolicy public static class java.awt.font.TextLayout$CaretPolicy}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

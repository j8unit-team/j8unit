 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Retention public
 * abstract @interface java.lang.annotation.Retention}.
 *
...
public abstract interface RetentionClassTests<SUT extends Retention>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Retention.class!",
                   Retention.class.isAssignableFrom(sut));
    }

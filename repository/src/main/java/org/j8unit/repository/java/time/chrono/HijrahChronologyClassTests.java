 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HijrahChronology
 * public final class java.time.chrono.HijrahChronology}.
 *
...
public abstract interface HijrahChronologyClassTests<SUT extends HijrahChronology>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.time.chrono.AbstractChronologyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HijrahChronology.class!",
                   HijrahChronology.class.isAssignableFrom(sut));
    }

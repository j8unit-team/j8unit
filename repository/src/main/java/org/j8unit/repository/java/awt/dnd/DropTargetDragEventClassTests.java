 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTargetDragEvent
...
public abstract interface DropTargetDragEventClassTests<SUT extends DropTargetDragEvent>
extends DropTargetEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetDragEvent.class!",
                   DropTargetDragEvent.class.isAssignableFrom(sut));
    }

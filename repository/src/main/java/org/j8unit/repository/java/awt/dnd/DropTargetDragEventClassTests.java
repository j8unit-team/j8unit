 ...
 * java.awt.dnd.DropTargetDragEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DropTargetDragEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DropTargetDragEventTests}.
 * </p>
 *
 * @see java.awt.dnd.DropTargetDragEvent class java.awt.dnd.DropTargetDragEvent (the hereby targeted class-under-test
 *      class)
 * @see DropTargetDragEventTests DropTargetDragEventTests (The complementary j8unit test interface containing the
...
extends DropTargetEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DropTargetDragEvent.class!",
                   java.awt.dnd.DropTargetDragEvent.class.isAssignableFrom(sut));
    }

 ...
 * java.util.concurrent.atomic.AtomicMarkableReference}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicMarkableReferenceTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AtomicMarkableReferenceTests}.
 * </p>
 *
 ...
 * @see AtomicMarkableReferenceTests AtomicMarkableReferenceTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicMarkableReference.class!",
                   java.util.concurrent.atomic.AtomicMarkableReference.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MultipleMaster
...
public abstract interface MultipleMasterClassTests<SUT extends MultipleMaster>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultipleMaster.class!",
                   MultipleMaster.class.isAssignableFrom(sut));
    }

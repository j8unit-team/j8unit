...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.font.MultipleMaster interface java.awt.font.MultipleMaster},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MultipleMasterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MultipleMasterTests}.
 * </p>
 *
 * @see java.awt.font.MultipleMaster interface java.awt.font.MultipleMaster (the hereby targeted class-under-test class)
 * @see MultipleMasterTests MultipleMasterTests (The complementary j8unit test interface containing the instance
...
public abstract interface MultipleMasterClassTests<SUT extends java.awt.font.MultipleMaster>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.font.MultipleMaster.class!",
                   java.awt.font.MultipleMaster.class.isAssignableFrom(sut));
    }

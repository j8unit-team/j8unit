...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain RuntimePermission class java.lang.RuntimePermission}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RuntimePermissionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see RuntimePermission class java.lang.RuntimePermission (the hereby targeted class-under-test class)
 * @see RuntimePermissionTests RuntimePermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RuntimePermission.class!",
                   RuntimePermission.class.isAssignableFrom(sut));
    }

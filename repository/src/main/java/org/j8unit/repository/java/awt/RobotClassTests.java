 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Robot public class
 * java.awt.Robot}.
 *
...
public abstract interface RobotClassTests<SUT extends Robot>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Robot]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Robot.class!", Robot.class.isAssignableFrom(sut));
    }

...
public abstract interface DefaultFocusTraversalPolicyClassTests<SUT extends DefaultFocusTraversalPolicy>
extends ContainerOrderFocusTraversalPolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultFocusTraversalPolicy.class!",
                   DefaultFocusTraversalPolicy.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConnectIOExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ConnectIOExceptionTests ConnectIOExceptionTests (The complementary j8unit test interface containing the instance
...
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.ConnectIOException.class!",
                   java.rmi.ConnectIOException.class.isAssignableFrom(sut));
    }

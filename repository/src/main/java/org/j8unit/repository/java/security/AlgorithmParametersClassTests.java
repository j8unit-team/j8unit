 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AlgorithmParameters
...
public abstract interface AlgorithmParametersClassTests<SUT extends AlgorithmParameters>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlgorithmParameters.class!",
                   AlgorithmParameters.class.isAssignableFrom(sut));
    }

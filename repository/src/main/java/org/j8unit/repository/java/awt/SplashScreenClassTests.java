 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SplashScreen public
 * final class java.awt.SplashScreen}.
 *
...
public abstract interface SplashScreenClassTests<SUT extends SplashScreen>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SplashScreen.class!",
                   SplashScreen.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Pack200Tests}).
 * </p>
 *
 * <p>
 ...
 * @see Pack200Tests Pack200Tests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.Pack200.class!",
                   java.util.jar.Pack200.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.jar.Pack200.Unpacker interface
     * java.util.jar.Pack200$Unpacker}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link Pack200Tests.UnpackerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see Pack200Tests.UnpackerTests Pack200Tests.UnpackerTests (The complementary j8unit test interface containing
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.Pack200.Unpacker.class!",
                       java.util.jar.Pack200.Unpacker.class.isAssignableFrom(sut));
        }
     ...
     * java.util.jar.Pack200$Packer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     * further type specific requirements). (In addition, the runtime type of this j8unit test interface's generic type
     * is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see {@link Pack200Tests.PackerTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link Pack200Tests.PackerTests}.
     * </p>
     *
     * @see java.util.jar.Pack200.Packer interface java.util.jar.Pack200$Packer (the hereby targeted class-under-test
     *      class)
     * @see Pack200Tests.PackerTests Pack200Tests.PackerTests (The complementary j8unit test interface containing the
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.Pack200.Packer.class!",
                       java.util.jar.Pack200.Packer.class.isAssignableFrom(sut));
        }

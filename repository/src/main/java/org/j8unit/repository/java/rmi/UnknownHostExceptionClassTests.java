 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownHostExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnknownHostExceptionTests}
 * .
 * </p>
 *
 * @see java.rmi.UnknownHostException class java.rmi.UnknownHostException (the hereby targeted class-under-test class)
 * @see UnknownHostExceptionTests UnknownHostExceptionTests (The complementary j8unit test interface containing the
...
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.UnknownHostException.class!",
                   java.rmi.UnknownHostException.class.isAssignableFrom(sut));
    }

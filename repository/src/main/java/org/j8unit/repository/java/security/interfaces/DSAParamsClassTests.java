 ...
 * java.security.interfaces.DSAParams}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAParamsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAParamsTests}.
 * </p>
 *
 * @see java.security.interfaces.DSAParams interface java.security.interfaces.DSAParams (the hereby targeted
 *      class-under-test class)
 * @see DSAParamsTests DSAParamsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DSAParamsClassTests<SUT extends java.security.interfaces.DSAParams>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.DSAParams.class!",
                   java.security.interfaces.DSAParams.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAParams public
 * abstract interface java.security.interfaces.DSAParams}.
 *
...
public abstract interface DSAParamsClassTests<SUT extends DSAParams>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAParams.class!",
                   DSAParams.class.isAssignableFrom(sut));
    }

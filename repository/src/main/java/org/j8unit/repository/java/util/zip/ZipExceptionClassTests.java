 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZipExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZipExceptionTests}.
 * </p>
 *
 * @see java.util.zip.ZipException class java.util.zip.ZipException (the hereby targeted class-under-test class)
 * @see ZipExceptionTests ZipExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.ZipException.class!",
                   java.util.zip.ZipException.class.isAssignableFrom(sut));
    }

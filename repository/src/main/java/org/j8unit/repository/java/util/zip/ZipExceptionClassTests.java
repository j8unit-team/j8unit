 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZipException public
...
public abstract interface ZipExceptionClassTests<SUT extends ZipException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZipException.class!",
                   ZipException.class.isAssignableFrom(sut));
    }

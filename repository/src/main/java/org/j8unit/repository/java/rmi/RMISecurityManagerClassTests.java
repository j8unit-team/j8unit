 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMISecurityManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMISecurityManagerTests}.
 * </p>
 *
 * @see java.rmi.RMISecurityManager class java.rmi.RMISecurityManager (the hereby targeted class-under-test class)
 * @see RMISecurityManagerTests RMISecurityManagerTests (The complementary j8unit test interface containing the instance
...
public abstract interface RMISecurityManagerClassTests<SUT extends java.rmi.RMISecurityManager>
extends org.j8unit.repository.java.lang.SecurityManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.RMISecurityManager.class!",
                   java.rmi.RMISecurityManager.class.isAssignableFrom(sut));
    }

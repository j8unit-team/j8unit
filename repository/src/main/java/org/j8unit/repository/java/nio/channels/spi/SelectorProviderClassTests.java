...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.spi.SelectorProvider class
 * java.nio.channels.spi.SelectorProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SelectorProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SelectorProviderTests}.
 * </p>
 *
 * @see java.nio.channels.spi.SelectorProvider class java.nio.channels.spi.SelectorProvider (the hereby targeted
 *      class-under-test class)
 * @see SelectorProviderTests SelectorProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface SelectorProviderClassTests<SUT extends java.nio.channels.spi.SelectorProvider>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.spi.SelectorProvider.class!",
                   java.nio.channels.spi.SelectorProvider.class.isAssignableFrom(sut));
    }

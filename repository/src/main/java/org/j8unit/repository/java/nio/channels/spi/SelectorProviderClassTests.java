 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SelectorProvider
...
public abstract interface SelectorProviderClassTests<SUT extends SelectorProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SelectorProvider.class!",
                   SelectorProvider.class.isAssignableFrom(sut));
    }

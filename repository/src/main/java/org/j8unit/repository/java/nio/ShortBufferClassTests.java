...
/**
 * <p>
 * Test class for {@link java.nio.ShortBuffer class java.nio.ShortBuffer}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.nio.ShortBufferTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.nio.BufferClassTests<SUT> {
    ...
    /**
     * <p>
     * Test method for {@link java.nio.ShortBuffer#wrap(short[]) public static java.nio.ShortBuffer
    ...
    @Test
    @Category(Draft.class)
    public default void test_wrap_shortArray()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;

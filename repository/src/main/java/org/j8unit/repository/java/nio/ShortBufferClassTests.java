 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ShortBuffer public
 * abstract class java.nio.ShortBuffer}.
 *
...
public abstract interface ShortBufferClassTests<SUT extends ShortBuffer>
extends ComparableClassTests<SUT>, BufferClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.ShortBuffer]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ShortBuffer.class!",
                   ShortBuffer.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.ShortBuffer]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.ShortBuffer class java.nio.ShortBuffer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShortBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ShortBufferTests}.
 * </p>
 *
 * @see java.nio.ShortBuffer class java.nio.ShortBuffer (the hereby targeted class-under-test class)
 * @see ShortBufferTests ShortBufferTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ShortBufferClassTests<SUT extends java.nio.ShortBuffer>
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.ShortBuffer.class!",
                   java.nio.ShortBuffer.class.isAssignableFrom(sut));
    }

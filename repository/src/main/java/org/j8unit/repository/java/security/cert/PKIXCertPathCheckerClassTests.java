...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.cert.PKIXCertPathChecker class
 * java.security.cert.PKIXCertPathChecker}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PKIXCertPathCheckerTests}).
 * </p>
 *
 * <p>
 ...
 * @see PKIXCertPathCheckerTests PKIXCertPathCheckerTests (The complementary j8unit test interface containing the
...
public abstract interface PKIXCertPathCheckerClassTests<SUT extends java.security.cert.PKIXCertPathChecker>
extends CertPathCheckerClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PKIXCertPathChecker.class!",
                   java.security.cert.PKIXCertPathChecker.class.isAssignableFrom(sut));
    }

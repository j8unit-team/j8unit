 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DosFileAttributes
 * public abstract interface java.nio.file.attribute.DosFileAttributes}.
 *
...
public abstract interface DosFileAttributesClassTests<SUT extends DosFileAttributes>
extends BasicFileAttributesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DosFileAttributes.class!",
                   DosFileAttributes.class.isAssignableFrom(sut));
    }

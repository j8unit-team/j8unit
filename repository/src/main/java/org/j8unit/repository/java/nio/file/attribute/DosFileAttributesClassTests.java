 ...
 * java.nio.file.attribute.DosFileAttributes}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DosFileAttributesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DosFileAttributesTests}.
 * </p>
 *
 * @see java.nio.file.attribute.DosFileAttributes interface java.nio.file.attribute.DosFileAttributes (the hereby
 *      targeted class-under-test class)
 * @see DosFileAttributesTests DosFileAttributesTests (The complementary j8unit test interface containing the instance
...
public abstract interface DosFileAttributesClassTests<SUT extends java.nio.file.attribute.DosFileAttributes>
extends BasicFileAttributesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.DosFileAttributes.class!",
                   java.nio.file.attribute.DosFileAttributes.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Target public
 * abstract @interface java.lang.annotation.Target}.
 *
...
public abstract interface TargetClassTests<SUT extends Target>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Target.class!",
                   Target.class.isAssignableFrom(sut));
    }

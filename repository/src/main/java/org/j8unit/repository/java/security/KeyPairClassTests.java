 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyPair public
 * final class java.security.KeyPair}.
 *
...
public abstract interface KeyPairClassTests<SUT extends KeyPair>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyPair.class!",
                   KeyPair.class.isAssignableFrom(sut));
    }

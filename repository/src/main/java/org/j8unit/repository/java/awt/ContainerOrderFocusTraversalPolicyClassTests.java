 ...
 * {@link ContainerOrderFocusTraversalPolicy public class java.awt.ContainerOrderFocusTraversalPolicy}.
 *
...
public abstract interface ContainerOrderFocusTraversalPolicyClassTests<SUT extends ContainerOrderFocusTraversalPolicy>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.awt.FocusTraversalPolicyClassTests<SUT> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.ContainerOrderFocusTraversalPolicy]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContainerOrderFocusTraversalPolicy.class!",
                   ContainerOrderFocusTraversalPolicy.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain AssertionError class java.lang.AssertionError}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AssertionErrorTests}).
 * </p>
 *
 * <p>
 ...
 * @see AssertionErrorTests AssertionErrorTests (The complementary j8unit test interface containing the instance
...
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AssertionError.class!",
                   AssertionError.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.RenderedImage interface java.awt.image.RenderedImage},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RenderedImageTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RenderedImageTests}.
 * </p>
 *
 * @see java.awt.image.RenderedImage interface java.awt.image.RenderedImage (the hereby targeted class-under-test class)
 * @see RenderedImageTests RenderedImageTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RenderedImageClassTests<SUT extends java.awt.image.RenderedImage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.RenderedImage.class!",
                   java.awt.image.RenderedImage.class.isAssignableFrom(sut));
    }

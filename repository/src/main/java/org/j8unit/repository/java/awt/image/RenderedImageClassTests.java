 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RenderedImage
 * public abstract interface java.awt.image.RenderedImage}.
 *
...
public abstract interface RenderedImageClassTests<SUT extends RenderedImage>
extends RepositoryClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.RenderedImage]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RenderedImage.class!",
                   RenderedImage.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.image.RenderedImage]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.awt.image.RenderedImage]

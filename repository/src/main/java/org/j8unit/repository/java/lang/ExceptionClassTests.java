...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Exception class java.lang.Exception}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExceptionTests}.
 * </p>
 *
 * @see Exception class java.lang.Exception (the hereby targeted class-under-test class)
 * @see ExceptionTests ExceptionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ExceptionClassTests<SUT extends Exception>
extends ThrowableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Exception.class!",
                   Exception.class.isAssignableFrom(sut));
    }

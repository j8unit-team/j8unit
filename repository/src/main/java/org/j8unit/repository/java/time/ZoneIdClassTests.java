 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZoneId public
 * abstract class java.time.ZoneId}.
 *
...
public abstract interface ZoneIdClassTests<SUT extends ZoneId>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZoneId.class!",
                   ZoneId.class.isAssignableFrom(sut));
    }

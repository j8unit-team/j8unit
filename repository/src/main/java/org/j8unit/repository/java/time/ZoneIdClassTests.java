...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.ZoneId class java.time.ZoneId}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZoneIdTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZoneIdTests}.
 * </p>
 *
 * @see java.time.ZoneId class java.time.ZoneId (the hereby targeted class-under-test class)
 * @see ZoneIdTests ZoneIdTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.ZoneId.class!",
                   java.time.ZoneId.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilterInputStream
...
public abstract interface FilterInputStreamClassTests<SUT extends FilterInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilterInputStream.class!",
                   FilterInputStream.class.isAssignableFrom(sut));
    }

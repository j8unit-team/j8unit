...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.FilterInputStream class java.io.FilterInputStream}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilterInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilterInputStreamTests}.
 * </p>
 *
 * @see java.io.FilterInputStream class java.io.FilterInputStream (the hereby targeted class-under-test class)
 * @see FilterInputStreamTests FilterInputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface FilterInputStreamClassTests<SUT extends java.io.FilterInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FilterInputStream.class!",
                   java.io.FilterInputStream.class.isAssignableFrom(sut));
    }

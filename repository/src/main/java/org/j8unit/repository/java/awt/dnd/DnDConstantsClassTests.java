 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DnDConstants public
 * final class java.awt.dnd.DnDConstants}.
 *
...
public abstract interface DnDConstantsClassTests<SUT extends DnDConstants>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DnDConstants.class!",
                   DnDConstants.class.isAssignableFrom(sut));
    }

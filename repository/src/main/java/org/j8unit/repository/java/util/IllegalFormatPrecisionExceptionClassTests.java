 ...
 * java.util.IllegalFormatPrecisionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link IllegalFormatPrecisionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalFormatPrecisionExceptionTests IllegalFormatPrecisionExceptionTests (The complementary j8unit test
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IllegalFormatPrecisionException.class!",
                   java.util.IllegalFormatPrecisionException.class.isAssignableFrom(sut));
    }

...
public abstract interface IllegalFormatPrecisionExceptionClassTests<SUT extends IllegalFormatPrecisionException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalFormatPrecisionException.class!",
                   IllegalFormatPrecisionException.class.isAssignableFrom(sut));
    }

...
public abstract interface MalformedParametersExceptionClassTests<SUT extends MalformedParametersException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MalformedParametersException.class!",
                   MalformedParametersException.class.isAssignableFrom(sut));
    }

 ...
 * {@link NotYetBoundException public class java.nio.channels.NotYetBoundException}.
 *
...
public abstract interface NotYetBoundExceptionClassTests<SUT extends NotYetBoundException>
extends IllegalStateExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.NotYetBoundException]
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotYetBoundException.class!",
                   NotYetBoundException.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.NotYetBoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotYetBoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotYetBoundExceptionTests}
 * .
 * </p>
 *
 * @see java.nio.channels.NotYetBoundException class java.nio.channels.NotYetBoundException (the hereby targeted
 *      class-under-test class)
 * @see NotYetBoundExceptionTests NotYetBoundExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.NotYetBoundException.class!",
                   java.nio.channels.NotYetBoundException.class.isAssignableFrom(sut));
    }

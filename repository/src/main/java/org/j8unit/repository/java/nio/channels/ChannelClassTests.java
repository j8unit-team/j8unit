 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Channel public
...
public abstract interface ChannelClassTests<SUT extends Channel>
extends CloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Channel.class!",
                   Channel.class.isAssignableFrom(sut));
    }

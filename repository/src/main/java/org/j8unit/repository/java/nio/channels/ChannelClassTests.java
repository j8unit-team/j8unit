...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.Channel interface java.nio.channels.Channel},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChannelTests}.
 * </p>
 *
 * @see java.nio.channels.Channel interface java.nio.channels.Channel (the hereby targeted class-under-test class)
 * @see ChannelTests ChannelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ChannelClassTests<SUT extends java.nio.channels.Channel>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.Channel.class!",
                   java.nio.channels.Channel.class.isAssignableFrom(sut));
    }

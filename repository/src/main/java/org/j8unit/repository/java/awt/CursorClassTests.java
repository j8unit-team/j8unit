 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Cursor public class
 * java.awt.Cursor}.
 *
...
public abstract interface CursorClassTests<SUT extends Cursor>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Cursor]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Cursor.class!",
                   Cursor.class.isAssignableFrom(sut));
    }

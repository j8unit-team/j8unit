 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PosixFilePermission
 * public final enum java.nio.file.attribute.PosixFilePermission}.
 *
...
public abstract interface PosixFilePermissionClassTests<SUT extends PosixFilePermission>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PosixFilePermission.class!",
                   PosixFilePermission.class.isAssignableFrom(sut));
    }

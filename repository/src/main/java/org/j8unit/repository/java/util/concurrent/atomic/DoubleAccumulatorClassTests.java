 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleAccumulator
...
public abstract interface DoubleAccumulatorClassTests<SUT extends DoubleAccumulator>
extends NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleAccumulator.class!",
                   DoubleAccumulator.class.isAssignableFrom(sut));
    }

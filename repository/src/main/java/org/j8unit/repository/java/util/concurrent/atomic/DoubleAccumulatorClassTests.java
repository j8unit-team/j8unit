 ...
 * java.util.concurrent.atomic.DoubleAccumulator}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleAccumulatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleAccumulatorTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.DoubleAccumulator class java.util.concurrent.atomic.DoubleAccumulator (the hereby
 *      targeted class-under-test class)
 * @see DoubleAccumulatorTests DoubleAccumulatorTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.DoubleAccumulator.class!",
                   java.util.concurrent.atomic.DoubleAccumulator.class.isAssignableFrom(sut));
    }

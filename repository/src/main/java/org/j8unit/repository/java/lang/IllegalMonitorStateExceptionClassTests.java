...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IllegalMonitorStateException class
 * java.lang.IllegalMonitorStateException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IllegalMonitorStateExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see IllegalMonitorStateExceptionTests IllegalMonitorStateExceptionTests (The complementary j8unit test interface
...
public abstract interface IllegalMonitorStateExceptionClassTests<SUT extends IllegalMonitorStateException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalMonitorStateException.class!",
                   IllegalMonitorStateException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Objects public
 * final class java.util.Objects}.
 *
...
public abstract interface ObjectsClassTests<SUT extends Objects>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.Objects]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Objects.class!",
                   Objects.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.Objects]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Objects class java.util.Objects}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectsTests}.
 * </p>
 *
 * @see java.util.Objects class java.util.Objects (the hereby targeted class-under-test class)
 * @see ObjectsTests ObjectsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Objects.class!",
                   java.util.Objects.class.isAssignableFrom(sut));
    }

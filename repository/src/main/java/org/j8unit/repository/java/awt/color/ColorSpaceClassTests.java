 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ColorSpace public
 * abstract class java.awt.color.ColorSpace}.
 *
...
public abstract interface ColorSpaceClassTests<SUT extends ColorSpace>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorSpace.class!",
                   ColorSpace.class.isAssignableFrom(sut));
    }

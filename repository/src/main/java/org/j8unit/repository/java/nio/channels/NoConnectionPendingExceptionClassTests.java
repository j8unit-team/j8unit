...
import org.j8unit.repository.java.lang.IllegalStateExceptionClassTests;
 ...
 * {@link NoConnectionPendingException public class java.nio.channels.NoConnectionPendingException}.
 *
...
public abstract interface NoConnectionPendingExceptionClassTests<SUT extends NoConnectionPendingException>
extends IllegalStateExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.NoConnectionPendingException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoConnectionPendingException.class!",
                   NoConnectionPendingException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.channels.NoConnectionPendingException]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.nio.channels.NoConnectionPendingException]

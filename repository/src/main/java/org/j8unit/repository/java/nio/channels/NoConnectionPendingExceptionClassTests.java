 ...
 * java.nio.channels.NoConnectionPendingException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link NoConnectionPendingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.channels.NoConnectionPendingException class java.nio.channels.NoConnectionPendingException (the hereby
 *      targeted class-under-test class)
 * @see NoConnectionPendingExceptionTests NoConnectionPendingExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.NoConnectionPendingException.class!",
                   java.nio.channels.NoConnectionPendingException.class.isAssignableFrom(sut));
    }

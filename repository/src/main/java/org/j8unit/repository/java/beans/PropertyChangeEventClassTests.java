...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.PropertyChangeEvent class java.beans.PropertyChangeEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyChangeEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PropertyChangeEventTests}.
 * </p>
 *
 * @see java.beans.PropertyChangeEvent class java.beans.PropertyChangeEvent (the hereby targeted class-under-test class)
 * @see PropertyChangeEventTests PropertyChangeEventTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyChangeEvent.class!",
                   java.beans.PropertyChangeEvent.class.isAssignableFrom(sut));
    }

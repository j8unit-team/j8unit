 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PropertyChangeEvent
...
public abstract interface PropertyChangeEventClassTests<SUT extends PropertyChangeEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyChangeEvent.class!",

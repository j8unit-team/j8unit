 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PKCS8EncodedKeySpec
...
extends EncodedKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKCS8EncodedKeySpec.class!",
                   PKCS8EncodedKeySpec.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.spec.PKCS8EncodedKeySpec class
 * java.security.spec.PKCS8EncodedKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PKCS8EncodedKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 * @see PKCS8EncodedKeySpecTests PKCS8EncodedKeySpecTests (The complementary j8unit test interface containing the
...
public abstract interface PKCS8EncodedKeySpecClassTests<SUT extends java.security.spec.PKCS8EncodedKeySpec>
extends EncodedKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.PKCS8EncodedKeySpec.class!",
                   java.security.spec.PKCS8EncodedKeySpec.class.isAssignableFrom(sut));
    }

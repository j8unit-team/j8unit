 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Toolkit public
...
public abstract interface ToolkitClassTests<SUT extends Toolkit>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Toolkit]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Toolkit.class!",
                   Toolkit.class.isAssignableFrom(sut));
    }

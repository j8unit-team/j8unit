 ...
 * java.util.IllegalFormatConversionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link IllegalFormatConversionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalFormatConversionExceptionTests IllegalFormatConversionExceptionTests (The complementary j8unit test
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IllegalFormatConversionException.class!",
                   java.util.IllegalFormatConversionException.class.isAssignableFrom(sut));
    }

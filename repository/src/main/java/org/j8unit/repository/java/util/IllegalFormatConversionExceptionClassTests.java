 ...
 * {@link IllegalFormatConversionException public class java.util.IllegalFormatConversionException}.
 *
...
public abstract interface IllegalFormatConversionExceptionClassTests<SUT extends IllegalFormatConversionException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalFormatConversionException.class!",

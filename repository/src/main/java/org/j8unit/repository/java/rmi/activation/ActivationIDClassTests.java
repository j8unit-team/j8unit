 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActivationID public
...
public abstract interface ActivationIDClassTests<SUT extends ActivationID>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationID.class!",
                   ActivationID.class.isAssignableFrom(sut));
    }

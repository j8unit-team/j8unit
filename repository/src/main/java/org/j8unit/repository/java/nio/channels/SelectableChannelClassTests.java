...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.SelectableChannel class
 * java.nio.channels.SelectableChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SelectableChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SelectableChannelTests}.
 * </p>
 *
 * @see java.nio.channels.SelectableChannel class java.nio.channels.SelectableChannel (the hereby targeted
 *      class-under-test class)
 * @see SelectableChannelTests SelectableChannelTests (The complementary j8unit test interface containing the instance
...
public abstract interface SelectableChannelClassTests<SUT extends java.nio.channels.SelectableChannel>
extends ChannelClassTests<SUT>, org.j8unit.repository.java.nio.channels.spi.AbstractInterruptibleChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.SelectableChannel.class!",
                   java.nio.channels.SelectableChannel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SelectableChannel
...
public abstract interface SelectableChannelClassTests<SUT extends SelectableChannel>
extends org.j8unit.repository.java.nio.channels.spi.AbstractInterruptibleChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SelectableChannel.class!",
                   SelectableChannel.class.isAssignableFrom(sut));
    }

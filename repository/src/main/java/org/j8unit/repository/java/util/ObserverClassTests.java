...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Observer interface java.util.Observer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObserverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObserverTests}.
 * </p>
 *
 * @see java.util.Observer interface java.util.Observer (the hereby targeted class-under-test class)
 * @see ObserverTests ObserverTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Observer.class!",
                   java.util.Observer.class.isAssignableFrom(sut));
    }

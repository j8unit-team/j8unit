 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Observer public
...
public abstract interface ObserverClassTests<SUT extends Observer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Observer.class!",
                   Observer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SerializedLambda
 * public final class java.lang.invoke.SerializedLambda}.
 *
...
public abstract interface SerializedLambdaClassTests<SUT extends SerializedLambda>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerializedLambda.class!",
                   SerializedLambda.class.isAssignableFrom(sut));
    }

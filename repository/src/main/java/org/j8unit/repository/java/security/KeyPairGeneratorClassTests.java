 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyPairGenerator
...
public abstract interface KeyPairGeneratorClassTests<SUT extends KeyPairGenerator>
extends KeyPairGeneratorSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyPairGenerator.class!",
                   KeyPairGenerator.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyPairGeneratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyPairGeneratorTests}.
 * </p>
 *
 * @see java.security.KeyPairGenerator class java.security.KeyPairGenerator (the hereby targeted class-under-test class)
 * @see KeyPairGeneratorTests KeyPairGeneratorTests (The complementary j8unit test interface containing the instance
...
extends KeyPairGeneratorSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.KeyPairGenerator.class!",
                   java.security.KeyPairGenerator.class.isAssignableFrom(sut));
    }

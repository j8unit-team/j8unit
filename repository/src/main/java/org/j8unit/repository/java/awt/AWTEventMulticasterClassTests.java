 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AWTEventMulticasterTests}).
 * </p>
 *
 * <p>
 ...
 * @see AWTEventMulticasterTests AWTEventMulticasterTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.awt.event.MouseWheelListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.AWTEventMulticaster.class!",
                   java.awt.AWTEventMulticaster.class.isAssignableFrom(sut));
    }

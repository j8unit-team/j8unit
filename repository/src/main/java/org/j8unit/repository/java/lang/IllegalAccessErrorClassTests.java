...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IllegalAccessError class java.lang.IllegalAccessError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IllegalAccessErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IllegalAccessErrorTests}.
 * </p>
 *
 * @see IllegalAccessError class java.lang.IllegalAccessError (the hereby targeted class-under-test class)
 * @see IllegalAccessErrorTests IllegalAccessErrorTests (The complementary j8unit test interface containing the instance
...
public abstract interface IllegalAccessErrorClassTests<SUT extends IllegalAccessError>
extends IncompatibleClassChangeErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalAccessError.class!",
                   IllegalAccessError.class.isAssignableFrom(sut));
    }

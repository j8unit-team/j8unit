 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LogRecordTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LogRecordTests}.
 * </p>
 *
 * @see java.util.logging.LogRecord class java.util.logging.LogRecord (the hereby targeted class-under-test class)
 * @see LogRecordTests LogRecordTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.LogRecord.class!",
                   java.util.logging.LogRecord.class.isAssignableFrom(sut));
    }

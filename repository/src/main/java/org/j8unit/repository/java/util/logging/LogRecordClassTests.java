 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LogRecord public
...
public abstract interface LogRecordClassTests<SUT extends LogRecord>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LogRecord.class!",
                   LogRecord.class.isAssignableFrom(sut));
    }

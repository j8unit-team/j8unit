...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain NoSuchFieldException class java.lang.NoSuchFieldException}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchFieldExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NoSuchFieldExceptionTests}
 * .
 * </p>
 *
 * @see NoSuchFieldException class java.lang.NoSuchFieldException (the hereby targeted class-under-test class)
 * @see NoSuchFieldExceptionTests NoSuchFieldExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface NoSuchFieldExceptionClassTests<SUT extends NoSuchFieldException>
extends ReflectiveOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchFieldException.class!",
                   NoSuchFieldException.class.isAssignableFrom(sut));
    }

 ...
 * {@link IllegalClassFormatException public class java.lang.instrument.IllegalClassFormatException}.
 *
...
public abstract interface IllegalClassFormatExceptionClassTests<SUT extends IllegalClassFormatException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalClassFormatException.class!",
                   IllegalClassFormatException.class.isAssignableFrom(sut));
    }

 ...
 * java.lang.reflect.InvocationTargetException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see InvocationTargetExceptionTests InvocationTargetExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.ReflectiveOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.InvocationTargetException.class!",
                   java.lang.reflect.InvocationTargetException.class.isAssignableFrom(sut));
    }

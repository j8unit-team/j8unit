 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProtocolExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ProtocolExceptionTests ProtocolExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ProtocolExceptionClassTests<SUT extends java.net.ProtocolException>
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.ProtocolException.class!",
                   java.net.ProtocolException.class.isAssignableFrom(sut));
    }

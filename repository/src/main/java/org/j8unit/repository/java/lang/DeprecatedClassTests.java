...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Deprecated interface java.lang.Deprecated}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DeprecatedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DeprecatedTests}.
 * </p>
 *
 * @see Deprecated interface java.lang.Deprecated (the hereby targeted class-under-test class)
 * @see DeprecatedTests DeprecatedTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DeprecatedClassTests<SUT extends Deprecated>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Deprecated.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Dialog class java.awt.Dialog}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DialogTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.Dialog class java.awt.Dialog (the hereby targeted class-under-test class)
 * @see DialogTests DialogTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends WindowClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Dialog.class!",
                   java.awt.Dialog.class.isAssignableFrom(sut));
    }
     ...
     * {@link DialogTests.ModalityTypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.awt.Dialog.ModalityType class java.awt.Dialog$ModalityType (the hereby targeted class-under-test class)
     * @see DialogTests.ModalityTypeTests DialogTests.ModalityTypeTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Dialog.ModalityType.class!",
                       java.awt.Dialog.ModalityType.class.isAssignableFrom(sut));
        }
     ...
     * java.awt.Dialog$ModalExclusionType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link DialogTests.ModalExclusionTypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.awt.Dialog.ModalExclusionType class java.awt.Dialog$ModalExclusionType (the hereby targeted
     *      class-under-test class)
     * @see DialogTests.ModalExclusionTypeTests DialogTests.ModalExclusionTypeTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Dialog.ModalExclusionType.class!",
                       java.awt.Dialog.ModalExclusionType.class.isAssignableFrom(sut));
        }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain StackTraceElement class java.lang.StackTraceElement}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StackTraceElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StackTraceElementTests}.
 * </p>
 *
 * @see StackTraceElement class java.lang.StackTraceElement (the hereby targeted class-under-test class)
 * @see StackTraceElementTests StackTraceElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface StackTraceElementClassTests<SUT extends StackTraceElement>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StackTraceElement.class!",
                   StackTraceElement.class.isAssignableFrom(sut));
    }

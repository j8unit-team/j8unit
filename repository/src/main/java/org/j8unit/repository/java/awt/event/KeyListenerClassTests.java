 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyListener public
 * abstract interface java.awt.event.KeyListener}.
 *
...
public abstract interface KeyListenerClassTests<SUT extends KeyListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyListener.class!",
                   KeyListener.class.isAssignableFrom(sut));
    }

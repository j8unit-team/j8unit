 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyListenerTests}.
 * </p>
 *
 * @see java.awt.event.KeyListener interface java.awt.event.KeyListener (the hereby targeted class-under-test class)
 * @see KeyListenerTests KeyListenerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeyListenerClassTests<SUT extends java.awt.event.KeyListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.KeyListener.class!",
                   java.awt.event.KeyListener.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.dnd.peer.DragSourceContextPeer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragSourceContextPeerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link DragSourceContextPeerTests}.
 * </p>
 *
 * @see java.awt.dnd.peer.DragSourceContextPeer interface java.awt.dnd.peer.DragSourceContextPeer (the hereby targeted
 *      class-under-test class)
 * @see DragSourceContextPeerTests DragSourceContextPeerTests (The complementary j8unit test interface containing the
...
public abstract interface DragSourceContextPeerClassTests<SUT extends java.awt.dnd.peer.DragSourceContextPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.peer.DragSourceContextPeer.class!",
                   java.awt.dnd.peer.DragSourceContextPeer.class.isAssignableFrom(sut));
    }

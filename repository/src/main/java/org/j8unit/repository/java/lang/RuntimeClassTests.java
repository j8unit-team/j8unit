...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Runtime class java.lang.Runtime}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RuntimeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RuntimeTests}.
 * </p>
 *
 * @see Runtime class java.lang.Runtime (the hereby targeted class-under-test class)
 * @see RuntimeTests RuntimeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RuntimeClassTests<SUT extends Runtime>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Runtime.class!",
                   Runtime.class.isAssignableFrom(sut));
    }

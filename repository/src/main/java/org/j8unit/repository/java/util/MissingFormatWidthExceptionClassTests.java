 ...
 * java.util.MissingFormatWidthException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link MissingFormatWidthExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see MissingFormatWidthExceptionTests MissingFormatWidthExceptionTests (The complementary j8unit test interface
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.MissingFormatWidthException.class!",
                   java.util.MissingFormatWidthException.class.isAssignableFrom(sut));
    }

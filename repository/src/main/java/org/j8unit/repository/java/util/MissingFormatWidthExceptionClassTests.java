 ...
 * {@link MissingFormatWidthException public class java.util.MissingFormatWidthException}.
 *
...
public abstract interface MissingFormatWidthExceptionClassTests<SUT extends MissingFormatWidthException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MissingFormatWidthException.class!",
                   MissingFormatWidthException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.MissingFormatWidthException]

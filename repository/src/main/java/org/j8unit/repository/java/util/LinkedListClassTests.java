 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkedList public
...
public abstract interface LinkedListClassTests<SUT extends LinkedList>
extends org.j8unit.repository.java.util.DequeClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>,
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractSequentialListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkedList.class!",
                   LinkedList.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.util.LinkedList class java.util.LinkedList}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.util.LinkedListTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.util.AbstractSequentialListClassTests<SUT, E> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.util.LinkedList<E>> sut = createNewSUT();

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.LinkedList class java.util.LinkedList}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkedListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkedListTests}.
 * </p>
 *
 * @see java.util.LinkedList class java.util.LinkedList (the hereby targeted class-under-test class)
 * @see LinkedListTests LinkedListTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ListClassTests<SUT>, DequeClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>,
org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractSequentialListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.LinkedList.class!",
                   java.util.LinkedList.class.isAssignableFrom(sut));
    }

 ...
 * java.util.function.LongUnaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongUnaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongUnaryOperatorTests}.
 * </p>
 *
 * @see java.util.function.LongUnaryOperator interface java.util.function.LongUnaryOperator (the hereby targeted
 *      class-under-test class)
 * @see LongUnaryOperatorTests LongUnaryOperatorTests (The complementary j8unit test interface containing the instance
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongUnaryOperator.class!",
                   java.util.function.LongUnaryOperator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongUnaryOperator
 * public abstract interface java.util.function.LongUnaryOperator}.
 *
...
public abstract interface LongUnaryOperatorClassTests<SUT extends LongUnaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongUnaryOperator.class!",
                   LongUnaryOperator.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.peer.KeyboardFocusManagerPeer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyboardFocusManagerPeerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link KeyboardFocusManagerPeerTests}.
 * </p>
 *
 * @see java.awt.peer.KeyboardFocusManagerPeer interface java.awt.peer.KeyboardFocusManagerPeer (the hereby targeted
 *      class-under-test class)
 * @see KeyboardFocusManagerPeerTests KeyboardFocusManagerPeerTests (The complementary j8unit test interface containing
...
public abstract interface KeyboardFocusManagerPeerClassTests<SUT extends java.awt.peer.KeyboardFocusManagerPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.KeyboardFocusManagerPeer.class!",
                   java.awt.peer.KeyboardFocusManagerPeer.class.isAssignableFrom(sut));
    }

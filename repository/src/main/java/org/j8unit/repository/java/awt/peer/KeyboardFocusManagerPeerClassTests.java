...
public abstract interface KeyboardFocusManagerPeerClassTests<SUT extends KeyboardFocusManagerPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyboardFocusManagerPeer.class!",
                   KeyboardFocusManagerPeer.class.isAssignableFrom(sut));
    }

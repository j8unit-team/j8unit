 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkedHashMapTests}).
 * </p>
 *
 * <p>
 ...
 * @see LinkedHashMapTests LinkedHashMapTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends MapClassTests<SUT>, HashMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.LinkedHashMap.class!",
                   java.util.LinkedHashMap.class.isAssignableFrom(sut));
    }

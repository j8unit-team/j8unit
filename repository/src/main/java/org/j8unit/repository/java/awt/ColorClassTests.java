...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Color class java.awt.Color}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ColorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ColorTests}.
 * </p>
 *
 * @see java.awt.Color class java.awt.Color (the hereby targeted class-under-test class)
 * @see ColorTests ColorTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends PaintClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Color.class!",
                   java.awt.Color.class.isAssignableFrom(sut));
    }

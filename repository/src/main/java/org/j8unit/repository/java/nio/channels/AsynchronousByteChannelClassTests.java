 ...
 * java.nio.channels.AsynchronousByteChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AsynchronousByteChannelTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see AsynchronousByteChannelTests AsynchronousByteChannelTests (The complementary j8unit test interface containing
...
public abstract interface AsynchronousByteChannelClassTests<SUT extends java.nio.channels.AsynchronousByteChannel>
extends AsynchronousChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AsynchronousByteChannel.class!",
                   java.nio.channels.AsynchronousByteChannel.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.java.nio.channels.AsynchronousChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsynchronousByteChannel.class!",
                   AsynchronousByteChannel.class.isAssignableFrom(sut));
    }

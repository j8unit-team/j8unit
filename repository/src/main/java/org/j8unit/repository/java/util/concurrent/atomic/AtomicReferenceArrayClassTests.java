...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.atomic.AtomicReferenceArray class
 * java.util.concurrent.atomic.AtomicReferenceArray}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicReferenceArrayTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AtomicReferenceArrayTests}
 * .
 * </p>
 *
 * @see java.util.concurrent.atomic.AtomicReferenceArray class java.util.concurrent.atomic.AtomicReferenceArray (the
 *      hereby targeted class-under-test class)
 * @see AtomicReferenceArrayTests AtomicReferenceArrayTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicReferenceArray.class!",
                   java.util.concurrent.atomic.AtomicReferenceArray.class.isAssignableFrom(sut));
    }

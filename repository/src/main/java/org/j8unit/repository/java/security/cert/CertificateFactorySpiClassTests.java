...
public abstract interface CertificateFactorySpiClassTests<SUT extends CertificateFactorySpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertificateFactorySpi.class!",
                   CertificateFactorySpi.class.isAssignableFrom(sut));
    }

 ...
 * java.security.cert.CertificateFactorySpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertificateFactorySpiTests}).
 * </p>
 *
 * <p>
 ...
 * {@link CertificateFactorySpiTests}.
 * </p>
 *
 * @see java.security.cert.CertificateFactorySpi class java.security.cert.CertificateFactorySpi (the hereby targeted
 *      class-under-test class)
 * @see CertificateFactorySpiTests CertificateFactorySpiTests (The complementary j8unit test interface containing the
...
public abstract interface CertificateFactorySpiClassTests<SUT extends java.security.cert.CertificateFactorySpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateFactorySpi.class!",
                   java.security.cert.CertificateFactorySpi.class.isAssignableFrom(sut));
    }

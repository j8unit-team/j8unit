...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.Introspector class java.beans.Introspector}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntrospectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntrospectorTests}.
 * </p>
 *
 * @see java.beans.Introspector class java.beans.Introspector (the hereby targeted class-under-test class)
 * @see IntrospectorTests IntrospectorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface IntrospectorClassTests<SUT extends java.beans.Introspector>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.Introspector.class!",
                   java.beans.Introspector.class.isAssignableFrom(sut));
    }

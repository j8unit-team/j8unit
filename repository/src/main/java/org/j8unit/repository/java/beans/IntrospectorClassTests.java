 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Introspector public
...
public abstract interface IntrospectorClassTests<SUT extends Introspector>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Introspector.class!",
                   Introspector.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileNotFoundExceptionTests FileNotFoundExceptionTests (The complementary j8unit test interface containing the
...
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FileNotFoundException.class!",
                   java.io.FileNotFoundException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Runnable interface java.lang.Runnable}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RunnableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RunnableTests}.
 * </p>
 *
 * @see Runnable interface java.lang.Runnable (the hereby targeted class-under-test class)
 * @see RunnableTests RunnableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RunnableClassTests<SUT extends Runnable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Runnable.class!",
                   Runnable.class.isAssignableFrom(sut));
    }

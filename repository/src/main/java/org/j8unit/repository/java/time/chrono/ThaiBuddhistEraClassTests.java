 ...
 * java.time.chrono.ThaiBuddhistEra}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThaiBuddhistEraTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ThaiBuddhistEraTests ThaiBuddhistEraTests (The complementary j8unit test interface containing the instance
...
extends EraClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.ThaiBuddhistEra.class!",
                   java.time.chrono.ThaiBuddhistEra.class.isAssignableFrom(sut));
    }

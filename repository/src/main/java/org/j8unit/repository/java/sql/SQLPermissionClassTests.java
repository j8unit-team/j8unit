 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLPermissionTests}.
 * </p>
 *
 * @see java.sql.SQLPermission class java.sql.SQLPermission (the hereby targeted class-under-test class)
 * @see SQLPermissionTests SQLPermissionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SQLPermissionClassTests<SUT extends java.sql.SQLPermission>
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLPermission.class!",
                   java.sql.SQLPermission.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLPermission
...
public abstract interface SQLPermissionClassTests<SUT extends SQLPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLPermission.class!",
                   SQLPermission.class.isAssignableFrom(sut));
    }

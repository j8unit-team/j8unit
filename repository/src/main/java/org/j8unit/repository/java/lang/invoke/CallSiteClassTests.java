 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CallSite public
 * abstract class java.lang.invoke.CallSite}.
 *
...
public abstract interface CallSiteClassTests<SUT extends CallSite>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CallSite.class!",
                   CallSite.class.isAssignableFrom(sut));
    }

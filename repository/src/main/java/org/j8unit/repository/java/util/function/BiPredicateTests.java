 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link BiPredicate
 * public abstract interface java.util.function.BiPredicate<T,U>}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.util.function.BiPredicateClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface BiPredicateTests<SUT extends BiPredicate<T, U>, T, U>

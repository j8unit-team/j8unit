...
public abstract interface NoSuchElementExceptionClassTests<SUT extends NoSuchElementException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchElementException.class!",
                   NoSuchElementException.class.isAssignableFrom(sut));
    }

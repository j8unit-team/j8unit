...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.NoSuchElementException class
 * java.util.NoSuchElementException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchElementExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link NoSuchElementExceptionTests}.
 * </p>
 *
 * @see java.util.NoSuchElementException class java.util.NoSuchElementException (the hereby targeted class-under-test
 *      class)
 * @see NoSuchElementExceptionTests NoSuchElementExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface NoSuchElementExceptionClassTests<SUT extends java.util.NoSuchElementException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.NoSuchElementException.class!",
                   java.util.NoSuchElementException.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.file.InvalidPathException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidPathExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvalidPathExceptionTests}
 * .
 * </p>
 *
 * @see java.nio.file.InvalidPathException class java.nio.file.InvalidPathException (the hereby targeted
 *      class-under-test class)
 * @see InvalidPathExceptionTests InvalidPathExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.InvalidPathException.class!",
                   java.nio.file.InvalidPathException.class.isAssignableFrom(sut));
    }

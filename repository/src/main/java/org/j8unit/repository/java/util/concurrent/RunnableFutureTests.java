 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link RunnableFuture
 ...
 * {@link org.j8unit.repository.java.util.concurrent.RunnableFutureClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface RunnableFutureTests<SUT extends RunnableFuture<V>, V>
extends RunnableTests<SUT>, FutureTests<SUT, V> {

...
import org.j8unit.repository.java.awt.ShapeClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CubicCurve2D public
 * abstract class java.awt.geom.CubicCurve2D}.
 *
...
public abstract interface CubicCurve2DClassTests<SUT extends CubicCurve2D>
extends ShapeClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.geom.CubicCurve2D]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CubicCurve2D.class!",
                   CubicCurve2D.class.isAssignableFrom(sut));
    }
     ...
     * {@link Float public static class java.awt.geom.CubicCurve2D$Float}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.CubicCurve2DClassTests<SUT> {

        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.geom.CubicCurve2D$Float]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link Double public static class java.awt.geom.CubicCurve2D$Double}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.CubicCurve2DClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.geom.CubicCurve2D$Double]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *

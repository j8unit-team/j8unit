...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.attribute.UserPrincipal interface
 * java.nio.file.attribute.UserPrincipal}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UserPrincipalTests}).
 * </p>
 *
 * <p>
 ...
 * @see UserPrincipalTests UserPrincipalTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.security.PrincipalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.UserPrincipal.class!",
                   java.nio.file.attribute.UserPrincipal.class.isAssignableFrom(sut));
    }

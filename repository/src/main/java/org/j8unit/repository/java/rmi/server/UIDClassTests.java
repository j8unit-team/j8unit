 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UID public final
...
public abstract interface UIDClassTests<SUT extends UID>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UID.class!", UID.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain InstantiationException class java.lang.InstantiationException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InstantiationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InstantiationExceptionTests}.
 * </p>
 *
 * @see InstantiationException class java.lang.InstantiationException (the hereby targeted class-under-test class)
 * @see InstantiationExceptionTests InstantiationExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface InstantiationExceptionClassTests<SUT extends InstantiationException>
extends ReflectiveOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InstantiationException.class!",
                   InstantiationException.class.isAssignableFrom(sut));
    }

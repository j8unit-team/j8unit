 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterException
 * public class java.awt.print.PrinterException}.
 *
...
public abstract interface PrinterExceptionClassTests<SUT extends PrinterException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterException.class!",
                   PrinterException.class.isAssignableFrom(sut));
    }

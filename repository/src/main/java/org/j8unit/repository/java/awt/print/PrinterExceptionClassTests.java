 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterExceptionTests}.
 * </p>
 *
 * @see java.awt.print.PrinterException class java.awt.print.PrinterException (the hereby targeted class-under-test
 *      class)
 * @see PrinterExceptionTests PrinterExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.PrinterException.class!",
                   java.awt.print.PrinterException.class.isAssignableFrom(sut));
    }

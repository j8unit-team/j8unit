...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.AlreadyBoundException.class!",
                   java.rmi.AlreadyBoundException.class.isAssignableFrom(sut));
    }

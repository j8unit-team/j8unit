...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.StringJoiner class java.util.StringJoiner}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringJoinerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringJoinerTests}.
 * </p>
 *
 * @see java.util.StringJoiner class java.util.StringJoiner (the hereby targeted class-under-test class)
 * @see StringJoinerTests StringJoinerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.StringJoiner.class!",
                   java.util.StringJoiner.class.isAssignableFrom(sut));
    }

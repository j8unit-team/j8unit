 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringJoiner public
 * final class java.util.StringJoiner}.
 *
...
public abstract interface StringJoinerClassTests<SUT extends StringJoiner>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringJoiner.class!",
                   StringJoiner.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.charset.spi.CharsetProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharsetProviderTests}).
 * </p>
 *
 * <p>
 ...
 * @see CharsetProviderTests CharsetProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface CharsetProviderClassTests<SUT extends java.nio.charset.spi.CharsetProvider>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.spi.CharsetProvider.class!",
                   java.nio.charset.spi.CharsetProvider.class.isAssignableFrom(sut));
    }

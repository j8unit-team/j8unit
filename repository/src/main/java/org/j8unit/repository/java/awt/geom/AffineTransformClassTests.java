 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AffineTransform
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AffineTransformTests}.
 * </p>
 *
 * <p>
...
public abstract interface AffineTransformClassTests<SUT extends AffineTransform>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AffineTransform.class!",
                   AffineTransform.class.isAssignableFrom(sut));
    }

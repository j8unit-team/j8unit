...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Comparable interface java.lang.Comparable}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComparableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComparableTests}.
 * </p>
 *
 * @see Comparable interface java.lang.Comparable (the hereby targeted class-under-test class)
 * @see ComparableTests ComparableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ComparableClassTests<SUT extends Comparable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Comparable.class!",
                   Comparable.class.isAssignableFrom(sut));
    }

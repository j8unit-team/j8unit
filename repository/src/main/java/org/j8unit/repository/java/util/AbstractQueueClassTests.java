...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.AbstractQueue class java.util.AbstractQueue}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractQueueTests}.
 * </p>
 *
 * @see java.util.AbstractQueue class java.util.AbstractQueue (the hereby targeted class-under-test class)
 * @see AbstractQueueTests AbstractQueueTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AbstractQueueClassTests<SUT extends java.util.AbstractQueue>
extends QueueClassTests<SUT>, AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractQueue.class!",
                   java.util.AbstractQueue.class.isAssignableFrom(sut));
    }

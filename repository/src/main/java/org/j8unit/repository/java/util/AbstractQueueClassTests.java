 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractQueue
 ...
 * {@link org.j8unit.repository.java.util.AbstractQueueTests}.
 * </p>
 *
 * <p>
...
public abstract interface AbstractQueueClassTests<SUT extends AbstractQueue>
extends org.j8unit.repository.java.util.QueueClassTests<SUT>, org.j8unit.repository.java.util.AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractQueue.class!",
                   AbstractQueue.class.isAssignableFrom(sut));
    }

...
public abstract interface ShapeGraphicAttributeClassTests<SUT extends ShapeGraphicAttribute>
extends org.j8unit.repository.java.awt.font.GraphicAttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ShapeGraphicAttribute.class!",
                   ShapeGraphicAttribute.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.font.ShapeGraphicAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShapeGraphicAttributeTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ShapeGraphicAttributeTests}.
 * </p>
 *
 * @see java.awt.font.ShapeGraphicAttribute class java.awt.font.ShapeGraphicAttribute (the hereby targeted
 *      class-under-test class)
 * @see ShapeGraphicAttributeTests ShapeGraphicAttributeTests (The complementary j8unit test interface containing the
...
extends GraphicAttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.font.ShapeGraphicAttribute.class!",
                   java.awt.font.ShapeGraphicAttribute.class.isAssignableFrom(sut));
    }

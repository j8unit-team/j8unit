...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.zone.ZoneOffsetTransition class
 * java.time.zone.ZoneOffsetTransition}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZoneOffsetTransitionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZoneOffsetTransitionTests}
 * .
 * </p>
 *
 * @see java.time.zone.ZoneOffsetTransition class java.time.zone.ZoneOffsetTransition (the hereby targeted
 *      class-under-test class)
 * @see ZoneOffsetTransitionTests ZoneOffsetTransitionTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.zone.ZoneOffsetTransition.class!",
                   java.time.zone.ZoneOffsetTransition.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyExceptionTests}.
 * </p>
 *
 * @see java.security.KeyException class java.security.KeyException (the hereby targeted class-under-test class)
 * @see KeyExceptionTests KeyExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.KeyException.class!",
                   java.security.KeyException.class.isAssignableFrom(sut));
    }

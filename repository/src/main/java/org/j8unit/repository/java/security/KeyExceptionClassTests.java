 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyException public
...
public abstract interface KeyExceptionClassTests<SUT extends KeyException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyException.class!",
                   KeyException.class.isAssignableFrom(sut));
    }

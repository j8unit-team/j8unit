 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AllPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AllPermissionTests}.
 * </p>
 *
 * @see java.security.AllPermission class java.security.AllPermission (the hereby targeted class-under-test class)
 * @see AllPermissionTests AllPermissionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.AllPermission.class!",
                   java.security.AllPermission.class.isAssignableFrom(sut));
    }

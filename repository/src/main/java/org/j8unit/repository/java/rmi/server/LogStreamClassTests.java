...
import org.j8unit.repository.java.io.PrintStreamClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LogStream public
...
public abstract interface LogStreamClassTests<SUT extends LogStream>
extends PrintStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LogStream.class!",
                   LogStream.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LogStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LogStreamTests}.
 * </p>
 *
 * @see java.rmi.server.LogStream class java.rmi.server.LogStream (the hereby targeted class-under-test class)
 * @see LogStreamTests LogStreamTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.PrintStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.LogStream.class!",
                   java.rmi.server.LogStream.class.isAssignableFrom(sut));
    }

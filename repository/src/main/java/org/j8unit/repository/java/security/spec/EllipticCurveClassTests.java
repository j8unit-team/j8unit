 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EllipticCurve
...
public abstract interface EllipticCurveClassTests<SUT extends EllipticCurve>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EllipticCurve.class!",
                   EllipticCurve.class.isAssignableFrom(sut));
    }

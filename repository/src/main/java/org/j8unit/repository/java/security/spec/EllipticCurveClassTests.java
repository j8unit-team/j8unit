 ...
 * java.security.spec.EllipticCurve}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EllipticCurveTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EllipticCurveTests}.
 * </p>
 *
 * @see java.security.spec.EllipticCurve class java.security.spec.EllipticCurve (the hereby targeted class-under-test
 *      class)
 * @see EllipticCurveTests EllipticCurveTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.EllipticCurve.class!",
                   java.security.spec.EllipticCurve.class.isAssignableFrom(sut));
    }

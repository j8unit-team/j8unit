 ...
 * java.nio.channels.DatagramChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DatagramChannelTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see DatagramChannelTests DatagramChannelTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.DatagramChannel.class!",
                   java.nio.channels.DatagramChannel.class.isAssignableFrom(sut));
    }

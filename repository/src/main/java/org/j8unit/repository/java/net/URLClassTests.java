 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URL public final
 * class java.net.URL}.
 *
...
public abstract interface URLClassTests<SUT extends URL>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URL.class!", URL.class.isAssignableFrom(sut));
    }

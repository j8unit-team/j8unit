 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LayoutManager2
...
public abstract interface LayoutManager2ClassTests<SUT extends LayoutManager2>
extends LayoutManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LayoutManager2.class!",
                   LayoutManager2.class.isAssignableFrom(sut));
    }

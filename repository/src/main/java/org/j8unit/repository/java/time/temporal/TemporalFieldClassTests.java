 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalField
...
public abstract interface TemporalFieldClassTests<SUT extends TemporalField>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalField.class!",
                   TemporalField.class.isAssignableFrom(sut));
    }

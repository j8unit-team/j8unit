...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.TemporalField interface
 * java.time.temporal.TemporalField}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalFieldTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalFieldTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalField interface java.time.temporal.TemporalField (the hereby targeted
 *      class-under-test class)
 * @see TemporalFieldTests TemporalFieldTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TemporalFieldClassTests<SUT extends java.time.temporal.TemporalField>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalField.class!",
                   java.time.temporal.TemporalField.class.isAssignableFrom(sut));
    }

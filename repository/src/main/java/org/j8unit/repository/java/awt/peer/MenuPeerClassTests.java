 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuPeer public
 * abstract interface java.awt.peer.MenuPeer}.
 *
...
public abstract interface MenuPeerClassTests<SUT extends MenuPeer>
extends MenuItemPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuPeer.class!",
                   MenuPeer.class.isAssignableFrom(sut));
    }

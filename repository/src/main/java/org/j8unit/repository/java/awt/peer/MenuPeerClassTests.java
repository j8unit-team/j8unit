...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.MenuPeer interface java.awt.peer.MenuPeer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuPeerTests}.
 * </p>
 *
 * @see java.awt.peer.MenuPeer interface java.awt.peer.MenuPeer (the hereby targeted class-under-test class)
 * @see MenuPeerTests MenuPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MenuPeerClassTests<SUT extends java.awt.peer.MenuPeer>
extends MenuItemPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.MenuPeer.class!",
                   java.awt.peer.MenuPeer.class.isAssignableFrom(sut));
    }

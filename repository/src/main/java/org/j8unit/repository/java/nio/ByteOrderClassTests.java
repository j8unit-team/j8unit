...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.ByteOrder class java.nio.ByteOrder}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ByteOrderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ByteOrderTests}.
 * </p>
 *
 * @see java.nio.ByteOrder class java.nio.ByteOrder (the hereby targeted class-under-test class)
 * @see ByteOrderTests ByteOrderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ByteOrderClassTests<SUT extends java.nio.ByteOrder>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.ByteOrder.class!",
                   java.nio.ByteOrder.class.isAssignableFrom(sut));
    }

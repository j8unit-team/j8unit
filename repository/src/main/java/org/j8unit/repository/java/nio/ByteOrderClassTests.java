 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ByteOrder public
 * final class java.nio.ByteOrder}.
 *
...
public abstract interface ByteOrderClassTests<SUT extends ByteOrder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ByteOrder.class!",
                   ByteOrder.class.isAssignableFrom(sut));
    }

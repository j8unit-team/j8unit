 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleToIntFunction
 * public abstract interface java.util.function.DoubleToIntFunction}.
 *
...
public abstract interface DoubleToIntFunctionClassTests<SUT extends DoubleToIntFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleToIntFunction.class!",
                   DoubleToIntFunction.class.isAssignableFrom(sut));
    }

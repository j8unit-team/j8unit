...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.DoubleToIntFunction interface
 * java.util.function.DoubleToIntFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleToIntFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleToIntFunctionTests}.
 * </p>
 *
 * @see java.util.function.DoubleToIntFunction interface java.util.function.DoubleToIntFunction (the hereby targeted
 *      class-under-test class)
 * @see DoubleToIntFunctionTests DoubleToIntFunctionTests (The complementary j8unit test interface containing the
...
public abstract interface DoubleToIntFunctionClassTests<SUT extends java.util.function.DoubleToIntFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoubleToIntFunction.class!",
                   java.util.function.DoubleToIntFunction.class.isAssignableFrom(sut));
    }

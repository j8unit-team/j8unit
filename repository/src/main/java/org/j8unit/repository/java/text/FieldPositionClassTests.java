 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FieldPosition
...
public abstract interface FieldPositionClassTests<SUT extends FieldPosition>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FieldPosition.class!",
                   FieldPosition.class.isAssignableFrom(sut));
    }

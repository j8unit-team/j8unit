...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.FieldPosition class java.text.FieldPosition}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FieldPositionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FieldPositionTests}.
 * </p>
 *
 * @see java.text.FieldPosition class java.text.FieldPosition (the hereby targeted class-under-test class)
 * @see FieldPositionTests FieldPositionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface FieldPositionClassTests<SUT extends java.text.FieldPosition>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.FieldPosition.class!",
                   java.text.FieldPosition.class.isAssignableFrom(sut));
    }

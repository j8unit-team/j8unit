...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.WritableRaster class java.awt.image.WritableRaster},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WritableRasterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WritableRasterTests}.
 * </p>
 *
 * @see java.awt.image.WritableRaster class java.awt.image.WritableRaster (the hereby targeted class-under-test class)
 * @see WritableRasterTests WritableRasterTests (The complementary j8unit test interface containing the instance
...
public abstract interface WritableRasterClassTests<SUT extends java.awt.image.WritableRaster>
extends RasterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.WritableRaster.class!",
                   java.awt.image.WritableRaster.class.isAssignableFrom(sut));
    }

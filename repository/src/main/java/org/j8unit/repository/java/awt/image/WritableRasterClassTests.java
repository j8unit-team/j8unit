 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WritableRaster
...
public abstract interface WritableRasterClassTests<SUT extends WritableRaster>
extends RasterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WritableRaster.class!",
                   WritableRaster.class.isAssignableFrom(sut));
    }

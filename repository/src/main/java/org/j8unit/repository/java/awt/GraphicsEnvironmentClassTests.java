 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GraphicsEnvironment
 * public abstract class java.awt.GraphicsEnvironment}.
 *
...
public abstract interface GraphicsEnvironmentClassTests<SUT extends GraphicsEnvironment>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GraphicsEnvironment.class!",
                   GraphicsEnvironment.class.isAssignableFrom(sut));
    }

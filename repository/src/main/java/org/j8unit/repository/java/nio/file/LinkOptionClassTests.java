 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkOptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see LinkOptionTests LinkOptionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends OpenOptionClassTests<SUT>, CopyOptionClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.LinkOption.class!",
                   java.nio.file.LinkOption.class.isAssignableFrom(sut));
    }

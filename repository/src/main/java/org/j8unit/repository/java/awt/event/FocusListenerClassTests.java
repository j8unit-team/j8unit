...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.FocusListener interface java.awt.event.FocusListener},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FocusListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FocusListenerTests}.
 * </p>
 *
 * @see java.awt.event.FocusListener interface java.awt.event.FocusListener (the hereby targeted class-under-test class)
 * @see FocusListenerTests FocusListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface FocusListenerClassTests<SUT extends java.awt.event.FocusListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.FocusListener.class!",
                   java.awt.event.FocusListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FocusListener
...
public abstract interface FocusListenerClassTests<SUT extends FocusListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FocusListener.class!",
                   FocusListener.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharConversionExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link CharConversionExceptionTests}.
 * </p>
 *
 * @see java.io.CharConversionException class java.io.CharConversionException (the hereby targeted class-under-test
 *      class)
 * @see CharConversionExceptionTests CharConversionExceptionTests (The complementary j8unit test interface containing
...
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.CharConversionException.class!",
                   java.io.CharConversionException.class.isAssignableFrom(sut));
    }

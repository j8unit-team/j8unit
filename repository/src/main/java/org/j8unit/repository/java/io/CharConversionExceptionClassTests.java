...
public abstract interface CharConversionExceptionClassTests<SUT extends CharConversionException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharConversionException.class!",
                   CharConversionException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain InternalError class java.lang.InternalError}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InternalErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InternalErrorTests}.
 * </p>
 *
 * @see InternalError class java.lang.InternalError (the hereby targeted class-under-test class)
 * @see InternalErrorTests InternalErrorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface InternalErrorClassTests<SUT extends InternalError>
extends VirtualMachineErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InternalError.class!",
                   InternalError.class.isAssignableFrom(sut));
    }

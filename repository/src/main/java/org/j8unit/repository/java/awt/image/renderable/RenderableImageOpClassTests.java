 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RenderableImageOp
 * public class java.awt.image.renderable.RenderableImageOp}.
 *
...
public abstract interface RenderableImageOpClassTests<SUT extends RenderableImageOp>
extends RenderableImageClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.renderable.RenderableImageOp]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RenderableImageOp.class!",
                   RenderableImageOp.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Collections public
...
public abstract interface CollectionsClassTests<SUT extends Collections>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Collections.class!",
                   Collections.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Collections class java.util.Collections}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollectionsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CollectionsTests}.
 * </p>
 *
 * @see java.util.Collections class java.util.Collections (the hereby targeted class-under-test class)
 * @see CollectionsTests CollectionsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Collections.class!",
                   java.util.Collections.class.isAssignableFrom(sut));
    }

 ...
 * java.security.cert.CertPathParameters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertPathParametersTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertPathParametersTests}.
 * </p>
 *
 * @see java.security.cert.CertPathParameters interface java.security.cert.CertPathParameters (the hereby targeted
 *      class-under-test class)
 * @see CertPathParametersTests CertPathParametersTests (The complementary j8unit test interface containing the instance
...
public abstract interface CertPathParametersClassTests<SUT extends java.security.cert.CertPathParameters>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathParameters.class!",
                   java.security.cert.CertPathParameters.class.isAssignableFrom(sut));
    }

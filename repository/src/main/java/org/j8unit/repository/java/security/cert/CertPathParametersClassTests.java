 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertPathParameters
 * public abstract interface java.security.cert.CertPathParameters}.
 *
...
public abstract interface CertPathParametersClassTests<SUT extends CertPathParameters>
extends CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathParameters.class!",
                   CertPathParameters.class.isAssignableFrom(sut));
    }

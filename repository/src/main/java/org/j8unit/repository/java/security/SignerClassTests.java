 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Signer public
 * abstract class java.security.Signer}.
 *
...
public abstract interface SignerClassTests<SUT extends Signer>
extends IdentityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Signer.class!",
                   Signer.class.isAssignableFrom(sut));
    }

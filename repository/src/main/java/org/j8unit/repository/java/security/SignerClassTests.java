...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.Signer class java.security.Signer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignerTests}.
 * </p>
 *
 * @see java.security.Signer class java.security.Signer (the hereby targeted class-under-test class)
 * @see SignerTests SignerTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends IdentityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Signer.class!",
                   java.security.Signer.class.isAssignableFrom(sut));
    }

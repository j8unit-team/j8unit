...
/**
 * <p>
 * Test class for {@link java.security.Signer class java.security.Signer}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.security.SignerTests}.
 * </p>
 *
 * <p>

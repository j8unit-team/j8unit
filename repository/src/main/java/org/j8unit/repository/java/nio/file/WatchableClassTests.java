 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Watchable public
 * abstract interface java.nio.file.Watchable}.
 *
...
public abstract interface WatchableClassTests<SUT extends Watchable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Watchable.class!",
                   Watchable.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.file.Watchable]

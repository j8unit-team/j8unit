 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WatchableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WatchableTests}.
 * </p>
 *
 * @see java.nio.file.Watchable interface java.nio.file.Watchable (the hereby targeted class-under-test class)
 * @see WatchableTests WatchableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WatchableClassTests<SUT extends java.nio.file.Watchable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.Watchable.class!",
                   java.nio.file.Watchable.class.isAssignableFrom(sut));
    }

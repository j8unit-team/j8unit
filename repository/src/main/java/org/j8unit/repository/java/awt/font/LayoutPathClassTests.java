 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LayoutPath public
 * abstract class java.awt.font.LayoutPath}.
 *
...
public abstract interface LayoutPathClassTests<SUT extends LayoutPath>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LayoutPath.class!",
                   LayoutPath.class.isAssignableFrom(sut));
    }

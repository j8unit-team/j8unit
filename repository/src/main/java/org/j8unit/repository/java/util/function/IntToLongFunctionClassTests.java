 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntToLongFunction
 * public abstract interface java.util.function.IntToLongFunction}.
 *
...
public abstract interface IntToLongFunctionClassTests<SUT extends IntToLongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntToLongFunction.class!",
                   IntToLongFunction.class.isAssignableFrom(sut));
    }

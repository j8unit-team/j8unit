...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.IntToLongFunction interface
 * java.util.function.IntToLongFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntToLongFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntToLongFunctionTests}.
 * </p>
 *
 * @see java.util.function.IntToLongFunction interface java.util.function.IntToLongFunction (the hereby targeted
 *      class-under-test class)
 * @see IntToLongFunctionTests IntToLongFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface IntToLongFunctionClassTests<SUT extends java.util.function.IntToLongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntToLongFunction.class!",
                   java.util.function.IntToLongFunction.class.isAssignableFrom(sut));
    }

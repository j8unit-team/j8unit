 ...
 * {@link ReplicateScaleFilter public class java.awt.image.ReplicateScaleFilter}.
 *
...
public abstract interface ReplicateScaleFilterClassTests<SUT extends ReplicateScaleFilter>
extends org.j8unit.repository.java.awt.image.ImageFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReplicateScaleFilter.class!",
                   ReplicateScaleFilter.class.isAssignableFrom(sut));
    }

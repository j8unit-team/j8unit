 ...
 * java.beans.beancontext.BeanContextServiceRevokedEvent}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextServiceRevokedEventTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.beans.beancontext.BeanContextServiceRevokedEvent class
 *      java.beans.beancontext.BeanContextServiceRevokedEvent (the hereby targeted class-under-test class)
 * @see BeanContextServiceRevokedEventTests BeanContextServiceRevokedEventTests (The complementary j8unit test interface
...
extends BeanContextEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServiceRevokedEvent.class!",
                   java.beans.beancontext.BeanContextServiceRevokedEvent.class.isAssignableFrom(sut));
    }

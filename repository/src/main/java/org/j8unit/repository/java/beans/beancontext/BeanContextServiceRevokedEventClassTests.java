 ...
 * {@link BeanContextServiceRevokedEvent public class java.beans.beancontext.BeanContextServiceRevokedEvent}.
 *
...
public abstract interface BeanContextServiceRevokedEventClassTests<SUT extends BeanContextServiceRevokedEvent>
extends BeanContextEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextServiceRevokedEvent.class!",
                   BeanContextServiceRevokedEvent.class.isAssignableFrom(sut));
    }

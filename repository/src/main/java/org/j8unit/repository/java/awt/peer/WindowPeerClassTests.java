...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.WindowPeer interface java.awt.peer.WindowPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WindowPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WindowPeerTests}.
 * </p>
 *
 * @see java.awt.peer.WindowPeer interface java.awt.peer.WindowPeer (the hereby targeted class-under-test class)
 * @see WindowPeerTests WindowPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WindowPeerClassTests<SUT extends java.awt.peer.WindowPeer>
extends ContainerPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.WindowPeer.class!",
                   java.awt.peer.WindowPeer.class.isAssignableFrom(sut));
    }

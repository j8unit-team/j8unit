 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WindowPeer public
 * abstract interface java.awt.peer.WindowPeer}.
 *
...
public abstract interface WindowPeerClassTests<SUT extends WindowPeer>
extends ContainerPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WindowPeer.class!",
                   WindowPeer.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JarExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see JarExceptionTests JarExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.zip.ZipExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.JarException.class!",
                   java.util.jar.JarException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.DialogPeer interface java.awt.peer.DialogPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DialogPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DialogPeerTests}.
 * </p>
 *
 * @see java.awt.peer.DialogPeer interface java.awt.peer.DialogPeer (the hereby targeted class-under-test class)
 * @see DialogPeerTests DialogPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DialogPeerClassTests<SUT extends java.awt.peer.DialogPeer>
extends WindowPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.DialogPeer.class!",
                   java.awt.peer.DialogPeer.class.isAssignableFrom(sut));
    }

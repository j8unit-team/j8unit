 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DialogPeer public
 * abstract interface java.awt.peer.DialogPeer}.
 *
...
public abstract interface DialogPeerClassTests<SUT extends DialogPeer>
extends WindowPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DialogPeer.class!",

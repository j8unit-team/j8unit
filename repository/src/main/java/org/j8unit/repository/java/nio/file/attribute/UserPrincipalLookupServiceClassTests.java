...
public abstract interface UserPrincipalLookupServiceClassTests<SUT extends UserPrincipalLookupService>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UserPrincipalLookupService.class!",
                   UserPrincipalLookupService.class.isAssignableFrom(sut));
    }

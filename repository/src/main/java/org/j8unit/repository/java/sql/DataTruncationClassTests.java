 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataTruncationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataTruncationTests}.
 * </p>
 *
 * @see java.sql.DataTruncation class java.sql.DataTruncation (the hereby targeted class-under-test class)
 * @see DataTruncationTests DataTruncationTests (The complementary j8unit test interface containing the instance
...
extends SQLWarningClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.DataTruncation.class!",
                   java.sql.DataTruncation.class.isAssignableFrom(sut));
    }

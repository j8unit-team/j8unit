 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataTruncation
...
public abstract interface DataTruncationClassTests<SUT extends DataTruncation>
extends SQLWarningClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataTruncation.class!",
                   DataTruncation.class.isAssignableFrom(sut));
    }

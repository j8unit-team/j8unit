...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain String class java.lang.String}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringTests}).
 * </p>
 *
 * <p>
 ...
 * @see StringTests StringTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface StringClassTests<SUT extends String>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, ComparableClassTests<SUT>, CharSequenceClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to String.class!",

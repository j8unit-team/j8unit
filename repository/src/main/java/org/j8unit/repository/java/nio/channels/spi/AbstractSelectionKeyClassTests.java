...
import org.j8unit.repository.java.nio.channels.SelectionKeyClassTests;
 ...
 * {@link AbstractSelectionKey public abstract class java.nio.channels.spi.AbstractSelectionKey}.
 *
 ...
 * {@link org.j8unit.repository.java.nio.channels.spi.AbstractSelectionKeyTests}.
 * </p>
 *
 * <p>
...
public abstract interface AbstractSelectionKeyClassTests<SUT extends AbstractSelectionKey>
extends SelectionKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractSelectionKey.class!",
                   AbstractSelectionKey.class.isAssignableFrom(sut));
    }

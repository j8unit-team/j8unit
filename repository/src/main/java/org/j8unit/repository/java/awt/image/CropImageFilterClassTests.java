 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CropImageFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CropImageFilterTests}.
 * </p>
 *
 * @see java.awt.image.CropImageFilter class java.awt.image.CropImageFilter (the hereby targeted class-under-test class)
 * @see CropImageFilterTests CropImageFilterTests (The complementary j8unit test interface containing the instance
...
extends ImageFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.CropImageFilter.class!",
                   java.awt.image.CropImageFilter.class.isAssignableFrom(sut));
    }

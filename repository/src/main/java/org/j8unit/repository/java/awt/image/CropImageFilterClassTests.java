 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CropImageFilter
...
public abstract interface CropImageFilterClassTests<SUT extends CropImageFilter>
extends org.j8unit.repository.java.awt.image.ImageFilterClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.CropImageFilter]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CropImageFilter.class!",
                   CropImageFilter.class.isAssignableFrom(sut));
    }

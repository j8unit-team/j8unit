 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PKIXParameters
...
public abstract interface PKIXParametersClassTests<SUT extends PKIXParameters>
extends CertPathParametersClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKIXParameters.class!",
                   PKIXParameters.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.print.PrinterIOException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterIOExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see PrinterIOExceptionTests PrinterIOExceptionTests (The complementary j8unit test interface containing the instance
...
extends PrinterExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.PrinterIOException.class!",
                   java.awt.print.PrinterIOException.class.isAssignableFrom(sut));
    }

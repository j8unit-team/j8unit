 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterIOException
...
extends org.j8unit.repository.java.awt.print.PrinterExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterIOException.class!",
                   PrinterIOException.class.isAssignableFrom(sut));
    }

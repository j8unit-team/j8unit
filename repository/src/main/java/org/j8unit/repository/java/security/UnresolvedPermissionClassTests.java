 ...
 * java.security.UnresolvedPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnresolvedPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnresolvedPermissionTests}
 * .
 * </p>
 *
 * @see java.security.UnresolvedPermission class java.security.UnresolvedPermission (the hereby targeted
 *      class-under-test class)
 * @see UnresolvedPermissionTests UnresolvedPermissionTests (The complementary j8unit test interface containing the
...
public abstract interface UnresolvedPermissionClassTests<SUT extends java.security.UnresolvedPermission>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.UnresolvedPermission.class!",
                   java.security.UnresolvedPermission.class.isAssignableFrom(sut));
    }

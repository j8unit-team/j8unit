 ...
 * {@link UnresolvedPermissionTests}.
 * </p>
 *
 * <p>
...
public abstract interface UnresolvedPermissionClassTests<SUT extends UnresolvedPermission>
extends PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnresolvedPermission.class!",
                   UnresolvedPermission.class.isAssignableFrom(sut));
    }

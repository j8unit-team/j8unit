 ...
 * java.sql.SQLSyntaxErrorException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLSyntaxErrorExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link SQLSyntaxErrorExceptionTests}.
 * </p>
 *
 * @see java.sql.SQLSyntaxErrorException class java.sql.SQLSyntaxErrorException (the hereby targeted class-under-test
 *      class)
 * @see SQLSyntaxErrorExceptionTests SQLSyntaxErrorExceptionTests (The complementary j8unit test interface containing
...
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLSyntaxErrorException.class!",
                   java.sql.SQLSyntaxErrorException.class.isAssignableFrom(sut));
    }

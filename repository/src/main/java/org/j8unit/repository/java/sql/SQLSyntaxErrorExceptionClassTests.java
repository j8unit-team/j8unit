 ...
 * {@link SQLSyntaxErrorException public class java.sql.SQLSyntaxErrorException}.
 *
...
public abstract interface SQLSyntaxErrorExceptionClassTests<SUT extends SQLSyntaxErrorException>
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLSyntaxErrorException.class!",
                   SQLSyntaxErrorException.class.isAssignableFrom(sut));
    }

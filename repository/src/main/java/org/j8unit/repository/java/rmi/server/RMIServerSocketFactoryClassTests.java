 ...
 * java.rmi.server.RMIServerSocketFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIServerSocketFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RMIServerSocketFactoryTests}.
 * </p>
 *
 * @see java.rmi.server.RMIServerSocketFactory interface java.rmi.server.RMIServerSocketFactory (the hereby targeted
 *      class-under-test class)
 * @see RMIServerSocketFactoryTests RMIServerSocketFactoryTests (The complementary j8unit test interface containing the
...
public abstract interface RMIServerSocketFactoryClassTests<SUT extends java.rmi.server.RMIServerSocketFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RMIServerSocketFactory.class!",
                   java.rmi.server.RMIServerSocketFactory.class.isAssignableFrom(sut));
    }

...
public abstract interface RMIServerSocketFactoryClassTests<SUT extends RMIServerSocketFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIServerSocketFactory.class!",
                   RMIServerSocketFactory.class.isAssignableFrom(sut));
    }

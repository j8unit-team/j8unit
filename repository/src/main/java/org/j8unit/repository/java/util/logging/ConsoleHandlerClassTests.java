 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ConsoleHandler
...
extends StreamHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConsoleHandler.class!",
                   ConsoleHandler.class.isAssignableFrom(sut));
    }

 ...
 * java.util.logging.ConsoleHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConsoleHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ConsoleHandlerTests ConsoleHandlerTests (The complementary j8unit test interface containing the instance
...
extends StreamHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.ConsoleHandler.class!",
                   java.util.logging.ConsoleHandler.class.isAssignableFrom(sut));
    }

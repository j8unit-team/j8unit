 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NumberFormatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NumberFormatTests}.
 * </p>
 *
 * @see java.text.NumberFormat class java.text.NumberFormat (the hereby targeted class-under-test class)
 * @see NumberFormatTests NumberFormatTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends FormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.NumberFormat.class!",
                   java.text.NumberFormat.class.isAssignableFrom(sut));
    }
     ...
     * {@link NumberFormatTests.FieldTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.text.NumberFormat.Field class java.text.NumberFormat$Field (the hereby targeted class-under-test class)
     * @see NumberFormatTests.FieldTests NumberFormatTests.FieldTests (The complementary j8unit test interface
    ...
    extends FormatClassTests.FieldClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.NumberFormat.Field.class!",
                       java.text.NumberFormat.Field.class.isAssignableFrom(sut));
        }

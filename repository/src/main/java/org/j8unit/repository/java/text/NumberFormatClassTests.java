 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NumberFormat public
...
public abstract interface NumberFormatClassTests<SUT extends NumberFormat>
extends FormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NumberFormat.class!",
                   NumberFormat.class.isAssignableFrom(sut));
    }
     ...
     * {@link Field public static class java.text.NumberFormat$Field}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FieldClassTests<SUT extends Field>

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TrayIconPeer public
 * abstract interface java.awt.peer.TrayIconPeer}.
 *
...
public abstract interface TrayIconPeerClassTests<SUT extends TrayIconPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TrayIconPeer.class!",
                   TrayIconPeer.class.isAssignableFrom(sut));
    }

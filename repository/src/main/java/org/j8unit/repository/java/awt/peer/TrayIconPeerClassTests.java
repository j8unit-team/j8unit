 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TrayIconPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TrayIconPeerTests}.
 * </p>
 *
 * @see java.awt.peer.TrayIconPeer interface java.awt.peer.TrayIconPeer (the hereby targeted class-under-test class)
 * @see TrayIconPeerTests TrayIconPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TrayIconPeerClassTests<SUT extends java.awt.peer.TrayIconPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.TrayIconPeer.class!",
                   java.awt.peer.TrayIconPeer.class.isAssignableFrom(sut));
    }

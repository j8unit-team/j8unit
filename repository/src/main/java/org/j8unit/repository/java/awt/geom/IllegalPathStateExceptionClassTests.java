 ...
 * java.awt.geom.IllegalPathStateException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IllegalPathStateExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalPathStateExceptionTests IllegalPathStateExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.IllegalPathStateException.class!",
                   java.awt.geom.IllegalPathStateException.class.isAssignableFrom(sut));
    }

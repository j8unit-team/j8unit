 ...
 * {@link IllegalPathStateException public class java.awt.geom.IllegalPathStateException}.
 *
...
public abstract interface IllegalPathStateExceptionClassTests<SUT extends IllegalPathStateException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalPathStateException.class!",
                   IllegalPathStateException.class.isAssignableFrom(sut));
    }

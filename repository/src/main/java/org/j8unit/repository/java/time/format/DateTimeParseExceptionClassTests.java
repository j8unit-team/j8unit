 ...
 * java.time.format.DateTimeParseException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTimeParseExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see DateTimeParseExceptionTests DateTimeParseExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.time.DateTimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.DateTimeParseException.class!",
                   java.time.format.DateTimeParseException.class.isAssignableFrom(sut));
    }

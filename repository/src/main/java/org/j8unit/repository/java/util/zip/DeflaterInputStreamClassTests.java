 ...
 * java.util.zip.DeflaterInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DeflaterInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DeflaterInputStreamTests}.
 * </p>
 *
 * @see java.util.zip.DeflaterInputStream class java.util.zip.DeflaterInputStream (the hereby targeted class-under-test
 *      class)
 * @see DeflaterInputStreamTests DeflaterInputStreamTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.DeflaterInputStream.class!",
                   java.util.zip.DeflaterInputStream.class.isAssignableFrom(sut));
    }

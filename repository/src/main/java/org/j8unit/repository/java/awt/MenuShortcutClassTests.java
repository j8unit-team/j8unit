 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuShortcut public
...
public abstract interface MenuShortcutClassTests<SUT extends MenuShortcut>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuShortcut.class!",
                   MenuShortcut.class.isAssignableFrom(sut));
    }

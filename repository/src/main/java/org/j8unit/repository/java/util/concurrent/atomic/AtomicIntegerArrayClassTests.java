 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AtomicIntegerArray
...
public abstract interface AtomicIntegerArrayClassTests<SUT extends AtomicIntegerArray>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicIntegerArray.class!",
                   AtomicIntegerArray.class.isAssignableFrom(sut));
    }

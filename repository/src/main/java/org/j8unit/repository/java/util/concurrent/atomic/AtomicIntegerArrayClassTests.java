 ...
 * java.util.concurrent.atomic.AtomicIntegerArray}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicIntegerArrayTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AtomicIntegerArrayTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.AtomicIntegerArray class java.util.concurrent.atomic.AtomicIntegerArray (the hereby
 *      targeted class-under-test class)
 * @see AtomicIntegerArrayTests AtomicIntegerArrayTests (The complementary j8unit test interface containing the instance
...
public abstract interface AtomicIntegerArrayClassTests<SUT extends java.util.concurrent.atomic.AtomicIntegerArray>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicIntegerArray.class!",
                   java.util.concurrent.atomic.AtomicIntegerArray.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DriverManagerTests}).
 * </p>
 *
 * <p>
 ...
 * @see DriverManagerTests DriverManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DriverManagerClassTests<SUT extends java.sql.DriverManager>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.DriverManager.class!",
                   java.sql.DriverManager.class.isAssignableFrom(sut));
    }

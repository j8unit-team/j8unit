 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DriverManager
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DriverManagerTests}.
 * </p>
 *
 * <p>
...
public abstract interface DriverManagerClassTests<SUT extends DriverManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DriverManager.class!",
                   DriverManager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertPath public
 * abstract class java.security.cert.CertPath}.
 *
...
public abstract interface CertPathClassTests<SUT extends CertPath>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPath.class!",
                   CertPath.class.isAssignableFrom(sut));
    }

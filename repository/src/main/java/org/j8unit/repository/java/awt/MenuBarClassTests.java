...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.MenuBar class java.awt.MenuBar}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuBarTests}).
 * </p>
 *
 * <p>
 ...
 * @see MenuBarTests MenuBarTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MenuBarClassTests<SUT extends java.awt.MenuBar>
extends MenuContainerClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, MenuComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.MenuBar.class!",
                   java.awt.MenuBar.class.isAssignableFrom(sut));
    }

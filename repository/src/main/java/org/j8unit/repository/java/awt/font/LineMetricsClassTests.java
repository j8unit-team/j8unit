 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LineMetrics public
 * abstract class java.awt.font.LineMetrics}.
 *
...
public abstract interface LineMetricsClassTests<SUT extends LineMetrics>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineMetrics.class!",
                   LineMetrics.class.isAssignableFrom(sut));
    }

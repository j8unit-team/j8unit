 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FlowLayout public
...
public abstract interface FlowLayoutClassTests<SUT extends FlowLayout>
extends LayoutManagerClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FlowLayout.class!",
                   FlowLayout.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RectangularShape
 * public abstract class java.awt.geom.RectangularShape}.
 *
...
public abstract interface RectangularShapeClassTests<SUT extends RectangularShape>
extends ShapeClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RectangularShape.class!",
                   RectangularShape.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.file.ProviderNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link ProviderNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ProviderNotFoundExceptionTests ProviderNotFoundExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.ProviderNotFoundException.class!",
                   java.nio.file.ProviderNotFoundException.class.isAssignableFrom(sut));
    }

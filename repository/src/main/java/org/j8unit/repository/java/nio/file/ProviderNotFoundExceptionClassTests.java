...
public abstract interface ProviderNotFoundExceptionClassTests<SUT extends ProviderNotFoundException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProviderNotFoundException.class!",
                   ProviderNotFoundException.class.isAssignableFrom(sut));
    }

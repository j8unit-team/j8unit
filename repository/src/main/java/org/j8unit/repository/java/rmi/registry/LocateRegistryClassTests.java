 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LocateRegistry
...
public abstract interface LocateRegistryClassTests<SUT extends LocateRegistry>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LocateRegistry.class!",

 ...
 * java.rmi.registry.LocateRegistry}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocateRegistryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LocateRegistryTests}.
 * </p>
 *
 * @see java.rmi.registry.LocateRegistry class java.rmi.registry.LocateRegistry (the hereby targeted class-under-test
 *      class)
 * @see LocateRegistryTests LocateRegistryTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.registry.LocateRegistry.class!",
                   java.rmi.registry.LocateRegistry.class.isAssignableFrom(sut));
    }

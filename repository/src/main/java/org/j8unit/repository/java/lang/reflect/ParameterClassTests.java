 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Parameter public
...
public abstract interface ParameterClassTests<SUT extends Parameter>
extends AnnotatedElementClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Parameter.class!",
                   Parameter.class.isAssignableFrom(sut));
    }

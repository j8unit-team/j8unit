 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DigestException
...
public abstract interface DigestExceptionClassTests<SUT extends DigestException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DigestException.class!",
                   DigestException.class.isAssignableFrom(sut));
    }

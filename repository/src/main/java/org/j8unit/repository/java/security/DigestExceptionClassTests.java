 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DigestExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DigestExceptionTests}.
 * </p>
 *
 * @see java.security.DigestException class java.security.DigestException (the hereby targeted class-under-test class)
 * @see DigestExceptionTests DigestExceptionTests (The complementary j8unit test interface containing the instance
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.DigestException.class!",
                   java.security.DigestException.class.isAssignableFrom(sut));
    }

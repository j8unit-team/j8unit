...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain NumberFormatException class java.lang.NumberFormatException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NumberFormatExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link NumberFormatExceptionTests}.
 * </p>
 *
 * @see NumberFormatException class java.lang.NumberFormatException (the hereby targeted class-under-test class)
 * @see NumberFormatExceptionTests NumberFormatExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface NumberFormatExceptionClassTests<SUT extends NumberFormatException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NumberFormatException.class!",
                   NumberFormatException.class.isAssignableFrom(sut));
    }

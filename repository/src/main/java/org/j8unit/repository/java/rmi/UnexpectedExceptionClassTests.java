 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnexpectedException
 * public class java.rmi.UnexpectedException}.
 *
...
public abstract interface UnexpectedExceptionClassTests<SUT extends UnexpectedException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnexpectedException.class!",
                   UnexpectedException.class.isAssignableFrom(sut));
    }

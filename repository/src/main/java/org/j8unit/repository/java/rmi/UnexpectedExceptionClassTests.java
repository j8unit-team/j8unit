 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnexpectedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnexpectedExceptionTests}.
 * </p>
 *
 * @see java.rmi.UnexpectedException class java.rmi.UnexpectedException (the hereby targeted class-under-test class)
 * @see UnexpectedExceptionTests UnexpectedExceptionTests (The complementary j8unit test interface containing the
...
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.UnexpectedException.class!",
                   java.rmi.UnexpectedException.class.isAssignableFrom(sut));
    }

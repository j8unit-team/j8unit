 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TransformAttribute
 * public final class java.awt.font.TransformAttribute}.
 *
...
public abstract interface TransformAttributeClassTests<SUT extends TransformAttribute>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.font.TransformAttribute]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransformAttribute.class!",
                   TransformAttribute.class.isAssignableFrom(sut));
    }

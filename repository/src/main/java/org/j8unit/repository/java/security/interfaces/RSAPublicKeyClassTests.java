 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RSAPublicKey public
 * abstract interface java.security.interfaces.RSAPublicKey}.
 *
...
public abstract interface RSAPublicKeyClassTests<SUT extends RSAPublicKey>
extends PublicKeyClassTests<SUT>, RSAKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAPublicKey.class!",
                   RSAPublicKey.class.isAssignableFrom(sut));
    }

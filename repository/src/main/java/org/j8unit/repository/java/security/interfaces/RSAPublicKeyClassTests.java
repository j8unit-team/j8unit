...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.interfaces.RSAPublicKey interface
 * java.security.interfaces.RSAPublicKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAPublicKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RSAPublicKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.RSAPublicKey interface java.security.interfaces.RSAPublicKey (the hereby targeted
 *      class-under-test class)
 * @see RSAPublicKeyTests RSAPublicKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RSAPublicKeyClassTests<SUT extends java.security.interfaces.RSAPublicKey>
extends org.j8unit.repository.java.security.PublicKeyClassTests<SUT>, RSAKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.RSAPublicKey.class!",
                   java.security.interfaces.RSAPublicKey.class.isAssignableFrom(sut));
    }

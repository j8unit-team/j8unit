...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.List interface java.util.List}, containing all type relevant
 ...
 * </p>
 *
 * @see java.util.List interface java.util.List (the hereby targeted class-under-test class)
...
public abstract interface ListClassTests<SUT extends java.util.List>
extends CollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.List.class!",
                   java.util.List.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterJobTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterJobTests}.
 * </p>
 *
 * @see java.awt.print.PrinterJob class java.awt.print.PrinterJob (the hereby targeted class-under-test class)
 * @see PrinterJobTests PrinterJobTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.PrinterJob.class!",
                   java.awt.print.PrinterJob.class.isAssignableFrom(sut));
    }

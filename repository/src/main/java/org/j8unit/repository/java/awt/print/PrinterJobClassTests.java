 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterJob public
...
public abstract interface PrinterJobClassTests<SUT extends PrinterJob>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterJob.class!",
                   PrinterJob.class.isAssignableFrom(sut));
    }

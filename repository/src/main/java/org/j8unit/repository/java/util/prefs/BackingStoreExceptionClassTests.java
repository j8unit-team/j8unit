 ...
 * {@link BackingStoreException public class java.util.prefs.BackingStoreException}.
 *
...
public abstract interface BackingStoreExceptionClassTests<SUT extends BackingStoreException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BackingStoreException.class!",
                   BackingStoreException.class.isAssignableFrom(sut));
    }

 ...
 * java.util.prefs.BackingStoreException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BackingStoreExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link BackingStoreExceptionTests}.
 * </p>
 *
 * @see java.util.prefs.BackingStoreException class java.util.prefs.BackingStoreException (the hereby targeted
 *      class-under-test class)
 * @see BackingStoreExceptionTests BackingStoreExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.BackingStoreException.class!",
                   java.util.prefs.BackingStoreException.class.isAssignableFrom(sut));
    }

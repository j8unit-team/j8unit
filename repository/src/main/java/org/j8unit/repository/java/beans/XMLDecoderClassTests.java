 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLDecoderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLDecoderTests}.
 * </p>
 *
 * @see java.beans.XMLDecoder class java.beans.XMLDecoder (the hereby targeted class-under-test class)
 * @see XMLDecoderTests XMLDecoderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.XMLDecoder.class!",
                   java.beans.XMLDecoder.class.isAssignableFrom(sut));
    }

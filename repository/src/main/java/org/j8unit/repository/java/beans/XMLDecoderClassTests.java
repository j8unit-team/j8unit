 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLDecoder public
...
public abstract interface XMLDecoderClassTests<SUT extends XMLDecoder>
extends AutoCloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLDecoder.class!",
                   XMLDecoder.class.isAssignableFrom(sut));
    }

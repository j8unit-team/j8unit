 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RemoteCall public
 * abstract interface java.rmi.server.RemoteCall}.
 *
...
public abstract interface RemoteCallClassTests<SUT extends RemoteCall>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemoteCall.class!",
                   RemoteCall.class.isAssignableFrom(sut));
    }

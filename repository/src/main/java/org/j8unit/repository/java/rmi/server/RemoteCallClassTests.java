 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RemoteCallTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RemoteCallTests}.
 * </p>
 *
 * @see java.rmi.server.RemoteCall interface java.rmi.server.RemoteCall (the hereby targeted class-under-test class)
 * @see RemoteCallTests RemoteCallTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RemoteCallClassTests<SUT extends java.rmi.server.RemoteCall>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RemoteCall.class!",
                   java.rmi.server.RemoteCall.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketTimeoutExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SocketTimeoutExceptionTests}.
 * </p>
 *
 * @see java.net.SocketTimeoutException class java.net.SocketTimeoutException (the hereby targeted class-under-test
 *      class)
 * @see SocketTimeoutExceptionTests SocketTimeoutExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface SocketTimeoutExceptionClassTests<SUT extends java.net.SocketTimeoutException>
extends org.j8unit.repository.java.io.InterruptedIOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketTimeoutException.class!",
                   java.net.SocketTimeoutException.class.isAssignableFrom(sut));
    }

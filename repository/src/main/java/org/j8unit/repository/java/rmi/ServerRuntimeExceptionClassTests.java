 ...
 * {@link ServerRuntimeException public class java.rmi.ServerRuntimeException}.
 *
...
public abstract interface ServerRuntimeExceptionClassTests<SUT extends ServerRuntimeException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerRuntimeException.class!",
                   ServerRuntimeException.class.isAssignableFrom(sut));
    }

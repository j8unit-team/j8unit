 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerRuntimeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ServerRuntimeExceptionTests}.
 * </p>
 *
 * @see java.rmi.ServerRuntimeException class java.rmi.ServerRuntimeException (the hereby targeted class-under-test
 *      class)
 * @see ServerRuntimeExceptionTests ServerRuntimeExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ServerRuntimeExceptionClassTests<SUT extends java.rmi.ServerRuntimeException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.ServerRuntimeException.class!",
                   java.rmi.ServerRuntimeException.class.isAssignableFrom(sut));
    }

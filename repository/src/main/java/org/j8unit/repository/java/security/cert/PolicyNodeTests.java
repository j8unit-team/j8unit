 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyNode
 * public abstract interface java.security.cert.PolicyNode}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.security.cert.PolicyNodeClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface PolicyNodeTests<SUT extends PolicyNode>
extends RepositoryTests<SUT> {
     ...
     * abstract java.util.Iterator<? extends java.security.cert.PolicyNode>

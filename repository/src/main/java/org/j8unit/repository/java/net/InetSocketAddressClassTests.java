...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.InetSocketAddress class java.net.InetSocketAddress},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InetSocketAddressTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InetSocketAddressTests}.
 * </p>
 *
 * @see java.net.InetSocketAddress class java.net.InetSocketAddress (the hereby targeted class-under-test class)
 * @see InetSocketAddressTests InetSocketAddressTests (The complementary j8unit test interface containing the instance
...
extends SocketAddressClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.InetSocketAddress.class!",
                   java.net.InetSocketAddress.class.isAssignableFrom(sut));
    }

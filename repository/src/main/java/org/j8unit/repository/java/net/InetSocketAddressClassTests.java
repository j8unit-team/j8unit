 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.net.InetSocketAddress
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.net.SocketAddressClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.net.InetSocketAddress#InetSocketAddress(java.net.InetAddress, int)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.net.InetSocketAddress#InetSocketAddress(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.net.InetSocketAddress#InetSocketAddress(java.lang.String, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.net.InetSocketAddress#createUnresolved(java.lang.String, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.net.InetSocketAddress#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

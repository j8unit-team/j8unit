 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InetSocketAddress
...
public abstract interface InetSocketAddressClassTests<SUT extends InetSocketAddress>
extends SocketAddressClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.net.InetSocketAddress]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InetSocketAddress.class!",
                   InetSocketAddress.class.isAssignableFrom(sut));
    }

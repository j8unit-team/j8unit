...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain TypeNotPresentException class java.lang.TypeNotPresentException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeNotPresentExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see TypeNotPresentExceptionTests TypeNotPresentExceptionTests (The complementary j8unit test interface containing
...
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeNotPresentException.class!",

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputContext public
...
public abstract interface InputContextClassTests<SUT extends InputContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputContext.class!",
                   InputContext.class.isAssignableFrom(sut));
    }

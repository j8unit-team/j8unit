 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IOException public
...
public abstract interface IOExceptionClassTests<SUT extends IOException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IOException.class!",
                   IOException.class.isAssignableFrom(sut));
    }

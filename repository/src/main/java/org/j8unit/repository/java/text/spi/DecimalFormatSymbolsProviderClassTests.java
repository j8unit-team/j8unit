 ...
 * {@link DecimalFormatSymbolsProvider public abstract class java.text.spi.DecimalFormatSymbolsProvider}.
 *
...
public abstract interface DecimalFormatSymbolsProviderClassTests<SUT extends DecimalFormatSymbolsProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DecimalFormatSymbolsProvider.class!",
                   DecimalFormatSymbolsProvider.class.isAssignableFrom(sut));
    }

 ...
 * java.text.spi.DecimalFormatSymbolsProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link DecimalFormatSymbolsProviderTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.text.spi.DecimalFormatSymbolsProvider class java.text.spi.DecimalFormatSymbolsProvider (the hereby targeted
 *      class-under-test class)
 * @see DecimalFormatSymbolsProviderTests DecimalFormatSymbolsProviderTests (The complementary j8unit test interface
...
public abstract interface DecimalFormatSymbolsProviderClassTests<SUT extends java.text.spi.DecimalFormatSymbolsProvider>
extends org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.spi.DecimalFormatSymbolsProvider.class!",
                   java.text.spi.DecimalFormatSymbolsProvider.class.isAssignableFrom(sut));
    }

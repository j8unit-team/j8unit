 ...
 * java.lang.reflect.UndeclaredThrowableException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UndeclaredThrowableExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UndeclaredThrowableExceptionTests UndeclaredThrowableExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.UndeclaredThrowableException.class!",
                   java.lang.reflect.UndeclaredThrowableException.class.isAssignableFrom(sut));
    }

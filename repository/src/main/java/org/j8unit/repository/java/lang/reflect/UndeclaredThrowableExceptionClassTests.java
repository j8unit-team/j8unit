 ...
 * {@link UndeclaredThrowableException public class java.lang.reflect.UndeclaredThrowableException}.
 *
...
public abstract interface UndeclaredThrowableExceptionClassTests<SUT extends UndeclaredThrowableException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UndeclaredThrowableException.class!",
                   UndeclaredThrowableException.class.isAssignableFrom(sut));
    }

...
public abstract interface BeanContextChildSupportClassTests<SUT extends BeanContextChildSupport>
extends BeanContextChildClassTests<SUT>, BeanContextServicesListenerClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextChildSupport.class!",

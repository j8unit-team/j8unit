 ...
 * java.beans.beancontext.BeanContextMembershipEvent}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextMembershipEventTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.beans.beancontext.BeanContextMembershipEvent class java.beans.beancontext.BeanContextMembershipEvent (the
 *      hereby targeted class-under-test class)
 * @see BeanContextMembershipEventTests BeanContextMembershipEventTests (The complementary j8unit test interface
...
extends BeanContextEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextMembershipEvent.class!",
                   java.beans.beancontext.BeanContextMembershipEvent.class.isAssignableFrom(sut));
    }

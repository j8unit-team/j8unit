 ...
 * {@link BeanContextMembershipEvent public class java.beans.beancontext.BeanContextMembershipEvent}.
 *
...
public abstract interface BeanContextMembershipEventClassTests<SUT extends BeanContextMembershipEvent>
extends BeanContextEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextMembershipEvent.class!",
                   BeanContextMembershipEvent.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.beans.beancontext.BeanContextMembershipEvent]

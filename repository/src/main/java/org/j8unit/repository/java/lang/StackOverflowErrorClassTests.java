...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain StackOverflowError class java.lang.StackOverflowError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StackOverflowErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StackOverflowErrorTests}.
 * </p>
 *
 * @see StackOverflowError class java.lang.StackOverflowError (the hereby targeted class-under-test class)
 * @see StackOverflowErrorTests StackOverflowErrorTests (The complementary j8unit test interface containing the instance
...
public abstract interface StackOverflowErrorClassTests<SUT extends StackOverflowError>
extends VirtualMachineErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StackOverflowError.class!",
                   StackOverflowError.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PSSParameterSpec
...
public abstract interface PSSParameterSpecClassTests<SUT extends PSSParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PSSParameterSpec.class!",
                   PSSParameterSpec.class.isAssignableFrom(sut));
    }

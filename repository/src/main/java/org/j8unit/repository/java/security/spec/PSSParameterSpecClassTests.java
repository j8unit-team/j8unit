 ...
 * java.security.spec.PSSParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PSSParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PSSParameterSpecTests}.
 * </p>
 *
 * @see java.security.spec.PSSParameterSpec class java.security.spec.PSSParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see PSSParameterSpecTests PSSParameterSpecTests (The complementary j8unit test interface containing the instance
...
public abstract interface PSSParameterSpecClassTests<SUT extends java.security.spec.PSSParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.PSSParameterSpec.class!",
                   java.security.spec.PSSParameterSpec.class.isAssignableFrom(sut));
    }

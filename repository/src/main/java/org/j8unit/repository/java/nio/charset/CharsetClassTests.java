 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Charset public
 * abstract class java.nio.charset.Charset}.
 *
...
public abstract interface CharsetClassTests<SUT extends Charset>
extends ComparableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Charset.class!",
                   Charset.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharsetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharsetTests}.
 * </p>
 *
 * @see java.nio.charset.Charset class java.nio.charset.Charset (the hereby targeted class-under-test class)
 * @see CharsetTests CharsetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.Charset.class!",
                   java.nio.charset.Charset.class.isAssignableFrom(sut));
    }

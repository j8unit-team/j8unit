 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMethodEvent
 * public class java.awt.event.InputMethodEvent}.
 *
...
public abstract interface InputMethodEventClassTests<SUT extends InputMethodEvent>
extends AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMethodEvent.class!",
                   InputMethodEvent.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.event.InputMethodEvent]

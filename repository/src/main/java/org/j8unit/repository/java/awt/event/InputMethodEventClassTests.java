...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.InputMethodEvent class java.awt.event.InputMethodEvent}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputMethodEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InputMethodEventTests}.
 * </p>
 *
 * @see java.awt.event.InputMethodEvent class java.awt.event.InputMethodEvent (the hereby targeted class-under-test
 *      class)
 * @see InputMethodEventTests InputMethodEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface InputMethodEventClassTests<SUT extends java.awt.event.InputMethodEvent>
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.InputMethodEvent.class!",
                   java.awt.event.InputMethodEvent.class.isAssignableFrom(sut));
    }

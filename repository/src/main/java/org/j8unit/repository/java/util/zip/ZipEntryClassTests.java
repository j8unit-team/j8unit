 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZipEntry public
...
public abstract interface ZipEntryClassTests<SUT extends ZipEntry>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZipEntry.class!",
                   ZipEntry.class.isAssignableFrom(sut));
    }

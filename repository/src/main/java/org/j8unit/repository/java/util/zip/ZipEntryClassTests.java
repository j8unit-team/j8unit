 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZipEntryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZipEntryTests}.
 * </p>
 *
 * @see java.util.zip.ZipEntry class java.util.zip.ZipEntry (the hereby targeted class-under-test class)
 * @see ZipEntryTests ZipEntryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ZipEntryClassTests<SUT extends java.util.zip.ZipEntry>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.ZipEntry.class!",
                   java.util.zip.ZipEntry.class.isAssignableFrom(sut));
    }

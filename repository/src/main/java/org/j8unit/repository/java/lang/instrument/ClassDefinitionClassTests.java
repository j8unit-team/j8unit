 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ClassDefinition
...
public abstract interface ClassDefinitionClassTests<SUT extends ClassDefinition>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassDefinition.class!",
                   ClassDefinition.class.isAssignableFrom(sut));
    }

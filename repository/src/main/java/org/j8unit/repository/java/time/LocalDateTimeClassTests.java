...
import org.j8unit.repository.java.time.chrono.ChronoLocalDateTimeClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LocalDateTime
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LocalDateTimeTests}.
 * </p>
 *
 * <p>
...
public abstract interface LocalDateTimeClassTests<SUT extends LocalDateTime>
extends ChronoLocalDateTimeClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LocalDateTime.class!",
                   LocalDateTime.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.LocalDateTime class java.time.LocalDateTime}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocalDateTimeTests}).
 * </p>
 *
 * <p>
 ...
 * @see LocalDateTimeTests LocalDateTimeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.LocalDateTime.class!",
                   java.time.LocalDateTime.class.isAssignableFrom(sut));
    }

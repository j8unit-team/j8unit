 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GridBagConstraints
...
public abstract interface GridBagConstraintsClassTests<SUT extends GridBagConstraints>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GridBagConstraints.class!",
                   GridBagConstraints.class.isAssignableFrom(sut));
    }

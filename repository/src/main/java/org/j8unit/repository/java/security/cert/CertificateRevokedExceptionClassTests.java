 ...
 * {@link CertificateRevokedException public class java.security.cert.CertificateRevokedException}.
 *
...
public abstract interface CertificateRevokedExceptionClassTests<SUT extends CertificateRevokedException>
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertificateRevokedException.class!",
                   CertificateRevokedException.class.isAssignableFrom(sut));
    }

 ...
 * java.security.cert.CertificateRevokedException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CertificateRevokedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see CertificateRevokedExceptionTests CertificateRevokedExceptionTests (The complementary j8unit test interface
...
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateRevokedException.class!",
                   java.security.cert.CertificateRevokedException.class.isAssignableFrom(sut));
    }

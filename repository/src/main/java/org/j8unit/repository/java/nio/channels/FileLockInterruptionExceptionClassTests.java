 ...
 * {@link FileLockInterruptionException public class java.nio.channels.FileLockInterruptionException}.
 *
...
public abstract interface FileLockInterruptionExceptionClassTests<SUT extends FileLockInterruptionException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileLockInterruptionException.class!",
                   FileLockInterruptionException.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.FileLockInterruptionException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link FileLockInterruptionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.channels.FileLockInterruptionException class java.nio.channels.FileLockInterruptionException (the
 *      hereby targeted class-under-test class)
 * @see FileLockInterruptionExceptionTests FileLockInterruptionExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.FileLockInterruptionException.class!",
                   java.nio.channels.FileLockInterruptionException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BorderLayout public
...
public abstract interface BorderLayoutClassTests<SUT extends BorderLayout>
extends LayoutManager2ClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BorderLayout.class!",
                   BorderLayout.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Deque interface java.util.Deque}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DequeTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.Deque interface java.util.Deque (the hereby targeted class-under-test class)
 * @see DequeTests DequeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DequeClassTests<SUT extends java.util.Deque>
extends QueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Deque.class!",
                   java.util.Deque.class.isAssignableFrom(sut));
    }

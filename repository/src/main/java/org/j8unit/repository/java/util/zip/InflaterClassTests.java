 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Inflater public
...
public abstract interface InflaterClassTests<SUT extends Inflater>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Inflater.class!",
                   Inflater.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.Inflater class java.util.zip.Inflater}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InflaterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InflaterTests}.
 * </p>
 *
 * @see java.util.zip.Inflater class java.util.zip.Inflater (the hereby targeted class-under-test class)
 * @see InflaterTests InflaterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InflaterClassTests<SUT extends java.util.zip.Inflater>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.Inflater.class!",
                   java.util.zip.Inflater.class.isAssignableFrom(sut));
    }

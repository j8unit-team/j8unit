 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ButtonPeer public
 * abstract interface java.awt.peer.ButtonPeer}.
 *
...
public abstract interface ButtonPeerClassTests<SUT extends ButtonPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ButtonPeer.class!",
                   ButtonPeer.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ButtonPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ButtonPeerTests}.
 * </p>
 *
 * @see java.awt.peer.ButtonPeer interface java.awt.peer.ButtonPeer (the hereby targeted class-under-test class)
 * @see ButtonPeerTests ButtonPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ButtonPeerClassTests<SUT extends java.awt.peer.ButtonPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.ButtonPeer.class!",
                   java.awt.peer.ButtonPeer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.PaintContext interface java.awt.PaintContext}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PaintContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PaintContextTests}.
 * </p>
 *
 * @see java.awt.PaintContext interface java.awt.PaintContext (the hereby targeted class-under-test class)
 * @see PaintContextTests PaintContextTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PaintContextClassTests<SUT extends java.awt.PaintContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.PaintContext.class!",
                   java.awt.PaintContext.class.isAssignableFrom(sut));
    }

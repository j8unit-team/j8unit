 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PaintContext public
 * abstract interface java.awt.PaintContext}.
 *
...
public abstract interface PaintContextClassTests<SUT extends PaintContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PaintContext.class!",
                   PaintContext.class.isAssignableFrom(sut));
    }

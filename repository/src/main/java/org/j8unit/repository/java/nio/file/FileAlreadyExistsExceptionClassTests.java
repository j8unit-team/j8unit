 ...
 * java.nio.file.FileAlreadyExistsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link FileAlreadyExistsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileAlreadyExistsExceptionTests FileAlreadyExistsExceptionTests (The complementary j8unit test interface
...
public abstract interface FileAlreadyExistsExceptionClassTests<SUT extends java.nio.file.FileAlreadyExistsException>
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileAlreadyExistsException.class!",
                   java.nio.file.FileAlreadyExistsException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain VerifyError class java.lang.VerifyError}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VerifyErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link VerifyErrorTests}.
 * </p>
 *
 * @see VerifyError class java.lang.VerifyError (the hereby targeted class-under-test class)
 * @see VerifyErrorTests VerifyErrorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface VerifyErrorClassTests<SUT extends VerifyError>
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VerifyError.class!",
                   VerifyError.class.isAssignableFrom(sut));
    }

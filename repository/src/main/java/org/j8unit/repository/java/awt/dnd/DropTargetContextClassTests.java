 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTargetContext
 * public class java.awt.dnd.DropTargetContext}.
 *
...
public abstract interface DropTargetContextClassTests<SUT extends DropTargetContext>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetContext.class!",
                   DropTargetContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Time public class
 * java.sql.Time}.
 *
...
extends DateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Time.class!", Time.class.isAssignableFrom(sut));
    }

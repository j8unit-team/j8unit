...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain java.sql.Time class java.sql.Time}, containing all class relevant test
...
extends org.j8unit.repository.java.util.DateClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.sql.Time#Time(int, int, int)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.sql.Time#Time(long)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.sql.Time#valueOf(java.time.LocalTime)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.sql.Time#valueOf(java.lang.String)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.sql.Time#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

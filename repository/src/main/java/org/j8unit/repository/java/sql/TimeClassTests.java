...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Time class java.sql.Time}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimeTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.sql.Time class java.sql.Time (the hereby targeted class-under-test class)
 * @see TimeTests TimeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface TimeClassTests<SUT extends java.sql.Time>
extends org.j8unit.repository.java.util.DateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Time.class!",
                   java.sql.Time.class.isAssignableFrom(sut));
    }

 ...
 * java.util.FormatterClosedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormatterClosedExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link FormatterClosedExceptionTests}.
 * </p>
 *
 * @see java.util.FormatterClosedException class java.util.FormatterClosedException (the hereby targeted
 *      class-under-test class)
 * @see FormatterClosedExceptionTests FormatterClosedExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.FormatterClosedException.class!",
                   java.util.FormatterClosedException.class.isAssignableFrom(sut));
    }

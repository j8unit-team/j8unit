...
public abstract interface FormatterClosedExceptionClassTests<SUT extends FormatterClosedException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormatterClosedException.class!",
                   FormatterClosedException.class.isAssignableFrom(sut));
    }

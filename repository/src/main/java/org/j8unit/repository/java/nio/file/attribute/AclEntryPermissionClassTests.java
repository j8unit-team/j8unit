 ...
 * java.nio.file.attribute.AclEntryPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AclEntryPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AclEntryPermissionTests}.
 * </p>
 *
 * @see java.nio.file.attribute.AclEntryPermission class java.nio.file.attribute.AclEntryPermission (the hereby targeted
 *      class-under-test class)
 * @see AclEntryPermissionTests AclEntryPermissionTests (The complementary j8unit test interface containing the instance
...
public abstract interface AclEntryPermissionClassTests<SUT extends java.nio.file.attribute.AclEntryPermission>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.AclEntryPermission.class!",
                   java.nio.file.attribute.AclEntryPermission.class.isAssignableFrom(sut));
    }

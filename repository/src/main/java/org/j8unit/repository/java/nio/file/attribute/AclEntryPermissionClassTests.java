 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AclEntryPermission
 * public final enum java.nio.file.attribute.AclEntryPermission}.
 *
...
public abstract interface AclEntryPermissionClassTests<SUT extends AclEntryPermission>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AclEntryPermission.class!",
                   AclEntryPermission.class.isAssignableFrom(sut));
    }

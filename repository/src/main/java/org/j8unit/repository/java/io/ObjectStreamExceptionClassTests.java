 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectStreamExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ObjectStreamExceptionTests}.
 * </p>
 *
 * @see java.io.ObjectStreamException class java.io.ObjectStreamException (the hereby targeted class-under-test class)
 * @see ObjectStreamExceptionTests ObjectStreamExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ObjectStreamExceptionClassTests<SUT extends java.io.ObjectStreamException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectStreamException.class!",
                   java.io.ObjectStreamException.class.isAssignableFrom(sut));
    }

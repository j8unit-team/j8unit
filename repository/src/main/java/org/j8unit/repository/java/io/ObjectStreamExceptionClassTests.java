 ...
 * {@link ObjectStreamException public abstract class java.io.ObjectStreamException}.
 *
...
public abstract interface ObjectStreamExceptionClassTests<SUT extends ObjectStreamException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectStreamException.class!",
                   ObjectStreamException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.io.ObjectStreamException]

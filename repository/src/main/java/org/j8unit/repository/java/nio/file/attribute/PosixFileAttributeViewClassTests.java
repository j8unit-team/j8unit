 ...
 * java.nio.file.attribute.PosixFileAttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PosixFileAttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 * @see PosixFileAttributeViewTests PosixFileAttributeViewTests (The complementary j8unit test interface containing the
...
public abstract interface PosixFileAttributeViewClassTests<SUT extends java.nio.file.attribute.PosixFileAttributeView>
extends BasicFileAttributeViewClassTests<SUT>, FileOwnerAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.PosixFileAttributeView.class!",
                   java.nio.file.attribute.PosixFileAttributeView.class.isAssignableFrom(sut));
    }

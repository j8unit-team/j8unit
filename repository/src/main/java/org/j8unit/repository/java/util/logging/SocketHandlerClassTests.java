 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketHandlerTests}.
 * </p>
 *
 * @see java.util.logging.SocketHandler class java.util.logging.SocketHandler (the hereby targeted class-under-test
 *      class)
 * @see SocketHandlerTests SocketHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SocketHandlerClassTests<SUT extends java.util.logging.SocketHandler>
extends StreamHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.SocketHandler.class!",
                   java.util.logging.SocketHandler.class.isAssignableFrom(sut));
    }

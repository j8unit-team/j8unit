 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketHandler
...
public abstract interface SocketHandlerClassTests<SUT extends SocketHandler>
extends StreamHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketHandler.class!",
                   SocketHandler.class.isAssignableFrom(sut));
    }

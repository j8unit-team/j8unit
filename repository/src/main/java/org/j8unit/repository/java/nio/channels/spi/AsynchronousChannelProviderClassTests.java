 ...
 * java.nio.channels.spi.AsynchronousChannelProvider}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AsynchronousChannelProviderTests}).
 * </p>
 *
 * <p>
 ...
 * @see AsynchronousChannelProviderTests AsynchronousChannelProviderTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.spi.AsynchronousChannelProvider.class!",
                   java.nio.channels.spi.AsynchronousChannelProvider.class.isAssignableFrom(sut));
    }

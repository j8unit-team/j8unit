...
public abstract interface AsynchronousChannelProviderClassTests<SUT extends AsynchronousChannelProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsynchronousChannelProvider.class!",
                   AsynchronousChannelProvider.class.isAssignableFrom(sut));
    }

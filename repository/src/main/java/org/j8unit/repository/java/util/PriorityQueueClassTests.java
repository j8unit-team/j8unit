 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.PriorityQueue
 */
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.PriorityQueue#PriorityQueue()
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.PriorityQueue#PriorityQueue(java.util.Collection)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.PriorityQueue#PriorityQueue(java.util.Comparator)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.PriorityQueue#PriorityQueue(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.PriorityQueue#PriorityQueue(int, java.util.Comparator)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.PriorityQueue#PriorityQueue(java.util.PriorityQueue)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.PriorityQueue#PriorityQueue(java.util.SortedSet)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.PriorityQueue#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

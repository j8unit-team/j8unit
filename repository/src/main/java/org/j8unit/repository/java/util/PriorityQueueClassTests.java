 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PriorityQueue
...
public abstract interface PriorityQueueClassTests<SUT extends PriorityQueue>
extends SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PriorityQueue.class!",
                   PriorityQueue.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.PriorityQueue class java.util.PriorityQueue}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PriorityQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PriorityQueueTests}.
 * </p>
 *
 * @see java.util.PriorityQueue class java.util.PriorityQueue (the hereby targeted class-under-test class)
 * @see PriorityQueueTests PriorityQueueTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.PriorityQueue.class!",
                   java.util.PriorityQueue.class.isAssignableFrom(sut));
    }

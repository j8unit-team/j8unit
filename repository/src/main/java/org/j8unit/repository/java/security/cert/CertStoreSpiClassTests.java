 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertStoreSpi public
 * abstract class java.security.cert.CertStoreSpi}.
 *
...
public abstract interface CertStoreSpiClassTests<SUT extends CertStoreSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertStoreSpi.class!",
                   CertStoreSpi.class.isAssignableFrom(sut));
    }

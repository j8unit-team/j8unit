 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkedTransferQueue
 * public class java.util.concurrent.LinkedTransferQueue<E>}.
 *
...
public abstract interface LinkedTransferQueueClassTests<SUT extends LinkedTransferQueue>
extends TransferQueueClassTests<SUT>, SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkedTransferQueue.class!",
                   LinkedTransferQueue.class.isAssignableFrom(sut));
    }

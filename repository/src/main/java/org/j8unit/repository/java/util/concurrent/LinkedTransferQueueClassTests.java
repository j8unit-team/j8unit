 ...
 * java.util.concurrent.LinkedTransferQueue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkedTransferQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkedTransferQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.LinkedTransferQueue class java.util.concurrent.LinkedTransferQueue (the hereby targeted
 *      class-under-test class)
 * @see LinkedTransferQueueTests LinkedTransferQueueTests (The complementary j8unit test interface containing the
...
extends TransferQueueClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.LinkedTransferQueue.class!",
                   java.util.concurrent.LinkedTransferQueue.class.isAssignableFrom(sut));
    }

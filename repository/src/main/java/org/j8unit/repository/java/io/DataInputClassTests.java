...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.DataInput interface java.io.DataInput}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataInputTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataInputTests}.
 * </p>
 *
 * @see java.io.DataInput interface java.io.DataInput (the hereby targeted class-under-test class)
 * @see DataInputTests DataInputTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DataInputClassTests<SUT extends java.io.DataInput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.DataInput.class!",
                   java.io.DataInput.class.isAssignableFrom(sut));
    }

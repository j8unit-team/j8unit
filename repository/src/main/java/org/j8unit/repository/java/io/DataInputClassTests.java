 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataInput public
 * abstract interface java.io.DataInput}.
 *
...
public abstract interface DataInputClassTests<SUT extends DataInput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataInput.class!",

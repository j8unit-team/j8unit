...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Timestamp class java.sql.Timestamp}, containing all type
...
extends org.j8unit.repository.java.util.DateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Timestamp.class!",
                   java.sql.Timestamp.class.isAssignableFrom(sut));
    }

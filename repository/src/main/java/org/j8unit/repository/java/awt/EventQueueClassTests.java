 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventQueue public
...
public abstract interface EventQueueClassTests<SUT extends EventQueue>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventQueue.class!",
                   EventQueue.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamTokenizerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamTokenizerTests}.
 * </p>
 *
 * @see java.io.StreamTokenizer class java.io.StreamTokenizer (the hereby targeted class-under-test class)
 * @see StreamTokenizerTests StreamTokenizerTests (The complementary j8unit test interface containing the instance
...
public abstract interface StreamTokenizerClassTests<SUT extends java.io.StreamTokenizer>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.StreamTokenizer.class!",
                   java.io.StreamTokenizer.class.isAssignableFrom(sut));
    }

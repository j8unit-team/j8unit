 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StreamTokenizer
...
public abstract interface StreamTokenizerClassTests<SUT extends StreamTokenizer>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamTokenizer.class!",
                   StreamTokenizer.class.isAssignableFrom(sut));
    }

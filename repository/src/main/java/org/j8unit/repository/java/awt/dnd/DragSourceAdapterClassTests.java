 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragSourceAdapter
 * public abstract class java.awt.dnd.DragSourceAdapter}.
 *
...
public abstract interface DragSourceAdapterClassTests<SUT extends DragSourceAdapter>
extends DragSourceListenerClassTests<SUT>, DragSourceMotionListenerClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.dnd.DragSourceAdapter]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSourceAdapter.class!",
                   DragSourceAdapter.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.dnd.DragSourceAdapter]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.awt.dnd.DragSourceAdapter]

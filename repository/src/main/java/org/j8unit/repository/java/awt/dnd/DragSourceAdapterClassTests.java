 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragSourceAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DragSourceAdapterTests}.
 * </p>
 *
 * @see java.awt.dnd.DragSourceAdapter class java.awt.dnd.DragSourceAdapter (the hereby targeted class-under-test class)
 * @see DragSourceAdapterTests DragSourceAdapterTests (The complementary j8unit test interface containing the instance
...
public abstract interface DragSourceAdapterClassTests<SUT extends java.awt.dnd.DragSourceAdapter>
extends DragSourceListenerClassTests<SUT>, DragSourceMotionListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragSourceAdapter.class!",
                   java.awt.dnd.DragSourceAdapter.class.isAssignableFrom(sut));
    }

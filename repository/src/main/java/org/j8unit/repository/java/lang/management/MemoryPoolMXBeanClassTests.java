 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MemoryPoolMXBean
 * public abstract interface java.lang.management.MemoryPoolMXBean}.
 *
...
public abstract interface MemoryPoolMXBeanClassTests<SUT extends MemoryPoolMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryPoolMXBean.class!",
                   MemoryPoolMXBean.class.isAssignableFrom(sut));
    }

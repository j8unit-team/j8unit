 ...
 * java.lang.management.MemoryPoolMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MemoryPoolMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MemoryPoolMXBeanTests}.
 * </p>
 *
 * @see java.lang.management.MemoryPoolMXBean interface java.lang.management.MemoryPoolMXBean (the hereby targeted
 *      class-under-test class)
 * @see MemoryPoolMXBeanTests MemoryPoolMXBeanTests (The complementary j8unit test interface containing the instance
...
public abstract interface MemoryPoolMXBeanClassTests<SUT extends java.lang.management.MemoryPoolMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.MemoryPoolMXBean.class!",
                   java.lang.management.MemoryPoolMXBean.class.isAssignableFrom(sut));
    }

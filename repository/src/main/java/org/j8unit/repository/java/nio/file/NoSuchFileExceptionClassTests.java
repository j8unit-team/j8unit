 ...
 * java.nio.file.NoSuchFileException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchFileExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NoSuchFileExceptionTests}.
 * </p>
 *
 * @see java.nio.file.NoSuchFileException class java.nio.file.NoSuchFileException (the hereby targeted class-under-test
 *      class)
 * @see NoSuchFileExceptionTests NoSuchFileExceptionTests (The complementary j8unit test interface containing the
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.NoSuchFileException.class!",
                   java.nio.file.NoSuchFileException.class.isAssignableFrom(sut));
    }

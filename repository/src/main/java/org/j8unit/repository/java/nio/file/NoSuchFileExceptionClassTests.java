 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NoSuchFileException
 * public class java.nio.file.NoSuchFileException}.
 *
...
public abstract interface NoSuchFileExceptionClassTests<SUT extends NoSuchFileException>
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchFileException.class!",
                   NoSuchFileException.class.isAssignableFrom(sut));
    }

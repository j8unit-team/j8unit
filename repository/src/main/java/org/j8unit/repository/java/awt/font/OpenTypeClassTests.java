 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OpenType public
 * abstract interface java.awt.font.OpenType}.
 *
...
public abstract interface OpenTypeClassTests<SUT extends OpenType>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenType.class!",
                   OpenType.class.isAssignableFrom(sut));
    }

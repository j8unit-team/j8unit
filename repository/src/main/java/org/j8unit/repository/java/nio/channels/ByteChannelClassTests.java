 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ByteChannel public
 * abstract interface java.nio.channels.ByteChannel}.
 *
...
public abstract interface ByteChannelClassTests<SUT extends ByteChannel>
extends org.j8unit.repository.java.nio.channels.ReadableByteChannelClassTests<SUT>, org.j8unit.repository.java.nio.channels.WritableByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ByteChannel.class!",
                   ByteChannel.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ByteChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ByteChannelTests}.
 * </p>
 *
 * @see java.nio.channels.ByteChannel interface java.nio.channels.ByteChannel (the hereby targeted class-under-test
 *      class)
 * @see ByteChannelTests ByteChannelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ByteChannelClassTests<SUT extends java.nio.channels.ByteChannel>
extends ReadableByteChannelClassTests<SUT>, WritableByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ByteChannel.class!",
                   java.nio.channels.ByteChannel.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Readable interface java.lang.Readable}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReadableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReadableTests}.
 * </p>
 *
 * @see Readable interface java.lang.Readable (the hereby targeted class-under-test class)
 * @see ReadableTests ReadableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ReadableClassTests<SUT extends Readable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Readable.class!",

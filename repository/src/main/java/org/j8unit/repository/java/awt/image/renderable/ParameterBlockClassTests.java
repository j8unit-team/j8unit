 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParameterBlock
...
public abstract interface ParameterBlockClassTests<SUT extends ParameterBlock>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.renderable.ParameterBlock]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParameterBlock.class!",
                   ParameterBlock.class.isAssignableFrom(sut));
    }

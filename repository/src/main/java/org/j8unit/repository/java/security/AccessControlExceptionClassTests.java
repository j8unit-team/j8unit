 ...
 * java.security.AccessControlException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessControlExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AccessControlExceptionTests}.
 * </p>
 *
 * @see java.security.AccessControlException class java.security.AccessControlException (the hereby targeted
 *      class-under-test class)
 * @see AccessControlExceptionTests AccessControlExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.SecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.AccessControlException.class!",
                   java.security.AccessControlException.class.isAssignableFrom(sut));
    }

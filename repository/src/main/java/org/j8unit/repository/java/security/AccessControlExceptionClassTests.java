 ...
 * {@link AccessControlException public class java.security.AccessControlException}.
 *
...
public abstract interface AccessControlExceptionClassTests<SUT extends AccessControlException>
extends SecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessControlException.class!",
                   AccessControlException.class.isAssignableFrom(sut));
    }

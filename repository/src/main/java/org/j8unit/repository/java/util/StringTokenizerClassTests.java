 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringTokenizerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringTokenizerTests}.
 * </p>
 *
 * @see java.util.StringTokenizer class java.util.StringTokenizer (the hereby targeted class-under-test class)
 * @see StringTokenizerTests StringTokenizerTests (The complementary j8unit test interface containing the instance
...
extends EnumerationClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.StringTokenizer.class!",
                   java.util.StringTokenizer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringTokenizer
...
public abstract interface StringTokenizerClassTests<SUT extends StringTokenizer>
extends EnumerationClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringTokenizer.class!",
                   StringTokenizer.class.isAssignableFrom(sut));
    }

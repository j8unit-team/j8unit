 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActivationDesc
 * public final class java.rmi.activation.ActivationDesc}.
 *
...
public abstract interface ActivationDescClassTests<SUT extends ActivationDesc>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationDesc.class!",
                   ActivationDesc.class.isAssignableFrom(sut));
    }

 ...
 * {@link ReadOnlyBufferException public class java.nio.ReadOnlyBufferException}.
 *
...
public abstract interface ReadOnlyBufferExceptionClassTests<SUT extends ReadOnlyBufferException>
extends org.j8unit.repository.java.lang.UnsupportedOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReadOnlyBufferException.class!",
                   ReadOnlyBufferException.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.ReadOnlyBufferException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReadOnlyBufferExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ReadOnlyBufferExceptionTests}.
 * </p>
 *
 * @see java.nio.ReadOnlyBufferException class java.nio.ReadOnlyBufferException (the hereby targeted class-under-test
 *      class)
 * @see ReadOnlyBufferExceptionTests ReadOnlyBufferExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.UnsupportedOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.ReadOnlyBufferException.class!",
                   java.nio.ReadOnlyBufferException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ICC_ProfileGray
...
extends org.j8unit.repository.java.awt.color.ICC_ProfileClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ICC_ProfileGray.class!",

 ...
 * {@link MultiPixelPackedSampleModel public class java.awt.image.MultiPixelPackedSampleModel}.
 *
...
public abstract interface MultiPixelPackedSampleModelClassTests<SUT extends MultiPixelPackedSampleModel>
extends SampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultiPixelPackedSampleModel.class!",
                   MultiPixelPackedSampleModel.class.isAssignableFrom(sut));
    }

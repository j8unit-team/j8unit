 ...
 * java.awt.image.MultiPixelPackedSampleModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link MultiPixelPackedSampleModelTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.image.MultiPixelPackedSampleModel class java.awt.image.MultiPixelPackedSampleModel (the hereby targeted
 *      class-under-test class)
 * @see MultiPixelPackedSampleModelTests MultiPixelPackedSampleModelTests (The complementary j8unit test interface
...
extends SampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.MultiPixelPackedSampleModel.class!",
                   java.awt.image.MultiPixelPackedSampleModel.class.isAssignableFrom(sut));
    }

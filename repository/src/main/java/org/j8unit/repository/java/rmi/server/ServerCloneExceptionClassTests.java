...
import org.j8unit.repository.java.lang.CloneNotSupportedExceptionClassTests;
 ...
 * {@link ServerCloneException public class java.rmi.server.ServerCloneException}.
 *
 ...
 * {@link ServerCloneExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface ServerCloneExceptionClassTests<SUT extends ServerCloneException>
extends CloneNotSupportedExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerCloneException.class!",
                   ServerCloneException.class.isAssignableFrom(sut));
    }

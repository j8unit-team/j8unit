...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.server.ServerCloneException class
 * java.rmi.server.ServerCloneException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerCloneExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServerCloneExceptionTests}
 * .
 * </p>
 *
 * @see java.rmi.server.ServerCloneException class java.rmi.server.ServerCloneException (the hereby targeted
 *      class-under-test class)
 * @see ServerCloneExceptionTests ServerCloneExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.CloneNotSupportedExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.ServerCloneException.class!",
                   java.rmi.server.ServerCloneException.class.isAssignableFrom(sut));
    }

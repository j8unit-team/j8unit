...
public abstract interface NonWritableChannelExceptionClassTests<SUT extends NonWritableChannelException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NonWritableChannelException.class!",
                   NonWritableChannelException.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.NonWritableChannelException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link NonWritableChannelExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see NonWritableChannelExceptionTests NonWritableChannelExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.NonWritableChannelException.class!",
                   java.nio.channels.NonWritableChannelException.class.isAssignableFrom(sut));
    }

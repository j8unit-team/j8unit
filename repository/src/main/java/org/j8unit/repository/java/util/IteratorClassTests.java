...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Iterator interface java.util.Iterator}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IteratorTests}).
 * </p>
 *
 * <p>
 ...
 * @see IteratorTests IteratorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Iterator.class!",
                   java.util.Iterator.class.isAssignableFrom(sut));
    }

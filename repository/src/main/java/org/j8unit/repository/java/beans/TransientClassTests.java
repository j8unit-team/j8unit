...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.Transient interface java.beans.Transient}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransientTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransientTests}.
 * </p>
 *
 * @see java.beans.Transient interface java.beans.Transient (the hereby targeted class-under-test class)
 * @see TransientTests TransientTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TransientClassTests<SUT extends java.beans.Transient>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.Transient.class!",
                   java.beans.Transient.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.BlockingQueue interface
 * java.util.concurrent.BlockingQueue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BlockingQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BlockingQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.BlockingQueue interface java.util.concurrent.BlockingQueue (the hereby targeted
 *      class-under-test class)
 * @see BlockingQueueTests BlockingQueueTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface BlockingQueueClassTests<SUT extends java.util.concurrent.BlockingQueue>
extends org.j8unit.repository.java.util.QueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.BlockingQueue.class!",
                   java.util.concurrent.BlockingQueue.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.util.QueueClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BlockingQueue
 * public abstract interface java.util.concurrent.BlockingQueue<E>}.
 *
...
public abstract interface BlockingQueueClassTests<SUT extends BlockingQueue>
extends QueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BlockingQueue.class!",
                   BlockingQueue.class.isAssignableFrom(sut));
    }

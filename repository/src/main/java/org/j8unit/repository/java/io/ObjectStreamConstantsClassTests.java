...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.ObjectStreamConstants interface java.io.ObjectStreamConstants}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectStreamConstantsTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ObjectStreamConstantsTests}.
 * </p>
 *
 * @see java.io.ObjectStreamConstants interface java.io.ObjectStreamConstants (the hereby targeted class-under-test
 *      class)
 * @see ObjectStreamConstantsTests ObjectStreamConstantsTests (The complementary j8unit test interface containing the
...
public abstract interface ObjectStreamConstantsClassTests<SUT extends java.io.ObjectStreamConstants>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectStreamConstants.class!",
                   java.io.ObjectStreamConstants.class.isAssignableFrom(sut));
    }

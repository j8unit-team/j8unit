 ...
 * {@link ObjectStreamConstants public abstract interface java.io.ObjectStreamConstants}.
 *
...
public abstract interface ObjectStreamConstantsClassTests<SUT extends ObjectStreamConstants>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectStreamConstants.class!",
                   ObjectStreamConstants.class.isAssignableFrom(sut));
    }

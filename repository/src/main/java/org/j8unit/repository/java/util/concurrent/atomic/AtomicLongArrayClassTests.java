 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AtomicLongArray
...
public abstract interface AtomicLongArrayClassTests<SUT extends AtomicLongArray>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicLongArray.class!",
                   AtomicLongArray.class.isAssignableFrom(sut));
    }

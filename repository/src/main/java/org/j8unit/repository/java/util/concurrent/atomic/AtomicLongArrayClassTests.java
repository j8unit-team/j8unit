...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.atomic.AtomicLongArray class
 * java.util.concurrent.atomic.AtomicLongArray}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicLongArrayTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AtomicLongArrayTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.AtomicLongArray class java.util.concurrent.atomic.AtomicLongArray (the hereby
 *      targeted class-under-test class)
 * @see AtomicLongArrayTests AtomicLongArrayTests (The complementary j8unit test interface containing the instance
...
public abstract interface AtomicLongArrayClassTests<SUT extends java.util.concurrent.atomic.AtomicLongArray>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicLongArray.class!",
                   java.util.concurrent.atomic.AtomicLongArray.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FormattableFlags
...
public abstract interface FormattableFlagsClassTests<SUT extends FormattableFlags>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormattableFlags.class!",
                   FormattableFlags.class.isAssignableFrom(sut));
    }

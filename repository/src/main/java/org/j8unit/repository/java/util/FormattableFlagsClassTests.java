...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.FormattableFlags class java.util.FormattableFlags},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormattableFlagsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FormattableFlagsTests}.
 * </p>
 *
 * @see java.util.FormattableFlags class java.util.FormattableFlags (the hereby targeted class-under-test class)
 * @see FormattableFlagsTests FormattableFlagsTests (The complementary j8unit test interface containing the instance
...
public abstract interface FormattableFlagsClassTests<SUT extends java.util.FormattableFlags>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.FormattableFlags.class!",
                   java.util.FormattableFlags.class.isAssignableFrom(sut));
    }

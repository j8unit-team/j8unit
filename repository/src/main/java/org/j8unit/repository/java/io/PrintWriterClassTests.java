 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintWriter public
...
public abstract interface PrintWriterClassTests<SUT extends PrintWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintWriter.class!",
                   PrintWriter.class.isAssignableFrom(sut));
    }

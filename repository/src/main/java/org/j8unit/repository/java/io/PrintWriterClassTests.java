...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.PrintWriter class java.io.PrintWriter}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintWriterTests}.
 * </p>
 *
 * @see java.io.PrintWriter class java.io.PrintWriter (the hereby targeted class-under-test class)
 * @see PrintWriterTests PrintWriterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PrintWriter.class!",
                   java.io.PrintWriter.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractSetTests}.
 * </p>
 *
 * @see java.util.AbstractSet class java.util.AbstractSet (the hereby targeted class-under-test class)
 * @see AbstractSetTests AbstractSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AbstractSetClassTests<SUT extends java.util.AbstractSet>
extends SetClassTests<SUT>, AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractSet.class!",
                   java.util.AbstractSet.class.isAssignableFrom(sut));
    }

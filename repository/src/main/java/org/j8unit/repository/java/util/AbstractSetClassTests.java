 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractSet public
 ...
 * {@link org.j8unit.repository.java.util.AbstractSetTests}.
 * </p>
 *
 * <p>
...
public abstract interface AbstractSetClassTests<SUT extends AbstractSet>
extends org.j8unit.repository.java.util.SetClassTests<SUT>, org.j8unit.repository.java.util.AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractSet.class!",
                   AbstractSet.class.isAssignableFrom(sut));
    }

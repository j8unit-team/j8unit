...
public abstract interface UnknownHostExceptionClassTests<SUT extends java.net.UnknownHostException>
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.UnknownHostException.class!",
                   java.net.UnknownHostException.class.isAssignableFrom(sut));
    }

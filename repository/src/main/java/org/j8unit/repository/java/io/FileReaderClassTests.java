...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.FileReader class java.io.FileReader}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileReaderTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.io.FileReader class java.io.FileReader (the hereby targeted class-under-test class)
 * @see FileReaderTests FileReaderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends InputStreamReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FileReader.class!",
                   java.io.FileReader.class.isAssignableFrom(sut));
    }

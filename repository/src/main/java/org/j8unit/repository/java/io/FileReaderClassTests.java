 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileReader public
...
extends InputStreamReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileReader.class!",
                   FileReader.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.io.FileReader]

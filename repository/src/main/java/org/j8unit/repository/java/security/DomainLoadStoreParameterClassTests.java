 ...
 * {@link DomainLoadStoreParameter public final class java.security.DomainLoadStoreParameter}.
 *
...
public abstract interface DomainLoadStoreParameterClassTests<SUT extends DomainLoadStoreParameter>
extends LoadStoreParameterClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DomainLoadStoreParameter.class!",
                   DomainLoadStoreParameter.class.isAssignableFrom(sut));
    }

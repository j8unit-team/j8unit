 ...
 * java.security.DomainLoadStoreParameter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DomainLoadStoreParameterTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link DomainLoadStoreParameterTests}.
 * </p>
 *
 * @see java.security.DomainLoadStoreParameter class java.security.DomainLoadStoreParameter (the hereby targeted
 *      class-under-test class)
 * @see DomainLoadStoreParameterTests DomainLoadStoreParameterTests (The complementary j8unit test interface containing
...
extends KeyStoreClassTests.LoadStoreParameterClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.DomainLoadStoreParameter.class!",
                   java.security.DomainLoadStoreParameter.class.isAssignableFrom(sut));
    }

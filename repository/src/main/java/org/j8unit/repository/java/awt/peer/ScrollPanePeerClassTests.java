 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScrollPanePeer
...
public abstract interface ScrollPanePeerClassTests<SUT extends ScrollPanePeer>
extends ContainerPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScrollPanePeer.class!",
                   ScrollPanePeer.class.isAssignableFrom(sut));
    }

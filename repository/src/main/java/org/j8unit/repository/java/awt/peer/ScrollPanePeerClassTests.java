...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.ScrollPanePeer interface java.awt.peer.ScrollPanePeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScrollPanePeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScrollPanePeerTests}.
 * </p>
 *
 * @see java.awt.peer.ScrollPanePeer interface java.awt.peer.ScrollPanePeer (the hereby targeted class-under-test class)
 * @see ScrollPanePeerTests ScrollPanePeerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ScrollPanePeerClassTests<SUT extends java.awt.peer.ScrollPanePeer>
extends ContainerPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.ScrollPanePeer.class!",
                   java.awt.peer.ScrollPanePeer.class.isAssignableFrom(sut));
    }

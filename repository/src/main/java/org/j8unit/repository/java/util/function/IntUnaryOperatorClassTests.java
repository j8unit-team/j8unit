...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.IntUnaryOperator interface
 * java.util.function.IntUnaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntUnaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntUnaryOperatorTests}.
 * </p>
 *
 * @see java.util.function.IntUnaryOperator interface java.util.function.IntUnaryOperator (the hereby targeted
 *      class-under-test class)
 * @see IntUnaryOperatorTests IntUnaryOperatorTests (The complementary j8unit test interface containing the instance
...
public abstract interface IntUnaryOperatorClassTests<SUT extends java.util.function.IntUnaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntUnaryOperator.class!",
                   java.util.function.IntUnaryOperator.class.isAssignableFrom(sut));
    }

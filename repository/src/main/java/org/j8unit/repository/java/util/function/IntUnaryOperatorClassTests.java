 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntUnaryOperator
 * public abstract interface java.util.function.IntUnaryOperator}.
 *
...
public abstract interface IntUnaryOperatorClassTests<SUT extends IntUnaryOperator>
extends RepositoryClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.function.IntUnaryOperator]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntUnaryOperator.class!",
                   IntUnaryOperator.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.function.IntUnaryOperator]

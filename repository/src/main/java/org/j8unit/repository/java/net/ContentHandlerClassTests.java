...
public abstract interface ContentHandlerClassTests<SUT extends java.net.ContentHandler>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.ContentHandler.class!",
                   java.net.ContentHandler.class.isAssignableFrom(sut));
    }

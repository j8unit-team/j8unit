...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Component class java.awt.Component}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentTests}).
 * </p>
 *
 * <p>
 ...
 * @see ComponentTests ComponentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.image.ImageObserverClassTests<SUT>, MenuContainerClassTests<SUT>,
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Component.class!",
                   java.awt.Component.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.awt.Component.BaselineResizeBehavior class
     * java.awt.Component$BaselineResizeBehavior}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link ComponentTests.BaselineResizeBehaviorTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ComponentTests.BaselineResizeBehaviorTests ComponentTests.BaselineResizeBehaviorTests (The complementary
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Component.BaselineResizeBehavior.class!",
                       java.awt.Component.BaselineResizeBehavior.class.isAssignableFrom(sut));
        }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.CRC32 class java.util.zip.CRC32}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CRC32Tests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CRC32Tests}.
 * </p>
 *
 * @see java.util.zip.CRC32 class java.util.zip.CRC32 (the hereby targeted class-under-test class)
 * @see CRC32Tests CRC32Tests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface CRC32ClassTests<SUT extends java.util.zip.CRC32>
extends ChecksumClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.CRC32.class!",
                   java.util.zip.CRC32.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.lang.ReadableClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CharBuffer public
 * abstract class java.nio.CharBuffer}.
 *
...
public abstract interface CharBufferClassTests<SUT extends CharBuffer>
extends ComparableClassTests<SUT>, AppendableClassTests<SUT>, CharSequenceClassTests<SUT>, ReadableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharBuffer.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Properties class java.util.Properties}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertiesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PropertiesTests}.
 * </p>
 *
 * @see java.util.Properties class java.util.Properties (the hereby targeted class-under-test class)
 * @see PropertiesTests PropertiesTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends HashtableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Properties.class!",
                   java.util.Properties.class.isAssignableFrom(sut));
    }

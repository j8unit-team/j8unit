 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Properties public
...
public abstract interface PropertiesClassTests<SUT extends Properties>
extends HashtableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Properties.class!",
                   Properties.class.isAssignableFrom(sut));
    }

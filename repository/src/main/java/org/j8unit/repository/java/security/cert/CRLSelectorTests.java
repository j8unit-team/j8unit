 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link CRLSelector
 * public abstract interface java.security.cert.CRLSelector}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.security.cert.CRLSelectorClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface CRLSelectorTests<SUT extends CRLSelector>

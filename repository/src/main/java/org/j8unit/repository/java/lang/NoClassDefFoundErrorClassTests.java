...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain NoClassDefFoundError class java.lang.NoClassDefFoundError}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoClassDefFoundErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NoClassDefFoundErrorTests}
 * .
 * </p>
 *
 * @see NoClassDefFoundError class java.lang.NoClassDefFoundError (the hereby targeted class-under-test class)
 * @see NoClassDefFoundErrorTests NoClassDefFoundErrorTests (The complementary j8unit test interface containing the
...
public abstract interface NoClassDefFoundErrorClassTests<SUT extends NoClassDefFoundError>
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoClassDefFoundError.class!",
                   NoClassDefFoundError.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.AsynchronousChannelGroup}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AsynchronousChannelGroupTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AsynchronousChannelGroupTests}.
 * </p>
 *
 * @see java.nio.channels.AsynchronousChannelGroup class java.nio.channels.AsynchronousChannelGroup (the hereby targeted
 *      class-under-test class)
 * @see AsynchronousChannelGroupTests AsynchronousChannelGroupTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AsynchronousChannelGroup.class!",
                   java.nio.channels.AsynchronousChannelGroup.class.isAssignableFrom(sut));
    }

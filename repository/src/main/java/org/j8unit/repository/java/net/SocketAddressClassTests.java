 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketAddressTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketAddressTests}.
 * </p>
 *
 * @see java.net.SocketAddress class java.net.SocketAddress (the hereby targeted class-under-test class)
 * @see SocketAddressTests SocketAddressTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SocketAddressClassTests<SUT extends java.net.SocketAddress>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketAddress.class!",
                   java.net.SocketAddress.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.EnumSet class java.util.EnumSet}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EnumSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EnumSetTests}.
 * </p>
 *
 * @see java.util.EnumSet class java.util.EnumSet (the hereby targeted class-under-test class)
 * @see EnumSetTests EnumSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.EnumSet.class!",
                   java.util.EnumSet.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EnumSet public
 * abstract class java.util.EnumSet<E>}.
 *
...
public abstract interface EnumSetClassTests<SUT extends EnumSet>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EnumSet.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IndexOutOfBoundsException class java.lang.IndexOutOfBoundsException},
 ...
 * {@link IndexOutOfBoundsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IndexOutOfBoundsExceptionTests IndexOutOfBoundsExceptionTests (The complementary j8unit test interface
...
public abstract interface IndexOutOfBoundsExceptionClassTests<SUT extends IndexOutOfBoundsException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IndexOutOfBoundsException.class!",
                   IndexOutOfBoundsException.class.isAssignableFrom(sut));
    }

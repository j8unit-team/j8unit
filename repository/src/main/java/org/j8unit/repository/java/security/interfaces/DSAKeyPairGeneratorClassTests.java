 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAKeyPairGenerator
 * public abstract interface java.security.interfaces.DSAKeyPairGenerator}.
 *
...
public abstract interface DSAKeyPairGeneratorClassTests<SUT extends DSAKeyPairGenerator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAKeyPairGenerator.class!",
                   DSAKeyPairGenerator.class.isAssignableFrom(sut));
    }

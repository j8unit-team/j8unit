 ...
 * java.security.interfaces.DSAKeyPairGenerator}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAKeyPairGeneratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAKeyPairGeneratorTests}.
 * </p>
 *
 * @see java.security.interfaces.DSAKeyPairGenerator interface java.security.interfaces.DSAKeyPairGenerator (the hereby
 *      targeted class-under-test class)
 * @see DSAKeyPairGeneratorTests DSAKeyPairGeneratorTests (The complementary j8unit test interface containing the
...
public abstract interface DSAKeyPairGeneratorClassTests<SUT extends java.security.interfaces.DSAKeyPairGenerator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.DSAKeyPairGenerator.class!",
                   java.security.interfaces.DSAKeyPairGenerator.class.isAssignableFrom(sut));
    }

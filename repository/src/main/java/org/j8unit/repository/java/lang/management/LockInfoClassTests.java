 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LockInfo public
...
public abstract interface LockInfoClassTests<SUT extends LockInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LockInfo.class!",
                   LockInfo.class.isAssignableFrom(sut));
    }

...
public abstract interface PropertyEditorSupportClassTests<SUT extends PropertyEditorSupport>
extends org.j8unit.repository.java.beans.PropertyEditorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyEditorSupport.class!",
                   PropertyEditorSupport.class.isAssignableFrom(sut));
    }

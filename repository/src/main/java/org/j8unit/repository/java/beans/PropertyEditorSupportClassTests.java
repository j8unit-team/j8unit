 ...
 * java.beans.PropertyEditorSupport}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyEditorSupportTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PropertyEditorSupportTests}.
 * </p>
 *
 * @see java.beans.PropertyEditorSupport class java.beans.PropertyEditorSupport (the hereby targeted class-under-test
 *      class)
 * @see PropertyEditorSupportTests PropertyEditorSupportTests (The complementary j8unit test interface containing the
...
extends PropertyEditorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyEditorSupport.class!",
                   java.beans.PropertyEditorSupport.class.isAssignableFrom(sut));
    }

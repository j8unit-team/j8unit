 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Signature public
 * abstract class java.security.Signature}.
 *
...
public abstract interface SignatureClassTests<SUT extends Signature>
extends SignatureSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Signature.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignatureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignatureTests}.
 * </p>
 *
 * @see java.security.Signature class java.security.Signature (the hereby targeted class-under-test class)
 * @see SignatureTests SignatureTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SignatureSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Signature.class!",
                   java.security.Signature.class.isAssignableFrom(sut));
    }

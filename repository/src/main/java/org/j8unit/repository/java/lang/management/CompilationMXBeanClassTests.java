 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompilationMXBean
 * public abstract interface java.lang.management.CompilationMXBean}.
 *
...
public abstract interface CompilationMXBeanClassTests<SUT extends CompilationMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompilationMXBean.class!",
                   CompilationMXBean.class.isAssignableFrom(sut));
    }

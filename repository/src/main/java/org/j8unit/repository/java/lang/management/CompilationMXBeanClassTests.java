 ...
 * java.lang.management.CompilationMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompilationMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompilationMXBeanTests}.
 * </p>
 *
 * @see java.lang.management.CompilationMXBean interface java.lang.management.CompilationMXBean (the hereby targeted
 *      class-under-test class)
 * @see CompilationMXBeanTests CompilationMXBeanTests (The complementary j8unit test interface containing the instance
...
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.CompilationMXBean.class!",
                   java.lang.management.CompilationMXBean.class.isAssignableFrom(sut));
    }

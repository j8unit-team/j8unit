 ...
 * java.util.zip.CheckedInputStream}, containing all instance relevant test methods (i.&thinsp;e., test methods of non-
...
extends org.j8unit.repository.java.io.FilterInputStreamTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.CheckedInputStream#getChecksum()
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.CheckedInputStream#read()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.CheckedInputStream#read(byte[], int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.CheckedInputStream#skip(long)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)

...
extends org.j8unit.repository.java.security.interfaces.RSAPrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAMultiPrimePrivateCrtKey.class!",
                   RSAMultiPrimePrivateCrtKey.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.interfaces.RSAMultiPrimePrivateCrtKey interface
 * java.security.interfaces.RSAMultiPrimePrivateCrtKey}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see RSAMultiPrimePrivateCrtKeyTests RSAMultiPrimePrivateCrtKeyTests (The complementary j8unit test interface
...
public abstract interface RSAMultiPrimePrivateCrtKeyClassTests<SUT extends java.security.interfaces.RSAMultiPrimePrivateCrtKey>
extends RSAPrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.RSAMultiPrimePrivateCrtKey.class!",
                   java.security.interfaces.RSAMultiPrimePrivateCrtKey.class.isAssignableFrom(sut));
    }

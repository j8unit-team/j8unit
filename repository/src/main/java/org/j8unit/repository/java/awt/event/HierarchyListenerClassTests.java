 ...
 * java.awt.event.HierarchyListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HierarchyListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HierarchyListenerTests}.
 * </p>
 *
 * @see java.awt.event.HierarchyListener interface java.awt.event.HierarchyListener (the hereby targeted
 *      class-under-test class)
 * @see HierarchyListenerTests HierarchyListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface HierarchyListenerClassTests<SUT extends java.awt.event.HierarchyListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.HierarchyListener.class!",
                   java.awt.event.HierarchyListener.class.isAssignableFrom(sut));
    }

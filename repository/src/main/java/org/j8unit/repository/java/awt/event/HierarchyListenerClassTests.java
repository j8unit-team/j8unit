 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HierarchyListener
 * public abstract interface java.awt.event.HierarchyListener}.
 *
...
public abstract interface HierarchyListenerClassTests<SUT extends HierarchyListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HierarchyListener.class!",
                   HierarchyListener.class.isAssignableFrom(sut));
    }

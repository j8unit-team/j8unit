...
import org.j8unit.repository.java.io.FilterOutputStreamClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CheckedOutputStream
...
public abstract interface CheckedOutputStreamClassTests<SUT extends CheckedOutputStream>
extends FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CheckedOutputStream.class!",
                   CheckedOutputStream.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.CheckedOutputStream class
 * java.util.zip.CheckedOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CheckedOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CheckedOutputStreamTests}.
 * </p>
 *
 * @see java.util.zip.CheckedOutputStream class java.util.zip.CheckedOutputStream (the hereby targeted class-under-test
 *      class)
 * @see CheckedOutputStreamTests CheckedOutputStreamTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.CheckedOutputStream.class!",
                   java.util.zip.CheckedOutputStream.class.isAssignableFrom(sut));
    }

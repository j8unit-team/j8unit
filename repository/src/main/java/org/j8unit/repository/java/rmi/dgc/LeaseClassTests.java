 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Lease public final
...
public abstract interface LeaseClassTests<SUT extends Lease>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.rmi.dgc.Lease]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Lease.class!", Lease.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Observable class java.util.Observable}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObservableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObservableTests}.
 * </p>
 *
 * @see java.util.Observable class java.util.Observable (the hereby targeted class-under-test class)
 * @see ObservableTests ObservableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ObservableClassTests<SUT extends java.util.Observable>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Observable.class!",
                   java.util.Observable.class.isAssignableFrom(sut));
    }

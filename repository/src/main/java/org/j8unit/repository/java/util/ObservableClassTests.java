 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Observable public
...
public abstract interface ObservableClassTests<SUT extends Observable>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Observable.class!",
                   Observable.class.isAssignableFrom(sut));
    }

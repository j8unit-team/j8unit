 ...
 * java.util.function.ToDoubleFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToDoubleFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToDoubleFunctionTests}.
 * </p>
 *
 * @see java.util.function.ToDoubleFunction interface java.util.function.ToDoubleFunction (the hereby targeted
 *      class-under-test class)
 * @see ToDoubleFunctionTests ToDoubleFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ToDoubleFunctionClassTests<SUT extends java.util.function.ToDoubleFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ToDoubleFunction.class!",
                   java.util.function.ToDoubleFunction.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToDoubleFunction
 * public abstract interface java.util.function.ToDoubleFunction<T>}.
 *
...
public abstract interface ToDoubleFunctionClassTests<SUT extends ToDoubleFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToDoubleFunction.class!",
                   ToDoubleFunction.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.Month class java.time.Month}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MonthTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MonthTests}.
 * </p>
 *
 * @see java.time.Month class java.time.Month (the hereby targeted class-under-test class)
 * @see MonthTests MonthTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.Month.class!",
                   java.time.Month.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ThaiBuddhistDate
 * public final class java.time.chrono.ThaiBuddhistDate}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ThaiBuddhistDateTests}.
 * </p>
 *
 * <p>
...
public abstract interface ThaiBuddhistDateClassTests<SUT extends ThaiBuddhistDate>
extends ChronoLocalDateClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThaiBuddhistDate.class!",
                   ThaiBuddhistDate.class.isAssignableFrom(sut));
    }

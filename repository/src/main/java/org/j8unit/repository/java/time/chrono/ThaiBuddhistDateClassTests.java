 ...
 * java.time.chrono.ThaiBuddhistDate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThaiBuddhistDateTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ThaiBuddhistDateTests ThaiBuddhistDateTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.ThaiBuddhistDate.class!",
                   java.time.chrono.ThaiBuddhistDate.class.isAssignableFrom(sut));
    }

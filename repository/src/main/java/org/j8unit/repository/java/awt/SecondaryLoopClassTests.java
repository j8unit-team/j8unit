 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecondaryLoop
 * public abstract interface java.awt.SecondaryLoop}.
 *
...
public abstract interface SecondaryLoopClassTests<SUT extends SecondaryLoop>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecondaryLoop.class!",
                   SecondaryLoop.class.isAssignableFrom(sut));
    }

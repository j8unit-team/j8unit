...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.SecondaryLoop interface java.awt.SecondaryLoop}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecondaryLoopTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecondaryLoopTests}.
 * </p>
 *
 * @see java.awt.SecondaryLoop interface java.awt.SecondaryLoop (the hereby targeted class-under-test class)
 * @see SecondaryLoopTests SecondaryLoopTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SecondaryLoopClassTests<SUT extends java.awt.SecondaryLoop>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.SecondaryLoop.class!",
                   java.awt.SecondaryLoop.class.isAssignableFrom(sut));
    }

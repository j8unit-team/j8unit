 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExecutionException
...
public abstract interface ExecutionExceptionClassTests<SUT extends ExecutionException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExecutionException.class!",
                   ExecutionException.class.isAssignableFrom(sut));
    }

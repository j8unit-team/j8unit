 ...
 * java.util.concurrent.ExecutionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExecutionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExecutionExceptionTests}.
 * </p>
 *
 * @see java.util.concurrent.ExecutionException class java.util.concurrent.ExecutionException (the hereby targeted
 *      class-under-test class)
 * @see ExecutionExceptionTests ExecutionExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ExecutionException.class!",
                   java.util.concurrent.ExecutionException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.UUID class java.util.UUID}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UUIDTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UUIDTests}.
 * </p>
 *
 * @see java.util.UUID class java.util.UUID (the hereby targeted class-under-test class)
 * @see UUIDTests UUIDTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.UUID.class!",
                   java.util.UUID.class.isAssignableFrom(sut));
    }

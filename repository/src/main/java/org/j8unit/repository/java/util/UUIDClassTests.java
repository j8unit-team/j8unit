 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UUID public final
...
public abstract interface UUIDClassTests<SUT extends UUID>
extends SerializableClassTests<SUT>, ComparableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UUID.class!", UUID.class.isAssignableFrom(sut));
    }

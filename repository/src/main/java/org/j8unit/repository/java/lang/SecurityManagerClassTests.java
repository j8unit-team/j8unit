...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain SecurityManager class java.lang.SecurityManager}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecurityManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecurityManagerTests}.
 * </p>
 *
 * @see SecurityManager class java.lang.SecurityManager (the hereby targeted class-under-test class)
 * @see SecurityManagerTests SecurityManagerTests (The complementary j8unit test interface containing the instance
...
public abstract interface SecurityManagerClassTests<SUT extends SecurityManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecurityManager.class!",
                   SecurityManager.class.isAssignableFrom(sut));
    }

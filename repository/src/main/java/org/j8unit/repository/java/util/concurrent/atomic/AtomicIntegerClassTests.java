 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AtomicInteger
...
public abstract interface AtomicIntegerClassTests<SUT extends AtomicInteger>
extends NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicInteger.class!",
                   AtomicInteger.class.isAssignableFrom(sut));
    }

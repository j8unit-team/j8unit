 ...
 * java.util.concurrent.atomic.AtomicInteger}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicIntegerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AtomicIntegerTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.AtomicInteger class java.util.concurrent.atomic.AtomicInteger (the hereby targeted
 *      class-under-test class)
 * @see AtomicIntegerTests AtomicIntegerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicInteger.class!",
                   java.util.concurrent.atomic.AtomicInteger.class.isAssignableFrom(sut));
    }

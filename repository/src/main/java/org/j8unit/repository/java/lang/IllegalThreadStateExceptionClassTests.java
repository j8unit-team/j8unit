...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IllegalThreadStateException class
 * java.lang.IllegalThreadStateException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IllegalThreadStateExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see IllegalThreadStateExceptionTests IllegalThreadStateExceptionTests (The complementary j8unit test interface
...
public abstract interface IllegalThreadStateExceptionClassTests<SUT extends IllegalThreadStateException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalThreadStateException.class!",

...
public abstract interface ProviderMismatchExceptionClassTests<SUT extends ProviderMismatchException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProviderMismatchException.class!",
                   ProviderMismatchException.class.isAssignableFrom(sut));
    }

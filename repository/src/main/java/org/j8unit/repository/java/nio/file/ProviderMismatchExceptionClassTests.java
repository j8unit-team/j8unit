 ...
 * java.nio.file.ProviderMismatchException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link ProviderMismatchExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.file.ProviderMismatchException class java.nio.file.ProviderMismatchException (the hereby targeted
 *      class-under-test class)
 * @see ProviderMismatchExceptionTests ProviderMismatchExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.ProviderMismatchException.class!",
                   java.nio.file.ProviderMismatchException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ByteLookupTableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ByteLookupTableTests}.
 * </p>
 *
 * @see java.awt.image.ByteLookupTable class java.awt.image.ByteLookupTable (the hereby targeted class-under-test class)
 * @see ByteLookupTableTests ByteLookupTableTests (The complementary j8unit test interface containing the instance
...
public abstract interface ByteLookupTableClassTests<SUT extends java.awt.image.ByteLookupTable>
extends LookupTableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ByteLookupTable.class!",
                   java.awt.image.ByteLookupTable.class.isAssignableFrom(sut));
    }

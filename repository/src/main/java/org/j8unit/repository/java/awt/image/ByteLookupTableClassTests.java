 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ByteLookupTable
 * public class java.awt.image.ByteLookupTable}.
 *
...
public abstract interface ByteLookupTableClassTests<SUT extends ByteLookupTable>
extends LookupTableClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.ByteLookupTable]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ByteLookupTable.class!",
                   ByteLookupTable.class.isAssignableFrom(sut));
    }

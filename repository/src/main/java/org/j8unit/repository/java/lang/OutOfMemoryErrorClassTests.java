...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain OutOfMemoryError class java.lang.OutOfMemoryError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OutOfMemoryErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OutOfMemoryErrorTests}.
 * </p>
 *
 * @see OutOfMemoryError class java.lang.OutOfMemoryError (the hereby targeted class-under-test class)
 * @see OutOfMemoryErrorTests OutOfMemoryErrorTests (The complementary j8unit test interface containing the instance
...
public abstract interface OutOfMemoryErrorClassTests<SUT extends OutOfMemoryError>
extends VirtualMachineErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OutOfMemoryError.class!",
                   OutOfMemoryError.class.isAssignableFrom(sut));
    }

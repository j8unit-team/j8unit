 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextAttributeTests}).
 * </p>
 *
 * <p>
 ...
 * @see TextAttributeTests TextAttributeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.text.AttributedCharacterIteratorClassTests.AttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.font.TextAttribute.class!",
                   java.awt.font.TextAttribute.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecureRandom public
...
public abstract interface SecureRandomClassTests<SUT extends SecureRandom>
extends RandomClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecureRandom.class!",
                   SecureRandom.class.isAssignableFrom(sut));
    }

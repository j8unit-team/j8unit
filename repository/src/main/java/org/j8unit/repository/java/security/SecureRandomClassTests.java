 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecureRandomTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecureRandomTests}.
 * </p>
 *
 * @see java.security.SecureRandom class java.security.SecureRandom (the hereby targeted class-under-test class)
 * @see SecureRandomTests SecureRandomTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.RandomClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.SecureRandom.class!",
                   java.security.SecureRandom.class.isAssignableFrom(sut));
    }

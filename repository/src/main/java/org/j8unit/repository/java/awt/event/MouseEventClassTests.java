 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseEvent public
...
public abstract interface MouseEventClassTests<SUT extends MouseEvent>
extends InputEventClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.event.MouseEvent]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseEvent.class!",
                   MouseEvent.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.event.MouseEvent]

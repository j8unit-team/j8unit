...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.MouseEvent class java.awt.event.MouseEvent}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseEventTests}.
 * </p>
 *
 * @see java.awt.event.MouseEvent class java.awt.event.MouseEvent (the hereby targeted class-under-test class)
 * @see MouseEventTests MouseEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MouseEventClassTests<SUT extends java.awt.event.MouseEvent>
extends InputEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.MouseEvent.class!",
                   java.awt.event.MouseEvent.class.isAssignableFrom(sut));
    }

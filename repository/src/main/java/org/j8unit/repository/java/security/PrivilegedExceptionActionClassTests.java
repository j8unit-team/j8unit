...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.PrivilegedExceptionAction interface
 * java.security.PrivilegedExceptionAction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link PrivilegedExceptionActionTests}).
 * </p>
 *
 * <p>
 ...
 * @see PrivilegedExceptionActionTests PrivilegedExceptionActionTests (The complementary j8unit test interface
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.PrivilegedExceptionAction.class!",
                   java.security.PrivilegedExceptionAction.class.isAssignableFrom(sut));
    }

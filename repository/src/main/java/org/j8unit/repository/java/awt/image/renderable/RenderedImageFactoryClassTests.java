 ...
 * java.awt.image.renderable.RenderedImageFactory}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RenderedImageFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RenderedImageFactoryTests}
 * .
 * </p>
 *
 * @see java.awt.image.renderable.RenderedImageFactory interface java.awt.image.renderable.RenderedImageFactory (the
 *      hereby targeted class-under-test class)
 * @see RenderedImageFactoryTests RenderedImageFactoryTests (The complementary j8unit test interface containing the
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.renderable.RenderedImageFactory.class!",
                   java.awt.image.renderable.RenderedImageFactory.class.isAssignableFrom(sut));
    }

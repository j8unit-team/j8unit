...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Math class java.lang.Math}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MathTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MathTests}.
 * </p>
 *
 * @see Math class java.lang.Math (the hereby targeted class-under-test class)
 * @see MathTests MathTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface MathClassTests<SUT extends Math>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Math.class!", Math.class.isAssignableFrom(sut));
    }

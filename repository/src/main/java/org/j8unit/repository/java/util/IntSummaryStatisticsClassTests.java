 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntSummaryStatisticsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntSummaryStatisticsTests}
 * .
 * </p>
 *
 * @see java.util.IntSummaryStatistics class java.util.IntSummaryStatistics (the hereby targeted class-under-test class)
 * @see IntSummaryStatisticsTests IntSummaryStatisticsTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.util.function.IntConsumerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IntSummaryStatistics.class!",
                   java.util.IntSummaryStatistics.class.isAssignableFrom(sut));
    }

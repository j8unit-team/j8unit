 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotLinkExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.file.NotLinkException class java.nio.file.NotLinkException (the hereby targeted class-under-test class)
 * @see NotLinkExceptionTests NotLinkExceptionTests (The complementary j8unit test interface containing the instance
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.NotLinkException.class!",
                   java.nio.file.NotLinkException.class.isAssignableFrom(sut));
    }

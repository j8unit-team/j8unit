 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotLinkException
 * public class java.nio.file.NotLinkException}.
 *
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotLinkException.class!",
                   NotLinkException.class.isAssignableFrom(sut));
    }

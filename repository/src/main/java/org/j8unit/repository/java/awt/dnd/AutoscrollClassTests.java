 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Autoscroll public
 * abstract interface java.awt.dnd.Autoscroll}.
 *
...
public abstract interface AutoscrollClassTests<SUT extends Autoscroll>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Autoscroll.class!",
                   Autoscroll.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AutoscrollTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AutoscrollTests}.
 * </p>
 *
 * @see java.awt.dnd.Autoscroll interface java.awt.dnd.Autoscroll (the hereby targeted class-under-test class)
 * @see AutoscrollTests AutoscrollTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AutoscrollClassTests<SUT extends java.awt.dnd.Autoscroll>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.Autoscroll.class!",
                   java.awt.dnd.Autoscroll.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.EOFException class java.io.EOFException}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EOFExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EOFExceptionTests}.
 * </p>
 *
 * @see java.io.EOFException class java.io.EOFException (the hereby targeted class-under-test class)
 * @see EOFExceptionTests EOFExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface EOFExceptionClassTests<SUT extends java.io.EOFException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.EOFException.class!",
                   java.io.EOFException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EOFException public
...
public abstract interface EOFExceptionClassTests<SUT extends EOFException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EOFException.class!",
                   EOFException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExecutableTests}).
 * </p>
 *
 * <p>
 ...
 * @see ExecutableTests ExecutableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ExecutableClassTests<SUT extends java.lang.reflect.Executable>
extends MemberClassTests<SUT>, GenericDeclarationClassTests<SUT>, AccessibleObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.Executable.class!",
                   java.lang.reflect.Executable.class.isAssignableFrom(sut));
    }

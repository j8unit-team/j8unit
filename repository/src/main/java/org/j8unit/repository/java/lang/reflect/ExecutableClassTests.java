 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Executable public
...
extends MemberClassTests<SUT>, GenericDeclarationClassTests<SUT>, AccessibleObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Executable.class!",
                   Executable.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBufferByteTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataBufferByteTests}.
 * </p>
 *
 * @see java.awt.image.DataBufferByte class java.awt.image.DataBufferByte (the hereby targeted class-under-test class)
 * @see DataBufferByteTests DataBufferByteTests (The complementary j8unit test interface containing the instance
...
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DataBufferByte.class!",
                   java.awt.image.DataBufferByte.class.isAssignableFrom(sut));
    }

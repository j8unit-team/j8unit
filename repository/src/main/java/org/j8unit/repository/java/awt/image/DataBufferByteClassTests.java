 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataBufferByte
...
public abstract interface DataBufferByteClassTests<SUT extends DataBufferByte>
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBufferByte.class!",
                   DataBufferByte.class.isAssignableFrom(sut));
    }

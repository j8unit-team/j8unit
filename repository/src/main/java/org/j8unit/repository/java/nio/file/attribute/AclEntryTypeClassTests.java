 ...
 * java.nio.file.attribute.AclEntryType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AclEntryTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AclEntryTypeTests}.
 * </p>
 *
 * @see java.nio.file.attribute.AclEntryType class java.nio.file.attribute.AclEntryType (the hereby targeted
 *      class-under-test class)
 * @see AclEntryTypeTests AclEntryTypeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.AclEntryType.class!",
                   java.nio.file.attribute.AclEntryType.class.isAssignableFrom(sut));
    }

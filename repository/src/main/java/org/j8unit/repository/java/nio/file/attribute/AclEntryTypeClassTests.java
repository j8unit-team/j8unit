 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AclEntryType public
 * final enum java.nio.file.attribute.AclEntryType}.
 *
...
public abstract interface AclEntryTypeClassTests<SUT extends AclEntryType>
extends EnumClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.file.attribute.AclEntryType]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AclEntryType.class!",
                   AclEntryType.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProxySelectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProxySelectorTests}.
 * </p>
 *
 * @see java.net.ProxySelector class java.net.ProxySelector (the hereby targeted class-under-test class)
 * @see ProxySelectorTests ProxySelectorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.ProxySelector.class!",
                   java.net.ProxySelector.class.isAssignableFrom(sut));
    }

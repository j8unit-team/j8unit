 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProxySelector
...
public abstract interface ProxySelectorClassTests<SUT extends ProxySelector>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProxySelector.class!",
                   ProxySelector.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CanvasPeer public
 * abstract interface java.awt.peer.CanvasPeer}.
 *
...
public abstract interface CanvasPeerClassTests<SUT extends CanvasPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CanvasPeer.class!",

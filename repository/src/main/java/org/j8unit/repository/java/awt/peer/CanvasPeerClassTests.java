 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CanvasPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CanvasPeerTests}.
 * </p>
 *
 * @see java.awt.peer.CanvasPeer interface java.awt.peer.CanvasPeer (the hereby targeted class-under-test class)
 * @see CanvasPeerTests CanvasPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CanvasPeerClassTests<SUT extends java.awt.peer.CanvasPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.CanvasPeer.class!",
                   java.awt.peer.CanvasPeer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.ThreadLocalRandom class
 * java.util.concurrent.ThreadLocalRandom}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadLocalRandomTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ThreadLocalRandomTests}.
 * </p>
 *
 * @see java.util.concurrent.ThreadLocalRandom class java.util.concurrent.ThreadLocalRandom (the hereby targeted
 *      class-under-test class)
 * @see ThreadLocalRandomTests ThreadLocalRandomTests (The complementary j8unit test interface containing the instance
...
public abstract interface ThreadLocalRandomClassTests<SUT extends java.util.concurrent.ThreadLocalRandom>
extends org.j8unit.repository.java.util.RandomClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ThreadLocalRandom.class!",
                   java.util.concurrent.ThreadLocalRandom.class.isAssignableFrom(sut));
    }

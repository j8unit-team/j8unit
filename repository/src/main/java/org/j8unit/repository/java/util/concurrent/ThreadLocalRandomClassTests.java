...
import org.j8unit.repository.java.util.RandomClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ThreadLocalRandom
...
public abstract interface ThreadLocalRandomClassTests<SUT extends ThreadLocalRandom>
extends RandomClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadLocalRandom.class!",
                   ThreadLocalRandom.class.isAssignableFrom(sut));
    }

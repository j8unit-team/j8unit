 ...
 * {@link KeyEventPostProcessor public abstract interface java.awt.KeyEventPostProcessor}.
 *
...
public abstract interface KeyEventPostProcessorClassTests<SUT extends KeyEventPostProcessor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyEventPostProcessor.class!",
                   KeyEventPostProcessor.class.isAssignableFrom(sut));
    }

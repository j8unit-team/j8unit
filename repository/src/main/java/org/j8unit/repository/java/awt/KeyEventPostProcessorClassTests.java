...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.KeyEventPostProcessor interface
 * java.awt.KeyEventPostProcessor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyEventPostProcessorTests}).
 * </p>
 *
 * <p>
 ...
 * {@link KeyEventPostProcessorTests}.
 * </p>
 *
 * @see java.awt.KeyEventPostProcessor interface java.awt.KeyEventPostProcessor (the hereby targeted class-under-test
 *      class)
 * @see KeyEventPostProcessorTests KeyEventPostProcessorTests (The complementary j8unit test interface containing the
...
public abstract interface KeyEventPostProcessorClassTests<SUT extends java.awt.KeyEventPostProcessor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.KeyEventPostProcessor.class!",
                   java.awt.KeyEventPostProcessor.class.isAssignableFrom(sut));
    }

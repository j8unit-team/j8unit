...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ArrayIndexOutOfBoundsException class
 * java.lang.ArrayIndexOutOfBoundsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ArrayIndexOutOfBoundsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ArrayIndexOutOfBoundsExceptionTests ArrayIndexOutOfBoundsExceptionTests (The complementary j8unit test interface
...
public abstract interface ArrayIndexOutOfBoundsExceptionClassTests<SUT extends ArrayIndexOutOfBoundsException>
extends IndexOutOfBoundsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ArrayIndexOutOfBoundsException.class!",
                   ArrayIndexOutOfBoundsException.class.isAssignableFrom(sut));
    }

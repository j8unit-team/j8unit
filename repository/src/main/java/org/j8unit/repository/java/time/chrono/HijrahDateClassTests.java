...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.chrono.HijrahDate class java.time.chrono.HijrahDate},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HijrahDateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HijrahDateTests}.
 * </p>
 *
 * @see java.time.chrono.HijrahDate class java.time.chrono.HijrahDate (the hereby targeted class-under-test class)
 * @see HijrahDateTests HijrahDateTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface HijrahDateClassTests<SUT extends java.time.chrono.HijrahDate>
extends ChronoLocalDateClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.HijrahDate.class!",
                   java.time.chrono.HijrahDate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HijrahDate public
 * final class java.time.chrono.HijrahDate}.
 *
...
public abstract interface HijrahDateClassTests<SUT extends HijrahDate>
extends ChronoLocalDateClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.HijrahDate]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HijrahDate.class!",
                   HijrahDate.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.time.chrono.HijrahDate]

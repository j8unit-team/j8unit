 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ICC_Profile public
...
public abstract interface ICC_ProfileClassTests<SUT extends ICC_Profile>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.color.ICC_Profile]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ICC_Profile.class!",
                   ICC_Profile.class.isAssignableFrom(sut));
    }

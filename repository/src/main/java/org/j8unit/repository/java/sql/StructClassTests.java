...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Struct interface java.sql.Struct}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StructTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StructTests}.
 * </p>
 *
 * @see java.sql.Struct interface java.sql.Struct (the hereby targeted class-under-test class)
 * @see StructTests StructTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface StructClassTests<SUT extends java.sql.Struct>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Struct.class!",
                   java.sql.Struct.class.isAssignableFrom(sut));
    }

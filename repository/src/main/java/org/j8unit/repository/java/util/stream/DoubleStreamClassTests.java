 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleStreamTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.stream.DoubleStream interface java.util.stream.DoubleStream (the hereby targeted class-under-test
 *      class)
 * @see DoubleStreamTests DoubleStreamTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends BaseStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.DoubleStream.class!",
                   java.util.stream.DoubleStream.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.stream.DoubleStream.Builder interface
     * java.util.stream.DoubleStream$Builder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link DoubleStreamTests.BuilderTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.util.stream.DoubleStream.Builder interface java.util.stream.DoubleStream$Builder (the hereby targeted
     *      class-under-test class)
     * @see DoubleStreamTests.BuilderTests DoubleStreamTests.BuilderTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.util.function.DoubleConsumerClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.DoubleStream.Builder.class!",
                       java.util.stream.DoubleStream.Builder.class.isAssignableFrom(sut));
        }

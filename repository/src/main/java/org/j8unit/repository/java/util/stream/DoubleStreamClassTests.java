 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleStream public
 * abstract interface java.util.stream.DoubleStream}.
 *
...
extends org.j8unit.repository.java.util.stream.BaseStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleStream.class!",
                   DoubleStream.class.isAssignableFrom(sut));
    }
     ...
     * {@link Builder public abstract static interface java.util.stream.DoubleStream$Builder}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentEventTests}.
 * </p>
 *
 * @see java.awt.event.ComponentEvent class java.awt.event.ComponentEvent (the hereby targeted class-under-test class)
 * @see ComponentEventTests ComponentEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ComponentEvent.class!",
                   java.awt.event.ComponentEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIClassLoader
...
public abstract interface RMIClassLoaderClassTests<SUT extends RMIClassLoader>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIClassLoader.class!",
                   RMIClassLoader.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIClassLoaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIClassLoaderTests}.
 * </p>
 *
 * @see java.rmi.server.RMIClassLoader class java.rmi.server.RMIClassLoader (the hereby targeted class-under-test class)
 * @see RMIClassLoaderTests RMIClassLoaderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RMIClassLoader.class!",
                   java.rmi.server.RMIClassLoader.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalQuery
 * public abstract interface java.time.temporal.TemporalQuery<R>}.
 *
...
public abstract interface TemporalQueryClassTests<SUT extends TemporalQuery>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalQuery.class!",
                   TemporalQuery.class.isAssignableFrom(sut));
    }

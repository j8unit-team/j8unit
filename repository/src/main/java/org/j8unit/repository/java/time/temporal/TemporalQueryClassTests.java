 ...
 * java.time.temporal.TemporalQuery}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalQueryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalQueryTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalQuery interface java.time.temporal.TemporalQuery (the hereby targeted
 *      class-under-test class)
 * @see TemporalQueryTests TemporalQueryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalQuery.class!",
                   java.time.temporal.TemporalQuery.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.file.StandardCopyOption}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardCopyOptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StandardCopyOptionTests}.
 * </p>
 *
 * @see java.nio.file.StandardCopyOption class java.nio.file.StandardCopyOption (the hereby targeted class-under-test
 *      class)
 * @see StandardCopyOptionTests StandardCopyOptionTests (The complementary j8unit test interface containing the instance
...
extends CopyOptionClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.StandardCopyOption.class!",
                   java.nio.file.StandardCopyOption.class.isAssignableFrom(sut));
    }

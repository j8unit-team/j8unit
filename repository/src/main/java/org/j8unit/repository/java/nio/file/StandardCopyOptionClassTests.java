 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StandardCopyOption
 * public final enum java.nio.file.StandardCopyOption}.
 *
...
public abstract interface StandardCopyOptionClassTests<SUT extends StandardCopyOption>
extends CopyOptionClassTests<SUT>, EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StandardCopyOption.class!",
                   StandardCopyOption.class.isAssignableFrom(sut));
    }

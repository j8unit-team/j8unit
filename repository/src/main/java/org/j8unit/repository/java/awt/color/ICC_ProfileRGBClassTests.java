 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ICC_ProfileRGB
...
public abstract interface ICC_ProfileRGBClassTests<SUT extends ICC_ProfileRGB>
extends ICC_ProfileClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ICC_ProfileRGB.class!",
                   ICC_ProfileRGB.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ICC_ProfileRGBTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ICC_ProfileRGBTests}.
 * </p>
 *
 * @see java.awt.color.ICC_ProfileRGB class java.awt.color.ICC_ProfileRGB (the hereby targeted class-under-test class)
 * @see ICC_ProfileRGBTests ICC_ProfileRGBTests (The complementary j8unit test interface containing the instance
...
public abstract interface ICC_ProfileRGBClassTests<SUT extends java.awt.color.ICC_ProfileRGB>
extends ICC_ProfileClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.color.ICC_ProfileRGB.class!",
                   java.awt.color.ICC_ProfileRGB.class.isAssignableFrom(sut));
    }

...
public abstract interface PermissionClassTests<SUT extends java.security.acl.Permission>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.acl.Permission.class!",
                   java.security.acl.Permission.class.isAssignableFrom(sut));
    }

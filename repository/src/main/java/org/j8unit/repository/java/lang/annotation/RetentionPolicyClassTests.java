 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RetentionPolicy
 * public final enum java.lang.annotation.RetentionPolicy}.
 *
...
public abstract interface RetentionPolicyClassTests<SUT extends RetentionPolicy>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RetentionPolicy.class!",
                   RetentionPolicy.class.isAssignableFrom(sut));
    }

...
public abstract interface UnknownGroupExceptionClassTests<SUT extends UnknownGroupException>
extends ActivationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownGroupException.class!",
                   UnknownGroupException.class.isAssignableFrom(sut));
    }

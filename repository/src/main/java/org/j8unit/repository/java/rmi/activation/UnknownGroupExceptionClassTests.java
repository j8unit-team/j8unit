...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.activation.UnknownGroupException class
 * java.rmi.activation.UnknownGroupException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownGroupExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link UnknownGroupExceptionTests}.
 * </p>
 *
 * @see java.rmi.activation.UnknownGroupException class java.rmi.activation.UnknownGroupException (the hereby targeted
 *      class-under-test class)
 * @see UnknownGroupExceptionTests UnknownGroupExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface UnknownGroupExceptionClassTests<SUT extends java.rmi.activation.UnknownGroupException>
extends ActivationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.UnknownGroupException.class!",
                   java.rmi.activation.UnknownGroupException.class.isAssignableFrom(sut));
    }

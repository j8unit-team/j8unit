 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FlavorEvent public
...
public abstract interface FlavorEventClassTests<SUT extends FlavorEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FlavorEvent.class!",
                   FlavorEvent.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.datatransfer.FlavorEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlavorEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FlavorEventTests}.
 * </p>
 *
 * @see java.awt.datatransfer.FlavorEvent class java.awt.datatransfer.FlavorEvent (the hereby targeted class-under-test
 *      class)
 * @see FlavorEventTests FlavorEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.FlavorEvent.class!",
                   java.awt.datatransfer.FlavorEvent.class.isAssignableFrom(sut));
    }

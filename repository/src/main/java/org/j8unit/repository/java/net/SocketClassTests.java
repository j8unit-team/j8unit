 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Socket public class
 * java.net.Socket}.
 *
...
public abstract interface SocketClassTests<SUT extends Socket>
extends CloseableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.net.Socket]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Socket.class!",
                   Socket.class.isAssignableFrom(sut));
    }

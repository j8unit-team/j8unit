...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.Socket class java.net.Socket}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketTests}.
 * </p>
 *
 * @see java.net.Socket class java.net.Socket (the hereby targeted class-under-test class)
 * @see SocketTests SocketTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.Socket.class!",
                   java.net.Socket.class.isAssignableFrom(sut));
    }

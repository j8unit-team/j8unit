 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CoderResult public
...
public abstract interface CoderResultClassTests<SUT extends CoderResult>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.charset.CoderResult]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CoderResult.class!",
                   CoderResult.class.isAssignableFrom(sut));
    }

 ...
 * {@link InvalidMarkExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface InvalidMarkExceptionClassTests<SUT extends InvalidMarkException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidMarkException.class!",
                   InvalidMarkException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.InvalidMarkException class java.nio.InvalidMarkException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidMarkExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvalidMarkExceptionTests}
 * .
 * </p>
 *
 * @see java.nio.InvalidMarkException class java.nio.InvalidMarkException (the hereby targeted class-under-test class)
 * @see InvalidMarkExceptionTests InvalidMarkExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface InvalidMarkExceptionClassTests<SUT extends java.nio.InvalidMarkException>
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.InvalidMarkException.class!",
                   java.nio.InvalidMarkException.class.isAssignableFrom(sut));
    }

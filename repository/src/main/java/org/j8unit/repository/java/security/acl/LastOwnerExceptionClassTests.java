 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LastOwnerException
...
public abstract interface LastOwnerExceptionClassTests<SUT extends LastOwnerException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LastOwnerException.class!",
                   LastOwnerException.class.isAssignableFrom(sut));
    }

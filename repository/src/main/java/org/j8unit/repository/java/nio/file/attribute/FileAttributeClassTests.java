 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileAttribute
...
public abstract interface FileAttributeClassTests<SUT extends FileAttribute>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileAttribute.class!",
                   FileAttribute.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.attribute.FileAttribute interface
 * java.nio.file.attribute.FileAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileAttributeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileAttributeTests}.
 * </p>
 *
 * @see java.nio.file.attribute.FileAttribute interface java.nio.file.attribute.FileAttribute (the hereby targeted
 *      class-under-test class)
 * @see FileAttributeTests FileAttributeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.FileAttribute.class!",
                   java.nio.file.attribute.FileAttribute.class.isAssignableFrom(sut));
    }

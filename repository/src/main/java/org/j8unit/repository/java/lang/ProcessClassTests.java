...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Process class java.lang.Process}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProcessTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProcessTests}.
 * </p>
 *
 * @see Process class java.lang.Process (the hereby targeted class-under-test class)
 * @see ProcessTests ProcessTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ProcessClassTests<SUT extends Process>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Process.class!",
                   Process.class.isAssignableFrom(sut));
    }

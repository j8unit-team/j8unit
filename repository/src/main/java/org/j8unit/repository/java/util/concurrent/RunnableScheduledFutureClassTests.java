 ...
 * java.util.concurrent.RunnableScheduledFuture}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RunnableScheduledFutureTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see RunnableScheduledFutureTests RunnableScheduledFutureTests (The complementary j8unit test interface containing
...
extends RunnableFutureClassTests<SUT>, ScheduledFutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.RunnableScheduledFuture.class!",
                   java.util.concurrent.RunnableScheduledFuture.class.isAssignableFrom(sut));
    }

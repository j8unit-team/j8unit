...
extends org.j8unit.repository.java.util.concurrent.RunnableFutureClassTests<SUT>, org.j8unit.repository.java.util.concurrent.ScheduledFutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RunnableScheduledFuture.class!",
                   RunnableScheduledFuture.class.isAssignableFrom(sut));
    }

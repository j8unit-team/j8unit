...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.IntPredicate interface
 * java.util.function.IntPredicate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntPredicateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntPredicateTests}.
 * </p>
 *
 * @see java.util.function.IntPredicate interface java.util.function.IntPredicate (the hereby targeted class-under-test
 *      class)
 * @see IntPredicateTests IntPredicateTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface IntPredicateClassTests<SUT extends java.util.function.IntPredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntPredicate.class!",
                   java.util.function.IntPredicate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntPredicate public
 * abstract interface java.util.function.IntPredicate}.
 *
...
public abstract interface IntPredicateClassTests<SUT extends IntPredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntPredicate.class!",
                   IntPredicate.class.isAssignableFrom(sut));
    }

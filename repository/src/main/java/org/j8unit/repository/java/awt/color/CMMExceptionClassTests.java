 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CMMException public
...
public abstract interface CMMExceptionClassTests<SUT extends CMMException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CMMException.class!",
                   CMMException.class.isAssignableFrom(sut));
    }

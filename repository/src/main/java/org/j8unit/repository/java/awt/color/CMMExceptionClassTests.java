...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.color.CMMException class java.awt.color.CMMException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CMMExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CMMExceptionTests}.
 * </p>
 *
 * @see java.awt.color.CMMException class java.awt.color.CMMException (the hereby targeted class-under-test class)
 * @see CMMExceptionTests CMMExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CMMExceptionClassTests<SUT extends java.awt.color.CMMException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.color.CMMException.class!",
                   java.awt.color.CMMException.class.isAssignableFrom(sut));
    }

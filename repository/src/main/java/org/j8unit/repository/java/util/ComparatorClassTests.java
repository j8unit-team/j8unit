 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComparatorTests}).
 * </p>
 *
 * <p>
 ...
 * @see ComparatorTests ComparatorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Comparator.class!",
                   java.util.Comparator.class.isAssignableFrom(sut));
    }

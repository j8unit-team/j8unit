 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Comparator public
 * abstract interface java.util.Comparator<T>}.
 *
...
public abstract interface ComparatorClassTests<SUT extends Comparator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Comparator.class!",
                   Comparator.class.isAssignableFrom(sut));
    }

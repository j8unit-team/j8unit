 ...
 * {@link MimeTypeParseException public class java.awt.datatransfer.MimeTypeParseException}.
 *
...
public abstract interface MimeTypeParseExceptionClassTests<SUT extends MimeTypeParseException>
extends ExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.datatransfer.MimeTypeParseException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MimeTypeParseException.class!",
                   MimeTypeParseException.class.isAssignableFrom(sut));
    }

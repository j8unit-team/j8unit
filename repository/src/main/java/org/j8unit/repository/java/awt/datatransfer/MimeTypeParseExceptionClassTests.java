 ...
 * java.awt.datatransfer.MimeTypeParseException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MimeTypeParseExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MimeTypeParseExceptionTests}.
 * </p>
 *
 * @see java.awt.datatransfer.MimeTypeParseException class java.awt.datatransfer.MimeTypeParseException (the hereby
 *      targeted class-under-test class)
 * @see MimeTypeParseExceptionTests MimeTypeParseExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.MimeTypeParseException.class!",
                   java.awt.datatransfer.MimeTypeParseException.class.isAssignableFrom(sut));
    }

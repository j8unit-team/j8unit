 ...
 * {@link PropertyEditorManager public class java.beans.PropertyEditorManager}.
 *
...
public abstract interface PropertyEditorManagerClassTests<SUT extends PropertyEditorManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyEditorManager.class!",
                   PropertyEditorManager.class.isAssignableFrom(sut));
    }

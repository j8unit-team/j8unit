 ...
 * java.beans.PropertyEditorManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyEditorManagerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PropertyEditorManagerTests}.
 * </p>
 *
 * @see java.beans.PropertyEditorManager class java.beans.PropertyEditorManager (the hereby targeted class-under-test
 *      class)
 * @see PropertyEditorManagerTests PropertyEditorManagerTests (The complementary j8unit test interface containing the
...
public abstract interface PropertyEditorManagerClassTests<SUT extends java.beans.PropertyEditorManager>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyEditorManager.class!",
                   java.beans.PropertyEditorManager.class.isAssignableFrom(sut));
    }

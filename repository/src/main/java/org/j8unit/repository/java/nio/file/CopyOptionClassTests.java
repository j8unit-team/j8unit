 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CopyOption public
 * abstract interface java.nio.file.CopyOption}.
 *
...
public abstract interface CopyOptionClassTests<SUT extends CopyOption>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CopyOption.class!",
                   CopyOption.class.isAssignableFrom(sut));
    }

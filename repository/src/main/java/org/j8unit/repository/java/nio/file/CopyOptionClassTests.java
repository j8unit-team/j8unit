 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CopyOptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CopyOptionTests}.
 * </p>
 *
 * @see java.nio.file.CopyOption interface java.nio.file.CopyOption (the hereby targeted class-under-test class)
 * @see CopyOptionTests CopyOptionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CopyOptionClassTests<SUT extends java.nio.file.CopyOption>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.CopyOption.class!",
                   java.nio.file.CopyOption.class.isAssignableFrom(sut));
    }

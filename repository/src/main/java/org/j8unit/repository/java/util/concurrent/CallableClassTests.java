 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Callable public
 * abstract interface java.util.concurrent.Callable<V>}.
 *
...
public abstract interface CallableClassTests<SUT extends Callable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Callable.class!",
                   Callable.class.isAssignableFrom(sut));
    }

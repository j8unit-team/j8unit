...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.Callable interface java.util.concurrent.Callable}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CallableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CallableTests}.
 * </p>
 *
 * @see java.util.concurrent.Callable interface java.util.concurrent.Callable (the hereby targeted class-under-test
 *      class)
 * @see CallableTests CallableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Callable.class!",
                   java.util.concurrent.Callable.class.isAssignableFrom(sut));
    }

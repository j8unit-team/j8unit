 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URISyntaxException
...
public abstract interface URISyntaxExceptionClassTests<SUT extends URISyntaxException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URISyntaxException.class!",
                   URISyntaxException.class.isAssignableFrom(sut));
    }

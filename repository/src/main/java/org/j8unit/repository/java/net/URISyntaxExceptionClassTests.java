 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URISyntaxExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URISyntaxExceptionTests}.
 * </p>
 *
 * @see java.net.URISyntaxException class java.net.URISyntaxException (the hereby targeted class-under-test class)
 * @see URISyntaxExceptionTests URISyntaxExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface URISyntaxExceptionClassTests<SUT extends java.net.URISyntaxException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URISyntaxException.class!",
                   java.net.URISyntaxException.class.isAssignableFrom(sut));
    }

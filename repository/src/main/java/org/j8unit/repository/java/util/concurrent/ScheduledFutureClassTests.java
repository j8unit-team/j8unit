 ...
 * java.util.concurrent.ScheduledFuture}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScheduledFutureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScheduledFutureTests}.
 * </p>
 *
 * @see java.util.concurrent.ScheduledFuture interface java.util.concurrent.ScheduledFuture (the hereby targeted
 *      class-under-test class)
 * @see ScheduledFutureTests ScheduledFutureTests (The complementary j8unit test interface containing the instance
...
public abstract interface ScheduledFutureClassTests<SUT extends java.util.concurrent.ScheduledFuture>
extends DelayedClassTests<SUT>, FutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ScheduledFuture.class!",
                   java.util.concurrent.ScheduledFuture.class.isAssignableFrom(sut));
    }

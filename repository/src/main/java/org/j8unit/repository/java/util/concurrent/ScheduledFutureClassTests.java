 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScheduledFuture
...
public abstract interface ScheduledFutureClassTests<SUT extends ScheduledFuture>
extends DelayedClassTests<SUT>, FutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScheduledFuture.class!",

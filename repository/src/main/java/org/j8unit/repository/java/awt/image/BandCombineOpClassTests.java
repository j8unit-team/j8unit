 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BandCombineOp
 * public class java.awt.image.BandCombineOp}.
 *
...
public abstract interface BandCombineOpClassTests<SUT extends BandCombineOp>
extends RasterOpClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BandCombineOp.class!",

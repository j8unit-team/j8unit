 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BandCombineOpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BandCombineOpTests}.
 * </p>
 *
 * @see java.awt.image.BandCombineOp class java.awt.image.BandCombineOp (the hereby targeted class-under-test class)
 * @see BandCombineOpTests BandCombineOpTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface BandCombineOpClassTests<SUT extends java.awt.image.BandCombineOp>
extends RasterOpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.BandCombineOp.class!",
                   java.awt.image.BandCombineOp.class.isAssignableFrom(sut));
    }

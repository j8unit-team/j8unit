 ...
 * java.sql.SQLTransactionRollbackException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link SQLTransactionRollbackExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.sql.SQLTransactionRollbackException class java.sql.SQLTransactionRollbackException (the hereby targeted
 *      class-under-test class)
 * @see SQLTransactionRollbackExceptionTests SQLTransactionRollbackExceptionTests (The complementary j8unit test
...
extends SQLTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLTransactionRollbackException.class!",
                   java.sql.SQLTransactionRollbackException.class.isAssignableFrom(sut));
    }

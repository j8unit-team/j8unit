...
public abstract interface SQLTransactionRollbackExceptionClassTests<SUT extends SQLTransactionRollbackException>
extends SQLTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLTransactionRollbackException.class!",
                   SQLTransactionRollbackException.class.isAssignableFrom(sut));
    }

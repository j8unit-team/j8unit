 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NavigableMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NavigableMapTests}.
 * </p>
 *
 * @see java.util.NavigableMap interface java.util.NavigableMap (the hereby targeted class-under-test class)
 * @see NavigableMapTests NavigableMapTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NavigableMapClassTests<SUT extends java.util.NavigableMap>
extends SortedMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.NavigableMap.class!",
                   java.util.NavigableMap.class.isAssignableFrom(sut));
    }

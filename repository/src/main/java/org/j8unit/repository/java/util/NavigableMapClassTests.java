 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NavigableMap public
 * abstract interface java.util.NavigableMap<K,V>}.
 *
...
public abstract interface NavigableMapClassTests<SUT extends NavigableMap>
extends SortedMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NavigableMap.class!",
                   NavigableMap.class.isAssignableFrom(sut));
    }

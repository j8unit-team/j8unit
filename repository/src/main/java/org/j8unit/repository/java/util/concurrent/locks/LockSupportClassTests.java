 ...
 * java.util.concurrent.locks.LockSupport}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LockSupportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LockSupportTests}.
 * </p>
 *
 * @see java.util.concurrent.locks.LockSupport class java.util.concurrent.locks.LockSupport (the hereby targeted
 *      class-under-test class)
 * @see LockSupportTests LockSupportTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.locks.LockSupport.class!",
                   java.util.concurrent.locks.LockSupport.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LockSupport public
...
public abstract interface LockSupportClassTests<SUT extends LockSupport>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.concurrent.locks.LockSupport]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LockSupport.class!",
                   LockSupport.class.isAssignableFrom(sut));
    }

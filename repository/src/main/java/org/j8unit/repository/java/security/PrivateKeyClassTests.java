 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrivateKey public
 * abstract interface java.security.PrivateKey}.
 *
...
public abstract interface PrivateKeyClassTests<SUT extends PrivateKey>
extends KeyClassTests<SUT>, DestroyableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrivateKey.class!",
                   PrivateKey.class.isAssignableFrom(sut));
    }

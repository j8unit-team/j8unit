 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrivateKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrivateKeyTests}.
 * </p>
 *
 * @see java.security.PrivateKey interface java.security.PrivateKey (the hereby targeted class-under-test class)
 * @see PrivateKeyTests PrivateKeyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PrivateKeyClassTests<SUT extends java.security.PrivateKey>
extends KeyClassTests<SUT>, org.j8unit.repository.javax.security.auth.DestroyableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.PrivateKey.class!",
                   java.security.PrivateKey.class.isAssignableFrom(sut));
    }

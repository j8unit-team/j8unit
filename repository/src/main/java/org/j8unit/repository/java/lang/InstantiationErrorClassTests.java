...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain InstantiationError class java.lang.InstantiationError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InstantiationErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InstantiationErrorTests}.
 * </p>
 *
 * @see InstantiationError class java.lang.InstantiationError (the hereby targeted class-under-test class)
 * @see InstantiationErrorTests InstantiationErrorTests (The complementary j8unit test interface containing the instance
...
public abstract interface InstantiationErrorClassTests<SUT extends InstantiationError>
extends IncompatibleClassChangeErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InstantiationError.class!",
                   InstantiationError.class.isAssignableFrom(sut));
    }

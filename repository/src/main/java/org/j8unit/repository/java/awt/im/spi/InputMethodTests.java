 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMethod
 * public abstract interface java.awt.im.spi.InputMethod}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.awt.im.spi.InputMethodClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface InputMethodTests<SUT extends InputMethod>
extends RepositoryTests<SUT> {
    ...
    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[java.awt.im.spi.InputMethod]

    // J8UNIT-MARKER-[END]-[INSTANCE]-[java.awt.im.spi.InputMethod]

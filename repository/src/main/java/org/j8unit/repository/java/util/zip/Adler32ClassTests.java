 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Adler32Tests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link Adler32Tests}.
 * </p>
 *
 * @see java.util.zip.Adler32 class java.util.zip.Adler32 (the hereby targeted class-under-test class)
 * @see Adler32Tests Adler32Tests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface Adler32ClassTests<SUT extends java.util.zip.Adler32>
extends ChecksumClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.Adler32.class!",
                   java.util.zip.Adler32.class.isAssignableFrom(sut));
    }

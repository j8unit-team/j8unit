 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Adler32 public
...
public abstract interface Adler32ClassTests<SUT extends Adler32>
extends org.j8unit.repository.java.util.zip.ChecksumClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Adler32.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.FeatureDescriptor class java.beans.FeatureDescriptor},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FeatureDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FeatureDescriptorTests}.
 * </p>
 *
 * @see java.beans.FeatureDescriptor class java.beans.FeatureDescriptor (the hereby targeted class-under-test class)
 * @see FeatureDescriptorTests FeatureDescriptorTests (The complementary j8unit test interface containing the instance
...
public abstract interface FeatureDescriptorClassTests<SUT extends java.beans.FeatureDescriptor>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.FeatureDescriptor.class!",
                   java.beans.FeatureDescriptor.class.isAssignableFrom(sut));
    }

 ...
 * java.util.ConcurrentModificationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ConcurrentModificationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.ConcurrentModificationException class java.util.ConcurrentModificationException (the hereby targeted
 *      class-under-test class)
 * @see ConcurrentModificationExceptionTests ConcurrentModificationExceptionTests (The complementary j8unit test
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ConcurrentModificationException.class!",
                   java.util.ConcurrentModificationException.class.isAssignableFrom(sut));
    }

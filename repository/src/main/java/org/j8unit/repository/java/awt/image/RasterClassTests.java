 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Raster public class
...
public abstract interface RasterClassTests<SUT extends Raster>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Raster.class!",
                   Raster.class.isAssignableFrom(sut));
    }

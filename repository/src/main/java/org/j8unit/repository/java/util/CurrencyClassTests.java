 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Currency public
 * final class java.util.Currency}.
 *
...
public abstract interface CurrencyClassTests<SUT extends Currency>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Currency.class!",
                   Currency.class.isAssignableFrom(sut));
    }

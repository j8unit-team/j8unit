...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Currency class java.util.Currency}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CurrencyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CurrencyTests}.
 * </p>
 *
 * @see java.util.Currency class java.util.Currency (the hereby targeted class-under-test class)
 * @see CurrencyTests CurrencyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CurrencyClassTests<SUT extends java.util.Currency>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Currency.class!",
                   java.util.Currency.class.isAssignableFrom(sut));
    }

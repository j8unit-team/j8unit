 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MemoryManagerMXBean
 * public abstract interface java.lang.management.MemoryManagerMXBean}.
 *
...
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryManagerMXBean.class!",
                   MemoryManagerMXBean.class.isAssignableFrom(sut));
    }

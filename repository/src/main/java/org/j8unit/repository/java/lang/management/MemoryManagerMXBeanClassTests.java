 ...
 * java.lang.management.MemoryManagerMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MemoryManagerMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 * @see MemoryManagerMXBeanTests MemoryManagerMXBeanTests (The complementary j8unit test interface containing the
...
public abstract interface MemoryManagerMXBeanClassTests<SUT extends java.lang.management.MemoryManagerMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.MemoryManagerMXBean.class!",
                   java.lang.management.MemoryManagerMXBean.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DisplayMode public
 * final class java.awt.DisplayMode}.
 *
...
public abstract interface DisplayModeClassTests<SUT extends DisplayMode>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DisplayMode.class!",
                   DisplayMode.class.isAssignableFrom(sut));
    }

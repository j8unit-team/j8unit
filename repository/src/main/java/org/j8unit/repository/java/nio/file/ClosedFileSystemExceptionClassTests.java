 ...
 * java.nio.file.ClosedFileSystemException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link ClosedFileSystemExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ClosedFileSystemExceptionTests ClosedFileSystemExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.ClosedFileSystemException.class!",
                   java.nio.file.ClosedFileSystemException.class.isAssignableFrom(sut));
    }

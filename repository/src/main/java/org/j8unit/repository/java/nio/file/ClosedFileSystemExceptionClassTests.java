...
public abstract interface ClosedFileSystemExceptionClassTests<SUT extends ClosedFileSystemException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClosedFileSystemException.class!",
                   ClosedFileSystemException.class.isAssignableFrom(sut));
    }

 ...
 * {@link DoubleSummaryStatistics public class java.util.DoubleSummaryStatistics}.
 *
...
public abstract interface DoubleSummaryStatisticsClassTests<SUT extends DoubleSummaryStatistics>
extends org.j8unit.repository.java.util.function.DoubleConsumerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleSummaryStatistics.class!",
                   DoubleSummaryStatistics.class.isAssignableFrom(sut));
    }

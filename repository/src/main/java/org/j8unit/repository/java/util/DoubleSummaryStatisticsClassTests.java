 ...
 * java.util.DoubleSummaryStatistics}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleSummaryStatisticsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link DoubleSummaryStatisticsTests}.
 * </p>
 *
 * @see java.util.DoubleSummaryStatistics class java.util.DoubleSummaryStatistics (the hereby targeted class-under-test
 *      class)
 * @see DoubleSummaryStatisticsTests DoubleSummaryStatisticsTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.util.function.DoubleConsumerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.DoubleSummaryStatistics.class!",
                   java.util.DoubleSummaryStatistics.class.isAssignableFrom(sut));
    }

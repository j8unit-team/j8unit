...
public abstract interface IncompleteAnnotationExceptionClassTests<SUT extends IncompleteAnnotationException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IncompleteAnnotationException.class!",
                   IncompleteAnnotationException.class.isAssignableFrom(sut));
    }

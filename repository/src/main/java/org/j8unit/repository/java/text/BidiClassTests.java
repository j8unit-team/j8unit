...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.Bidi class java.text.Bidi}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BidiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BidiTests}.
 * </p>
 *
 * @see java.text.Bidi class java.text.Bidi (the hereby targeted class-under-test class)
 * @see BidiTests BidiTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.Bidi.class!",
                   java.text.Bidi.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Bidi public final
...
public abstract interface BidiClassTests<SUT extends Bidi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Bidi.class!", Bidi.class.isAssignableFrom(sut));
    }

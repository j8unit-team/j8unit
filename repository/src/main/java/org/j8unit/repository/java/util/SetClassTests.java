...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Set interface java.util.Set}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SetTests}.
 * </p>
 *
 * @see java.util.Set interface java.util.Set (the hereby targeted class-under-test class)
 * @see SetTests SetTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface SetClassTests<SUT extends java.util.Set>
extends CollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Set.class!",
                   java.util.Set.class.isAssignableFrom(sut));
    }

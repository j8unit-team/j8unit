...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.DoubleSupplier interface
 * java.util.function.DoubleSupplier}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleSupplierTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleSupplierTests}.
 * </p>
 *
 * @see java.util.function.DoubleSupplier interface java.util.function.DoubleSupplier (the hereby targeted
 *      class-under-test class)
 * @see DoubleSupplierTests DoubleSupplierTests (The complementary j8unit test interface containing the instance
...
public abstract interface DoubleSupplierClassTests<SUT extends java.util.function.DoubleSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoubleSupplier.class!",
                   java.util.function.DoubleSupplier.class.isAssignableFrom(sut));
    }

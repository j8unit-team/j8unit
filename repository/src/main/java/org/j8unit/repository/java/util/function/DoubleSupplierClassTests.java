 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleSupplier
...
public abstract interface DoubleSupplierClassTests<SUT extends DoubleSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleSupplier.class!",
                   DoubleSupplier.class.isAssignableFrom(sut));
    }

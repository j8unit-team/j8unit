 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.AbstractMap
 */
...
extends org.j8unit.repository.java.util.MapClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * java.util.AbstractMap$SimpleEntry}, containing all class relevant test methods (at least the test methods of
     ...
     * @since 0.9.0
     *
     * @j8unit.aim java.util.AbstractMap.SimpleEntry
     */
    @SuppressWarnings("rawtypes")
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    ...
    org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
         ...
         * </p>
         *
         * @j8unit.aim java.util.AbstractMap.SimpleEntry#SimpleEntry(java.util.Map.Entry)
         */
         ...
         * </p>
         *
         * @j8unit.aim java.util.AbstractMap.SimpleEntry#SimpleEntry(java.lang.Object, java.lang.Object)
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
        ...
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            final java.util.AbstractMap.SimpleEntry<?, ?> sut = null; // = new SimpleEntry(java.lang.Object,
                                                                      // java.lang.Object);
        }
         ...
         * @since 0.9.2
         *
         * @j8unit.aim java.util.AbstractMap.SimpleEntry#isAssignableFrom(java.lang.Class)
         */
        @Override
        @Test
     ...
     * @since 0.9.0
     *
     * @j8unit.aim java.util.AbstractMap.SimpleImmutableEntry
     */
    @SuppressWarnings("rawtypes")
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    ...
    org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
         ...
         * </p>
         *
         * @j8unit.aim java.util.AbstractMap.SimpleImmutableEntry#SimpleImmutableEntry(java.util.Map.Entry)
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
         ...
         * </p>
         *
         * @j8unit.aim java.util.AbstractMap.SimpleImmutableEntry#SimpleImmutableEntry(java.lang.Object,
         *             java.lang.Object)
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        ...
        throws Exception {
            ...
            @SuppressWarnings("unused")
            final java.util.AbstractMap.SimpleImmutableEntry<?, ?> sut = null; // = new
                                                                               // SimpleImmutableEntry(java.lang.Object,
                                                                               // java.lang.Object);
        }
         ...
         * @since 0.9.2
         *
         * @j8unit.aim java.util.AbstractMap.SimpleImmutableEntry#isAssignableFrom(java.lang.Class)
         */
        @Override
        @Test
        public default void testBaseTypeIsAssignableFromCurrentType()
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.AbstractMap#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test
    public default void testBaseTypeIsAssignableFromCurrentType()

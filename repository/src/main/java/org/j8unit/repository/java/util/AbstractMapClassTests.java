...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.AbstractMap class java.util.AbstractMap}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractMapTests}).
 * </p>
 *
 * <p>
 ...
 * @see AbstractMapTests AbstractMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends MapClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractMap.class!",
                   java.util.AbstractMap.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.AbstractMap.SimpleImmutableEntry class
     * java.util.AbstractMap$SimpleImmutableEntry}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link AbstractMapTests.SimpleImmutableEntryTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see AbstractMapTests.SimpleImmutableEntryTests AbstractMapTests.SimpleImmutableEntryTests (The complementary
    ...
    extends MapClassTests.EntryClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
    org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractMap.SimpleImmutableEntry.class!",
                       java.util.AbstractMap.SimpleImmutableEntry.class.isAssignableFrom(sut));
        }
    ...
    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.AbstractMap.SimpleEntry class
     * java.util.AbstractMap$SimpleEntry}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link AbstractMapTests.SimpleEntryTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see AbstractMapTests.SimpleEntryTests AbstractMapTests.SimpleEntryTests (The complementary j8unit test interface
    ...
    org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractMap.SimpleEntry.class!",
                       java.util.AbstractMap.SimpleEntry.class.isAssignableFrom(sut));
        }

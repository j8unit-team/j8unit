 ...
 * java.nio.channels.spi.AbstractInterruptibleChannel}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see AbstractInterruptibleChannelTests AbstractInterruptibleChannelTests (The complementary j8unit test interface
...
public abstract interface AbstractInterruptibleChannelClassTests<SUT extends java.nio.channels.spi.AbstractInterruptibleChannel>
extends org.j8unit.repository.java.nio.channels.ChannelClassTests<SUT>, org.j8unit.repository.java.nio.channels.InterruptibleChannelClassTests<SUT>,
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.spi.AbstractInterruptibleChannel.class!",
                   java.nio.channels.spi.AbstractInterruptibleChannel.class.isAssignableFrom(sut));
    }

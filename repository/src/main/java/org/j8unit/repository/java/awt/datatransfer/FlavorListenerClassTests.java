 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FlavorListener
...
public abstract interface FlavorListenerClassTests<SUT extends FlavorListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FlavorListener.class!",
                   FlavorListener.class.isAssignableFrom(sut));
    }

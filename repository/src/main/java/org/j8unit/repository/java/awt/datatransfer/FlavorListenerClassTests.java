 ...
 * java.awt.datatransfer.FlavorListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlavorListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FlavorListenerTests}.
 * </p>
 *
 * @see java.awt.datatransfer.FlavorListener interface java.awt.datatransfer.FlavorListener (the hereby targeted
 *      class-under-test class)
 * @see FlavorListenerTests FlavorListenerTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.FlavorListener.class!",
                   java.awt.datatransfer.FlavorListener.class.isAssignableFrom(sut));
    }

...
public abstract interface InterruptibleChannelClassTests<SUT extends InterruptibleChannel>
extends org.j8unit.repository.java.nio.channels.ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InterruptibleChannel.class!",
                   InterruptibleChannel.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.InterruptibleChannel interface
 * java.nio.channels.InterruptibleChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InterruptibleChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InterruptibleChannelTests}
 * .
 * </p>
 *
 * @see java.nio.channels.InterruptibleChannel interface java.nio.channels.InterruptibleChannel (the hereby targeted
 *      class-under-test class)
 * @see InterruptibleChannelTests InterruptibleChannelTests (The complementary j8unit test interface containing the
...
public abstract interface InterruptibleChannelClassTests<SUT extends java.nio.channels.InterruptibleChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.InterruptibleChannel.class!",
                   java.nio.channels.InterruptibleChannel.class.isAssignableFrom(sut));
    }

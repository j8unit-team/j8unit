 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link Scrollbar
 ...
 * {@link org.j8unit.repository.java.awt.ScrollbarClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface ScrollbarTests<SUT extends Scrollbar>
...
org.j8unit.repository.java.awt.ComponentTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getVisible()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getLineIncrement()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getPageIncrement()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link java.awt.Scrollbar#getListeners(Class) public <T>
     * T[] java.awt.Scrollbar.getListeners(java.lang.Class<T>)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.

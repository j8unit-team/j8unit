 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileSystems public
 * final class java.nio.file.FileSystems}.
 *
...
public abstract interface FileSystemsClassTests<SUT extends FileSystems>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystems.class!",
                   FileSystems.class.isAssignableFrom(sut));
    }

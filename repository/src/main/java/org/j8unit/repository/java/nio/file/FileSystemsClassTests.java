 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileSystemsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileSystemsTests}.
 * </p>
 *
 * @see java.nio.file.FileSystems class java.nio.file.FileSystems (the hereby targeted class-under-test class)
 * @see FileSystemsTests FileSystemsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileSystems.class!",
                   java.nio.file.FileSystems.class.isAssignableFrom(sut));
    }

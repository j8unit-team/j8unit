 ...
 * java.nio.channels.NonReadableChannelException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link NonReadableChannelExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.channels.NonReadableChannelException class java.nio.channels.NonReadableChannelException (the hereby
 *      targeted class-under-test class)
 * @see NonReadableChannelExceptionTests NonReadableChannelExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.NonReadableChannelException.class!",
                   java.nio.channels.NonReadableChannelException.class.isAssignableFrom(sut));
    }

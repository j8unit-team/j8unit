...
public abstract interface NonReadableChannelExceptionClassTests<SUT extends NonReadableChannelException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NonReadableChannelException.class!",
                   NonReadableChannelException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.channels.NonReadableChannelException]

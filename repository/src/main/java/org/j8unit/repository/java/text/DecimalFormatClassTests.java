 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DecimalFormat
...
public abstract interface DecimalFormatClassTests<SUT extends DecimalFormat>
extends NumberFormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DecimalFormat.class!",
                   DecimalFormat.class.isAssignableFrom(sut));
    }

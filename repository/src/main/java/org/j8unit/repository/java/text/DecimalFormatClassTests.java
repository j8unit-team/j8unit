...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.DecimalFormat class java.text.DecimalFormat}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DecimalFormatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DecimalFormatTests}.
 * </p>
 *
 * @see java.text.DecimalFormat class java.text.DecimalFormat (the hereby targeted class-under-test class)
 * @see DecimalFormatTests DecimalFormatTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DecimalFormatClassTests<SUT extends java.text.DecimalFormat>
extends NumberFormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.DecimalFormat.class!",
                   java.text.DecimalFormat.class.isAssignableFrom(sut));
    }

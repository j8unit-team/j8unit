...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.DataOutput interface java.io.DataOutput}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataOutputTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataOutputTests}.
 * </p>
 *
 * @see java.io.DataOutput interface java.io.DataOutput (the hereby targeted class-under-test class)
 * @see DataOutputTests DataOutputTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DataOutputClassTests<SUT extends java.io.DataOutput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.DataOutput.class!",
                   java.io.DataOutput.class.isAssignableFrom(sut));
    }

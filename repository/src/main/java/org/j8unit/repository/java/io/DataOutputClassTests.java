 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataOutput public
 * abstract interface java.io.DataOutput}.
 *
...
public abstract interface DataOutputClassTests<SUT extends DataOutput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataOutput.class!",
                   DataOutput.class.isAssignableFrom(sut));
    }

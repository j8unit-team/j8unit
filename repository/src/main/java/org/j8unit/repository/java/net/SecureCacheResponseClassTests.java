...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.SecureCacheResponse class java.net.SecureCacheResponse},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecureCacheResponseTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecureCacheResponseTests}.
 * </p>
 *
 * @see java.net.SecureCacheResponse class java.net.SecureCacheResponse (the hereby targeted class-under-test class)
 * @see SecureCacheResponseTests SecureCacheResponseTests (The complementary j8unit test interface containing the
...
extends CacheResponseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SecureCacheResponse.class!",
                   java.net.SecureCacheResponse.class.isAssignableFrom(sut));
    }

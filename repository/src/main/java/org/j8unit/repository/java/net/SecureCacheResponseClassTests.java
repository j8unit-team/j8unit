 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecureCacheResponse
...
public abstract interface SecureCacheResponseClassTests<SUT extends SecureCacheResponse>
extends CacheResponseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecureCacheResponse.class!",
                   SecureCacheResponse.class.isAssignableFrom(sut));
    }

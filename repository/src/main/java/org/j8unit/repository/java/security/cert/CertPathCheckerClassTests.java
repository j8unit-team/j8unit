 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertPathChecker
...
public abstract interface CertPathCheckerClassTests<SUT extends CertPathChecker>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathChecker.class!",
                   CertPathChecker.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.cert.CertPathChecker interface
 * java.security.cert.CertPathChecker}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertPathCheckerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertPathCheckerTests}.
 * </p>
 *
 * @see java.security.cert.CertPathChecker interface java.security.cert.CertPathChecker (the hereby targeted
 *      class-under-test class)
 * @see CertPathCheckerTests CertPathCheckerTests (The complementary j8unit test interface containing the instance
...
public abstract interface CertPathCheckerClassTests<SUT extends java.security.cert.CertPathChecker>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathChecker.class!",
                   java.security.cert.CertPathChecker.class.isAssignableFrom(sut));
    }

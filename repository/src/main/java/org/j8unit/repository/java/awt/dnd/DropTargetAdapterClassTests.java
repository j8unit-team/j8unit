 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTargetAdapter
 * public abstract class java.awt.dnd.DropTargetAdapter}.
 *
...
public abstract interface DropTargetAdapterClassTests<SUT extends DropTargetAdapter>
extends org.j8unit.repository.java.awt.dnd.DropTargetListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetAdapter.class!",
                   DropTargetAdapter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RSAPrivateCrtKey
 * public abstract interface java.security.interfaces.RSAPrivateCrtKey}.
 *
...
public abstract interface RSAPrivateCrtKeyClassTests<SUT extends RSAPrivateCrtKey>
extends RSAPrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAPrivateCrtKey.class!",
                   RSAPrivateCrtKey.class.isAssignableFrom(sut));
    }

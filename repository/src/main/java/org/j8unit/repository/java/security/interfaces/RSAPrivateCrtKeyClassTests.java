...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.interfaces.RSAPrivateCrtKey interface
 * java.security.interfaces.RSAPrivateCrtKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAPrivateCrtKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RSAPrivateCrtKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.RSAPrivateCrtKey interface java.security.interfaces.RSAPrivateCrtKey (the hereby
 *      targeted class-under-test class)
 * @see RSAPrivateCrtKeyTests RSAPrivateCrtKeyTests (The complementary j8unit test interface containing the instance
...
public abstract interface RSAPrivateCrtKeyClassTests<SUT extends java.security.interfaces.RSAPrivateCrtKey>
extends RSAPrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.RSAPrivateCrtKey.class!",
                   java.security.interfaces.RSAPrivateCrtKey.class.isAssignableFrom(sut));
    }

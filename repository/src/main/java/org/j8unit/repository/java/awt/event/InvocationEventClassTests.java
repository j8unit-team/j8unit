...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.InvocationEvent class java.awt.event.InvocationEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvocationEventTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.event.InvocationEvent class java.awt.event.InvocationEvent (the hereby targeted class-under-test class)
 * @see InvocationEventTests InvocationEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface InvocationEventClassTests<SUT extends java.awt.event.InvocationEvent>
extends org.j8unit.repository.java.awt.ActiveEventClassTests<SUT>, org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.InvocationEvent.class!",
                   java.awt.event.InvocationEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvocationEvent
...
extends ActiveEventClassTests<SUT>, AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvocationEvent.class!",
                   InvocationEvent.class.isAssignableFrom(sut));
    }

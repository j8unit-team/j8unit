 ...
 * java.util.PropertyResourceBundle}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyResourceBundleTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PropertyResourceBundleTests}.
 * </p>
 *
 * @see java.util.PropertyResourceBundle class java.util.PropertyResourceBundle (the hereby targeted class-under-test
 *      class)
 * @see PropertyResourceBundleTests PropertyResourceBundleTests (The complementary j8unit test interface containing the
...
extends ResourceBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.PropertyResourceBundle.class!",
                   java.util.PropertyResourceBundle.class.isAssignableFrom(sut));
    }

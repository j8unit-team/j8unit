...
public abstract interface PropertyResourceBundleClassTests<SUT extends PropertyResourceBundle>
extends ResourceBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyResourceBundle.class!",
                   PropertyResourceBundle.class.isAssignableFrom(sut));
    }

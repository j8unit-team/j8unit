...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.beancontext.BeanContextChildComponentProxy interface
 * java.beans.beancontext.BeanContextChildComponentProxy}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextChildComponentProxyTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextChildComponentProxyTests BeanContextChildComponentProxyTests (The complementary j8unit test interface
...
public abstract interface BeanContextChildComponentProxyClassTests<SUT extends java.beans.beancontext.BeanContextChildComponentProxy>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextChildComponentProxy.class!",
                   java.beans.beancontext.BeanContextChildComponentProxy.class.isAssignableFrom(sut));
    }

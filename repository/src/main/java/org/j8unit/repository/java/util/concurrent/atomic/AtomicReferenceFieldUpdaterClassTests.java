...
public abstract interface AtomicReferenceFieldUpdaterClassTests<SUT extends AtomicReferenceFieldUpdater>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicReferenceFieldUpdater.class!",
                   AtomicReferenceFieldUpdater.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActionListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActionListenerTests}.
 * </p>
 *
 * @see java.awt.event.ActionListener interface java.awt.event.ActionListener (the hereby targeted class-under-test
 *      class)
 * @see ActionListenerTests ActionListenerTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ActionListener.class!",
                   java.awt.event.ActionListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActionListener
...
public abstract interface ActionListenerClassTests<SUT extends ActionListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActionListener.class!",
                   ActionListener.class.isAssignableFrom(sut));
    }

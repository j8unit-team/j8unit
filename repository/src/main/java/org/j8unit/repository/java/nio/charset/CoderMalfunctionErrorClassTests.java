 ...
 * java.nio.charset.CoderMalfunctionError}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CoderMalfunctionErrorTests}).
 * </p>
 *
 * <p>
 ...
 * @see CoderMalfunctionErrorTests CoderMalfunctionErrorTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.CoderMalfunctionError.class!",
                   java.nio.charset.CoderMalfunctionError.class.isAssignableFrom(sut));
    }

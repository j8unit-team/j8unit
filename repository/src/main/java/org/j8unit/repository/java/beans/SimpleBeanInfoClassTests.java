 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleBeanInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleBeanInfoTests}.
 * </p>
 *
 * @see java.beans.SimpleBeanInfo class java.beans.SimpleBeanInfo (the hereby targeted class-under-test class)
 * @see SimpleBeanInfoTests SimpleBeanInfoTests (The complementary j8unit test interface containing the instance
...
public abstract interface SimpleBeanInfoClassTests<SUT extends java.beans.SimpleBeanInfo>
extends BeanInfoClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.SimpleBeanInfo.class!",
                   java.beans.SimpleBeanInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleBeanInfo
...
public abstract interface SimpleBeanInfoClassTests<SUT extends SimpleBeanInfo>
extends BeanInfoClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleBeanInfo.class!",
                   SimpleBeanInfo.class.isAssignableFrom(sut));
    }

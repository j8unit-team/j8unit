...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain StringBuffer class java.lang.StringBuffer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringBufferTests}.
 * </p>
 *
 * @see StringBuffer class java.lang.StringBuffer (the hereby targeted class-under-test class)
 * @see StringBufferTests StringBufferTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StringBufferClassTests<SUT extends StringBuffer>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, CharSequenceClassTests<SUT>, AppendableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringBuffer.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HttpURLConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HttpURLConnectionTests}.
 * </p>
 *
 * @see java.net.HttpURLConnection class java.net.HttpURLConnection (the hereby targeted class-under-test class)
 * @see HttpURLConnectionTests HttpURLConnectionTests (The complementary j8unit test interface containing the instance
...
public abstract interface HttpURLConnectionClassTests<SUT extends java.net.HttpURLConnection>
extends URLConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.HttpURLConnection.class!",
                   java.net.HttpURLConnection.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HttpURLConnection
...
public abstract interface HttpURLConnectionClassTests<SUT extends HttpURLConnection>
extends URLConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HttpURLConnection.class!",
                   HttpURLConnection.class.isAssignableFrom(sut));
    }

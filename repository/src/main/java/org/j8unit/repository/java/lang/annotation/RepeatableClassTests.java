 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Repeatable public
 * abstract @interface java.lang.annotation.Repeatable}.
 *
...
public abstract interface RepeatableClassTests<SUT extends Repeatable>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Repeatable.class!",
                   Repeatable.class.isAssignableFrom(sut));
    }

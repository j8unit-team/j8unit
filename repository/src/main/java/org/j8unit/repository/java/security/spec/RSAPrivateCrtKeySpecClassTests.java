 ...
 * {@link org.j8unit.repository.java.security.spec.RSAPrivateCrtKeySpecTests}.
 * </p>
 *
 * <p>
...
public abstract interface RSAPrivateCrtKeySpecClassTests<SUT extends RSAPrivateCrtKeySpec>
extends RSAPrivateKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAPrivateCrtKeySpec.class!",
                   RSAPrivateCrtKeySpec.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.spec.RSAPrivateCrtKeySpec]

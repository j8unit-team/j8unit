...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.spec.RSAPrivateCrtKeySpec class
 * java.security.spec.RSAPrivateCrtKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAPrivateCrtKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RSAPrivateCrtKeySpecTests}
 * .
 * </p>
 *
 * @see java.security.spec.RSAPrivateCrtKeySpec class java.security.spec.RSAPrivateCrtKeySpec (the hereby targeted
 *      class-under-test class)
 * @see RSAPrivateCrtKeySpecTests RSAPrivateCrtKeySpecTests (The complementary j8unit test interface containing the
...
extends RSAPrivateKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.RSAPrivateCrtKeySpec.class!",
                   java.security.spec.RSAPrivateCrtKeySpec.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProviderTests}).
 * </p>
 *
 * <p>
 ...
 * @see ProviderTests ProviderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.util.PropertiesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Provider.class!",
                   java.security.Provider.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.security.Provider.Service class
     * java.security.Provider$Service}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link ProviderTests.ServiceTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see ProviderTests.ServiceTests ProviderTests.ServiceTests (The complementary j8unit test interface containing
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Provider.Service.class!",
                       java.security.Provider.Service.class.isAssignableFrom(sut));
        }

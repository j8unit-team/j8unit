 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ThreadInfo public
...
public abstract interface ThreadInfoClassTests<SUT extends ThreadInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadInfo.class!",
                   ThreadInfo.class.isAssignableFrom(sut));
    }

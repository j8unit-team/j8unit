 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PseudoColumnUsage
 * public final enum java.sql.PseudoColumnUsage}.
 *
...
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PseudoColumnUsage.class!",
                   PseudoColumnUsage.class.isAssignableFrom(sut));
    }

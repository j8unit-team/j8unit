 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PseudoColumnUsageTests}).
 * </p>
 *
 * <p>
 ...
 * @see PseudoColumnUsageTests PseudoColumnUsageTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.PseudoColumnUsage.class!",
                   java.sql.PseudoColumnUsage.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain InterruptedException class java.lang.InterruptedException}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InterruptedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InterruptedExceptionTests}
 * .
 * </p>
 *
 * @see InterruptedException class java.lang.InterruptedException (the hereby targeted class-under-test class)
 * @see InterruptedExceptionTests InterruptedExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface InterruptedExceptionClassTests<SUT extends InterruptedException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InterruptedException.class!",
                   InterruptedException.class.isAssignableFrom(sut));
    }

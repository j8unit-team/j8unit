 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ICC_ColorSpace
...
public abstract interface ICC_ColorSpaceClassTests<SUT extends ICC_ColorSpace>
extends ColorSpaceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ICC_ColorSpace.class!",
                   ICC_ColorSpace.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AclEntry public
 * final class java.nio.file.attribute.AclEntry}.
 *
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AclEntry.class!",
                   AclEntry.class.isAssignableFrom(sut));
    }
     ...
     * {@link Builder public static final class java.nio.file.attribute.AclEntry$Builder}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

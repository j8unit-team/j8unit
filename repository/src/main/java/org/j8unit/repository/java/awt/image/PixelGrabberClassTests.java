 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PixelGrabber public
...
public abstract interface PixelGrabberClassTests<SUT extends PixelGrabber>
extends org.j8unit.repository.java.awt.image.ImageConsumerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PixelGrabber.class!",
                   PixelGrabber.class.isAssignableFrom(sut));
    }

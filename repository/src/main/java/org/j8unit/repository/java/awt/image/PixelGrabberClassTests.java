 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PixelGrabberTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PixelGrabberTests}.
 * </p>
 *
 * @see java.awt.image.PixelGrabber class java.awt.image.PixelGrabber (the hereby targeted class-under-test class)
 * @see PixelGrabberTests PixelGrabberTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ImageConsumerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.PixelGrabber.class!",
                   java.awt.image.PixelGrabber.class.isAssignableFrom(sut));
    }

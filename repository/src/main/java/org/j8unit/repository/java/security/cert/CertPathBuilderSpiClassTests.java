 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertPathBuilderSpi
...
public abstract interface CertPathBuilderSpiClassTests<SUT extends CertPathBuilderSpi>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.cert.CertPathBuilderSpi]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathBuilderSpi.class!",
                   CertPathBuilderSpi.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.cert.CertPathBuilderSpi]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.security.cert.CertPathBuilderSpi]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Instrumentation
...
public abstract interface InstrumentationClassTests<SUT extends Instrumentation>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Instrumentation.class!",
                   Instrumentation.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.lang.instrument.Instrumentation]

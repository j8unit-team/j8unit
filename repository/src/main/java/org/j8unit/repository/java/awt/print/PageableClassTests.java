 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Pageable public
...
public abstract interface PageableClassTests<SUT extends Pageable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Pageable.class!",
                   Pageable.class.isAssignableFrom(sut));
    }

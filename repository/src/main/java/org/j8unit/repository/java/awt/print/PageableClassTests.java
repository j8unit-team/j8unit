 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PageableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PageableTests}.
 * </p>
 *
 * @see java.awt.print.Pageable interface java.awt.print.Pageable (the hereby targeted class-under-test class)
 * @see PageableTests PageableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PageableClassTests<SUT extends java.awt.print.Pageable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.Pageable.class!",
                   java.awt.print.Pageable.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RemoteRef public
 * abstract interface java.rmi.server.RemoteRef}.
 *
...
public abstract interface RemoteRefClassTests<SUT extends RemoteRef>
extends ExternalizableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemoteRef.class!",
                   RemoteRef.class.isAssignableFrom(sut));
    }

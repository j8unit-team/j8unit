...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.server.RemoteRef interface java.rmi.server.RemoteRef},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RemoteRefTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RemoteRefTests}.
 * </p>
 *
 * @see java.rmi.server.RemoteRef interface java.rmi.server.RemoteRef (the hereby targeted class-under-test class)
 * @see RemoteRefTests RemoteRefTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RemoteRefClassTests<SUT extends java.rmi.server.RemoteRef>
extends org.j8unit.repository.java.io.ExternalizableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RemoteRef.class!",
                   java.rmi.server.RemoteRef.class.isAssignableFrom(sut));
    }

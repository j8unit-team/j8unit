...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.ImageProducer interface java.awt.image.ImageProducer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageProducerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageProducerTests}.
 * </p>
 *
 * @see java.awt.image.ImageProducer interface java.awt.image.ImageProducer (the hereby targeted class-under-test class)
 * @see ImageProducerTests ImageProducerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ImageProducerClassTests<SUT extends java.awt.image.ImageProducer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ImageProducer.class!",
                   java.awt.image.ImageProducer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageProducer
...
public abstract interface ImageProducerClassTests<SUT extends ImageProducer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageProducer.class!",
                   ImageProducer.class.isAssignableFrom(sut));
    }

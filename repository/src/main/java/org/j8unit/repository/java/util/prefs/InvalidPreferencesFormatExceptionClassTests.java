...
public abstract interface InvalidPreferencesFormatExceptionClassTests<SUT extends InvalidPreferencesFormatException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidPreferencesFormatException.class!",
                   InvalidPreferencesFormatException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UTFDataFormatExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link UTFDataFormatExceptionTests}.
 * </p>
 *
 * @see java.io.UTFDataFormatException class java.io.UTFDataFormatException (the hereby targeted class-under-test class)
 * @see UTFDataFormatExceptionTests UTFDataFormatExceptionTests (The complementary j8unit test interface containing the
...
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.UTFDataFormatException.class!",
                   java.io.UTFDataFormatException.class.isAssignableFrom(sut));
    }

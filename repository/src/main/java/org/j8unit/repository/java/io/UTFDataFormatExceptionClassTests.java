...
public abstract interface UTFDataFormatExceptionClassTests<SUT extends UTFDataFormatException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UTFDataFormatException.class!",
                   UTFDataFormatException.class.isAssignableFrom(sut));
    }

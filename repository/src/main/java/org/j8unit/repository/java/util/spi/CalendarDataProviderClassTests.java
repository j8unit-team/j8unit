 ...
 * java.util.spi.CalendarDataProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CalendarDataProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CalendarDataProviderTests}
 * .
 * </p>
 *
 * @see java.util.spi.CalendarDataProvider class java.util.spi.CalendarDataProvider (the hereby targeted
 *      class-under-test class)
 * @see CalendarDataProviderTests CalendarDataProviderTests (The complementary j8unit test interface containing the
...
public abstract interface CalendarDataProviderClassTests<SUT extends java.util.spi.CalendarDataProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.spi.CalendarDataProvider.class!",
                   java.util.spi.CalendarDataProvider.class.isAssignableFrom(sut));
    }

 ...
 * {@link CalendarDataProvider public abstract class java.util.spi.CalendarDataProvider}.
 *
 ...
 * {@link CalendarDataProviderTests}.
 * </p>
 *
 * <p>
...
public abstract interface CalendarDataProviderClassTests<SUT extends CalendarDataProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CalendarDataProvider.class!",
                   CalendarDataProvider.class.isAssignableFrom(sut));
    }

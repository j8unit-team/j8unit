 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BigInteger public
...
public abstract interface BigIntegerClassTests<SUT extends BigInteger>
extends ComparableClassTests<SUT>, NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BigInteger.class!",
                   BigInteger.class.isAssignableFrom(sut));
    }

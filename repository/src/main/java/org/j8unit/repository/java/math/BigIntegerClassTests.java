...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.math.BigInteger class java.math.BigInteger}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BigIntegerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BigIntegerTests}.
 * </p>
 *
 * @see java.math.BigInteger class java.math.BigInteger (the hereby targeted class-under-test class)
 * @see BigIntegerTests BigIntegerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.math.BigInteger.class!",
                   java.math.BigInteger.class.isAssignableFrom(sut));
    }

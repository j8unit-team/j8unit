 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateFormatSymbolsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateFormatSymbolsTests}.
 * </p>
 *
 * @see java.text.DateFormatSymbols class java.text.DateFormatSymbols (the hereby targeted class-under-test class)
 * @see DateFormatSymbolsTests DateFormatSymbolsTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.DateFormatSymbols.class!",
                   java.text.DateFormatSymbols.class.isAssignableFrom(sut));
    }

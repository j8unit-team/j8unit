 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateFormatSymbols
...
public abstract interface DateFormatSymbolsClassTests<SUT extends DateFormatSymbols>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateFormatSymbols.class!",
                   DateFormatSymbols.class.isAssignableFrom(sut));
    }

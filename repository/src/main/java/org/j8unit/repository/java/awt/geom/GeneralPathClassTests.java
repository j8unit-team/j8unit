...
import org.j8unit.repository.java.awt.geom.Path2DClassTests.FloatClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GeneralPath public
 * final class java.awt.geom.GeneralPath}.
 *
...
public abstract interface GeneralPathClassTests<SUT extends GeneralPath>
extends FloatClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.geom.GeneralPath]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GeneralPath.class!",

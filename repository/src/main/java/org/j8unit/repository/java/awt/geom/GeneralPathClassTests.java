 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GeneralPathTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GeneralPathTests}.
 * </p>
 *
 * @see java.awt.geom.GeneralPath class java.awt.geom.GeneralPath (the hereby targeted class-under-test class)
 * @see GeneralPathTests GeneralPathTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends Path2DClassTests.FloatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.GeneralPath.class!",
                   java.awt.geom.GeneralPath.class.isAssignableFrom(sut));
    }

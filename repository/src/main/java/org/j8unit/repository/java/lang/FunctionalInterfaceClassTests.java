...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain FunctionalInterface interface java.lang.FunctionalInterface},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FunctionalInterfaceTests}).
 * </p>
 *
 * <p>
 ...
 * @see FunctionalInterfaceTests FunctionalInterfaceTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FunctionalInterface.class!",
                   FunctionalInterface.class.isAssignableFrom(sut));
    }

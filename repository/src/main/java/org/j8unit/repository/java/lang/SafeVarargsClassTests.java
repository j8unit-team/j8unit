...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain SafeVarargs interface java.lang.SafeVarargs}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SafeVarargsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SafeVarargsTests}.
 * </p>
 *
 * @see SafeVarargs interface java.lang.SafeVarargs (the hereby targeted class-under-test class)
 * @see SafeVarargsTests SafeVarargsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SafeVarargsClassTests<SUT extends SafeVarargs>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SafeVarargs.class!",
                   SafeVarargs.class.isAssignableFrom(sut));
    }

 ...
 * {@link SQLNonTransientException public class java.sql.SQLNonTransientException}.
 *
...
extends org.j8unit.repository.java.sql.SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLNonTransientException.class!",
                   SQLNonTransientException.class.isAssignableFrom(sut));
    }

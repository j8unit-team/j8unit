 ...
 * java.sql.SQLNonTransientException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLNonTransientExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.sql.SQLNonTransientException class java.sql.SQLNonTransientException (the hereby targeted class-under-test
 *      class)
 * @see SQLNonTransientExceptionTests SQLNonTransientExceptionTests (The complementary j8unit test interface containing
...
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLNonTransientException.class!",
                   java.sql.SQLNonTransientException.class.isAssignableFrom(sut));
    }

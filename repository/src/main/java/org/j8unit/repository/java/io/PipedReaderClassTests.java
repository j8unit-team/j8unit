...
/**
 * <p>
 * Test class for {@link java.io.PipedReader class java.io.PipedReader}, containing all class relevant test methods (at
 * least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.io.PipedReaderTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.io.ReaderClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.io.PipedReader> sut = createNewSUT();

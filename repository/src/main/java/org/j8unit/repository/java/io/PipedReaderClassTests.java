 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PipedReader public
...
public abstract interface PipedReaderClassTests<SUT extends PipedReader>
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PipedReader.class!",
                   PipedReader.class.isAssignableFrom(sut));
    }

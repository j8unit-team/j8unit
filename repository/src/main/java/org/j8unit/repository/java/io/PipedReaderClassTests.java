...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.PipedReader class java.io.PipedReader}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PipedReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PipedReaderTests}.
 * </p>
 *
 * @see java.io.PipedReader class java.io.PipedReader (the hereby targeted class-under-test class)
 * @see PipedReaderTests PipedReaderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PipedReader.class!",
                   java.io.PipedReader.class.isAssignableFrom(sut));
    }

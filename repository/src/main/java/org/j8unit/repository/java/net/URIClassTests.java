...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.URI class java.net.URI}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URITests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URITests}.
 * </p>
 *
 * @see java.net.URI class java.net.URI (the hereby targeted class-under-test class)
 * @see URITests URITests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URI.class!",
                   java.net.URI.class.isAssignableFrom(sut));
    }

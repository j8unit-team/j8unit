 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GradientPaintTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GradientPaintTests}.
 * </p>
 *
 * @see java.awt.GradientPaint class java.awt.GradientPaint (the hereby targeted class-under-test class)
 * @see GradientPaintTests GradientPaintTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends PaintClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.GradientPaint.class!",
                   java.awt.GradientPaint.class.isAssignableFrom(sut));
    }

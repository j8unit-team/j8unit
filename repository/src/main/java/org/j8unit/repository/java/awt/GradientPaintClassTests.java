 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GradientPaint
...
public abstract interface GradientPaintClassTests<SUT extends GradientPaint>
extends PaintClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GradientPaint.class!",
                   GradientPaint.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Frame class java.awt.Frame}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FrameTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FrameTests}.
 * </p>
 *
 * @see java.awt.Frame class java.awt.Frame (the hereby targeted class-under-test class)
 * @see FrameTests FrameTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface FrameClassTests<SUT extends java.awt.Frame>
extends MenuContainerClassTests<SUT>, WindowClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Frame.class!",
                   java.awt.Frame.class.isAssignableFrom(sut));
    }

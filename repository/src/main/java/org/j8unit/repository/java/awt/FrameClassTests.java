 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Frame public class
 * java.awt.Frame}.
 *
...
public abstract interface FrameClassTests<SUT extends Frame>
extends WindowClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Frame]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Frame.class!", Frame.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.java.awt.MenuContainerClassTests<SUT>, org.j8unit.repository.java.awt.WindowClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_Frame_GraphicsConfiguration()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.Frame sut = null; // = new Frame(java.awt.GraphicsConfiguration);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_getFrames()
    throws Exception {

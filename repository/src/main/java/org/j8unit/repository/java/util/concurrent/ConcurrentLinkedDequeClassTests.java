 ...
 * java.util.concurrent.ConcurrentLinkedDeque}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConcurrentLinkedDequeTests}).
 * </p>
 *
 * <p>
 ...
 * @see ConcurrentLinkedDequeTests ConcurrentLinkedDequeTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.util.AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ConcurrentLinkedDeque.class!",
                   java.util.concurrent.ConcurrentLinkedDeque.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyboardFocusManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyboardFocusManagerTests}
 * .
 * </p>
 *
 * @see java.awt.KeyboardFocusManager class java.awt.KeyboardFocusManager (the hereby targeted class-under-test class)
 * @see KeyboardFocusManagerTests KeyboardFocusManagerTests (The complementary j8unit test interface containing the
...
public abstract interface KeyboardFocusManagerClassTests<SUT extends java.awt.KeyboardFocusManager>
extends KeyEventDispatcherClassTests<SUT>, KeyEventPostProcessorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.KeyboardFocusManager.class!",
                   java.awt.KeyboardFocusManager.class.isAssignableFrom(sut));
    }

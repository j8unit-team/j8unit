 ...
 * {@link KeyboardFocusManagerTests}.
 * </p>
 *
 * <p>
...
public abstract interface KeyboardFocusManagerClassTests<SUT extends KeyboardFocusManager>
extends KeyEventDispatcherClassTests<SUT>, KeyEventPostProcessorClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyboardFocusManager.class!",
                   KeyboardFocusManager.class.isAssignableFrom(sut));
    }

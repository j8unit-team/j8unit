 ...
 * java.nio.charset.UnsupportedCharsetException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UnsupportedCharsetExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.charset.UnsupportedCharsetException class java.nio.charset.UnsupportedCharsetException (the hereby
 *      targeted class-under-test class)
 * @see UnsupportedCharsetExceptionTests UnsupportedCharsetExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.UnsupportedCharsetException.class!",
                   java.nio.charset.UnsupportedCharsetException.class.isAssignableFrom(sut));
    }

 ...
 * {@link UnsupportedCharsetException public class java.nio.charset.UnsupportedCharsetException}.
 *
...
public abstract interface UnsupportedCharsetExceptionClassTests<SUT extends UnsupportedCharsetException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedCharsetException.class!",
                   UnsupportedCharsetException.class.isAssignableFrom(sut));
    }

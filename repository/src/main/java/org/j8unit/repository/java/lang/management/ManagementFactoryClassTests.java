 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ManagementFactory
...
public abstract interface ManagementFactoryClassTests<SUT extends ManagementFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ManagementFactory.class!",
                   ManagementFactory.class.isAssignableFrom(sut));
    }

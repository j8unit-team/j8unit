...
public abstract interface ManagementFactoryClassTests<SUT extends java.lang.management.ManagementFactory>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    /**
     * <p>
     * Test method for {@link java.lang.management.ManagementFactory#getCompilationMXBean() public static
    ...
    @Test
    @Category(Draft.class)
    public default void test_getCompilationMXBean()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link java.lang.management.ManagementFactory#getMemoryPoolMXBeans() public static java.util.List
    ...
    @Test
    @Category(Draft.class)
    public default void test_getMemoryPoolMXBeans()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link java.lang.management.ManagementFactory#getPlatformMXBean(java.lang.Class) public static
    ...
    @Test
    @Category(Draft.class)
    public default void test_getPlatformMXBean_Class()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
     ...
     * <p>
     * Test method for
     * {@link java.lang.management.ManagementFactory#getPlatformMXBean(javax.management.MBeanServerConnection,java.lang.Class)
     * public static java.lang.management.PlatformManagedObject
    ...
    @Test
    @Category(Draft.class)
    public default void test_getPlatformMXBean_MBeanServerConnection_Class()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getPlatformMXBeans_Class()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
     ...
     * <p>
     * Test method for
     * {@link java.lang.management.ManagementFactory#getPlatformMXBeans(javax.management.MBeanServerConnection,java.lang.Class)
    ...
    @Test
    @Category(Draft.class)
    public default void test_getPlatformMXBeans_MBeanServerConnection_Class()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getRuntimeMXBean()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;

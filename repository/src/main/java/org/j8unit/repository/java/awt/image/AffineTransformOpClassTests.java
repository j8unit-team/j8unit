 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AffineTransformOp
 * public class java.awt.image.AffineTransformOp}.
 *
...
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AffineTransformOp.class!",
                   AffineTransformOp.class.isAssignableFrom(sut));
    }

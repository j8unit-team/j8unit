 ...
 * java.awt.image.AffineTransformOp}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AffineTransformOpTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see AffineTransformOpTests AffineTransformOpTests (The complementary j8unit test interface containing the instance
...
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.AffineTransformOp.class!",
                   java.awt.image.AffineTransformOp.class.isAssignableFrom(sut));
    }

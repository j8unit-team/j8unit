...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ThreadLocal class java.lang.ThreadLocal}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadLocalTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ThreadLocalTests}.
 * </p>
 *
 * @see ThreadLocal class java.lang.ThreadLocal (the hereby targeted class-under-test class)
 * @see ThreadLocalTests ThreadLocalTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ThreadLocalClassTests<SUT extends ThreadLocal>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadLocal.class!",
                   ThreadLocal.class.isAssignableFrom(sut));
    }

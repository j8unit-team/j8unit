 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessibleObject
...
public abstract interface AccessibleObjectClassTests<SUT extends AccessibleObject>
extends AnnotatedElementClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessibleObject.class!",
                   AccessibleObject.class.isAssignableFrom(sut));
    }

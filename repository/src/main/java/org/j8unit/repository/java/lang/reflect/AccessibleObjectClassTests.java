...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.AccessibleObject class
 * java.lang.reflect.AccessibleObject}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessibleObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessibleObjectTests}.
 * </p>
 *
 * @see java.lang.reflect.AccessibleObject class java.lang.reflect.AccessibleObject (the hereby targeted
 *      class-under-test class)
 * @see AccessibleObjectTests AccessibleObjectTests (The complementary j8unit test interface containing the instance
...
public abstract interface AccessibleObjectClassTests<SUT extends java.lang.reflect.AccessibleObject>
extends AnnotatedElementClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.AccessibleObject.class!",
                   java.lang.reflect.AccessibleObject.class.isAssignableFrom(sut));
    }

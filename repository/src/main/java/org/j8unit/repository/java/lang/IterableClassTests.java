...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Iterable interface java.lang.Iterable}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IterableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IterableTests}.
 * </p>
 *
 * @see Iterable interface java.lang.Iterable (the hereby targeted class-under-test class)
 * @see IterableTests IterableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IterableClassTests<SUT extends Iterable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Iterable.class!",
                   Iterable.class.isAssignableFrom(sut));
    }

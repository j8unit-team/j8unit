 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragSourceListener
 * public abstract interface java.awt.dnd.DragSourceListener}.
 *
...
public abstract interface DragSourceListenerClassTests<SUT extends DragSourceListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSourceListener.class!",
                   DragSourceListener.class.isAssignableFrom(sut));
    }

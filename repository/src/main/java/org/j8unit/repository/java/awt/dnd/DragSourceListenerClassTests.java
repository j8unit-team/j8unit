...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.dnd.DragSourceListener interface
 * java.awt.dnd.DragSourceListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragSourceListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DragSourceListenerTests}.
 * </p>
 *
 * @see java.awt.dnd.DragSourceListener interface java.awt.dnd.DragSourceListener (the hereby targeted class-under-test
 *      class)
 * @see DragSourceListenerTests DragSourceListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DragSourceListenerClassTests<SUT extends java.awt.dnd.DragSourceListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragSourceListener.class!",
                   java.awt.dnd.DragSourceListener.class.isAssignableFrom(sut));
    }

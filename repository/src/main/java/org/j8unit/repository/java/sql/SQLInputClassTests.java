 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLInput public
...
public abstract interface SQLInputClassTests<SUT extends SQLInput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLInput.class!",
                   SQLInput.class.isAssignableFrom(sut));
    }

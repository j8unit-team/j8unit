...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.SQLInput interface java.sql.SQLInput}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLInputTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLInputTests}.
 * </p>
 *
 * @see java.sql.SQLInput interface java.sql.SQLInput (the hereby targeted class-under-test class)
 * @see SQLInputTests SQLInputTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SQLInputClassTests<SUT extends java.sql.SQLInput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLInput.class!",
                   java.sql.SQLInput.class.isAssignableFrom(sut));
    }

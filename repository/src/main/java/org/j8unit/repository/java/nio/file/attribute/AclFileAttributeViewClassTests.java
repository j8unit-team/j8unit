...
public abstract interface AclFileAttributeViewClassTests<SUT extends AclFileAttributeView>
extends org.j8unit.repository.java.nio.file.attribute.FileOwnerAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AclFileAttributeView.class!",
                   AclFileAttributeView.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.file.attribute.AclFileAttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AclFileAttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AclFileAttributeViewTests}
 * .
 * </p>
 *
 * @see java.nio.file.attribute.AclFileAttributeView interface java.nio.file.attribute.AclFileAttributeView (the hereby
 *      targeted class-under-test class)
 * @see AclFileAttributeViewTests AclFileAttributeViewTests (The complementary j8unit test interface containing the
...
public abstract interface AclFileAttributeViewClassTests<SUT extends java.nio.file.attribute.AclFileAttributeView>
extends FileOwnerAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.AclFileAttributeView.class!",
                   java.nio.file.attribute.AclFileAttributeView.class.isAssignableFrom(sut));
    }

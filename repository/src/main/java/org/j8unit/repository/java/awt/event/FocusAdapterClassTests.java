 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FocusAdapter public
 * abstract class java.awt.event.FocusAdapter}.
 *
...
public abstract interface FocusAdapterClassTests<SUT extends FocusAdapter>
extends FocusListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FocusAdapter.class!",
                   FocusAdapter.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.event.FocusAdapter]

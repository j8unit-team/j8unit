...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.jar.Manifest class java.util.jar.Manifest}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ManifestTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ManifestTests}.
 * </p>
 *
 * @see java.util.jar.Manifest class java.util.jar.Manifest (the hereby targeted class-under-test class)
 * @see ManifestTests ManifestTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ManifestClassTests<SUT extends java.util.jar.Manifest>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.Manifest.class!",
                   java.util.jar.Manifest.class.isAssignableFrom(sut));
    }

 ...
 * java.beans.beancontext.BeanContextServices}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanContextServicesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BeanContextServicesTests}.
 * </p>
 *
 * @see java.beans.beancontext.BeanContextServices interface java.beans.beancontext.BeanContextServices (the hereby
 *      targeted class-under-test class)
 * @see BeanContextServicesTests BeanContextServicesTests (The complementary j8unit test interface containing the
...
extends BeanContextClassTests<SUT>, BeanContextServicesListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServices.class!",
                   java.beans.beancontext.BeanContextServices.class.isAssignableFrom(sut));
    }

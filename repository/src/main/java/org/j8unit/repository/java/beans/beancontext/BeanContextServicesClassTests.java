 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanContextServices
 * public abstract interface java.beans.beancontext.BeanContextServices}.
 *
...
public abstract interface BeanContextServicesClassTests<SUT extends BeanContextServices>
extends BeanContextClassTests<SUT>, BeanContextServicesListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextServices.class!",

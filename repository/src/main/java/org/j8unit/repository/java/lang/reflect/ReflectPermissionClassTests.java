 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReflectPermission
...
public abstract interface ReflectPermissionClassTests<SUT extends ReflectPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReflectPermission.class!",
                   ReflectPermission.class.isAssignableFrom(sut));
    }

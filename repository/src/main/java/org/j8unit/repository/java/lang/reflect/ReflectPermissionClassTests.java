 ...
 * java.lang.reflect.ReflectPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReflectPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReflectPermissionTests}.
 * </p>
 *
 * @see java.lang.reflect.ReflectPermission class java.lang.reflect.ReflectPermission (the hereby targeted
 *      class-under-test class)
 * @see ReflectPermissionTests ReflectPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.ReflectPermission.class!",
                   java.lang.reflect.ReflectPermission.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PointerInfo public
...
public abstract interface PointerInfoClassTests<SUT extends PointerInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PointerInfo.class!",
                   PointerInfo.class.isAssignableFrom(sut));
    }

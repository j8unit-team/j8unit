 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnnotatedType
...
public abstract interface AnnotatedTypeClassTests<SUT extends AnnotatedType>
extends AnnotatedElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotatedType.class!",
                   AnnotatedType.class.isAssignableFrom(sut));
    }

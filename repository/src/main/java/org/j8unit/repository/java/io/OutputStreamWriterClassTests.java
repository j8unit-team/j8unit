 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OutputStreamWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OutputStreamWriterTests}.
 * </p>
 *
 * @see java.io.OutputStreamWriter class java.io.OutputStreamWriter (the hereby targeted class-under-test class)
 * @see OutputStreamWriterTests OutputStreamWriterTests (The complementary j8unit test interface containing the instance
...
public abstract interface OutputStreamWriterClassTests<SUT extends java.io.OutputStreamWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.OutputStreamWriter.class!",
                   java.io.OutputStreamWriter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OutputStreamWriter
...
public abstract interface OutputStreamWriterClassTests<SUT extends OutputStreamWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OutputStreamWriter.class!",
                   OutputStreamWriter.class.isAssignableFrom(sut));
    }

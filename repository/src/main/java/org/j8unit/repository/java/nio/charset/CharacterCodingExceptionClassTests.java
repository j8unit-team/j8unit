 ...
 * {@link CharacterCodingException public class java.nio.charset.CharacterCodingException}.
 *
...
public abstract interface CharacterCodingExceptionClassTests<SUT extends CharacterCodingException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharacterCodingException.class!",
                   CharacterCodingException.class.isAssignableFrom(sut));
    }

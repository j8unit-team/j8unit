 ...
 * java.nio.charset.CharacterCodingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharacterCodingExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link CharacterCodingExceptionTests}.
 * </p>
 *
 * @see java.nio.charset.CharacterCodingException class java.nio.charset.CharacterCodingException (the hereby targeted
 *      class-under-test class)
 * @see CharacterCodingExceptionTests CharacterCodingExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.CharacterCodingException.class!",
                   java.nio.charset.CharacterCodingException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LineNumberInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see LineNumberInputStreamTests LineNumberInputStreamTests (The complementary j8unit test interface containing the
...
extends FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.LineNumberInputStream.class!",
                   java.io.LineNumberInputStream.class.isAssignableFrom(sut));
    }

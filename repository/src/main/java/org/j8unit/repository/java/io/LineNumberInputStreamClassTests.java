 ...
 * {@link LineNumberInputStream public class java.io.LineNumberInputStream}.
 *
...
extends org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineNumberInputStream.class!",
                   LineNumberInputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CharArrayWriter
...
public abstract interface CharArrayWriterClassTests<SUT extends CharArrayWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharArrayWriter.class!",
                   CharArrayWriter.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharArrayWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharArrayWriterTests}.
 * </p>
 *
 * @see java.io.CharArrayWriter class java.io.CharArrayWriter (the hereby targeted class-under-test class)
 * @see CharArrayWriterTests CharArrayWriterTests (The complementary j8unit test interface containing the instance
...
public abstract interface CharArrayWriterClassTests<SUT extends java.io.CharArrayWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.CharArrayWriter.class!",
                   java.io.CharArrayWriter.class.isAssignableFrom(sut));
    }

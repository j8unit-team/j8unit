 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AdjustmentEvent
...
public abstract interface AdjustmentEventClassTests<SUT extends AdjustmentEvent>
extends AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdjustmentEvent.class!",
                   AdjustmentEvent.class.isAssignableFrom(sut));
    }

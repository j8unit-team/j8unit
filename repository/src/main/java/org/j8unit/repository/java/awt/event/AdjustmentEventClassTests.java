...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.AdjustmentEvent class java.awt.event.AdjustmentEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AdjustmentEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AdjustmentEventTests}.
 * </p>
 *
 * @see java.awt.event.AdjustmentEvent class java.awt.event.AdjustmentEvent (the hereby targeted class-under-test class)
 * @see AdjustmentEventTests AdjustmentEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface AdjustmentEventClassTests<SUT extends java.awt.event.AdjustmentEvent>
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.AdjustmentEvent.class!",
                   java.awt.event.AdjustmentEvent.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.datatransfer.FlavorMap interface
 * java.awt.datatransfer.FlavorMap}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlavorMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FlavorMapTests}.
 * </p>
 *
 * @see java.awt.datatransfer.FlavorMap interface java.awt.datatransfer.FlavorMap (the hereby targeted class-under-test
 *      class)
 * @see FlavorMapTests FlavorMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FlavorMapClassTests<SUT extends java.awt.datatransfer.FlavorMap>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.FlavorMap.class!",
                   java.awt.datatransfer.FlavorMap.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FlavorMap public
 * abstract interface java.awt.datatransfer.FlavorMap}.
 *
...
public abstract interface FlavorMapClassTests<SUT extends FlavorMap>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FlavorMap.class!",
                   FlavorMap.class.isAssignableFrom(sut));
    }

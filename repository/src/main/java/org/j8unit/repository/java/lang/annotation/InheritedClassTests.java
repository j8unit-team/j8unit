 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Inherited public
 * abstract @interface java.lang.annotation.Inherited}.
 *
...
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Inherited.class!",
                   Inherited.class.isAssignableFrom(sut));
    }

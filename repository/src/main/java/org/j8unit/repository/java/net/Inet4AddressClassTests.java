 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Inet4Address public
 * final class java.net.Inet4Address}.
 *
...
public abstract interface Inet4AddressClassTests<SUT extends Inet4Address>
extends InetAddressClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Inet4Address.class!",
                   Inet4Address.class.isAssignableFrom(sut));
    }

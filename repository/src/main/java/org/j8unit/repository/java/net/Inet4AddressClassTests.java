...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.Inet4Address class java.net.Inet4Address}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Inet4AddressTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link Inet4AddressTests}.
 * </p>
 *
 * @see java.net.Inet4Address class java.net.Inet4Address (the hereby targeted class-under-test class)
 * @see Inet4AddressTests Inet4AddressTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends InetAddressClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.Inet4Address.class!",
                   java.net.Inet4Address.class.isAssignableFrom(sut));
    }

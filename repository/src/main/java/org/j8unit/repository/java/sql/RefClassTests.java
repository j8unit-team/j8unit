 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Ref public abstract
...
public abstract interface RefClassTests<SUT extends Ref>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Ref.class!", Ref.class.isAssignableFrom(sut));
    }

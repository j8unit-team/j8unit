...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Ref interface java.sql.Ref}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RefTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RefTests}.
 * </p>
 *
 * @see java.sql.Ref interface java.sql.Ref (the hereby targeted class-under-test class)
 * @see RefTests RefTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface RefClassTests<SUT extends java.sql.Ref>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Ref.class!",
                   java.sql.Ref.class.isAssignableFrom(sut));
    }

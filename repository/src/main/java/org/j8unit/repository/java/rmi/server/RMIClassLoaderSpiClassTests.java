 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIClassLoaderSpi
...
public abstract interface RMIClassLoaderSpiClassTests<SUT extends RMIClassLoaderSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIClassLoaderSpi.class!",

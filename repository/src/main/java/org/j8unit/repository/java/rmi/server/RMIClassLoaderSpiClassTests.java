 ...
 * java.rmi.server.RMIClassLoaderSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIClassLoaderSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIClassLoaderSpiTests}.
 * </p>
 *
 * @see java.rmi.server.RMIClassLoaderSpi class java.rmi.server.RMIClassLoaderSpi (the hereby targeted class-under-test
 *      class)
 * @see RMIClassLoaderSpiTests RMIClassLoaderSpiTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RMIClassLoaderSpi.class!",
                   java.rmi.server.RMIClassLoaderSpi.class.isAssignableFrom(sut));
    }

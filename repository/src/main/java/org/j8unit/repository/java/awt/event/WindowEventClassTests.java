...
/**
 * <p>
 * Test class for {@link java.awt.event.WindowEvent class java.awt.event.WindowEvent}, containing all class relevant
...
extends org.j8unit.repository.java.awt.event.ComponentEventClassTests<SUT> {
    ...
    /**
     * Test method for {@link java.awt.event.WindowEvent#WindowEvent(java.awt.Window,int,java.awt.Window,int,int) public
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.event.WindowEvent sut = null; // = new WindowEvent(java.awt.Window,int,java.awt.Window,int,int);
    }
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.awt.event.WindowEvent> sut = createNewSUT();

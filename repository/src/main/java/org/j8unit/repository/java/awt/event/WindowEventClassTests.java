 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WindowEvent public
...
public abstract interface WindowEventClassTests<SUT extends WindowEvent>
extends ComponentEventClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.event.WindowEvent]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WindowEvent.class!",
                   WindowEvent.class.isAssignableFrom(sut));
    }

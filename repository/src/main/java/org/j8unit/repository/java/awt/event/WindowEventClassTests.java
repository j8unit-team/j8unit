 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WindowEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WindowEventTests}.
 * </p>
 *
 * @see java.awt.event.WindowEvent class java.awt.event.WindowEvent (the hereby targeted class-under-test class)
 * @see WindowEventTests WindowEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.WindowEvent.class!",
                   java.awt.event.WindowEvent.class.isAssignableFrom(sut));
    }

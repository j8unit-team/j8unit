 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicPermission
...
public abstract interface BasicPermissionClassTests<SUT extends BasicPermission>
extends PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicPermission.class!",
                   BasicPermission.class.isAssignableFrom(sut));
    }

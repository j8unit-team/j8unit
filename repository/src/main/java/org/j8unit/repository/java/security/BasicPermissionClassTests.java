...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.BasicPermission class java.security.BasicPermission},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicPermissionTests}.
 * </p>
 *
 * @see java.security.BasicPermission class java.security.BasicPermission (the hereby targeted class-under-test class)
 * @see BasicPermissionTests BasicPermissionTests (The complementary j8unit test interface containing the instance
...
public abstract interface BasicPermissionClassTests<SUT extends java.security.BasicPermission>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.BasicPermission.class!",
                   java.security.BasicPermission.class.isAssignableFrom(sut));
    }

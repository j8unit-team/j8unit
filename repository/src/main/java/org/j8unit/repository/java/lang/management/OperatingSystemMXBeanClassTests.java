...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.management.OperatingSystemMXBean interface
 * java.lang.management.OperatingSystemMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OperatingSystemMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.lang.management.OperatingSystemMXBean interface java.lang.management.OperatingSystemMXBean (the hereby
 *      targeted class-under-test class)
 * @see OperatingSystemMXBeanTests OperatingSystemMXBeanTests (The complementary j8unit test interface containing the
...
public abstract interface OperatingSystemMXBeanClassTests<SUT extends java.lang.management.OperatingSystemMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.OperatingSystemMXBean.class!",
                   java.lang.management.OperatingSystemMXBean.class.isAssignableFrom(sut));
    }

 ...
 * {@link OperatingSystemMXBean public abstract interface java.lang.management.OperatingSystemMXBean}.
 *
...
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OperatingSystemMXBean.class!",
                   OperatingSystemMXBean.class.isAssignableFrom(sut));
    }

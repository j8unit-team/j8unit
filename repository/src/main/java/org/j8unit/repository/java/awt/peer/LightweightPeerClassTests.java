 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LightweightPeer
...
public abstract interface LightweightPeerClassTests<SUT extends LightweightPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LightweightPeer.class!",
                   LightweightPeer.class.isAssignableFrom(sut));
    }

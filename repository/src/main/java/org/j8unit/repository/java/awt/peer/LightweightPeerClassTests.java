 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LightweightPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LightweightPeerTests}.
 * </p>
 *
 * @see java.awt.peer.LightweightPeer interface java.awt.peer.LightweightPeer (the hereby targeted class-under-test
 *      class)
 * @see LightweightPeerTests LightweightPeerTests (The complementary j8unit test interface containing the instance
...
public abstract interface LightweightPeerClassTests<SUT extends java.awt.peer.LightweightPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.LightweightPeer.class!",
                   java.awt.peer.LightweightPeer.class.isAssignableFrom(sut));
    }

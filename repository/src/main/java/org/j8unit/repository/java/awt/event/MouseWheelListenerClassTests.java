 ...
 * java.awt.event.MouseWheelListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseWheelListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseWheelListenerTests}.
 * </p>
 *
 * @see java.awt.event.MouseWheelListener interface java.awt.event.MouseWheelListener (the hereby targeted
 *      class-under-test class)
 * @see MouseWheelListenerTests MouseWheelListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface MouseWheelListenerClassTests<SUT extends java.awt.event.MouseWheelListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.MouseWheelListener.class!",
                   java.awt.event.MouseWheelListener.class.isAssignableFrom(sut));
    }

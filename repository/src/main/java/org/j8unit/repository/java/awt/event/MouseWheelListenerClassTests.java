 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseWheelListener
 * public abstract interface java.awt.event.MouseWheelListener}.
 *
...
public abstract interface MouseWheelListenerClassTests<SUT extends MouseWheelListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseWheelListener.class!",
                   MouseWheelListener.class.isAssignableFrom(sut));
    }

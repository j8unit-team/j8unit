 ...
 * java.nio.charset.UnmappableCharacterException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UnmappableCharacterExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnmappableCharacterExceptionTests UnmappableCharacterExceptionTests (The complementary j8unit test interface
...
extends CharacterCodingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.UnmappableCharacterException.class!",
                   java.nio.charset.UnmappableCharacterException.class.isAssignableFrom(sut));
    }

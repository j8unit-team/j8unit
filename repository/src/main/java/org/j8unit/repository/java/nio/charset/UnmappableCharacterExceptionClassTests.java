 ...
 * {@link UnmappableCharacterException public class java.nio.charset.UnmappableCharacterException}.
 *
...
public abstract interface UnmappableCharacterExceptionClassTests<SUT extends UnmappableCharacterException>
extends CharacterCodingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnmappableCharacterException.class!",
                   UnmappableCharacterException.class.isAssignableFrom(sut));
    }

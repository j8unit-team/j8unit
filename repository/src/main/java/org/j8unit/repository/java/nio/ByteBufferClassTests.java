 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ByteBuffer public
 * abstract class java.nio.ByteBuffer}.
 *
...
public abstract interface ByteBufferClassTests<SUT extends ByteBuffer>
extends ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ByteBuffer.class!",
                   ByteBuffer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.ByteBuffer class java.nio.ByteBuffer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ByteBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ByteBufferTests}.
 * </p>
 *
 * @see java.nio.ByteBuffer class java.nio.ByteBuffer (the hereby targeted class-under-test class)
 * @see ByteBufferTests ByteBufferTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.ByteBuffer.class!",
                   java.nio.ByteBuffer.class.isAssignableFrom(sut));
    }

 ...
 * {@link FileSystemNotFoundException public class java.nio.file.FileSystemNotFoundException}.
 *
 ...
 * {@link FileSystemNotFoundExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface FileSystemNotFoundExceptionClassTests<SUT extends FileSystemNotFoundException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystemNotFoundException.class!",
                   FileSystemNotFoundException.class.isAssignableFrom(sut));
    }

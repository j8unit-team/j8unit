 ...
 * java.nio.file.FileSystemNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see FileSystemNotFoundExceptionTests FileSystemNotFoundExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileSystemNotFoundException.class!",
                   java.nio.file.FileSystemNotFoundException.class.isAssignableFrom(sut));
    }

 ...
 * java.util.function.LongToDoubleFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongToDoubleFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongToDoubleFunctionTests}
 * .
 * </p>
 *
 * @see java.util.function.LongToDoubleFunction interface java.util.function.LongToDoubleFunction (the hereby targeted
 *      class-under-test class)
 * @see LongToDoubleFunctionTests LongToDoubleFunctionTests (The complementary j8unit test interface containing the
...
public abstract interface LongToDoubleFunctionClassTests<SUT extends java.util.function.LongToDoubleFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongToDoubleFunction.class!",
                   java.util.function.LongToDoubleFunction.class.isAssignableFrom(sut));
    }

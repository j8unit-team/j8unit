 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IndexColorModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IndexColorModelTests}.
 * </p>
 *
 * @see java.awt.image.IndexColorModel class java.awt.image.IndexColorModel (the hereby targeted class-under-test class)
 * @see IndexColorModelTests IndexColorModelTests (The complementary j8unit test interface containing the instance
...
extends ColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.IndexColorModel.class!",
                   java.awt.image.IndexColorModel.class.isAssignableFrom(sut));
    }

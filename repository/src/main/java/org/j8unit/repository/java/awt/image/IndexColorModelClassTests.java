...
/**
 * <p>
 * Test class for {@link java.awt.image.IndexColorModel class java.awt.image.IndexColorModel}, containing all class
...
extends org.j8unit.repository.java.awt.image.ColorModelClassTests<SUT> {
    ...
    /**
     * Test method for {@link java.awt.image.IndexColorModel#IndexColorModel(int,int,byte[],byte[],byte[],int) public
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.IndexColorModel sut = null; // = new IndexColorModel(int,int,byte[],byte[],byte[],int);
    }
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.awt.image.IndexColorModel> sut = createNewSUT();

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IndexColorModel
...
public abstract interface IndexColorModelClassTests<SUT extends IndexColorModel>
extends ColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IndexColorModel.class!",
                   IndexColorModel.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.image.IndexColorModel]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.awt.image.IndexColorModel]

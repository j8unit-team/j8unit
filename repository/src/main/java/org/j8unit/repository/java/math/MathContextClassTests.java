 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MathContext public
 * final class java.math.MathContext}.
 *
...
public abstract interface MathContextClassTests<SUT extends MathContext>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MathContext.class!",
                   MathContext.class.isAssignableFrom(sut));
    }

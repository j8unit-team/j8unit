 ...
 * java.nio.channels.GatheringByteChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GatheringByteChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GatheringByteChannelTests}
 * .
 * </p>
 *
 * @see java.nio.channels.GatheringByteChannel interface java.nio.channels.GatheringByteChannel (the hereby targeted
 *      class-under-test class)
 * @see GatheringByteChannelTests GatheringByteChannelTests (The complementary j8unit test interface containing the
...
public abstract interface GatheringByteChannelClassTests<SUT extends java.nio.channels.GatheringByteChannel>
extends WritableByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.GatheringByteChannel.class!",
                   java.nio.channels.GatheringByteChannel.class.isAssignableFrom(sut));
    }

 ...
 * {@link GatheringByteChannelTests}.
 * </p>
 *
 * <p>
...
public abstract interface GatheringByteChannelClassTests<SUT extends GatheringByteChannel>
extends WritableByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GatheringByteChannel.class!",
                   GatheringByteChannel.class.isAssignableFrom(sut));
    }

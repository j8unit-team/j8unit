 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventObject public
...
public abstract interface EventObjectClassTests<SUT extends EventObject>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventObject.class!",
                   EventObject.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventObjectTests}.
 * </p>
 *
 * @see java.util.EventObject class java.util.EventObject (the hereby targeted class-under-test class)
 * @see EventObjectTests EventObjectTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.EventObject.class!",
                   java.util.EventObject.class.isAssignableFrom(sut));
    }

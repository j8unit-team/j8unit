 ...
 * java.util.spi.LocaleServiceProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocaleServiceProviderTests}).
 * </p>
 *
 * <p>
 ...
 * {@link LocaleServiceProviderTests}.
 * </p>
 *
 * @see java.util.spi.LocaleServiceProvider class java.util.spi.LocaleServiceProvider (the hereby targeted
 *      class-under-test class)
 * @see LocaleServiceProviderTests LocaleServiceProviderTests (The complementary j8unit test interface containing the
...
public abstract interface LocaleServiceProviderClassTests<SUT extends java.util.spi.LocaleServiceProvider>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.spi.LocaleServiceProvider.class!",
                   java.util.spi.LocaleServiceProvider.class.isAssignableFrom(sut));
    }

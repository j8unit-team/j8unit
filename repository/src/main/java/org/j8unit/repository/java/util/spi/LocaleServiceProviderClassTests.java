 ...
 * {@link LocaleServiceProvider public abstract class java.util.spi.LocaleServiceProvider}.
 *
...
public abstract interface LocaleServiceProviderClassTests<SUT extends LocaleServiceProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LocaleServiceProvider.class!",
                   LocaleServiceProvider.class.isAssignableFrom(sut));
    }

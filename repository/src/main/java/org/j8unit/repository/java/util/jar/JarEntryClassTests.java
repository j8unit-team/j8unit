...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.jar.JarEntry class java.util.jar.JarEntry}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JarEntryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JarEntryTests}.
 * </p>
 *
 * @see java.util.jar.JarEntry class java.util.jar.JarEntry (the hereby targeted class-under-test class)
 * @see JarEntryTests JarEntryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JarEntryClassTests<SUT extends java.util.jar.JarEntry>
extends org.j8unit.repository.java.util.zip.ZipEntryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.JarEntry.class!",
                   java.util.jar.JarEntry.class.isAssignableFrom(sut));
    }

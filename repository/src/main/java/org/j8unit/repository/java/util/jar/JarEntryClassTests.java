...
import org.j8unit.repository.java.util.zip.ZipEntryClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JarEntry public
...
public abstract interface JarEntryClassTests<SUT extends JarEntry>
extends ZipEntryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JarEntry.class!",
                   JarEntry.class.isAssignableFrom(sut));
    }

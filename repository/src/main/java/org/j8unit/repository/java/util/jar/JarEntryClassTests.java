 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.jar.JarEntry
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.util.zip.ZipEntryClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.jar.JarEntry#JarEntry(java.util.jar.JarEntry)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.jar.JarEntry#JarEntry(java.lang.String)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.jar.JarEntry#JarEntry(java.util.zip.ZipEntry)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.jar.JarEntry#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GenericArrayType
 * public abstract interface java.lang.reflect.GenericArrayType}.
 *
...
extends TypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GenericArrayType.class!",
                   GenericArrayType.class.isAssignableFrom(sut));
    }

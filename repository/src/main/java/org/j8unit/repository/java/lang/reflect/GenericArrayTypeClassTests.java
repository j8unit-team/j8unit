 ...
 * java.lang.reflect.GenericArrayType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GenericArrayTypeTests}).
 * </p>
 *
 * <p>
 ...
 * @see GenericArrayTypeTests GenericArrayTypeTests (The complementary j8unit test interface containing the instance
...
extends TypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.GenericArrayType.class!",
                   java.lang.reflect.GenericArrayType.class.isAssignableFrom(sut));
    }

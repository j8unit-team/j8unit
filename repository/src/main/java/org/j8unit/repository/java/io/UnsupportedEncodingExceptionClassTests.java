 ...
 * {@link UnsupportedEncodingException public class java.io.UnsupportedEncodingException}.
 *
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedEncodingException.class!",
                   UnsupportedEncodingException.class.isAssignableFrom(sut));
    }

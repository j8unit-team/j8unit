 ...
 * java.io.UnsupportedEncodingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see java.io.UnsupportedEncodingException class java.io.UnsupportedEncodingException (the hereby targeted
 *      class-under-test class)
 * @see UnsupportedEncodingExceptionTests UnsupportedEncodingExceptionTests (The complementary j8unit test interface
...
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.UnsupportedEncodingException.class!",
                   java.io.UnsupportedEncodingException.class.isAssignableFrom(sut));
    }

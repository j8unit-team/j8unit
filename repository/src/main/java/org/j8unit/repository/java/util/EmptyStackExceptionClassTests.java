 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EmptyStackExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EmptyStackExceptionTests}.
 * </p>
 *
 * @see java.util.EmptyStackException class java.util.EmptyStackException (the hereby targeted class-under-test class)
 * @see EmptyStackExceptionTests EmptyStackExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.EmptyStackException.class!",
                   java.util.EmptyStackException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EmptyStackException
...
public abstract interface EmptyStackExceptionClassTests<SUT extends EmptyStackException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EmptyStackException.class!",
                   EmptyStackException.class.isAssignableFrom(sut));
    }

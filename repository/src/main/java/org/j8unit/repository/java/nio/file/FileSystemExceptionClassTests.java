 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileSystemException
 * public class java.nio.file.FileSystemException}.
 *
...
public abstract interface FileSystemExceptionClassTests<SUT extends FileSystemException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystemException.class!",
                   FileSystemException.class.isAssignableFrom(sut));
    }

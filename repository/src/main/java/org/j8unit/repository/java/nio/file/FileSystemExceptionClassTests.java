 ...
 * java.nio.file.FileSystemException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileSystemExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileSystemExceptionTests}.
 * </p>
 *
 * @see java.nio.file.FileSystemException class java.nio.file.FileSystemException (the hereby targeted class-under-test
 *      class)
 * @see FileSystemExceptionTests FileSystemExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileSystemException.class!",
                   java.nio.file.FileSystemException.class.isAssignableFrom(sut));
    }

...
extends NavigableSetClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConcurrentSkipListSet.class!",
                   ConcurrentSkipListSet.class.isAssignableFrom(sut));
    }

 ...
 * java.util.concurrent.ConcurrentSkipListSet}, containing all class relevant test methods (at least the test methods of
 * accessible constructors and of accessible {@code static} methods). The counterpart J8Unit test interface containing
 * the instance relevant test methods is {@link org.j8unit.repository.java.util.concurrent.ConcurrentSkipListSetTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractSetClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ConcurrentSkipListSet#ConcurrentSkipListSet()
     */
    ...
    /**
     * <p>
     * Test method for {@link java.util.concurrent.ConcurrentSkipListSet#ConcurrentSkipListSet(java.util.Collection)
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ConcurrentSkipListSet#ConcurrentSkipListSet(java.util.Collection)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ConcurrentSkipListSet_Collection()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    /**
     * <p>
     * Test method for {@link java.util.concurrent.ConcurrentSkipListSet#ConcurrentSkipListSet(java.util.Comparator)
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ConcurrentSkipListSet#ConcurrentSkipListSet(java.util.Comparator)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ConcurrentSkipListSet_Comparator()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.concurrent.ConcurrentSkipListSet<?> sut = null; // = new
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ConcurrentSkipListSet#ConcurrentSkipListSet(java.util.SortedSet)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.concurrent.ConcurrentSkipListSet#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

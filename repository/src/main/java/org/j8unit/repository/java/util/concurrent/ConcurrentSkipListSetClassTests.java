 ...
 * java.util.concurrent.ConcurrentSkipListSet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConcurrentSkipListSetTests}).
 * </p>
 *
 * <p>
 ...
 * @see ConcurrentSkipListSetTests ConcurrentSkipListSetTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ConcurrentSkipListSet.class!",
                   java.util.concurrent.ConcurrentSkipListSet.class.isAssignableFrom(sut));
    }

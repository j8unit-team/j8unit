 ...
 * java.security.UnrecoverableKeyException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link UnrecoverableKeyExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnrecoverableKeyExceptionTests UnrecoverableKeyExceptionTests (The complementary j8unit test interface
...
extends UnrecoverableEntryExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.UnrecoverableKeyException.class!",
                   java.security.UnrecoverableKeyException.class.isAssignableFrom(sut));
    }

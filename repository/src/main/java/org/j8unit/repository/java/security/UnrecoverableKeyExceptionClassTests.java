...
public abstract interface UnrecoverableKeyExceptionClassTests<SUT extends UnrecoverableKeyException>
extends org.j8unit.repository.java.security.UnrecoverableEntryExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnrecoverableKeyException.class!",
                   UnrecoverableKeyException.class.isAssignableFrom(sut));
    }

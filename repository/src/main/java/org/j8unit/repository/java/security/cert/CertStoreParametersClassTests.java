 ...
 * java.security.cert.CertStoreParameters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertStoreParametersTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertStoreParametersTests}.
 * </p>
 *
 * @see java.security.cert.CertStoreParameters interface java.security.cert.CertStoreParameters (the hereby targeted
 *      class-under-test class)
 * @see CertStoreParametersTests CertStoreParametersTests (The complementary j8unit test interface containing the
...
public abstract interface CertStoreParametersClassTests<SUT extends java.security.cert.CertStoreParameters>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertStoreParameters.class!",
                   java.security.cert.CertStoreParameters.class.isAssignableFrom(sut));
    }

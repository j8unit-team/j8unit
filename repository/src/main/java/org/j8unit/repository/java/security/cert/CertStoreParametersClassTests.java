 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertStoreParameters
 * public abstract interface java.security.cert.CertStoreParameters}.
 *
...
public abstract interface CertStoreParametersClassTests<SUT extends CertStoreParameters>
extends CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertStoreParameters.class!",
                   CertStoreParameters.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.charset.StandardCharsets}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardCharsetsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StandardCharsetsTests}.
 * </p>
 *
 * @see java.nio.charset.StandardCharsets class java.nio.charset.StandardCharsets (the hereby targeted class-under-test
 *      class)
 * @see StandardCharsetsTests StandardCharsetsTests (The complementary j8unit test interface containing the instance
...
public abstract interface StandardCharsetsClassTests<SUT extends java.nio.charset.StandardCharsets>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.StandardCharsets.class!",
                   java.nio.charset.StandardCharsets.class.isAssignableFrom(sut));
    }

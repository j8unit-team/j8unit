 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StandardCharsets
...
public abstract interface StandardCharsetsClassTests<SUT extends StandardCharsets>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StandardCharsets.class!",
                   StandardCharsets.class.isAssignableFrom(sut));
    }

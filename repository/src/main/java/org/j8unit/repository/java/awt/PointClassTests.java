...
import org.j8unit.repository.java.awt.geom.Point2DClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Point public class
 * java.awt.Point}.
 *
...
public abstract interface PointClassTests<SUT extends Point>
extends SerializableClassTests<SUT>, Point2DClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Point.class!", Point.class.isAssignableFrom(sut));
    }

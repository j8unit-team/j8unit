...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Point class java.awt.Point}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PointTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PointTests}.
 * </p>
 *
 * @see java.awt.Point class java.awt.Point (the hereby targeted class-under-test class)
 * @see PointTests PointTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface PointClassTests<SUT extends java.awt.Point>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.Point2DClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Point.class!",
                   java.awt.Point.class.isAssignableFrom(sut));
    }

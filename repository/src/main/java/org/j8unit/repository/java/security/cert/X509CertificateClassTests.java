 ...
 * java.security.cert.X509Certificate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509CertificateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509CertificateTests}.
 * </p>
 *
 * @see java.security.cert.X509Certificate class java.security.cert.X509Certificate (the hereby targeted
 *      class-under-test class)
 * @see X509CertificateTests X509CertificateTests (The complementary j8unit test interface containing the instance
...
public abstract interface X509CertificateClassTests<SUT extends java.security.cert.X509Certificate>
extends X509ExtensionClassTests<SUT>, CertificateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.X509Certificate.class!",
                   java.security.cert.X509Certificate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509Certificate
...
public abstract interface X509CertificateClassTests<SUT extends X509Certificate>
extends X509ExtensionClassTests<SUT>, CertificateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509Certificate.class!",
                   X509Certificate.class.isAssignableFrom(sut));
    }

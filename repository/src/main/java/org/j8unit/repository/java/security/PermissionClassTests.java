...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.Permission class java.security.Permission}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PermissionTests}.
 * </p>
 *
 * @see java.security.Permission class java.security.Permission (the hereby targeted class-under-test class)
 * @see PermissionTests PermissionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PermissionClassTests<SUT extends java.security.Permission>
extends GuardClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Permission.class!",
                   java.security.Permission.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.util.EnumMap class java.util.EnumMap}, containing all class relevant test methods (at
 * least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.util.EnumMapTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.util.AbstractMapClassTests<SUT, K, V> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.util.EnumMap<K, V>> sut = createNewSUT();

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EnumMap public
...
public abstract interface EnumMapClassTests<SUT extends EnumMap>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EnumMap.class!",

...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain java.util.EnumMap class java.util.EnumMap}, containing all class
 * relevant test methods (at least the test methods of accessible constructors and of accessible {@code static}
 * methods). The counterpart J8Unit test interface containing the instance relevant test methods is
 * {@link org.j8unit.repository.java.util.EnumMapTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.util.AbstractMapClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.EnumMap#EnumMap(java.lang.Class)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_EnumMap_Class()
    throws Exception {
        // create new instance
     ...
     * </p>
     *
     * @j8unit.aim java.util.EnumMap#EnumMap(java.util.EnumMap)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_EnumMap_EnumMap()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * </p>
     *
     * @j8unit.aim java.util.EnumMap#EnumMap(java.util.Map)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.EnumMap#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

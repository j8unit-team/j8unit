...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.EnumMap class java.util.EnumMap}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EnumMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EnumMapTests}.
 * </p>
 *
 * @see java.util.EnumMap class java.util.EnumMap (the hereby targeted class-under-test class)
 * @see EnumMapTests EnumMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.EnumMap.class!",
                   java.util.EnumMap.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.datatransfer.SystemFlavorMap}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SystemFlavorMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SystemFlavorMapTests}.
 * </p>
 *
 * @see java.awt.datatransfer.SystemFlavorMap class java.awt.datatransfer.SystemFlavorMap (the hereby targeted
 *      class-under-test class)
 * @see SystemFlavorMapTests SystemFlavorMapTests (The complementary j8unit test interface containing the instance
...
extends FlavorMapClassTests<SUT>, FlavorTableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.SystemFlavorMap.class!",
                   java.awt.datatransfer.SystemFlavorMap.class.isAssignableFrom(sut));
    }

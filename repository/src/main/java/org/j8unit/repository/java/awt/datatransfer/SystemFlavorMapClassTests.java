 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SystemFlavorMap
 * public final class java.awt.datatransfer.SystemFlavorMap}.
 *
...
public abstract interface SystemFlavorMapClassTests<SUT extends SystemFlavorMap>
extends FlavorTableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SystemFlavorMap.class!",
                   SystemFlavorMap.class.isAssignableFrom(sut));
    }

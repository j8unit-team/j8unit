 ...
 * java.awt.image.renderable.RenderableImage}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RenderableImageTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RenderableImageTests}.
 * </p>
 *
 * @see java.awt.image.renderable.RenderableImage interface java.awt.image.renderable.RenderableImage (the hereby
 *      targeted class-under-test class)
 * @see RenderableImageTests RenderableImageTests (The complementary j8unit test interface containing the instance
...
public abstract interface RenderableImageClassTests<SUT extends java.awt.image.renderable.RenderableImage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.renderable.RenderableImage.class!",
                   java.awt.image.renderable.RenderableImage.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RenderableImage
...
public abstract interface RenderableImageClassTests<SUT extends RenderableImage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RenderableImage.class!",
                   RenderableImage.class.isAssignableFrom(sut));
    }

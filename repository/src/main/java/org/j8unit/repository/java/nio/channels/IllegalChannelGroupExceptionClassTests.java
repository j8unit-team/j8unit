 ...
 * java.nio.channels.IllegalChannelGroupException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link IllegalChannelGroupExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.channels.IllegalChannelGroupException class java.nio.channels.IllegalChannelGroupException (the hereby
 *      targeted class-under-test class)
 * @see IllegalChannelGroupExceptionTests IllegalChannelGroupExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.IllegalChannelGroupException.class!",
                   java.nio.channels.IllegalChannelGroupException.class.isAssignableFrom(sut));
    }

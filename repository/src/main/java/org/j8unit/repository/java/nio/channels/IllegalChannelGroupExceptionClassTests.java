...
public abstract interface IllegalChannelGroupExceptionClassTests<SUT extends IllegalChannelGroupException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalChannelGroupException.class!",
                   IllegalChannelGroupException.class.isAssignableFrom(sut));
    }

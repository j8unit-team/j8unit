 ...
 * java.security.interfaces.DSAPrivateKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAPrivateKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAPrivateKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.DSAPrivateKey interface java.security.interfaces.DSAPrivateKey (the hereby targeted
 *      class-under-test class)
 * @see DSAPrivateKeyTests DSAPrivateKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DSAPrivateKeyClassTests<SUT extends java.security.interfaces.DSAPrivateKey>
extends DSAKeyClassTests<SUT>, org.j8unit.repository.java.security.PrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.DSAPrivateKey.class!",
                   java.security.interfaces.DSAPrivateKey.class.isAssignableFrom(sut));
    }

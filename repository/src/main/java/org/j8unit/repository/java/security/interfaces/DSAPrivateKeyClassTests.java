...
import org.j8unit.repository.java.security.PrivateKeyClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAPrivateKey
 * public abstract interface java.security.interfaces.DSAPrivateKey}.
 *
...
public abstract interface DSAPrivateKeyClassTests<SUT extends DSAPrivateKey>
extends DSAKeyClassTests<SUT>, PrivateKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAPrivateKey.class!",
                   DSAPrivateKey.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentPeerTests}.
 * </p>
 *
 * @see java.awt.peer.ComponentPeer interface java.awt.peer.ComponentPeer (the hereby targeted class-under-test class)
 * @see ComponentPeerTests ComponentPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ComponentPeerClassTests<SUT extends java.awt.peer.ComponentPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.ComponentPeer.class!",
                   java.awt.peer.ComponentPeer.class.isAssignableFrom(sut));
    }

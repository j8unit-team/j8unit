 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Constructor public
...
public abstract interface ConstructorClassTests<SUT extends Constructor>
extends ExecutableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Constructor.class!",
                   Constructor.class.isAssignableFrom(sut));
    }

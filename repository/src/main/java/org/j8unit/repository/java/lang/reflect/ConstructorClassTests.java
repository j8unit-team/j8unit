...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.Constructor class java.lang.reflect.Constructor},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConstructorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConstructorTests}.
 * </p>
 *
 * @see java.lang.reflect.Constructor class java.lang.reflect.Constructor (the hereby targeted class-under-test class)
 * @see ConstructorTests ConstructorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ExecutableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.Constructor.class!",
                   java.lang.reflect.Constructor.class.isAssignableFrom(sut));
    }

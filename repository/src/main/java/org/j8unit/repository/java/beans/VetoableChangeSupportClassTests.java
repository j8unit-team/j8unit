 ...
 * java.beans.VetoableChangeSupport}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VetoableChangeSupportTests}).
 * </p>
 *
 * <p>
 ...
 * {@link VetoableChangeSupportTests}.
 * </p>
 *
 * @see java.beans.VetoableChangeSupport class java.beans.VetoableChangeSupport (the hereby targeted class-under-test
 *      class)
 * @see VetoableChangeSupportTests VetoableChangeSupportTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.VetoableChangeSupport.class!",
                   java.beans.VetoableChangeSupport.class.isAssignableFrom(sut));
    }

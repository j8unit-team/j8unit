 ...
 * java.security.InvalidKeyException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
extends KeyExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.InvalidKeyException.class!",
                   java.security.InvalidKeyException.class.isAssignableFrom(sut));
    }

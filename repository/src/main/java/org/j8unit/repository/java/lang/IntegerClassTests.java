...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Integer class java.lang.Integer}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntegerTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see Integer class java.lang.Integer (the hereby targeted class-under-test class)
 * @see IntegerTests IntegerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ComparableClassTests<SUT>, NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Integer.class!",

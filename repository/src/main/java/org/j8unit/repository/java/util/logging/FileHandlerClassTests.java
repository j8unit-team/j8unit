 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileHandlerTests}.
 * </p>
 *
 * @see java.util.logging.FileHandler class java.util.logging.FileHandler (the hereby targeted class-under-test class)
 * @see FileHandlerTests FileHandlerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileHandlerClassTests<SUT extends java.util.logging.FileHandler>
extends StreamHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.FileHandler.class!",
                   java.util.logging.FileHandler.class.isAssignableFrom(sut));
    }

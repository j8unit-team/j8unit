...
extends org.j8unit.repository.java.util.logging.StreamHandlerClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_FileHandler_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.logging.FileHandler sut = null; // = new FileHandler(java.lang.String);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_FileHandler_String_int_int_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

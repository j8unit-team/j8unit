 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileHandler public
...
public abstract interface FileHandlerClassTests<SUT extends FileHandler>
extends StreamHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileHandler.class!",
                   FileHandler.class.isAssignableFrom(sut));
    }

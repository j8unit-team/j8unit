...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.LocalDate class java.time.LocalDate}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocalDateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LocalDateTests}.
 * </p>
 *
 * @see java.time.LocalDate class java.time.LocalDate (the hereby targeted class-under-test class)
 * @see LocalDateTests LocalDateTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.LocalDate.class!",
                   java.time.LocalDate.class.isAssignableFrom(sut));
    }

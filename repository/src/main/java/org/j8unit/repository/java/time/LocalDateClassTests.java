...
import org.j8unit.repository.java.time.chrono.ChronoLocalDateClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LocalDate public
 * final class java.time.LocalDate}.
 *
...
public abstract interface LocalDateClassTests<SUT extends LocalDate>
extends ChronoLocalDateClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LocalDate.class!",
                   LocalDate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Kernel public class
...
public abstract interface KernelClassTests<SUT extends Kernel>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Kernel.class!",
                   Kernel.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.image.Kernel]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.Kernel class java.awt.image.Kernel}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KernelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KernelTests}.
 * </p>
 *
 * @see java.awt.image.Kernel class java.awt.image.Kernel (the hereby targeted class-under-test class)
 * @see KernelTests KernelTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface KernelClassTests<SUT extends java.awt.image.Kernel>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.Kernel.class!",
                   java.awt.image.Kernel.class.isAssignableFrom(sut));
    }

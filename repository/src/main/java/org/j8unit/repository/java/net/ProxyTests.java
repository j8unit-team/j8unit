...
/**
 * <p>
 * Test class for {@link java.net.Proxy class java.net.Proxy}, containing all instance relevant test methods
...
extends org.j8unit.repository.java.lang.ObjectTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_address()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test class for {@link java.net.Proxy$Type class java.net.Proxy$Type}, containing all instance relevant test

 ...
 * java.nio.channels.AsynchronousSocketChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link AsynchronousSocketChannelTests}).
 * </p>
 *
 * <p>
 ...
 * @see AsynchronousSocketChannelTests AsynchronousSocketChannelTests (The complementary j8unit test interface
...
extends AsynchronousByteChannelClassTests<SUT>, NetworkChannelClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AsynchronousSocketChannel.class!",
                   java.nio.channels.AsynchronousSocketChannel.class.isAssignableFrom(sut));
    }

 ...
 * {@link AsynchronousSocketChannel public abstract class java.nio.channels.AsynchronousSocketChannel}.
 *
...
public abstract interface AsynchronousSocketChannelClassTests<SUT extends AsynchronousSocketChannel>
extends AsynchronousByteChannelClassTests<SUT>, NetworkChannelClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsynchronousSocketChannel.class!",
                   AsynchronousSocketChannel.class.isAssignableFrom(sut));
    }

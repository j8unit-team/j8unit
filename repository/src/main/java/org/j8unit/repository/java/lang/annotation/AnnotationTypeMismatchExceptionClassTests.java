...
public abstract interface AnnotationTypeMismatchExceptionClassTests<SUT extends AnnotationTypeMismatchException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotationTypeMismatchException.class!",
                   AnnotationTypeMismatchException.class.isAssignableFrom(sut));
    }

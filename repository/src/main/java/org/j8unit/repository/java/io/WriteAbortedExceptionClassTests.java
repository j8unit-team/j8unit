 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WriteAbortedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link WriteAbortedExceptionTests}.
 * </p>
 *
 * @see java.io.WriteAbortedException class java.io.WriteAbortedException (the hereby targeted class-under-test class)
 * @see WriteAbortedExceptionTests WriteAbortedExceptionTests (The complementary j8unit test interface containing the
...
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.WriteAbortedException.class!",
                   java.io.WriteAbortedException.class.isAssignableFrom(sut));
    }

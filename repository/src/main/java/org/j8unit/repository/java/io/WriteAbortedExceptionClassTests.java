 ...
 * {@link WriteAbortedException public class java.io.WriteAbortedException}.
 *
...
public abstract interface WriteAbortedExceptionClassTests<SUT extends WriteAbortedException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WriteAbortedException.class!",
                   WriteAbortedException.class.isAssignableFrom(sut));
    }

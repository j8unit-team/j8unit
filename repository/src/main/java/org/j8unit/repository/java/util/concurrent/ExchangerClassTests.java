...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.Exchanger class java.util.concurrent.Exchanger},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExchangerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExchangerTests}.
 * </p>
 *
 * @see java.util.concurrent.Exchanger class java.util.concurrent.Exchanger (the hereby targeted class-under-test class)
 * @see ExchangerTests ExchangerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ExchangerClassTests<SUT extends java.util.concurrent.Exchanger>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Exchanger.class!",
                   java.util.concurrent.Exchanger.class.isAssignableFrom(sut));
    }

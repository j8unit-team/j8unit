 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Exchanger public
...
public abstract interface ExchangerClassTests<SUT extends Exchanger>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Exchanger.class!",
                   Exchanger.class.isAssignableFrom(sut));
    }

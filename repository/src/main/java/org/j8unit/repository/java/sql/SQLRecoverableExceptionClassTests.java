...
public abstract interface SQLRecoverableExceptionClassTests<SUT extends SQLRecoverableException>
extends org.j8unit.repository.java.sql.SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLRecoverableException.class!",
                   SQLRecoverableException.class.isAssignableFrom(sut));
    }

 ...
 * java.sql.SQLRecoverableException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLRecoverableExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link SQLRecoverableExceptionTests}.
 * </p>
 *
 * @see java.sql.SQLRecoverableException class java.sql.SQLRecoverableException (the hereby targeted class-under-test
 *      class)
 * @see SQLRecoverableExceptionTests SQLRecoverableExceptionTests (The complementary j8unit test interface containing
...
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLRecoverableException.class!",
                   java.sql.SQLRecoverableException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLXML public
...
public abstract interface SQLXMLClassTests<SUT extends SQLXML>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLXML.class!",
                   SQLXML.class.isAssignableFrom(sut));
    }

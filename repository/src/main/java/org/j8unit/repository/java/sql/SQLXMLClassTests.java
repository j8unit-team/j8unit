...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.SQLXML interface java.sql.SQLXML}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLXMLTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLXMLTests}.
 * </p>
 *
 * @see java.sql.SQLXML interface java.sql.SQLXML (the hereby targeted class-under-test class)
 * @see SQLXMLTests SQLXMLTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface SQLXMLClassTests<SUT extends java.sql.SQLXML>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLXML.class!",
                   java.sql.SQLXML.class.isAssignableFrom(sut));
    }

 ...
 * {@link IllegalFormatFlagsException public class java.util.IllegalFormatFlagsException}.
 *
...
public abstract interface IllegalFormatFlagsExceptionClassTests<SUT extends IllegalFormatFlagsException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalFormatFlagsException.class!",
                   IllegalFormatFlagsException.class.isAssignableFrom(sut));
    }

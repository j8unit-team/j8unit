 ...
 * java.util.IllegalFormatFlagsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IllegalFormatFlagsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalFormatFlagsExceptionTests IllegalFormatFlagsExceptionTests (The complementary j8unit test interface
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IllegalFormatFlagsException.class!",
                   java.util.IllegalFormatFlagsException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain CharSequence interface java.lang.CharSequence}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharSequenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharSequenceTests}.
 * </p>
 *
 * @see CharSequence interface java.lang.CharSequence (the hereby targeted class-under-test class)
 * @see CharSequenceTests CharSequenceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CharSequenceClassTests<SUT extends CharSequence>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharSequence.class!",
                   CharSequence.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.beans.Beans class java.beans.Beans}, containing all class relevant test methods (at least
 * the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test class
 * containing the instance relevant test methods is {@link org.j8unit.repository.java.beans.BeansTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    public default void create_Beans()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public default void test_isGuiAvailable()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link java.beans.Beans#isInstanceOf(java.lang.Object,java.lang.Class) public static boolean
    ...
    @Test
    @Category(Draft.class)
    public default void test_isInstanceOf_Object_Class()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link java.beans.Beans#setDesignTime(boolean) public static void
    ...
    @Test
    @Category(Draft.class)
    public default void test_setGuiAvailable_boolean()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;

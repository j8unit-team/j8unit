 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Beans public class
 * java.beans.Beans}.
 *
...
public abstract interface BeansClassTests<SUT extends Beans>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Beans.class!", Beans.class.isAssignableFrom(sut));
    }

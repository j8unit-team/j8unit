...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.prefs.PreferenceChangeListener interface
 * java.util.prefs.PreferenceChangeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PreferenceChangeListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link PreferenceChangeListenerTests}.
 * </p>
 *
 * @see java.util.prefs.PreferenceChangeListener interface java.util.prefs.PreferenceChangeListener (the hereby targeted
 *      class-under-test class)
 * @see PreferenceChangeListenerTests PreferenceChangeListenerTests (The complementary j8unit test interface containing
...
public abstract interface PreferenceChangeListenerClassTests<SUT extends java.util.prefs.PreferenceChangeListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.PreferenceChangeListener.class!",
                   java.util.prefs.PreferenceChangeListener.class.isAssignableFrom(sut));
    }

...
public abstract interface PreferenceChangeListenerClassTests<SUT extends PreferenceChangeListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PreferenceChangeListener.class!",
                   PreferenceChangeListener.class.isAssignableFrom(sut));
    }

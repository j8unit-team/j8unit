 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLFormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLFormatterTests}.
 * </p>
 *
 * @see java.util.logging.XMLFormatter class java.util.logging.XMLFormatter (the hereby targeted class-under-test class)
 * @see XMLFormatterTests XMLFormatterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface XMLFormatterClassTests<SUT extends java.util.logging.XMLFormatter>
extends FormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.XMLFormatter.class!",
                   java.util.logging.XMLFormatter.class.isAssignableFrom(sut));
    }

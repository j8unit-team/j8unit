 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLFormatter public
...
public abstract interface XMLFormatterClassTests<SUT extends XMLFormatter>
extends FormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLFormatter.class!",

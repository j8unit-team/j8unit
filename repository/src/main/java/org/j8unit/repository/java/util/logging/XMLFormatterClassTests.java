...
extends org.j8unit.repository.java.util.logging.FormatterClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.logging.XMLFormatter#XMLFormatter()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_XMLFormatter()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.logging.XMLFormatter sut = null; // = new XMLFormatter();
    }

    /**
     * @since 0.9.2
     *
     * @j8unit.aim java.util.logging.XMLFormatter#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

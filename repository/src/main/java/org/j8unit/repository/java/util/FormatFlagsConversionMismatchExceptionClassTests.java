 ...
 * java.util.FormatFlagsConversionMismatchException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link FormatFlagsConversionMismatchExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see FormatFlagsConversionMismatchExceptionTests FormatFlagsConversionMismatchExceptionTests (The complementary
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.FormatFlagsConversionMismatchException.class!",
                   java.util.FormatFlagsConversionMismatchException.class.isAssignableFrom(sut));
    }

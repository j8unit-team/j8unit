 ...
 * {@link FormatFlagsConversionMismatchException public class java.util.FormatFlagsConversionMismatchException}.
 *
...
public abstract interface FormatFlagsConversionMismatchExceptionClassTests<SUT extends FormatFlagsConversionMismatchException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormatFlagsConversionMismatchException.class!",
                   FormatFlagsConversionMismatchException.class.isAssignableFrom(sut));
    }

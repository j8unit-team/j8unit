 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PipedWriter public
...
public abstract interface PipedWriterClassTests<SUT extends PipedWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PipedWriter.class!",
                   PipedWriter.class.isAssignableFrom(sut));
    }

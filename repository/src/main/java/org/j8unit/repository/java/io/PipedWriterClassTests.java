...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.PipedWriter class java.io.PipedWriter}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PipedWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PipedWriterTests}.
 * </p>
 *
 * @see java.io.PipedWriter class java.io.PipedWriter (the hereby targeted class-under-test class)
 * @see PipedWriterTests PipedWriterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PipedWriter.class!",
                   java.io.PipedWriter.class.isAssignableFrom(sut));
    }

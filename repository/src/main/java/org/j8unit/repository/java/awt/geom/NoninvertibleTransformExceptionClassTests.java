 ...
 * {@link NoninvertibleTransformException public class java.awt.geom.NoninvertibleTransformException}.
 *
...
public abstract interface NoninvertibleTransformExceptionClassTests<SUT extends NoninvertibleTransformException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoninvertibleTransformException.class!",
                   NoninvertibleTransformException.class.isAssignableFrom(sut));
    }

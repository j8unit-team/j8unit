 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageCapabilitiesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageCapabilitiesTests}.
 * </p>
 *
 * @see java.awt.ImageCapabilities class java.awt.ImageCapabilities (the hereby targeted class-under-test class)
 * @see ImageCapabilitiesTests ImageCapabilitiesTests (The complementary j8unit test interface containing the instance
...
public abstract interface ImageCapabilitiesClassTests<SUT extends java.awt.ImageCapabilities>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.ImageCapabilities.class!",
                   java.awt.ImageCapabilities.class.isAssignableFrom(sut));
    }

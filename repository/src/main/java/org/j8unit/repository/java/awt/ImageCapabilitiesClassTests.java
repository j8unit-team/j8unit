 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageCapabilities
 * public class java.awt.ImageCapabilities}.
 *
...
public abstract interface ImageCapabilitiesClassTests<SUT extends ImageCapabilities>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageCapabilities.class!",
                   ImageCapabilities.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.ItemSelectable interface java.awt.ItemSelectable}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ItemSelectableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ItemSelectableTests}.
 * </p>
 *
 * @see java.awt.ItemSelectable interface java.awt.ItemSelectable (the hereby targeted class-under-test class)
 * @see ItemSelectableTests ItemSelectableTests (The complementary j8unit test interface containing the instance
...
public abstract interface ItemSelectableClassTests<SUT extends java.awt.ItemSelectable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.ItemSelectable.class!",
                   java.awt.ItemSelectable.class.isAssignableFrom(sut));
    }

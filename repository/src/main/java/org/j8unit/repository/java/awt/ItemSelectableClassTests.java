 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ItemSelectable
...
public abstract interface ItemSelectableClassTests<SUT extends ItemSelectable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ItemSelectable.class!",
                   ItemSelectable.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.RandomAccess interface java.util.RandomAccess}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RandomAccessTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RandomAccessTests}.
 * </p>
 *
 * @see java.util.RandomAccess interface java.util.RandomAccess (the hereby targeted class-under-test class)
 * @see RandomAccessTests RandomAccessTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RandomAccessClassTests<SUT extends java.util.RandomAccess>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.RandomAccess.class!",
                   java.util.RandomAccess.class.isAssignableFrom(sut));
    }

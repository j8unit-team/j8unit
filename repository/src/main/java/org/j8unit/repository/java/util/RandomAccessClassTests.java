 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RandomAccess public
 * abstract interface java.util.RandomAccess}.
 *
...
public abstract interface RandomAccessClassTests<SUT extends RandomAccess>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RandomAccess.class!",
                   RandomAccess.class.isAssignableFrom(sut));
    }

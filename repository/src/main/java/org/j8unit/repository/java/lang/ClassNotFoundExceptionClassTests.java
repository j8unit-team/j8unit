...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ClassNotFoundException class java.lang.ClassNotFoundException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ClassNotFoundExceptionTests}.
 * </p>
 *
 * @see ClassNotFoundException class java.lang.ClassNotFoundException (the hereby targeted class-under-test class)
 * @see ClassNotFoundExceptionTests ClassNotFoundExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ClassNotFoundExceptionClassTests<SUT extends ClassNotFoundException>
extends ReflectiveOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassNotFoundException.class!",
                   ClassNotFoundException.class.isAssignableFrom(sut));
    }

 ...
 * {@link org.j8unit.repository.java.text.spi.NumberFormatProviderTests}.
 * </p>
 *
 * <p>
...
public abstract interface NumberFormatProviderClassTests<SUT extends NumberFormatProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NumberFormatProvider.class!",
                   NumberFormatProvider.class.isAssignableFrom(sut));
    }

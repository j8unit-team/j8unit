...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.spi.NumberFormatProvider class
 * java.text.spi.NumberFormatProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NumberFormatProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NumberFormatProviderTests}
 * .
 * </p>
 *
 * @see java.text.spi.NumberFormatProvider class java.text.spi.NumberFormatProvider (the hereby targeted
 *      class-under-test class)
 * @see NumberFormatProviderTests NumberFormatProviderTests (The complementary j8unit test interface containing the
...
public abstract interface NumberFormatProviderClassTests<SUT extends java.text.spi.NumberFormatProvider>
extends org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.spi.NumberFormatProvider.class!",
                   java.text.spi.NumberFormatProvider.class.isAssignableFrom(sut));
    }

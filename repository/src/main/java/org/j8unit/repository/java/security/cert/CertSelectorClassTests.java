 ...
 * java.security.cert.CertSelector}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertSelectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertSelectorTests}.
 * </p>
 *
 * @see java.security.cert.CertSelector interface java.security.cert.CertSelector (the hereby targeted class-under-test
 *      class)
 * @see CertSelectorTests CertSelectorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CertSelectorClassTests<SUT extends java.security.cert.CertSelector>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertSelector.class!",
                   java.security.cert.CertSelector.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertSelector public
 * abstract interface java.security.cert.CertSelector}.
 *
...
public abstract interface CertSelectorClassTests<SUT extends CertSelector>
extends CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertSelector.class!",
                   CertSelector.class.isAssignableFrom(sut));
    }

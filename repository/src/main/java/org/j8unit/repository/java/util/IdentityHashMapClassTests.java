 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IdentityHashMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IdentityHashMapTests}.
 * </p>
 *
 * @see java.util.IdentityHashMap class java.util.IdentityHashMap (the hereby targeted class-under-test class)
 * @see IdentityHashMapTests IdentityHashMapTests (The complementary j8unit test interface containing the instance
...
extends MapClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>,
AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IdentityHashMap.class!",
                   java.util.IdentityHashMap.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IdentityHashMap
...
public abstract interface IdentityHashMapClassTests<SUT extends IdentityHashMap>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdentityHashMap.class!",
                   IdentityHashMap.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.IdentityHashMap]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.util.IdentityHashMap]

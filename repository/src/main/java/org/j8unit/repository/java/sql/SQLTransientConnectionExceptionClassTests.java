 ...
 * {@link SQLTransientConnectionException public class java.sql.SQLTransientConnectionException}.
 *
...
public abstract interface SQLTransientConnectionExceptionClassTests<SUT extends SQLTransientConnectionException>
extends SQLTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLTransientConnectionException.class!",
                   SQLTransientConnectionException.class.isAssignableFrom(sut));
    }

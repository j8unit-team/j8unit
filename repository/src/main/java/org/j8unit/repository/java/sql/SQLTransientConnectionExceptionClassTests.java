 ...
 * java.sql.SQLTransientConnectionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link SQLTransientConnectionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see SQLTransientConnectionExceptionTests SQLTransientConnectionExceptionTests (The complementary j8unit test
...
extends SQLTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLTransientConnectionException.class!",
                   java.sql.SQLTransientConnectionException.class.isAssignableFrom(sut));
    }

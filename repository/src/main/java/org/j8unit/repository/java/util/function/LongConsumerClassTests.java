...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.LongConsumer interface
 * java.util.function.LongConsumer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongConsumerTests}.
 * </p>
 *
 * @see java.util.function.LongConsumer interface java.util.function.LongConsumer (the hereby targeted class-under-test
 *      class)
 * @see LongConsumerTests LongConsumerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LongConsumerClassTests<SUT extends java.util.function.LongConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongConsumer.class!",
                   java.util.function.LongConsumer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongConsumer public
 * abstract interface java.util.function.LongConsumer}.
 *
...
public abstract interface LongConsumerClassTests<SUT extends LongConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongConsumer.class!",

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Formattable public
 * abstract interface java.util.Formattable}.
 *
...
public abstract interface FormattableClassTests<SUT extends Formattable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Formattable.class!",
                   Formattable.class.isAssignableFrom(sut));
    }

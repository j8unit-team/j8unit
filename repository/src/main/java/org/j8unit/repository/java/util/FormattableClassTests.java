 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormattableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FormattableTests}.
 * </p>
 *
 * @see java.util.Formattable interface java.util.Formattable (the hereby targeted class-under-test class)
 * @see FormattableTests FormattableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FormattableClassTests<SUT extends java.util.Formattable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Formattable.class!",
                   java.util.Formattable.class.isAssignableFrom(sut));
    }

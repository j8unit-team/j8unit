...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.AWTError class java.awt.AWTError}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AWTErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AWTErrorTests}.
 * </p>
 *
 * @see java.awt.AWTError class java.awt.AWTError (the hereby targeted class-under-test class)
 * @see AWTErrorTests AWTErrorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AWTErrorClassTests<SUT extends java.awt.AWTError>
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.AWTError.class!",
                   java.awt.AWTError.class.isAssignableFrom(sut));
    }

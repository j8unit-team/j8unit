 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AWTError public
...
public abstract interface AWTErrorClassTests<SUT extends AWTError>
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AWTError.class!",
                   AWTError.class.isAssignableFrom(sut));
    }

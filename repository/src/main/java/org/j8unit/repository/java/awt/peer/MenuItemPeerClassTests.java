 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuItemPeer public
 * abstract interface java.awt.peer.MenuItemPeer}.
 *
...
public abstract interface MenuItemPeerClassTests<SUT extends MenuItemPeer>
extends MenuComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuItemPeer.class!",
                   MenuItemPeer.class.isAssignableFrom(sut));
    }

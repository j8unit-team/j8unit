...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.MenuItemPeer interface java.awt.peer.MenuItemPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuItemPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuItemPeerTests}.
 * </p>
 *
 * @see java.awt.peer.MenuItemPeer interface java.awt.peer.MenuItemPeer (the hereby targeted class-under-test class)
 * @see MenuItemPeerTests MenuItemPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MenuItemPeerClassTests<SUT extends java.awt.peer.MenuItemPeer>
extends MenuComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.MenuItemPeer.class!",
                   java.awt.peer.MenuItemPeer.class.isAssignableFrom(sut));
    }

 ...
 * java.security.cert.CertPathValidatorSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertPathValidatorSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertPathValidatorSpiTests}
 * .
 * </p>
 *
 * @see java.security.cert.CertPathValidatorSpi class java.security.cert.CertPathValidatorSpi (the hereby targeted
 *      class-under-test class)
 * @see CertPathValidatorSpiTests CertPathValidatorSpiTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathValidatorSpi.class!",
                   java.security.cert.CertPathValidatorSpi.class.isAssignableFrom(sut));
    }

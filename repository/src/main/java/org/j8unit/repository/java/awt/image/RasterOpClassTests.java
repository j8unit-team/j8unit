 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RasterOp public
 * abstract interface java.awt.image.RasterOp}.
 *
...
public abstract interface RasterOpClassTests<SUT extends RasterOp>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RasterOp.class!",
                   RasterOp.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LambdaMetafactory
...
public abstract interface LambdaMetafactoryClassTests<SUT extends LambdaMetafactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LambdaMetafactory.class!",
                   LambdaMetafactory.class.isAssignableFrom(sut));
    }

 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link CheckboxGroup
 ...
 * {@link org.j8unit.repository.java.awt.CheckboxGroupClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface CheckboxGroupTests<SUT extends CheckboxGroup>
extends SerializableTests<SUT>, ObjectTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[INSTANCE]-[java.awt.CheckboxGroup]
    ...
    public default void test_getSelectedCheckbox()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_setSelectedCheckbox_Checkbox()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    // J8UNIT-MARKER-[MANUAL]-[INSTANCE]-[java.awt.CheckboxGroup]

    // J8UNIT-MARKER-[END]-[INSTANCE]-[java.awt.CheckboxGroup]

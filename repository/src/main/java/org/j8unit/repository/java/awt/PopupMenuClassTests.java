 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PopupMenu public
...
extends MenuClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PopupMenu.class!",
                   PopupMenu.class.isAssignableFrom(sut));
    }

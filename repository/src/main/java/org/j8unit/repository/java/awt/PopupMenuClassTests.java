...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.PopupMenu class java.awt.PopupMenu}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PopupMenuTests}).
 * </p>
 *
 * <p>
 ...
 * @see PopupMenuTests PopupMenuTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PopupMenuClassTests<SUT extends java.awt.PopupMenu>
extends MenuClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.PopupMenu.class!",
                   java.awt.PopupMenu.class.isAssignableFrom(sut));
    }

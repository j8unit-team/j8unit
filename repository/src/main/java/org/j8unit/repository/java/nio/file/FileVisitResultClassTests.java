 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileVisitResult
...
public abstract interface FileVisitResultClassTests<SUT extends FileVisitResult>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileVisitResult.class!",
                   FileVisitResult.class.isAssignableFrom(sut));
    }

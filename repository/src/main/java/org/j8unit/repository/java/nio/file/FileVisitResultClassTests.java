...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.FileVisitResult class java.nio.file.FileVisitResult},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileVisitResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileVisitResultTests}.
 * </p>
 *
 * @see java.nio.file.FileVisitResult class java.nio.file.FileVisitResult (the hereby targeted class-under-test class)
 * @see FileVisitResultTests FileVisitResultTests (The complementary j8unit test interface containing the instance
...
public abstract interface FileVisitResultClassTests<SUT extends java.nio.file.FileVisitResult>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileVisitResult.class!",
                   java.nio.file.FileVisitResult.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Visibility public
 * abstract interface java.beans.Visibility}.
 *
...
public abstract interface VisibilityClassTests<SUT extends Visibility>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Visibility.class!",

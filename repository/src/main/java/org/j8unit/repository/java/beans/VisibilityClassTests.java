 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VisibilityTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link VisibilityTests}.
 * </p>
 *
 * @see java.beans.Visibility interface java.beans.Visibility (the hereby targeted class-under-test class)
 * @see VisibilityTests VisibilityTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface VisibilityClassTests<SUT extends java.beans.Visibility>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.Visibility.class!",
                   java.beans.Visibility.class.isAssignableFrom(sut));
    }

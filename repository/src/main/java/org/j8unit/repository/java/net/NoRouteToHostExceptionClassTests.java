...
public abstract interface NoRouteToHostExceptionClassTests<SUT extends NoRouteToHostException>
extends SocketExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoRouteToHostException.class!",
                   NoRouteToHostException.class.isAssignableFrom(sut));
    }

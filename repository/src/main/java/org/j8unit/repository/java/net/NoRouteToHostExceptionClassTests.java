...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.NoRouteToHostException class java.net.NoRouteToHostException}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoRouteToHostExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see NoRouteToHostExceptionTests NoRouteToHostExceptionTests (The complementary j8unit test interface containing the
...
extends SocketExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.NoRouteToHostException.class!",
                   java.net.NoRouteToHostException.class.isAssignableFrom(sut));
    }

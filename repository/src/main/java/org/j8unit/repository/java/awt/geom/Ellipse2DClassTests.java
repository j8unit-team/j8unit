 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Ellipse2DTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.geom.Ellipse2D class java.awt.geom.Ellipse2D (the hereby targeted class-under-test class)
 * @see Ellipse2DTests Ellipse2DTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RectangularShapeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.Ellipse2D.class!",
                   java.awt.geom.Ellipse2D.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.awt.geom.Ellipse2D.Double class
     * java.awt.geom.Ellipse2D$Double}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link Ellipse2DTests.DoubleTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.awt.geom.Ellipse2D.Double class java.awt.geom.Ellipse2D$Double (the hereby targeted class-under-test
     *      class)
     * @see Ellipse2DTests.DoubleTests Ellipse2DTests.DoubleTests (The complementary j8unit test interface containing
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, Ellipse2DClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.Ellipse2D.Double.class!",
                       java.awt.geom.Ellipse2D.Double.class.isAssignableFrom(sut));
        }
     ...
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see {@link Ellipse2DTests.FloatTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link Ellipse2DTests.FloatTests}.
     * </p>
     *
     * @see java.awt.geom.Ellipse2D.Float class java.awt.geom.Ellipse2D$Float (the hereby targeted class-under-test
     *      class)
     * @see Ellipse2DTests.FloatTests Ellipse2DTests.FloatTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, Ellipse2DClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.Ellipse2D.Float.class!",
                       java.awt.geom.Ellipse2D.Float.class.isAssignableFrom(sut));
        }

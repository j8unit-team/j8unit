 ...
 * methods is {@link org.j8unit.repository.java.awt.geom.Ellipse2DTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.awt.geom.RectangularShapeClassTests<SUT>
{
    ...
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.awt.geom.Ellipse2D> sut = createNewSUT();
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.awt.geom.Ellipse2DTests.DoubleTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>,
            org.j8unit.repository.java.awt.geom.Ellipse2DClassTests<SUT>
    {
        ...
        public default void create_Double() throws Exception {
            ...
            java.awt.geom.Ellipse2D.Double sut = null; // = new Double();
        }

        /**
         * Test method for {@link java.awt.geom.Ellipse2D.Double#Double(double,double,double,double) public java.awt.geom.Ellipse2D$Double(double,double,double,double)}.
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
        public default void create_Double_double_double_double_double() throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            java.awt.geom.Ellipse2D.Double sut = null; // = new Double(double,double,double,double);
        }

        @Test
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.awt.geom.Ellipse2D.Double> sut = createNewSUT();
            // assert assignability
            ...
            org.j8unit.repository.java.awt.geom.Ellipse2DClassTests<SUT>
    {
        ...
        public default void create_Float() throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            java.awt.geom.Ellipse2D.Float sut = null; // = new Float();
        }

        /**
         * Test method for {@link java.awt.geom.Ellipse2D.Float#Float(float,float,float,float) public java.awt.geom.Ellipse2D$Float(float,float,float,float)}.
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
        public default void create_Float_float_float_float_float() throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            java.awt.geom.Ellipse2D.Float sut = null; // = new Float(float,float,float,float);
        }

        @Test
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.awt.geom.Ellipse2D.Float> sut = createNewSUT();
            // assert assignability

 ...
 * java.security.InvalidAlgorithmParameterException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidAlgorithmParameterExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidAlgorithmParameterExceptionTests InvalidAlgorithmParameterExceptionTests (The complementary j8unit test
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.InvalidAlgorithmParameterException.class!",
                   java.security.InvalidAlgorithmParameterException.class.isAssignableFrom(sut));
    }

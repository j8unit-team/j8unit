...
public abstract interface InvalidAlgorithmParameterExceptionClassTests<SUT extends InvalidAlgorithmParameterException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidAlgorithmParameterException.class!",
                   InvalidAlgorithmParameterException.class.isAssignableFrom(sut));
    }

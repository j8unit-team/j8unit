...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Date class java.util.Date}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateTests}.
 * </p>
 *
 * @see java.util.Date class java.util.Date (the hereby targeted class-under-test class)
 * @see DateTests DateTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Date.class!",
                   java.util.Date.class.isAssignableFrom(sut));
    }

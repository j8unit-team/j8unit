...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain RuntimeException class java.lang.RuntimeException}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RuntimeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RuntimeExceptionTests}.
 * </p>
 *
 * @see RuntimeException class java.lang.RuntimeException (the hereby targeted class-under-test class)
 * @see RuntimeExceptionTests RuntimeExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface RuntimeExceptionClassTests<SUT extends RuntimeException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RuntimeException.class!",
                   RuntimeException.class.isAssignableFrom(sut));
    }

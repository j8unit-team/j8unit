...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.spi.BreakIteratorProvider class
 * java.text.spi.BreakIteratorProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BreakIteratorProviderTests}).
 * </p>
 *
 * <p>
 ...
 * {@link BreakIteratorProviderTests}.
 * </p>
 *
 * @see java.text.spi.BreakIteratorProvider class java.text.spi.BreakIteratorProvider (the hereby targeted
 *      class-under-test class)
 * @see BreakIteratorProviderTests BreakIteratorProviderTests (The complementary j8unit test interface containing the
...
public abstract interface BreakIteratorProviderClassTests<SUT extends java.text.spi.BreakIteratorProvider>
extends org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.spi.BreakIteratorProvider.class!",
                   java.text.spi.BreakIteratorProvider.class.isAssignableFrom(sut));
    }

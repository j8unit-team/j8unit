 ...
 * {@link BreakIteratorProvider public abstract class java.text.spi.BreakIteratorProvider}.
 *
...
public abstract interface BreakIteratorProviderClassTests<SUT extends BreakIteratorProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BreakIteratorProvider.class!",
                   BreakIteratorProvider.class.isAssignableFrom(sut));
    }

 ...
 * {@link ContentHandlerFactory public abstract interface java.net.ContentHandlerFactory}.
 *
...
public abstract interface ContentHandlerFactoryClassTests<SUT extends ContentHandlerFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContentHandlerFactory.class!",
                   ContentHandlerFactory.class.isAssignableFrom(sut));
    }

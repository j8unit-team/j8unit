 ...
 * java.net.ContentHandlerFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContentHandlerFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ContentHandlerFactoryTests}.
 * </p>
 *
 * @see java.net.ContentHandlerFactory interface java.net.ContentHandlerFactory (the hereby targeted class-under-test
 *      class)
 * @see ContentHandlerFactoryTests ContentHandlerFactoryTests (The complementary j8unit test interface containing the
...
public abstract interface ContentHandlerFactoryClassTests<SUT extends java.net.ContentHandlerFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.ContentHandlerFactory.class!",
                   java.net.ContentHandlerFactory.class.isAssignableFrom(sut));
    }

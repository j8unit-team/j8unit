 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileInputStream
...
public abstract interface FileInputStreamClassTests<SUT extends FileInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileInputStream.class!",
                   FileInputStream.class.isAssignableFrom(sut));
    }

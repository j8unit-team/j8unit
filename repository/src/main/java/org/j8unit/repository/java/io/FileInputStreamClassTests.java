 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileInputStreamTests}.
 * </p>
 *
 * @see java.io.FileInputStream class java.io.FileInputStream (the hereby targeted class-under-test class)
 * @see FileInputStreamTests FileInputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface FileInputStreamClassTests<SUT extends java.io.FileInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FileInputStream.class!",
                   java.io.FileInputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Types public class
 * java.sql.Types}.
 *
...
public abstract interface TypesClassTests<SUT extends Types>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Types.class!", Types.class.isAssignableFrom(sut));
    }

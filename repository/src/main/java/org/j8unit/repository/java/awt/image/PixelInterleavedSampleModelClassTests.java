 ...
 * java.awt.image.PixelInterleavedSampleModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see PixelInterleavedSampleModelTests PixelInterleavedSampleModelTests (The complementary j8unit test interface
...
extends ComponentSampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.PixelInterleavedSampleModel.class!",
                   java.awt.image.PixelInterleavedSampleModel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageObserver
...
public abstract interface ImageObserverClassTests<SUT extends ImageObserver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageObserver.class!",
                   ImageObserver.class.isAssignableFrom(sut));
    }

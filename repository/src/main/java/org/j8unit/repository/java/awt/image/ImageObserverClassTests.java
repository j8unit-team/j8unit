 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageObserverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageObserverTests}.
 * </p>
 *
 * @see java.awt.image.ImageObserver interface java.awt.image.ImageObserver (the hereby targeted class-under-test class)
 * @see ImageObserverTests ImageObserverTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ImageObserverClassTests<SUT extends java.awt.image.ImageObserver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ImageObserver.class!",
                   java.awt.image.ImageObserver.class.isAssignableFrom(sut));
    }

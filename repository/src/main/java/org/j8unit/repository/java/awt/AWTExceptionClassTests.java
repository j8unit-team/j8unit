 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AWTException public
...
public abstract interface AWTExceptionClassTests<SUT extends AWTException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AWTException.class!",
                   AWTException.class.isAssignableFrom(sut));
    }

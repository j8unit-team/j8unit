 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AWTExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AWTExceptionTests}.
 * </p>
 *
 * @see java.awt.AWTException class java.awt.AWTException (the hereby targeted class-under-test class)
 * @see AWTExceptionTests AWTExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.AWTException.class!",
                   java.awt.AWTException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClipboardTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClipboardTests}.
 * </p>
 *
 * @see java.awt.datatransfer.Clipboard class java.awt.datatransfer.Clipboard (the hereby targeted class-under-test
 *      class)
 * @see ClipboardTests ClipboardTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.Clipboard.class!",
                   java.awt.datatransfer.Clipboard.class.isAssignableFrom(sut));
    }

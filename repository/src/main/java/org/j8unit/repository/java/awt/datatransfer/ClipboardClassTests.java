 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Clipboard public
...
public abstract interface ClipboardClassTests<SUT extends Clipboard>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Clipboard.class!",
                   Clipboard.class.isAssignableFrom(sut));
    }

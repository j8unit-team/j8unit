 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketException
...
public abstract interface SocketExceptionClassTests<SUT extends SocketException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketException.class!",
                   SocketException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketExceptionTests}.
 * </p>
 *
 * @see java.net.SocketException class java.net.SocketException (the hereby targeted class-under-test class)
 * @see SocketExceptionTests SocketExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketException.class!",
                   java.net.SocketException.class.isAssignableFrom(sut));
    }

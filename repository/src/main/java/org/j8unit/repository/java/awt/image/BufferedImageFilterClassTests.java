 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferedImageFilter
 * public class java.awt.image.BufferedImageFilter}.
 *
...
public abstract interface BufferedImageFilterClassTests<SUT extends BufferedImageFilter>
extends ImageFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferedImageFilter.class!",
                   BufferedImageFilter.class.isAssignableFrom(sut));
    }

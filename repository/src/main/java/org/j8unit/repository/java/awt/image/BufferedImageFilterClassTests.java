 ...
 * java.awt.image.BufferedImageFilter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferedImageFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferedImageFilterTests}.
 * </p>
 *
 * @see java.awt.image.BufferedImageFilter class java.awt.image.BufferedImageFilter (the hereby targeted
 *      class-under-test class)
 * @see BufferedImageFilterTests BufferedImageFilterTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, ImageFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.BufferedImageFilter.class!",
                   java.awt.image.BufferedImageFilter.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZoneRulesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZoneRulesTests}.
 * </p>
 *
 * @see java.time.zone.ZoneRules class java.time.zone.ZoneRules (the hereby targeted class-under-test class)
 * @see ZoneRulesTests ZoneRulesTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.zone.ZoneRules.class!",
                   java.time.zone.ZoneRules.class.isAssignableFrom(sut));
    }

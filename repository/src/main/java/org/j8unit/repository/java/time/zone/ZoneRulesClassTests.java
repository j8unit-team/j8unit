 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZoneRules public
 * final class java.time.zone.ZoneRules}.
 *
...
public abstract interface ZoneRulesClassTests<SUT extends ZoneRules>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZoneRules.class!",
                   ZoneRules.class.isAssignableFrom(sut));
    }

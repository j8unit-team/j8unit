...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.TexturePaint class java.awt.TexturePaint}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TexturePaintTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TexturePaintTests}.
 * </p>
 *
 * @see java.awt.TexturePaint class java.awt.TexturePaint (the hereby targeted class-under-test class)
 * @see TexturePaintTests TexturePaintTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TexturePaintClassTests<SUT extends java.awt.TexturePaint>
extends PaintClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.TexturePaint.class!",
                   java.awt.TexturePaint.class.isAssignableFrom(sut));
    }

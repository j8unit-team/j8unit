 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TexturePaint public
...
public abstract interface TexturePaintClassTests<SUT extends TexturePaint>
extends PaintClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TexturePaint.class!",
                   TexturePaint.class.isAssignableFrom(sut));
    }

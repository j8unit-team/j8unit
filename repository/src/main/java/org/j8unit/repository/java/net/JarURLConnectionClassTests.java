 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JarURLConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JarURLConnectionTests}.
 * </p>
 *
 * @see java.net.JarURLConnection class java.net.JarURLConnection (the hereby targeted class-under-test class)
 * @see JarURLConnectionTests JarURLConnectionTests (The complementary j8unit test interface containing the instance
...
public abstract interface JarURLConnectionClassTests<SUT extends java.net.JarURLConnection>
extends URLConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.JarURLConnection.class!",
                   java.net.JarURLConnection.class.isAssignableFrom(sut));
    }

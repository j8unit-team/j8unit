 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JarURLConnection
...
public abstract interface JarURLConnectionClassTests<SUT extends JarURLConnection>
extends URLConnectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JarURLConnection.class!",
                   JarURLConnection.class.isAssignableFrom(sut));
    }

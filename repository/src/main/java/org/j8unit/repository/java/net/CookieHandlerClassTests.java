 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CookieHandler
...
public abstract interface CookieHandlerClassTests<SUT extends CookieHandler>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CookieHandler.class!",
                   CookieHandler.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CookieHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CookieHandlerTests}.
 * </p>
 *
 * @see java.net.CookieHandler class java.net.CookieHandler (the hereby targeted class-under-test class)
 * @see CookieHandlerTests CookieHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.CookieHandler.class!",
                   java.net.CookieHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintStream public
...
public abstract interface PrintStreamClassTests<SUT extends PrintStream>
extends AppendableClassTests<SUT>, FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintStream.class!",
                   PrintStream.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.PrintStream class java.io.PrintStream}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintStreamTests}.
 * </p>
 *
 * @see java.io.PrintStream class java.io.PrintStream (the hereby targeted class-under-test class)
 * @see PrintStreamTests PrintStreamTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.AppendableClassTests<SUT>, CloseableClassTests<SUT>, FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PrintStream.class!",
                   java.io.PrintStream.class.isAssignableFrom(sut));
    }

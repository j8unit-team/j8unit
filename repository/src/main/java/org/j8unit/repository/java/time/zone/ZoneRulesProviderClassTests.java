 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZoneRulesProvider
 * public abstract class java.time.zone.ZoneRulesProvider}.
 *
...
public abstract interface ZoneRulesProviderClassTests<SUT extends ZoneRulesProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZoneRulesProvider.class!",
                   ZoneRulesProvider.class.isAssignableFrom(sut));
    }

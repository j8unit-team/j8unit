 ...
 * java.time.zone.ZoneRulesProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZoneRulesProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZoneRulesProviderTests}.
 * </p>
 *
 * @see java.time.zone.ZoneRulesProvider class java.time.zone.ZoneRulesProvider (the hereby targeted class-under-test
 *      class)
 * @see ZoneRulesProviderTests ZoneRulesProviderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.zone.ZoneRulesProvider.class!",
                   java.time.zone.ZoneRulesProvider.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.DayOfWeek class java.time.DayOfWeek}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DayOfWeekTests}).
 * </p>
 *
 * <p>
 ...
 * @see DayOfWeekTests DayOfWeekTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.DayOfWeek.class!",
                   java.time.DayOfWeek.class.isAssignableFrom(sut));
    }

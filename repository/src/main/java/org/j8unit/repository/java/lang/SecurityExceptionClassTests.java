...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain SecurityException class java.lang.SecurityException}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecurityExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecurityExceptionTests}.
 * </p>
 *
 * @see SecurityException class java.lang.SecurityException (the hereby targeted class-under-test class)
 * @see SecurityExceptionTests SecurityExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface SecurityExceptionClassTests<SUT extends SecurityException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecurityException.class!",
                   SecurityException.class.isAssignableFrom(sut));
    }

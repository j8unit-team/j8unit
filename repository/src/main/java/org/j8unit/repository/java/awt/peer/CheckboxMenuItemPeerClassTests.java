...
extends org.j8unit.repository.java.awt.peer.MenuItemPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CheckboxMenuItemPeer.class!",
                   CheckboxMenuItemPeer.class.isAssignableFrom(sut));
    }

 ...
 * non-{@code static} methods) of {@linkplain java.awt.image.AreaAveragingScaleFilter class
 * java.awt.image.AreaAveragingScaleFilter}. The complementary j8unit test interface containing the class relevant
 * aspects is {@link AreaAveragingScaleFilterClassTests}.
 * </p>
 *
 * @see java.awt.image.AreaAveragingScaleFilter class java.awt.image.AreaAveragingScaleFilter (the hereby targeted
 *      class-under-test class)
 * @see AreaAveragingScaleFilterClassTests AreaAveragingScaleFilterClassTests (the complementary j8unit test interface
...
extends ReplicateScaleFilterTests<SUT> {
     ...
     * </p>
     *
     * @see java.awt.image.AreaAveragingScaleFilter#setHints(int) public void
     *      java.awt.image.AreaAveragingScaleFilter.setHints(int) (the hereby targeted method-under-test)
     */
     ...
     * </p>
     *
     * @see java.awt.image.AreaAveragingScaleFilter#setPixels(int, int, int, int, java.awt.image.ColorModel, int[], int,
     *      int) public void
     *      java.awt.image.AreaAveragingScaleFilter.setPixels(int,int,int,int,java.awt.image.ColorModel,int[],int,int)
     ...
     * </p>
     *
     * @see java.awt.image.AreaAveragingScaleFilter#setPixels(int, int, int, int, java.awt.image.ColorModel, byte[],
     *      int, int) public void
     *      java.awt.image.AreaAveragingScaleFilter.setPixels(int,int,int,int,java.awt.image.ColorModel,byte[],int,int)
     *      (the hereby targeted method-under-test)
     */

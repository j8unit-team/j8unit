 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Statement public
 * abstract interface java.sql.Statement}.
 *
...
public abstract interface StatementClassTests<SUT extends Statement>
extends org.j8unit.repository.java.sql.WrapperClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Statement.class!",
                   Statement.class.isAssignableFrom(sut));
    }

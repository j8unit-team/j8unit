...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Statement interface java.sql.Statement}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StatementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StatementTests}.
 * </p>
 *
 * @see java.sql.Statement interface java.sql.Statement (the hereby targeted class-under-test class)
 * @see StatementTests StatementTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface StatementClassTests<SUT extends java.sql.Statement>
extends WrapperClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Statement.class!",
                   java.sql.Statement.class.isAssignableFrom(sut));
    }

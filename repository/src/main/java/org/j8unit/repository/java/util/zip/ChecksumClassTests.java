...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.Checksum interface java.util.zip.Checksum}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChecksumTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChecksumTests}.
 * </p>
 *
 * @see java.util.zip.Checksum interface java.util.zip.Checksum (the hereby targeted class-under-test class)
 * @see ChecksumTests ChecksumTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ChecksumClassTests<SUT extends java.util.zip.Checksum>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.Checksum.class!",
                   java.util.zip.Checksum.class.isAssignableFrom(sut));
    }

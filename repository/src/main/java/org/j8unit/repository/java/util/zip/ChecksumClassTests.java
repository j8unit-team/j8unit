 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Checksum public
 * abstract interface java.util.zip.Checksum}.
 *
...
public abstract interface ChecksumClassTests<SUT extends Checksum>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Checksum.class!",
                   Checksum.class.isAssignableFrom(sut));
    }

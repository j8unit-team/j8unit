 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntBuffer public
 * abstract class java.nio.IntBuffer}.
 *
...
public abstract interface IntBufferClassTests<SUT extends IntBuffer>
extends ComparableClassTests<SUT>, BufferClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.IntBuffer]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntBuffer.class!",

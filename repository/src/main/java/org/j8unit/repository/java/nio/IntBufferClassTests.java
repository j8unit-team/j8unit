...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.IntBuffer class java.nio.IntBuffer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntBufferTests}.
 * </p>
 *
 * @see java.nio.IntBuffer class java.nio.IntBuffer (the hereby targeted class-under-test class)
 * @see IntBufferTests IntBufferTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.IntBuffer.class!",
                   java.nio.IntBuffer.class.isAssignableFrom(sut));
    }

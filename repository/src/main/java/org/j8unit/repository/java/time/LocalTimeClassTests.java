 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LocalTime public
 * final class java.time.LocalTime}.
 *
...
public abstract interface LocalTimeClassTests<SUT extends LocalTime>
extends TemporalClassTests<SUT>, TemporalAdjusterClassTests<SUT>, ComparableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LocalTime.class!",
                   LocalTime.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.LocalTime class java.time.LocalTime}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocalTimeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LocalTimeTests}.
 * </p>
 *
 * @see java.time.LocalTime class java.time.LocalTime (the hereby targeted class-under-test class)
 * @see LocalTimeTests LocalTimeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LocalTimeClassTests<SUT extends java.time.LocalTime>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.LocalTime.class!",
                   java.time.LocalTime.class.isAssignableFrom(sut));
    }

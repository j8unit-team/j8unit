 ...
 * {@link PlatformLoggingMXBean public abstract interface java.lang.management.PlatformLoggingMXBean}.
 *
 ...
 * {@link org.j8unit.repository.java.lang.management.PlatformLoggingMXBeanTests}.
 * </p>
 *
 * <p>
...
public abstract interface PlatformLoggingMXBeanClassTests<SUT extends PlatformLoggingMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PlatformLoggingMXBean.class!",
                   PlatformLoggingMXBean.class.isAssignableFrom(sut));
    }

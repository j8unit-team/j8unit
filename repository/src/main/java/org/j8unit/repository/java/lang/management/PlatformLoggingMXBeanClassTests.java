...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.management.PlatformLoggingMXBean interface
 * java.lang.management.PlatformLoggingMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PlatformLoggingMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PlatformLoggingMXBeanTests}.
 * </p>
 *
 * @see java.lang.management.PlatformLoggingMXBean interface java.lang.management.PlatformLoggingMXBean (the hereby
 *      targeted class-under-test class)
 * @see PlatformLoggingMXBeanTests PlatformLoggingMXBeanTests (The complementary j8unit test interface containing the
...
public abstract interface PlatformLoggingMXBeanClassTests<SUT extends java.lang.management.PlatformLoggingMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.PlatformLoggingMXBean.class!",
                   java.lang.management.PlatformLoggingMXBean.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.SampleModel class java.awt.image.SampleModel},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SampleModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SampleModelTests}.
 * </p>
 *
 * @see java.awt.image.SampleModel class java.awt.image.SampleModel (the hereby targeted class-under-test class)
 * @see SampleModelTests SampleModelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SampleModelClassTests<SUT extends java.awt.image.SampleModel>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.SampleModel.class!",
                   java.awt.image.SampleModel.class.isAssignableFrom(sut));
    }

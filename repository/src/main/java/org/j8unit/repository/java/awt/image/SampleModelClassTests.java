 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SampleModel public
 * abstract class java.awt.image.SampleModel}.
 *
...
public abstract interface SampleModelClassTests<SUT extends SampleModel>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.SampleModel]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SampleModel.class!",
                   SampleModel.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.image.SampleModel]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.awt.image.SampleModel]

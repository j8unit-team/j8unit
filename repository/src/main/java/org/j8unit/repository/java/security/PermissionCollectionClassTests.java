...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.PermissionCollection class
 * java.security.PermissionCollection}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PermissionCollectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PermissionCollectionTests}
 * .
 * </p>
 *
 * @see java.security.PermissionCollection class java.security.PermissionCollection (the hereby targeted
 *      class-under-test class)
 * @see PermissionCollectionTests PermissionCollectionTests (The complementary j8unit test interface containing the
...
public abstract interface PermissionCollectionClassTests<SUT extends java.security.PermissionCollection>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.PermissionCollection.class!",
                   java.security.PermissionCollection.class.isAssignableFrom(sut));
    }

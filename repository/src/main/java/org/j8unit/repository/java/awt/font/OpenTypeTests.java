 ...
 * {@link org.j8unit.repository.java.awt.font.OpenTypeClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface OpenTypeTests<SUT extends OpenType>
extends RepositoryTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getFontTableSize_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getFontTable_String_int_int()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

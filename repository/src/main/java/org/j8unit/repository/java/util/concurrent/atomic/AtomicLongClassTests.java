...
import org.j8unit.repository.java.lang.NumberClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AtomicLong public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AtomicLongTests}.
 * </p>
 *
 * <p>
...
public abstract interface AtomicLongClassTests<SUT extends AtomicLong>
extends NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicLong.class!",
                   AtomicLong.class.isAssignableFrom(sut));
    }

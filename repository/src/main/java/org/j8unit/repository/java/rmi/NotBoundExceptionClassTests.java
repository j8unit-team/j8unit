 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotBoundException
 * public class java.rmi.NotBoundException}.
 *
...
public abstract interface NotBoundExceptionClassTests<SUT extends NotBoundException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotBoundException.class!",
                   NotBoundException.class.isAssignableFrom(sut));
    }

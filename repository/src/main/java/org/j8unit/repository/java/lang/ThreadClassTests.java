...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Thread class java.lang.Thread}, containing all type relevant aspects
 * (e.&thinsp;g., runtime constraints and further type specific requirements). (In addition, the runtime type of this
 * j8unit test interface's generic type is verified by {@link #verifyGenericType()}).
 * </p>
 *
 * <p>
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadTests}).
 * </p>
 *
 * <p>
 ...
 * @see ThreadTests ThreadTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends RunnableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Thread.class!",
                   Thread.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain Thread.UncaughtExceptionHandler interface
     * java.lang.Thread$UncaughtExceptionHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link ThreadTests.UncaughtExceptionHandlerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ThreadTests.UncaughtExceptionHandlerTests ThreadTests.UncaughtExceptionHandlerTests (The complementary
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface UncaughtExceptionHandlerClassTests<SUT extends Thread.UncaughtExceptionHandler>
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Thread.UncaughtExceptionHandler.class!",
                       Thread.UncaughtExceptionHandler.class.isAssignableFrom(sut));
        }
    ...
    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain Thread.State class java.lang.Thread$State}, containing all type
     ...
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadTests.StateTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link ThreadTests.StateTests}.
     * </p>
     *
     * @see Thread.State class java.lang.Thread$State (the hereby targeted class-under-test class)
     * @see ThreadTests.StateTests ThreadTests.StateTests (The complementary j8unit test interface containing the
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface StateClassTests<SUT extends Thread.State>
    extends EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Thread.State.class!",
                       Thread.State.class.isAssignableFrom(sut));
        }

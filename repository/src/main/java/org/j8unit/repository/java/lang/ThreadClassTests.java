 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Thread public class
 * java.lang.Thread}.
 *
...
extends RunnableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface UncaughtExceptionHandlerClassTests<SUT extends UncaughtExceptionHandler>
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link State public static final enum java.lang.Thread$State}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

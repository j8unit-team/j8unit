...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.spi.AbstractSelector class
 * java.nio.channels.spi.AbstractSelector}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractSelectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractSelectorTests}.
 * </p>
 *
 * @see java.nio.channels.spi.AbstractSelector class java.nio.channels.spi.AbstractSelector (the hereby targeted
 *      class-under-test class)
 * @see AbstractSelectorTests AbstractSelectorTests (The complementary j8unit test interface containing the instance
...
public abstract interface AbstractSelectorClassTests<SUT extends java.nio.channels.spi.AbstractSelector>
extends org.j8unit.repository.java.nio.channels.SelectorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.spi.AbstractSelector.class!",
                   java.nio.channels.spi.AbstractSelector.class.isAssignableFrom(sut));
    }

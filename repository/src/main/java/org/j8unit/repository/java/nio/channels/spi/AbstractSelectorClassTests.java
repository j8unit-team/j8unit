...
import org.j8unit.repository.java.nio.channels.SelectorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractSelector
...
public abstract interface AbstractSelectorClassTests<SUT extends AbstractSelector>
extends SelectorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractSelector.class!",
                   AbstractSelector.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BeanDescriptorTests}.
 * </p>
 *
 * @see java.beans.BeanDescriptor class java.beans.BeanDescriptor (the hereby targeted class-under-test class)
 * @see BeanDescriptorTests BeanDescriptorTests (The complementary j8unit test interface containing the instance
...
public abstract interface BeanDescriptorClassTests<SUT extends java.beans.BeanDescriptor>
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.BeanDescriptor.class!",
                   java.beans.BeanDescriptor.class.isAssignableFrom(sut));
    }

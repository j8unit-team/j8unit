 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanDescriptor
...
public abstract interface BeanDescriptorClassTests<SUT extends BeanDescriptor>
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanDescriptor.class!",
                   BeanDescriptor.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain NoSuchMethodError class java.lang.NoSuchMethodError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchMethodErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NoSuchMethodErrorTests}.
 * </p>
 *
 * @see NoSuchMethodError class java.lang.NoSuchMethodError (the hereby targeted class-under-test class)
 * @see NoSuchMethodErrorTests NoSuchMethodErrorTests (The complementary j8unit test interface containing the instance
...
public abstract interface NoSuchMethodErrorClassTests<SUT extends NoSuchMethodError>
extends IncompatibleClassChangeErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchMethodError.class!",
                   NoSuchMethodError.class.isAssignableFrom(sut));
    }

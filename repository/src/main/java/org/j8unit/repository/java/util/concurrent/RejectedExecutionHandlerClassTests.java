 ...
 * {@link RejectedExecutionHandler public abstract interface java.util.concurrent.RejectedExecutionHandler}.
 *
...
public abstract interface RejectedExecutionHandlerClassTests<SUT extends RejectedExecutionHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RejectedExecutionHandler.class!",
                   RejectedExecutionHandler.class.isAssignableFrom(sut));
    }

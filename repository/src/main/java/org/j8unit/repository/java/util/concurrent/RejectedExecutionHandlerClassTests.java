 ...
 * java.util.concurrent.RejectedExecutionHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RejectedExecutionHandlerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link RejectedExecutionHandlerTests}.
 * </p>
 *
 * @see java.util.concurrent.RejectedExecutionHandler interface java.util.concurrent.RejectedExecutionHandler (the
 *      hereby targeted class-under-test class)
 * @see RejectedExecutionHandlerTests RejectedExecutionHandlerTests (The complementary j8unit test interface containing
...
public abstract interface RejectedExecutionHandlerClassTests<SUT extends java.util.concurrent.RejectedExecutionHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.RejectedExecutionHandler.class!",
                   java.util.concurrent.RejectedExecutionHandler.class.isAssignableFrom(sut));
    }

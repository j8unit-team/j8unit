 ...
 * java.util.MissingFormatArgumentException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link MissingFormatArgumentExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see MissingFormatArgumentExceptionTests MissingFormatArgumentExceptionTests (The complementary j8unit test interface
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.MissingFormatArgumentException.class!",
                   java.util.MissingFormatArgumentException.class.isAssignableFrom(sut));
    }

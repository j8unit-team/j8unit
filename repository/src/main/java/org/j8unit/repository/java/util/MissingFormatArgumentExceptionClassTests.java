 ...
 * {@link MissingFormatArgumentException public class java.util.MissingFormatArgumentException}.
 *
...
public abstract interface MissingFormatArgumentExceptionClassTests<SUT extends MissingFormatArgumentException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MissingFormatArgumentException.class!",
                   MissingFormatArgumentException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.MissingFormatArgumentException]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.util.MissingFormatArgumentException]

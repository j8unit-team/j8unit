 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChronoLocalDate
...
public abstract interface ChronoLocalDateClassTests<SUT extends ChronoLocalDate>
extends TemporalClassTests<SUT>, TemporalAdjusterClassTests<SUT>, ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChronoLocalDate.class!",
                   ChronoLocalDate.class.isAssignableFrom(sut));
    }

 ...
 * java.time.chrono.ChronoLocalDate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChronoLocalDateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChronoLocalDateTests}.
 * </p>
 *
 * @see java.time.chrono.ChronoLocalDate interface java.time.chrono.ChronoLocalDate (the hereby targeted
 *      class-under-test class)
 * @see ChronoLocalDateTests ChronoLocalDateTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.java.lang.ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.ChronoLocalDate.class!",
                   java.time.chrono.ChronoLocalDate.class.isAssignableFrom(sut));
    }

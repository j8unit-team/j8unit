 ...
 * java.util.InvalidPropertiesFormatException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link InvalidPropertiesFormatExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidPropertiesFormatExceptionTests InvalidPropertiesFormatExceptionTests (The complementary j8unit test
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.InvalidPropertiesFormatException.class!",
                   java.util.InvalidPropertiesFormatException.class.isAssignableFrom(sut));
    }

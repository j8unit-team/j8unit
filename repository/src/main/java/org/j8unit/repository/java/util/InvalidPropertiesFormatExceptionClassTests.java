...
public abstract interface InvalidPropertiesFormatExceptionClassTests<SUT extends InvalidPropertiesFormatException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidPropertiesFormatException.class!",
                   InvalidPropertiesFormatException.class.isAssignableFrom(sut));
    }

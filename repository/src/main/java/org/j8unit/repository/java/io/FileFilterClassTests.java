 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileFilter public
 * abstract interface java.io.FileFilter}.
 *
...
public abstract interface FileFilterClassTests<SUT extends FileFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileFilter.class!",
                   FileFilter.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.FileFilter interface java.io.FileFilter}, containing all type
...
public abstract interface FileFilterClassTests<SUT extends java.io.FileFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FileFilter.class!",
                   java.io.FileFilter.class.isAssignableFrom(sut));
    }

 ...
 * java.util.IllegalFormatWidthException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IllegalFormatWidthExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalFormatWidthExceptionTests IllegalFormatWidthExceptionTests (The complementary j8unit test interface
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IllegalFormatWidthException.class!",
                   java.util.IllegalFormatWidthException.class.isAssignableFrom(sut));
    }

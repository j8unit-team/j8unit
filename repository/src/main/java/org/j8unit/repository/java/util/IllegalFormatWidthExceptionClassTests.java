...
public abstract interface IllegalFormatWidthExceptionClassTests<SUT extends IllegalFormatWidthException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalFormatWidthException.class!",
                   IllegalFormatWidthException.class.isAssignableFrom(sut));
    }

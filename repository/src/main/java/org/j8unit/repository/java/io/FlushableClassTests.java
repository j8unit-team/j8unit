...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.Flushable interface java.io.Flushable}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlushableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FlushableTests}.
 * </p>
 *
 * @see java.io.Flushable interface java.io.Flushable (the hereby targeted class-under-test class)
 * @see FlushableTests FlushableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FlushableClassTests<SUT extends java.io.Flushable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.Flushable.class!",
                   java.io.Flushable.class.isAssignableFrom(sut));
    }

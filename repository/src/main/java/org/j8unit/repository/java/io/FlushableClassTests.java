 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Flushable public
 * abstract interface java.io.Flushable}.
 *
...
public abstract interface FlushableClassTests<SUT extends Flushable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Flushable.class!",
                   Flushable.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResponseCache
...
public abstract interface ResponseCacheClassTests<SUT extends ResponseCache>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResponseCache.class!",
                   ResponseCache.class.isAssignableFrom(sut));
    }

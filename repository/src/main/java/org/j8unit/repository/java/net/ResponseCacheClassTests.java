 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResponseCacheTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ResponseCacheTests}.
 * </p>
 *
 * @see java.net.ResponseCache class java.net.ResponseCache (the hereby targeted class-under-test class)
 * @see ResponseCacheTests ResponseCacheTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.ResponseCache.class!",
                   java.net.ResponseCache.class.isAssignableFrom(sut));
    }

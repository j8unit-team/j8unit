 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReadWriteLock
...
public abstract interface ReadWriteLockClassTests<SUT extends ReadWriteLock>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReadWriteLock.class!",
                   ReadWriteLock.class.isAssignableFrom(sut));
    }

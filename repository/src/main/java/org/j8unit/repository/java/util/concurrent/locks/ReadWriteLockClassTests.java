 ...
 * java.util.concurrent.locks.ReadWriteLock}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReadWriteLockTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReadWriteLockTests}.
 * </p>
 *
 * @see java.util.concurrent.locks.ReadWriteLock interface java.util.concurrent.locks.ReadWriteLock (the hereby targeted
 *      class-under-test class)
 * @see ReadWriteLockTests ReadWriteLockTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ReadWriteLockClassTests<SUT extends java.util.concurrent.locks.ReadWriteLock>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.locks.ReadWriteLock.class!",
                   java.util.concurrent.locks.ReadWriteLock.class.isAssignableFrom(sut));
    }

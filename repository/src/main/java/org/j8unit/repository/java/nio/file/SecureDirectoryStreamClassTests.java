 ...
 * java.nio.file.SecureDirectoryStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecureDirectoryStreamTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SecureDirectoryStreamTests}.
 * </p>
 *
 * @see java.nio.file.SecureDirectoryStream interface java.nio.file.SecureDirectoryStream (the hereby targeted
 *      class-under-test class)
 * @see SecureDirectoryStreamTests SecureDirectoryStreamTests (The complementary j8unit test interface containing the
...
public abstract interface SecureDirectoryStreamClassTests<SUT extends java.nio.file.SecureDirectoryStream>
extends DirectoryStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.SecureDirectoryStream.class!",
                   java.nio.file.SecureDirectoryStream.class.isAssignableFrom(sut));
    }

 ...
 * {@link SecureDirectoryStream public abstract interface java.nio.file.SecureDirectoryStream<T>}.
 *
...
public abstract interface SecureDirectoryStreamClassTests<SUT extends SecureDirectoryStream>
extends org.j8unit.repository.java.nio.file.DirectoryStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecureDirectoryStream.class!",
                   SecureDirectoryStream.class.isAssignableFrom(sut));
    }

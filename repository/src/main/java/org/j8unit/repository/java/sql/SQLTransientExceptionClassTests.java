 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLTransientExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SQLTransientExceptionTests}.
 * </p>
 *
 * @see java.sql.SQLTransientException class java.sql.SQLTransientException (the hereby targeted class-under-test class)
 * @see SQLTransientExceptionTests SQLTransientExceptionTests (The complementary j8unit test interface containing the
...
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLTransientException.class!",
                   java.sql.SQLTransientException.class.isAssignableFrom(sut));
    }

 ...
 * {@link SQLTransientException public class java.sql.SQLTransientException}.
 *
...
public abstract interface SQLTransientExceptionClassTests<SUT extends SQLTransientException>
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLTransientException.class!",
                   SQLTransientException.class.isAssignableFrom(sut));
    }

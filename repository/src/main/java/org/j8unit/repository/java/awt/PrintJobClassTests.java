 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintJob public
...
public abstract interface PrintJobClassTests<SUT extends PrintJob>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintJob.class!",
                   PrintJob.class.isAssignableFrom(sut));
    }

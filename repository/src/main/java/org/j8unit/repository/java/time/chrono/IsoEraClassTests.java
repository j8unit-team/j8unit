 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IsoEraTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IsoEraTests}.
 * </p>
 *
 * @see java.time.chrono.IsoEra class java.time.chrono.IsoEra (the hereby targeted class-under-test class)
 * @see IsoEraTests IsoEraTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends EraClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.IsoEra.class!",
                   java.time.chrono.IsoEra.class.isAssignableFrom(sut));
    }

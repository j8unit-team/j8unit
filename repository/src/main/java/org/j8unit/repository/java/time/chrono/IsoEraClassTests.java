 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IsoEra public final
...
public abstract interface IsoEraClassTests<SUT extends IsoEra>
extends EraClassTests<SUT>, EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IsoEra.class!",
                   IsoEra.class.isAssignableFrom(sut));
    }

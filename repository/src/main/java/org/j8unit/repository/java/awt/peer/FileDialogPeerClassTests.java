 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileDialogPeer
...
extends org.j8unit.repository.java.awt.peer.DialogPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileDialogPeer.class!",
                   FileDialogPeer.class.isAssignableFrom(sut));
    }

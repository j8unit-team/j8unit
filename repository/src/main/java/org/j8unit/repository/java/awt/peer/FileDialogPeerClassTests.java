 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileDialogPeerTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileDialogPeerTests FileDialogPeerTests (The complementary j8unit test interface containing the instance
...
public abstract interface FileDialogPeerClassTests<SUT extends java.awt.peer.FileDialogPeer>
extends DialogPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.FileDialogPeer.class!",
                   java.awt.peer.FileDialogPeer.class.isAssignableFrom(sut));
    }

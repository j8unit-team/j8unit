 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Arc2D public
...
public abstract interface Arc2DClassTests<SUT extends Arc2D>
extends RectangularShapeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Arc2D.class!", Arc2D.class.isAssignableFrom(sut));
    }
     ...
     * {@link Double public static class java.awt.geom.Arc2D$Double}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link Float public static class java.awt.geom.Arc2D$Float}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

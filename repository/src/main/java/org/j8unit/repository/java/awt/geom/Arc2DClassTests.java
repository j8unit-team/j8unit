...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.geom.Arc2D class java.awt.geom.Arc2D}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Arc2DTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link Arc2DTests}.
 * </p>
 *
 * @see java.awt.geom.Arc2D class java.awt.geom.Arc2D (the hereby targeted class-under-test class)
 * @see Arc2DTests Arc2DTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends RectangularShapeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.Arc2D.class!",
                   java.awt.geom.Arc2D.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link Arc2DTests.FloatTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link Arc2DTests.FloatTests}
     * .
     * </p>
     *
     * @see java.awt.geom.Arc2D.Float class java.awt.geom.Arc2D$Float (the hereby targeted class-under-test class)
     * @see Arc2DTests.FloatTests Arc2DTests.FloatTests (The complementary j8unit test interface containing the instance
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, Arc2DClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.Arc2D.Float.class!",
                       java.awt.geom.Arc2D.Float.class.isAssignableFrom(sut));
        }
     ...
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see {@link Arc2DTests.DoubleTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * {@link Arc2DTests.DoubleTests}.
     * </p>
     *
     * @see java.awt.geom.Arc2D.Double class java.awt.geom.Arc2D$Double (the hereby targeted class-under-test class)
     * @see Arc2DTests.DoubleTests Arc2DTests.DoubleTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, Arc2DClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.Arc2D.Double.class!",
                       java.awt.geom.Arc2D.Double.class.isAssignableFrom(sut));
        }

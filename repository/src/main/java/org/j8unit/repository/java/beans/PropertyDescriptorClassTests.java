 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PropertyDescriptor
...
public abstract interface PropertyDescriptorClassTests<SUT extends PropertyDescriptor>
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyDescriptor.class!",
                   PropertyDescriptor.class.isAssignableFrom(sut));
    }

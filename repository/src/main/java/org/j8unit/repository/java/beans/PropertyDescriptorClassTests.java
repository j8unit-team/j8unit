 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PropertyDescriptorTests}.
 * </p>
 *
 * @see java.beans.PropertyDescriptor class java.beans.PropertyDescriptor (the hereby targeted class-under-test class)
 * @see PropertyDescriptorTests PropertyDescriptorTests (The complementary j8unit test interface containing the instance
...
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyDescriptor.class!",
                   java.beans.PropertyDescriptor.class.isAssignableFrom(sut));
    }

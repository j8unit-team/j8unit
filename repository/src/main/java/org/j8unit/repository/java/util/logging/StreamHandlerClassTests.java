 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.logging.StreamHandler
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.util.logging.HandlerClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.logging.StreamHandler#StreamHandler()
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.logging.StreamHandler#StreamHandler(java.io.OutputStream, java.util.logging.Formatter)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.logging.StreamHandler sut = null; // = new StreamHandler(java.io.OutputStream,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.logging.StreamHandler#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.logging.StreamHandler class java.util.logging.StreamHandler}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamHandlerTests}.
 * </p>
 *
 * @see java.util.logging.StreamHandler class java.util.logging.StreamHandler (the hereby targeted class-under-test
 *      class)
 * @see StreamHandlerTests StreamHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StreamHandlerClassTests<SUT extends java.util.logging.StreamHandler>
extends HandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.StreamHandler.class!",
                   java.util.logging.StreamHandler.class.isAssignableFrom(sut));
    }

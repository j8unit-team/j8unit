 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StreamHandler
...
public abstract interface StreamHandlerClassTests<SUT extends StreamHandler>
extends HandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamHandler.class!",
                   StreamHandler.class.isAssignableFrom(sut));
    }

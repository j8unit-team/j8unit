 ...
 * {@link AlgorithmParameterSpec public abstract interface java.security.spec.AlgorithmParameterSpec}.
 *
...
public abstract interface AlgorithmParameterSpecClassTests<SUT extends AlgorithmParameterSpec>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlgorithmParameterSpec.class!",
                   AlgorithmParameterSpec.class.isAssignableFrom(sut));
    }

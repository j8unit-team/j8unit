 ...
 * java.security.spec.AlgorithmParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AlgorithmParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AlgorithmParameterSpecTests}.
 * </p>
 *
 * @see java.security.spec.AlgorithmParameterSpec interface java.security.spec.AlgorithmParameterSpec (the hereby
 *      targeted class-under-test class)
 * @see AlgorithmParameterSpecTests AlgorithmParameterSpecTests (The complementary j8unit test interface containing the
...
public abstract interface AlgorithmParameterSpecClassTests<SUT extends java.security.spec.AlgorithmParameterSpec>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.AlgorithmParameterSpec.class!",
                   java.security.spec.AlgorithmParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Path public
...
org.j8unit.repository.java.nio.file.WatchableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Path.class!", Path.class.isAssignableFrom(sut));
    }

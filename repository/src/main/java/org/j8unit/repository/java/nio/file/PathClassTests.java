...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.Path interface java.nio.file.Path}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PathTests}).
 * </p>
 *
 * <p>
 ...
 * @see PathTests PathTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.IterableClassTests<SUT>, WatchableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.Path.class!",
                   java.nio.file.Path.class.isAssignableFrom(sut));
    }

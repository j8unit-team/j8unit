...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.PipedInputStream class java.io.PipedInputStream}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PipedInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PipedInputStreamTests}.
 * </p>
 *
 * @see java.io.PipedInputStream class java.io.PipedInputStream (the hereby targeted class-under-test class)
 * @see PipedInputStreamTests PipedInputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface PipedInputStreamClassTests<SUT extends java.io.PipedInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PipedInputStream.class!",
                   java.io.PipedInputStream.class.isAssignableFrom(sut));
    }

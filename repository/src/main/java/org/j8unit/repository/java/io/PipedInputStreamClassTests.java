 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PipedInputStream
...
public abstract interface PipedInputStreamClassTests<SUT extends PipedInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PipedInputStream.class!",
                   PipedInputStream.class.isAssignableFrom(sut));
    }

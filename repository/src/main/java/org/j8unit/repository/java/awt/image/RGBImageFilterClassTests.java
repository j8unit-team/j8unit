 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RGBImageFilter
...
public abstract interface RGBImageFilterClassTests<SUT extends RGBImageFilter>
extends org.j8unit.repository.java.awt.image.ImageFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RGBImageFilter.class!",
                   RGBImageFilter.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.image.RGBImageFilter]

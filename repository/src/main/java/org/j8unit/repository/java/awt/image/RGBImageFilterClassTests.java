 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RGBImageFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RGBImageFilterTests}.
 * </p>
 *
 * @see java.awt.image.RGBImageFilter class java.awt.image.RGBImageFilter (the hereby targeted class-under-test class)
 * @see RGBImageFilterTests RGBImageFilterTests (The complementary j8unit test interface containing the instance
...
extends ImageFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.RGBImageFilter.class!",
                   java.awt.image.RGBImageFilter.class.isAssignableFrom(sut));
    }

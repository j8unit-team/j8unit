 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateFormat public
...
public abstract interface DateFormatClassTests<SUT extends DateFormat>
extends FormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateFormat.class!",
                   DateFormat.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.text.DateFormat]
     ...
     * {@link Field public static class java.text.DateFormat$Field}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends org.j8unit.repository.java.text.FormatClassTests.FieldClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.text.DateFormat$Field]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GridBagLayoutInfo
 * public class java.awt.GridBagLayoutInfo}.
 *
...
public abstract interface GridBagLayoutInfoClassTests<SUT extends GridBagLayoutInfo>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GridBagLayoutInfo.class!",
                   GridBagLayoutInfo.class.isAssignableFrom(sut));
    }

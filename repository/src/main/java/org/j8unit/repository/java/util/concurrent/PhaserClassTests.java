 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Phaser public class
...
public abstract interface PhaserClassTests<SUT extends Phaser>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Phaser.class!",
                   Phaser.class.isAssignableFrom(sut));
    }

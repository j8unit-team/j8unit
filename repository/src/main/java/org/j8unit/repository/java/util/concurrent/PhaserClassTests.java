 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PhaserTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PhaserTests}.
 * </p>
 *
 * @see java.util.concurrent.Phaser class java.util.concurrent.Phaser (the hereby targeted class-under-test class)
 * @see PhaserTests PhaserTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Phaser.class!",
                   java.util.concurrent.Phaser.class.isAssignableFrom(sut));
    }

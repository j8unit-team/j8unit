...
import org.j8unit.repository.java.lang.ClassLoaderClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecureClassLoader
...
public abstract interface SecureClassLoaderClassTests<SUT extends SecureClassLoader>
extends ClassLoaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecureClassLoader.class!",
                   SecureClassLoader.class.isAssignableFrom(sut));
    }

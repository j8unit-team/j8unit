 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SecureClassLoaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SecureClassLoaderTests}.
 * </p>
 *
 * @see java.security.SecureClassLoader class java.security.SecureClassLoader (the hereby targeted class-under-test
 *      class)
 * @see SecureClassLoaderTests SecureClassLoaderTests (The complementary j8unit test interface containing the instance
...
public abstract interface SecureClassLoaderClassTests<SUT extends java.security.SecureClassLoader>
extends org.j8unit.repository.java.lang.ClassLoaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.SecureClassLoader.class!",
                   java.security.SecureClassLoader.class.isAssignableFrom(sut));
    }

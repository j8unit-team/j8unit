 ...
 * java.beans.IndexedPropertyDescriptor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * @see IndexedPropertyDescriptorTests IndexedPropertyDescriptorTests (The complementary j8unit test interface
...
extends PropertyDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.IndexedPropertyDescriptor.class!",
                   java.beans.IndexedPropertyDescriptor.class.isAssignableFrom(sut));
    }

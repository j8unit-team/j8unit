 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RandomAccessFile
...
public abstract interface RandomAccessFileClassTests<SUT extends RandomAccessFile>
extends DataOutputClassTests<SUT>, DataInputClassTests<SUT>, CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RandomAccessFile.class!",

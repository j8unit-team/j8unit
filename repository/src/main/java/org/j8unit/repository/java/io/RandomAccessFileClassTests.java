 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RandomAccessFileTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RandomAccessFileTests}.
 * </p>
 *
 * @see java.io.RandomAccessFile class java.io.RandomAccessFile (the hereby targeted class-under-test class)
 * @see RandomAccessFileTests RandomAccessFileTests (The complementary j8unit test interface containing the instance
...
extends DataOutputClassTests<SUT>, DataInputClassTests<SUT>, CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.RandomAccessFile.class!",
                   java.io.RandomAccessFile.class.isAssignableFrom(sut));
    }

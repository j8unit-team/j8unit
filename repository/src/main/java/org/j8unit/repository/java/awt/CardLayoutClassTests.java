 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CardLayout public
...
public abstract interface CardLayoutClassTests<SUT extends CardLayout>
extends LayoutManager2ClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.CardLayout]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CardLayout.class!",
                   CardLayout.class.isAssignableFrom(sut));
    }

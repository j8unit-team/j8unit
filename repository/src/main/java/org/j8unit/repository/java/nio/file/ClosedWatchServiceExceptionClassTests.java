...
public abstract interface ClosedWatchServiceExceptionClassTests<SUT extends ClosedWatchServiceException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClosedWatchServiceException.class!",
                   ClosedWatchServiceException.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.file.ClosedWatchServiceException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ClosedWatchServiceExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ClosedWatchServiceExceptionTests ClosedWatchServiceExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.ClosedWatchServiceException.class!",
                   java.nio.file.ClosedWatchServiceException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImagingOpException
 * public class java.awt.image.ImagingOpException}.
 *
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImagingOpException.class!",
                   ImagingOpException.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.image.ImagingOpException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImagingOpExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.image.ImagingOpException class java.awt.image.ImagingOpException (the hereby targeted class-under-test
 *      class)
 * @see ImagingOpExceptionTests ImagingOpExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ImagingOpException.class!",
                   java.awt.image.ImagingOpException.class.isAssignableFrom(sut));
    }

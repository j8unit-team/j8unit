 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComponentColorModel
 * public class java.awt.image.ComponentColorModel}.
 *
...
public abstract interface ComponentColorModelClassTests<SUT extends ComponentColorModel>
extends ColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentColorModel.class!",
                   ComponentColorModel.class.isAssignableFrom(sut));
    }

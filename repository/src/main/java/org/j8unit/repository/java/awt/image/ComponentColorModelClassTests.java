...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.ComponentColorModel class
 * java.awt.image.ComponentColorModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentColorModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentColorModelTests}.
 * </p>
 *
 * @see java.awt.image.ComponentColorModel class java.awt.image.ComponentColorModel (the hereby targeted
 *      class-under-test class)
 * @see ComponentColorModelTests ComponentColorModelTests (The complementary j8unit test interface containing the
...
public abstract interface ComponentColorModelClassTests<SUT extends java.awt.image.ComponentColorModel>
extends ColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ComponentColorModel.class!",
                   java.awt.image.ComponentColorModel.class.isAssignableFrom(sut));
    }

 ...
 * java.util.concurrent.CountDownLatch}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CountDownLatchTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CountDownLatchTests}.
 * </p>
 *
 * @see java.util.concurrent.CountDownLatch class java.util.concurrent.CountDownLatch (the hereby targeted
 *      class-under-test class)
 * @see CountDownLatchTests CountDownLatchTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CountDownLatch.class!",
                   java.util.concurrent.CountDownLatch.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CountDownLatch
...
public abstract interface CountDownLatchClassTests<SUT extends CountDownLatch>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CountDownLatch.class!",
                   CountDownLatch.class.isAssignableFrom(sut));
    }

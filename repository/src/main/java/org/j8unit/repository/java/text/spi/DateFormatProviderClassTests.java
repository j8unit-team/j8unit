...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.spi.DateFormatProvider class
 * java.text.spi.DateFormatProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateFormatProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateFormatProviderTests}.
 * </p>
 *
 * @see java.text.spi.DateFormatProvider class java.text.spi.DateFormatProvider (the hereby targeted class-under-test
 *      class)
 * @see DateFormatProviderTests DateFormatProviderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.spi.DateFormatProvider.class!",
                   java.text.spi.DateFormatProvider.class.isAssignableFrom(sut));
    }

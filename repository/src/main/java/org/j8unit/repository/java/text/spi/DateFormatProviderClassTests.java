...
import org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateFormatProvider
 * public abstract class java.text.spi.DateFormatProvider}.
 *
...
public abstract interface DateFormatProviderClassTests<SUT extends DateFormatProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateFormatProvider.class!",
                   DateFormatProvider.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HttpRetryException
...
public abstract interface HttpRetryExceptionClassTests<SUT extends HttpRetryException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HttpRetryException.class!",
                   HttpRetryException.class.isAssignableFrom(sut));
    }

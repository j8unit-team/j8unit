 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HttpRetryExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HttpRetryExceptionTests}.
 * </p>
 *
 * @see java.net.HttpRetryException class java.net.HttpRetryException (the hereby targeted class-under-test class)
 * @see HttpRetryExceptionTests HttpRetryExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.HttpRetryException.class!",
                   java.net.HttpRetryException.class.isAssignableFrom(sut));
    }

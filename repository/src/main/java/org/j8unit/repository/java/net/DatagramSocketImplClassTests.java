 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DatagramSocketImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DatagramSocketImplTests}.
 * </p>
 *
 * @see java.net.DatagramSocketImpl class java.net.DatagramSocketImpl (the hereby targeted class-under-test class)
 * @see DatagramSocketImplTests DatagramSocketImplTests (The complementary j8unit test interface containing the instance
...
public abstract interface DatagramSocketImplClassTests<SUT extends java.net.DatagramSocketImpl>
extends SocketOptionsClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.DatagramSocketImpl.class!",
                   java.net.DatagramSocketImpl.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DatagramSocketImpl
...
public abstract interface DatagramSocketImplClassTests<SUT extends DatagramSocketImpl>
extends SocketOptionsClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatagramSocketImpl.class!",

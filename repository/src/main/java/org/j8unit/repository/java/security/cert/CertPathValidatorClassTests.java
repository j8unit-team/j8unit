 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertPathValidator
...
public abstract interface CertPathValidatorClassTests<SUT extends CertPathValidator>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathValidator.class!",
                   CertPathValidator.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DriverPropertyInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DriverPropertyInfoTests}.
 * </p>
 *
 * @see java.sql.DriverPropertyInfo class java.sql.DriverPropertyInfo (the hereby targeted class-under-test class)
 * @see DriverPropertyInfoTests DriverPropertyInfoTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.DriverPropertyInfo.class!",
                   java.sql.DriverPropertyInfo.class.isAssignableFrom(sut));
    }

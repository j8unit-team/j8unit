...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Arrays class java.util.Arrays}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ArraysTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ArraysTests}.
 * </p>
 *
 * @see java.util.Arrays class java.util.Arrays (the hereby targeted class-under-test class)
 * @see ArraysTests ArraysTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Arrays.class!",
                   java.util.Arrays.class.isAssignableFrom(sut));
    }

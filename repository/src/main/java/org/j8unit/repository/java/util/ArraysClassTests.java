 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Arrays public class
 * java.util.Arrays}.
 *
...
public abstract interface ArraysClassTests<SUT extends Arrays>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Arrays.class!",
                   Arrays.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Button public class
 * java.awt.Button}.
 *
...
public abstract interface ButtonClassTests<SUT extends Button>
extends AccessibleClassTests<SUT>, ComponentClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Button]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Button.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Button class java.awt.Button}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ButtonTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ButtonTests}.
 * </p>
 *
 * @see java.awt.Button class java.awt.Button (the hereby targeted class-under-test class)
 * @see ButtonTests ButtonTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ButtonClassTests<SUT extends java.awt.Button>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Button.class!",
                   java.awt.Button.class.isAssignableFrom(sut));
    }

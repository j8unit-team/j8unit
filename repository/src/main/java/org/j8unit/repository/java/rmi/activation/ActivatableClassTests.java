 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivatableTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ActivatableTests ActivatableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.rmi.server.RemoteServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.Activatable.class!",
                   java.rmi.activation.Activatable.class.isAssignableFrom(sut));
    }

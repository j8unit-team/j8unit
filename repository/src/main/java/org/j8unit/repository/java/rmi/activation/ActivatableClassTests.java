...
import org.j8unit.repository.java.rmi.server.RemoteServerClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Activatable public
 * abstract class java.rmi.activation.Activatable}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActivatableTests}.
 * </p>
 *
 * <p>
...
public abstract interface ActivatableClassTests<SUT extends Activatable>
extends RemoteServerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Activatable.class!",
                   Activatable.class.isAssignableFrom(sut));
    }

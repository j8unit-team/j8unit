 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLOutput public
 * abstract interface java.sql.SQLOutput}.
 *
...
public abstract interface SQLOutputClassTests<SUT extends SQLOutput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLOutput.class!",
                   SQLOutput.class.isAssignableFrom(sut));
    }

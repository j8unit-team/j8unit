...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.SQLOutput interface java.sql.SQLOutput}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLOutputTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLOutputTests}.
 * </p>
 *
 * @see java.sql.SQLOutput interface java.sql.SQLOutput (the hereby targeted class-under-test class)
 * @see SQLOutputTests SQLOutputTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SQLOutputClassTests<SUT extends java.sql.SQLOutput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLOutput.class!",
                   java.sql.SQLOutput.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Queue public
 * abstract interface java.util.Queue<E>}.
 *
...
public abstract interface QueueClassTests<SUT extends Queue>
extends CollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Queue.class!", Queue.class.isAssignableFrom(sut));
    }

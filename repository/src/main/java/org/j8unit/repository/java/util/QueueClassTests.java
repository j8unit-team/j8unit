...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Queue interface java.util.Queue}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link QueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link QueueTests}.
 * </p>
 *
 * @see java.util.Queue interface java.util.Queue (the hereby targeted class-under-test class)
 * @see QueueTests QueueTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends CollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Queue.class!",
                   java.util.Queue.class.isAssignableFrom(sut));
    }

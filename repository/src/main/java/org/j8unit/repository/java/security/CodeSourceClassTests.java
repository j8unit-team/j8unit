 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CodeSource public
...
public abstract interface CodeSourceClassTests<SUT extends CodeSource>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CodeSource.class!",
                   CodeSource.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.WritableByteChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WritableByteChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WritableByteChannelTests}.
 * </p>
 *
 * @see java.nio.channels.WritableByteChannel interface java.nio.channels.WritableByteChannel (the hereby targeted
 *      class-under-test class)
 * @see WritableByteChannelTests WritableByteChannelTests (The complementary j8unit test interface containing the
...
public abstract interface WritableByteChannelClassTests<SUT extends java.nio.channels.WritableByteChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.WritableByteChannel.class!",
                   java.nio.channels.WritableByteChannel.class.isAssignableFrom(sut));
    }

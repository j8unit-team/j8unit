 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WritableByteChannel
 * public abstract interface java.nio.channels.WritableByteChannel}.
 *
...
public abstract interface WritableByteChannelClassTests<SUT extends WritableByteChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WritableByteChannel.class!",
                   WritableByteChannel.class.isAssignableFrom(sut));
    }

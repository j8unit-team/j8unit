 ...
 * java.util.concurrent.ForkJoinPool}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ForkJoinPoolTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ForkJoinPoolTests ForkJoinPoolTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends AbstractExecutorServiceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ForkJoinPool.class!",
                   java.util.concurrent.ForkJoinPool.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.concurrent.ForkJoinPool.ForkJoinWorkerThreadFactory
     * interface java.util.concurrent.ForkJoinPool$ForkJoinWorkerThreadFactory}, containing all type relevant aspects
     ...
     * {@link ForkJoinPoolTests.ForkJoinWorkerThreadFactoryTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ForkJoinPoolTests.ForkJoinWorkerThreadFactoryTests ForkJoinPoolTests.ForkJoinWorkerThreadFactoryTests (The
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ForkJoinPool.ForkJoinWorkerThreadFactory.class!",
                       java.util.concurrent.ForkJoinPool.ForkJoinWorkerThreadFactory.class.isAssignableFrom(sut));
        }
     ...
     * java.util.concurrent.ForkJoinPool$ManagedBlocker}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link ForkJoinPoolTests.ManagedBlockerTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ForkJoinPoolTests.ManagedBlockerTests ForkJoinPoolTests.ManagedBlockerTests (The complementary j8unit test
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ForkJoinPool.ManagedBlocker.class!",
                       java.util.concurrent.ForkJoinPool.ManagedBlocker.class.isAssignableFrom(sut));
        }

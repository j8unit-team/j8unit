...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.ServerSocketChannel class
 * java.nio.channels.ServerSocketChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerSocketChannelTests}).
 * </p>
 *
 * <p>
 ...
 * @see ServerSocketChannelTests ServerSocketChannelTests (The complementary j8unit test interface containing the
...
public abstract interface ServerSocketChannelClassTests<SUT extends java.nio.channels.ServerSocketChannel>
extends NetworkChannelClassTests<SUT>, org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ServerSocketChannel.class!",
                   java.nio.channels.ServerSocketChannel.class.isAssignableFrom(sut));
    }

 ...
 * </p>
 *
 * @see java.util.EventListener interface java.util.EventListener (the hereby targeted class-under-test class)
...
public abstract interface EventListenerClassTests<SUT extends java.util.EventListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.EventListener.class!",
                   java.util.EventListener.class.isAssignableFrom(sut));
    }

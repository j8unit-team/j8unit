 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventListener
 * public abstract interface java.util.EventListener}.
 *
...
public abstract interface EventListenerClassTests<SUT extends EventListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventListener.class!",
                   EventListener.class.isAssignableFrom(sut));
    }

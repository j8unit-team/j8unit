...
public abstract interface InvalidObjectExceptionClassTests<SUT extends InvalidObjectException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidObjectException.class!",
                   InvalidObjectException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidObjectExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InvalidObjectExceptionTests}.
 * </p>
 *
 * @see java.io.InvalidObjectException class java.io.InvalidObjectException (the hereby targeted class-under-test class)
 * @see InvalidObjectExceptionTests InvalidObjectExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface InvalidObjectExceptionClassTests<SUT extends java.io.InvalidObjectException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.InvalidObjectException.class!",
                   java.io.InvalidObjectException.class.isAssignableFrom(sut));
    }

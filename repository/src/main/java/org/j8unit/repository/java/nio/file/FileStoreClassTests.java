 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileStore public
 * abstract class java.nio.file.FileStore}.
 *
...
public abstract interface FileStoreClassTests<SUT extends FileStore>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileStore.class!",
                   FileStore.class.isAssignableFrom(sut));
    }

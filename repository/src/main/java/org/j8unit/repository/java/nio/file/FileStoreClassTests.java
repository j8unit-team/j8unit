 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileStoreTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileStoreTests}.
 * </p>
 *
 * @see java.nio.file.FileStore class java.nio.file.FileStore (the hereby targeted class-under-test class)
 * @see FileStoreTests FileStoreTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileStoreClassTests<SUT extends java.nio.file.FileStore>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileStore.class!",
                   java.nio.file.FileStore.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Pattern public
...
public abstract interface PatternClassTests<SUT extends Pattern>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.regex.Pattern]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Pattern.class!",
                   Pattern.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.regex.Pattern]

 ...
 * java.sql.SQLInvalidAuthorizationSpecException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link SQLInvalidAuthorizationSpecExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.sql.SQLInvalidAuthorizationSpecException class java.sql.SQLInvalidAuthorizationSpecException (the hereby
 *      targeted class-under-test class)
 * @see SQLInvalidAuthorizationSpecExceptionTests SQLInvalidAuthorizationSpecExceptionTests (The complementary j8unit
...
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLInvalidAuthorizationSpecException.class!",
                   java.sql.SQLInvalidAuthorizationSpecException.class.isAssignableFrom(sut));
    }

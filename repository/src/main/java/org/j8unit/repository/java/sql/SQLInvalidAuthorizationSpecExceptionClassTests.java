 ...
 * {@link SQLInvalidAuthorizationSpecException public class java.sql.SQLInvalidAuthorizationSpecException}.
 *
...
public abstract interface SQLInvalidAuthorizationSpecExceptionClassTests<SUT extends SQLInvalidAuthorizationSpecException>
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLInvalidAuthorizationSpecException.class!",
                   SQLInvalidAuthorizationSpecException.class.isAssignableFrom(sut));
    }

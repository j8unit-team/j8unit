...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.ContainerListener interface
 * java.awt.event.ContainerListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContainerListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ContainerListenerTests}.
 * </p>
 *
 * @see java.awt.event.ContainerListener interface java.awt.event.ContainerListener (the hereby targeted
 *      class-under-test class)
 * @see ContainerListenerTests ContainerListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ContainerListenerClassTests<SUT extends java.awt.event.ContainerListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ContainerListener.class!",
                   java.awt.event.ContainerListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ContainerListener
...
public abstract interface ContainerListenerClassTests<SUT extends ContainerListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContainerListener.class!",
                   ContainerListener.class.isAssignableFrom(sut));
    }

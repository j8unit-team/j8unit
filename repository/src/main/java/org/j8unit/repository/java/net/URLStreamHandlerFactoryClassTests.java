 ...
 * {@link URLStreamHandlerFactory public abstract interface java.net.URLStreamHandlerFactory}.
 *
...
public abstract interface URLStreamHandlerFactoryClassTests<SUT extends URLStreamHandlerFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLStreamHandlerFactory.class!",

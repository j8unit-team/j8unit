 ...
 * java.net.URLStreamHandlerFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLStreamHandlerFactoryTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link URLStreamHandlerFactoryTests}.
 * </p>
 *
 * @see java.net.URLStreamHandlerFactory interface java.net.URLStreamHandlerFactory (the hereby targeted
 *      class-under-test class)
 * @see URLStreamHandlerFactoryTests URLStreamHandlerFactoryTests (The complementary j8unit test interface containing
...
public abstract interface URLStreamHandlerFactoryClassTests<SUT extends java.net.URLStreamHandlerFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URLStreamHandlerFactory.class!",
                   java.net.URLStreamHandlerFactory.class.isAssignableFrom(sut));
    }

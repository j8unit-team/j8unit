...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.ScrollbarPeer interface java.awt.peer.ScrollbarPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScrollbarPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScrollbarPeerTests}.
 * </p>
 *
 * @see java.awt.peer.ScrollbarPeer interface java.awt.peer.ScrollbarPeer (the hereby targeted class-under-test class)
 * @see ScrollbarPeerTests ScrollbarPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ScrollbarPeerClassTests<SUT extends java.awt.peer.ScrollbarPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.ScrollbarPeer.class!",
                   java.awt.peer.ScrollbarPeer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScrollbarPeer
...
public abstract interface ScrollbarPeerClassTests<SUT extends ScrollbarPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScrollbarPeer.class!",
                   ScrollbarPeer.class.isAssignableFrom(sut));
    }

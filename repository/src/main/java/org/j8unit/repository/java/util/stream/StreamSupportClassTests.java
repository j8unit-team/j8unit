 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamSupportTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamSupportTests}.
 * </p>
 *
 * @see java.util.stream.StreamSupport class java.util.stream.StreamSupport (the hereby targeted class-under-test class)
 * @see StreamSupportTests StreamSupportTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.StreamSupport.class!",
                   java.util.stream.StreamSupport.class.isAssignableFrom(sut));
    }

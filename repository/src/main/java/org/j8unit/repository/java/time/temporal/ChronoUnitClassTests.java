 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChronoUnit public
 * final enum java.time.temporal.ChronoUnit}.
 *
...
public abstract interface ChronoUnitClassTests<SUT extends ChronoUnit>
extends org.j8unit.repository.java.time.temporal.TemporalUnitClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChronoUnit.class!",
                   ChronoUnit.class.isAssignableFrom(sut));
    }

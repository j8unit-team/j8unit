...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.ChronoUnit class java.time.temporal.ChronoUnit},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChronoUnitTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChronoUnitTests}.
 * </p>
 *
 * @see java.time.temporal.ChronoUnit class java.time.temporal.ChronoUnit (the hereby targeted class-under-test class)
 * @see ChronoUnitTests ChronoUnitTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ChronoUnitClassTests<SUT extends java.time.temporal.ChronoUnit>
extends TemporalUnitClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.ChronoUnit.class!",
                   java.time.temporal.ChronoUnit.class.isAssignableFrom(sut));
    }

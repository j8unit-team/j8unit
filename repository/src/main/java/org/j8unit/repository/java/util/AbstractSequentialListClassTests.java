...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.AbstractSequentialList class
 * java.util.AbstractSequentialList}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractSequentialListTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AbstractSequentialListTests}.
 * </p>
 *
 * @see java.util.AbstractSequentialList class java.util.AbstractSequentialList (the hereby targeted class-under-test
 *      class)
 * @see AbstractSequentialListTests AbstractSequentialListTests (The complementary j8unit test interface containing the
...
public abstract interface AbstractSequentialListClassTests<SUT extends java.util.AbstractSequentialList>
extends AbstractListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractSequentialList.class!",
                   java.util.AbstractSequentialList.class.isAssignableFrom(sut));
    }

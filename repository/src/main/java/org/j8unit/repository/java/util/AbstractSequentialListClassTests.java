...
public abstract interface AbstractSequentialListClassTests<SUT extends AbstractSequentialList>
extends org.j8unit.repository.java.util.AbstractListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractSequentialList.class!",
                   AbstractSequentialList.class.isAssignableFrom(sut));
    }

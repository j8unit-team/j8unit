 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WatchService public
 * abstract interface java.nio.file.WatchService}.
 *
...
public abstract interface WatchServiceClassTests<SUT extends WatchService>
extends CloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WatchService.class!",
                   WatchService.class.isAssignableFrom(sut));
    }

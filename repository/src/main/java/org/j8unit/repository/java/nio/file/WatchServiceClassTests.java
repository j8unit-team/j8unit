...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.WatchService interface java.nio.file.WatchService},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WatchServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WatchServiceTests}.
 * </p>
 *
 * @see java.nio.file.WatchService interface java.nio.file.WatchService (the hereby targeted class-under-test class)
 * @see WatchServiceTests WatchServiceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface WatchServiceClassTests<SUT extends java.nio.file.WatchService>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.WatchService.class!",
                   java.nio.file.WatchService.class.isAssignableFrom(sut));
    }

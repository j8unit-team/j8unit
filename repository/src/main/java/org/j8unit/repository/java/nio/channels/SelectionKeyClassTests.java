 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SelectionKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SelectionKeyTests}.
 * </p>
 *
 * @see java.nio.channels.SelectionKey class java.nio.channels.SelectionKey (the hereby targeted class-under-test class)
 * @see SelectionKeyTests SelectionKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SelectionKeyClassTests<SUT extends java.nio.channels.SelectionKey>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.SelectionKey.class!",
                   java.nio.channels.SelectionKey.class.isAssignableFrom(sut));
    }

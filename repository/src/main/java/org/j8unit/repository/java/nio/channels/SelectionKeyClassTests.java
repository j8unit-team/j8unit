 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SelectionKey public
 * abstract class java.nio.channels.SelectionKey}.
 *
...
public abstract interface SelectionKeyClassTests<SUT extends SelectionKey>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SelectionKey.class!",
                   SelectionKey.class.isAssignableFrom(sut));
    }

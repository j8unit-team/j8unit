 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GlyphVector public
 * abstract class java.awt.font.GlyphVector}.
 *
...
public abstract interface GlyphVectorClassTests<SUT extends GlyphVector>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GlyphVector.class!",
                   GlyphVector.class.isAssignableFrom(sut));
    }

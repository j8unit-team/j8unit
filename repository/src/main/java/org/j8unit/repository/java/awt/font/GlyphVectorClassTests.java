 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GlyphVectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GlyphVectorTests}.
 * </p>
 *
 * @see java.awt.font.GlyphVector class java.awt.font.GlyphVector (the hereby targeted class-under-test class)
 * @see GlyphVectorTests GlyphVectorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface GlyphVectorClassTests<SUT extends java.awt.font.GlyphVector>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.font.GlyphVector.class!",
                   java.awt.font.GlyphVector.class.isAssignableFrom(sut));
    }

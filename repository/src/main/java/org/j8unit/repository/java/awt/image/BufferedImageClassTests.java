 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferedImageTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferedImageTests}.
 * </p>
 *
 * @see java.awt.image.BufferedImage class java.awt.image.BufferedImage (the hereby targeted class-under-test class)
 * @see BufferedImageTests BufferedImageTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends WritableRenderedImageClassTests<SUT>, org.j8unit.repository.java.awt.TransparencyClassTests<SUT>, org.j8unit.repository.java.awt.ImageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.BufferedImage.class!",
                   java.awt.image.BufferedImage.class.isAssignableFrom(sut));
    }

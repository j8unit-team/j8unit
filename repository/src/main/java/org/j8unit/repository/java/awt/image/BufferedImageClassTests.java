 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferedImage
...
public abstract interface BufferedImageClassTests<SUT extends BufferedImage>
extends WritableRenderedImageClassTests<SUT>, TransparencyClassTests<SUT>, ImageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferedImage.class!",
                   BufferedImage.class.isAssignableFrom(sut));
    }

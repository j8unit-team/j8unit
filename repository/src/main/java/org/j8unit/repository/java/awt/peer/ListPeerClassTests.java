 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListPeer public
 * abstract interface java.awt.peer.ListPeer}.
 *
...
public abstract interface ListPeerClassTests<SUT extends ListPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListPeer.class!",
                   ListPeer.class.isAssignableFrom(sut));
    }

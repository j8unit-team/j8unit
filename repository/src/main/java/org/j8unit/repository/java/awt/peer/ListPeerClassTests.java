...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.ListPeer interface java.awt.peer.ListPeer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListPeerTests}.
 * </p>
 *
 * @see java.awt.peer.ListPeer interface java.awt.peer.ListPeer (the hereby targeted class-under-test class)
 * @see ListPeerTests ListPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ListPeerClassTests<SUT extends java.awt.peer.ListPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.ListPeer.class!",
                   java.awt.peer.ListPeer.class.isAssignableFrom(sut));
    }

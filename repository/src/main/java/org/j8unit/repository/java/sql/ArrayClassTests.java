...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Array interface java.sql.Array}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ArrayTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ArrayTests}.
 * </p>
 *
 * @see java.sql.Array interface java.sql.Array (the hereby targeted class-under-test class)
 * @see ArrayTests ArrayTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ArrayClassTests<SUT extends java.sql.Array>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Array.class!",
                   java.sql.Array.class.isAssignableFrom(sut));
    }

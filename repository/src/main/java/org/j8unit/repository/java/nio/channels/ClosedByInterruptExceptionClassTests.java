 ...
 * {@link ClosedByInterruptException public class java.nio.channels.ClosedByInterruptException}.
 *
...
public abstract interface ClosedByInterruptExceptionClassTests<SUT extends ClosedByInterruptException>
extends AsynchronousCloseExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClosedByInterruptException.class!",
                   ClosedByInterruptException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.channels.ClosedByInterruptException]

 ...
 * java.nio.channels.ClosedByInterruptException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link ClosedByInterruptExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ClosedByInterruptExceptionTests ClosedByInterruptExceptionTests (The complementary j8unit test interface
...
extends AsynchronousCloseExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ClosedByInterruptException.class!",
                   java.nio.channels.ClosedByInterruptException.class.isAssignableFrom(sut));
    }

 ...
 * {@link BufferUnderflowException public class java.nio.BufferUnderflowException}.
 *
...
public abstract interface BufferUnderflowExceptionClassTests<SUT extends BufferUnderflowException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferUnderflowException.class!",
                   BufferUnderflowException.class.isAssignableFrom(sut));
    }

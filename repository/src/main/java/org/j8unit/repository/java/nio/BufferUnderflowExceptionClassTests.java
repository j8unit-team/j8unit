 ...
 * java.nio.BufferUnderflowException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferUnderflowExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link BufferUnderflowExceptionTests}.
 * </p>
 *
 * @see java.nio.BufferUnderflowException class java.nio.BufferUnderflowException (the hereby targeted class-under-test
 *      class)
 * @see BufferUnderflowExceptionTests BufferUnderflowExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.BufferUnderflowException.class!",
                   java.nio.BufferUnderflowException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerializableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SerializableTests}.
 * </p>
 *
 * @see java.io.Serializable interface java.io.Serializable (the hereby targeted class-under-test class)
 * @see SerializableTests SerializableTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SerializableClassTests<SUT extends java.io.Serializable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.Serializable.class!",
                   java.io.Serializable.class.isAssignableFrom(sut));
    }

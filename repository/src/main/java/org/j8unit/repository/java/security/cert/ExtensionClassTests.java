...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.cert.Extension interface java.security.cert.Extension},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExtensionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ExtensionTests ExtensionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ExtensionClassTests<SUT extends java.security.cert.Extension>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.Extension.class!",
                   java.security.cert.Extension.class.isAssignableFrom(sut));
    }

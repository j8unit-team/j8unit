 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Extension public
 * abstract interface java.security.cert.Extension}.
 *
...
public abstract interface ExtensionClassTests<SUT extends Extension>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Extension.class!",
                   Extension.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SplittableRandom
...
public abstract interface SplittableRandomClassTests<SUT extends SplittableRandom>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.SplittableRandom]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SplittableRandom.class!",
                   SplittableRandom.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.SplittableRandom class java.util.SplittableRandom},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SplittableRandomTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SplittableRandomTests}.
 * </p>
 *
 * @see java.util.SplittableRandom class java.util.SplittableRandom (the hereby targeted class-under-test class)
 * @see SplittableRandomTests SplittableRandomTests (The complementary j8unit test interface containing the instance
...
public abstract interface SplittableRandomClassTests<SUT extends java.util.SplittableRandom>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.SplittableRandom.class!",
                   java.util.SplittableRandom.class.isAssignableFrom(sut));
    }

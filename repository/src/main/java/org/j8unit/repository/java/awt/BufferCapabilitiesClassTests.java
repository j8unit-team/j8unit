 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferCapabilities
 * public class java.awt.BufferCapabilities}.
 *
...
public abstract interface BufferCapabilitiesClassTests<SUT extends BufferCapabilities>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferCapabilities.class!",
     ...
     * {@link FlipContents public static final class java.awt.BufferCapabilities$FlipContents}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FlipContentsClassTests<SUT extends FlipContents>

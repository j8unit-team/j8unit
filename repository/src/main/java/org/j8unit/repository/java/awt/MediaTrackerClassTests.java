 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MediaTracker public
...
public abstract interface MediaTrackerClassTests<SUT extends MediaTracker>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MediaTracker.class!",
                   MediaTracker.class.isAssignableFrom(sut));
    }

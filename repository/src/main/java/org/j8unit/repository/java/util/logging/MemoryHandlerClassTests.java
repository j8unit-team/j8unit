...
extends org.j8unit.repository.java.util.logging.HandlerClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.logging.MemoryHandler#MemoryHandler()
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.logging.MemoryHandler#MemoryHandler(java.util.logging.Handler, int,
     *             java.util.logging.Level)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_MemoryHandler_Handler_int_Level()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.logging.MemoryHandler sut = null; // = new MemoryHandler(java.util.logging.Handler, int,
                                                          // java.util.logging.Level);
    }
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.logging.MemoryHandler#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

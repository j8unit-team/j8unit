 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MemoryHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MemoryHandlerTests}.
 * </p>
 *
 * @see java.util.logging.MemoryHandler class java.util.logging.MemoryHandler (the hereby targeted class-under-test
 *      class)
 * @see MemoryHandlerTests MemoryHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends HandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.MemoryHandler.class!",
                   java.util.logging.MemoryHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MemoryHandler
...
public abstract interface MemoryHandlerClassTests<SUT extends MemoryHandler>
extends HandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryHandler.class!",

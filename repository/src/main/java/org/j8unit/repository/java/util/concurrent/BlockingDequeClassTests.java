...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.BlockingDeque interface
 * java.util.concurrent.BlockingDeque}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BlockingDequeTests}).
 * </p>
 *
 * <p>
 ...
 * @see BlockingDequeTests BlockingDequeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends BlockingQueueClassTests<SUT>, org.j8unit.repository.java.util.DequeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.BlockingDeque.class!",
                   java.util.concurrent.BlockingDeque.class.isAssignableFrom(sut));
    }

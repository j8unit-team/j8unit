 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BlockingDeque
...
extends org.j8unit.repository.java.util.concurrent.BlockingQueueClassTests<SUT>, org.j8unit.repository.java.util.DequeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BlockingDeque.class!",
                   BlockingDeque.class.isAssignableFrom(sut));
    }

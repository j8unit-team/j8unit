...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.locks.Condition interface
 * java.util.concurrent.locks.Condition}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConditionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConditionTests}.
 * </p>
 *
 * @see java.util.concurrent.locks.Condition interface java.util.concurrent.locks.Condition (the hereby targeted
 *      class-under-test class)
 * @see ConditionTests ConditionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ConditionClassTests<SUT extends java.util.concurrent.locks.Condition>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.locks.Condition.class!",
                   java.util.concurrent.locks.Condition.class.isAssignableFrom(sut));
    }

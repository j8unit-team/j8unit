 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Condition public
 * abstract interface java.util.concurrent.locks.Condition}.
 *
...
public abstract interface ConditionClassTests<SUT extends Condition>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Condition.class!",
                   Condition.class.isAssignableFrom(sut));
    }

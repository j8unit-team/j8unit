...
public abstract interface UnknownFormatConversionExceptionClassTests<SUT extends UnknownFormatConversionException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownFormatConversionException.class!",
                   UnknownFormatConversionException.class.isAssignableFrom(sut));
    }

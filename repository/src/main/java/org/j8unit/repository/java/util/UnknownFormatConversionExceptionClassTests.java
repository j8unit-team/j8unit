 ...
 * java.util.UnknownFormatConversionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link UnknownFormatConversionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnknownFormatConversionExceptionTests UnknownFormatConversionExceptionTests (The complementary j8unit test
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.UnknownFormatConversionException.class!",
                   java.util.UnknownFormatConversionException.class.isAssignableFrom(sut));
    }

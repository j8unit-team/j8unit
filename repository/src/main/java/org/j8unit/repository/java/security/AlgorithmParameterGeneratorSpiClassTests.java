...
public abstract interface AlgorithmParameterGeneratorSpiClassTests<SUT extends AlgorithmParameterGeneratorSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlgorithmParameterGeneratorSpi.class!",
                   AlgorithmParameterGeneratorSpi.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvocationHandler
 * public abstract interface java.lang.reflect.InvocationHandler}.
 *
...
public abstract interface InvocationHandlerClassTests<SUT extends InvocationHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvocationHandler.class!",
                   InvocationHandler.class.isAssignableFrom(sut));
    }

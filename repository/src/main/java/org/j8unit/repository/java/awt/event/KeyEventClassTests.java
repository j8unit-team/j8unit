...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.KeyEvent class java.awt.event.KeyEvent}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyEventTests}.
 * </p>
 *
 * @see java.awt.event.KeyEvent class java.awt.event.KeyEvent (the hereby targeted class-under-test class)
 * @see KeyEventTests KeyEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends InputEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.KeyEvent.class!",
                   java.awt.event.KeyEvent.class.isAssignableFrom(sut));
    }

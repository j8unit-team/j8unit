 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyEvent public
...
public abstract interface KeyEventClassTests<SUT extends KeyEvent>
extends InputEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyEvent.class!",
                   KeyEvent.class.isAssignableFrom(sut));
    }

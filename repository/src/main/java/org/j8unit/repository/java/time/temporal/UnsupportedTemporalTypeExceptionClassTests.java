...
extends org.j8unit.repository.java.time.DateTimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedTemporalTypeException.class!",
                   UnsupportedTemporalTypeException.class.isAssignableFrom(sut));
    }

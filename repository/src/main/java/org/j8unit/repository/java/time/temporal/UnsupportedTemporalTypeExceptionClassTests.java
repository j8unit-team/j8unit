 ...
 * java.time.temporal.UnsupportedTemporalTypeException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see UnsupportedTemporalTypeExceptionTests UnsupportedTemporalTypeExceptionTests (The complementary j8unit test
...
extends org.j8unit.repository.java.time.DateTimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.UnsupportedTemporalTypeException.class!",
                   java.time.temporal.UnsupportedTemporalTypeException.class.isAssignableFrom(sut));
    }

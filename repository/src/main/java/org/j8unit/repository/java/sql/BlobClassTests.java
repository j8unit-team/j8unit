...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Blob interface java.sql.Blob}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BlobTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BlobTests}.
 * </p>
 *
 * @see java.sql.Blob interface java.sql.Blob (the hereby targeted class-under-test class)
 * @see BlobTests BlobTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface BlobClassTests<SUT extends java.sql.Blob>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Blob.class!",
                   java.sql.Blob.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Blob public
...
public abstract interface BlobClassTests<SUT extends Blob>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Blob.class!", Blob.class.isAssignableFrom(sut));
    }

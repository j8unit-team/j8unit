 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Skeleton public
 * abstract interface java.rmi.server.Skeleton}.
 *
...
public abstract interface SkeletonClassTests<SUT extends Skeleton>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Skeleton.class!",
                   Skeleton.class.isAssignableFrom(sut));
    }

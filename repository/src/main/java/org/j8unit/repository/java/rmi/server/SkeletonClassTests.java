...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.server.Skeleton interface java.rmi.server.Skeleton},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SkeletonTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SkeletonTests}.
 * </p>
 *
 * @see java.rmi.server.Skeleton interface java.rmi.server.Skeleton (the hereby targeted class-under-test class)
 * @see SkeletonTests SkeletonTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SkeletonClassTests<SUT extends java.rmi.server.Skeleton>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.Skeleton.class!",
                   java.rmi.server.Skeleton.class.isAssignableFrom(sut));
    }

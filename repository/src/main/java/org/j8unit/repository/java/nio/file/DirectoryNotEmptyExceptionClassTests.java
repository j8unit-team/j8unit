...
public abstract interface DirectoryNotEmptyExceptionClassTests<SUT extends DirectoryNotEmptyException>
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirectoryNotEmptyException.class!",
                   DirectoryNotEmptyException.class.isAssignableFrom(sut));
    }

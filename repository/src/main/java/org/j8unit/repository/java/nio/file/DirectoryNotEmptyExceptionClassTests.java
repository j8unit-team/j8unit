 ...
 * java.nio.file.DirectoryNotEmptyException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link DirectoryNotEmptyExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see DirectoryNotEmptyExceptionTests DirectoryNotEmptyExceptionTests (The complementary j8unit test interface
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.DirectoryNotEmptyException.class!",
                   java.nio.file.DirectoryNotEmptyException.class.isAssignableFrom(sut));
    }

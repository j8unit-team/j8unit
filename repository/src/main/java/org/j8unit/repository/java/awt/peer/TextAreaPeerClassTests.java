...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.TextAreaPeer interface java.awt.peer.TextAreaPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextAreaPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextAreaPeerTests}.
 * </p>
 *
 * @see java.awt.peer.TextAreaPeer interface java.awt.peer.TextAreaPeer (the hereby targeted class-under-test class)
 * @see TextAreaPeerTests TextAreaPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TextAreaPeerClassTests<SUT extends java.awt.peer.TextAreaPeer>
extends TextComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.TextAreaPeer.class!",
                   java.awt.peer.TextAreaPeer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextAreaPeer public
 * abstract interface java.awt.peer.TextAreaPeer}.
 *
...
public abstract interface TextAreaPeerClassTests<SUT extends TextAreaPeer>
extends TextComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextAreaPeer.class!",
                   TextAreaPeer.class.isAssignableFrom(sut));
    }

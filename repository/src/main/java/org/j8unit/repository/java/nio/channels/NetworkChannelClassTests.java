 ...
 * java.nio.channels.NetworkChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NetworkChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NetworkChannelTests}.
 * </p>
 *
 * @see java.nio.channels.NetworkChannel interface java.nio.channels.NetworkChannel (the hereby targeted
 *      class-under-test class)
 * @see NetworkChannelTests NetworkChannelTests (The complementary j8unit test interface containing the instance
...
public abstract interface NetworkChannelClassTests<SUT extends java.nio.channels.NetworkChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.NetworkChannel.class!",
                   java.nio.channels.NetworkChannel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NetworkChannel
 * public abstract interface java.nio.channels.NetworkChannel}.
 *
...
public abstract interface NetworkChannelClassTests<SUT extends NetworkChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NetworkChannel.class!",
                   NetworkChannel.class.isAssignableFrom(sut));
    }

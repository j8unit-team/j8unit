...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.BufferedImageOp interface
 * java.awt.image.BufferedImageOp}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferedImageOpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferedImageOpTests}.
 * </p>
 *
 * @see java.awt.image.BufferedImageOp interface java.awt.image.BufferedImageOp (the hereby targeted class-under-test
 *      class)
 * @see BufferedImageOpTests BufferedImageOpTests (The complementary j8unit test interface containing the instance
...
public abstract interface BufferedImageOpClassTests<SUT extends java.awt.image.BufferedImageOp>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.BufferedImageOp.class!",
                   java.awt.image.BufferedImageOp.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OptionalDataExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see OptionalDataExceptionTests OptionalDataExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface OptionalDataExceptionClassTests<SUT extends java.io.OptionalDataException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.OptionalDataException.class!",
                   java.io.OptionalDataException.class.isAssignableFrom(sut));
    }

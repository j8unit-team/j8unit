 ...
 * java.util.concurrent.ConcurrentNavigableMap}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConcurrentNavigableMapTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ConcurrentNavigableMapTests}.
 * </p>
 *
 * @see java.util.concurrent.ConcurrentNavigableMap interface java.util.concurrent.ConcurrentNavigableMap (the hereby
 *      targeted class-under-test class)
 * @see ConcurrentNavigableMapTests ConcurrentNavigableMapTests (The complementary j8unit test interface containing the
...
public abstract interface ConcurrentNavigableMapClassTests<SUT extends java.util.concurrent.ConcurrentNavigableMap>
extends ConcurrentMapClassTests<SUT>, org.j8unit.repository.java.util.NavigableMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ConcurrentNavigableMap.class!",
                   java.util.concurrent.ConcurrentNavigableMap.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.util.concurrent.ConcurrentNavigableMap interface java.util.concurrent.ConcurrentNavigableMap},
...
extends org.j8unit.repository.java.util.concurrent.ConcurrentMapClassTests<SUT,K,V>,
        org.j8unit.repository.java.util.NavigableMapClassTests<SUT,K,V>
{

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.util.concurrent.ConcurrentNavigableMap<K,V>> sut = createNewSUT();

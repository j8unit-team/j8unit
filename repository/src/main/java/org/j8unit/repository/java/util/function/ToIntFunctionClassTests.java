 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToIntFunction
 * public abstract interface java.util.function.ToIntFunction<T>}.
 *
...
public abstract interface ToIntFunctionClassTests<SUT extends ToIntFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToIntFunction.class!",
                   ToIntFunction.class.isAssignableFrom(sut));
    }

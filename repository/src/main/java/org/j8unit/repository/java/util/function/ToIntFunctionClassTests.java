...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.ToIntFunction interface
 * java.util.function.ToIntFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToIntFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToIntFunctionTests}.
 * </p>
 *
 * @see java.util.function.ToIntFunction interface java.util.function.ToIntFunction (the hereby targeted
 *      class-under-test class)
 * @see ToIntFunctionTests ToIntFunctionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ToIntFunction.class!",
                   java.util.function.ToIntFunction.class.isAssignableFrom(sut));
    }

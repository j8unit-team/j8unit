...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.dnd.peer.DropTargetContextPeer interface
 * java.awt.dnd.peer.DropTargetContextPeer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DropTargetContextPeerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link DropTargetContextPeerTests}.
 * </p>
 *
 * @see java.awt.dnd.peer.DropTargetContextPeer interface java.awt.dnd.peer.DropTargetContextPeer (the hereby targeted
 *      class-under-test class)
 * @see DropTargetContextPeerTests DropTargetContextPeerTests (The complementary j8unit test interface containing the
...
public abstract interface DropTargetContextPeerClassTests<SUT extends java.awt.dnd.peer.DropTargetContextPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.peer.DropTargetContextPeer.class!",
                   java.awt.dnd.peer.DropTargetContextPeer.class.isAssignableFrom(sut));
    }

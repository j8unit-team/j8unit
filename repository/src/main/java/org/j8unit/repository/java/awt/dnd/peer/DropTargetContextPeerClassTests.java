 ...
 * {@link DropTargetContextPeer public abstract interface java.awt.dnd.peer.DropTargetContextPeer}.
 *
...
public abstract interface DropTargetContextPeerClassTests<SUT extends DropTargetContextPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetContextPeer.class!",
                   DropTargetContextPeer.class.isAssignableFrom(sut));
    }

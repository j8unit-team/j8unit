 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ColorConvertOpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ColorConvertOpTests}.
 * </p>
 *
 * @see java.awt.image.ColorConvertOp class java.awt.image.ColorConvertOp (the hereby targeted class-under-test class)
 * @see ColorConvertOpTests ColorConvertOpTests (The complementary j8unit test interface containing the instance
...
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ColorConvertOp.class!",
                   java.awt.image.ColorConvertOp.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ColorConvertOp
 * public class java.awt.image.ColorConvertOp}.
 *
...
public abstract interface ColorConvertOpClassTests<SUT extends ColorConvertOp>
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorConvertOp.class!",
                   ColorConvertOp.class.isAssignableFrom(sut));
    }

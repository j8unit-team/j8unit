 ...
 * java.util.prefs.PreferenceChangeEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PreferenceChangeEventTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PreferenceChangeEventTests}.
 * </p>
 *
 * @see java.util.prefs.PreferenceChangeEvent class java.util.prefs.PreferenceChangeEvent (the hereby targeted
 *      class-under-test class)
 * @see PreferenceChangeEventTests PreferenceChangeEventTests (The complementary j8unit test interface containing the
...
public abstract interface PreferenceChangeEventClassTests<SUT extends java.util.prefs.PreferenceChangeEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.PreferenceChangeEvent.class!",
                   java.util.prefs.PreferenceChangeEvent.class.isAssignableFrom(sut));
    }

...
public abstract interface PreferenceChangeEventClassTests<SUT extends PreferenceChangeEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PreferenceChangeEvent.class!",
                   PreferenceChangeEvent.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain EnumConstantNotPresentException class
 * java.lang.EnumConstantNotPresentException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link EnumConstantNotPresentExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see EnumConstantNotPresentExceptionTests EnumConstantNotPresentExceptionTests (The complementary j8unit test
...
public abstract interface EnumConstantNotPresentExceptionClassTests<SUT extends EnumConstantNotPresentException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EnumConstantNotPresentException.class!",
                   EnumConstantNotPresentException.class.isAssignableFrom(sut));
    }

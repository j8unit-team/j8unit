 ...
 * java.awt.print.PrinterAbortException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterAbortExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PrinterAbortExceptionTests}.
 * </p>
 *
 * @see java.awt.print.PrinterAbortException class java.awt.print.PrinterAbortException (the hereby targeted
 *      class-under-test class)
 * @see PrinterAbortExceptionTests PrinterAbortExceptionTests (The complementary j8unit test interface containing the
...
extends PrinterExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.PrinterAbortException.class!",
                   java.awt.print.PrinterAbortException.class.isAssignableFrom(sut));
    }

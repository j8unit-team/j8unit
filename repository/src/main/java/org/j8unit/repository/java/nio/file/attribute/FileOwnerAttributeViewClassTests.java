 ...
 * java.nio.file.attribute.FileOwnerAttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileOwnerAttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 * {@link FileOwnerAttributeViewTests}.
 * </p>
 *
 * @see java.nio.file.attribute.FileOwnerAttributeView interface java.nio.file.attribute.FileOwnerAttributeView (the
 *      hereby targeted class-under-test class)
 * @see FileOwnerAttributeViewTests FileOwnerAttributeViewTests (The complementary j8unit test interface containing the
...
public abstract interface FileOwnerAttributeViewClassTests<SUT extends java.nio.file.attribute.FileOwnerAttributeView>
extends FileAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.FileOwnerAttributeView.class!",
                   java.nio.file.attribute.FileOwnerAttributeView.class.isAssignableFrom(sut));
    }

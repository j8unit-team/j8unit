...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.TreeMap class java.util.TreeMap}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeMapTests}.
 * </p>
 *
 * @see java.util.TreeMap class java.util.TreeMap (the hereby targeted class-under-test class)
 * @see TreeMapTests TreeMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends NavigableMapClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.TreeMap.class!",
                   java.util.TreeMap.class.isAssignableFrom(sut));
    }

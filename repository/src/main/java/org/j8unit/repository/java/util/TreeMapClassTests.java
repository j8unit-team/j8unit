...
/**
 * <p>
 * Test class for {@link java.util.TreeMap class java.util.TreeMap}, containing all class relevant test methods (at
 * least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.util.TreeMapTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractMapClassTests<SUT, K, V> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.util.TreeMap<K, V>> sut = createNewSUT();

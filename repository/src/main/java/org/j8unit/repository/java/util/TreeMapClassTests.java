 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeMap public
...
public abstract interface TreeMapClassTests<SUT extends TreeMap>
extends NavigableMapClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeMap.class!",

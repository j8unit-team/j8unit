...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Paint interface java.awt.Paint}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PaintTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PaintTests}.
 * </p>
 *
 * @see java.awt.Paint interface java.awt.Paint (the hereby targeted class-under-test class)
 * @see PaintTests PaintTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface PaintClassTests<SUT extends java.awt.Paint>
extends TransparencyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Paint.class!",
                   java.awt.Paint.class.isAssignableFrom(sut));
    }

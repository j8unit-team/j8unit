 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MarshalledObject
 * public final class java.rmi.MarshalledObject<T>}.
 *
...
public abstract interface MarshalledObjectClassTests<SUT extends MarshalledObject>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MarshalledObject.class!",
                   MarshalledObject.class.isAssignableFrom(sut));
    }

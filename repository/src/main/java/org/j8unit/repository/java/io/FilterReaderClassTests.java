...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.FilterReader class java.io.FilterReader}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilterReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilterReaderTests}.
 * </p>
 *
 * @see java.io.FilterReader class java.io.FilterReader (the hereby targeted class-under-test class)
 * @see FilterReaderTests FilterReaderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface FilterReaderClassTests<SUT extends java.io.FilterReader>
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FilterReader.class!",
                   java.io.FilterReader.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActiveEvent public
 * abstract interface java.awt.ActiveEvent}.
 *
...
public abstract interface ActiveEventClassTests<SUT extends ActiveEvent>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActiveEvent.class!",
                   ActiveEvent.class.isAssignableFrom(sut));
    }

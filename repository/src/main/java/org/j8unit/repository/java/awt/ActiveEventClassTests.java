...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.ActiveEvent interface java.awt.ActiveEvent}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActiveEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActiveEventTests}.
 * </p>
 *
 * @see java.awt.ActiveEvent interface java.awt.ActiveEvent (the hereby targeted class-under-test class)
 * @see ActiveEventTests ActiveEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ActiveEventClassTests<SUT extends java.awt.ActiveEvent>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.ActiveEvent.class!",
                   java.awt.ActiveEvent.class.isAssignableFrom(sut));
    }

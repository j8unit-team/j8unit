 ...
 * {@link ArrayBlockingQueue public class java.util.concurrent.ArrayBlockingQueue<E>}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.util.concurrent.ArrayBlockingQueueClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface ArrayBlockingQueueTests<SUT extends ArrayBlockingQueue<E>, E>

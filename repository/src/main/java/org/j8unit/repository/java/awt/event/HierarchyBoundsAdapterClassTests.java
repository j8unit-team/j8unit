...
public abstract interface HierarchyBoundsAdapterClassTests<SUT extends HierarchyBoundsAdapter>
extends org.j8unit.repository.java.awt.event.HierarchyBoundsListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HierarchyBoundsAdapter.class!",
                   HierarchyBoundsAdapter.class.isAssignableFrom(sut));
    }

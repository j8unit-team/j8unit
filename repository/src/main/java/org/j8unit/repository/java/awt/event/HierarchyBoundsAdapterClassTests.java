 ...
 * java.awt.event.HierarchyBoundsAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HierarchyBoundsAdapterTests}).
 * </p>
 *
 * <p>
 ...
 * {@link HierarchyBoundsAdapterTests}.
 * </p>
 *
 * @see java.awt.event.HierarchyBoundsAdapter class java.awt.event.HierarchyBoundsAdapter (the hereby targeted
 *      class-under-test class)
 * @see HierarchyBoundsAdapterTests HierarchyBoundsAdapterTests (The complementary j8unit test interface containing the
...
extends HierarchyBoundsListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.HierarchyBoundsAdapter.class!",
                   java.awt.event.HierarchyBoundsAdapter.class.isAssignableFrom(sut));
    }

 ...
 * {@link BeanContextContainerProxy public abstract interface java.beans.beancontext.BeanContextContainerProxy}.
 *
...
public abstract interface BeanContextContainerProxyClassTests<SUT extends BeanContextContainerProxy>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextContainerProxy.class!",
                   BeanContextContainerProxy.class.isAssignableFrom(sut));
    }

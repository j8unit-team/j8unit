 ...
 * java.beans.beancontext.BeanContextContainerProxy}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextContainerProxyTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextContainerProxyTests BeanContextContainerProxyTests (The complementary j8unit test interface
...
public abstract interface BeanContextContainerProxyClassTests<SUT extends java.beans.beancontext.BeanContextContainerProxy>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextContainerProxy.class!",
                   java.beans.beancontext.BeanContextContainerProxy.class.isAssignableFrom(sut));
    }

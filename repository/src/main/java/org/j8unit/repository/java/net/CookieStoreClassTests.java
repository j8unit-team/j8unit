...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.CookieStore interface java.net.CookieStore}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CookieStoreTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CookieStoreTests}.
 * </p>
 *
 * @see java.net.CookieStore interface java.net.CookieStore (the hereby targeted class-under-test class)
 * @see CookieStoreTests CookieStoreTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CookieStoreClassTests<SUT extends java.net.CookieStore>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.CookieStore.class!",
                   java.net.CookieStore.class.isAssignableFrom(sut));
    }

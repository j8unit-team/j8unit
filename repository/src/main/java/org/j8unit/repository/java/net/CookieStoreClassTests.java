 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CookieStore public
 * abstract interface java.net.CookieStore}.
 *
...
public abstract interface CookieStoreClassTests<SUT extends CookieStore>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CookieStore.class!",
                   CookieStore.class.isAssignableFrom(sut));
    }

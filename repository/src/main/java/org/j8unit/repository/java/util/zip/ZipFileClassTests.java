...
/**
 * <p>
 * Test class for {@link java.util.zip.ZipFile class java.util.zip.ZipFile}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.util.zip.ZipFileTests}.
 * </p>
 *
 * <p>
...
public abstract interface ZipFileClassTests<SUT extends java.util.zip.ZipFile>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    public default void create_ZipFile_File()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.zip.ZipFile sut = null; // = new ZipFile(java.io.File);
    }

    /**
     * Test method for {@link java.util.zip.ZipFile#ZipFile(java.io.File,java.nio.charset.Charset) public
     * java.util.zip.ZipFile(java.io.File,java.nio.charset.Charset) throws java.io.IOException}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ZipFile_File_Charset()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.zip.ZipFile sut = null; // = new ZipFile(java.io.File,java.nio.charset.Charset);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_ZipFile_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.zip.ZipFile sut = null; // = new ZipFile(java.lang.String);
    }

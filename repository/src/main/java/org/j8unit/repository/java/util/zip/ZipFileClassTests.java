 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZipFile public
...
public abstract interface ZipFileClassTests<SUT extends ZipFile>
extends CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZipFile.class!",
                   ZipFile.class.isAssignableFrom(sut));
    }

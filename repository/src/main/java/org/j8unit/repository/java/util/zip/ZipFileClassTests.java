...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.ZipFile class java.util.zip.ZipFile}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZipFileTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZipFileTests}.
 * </p>
 *
 * @see java.util.zip.ZipFile class java.util.zip.ZipFile (the hereby targeted class-under-test class)
 * @see ZipFileTests ZipFileTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.ZipFile.class!",
                   java.util.zip.ZipFile.class.isAssignableFrom(sut));
    }

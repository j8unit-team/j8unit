 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JapaneseDateTests}).
 * </p>
 *
 * <p>
 ...
 * @see JapaneseDateTests JapaneseDateTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.JapaneseDate.class!",
                   java.time.chrono.JapaneseDate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JapaneseDate public
 * final class java.time.chrono.JapaneseDate}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JapaneseDateTests}.
 * </p>
 *
 * <p>
...
public abstract interface JapaneseDateClassTests<SUT extends JapaneseDate>
extends ChronoLocalDateClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JapaneseDate.class!",
                   JapaneseDate.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.time.chrono.JapaneseDate]

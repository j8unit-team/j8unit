...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.JapaneseDate#from(java.time.temporal.TemporalAccessor)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.JapaneseDate#now()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.JapaneseDate#now(java.time.Clock)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.JapaneseDate#now(java.time.ZoneId)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    /**
     * <p>
     * Test method for {@link java.time.chrono.JapaneseDate#of(int, int, int) public static
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.JapaneseDate#of(int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    /**
     * <p>
     * Test method for {@link java.time.chrono.JapaneseDate#of(java.time.chrono.JapaneseEra, int, int, int) public
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.JapaneseDate#of(java.time.chrono.JapaneseEra, int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.time.chrono.JapaneseDate#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Optional class java.util.Optional}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OptionalTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OptionalTests}.
 * </p>
 *
 * @see java.util.Optional class java.util.Optional (the hereby targeted class-under-test class)
 * @see OptionalTests OptionalTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Optional.class!",
                   java.util.Optional.class.isAssignableFrom(sut));
    }

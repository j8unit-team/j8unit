 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Optional public
...
public abstract interface OptionalClassTests<SUT extends Optional>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Optional.class!",
                   Optional.class.isAssignableFrom(sut));
    }

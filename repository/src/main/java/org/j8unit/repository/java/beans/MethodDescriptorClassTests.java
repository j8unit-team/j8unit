 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MethodDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MethodDescriptorTests}.
 * </p>
 *
 * @see java.beans.MethodDescriptor class java.beans.MethodDescriptor (the hereby targeted class-under-test class)
 * @see MethodDescriptorTests MethodDescriptorTests (The complementary j8unit test interface containing the instance
...
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.MethodDescriptor.class!",
                   java.beans.MethodDescriptor.class.isAssignableFrom(sut));
    }

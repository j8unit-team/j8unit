 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MethodDescriptor
...
public abstract interface MethodDescriptorClassTests<SUT extends MethodDescriptor>
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MethodDescriptor.class!",
                   MethodDescriptor.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain BootstrapMethodError class java.lang.BootstrapMethodError}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BootstrapMethodErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BootstrapMethodErrorTests}
 * .
 * </p>
 *
 * @see BootstrapMethodError class java.lang.BootstrapMethodError (the hereby targeted class-under-test class)
 * @see BootstrapMethodErrorTests BootstrapMethodErrorTests (The complementary j8unit test interface containing the
...
public abstract interface BootstrapMethodErrorClassTests<SUT extends BootstrapMethodError>
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BootstrapMethodError.class!",
                   BootstrapMethodError.class.isAssignableFrom(sut));
    }

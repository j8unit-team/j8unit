 ...
 * java.beans.beancontext.BeanContextServicesSupport}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextServicesSupportTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextServicesSupportTests BeanContextServicesSupportTests (The complementary j8unit test interface
...
extends BeanContextServicesClassTests<SUT>, BeanContextSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServicesSupport.class!",
                   java.beans.beancontext.BeanContextServicesSupport.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MethodHandlesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MethodHandlesTests}.
 * </p>
 *
 * @see java.lang.invoke.MethodHandles class java.lang.invoke.MethodHandles (the hereby targeted class-under-test class)
 * @see MethodHandlesTests MethodHandlesTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.invoke.MethodHandles.class!",
                   java.lang.invoke.MethodHandles.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.lang.invoke.MethodHandles.Lookup class
     * java.lang.invoke.MethodHandles$Lookup}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link MethodHandlesTests.LookupTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see MethodHandlesTests.LookupTests MethodHandlesTests.LookupTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.invoke.MethodHandles.Lookup.class!",
                       java.lang.invoke.MethodHandles.Lookup.class.isAssignableFrom(sut));
        }

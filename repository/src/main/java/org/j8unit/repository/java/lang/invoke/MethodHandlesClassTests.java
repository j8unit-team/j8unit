...
import org.j8unit.repository.java.lang.invoke.MethodHandlesTests.LookupTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MethodHandles
...
public abstract interface MethodHandlesClassTests<SUT extends MethodHandles>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MethodHandles.class!",
     ...
     * {@link Lookup public static final class java.lang.invoke.MethodHandles$Lookup}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link LookupTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface LookupClassTests<SUT extends Lookup>
    extends ObjectClassTests<SUT> {

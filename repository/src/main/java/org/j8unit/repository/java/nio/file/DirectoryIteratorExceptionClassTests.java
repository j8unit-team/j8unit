...
import org.j8unit.repository.java.util.ConcurrentModificationExceptionClassTests;
 ...
 * {@link DirectoryIteratorException public final class java.nio.file.DirectoryIteratorException}.
 *
...
public abstract interface DirectoryIteratorExceptionClassTests<SUT extends DirectoryIteratorException>
extends ConcurrentModificationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirectoryIteratorException.class!",
                   DirectoryIteratorException.class.isAssignableFrom(sut));
    }

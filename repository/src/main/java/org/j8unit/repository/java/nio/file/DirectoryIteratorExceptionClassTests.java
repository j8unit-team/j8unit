 ...
 * java.nio.file.DirectoryIteratorException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link DirectoryIteratorExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see DirectoryIteratorExceptionTests DirectoryIteratorExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.util.ConcurrentModificationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.DirectoryIteratorException.class!",
                   java.nio.file.DirectoryIteratorException.class.isAssignableFrom(sut));
    }

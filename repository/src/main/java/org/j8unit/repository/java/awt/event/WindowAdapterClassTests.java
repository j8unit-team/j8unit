...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.WindowAdapter class java.awt.event.WindowAdapter},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WindowAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WindowAdapterTests}.
 * </p>
 *
 * @see java.awt.event.WindowAdapter class java.awt.event.WindowAdapter (the hereby targeted class-under-test class)
 * @see WindowAdapterTests WindowAdapterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface WindowAdapterClassTests<SUT extends java.awt.event.WindowAdapter>
extends WindowListenerClassTests<SUT>, WindowStateListenerClassTests<SUT>, WindowFocusListenerClassTests<SUT>,
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.WindowAdapter.class!",
                   java.awt.event.WindowAdapter.class.isAssignableFrom(sut));
    }

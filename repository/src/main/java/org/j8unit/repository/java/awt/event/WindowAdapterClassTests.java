 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WindowAdapter
...
public abstract interface WindowAdapterClassTests<SUT extends WindowAdapter>
extends WindowListenerClassTests<SUT>, WindowStateListenerClassTests<SUT>, WindowFocusListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WindowAdapter.class!",

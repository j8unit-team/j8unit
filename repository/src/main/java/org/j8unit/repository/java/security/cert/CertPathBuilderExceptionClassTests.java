 ...
 * java.security.cert.CertPathBuilderException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertPathBuilderExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link CertPathBuilderExceptionTests}.
 * </p>
 *
 * @see java.security.cert.CertPathBuilderException class java.security.cert.CertPathBuilderException (the hereby
 *      targeted class-under-test class)
 * @see CertPathBuilderExceptionTests CertPathBuilderExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathBuilderException.class!",
                   java.security.cert.CertPathBuilderException.class.isAssignableFrom(sut));
    }

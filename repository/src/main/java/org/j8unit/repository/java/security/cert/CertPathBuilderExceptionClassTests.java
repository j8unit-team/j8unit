...
public abstract interface CertPathBuilderExceptionClassTests<SUT extends CertPathBuilderException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathBuilderException.class!",
                   CertPathBuilderException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RSAPrivateKey
...
public abstract interface RSAPrivateKeyClassTests<SUT extends RSAPrivateKey>
extends PrivateKeyClassTests<SUT>, RSAKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAPrivateKey.class!",
                   RSAPrivateKey.class.isAssignableFrom(sut));
    }

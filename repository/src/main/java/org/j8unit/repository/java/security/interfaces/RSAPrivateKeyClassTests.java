 ...
 * java.security.interfaces.RSAPrivateKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAPrivateKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RSAPrivateKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.RSAPrivateKey interface java.security.interfaces.RSAPrivateKey (the hereby targeted
 *      class-under-test class)
 * @see RSAPrivateKeyTests RSAPrivateKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RSAPrivateKeyClassTests<SUT extends java.security.interfaces.RSAPrivateKey>
extends org.j8unit.repository.java.security.PrivateKeyClassTests<SUT>, RSAKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.RSAPrivateKey.class!",
                   java.security.interfaces.RSAPrivateKey.class.isAssignableFrom(sut));
    }

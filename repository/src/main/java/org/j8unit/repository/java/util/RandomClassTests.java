...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Random class java.util.Random}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RandomTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RandomTests}.
 * </p>
 *
 * @see java.util.Random class java.util.Random (the hereby targeted class-under-test class)
 * @see RandomTests RandomTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface RandomClassTests<SUT extends java.util.Random>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Random.class!",
                   java.util.Random.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Random public class
 * java.util.Random}.
 *
...
public abstract interface RandomClassTests<SUT extends Random>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Random.class!",
                   Random.class.isAssignableFrom(sut));
    }

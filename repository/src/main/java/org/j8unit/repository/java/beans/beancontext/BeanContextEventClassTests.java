 ...
 * java.beans.beancontext.BeanContextEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanContextEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BeanContextEventTests}.
 * </p>
 *
 * @see java.beans.beancontext.BeanContextEvent class java.beans.beancontext.BeanContextEvent (the hereby targeted
 *      class-under-test class)
 * @see BeanContextEventTests BeanContextEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface BeanContextEventClassTests<SUT extends java.beans.beancontext.BeanContextEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextEvent.class!",
                   java.beans.beancontext.BeanContextEvent.class.isAssignableFrom(sut));
    }

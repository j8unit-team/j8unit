 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanContextEvent
 * public abstract class java.beans.beancontext.BeanContextEvent}.
 *
...
public abstract interface BeanContextEventClassTests<SUT extends BeanContextEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextEvent.class!",
                   BeanContextEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IsoFields public
 * final class java.time.temporal.IsoFields}.
 *
...
public abstract interface IsoFieldsClassTests<SUT extends IsoFields>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IsoFields.class!",
                   IsoFields.class.isAssignableFrom(sut));
    }

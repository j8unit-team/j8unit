...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.IsoFields class java.time.temporal.IsoFields},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IsoFieldsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IsoFieldsTests}.
 * </p>
 *
 * @see java.time.temporal.IsoFields class java.time.temporal.IsoFields (the hereby targeted class-under-test class)
 * @see IsoFieldsTests IsoFieldsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IsoFieldsClassTests<SUT extends java.time.temporal.IsoFields>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.IsoFields.class!",
                   java.time.temporal.IsoFields.class.isAssignableFrom(sut));
    }

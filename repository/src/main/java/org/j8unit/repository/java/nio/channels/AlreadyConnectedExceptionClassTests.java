 ...
 * java.nio.channels.AlreadyConnectedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link AlreadyConnectedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see AlreadyConnectedExceptionTests AlreadyConnectedExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AlreadyConnectedException.class!",
                   java.nio.channels.AlreadyConnectedException.class.isAssignableFrom(sut));
    }

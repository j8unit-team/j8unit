 ...
 * {@link AlreadyConnectedException public class java.nio.channels.AlreadyConnectedException}.
 *
...
public abstract interface AlreadyConnectedExceptionClassTests<SUT extends AlreadyConnectedException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlreadyConnectedException.class!",
                   AlreadyConnectedException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.channels.AlreadyConnectedException]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.nio.channels.AlreadyConnectedException]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.ItemListener interface java.awt.event.ItemListener},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ItemListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ItemListenerTests}.
 * </p>
 *
 * @see java.awt.event.ItemListener interface java.awt.event.ItemListener (the hereby targeted class-under-test class)
 * @see ItemListenerTests ItemListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ItemListenerClassTests<SUT extends java.awt.event.ItemListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ItemListener.class!",
                   java.awt.event.ItemListener.class.isAssignableFrom(sut));
    }

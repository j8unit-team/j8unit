 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ItemListener public
 * abstract interface java.awt.event.ItemListener}.
 *
...
public abstract interface ItemListenerClassTests<SUT extends ItemListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ItemListener.class!",

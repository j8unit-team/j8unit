 ...
 * {@link MemoryNotificationInfo public class java.lang.management.MemoryNotificationInfo}.
 *
...
public abstract interface MemoryNotificationInfoClassTests<SUT extends MemoryNotificationInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryNotificationInfo.class!",
                   MemoryNotificationInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECKey public
...
public abstract interface ECKeyClassTests<SUT extends ECKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECKey.class!", ECKey.class.isAssignableFrom(sut));
    }

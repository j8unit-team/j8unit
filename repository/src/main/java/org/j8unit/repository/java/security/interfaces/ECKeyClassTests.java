...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.interfaces.ECKey interface
 * java.security.interfaces.ECKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.ECKey interface java.security.interfaces.ECKey (the hereby targeted class-under-test
 *      class)
 * @see ECKeyTests ECKeyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ECKeyClassTests<SUT extends java.security.interfaces.ECKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.ECKey.class!",
                   java.security.interfaces.ECKey.class.isAssignableFrom(sut));
    }

 ...
 * java.util.function.UnaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnaryOperatorTests}.
 * </p>
 *
 * @see java.util.function.UnaryOperator interface java.util.function.UnaryOperator (the hereby targeted
 *      class-under-test class)
 * @see UnaryOperatorTests UnaryOperatorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends FunctionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.UnaryOperator.class!",
                   java.util.function.UnaryOperator.class.isAssignableFrom(sut));
    }

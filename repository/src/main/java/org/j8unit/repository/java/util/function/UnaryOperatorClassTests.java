 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnaryOperator
...
public abstract interface UnaryOperatorClassTests<SUT extends UnaryOperator>
extends FunctionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnaryOperator.class!",
                   UnaryOperator.class.isAssignableFrom(sut));
    }

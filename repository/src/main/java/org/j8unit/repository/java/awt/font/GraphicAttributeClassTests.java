 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GraphicAttribute
...
public abstract interface GraphicAttributeClassTests<SUT extends GraphicAttribute>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GraphicAttribute.class!",
                   GraphicAttribute.class.isAssignableFrom(sut));
    }

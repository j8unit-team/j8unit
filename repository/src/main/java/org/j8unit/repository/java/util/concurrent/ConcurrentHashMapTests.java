 ...
 * {@link ConcurrentHashMap public class java.util.concurrent.ConcurrentHashMap<K,V>}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.util.AbstractMapTests<SUT, K, V> {
     ...
     * <p>
     * Reusable j8unit test interface containing the instance relevant aspects &ndash;&nbsp;i.&thinsp;e., test methods
     * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link KeySetView
     * public static class java.util.concurrent.ConcurrentHashMap$KeySetView<K,V>}.
     * </p>
     *
     * <p>

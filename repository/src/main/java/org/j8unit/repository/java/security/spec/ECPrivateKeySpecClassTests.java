 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECPrivateKeySpec
...
public abstract interface ECPrivateKeySpecClassTests<SUT extends ECPrivateKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECPrivateKeySpec.class!",
                   ECPrivateKeySpec.class.isAssignableFrom(sut));
    }

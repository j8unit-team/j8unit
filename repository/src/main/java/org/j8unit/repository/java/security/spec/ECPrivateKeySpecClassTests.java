 ...
 * java.security.spec.ECPrivateKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECPrivateKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECPrivateKeySpecTests}.
 * </p>
 *
 * @see java.security.spec.ECPrivateKeySpec class java.security.spec.ECPrivateKeySpec (the hereby targeted
 *      class-under-test class)
 * @see ECPrivateKeySpecTests ECPrivateKeySpecTests (The complementary j8unit test interface containing the instance
...
public abstract interface ECPrivateKeySpecClassTests<SUT extends java.security.spec.ECPrivateKeySpec>
extends KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECPrivateKeySpec.class!",
                   java.security.spec.ECPrivateKeySpec.class.isAssignableFrom(sut));
    }

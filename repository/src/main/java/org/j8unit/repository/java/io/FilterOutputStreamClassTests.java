 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilterOutputStream
...
public abstract interface FilterOutputStreamClassTests<SUT extends FilterOutputStream>
extends OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilterOutputStream.class!",
                   FilterOutputStream.class.isAssignableFrom(sut));
    }

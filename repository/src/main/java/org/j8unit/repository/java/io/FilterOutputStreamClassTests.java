 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilterOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilterOutputStreamTests}.
 * </p>
 *
 * @see java.io.FilterOutputStream class java.io.FilterOutputStream (the hereby targeted class-under-test class)
 * @see FilterOutputStreamTests FilterOutputStreamTests (The complementary j8unit test interface containing the instance
...
extends OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FilterOutputStream.class!",
                   java.io.FilterOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * {@link BufferOverflowException public class java.nio.BufferOverflowException}.
 *
...
public abstract interface BufferOverflowExceptionClassTests<SUT extends BufferOverflowException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferOverflowException.class!",
                   BufferOverflowException.class.isAssignableFrom(sut));
    }

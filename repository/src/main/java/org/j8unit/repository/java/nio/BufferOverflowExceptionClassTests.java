 ...
 * java.nio.BufferOverflowException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferOverflowExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link BufferOverflowExceptionTests}.
 * </p>
 *
 * @see java.nio.BufferOverflowException class java.nio.BufferOverflowException (the hereby targeted class-under-test
 *      class)
 * @see BufferOverflowExceptionTests BufferOverflowExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.BufferOverflowException.class!",
                   java.nio.BufferOverflowException.class.isAssignableFrom(sut));
    }

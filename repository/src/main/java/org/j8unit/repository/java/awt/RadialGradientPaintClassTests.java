 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RadialGradientPaint
 * public final class java.awt.RadialGradientPaint}.
 *
...
public abstract interface RadialGradientPaintClassTests<SUT extends RadialGradientPaint>
extends MultipleGradientPaintClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RadialGradientPaint.class!",
                   RadialGradientPaint.class.isAssignableFrom(sut));
    }

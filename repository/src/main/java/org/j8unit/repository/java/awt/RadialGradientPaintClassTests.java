 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RadialGradientPaintTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RadialGradientPaintTests}.
 * </p>
 *
 * @see java.awt.RadialGradientPaint class java.awt.RadialGradientPaint (the hereby targeted class-under-test class)
 * @see RadialGradientPaintTests RadialGradientPaintTests (The complementary j8unit test interface containing the
...
extends MultipleGradientPaintClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.RadialGradientPaint.class!",
                   java.awt.RadialGradientPaint.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.InputStream class java.io.InputStream}, containing all type
...
public abstract interface InputStreamClassTests<SUT extends java.io.InputStream>
extends CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.InputStream.class!",
                   java.io.InputStream.class.isAssignableFrom(sut));
    }

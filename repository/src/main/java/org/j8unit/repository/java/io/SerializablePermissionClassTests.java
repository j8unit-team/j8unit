...
public abstract interface SerializablePermissionClassTests<SUT extends SerializablePermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SerializablePermission.class!",
                   SerializablePermission.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SerializablePermissionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SerializablePermissionTests}.
 * </p>
 *
 * @see java.io.SerializablePermission class java.io.SerializablePermission (the hereby targeted class-under-test class)
 * @see SerializablePermissionTests SerializablePermissionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.SerializablePermission.class!",
                   java.io.SerializablePermission.class.isAssignableFrom(sut));
    }

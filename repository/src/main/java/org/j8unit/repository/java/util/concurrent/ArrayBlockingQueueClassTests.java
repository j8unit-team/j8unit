 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ArrayBlockingQueue
...
public abstract interface ArrayBlockingQueueClassTests<SUT extends ArrayBlockingQueue>
extends BlockingQueueClassTests<SUT>, SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ArrayBlockingQueue.class!",
                   ArrayBlockingQueue.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.concurrent.ArrayBlockingQueue]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.util.concurrent.ArrayBlockingQueue]

 ...
 * java.util.concurrent.ArrayBlockingQueue}, containing all class relevant test methods (at least the test methods of
 * accessible constructors and of accessible {@code static} methods). The counterpart J8Unit test interface containing
 * the instance relevant test methods is {@link org.j8unit.repository.java.util.concurrent.ArrayBlockingQueueTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ArrayBlockingQueue#ArrayBlockingQueue(int)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ArrayBlockingQueue#ArrayBlockingQueue(int, boolean)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ArrayBlockingQueue_int_boolean()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * java.util.concurrent.ArrayBlockingQueue(int,boolean,java.util.Collection)}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ArrayBlockingQueue#ArrayBlockingQueue(int, boolean, java.util.Collection)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ArrayBlockingQueue_int_boolean_Collection()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.concurrent.ArrayBlockingQueue<?> sut = null; // = new ArrayBlockingQueue(int, boolean,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.concurrent.ArrayBlockingQueue#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

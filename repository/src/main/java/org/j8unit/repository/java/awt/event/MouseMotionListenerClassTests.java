...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.MouseMotionListener interface
 * java.awt.event.MouseMotionListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseMotionListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseMotionListenerTests}.
 * </p>
 *
 * @see java.awt.event.MouseMotionListener interface java.awt.event.MouseMotionListener (the hereby targeted
 *      class-under-test class)
 * @see MouseMotionListenerTests MouseMotionListenerTests (The complementary j8unit test interface containing the
...
public abstract interface MouseMotionListenerClassTests<SUT extends java.awt.event.MouseMotionListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.MouseMotionListener.class!",
                   java.awt.event.MouseMotionListener.class.isAssignableFrom(sut));
    }

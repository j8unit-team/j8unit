 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseMotionListener
...
public abstract interface MouseMotionListenerClassTests<SUT extends MouseMotionListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseMotionListener.class!",
                   MouseMotionListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToDoubleBiFunction
 * public abstract interface java.util.function.ToDoubleBiFunction<T,U>}.
 *
...
public abstract interface ToDoubleBiFunctionClassTests<SUT extends ToDoubleBiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToDoubleBiFunction.class!",
                   ToDoubleBiFunction.class.isAssignableFrom(sut));
    }

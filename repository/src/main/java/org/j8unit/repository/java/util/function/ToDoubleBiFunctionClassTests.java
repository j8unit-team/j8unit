...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.ToDoubleBiFunction interface
 * java.util.function.ToDoubleBiFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToDoubleBiFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToDoubleBiFunctionTests}.
 * </p>
 *
 * @see java.util.function.ToDoubleBiFunction interface java.util.function.ToDoubleBiFunction (the hereby targeted
 *      class-under-test class)
 * @see ToDoubleBiFunctionTests ToDoubleBiFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ToDoubleBiFunctionClassTests<SUT extends java.util.function.ToDoubleBiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ToDoubleBiFunction.class!",
                   java.util.function.ToDoubleBiFunction.class.isAssignableFrom(sut));
    }

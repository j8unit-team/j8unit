 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractCollectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractCollectionTests}.
 * </p>
 *
 * @see java.util.AbstractCollection class java.util.AbstractCollection (the hereby targeted class-under-test class)
 * @see AbstractCollectionTests AbstractCollectionTests (The complementary j8unit test interface containing the instance
...
extends CollectionClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractCollection.class!",
                   java.util.AbstractCollection.class.isAssignableFrom(sut));
    }

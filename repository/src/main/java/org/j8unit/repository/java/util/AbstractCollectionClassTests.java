 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractCollection
...
public abstract interface AbstractCollectionClassTests<SUT extends AbstractCollection>
extends CollectionClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractCollection.class!",
                   AbstractCollection.class.isAssignableFrom(sut));
    }

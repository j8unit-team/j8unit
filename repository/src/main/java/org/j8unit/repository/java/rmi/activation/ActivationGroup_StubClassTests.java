 ...
 * java.rmi.activation.ActivationGroup_Stub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationGroup_StubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActivationGroup_StubTests}
 * .
 * </p>
 *
 * @see java.rmi.activation.ActivationGroup_Stub class java.rmi.activation.ActivationGroup_Stub (the hereby targeted
 *      class-under-test class)
 * @see ActivationGroup_StubTests ActivationGroup_StubTests (The complementary j8unit test interface containing the
...
public abstract interface ActivationGroup_StubClassTests<SUT extends java.rmi.activation.ActivationGroup_Stub>
extends ActivationInstantiatorClassTests<SUT>, org.j8unit.repository.java.rmi.RemoteClassTests<SUT>,
org.j8unit.repository.java.rmi.server.RemoteStubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationGroup_Stub.class!",
                   java.rmi.activation.ActivationGroup_Stub.class.isAssignableFrom(sut));
    }

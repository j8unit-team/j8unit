 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTargetDropEvent
...
public abstract interface DropTargetDropEventClassTests<SUT extends DropTargetDropEvent>
extends DropTargetEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetDropEvent.class!",
                   DropTargetDropEvent.class.isAssignableFrom(sut));
    }

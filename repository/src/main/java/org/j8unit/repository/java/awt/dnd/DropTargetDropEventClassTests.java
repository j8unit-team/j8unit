...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.dnd.DropTargetDropEvent class
 * java.awt.dnd.DropTargetDropEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DropTargetDropEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DropTargetDropEventTests}.
 * </p>
 *
 * @see java.awt.dnd.DropTargetDropEvent class java.awt.dnd.DropTargetDropEvent (the hereby targeted class-under-test
 *      class)
 * @see DropTargetDropEventTests DropTargetDropEventTests (The complementary j8unit test interface containing the
...
public abstract interface DropTargetDropEventClassTests<SUT extends java.awt.dnd.DropTargetDropEvent>
extends DropTargetEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DropTargetDropEvent.class!",
                   java.awt.dnd.DropTargetDropEvent.class.isAssignableFrom(sut));
    }

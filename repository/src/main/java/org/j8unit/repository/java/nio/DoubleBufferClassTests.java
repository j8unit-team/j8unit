 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleBufferTests}.
 * </p>
 *
 * @see java.nio.DoubleBuffer class java.nio.DoubleBuffer (the hereby targeted class-under-test class)
 * @see DoubleBufferTests DoubleBufferTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.DoubleBuffer.class!",
                   java.nio.DoubleBuffer.class.isAssignableFrom(sut));
    }

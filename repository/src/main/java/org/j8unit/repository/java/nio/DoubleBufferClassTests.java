 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleBuffer public
 * abstract class java.nio.DoubleBuffer}.
 *
...
public abstract interface DoubleBufferClassTests<SUT extends DoubleBuffer>
extends ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleBuffer.class!",
                   DoubleBuffer.class.isAssignableFrom(sut));
    }

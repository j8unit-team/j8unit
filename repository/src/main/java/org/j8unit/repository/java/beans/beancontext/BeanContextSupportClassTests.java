 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanContextSupport
...
extends BeanContextClassTests<SUT>, PropertyChangeListenerClassTests<SUT>, VetoableChangeListenerClassTests<SUT>, BeanContextChildSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextSupport.class!",

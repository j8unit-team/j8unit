 ...
 * java.beans.beancontext.BeanContextSupport}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanContextSupportTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextSupportTests BeanContextSupportTests (The complementary j8unit test interface containing the instance
...
extends BeanContextClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
...
BeanContextChildSupportClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextSupport.class!",
                   java.beans.beancontext.BeanContextSupport.class.isAssignableFrom(sut));
    }

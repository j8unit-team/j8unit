...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.WatchKey interface java.nio.file.WatchKey}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WatchKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WatchKeyTests}.
 * </p>
 *
 * @see java.nio.file.WatchKey interface java.nio.file.WatchKey (the hereby targeted class-under-test class)
 * @see WatchKeyTests WatchKeyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WatchKeyClassTests<SUT extends java.nio.file.WatchKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.WatchKey.class!",
                   java.nio.file.WatchKey.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SyncFailedException
...
public abstract interface SyncFailedExceptionClassTests<SUT extends SyncFailedException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SyncFailedException.class!",
                   SyncFailedException.class.isAssignableFrom(sut));
    }

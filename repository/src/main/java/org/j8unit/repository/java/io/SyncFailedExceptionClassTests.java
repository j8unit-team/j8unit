 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SyncFailedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SyncFailedExceptionTests}.
 * </p>
 *
 * @see java.io.SyncFailedException class java.io.SyncFailedException (the hereby targeted class-under-test class)
 * @see SyncFailedExceptionTests SyncFailedExceptionTests (The complementary j8unit test interface containing the
...
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.SyncFailedException.class!",
                   java.io.SyncFailedException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleFileVisitor
 * public class java.nio.file.SimpleFileVisitor<T>}.
 *
...
public abstract interface SimpleFileVisitorClassTests<SUT extends SimpleFileVisitor>
extends FileVisitorClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleFileVisitor.class!",

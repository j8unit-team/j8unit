 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleFileVisitorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleFileVisitorTests}.
 * </p>
 *
 * @see java.nio.file.SimpleFileVisitor class java.nio.file.SimpleFileVisitor (the hereby targeted class-under-test
 *      class)
 * @see SimpleFileVisitorTests SimpleFileVisitorTests (The complementary j8unit test interface containing the instance
...
extends FileVisitorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.SimpleFileVisitor.class!",
                   java.nio.file.SimpleFileVisitor.class.isAssignableFrom(sut));
    }

...
extends InvocationHandlerClassTests<SUT>, RemoteObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemoteObjectInvocationHandler.class!",
                   RemoteObjectInvocationHandler.class.isAssignableFrom(sut));
    }

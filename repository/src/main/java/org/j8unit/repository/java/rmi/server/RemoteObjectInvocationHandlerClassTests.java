 ...
 * java.rmi.server.RemoteObjectInvocationHandler}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see RemoteObjectInvocationHandlerTests RemoteObjectInvocationHandlerTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.reflect.InvocationHandlerClassTests<SUT>, RemoteObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RemoteObjectInvocationHandler.class!",
                   java.rmi.server.RemoteObjectInvocationHandler.class.isAssignableFrom(sut));
    }

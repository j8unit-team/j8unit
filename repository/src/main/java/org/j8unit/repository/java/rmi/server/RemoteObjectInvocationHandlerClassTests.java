 ...
 * java.rmi.server.RemoteObjectInvocationHandler}, containing all class relevant test methods (at least the test methods
...
extends org.j8unit.repository.java.lang.reflect.InvocationHandlerClassTests<SUT>, org.j8unit.repository.java.rmi.server.RemoteObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteObjectInvocationHandler#RemoteObjectInvocationHandler(java.rmi.server.
     *             RemoteRef)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_RemoteObjectInvocationHandler_RemoteRef()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.rmi.server.RemoteObjectInvocationHandler sut = null; // = new
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.rmi.server.RemoteObjectInvocationHandler#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

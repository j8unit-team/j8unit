 ...
 * java.nio.file.attribute.FileStoreAttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileStoreAttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 * {@link FileStoreAttributeViewTests}.
 * </p>
 *
 * @see java.nio.file.attribute.FileStoreAttributeView interface java.nio.file.attribute.FileStoreAttributeView (the
 *      hereby targeted class-under-test class)
 * @see FileStoreAttributeViewTests FileStoreAttributeViewTests (The complementary j8unit test interface containing the
...
public abstract interface FileStoreAttributeViewClassTests<SUT extends java.nio.file.attribute.FileStoreAttributeView>
extends AttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.FileStoreAttributeView.class!",
                   java.nio.file.attribute.FileStoreAttributeView.class.isAssignableFrom(sut));
    }

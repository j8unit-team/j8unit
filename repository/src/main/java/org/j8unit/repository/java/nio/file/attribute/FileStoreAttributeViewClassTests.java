...
public abstract interface FileStoreAttributeViewClassTests<SUT extends FileStoreAttributeView>
extends org.j8unit.repository.java.nio.file.attribute.AttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileStoreAttributeView.class!",

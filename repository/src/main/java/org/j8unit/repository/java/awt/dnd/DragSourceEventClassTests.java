 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragSourceEvent
...
public abstract interface DragSourceEventClassTests<SUT extends DragSourceEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSourceEvent.class!",
                   DragSourceEvent.class.isAssignableFrom(sut));
    }

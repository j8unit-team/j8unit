 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragSourceEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DragSourceEventTests}.
 * </p>
 *
 * @see java.awt.dnd.DragSourceEvent class java.awt.dnd.DragSourceEvent (the hereby targeted class-under-test class)
 * @see DragSourceEventTests DragSourceEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragSourceEvent.class!",
                   java.awt.dnd.DragSourceEvent.class.isAssignableFrom(sut));
    }

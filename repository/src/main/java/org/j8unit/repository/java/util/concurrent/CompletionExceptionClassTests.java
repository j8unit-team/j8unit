 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompletionException
...
public abstract interface CompletionExceptionClassTests<SUT extends CompletionException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompletionException.class!",
                   CompletionException.class.isAssignableFrom(sut));
    }

 ...
 * java.util.concurrent.CompletionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompletionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompletionExceptionTests}.
 * </p>
 *
 * @see java.util.concurrent.CompletionException class java.util.concurrent.CompletionException (the hereby targeted
 *      class-under-test class)
 * @see CompletionExceptionTests CompletionExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CompletionException.class!",
                   java.util.concurrent.CompletionException.class.isAssignableFrom(sut));
    }

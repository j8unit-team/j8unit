 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECFieldFp public
...
public abstract interface ECFieldFpClassTests<SUT extends ECFieldFp>
extends ECFieldClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECFieldFp.class!",
                   ECFieldFp.class.isAssignableFrom(sut));
    }

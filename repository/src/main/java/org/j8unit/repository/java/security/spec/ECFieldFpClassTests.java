...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.spec.ECFieldFp class java.security.spec.ECFieldFp},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECFieldFpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECFieldFpTests}.
 * </p>
 *
 * @see java.security.spec.ECFieldFp class java.security.spec.ECFieldFp (the hereby targeted class-under-test class)
 * @see ECFieldFpTests ECFieldFpTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ECFieldFpClassTests<SUT extends java.security.spec.ECFieldFp>
extends ECFieldClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECFieldFp.class!",
                   java.security.spec.ECFieldFp.class.isAssignableFrom(sut));
    }

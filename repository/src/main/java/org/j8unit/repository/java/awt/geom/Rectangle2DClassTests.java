...
extends org.j8unit.repository.java.awt.geom.RectangularShapeClassTests<SUT> {
     ...
     * java.awt.geom.Rectangle2D$Double}, containing all class relevant test methods (at least the test methods of
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.Rectangle2DClassTests<SUT> {
         ...
         * </p>
         *
         * @j8unit.aim java.awt.geom.Rectangle2D.Double#Double()
         */
        ...
        throws Exception {
            ...
            final java.awt.geom.Rectangle2D.Double sut = null; // = new Double();
        }

        /**
         * <p>
         * Test method for {@link java.awt.geom.Rectangle2D.Double#Double(double, double, double, double) public
         ...
         * </p>
         *
         * @j8unit.aim java.awt.geom.Rectangle2D.Double#Double(double, double, double, double)
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
        ...
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            final java.awt.geom.Rectangle2D.Double sut = null; // = new Double(double, double, double, double);
        }

        /**
         * @since 0.9.2
         *
         * @j8unit.aim java.awt.geom.Rectangle2D.Double#isAssignableFrom(java.lang.Class)
         */
        @Override
        @Test
     ...
     * java.awt.geom.Rectangle2D$Float}, containing all class relevant test methods (at least the test methods of
     * accessible constructors and of accessible {@code static} methods). The counterpart J8Unit test interface
     * containing the instance relevant test methods is
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.Rectangle2DClassTests<SUT> {
         ...
         * </p>
         *
         * @j8unit.aim java.awt.geom.Rectangle2D.Float#Float()
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
        ...
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            final java.awt.geom.Rectangle2D.Float sut = null; // = new Float();
        }

        /**
         * <p>
         * Test method for {@link java.awt.geom.Rectangle2D.Float#Float(float, float, float, float) public
         ...
         * </p>
         *
         * @j8unit.aim java.awt.geom.Rectangle2D.Float#Float(float, float, float, float)
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
        ...
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            final java.awt.geom.Rectangle2D.Float sut = null; // = new Float(float, float, float, float);
        }

        /**
         * @since 0.9.2
         *
         * @j8unit.aim java.awt.geom.Rectangle2D.Float#isAssignableFrom(java.lang.Class)
         */
        @Override
        @Test
        public default void testBaseTypeIsAssignableFromCurrentType()
     ...
     * </p>
     *
     * @j8unit.aim java.awt.geom.Rectangle2D#intersect(java.awt.geom.Rectangle2D, java.awt.geom.Rectangle2D,
     ...
     * </p>
     *
     * @j8unit.aim java.awt.geom.Rectangle2D#union(java.awt.geom.Rectangle2D, java.awt.geom.Rectangle2D,
     *             java.awt.geom.Rectangle2D)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.awt.geom.Rectangle2D#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test
    public default void testBaseTypeIsAssignableFromCurrentType()

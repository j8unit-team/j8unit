 ...
 * java.util.concurrent.RecursiveAction}, containing all class relevant test methods (at least the test methods of
 * accessible constructors and of accessible {@code static} methods). The counterpart J8Unit test interface containing
 * the instance relevant test methods is {@link org.j8unit.repository.java.util.concurrent.RecursiveActionTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.util.concurrent.ForkJoinTaskClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.RecursiveAction#RecursiveAction()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_RecursiveAction()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.concurrent.RecursiveAction sut = null; // = new RecursiveAction();
    }

    /**
     * @since 0.9.2
     *
     * @j8unit.aim java.util.concurrent.RecursiveAction#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

 ...
 * java.util.concurrent.RecursiveAction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RecursiveActionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RecursiveActionTests}.
 * </p>
 *
 * @see java.util.concurrent.RecursiveAction class java.util.concurrent.RecursiveAction (the hereby targeted
 *      class-under-test class)
 * @see RecursiveActionTests RecursiveActionTests (The complementary j8unit test interface containing the instance
...
extends ForkJoinTaskClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.RecursiveAction.class!",
                   java.util.concurrent.RecursiveAction.class.isAssignableFrom(sut));
    }

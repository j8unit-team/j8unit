 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RecursiveAction
...
public abstract interface RecursiveActionClassTests<SUT extends RecursiveAction>
extends ForkJoinTaskClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RecursiveAction.class!",
                   RecursiveAction.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BiFunction public
 * abstract interface java.util.function.BiFunction<T,U,R>}.
 *
...
public abstract interface BiFunctionClassTests<SUT extends BiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BiFunction.class!",
                   BiFunction.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BiFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BiFunctionTests}.
 * </p>
 *
 * @see java.util.function.BiFunction interface java.util.function.BiFunction (the hereby targeted class-under-test
 *      class)
 * @see BiFunctionTests BiFunctionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BiFunctionClassTests<SUT extends java.util.function.BiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.BiFunction.class!",
                   java.util.function.BiFunction.class.isAssignableFrom(sut));
    }

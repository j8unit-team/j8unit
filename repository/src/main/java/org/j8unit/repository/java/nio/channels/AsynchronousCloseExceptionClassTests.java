 ...
 * {@link AsynchronousCloseException public class java.nio.channels.AsynchronousCloseException}.
 *
...
extends ClosedChannelExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsynchronousCloseException.class!",
                   AsynchronousCloseException.class.isAssignableFrom(sut));
    }

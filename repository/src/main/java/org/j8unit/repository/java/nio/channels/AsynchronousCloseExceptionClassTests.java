 ...
 * java.nio.channels.AsynchronousCloseException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * </p>
 *
 * @see java.nio.channels.AsynchronousCloseException class java.nio.channels.AsynchronousCloseException (the hereby
 *      targeted class-under-test class)
 * @see AsynchronousCloseExceptionTests AsynchronousCloseExceptionTests (The complementary j8unit test interface
...
extends ClosedChannelExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AsynchronousCloseException.class!",
                   java.nio.channels.AsynchronousCloseException.class.isAssignableFrom(sut));
    }

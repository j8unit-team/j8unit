 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AuthProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AuthProviderTests}.
 * </p>
 *
 * @see java.security.AuthProvider class java.security.AuthProvider (the hereby targeted class-under-test class)
 * @see AuthProviderTests AuthProviderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AuthProviderClassTests<SUT extends java.security.AuthProvider>
extends ProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.AuthProvider.class!",
                   java.security.AuthProvider.class.isAssignableFrom(sut));
    }

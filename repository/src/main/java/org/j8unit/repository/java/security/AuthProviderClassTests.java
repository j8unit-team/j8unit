 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AuthProvider public
 * abstract class java.security.AuthProvider}.
 *
...
public abstract interface AuthProviderClassTests<SUT extends AuthProvider>
extends ProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AuthProvider.class!",

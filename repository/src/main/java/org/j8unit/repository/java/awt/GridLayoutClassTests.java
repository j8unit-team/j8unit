...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.GridLayout class java.awt.GridLayout}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GridLayoutTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GridLayoutTests}.
 * </p>
 *
 * @see java.awt.GridLayout class java.awt.GridLayout (the hereby targeted class-under-test class)
 * @see GridLayoutTests GridLayoutTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends LayoutManagerClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.GridLayout.class!",
                   java.awt.GridLayout.class.isAssignableFrom(sut));
    }

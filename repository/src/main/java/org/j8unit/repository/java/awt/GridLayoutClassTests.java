 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GridLayout public
...
public abstract interface GridLayoutClassTests<SUT extends GridLayout>
extends LayoutManagerClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GridLayout.class!",

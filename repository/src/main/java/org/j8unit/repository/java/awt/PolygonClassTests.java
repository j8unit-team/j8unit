 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Polygon public
...
public abstract interface PolygonClassTests<SUT extends Polygon>
extends ShapeClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Polygon]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Polygon.class!",
                   Polygon.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.Polygon]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.awt.Polygon]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrivilegedAction
 * public abstract interface java.security.PrivilegedAction<T>}.
 *
...
public abstract interface PrivilegedActionClassTests<SUT extends PrivilegedAction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrivilegedAction.class!",
                   PrivilegedAction.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.PrivilegedAction interface
 * java.security.PrivilegedAction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrivilegedActionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrivilegedActionTests}.
 * </p>
 *
 * @see java.security.PrivilegedAction interface java.security.PrivilegedAction (the hereby targeted class-under-test
 *      class)
 * @see PrivilegedActionTests PrivilegedActionTests (The complementary j8unit test interface containing the instance
...
public abstract interface PrivilegedActionClassTests<SUT extends java.security.PrivilegedAction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.PrivilegedAction.class!",
                   java.security.PrivilegedAction.class.isAssignableFrom(sut));
    }

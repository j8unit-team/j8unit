...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain java.time.MonthDay class java.time.MonthDay}, containing all class
 ...
 * </p>
 *
 * @see org.j8unit.repository.java.time.MonthDayTests
 *
 * @param SUT
...
public abstract interface MonthDayClassTests<SUT extends java.time.MonthDay>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#from(java.time.temporal.TemporalAccessor)
     */
    ...
    /**
     * <p>
     * Test method for {@link java.time.MonthDay#now() public static java.time.MonthDay java.time.MonthDay.now()}.
     *
     * Up to now, there is no real implementation of this test method. But with your help at
     * <a href="http://www.j8unit.org">http://www.j8unit.org</a> this marker method will be replaced by meaningful test
     * methods soon.
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#now()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    /**
     * <p>
     * Test method for {@link java.time.MonthDay#now(java.time.Clock) public static java.time.MonthDay
     ...
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#now(java.time.Clock)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#now(java.time.ZoneId)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#of(int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#of(java.time.Month, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    /**
     * <p>
     * Test method for {@link java.time.MonthDay#parse(java.lang.CharSequence) public static java.time.MonthDay
     ...
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#parse(java.lang.CharSequence)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    /**
     * <p>
     * Test method for {@link java.time.MonthDay#parse(java.lang.CharSequence, java.time.format.DateTimeFormatter)
     * public static java.time.MonthDay
     ...
     * </p>
     *
     * @j8unit.aim java.time.MonthDay#parse(java.lang.CharSequence, java.time.format.DateTimeFormatter)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.time.MonthDay#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

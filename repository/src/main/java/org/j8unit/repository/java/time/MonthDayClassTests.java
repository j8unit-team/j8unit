...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.MonthDay class java.time.MonthDay}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MonthDayTests}).
 * </p>
 *
 * <p>
 ...
 * @see MonthDayTests MonthDayTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.MonthDay.class!",
                   java.time.MonthDay.class.isAssignableFrom(sut));
    }

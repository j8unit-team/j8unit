 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLType public
 * abstract interface java.sql.SQLType}.
 *
...
public abstract interface SQLTypeClassTests<SUT extends SQLType>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLType.class!",

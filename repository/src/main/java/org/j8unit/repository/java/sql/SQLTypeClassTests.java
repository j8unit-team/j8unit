...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.SQLType interface java.sql.SQLType}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLTypeTests}.
 * </p>
 *
 * @see java.sql.SQLType interface java.sql.SQLType (the hereby targeted class-under-test class)
 * @see SQLTypeTests SQLTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SQLTypeClassTests<SUT extends java.sql.SQLType>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLType.class!",
                   java.sql.SQLType.class.isAssignableFrom(sut));
    }

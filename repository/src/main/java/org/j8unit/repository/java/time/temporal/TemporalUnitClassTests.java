 ...
 * java.time.temporal.TemporalUnit}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalUnitTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalUnitTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalUnit interface java.time.temporal.TemporalUnit (the hereby targeted class-under-test
 *      class)
 * @see TemporalUnitTests TemporalUnitTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TemporalUnitClassTests<SUT extends java.time.temporal.TemporalUnit>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalUnit.class!",
                   java.time.temporal.TemporalUnit.class.isAssignableFrom(sut));
    }

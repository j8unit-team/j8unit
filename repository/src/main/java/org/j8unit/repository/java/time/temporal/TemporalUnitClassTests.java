 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalUnit public
 * abstract interface java.time.temporal.TemporalUnit}.
 *
...
public abstract interface TemporalUnitClassTests<SUT extends TemporalUnit>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalUnit.class!",

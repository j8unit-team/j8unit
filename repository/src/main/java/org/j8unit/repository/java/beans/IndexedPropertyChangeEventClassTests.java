 ...
 * {@link IndexedPropertyChangeEvent public class java.beans.IndexedPropertyChangeEvent}.
 *
 ...
 * {@link IndexedPropertyChangeEventTests}.
 * </p>
 *
 * <p>
...
public abstract interface IndexedPropertyChangeEventClassTests<SUT extends IndexedPropertyChangeEvent>
extends PropertyChangeEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IndexedPropertyChangeEvent.class!",
                   IndexedPropertyChangeEvent.class.isAssignableFrom(sut));
    }

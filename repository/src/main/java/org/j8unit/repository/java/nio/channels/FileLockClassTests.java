...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.FileLock class java.nio.channels.FileLock},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileLockTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileLockTests}.
 * </p>
 *
 * @see java.nio.channels.FileLock class java.nio.channels.FileLock (the hereby targeted class-under-test class)
 * @see FileLockTests FileLockTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileLockClassTests<SUT extends java.nio.channels.FileLock>
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.FileLock.class!",
                   java.nio.channels.FileLock.class.isAssignableFrom(sut));
    }

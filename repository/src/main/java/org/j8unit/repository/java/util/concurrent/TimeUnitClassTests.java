 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimeUnitTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TimeUnitTests}.
 * </p>
 *
 * @see java.util.concurrent.TimeUnit class java.util.concurrent.TimeUnit (the hereby targeted class-under-test class)
 * @see TimeUnitTests TimeUnitTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TimeUnitClassTests<SUT extends java.util.concurrent.TimeUnit>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.TimeUnit.class!",
                   java.util.concurrent.TimeUnit.class.isAssignableFrom(sut));
    }

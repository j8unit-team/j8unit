 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TimeUnit public
 * abstract enum java.util.concurrent.TimeUnit}.
 *
...
public abstract interface TimeUnitClassTests<SUT extends TimeUnit>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimeUnit.class!",
                   TimeUnit.class.isAssignableFrom(sut));
    }

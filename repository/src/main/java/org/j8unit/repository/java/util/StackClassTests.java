 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Stack public class
 * java.util.Stack<E>}.
 *
...
public abstract interface StackClassTests<SUT extends Stack>
extends VectorClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.Stack]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Stack.class!", Stack.class.isAssignableFrom(sut));
    }

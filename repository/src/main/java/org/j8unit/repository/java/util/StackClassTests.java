...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Stack class java.util.Stack}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StackTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StackTests}.
 * </p>
 *
 * @see java.util.Stack class java.util.Stack (the hereby targeted class-under-test class)
 * @see StackTests StackTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends VectorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Stack.class!",
                   java.util.Stack.class.isAssignableFrom(sut));
    }

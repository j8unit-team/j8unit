 ...
 * java.security.cert.LDAPCertStoreParameters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LDAPCertStoreParametersTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link LDAPCertStoreParametersTests}.
 * </p>
 *
 * @see java.security.cert.LDAPCertStoreParameters class java.security.cert.LDAPCertStoreParameters (the hereby targeted
 *      class-under-test class)
 * @see LDAPCertStoreParametersTests LDAPCertStoreParametersTests (The complementary j8unit test interface containing
...
extends CertStoreParametersClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.LDAPCertStoreParameters.class!",
                   java.security.cert.LDAPCertStoreParameters.class.isAssignableFrom(sut));
    }

 ...
 * {@link LDAPCertStoreParameters public class java.security.cert.LDAPCertStoreParameters}.
 *
...
public abstract interface LDAPCertStoreParametersClassTests<SUT extends LDAPCertStoreParameters>
extends org.j8unit.repository.java.security.cert.CertStoreParametersClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LDAPCertStoreParameters.class!",
                   LDAPCertStoreParameters.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Naming public final
...
public abstract interface NamingClassTests<SUT extends Naming>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Naming.class!",
                   Naming.class.isAssignableFrom(sut));
    }

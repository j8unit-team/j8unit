...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.Naming class java.rmi.Naming}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingTests}.
 * </p>
 *
 * @see java.rmi.Naming class java.rmi.Naming (the hereby targeted class-under-test class)
 * @see NamingTests NamingTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface NamingClassTests<SUT extends java.rmi.Naming>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.Naming.class!",
                   java.rmi.Naming.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain StringIndexOutOfBoundsException class
 * java.lang.StringIndexOutOfBoundsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link StringIndexOutOfBoundsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see StringIndexOutOfBoundsExceptionTests StringIndexOutOfBoundsExceptionTests (The complementary j8unit test
...
public abstract interface StringIndexOutOfBoundsExceptionClassTests<SUT extends StringIndexOutOfBoundsException>
extends IndexOutOfBoundsExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringIndexOutOfBoundsException.class!",
                   StringIndexOutOfBoundsException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LabelPeer public
 * abstract interface java.awt.peer.LabelPeer}.
 *
...
public abstract interface LabelPeerClassTests<SUT extends LabelPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LabelPeer.class!",
                   LabelPeer.class.isAssignableFrom(sut));
    }

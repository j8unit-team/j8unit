...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.LabelPeer interface java.awt.peer.LabelPeer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LabelPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LabelPeerTests}.
 * </p>
 *
 * @see java.awt.peer.LabelPeer interface java.awt.peer.LabelPeer (the hereby targeted class-under-test class)
 * @see LabelPeerTests LabelPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LabelPeerClassTests<SUT extends java.awt.peer.LabelPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.LabelPeer.class!",
                   java.awt.peer.LabelPeer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.SeekableByteChannel interface
 * java.nio.channels.SeekableByteChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SeekableByteChannelTests}).
 * </p>
 *
 * <p>
 ...
 * @see SeekableByteChannelTests SeekableByteChannelTests (The complementary j8unit test interface containing the
...
public abstract interface SeekableByteChannelClassTests<SUT extends java.nio.channels.SeekableByteChannel>
extends ByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.SeekableByteChannel.class!",
                   java.nio.channels.SeekableByteChannel.class.isAssignableFrom(sut));
    }

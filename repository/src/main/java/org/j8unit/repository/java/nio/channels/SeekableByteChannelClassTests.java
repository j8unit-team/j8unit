 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SeekableByteChannel
 * public abstract interface java.nio.channels.SeekableByteChannel}.
 *
...
extends ByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SeekableByteChannel.class!",
                   SeekableByteChannel.class.isAssignableFrom(sut));
    }

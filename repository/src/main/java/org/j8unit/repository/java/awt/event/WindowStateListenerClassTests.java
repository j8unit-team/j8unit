...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.WindowStateListener interface
 * java.awt.event.WindowStateListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WindowStateListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WindowStateListenerTests}.
 * </p>
 *
 * @see java.awt.event.WindowStateListener interface java.awt.event.WindowStateListener (the hereby targeted
 *      class-under-test class)
 * @see WindowStateListenerTests WindowStateListenerTests (The complementary j8unit test interface containing the
...
public abstract interface WindowStateListenerClassTests<SUT extends java.awt.event.WindowStateListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.WindowStateListener.class!",
                   java.awt.event.WindowStateListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WindowStateListener
 * public abstract interface java.awt.event.WindowStateListener}.
 *
...
public abstract interface WindowStateListenerClassTests<SUT extends WindowStateListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WindowStateListener.class!",
                   WindowStateListener.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMISecurityExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMISecurityExceptionTests}
 * .
 * </p>
 *
 * @see java.rmi.RMISecurityException class java.rmi.RMISecurityException (the hereby targeted class-under-test class)
 * @see RMISecurityExceptionTests RMISecurityExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.SecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.RMISecurityException.class!",
                   java.rmi.RMISecurityException.class.isAssignableFrom(sut));
    }

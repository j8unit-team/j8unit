 ...
 * {@link RMISecurityException public class java.rmi.RMISecurityException}.
 *
...
extends SecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMISecurityException.class!",
                   RMISecurityException.class.isAssignableFrom(sut));
    }

 ...
 * @since 0.9.0
 * @see org.j8unit.repository.java.text.BidiClassTests
 */
...
extends org.j8unit.repository.java.lang.ObjectTests<SUT>
{
    ...
    public default void test_getLevelAt_int() throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_isLeftToRight() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    /**
     * <p>
     * Test method for {@link java.text.Bidi#createLineBidi(int,int) public java.text.Bidi java.text.Bidi.createLineBidi(int,int)}.
     * </p>
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void test_createLineBidi_int_int() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_getRunStart_int() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_getRunLevel_int() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_baseIsLeftToRight() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_isRightToLeft() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_getRunLimit_int() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_getRunCount() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_getBaseLevel() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_isMixed() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }

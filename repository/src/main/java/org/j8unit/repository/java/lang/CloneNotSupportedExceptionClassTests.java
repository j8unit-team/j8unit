...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain CloneNotSupportedException class java.lang.CloneNotSupportedException}
 ...
 * {@link CloneNotSupportedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see CloneNotSupportedExceptionTests CloneNotSupportedExceptionTests (The complementary j8unit test interface
...
public abstract interface CloneNotSupportedExceptionClassTests<SUT extends CloneNotSupportedException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CloneNotSupportedException.class!",
                   CloneNotSupportedException.class.isAssignableFrom(sut));
    }

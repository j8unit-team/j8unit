 ...
 * java.rmi.server.RMIFailureHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIFailureHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMIFailureHandlerTests}.
 * </p>
 *
 * @see java.rmi.server.RMIFailureHandler interface java.rmi.server.RMIFailureHandler (the hereby targeted
 *      class-under-test class)
 * @see RMIFailureHandlerTests RMIFailureHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface RMIFailureHandlerClassTests<SUT extends java.rmi.server.RMIFailureHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RMIFailureHandler.class!",
                   java.rmi.server.RMIFailureHandler.class.isAssignableFrom(sut));
    }

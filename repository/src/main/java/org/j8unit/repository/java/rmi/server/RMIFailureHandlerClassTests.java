 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMIFailureHandler
 * public abstract interface java.rmi.server.RMIFailureHandler}.
 *
...
public abstract interface RMIFailureHandlerClassTests<SUT extends RMIFailureHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIFailureHandler.class!",
                   RMIFailureHandler.class.isAssignableFrom(sut));
    }

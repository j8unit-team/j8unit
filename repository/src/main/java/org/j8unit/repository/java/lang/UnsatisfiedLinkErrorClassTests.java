...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain UnsatisfiedLinkError class java.lang.UnsatisfiedLinkError}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnsatisfiedLinkErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnsatisfiedLinkErrorTests}
 * .
 * </p>
 *
 * @see UnsatisfiedLinkError class java.lang.UnsatisfiedLinkError (the hereby targeted class-under-test class)
 * @see UnsatisfiedLinkErrorTests UnsatisfiedLinkErrorTests (The complementary j8unit test interface containing the
...
public abstract interface UnsatisfiedLinkErrorClassTests<SUT extends UnsatisfiedLinkError>
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsatisfiedLinkError.class!",
                   UnsatisfiedLinkError.class.isAssignableFrom(sut));
    }

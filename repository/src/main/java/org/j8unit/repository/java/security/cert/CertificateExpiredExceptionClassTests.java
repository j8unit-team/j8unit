 ...
 * java.security.cert.CertificateExpiredException}, containing all type relevant aspects (e.&thinsp;g., runtime
...
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateExpiredException.class!",
                   java.security.cert.CertificateExpiredException.class.isAssignableFrom(sut));
    }

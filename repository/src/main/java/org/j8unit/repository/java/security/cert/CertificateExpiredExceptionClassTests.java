...
public abstract interface CertificateExpiredExceptionClassTests<SUT extends CertificateExpiredException>
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertificateExpiredException.class!",

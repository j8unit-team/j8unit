 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollectorsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CollectorsTests}.
 * </p>
 *
 * @see java.util.stream.Collectors class java.util.stream.Collectors (the hereby targeted class-under-test class)
 * @see CollectorsTests CollectorsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CollectorsClassTests<SUT extends java.util.stream.Collectors>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.Collectors.class!",
                   java.util.stream.Collectors.class.isAssignableFrom(sut));
    }

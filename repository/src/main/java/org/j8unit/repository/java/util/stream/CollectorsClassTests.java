 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Collectors public
...
public abstract interface CollectorsClassTests<SUT extends Collectors>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Collectors.class!",
                   Collectors.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.stream.Collectors]

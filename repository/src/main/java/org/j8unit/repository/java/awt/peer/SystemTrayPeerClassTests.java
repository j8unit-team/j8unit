...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.SystemTrayPeer interface java.awt.peer.SystemTrayPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SystemTrayPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SystemTrayPeerTests}.
 * </p>
 *
 * @see java.awt.peer.SystemTrayPeer interface java.awt.peer.SystemTrayPeer (the hereby targeted class-under-test class)
 * @see SystemTrayPeerTests SystemTrayPeerTests (The complementary j8unit test interface containing the instance
...
public abstract interface SystemTrayPeerClassTests<SUT extends java.awt.peer.SystemTrayPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.SystemTrayPeer.class!",
                   java.awt.peer.SystemTrayPeer.class.isAssignableFrom(sut));
    }

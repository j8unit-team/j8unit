 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SystemTrayPeer
 * public abstract interface java.awt.peer.SystemTrayPeer}.
 *
...
public abstract interface SystemTrayPeerClassTests<SUT extends SystemTrayPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SystemTrayPeer.class!",

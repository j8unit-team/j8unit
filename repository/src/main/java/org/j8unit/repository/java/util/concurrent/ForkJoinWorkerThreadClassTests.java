...
extends org.j8unit.repository.java.lang.ThreadClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ForkJoinWorkerThread.class!",
                   ForkJoinWorkerThread.class.isAssignableFrom(sut));
    }

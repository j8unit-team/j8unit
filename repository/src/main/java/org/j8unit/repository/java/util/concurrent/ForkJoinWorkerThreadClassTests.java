...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.ForkJoinWorkerThread class
 * java.util.concurrent.ForkJoinWorkerThread}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ForkJoinWorkerThreadTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ForkJoinWorkerThreadTests}
 * .
 * </p>
 *
 * @see java.util.concurrent.ForkJoinWorkerThread class java.util.concurrent.ForkJoinWorkerThread (the hereby targeted
 *      class-under-test class)
 * @see ForkJoinWorkerThreadTests ForkJoinWorkerThreadTests (The complementary j8unit test interface containing the
...
public abstract interface ForkJoinWorkerThreadClassTests<SUT extends java.util.concurrent.ForkJoinWorkerThread>
extends org.j8unit.repository.java.lang.ThreadClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ForkJoinWorkerThread.class!",
                   java.util.concurrent.ForkJoinWorkerThread.class.isAssignableFrom(sut));
    }

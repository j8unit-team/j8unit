 ...
 * java.awt.dnd.peer.DropTargetPeer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DropTargetPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DropTargetPeerTests}.
 * </p>
 *
 * @see java.awt.dnd.peer.DropTargetPeer interface java.awt.dnd.peer.DropTargetPeer (the hereby targeted
 *      class-under-test class)
 * @see DropTargetPeerTests DropTargetPeerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DropTargetPeerClassTests<SUT extends java.awt.dnd.peer.DropTargetPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.peer.DropTargetPeer.class!",
                   java.awt.dnd.peer.DropTargetPeer.class.isAssignableFrom(sut));
    }

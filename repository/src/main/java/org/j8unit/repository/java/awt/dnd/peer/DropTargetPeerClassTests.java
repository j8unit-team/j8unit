 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTargetPeer
 * public abstract interface java.awt.dnd.peer.DropTargetPeer}.
 *
...
public abstract interface DropTargetPeerClassTests<SUT extends DropTargetPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetPeer.class!",
                   DropTargetPeer.class.isAssignableFrom(sut));
    }

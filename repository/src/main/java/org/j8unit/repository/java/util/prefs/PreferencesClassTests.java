 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Preferences public
...
public abstract interface PreferencesClassTests<SUT extends Preferences>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Preferences.class!",
                   Preferences.class.isAssignableFrom(sut));
    }

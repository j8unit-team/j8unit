 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PreferencesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PreferencesTests}.
 * </p>
 *
 * @see java.util.prefs.Preferences class java.util.prefs.Preferences (the hereby targeted class-under-test class)
 * @see PreferencesTests PreferencesTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.Preferences.class!",
                   java.util.prefs.Preferences.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MulticastChannel
 * public abstract interface java.nio.channels.MulticastChannel}.
 *
...
public abstract interface MulticastChannelClassTests<SUT extends MulticastChannel>
extends NetworkChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MulticastChannel.class!",
                   MulticastChannel.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.MulticastChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MulticastChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MulticastChannelTests}.
 * </p>
 *
 * @see java.nio.channels.MulticastChannel interface java.nio.channels.MulticastChannel (the hereby targeted
 *      class-under-test class)
 * @see MulticastChannelTests MulticastChannelTests (The complementary j8unit test interface containing the instance
...
public abstract interface MulticastChannelClassTests<SUT extends java.nio.channels.MulticastChannel>
extends NetworkChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.MulticastChannel.class!",
                   java.nio.channels.MulticastChannel.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.UncheckedIOException class java.io.UncheckedIOException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UncheckedIOExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UncheckedIOExceptionTests}
 * .
 * </p>
 *
 * @see java.io.UncheckedIOException class java.io.UncheckedIOException (the hereby targeted class-under-test class)
 * @see UncheckedIOExceptionTests UncheckedIOExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface UncheckedIOExceptionClassTests<SUT extends java.io.UncheckedIOException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.UncheckedIOException.class!",
                   java.io.UncheckedIOException.class.isAssignableFrom(sut));
    }

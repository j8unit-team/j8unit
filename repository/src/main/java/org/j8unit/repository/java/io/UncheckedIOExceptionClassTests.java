 ...
 * {@link UncheckedIOException public class java.io.UncheckedIOException}.
 *
...
public abstract interface UncheckedIOExceptionClassTests<SUT extends UncheckedIOException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UncheckedIOException.class!",
                   UncheckedIOException.class.isAssignableFrom(sut));
    }

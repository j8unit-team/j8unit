 ...
 * java.awt.datatransfer.FlavorTable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlavorTableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FlavorTableTests}.
 * </p>
 *
 * @see java.awt.datatransfer.FlavorTable interface java.awt.datatransfer.FlavorTable (the hereby targeted
 *      class-under-test class)
 * @see FlavorTableTests FlavorTableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FlavorTableClassTests<SUT extends java.awt.datatransfer.FlavorTable>
extends FlavorMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.FlavorTable.class!",
                   java.awt.datatransfer.FlavorTable.class.isAssignableFrom(sut));
    }

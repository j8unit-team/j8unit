 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FlavorTable public
 * abstract interface java.awt.datatransfer.FlavorTable}.
 *
...
public abstract interface FlavorTableClassTests<SUT extends FlavorTable>
extends FlavorMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FlavorTable.class!",
                   FlavorTable.class.isAssignableFrom(sut));
    }

 ...
 * java.lang.instrument.ClassFileTransformer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassFileTransformerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClassFileTransformerTests}
 * .
 * </p>
 *
 * @see java.lang.instrument.ClassFileTransformer interface java.lang.instrument.ClassFileTransformer (the hereby
 *      targeted class-under-test class)
 * @see ClassFileTransformerTests ClassFileTransformerTests (The complementary j8unit test interface containing the
...
public abstract interface ClassFileTransformerClassTests<SUT extends java.lang.instrument.ClassFileTransformer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.instrument.ClassFileTransformer.class!",
                   java.lang.instrument.ClassFileTransformer.class.isAssignableFrom(sut));
    }

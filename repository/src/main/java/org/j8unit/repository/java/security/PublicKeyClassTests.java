 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PublicKeyTests}).
 * </p>
 *
 * <p>
 ...
 * @see PublicKeyTests PublicKeyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PublicKeyClassTests<SUT extends java.security.PublicKey>
extends KeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.PublicKey.class!",
                   java.security.PublicKey.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PublicKey public
 * abstract interface java.security.PublicKey}.
 *
...
extends org.j8unit.repository.java.security.KeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PublicKey.class!",
                   PublicKey.class.isAssignableFrom(sut));
    }

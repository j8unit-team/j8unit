 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MinguoEra public
 * final enum java.time.chrono.MinguoEra}.
 *
...
public abstract interface MinguoEraClassTests<SUT extends MinguoEra>
extends EraClassTests<SUT>, EnumClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.MinguoEra]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MinguoEra.class!",
                   MinguoEra.class.isAssignableFrom(sut));
    }

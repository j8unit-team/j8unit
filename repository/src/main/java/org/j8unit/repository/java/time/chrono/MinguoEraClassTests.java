 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MinguoEraTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MinguoEraTests}.
 * </p>
 *
 * @see java.time.chrono.MinguoEra class java.time.chrono.MinguoEra (the hereby targeted class-under-test class)
 * @see MinguoEraTests MinguoEraTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends EraClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.MinguoEra.class!",
                   java.time.chrono.MinguoEra.class.isAssignableFrom(sut));
    }

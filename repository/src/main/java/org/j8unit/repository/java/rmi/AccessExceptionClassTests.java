 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessException
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessException.class!",

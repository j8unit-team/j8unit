 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see AccessExceptionTests AccessExceptionTests (The complementary j8unit test interface containing the instance
...
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.AccessException.class!",
                   java.rmi.AccessException.class.isAssignableFrom(sut));
    }

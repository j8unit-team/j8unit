 ...
 * java.rmi.server.ServerNotActiveException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerNotActiveExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ServerNotActiveExceptionTests}.
 * </p>
 *
 * @see java.rmi.server.ServerNotActiveException class java.rmi.server.ServerNotActiveException (the hereby targeted
 *      class-under-test class)
 * @see ServerNotActiveExceptionTests ServerNotActiveExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.ServerNotActiveException.class!",
                   java.rmi.server.ServerNotActiveException.class.isAssignableFrom(sut));
    }

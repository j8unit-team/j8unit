 ...
 * {@link ServerNotActiveException public class java.rmi.server.ServerNotActiveException}.
 *
...
public abstract interface ServerNotActiveExceptionClassTests<SUT extends ServerNotActiveException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerNotActiveException.class!",
                   ServerNotActiveException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MinguoDate public
 * final class java.time.chrono.MinguoDate}.
 *
...
public abstract interface MinguoDateClassTests<SUT extends MinguoDate>
extends ChronoLocalDateClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.MinguoDate]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MinguoDate.class!",
                   MinguoDate.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.time.chrono.MinguoDate]

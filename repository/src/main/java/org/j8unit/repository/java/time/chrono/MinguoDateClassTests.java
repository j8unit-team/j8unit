 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MinguoDateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MinguoDateTests}.
 * </p>
 *
 * @see java.time.chrono.MinguoDate class java.time.chrono.MinguoDate (the hereby targeted class-under-test class)
 * @see MinguoDateTests MinguoDateTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.MinguoDate.class!",
                   java.time.chrono.MinguoDate.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.IllegalComponentStateException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IllegalComponentStateExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalComponentStateExceptionTests IllegalComponentStateExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.IllegalComponentStateException.class!",
                   java.awt.IllegalComponentStateException.class.isAssignableFrom(sut));
    }

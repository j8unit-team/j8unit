...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.URLClassLoader class java.net.URLClassLoader}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLClassLoaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URLClassLoaderTests}.
 * </p>
 *
 * @see java.net.URLClassLoader class java.net.URLClassLoader (the hereby targeted class-under-test class)
 * @see URLClassLoaderTests URLClassLoaderTests (The complementary j8unit test interface containing the instance
...
public abstract interface URLClassLoaderClassTests<SUT extends java.net.URLClassLoader>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.security.SecureClassLoaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URLClassLoader.class!",
                   java.net.URLClassLoader.class.isAssignableFrom(sut));
    }

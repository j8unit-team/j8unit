...
import org.j8unit.repository.java.security.SecureClassLoaderClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URLClassLoader
...
public abstract interface URLClassLoaderClassTests<SUT extends URLClassLoader>
extends CloseableClassTests<SUT>, SecureClassLoaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLClassLoader.class!",
                   URLClassLoader.class.isAssignableFrom(sut));
    }

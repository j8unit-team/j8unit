...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain SuppressWarnings interface java.lang.SuppressWarnings}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SuppressWarningsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SuppressWarningsTests}.
 * </p>
 *
 * @see SuppressWarnings interface java.lang.SuppressWarnings (the hereby targeted class-under-test class)
 * @see SuppressWarningsTests SuppressWarningsTests (The complementary j8unit test interface containing the instance
...
public abstract interface SuppressWarningsClassTests<SUT extends SuppressWarnings>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SuppressWarnings.class!",
                   SuppressWarnings.class.isAssignableFrom(sut));
    }

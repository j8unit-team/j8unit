 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FocusTraversalPolicyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FocusTraversalPolicyTests}
 * .
 * </p>
 *
 * @see java.awt.FocusTraversalPolicy class java.awt.FocusTraversalPolicy (the hereby targeted class-under-test class)
 * @see FocusTraversalPolicyTests FocusTraversalPolicyTests (The complementary j8unit test interface containing the
...
public abstract interface FocusTraversalPolicyClassTests<SUT extends java.awt.FocusTraversalPolicy>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.FocusTraversalPolicy.class!",
                   java.awt.FocusTraversalPolicy.class.isAssignableFrom(sut));
    }

 ...
 * java.util.concurrent.CyclicBarrier}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CyclicBarrierTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CyclicBarrierTests}.
 * </p>
 *
 * @see java.util.concurrent.CyclicBarrier class java.util.concurrent.CyclicBarrier (the hereby targeted
 *      class-under-test class)
 * @see CyclicBarrierTests CyclicBarrierTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CyclicBarrier.class!",
                   java.util.concurrent.CyclicBarrier.class.isAssignableFrom(sut));
    }

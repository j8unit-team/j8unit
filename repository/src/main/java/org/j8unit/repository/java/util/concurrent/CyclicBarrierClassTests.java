 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CyclicBarrier
...
public abstract interface CyclicBarrierClassTests<SUT extends CyclicBarrier>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CyclicBarrier.class!",
                   CyclicBarrier.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SortedSet public
 * abstract interface java.util.SortedSet<E>}.
 *
...
public abstract interface SortedSetClassTests<SUT extends SortedSet>
extends SetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SortedSet.class!",
                   SortedSet.class.isAssignableFrom(sut));
    }

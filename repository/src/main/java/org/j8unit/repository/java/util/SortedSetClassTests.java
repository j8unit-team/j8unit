 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SortedSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SortedSetTests}.
 * </p>
 *
 * @see java.util.SortedSet interface java.util.SortedSet (the hereby targeted class-under-test class)
 * @see SortedSetTests SortedSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.SortedSet.class!",
                   java.util.SortedSet.class.isAssignableFrom(sut));
    }

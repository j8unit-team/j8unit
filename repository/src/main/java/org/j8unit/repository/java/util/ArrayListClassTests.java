...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain java.util.ArrayList class java.util.ArrayList}, containing all class
 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.ArrayList
 */
...
org.j8unit.repository.java.util.AbstractListClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.ArrayList#ArrayList()
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.ArrayList#ArrayList(java.util.Collection)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ArrayList_Collection()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * </p>
     *
     * @j8unit.aim java.util.ArrayList#ArrayList(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ArrayList_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.ArrayList#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

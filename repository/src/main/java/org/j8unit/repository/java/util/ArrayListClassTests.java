...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.ArrayList class java.util.ArrayList}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ArrayListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ArrayListTests}.
 * </p>
 *
 * @see java.util.ArrayList class java.util.ArrayList (the hereby targeted class-under-test class)
 * @see ArrayListTests ArrayListTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ArrayList.class!",
                   java.util.ArrayList.class.isAssignableFrom(sut));
    }

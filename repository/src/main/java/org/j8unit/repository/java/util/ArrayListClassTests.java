...
/**
 * <p>
 * Test class for {@link java.util.ArrayList class java.util.ArrayList}, containing all class relevant test methods (at
 * least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.util.ArrayListTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.util.AbstractListClassTests<SUT, E> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.util.ArrayList<E>> sut = createNewSUT();

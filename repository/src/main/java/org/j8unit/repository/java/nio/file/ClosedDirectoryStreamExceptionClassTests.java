 ...
 * java.nio.file.ClosedDirectoryStreamException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link ClosedDirectoryStreamExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.file.ClosedDirectoryStreamException class java.nio.file.ClosedDirectoryStreamException (the hereby
 *      targeted class-under-test class)
 * @see ClosedDirectoryStreamExceptionTests ClosedDirectoryStreamExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.ClosedDirectoryStreamException.class!",
                   java.nio.file.ClosedDirectoryStreamException.class.isAssignableFrom(sut));
    }

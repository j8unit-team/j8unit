...
public abstract interface ClosedDirectoryStreamExceptionClassTests<SUT extends ClosedDirectoryStreamException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClosedDirectoryStreamException.class!",
                   ClosedDirectoryStreamException.class.isAssignableFrom(sut));
    }

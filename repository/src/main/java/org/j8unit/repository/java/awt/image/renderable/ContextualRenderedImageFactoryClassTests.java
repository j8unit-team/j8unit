...
extends RenderedImageFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContextualRenderedImageFactory.class!",
                   ContextualRenderedImageFactory.class.isAssignableFrom(sut));
    }

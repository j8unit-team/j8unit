 ...
 * java.awt.image.renderable.ContextualRenderedImageFactory}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * </p>
 *
 * @see java.awt.image.renderable.ContextualRenderedImageFactory interface
 *      java.awt.image.renderable.ContextualRenderedImageFactory (the hereby targeted class-under-test class)
 * @see ContextualRenderedImageFactoryTests ContextualRenderedImageFactoryTests (The complementary j8unit test interface
...
public abstract interface ContextualRenderedImageFactoryClassTests<SUT extends java.awt.image.renderable.ContextualRenderedImageFactory>
extends RenderedImageFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.renderable.ContextualRenderedImageFactory.class!",
                   java.awt.image.renderable.ContextualRenderedImageFactory.class.isAssignableFrom(sut));
    }

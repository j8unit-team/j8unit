 ...
 * {@link DuplicateFormatFlagsException public class java.util.DuplicateFormatFlagsException}.
 *
...
public abstract interface DuplicateFormatFlagsExceptionClassTests<SUT extends DuplicateFormatFlagsException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DuplicateFormatFlagsException.class!",
                   DuplicateFormatFlagsException.class.isAssignableFrom(sut));
    }

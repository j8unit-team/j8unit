 ...
 * java.util.DuplicateFormatFlagsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link DuplicateFormatFlagsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see DuplicateFormatFlagsExceptionTests DuplicateFormatFlagsExceptionTests (The complementary j8unit test interface
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.DuplicateFormatFlagsException.class!",
                   java.util.DuplicateFormatFlagsException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Savepoint public
 * abstract interface java.sql.Savepoint}.
 *
...
public abstract interface SavepointClassTests<SUT extends Savepoint>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Savepoint.class!",
                   Savepoint.class.isAssignableFrom(sut));
    }

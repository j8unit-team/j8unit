...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Savepoint interface java.sql.Savepoint}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SavepointTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SavepointTests}.
 * </p>
 *
 * @see java.sql.Savepoint interface java.sql.Savepoint (the hereby targeted class-under-test class)
 * @see SavepointTests SavepointTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SavepointClassTests<SUT extends java.sql.Savepoint>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Savepoint.class!",
                   java.sql.Savepoint.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageFilter public
...
public abstract interface ImageFilterClassTests<SUT extends ImageFilter>
extends ImageConsumerClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageFilter.class!",
                   ImageFilter.class.isAssignableFrom(sut));
    }

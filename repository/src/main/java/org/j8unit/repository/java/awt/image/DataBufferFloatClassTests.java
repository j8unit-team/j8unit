...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.DataBufferFloat class java.awt.image.DataBufferFloat},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBufferFloatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataBufferFloatTests}.
 * </p>
 *
 * @see java.awt.image.DataBufferFloat class java.awt.image.DataBufferFloat (the hereby targeted class-under-test class)
 * @see DataBufferFloatTests DataBufferFloatTests (The complementary j8unit test interface containing the instance
...
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DataBufferFloat.class!",
                   java.awt.image.DataBufferFloat.class.isAssignableFrom(sut));
    }

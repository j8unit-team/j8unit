 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataBufferFloat
 * public final class java.awt.image.DataBufferFloat}.
 *
...
public abstract interface DataBufferFloatClassTests<SUT extends DataBufferFloat>
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBufferFloat.class!",
                   DataBufferFloat.class.isAssignableFrom(sut));
    }

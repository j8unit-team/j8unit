 ...
 * java.security.interfaces.RSAKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RSAKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.RSAKey interface java.security.interfaces.RSAKey (the hereby targeted class-under-test
 *      class)
 * @see RSAKeyTests RSAKeyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface RSAKeyClassTests<SUT extends java.security.interfaces.RSAKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.RSAKey.class!",
                   java.security.interfaces.RSAKey.class.isAssignableFrom(sut));
    }

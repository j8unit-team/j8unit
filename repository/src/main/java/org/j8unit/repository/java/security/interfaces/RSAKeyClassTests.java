 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RSAKey public
 * abstract interface java.security.interfaces.RSAKey}.
 *
...
public abstract interface RSAKeyClassTests<SUT extends RSAKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAKey.class!",
                   RSAKey.class.isAssignableFrom(sut));
    }

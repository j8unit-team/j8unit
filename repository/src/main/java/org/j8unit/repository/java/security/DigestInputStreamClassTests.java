...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.DigestInputStream class java.security.DigestInputStream}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DigestInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DigestInputStreamTests}.
 * </p>
 *
 * @see java.security.DigestInputStream class java.security.DigestInputStream (the hereby targeted class-under-test
 *      class)
 * @see DigestInputStreamTests DigestInputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface DigestInputStreamClassTests<SUT extends java.security.DigestInputStream>
extends org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.DigestInputStream.class!",
                   java.security.DigestInputStream.class.isAssignableFrom(sut));
    }

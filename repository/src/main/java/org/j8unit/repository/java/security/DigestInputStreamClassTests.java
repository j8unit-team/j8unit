 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DigestInputStream
...
public abstract interface DigestInputStreamClassTests<SUT extends DigestInputStream>
extends FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DigestInputStream.class!",
                   DigestInputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Collection public
 * abstract interface java.util.Collection<E>}.
 *
...
public abstract interface CollectionClassTests<SUT extends Collection>
extends IterableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Collection.class!",
                   Collection.class.isAssignableFrom(sut));
    }

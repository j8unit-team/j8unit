...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Collection interface java.util.Collection}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CollectionTests}.
 * </p>
 *
 * @see java.util.Collection interface java.util.Collection (the hereby targeted class-under-test class)
 * @see CollectionTests CollectionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CollectionClassTests<SUT extends java.util.Collection>
extends org.j8unit.repository.java.lang.IterableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Collection.class!",
                   java.util.Collection.class.isAssignableFrom(sut));
    }

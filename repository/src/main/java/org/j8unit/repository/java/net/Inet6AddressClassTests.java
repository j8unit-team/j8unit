 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Inet6AddressTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link Inet6AddressTests}.
 * </p>
 *
 * @see java.net.Inet6Address class java.net.Inet6Address (the hereby targeted class-under-test class)
 * @see Inet6AddressTests Inet6AddressTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface Inet6AddressClassTests<SUT extends java.net.Inet6Address>
extends InetAddressClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.Inet6Address.class!",
                   java.net.Inet6Address.class.isAssignableFrom(sut));
    }

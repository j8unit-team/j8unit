 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Inet6Address public
 * final class java.net.Inet6Address}.
 *
...
public abstract interface Inet6AddressClassTests<SUT extends Inet6Address>
extends InetAddressClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Inet6Address.class!",
                   Inet6Address.class.isAssignableFrom(sut));
    }

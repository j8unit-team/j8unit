...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.FileSystem class java.nio.file.FileSystem}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileSystemTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileSystemTests}.
 * </p>
 *
 * @see java.nio.file.FileSystem class java.nio.file.FileSystem (the hereby targeted class-under-test class)
 * @see FileSystemTests FileSystemTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileSystemClassTests<SUT extends java.nio.file.FileSystem>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileSystem.class!",
                   java.nio.file.FileSystem.class.isAssignableFrom(sut));
    }

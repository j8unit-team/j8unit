 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileSystem public
 * abstract class java.nio.file.FileSystem}.
 *
...
public abstract interface FileSystemClassTests<SUT extends FileSystem>
extends CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystem.class!",
                   FileSystem.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.file.FileSystem]

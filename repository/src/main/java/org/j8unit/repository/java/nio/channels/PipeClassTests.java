...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * java.nio.channels.Pipe$SinkChannel}, containing all class relevant test methods (at least the test methods of
    ...
    org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT> {
         ...
         * @since 0.9.2
         *
         * @j8unit.aim java.nio.channels.Pipe.SinkChannel#isAssignableFrom(java.lang.Class)
         */
        @Override
        @Test
     ...
     * java.nio.channels.Pipe$SourceChannel}, containing all class relevant test methods (at least the test methods of
     * accessible constructors and of accessible {@code static} methods). The counterpart J8Unit test interface
     * containing the instance relevant test methods is
    ...
    org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT> {
         ...
         * @since 0.9.2
         *
         * @j8unit.aim java.nio.channels.Pipe.SourceChannel#isAssignableFrom(java.lang.Class)
         */
        @Override
        @Test
        public default void testBaseTypeIsAssignableFromCurrentType()
     ...
     * </p>
     *
     * @j8unit.aim java.nio.channels.Pipe#open()
     */
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.nio.channels.Pipe#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test
    public default void testBaseTypeIsAssignableFromCurrentType()

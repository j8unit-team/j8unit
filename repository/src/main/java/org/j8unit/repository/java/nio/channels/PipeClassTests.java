 ...
 * methods is {@link org.j8unit.repository.java.nio.channels.PipeTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT>
{
    ...
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.nio.channels.Pipe> sut = createNewSUT();
    ...
    /**
     * <p>
     * Test method for {@link java.nio.channels.Pipe#open() public static java.nio.channels.Pipe java.nio.channels.Pipe.open() throws java.io.IOException}.
     * </p>
     */
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.nio.channels.PipeTests.SinkChannelTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
            ...
            org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.nio.channels.Pipe.SinkChannel> sut = createNewSUT();
            // assert assignability
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.nio.channels.PipeTests.SourceChannelTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
            ...
            org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.nio.channels.Pipe.SourceChannel> sut = createNewSUT();
            // assert assignability

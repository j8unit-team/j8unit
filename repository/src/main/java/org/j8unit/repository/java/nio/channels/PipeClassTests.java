 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PipeTests}).
 * </p>
 *
 * <p>
 ...
 * @see PipeTests PipeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.Pipe.class!",
                   java.nio.channels.Pipe.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.nio.channels.Pipe.SourceChannel class
     * java.nio.channels.Pipe$SourceChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link PipeTests.SourceChannelTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see PipeTests.SourceChannelTests PipeTests.SourceChannelTests (The complementary j8unit test interface
    ...
    extends ReadableByteChannelClassTests<SUT>, ScatteringByteChannelClassTests<SUT>,
    org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.Pipe.SourceChannel.class!",
                       java.nio.channels.Pipe.SourceChannel.class.isAssignableFrom(sut));
        }
     ...
     * java.nio.channels.Pipe$SinkChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link PipeTests.SinkChannelTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class-under-test class)
     * @see PipeTests.SinkChannelTests PipeTests.SinkChannelTests (The complementary j8unit test interface containing
    ...
    extends WritableByteChannelClassTests<SUT>, GatheringByteChannelClassTests<SUT>,
    org.j8unit.repository.java.nio.channels.spi.AbstractSelectableChannelClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.Pipe.SinkChannel.class!",
                       java.nio.channels.Pipe.SinkChannel.class.isAssignableFrom(sut));
        }

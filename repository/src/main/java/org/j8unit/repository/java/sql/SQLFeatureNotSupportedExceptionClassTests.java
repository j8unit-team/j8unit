 ...
 * {@link SQLFeatureNotSupportedException public class java.sql.SQLFeatureNotSupportedException}.
 *
...
public abstract interface SQLFeatureNotSupportedExceptionClassTests<SUT extends SQLFeatureNotSupportedException>
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLFeatureNotSupportedException.class!",
                   SQLFeatureNotSupportedException.class.isAssignableFrom(sut));
    }

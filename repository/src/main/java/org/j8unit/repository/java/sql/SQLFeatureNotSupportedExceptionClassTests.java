 ...
 * java.sql.SQLFeatureNotSupportedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link SQLFeatureNotSupportedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.sql.SQLFeatureNotSupportedException class java.sql.SQLFeatureNotSupportedException (the hereby targeted
 *      class-under-test class)
 * @see SQLFeatureNotSupportedExceptionTests SQLFeatureNotSupportedExceptionTests (The complementary j8unit test
...
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLFeatureNotSupportedException.class!",
                   java.sql.SQLFeatureNotSupportedException.class.isAssignableFrom(sut));
    }

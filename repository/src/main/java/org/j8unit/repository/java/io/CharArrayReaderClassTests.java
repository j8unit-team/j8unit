 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharArrayReaderTests}).
 * </p>
 *
 * <p>
 ...
 * @see CharArrayReaderTests CharArrayReaderTests (The complementary j8unit test interface containing the instance
...
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.CharArrayReader.class!",
                   java.io.CharArrayReader.class.isAssignableFrom(sut));
    }

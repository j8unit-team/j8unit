...
public abstract interface CertPathBuilderResultClassTests<SUT extends CertPathBuilderResult>
extends CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathBuilderResult.class!",
                   CertPathBuilderResult.class.isAssignableFrom(sut));
    }

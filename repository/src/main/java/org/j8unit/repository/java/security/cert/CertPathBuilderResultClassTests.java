 ...
 * java.security.cert.CertPathBuilderResult}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertPathBuilderResultTests}).
 * </p>
 *
 * <p>
 ...
 * {@link CertPathBuilderResultTests}.
 * </p>
 *
 * @see java.security.cert.CertPathBuilderResult interface java.security.cert.CertPathBuilderResult (the hereby targeted
 *      class-under-test class)
 * @see CertPathBuilderResultTests CertPathBuilderResultTests (The complementary j8unit test interface containing the
...
public abstract interface CertPathBuilderResultClassTests<SUT extends java.security.cert.CertPathBuilderResult>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathBuilderResult.class!",
                   java.security.cert.CertPathBuilderResult.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PaintEvent public
...
public abstract interface PaintEventClassTests<SUT extends PaintEvent>
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PaintEvent.class!",
                   PaintEvent.class.isAssignableFrom(sut));
    }

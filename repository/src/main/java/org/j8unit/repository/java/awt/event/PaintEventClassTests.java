...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.PaintEvent class java.awt.event.PaintEvent}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PaintEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PaintEventTests}.
 * </p>
 *
 * @see java.awt.event.PaintEvent class java.awt.event.PaintEvent (the hereby targeted class-under-test class)
 * @see PaintEventTests PaintEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PaintEventClassTests<SUT extends java.awt.event.PaintEvent>
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.PaintEvent.class!",
                   java.awt.event.PaintEvent.class.isAssignableFrom(sut));
    }

 ...
 * {@link AtomicLongFieldUpdater public abstract class java.util.concurrent.atomic.AtomicLongFieldUpdater<T>}.
 *
...
public abstract interface AtomicLongFieldUpdaterClassTests<SUT extends AtomicLongFieldUpdater>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicLongFieldUpdater.class!",
                   AtomicLongFieldUpdater.class.isAssignableFrom(sut));
    }

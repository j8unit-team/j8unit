 ...
 * java.util.concurrent.atomic.AtomicLongFieldUpdater}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicLongFieldUpdaterTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AtomicLongFieldUpdaterTests}.
 * </p>
 *
 ...
 * @see AtomicLongFieldUpdaterTests AtomicLongFieldUpdaterTests (The complementary j8unit test interface containing the
...
public abstract interface AtomicLongFieldUpdaterClassTests<SUT extends java.util.concurrent.atomic.AtomicLongFieldUpdater>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicLongFieldUpdater.class!",
                   java.util.concurrent.atomic.AtomicLongFieldUpdater.class.isAssignableFrom(sut));
    }

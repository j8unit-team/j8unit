...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.PasswordAuthentication class java.net.PasswordAuthentication}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PasswordAuthenticationTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PasswordAuthenticationTests}.
 * </p>
 *
 * @see java.net.PasswordAuthentication class java.net.PasswordAuthentication (the hereby targeted class-under-test
 *      class)
 * @see PasswordAuthenticationTests PasswordAuthenticationTests (The complementary j8unit test interface containing the
...
public abstract interface PasswordAuthenticationClassTests<SUT extends java.net.PasswordAuthentication>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.PasswordAuthentication.class!",
                   java.net.PasswordAuthentication.class.isAssignableFrom(sut));
    }

 ...
 * {@link PasswordAuthentication public final class java.net.PasswordAuthentication}.
 *
...
public abstract interface PasswordAuthenticationClassTests<SUT extends PasswordAuthentication>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PasswordAuthentication.class!",
                   PasswordAuthentication.class.isAssignableFrom(sut));
    }

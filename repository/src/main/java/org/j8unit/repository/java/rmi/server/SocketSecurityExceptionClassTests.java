 ...
 * java.rmi.server.SocketSecurityException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketSecurityExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link SocketSecurityExceptionTests}.
 * </p>
 *
 * @see java.rmi.server.SocketSecurityException class java.rmi.server.SocketSecurityException (the hereby targeted
 *      class-under-test class)
 * @see SocketSecurityExceptionTests SocketSecurityExceptionTests (The complementary j8unit test interface containing
...
extends ExportExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.SocketSecurityException.class!",
                   java.rmi.server.SocketSecurityException.class.isAssignableFrom(sut));
    }

...
public abstract interface SocketSecurityExceptionClassTests<SUT extends SocketSecurityException>
extends org.j8unit.repository.java.rmi.server.ExportExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketSecurityException.class!",
                   SocketSecurityException.class.isAssignableFrom(sut));
    }

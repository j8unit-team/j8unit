 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OptionalLongTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OptionalLongTests}.
 * </p>
 *
 * @see java.util.OptionalLong class java.util.OptionalLong (the hereby targeted class-under-test class)
 * @see OptionalLongTests OptionalLongTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.OptionalLong.class!",
                   java.util.OptionalLong.class.isAssignableFrom(sut));
    }

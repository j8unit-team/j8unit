 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OptionalLong public
...
public abstract interface OptionalLongClassTests<SUT extends OptionalLong>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.OptionalLong]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OptionalLong.class!",
                   OptionalLong.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.OptionalLong]

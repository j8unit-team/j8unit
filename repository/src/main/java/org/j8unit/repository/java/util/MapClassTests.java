 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Map public abstract
...
public abstract interface MapClassTests<SUT extends Map>
extends RepositoryClassTests<SUT> {
     ...
     * {@link Entry public abstract static interface java.util.Map$Entry<K,V>}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

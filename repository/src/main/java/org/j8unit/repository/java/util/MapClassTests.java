...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Map interface java.util.Map}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MapTests}.
 * </p>
 *
 * @see java.util.Map interface java.util.Map (the hereby targeted class-under-test class)
 * @see MapTests MapTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Map.class!",
                   java.util.Map.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.Map.Entry interface java.util.Map$Entry}, containing all
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link MapTests.EntryTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link MapTests.EntryTests}.
     * </p>
     *
     * @see java.util.Map.Entry interface java.util.Map$Entry (the hereby targeted class-under-test class)
     * @see MapTests.EntryTests MapTests.EntryTests (The complementary j8unit test interface containing the instance
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Map.Entry.class!",
                       java.util.Map.Entry.class.isAssignableFrom(sut));
        }

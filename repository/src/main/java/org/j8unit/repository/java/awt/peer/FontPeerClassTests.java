...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.FontPeer interface java.awt.peer.FontPeer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FontPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FontPeerTests}.
 * </p>
 *
 * @see java.awt.peer.FontPeer interface java.awt.peer.FontPeer (the hereby targeted class-under-test class)
 * @see FontPeerTests FontPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FontPeerClassTests<SUT extends java.awt.peer.FontPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.FontPeer.class!",
                   java.awt.peer.FontPeer.class.isAssignableFrom(sut));
    }

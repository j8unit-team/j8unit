 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FontPeer public
...
public abstract interface FontPeerClassTests<SUT extends FontPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FontPeer.class!",
                   FontPeer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.Method class java.lang.reflect.Method}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MethodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MethodTests}.
 * </p>
 *
 * @see java.lang.reflect.Method class java.lang.reflect.Method (the hereby targeted class-under-test class)
 * @see MethodTests MethodTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface MethodClassTests<SUT extends java.lang.reflect.Method>
extends ExecutableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.Method.class!",
                   java.lang.reflect.Method.class.isAssignableFrom(sut));
    }

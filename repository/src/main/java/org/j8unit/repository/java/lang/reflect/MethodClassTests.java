 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Method public final
...
public abstract interface MethodClassTests<SUT extends Method>
extends ExecutableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Method.class!",
                   Method.class.isAssignableFrom(sut));
    }

...
public abstract interface GraphicsConfigTemplateClassTests<SUT extends GraphicsConfigTemplate>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GraphicsConfigTemplate.class!",
                   GraphicsConfigTemplate.class.isAssignableFrom(sut));
    }

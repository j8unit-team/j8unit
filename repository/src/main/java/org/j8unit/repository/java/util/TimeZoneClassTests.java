 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TimeZone public
...
public abstract interface TimeZoneClassTests<SUT extends TimeZone>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimeZone.class!",
                   TimeZone.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.TimeZone class java.util.TimeZone}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimeZoneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TimeZoneTests}.
 * </p>
 *
 * @see java.util.TimeZone class java.util.TimeZone (the hereby targeted class-under-test class)
 * @see TimeZoneTests TimeZoneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.TimeZone.class!",
                   java.util.TimeZone.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.util.ComparatorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Collator public
...
public abstract interface CollatorClassTests<SUT extends Collator>
extends ComparatorClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Collator.class!",
                   Collator.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.Collator class java.text.Collator}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CollatorTests}.
 * </p>
 *
 * @see java.text.Collator class java.text.Collator (the hereby targeted class-under-test class)
 * @see CollatorTests CollatorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.Collator.class!",
                   java.text.Collator.class.isAssignableFrom(sut));
    }

 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link NavigableSet
 * public abstract interface java.util.NavigableSet<E>}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.util.NavigableSetClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface NavigableSetTests<SUT extends NavigableSet<E>, E>

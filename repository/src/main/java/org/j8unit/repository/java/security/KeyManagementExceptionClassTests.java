 ...
 * java.security.KeyManagementException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyManagementExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.security.KeyManagementException class java.security.KeyManagementException (the hereby targeted
 *      class-under-test class)
 * @see KeyManagementExceptionTests KeyManagementExceptionTests (The complementary j8unit test interface containing the
...
extends KeyExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.KeyManagementException.class!",
                   java.security.KeyManagementException.class.isAssignableFrom(sut));
    }

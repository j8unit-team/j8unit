 ...
 * java.awt.font.ImageGraphicAttribute}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageGraphicAttributeTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ImageGraphicAttributeTests}.
 * </p>
 *
 * @see java.awt.font.ImageGraphicAttribute class java.awt.font.ImageGraphicAttribute (the hereby targeted
 *      class-under-test class)
 * @see ImageGraphicAttributeTests ImageGraphicAttributeTests (The complementary j8unit test interface containing the
...
extends GraphicAttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.font.ImageGraphicAttribute.class!",
                   java.awt.font.ImageGraphicAttribute.class.isAssignableFrom(sut));
    }

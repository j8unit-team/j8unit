 ...
 * {@link ImageGraphicAttribute public final class java.awt.font.ImageGraphicAttribute}.
 *
...
public abstract interface ImageGraphicAttributeClassTests<SUT extends ImageGraphicAttribute>
extends org.j8unit.repository.java.awt.font.GraphicAttributeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageGraphicAttribute.class!",
                   ImageGraphicAttribute.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ScrollPane public
...
public abstract interface ScrollPaneClassTests<SUT extends ScrollPane>
extends AccessibleClassTests<SUT>, ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScrollPane.class!",
                   ScrollPane.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.ScrollPane]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.ScrollPane class java.awt.ScrollPane}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScrollPaneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScrollPaneTests}.
 * </p>
 *
 * @see java.awt.ScrollPane class java.awt.ScrollPane (the hereby targeted class-under-test class)
 * @see ScrollPaneTests ScrollPaneTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ScrollPaneClassTests<SUT extends java.awt.ScrollPane>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.ScrollPane.class!",
                   java.awt.ScrollPane.class.isAssignableFrom(sut));
    }

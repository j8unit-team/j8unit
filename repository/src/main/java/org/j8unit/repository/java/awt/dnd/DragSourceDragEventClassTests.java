 ...
 * java.awt.dnd.DragSourceDragEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragSourceDragEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DragSourceDragEventTests}.
 * </p>
 *
 * @see java.awt.dnd.DragSourceDragEvent class java.awt.dnd.DragSourceDragEvent (the hereby targeted class-under-test
 *      class)
 * @see DragSourceDragEventTests DragSourceDragEventTests (The complementary j8unit test interface containing the
...
extends DragSourceEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragSourceDragEvent.class!",
                   java.awt.dnd.DragSourceDragEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragSourceDragEvent
...
public abstract interface DragSourceDragEventClassTests<SUT extends DragSourceDragEvent>
extends DragSourceEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSourceDragEvent.class!",
                   DragSourceDragEvent.class.isAssignableFrom(sut));
    }

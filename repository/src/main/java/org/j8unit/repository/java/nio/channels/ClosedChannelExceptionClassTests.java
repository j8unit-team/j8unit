...
public abstract interface ClosedChannelExceptionClassTests<SUT extends ClosedChannelException>
extends IOExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.ClosedChannelException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClosedChannelException.class!",
                   ClosedChannelException.class.isAssignableFrom(sut));
    }

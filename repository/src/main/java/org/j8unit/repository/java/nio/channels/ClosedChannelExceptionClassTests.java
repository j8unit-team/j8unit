 ...
 * java.nio.channels.ClosedChannelException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClosedChannelExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ClosedChannelExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.ClosedChannelException class java.nio.channels.ClosedChannelException (the hereby targeted
 *      class-under-test class)
 * @see ClosedChannelExceptionTests ClosedChannelExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ClosedChannelException.class!",
                   java.nio.channels.ClosedChannelException.class.isAssignableFrom(sut));
    }

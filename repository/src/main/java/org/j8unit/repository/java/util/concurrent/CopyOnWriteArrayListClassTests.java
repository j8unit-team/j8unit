 ...
 * java.util.concurrent.CopyOnWriteArrayList}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CopyOnWriteArrayListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CopyOnWriteArrayListTests}
 * .
 * </p>
 *
 * @see java.util.concurrent.CopyOnWriteArrayList class java.util.concurrent.CopyOnWriteArrayList (the hereby targeted
 *      class-under-test class)
 * @see CopyOnWriteArrayListTests CopyOnWriteArrayListTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CopyOnWriteArrayList.class!",
                   java.util.concurrent.CopyOnWriteArrayList.class.isAssignableFrom(sut));
    }

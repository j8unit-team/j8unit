...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CopyOnWriteArrayList.class!",
                   CopyOnWriteArrayList.class.isAssignableFrom(sut));
    }

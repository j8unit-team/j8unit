...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.CollationKey class java.text.CollationKey}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollationKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CollationKeyTests}.
 * </p>
 *
 * @see java.text.CollationKey class java.text.CollationKey (the hereby targeted class-under-test class)
 * @see CollationKeyTests CollationKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CollationKeyClassTests<SUT extends java.text.CollationKey>
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.CollationKey.class!",
                   java.text.CollationKey.class.isAssignableFrom(sut));
    }

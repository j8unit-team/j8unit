 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CollationKey public
 * abstract class java.text.CollationKey}.
 *
...
public abstract interface CollationKeyClassTests<SUT extends CollationKey>
extends ComparableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CollationKey.class!",
                   CollationKey.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrimitiveIterator
 * public abstract interface java.util.PrimitiveIterator<T,T_CONS>}.
 *
...
extends IteratorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrimitiveIterator.class!",
     ...
     * {@link OfLong public abstract static interface java.util.PrimitiveIterator$OfLong}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link OfDouble public abstract static interface java.util.PrimitiveIterator$OfDouble}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link OfInt public abstract static interface java.util.PrimitiveIterator$OfInt}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

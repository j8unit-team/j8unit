 ...
 * methods is {@link org.j8unit.repository.java.util.PrimitiveIteratorTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.util.IteratorClassTests<SUT,T>
{
    ...
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.util.PrimitiveIterator<T,T_CONS>> sut = createNewSUT();
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.util.PrimitiveIteratorTests.OfLongTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends org.j8unit.repository.java.util.PrimitiveIteratorClassTests<SUT,java.lang.Long,java.util.function.LongConsumer>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.util.PrimitiveIterator.OfLong> sut = createNewSUT();
            // assert assignability
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.util.PrimitiveIteratorTests.OfIntTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends org.j8unit.repository.java.util.PrimitiveIteratorClassTests<SUT,java.lang.Integer,java.util.function.IntConsumer>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.util.PrimitiveIterator.OfInt> sut = createNewSUT();
            // assert assignability
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.util.PrimitiveIteratorTests.OfDoubleTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends org.j8unit.repository.java.util.PrimitiveIteratorClassTests<SUT,java.lang.Double,java.util.function.DoubleConsumer>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.util.PrimitiveIterator.OfDouble> sut = createNewSUT();
            // assert assignability

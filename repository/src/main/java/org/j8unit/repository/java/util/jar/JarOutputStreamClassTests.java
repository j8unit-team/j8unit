...
extends org.j8unit.repository.java.util.zip.ZipOutputStreamClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.jar.JarOutputStream#JarOutputStream(java.io.OutputStream)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.jar.JarOutputStream#JarOutputStream(java.io.OutputStream, java.util.jar.Manifest)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_JarOutputStream_OutputStream_Manifest()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.jar.JarOutputStream sut = null; // = new JarOutputStream(java.io.OutputStream,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.jar.JarOutputStream#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

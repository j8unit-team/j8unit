...
import org.j8unit.repository.java.util.zip.ZipOutputStreamClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JarOutputStream
...
public abstract interface JarOutputStreamClassTests<SUT extends JarOutputStream>
extends ZipOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JarOutputStream.class!",
                   JarOutputStream.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.util.jar.JarOutputStream class java.util.jar.JarOutputStream}, containing all class
...
extends org.j8unit.repository.java.util.zip.ZipOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.util.jar.JarOutputStream> sut = createNewSUT();

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JarOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JarOutputStreamTests}.
 * </p>
 *
 * @see java.util.jar.JarOutputStream class java.util.jar.JarOutputStream (the hereby targeted class-under-test class)
 * @see JarOutputStreamTests JarOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface JarOutputStreamClassTests<SUT extends java.util.jar.JarOutputStream>
extends org.j8unit.repository.java.util.zip.ZipOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.JarOutputStream.class!",
                   java.util.jar.JarOutputStream.class.isAssignableFrom(sut));
    }

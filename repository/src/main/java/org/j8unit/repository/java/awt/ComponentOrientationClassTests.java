 ...
 * {@link ComponentOrientationTests}.
 * </p>
 *
 * <p>
...
public abstract interface ComponentOrientationClassTests<SUT extends ComponentOrientation>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentOrientation.class!",
                   ComponentOrientation.class.isAssignableFrom(sut));
    }

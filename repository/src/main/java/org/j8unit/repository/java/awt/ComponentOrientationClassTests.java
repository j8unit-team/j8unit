 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentOrientationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentOrientationTests}
 * .
 * </p>
 *
 * @see java.awt.ComponentOrientation class java.awt.ComponentOrientation (the hereby targeted class-under-test class)
 * @see ComponentOrientationTests ComponentOrientationTests (The complementary j8unit test interface containing the
...
public abstract interface ComponentOrientationClassTests<SUT extends java.awt.ComponentOrientation>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.ComponentOrientation.class!",
                   java.awt.ComponentOrientation.class.isAssignableFrom(sut));
    }

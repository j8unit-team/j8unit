 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BatchUpdateExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BatchUpdateExceptionTests}
 * .
 * </p>
 *
 * @see java.sql.BatchUpdateException class java.sql.BatchUpdateException (the hereby targeted class-under-test class)
 * @see BatchUpdateExceptionTests BatchUpdateExceptionTests (The complementary j8unit test interface containing the
...
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.BatchUpdateException.class!",
                   java.sql.BatchUpdateException.class.isAssignableFrom(sut));
    }

 ...
 * {@link BatchUpdateException public class java.sql.BatchUpdateException}.
 *
 ...
 * {@link BatchUpdateExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface BatchUpdateExceptionClassTests<SUT extends BatchUpdateException>
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BatchUpdateException.class!",
                   BatchUpdateException.class.isAssignableFrom(sut));
    }

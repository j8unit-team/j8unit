 ...
 * java.nio.channels.AcceptPendingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AcceptPendingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AcceptPendingExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.AcceptPendingException class java.nio.channels.AcceptPendingException (the hereby targeted
 *      class-under-test class)
 * @see AcceptPendingExceptionTests AcceptPendingExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AcceptPendingException.class!",
                   java.nio.channels.AcceptPendingException.class.isAssignableFrom(sut));
    }

 ...
 * {@link AcceptPendingException public class java.nio.channels.AcceptPendingException}.
 *
 ...
 * {@link org.j8unit.repository.java.nio.channels.AcceptPendingExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface AcceptPendingExceptionClassTests<SUT extends AcceptPendingException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AcceptPendingException.class!",
                   AcceptPendingException.class.isAssignableFrom(sut));
    }

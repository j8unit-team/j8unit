 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharacterIteratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharacterIteratorTests}.
 * </p>
 *
 * @see java.text.CharacterIterator interface java.text.CharacterIterator (the hereby targeted class-under-test class)
 * @see CharacterIteratorTests CharacterIteratorTests (The complementary j8unit test interface containing the instance
...
public abstract interface CharacterIteratorClassTests<SUT extends java.text.CharacterIterator>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.CharacterIterator.class!",
                   java.text.CharacterIterator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CharacterIterator
...
public abstract interface CharacterIteratorClassTests<SUT extends CharacterIterator>
extends CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharacterIterator.class!",
                   CharacterIterator.class.isAssignableFrom(sut));
    }

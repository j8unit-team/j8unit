...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.List class java.awt.List}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListTests}.
 * </p>
 *
 * @see java.awt.List class java.awt.List (the hereby targeted class-under-test class)
 * @see ListTests ListTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends ItemSelectableClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.List.class!",
                   java.awt.List.class.isAssignableFrom(sut));
    }

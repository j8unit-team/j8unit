 ...
 * methods is {@link org.j8unit.repository.java.awt.ListTests}.
 * </p>
 *
 * <p>
        ...
        org.j8unit.repository.java.awt.ComponentClassTests<SUT>
{
    ...
    /**
     * Test method for {@link java.awt.List#List(int,boolean) public java.awt.List(int,boolean) throws java.awt.HeadlessException}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_List_int_boolean() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.awt.List sut = null; // = new List(int,boolean);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_List_int() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.awt.List sut = null; // = new List(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_List() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.awt.List sut = null; // = new List();
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.awt.List> sut = createNewSUT();

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URLEncoder public
...
public abstract interface URLEncoderClassTests<SUT extends URLEncoder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLEncoder.class!",
                   URLEncoder.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.net.URLEncoder]

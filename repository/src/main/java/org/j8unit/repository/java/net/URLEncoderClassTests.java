...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.URLEncoder class java.net.URLEncoder}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLEncoderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URLEncoderTests}.
 * </p>
 *
 * @see java.net.URLEncoder class java.net.URLEncoder (the hereby targeted class-under-test class)
 * @see URLEncoderTests URLEncoderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URLEncoder.class!",
                   java.net.URLEncoder.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventListenerProxyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventListenerProxyTests}.
 * </p>
 *
 * @see java.util.EventListenerProxy class java.util.EventListenerProxy (the hereby targeted class-under-test class)
 * @see EventListenerProxyTests EventListenerProxyTests (The complementary j8unit test interface containing the instance
...
extends EventListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.EventListenerProxy.class!",
                   java.util.EventListenerProxy.class.isAssignableFrom(sut));
    }

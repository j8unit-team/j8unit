 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventListenerProxy
 * public abstract class java.util.EventListenerProxy<T>}.
 *
...
public abstract interface EventListenerProxyClassTests<SUT extends EventListenerProxy>
extends EventListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventListenerProxy.class!",
                   EventListenerProxy.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MemoryType public
 * final enum java.lang.management.MemoryType}.
 *
...
public abstract interface MemoryTypeClassTests<SUT extends MemoryType>
extends EnumClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.lang.management.MemoryType]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryType.class!",
                   MemoryType.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.WeekFields class java.time.temporal.WeekFields},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WeekFieldsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WeekFieldsTests}.
 * </p>
 *
 * @see java.time.temporal.WeekFields class java.time.temporal.WeekFields (the hereby targeted class-under-test class)
 * @see WeekFieldsTests WeekFieldsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WeekFieldsClassTests<SUT extends java.time.temporal.WeekFields>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.WeekFields.class!",
                   java.time.temporal.WeekFields.class.isAssignableFrom(sut));
    }

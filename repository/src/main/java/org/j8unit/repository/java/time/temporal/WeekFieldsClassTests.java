 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WeekFields public
 * final class java.time.temporal.WeekFields}.
 *
...
public abstract interface WeekFieldsClassTests<SUT extends WeekFields>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WeekFields.class!",
                   WeekFields.class.isAssignableFrom(sut));
    }

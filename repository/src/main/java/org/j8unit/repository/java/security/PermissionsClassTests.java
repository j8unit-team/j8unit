...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.Permissions class java.security.Permissions}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PermissionsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PermissionsTests}.
 * </p>
 *
 * @see java.security.Permissions class java.security.Permissions (the hereby targeted class-under-test class)
 * @see PermissionsTests PermissionsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PermissionsClassTests<SUT extends java.security.Permissions>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, PermissionCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Permissions.class!",
                   java.security.Permissions.class.isAssignableFrom(sut));
    }

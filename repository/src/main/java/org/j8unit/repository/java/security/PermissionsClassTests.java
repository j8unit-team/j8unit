 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Permissions public
 * final class java.security.Permissions}.
 *
...
public abstract interface PermissionsClassTests<SUT extends Permissions>
extends PermissionCollectionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.Permissions]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Permissions.class!",
                   Permissions.class.isAssignableFrom(sut));
    }

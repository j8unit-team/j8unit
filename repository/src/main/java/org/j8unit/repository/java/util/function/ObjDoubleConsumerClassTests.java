 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjDoubleConsumer
 * public abstract interface java.util.function.ObjDoubleConsumer<T>}.
 *
...
public abstract interface ObjDoubleConsumerClassTests<SUT extends ObjDoubleConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjDoubleConsumer.class!",
                   ObjDoubleConsumer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.ObjDoubleConsumer interface
 * java.util.function.ObjDoubleConsumer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjDoubleConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjDoubleConsumerTests}.
 * </p>
 *
 * @see java.util.function.ObjDoubleConsumer interface java.util.function.ObjDoubleConsumer (the hereby targeted
 *      class-under-test class)
 * @see ObjDoubleConsumerTests ObjDoubleConsumerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ObjDoubleConsumerClassTests<SUT extends java.util.function.ObjDoubleConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ObjDoubleConsumer.class!",
                   java.util.function.ObjDoubleConsumer.class.isAssignableFrom(sut));
    }

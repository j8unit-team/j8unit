 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Scrollbar public
...
public abstract interface ScrollbarClassTests<SUT extends Scrollbar>
extends AdjustableClassTests<SUT>, AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Scrollbar.class!",
                   Scrollbar.class.isAssignableFrom(sut));
    }

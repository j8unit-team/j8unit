...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Scrollbar class java.awt.Scrollbar}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScrollbarTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ScrollbarTests}.
 * </p>
 *
 * @see java.awt.Scrollbar class java.awt.Scrollbar (the hereby targeted class-under-test class)
 * @see ScrollbarTests ScrollbarTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends AdjustableClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Scrollbar.class!",
                   java.awt.Scrollbar.class.isAssignableFrom(sut));
    }

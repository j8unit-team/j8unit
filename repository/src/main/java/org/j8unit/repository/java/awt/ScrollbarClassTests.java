...
/**
 * <p>
 * Test class for {@link java.awt.Scrollbar class java.awt.Scrollbar}, containing all class relevant test methods (at
 * least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.awt.ScrollbarTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.awt.ComponentClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.awt.Scrollbar> sut = createNewSUT();

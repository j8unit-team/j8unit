...
public abstract interface RSAMultiPrimePrivateCrtKeySpecClassTests<SUT extends RSAMultiPrimePrivateCrtKeySpec>
extends RSAPrivateKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAMultiPrimePrivateCrtKeySpec.class!",
                   RSAMultiPrimePrivateCrtKeySpec.class.isAssignableFrom(sut));
    }

 ...
 * java.security.spec.RSAMultiPrimePrivateCrtKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link RSAMultiPrimePrivateCrtKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 * @see RSAMultiPrimePrivateCrtKeySpecTests RSAMultiPrimePrivateCrtKeySpecTests (The complementary j8unit test interface
...
extends RSAPrivateKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.RSAMultiPrimePrivateCrtKeySpec.class!",
                   java.security.spec.RSAMultiPrimePrivateCrtKeySpec.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Scanner public
...
extends IteratorClassTests<SUT>, CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Scanner.class!",
                   Scanner.class.isAssignableFrom(sut));
    }

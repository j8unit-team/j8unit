...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_Scanner_File_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public default void create_Scanner_ReadableByteChannel()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.Scanner sut = null; // = new Scanner(java.nio.channels.ReadableByteChannel);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_Scanner_ReadableByteChannel_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.util.Scanner> sut = createNewSUT();

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Scanner class java.util.Scanner}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScannerTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.Scanner class java.util.Scanner (the hereby targeted class-under-test class)
 * @see ScannerTests ScannerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends IteratorClassTests<SUT>, org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Scanner.class!",
                   java.util.Scanner.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Delayed public
...
public abstract interface DelayedClassTests<SUT extends Delayed>
extends ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Delayed.class!",
                   Delayed.class.isAssignableFrom(sut));
    }

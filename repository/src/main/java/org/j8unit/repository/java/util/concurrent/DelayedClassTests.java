...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.Delayed interface java.util.concurrent.Delayed},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DelayedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DelayedTests}.
 * </p>
 *
 * @see java.util.concurrent.Delayed interface java.util.concurrent.Delayed (the hereby targeted class-under-test class)
 * @see DelayedTests DelayedTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Delayed.class!",
                   java.util.concurrent.Delayed.class.isAssignableFrom(sut));
    }

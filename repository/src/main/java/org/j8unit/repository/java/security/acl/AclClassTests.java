 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Acl public abstract
...
public abstract interface AclClassTests<SUT extends Acl>
extends OwnerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Acl.class!", Acl.class.isAssignableFrom(sut));
    }

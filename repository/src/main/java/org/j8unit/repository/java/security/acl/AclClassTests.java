...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.acl.Acl interface java.security.acl.Acl}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AclTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AclTests}.
 * </p>
 *
 * @see java.security.acl.Acl interface java.security.acl.Acl (the hereby targeted class-under-test class)
 * @see AclTests AclTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface AclClassTests<SUT extends java.security.acl.Acl>
extends OwnerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.acl.Acl.class!",
                   java.security.acl.Acl.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.ParameterizedType interface
 * java.lang.reflect.ParameterizedType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParameterizedTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParameterizedTypeTests}.
 * </p>
 *
 * @see java.lang.reflect.ParameterizedType interface java.lang.reflect.ParameterizedType (the hereby targeted
 *      class-under-test class)
 * @see ParameterizedTypeTests ParameterizedTypeTests (The complementary j8unit test interface containing the instance
...
public abstract interface ParameterizedTypeClassTests<SUT extends java.lang.reflect.ParameterizedType>
extends TypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.ParameterizedType.class!",
                   java.lang.reflect.ParameterizedType.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParameterizedType
 * public abstract interface java.lang.reflect.ParameterizedType}.
 *
...
public abstract interface ParameterizedTypeClassTests<SUT extends ParameterizedType>
extends TypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParameterizedType.class!",
                   ParameterizedType.class.isAssignableFrom(sut));
    }

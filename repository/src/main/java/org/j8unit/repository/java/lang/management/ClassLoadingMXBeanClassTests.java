...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.management.ClassLoadingMXBean interface
 * java.lang.management.ClassLoadingMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassLoadingMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClassLoadingMXBeanTests}.
 * </p>
 *
 * @see java.lang.management.ClassLoadingMXBean interface java.lang.management.ClassLoadingMXBean (the hereby targeted
 *      class-under-test class)
 * @see ClassLoadingMXBeanTests ClassLoadingMXBeanTests (The complementary j8unit test interface containing the instance
...
public abstract interface ClassLoadingMXBeanClassTests<SUT extends java.lang.management.ClassLoadingMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.ClassLoadingMXBean.class!",
                   java.lang.management.ClassLoadingMXBean.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ClassLoadingMXBean
 * public abstract interface java.lang.management.ClassLoadingMXBean}.
 *
...
public abstract interface ClassLoadingMXBeanClassTests<SUT extends ClassLoadingMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassLoadingMXBean.class!",
                   ClassLoadingMXBean.class.isAssignableFrom(sut));
    }

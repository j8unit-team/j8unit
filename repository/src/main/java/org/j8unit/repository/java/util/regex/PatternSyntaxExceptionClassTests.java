 ...
 * {@link PatternSyntaxException public class java.util.regex.PatternSyntaxException}.
 *
...
public abstract interface PatternSyntaxExceptionClassTests<SUT extends PatternSyntaxException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PatternSyntaxException.class!",
                   PatternSyntaxException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.regex.PatternSyntaxException]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.util.regex.PatternSyntaxException]

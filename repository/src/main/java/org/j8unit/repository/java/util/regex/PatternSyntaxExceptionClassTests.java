 ...
 * java.util.regex.PatternSyntaxException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PatternSyntaxExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PatternSyntaxExceptionTests}.
 * </p>
 *
 * @see java.util.regex.PatternSyntaxException class java.util.regex.PatternSyntaxException (the hereby targeted
 *      class-under-test class)
 * @see PatternSyntaxExceptionTests PatternSyntaxExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.regex.PatternSyntaxException.class!",
                   java.util.regex.PatternSyntaxException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.FilterWriter class java.io.FilterWriter}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilterWriterTests}).
 * </p>
 *
 * <p>
 ...
 * @see FilterWriterTests FilterWriterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface FilterWriterClassTests<SUT extends java.io.FilterWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FilterWriter.class!",
                   java.io.FilterWriter.class.isAssignableFrom(sut));
    }

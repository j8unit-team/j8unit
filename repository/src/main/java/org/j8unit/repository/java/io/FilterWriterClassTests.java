 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilterWriter public
...
extends org.j8unit.repository.java.io.WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilterWriter.class!",
                   FilterWriter.class.isAssignableFrom(sut));
    }

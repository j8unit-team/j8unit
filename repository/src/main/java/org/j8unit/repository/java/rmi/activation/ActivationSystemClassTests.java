 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActivationSystem
 * public abstract interface java.rmi.activation.ActivationSystem}.
 *
...
public abstract interface ActivationSystemClassTests<SUT extends ActivationSystem>
extends RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationSystem.class!",
                   ActivationSystem.class.isAssignableFrom(sut));
    }

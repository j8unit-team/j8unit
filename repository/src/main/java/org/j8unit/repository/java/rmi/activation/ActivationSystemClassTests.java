 ...
 * java.rmi.activation.ActivationSystem}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationSystemTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActivationSystemTests}.
 * </p>
 *
 * @see java.rmi.activation.ActivationSystem interface java.rmi.activation.ActivationSystem (the hereby targeted
 *      class-under-test class)
 * @see ActivationSystemTests ActivationSystemTests (The complementary j8unit test interface containing the instance
...
public abstract interface ActivationSystemClassTests<SUT extends java.rmi.activation.ActivationSystem>
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationSystem.class!",
                   java.rmi.activation.ActivationSystem.class.isAssignableFrom(sut));
    }

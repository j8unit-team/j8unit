 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileSystemProvider
...
public abstract interface FileSystemProviderClassTests<SUT extends FileSystemProvider>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystemProvider.class!",
                   FileSystemProvider.class.isAssignableFrom(sut));
    }

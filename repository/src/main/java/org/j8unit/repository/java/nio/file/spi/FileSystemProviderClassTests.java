 ...
 * java.nio.file.spi.FileSystemProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileSystemProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileSystemProviderTests}.
 * </p>
 *
 * @see java.nio.file.spi.FileSystemProvider class java.nio.file.spi.FileSystemProvider (the hereby targeted
 *      class-under-test class)
 * @see FileSystemProviderTests FileSystemProviderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.spi.FileSystemProvider.class!",
                   java.nio.file.spi.FileSystemProvider.class.isAssignableFrom(sut));
    }

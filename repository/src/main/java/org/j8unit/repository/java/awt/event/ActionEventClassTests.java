...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.ActionEvent class java.awt.event.ActionEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActionEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActionEventTests}.
 * </p>
 *
 * @see java.awt.event.ActionEvent class java.awt.event.ActionEvent (the hereby targeted class-under-test class)
 * @see ActionEventTests ActionEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ActionEventClassTests<SUT extends java.awt.event.ActionEvent>
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ActionEvent.class!",
                   java.awt.event.ActionEvent.class.isAssignableFrom(sut));
    }

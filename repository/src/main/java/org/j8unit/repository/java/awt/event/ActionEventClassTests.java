 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActionEvent public
...
public abstract interface ActionEventClassTests<SUT extends ActionEvent>
extends AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActionEvent.class!",
                   ActionEvent.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.TextField class java.awt.TextField}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextFieldTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextFieldTests}.
 * </p>
 *
 * @see java.awt.TextField class java.awt.TextField (the hereby targeted class-under-test class)
 * @see TextFieldTests TextFieldTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends TextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.TextField.class!",
                   java.awt.TextField.class.isAssignableFrom(sut));
    }

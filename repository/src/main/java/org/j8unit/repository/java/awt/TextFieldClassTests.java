 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextField public
...
public abstract interface TextFieldClassTests<SUT extends TextField>
extends TextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextField.class!",
                   TextField.class.isAssignableFrom(sut));
    }

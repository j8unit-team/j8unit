 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuItem public
...
public abstract interface MenuItemClassTests<SUT extends MenuItem>
extends AccessibleClassTests<SUT>, MenuComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuItem.class!",
                   MenuItem.class.isAssignableFrom(sut));
    }

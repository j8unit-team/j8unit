...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.MenuItem class java.awt.MenuItem}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuItemTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuItemTests}.
 * </p>
 *
 * @see java.awt.MenuItem class java.awt.MenuItem (the hereby targeted class-under-test class)
 * @see MenuItemTests MenuItemTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MenuItemClassTests<SUT extends java.awt.MenuItem>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, MenuComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.MenuItem.class!",
                   java.awt.MenuItem.class.isAssignableFrom(sut));
    }

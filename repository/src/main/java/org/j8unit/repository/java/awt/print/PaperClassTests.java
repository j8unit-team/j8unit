...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.print.Paper class java.awt.print.Paper}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PaperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PaperTests}.
 * </p>
 *
 * @see java.awt.print.Paper class java.awt.print.Paper (the hereby targeted class-under-test class)
 * @see PaperTests PaperTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface PaperClassTests<SUT extends java.awt.print.Paper>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.Paper.class!",
                   java.awt.print.Paper.class.isAssignableFrom(sut));
    }

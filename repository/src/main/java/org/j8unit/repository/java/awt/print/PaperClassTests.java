 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Paper public class
...
public abstract interface PaperClassTests<SUT extends Paper>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Paper.class!", Paper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ClientInfoStatus
 * public final enum java.sql.ClientInfoStatus}.
 *
...
public abstract interface ClientInfoStatusClassTests<SUT extends ClientInfoStatus>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClientInfoStatus.class!",

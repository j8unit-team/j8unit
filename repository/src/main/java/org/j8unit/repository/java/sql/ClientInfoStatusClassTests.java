 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClientInfoStatusTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClientInfoStatusTests}.
 * </p>
 *
 * @see java.sql.ClientInfoStatus class java.sql.ClientInfoStatus (the hereby targeted class-under-test class)
 * @see ClientInfoStatusTests ClientInfoStatusTests (The complementary j8unit test interface containing the instance
...
public abstract interface ClientInfoStatusClassTests<SUT extends java.sql.ClientInfoStatus>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.ClientInfoStatus.class!",
                   java.sql.ClientInfoStatus.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AppletInitializerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AppletInitializerTests}.
 * </p>
 *
 * @see java.beans.AppletInitializer interface java.beans.AppletInitializer (the hereby targeted class-under-test class)
 * @see AppletInitializerTests AppletInitializerTests (The complementary j8unit test interface containing the instance
...
public abstract interface AppletInitializerClassTests<SUT extends java.beans.AppletInitializer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.AppletInitializer.class!",
                   java.beans.AppletInitializer.class.isAssignableFrom(sut));
    }

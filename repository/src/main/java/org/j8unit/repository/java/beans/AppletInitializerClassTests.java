 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AppletInitializer
 * public abstract interface java.beans.AppletInitializer}.
 *
...
public abstract interface AppletInitializerClassTests<SUT extends AppletInitializer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AppletInitializer.class!",

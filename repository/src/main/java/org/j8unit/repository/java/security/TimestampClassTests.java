 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Timestamp public
 * final class java.security.Timestamp}.
 *
...
public abstract interface TimestampClassTests<SUT extends Timestamp>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Timestamp.class!",
                   Timestamp.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NetPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NetPermissionTests}.
 * </p>
 *
 * @see java.net.NetPermission class java.net.NetPermission (the hereby targeted class-under-test class)
 * @see NetPermissionTests NetPermissionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NetPermissionClassTests<SUT extends java.net.NetPermission>
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.NetPermission.class!",
                   java.net.NetPermission.class.isAssignableFrom(sut));
    }

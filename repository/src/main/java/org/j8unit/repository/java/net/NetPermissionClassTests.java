 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NetPermission
...
public abstract interface NetPermissionClassTests<SUT extends NetPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NetPermission.class!",
                   NetPermission.class.isAssignableFrom(sut));
    }

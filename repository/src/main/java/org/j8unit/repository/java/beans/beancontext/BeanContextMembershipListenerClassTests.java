...
public abstract interface BeanContextMembershipListenerClassTests<SUT extends BeanContextMembershipListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextMembershipListener.class!",
                   BeanContextMembershipListener.class.isAssignableFrom(sut));
    }

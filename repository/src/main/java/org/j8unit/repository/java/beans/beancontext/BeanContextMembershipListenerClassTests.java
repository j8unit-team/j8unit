 ...
 * java.beans.beancontext.BeanContextMembershipListener}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextMembershipListenerTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextMembershipListenerTests BeanContextMembershipListenerTests (The complementary j8unit test interface
...
public abstract interface BeanContextMembershipListenerClassTests<SUT extends java.beans.beancontext.BeanContextMembershipListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextMembershipListener.class!",
                   java.beans.beancontext.BeanContextMembershipListener.class.isAssignableFrom(sut));
    }

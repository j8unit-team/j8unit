...
public abstract interface DefaultPersistenceDelegateClassTests<SUT extends DefaultPersistenceDelegate>
extends PersistenceDelegateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultPersistenceDelegate.class!",
                   DefaultPersistenceDelegate.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.beans.DefaultPersistenceDelegate]

 ...
 * java.beans.DefaultPersistenceDelegate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link DefaultPersistenceDelegateTests}).
 * </p>
 *
 * <p>
 ...
 * @see DefaultPersistenceDelegateTests DefaultPersistenceDelegateTests (The complementary j8unit test interface
...
extends PersistenceDelegateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.DefaultPersistenceDelegate.class!",
                   java.beans.DefaultPersistenceDelegate.class.isAssignableFrom(sut));
    }

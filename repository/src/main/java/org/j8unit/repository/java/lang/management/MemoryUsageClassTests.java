 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MemoryUsage public
...
public abstract interface MemoryUsageClassTests<SUT extends MemoryUsage>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryUsage.class!",
                   MemoryUsage.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.lang.management.MemoryUsage]

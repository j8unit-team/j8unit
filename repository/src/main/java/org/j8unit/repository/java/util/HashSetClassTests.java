...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.HashSet class java.util.HashSet}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HashSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HashSetTests}.
 * </p>
 *
 * @see java.util.HashSet class java.util.HashSet (the hereby targeted class-under-test class)
 * @see HashSetTests HashSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.HashSet.class!",
                   java.util.HashSet.class.isAssignableFrom(sut));
    }

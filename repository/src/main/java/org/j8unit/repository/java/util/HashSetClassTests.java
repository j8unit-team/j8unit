 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HashSet public
...
public abstract interface HashSetClassTests<SUT extends HashSet>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HashSet.class!",

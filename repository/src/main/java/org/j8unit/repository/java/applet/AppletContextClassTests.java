...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.applet.AppletContext interface java.applet.AppletContext},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AppletContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AppletContextTests}.
 * </p>
 *
 * @see java.applet.AppletContext interface java.applet.AppletContext (the hereby targeted class-under-test class)
 * @see AppletContextTests AppletContextTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AppletContextClassTests<SUT extends java.applet.AppletContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.applet.AppletContext.class!",
                   java.applet.AppletContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AppletContext
...
public abstract interface AppletContextClassTests<SUT extends AppletContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AppletContext.class!",
                   AppletContext.class.isAssignableFrom(sut));
    }

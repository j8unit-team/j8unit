...
public abstract interface AccessControlContextClassTests<SUT extends AccessControlContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessControlContext.class!",
                   AccessControlContext.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.AccessControlContext class
 * java.security.AccessControlContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessControlContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AccessControlContextTests}
 * .
 * </p>
 *
 * @see java.security.AccessControlContext class java.security.AccessControlContext (the hereby targeted
 *      class-under-test class)
 * @see AccessControlContextTests AccessControlContextTests (The complementary j8unit test interface containing the
...
public abstract interface AccessControlContextClassTests<SUT extends java.security.AccessControlContext>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.AccessControlContext.class!",
                   java.security.AccessControlContext.class.isAssignableFrom(sut));
    }

 ...
 * {@link CalendarNameProviderTests}.
 * </p>
 *
 * <p>
...
public abstract interface CalendarNameProviderClassTests<SUT extends CalendarNameProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CalendarNameProvider.class!",
                   CalendarNameProvider.class.isAssignableFrom(sut));
    }

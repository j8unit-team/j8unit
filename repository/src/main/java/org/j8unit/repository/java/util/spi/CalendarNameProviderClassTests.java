 ...
 * java.util.spi.CalendarNameProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CalendarNameProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CalendarNameProviderTests}
 * .
 * </p>
 *
 * @see java.util.spi.CalendarNameProvider class java.util.spi.CalendarNameProvider (the hereby targeted
 *      class-under-test class)
 * @see CalendarNameProviderTests CalendarNameProviderTests (The complementary j8unit test interface containing the
...
public abstract interface CalendarNameProviderClassTests<SUT extends java.util.spi.CalendarNameProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.spi.CalendarNameProvider.class!",
                   java.util.spi.CalendarNameProvider.class.isAssignableFrom(sut));
    }

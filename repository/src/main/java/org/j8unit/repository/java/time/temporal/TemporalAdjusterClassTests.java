 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalAdjuster
 * public abstract interface java.time.temporal.TemporalAdjuster}.
 *
...
public abstract interface TemporalAdjusterClassTests<SUT extends TemporalAdjuster>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalAdjuster.class!",
                   TemporalAdjuster.class.isAssignableFrom(sut));
    }

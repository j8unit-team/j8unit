 ...
 * java.time.temporal.TemporalAdjuster}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalAdjusterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalAdjusterTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalAdjuster interface java.time.temporal.TemporalAdjuster (the hereby targeted
 *      class-under-test class)
 * @see TemporalAdjusterTests TemporalAdjusterTests (The complementary j8unit test interface containing the instance
...
public abstract interface TemporalAdjusterClassTests<SUT extends java.time.temporal.TemporalAdjuster>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalAdjuster.class!",
                   java.time.temporal.TemporalAdjuster.class.isAssignableFrom(sut));
    }

 ...
 * java.security.NoSuchProviderException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchProviderExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see NoSuchProviderExceptionTests NoSuchProviderExceptionTests (The complementary j8unit test interface containing
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.NoSuchProviderException.class!",
                   java.security.NoSuchProviderException.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.dnd.MouseDragGestureRecognizer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see java.awt.dnd.MouseDragGestureRecognizer class java.awt.dnd.MouseDragGestureRecognizer (the hereby targeted
 *      class-under-test class)
 * @see MouseDragGestureRecognizerTests MouseDragGestureRecognizerTests (The complementary j8unit test interface
...
public abstract interface MouseDragGestureRecognizerClassTests<SUT extends java.awt.dnd.MouseDragGestureRecognizer>
...
DragGestureRecognizerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.MouseDragGestureRecognizer.class!",
                   java.awt.dnd.MouseDragGestureRecognizer.class.isAssignableFrom(sut));
    }

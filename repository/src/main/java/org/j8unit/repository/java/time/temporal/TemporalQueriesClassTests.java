 ...
 * java.time.temporal.TemporalQueries}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalQueriesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalQueriesTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalQueries class java.time.temporal.TemporalQueries (the hereby targeted
 *      class-under-test class)
 * @see TemporalQueriesTests TemporalQueriesTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalQueries.class!",
                   java.time.temporal.TemporalQueries.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalQueries
...
public abstract interface TemporalQueriesClassTests<SUT extends TemporalQueries>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalQueries.class!",
                   TemporalQueries.class.isAssignableFrom(sut));
    }

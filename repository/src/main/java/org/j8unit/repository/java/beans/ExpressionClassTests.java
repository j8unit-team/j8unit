...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.Expression class java.beans.Expression}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExpressionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExpressionTests}.
 * </p>
 *
 * @see java.beans.Expression class java.beans.Expression (the hereby targeted class-under-test class)
 * @see ExpressionTests ExpressionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ExpressionClassTests<SUT extends java.beans.Expression>
extends StatementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.Expression.class!",
                   java.beans.Expression.class.isAssignableFrom(sut));
    }

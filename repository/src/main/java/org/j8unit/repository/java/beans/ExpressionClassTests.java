 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Expression public
...
public abstract interface ExpressionClassTests<SUT extends Expression>
extends StatementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Expression.class!",
                   Expression.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.Clock class java.time.Clock}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClockTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClockTests}.
 * </p>
 *
 * @see java.time.Clock class java.time.Clock (the hereby targeted class-under-test class)
 * @see ClockTests ClockTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.Clock.class!",
                   java.time.Clock.class.isAssignableFrom(sut));
    }

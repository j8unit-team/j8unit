 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Clock public
...
public abstract interface ClockClassTests<SUT extends Clock>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Clock.class!", Clock.class.isAssignableFrom(sut));
    }

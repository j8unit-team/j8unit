 ...
 * java.security.cert.X509Extension}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509ExtensionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509ExtensionTests}.
 * </p>
 *
 * @see java.security.cert.X509Extension interface java.security.cert.X509Extension (the hereby targeted
 *      class-under-test class)
 * @see X509ExtensionTests X509ExtensionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface X509ExtensionClassTests<SUT extends java.security.cert.X509Extension>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.X509Extension.class!",
                   java.security.cert.X509Extension.class.isAssignableFrom(sut));
    }

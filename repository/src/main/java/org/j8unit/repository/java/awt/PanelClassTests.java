...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Panel class java.awt.Panel}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PanelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PanelTests}.
 * </p>
 *
 * @see java.awt.Panel class java.awt.Panel (the hereby targeted class-under-test class)
 * @see PanelTests PanelTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface PanelClassTests<SUT extends java.awt.Panel>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Panel.class!",
                   java.awt.Panel.class.isAssignableFrom(sut));
    }

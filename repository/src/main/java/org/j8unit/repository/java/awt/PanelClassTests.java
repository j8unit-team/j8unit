 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Panel public class
 * java.awt.Panel}.
 *
...
public abstract interface PanelClassTests<SUT extends Panel>
extends AccessibleClassTests<SUT>, ContainerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Panel.class!", Panel.class.isAssignableFrom(sut));
    }

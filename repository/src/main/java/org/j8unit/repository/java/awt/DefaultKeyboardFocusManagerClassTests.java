 ...
 * java.awt.DefaultKeyboardFocusManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link DefaultKeyboardFocusManagerTests}).
 * </p>
 *
 * <p>
 ...
 * @see DefaultKeyboardFocusManagerTests DefaultKeyboardFocusManagerTests (The complementary j8unit test interface
...
extends KeyboardFocusManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.DefaultKeyboardFocusManager.class!",
                   java.awt.DefaultKeyboardFocusManager.class.isAssignableFrom(sut));
    }

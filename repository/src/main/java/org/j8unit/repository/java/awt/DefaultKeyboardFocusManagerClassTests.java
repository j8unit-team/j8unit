...
public abstract interface DefaultKeyboardFocusManagerClassTests<SUT extends DefaultKeyboardFocusManager>
extends KeyboardFocusManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultKeyboardFocusManager.class!",
                   DefaultKeyboardFocusManager.class.isAssignableFrom(sut));
    }

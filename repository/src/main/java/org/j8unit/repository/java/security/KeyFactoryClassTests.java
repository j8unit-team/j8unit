 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyFactory public
...
public abstract interface KeyFactoryClassTests<SUT extends KeyFactory>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyFactory.class!",
                   KeyFactory.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyFactoryTests}.
 * </p>
 *
 * @see java.security.KeyFactory class java.security.KeyFactory (the hereby targeted class-under-test class)
 * @see KeyFactoryTests KeyFactoryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.KeyFactory.class!",
                   java.security.KeyFactory.class.isAssignableFrom(sut));
    }

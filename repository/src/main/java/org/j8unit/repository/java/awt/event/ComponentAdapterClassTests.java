 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComponentAdapter
...
public abstract interface ComponentAdapterClassTests<SUT extends ComponentAdapter>
extends ComponentListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentAdapter.class!",
                   ComponentAdapter.class.isAssignableFrom(sut));
    }

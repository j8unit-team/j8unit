 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentAdapterTests}.
 * </p>
 *
 * @see java.awt.event.ComponentAdapter class java.awt.event.ComponentAdapter (the hereby targeted class-under-test
 *      class)
 * @see ComponentAdapterTests ComponentAdapterTests (The complementary j8unit test interface containing the instance
...
public abstract interface ComponentAdapterClassTests<SUT extends java.awt.event.ComponentAdapter>
extends ComponentListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ComponentAdapter.class!",
                   java.awt.event.ComponentAdapter.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PhantomReferenceTests}).
 * </p>
 *
 * <p>
 ...
 * @see PhantomReferenceTests PhantomReferenceTests (The complementary j8unit test interface containing the instance
...
extends ReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.ref.PhantomReference.class!",
                   java.lang.ref.PhantomReference.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PhantomReference
 * public class java.lang.ref.PhantomReference<T>}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PhantomReferenceTests}.
 * </p>
 *
 * <p>
...
public abstract interface PhantomReferenceClassTests<SUT extends PhantomReference>
extends ReferenceClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.lang.ref.PhantomReference]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PhantomReference.class!",
                   PhantomReference.class.isAssignableFrom(sut));
    }

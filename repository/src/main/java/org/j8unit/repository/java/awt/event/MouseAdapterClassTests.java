 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseAdapter public
 * abstract class java.awt.event.MouseAdapter}.
 *
...
public abstract interface MouseAdapterClassTests<SUT extends MouseAdapter>
extends MouseListenerClassTests<SUT>, MouseWheelListenerClassTests<SUT>, MouseMotionListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseAdapter.class!",

 ...
 * {@link GarbageCollectorMXBean public abstract interface java.lang.management.GarbageCollectorMXBean}.
 *
...
extends MemoryManagerMXBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GarbageCollectorMXBean.class!",
                   GarbageCollectorMXBean.class.isAssignableFrom(sut));
    }

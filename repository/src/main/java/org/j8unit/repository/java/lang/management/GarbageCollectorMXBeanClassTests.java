 ...
 * java.lang.management.GarbageCollectorMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GarbageCollectorMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 * @see GarbageCollectorMXBeanTests GarbageCollectorMXBeanTests (The complementary j8unit test interface containing the
...
public abstract interface GarbageCollectorMXBeanClassTests<SUT extends java.lang.management.GarbageCollectorMXBean>
extends MemoryManagerMXBeanClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.GarbageCollectorMXBean.class!",
                   java.lang.management.GarbageCollectorMXBean.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CallableStatement
 * public abstract interface java.sql.CallableStatement}.
 *
...
public abstract interface CallableStatementClassTests<SUT extends CallableStatement>
extends PreparedStatementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CallableStatement.class!",
                   CallableStatement.class.isAssignableFrom(sut));
    }

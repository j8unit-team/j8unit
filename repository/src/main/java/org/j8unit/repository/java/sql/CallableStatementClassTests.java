 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CallableStatementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CallableStatementTests}.
 * </p>
 *
 * @see java.sql.CallableStatement interface java.sql.CallableStatement (the hereby targeted class-under-test class)
 * @see CallableStatementTests CallableStatementTests (The complementary j8unit test interface containing the instance
...
public abstract interface CallableStatementClassTests<SUT extends java.sql.CallableStatement>
extends PreparedStatementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.CallableStatement.class!",
                   java.sql.CallableStatement.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.InputMethodListener interface
 * java.awt.event.InputMethodListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputMethodListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InputMethodListenerTests}.
 * </p>
 *
 * @see java.awt.event.InputMethodListener interface java.awt.event.InputMethodListener (the hereby targeted
 *      class-under-test class)
 * @see InputMethodListenerTests InputMethodListenerTests (The complementary j8unit test interface containing the
...
public abstract interface InputMethodListenerClassTests<SUT extends java.awt.event.InputMethodListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.InputMethodListener.class!",
                   java.awt.event.InputMethodListener.class.isAssignableFrom(sut));
    }

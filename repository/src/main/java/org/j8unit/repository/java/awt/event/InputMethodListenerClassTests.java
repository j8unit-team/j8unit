 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMethodListener
 * public abstract interface java.awt.event.InputMethodListener}.
 *
...
public abstract interface InputMethodListenerClassTests<SUT extends InputMethodListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMethodListener.class!",
                   InputMethodListener.class.isAssignableFrom(sut));
    }

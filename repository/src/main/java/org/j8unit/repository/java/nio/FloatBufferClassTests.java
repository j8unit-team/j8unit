 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FloatBuffer public
 * abstract class java.nio.FloatBuffer}.
 *
...
public abstract interface FloatBufferClassTests<SUT extends FloatBuffer>
extends ComparableClassTests<SUT>, BufferClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.FloatBuffer]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FloatBuffer.class!",
                   FloatBuffer.class.isAssignableFrom(sut));
    }

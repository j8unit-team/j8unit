...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.FloatBuffer class java.nio.FloatBuffer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FloatBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FloatBufferTests}.
 * </p>
 *
 * @see java.nio.FloatBuffer class java.nio.FloatBuffer (the hereby targeted class-under-test class)
 * @see FloatBufferTests FloatBufferTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.FloatBuffer.class!",
                   java.nio.FloatBuffer.class.isAssignableFrom(sut));
    }

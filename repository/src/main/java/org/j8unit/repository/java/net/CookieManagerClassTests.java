 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CookieManager
...
public abstract interface CookieManagerClassTests<SUT extends CookieManager>
extends CookieHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CookieManager.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CookieManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CookieManagerTests}.
 * </p>
 *
 * @see java.net.CookieManager class java.net.CookieManager (the hereby targeted class-under-test class)
 * @see CookieManagerTests CookieManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends CookieHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.CookieManager.class!",
                   java.net.CookieManager.class.isAssignableFrom(sut));
    }

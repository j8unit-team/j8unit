...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IncompatibleClassChangeError class
 * java.lang.IncompatibleClassChangeError}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link IncompatibleClassChangeErrorTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see IncompatibleClassChangeErrorTests IncompatibleClassChangeErrorTests (The complementary j8unit test interface
...
public abstract interface IncompatibleClassChangeErrorClassTests<SUT extends IncompatibleClassChangeError>
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IncompatibleClassChangeError.class!",

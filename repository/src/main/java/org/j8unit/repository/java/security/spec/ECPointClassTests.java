 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECPoint public
...
public abstract interface ECPointClassTests<SUT extends ECPoint>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECPoint.class!",
                   ECPoint.class.isAssignableFrom(sut));
    }

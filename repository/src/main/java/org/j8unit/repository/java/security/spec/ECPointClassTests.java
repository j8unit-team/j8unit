 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECPointTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECPointTests}.
 * </p>
 *
 * @see java.security.spec.ECPoint class java.security.spec.ECPoint (the hereby targeted class-under-test class)
 * @see ECPointTests ECPointTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECPoint.class!",
                   java.security.spec.ECPoint.class.isAssignableFrom(sut));
    }

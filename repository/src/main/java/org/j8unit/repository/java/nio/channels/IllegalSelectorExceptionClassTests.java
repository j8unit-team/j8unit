 ...
 * {@link IllegalSelectorException public class java.nio.channels.IllegalSelectorException}.
 *
...
public abstract interface IllegalSelectorExceptionClassTests<SUT extends IllegalSelectorException>
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalSelectorException.class!",
                   IllegalSelectorException.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.IllegalSelectorException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IllegalSelectorExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link IllegalSelectorExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.IllegalSelectorException class java.nio.channels.IllegalSelectorException (the hereby targeted
 *      class-under-test class)
 * @see IllegalSelectorExceptionTests IllegalSelectorExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.IllegalSelectorException.class!",
                   java.nio.channels.IllegalSelectorException.class.isAssignableFrom(sut));
    }

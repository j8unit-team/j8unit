...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.math.BigDecimal class java.math.BigDecimal}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BigDecimalTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BigDecimalTests}.
 * </p>
 *
 * @see java.math.BigDecimal class java.math.BigDecimal (the hereby targeted class-under-test class)
 * @see BigDecimalTests BigDecimalTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.math.BigDecimal.class!",
                   java.math.BigDecimal.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BigDecimal public
...
public abstract interface BigDecimalClassTests<SUT extends BigDecimal>
extends ComparableClassTests<SUT>, NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BigDecimal.class!",
                   BigDecimal.class.isAssignableFrom(sut));
    }

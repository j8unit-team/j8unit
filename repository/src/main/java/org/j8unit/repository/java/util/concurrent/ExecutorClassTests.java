 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExecutorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExecutorTests}.
 * </p>
 *
 * @see java.util.concurrent.Executor interface java.util.concurrent.Executor (the hereby targeted class-under-test
 *      class)
 * @see ExecutorTests ExecutorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ExecutorClassTests<SUT extends java.util.concurrent.Executor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Executor.class!",
                   java.util.concurrent.Executor.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Executor public
 * abstract interface java.util.concurrent.Executor}.
 *
...
public abstract interface ExecutorClassTests<SUT extends Executor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Executor.class!",
                   Executor.class.isAssignableFrom(sut));
    }

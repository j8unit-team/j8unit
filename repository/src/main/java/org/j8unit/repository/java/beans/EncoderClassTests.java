...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.Encoder class java.beans.Encoder}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EncoderTests}).
 * </p>
 *
 * <p>
 ...
 * @see EncoderTests EncoderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.Encoder.class!",
                   java.beans.Encoder.class.isAssignableFrom(sut));
    }

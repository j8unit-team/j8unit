...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ThreadDeath class java.lang.ThreadDeath}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadDeathTests}).
 * </p>
 *
 * <p>
 ...
 * @see ThreadDeathTests ThreadDeathTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadDeath.class!",
                   ThreadDeath.class.isAssignableFrom(sut));
    }

...
public abstract interface ECFieldF2mClassTests<SUT extends java.security.spec.ECFieldF2m>
extends org.j8unit.repository.java.security.spec.ECFieldClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.security.spec.ECFieldF2m#ECFieldF2m(int)
     */
    ...
    /**
     * <p>
     * Test method for {@link java.security.spec.ECFieldF2m#ECFieldF2m(int, java.math.BigInteger) public
     ...
     * </p>
     *
     * @j8unit.aim java.security.spec.ECFieldF2m#ECFieldF2m(int, java.math.BigInteger)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ECFieldF2m_int_BigInteger()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.security.spec.ECFieldF2m sut = null; // = new ECFieldF2m(int, java.math.BigInteger);
    }
     ...
     * </p>
     *
     * @j8unit.aim java.security.spec.ECFieldF2m#ECFieldF2m(int, int[])
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.security.spec.ECFieldF2m#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

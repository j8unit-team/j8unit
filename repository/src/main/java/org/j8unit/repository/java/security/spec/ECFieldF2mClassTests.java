 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECFieldF2mTests}).
 * </p>
 *
 * <p>
 ...
 * @see ECFieldF2mTests ECFieldF2mTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ECFieldClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECFieldF2m.class!",
                   java.security.spec.ECFieldF2m.class.isAssignableFrom(sut));
    }

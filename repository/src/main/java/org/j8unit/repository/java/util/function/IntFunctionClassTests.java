...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.IntFunction interface
 * java.util.function.IntFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntFunctionTests}.
 * </p>
 *
 * @see java.util.function.IntFunction interface java.util.function.IntFunction (the hereby targeted class-under-test
 *      class)
 * @see IntFunctionTests IntFunctionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IntFunctionClassTests<SUT extends java.util.function.IntFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntFunction.class!",
                   java.util.function.IntFunction.class.isAssignableFrom(sut));
    }

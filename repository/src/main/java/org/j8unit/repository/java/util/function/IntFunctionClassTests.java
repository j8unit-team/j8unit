 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntFunction public
 * abstract interface java.util.function.IntFunction<R>}.
 *
...
public abstract interface IntFunctionClassTests<SUT extends IntFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntFunction.class!",
                   IntFunction.class.isAssignableFrom(sut));
    }

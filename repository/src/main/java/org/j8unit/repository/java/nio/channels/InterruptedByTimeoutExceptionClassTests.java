 ...
 * java.nio.channels.InterruptedByTimeoutException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InterruptedByTimeoutExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InterruptedByTimeoutExceptionTests InterruptedByTimeoutExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.InterruptedByTimeoutException.class!",
                   java.nio.channels.InterruptedByTimeoutException.class.isAssignableFrom(sut));
    }

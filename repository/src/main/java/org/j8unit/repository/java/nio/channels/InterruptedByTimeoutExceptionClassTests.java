...
public abstract interface InterruptedByTimeoutExceptionClassTests<SUT extends InterruptedByTimeoutException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InterruptedByTimeoutException.class!",
                   InterruptedByTimeoutException.class.isAssignableFrom(sut));
    }

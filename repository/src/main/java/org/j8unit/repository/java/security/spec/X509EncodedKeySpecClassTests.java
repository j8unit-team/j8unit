 ...
 * java.security.spec.X509EncodedKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509EncodedKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509EncodedKeySpecTests}.
 * </p>
 *
 * @see java.security.spec.X509EncodedKeySpec class java.security.spec.X509EncodedKeySpec (the hereby targeted
 *      class-under-test class)
 * @see X509EncodedKeySpecTests X509EncodedKeySpecTests (The complementary j8unit test interface containing the instance
...
extends EncodedKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.X509EncodedKeySpec.class!",
                   java.security.spec.X509EncodedKeySpec.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509EncodedKeySpec
...
public abstract interface X509EncodedKeySpecClassTests<SUT extends X509EncodedKeySpec>
extends EncodedKeySpecClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509EncodedKeySpec.class!",
                   X509EncodedKeySpec.class.isAssignableFrom(sut));
    }

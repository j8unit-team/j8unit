 ...
 * {@link AlreadyBoundException public class java.nio.channels.AlreadyBoundException}.
 *
...
public abstract interface AlreadyBoundExceptionClassTests<SUT extends AlreadyBoundException>
extends IllegalStateExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.AlreadyBoundException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlreadyBoundException.class!",
                   AlreadyBoundException.class.isAssignableFrom(sut));
    }

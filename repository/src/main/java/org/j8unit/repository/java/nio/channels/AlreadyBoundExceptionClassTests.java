 ...
 * java.nio.channels.AlreadyBoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AlreadyBoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AlreadyBoundExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.AlreadyBoundException class java.nio.channels.AlreadyBoundException (the hereby targeted
 *      class-under-test class)
 * @see AlreadyBoundExceptionTests AlreadyBoundExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AlreadyBoundException.class!",
                   java.nio.channels.AlreadyBoundException.class.isAssignableFrom(sut));
    }

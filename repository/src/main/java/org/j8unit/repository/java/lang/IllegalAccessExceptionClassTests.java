...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IllegalAccessException class java.lang.IllegalAccessException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IllegalAccessExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link IllegalAccessExceptionTests}.
 * </p>
 *
 * @see IllegalAccessException class java.lang.IllegalAccessException (the hereby targeted class-under-test class)
 * @see IllegalAccessExceptionTests IllegalAccessExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface IllegalAccessExceptionClassTests<SUT extends IllegalAccessException>
extends ReflectiveOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalAccessException.class!",
                   IllegalAccessException.class.isAssignableFrom(sut));
    }

 ...
 * java.time.temporal.TemporalAdjusters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalAdjustersTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalAdjustersTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalAdjusters class java.time.temporal.TemporalAdjusters (the hereby targeted
 *      class-under-test class)
 * @see TemporalAdjustersTests TemporalAdjustersTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalAdjusters.class!",
                   java.time.temporal.TemporalAdjusters.class.isAssignableFrom(sut));
    }

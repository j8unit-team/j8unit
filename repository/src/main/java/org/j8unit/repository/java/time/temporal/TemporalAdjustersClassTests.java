 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalAdjusters
...
public abstract interface TemporalAdjustersClassTests<SUT extends TemporalAdjusters>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.temporal.TemporalAdjusters]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalAdjusters.class!",
                   TemporalAdjusters.class.isAssignableFrom(sut));
    }

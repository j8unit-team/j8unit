 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Label public class
 * java.awt.Label}.
 *
...
public abstract interface LabelClassTests<SUT extends Label>
extends AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Label.class!", Label.class.isAssignableFrom(sut));
    }

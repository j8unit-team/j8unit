 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Adjustable public
 * abstract interface java.awt.Adjustable}.
 *
...
public abstract interface AdjustableClassTests<SUT extends Adjustable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Adjustable.class!",
                   Adjustable.class.isAssignableFrom(sut));
    }

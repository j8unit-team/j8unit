...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Adjustable interface java.awt.Adjustable}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AdjustableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AdjustableTests}.
 * </p>
 *
 * @see java.awt.Adjustable interface java.awt.Adjustable (the hereby targeted class-under-test class)
 * @see AdjustableTests AdjustableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AdjustableClassTests<SUT extends java.awt.Adjustable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Adjustable.class!",
                   java.awt.Adjustable.class.isAssignableFrom(sut));
    }

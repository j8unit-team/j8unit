 ...
 * java.util.concurrent.AbstractExecutorService}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractExecutorServiceTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AbstractExecutorServiceTests}.
 * </p>
 *
 * @see java.util.concurrent.AbstractExecutorService class java.util.concurrent.AbstractExecutorService (the hereby
 *      targeted class-under-test class)
 * @see AbstractExecutorServiceTests AbstractExecutorServiceTests (The complementary j8unit test interface containing
...
extends ExecutorServiceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.AbstractExecutorService.class!",
                   java.util.concurrent.AbstractExecutorService.class.isAssignableFrom(sut));
    }

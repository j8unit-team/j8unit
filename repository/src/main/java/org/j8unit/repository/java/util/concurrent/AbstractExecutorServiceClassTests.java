 ...
 * {@link AbstractExecutorService public abstract class java.util.concurrent.AbstractExecutorService}.
 *
...
public abstract interface AbstractExecutorServiceClassTests<SUT extends AbstractExecutorService>
extends org.j8unit.repository.java.util.concurrent.ExecutorServiceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractExecutorService.class!",
                   AbstractExecutorService.class.isAssignableFrom(sut));
    }

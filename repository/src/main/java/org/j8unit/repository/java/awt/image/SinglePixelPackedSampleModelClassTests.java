 ...
 * java.awt.image.SinglePixelPackedSampleModel}, containing all class relevant test methods (at least the test methods
...
extends org.j8unit.repository.java.awt.image.SampleModelClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.awt.image.SinglePixelPackedSampleModel#SinglePixelPackedSampleModel(int, int, int, int, int[])
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_SinglePixelPackedSampleModel_int_int_int_int_intArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.SinglePixelPackedSampleModel sut = null; // = new SinglePixelPackedSampleModel(int, int,
                                                                      // int, int, int[]);
    }
     ...
     * </p>
     *
     * @j8unit.aim java.awt.image.SinglePixelPackedSampleModel#SinglePixelPackedSampleModel(int, int, int, int[])
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_SinglePixelPackedSampleModel_int_int_int_intArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.SinglePixelPackedSampleModel sut = null; // = new SinglePixelPackedSampleModel(int, int,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.awt.image.SinglePixelPackedSampleModel#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

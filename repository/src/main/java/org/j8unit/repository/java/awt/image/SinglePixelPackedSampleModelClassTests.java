...
public abstract interface SinglePixelPackedSampleModelClassTests<SUT extends SinglePixelPackedSampleModel>
extends SampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SinglePixelPackedSampleModel.class!",
                   SinglePixelPackedSampleModel.class.isAssignableFrom(sut));
    }

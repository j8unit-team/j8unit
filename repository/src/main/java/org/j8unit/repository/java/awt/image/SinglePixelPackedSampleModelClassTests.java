 ...
 * java.awt.image.SinglePixelPackedSampleModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link SinglePixelPackedSampleModelTests}).
 * </p>
 *
 * <p>
 ...
 * @see SinglePixelPackedSampleModelTests SinglePixelPackedSampleModelTests (The complementary j8unit test interface
...
extends SampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.SinglePixelPackedSampleModel.class!",
                   java.awt.image.SinglePixelPackedSampleModel.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InputEventTests}.
 * </p>
 *
 * @see java.awt.event.InputEvent class java.awt.event.InputEvent (the hereby targeted class-under-test class)
 * @see InputEventTests InputEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InputEventClassTests<SUT extends java.awt.event.InputEvent>
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.InputEvent.class!",
                   java.awt.event.InputEvent.class.isAssignableFrom(sut));
    }

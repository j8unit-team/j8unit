 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputEvent public
...
public abstract interface InputEventClassTests<SUT extends InputEvent>
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputEvent.class!",
                   InputEvent.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.java.awt.event.ComponentEventClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.awt.event.InputEvent#getMaskForButton(int)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.awt.event.InputEvent#getModifiersExText(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.awt.event.InputEvent#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

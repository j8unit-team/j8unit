...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.Predicate interface java.util.function.Predicate},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PredicateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PredicateTests}.
 * </p>
 *
 * @see java.util.function.Predicate interface java.util.function.Predicate (the hereby targeted class-under-test class)
 * @see PredicateTests PredicateTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PredicateClassTests<SUT extends java.util.function.Predicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.Predicate.class!",
                   java.util.function.Predicate.class.isAssignableFrom(sut));
    }

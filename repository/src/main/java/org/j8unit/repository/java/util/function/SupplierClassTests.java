 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SupplierTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SupplierTests}.
 * </p>
 *
 * @see java.util.function.Supplier interface java.util.function.Supplier (the hereby targeted class-under-test class)
 * @see SupplierTests SupplierTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.Supplier.class!",
                   java.util.function.Supplier.class.isAssignableFrom(sut));
    }

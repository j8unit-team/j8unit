 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Supplier public
 * abstract interface java.util.function.Supplier<T>}.
 *
...
public abstract interface SupplierClassTests<SUT extends Supplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Supplier.class!",
                   Supplier.class.isAssignableFrom(sut));
    }

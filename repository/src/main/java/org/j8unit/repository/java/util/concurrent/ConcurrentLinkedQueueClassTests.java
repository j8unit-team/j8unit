 ...
 * java.util.concurrent.ConcurrentLinkedQueue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConcurrentLinkedQueueTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ConcurrentLinkedQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.ConcurrentLinkedQueue class java.util.concurrent.ConcurrentLinkedQueue (the hereby targeted
 *      class-under-test class)
 * @see ConcurrentLinkedQueueTests ConcurrentLinkedQueueTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ConcurrentLinkedQueue.class!",
                   java.util.concurrent.ConcurrentLinkedQueue.class.isAssignableFrom(sut));
    }

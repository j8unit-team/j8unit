...
public abstract interface ConcurrentLinkedQueueClassTests<SUT extends ConcurrentLinkedQueue>
extends SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConcurrentLinkedQueue.class!",
                   ConcurrentLinkedQueue.class.isAssignableFrom(sut));
    }

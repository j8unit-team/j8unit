 ...
 * java.util.function.DoubleBinaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleBinaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleBinaryOperatorTests}
 * .
 * </p>
 *
 * @see java.util.function.DoubleBinaryOperator interface java.util.function.DoubleBinaryOperator (the hereby targeted
 *      class-under-test class)
 * @see DoubleBinaryOperatorTests DoubleBinaryOperatorTests (The complementary j8unit test interface containing the
...
public abstract interface DoubleBinaryOperatorClassTests<SUT extends java.util.function.DoubleBinaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoubleBinaryOperator.class!",
                   java.util.function.DoubleBinaryOperator.class.isAssignableFrom(sut));
    }

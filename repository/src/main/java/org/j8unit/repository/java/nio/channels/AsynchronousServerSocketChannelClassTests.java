 ...
 * java.nio.channels.AsynchronousServerSocketChannel}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AsynchronousServerSocketChannelTests}).
 * </p>
 *
 * <p>
 ...
 * @see AsynchronousServerSocketChannelTests AsynchronousServerSocketChannelTests (The complementary j8unit test
...
extends AsynchronousChannelClassTests<SUT>, NetworkChannelClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AsynchronousServerSocketChannel.class!",
                   java.nio.channels.AsynchronousServerSocketChannel.class.isAssignableFrom(sut));
    }

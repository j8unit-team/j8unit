 ...
 * {@link AsynchronousServerSocketChannel public abstract class java.nio.channels.AsynchronousServerSocketChannel}.
 *
...
public abstract interface AsynchronousServerSocketChannelClassTests<SUT extends AsynchronousServerSocketChannel>
extends AsynchronousChannelClassTests<SUT>, NetworkChannelClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsynchronousServerSocketChannel.class!",
                   AsynchronousServerSocketChannel.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyStoreExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see KeyStoreExceptionTests KeyStoreExceptionTests (The complementary j8unit test interface containing the instance
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.KeyStoreException.class!",
                   java.security.KeyStoreException.class.isAssignableFrom(sut));
    }

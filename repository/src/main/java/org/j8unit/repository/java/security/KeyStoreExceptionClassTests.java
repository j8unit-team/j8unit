...
/**
 * <p>
 * Test class for {@link java.security.KeyStoreException class java.security.KeyStoreException}, containing all class
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.security.KeyStoreException sut = null; // = new
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.security.KeyStoreException> sut = createNewSUT();

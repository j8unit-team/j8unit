 ...
 * java.text.spi.DateFormatSymbolsProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link DateFormatSymbolsProviderTests}).
 * </p>
 *
 * <p>
 ...
 * @see DateFormatSymbolsProviderTests DateFormatSymbolsProviderTests (The complementary j8unit test interface
...
public abstract interface DateFormatSymbolsProviderClassTests<SUT extends java.text.spi.DateFormatSymbolsProvider>
extends org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.spi.DateFormatSymbolsProvider.class!",
                   java.text.spi.DateFormatSymbolsProvider.class.isAssignableFrom(sut));
    }

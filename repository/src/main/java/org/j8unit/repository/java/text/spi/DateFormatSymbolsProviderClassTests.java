 ...
 * {@link DateFormatSymbolsProvider public abstract class java.text.spi.DateFormatSymbolsProvider}.
 *
...
public abstract interface DateFormatSymbolsProviderClassTests<SUT extends DateFormatSymbolsProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateFormatSymbolsProvider.class!",
                   DateFormatSymbolsProvider.class.isAssignableFrom(sut));
    }

 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.net.DatagramPacket
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.net.DatagramPacket#DatagramPacket(byte[], int)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.net.DatagramPacket#DatagramPacket(byte[], int, java.net.InetAddress, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.net.DatagramPacket#DatagramPacket(byte[], int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.net.DatagramPacket#DatagramPacket(byte[], int, int, java.net.InetAddress, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.net.DatagramPacket#DatagramPacket(byte[], int, int, java.net.SocketAddress)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.net.DatagramPacket#DatagramPacket(byte[], int, java.net.SocketAddress)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.net.DatagramPacket#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

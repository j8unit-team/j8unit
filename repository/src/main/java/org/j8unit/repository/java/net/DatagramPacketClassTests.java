 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DatagramPacket
...
public abstract interface DatagramPacketClassTests<SUT extends DatagramPacket>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatagramPacket.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.DatagramPacket class java.net.DatagramPacket}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DatagramPacketTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DatagramPacketTests}.
 * </p>
 *
 * @see java.net.DatagramPacket class java.net.DatagramPacket (the hereby targeted class-under-test class)
 * @see DatagramPacketTests DatagramPacketTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.DatagramPacket.class!",
                   java.net.DatagramPacket.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.SQLWarning class java.sql.SQLWarning}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLWarningTests}).
 * </p>
 *
 * <p>
 ...
 * @see SQLWarningTests SQLWarningTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLWarning.class!",
                   java.sql.SQLWarning.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Wrapper public
 * abstract interface java.sql.Wrapper}.
 *
...
public abstract interface WrapperClassTests<SUT extends Wrapper>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Wrapper.class!",
                   Wrapper.class.isAssignableFrom(sut));
    }

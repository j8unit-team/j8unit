...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Wrapper interface java.sql.Wrapper}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WrapperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WrapperTests}.
 * </p>
 *
 * @see java.sql.Wrapper interface java.sql.Wrapper (the hereby targeted class-under-test class)
 * @see WrapperTests WrapperTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface WrapperClassTests<SUT extends java.sql.Wrapper>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Wrapper.class!",
                   java.sql.Wrapper.class.isAssignableFrom(sut));
    }

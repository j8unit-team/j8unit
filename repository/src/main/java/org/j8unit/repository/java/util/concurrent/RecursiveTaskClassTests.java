 ...
 * java.util.concurrent.RecursiveTask}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RecursiveTaskTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RecursiveTaskTests}.
 * </p>
 *
 * @see java.util.concurrent.RecursiveTask class java.util.concurrent.RecursiveTask (the hereby targeted
 *      class-under-test class)
 * @see RecursiveTaskTests RecursiveTaskTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ForkJoinTaskClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.RecursiveTask.class!",
                   java.util.concurrent.RecursiveTask.class.isAssignableFrom(sut));
    }

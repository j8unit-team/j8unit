 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RecursiveTask
 * public abstract class java.util.concurrent.RecursiveTask<V>}.
 *
...
public abstract interface RecursiveTaskClassTests<SUT extends RecursiveTask>
extends ForkJoinTaskClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RecursiveTask.class!",
                   RecursiveTask.class.isAssignableFrom(sut));
    }

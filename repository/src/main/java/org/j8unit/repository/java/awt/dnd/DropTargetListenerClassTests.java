 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTargetListener
 * public abstract interface java.awt.dnd.DropTargetListener}.
 *
...
public abstract interface DropTargetListenerClassTests<SUT extends DropTargetListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetListener.class!",
                   DropTargetListener.class.isAssignableFrom(sut));
    }

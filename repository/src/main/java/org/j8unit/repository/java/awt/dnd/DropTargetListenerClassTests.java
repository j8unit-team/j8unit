...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.dnd.DropTargetListener interface
 * java.awt.dnd.DropTargetListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DropTargetListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DropTargetListenerTests}.
 * </p>
 *
 * @see java.awt.dnd.DropTargetListener interface java.awt.dnd.DropTargetListener (the hereby targeted class-under-test
 *      class)
 * @see DropTargetListenerTests DropTargetListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DropTargetListenerClassTests<SUT extends java.awt.dnd.DropTargetListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DropTargetListener.class!",
                   java.awt.dnd.DropTargetListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Date class java.sql.Date}, containing all type relevant
...
extends org.j8unit.repository.java.util.DateClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Date.class!",
                   java.sql.Date.class.isAssignableFrom(sut));
    }

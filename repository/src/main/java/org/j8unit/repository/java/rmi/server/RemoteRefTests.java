...
extends org.j8unit.repository.java.io.ExternalizableTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#done(java.rmi.server.RemoteCall)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#getRefClass(java.io.ObjectOutput)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * <p>
     * Test method for
     * {@link java.rmi.server.RemoteRef#invoke(java.rmi.Remote, java.lang.reflect.Method, java.lang.Object[], long)
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#invoke(java.rmi.Remote, java.lang.reflect.Method, java.lang.Object[], long)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#invoke(java.rmi.server.RemoteCall)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#newCall(java.rmi.server.RemoteObject, java.rmi.server.Operation[], int,
     *             long)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#remoteEquals(java.rmi.server.RemoteRef)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#remoteHashCode()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.rmi.server.RemoteRef#remoteToString()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)

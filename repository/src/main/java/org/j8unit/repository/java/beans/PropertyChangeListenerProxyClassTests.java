 ...
 * {@link PropertyChangeListenerProxy public class java.beans.PropertyChangeListenerProxy}.
 *
...
public abstract interface PropertyChangeListenerProxyClassTests<SUT extends PropertyChangeListenerProxy>
extends PropertyChangeListenerClassTests<SUT>, EventListenerProxyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyChangeListenerProxy.class!",
                   PropertyChangeListenerProxy.class.isAssignableFrom(sut));
    }

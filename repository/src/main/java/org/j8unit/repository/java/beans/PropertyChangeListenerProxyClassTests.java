 ...
 * java.beans.PropertyChangeListenerProxy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link PropertyChangeListenerProxyTests}).
 * </p>
 *
 * <p>
 ...
 * @see PropertyChangeListenerProxyTests PropertyChangeListenerProxyTests (The complementary j8unit test interface
...
extends PropertyChangeListenerClassTests<SUT>, org.j8unit.repository.java.util.EventListenerProxyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyChangeListenerProxy.class!",
                   java.beans.PropertyChangeListenerProxy.class.isAssignableFrom(sut));
    }

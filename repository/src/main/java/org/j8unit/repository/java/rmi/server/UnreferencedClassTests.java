 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Unreferenced public
 * abstract interface java.rmi.server.Unreferenced}.
 *
...
public abstract interface UnreferencedClassTests<SUT extends Unreferenced>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Unreferenced.class!",

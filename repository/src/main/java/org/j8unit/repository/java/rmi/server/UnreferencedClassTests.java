...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.server.Unreferenced interface java.rmi.server.Unreferenced},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnreferencedTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnreferencedTests}.
 * </p>
 *
 * @see java.rmi.server.Unreferenced interface java.rmi.server.Unreferenced (the hereby targeted class-under-test class)
 * @see UnreferencedTests UnreferencedTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface UnreferencedClassTests<SUT extends java.rmi.server.Unreferenced>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.Unreferenced.class!",
                   java.rmi.server.Unreferenced.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.stream.IntStream interface java.util.stream.IntStream},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntStreamTests}.
 * </p>
 *
 * @see java.util.stream.IntStream interface java.util.stream.IntStream (the hereby targeted class-under-test class)
 * @see IntStreamTests IntStreamTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends BaseStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.IntStream.class!",
                   java.util.stream.IntStream.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.stream.IntStream.Builder interface
     * java.util.stream.IntStream$Builder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link IntStreamTests.BuilderTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.util.stream.IntStream.Builder interface java.util.stream.IntStream$Builder (the hereby targeted
     *      class-under-test class)
     * @see IntStreamTests.BuilderTests IntStreamTests.BuilderTests (The complementary j8unit test interface containing
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface BuilderClassTests<SUT extends java.util.stream.IntStream.Builder>
    extends org.j8unit.repository.java.util.function.IntConsumerClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.IntStream.Builder.class!",
                       java.util.stream.IntStream.Builder.class.isAssignableFrom(sut));
        }

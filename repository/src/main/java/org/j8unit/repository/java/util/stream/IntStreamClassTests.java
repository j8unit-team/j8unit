 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntStream public
 * abstract interface java.util.stream.IntStream}.
 *
...
public abstract interface IntStreamClassTests<SUT extends IntStream>
extends BaseStreamClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.stream.IntStream]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntStream.class!",
                   IntStream.class.isAssignableFrom(sut));
    }
     ...
     * {@link Builder public abstract static interface java.util.stream.IntStream$Builder}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends IntConsumerClassTests<SUT> {

        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.stream.IntStream$Builder]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *

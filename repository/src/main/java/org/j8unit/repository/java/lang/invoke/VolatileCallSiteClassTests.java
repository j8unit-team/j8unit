 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VolatileCallSite
 * public class java.lang.invoke.VolatileCallSite}.
 *
...
public abstract interface VolatileCallSiteClassTests<SUT extends VolatileCallSite>
extends CallSiteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VolatileCallSite.class!",

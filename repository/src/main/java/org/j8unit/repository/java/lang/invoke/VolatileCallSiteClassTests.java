...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.invoke.VolatileCallSite class
 * java.lang.invoke.VolatileCallSite}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VolatileCallSiteTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link VolatileCallSiteTests}.
 * </p>
 *
 * @see java.lang.invoke.VolatileCallSite class java.lang.invoke.VolatileCallSite (the hereby targeted class-under-test
 *      class)
 * @see VolatileCallSiteTests VolatileCallSiteTests (The complementary j8unit test interface containing the instance
...
extends CallSiteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.invoke.VolatileCallSite.class!",
                   java.lang.invoke.VolatileCallSite.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.jar.Attributes class java.util.jar.Attributes}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributesTests}).
 * </p>
 *
 * <p>
 ...
 * @see AttributesTests AttributesTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.Attributes.class!",
                   java.util.jar.Attributes.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.jar.Attributes.Name class java.util.jar.Attributes$Name}
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link AttributesTests.NameTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * {@link AttributesTests.NameTests}.
     * </p>
     *
     * @see java.util.jar.Attributes.Name class java.util.jar.Attributes$Name (the hereby targeted class-under-test
     *      class)
     * @see AttributesTests.NameTests AttributesTests.NameTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.Attributes.Name.class!",
                       java.util.jar.Attributes.Name.class.isAssignableFrom(sut));
        }

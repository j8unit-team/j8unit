 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Attributes public
...
public abstract interface AttributesClassTests<SUT extends Attributes>
extends MapClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Attributes.class!",
                   Attributes.class.isAssignableFrom(sut));
    }
     ...
     * {@link Name public static class java.util.jar.Attributes$Name}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface NameClassTests<SUT extends Name>
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Name.class!",
                              Name.class.isAssignableFrom(sut));
        }

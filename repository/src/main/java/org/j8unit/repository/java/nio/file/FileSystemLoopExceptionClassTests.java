...
public abstract interface FileSystemLoopExceptionClassTests<SUT extends FileSystemLoopException>
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystemLoopException.class!",
                   FileSystemLoopException.class.isAssignableFrom(sut));
    }

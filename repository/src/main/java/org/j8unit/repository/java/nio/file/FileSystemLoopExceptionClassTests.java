...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.FileSystemLoopException class
 * java.nio.file.FileSystemLoopException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileSystemLoopExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link FileSystemLoopExceptionTests}.
 * </p>
 *
 * @see java.nio.file.FileSystemLoopException class java.nio.file.FileSystemLoopException (the hereby targeted
 *      class-under-test class)
 * @see FileSystemLoopExceptionTests FileSystemLoopExceptionTests (The complementary j8unit test interface containing
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileSystemLoopException.class!",
                   java.nio.file.FileSystemLoopException.class.isAssignableFrom(sut));
    }

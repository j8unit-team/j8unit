 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RuleBasedCollatorTests}).
 * </p>
 *
 * <p>
 ...
 * @see RuleBasedCollatorTests RuleBasedCollatorTests (The complementary j8unit test interface containing the instance
...
extends CollatorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.RuleBasedCollator.class!",
                   java.text.RuleBasedCollator.class.isAssignableFrom(sut));
    }

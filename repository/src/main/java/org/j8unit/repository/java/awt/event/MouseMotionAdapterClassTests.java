 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseMotionAdapter
...
public abstract interface MouseMotionAdapterClassTests<SUT extends MouseMotionAdapter>
extends MouseMotionListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseMotionAdapter.class!",
                   MouseMotionAdapter.class.isAssignableFrom(sut));
    }

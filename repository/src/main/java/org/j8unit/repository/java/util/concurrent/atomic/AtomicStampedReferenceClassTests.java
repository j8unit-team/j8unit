 ...
 * {@link AtomicStampedReference public class java.util.concurrent.atomic.AtomicStampedReference<V>}.
 *
...
public abstract interface AtomicStampedReferenceClassTests<SUT extends AtomicStampedReference>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicStampedReference.class!",
                   AtomicStampedReference.class.isAssignableFrom(sut));
    }

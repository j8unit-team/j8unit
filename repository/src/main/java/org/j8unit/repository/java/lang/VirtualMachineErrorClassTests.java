...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain VirtualMachineError class java.lang.VirtualMachineError}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VirtualMachineErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link VirtualMachineErrorTests}.
 * </p>
 *
 * @see VirtualMachineError class java.lang.VirtualMachineError (the hereby targeted class-under-test class)
 * @see VirtualMachineErrorTests VirtualMachineErrorTests (The complementary j8unit test interface containing the
...
public abstract interface VirtualMachineErrorClassTests<SUT extends VirtualMachineError>
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VirtualMachineError.class!",
                   VirtualMachineError.class.isAssignableFrom(sut));
    }

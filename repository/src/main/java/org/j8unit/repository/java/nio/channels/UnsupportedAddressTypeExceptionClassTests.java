 ...
 * java.nio.channels.UnsupportedAddressTypeException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UnsupportedAddressTypeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnsupportedAddressTypeExceptionTests UnsupportedAddressTypeExceptionTests (The complementary j8unit test
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.UnsupportedAddressTypeException.class!",
                   java.nio.channels.UnsupportedAddressTypeException.class.isAssignableFrom(sut));
    }

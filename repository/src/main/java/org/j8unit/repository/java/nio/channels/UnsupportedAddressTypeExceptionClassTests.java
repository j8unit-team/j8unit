 ...
 * {@link UnsupportedAddressTypeException public class java.nio.channels.UnsupportedAddressTypeException}.
 *
...
public abstract interface UnsupportedAddressTypeExceptionClassTests<SUT extends UnsupportedAddressTypeException>
extends IllegalArgumentExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.UnsupportedAddressTypeException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedAddressTypeException.class!",
                   UnsupportedAddressTypeException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.channels.UnsupportedAddressTypeException]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.nio.channels.UnsupportedAddressTypeException]

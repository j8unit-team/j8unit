...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.LineNumberReader class java.io.LineNumberReader}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LineNumberReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LineNumberReaderTests}.
 * </p>
 *
 * @see java.io.LineNumberReader class java.io.LineNumberReader (the hereby targeted class-under-test class)
 * @see LineNumberReaderTests LineNumberReaderTests (The complementary j8unit test interface containing the instance
...
extends BufferedReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.LineNumberReader.class!",
                   java.io.LineNumberReader.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LineNumberReader
...
public abstract interface LineNumberReaderClassTests<SUT extends LineNumberReader>
extends BufferedReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LineNumberReader.class!",
                   LineNumberReader.class.isAssignableFrom(sut));
    }

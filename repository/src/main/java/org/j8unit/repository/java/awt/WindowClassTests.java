 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Window public class
 * java.awt.Window}.
 *
...
public abstract interface WindowClassTests<SUT extends Window>
extends AccessibleClassTests<SUT>, ContainerClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Window]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Window.class!",
     ...
     * {@link Type public static final enum java.awt.Window$Type}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends EnumClassTests<SUT> {
        ...
        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.Window$Type]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *

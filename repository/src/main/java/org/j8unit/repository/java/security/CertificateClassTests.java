...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.Certificate interface java.security.Certificate},
...
public abstract interface CertificateClassTests<SUT extends java.security.Certificate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Certificate.class!",
                   java.security.Certificate.class.isAssignableFrom(sut));
    }

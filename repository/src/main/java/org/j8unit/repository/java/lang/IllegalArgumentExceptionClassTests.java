...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IllegalArgumentException class java.lang.IllegalArgumentException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IllegalArgumentExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link IllegalArgumentExceptionTests}.
 * </p>
 *
 * @see IllegalArgumentException class java.lang.IllegalArgumentException (the hereby targeted class-under-test class)
 * @see IllegalArgumentExceptionTests IllegalArgumentExceptionTests (The complementary j8unit test interface containing
...
public abstract interface IllegalArgumentExceptionClassTests<SUT extends IllegalArgumentException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalArgumentException.class!",
                   IllegalArgumentException.class.isAssignableFrom(sut));
    }

...
extends DataOutputClassTests<SUT>, FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.DataOutputStream.class!",
                   java.io.DataOutputStream.class.isAssignableFrom(sut));
    }

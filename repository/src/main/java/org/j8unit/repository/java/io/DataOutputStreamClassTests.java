 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataOutputStream
...
extends org.j8unit.repository.java.io.DataOutputClassTests<SUT>, org.j8unit.repository.java.io.FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataOutputStream.class!",
                   DataOutputStream.class.isAssignableFrom(sut));
    }

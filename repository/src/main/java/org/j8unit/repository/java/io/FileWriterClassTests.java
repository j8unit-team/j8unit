...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.FileWriter class java.io.FileWriter}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileWriterTests}.
 * </p>
 *
 * @see java.io.FileWriter class java.io.FileWriter (the hereby targeted class-under-test class)
 * @see FileWriterTests FileWriterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileWriterClassTests<SUT extends java.io.FileWriter>
extends OutputStreamWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FileWriter.class!",
                   java.io.FileWriter.class.isAssignableFrom(sut));
    }

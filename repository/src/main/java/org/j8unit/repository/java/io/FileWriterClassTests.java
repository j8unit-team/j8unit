 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileWriter public
...
public abstract interface FileWriterClassTests<SUT extends FileWriter>
extends OutputStreamWriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileWriter.class!",

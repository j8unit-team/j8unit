 ...
 * {@link MulticastChannel public abstract interface java.nio.channels.MulticastChannel}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.nio.channels.MulticastChannelClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface MulticastChannelTests<SUT extends MulticastChannel>

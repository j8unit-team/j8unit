 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SignStyle public
 * final enum java.time.format.SignStyle}.
 *
...
public abstract interface SignStyleClassTests<SUT extends SignStyle>
extends EnumClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.format.SignStyle]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignStyle.class!",
                   SignStyle.class.isAssignableFrom(sut));
    }

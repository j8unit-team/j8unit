...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.format.SignStyle class java.time.format.SignStyle},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignStyleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignStyleTests}.
 * </p>
 *
 * @see java.time.format.SignStyle class java.time.format.SignStyle (the hereby targeted class-under-test class)
 * @see SignStyleTests SignStyleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SignStyleClassTests<SUT extends java.time.format.SignStyle>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.SignStyle.class!",
                   java.time.format.SignStyle.class.isAssignableFrom(sut));
    }

 ...
 * java.rmi.activation.ActivationGroup}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationGroupTests}).
 * </p>
 *
 * <p>
 ...
 * @see ActivationGroupTests ActivationGroupTests (The complementary j8unit test interface containing the instance
...
extends ActivationInstantiatorClassTests<SUT>, org.j8unit.repository.java.rmi.server.UnicastRemoteObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationGroup.class!",
                   java.rmi.activation.ActivationGroup.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MessageDigestTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MessageDigestTests}.
 * </p>
 *
 * @see java.security.MessageDigest class java.security.MessageDigest (the hereby targeted class-under-test class)
 * @see MessageDigestTests MessageDigestTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends MessageDigestSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.MessageDigest.class!",
                   java.security.MessageDigest.class.isAssignableFrom(sut));
    }

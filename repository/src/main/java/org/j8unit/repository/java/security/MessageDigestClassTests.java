 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MessageDigest
...
public abstract interface MessageDigestClassTests<SUT extends MessageDigest>
extends MessageDigestSpiClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MessageDigest.class!",
                   MessageDigest.class.isAssignableFrom(sut));
    }

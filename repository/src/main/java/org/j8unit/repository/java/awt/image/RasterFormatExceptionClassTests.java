...
public abstract interface RasterFormatExceptionClassTests<SUT extends RasterFormatException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RasterFormatException.class!",
                   RasterFormatException.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.image.RasterFormatException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RasterFormatExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RasterFormatExceptionTests}.
 * </p>
 *
 * @see java.awt.image.RasterFormatException class java.awt.image.RasterFormatException (the hereby targeted
 *      class-under-test class)
 * @see RasterFormatExceptionTests RasterFormatExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.RasterFormatException.class!",
                   java.awt.image.RasterFormatException.class.isAssignableFrom(sut));
    }

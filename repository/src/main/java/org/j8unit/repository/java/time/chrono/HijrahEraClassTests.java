 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HijrahEraTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HijrahEraTests}.
 * </p>
 *
 * @see java.time.chrono.HijrahEra class java.time.chrono.HijrahEra (the hereby targeted class-under-test class)
 * @see HijrahEraTests HijrahEraTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends EraClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.HijrahEra.class!",
                   java.time.chrono.HijrahEra.class.isAssignableFrom(sut));
    }

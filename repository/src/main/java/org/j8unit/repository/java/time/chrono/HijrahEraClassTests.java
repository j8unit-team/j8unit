 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HijrahEra public
 * final enum java.time.chrono.HijrahEra}.
 *
...
public abstract interface HijrahEraClassTests<SUT extends HijrahEra>
extends EraClassTests<SUT>, EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HijrahEra.class!",
                   HijrahEra.class.isAssignableFrom(sut));
    }

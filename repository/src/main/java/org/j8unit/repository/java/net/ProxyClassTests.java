...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.Proxy class java.net.Proxy}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProxyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProxyTests}.
 * </p>
 *
 * @see java.net.Proxy class java.net.Proxy (the hereby targeted class-under-test class)
 * @see ProxyTests ProxyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.Proxy.class!",
                   java.net.Proxy.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link ProxyTests.TypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link ProxyTests.TypeTests}.
     * </p>
     *
     * @see java.net.Proxy.Type class java.net.Proxy$Type (the hereby targeted class-under-test class)
     * @see ProxyTests.TypeTests ProxyTests.TypeTests (The complementary j8unit test interface containing the instance
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.Proxy.Type.class!",
                       java.net.Proxy.Type.class.isAssignableFrom(sut));
        }

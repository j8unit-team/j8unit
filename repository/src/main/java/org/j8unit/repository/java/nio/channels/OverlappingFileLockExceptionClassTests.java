...
public abstract interface OverlappingFileLockExceptionClassTests<SUT extends OverlappingFileLockException>
extends IllegalStateExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.OverlappingFileLockException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OverlappingFileLockException.class!",
                   OverlappingFileLockException.class.isAssignableFrom(sut));
    }

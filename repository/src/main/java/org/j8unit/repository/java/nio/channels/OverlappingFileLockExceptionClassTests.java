 ...
 * java.nio.channels.OverlappingFileLockException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link OverlappingFileLockExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.channels.OverlappingFileLockException class java.nio.channels.OverlappingFileLockException (the hereby
 *      targeted class-under-test class)
 * @see OverlappingFileLockExceptionTests OverlappingFileLockExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.OverlappingFileLockException.class!",
                   java.nio.channels.OverlappingFileLockException.class.isAssignableFrom(sut));
    }

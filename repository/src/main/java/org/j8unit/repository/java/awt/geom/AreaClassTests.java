 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Area public class
 * java.awt.geom.Area}.
 *
...
public abstract interface AreaClassTests<SUT extends Area>
extends ShapeClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Area.class!", Area.class.isAssignableFrom(sut));
    }

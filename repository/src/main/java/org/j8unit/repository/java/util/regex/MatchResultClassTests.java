...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.regex.MatchResult interface java.util.regex.MatchResult},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MatchResultTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MatchResultTests}.
 * </p>
 *
 * @see java.util.regex.MatchResult interface java.util.regex.MatchResult (the hereby targeted class-under-test class)
 * @see MatchResultTests MatchResultTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MatchResultClassTests<SUT extends java.util.regex.MatchResult>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.regex.MatchResult.class!",
                   java.util.regex.MatchResult.class.isAssignableFrom(sut));
    }

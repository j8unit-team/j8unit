 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MatchResult public
 * abstract interface java.util.regex.MatchResult}.
 *
...
public abstract interface MatchResultClassTests<SUT extends MatchResult>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MatchResult.class!",
                   MatchResult.class.isAssignableFrom(sut));
    }

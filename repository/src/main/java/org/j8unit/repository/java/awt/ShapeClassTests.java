...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Shape interface java.awt.Shape}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShapeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ShapeTests}.
 * </p>
 *
 * @see java.awt.Shape interface java.awt.Shape (the hereby targeted class-under-test class)
 * @see ShapeTests ShapeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ShapeClassTests<SUT extends java.awt.Shape>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Shape.class!",
                   java.awt.Shape.class.isAssignableFrom(sut));
    }

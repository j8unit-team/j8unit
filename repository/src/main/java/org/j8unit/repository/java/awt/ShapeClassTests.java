 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Shape public
...
public abstract interface ShapeClassTests<SUT extends Shape>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Shape.class!", Shape.class.isAssignableFrom(sut));
    }

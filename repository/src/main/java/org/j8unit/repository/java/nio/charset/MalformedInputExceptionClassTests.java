...
public abstract interface MalformedInputExceptionClassTests<SUT extends MalformedInputException>
extends CharacterCodingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MalformedInputException.class!",
                   MalformedInputException.class.isAssignableFrom(sut));
    }

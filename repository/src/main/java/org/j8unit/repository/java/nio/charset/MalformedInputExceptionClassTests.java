 ...
 * java.nio.charset.MalformedInputException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MalformedInputExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link MalformedInputExceptionTests}.
 * </p>
 *
 * @see java.nio.charset.MalformedInputException class java.nio.charset.MalformedInputException (the hereby targeted
 *      class-under-test class)
 * @see MalformedInputExceptionTests MalformedInputExceptionTests (The complementary j8unit test interface containing
...
extends CharacterCodingExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.MalformedInputException.class!",
                   java.nio.charset.MalformedInputException.class.isAssignableFrom(sut));
    }

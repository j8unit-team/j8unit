 ...
 * {@link org.j8unit.repository.java.rmi.activation.ActivationInstantiatorTests}.
 * </p>
 *
 * <p>
...
public abstract interface ActivationInstantiatorClassTests<SUT extends ActivationInstantiator>
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationInstantiator.class!",
                   ActivationInstantiator.class.isAssignableFrom(sut));
    }

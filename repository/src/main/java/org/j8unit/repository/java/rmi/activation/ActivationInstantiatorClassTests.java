 ...
 * java.rmi.activation.ActivationInstantiator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationInstantiatorTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ActivationInstantiatorTests}.
 * </p>
 *
 * @see java.rmi.activation.ActivationInstantiator interface java.rmi.activation.ActivationInstantiator (the hereby
 *      targeted class-under-test class)
 * @see ActivationInstantiatorTests ActivationInstantiatorTests (The complementary j8unit test interface containing the
...
public abstract interface ActivationInstantiatorClassTests<SUT extends java.rmi.activation.ActivationInstantiator>
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationInstantiator.class!",
                   java.rmi.activation.ActivationInstantiator.class.isAssignableFrom(sut));
    }

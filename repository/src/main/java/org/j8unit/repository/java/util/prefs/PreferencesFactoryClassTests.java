 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PreferencesFactory
 * public abstract interface java.util.prefs.PreferencesFactory}.
 *
...
public abstract interface PreferencesFactoryClassTests<SUT extends PreferencesFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PreferencesFactory.class!",
                   PreferencesFactory.class.isAssignableFrom(sut));
    }

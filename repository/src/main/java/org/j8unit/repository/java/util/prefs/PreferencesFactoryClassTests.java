 ...
 * java.util.prefs.PreferencesFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PreferencesFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PreferencesFactoryTests}.
 * </p>
 *
 * @see java.util.prefs.PreferencesFactory interface java.util.prefs.PreferencesFactory (the hereby targeted
 *      class-under-test class)
 * @see PreferencesFactoryTests PreferencesFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface PreferencesFactoryClassTests<SUT extends java.util.prefs.PreferencesFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.PreferencesFactory.class!",
                   java.util.prefs.PreferencesFactory.class.isAssignableFrom(sut));
    }

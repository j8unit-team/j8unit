 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextMeasurer public
 * final class java.awt.font.TextMeasurer}.
 *
...
public abstract interface TextMeasurerClassTests<SUT extends TextMeasurer>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextMeasurer.class!",
                   TextMeasurer.class.isAssignableFrom(sut));
    }

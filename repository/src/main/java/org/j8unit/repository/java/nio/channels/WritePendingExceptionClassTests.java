 ...
 * {@link WritePendingException public class java.nio.channels.WritePendingException}.
 *
...
public abstract interface WritePendingExceptionClassTests<SUT extends WritePendingException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WritePendingException.class!",
                   WritePendingException.class.isAssignableFrom(sut));
    }

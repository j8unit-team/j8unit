 ...
 * java.nio.channels.WritePendingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WritePendingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link WritePendingExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.WritePendingException class java.nio.channels.WritePendingException (the hereby targeted
 *      class-under-test class)
 * @see WritePendingExceptionTests WritePendingExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.WritePendingException.class!",
                   java.nio.channels.WritePendingException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileTypeDetector
 * public abstract class java.nio.file.spi.FileTypeDetector}.
 *
...
public abstract interface FileTypeDetectorClassTests<SUT extends FileTypeDetector>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileTypeDetector.class!",
                   FileTypeDetector.class.isAssignableFrom(sut));
    }

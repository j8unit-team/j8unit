 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CryptoPrimitive
...
public abstract interface CryptoPrimitiveClassTests<SUT extends CryptoPrimitive>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CryptoPrimitive.class!",
                   CryptoPrimitive.class.isAssignableFrom(sut));
    }

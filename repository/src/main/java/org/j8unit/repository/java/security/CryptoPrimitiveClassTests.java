 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CryptoPrimitiveTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CryptoPrimitiveTests}.
 * </p>
 *
 * @see java.security.CryptoPrimitive class java.security.CryptoPrimitive (the hereby targeted class-under-test class)
 * @see CryptoPrimitiveTests CryptoPrimitiveTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.CryptoPrimitive.class!",
                   java.security.CryptoPrimitive.class.isAssignableFrom(sut));
    }

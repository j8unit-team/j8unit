 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PanelPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PanelPeerTests}.
 * </p>
 *
 * @see java.awt.peer.PanelPeer interface java.awt.peer.PanelPeer (the hereby targeted class-under-test class)
 * @see PanelPeerTests PanelPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PanelPeerClassTests<SUT extends java.awt.peer.PanelPeer>
extends ContainerPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.PanelPeer.class!",
                   java.awt.peer.PanelPeer.class.isAssignableFrom(sut));
    }

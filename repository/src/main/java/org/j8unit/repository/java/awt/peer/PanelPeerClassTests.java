 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PanelPeer public
 * abstract interface java.awt.peer.PanelPeer}.
 *
...
public abstract interface PanelPeerClassTests<SUT extends PanelPeer>
extends ContainerPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PanelPeer.class!",
                   PanelPeer.class.isAssignableFrom(sut));
    }

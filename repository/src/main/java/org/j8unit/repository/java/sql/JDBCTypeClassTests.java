...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.JDBCType class java.sql.JDBCType}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JDBCTypeTests}).
 * </p>
 *
 * <p>
 ...
 * @see JDBCTypeTests JDBCTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SQLTypeClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.JDBCType.class!",
                   java.sql.JDBCType.class.isAssignableFrom(sut));
    }

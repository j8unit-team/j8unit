 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JDBCType public
...
extends SQLTypeClassTests<SUT>, EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JDBCType.class!",
                   JDBCType.class.isAssignableFrom(sut));
    }

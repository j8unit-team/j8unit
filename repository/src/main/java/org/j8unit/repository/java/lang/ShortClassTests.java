...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Short class java.lang.Short}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShortTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ShortTests}.
 * </p>
 *
 * @see Short class java.lang.Short (the hereby targeted class-under-test class)
 * @see ShortTests ShortTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ShortClassTests<SUT extends Short>
extends ComparableClassTests<SUT>, NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Short.class!", Short.class.isAssignableFrom(sut));
    }

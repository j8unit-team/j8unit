...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.server.RemoteObject class java.rmi.server.RemoteObject},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RemoteObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RemoteObjectTests}.
 * </p>
 *
 * @see java.rmi.server.RemoteObject class java.rmi.server.RemoteObject (the hereby targeted class-under-test class)
 * @see RemoteObjectTests RemoteObjectTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RemoteObject.class!",
                   java.rmi.server.RemoteObject.class.isAssignableFrom(sut));
    }

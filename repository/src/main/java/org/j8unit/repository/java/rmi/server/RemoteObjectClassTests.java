 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RemoteObject public
...
public abstract interface RemoteObjectClassTests<SUT extends RemoteObject>
extends RemoteClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemoteObject.class!",
                   RemoteObject.class.isAssignableFrom(sut));
    }

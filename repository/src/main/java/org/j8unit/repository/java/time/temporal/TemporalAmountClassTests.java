 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalAmount
 * public abstract interface java.time.temporal.TemporalAmount}.
 *
...
public abstract interface TemporalAmountClassTests<SUT extends TemporalAmount>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalAmount.class!",
                   TemporalAmount.class.isAssignableFrom(sut));
    }

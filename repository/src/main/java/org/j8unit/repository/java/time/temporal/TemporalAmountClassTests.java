...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.TemporalAmount interface
 * java.time.temporal.TemporalAmount}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalAmountTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalAmountTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalAmount interface java.time.temporal.TemporalAmount (the hereby targeted
 *      class-under-test class)
 * @see TemporalAmountTests TemporalAmountTests (The complementary j8unit test interface containing the instance
...
public abstract interface TemporalAmountClassTests<SUT extends java.time.temporal.TemporalAmount>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalAmount.class!",
                   java.time.temporal.TemporalAmount.class.isAssignableFrom(sut));
    }

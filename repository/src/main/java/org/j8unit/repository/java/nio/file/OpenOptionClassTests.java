 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OpenOptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OpenOptionTests}.
 * </p>
 *
 * @see java.nio.file.OpenOption interface java.nio.file.OpenOption (the hereby targeted class-under-test class)
 * @see OpenOptionTests OpenOptionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface OpenOptionClassTests<SUT extends java.nio.file.OpenOption>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.OpenOption.class!",
                   java.nio.file.OpenOption.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OpenOption public
 * abstract interface java.nio.file.OpenOption}.
 *
...
public abstract interface OpenOptionClassTests<SUT extends OpenOption>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OpenOption.class!",
                   OpenOption.class.isAssignableFrom(sut));
    }

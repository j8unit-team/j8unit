...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.UnmarshalException class java.rmi.UnmarshalException},
...
public abstract interface UnmarshalExceptionClassTests<SUT extends java.rmi.UnmarshalException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.UnmarshalException.class!",
                   java.rmi.UnmarshalException.class.isAssignableFrom(sut));
    }

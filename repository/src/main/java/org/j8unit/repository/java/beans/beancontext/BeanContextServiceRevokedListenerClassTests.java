 ...
 * java.beans.beancontext.BeanContextServiceRevokedListener}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * {@link BeanContextServiceRevokedListenerTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextServiceRevokedListenerTests BeanContextServiceRevokedListenerTests (The complementary j8unit test
...
public abstract interface BeanContextServiceRevokedListenerClassTests<SUT extends java.beans.beancontext.BeanContextServiceRevokedListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServiceRevokedListener.class!",
                   java.beans.beancontext.BeanContextServiceRevokedListener.class.isAssignableFrom(sut));
    }

...
public abstract interface BeanContextServiceRevokedListenerClassTests<SUT extends BeanContextServiceRevokedListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextServiceRevokedListener.class!",
                   BeanContextServiceRevokedListener.class.isAssignableFrom(sut));
    }

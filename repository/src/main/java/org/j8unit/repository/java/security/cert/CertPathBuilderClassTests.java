 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertPathBuilder
...
public abstract interface CertPathBuilderClassTests<SUT extends CertPathBuilder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathBuilder.class!",
                   CertPathBuilder.class.isAssignableFrom(sut));
    }

 ...
 * java.time.zone.ZoneRulesException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZoneRulesExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZoneRulesExceptionTests}.
 * </p>
 *
 * @see java.time.zone.ZoneRulesException class java.time.zone.ZoneRulesException (the hereby targeted class-under-test
 *      class)
 * @see ZoneRulesExceptionTests ZoneRulesExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.time.DateTimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.zone.ZoneRulesException.class!",
                   java.time.zone.ZoneRulesException.class.isAssignableFrom(sut));
    }

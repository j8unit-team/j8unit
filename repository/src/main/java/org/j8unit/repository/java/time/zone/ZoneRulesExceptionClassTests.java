 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZoneRulesException
 * public class java.time.zone.ZoneRulesException}.
 *
...
public abstract interface ZoneRulesExceptionClassTests<SUT extends ZoneRulesException>
extends DateTimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZoneRulesException.class!",
                   ZoneRulesException.class.isAssignableFrom(sut));
    }

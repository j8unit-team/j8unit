...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.StringReader class java.io.StringReader}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringReaderTests}.
 * </p>
 *
 * @see java.io.StringReader class java.io.StringReader (the hereby targeted class-under-test class)
 * @see StringReaderTests StringReaderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StringReaderClassTests<SUT extends java.io.StringReader>
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.StringReader.class!",
                   java.io.StringReader.class.isAssignableFrom(sut));
    }

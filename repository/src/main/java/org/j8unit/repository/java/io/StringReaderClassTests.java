 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringReader public
...
public abstract interface StringReaderClassTests<SUT extends StringReader>
extends ReaderClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.StringReader]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringReader.class!",
                   StringReader.class.isAssignableFrom(sut));
    }

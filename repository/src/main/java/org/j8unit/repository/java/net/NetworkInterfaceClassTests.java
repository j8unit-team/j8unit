 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NetworkInterfaceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NetworkInterfaceTests}.
 * </p>
 *
 * @see java.net.NetworkInterface class java.net.NetworkInterface (the hereby targeted class-under-test class)
 * @see NetworkInterfaceTests NetworkInterfaceTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.NetworkInterface.class!",
                   java.net.NetworkInterface.class.isAssignableFrom(sut));
    }

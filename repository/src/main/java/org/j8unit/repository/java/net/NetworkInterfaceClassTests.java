 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NetworkInterface
...
public abstract interface NetworkInterfaceClassTests<SUT extends NetworkInterface>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NetworkInterface.class!",
                   NetworkInterface.class.isAssignableFrom(sut));
    }

 ...
 * java.util.zip.DataFormatException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataFormatExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataFormatExceptionTests}.
 * </p>
 *
 * @see java.util.zip.DataFormatException class java.util.zip.DataFormatException (the hereby targeted class-under-test
 *      class)
 * @see DataFormatExceptionTests DataFormatExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.DataFormatException.class!",
                   java.util.zip.DataFormatException.class.isAssignableFrom(sut));
    }

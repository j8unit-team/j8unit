 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BreakIteratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BreakIteratorTests}.
 * </p>
 *
 * @see java.text.BreakIterator class java.text.BreakIterator (the hereby targeted class-under-test class)
 * @see BreakIteratorTests BreakIteratorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.BreakIterator.class!",
                   java.text.BreakIterator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BreakIterator
...
public abstract interface BreakIteratorClassTests<SUT extends BreakIterator>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BreakIterator.class!",
                   BreakIterator.class.isAssignableFrom(sut));
    }

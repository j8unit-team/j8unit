 ...
 * java.security.cert.X509CRLSelector}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509CRLSelectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509CRLSelectorTests}.
 * </p>
 *
 * @see java.security.cert.X509CRLSelector class java.security.cert.X509CRLSelector (the hereby targeted
 *      class-under-test class)
 * @see X509CRLSelectorTests X509CRLSelectorTests (The complementary j8unit test interface containing the instance
...
extends CRLSelectorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.X509CRLSelector.class!",
                   java.security.cert.X509CRLSelector.class.isAssignableFrom(sut));
    }

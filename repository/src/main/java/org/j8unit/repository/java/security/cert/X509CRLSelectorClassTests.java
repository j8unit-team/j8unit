 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509CRLSelector
...
public abstract interface X509CRLSelectorClassTests<SUT extends X509CRLSelector>
extends org.j8unit.repository.java.security.cert.CRLSelectorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509CRLSelector.class!",
                   X509CRLSelector.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Identity public
 * abstract class java.security.Identity}.
 *
...
public abstract interface IdentityClassTests<SUT extends Identity>
extends PrincipalClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.Identity]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Identity.class!",
                   Identity.class.isAssignableFrom(sut));
    }

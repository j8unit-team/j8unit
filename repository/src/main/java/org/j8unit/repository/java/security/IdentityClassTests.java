 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IdentityTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IdentityTests}.
 * </p>
 *
 * @see java.security.Identity class java.security.Identity (the hereby targeted class-under-test class)
 * @see IdentityTests IdentityTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends PrincipalClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Identity.class!",
                   java.security.Identity.class.isAssignableFrom(sut));
    }

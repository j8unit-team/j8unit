 ...
 * java.util.logging.LoggingMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LoggingMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LoggingMXBeanTests}.
 * </p>
 *
 * @see java.util.logging.LoggingMXBean interface java.util.logging.LoggingMXBean (the hereby targeted class-under-test
 *      class)
 * @see LoggingMXBeanTests LoggingMXBeanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LoggingMXBeanClassTests<SUT extends java.util.logging.LoggingMXBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.LoggingMXBean.class!",
                   java.util.logging.LoggingMXBean.class.isAssignableFrom(sut));
    }

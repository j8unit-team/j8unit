 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LoggingMXBean
 * public abstract interface java.util.logging.LoggingMXBean}.
 *
...
public abstract interface LoggingMXBeanClassTests<SUT extends LoggingMXBean>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LoggingMXBean.class!",

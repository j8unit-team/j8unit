...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.DriverAction interface java.sql.DriverAction}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DriverActionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DriverActionTests}.
 * </p>
 *
 * @see java.sql.DriverAction interface java.sql.DriverAction (the hereby targeted class-under-test class)
 * @see DriverActionTests DriverActionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DriverActionClassTests<SUT extends java.sql.DriverAction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.DriverAction.class!",
                   java.sql.DriverAction.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DriverAction public
 * abstract interface java.sql.DriverAction}.
 *
...
public abstract interface DriverActionClassTests<SUT extends DriverAction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DriverAction.class!",

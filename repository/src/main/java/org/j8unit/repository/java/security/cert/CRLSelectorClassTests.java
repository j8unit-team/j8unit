 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CRLSelector public
 * abstract interface java.security.cert.CRLSelector}.
 *
...
public abstract interface CRLSelectorClassTests<SUT extends CRLSelector>
extends CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CRLSelector.class!",
                   CRLSelector.class.isAssignableFrom(sut));
    }

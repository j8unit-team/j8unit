 ...
 * java.security.cert.CRLSelector}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CRLSelectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CRLSelectorTests}.
 * </p>
 *
 * @see java.security.cert.CRLSelector interface java.security.cert.CRLSelector (the hereby targeted class-under-test
 *      class)
 * @see CRLSelectorTests CRLSelectorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CRLSelectorClassTests<SUT extends java.security.cert.CRLSelector>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CRLSelector.class!",
                   java.security.cert.CRLSelector.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FontFormatException
 * public class java.awt.FontFormatException}.
 *
...
public abstract interface FontFormatExceptionClassTests<SUT extends FontFormatException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FontFormatException.class!",
                   FontFormatException.class.isAssignableFrom(sut));
    }

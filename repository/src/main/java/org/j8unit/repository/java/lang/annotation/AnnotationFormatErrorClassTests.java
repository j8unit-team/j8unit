...
public abstract interface AnnotationFormatErrorClassTests<SUT extends AnnotationFormatError>
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotationFormatError.class!",
                   AnnotationFormatError.class.isAssignableFrom(sut));
    }

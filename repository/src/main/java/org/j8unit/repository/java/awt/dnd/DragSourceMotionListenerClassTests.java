 ...
 * java.awt.dnd.DragSourceMotionListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragSourceMotionListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link DragSourceMotionListenerTests}.
 * </p>
 *
 * @see java.awt.dnd.DragSourceMotionListener interface java.awt.dnd.DragSourceMotionListener (the hereby targeted
 *      class-under-test class)
 * @see DragSourceMotionListenerTests DragSourceMotionListenerTests (The complementary j8unit test interface containing
...
public abstract interface DragSourceMotionListenerClassTests<SUT extends java.awt.dnd.DragSourceMotionListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragSourceMotionListener.class!",
                   java.awt.dnd.DragSourceMotionListener.class.isAssignableFrom(sut));
    }

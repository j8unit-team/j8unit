...
public abstract interface DragSourceMotionListenerClassTests<SUT extends DragSourceMotionListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSourceMotionListener.class!",
                   DragSourceMotionListener.class.isAssignableFrom(sut));
    }

...
public abstract interface IllformedLocaleExceptionClassTests<SUT extends IllformedLocaleException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllformedLocaleException.class!",
                   IllformedLocaleException.class.isAssignableFrom(sut));
    }

 ...
 * java.util.IllformedLocaleException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IllformedLocaleExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link IllformedLocaleExceptionTests}.
 * </p>
 *
 * @see java.util.IllformedLocaleException class java.util.IllformedLocaleException (the hereby targeted
 *      class-under-test class)
 * @see IllformedLocaleExceptionTests IllformedLocaleExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IllformedLocaleException.class!",
                   java.util.IllformedLocaleException.class.isAssignableFrom(sut));
    }

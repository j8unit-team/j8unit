 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeSet public
...
public abstract interface TreeSetClassTests<SUT extends TreeSet>
extends NavigableSetClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeSet.class!",
                   TreeSet.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.TreeSet]

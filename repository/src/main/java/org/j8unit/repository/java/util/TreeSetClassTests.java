...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.TreeSet class java.util.TreeSet}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeSetTests}.
 * </p>
 *
 * @see java.util.TreeSet class java.util.TreeSet (the hereby targeted class-under-test class)
 * @see TreeSetTests TreeSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends NavigableSetClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.TreeSet.class!",
                   java.util.TreeSet.class.isAssignableFrom(sut));
    }

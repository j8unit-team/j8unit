...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.SystemColor class java.awt.SystemColor}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SystemColorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SystemColorTests}.
 * </p>
 *
 * @see java.awt.SystemColor class java.awt.SystemColor (the hereby targeted class-under-test class)
 * @see SystemColorTests SystemColorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SystemColorClassTests<SUT extends java.awt.SystemColor>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, ColorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.SystemColor.class!",
                   java.awt.SystemColor.class.isAssignableFrom(sut));
    }

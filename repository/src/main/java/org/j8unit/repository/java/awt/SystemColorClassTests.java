 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SystemColor public
...
public abstract interface SystemColorClassTests<SUT extends SystemColor>
extends ColorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SystemColor.class!",
                   SystemColor.class.isAssignableFrom(sut));
    }

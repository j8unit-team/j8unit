 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DecimalStyleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DecimalStyleTests}.
 * </p>
 *
 * @see java.time.format.DecimalStyle class java.time.format.DecimalStyle (the hereby targeted class-under-test class)
 * @see DecimalStyleTests DecimalStyleTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DecimalStyleClassTests<SUT extends java.time.format.DecimalStyle>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.DecimalStyle.class!",
                   java.time.format.DecimalStyle.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DecimalStyle public
 * final class java.time.format.DecimalStyle}.
 *
...
public abstract interface DecimalStyleClassTests<SUT extends DecimalStyle>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.format.DecimalStyle]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DecimalStyle.class!",
                   DecimalStyle.class.isAssignableFrom(sut));
    }

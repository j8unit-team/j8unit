 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PersistenceDelegate
 * public abstract class java.beans.PersistenceDelegate}.
 *
...
public abstract interface PersistenceDelegateClassTests<SUT extends PersistenceDelegate>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PersistenceDelegate.class!",
                   PersistenceDelegate.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.beans.PersistenceDelegate]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PersistenceDelegateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PersistenceDelegateTests}.
 * </p>
 *
 * @see java.beans.PersistenceDelegate class java.beans.PersistenceDelegate (the hereby targeted class-under-test class)
 * @see PersistenceDelegateTests PersistenceDelegateTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PersistenceDelegate.class!",
                   java.beans.PersistenceDelegate.class.isAssignableFrom(sut));
    }

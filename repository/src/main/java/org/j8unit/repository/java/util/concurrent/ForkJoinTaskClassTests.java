 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ForkJoinTask public
 * abstract class java.util.concurrent.ForkJoinTask<V>}.
 *
...
public abstract interface ForkJoinTaskClassTests<SUT extends ForkJoinTask>
extends FutureClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ForkJoinTask.class!",
                   ForkJoinTask.class.isAssignableFrom(sut));
    }

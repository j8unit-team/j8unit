 ...
 * java.util.concurrent.ForkJoinTask}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ForkJoinTaskTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ForkJoinTaskTests}.
 * </p>
 *
 * @see java.util.concurrent.ForkJoinTask class java.util.concurrent.ForkJoinTask (the hereby targeted class-under-test
 *      class)
 * @see ForkJoinTaskTests ForkJoinTaskTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends FutureClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ForkJoinTask.class!",
                   java.util.concurrent.ForkJoinTask.class.isAssignableFrom(sut));
    }

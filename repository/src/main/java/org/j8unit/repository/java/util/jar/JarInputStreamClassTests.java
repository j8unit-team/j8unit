 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JarInputStream
...
extends org.j8unit.repository.java.util.zip.ZipInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JarInputStream.class!",
                   JarInputStream.class.isAssignableFrom(sut));
    }

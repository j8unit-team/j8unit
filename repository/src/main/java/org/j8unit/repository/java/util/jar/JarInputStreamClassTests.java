 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JarInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see JarInputStreamTests JarInputStreamTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.util.zip.ZipInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.JarInputStream.class!",
                   java.util.jar.JarInputStream.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributedStringTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AttributedStringTests}.
 * </p>
 *
 * @see java.text.AttributedString class java.text.AttributedString (the hereby targeted class-under-test class)
 * @see AttributedStringTests AttributedStringTests (The complementary j8unit test interface containing the instance
...
public abstract interface AttributedStringClassTests<SUT extends java.text.AttributedString>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.AttributedString.class!",
                   java.text.AttributedString.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.Policy class java.security.Policy}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PolicyTests}.
 * </p>
 *
 * @see java.security.Policy class java.security.Policy (the hereby targeted class-under-test class)
 * @see PolicyTests PolicyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface PolicyClassTests<SUT extends java.security.Policy>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Policy.class!",
                   java.security.Policy.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.security.Policy.Parameters interface
     * java.security.Policy$Parameters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link PolicyTests.ParametersTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see PolicyTests.ParametersTests PolicyTests.ParametersTests (The complementary j8unit test interface containing
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ParametersClassTests<SUT extends java.security.Policy.Parameters>
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Policy.Parameters.class!",
                       java.security.Policy.Parameters.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinearGradientPaint
 * public final class java.awt.LinearGradientPaint}.
 *
...
public abstract interface LinearGradientPaintClassTests<SUT extends LinearGradientPaint>
extends MultipleGradientPaintClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinearGradientPaint.class!",
                   LinearGradientPaint.class.isAssignableFrom(sut));
    }

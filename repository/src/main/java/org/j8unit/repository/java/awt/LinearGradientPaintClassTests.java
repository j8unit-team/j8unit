 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinearGradientPaintTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinearGradientPaintTests}.
 * </p>
 *
 * @see java.awt.LinearGradientPaint class java.awt.LinearGradientPaint (the hereby targeted class-under-test class)
 * @see LinearGradientPaintTests LinearGradientPaintTests (The complementary j8unit test interface containing the
...
extends MultipleGradientPaintClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.LinearGradientPaint.class!",
                   java.awt.LinearGradientPaint.class.isAssignableFrom(sut));
    }

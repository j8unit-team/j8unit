...
extends org.j8unit.repository.java.awt.MultipleGradientPaintClassTests<SUT> {
    ...
    public default void create_LinearGradientPaint_Point2D_Point2D_floatArray_ColorArray_CycleMethod_ColorSpaceType_AffineTransform()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public default void create_LinearGradientPaint_Point2D_Point2D_floatArray_ColorArray_CycleMethod()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.LinearGradientPaint sut = null; // = new
    ...
    @Test
    @Category(Draft.class)
    public default void create_LinearGradientPaint_Point2D_Point2D_floatArray_ColorArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.LinearGradientPaint sut = null; // = new
    ...
    @Test
    @Category(Draft.class)
    public default void create_LinearGradientPaint_float_float_float_float_floatArray_ColorArray_CycleMethod()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.LinearGradientPaint sut = null; // = new
    ...
    @Test
    @Category(Draft.class)
    public default void create_LinearGradientPaint_float_float_float_float_floatArray_ColorArray()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.LinearGradientPaint sut = null; // = new
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.awt.LinearGradientPaint> sut = createNewSUT();

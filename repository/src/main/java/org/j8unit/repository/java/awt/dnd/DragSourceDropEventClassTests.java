 ...
 * java.awt.dnd.DragSourceDropEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragSourceDropEventTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see DragSourceDropEventTests DragSourceDropEventTests (The complementary j8unit test interface containing the
...
extends DragSourceEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragSourceDropEvent.class!",
                   java.awt.dnd.DragSourceDropEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragSourceDropEvent
 * public class java.awt.dnd.DragSourceDropEvent}.
 *
...
extends DragSourceEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSourceDropEvent.class!",
                   DragSourceDropEvent.class.isAssignableFrom(sut));
    }

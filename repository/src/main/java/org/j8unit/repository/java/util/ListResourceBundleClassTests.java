 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListResourceBundle
...
public abstract interface ListResourceBundleClassTests<SUT extends ListResourceBundle>
extends ResourceBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListResourceBundle.class!",
                   ListResourceBundle.class.isAssignableFrom(sut));
    }

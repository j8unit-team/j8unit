 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListResourceBundleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListResourceBundleTests}.
 * </p>
 *
 * @see java.util.ListResourceBundle class java.util.ListResourceBundle (the hereby targeted class-under-test class)
 * @see ListResourceBundleTests ListResourceBundleTests (The complementary j8unit test interface containing the instance
...
public abstract interface ListResourceBundleClassTests<SUT extends java.util.ListResourceBundle>
extends ResourceBundleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ListResourceBundle.class!",
                   java.util.ListResourceBundle.class.isAssignableFrom(sut));
    }

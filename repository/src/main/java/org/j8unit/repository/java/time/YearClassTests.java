...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.Year class java.time.Year}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link YearTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link YearTests}.
 * </p>
 *
 * @see java.time.Year class java.time.Year (the hereby targeted class-under-test class)
 * @see YearTests YearTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface YearClassTests<SUT extends java.time.Year>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.Year.class!",
                   java.time.Year.class.isAssignableFrom(sut));
    }

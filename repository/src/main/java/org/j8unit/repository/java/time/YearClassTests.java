 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Year public final
...
public abstract interface YearClassTests<SUT extends Year>
extends TemporalClassTests<SUT>, TemporalAdjusterClassTests<SUT>, ComparableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.Year]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Year.class!", Year.class.isAssignableFrom(sut));
    }

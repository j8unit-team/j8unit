 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileTime public
 * final class java.nio.file.attribute.FileTime}.
 *
...
public abstract interface FileTimeClassTests<SUT extends FileTime>
extends ComparableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileTime.class!",
                   FileTime.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.attribute.FileTime class
 * java.nio.file.attribute.FileTime}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileTimeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileTimeTests}.
 * </p>
 *
 * @see java.nio.file.attribute.FileTime class java.nio.file.attribute.FileTime (the hereby targeted class-under-test
 *      class)
 * @see FileTimeTests FileTimeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileTimeClassTests<SUT extends java.nio.file.attribute.FileTime>
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.FileTime.class!",
                   java.nio.file.attribute.FileTime.class.isAssignableFrom(sut));
    }

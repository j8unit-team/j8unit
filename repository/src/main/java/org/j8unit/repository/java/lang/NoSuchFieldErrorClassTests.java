...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain NoSuchFieldError class java.lang.NoSuchFieldError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchFieldErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NoSuchFieldErrorTests}.
 * </p>
 *
 * @see NoSuchFieldError class java.lang.NoSuchFieldError (the hereby targeted class-under-test class)
 * @see NoSuchFieldErrorTests NoSuchFieldErrorTests (The complementary j8unit test interface containing the instance
...
public abstract interface NoSuchFieldErrorClassTests<SUT extends NoSuchFieldError>
extends IncompatibleClassChangeErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoSuchFieldError.class!",
                   NoSuchFieldError.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FontRenderContext
 * public class java.awt.font.FontRenderContext}.
 *
...
public abstract interface FontRenderContextClassTests<SUT extends FontRenderContext>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FontRenderContext.class!",
                   FontRenderContext.class.isAssignableFrom(sut));
    }

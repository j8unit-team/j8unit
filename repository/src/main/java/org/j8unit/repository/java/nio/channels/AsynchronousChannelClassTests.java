 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AsynchronousChannel
 * public abstract interface java.nio.channels.AsynchronousChannel}.
 *
...
public abstract interface AsynchronousChannelClassTests<SUT extends AsynchronousChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsynchronousChannel.class!",
                   AsynchronousChannel.class.isAssignableFrom(sut));
    }

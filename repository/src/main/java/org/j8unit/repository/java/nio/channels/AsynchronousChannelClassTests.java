...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.AsynchronousChannel interface
 * java.nio.channels.AsynchronousChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AsynchronousChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AsynchronousChannelTests}.
 * </p>
 *
 * @see java.nio.channels.AsynchronousChannel interface java.nio.channels.AsynchronousChannel (the hereby targeted
 *      class-under-test class)
 * @see AsynchronousChannelTests AsynchronousChannelTests (The complementary j8unit test interface containing the
...
public abstract interface AsynchronousChannelClassTests<SUT extends java.nio.channels.AsynchronousChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AsynchronousChannel.class!",
                   java.nio.channels.AsynchronousChannel.class.isAssignableFrom(sut));
    }

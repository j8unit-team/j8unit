 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleDateFormat
...
public abstract interface SimpleDateFormatClassTests<SUT extends SimpleDateFormat>
extends DateFormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleDateFormat.class!",
                   SimpleDateFormat.class.isAssignableFrom(sut));
    }

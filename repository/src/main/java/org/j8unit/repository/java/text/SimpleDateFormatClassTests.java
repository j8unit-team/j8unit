 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleDateFormatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleDateFormatTests}.
 * </p>
 *
 * @see java.text.SimpleDateFormat class java.text.SimpleDateFormat (the hereby targeted class-under-test class)
 * @see SimpleDateFormatTests SimpleDateFormatTests (The complementary j8unit test interface containing the instance
...
extends DateFormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.SimpleDateFormat.class!",
                   java.text.SimpleDateFormat.class.isAssignableFrom(sut));
    }

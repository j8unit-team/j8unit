...
/**
 * <p>
 * Test class for {@link java.text.SimpleDateFormat class java.text.SimpleDateFormat}, containing all class relevant
...
extends org.j8unit.repository.java.text.DateFormatClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.text.SimpleDateFormat sut = null; // = new

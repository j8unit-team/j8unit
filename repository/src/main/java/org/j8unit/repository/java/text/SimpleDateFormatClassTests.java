...
public abstract interface SimpleDateFormatClassTests<SUT extends java.text.SimpleDateFormat>
extends org.j8unit.repository.java.text.DateFormatClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.text.SimpleDateFormat#SimpleDateFormat()
     */
     ...
     * </p>
     *
     * @j8unit.aim java.text.SimpleDateFormat#SimpleDateFormat(java.lang.String)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.text.SimpleDateFormat#SimpleDateFormat(java.lang.String, java.text.DateFormatSymbols)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_SimpleDateFormat_String_DateFormatSymbols()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.text.SimpleDateFormat sut = null; // = new SimpleDateFormat(java.lang.String,
    ...
    /**
     * <p>
     * Test method for {@link java.text.SimpleDateFormat#SimpleDateFormat(java.lang.String, java.util.Locale) public
     ...
     * </p>
     *
     * @j8unit.aim java.text.SimpleDateFormat#SimpleDateFormat(java.lang.String, java.util.Locale)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_SimpleDateFormat_String_Locale()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.text.SimpleDateFormat#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketPermission
...
public abstract interface SocketPermissionClassTests<SUT extends SocketPermission>
extends PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketPermission.class!",
                   SocketPermission.class.isAssignableFrom(sut));
    }

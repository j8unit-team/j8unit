 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketPermissionTests}.
 * </p>
 *
 * @see java.net.SocketPermission class java.net.SocketPermission (the hereby targeted class-under-test class)
 * @see SocketPermissionTests SocketPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.security.PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketPermission.class!",
                   java.net.SocketPermission.class.isAssignableFrom(sut));
    }

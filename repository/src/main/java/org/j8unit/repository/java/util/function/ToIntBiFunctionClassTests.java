 ...
 * java.util.function.ToIntBiFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToIntBiFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToIntBiFunctionTests}.
 * </p>
 *
 * @see java.util.function.ToIntBiFunction interface java.util.function.ToIntBiFunction (the hereby targeted
 *      class-under-test class)
 * @see ToIntBiFunctionTests ToIntBiFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ToIntBiFunctionClassTests<SUT extends java.util.function.ToIntBiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ToIntBiFunction.class!",
                   java.util.function.ToIntBiFunction.class.isAssignableFrom(sut));
    }

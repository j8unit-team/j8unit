 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToIntBiFunction
 * public abstract interface java.util.function.ToIntBiFunction<T,U>}.
 *
...
public abstract interface ToIntBiFunctionClassTests<SUT extends ToIntBiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToIntBiFunction.class!",
                   ToIntBiFunction.class.isAssignableFrom(sut));
    }

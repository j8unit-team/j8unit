...
public abstract interface InputMismatchExceptionClassTests<SUT extends InputMismatchException>
extends org.j8unit.repository.java.util.NoSuchElementExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMismatchException.class!",
                   InputMismatchException.class.isAssignableFrom(sut));
    }

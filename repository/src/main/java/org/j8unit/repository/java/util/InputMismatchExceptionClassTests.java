 ...
 * java.util.InputMismatchException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputMismatchExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InputMismatchExceptionTests}.
 * </p>
 *
 * @see java.util.InputMismatchException class java.util.InputMismatchException (the hereby targeted class-under-test
 *      class)
 * @see InputMismatchExceptionTests InputMismatchExceptionTests (The complementary j8unit test interface containing the
...
extends NoSuchElementExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.InputMismatchException.class!",
                   java.util.InputMismatchException.class.isAssignableFrom(sut));
    }

 ...
 * java.rmi.activation.ActivationMonitor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationMonitorTests}).
 * </p>
 *
 * <p>
 ...
 * @see ActivationMonitorTests ActivationMonitorTests (The complementary j8unit test interface containing the instance
...
public abstract interface ActivationMonitorClassTests<SUT extends java.rmi.activation.ActivationMonitor>
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationMonitor.class!",
                   java.rmi.activation.ActivationMonitor.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActivationMonitor
 * public abstract interface java.rmi.activation.ActivationMonitor}.
 *
...
extends RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationMonitor.class!",
                   ActivationMonitor.class.isAssignableFrom(sut));
    }

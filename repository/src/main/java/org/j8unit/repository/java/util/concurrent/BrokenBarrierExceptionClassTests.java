 ...
 * java.util.concurrent.BrokenBarrierException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BrokenBarrierExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link BrokenBarrierExceptionTests}.
 * </p>
 *
 * @see java.util.concurrent.BrokenBarrierException class java.util.concurrent.BrokenBarrierException (the hereby
 *      targeted class-under-test class)
 * @see BrokenBarrierExceptionTests BrokenBarrierExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.BrokenBarrierException.class!",
                   java.util.concurrent.BrokenBarrierException.class.isAssignableFrom(sut));
    }

 ...
 * {@link BrokenBarrierException public class java.util.concurrent.BrokenBarrierException}.
 *
...
public abstract interface BrokenBarrierExceptionClassTests<SUT extends BrokenBarrierException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BrokenBarrierException.class!",
                   BrokenBarrierException.class.isAssignableFrom(sut));
    }

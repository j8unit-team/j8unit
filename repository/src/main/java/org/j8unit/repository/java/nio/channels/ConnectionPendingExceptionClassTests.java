...
public abstract interface ConnectionPendingExceptionClassTests<SUT extends ConnectionPendingException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConnectionPendingException.class!",
                   ConnectionPendingException.class.isAssignableFrom(sut));
    }

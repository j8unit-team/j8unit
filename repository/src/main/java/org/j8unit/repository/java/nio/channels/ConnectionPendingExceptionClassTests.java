...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.ConnectionPendingException class
 * java.nio.channels.ConnectionPendingException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link ConnectionPendingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ConnectionPendingExceptionTests ConnectionPendingExceptionTests (The complementary j8unit test interface
...
public abstract interface ConnectionPendingExceptionClassTests<SUT extends java.nio.channels.ConnectionPendingException>
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ConnectionPendingException.class!",
                   java.nio.channels.ConnectionPendingException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AppletStub public
 * abstract interface java.applet.AppletStub}.
 *
...
public abstract interface AppletStubClassTests<SUT extends AppletStub>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AppletStub.class!",
                   AppletStub.class.isAssignableFrom(sut));
    }

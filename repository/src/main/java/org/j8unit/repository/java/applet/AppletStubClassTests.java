 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AppletStubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AppletStubTests}.
 * </p>
 *
 * @see java.applet.AppletStub interface java.applet.AppletStub (the hereby targeted class-under-test class)
 * @see AppletStubTests AppletStubTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AppletStubClassTests<SUT extends java.applet.AppletStub>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.applet.AppletStub.class!",
                   java.applet.AppletStub.class.isAssignableFrom(sut));
    }

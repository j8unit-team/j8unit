 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link Collector
 * public abstract interface java.util.stream.Collector<T,A,R>}.
 * </p>
 *
 * <p>
...
public abstract interface CollectorTests<SUT extends Collector<T, A, R>, T, A, R>
extends RepositoryTests<SUT> {
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface CharacteristicsTests<SUT extends Characteristics>
    extends org.j8unit.repository.java.lang.EnumTests<SUT, Characteristics> {

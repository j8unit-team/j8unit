 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AWTPermission
...
public abstract interface AWTPermissionClassTests<SUT extends AWTPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AWTPermission.class!",
                   AWTPermission.class.isAssignableFrom(sut));
    }

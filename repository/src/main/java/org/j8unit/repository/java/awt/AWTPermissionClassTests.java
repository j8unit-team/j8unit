 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AWTPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AWTPermissionTests}.
 * </p>
 *
 * @see java.awt.AWTPermission class java.awt.AWTPermission (the hereby targeted class-under-test class)
 * @see AWTPermissionTests AWTPermissionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.AWTPermission.class!",
                   java.awt.AWTPermission.class.isAssignableFrom(sut));
    }

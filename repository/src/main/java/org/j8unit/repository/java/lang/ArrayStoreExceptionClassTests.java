...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ArrayStoreException class java.lang.ArrayStoreException}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ArrayStoreExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ArrayStoreExceptionTests}.
 * </p>
 *
 * @see ArrayStoreException class java.lang.ArrayStoreException (the hereby targeted class-under-test class)
 * @see ArrayStoreExceptionTests ArrayStoreExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ArrayStoreExceptionClassTests<SUT extends ArrayStoreException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ArrayStoreException.class!",
                   ArrayStoreException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MappedByteBuffer
...
public abstract interface MappedByteBufferClassTests<SUT extends MappedByteBuffer>
extends ByteBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MappedByteBuffer.class!",

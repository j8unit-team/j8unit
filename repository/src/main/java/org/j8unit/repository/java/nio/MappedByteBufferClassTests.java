 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MappedByteBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MappedByteBufferTests}.
 * </p>
 *
 * @see java.nio.MappedByteBuffer class java.nio.MappedByteBuffer (the hereby targeted class-under-test class)
 * @see MappedByteBufferTests MappedByteBufferTests (The complementary j8unit test interface containing the instance
...
public abstract interface MappedByteBufferClassTests<SUT extends java.nio.MappedByteBuffer>
extends ByteBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.MappedByteBuffer.class!",
                   java.nio.MappedByteBuffer.class.isAssignableFrom(sut));
    }

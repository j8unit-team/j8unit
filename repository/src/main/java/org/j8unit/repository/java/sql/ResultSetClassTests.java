 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResultSet public
 * abstract interface java.sql.ResultSet}.
 *
...
public abstract interface ResultSetClassTests<SUT extends ResultSet>
extends org.j8unit.repository.java.sql.WrapperClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResultSet.class!",
                   ResultSet.class.isAssignableFrom(sut));
    }

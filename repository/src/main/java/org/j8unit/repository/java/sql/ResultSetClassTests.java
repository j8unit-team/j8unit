...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.ResultSet interface java.sql.ResultSet}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResultSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ResultSetTests}.
 * </p>
 *
 * @see java.sql.ResultSet interface java.sql.ResultSet (the hereby targeted class-under-test class)
 * @see ResultSetTests ResultSetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ResultSetClassTests<SUT extends java.sql.ResultSet>
extends WrapperClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.ResultSet.class!",
                   java.sql.ResultSet.class.isAssignableFrom(sut));
    }

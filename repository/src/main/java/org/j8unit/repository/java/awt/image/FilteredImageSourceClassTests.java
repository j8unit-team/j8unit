 ...
 * java.awt.image.FilteredImageSource}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilteredImageSourceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilteredImageSourceTests}.
 * </p>
 *
 * @see java.awt.image.FilteredImageSource class java.awt.image.FilteredImageSource (the hereby targeted
 *      class-under-test class)
 * @see FilteredImageSourceTests FilteredImageSourceTests (The complementary j8unit test interface containing the
...
extends ImageProducerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.FilteredImageSource.class!",
                   java.awt.image.FilteredImageSource.class.isAssignableFrom(sut));
    }

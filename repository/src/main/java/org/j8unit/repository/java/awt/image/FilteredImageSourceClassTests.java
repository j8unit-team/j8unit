 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilteredImageSource
...
public abstract interface FilteredImageSourceClassTests<SUT extends FilteredImageSource>
extends ImageProducerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilteredImageSource.class!",
                   FilteredImageSource.class.isAssignableFrom(sut));
    }

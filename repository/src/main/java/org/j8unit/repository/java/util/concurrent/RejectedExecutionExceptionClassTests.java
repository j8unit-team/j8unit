 ...
 * java.util.concurrent.RejectedExecutionException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link RejectedExecutionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see RejectedExecutionExceptionTests RejectedExecutionExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.RejectedExecutionException.class!",
                   java.util.concurrent.RejectedExecutionException.class.isAssignableFrom(sut));
    }

 ...
 * {@link RejectedExecutionException public class java.util.concurrent.RejectedExecutionException}.
 *
...
public abstract interface RejectedExecutionExceptionClassTests<SUT extends RejectedExecutionException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RejectedExecutionException.class!",
                   RejectedExecutionException.class.isAssignableFrom(sut));
    }

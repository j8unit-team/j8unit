 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResolverStyle
...
public abstract interface ResolverStyleClassTests<SUT extends ResolverStyle>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResolverStyle.class!",
                   ResolverStyle.class.isAssignableFrom(sut));
    }

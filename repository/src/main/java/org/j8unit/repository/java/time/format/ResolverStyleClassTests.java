...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.format.ResolverStyle class java.time.format.ResolverStyle},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResolverStyleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ResolverStyleTests}.
 * </p>
 *
 * @see java.time.format.ResolverStyle class java.time.format.ResolverStyle (the hereby targeted class-under-test class)
 * @see ResolverStyleTests ResolverStyleTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ResolverStyleClassTests<SUT extends java.time.format.ResolverStyle>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.ResolverStyle.class!",
                   java.time.format.ResolverStyle.class.isAssignableFrom(sut));
    }

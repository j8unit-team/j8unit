 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextFieldPeer
...
public abstract interface TextFieldPeerClassTests<SUT extends TextFieldPeer>
extends TextComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextFieldPeer.class!",
                   TextFieldPeer.class.isAssignableFrom(sut));
    }

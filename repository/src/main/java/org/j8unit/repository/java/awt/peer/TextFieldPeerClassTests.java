...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.TextFieldPeer interface java.awt.peer.TextFieldPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextFieldPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextFieldPeerTests}.
 * </p>
 *
 * @see java.awt.peer.TextFieldPeer interface java.awt.peer.TextFieldPeer (the hereby targeted class-under-test class)
 * @see TextFieldPeerTests TextFieldPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TextFieldPeerClassTests<SUT extends java.awt.peer.TextFieldPeer>
extends TextComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.TextFieldPeer.class!",
                   java.awt.peer.TextFieldPeer.class.isAssignableFrom(sut));
    }

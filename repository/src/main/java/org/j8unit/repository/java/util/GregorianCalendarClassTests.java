 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GregorianCalendar
...
public abstract interface GregorianCalendarClassTests<SUT extends GregorianCalendar>
extends CalendarClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GregorianCalendar.class!",
                   GregorianCalendar.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GregorianCalendarTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GregorianCalendarTests}.
 * </p>
 *
 * @see java.util.GregorianCalendar class java.util.GregorianCalendar (the hereby targeted class-under-test class)
 * @see GregorianCalendarTests GregorianCalendarTests (The complementary j8unit test interface containing the instance
...
extends CalendarClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.GregorianCalendar.class!",
                   java.util.GregorianCalendar.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Type public
 * abstract interface java.lang.reflect.Type}.
 *
...
public abstract interface TypeClassTests<SUT extends Type>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Type.class!", Type.class.isAssignableFrom(sut));
    }

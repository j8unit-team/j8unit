...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.Type interface java.lang.reflect.Type}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeTests}).
 * </p>
 *
 * <p>
 ...
 * @see TypeTests TypeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface TypeClassTests<SUT extends java.lang.reflect.Type>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.Type.class!",
                   java.lang.reflect.Type.class.isAssignableFrom(sut));
    }

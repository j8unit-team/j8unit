 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleFunction
 * public abstract interface java.util.function.DoubleFunction<R>}.
 *
...
public abstract interface DoubleFunctionClassTests<SUT extends DoubleFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleFunction.class!",
                   DoubleFunction.class.isAssignableFrom(sut));
    }

 ...
 * java.util.function.DoubleFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleFunctionTests}.
 * </p>
 *
 * @see java.util.function.DoubleFunction interface java.util.function.DoubleFunction (the hereby targeted
 *      class-under-test class)
 * @see DoubleFunctionTests DoubleFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface DoubleFunctionClassTests<SUT extends java.util.function.DoubleFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoubleFunction.class!",
                   java.util.function.DoubleFunction.class.isAssignableFrom(sut));
    }

 ...
 * java.security.interfaces.DSAPublicKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAPublicKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAPublicKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.DSAPublicKey interface java.security.interfaces.DSAPublicKey (the hereby targeted
 *      class-under-test class)
 * @see DSAPublicKeyTests DSAPublicKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DSAPublicKeyClassTests<SUT extends java.security.interfaces.DSAPublicKey>
extends DSAKeyClassTests<SUT>, org.j8unit.repository.java.security.PublicKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.DSAPublicKey.class!",
                   java.security.interfaces.DSAPublicKey.class.isAssignableFrom(sut));
    }

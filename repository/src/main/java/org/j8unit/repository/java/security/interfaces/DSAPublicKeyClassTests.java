 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAPublicKey public
 * abstract interface java.security.interfaces.DSAPublicKey}.
 *
...
public abstract interface DSAPublicKeyClassTests<SUT extends DSAPublicKey>
extends DSAKeyClassTests<SUT>, PublicKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAPublicKey.class!",
                   DSAPublicKey.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntToDoubleFunction
 * public abstract interface java.util.function.IntToDoubleFunction}.
 *
...
public abstract interface IntToDoubleFunctionClassTests<SUT extends IntToDoubleFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntToDoubleFunction.class!",
                   IntToDoubleFunction.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.IntToDoubleFunction interface
 * java.util.function.IntToDoubleFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntToDoubleFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntToDoubleFunctionTests}.
 * </p>
 *
 * @see java.util.function.IntToDoubleFunction interface java.util.function.IntToDoubleFunction (the hereby targeted
 *      class-under-test class)
 * @see IntToDoubleFunctionTests IntToDoubleFunctionTests (The complementary j8unit test interface containing the
...
public abstract interface IntToDoubleFunctionClassTests<SUT extends java.util.function.IntToDoubleFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntToDoubleFunction.class!",
                   java.util.function.IntToDoubleFunction.class.isAssignableFrom(sut));
    }

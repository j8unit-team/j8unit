 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParameterMetaDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParameterMetaDataTests}.
 * </p>
 *
 * @see java.sql.ParameterMetaData interface java.sql.ParameterMetaData (the hereby targeted class-under-test class)
 * @see ParameterMetaDataTests ParameterMetaDataTests (The complementary j8unit test interface containing the instance
...
public abstract interface ParameterMetaDataClassTests<SUT extends java.sql.ParameterMetaData>
extends WrapperClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.ParameterMetaData.class!",
                   java.sql.ParameterMetaData.class.isAssignableFrom(sut));
    }

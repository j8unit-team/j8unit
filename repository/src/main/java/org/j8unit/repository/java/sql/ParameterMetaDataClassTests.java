 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParameterMetaData
 * public abstract interface java.sql.ParameterMetaData}.
 *
...
public abstract interface ParameterMetaDataClassTests<SUT extends ParameterMetaData>
extends WrapperClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParameterMetaData.class!",
                   ParameterMetaData.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.charset.CharsetDecoder class java.nio.charset.CharsetDecoder}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharsetDecoderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharsetDecoderTests}.
 * </p>
 *
 * @see java.nio.charset.CharsetDecoder class java.nio.charset.CharsetDecoder (the hereby targeted class-under-test
 *      class)
 * @see CharsetDecoderTests CharsetDecoderTests (The complementary j8unit test interface containing the instance
...
public abstract interface CharsetDecoderClassTests<SUT extends java.nio.charset.CharsetDecoder>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.CharsetDecoder.class!",
                   java.nio.charset.CharsetDecoder.class.isAssignableFrom(sut));
    }

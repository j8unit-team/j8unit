 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IOError public
...
public abstract interface IOErrorClassTests<SUT extends IOError>
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IOError.class!",
                   IOError.class.isAssignableFrom(sut));
    }

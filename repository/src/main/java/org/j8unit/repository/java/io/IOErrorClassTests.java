...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.IOError class java.io.IOError}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IOErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IOErrorTests}.
 * </p>
 *
 * @see java.io.IOError class java.io.IOError (the hereby targeted class-under-test class)
 * @see IOErrorTests IOErrorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IOErrorClassTests<SUT extends java.io.IOError>
extends org.j8unit.repository.java.lang.ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.IOError.class!",
                   java.io.IOError.class.isAssignableFrom(sut));
    }

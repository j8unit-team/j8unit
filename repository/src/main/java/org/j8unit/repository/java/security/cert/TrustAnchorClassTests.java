 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TrustAnchor public
...
public abstract interface TrustAnchorClassTests<SUT extends TrustAnchor>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TrustAnchor.class!",
                   TrustAnchor.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TrustAnchorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TrustAnchorTests}.
 * </p>
 *
 * @see java.security.cert.TrustAnchor class java.security.cert.TrustAnchor (the hereby targeted class-under-test class)
 * @see TrustAnchorTests TrustAnchorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.TrustAnchor.class!",
                   java.security.cert.TrustAnchor.class.isAssignableFrom(sut));
    }

 ...
 * {@link CollectionCertStoreParameters public class java.security.cert.CollectionCertStoreParameters}.
 *
...
public abstract interface CollectionCertStoreParametersClassTests<SUT extends CollectionCertStoreParameters>
extends CertStoreParametersClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CollectionCertStoreParameters.class!",
                   CollectionCertStoreParameters.class.isAssignableFrom(sut));
    }

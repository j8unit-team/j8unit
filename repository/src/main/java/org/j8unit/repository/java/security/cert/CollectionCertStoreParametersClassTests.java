 ...
 * java.security.cert.CollectionCertStoreParameters}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CollectionCertStoreParametersTests}).
 * </p>
 *
 * <p>
 ...
 * @see CollectionCertStoreParametersTests CollectionCertStoreParametersTests (The complementary j8unit test interface
...
public abstract interface CollectionCertStoreParametersClassTests<SUT extends java.security.cert.CollectionCertStoreParameters>
extends CertStoreParametersClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CollectionCertStoreParameters.class!",
                   java.security.cert.CollectionCertStoreParameters.class.isAssignableFrom(sut));
    }

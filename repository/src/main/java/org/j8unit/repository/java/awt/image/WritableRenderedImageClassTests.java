 ...
 * java.awt.image.WritableRenderedImage}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WritableRenderedImageTests}).
 * </p>
 *
 * <p>
 ...
 * @see WritableRenderedImageTests WritableRenderedImageTests (The complementary j8unit test interface containing the
...
public abstract interface WritableRenderedImageClassTests<SUT extends java.awt.image.WritableRenderedImage>
extends RenderedImageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.WritableRenderedImage.class!",
                   java.awt.image.WritableRenderedImage.class.isAssignableFrom(sut));
    }

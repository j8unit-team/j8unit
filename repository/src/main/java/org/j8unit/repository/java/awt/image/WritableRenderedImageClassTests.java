...
extends org.j8unit.repository.java.awt.image.RenderedImageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WritableRenderedImage.class!",
                   WritableRenderedImage.class.isAssignableFrom(sut));
    }

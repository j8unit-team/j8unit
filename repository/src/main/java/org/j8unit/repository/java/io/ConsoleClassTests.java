 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Console public
...
public abstract interface ConsoleClassTests<SUT extends Console>
extends org.j8unit.repository.java.io.FlushableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Console.class!",
                   Console.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.Console class java.io.Console}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConsoleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConsoleTests}.
 * </p>
 *
 * @see java.io.Console class java.io.Console (the hereby targeted class-under-test class)
 * @see ConsoleTests ConsoleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ConsoleClassTests<SUT extends java.io.Console>
extends FlushableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.Console.class!",
                   java.io.Console.class.isAssignableFrom(sut));
    }

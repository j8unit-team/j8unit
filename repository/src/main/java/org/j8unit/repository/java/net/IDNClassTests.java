 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IDN public final
 * class java.net.IDN}.
 *
...
public abstract interface IDNClassTests<SUT extends IDN>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IDN.class!", IDN.class.isAssignableFrom(sut));
    }

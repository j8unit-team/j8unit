...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.IDN class java.net.IDN}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IDNTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IDNTests}.
 * </p>
 *
 * @see java.net.IDN class java.net.IDN (the hereby targeted class-under-test class)
 * @see IDNTests IDNTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface IDNClassTests<SUT extends java.net.IDN>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.IDN.class!",
                   java.net.IDN.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.channels.ClosedSelectorException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClosedSelectorExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ClosedSelectorExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.ClosedSelectorException class java.nio.channels.ClosedSelectorException (the hereby targeted
 *      class-under-test class)
 * @see ClosedSelectorExceptionTests ClosedSelectorExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ClosedSelectorException.class!",
                   java.nio.channels.ClosedSelectorException.class.isAssignableFrom(sut));
    }

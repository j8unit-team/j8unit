 ...
 * {@link ClosedSelectorException public class java.nio.channels.ClosedSelectorException}.
 *
...
public abstract interface ClosedSelectorExceptionClassTests<SUT extends ClosedSelectorException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClosedSelectorException.class!",
                   ClosedSelectorException.class.isAssignableFrom(sut));
    }

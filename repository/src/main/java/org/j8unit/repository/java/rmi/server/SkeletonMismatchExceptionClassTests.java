 ...
 * java.rmi.server.SkeletonMismatchException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link SkeletonMismatchExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see SkeletonMismatchExceptionTests SkeletonMismatchExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.SkeletonMismatchException.class!",
                   java.rmi.server.SkeletonMismatchException.class.isAssignableFrom(sut));
    }

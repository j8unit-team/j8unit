...
public abstract interface SkeletonMismatchExceptionClassTests<SUT extends SkeletonMismatchException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SkeletonMismatchException.class!",
                   SkeletonMismatchException.class.isAssignableFrom(sut));
    }

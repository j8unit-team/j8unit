...
public abstract interface RMIClientSocketFactoryClassTests<SUT extends RMIClientSocketFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMIClientSocketFactory.class!",
                   RMIClientSocketFactory.class.isAssignableFrom(sut));
    }

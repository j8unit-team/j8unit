 ...
 * java.rmi.server.RMIClientSocketFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMIClientSocketFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RMIClientSocketFactoryTests}.
 * </p>
 *
 * @see java.rmi.server.RMIClientSocketFactory interface java.rmi.server.RMIClientSocketFactory (the hereby targeted
 *      class-under-test class)
 * @see RMIClientSocketFactoryTests RMIClientSocketFactoryTests (The complementary j8unit test interface containing the
...
public abstract interface RMIClientSocketFactoryClassTests<SUT extends java.rmi.server.RMIClientSocketFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RMIClientSocketFactory.class!",
                   java.rmi.server.RMIClientSocketFactory.class.isAssignableFrom(sut));
    }

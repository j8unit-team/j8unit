 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AuthenticatorTests}).
 * </p>
 *
 * <p>
 ...
 * @see AuthenticatorTests AuthenticatorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.Authenticator.class!",
                   java.net.Authenticator.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.net.Authenticator.RequestorType class
     * java.net.Authenticator$RequestorType}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link AuthenticatorTests.RequestorTypeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see AuthenticatorTests.RequestorTypeTests AuthenticatorTests.RequestorTypeTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.Authenticator.RequestorType.class!",
                       java.net.Authenticator.RequestorType.class.isAssignableFrom(sut));
        }

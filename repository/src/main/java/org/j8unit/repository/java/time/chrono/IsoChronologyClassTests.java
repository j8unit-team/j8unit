 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IsoChronology
...
public abstract interface IsoChronologyClassTests<SUT extends IsoChronology>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.time.chrono.AbstractChronologyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IsoChronology.class!",
                   IsoChronology.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.chrono.IsoChronology class java.time.chrono.IsoChronology},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IsoChronologyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IsoChronologyTests}.
 * </p>
 *
 * @see java.time.chrono.IsoChronology class java.time.chrono.IsoChronology (the hereby targeted class-under-test class)
 * @see IsoChronologyTests IsoChronologyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface IsoChronologyClassTests<SUT extends java.time.chrono.IsoChronology>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractChronologyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.IsoChronology.class!",
                   java.time.chrono.IsoChronology.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RemoteException
...
public abstract interface RemoteExceptionClassTests<SUT extends RemoteException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemoteException.class!",
                   RemoteException.class.isAssignableFrom(sut));
    }

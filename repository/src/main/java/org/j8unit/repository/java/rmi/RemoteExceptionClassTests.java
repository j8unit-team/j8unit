...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.RemoteException class java.rmi.RemoteException}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RemoteExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RemoteExceptionTests}.
 * </p>
 *
 * @see java.rmi.RemoteException class java.rmi.RemoteException (the hereby targeted class-under-test class)
 * @see RemoteExceptionTests RemoteExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.RemoteException.class!",
                   java.rmi.RemoteException.class.isAssignableFrom(sut));
    }

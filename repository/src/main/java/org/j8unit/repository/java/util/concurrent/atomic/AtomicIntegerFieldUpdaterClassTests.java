 ...
 * {@link AtomicIntegerFieldUpdater public abstract class java.util.concurrent.atomic.AtomicIntegerFieldUpdater<T>}.
 *
...
public abstract interface AtomicIntegerFieldUpdaterClassTests<SUT extends AtomicIntegerFieldUpdater>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicIntegerFieldUpdater.class!",
                   AtomicIntegerFieldUpdater.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.concurrent.atomic.AtomicIntegerFieldUpdater]

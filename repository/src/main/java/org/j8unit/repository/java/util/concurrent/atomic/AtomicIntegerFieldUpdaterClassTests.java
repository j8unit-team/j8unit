 ...
 * java.util.concurrent.atomic.AtomicIntegerFieldUpdater}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AtomicIntegerFieldUpdaterTests}).
 * </p>
 *
 * <p>
 ...
 * @see AtomicIntegerFieldUpdaterTests AtomicIntegerFieldUpdaterTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicIntegerFieldUpdater.class!",
                   java.util.concurrent.atomic.AtomicIntegerFieldUpdater.class.isAssignableFrom(sut));
    }

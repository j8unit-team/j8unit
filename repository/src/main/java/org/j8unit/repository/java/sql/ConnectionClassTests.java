...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Connection interface java.sql.Connection}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConnectionTests}.
 * </p>
 *
 * @see java.sql.Connection interface java.sql.Connection (the hereby targeted class-under-test class)
 * @see ConnectionTests ConnectionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ConnectionClassTests<SUT extends java.sql.Connection>
extends WrapperClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Connection.class!",
                   java.sql.Connection.class.isAssignableFrom(sut));
    }

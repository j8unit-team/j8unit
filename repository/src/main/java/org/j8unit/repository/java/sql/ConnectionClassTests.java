 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Connection public
 * abstract interface java.sql.Connection}.
 *
...
public abstract interface ConnectionClassTests<SUT extends Connection>
extends org.j8unit.repository.java.sql.WrapperClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Connection.class!",
                   Connection.class.isAssignableFrom(sut));
    }

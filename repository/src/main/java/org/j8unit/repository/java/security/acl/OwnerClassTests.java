 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OwnerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OwnerTests}.
 * </p>
 *
 * @see java.security.acl.Owner interface java.security.acl.Owner (the hereby targeted class-under-test class)
 * @see OwnerTests OwnerTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface OwnerClassTests<SUT extends java.security.acl.Owner>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.acl.Owner.class!",
                   java.security.acl.Owner.class.isAssignableFrom(sut));
    }

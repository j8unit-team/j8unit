 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VMID public final
...
public abstract interface VMIDClassTests<SUT extends VMID>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VMID.class!", VMID.class.isAssignableFrom(sut));
    }

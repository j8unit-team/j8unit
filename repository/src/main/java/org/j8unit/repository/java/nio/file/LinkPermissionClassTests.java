 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkPermission
...
public abstract interface LinkPermissionClassTests<SUT extends LinkPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkPermission.class!",
                   LinkPermission.class.isAssignableFrom(sut));
    }

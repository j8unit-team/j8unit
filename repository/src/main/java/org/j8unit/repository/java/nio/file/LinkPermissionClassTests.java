 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkPermissionTests}.
 * </p>
 *
 * @see java.nio.file.LinkPermission class java.nio.file.LinkPermission (the hereby targeted class-under-test class)
 * @see LinkPermissionTests LinkPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.LinkPermission.class!",
                   java.nio.file.LinkPermission.class.isAssignableFrom(sut));
    }

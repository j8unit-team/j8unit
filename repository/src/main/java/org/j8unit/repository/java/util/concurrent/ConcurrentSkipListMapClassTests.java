 ...
 * java.util.concurrent.ConcurrentSkipListMap}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConcurrentSkipListMapTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ConcurrentSkipListMapTests}.
 * </p>
 *
 * @see java.util.concurrent.ConcurrentSkipListMap class java.util.concurrent.ConcurrentSkipListMap (the hereby targeted
 *      class-under-test class)
 * @see ConcurrentSkipListMapTests ConcurrentSkipListMapTests (The complementary j8unit test interface containing the
...
extends ConcurrentNavigableMapClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>,
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ConcurrentSkipListMap.class!",
                   java.util.concurrent.ConcurrentSkipListMap.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ContainerAdapter
...
public abstract interface ContainerAdapterClassTests<SUT extends ContainerAdapter>
extends org.j8unit.repository.java.awt.event.ContainerListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContainerAdapter.class!",
                   ContainerAdapter.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.event.ContainerAdapter]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.awt.event.ContainerAdapter]

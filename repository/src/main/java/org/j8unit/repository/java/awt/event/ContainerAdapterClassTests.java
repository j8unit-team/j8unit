...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.ContainerAdapter class java.awt.event.ContainerAdapter}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContainerAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ContainerAdapterTests}.
 * </p>
 *
 * @see java.awt.event.ContainerAdapter class java.awt.event.ContainerAdapter (the hereby targeted class-under-test
 *      class)
 * @see ContainerAdapterTests ContainerAdapterTests (The complementary j8unit test interface containing the instance
...
public abstract interface ContainerAdapterClassTests<SUT extends java.awt.event.ContainerAdapter>
extends ContainerListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ContainerAdapter.class!",
                   java.awt.event.ContainerAdapter.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.HttpCookie class java.net.HttpCookie}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HttpCookieTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HttpCookieTests}.
 * </p>
 *
 * @see java.net.HttpCookie class java.net.HttpCookie (the hereby targeted class-under-test class)
 * @see HttpCookieTests HttpCookieTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.HttpCookie.class!",
                   java.net.HttpCookie.class.isAssignableFrom(sut));
    }

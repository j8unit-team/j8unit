 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HttpCookie public
 * final class java.net.HttpCookie}.
 *
...
public abstract interface HttpCookieClassTests<SUT extends HttpCookie>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HttpCookie.class!",

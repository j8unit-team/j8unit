 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ItemEvent public
...
public abstract interface ItemEventClassTests<SUT extends ItemEvent>
extends AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ItemEvent.class!",
                   ItemEvent.class.isAssignableFrom(sut));
    }

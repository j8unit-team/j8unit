...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.ItemEvent class java.awt.event.ItemEvent}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ItemEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ItemEventTests}.
 * </p>
 *
 * @see java.awt.event.ItemEvent class java.awt.event.ItemEvent (the hereby targeted class-under-test class)
 * @see ItemEventTests ItemEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ItemEventClassTests<SUT extends java.awt.event.ItemEvent>
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ItemEvent.class!",
                   java.awt.event.ItemEvent.class.isAssignableFrom(sut));
    }

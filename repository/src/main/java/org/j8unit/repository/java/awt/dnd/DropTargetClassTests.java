 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTarget public
...
public abstract interface DropTargetClassTests<SUT extends DropTarget>
extends DropTargetListenerClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTarget.class!",
                   DropTarget.class.isAssignableFrom(sut));
    }

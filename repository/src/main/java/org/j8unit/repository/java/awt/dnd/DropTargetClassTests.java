 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DropTargetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DropTargetTests}.
 * </p>
 *
 * @see java.awt.dnd.DropTarget class java.awt.dnd.DropTarget (the hereby targeted class-under-test class)
 * @see DropTargetTests DropTargetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends DropTargetListenerClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DropTarget.class!",
                   java.awt.dnd.DropTarget.class.isAssignableFrom(sut));
    }

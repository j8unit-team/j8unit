 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextStyleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextStyleTests}.
 * </p>
 *
 * @see java.time.format.TextStyle class java.time.format.TextStyle (the hereby targeted class-under-test class)
 * @see TextStyleTests TextStyleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.TextStyle.class!",
                   java.time.format.TextStyle.class.isAssignableFrom(sut));
    }

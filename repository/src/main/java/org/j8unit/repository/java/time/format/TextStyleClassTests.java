 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextStyle public
 * final enum java.time.format.TextStyle}.
 *
...
public abstract interface TextStyleClassTests<SUT extends TextStyle>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextStyle.class!",
                   TextStyle.class.isAssignableFrom(sut));
    }

 ...
 * {@link ScatteringByteChannel public abstract interface java.nio.channels.ScatteringByteChannel}.
 *
...
public abstract interface ScatteringByteChannelClassTests<SUT extends ScatteringByteChannel>
extends ReadableByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ScatteringByteChannel.class!",
                   ScatteringByteChannel.class.isAssignableFrom(sut));
    }

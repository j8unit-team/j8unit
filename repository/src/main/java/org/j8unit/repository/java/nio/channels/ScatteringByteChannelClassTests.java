...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.ScatteringByteChannel interface
 * java.nio.channels.ScatteringByteChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScatteringByteChannelTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ScatteringByteChannelTests}.
 * </p>
 *
 * @see java.nio.channels.ScatteringByteChannel interface java.nio.channels.ScatteringByteChannel (the hereby targeted
 *      class-under-test class)
 * @see ScatteringByteChannelTests ScatteringByteChannelTests (The complementary j8unit test interface containing the
...
extends ReadableByteChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ScatteringByteChannel.class!",
                   java.nio.channels.ScatteringByteChannel.class.isAssignableFrom(sut));
    }

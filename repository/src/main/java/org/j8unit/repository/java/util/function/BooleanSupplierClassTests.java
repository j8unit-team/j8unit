...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.BooleanSupplier interface
 * java.util.function.BooleanSupplier}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BooleanSupplierTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BooleanSupplierTests}.
 * </p>
 *
 * @see java.util.function.BooleanSupplier interface java.util.function.BooleanSupplier (the hereby targeted
 *      class-under-test class)
 * @see BooleanSupplierTests BooleanSupplierTests (The complementary j8unit test interface containing the instance
...
public abstract interface BooleanSupplierClassTests<SUT extends java.util.function.BooleanSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.BooleanSupplier.class!",
                   java.util.function.BooleanSupplier.class.isAssignableFrom(sut));
    }

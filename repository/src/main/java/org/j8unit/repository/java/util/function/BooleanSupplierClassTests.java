 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BooleanSupplier
 * public abstract interface java.util.function.BooleanSupplier}.
 *
...
public abstract interface BooleanSupplierClassTests<SUT extends BooleanSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BooleanSupplier.class!",
                   BooleanSupplier.class.isAssignableFrom(sut));
    }

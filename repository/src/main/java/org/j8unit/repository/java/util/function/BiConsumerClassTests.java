...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.BiConsumer interface java.util.function.BiConsumer}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BiConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BiConsumerTests}.
 * </p>
 *
 * @see java.util.function.BiConsumer interface java.util.function.BiConsumer (the hereby targeted class-under-test
 *      class)
 * @see BiConsumerTests BiConsumerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BiConsumerClassTests<SUT extends java.util.function.BiConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.BiConsumer.class!",
                   java.util.function.BiConsumer.class.isAssignableFrom(sut));
    }

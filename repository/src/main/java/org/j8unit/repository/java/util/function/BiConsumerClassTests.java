 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BiConsumer public
 * abstract interface java.util.function.BiConsumer<T,U>}.
 *
...
public abstract interface BiConsumerClassTests<SUT extends BiConsumer>
extends RepositoryClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.function.BiConsumer]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BiConsumer.class!",
                   BiConsumer.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.function.BiConsumer]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.util.function.BiConsumer]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain AbstractMethodError class java.lang.AbstractMethodError}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractMethodErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractMethodErrorTests}.
 * </p>
 *
 * @see AbstractMethodError class java.lang.AbstractMethodError (the hereby targeted class-under-test class)
 * @see AbstractMethodErrorTests AbstractMethodErrorTests (The complementary j8unit test interface containing the
...
public abstract interface AbstractMethodErrorClassTests<SUT extends AbstractMethodError>
extends IncompatibleClassChangeErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractMethodError.class!",
                   AbstractMethodError.class.isAssignableFrom(sut));
    }

...
public abstract interface UnknownFormatFlagsExceptionClassTests<SUT extends UnknownFormatFlagsException>
extends org.j8unit.repository.java.util.IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownFormatFlagsException.class!",
                   UnknownFormatFlagsException.class.isAssignableFrom(sut));
    }

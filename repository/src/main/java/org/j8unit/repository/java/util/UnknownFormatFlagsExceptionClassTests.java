 ...
 * java.util.UnknownFormatFlagsException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link UnknownFormatFlagsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnknownFormatFlagsExceptionTests UnknownFormatFlagsExceptionTests (The complementary j8unit test interface
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.UnknownFormatFlagsException.class!",
                   java.util.UnknownFormatFlagsException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResourceBundleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ResourceBundleTests}.
 * </p>
 *
 * @see java.util.ResourceBundle class java.util.ResourceBundle (the hereby targeted class-under-test class)
 * @see ResourceBundleTests ResourceBundleTests (The complementary j8unit test interface containing the instance
...
public abstract interface ResourceBundleClassTests<SUT extends java.util.ResourceBundle>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ResourceBundle.class!",
                   java.util.ResourceBundle.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.ResourceBundle.Control class
     * java.util.ResourceBundle$Control}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link ResourceBundleTests.ControlTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.util.ResourceBundle.Control class java.util.ResourceBundle$Control (the hereby targeted
     *      class-under-test class)
     * @see ResourceBundleTests.ControlTests ResourceBundleTests.ControlTests (The complementary j8unit test interface
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ControlClassTests<SUT extends java.util.ResourceBundle.Control>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ResourceBundle.Control.class!",
                       java.util.ResourceBundle.Control.class.isAssignableFrom(sut));
        }

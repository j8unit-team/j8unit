 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResourceBundle
...
public abstract interface ResourceBundleClassTests<SUT extends ResourceBundle>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResourceBundle.class!",
                   ResourceBundle.class.isAssignableFrom(sut));
    }
     ...
     * {@link Control public static class java.util.ResourceBundle$Control}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ControlClassTests<SUT extends Control>
    extends ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Control.class!",
                              Control.class.isAssignableFrom(sut));
        }

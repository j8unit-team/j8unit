...
public abstract interface CollationElementIteratorClassTests<SUT extends CollationElementIterator>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CollationElementIterator.class!",
                   CollationElementIterator.class.isAssignableFrom(sut));
    }

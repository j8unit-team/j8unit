 ...
 * java.text.CollationElementIterator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollationElementIteratorTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link CollationElementIteratorTests}.
 * </p>
 *
 * @see java.text.CollationElementIterator class java.text.CollationElementIterator (the hereby targeted
 *      class-under-test class)
 * @see CollationElementIteratorTests CollationElementIteratorTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.CollationElementIterator.class!",
                   java.text.CollationElementIterator.class.isAssignableFrom(sut));
    }

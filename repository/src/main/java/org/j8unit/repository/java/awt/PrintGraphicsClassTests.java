 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrintGraphics
...
public abstract interface PrintGraphicsClassTests<SUT extends PrintGraphics>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrintGraphics.class!",
                   PrintGraphics.class.isAssignableFrom(sut));
    }

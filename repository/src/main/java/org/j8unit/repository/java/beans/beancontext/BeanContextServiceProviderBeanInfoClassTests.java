 ...
 * java.beans.beancontext.BeanContextServiceProviderBeanInfo}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * {@link BeanContextServiceProviderBeanInfoTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextServiceProviderBeanInfoTests BeanContextServiceProviderBeanInfoTests (The complementary j8unit test
...
extends org.j8unit.repository.java.beans.BeanInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServiceProviderBeanInfo.class!",
                   java.beans.beancontext.BeanContextServiceProviderBeanInfo.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.beans.BeanInfoClassTests;
 ...
 * {@link BeanContextServiceProviderBeanInfo public abstract interface
...
public abstract interface BeanContextServiceProviderBeanInfoClassTests<SUT extends BeanContextServiceProviderBeanInfo>
extends BeanInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextServiceProviderBeanInfo.class!",
                   BeanContextServiceProviderBeanInfo.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.beans.beancontext.BeanContextServiceProviderBeanInfo]

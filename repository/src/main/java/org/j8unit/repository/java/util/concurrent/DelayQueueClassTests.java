...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.DelayQueue class java.util.concurrent.DelayQueue}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DelayQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DelayQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.DelayQueue class java.util.concurrent.DelayQueue (the hereby targeted class-under-test
 *      class)
 * @see DelayQueueTests DelayQueueTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends BlockingQueueClassTests<SUT>, org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.DelayQueue.class!",
                   java.util.concurrent.DelayQueue.class.isAssignableFrom(sut));
    }

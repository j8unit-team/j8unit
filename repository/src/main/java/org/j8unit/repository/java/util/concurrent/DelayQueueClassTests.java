 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DelayQueue public
 * class java.util.concurrent.DelayQueue<E>}.
 *
...
public abstract interface DelayQueueClassTests<SUT extends DelayQueue>
extends BlockingQueueClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DelayQueue.class!",
                   DelayQueue.class.isAssignableFrom(sut));
    }

 ...
 * java.nio.charset.IllegalCharsetNameException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link IllegalCharsetNameExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalCharsetNameExceptionTests IllegalCharsetNameExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.IllegalCharsetNameException.class!",
                   java.nio.charset.IllegalCharsetNameException.class.isAssignableFrom(sut));
    }

...
public abstract interface IllegalCharsetNameExceptionClassTests<SUT extends IllegalCharsetNameException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalCharsetNameException.class!",

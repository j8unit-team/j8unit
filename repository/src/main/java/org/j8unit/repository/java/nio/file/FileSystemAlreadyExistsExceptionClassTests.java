 ...
 * java.nio.file.FileSystemAlreadyExistsException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link FileSystemAlreadyExistsExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileSystemAlreadyExistsExceptionTests FileSystemAlreadyExistsExceptionTests (The complementary j8unit test
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileSystemAlreadyExistsException.class!",
                   java.nio.file.FileSystemAlreadyExistsException.class.isAssignableFrom(sut));
    }

 ...
 * {@link FileSystemAlreadyExistsException public class java.nio.file.FileSystemAlreadyExistsException}.
 *
...
public abstract interface FileSystemAlreadyExistsExceptionClassTests<SUT extends FileSystemAlreadyExistsException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileSystemAlreadyExistsException.class!",
                   FileSystemAlreadyExistsException.class.isAssignableFrom(sut));
    }

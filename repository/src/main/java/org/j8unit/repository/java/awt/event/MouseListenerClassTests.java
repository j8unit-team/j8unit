 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseListener
...
public abstract interface MouseListenerClassTests<SUT extends MouseListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseListener.class!",
                   MouseListener.class.isAssignableFrom(sut));
    }

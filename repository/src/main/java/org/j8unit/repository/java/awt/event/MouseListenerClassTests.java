 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseListenerTests}.
 * </p>
 *
 * @see java.awt.event.MouseListener interface java.awt.event.MouseListener (the hereby targeted class-under-test class)
 * @see MouseListenerTests MouseListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MouseListenerClassTests<SUT extends java.awt.event.MouseListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.MouseListener.class!",
                   java.awt.event.MouseListener.class.isAssignableFrom(sut));
    }

 ...
 * java.sql.SQLNonTransientConnectionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link SQLNonTransientConnectionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see SQLNonTransientConnectionExceptionTests SQLNonTransientConnectionExceptionTests (The complementary j8unit test
...
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLNonTransientConnectionException.class!",
                   java.sql.SQLNonTransientConnectionException.class.isAssignableFrom(sut));
    }

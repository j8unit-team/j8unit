...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.activation.ActivationGroupDesc class
 * java.rmi.activation.ActivationGroupDesc}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationGroupDescTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActivationGroupDescTests}.
 * </p>
 *
 * @see java.rmi.activation.ActivationGroupDesc class java.rmi.activation.ActivationGroupDesc (the hereby targeted
 *      class-under-test class)
 * @see ActivationGroupDescTests ActivationGroupDescTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationGroupDesc.class!",
                   java.rmi.activation.ActivationGroupDesc.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.rmi.activation.ActivationGroupDesc.CommandEnvironment class
     * java.rmi.activation.ActivationGroupDesc$CommandEnvironment}, containing all type relevant aspects (e.&thinsp;g.,
     ...
     * {@link ActivationGroupDescTests.CommandEnvironmentTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ActivationGroupDescTests.CommandEnvironmentTests ActivationGroupDescTests.CommandEnvironmentTests (The
    ...
    extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationGroupDesc.CommandEnvironment.class!",
                       java.rmi.activation.ActivationGroupDesc.CommandEnvironment.class.isAssignableFrom(sut));
        }

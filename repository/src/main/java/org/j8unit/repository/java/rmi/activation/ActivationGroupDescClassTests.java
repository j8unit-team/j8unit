...
import org.j8unit.repository.java.rmi.activation.ActivationGroupDescTests.CommandEnvironmentTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActivationGroupDesc
 * public final class java.rmi.activation.ActivationGroupDesc}.
 *
...
public abstract interface ActivationGroupDescClassTests<SUT extends ActivationGroupDesc>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationGroupDesc.class!",
                   ActivationGroupDesc.class.isAssignableFrom(sut));
    }
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface CommandEnvironmentClassTests<SUT extends CommandEnvironment>
    extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CommandEnvironment.class!",
                              CommandEnvironment.class.isAssignableFrom(sut));
        }

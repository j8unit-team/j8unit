 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServerRef public
 * abstract interface java.rmi.server.ServerRef}.
 *
...
public abstract interface ServerRefClassTests<SUT extends ServerRef>
extends RemoteRefClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerRef.class!",
                   ServerRef.class.isAssignableFrom(sut));
    }

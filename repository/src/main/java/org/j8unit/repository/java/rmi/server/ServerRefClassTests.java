 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerRefTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServerRefTests}.
 * </p>
 *
 * @see java.rmi.server.ServerRef interface java.rmi.server.ServerRef (the hereby targeted class-under-test class)
 * @see ServerRefTests ServerRefTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ServerRefClassTests<SUT extends java.rmi.server.ServerRef>
extends RemoteRefClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.ServerRef.class!",
                   java.rmi.server.ServerRef.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ClassValue class java.lang.ClassValue}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassValueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClassValueTests}.
 * </p>
 *
 * @see ClassValue class java.lang.ClassValue (the hereby targeted class-under-test class)
 * @see ClassValueTests ClassValueTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ClassValueClassTests<SUT extends ClassValue>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassValue.class!",
                   ClassValue.class.isAssignableFrom(sut));
    }

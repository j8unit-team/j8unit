 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMethodContext
 * public abstract interface java.awt.im.spi.InputMethodContext}.
 *
...
extends InputMethodRequestsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMethodContext.class!",
                   InputMethodContext.class.isAssignableFrom(sut));
    }

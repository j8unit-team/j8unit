 ...
 * java.awt.im.spi.InputMethodContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputMethodContextTests}).
 * </p>
 *
 * <p>
 ...
 * @see InputMethodContextTests InputMethodContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface InputMethodContextClassTests<SUT extends java.awt.im.spi.InputMethodContext>
extends org.j8unit.repository.java.awt.im.InputMethodRequestsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.im.spi.InputMethodContext.class!",
                   java.awt.im.spi.InputMethodContext.class.isAssignableFrom(sut));
    }

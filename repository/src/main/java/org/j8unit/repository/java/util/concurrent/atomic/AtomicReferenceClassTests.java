 ...
 * java.util.concurrent.atomic.AtomicReference}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicReferenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AtomicReferenceTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.AtomicReference class java.util.concurrent.atomic.AtomicReference (the hereby
 *      targeted class-under-test class)
 * @see AtomicReferenceTests AtomicReferenceTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicReference.class!",
                   java.util.concurrent.atomic.AtomicReference.class.isAssignableFrom(sut));
    }

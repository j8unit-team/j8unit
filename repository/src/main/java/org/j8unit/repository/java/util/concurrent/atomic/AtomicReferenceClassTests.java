 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AtomicReference
 * public class java.util.concurrent.atomic.AtomicReference<V>}.
 *
...
public abstract interface AtomicReferenceClassTests<SUT extends AtomicReference>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicReference.class!",
                   AtomicReference.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.concurrent.atomic.AtomicReference]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.MenuContainer interface java.awt.MenuContainer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuContainerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuContainerTests}.
 * </p>
 *
 * @see java.awt.MenuContainer interface java.awt.MenuContainer (the hereby targeted class-under-test class)
 * @see MenuContainerTests MenuContainerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MenuContainerClassTests<SUT extends java.awt.MenuContainer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.MenuContainer.class!",
                   java.awt.MenuContainer.class.isAssignableFrom(sut));
    }

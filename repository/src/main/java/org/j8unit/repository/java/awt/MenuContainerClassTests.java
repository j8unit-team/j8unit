 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuContainer
...
public abstract interface MenuContainerClassTests<SUT extends MenuContainer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuContainer.class!",
                   MenuContainer.class.isAssignableFrom(sut));
    }

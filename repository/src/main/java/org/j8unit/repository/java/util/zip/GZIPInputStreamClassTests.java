 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.zip.GZIPInputStream
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.util.zip.InflaterInputStreamClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.GZIPInputStream#GZIPInputStream(java.io.InputStream)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.GZIPInputStream#GZIPInputStream(java.io.InputStream, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.zip.GZIPInputStream#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

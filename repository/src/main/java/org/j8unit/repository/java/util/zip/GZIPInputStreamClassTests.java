...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.GZIPInputStream class java.util.zip.GZIPInputStream},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GZIPInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GZIPInputStreamTests}.
 * </p>
 *
 * @see java.util.zip.GZIPInputStream class java.util.zip.GZIPInputStream (the hereby targeted class-under-test class)
 * @see GZIPInputStreamTests GZIPInputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface GZIPInputStreamClassTests<SUT extends java.util.zip.GZIPInputStream>
extends InflaterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.GZIPInputStream.class!",
                   java.util.zip.GZIPInputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GZIPInputStream
...
public abstract interface GZIPInputStreamClassTests<SUT extends GZIPInputStream>
extends InflaterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GZIPInputStream.class!",
                   GZIPInputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilePermission
...
public abstract interface FilePermissionClassTests<SUT extends FilePermission>
extends PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilePermission.class!",
                   FilePermission.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilePermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilePermissionTests}.
 * </p>
 *
 * @see java.io.FilePermission class java.io.FilePermission (the hereby targeted class-under-test class)
 * @see FilePermissionTests FilePermissionTests (The complementary j8unit test interface containing the instance
...
public abstract interface FilePermissionClassTests<SUT extends java.io.FilePermission>
extends SerializableClassTests<SUT>, org.j8unit.repository.java.security.PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FilePermission.class!",
                   java.io.FilePermission.class.isAssignableFrom(sut));
    }

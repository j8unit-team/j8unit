 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Choice public class
 * java.awt.Choice}.
 *
...
public abstract interface ChoiceClassTests<SUT extends Choice>
extends ItemSelectableClassTests<SUT>, AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Choice.class!",
                   Choice.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Choice class java.awt.Choice}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChoiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChoiceTests}.
 * </p>
 *
 * @see java.awt.Choice class java.awt.Choice (the hereby targeted class-under-test class)
 * @see ChoiceTests ChoiceTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ChoiceClassTests<SUT extends java.awt.Choice>
extends ItemSelectableClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Choice.class!",
                   java.awt.Choice.class.isAssignableFrom(sut));
    }

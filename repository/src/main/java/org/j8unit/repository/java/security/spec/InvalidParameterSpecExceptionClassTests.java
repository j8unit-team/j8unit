...
public abstract interface InvalidParameterSpecExceptionClassTests<SUT extends InvalidParameterSpecException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidParameterSpecException.class!",
                   InvalidParameterSpecException.class.isAssignableFrom(sut));
    }

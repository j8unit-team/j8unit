 ...
 * java.security.spec.InvalidParameterSpecException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link InvalidParameterSpecExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidParameterSpecExceptionTests InvalidParameterSpecExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.InvalidParameterSpecException.class!",
                   java.security.spec.InvalidParameterSpecException.class.isAssignableFrom(sut));
    }

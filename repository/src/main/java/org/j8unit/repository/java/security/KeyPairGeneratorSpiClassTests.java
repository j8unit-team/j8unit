 ...
 * java.security.KeyPairGeneratorSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyPairGeneratorSpiTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyPairGeneratorSpiTests}.
 * </p>
 *
 * @see java.security.KeyPairGeneratorSpi class java.security.KeyPairGeneratorSpi (the hereby targeted class-under-test
 *      class)
 * @see KeyPairGeneratorSpiTests KeyPairGeneratorSpiTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.KeyPairGeneratorSpi.class!",
                   java.security.KeyPairGeneratorSpi.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyPairGeneratorSpi
...
public abstract interface KeyPairGeneratorSpiClassTests<SUT extends KeyPairGeneratorSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyPairGeneratorSpi.class!",
                   KeyPairGeneratorSpi.class.isAssignableFrom(sut));
    }

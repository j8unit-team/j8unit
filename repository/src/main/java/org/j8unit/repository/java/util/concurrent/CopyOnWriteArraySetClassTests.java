 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CopyOnWriteArraySet
 * public class java.util.concurrent.CopyOnWriteArraySet<E>}.
 *
...
public abstract interface CopyOnWriteArraySetClassTests<SUT extends CopyOnWriteArraySet>
extends SerializableClassTests<SUT>, AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CopyOnWriteArraySet.class!",
                   CopyOnWriteArraySet.class.isAssignableFrom(sut));
    }

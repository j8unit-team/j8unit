 ...
 * java.util.concurrent.CopyOnWriteArraySet}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CopyOnWriteArraySetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CopyOnWriteArraySetTests}.
 * </p>
 *
 * @see java.util.concurrent.CopyOnWriteArraySet class java.util.concurrent.CopyOnWriteArraySet (the hereby targeted
 *      class-under-test class)
 * @see CopyOnWriteArraySetTests CopyOnWriteArraySetTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CopyOnWriteArraySet.class!",
                   java.util.concurrent.CopyOnWriteArraySet.class.isAssignableFrom(sut));
    }

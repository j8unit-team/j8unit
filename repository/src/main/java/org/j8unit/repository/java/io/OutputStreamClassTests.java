...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.OutputStream class java.io.OutputStream}, containing all type
...
public abstract interface OutputStreamClassTests<SUT extends java.io.OutputStream>
extends CloseableClassTests<SUT>, FlushableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.OutputStream.class!",
                   java.io.OutputStream.class.isAssignableFrom(sut));
    }

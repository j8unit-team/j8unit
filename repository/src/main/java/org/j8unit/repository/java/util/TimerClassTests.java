...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Timer class java.util.Timer}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimerTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.Timer class java.util.Timer (the hereby targeted class-under-test class)
 * @see TimerTests TimerTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface TimerClassTests<SUT extends java.util.Timer>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Timer.class!",
                   java.util.Timer.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.event.ComponentListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentListenerTests}.
 * </p>
 *
 * @see java.awt.event.ComponentListener interface java.awt.event.ComponentListener (the hereby targeted
 *      class-under-test class)
 * @see ComponentListenerTests ComponentListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ComponentListenerClassTests<SUT extends java.awt.event.ComponentListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ComponentListener.class!",
                   java.awt.event.ComponentListener.class.isAssignableFrom(sut));
    }

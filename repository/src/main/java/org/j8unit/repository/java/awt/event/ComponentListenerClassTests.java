 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComponentListener
...
public abstract interface ComponentListenerClassTests<SUT extends ComponentListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentListener.class!",
                   ComponentListener.class.isAssignableFrom(sut));
    }

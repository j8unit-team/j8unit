 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChronoLocalDateTime
 * public abstract interface java.time.chrono.ChronoLocalDateTime<D>}.
 *
...
public abstract interface ChronoLocalDateTimeClassTests<SUT extends ChronoLocalDateTime>
extends TemporalClassTests<SUT>, TemporalAdjusterClassTests<SUT>, ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChronoLocalDateTime.class!",
                   ChronoLocalDateTime.class.isAssignableFrom(sut));
    }

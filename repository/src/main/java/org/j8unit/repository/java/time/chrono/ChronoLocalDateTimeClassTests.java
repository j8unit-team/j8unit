 ...
 * java.time.chrono.ChronoLocalDateTime}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChronoLocalDateTimeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChronoLocalDateTimeTests}.
 * </p>
 *
 * @see java.time.chrono.ChronoLocalDateTime interface java.time.chrono.ChronoLocalDateTime (the hereby targeted
 *      class-under-test class)
 * @see ChronoLocalDateTimeTests ChronoLocalDateTimeTests (The complementary j8unit test interface containing the
...
org.j8unit.repository.java.lang.ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.ChronoLocalDateTime.class!",
                   java.time.chrono.ChronoLocalDateTime.class.isAssignableFrom(sut));
    }

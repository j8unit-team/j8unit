...
public abstract interface AnnotatedParameterizedTypeClassTests<SUT extends AnnotatedParameterizedType>
extends AnnotatedTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotatedParameterizedType.class!",
                   AnnotatedParameterizedType.class.isAssignableFrom(sut));
    }

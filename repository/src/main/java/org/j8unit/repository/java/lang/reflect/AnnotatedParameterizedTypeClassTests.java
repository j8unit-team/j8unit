 ...
 * java.lang.reflect.AnnotatedParameterizedType}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AnnotatedParameterizedTypeTests}).
 * </p>
 *
 * <p>
 ...
 * @see AnnotatedParameterizedTypeTests AnnotatedParameterizedTypeTests (The complementary j8unit test interface
...
public abstract interface AnnotatedParameterizedTypeClassTests<SUT extends java.lang.reflect.AnnotatedParameterizedType>
extends AnnotatedTypeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.AnnotatedParameterizedType.class!",
                   java.lang.reflect.AnnotatedParameterizedType.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DirectoryStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DirectoryStreamTests}.
 * </p>
 *
 * @see java.nio.file.DirectoryStream interface java.nio.file.DirectoryStream (the hereby targeted class-under-test
 *      class)
 * @see DirectoryStreamTests DirectoryStreamTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.IterableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.DirectoryStream.class!",
                   java.nio.file.DirectoryStream.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.nio.file.DirectoryStream.Filter interface
     * java.nio.file.DirectoryStream$Filter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link DirectoryStreamTests.FilterTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see DirectoryStreamTests.FilterTests DirectoryStreamTests.FilterTests (The complementary j8unit test interface
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.DirectoryStream.Filter.class!",
                       java.nio.file.DirectoryStream.Filter.class.isAssignableFrom(sut));
        }

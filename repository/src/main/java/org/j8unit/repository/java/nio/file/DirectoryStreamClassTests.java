 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DirectoryStream
...
public abstract interface DirectoryStreamClassTests<SUT extends DirectoryStream>
extends CloseableClassTests<SUT>, IterableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirectoryStream.class!",
     ...
     * {@link Filter public abstract static interface java.nio.file.DirectoryStream$Filter<T>}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

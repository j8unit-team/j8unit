 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InterruptedIOExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InterruptedIOExceptionTests}.
 * </p>
 *
 * @see java.io.InterruptedIOException class java.io.InterruptedIOException (the hereby targeted class-under-test class)
 * @see InterruptedIOExceptionTests InterruptedIOExceptionTests (The complementary j8unit test interface containing the
...
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.InterruptedIOException.class!",
                   java.io.InterruptedIOException.class.isAssignableFrom(sut));
    }

...
public abstract interface InterruptedIOExceptionClassTests<SUT extends InterruptedIOException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InterruptedIOException.class!",
                   InterruptedIOException.class.isAssignableFrom(sut));
    }

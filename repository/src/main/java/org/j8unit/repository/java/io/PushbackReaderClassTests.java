 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PushbackReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PushbackReaderTests}.
 * </p>
 *
 * @see java.io.PushbackReader class java.io.PushbackReader (the hereby targeted class-under-test class)
 * @see PushbackReaderTests PushbackReaderTests (The complementary j8unit test interface containing the instance
...
public abstract interface PushbackReaderClassTests<SUT extends java.io.PushbackReader>
extends FilterReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PushbackReader.class!",
                   java.io.PushbackReader.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PushbackReader
...
public abstract interface PushbackReaderClassTests<SUT extends PushbackReader>
extends FilterReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PushbackReader.class!",
                   PushbackReader.class.isAssignableFrom(sut));
    }

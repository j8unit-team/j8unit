 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServerExceptionTests}.
 * </p>
 *
 * @see java.rmi.ServerException class java.rmi.ServerException (the hereby targeted class-under-test class)
 * @see ServerExceptionTests ServerExceptionTests (The complementary j8unit test interface containing the instance
...
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.ServerException.class!",
                   java.rmi.ServerException.class.isAssignableFrom(sut));
    }

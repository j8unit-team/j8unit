...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.NClob interface java.sql.NClob}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NClobTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.sql.NClob interface java.sql.NClob (the hereby targeted class-under-test class)
 * @see NClobTests NClobTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface NClobClassTests<SUT extends java.sql.NClob>
extends ClobClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.NClob.class!",
                   java.sql.NClob.class.isAssignableFrom(sut));
    }

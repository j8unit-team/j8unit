 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NavigableSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NavigableSetTests}.
 * </p>
 *
 * @see java.util.NavigableSet interface java.util.NavigableSet (the hereby targeted class-under-test class)
 * @see NavigableSetTests NavigableSetTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SortedSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.NavigableSet.class!",
                   java.util.NavigableSet.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NavigableSet public
 * abstract interface java.util.NavigableSet<E>}.
 *
...
public abstract interface NavigableSetClassTests<SUT extends NavigableSet>
extends SortedSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NavigableSet.class!",
                   NavigableSet.class.isAssignableFrom(sut));
    }

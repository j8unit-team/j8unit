 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JapaneseEra public
 * final class java.time.chrono.JapaneseEra}.
 *
 ...
 * {@link org.j8unit.repository.java.time.chrono.JapaneseEraTests}.
 * </p>
 *
 * <p>
...
public abstract interface JapaneseEraClassTests<SUT extends JapaneseEra>
extends EraClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.JapaneseEra]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JapaneseEra.class!",
                   JapaneseEra.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.time.chrono.JapaneseEra]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ClassFormatError class java.lang.ClassFormatError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassFormatErrorTests}).
 * </p>
 *
 * <p>
 ...
 * @see ClassFormatErrorTests ClassFormatErrorTests (The complementary j8unit test interface containing the instance
...
extends LinkageErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassFormatError.class!",
                   ClassFormatError.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.ObjIntConsumer interface
 * java.util.function.ObjIntConsumer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjIntConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjIntConsumerTests}.
 * </p>
 *
 * @see java.util.function.ObjIntConsumer interface java.util.function.ObjIntConsumer (the hereby targeted
 *      class-under-test class)
 * @see ObjIntConsumerTests ObjIntConsumerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ObjIntConsumerClassTests<SUT extends java.util.function.ObjIntConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ObjIntConsumer.class!",
                   java.util.function.ObjIntConsumer.class.isAssignableFrom(sut));
    }

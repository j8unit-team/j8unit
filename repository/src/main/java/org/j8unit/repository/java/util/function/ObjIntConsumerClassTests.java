 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjIntConsumer
 * public abstract interface java.util.function.ObjIntConsumer<T>}.
 *
...
public abstract interface ObjIntConsumerClassTests<SUT extends ObjIntConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjIntConsumer.class!",
                   ObjIntConsumer.class.isAssignableFrom(sut));
    }

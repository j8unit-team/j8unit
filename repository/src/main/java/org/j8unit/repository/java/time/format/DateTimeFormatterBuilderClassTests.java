 ...
 * java.time.format.DateTimeFormatterBuilder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTimeFormatterBuilderTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link DateTimeFormatterBuilderTests}.
 * </p>
 *
 * @see java.time.format.DateTimeFormatterBuilder class java.time.format.DateTimeFormatterBuilder (the hereby targeted
 *      class-under-test class)
 * @see DateTimeFormatterBuilderTests DateTimeFormatterBuilderTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.DateTimeFormatterBuilder.class!",
                   java.time.format.DateTimeFormatterBuilder.class.isAssignableFrom(sut));
    }

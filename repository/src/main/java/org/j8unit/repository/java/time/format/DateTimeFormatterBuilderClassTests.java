...
public abstract interface DateTimeFormatterBuilderClassTests<SUT extends DateTimeFormatterBuilder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateTimeFormatterBuilder.class!",
                   DateTimeFormatterBuilder.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.time.format.DateTimeFormatterBuilder]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextComponent
...
public abstract interface TextComponentClassTests<SUT extends TextComponent>
extends AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextComponent.class!",
                   TextComponent.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextComponentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextComponentTests}.
 * </p>
 *
 * @see java.awt.TextComponent class java.awt.TextComponent (the hereby targeted class-under-test class)
 * @see TextComponentTests TextComponentTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TextComponentClassTests<SUT extends java.awt.TextComponent>
extends org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.TextComponent.class!",
                   java.awt.TextComponent.class.isAssignableFrom(sut));
    }

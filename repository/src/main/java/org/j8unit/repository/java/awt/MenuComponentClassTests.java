 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuComponent
...
public abstract interface MenuComponentClassTests<SUT extends MenuComponent>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuComponent.class!",
                   MenuComponent.class.isAssignableFrom(sut));
    }

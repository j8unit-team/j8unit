 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MalformedURLExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link MalformedURLExceptionTests}.
 * </p>
 *
 * @see java.net.MalformedURLException class java.net.MalformedURLException (the hereby targeted class-under-test class)
 * @see MalformedURLExceptionTests MalformedURLExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface MalformedURLExceptionClassTests<SUT extends java.net.MalformedURLException>
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.MalformedURLException.class!",
                   java.net.MalformedURLException.class.isAssignableFrom(sut));
    }

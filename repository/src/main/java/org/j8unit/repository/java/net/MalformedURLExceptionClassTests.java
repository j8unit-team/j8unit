 ...
 * {@link MalformedURLException public class java.net.MalformedURLException}.
 *
...
public abstract interface MalformedURLExceptionClassTests<SUT extends MalformedURLException>
extends IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MalformedURLException.class!",
                   MalformedURLException.class.isAssignableFrom(sut));
    }

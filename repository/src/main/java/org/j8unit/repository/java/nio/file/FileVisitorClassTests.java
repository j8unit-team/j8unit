 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileVisitor public
 * abstract interface java.nio.file.FileVisitor<T>}.
 *
...
public abstract interface FileVisitorClassTests<SUT extends FileVisitor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileVisitor.class!",
                   FileVisitor.class.isAssignableFrom(sut));
    }

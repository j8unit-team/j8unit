 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileVisitorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileVisitorTests}.
 * </p>
 *
 * @see java.nio.file.FileVisitor interface java.nio.file.FileVisitor (the hereby targeted class-under-test class)
 * @see FileVisitorTests FileVisitorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileVisitorClassTests<SUT extends java.nio.file.FileVisitor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.FileVisitor.class!",
                   java.nio.file.FileVisitor.class.isAssignableFrom(sut));
    }

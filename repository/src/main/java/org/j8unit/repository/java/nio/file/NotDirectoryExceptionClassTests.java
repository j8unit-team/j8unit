 ...
 * java.nio.file.NotDirectoryException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotDirectoryExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link NotDirectoryExceptionTests}.
 * </p>
 *
 * @see java.nio.file.NotDirectoryException class java.nio.file.NotDirectoryException (the hereby targeted
 *      class-under-test class)
 * @see NotDirectoryExceptionTests NotDirectoryExceptionTests (The complementary j8unit test interface containing the
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.NotDirectoryException.class!",
                   java.nio.file.NotDirectoryException.class.isAssignableFrom(sut));
    }

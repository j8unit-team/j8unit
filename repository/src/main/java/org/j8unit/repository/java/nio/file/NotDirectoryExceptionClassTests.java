 ...
 * {@link NotDirectoryException public class java.nio.file.NotDirectoryException}.
 *
...
public abstract interface NotDirectoryExceptionClassTests<SUT extends NotDirectoryException>
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotDirectoryException.class!",
                   NotDirectoryException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongStream public
 * abstract interface java.util.stream.LongStream}.
 *
...
extends BaseStreamClassTests<SUT> {
     ...
     * {@link Builder public abstract static interface java.util.stream.LongStream$Builder}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

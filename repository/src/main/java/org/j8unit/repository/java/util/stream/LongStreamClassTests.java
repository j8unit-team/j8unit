...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.stream.LongStream interface java.util.stream.LongStream},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see LongStreamTests LongStreamTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends BaseStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.LongStream.class!",
                   java.util.stream.LongStream.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.stream.LongStream.Builder interface
     * java.util.stream.LongStream$Builder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link LongStreamTests.BuilderTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see LongStreamTests.BuilderTests LongStreamTests.BuilderTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.util.function.LongConsumerClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.LongStream.Builder.class!",
                       java.util.stream.LongStream.Builder.class.isAssignableFrom(sut));
        }

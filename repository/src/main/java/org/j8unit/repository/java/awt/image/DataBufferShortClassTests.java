 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataBufferShort
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataBufferShortTests}.
 * </p>
 *
 * <p>
...
public abstract interface DataBufferShortClassTests<SUT extends DataBufferShort>
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBufferShort.class!",
                   DataBufferShort.class.isAssignableFrom(sut));
    }

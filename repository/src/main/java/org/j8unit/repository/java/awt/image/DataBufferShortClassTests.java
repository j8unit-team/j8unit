...
/**
 * <p>
 * Test class for {@link java.awt.image.DataBufferShort class java.awt.image.DataBufferShort}, containing all class
...
extends org.j8unit.repository.java.awt.image.DataBufferClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_DataBufferShort_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.DataBufferShort sut = null; // = new DataBufferShort(int);
    }

    /**
     * Test method for {@link java.awt.image.DataBufferShort#DataBufferShort(int,int) public
     * java.awt.image.DataBufferShort(int,int)}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_DataBufferShort_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.DataBufferShort sut = null; // = new DataBufferShort(int,int);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_DataBufferShort_shortArray_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.DataBufferShort sut = null; // = new DataBufferShort(short[],int);
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.awt.image.DataBufferShort> sut = createNewSUT();

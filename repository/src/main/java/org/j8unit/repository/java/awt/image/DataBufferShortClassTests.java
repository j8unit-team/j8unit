 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBufferShortTests}).
 * </p>
 *
 * <p>
 ...
 * @see DataBufferShortTests DataBufferShortTests (The complementary j8unit test interface containing the instance
...
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DataBufferShort.class!",
                   java.awt.image.DataBufferShort.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Driver public
 * abstract interface java.sql.Driver}.
 *
...
public abstract interface DriverClassTests<SUT extends Driver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Driver.class!",
                   Driver.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Driver interface java.sql.Driver}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DriverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DriverTests}.
 * </p>
 *
 * @see java.sql.Driver interface java.sql.Driver (the hereby targeted class-under-test class)
 * @see DriverTests DriverTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DriverClassTests<SUT extends java.sql.Driver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Driver.class!",
                   java.sql.Driver.class.isAssignableFrom(sut));
    }

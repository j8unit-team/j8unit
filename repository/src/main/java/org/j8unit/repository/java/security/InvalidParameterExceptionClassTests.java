 ...
 * java.security.InvalidParameterException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * @see InvalidParameterExceptionTests InvalidParameterExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.InvalidParameterException.class!",
                   java.security.InvalidParameterException.class.isAssignableFrom(sut));
    }

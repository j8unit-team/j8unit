...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.chrono.Era interface java.time.chrono.Era}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EraTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EraTests}.
 * </p>
 *
 * @see java.time.chrono.Era interface java.time.chrono.Era (the hereby targeted class-under-test class)
 * @see EraTests EraTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface EraClassTests<SUT extends java.time.chrono.Era>
extends org.j8unit.repository.java.time.temporal.TemporalAccessorClassTests<SUT>, org.j8unit.repository.java.time.temporal.TemporalAdjusterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.Era.class!",
                   java.time.chrono.Era.class.isAssignableFrom(sut));
    }

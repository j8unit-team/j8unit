...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.BiPredicate interface
 * java.util.function.BiPredicate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BiPredicateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BiPredicateTests}.
 * </p>
 *
 * @see java.util.function.BiPredicate interface java.util.function.BiPredicate (the hereby targeted class-under-test
 *      class)
 * @see BiPredicateTests BiPredicateTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BiPredicateClassTests<SUT extends java.util.function.BiPredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.BiPredicate.class!",
                   java.util.function.BiPredicate.class.isAssignableFrom(sut));
    }

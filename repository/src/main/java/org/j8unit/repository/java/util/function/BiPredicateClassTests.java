 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BiPredicate public
 * abstract interface java.util.function.BiPredicate<T,U>}.
 *
...
public abstract interface BiPredicateClassTests<SUT extends BiPredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BiPredicate.class!",
                   BiPredicate.class.isAssignableFrom(sut));
    }

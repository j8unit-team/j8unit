...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.Format class java.text.Format}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormatTests}).
 * </p>
 *
 * <p>
 ...
 * @see FormatTests FormatTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.Format.class!",
                   java.text.Format.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link FormatTests.FieldTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * {@link FormatTests.FieldTests}.
     * </p>
     *
     * @see java.text.Format.Field class java.text.Format$Field (the hereby targeted class-under-test class)
     * @see FormatTests.FieldTests FormatTests.FieldTests (The complementary j8unit test interface containing the
    ...
    extends AttributedCharacterIteratorClassTests.AttributeClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.Format.Field.class!",
                       java.text.Format.Field.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Format public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FormatTests}.
 * </p>
 *
 * <p>
...
public abstract interface FormatClassTests<SUT extends Format>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Format.class!",
                   Format.class.isAssignableFrom(sut));
    }
     ...
     * {@link Field public static class java.text.Format$Field}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

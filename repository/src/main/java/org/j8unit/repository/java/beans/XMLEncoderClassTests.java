 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLEncoderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link XMLEncoderTests}.
 * </p>
 *
 * @see java.beans.XMLEncoder class java.beans.XMLEncoder (the hereby targeted class-under-test class)
 * @see XMLEncoderTests XMLEncoderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT>, EncoderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.XMLEncoder.class!",
                   java.beans.XMLEncoder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLEncoder public
...
public abstract interface XMLEncoderClassTests<SUT extends XMLEncoder>
extends AutoCloseableClassTests<SUT>, EncoderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLEncoder.class!",
                   XMLEncoder.class.isAssignableFrom(sut));
    }

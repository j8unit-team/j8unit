 ...
 * java.security.spec.DSAPublicKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAPublicKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAPublicKeySpecTests}.
 * </p>
 *
 * @see java.security.spec.DSAPublicKeySpec class java.security.spec.DSAPublicKeySpec (the hereby targeted
 *      class-under-test class)
 * @see DSAPublicKeySpecTests DSAPublicKeySpecTests (The complementary j8unit test interface containing the instance
...
extends KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.DSAPublicKeySpec.class!",
                   java.security.spec.DSAPublicKeySpec.class.isAssignableFrom(sut));
    }

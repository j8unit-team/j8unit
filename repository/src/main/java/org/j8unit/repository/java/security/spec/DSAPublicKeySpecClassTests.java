 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAPublicKeySpec
...
public abstract interface DSAPublicKeySpecClassTests<SUT extends DSAPublicKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAPublicKeySpec.class!",
                   DSAPublicKeySpec.class.isAssignableFrom(sut));
    }

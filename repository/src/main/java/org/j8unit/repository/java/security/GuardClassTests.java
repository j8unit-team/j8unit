 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GuardTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GuardTests}.
 * </p>
 *
 * @see java.security.Guard interface java.security.Guard (the hereby targeted class-under-test class)
 * @see GuardTests GuardTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface GuardClassTests<SUT extends java.security.Guard>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Guard.class!",
                   java.security.Guard.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StubNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link StubNotFoundExceptionTests}.
 * </p>
 *
 * @see java.rmi.StubNotFoundException class java.rmi.StubNotFoundException (the hereby targeted class-under-test class)
 * @see StubNotFoundExceptionTests StubNotFoundExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface StubNotFoundExceptionClassTests<SUT extends java.rmi.StubNotFoundException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.StubNotFoundException.class!",
                   java.rmi.StubNotFoundException.class.isAssignableFrom(sut));
    }

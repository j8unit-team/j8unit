...
public abstract interface StubNotFoundExceptionClassTests<SUT extends StubNotFoundException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StubNotFoundException.class!",
                   StubNotFoundException.class.isAssignableFrom(sut));
    }

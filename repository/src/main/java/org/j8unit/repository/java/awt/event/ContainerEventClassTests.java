 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContainerEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ContainerEventTests}.
 * </p>
 *
 * @see java.awt.event.ContainerEvent class java.awt.event.ContainerEvent (the hereby targeted class-under-test class)
 * @see ContainerEventTests ContainerEventTests (The complementary j8unit test interface containing the instance
...
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.ContainerEvent.class!",
                   java.awt.event.ContainerEvent.class.isAssignableFrom(sut));
    }

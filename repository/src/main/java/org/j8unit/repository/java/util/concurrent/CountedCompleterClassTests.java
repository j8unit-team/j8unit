 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CountedCompleter
 * public abstract class java.util.concurrent.CountedCompleter<T>}.
 *
...
public abstract interface CountedCompleterClassTests<SUT extends CountedCompleter>
extends ForkJoinTaskClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CountedCompleter.class!",
                   CountedCompleter.class.isAssignableFrom(sut));
    }

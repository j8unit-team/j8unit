 ...
 * java.util.concurrent.CountedCompleter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CountedCompleterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CountedCompleterTests}.
 * </p>
 *
 * @see java.util.concurrent.CountedCompleter class java.util.concurrent.CountedCompleter (the hereby targeted
 *      class-under-test class)
 * @see CountedCompleterTests CountedCompleterTests (The complementary j8unit test interface containing the instance
...
public abstract interface CountedCompleterClassTests<SUT extends java.util.concurrent.CountedCompleter>
extends ForkJoinTaskClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CountedCompleter.class!",
                   java.util.concurrent.CountedCompleter.class.isAssignableFrom(sut));
    }

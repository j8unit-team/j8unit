 ...
 * java.beans.PropertyChangeSupport}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyChangeSupportTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PropertyChangeSupportTests}.
 * </p>
 *
 * @see java.beans.PropertyChangeSupport class java.beans.PropertyChangeSupport (the hereby targeted class-under-test
 *      class)
 * @see PropertyChangeSupportTests PropertyChangeSupportTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyChangeSupport.class!",
                   java.beans.PropertyChangeSupport.class.isAssignableFrom(sut));
    }

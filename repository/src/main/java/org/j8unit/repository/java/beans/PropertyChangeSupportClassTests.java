...
public abstract interface PropertyChangeSupportClassTests<SUT extends PropertyChangeSupport>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyChangeSupport.class!",
                   PropertyChangeSupport.class.isAssignableFrom(sut));
    }

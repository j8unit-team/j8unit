 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECPrivateKey public
 * abstract interface java.security.interfaces.ECPrivateKey}.
 *
...
public abstract interface ECPrivateKeyClassTests<SUT extends ECPrivateKey>
extends PrivateKeyClassTests<SUT>, ECKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECPrivateKey.class!",
                   ECPrivateKey.class.isAssignableFrom(sut));
    }

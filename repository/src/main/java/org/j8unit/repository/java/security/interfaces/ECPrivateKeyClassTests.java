 ...
 * java.security.interfaces.ECPrivateKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECPrivateKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECPrivateKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.ECPrivateKey interface java.security.interfaces.ECPrivateKey (the hereby targeted
 *      class-under-test class)
 * @see ECPrivateKeyTests ECPrivateKeyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.security.PrivateKeyClassTests<SUT>, ECKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.ECPrivateKey.class!",
                   java.security.interfaces.ECPrivateKey.class.isAssignableFrom(sut));
    }

 ...
 * {@link StringCharacterIterator public final class java.text.StringCharacterIterator}.
 *
...
public abstract interface StringCharacterIteratorClassTests<SUT extends StringCharacterIterator>
extends CharacterIteratorClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.text.StringCharacterIterator]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringCharacterIterator.class!",
                   StringCharacterIterator.class.isAssignableFrom(sut));
    }

 ...
 * java.text.StringCharacterIterator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringCharacterIteratorTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link StringCharacterIteratorTests}.
 * </p>
 *
 * @see java.text.StringCharacterIterator class java.text.StringCharacterIterator (the hereby targeted class-under-test
 *      class)
 * @see StringCharacterIteratorTests StringCharacterIteratorTests (The complementary j8unit test interface containing
...
extends CharacterIteratorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.StringCharacterIterator.class!",
                   java.text.StringCharacterIterator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LookupTable public
 * abstract class java.awt.image.LookupTable}.
 *
...
public abstract interface LookupTableClassTests<SUT extends LookupTable>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LookupTable.class!",
                   LookupTable.class.isAssignableFrom(sut));
    }

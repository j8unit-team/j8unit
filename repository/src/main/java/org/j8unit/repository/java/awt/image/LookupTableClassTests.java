...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.LookupTable class java.awt.image.LookupTable},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LookupTableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LookupTableTests}.
 * </p>
 *
 * @see java.awt.image.LookupTable class java.awt.image.LookupTable (the hereby targeted class-under-test class)
 * @see LookupTableTests LookupTableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LookupTableClassTests<SUT extends java.awt.image.LookupTable>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.LookupTable.class!",
                   java.awt.image.LookupTable.class.isAssignableFrom(sut));
    }

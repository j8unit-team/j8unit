 ...
 * java.lang.management.MonitorInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MonitorInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MonitorInfoTests}.
 * </p>
 *
 * @see java.lang.management.MonitorInfo class java.lang.management.MonitorInfo (the hereby targeted class-under-test
 *      class)
 * @see MonitorInfoTests MonitorInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends LockInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.MonitorInfo.class!",
                   java.lang.management.MonitorInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MonitorInfo public
...
public abstract interface MonitorInfoClassTests<SUT extends MonitorInfo>
extends LockInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MonitorInfo.class!",
                   MonitorInfo.class.isAssignableFrom(sut));
    }

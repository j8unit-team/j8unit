...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.VetoableChangeListener interface
 * java.beans.VetoableChangeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VetoableChangeListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link VetoableChangeListenerTests}.
 * </p>
 *
 * @see java.beans.VetoableChangeListener interface java.beans.VetoableChangeListener (the hereby targeted
 *      class-under-test class)
 * @see VetoableChangeListenerTests VetoableChangeListenerTests (The complementary j8unit test interface containing the
...
public abstract interface VetoableChangeListenerClassTests<SUT extends java.beans.VetoableChangeListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.VetoableChangeListener.class!",
                   java.beans.VetoableChangeListener.class.isAssignableFrom(sut));
    }

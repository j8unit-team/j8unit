 ...
 * {@link VetoableChangeListener public abstract interface java.beans.VetoableChangeListener}.
 *
 ...
 * {@link org.j8unit.repository.java.beans.VetoableChangeListenerTests}.
 * </p>
 *
 * <p>
...
public abstract interface VetoableChangeListenerClassTests<SUT extends VetoableChangeListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VetoableChangeListener.class!",
                   VetoableChangeListener.class.isAssignableFrom(sut));
    }

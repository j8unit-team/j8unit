 ...
 * java.awt.image.AreaAveragingScaleFilter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AreaAveragingScaleFilterTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AreaAveragingScaleFilterTests}.
 * </p>
 *
 * @see java.awt.image.AreaAveragingScaleFilter class java.awt.image.AreaAveragingScaleFilter (the hereby targeted
 *      class-under-test class)
 * @see AreaAveragingScaleFilterTests AreaAveragingScaleFilterTests (The complementary j8unit test interface containing
...
public abstract interface AreaAveragingScaleFilterClassTests<SUT extends java.awt.image.AreaAveragingScaleFilter>
extends ReplicateScaleFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.AreaAveragingScaleFilter.class!",
                   java.awt.image.AreaAveragingScaleFilter.class.isAssignableFrom(sut));
    }

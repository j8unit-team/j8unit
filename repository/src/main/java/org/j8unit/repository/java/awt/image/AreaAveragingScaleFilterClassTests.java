...
public abstract interface AreaAveragingScaleFilterClassTests<SUT extends AreaAveragingScaleFilter>
extends ReplicateScaleFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AreaAveragingScaleFilter.class!",
                   AreaAveragingScaleFilter.class.isAssignableFrom(sut));
    }

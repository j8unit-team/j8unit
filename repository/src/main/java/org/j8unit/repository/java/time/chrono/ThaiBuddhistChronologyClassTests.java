 ...
 * java.time.chrono.ThaiBuddhistChronology}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThaiBuddhistChronologyTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ThaiBuddhistChronologyTests}.
 * </p>
 *
 * @see java.time.chrono.ThaiBuddhistChronology class java.time.chrono.ThaiBuddhistChronology (the hereby targeted
 *      class-under-test class)
 * @see ThaiBuddhistChronologyTests ThaiBuddhistChronologyTests (The complementary j8unit test interface containing the
...
public abstract interface ThaiBuddhistChronologyClassTests<SUT extends java.time.chrono.ThaiBuddhistChronology>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractChronologyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.ThaiBuddhistChronology.class!",
                   java.time.chrono.ThaiBuddhistChronology.class.isAssignableFrom(sut));
    }

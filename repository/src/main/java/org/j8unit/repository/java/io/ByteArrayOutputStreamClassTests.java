...
public abstract interface ByteArrayOutputStreamClassTests<SUT extends ByteArrayOutputStream>
extends OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ByteArrayOutputStream.class!",
                   ByteArrayOutputStream.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.ByteArrayOutputStream class java.io.ByteArrayOutputStream},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ByteArrayOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ByteArrayOutputStreamTests}.
 * </p>
 *
 * @see java.io.ByteArrayOutputStream class java.io.ByteArrayOutputStream (the hereby targeted class-under-test class)
 * @see ByteArrayOutputStreamTests ByteArrayOutputStreamTests (The complementary j8unit test interface containing the
...
public abstract interface ByteArrayOutputStreamClassTests<SUT extends java.io.ByteArrayOutputStream>
extends OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ByteArrayOutputStream.class!",
                   java.io.ByteArrayOutputStream.class.isAssignableFrom(sut));
    }

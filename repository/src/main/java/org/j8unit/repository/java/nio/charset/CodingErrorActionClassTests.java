 ...
 * java.nio.charset.CodingErrorAction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CodingErrorActionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CodingErrorActionTests}.
 * </p>
 *
 * @see java.nio.charset.CodingErrorAction class java.nio.charset.CodingErrorAction (the hereby targeted
 *      class-under-test class)
 * @see CodingErrorActionTests CodingErrorActionTests (The complementary j8unit test interface containing the instance
...
public abstract interface CodingErrorActionClassTests<SUT extends java.nio.charset.CodingErrorAction>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.CodingErrorAction.class!",
                   java.nio.charset.CodingErrorAction.class.isAssignableFrom(sut));
    }

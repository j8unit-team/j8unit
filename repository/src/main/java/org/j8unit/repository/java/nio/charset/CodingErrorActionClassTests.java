 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CodingErrorAction
...
public abstract interface CodingErrorActionClassTests<SUT extends CodingErrorAction>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CodingErrorAction.class!",
                   CodingErrorAction.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotActiveException
...
public abstract interface NotActiveExceptionClassTests<SUT extends NotActiveException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotActiveException.class!",
                   NotActiveException.class.isAssignableFrom(sut));
    }

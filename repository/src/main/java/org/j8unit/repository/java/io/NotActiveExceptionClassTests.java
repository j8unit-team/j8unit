...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.NotActiveException class java.io.NotActiveException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotActiveExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotActiveExceptionTests}.
 * </p>
 *
 * @see java.io.NotActiveException class java.io.NotActiveException (the hereby targeted class-under-test class)
 * @see NotActiveExceptionTests NotActiveExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface NotActiveExceptionClassTests<SUT extends java.io.NotActiveException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.NotActiveException.class!",
                   java.io.NotActiveException.class.isAssignableFrom(sut));
    }

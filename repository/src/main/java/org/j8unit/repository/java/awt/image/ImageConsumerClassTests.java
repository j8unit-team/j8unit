 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImageConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ImageConsumerTests}.
 * </p>
 *
 * @see java.awt.image.ImageConsumer interface java.awt.image.ImageConsumer (the hereby targeted class-under-test class)
 * @see ImageConsumerTests ImageConsumerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ImageConsumerClassTests<SUT extends java.awt.image.ImageConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ImageConsumer.class!",
                   java.awt.image.ImageConsumer.class.isAssignableFrom(sut));
    }

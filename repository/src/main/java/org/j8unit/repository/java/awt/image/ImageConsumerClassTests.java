 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ImageConsumer
...
public abstract interface ImageConsumerClassTests<SUT extends ImageConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImageConsumer.class!",
                   ImageConsumer.class.isAssignableFrom(sut));
    }

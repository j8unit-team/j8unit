 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataBufferUShort
 * public final class java.awt.image.DataBufferUShort}.
 *
...
public abstract interface DataBufferUShortClassTests<SUT extends DataBufferUShort>
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBufferUShort.class!",
                   DataBufferUShort.class.isAssignableFrom(sut));
    }

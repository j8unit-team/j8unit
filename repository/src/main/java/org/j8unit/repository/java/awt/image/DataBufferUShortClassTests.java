 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBufferUShortTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataBufferUShortTests}.
 * </p>
 *
 * @see java.awt.image.DataBufferUShort class java.awt.image.DataBufferUShort (the hereby targeted class-under-test
 *      class)
 * @see DataBufferUShortTests DataBufferUShortTests (The complementary j8unit test interface containing the instance
...
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DataBufferUShort.class!",
                   java.awt.image.DataBufferUShort.class.isAssignableFrom(sut));
    }

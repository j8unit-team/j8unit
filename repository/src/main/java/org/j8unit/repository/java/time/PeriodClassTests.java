...
import org.j8unit.repository.java.time.chrono.ChronoPeriodClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Period public final
...
public abstract interface PeriodClassTests<SUT extends Period>
extends ChronoPeriodClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Period.class!",
                   Period.class.isAssignableFrom(sut));
    }

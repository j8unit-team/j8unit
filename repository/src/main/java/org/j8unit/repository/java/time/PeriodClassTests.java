...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.Period class java.time.Period}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PeriodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PeriodTests}.
 * </p>
 *
 * @see java.time.Period class java.time.Period (the hereby targeted class-under-test class)
 * @see PeriodTests PeriodTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.Period.class!",
                   java.time.Period.class.isAssignableFrom(sut));
    }

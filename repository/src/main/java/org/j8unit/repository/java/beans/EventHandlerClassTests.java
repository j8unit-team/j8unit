 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventHandler public
...
public abstract interface EventHandlerClassTests<SUT extends EventHandler>
extends InvocationHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventHandler.class!",
                   EventHandler.class.isAssignableFrom(sut));
    }

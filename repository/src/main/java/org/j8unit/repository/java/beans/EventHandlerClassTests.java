 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventHandlerTests}.
 * </p>
 *
 * @see java.beans.EventHandler class java.beans.EventHandler (the hereby targeted class-under-test class)
 * @see EventHandlerTests EventHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.reflect.InvocationHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.EventHandler.class!",
                   java.beans.EventHandler.class.isAssignableFrom(sut));
    }

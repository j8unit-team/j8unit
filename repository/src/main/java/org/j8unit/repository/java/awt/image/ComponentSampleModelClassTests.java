 ...
 * java.awt.image.ComponentSampleModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ComponentSampleModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ComponentSampleModelTests}
 * .
 * </p>
 *
 * @see java.awt.image.ComponentSampleModel class java.awt.image.ComponentSampleModel (the hereby targeted
 *      class-under-test class)
 * @see ComponentSampleModelTests ComponentSampleModelTests (The complementary j8unit test interface containing the
...
extends SampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ComponentSampleModel.class!",
                   java.awt.image.ComponentSampleModel.class.isAssignableFrom(sut));
    }

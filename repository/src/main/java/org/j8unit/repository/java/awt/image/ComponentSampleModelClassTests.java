...
public abstract interface ComponentSampleModelClassTests<SUT extends ComponentSampleModel>
extends org.j8unit.repository.java.awt.image.SampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentSampleModel.class!",
                   ComponentSampleModel.class.isAssignableFrom(sut));
    }

 ...
 * java.security.spec.RSAKeyGenParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAKeyGenParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 * {@link RSAKeyGenParameterSpecTests}.
 * </p>
 *
 * @see java.security.spec.RSAKeyGenParameterSpec class java.security.spec.RSAKeyGenParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see RSAKeyGenParameterSpecTests RSAKeyGenParameterSpecTests (The complementary j8unit test interface containing the
...
extends AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.RSAKeyGenParameterSpec.class!",
                   java.security.spec.RSAKeyGenParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * {@link RSAKeyGenParameterSpec public class java.security.spec.RSAKeyGenParameterSpec}.
 *
...
public abstract interface RSAKeyGenParameterSpecClassTests<SUT extends RSAKeyGenParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAKeyGenParameterSpec.class!",
                   RSAKeyGenParameterSpec.class.isAssignableFrom(sut));
    }

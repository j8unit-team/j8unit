 ...
 * java.util.concurrent.TimeoutException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimeoutExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TimeoutExceptionTests}.
 * </p>
 *
 * @see java.util.concurrent.TimeoutException class java.util.concurrent.TimeoutException (the hereby targeted
 *      class-under-test class)
 * @see TimeoutExceptionTests TimeoutExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface TimeoutExceptionClassTests<SUT extends java.util.concurrent.TimeoutException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.TimeoutException.class!",
                   java.util.concurrent.TimeoutException.class.isAssignableFrom(sut));
    }

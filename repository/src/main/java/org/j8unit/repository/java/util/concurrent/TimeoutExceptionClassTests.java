 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TimeoutException
...
public abstract interface TimeoutExceptionClassTests<SUT extends TimeoutException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimeoutException.class!",
                   TimeoutException.class.isAssignableFrom(sut));
    }

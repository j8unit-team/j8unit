...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ClassLoader class java.lang.ClassLoader}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassLoaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClassLoaderTests}.
 * </p>
 *
 * @see ClassLoader class java.lang.ClassLoader (the hereby targeted class-under-test class)
 * @see ClassLoaderTests ClassLoaderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ClassLoaderClassTests<SUT extends ClassLoader>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassLoader.class!",
                   ClassLoader.class.isAssignableFrom(sut));
    }

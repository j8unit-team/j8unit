 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ActivationException
 * public class java.rmi.activation.ActivationException}.
 *
...
public abstract interface ActivationExceptionClassTests<SUT extends ActivationException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivationException.class!",
                   ActivationException.class.isAssignableFrom(sut));
    }

 ...
 * java.rmi.activation.ActivationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActivationExceptionTests}.
 * </p>
 *
 * @see java.rmi.activation.ActivationException class java.rmi.activation.ActivationException (the hereby targeted
 *      class-under-test class)
 * @see ActivationExceptionTests ActivationExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ActivationExceptionClassTests<SUT extends java.rmi.activation.ActivationException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivationException.class!",
                   java.rmi.activation.ActivationException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AccessController
...
public abstract interface AccessControllerClassTests<SUT extends AccessController>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessController.class!",
                   AccessController.class.isAssignableFrom(sut));
    }

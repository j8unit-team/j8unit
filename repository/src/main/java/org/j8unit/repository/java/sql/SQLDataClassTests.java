 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLData public
 * abstract interface java.sql.SQLData}.
 *
...
public abstract interface SQLDataClassTests<SUT extends SQLData>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLData.class!",
                   SQLData.class.isAssignableFrom(sut));
    }

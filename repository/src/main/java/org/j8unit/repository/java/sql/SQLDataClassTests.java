...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.SQLData interface java.sql.SQLData}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLDataTests}.
 * </p>
 *
 * @see java.sql.SQLData interface java.sql.SQLData (the hereby targeted class-under-test class)
 * @see SQLDataTests SQLDataTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SQLDataClassTests<SUT extends java.sql.SQLData>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLData.class!",
                   java.sql.SQLData.class.isAssignableFrom(sut));
    }

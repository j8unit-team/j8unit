 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragSource public
...
public abstract interface DragSourceClassTests<SUT extends DragSource>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSource.class!",
                   DragSource.class.isAssignableFrom(sut));
    }

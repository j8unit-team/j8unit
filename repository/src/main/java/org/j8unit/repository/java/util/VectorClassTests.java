...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Vector class java.util.Vector}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link VectorTests}.
 * </p>
 *
 * @see java.util.Vector class java.util.Vector (the hereby targeted class-under-test class)
 * @see VectorTests VectorTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends ListClassTests<SUT>, RandomAccessClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>,
org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Vector.class!",
                   java.util.Vector.class.isAssignableFrom(sut));
    }

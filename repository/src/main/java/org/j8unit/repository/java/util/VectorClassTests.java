 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Vector public class
 * java.util.Vector<E>}.
 *
 ...
 * {@link org.j8unit.repository.java.util.VectorTests}.
 * </p>
 *
 * <p>
...
public abstract interface VectorClassTests<SUT extends Vector>
...
org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractListClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Vector.class!",
                   Vector.class.isAssignableFrom(sut));
    }

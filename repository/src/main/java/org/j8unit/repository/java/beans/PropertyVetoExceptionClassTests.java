...
public abstract interface PropertyVetoExceptionClassTests<SUT extends PropertyVetoException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyVetoException.class!",
                   PropertyVetoException.class.isAssignableFrom(sut));
    }

 ...
 * java.beans.PropertyVetoException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyVetoExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see PropertyVetoExceptionTests PropertyVetoExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyVetoException.class!",
                   java.beans.PropertyVetoException.class.isAssignableFrom(sut));
    }

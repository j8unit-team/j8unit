 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindException
...
extends org.j8unit.repository.java.net.SocketExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindException.class!",
                   BindException.class.isAssignableFrom(sut));
    }

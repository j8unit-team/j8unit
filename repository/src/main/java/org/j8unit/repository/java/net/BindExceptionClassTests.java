...
/**
 * <p>
 * Test class for {@link java.net.BindException class java.net.BindException}, containing all class relevant test
...
extends org.j8unit.repository.java.net.SocketExceptionClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_BindException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.net.BindException> sut = createNewSUT();

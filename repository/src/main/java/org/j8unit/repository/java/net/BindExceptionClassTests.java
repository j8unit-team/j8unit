 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see BindExceptionTests BindExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface BindExceptionClassTests<SUT extends java.net.BindException>
extends SocketExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.BindException.class!",
                   java.net.BindException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataInputStream
...
public abstract interface DataInputStreamClassTests<SUT extends DataInputStream>
extends org.j8unit.repository.java.io.DataInputClassTests<SUT>, org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataInputStream.class!",
                   DataInputStream.class.isAssignableFrom(sut));
    }

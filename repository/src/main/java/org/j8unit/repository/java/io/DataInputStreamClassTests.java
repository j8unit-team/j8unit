 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see DataInputStreamTests DataInputStreamTests (The complementary j8unit test interface containing the instance
...
extends DataInputClassTests<SUT>, FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.DataInputStream.class!",
                   java.io.DataInputStream.class.isAssignableFrom(sut));
    }

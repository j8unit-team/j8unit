 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyStoreSpi public
 * abstract class java.security.KeyStoreSpi}.
 *
...
public abstract interface KeyStoreSpiClassTests<SUT extends KeyStoreSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyStoreSpi.class!",
                   KeyStoreSpi.class.isAssignableFrom(sut));
    }

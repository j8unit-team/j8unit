 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MethodType public
 * final class java.lang.invoke.MethodType}.
 *
...
public abstract interface MethodTypeClassTests<SUT extends MethodType>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.lang.invoke.MethodType]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MethodType.class!",

...
public abstract interface GeneralSecurityExceptionClassTests<SUT extends GeneralSecurityException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GeneralSecurityException.class!",
                   GeneralSecurityException.class.isAssignableFrom(sut));
    }

 ...
 * java.security.GeneralSecurityException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GeneralSecurityExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link GeneralSecurityExceptionTests}.
 * </p>
 *
 * @see java.security.GeneralSecurityException class java.security.GeneralSecurityException (the hereby targeted
 *      class-under-test class)
 * @see GeneralSecurityExceptionTests GeneralSecurityExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.GeneralSecurityException.class!",
                   java.security.GeneralSecurityException.class.isAssignableFrom(sut));
    }

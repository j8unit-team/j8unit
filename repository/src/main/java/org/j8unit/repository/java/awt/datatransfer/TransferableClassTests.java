 ...
 * java.awt.datatransfer.Transferable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransferableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransferableTests}.
 * </p>
 *
 * @see java.awt.datatransfer.Transferable interface java.awt.datatransfer.Transferable (the hereby targeted
 *      class-under-test class)
 * @see TransferableTests TransferableTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TransferableClassTests<SUT extends java.awt.datatransfer.Transferable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.Transferable.class!",
                   java.awt.datatransfer.Transferable.class.isAssignableFrom(sut));
    }

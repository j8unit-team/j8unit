 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Transferable public
 * abstract interface java.awt.datatransfer.Transferable}.
 *
...
public abstract interface TransferableClassTests<SUT extends Transferable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Transferable.class!",
                   Transferable.class.isAssignableFrom(sut));
    }

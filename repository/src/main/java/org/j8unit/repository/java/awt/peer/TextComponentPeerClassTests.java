 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextComponentPeer
...
public abstract interface TextComponentPeerClassTests<SUT extends TextComponentPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextComponentPeer.class!",
                   TextComponentPeer.class.isAssignableFrom(sut));
    }

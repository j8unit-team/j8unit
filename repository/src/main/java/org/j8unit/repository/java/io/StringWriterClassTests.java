 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringWriter public
...
public abstract interface StringWriterClassTests<SUT extends StringWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringWriter.class!",
                   StringWriter.class.isAssignableFrom(sut));
    }

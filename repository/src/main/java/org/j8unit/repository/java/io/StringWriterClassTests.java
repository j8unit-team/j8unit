...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.StringWriter class java.io.StringWriter}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringWriterTests}.
 * </p>
 *
 * @see java.io.StringWriter class java.io.StringWriter (the hereby targeted class-under-test class)
 * @see StringWriterTests StringWriterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface StringWriterClassTests<SUT extends java.io.StringWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.StringWriter.class!",
                   java.io.StringWriter.class.isAssignableFrom(sut));
    }

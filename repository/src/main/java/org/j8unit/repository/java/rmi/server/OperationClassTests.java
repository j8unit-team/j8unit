 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Operation public
...
public abstract interface OperationClassTests<SUT extends Operation>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Operation.class!",
                   Operation.class.isAssignableFrom(sut));
    }

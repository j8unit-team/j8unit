...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.server.Operation class java.rmi.server.Operation}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OperationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OperationTests}.
 * </p>
 *
 * @see java.rmi.server.Operation class java.rmi.server.Operation (the hereby targeted class-under-test class)
 * @see OperationTests OperationTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface OperationClassTests<SUT extends java.rmi.server.Operation>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.Operation.class!",
                   java.rmi.server.Operation.class.isAssignableFrom(sut));
    }

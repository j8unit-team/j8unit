...
org.j8unit.repository.java.security.cert.PKIXCertPathValidatorResultClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.security.cert.PKIXCertPathBuilderResult#PKIXCertPathBuilderResult(java.security.cert.CertPath,
     *             java.security.cert.TrustAnchor, java.security.cert.PolicyNode, java.security.PublicKey)
     */
    ...
    throws Exception {
        ...
        final java.security.cert.PKIXCertPathBuilderResult sut = null; // = new
                                                                       // PKIXCertPathBuilderResult(java.security.cert.CertPath,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.security.cert.PKIXCertPathBuilderResult#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

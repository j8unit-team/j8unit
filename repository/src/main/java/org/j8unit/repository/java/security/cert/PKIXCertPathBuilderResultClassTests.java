 ...
 * java.security.cert.PKIXCertPathBuilderResult}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see PKIXCertPathBuilderResultTests PKIXCertPathBuilderResultTests (The complementary j8unit test interface
...
extends CertPathBuilderResultClassTests<SUT>, PKIXCertPathValidatorResultClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PKIXCertPathBuilderResult.class!",
                   java.security.cert.PKIXCertPathBuilderResult.class.isAssignableFrom(sut));
    }

...
extends CertPathBuilderResultClassTests<SUT>, PKIXCertPathValidatorResultClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKIXCertPathBuilderResult.class!",
                   PKIXCertPathBuilderResult.class.isAssignableFrom(sut));
    }

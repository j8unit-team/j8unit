...
extends org.j8unit.repository.java.util.zip.DeflaterOutputStreamClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.ZipOutputStream#ZipOutputStream(java.io.OutputStream)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.ZipOutputStream#ZipOutputStream(java.io.OutputStream, java.nio.charset.Charset)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ZipOutputStream_OutputStream_Charset()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.zip.ZipOutputStream sut = null; // = new ZipOutputStream(java.io.OutputStream,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.zip.ZipOutputStream#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

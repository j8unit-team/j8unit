 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZipOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZipOutputStreamTests}.
 * </p>
 *
 * @see java.util.zip.ZipOutputStream class java.util.zip.ZipOutputStream (the hereby targeted class-under-test class)
 * @see ZipOutputStreamTests ZipOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface ZipOutputStreamClassTests<SUT extends java.util.zip.ZipOutputStream>
extends DeflaterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.ZipOutputStream.class!",
                   java.util.zip.ZipOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZipOutputStream
...
public abstract interface ZipOutputStreamClassTests<SUT extends ZipOutputStream>
extends DeflaterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZipOutputStream.class!",
                   ZipOutputStream.class.isAssignableFrom(sut));
    }

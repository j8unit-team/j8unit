 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MGF1ParameterSpec
...
public abstract interface MGF1ParameterSpecClassTests<SUT extends MGF1ParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MGF1ParameterSpec.class!",
                   MGF1ParameterSpec.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.YearMonth class java.time.YearMonth}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link YearMonthTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link YearMonthTests}.
 * </p>
 *
 * @see java.time.YearMonth class java.time.YearMonth (the hereby targeted class-under-test class)
 * @see YearMonthTests YearMonthTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.YearMonth.class!",
                   java.time.YearMonth.class.isAssignableFrom(sut));
    }

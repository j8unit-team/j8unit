 ...
 * java.security.spec.InvalidKeySpecException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidKeySpecExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link InvalidKeySpecExceptionTests}.
 * </p>
 *
 * @see java.security.spec.InvalidKeySpecException class java.security.spec.InvalidKeySpecException (the hereby targeted
 *      class-under-test class)
 * @see InvalidKeySpecExceptionTests InvalidKeySpecExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.InvalidKeySpecException.class!",
                   java.security.spec.InvalidKeySpecException.class.isAssignableFrom(sut));
    }

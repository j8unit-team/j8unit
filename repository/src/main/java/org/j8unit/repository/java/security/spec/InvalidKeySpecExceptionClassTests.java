 ...
 * {@link org.j8unit.repository.java.security.spec.InvalidKeySpecExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface InvalidKeySpecExceptionClassTests<SUT extends InvalidKeySpecException>
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidKeySpecException.class!",
                   InvalidKeySpecException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.ProviderException class java.security.ProviderException}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProviderExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProviderExceptionTests}.
 * </p>
 *
 * @see java.security.ProviderException class java.security.ProviderException (the hereby targeted class-under-test
 *      class)
 * @see ProviderExceptionTests ProviderExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ProviderExceptionClassTests<SUT extends java.security.ProviderException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.ProviderException.class!",
                   java.security.ProviderException.class.isAssignableFrom(sut));
    }

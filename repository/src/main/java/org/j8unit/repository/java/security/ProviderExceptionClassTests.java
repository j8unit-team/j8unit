 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProviderException
...
public abstract interface ProviderExceptionClassTests<SUT extends ProviderException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProviderException.class!",
                   ProviderException.class.isAssignableFrom(sut));
    }

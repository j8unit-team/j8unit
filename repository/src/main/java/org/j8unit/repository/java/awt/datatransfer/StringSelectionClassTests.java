 ...
 * java.awt.datatransfer.StringSelection}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringSelectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StringSelectionTests}.
 * </p>
 *
 * @see java.awt.datatransfer.StringSelection class java.awt.datatransfer.StringSelection (the hereby targeted
 *      class-under-test class)
 * @see StringSelectionTests StringSelectionTests (The complementary j8unit test interface containing the instance
...
extends TransferableClassTests<SUT>, ClipboardOwnerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.StringSelection.class!",
                   java.awt.datatransfer.StringSelection.class.isAssignableFrom(sut));
    }

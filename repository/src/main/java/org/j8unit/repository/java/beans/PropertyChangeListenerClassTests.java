...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.PropertyChangeListener interface
 * java.beans.PropertyChangeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyChangeListenerTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PropertyChangeListenerTests}.
 * </p>
 *
 * @see java.beans.PropertyChangeListener interface java.beans.PropertyChangeListener (the hereby targeted
 *      class-under-test class)
 * @see PropertyChangeListenerTests PropertyChangeListenerTests (The complementary j8unit test interface containing the
...
public abstract interface PropertyChangeListenerClassTests<SUT extends java.beans.PropertyChangeListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyChangeListener.class!",
                   java.beans.PropertyChangeListener.class.isAssignableFrom(sut));
    }

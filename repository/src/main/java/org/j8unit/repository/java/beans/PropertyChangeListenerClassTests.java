 ...
 * {@link PropertyChangeListener public abstract interface java.beans.PropertyChangeListener}.
 *
 ...
 * {@link org.j8unit.repository.java.beans.PropertyChangeListenerTests}.
 * </p>
 *
 * <p>
...
public abstract interface PropertyChangeListenerClassTests<SUT extends PropertyChangeListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyChangeListener.class!",
                   PropertyChangeListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Composite interface java.awt.Composite}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompositeTests}.
 * </p>
 *
 * @see java.awt.Composite interface java.awt.Composite (the hereby targeted class-under-test class)
 * @see CompositeTests CompositeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CompositeClassTests<SUT extends java.awt.Composite>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Composite.class!",
                   java.awt.Composite.class.isAssignableFrom(sut));
    }

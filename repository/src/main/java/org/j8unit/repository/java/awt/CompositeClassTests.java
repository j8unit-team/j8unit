 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Composite public
 * abstract interface java.awt.Composite}.
 *
...
public abstract interface CompositeClassTests<SUT extends Composite>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Composite.class!",
                   Composite.class.isAssignableFrom(sut));
    }

...
public abstract interface LambdaConversionExceptionClassTests<SUT extends LambdaConversionException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LambdaConversionException.class!",
                   LambdaConversionException.class.isAssignableFrom(sut));
    }

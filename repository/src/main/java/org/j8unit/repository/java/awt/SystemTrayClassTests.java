 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SystemTray public
...
public abstract interface SystemTrayClassTests<SUT extends SystemTray>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SystemTray.class!",
                   SystemTray.class.isAssignableFrom(sut));
    }

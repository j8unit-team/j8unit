 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileNameMap public
 * abstract interface java.net.FileNameMap}.
 *
...
public abstract interface FileNameMapClassTests<SUT extends FileNameMap>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileNameMap.class!",
                   FileNameMap.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.FileNameMap interface java.net.FileNameMap}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileNameMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileNameMapTests}.
 * </p>
 *
 * @see java.net.FileNameMap interface java.net.FileNameMap (the hereby targeted class-under-test class)
 * @see FileNameMapTests FileNameMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FileNameMapClassTests<SUT extends java.net.FileNameMap>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.FileNameMap.class!",
                   java.net.FileNameMap.class.isAssignableFrom(sut));
    }

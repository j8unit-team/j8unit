...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.dgc.DGC interface java.rmi.dgc.DGC}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DGCTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DGCTests}.
 * </p>
 *
 * @see java.rmi.dgc.DGC interface java.rmi.dgc.DGC (the hereby targeted class-under-test class)
 * @see DGCTests DGCTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DGCClassTests<SUT extends java.rmi.dgc.DGC>
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.dgc.DGC.class!",
                   java.rmi.dgc.DGC.class.isAssignableFrom(sut));
    }

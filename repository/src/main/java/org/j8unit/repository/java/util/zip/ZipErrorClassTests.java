...
import org.j8unit.repository.java.lang.InternalErrorClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ZipError public
...
public abstract interface ZipErrorClassTests<SUT extends ZipError>
extends InternalErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ZipError.class!",
                   ZipError.class.isAssignableFrom(sut));
    }

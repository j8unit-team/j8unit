...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.ZipError class java.util.zip.ZipError}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZipErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZipErrorTests}.
 * </p>
 *
 * @see java.util.zip.ZipError class java.util.zip.ZipError (the hereby targeted class-under-test class)
 * @see ZipErrorTests ZipErrorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ZipErrorClassTests<SUT extends java.util.zip.ZipError>
extends org.j8unit.repository.java.lang.InternalErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.ZipError.class!",
                   java.util.zip.ZipError.class.isAssignableFrom(sut));
    }

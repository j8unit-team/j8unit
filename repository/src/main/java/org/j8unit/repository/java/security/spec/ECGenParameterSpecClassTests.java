 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECGenParameterSpec
...
public abstract interface ECGenParameterSpecClassTests<SUT extends ECGenParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECGenParameterSpec.class!",
                   ECGenParameterSpec.class.isAssignableFrom(sut));
    }

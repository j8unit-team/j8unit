 ...
 * java.security.spec.ECGenParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECGenParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECGenParameterSpecTests}.
 * </p>
 *
 * @see java.security.spec.ECGenParameterSpec class java.security.spec.ECGenParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see ECGenParameterSpecTests ECGenParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECGenParameterSpec.class!",
                   java.security.spec.ECGenParameterSpec.class.isAssignableFrom(sut));
    }

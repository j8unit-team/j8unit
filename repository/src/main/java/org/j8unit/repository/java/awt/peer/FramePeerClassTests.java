 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FramePeer public
 * abstract interface java.awt.peer.FramePeer}.
 *
...
extends WindowPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FramePeer.class!",
                   FramePeer.class.isAssignableFrom(sut));
    }

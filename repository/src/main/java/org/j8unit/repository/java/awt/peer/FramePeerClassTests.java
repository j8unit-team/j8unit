...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.FramePeer interface java.awt.peer.FramePeer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FramePeerTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.peer.FramePeer interface java.awt.peer.FramePeer (the hereby targeted class-under-test class)
 * @see FramePeerTests FramePeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FramePeerClassTests<SUT extends java.awt.peer.FramePeer>
extends WindowPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.FramePeer.class!",
                   java.awt.peer.FramePeer.class.isAssignableFrom(sut));
    }

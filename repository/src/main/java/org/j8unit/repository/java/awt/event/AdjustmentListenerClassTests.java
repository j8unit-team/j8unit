...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.AdjustmentListener interface
 * java.awt.event.AdjustmentListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AdjustmentListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AdjustmentListenerTests}.
 * </p>
 *
 * @see java.awt.event.AdjustmentListener interface java.awt.event.AdjustmentListener (the hereby targeted
 *      class-under-test class)
 * @see AdjustmentListenerTests AdjustmentListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface AdjustmentListenerClassTests<SUT extends java.awt.event.AdjustmentListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.AdjustmentListener.class!",
                   java.awt.event.AdjustmentListener.class.isAssignableFrom(sut));
    }

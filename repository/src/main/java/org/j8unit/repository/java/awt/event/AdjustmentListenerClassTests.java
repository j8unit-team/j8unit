 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AdjustmentListener
...
public abstract interface AdjustmentListenerClassTests<SUT extends AdjustmentListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdjustmentListener.class!",
                   AdjustmentListener.class.isAssignableFrom(sut));
    }

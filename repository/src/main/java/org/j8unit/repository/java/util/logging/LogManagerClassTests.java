 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LogManager public
...
public abstract interface LogManagerClassTests<SUT extends LogManager>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.logging.LogManager]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LogManager.class!",
                   LogManager.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.logging.LogManager]

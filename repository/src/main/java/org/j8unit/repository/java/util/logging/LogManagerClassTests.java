...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.logging.LogManager class java.util.logging.LogManager},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LogManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LogManagerTests}.
 * </p>
 *
 * @see java.util.logging.LogManager class java.util.logging.LogManager (the hereby targeted class-under-test class)
 * @see LogManagerTests LogManagerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LogManagerClassTests<SUT extends java.util.logging.LogManager>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.LogManager.class!",
                   java.util.logging.LogManager.class.isAssignableFrom(sut));
    }

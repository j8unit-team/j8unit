...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.ConstructorProperties interface
 * java.beans.ConstructorProperties}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConstructorPropertiesTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ConstructorPropertiesTests}.
 * </p>
 *
 * @see java.beans.ConstructorProperties interface java.beans.ConstructorProperties (the hereby targeted
 *      class-under-test class)
 * @see ConstructorPropertiesTests ConstructorPropertiesTests (The complementary j8unit test interface containing the
...
public abstract interface ConstructorPropertiesClassTests<SUT extends java.beans.ConstructorProperties>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.ConstructorProperties.class!",
                   java.beans.ConstructorProperties.class.isAssignableFrom(sut));
    }

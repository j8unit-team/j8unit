 ...
 * {@link ConstructorProperties public abstract @interface java.beans.ConstructorProperties}.
 *
...
public abstract interface ConstructorPropertiesClassTests<SUT extends ConstructorProperties>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConstructorProperties.class!",
                   ConstructorProperties.class.isAssignableFrom(sut));
    }

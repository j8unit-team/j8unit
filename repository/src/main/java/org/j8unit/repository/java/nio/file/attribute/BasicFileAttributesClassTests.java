 ...
 * java.nio.file.attribute.BasicFileAttributes}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicFileAttributesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicFileAttributesTests}.
 * </p>
 *
 * @see java.nio.file.attribute.BasicFileAttributes interface java.nio.file.attribute.BasicFileAttributes (the hereby
 *      targeted class-under-test class)
 * @see BasicFileAttributesTests BasicFileAttributesTests (The complementary j8unit test interface containing the
...
public abstract interface BasicFileAttributesClassTests<SUT extends java.nio.file.attribute.BasicFileAttributes>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.BasicFileAttributes.class!",
                   java.nio.file.attribute.BasicFileAttributes.class.isAssignableFrom(sut));
    }

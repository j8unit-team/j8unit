 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicFileAttributes
 * public abstract interface java.nio.file.attribute.BasicFileAttributes}.
 *
...
public abstract interface BasicFileAttributesClassTests<SUT extends BasicFileAttributes>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicFileAttributes.class!",

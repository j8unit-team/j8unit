...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.Temporal interface java.time.temporal.Temporal},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalTests}).
 * </p>
 *
 * <p>
 ...
 * @see TemporalTests TemporalTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TemporalClassTests<SUT extends java.time.temporal.Temporal>
extends TemporalAccessorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.Temporal.class!",
                   java.time.temporal.Temporal.class.isAssignableFrom(sut));
    }

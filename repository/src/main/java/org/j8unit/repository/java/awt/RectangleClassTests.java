...
import org.j8unit.repository.java.awt.geom.Rectangle2DClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Rectangle public
...
public abstract interface RectangleClassTests<SUT extends Rectangle>
extends SerializableClassTests<SUT>, Rectangle2DClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Rectangle.class!",
                   Rectangle.class.isAssignableFrom(sut));
    }

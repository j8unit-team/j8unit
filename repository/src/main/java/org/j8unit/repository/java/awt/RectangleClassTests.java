...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Rectangle class java.awt.Rectangle}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RectangleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RectangleTests}.
 * </p>
 *
 * @see java.awt.Rectangle class java.awt.Rectangle (the hereby targeted class-under-test class)
 * @see RectangleTests RectangleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RectangleClassTests<SUT extends java.awt.Rectangle>
extends ShapeClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.Rectangle2DClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Rectangle.class!",
                   java.awt.Rectangle.class.isAssignableFrom(sut));
    }

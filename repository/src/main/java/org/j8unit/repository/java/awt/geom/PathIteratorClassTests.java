 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PathIterator public
 * abstract interface java.awt.geom.PathIterator}.
 *
...
public abstract interface PathIteratorClassTests<SUT extends PathIterator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PathIterator.class!",

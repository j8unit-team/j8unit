...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.geom.PathIterator interface java.awt.geom.PathIterator},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PathIteratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PathIteratorTests}.
 * </p>
 *
 * @see java.awt.geom.PathIterator interface java.awt.geom.PathIterator (the hereby targeted class-under-test class)
 * @see PathIteratorTests PathIteratorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PathIteratorClassTests<SUT extends java.awt.geom.PathIterator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.PathIterator.class!",
                   java.awt.geom.PathIterator.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain ClassCastException class java.lang.ClassCastException}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClassCastExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClassCastExceptionTests}.
 * </p>
 *
 * @see ClassCastException class java.lang.ClassCastException (the hereby targeted class-under-test class)
 * @see ClassCastExceptionTests ClassCastExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ClassCastExceptionClassTests<SUT extends ClassCastException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClassCastException.class!",
                   ClassCastException.class.isAssignableFrom(sut));
    }

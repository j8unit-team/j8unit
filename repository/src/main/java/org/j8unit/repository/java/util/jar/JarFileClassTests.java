...
import org.j8unit.repository.java.util.zip.ZipFileClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JarFile public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JarFileTests}.
 * </p>
 *
 * <p>
...
public abstract interface JarFileClassTests<SUT extends JarFile>
extends ZipFileClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JarFile.class!",
                   JarFile.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JarFileTests}).
 * </p>
 *
 * <p>
 ...
 * @see JarFileTests JarFileTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface JarFileClassTests<SUT extends java.util.jar.JarFile>
extends org.j8unit.repository.java.util.zip.ZipFileClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.jar.JarFile.class!",
                   java.util.jar.JarFile.class.isAssignableFrom(sut));
    }

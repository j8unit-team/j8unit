 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectInputValidationTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ObjectInputValidationTests}.
 * </p>
 *
 * @see java.io.ObjectInputValidation interface java.io.ObjectInputValidation (the hereby targeted class-under-test
 *      class)
 * @see ObjectInputValidationTests ObjectInputValidationTests (The complementary j8unit test interface containing the
...
public abstract interface ObjectInputValidationClassTests<SUT extends java.io.ObjectInputValidation>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectInputValidation.class!",
                   java.io.ObjectInputValidation.class.isAssignableFrom(sut));
    }

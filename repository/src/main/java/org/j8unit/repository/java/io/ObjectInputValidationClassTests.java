 ...
 * {@link ObjectInputValidation public abstract interface java.io.ObjectInputValidation}.
 *
...
public abstract interface ObjectInputValidationClassTests<SUT extends ObjectInputValidation>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectInputValidation.class!",
                   ObjectInputValidation.class.isAssignableFrom(sut));
    }

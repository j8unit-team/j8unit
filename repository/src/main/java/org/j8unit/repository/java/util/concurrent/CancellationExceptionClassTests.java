...
public abstract interface CancellationExceptionClassTests<SUT extends CancellationException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CancellationException.class!",
                   CancellationException.class.isAssignableFrom(sut));
    }

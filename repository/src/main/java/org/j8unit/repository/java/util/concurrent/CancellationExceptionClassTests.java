 ...
 * java.util.concurrent.CancellationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CancellationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link CancellationExceptionTests}.
 * </p>
 *
 * @see java.util.concurrent.CancellationException class java.util.concurrent.CancellationException (the hereby targeted
 *      class-under-test class)
 * @see CancellationExceptionTests CancellationExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CancellationException.class!",
                   java.util.concurrent.CancellationException.class.isAssignableFrom(sut));
    }

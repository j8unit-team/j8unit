 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferedOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferedOutputStreamTests}
 * .
 * </p>
 *
 * @see java.io.BufferedOutputStream class java.io.BufferedOutputStream (the hereby targeted class-under-test class)
 * @see BufferedOutputStreamTests BufferedOutputStreamTests (The complementary j8unit test interface containing the
...
extends FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.BufferedOutputStream.class!",
                   java.io.BufferedOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * {@link BufferedOutputStreamTests}.
 * </p>
 *
 * <p>
...
public abstract interface BufferedOutputStreamClassTests<SUT extends BufferedOutputStream>
extends FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferedOutputStream.class!",
                   BufferedOutputStream.class.isAssignableFrom(sut));
    }

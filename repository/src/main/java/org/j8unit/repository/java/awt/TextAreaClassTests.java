...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.TextArea class java.awt.TextArea}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextAreaTests}).
 * </p>
 *
 * <p>
 ...
 * @see TextAreaTests TextAreaTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends TextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.TextArea.class!",
                   java.awt.TextArea.class.isAssignableFrom(sut));
    }

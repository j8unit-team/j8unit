 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextArea public
...
extends org.j8unit.repository.java.awt.TextComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextArea.class!",
                   TextArea.class.isAssignableFrom(sut));
    }

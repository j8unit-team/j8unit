...
import org.j8unit.repository.java.text.NormalizerTests.FormTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Normalizer public
 * final class java.text.Normalizer}.
 *
...
public abstract interface NormalizerClassTests<SUT extends Normalizer>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Normalizer.class!",
                   Normalizer.class.isAssignableFrom(sut));
    }
     ...
     * {@link Form public static final enum java.text.Normalizer$Form}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     *
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is {@link FormTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface FormClassTests<SUT extends Form>
    extends EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            Assert.assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Form.class!",
                              Form.class.isAssignableFrom(sut));
        }

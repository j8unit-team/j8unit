...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.text.Normalizer class java.text.Normalizer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NormalizerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NormalizerTests}.
 * </p>
 *
 * @see java.text.Normalizer class java.text.Normalizer (the hereby targeted class-under-test class)
 * @see NormalizerTests NormalizerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.Normalizer.class!",
                   java.text.Normalizer.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link NormalizerTests.FormTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * {@link NormalizerTests.FormTests}.
     * </p>
     *
     * @see java.text.Normalizer.Form class java.text.Normalizer$Form (the hereby targeted class-under-test class)
     * @see NormalizerTests.FormTests NormalizerTests.FormTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.Normalizer.Form.class!",
                       java.text.Normalizer.Form.class.isAssignableFrom(sut));
        }

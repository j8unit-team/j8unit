 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VolatileImage
...
extends TransparencyClassTests<SUT>, ImageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VolatileImage.class!",
                   VolatileImage.class.isAssignableFrom(sut));
    }

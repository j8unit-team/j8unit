...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.VolatileImage class java.awt.image.VolatileImage},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VolatileImageTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.image.VolatileImage class java.awt.image.VolatileImage (the hereby targeted class-under-test class)
 * @see VolatileImageTests VolatileImageTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface VolatileImageClassTests<SUT extends java.awt.image.VolatileImage>
extends org.j8unit.repository.java.awt.TransparencyClassTests<SUT>, org.j8unit.repository.java.awt.ImageClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.VolatileImage.class!",
                   java.awt.image.VolatileImage.class.isAssignableFrom(sut));
    }

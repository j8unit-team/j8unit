...
public abstract interface IllegalFormatCodePointExceptionClassTests<SUT extends IllegalFormatCodePointException>
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalFormatCodePointException.class!",
                   IllegalFormatCodePointException.class.isAssignableFrom(sut));
    }

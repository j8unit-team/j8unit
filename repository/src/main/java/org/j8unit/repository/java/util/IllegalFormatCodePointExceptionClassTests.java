 ...
 * java.util.IllegalFormatCodePointException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link IllegalFormatCodePointExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalFormatCodePointExceptionTests IllegalFormatCodePointExceptionTests (The complementary j8unit test
...
extends IllegalFormatExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IllegalFormatCodePointException.class!",
                   java.util.IllegalFormatCodePointException.class.isAssignableFrom(sut));
    }

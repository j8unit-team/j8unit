 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventSetDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventSetDescriptorTests}.
 * </p>
 *
 * @see java.beans.EventSetDescriptor class java.beans.EventSetDescriptor (the hereby targeted class-under-test class)
 * @see EventSetDescriptorTests EventSetDescriptorTests (The complementary j8unit test interface containing the instance
...
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.EventSetDescriptor.class!",
                   java.beans.EventSetDescriptor.class.isAssignableFrom(sut));
    }

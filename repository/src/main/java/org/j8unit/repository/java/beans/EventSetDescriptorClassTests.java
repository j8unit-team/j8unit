 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventSetDescriptor
...
public abstract interface EventSetDescriptorClassTests<SUT extends EventSetDescriptor>
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventSetDescriptor.class!",
                   EventSetDescriptor.class.isAssignableFrom(sut));
    }

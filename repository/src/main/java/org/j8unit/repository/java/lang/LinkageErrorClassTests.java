...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain LinkageError class java.lang.LinkageError}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkageErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkageErrorTests}.
 * </p>
 *
 * @see LinkageError class java.lang.LinkageError (the hereby targeted class-under-test class)
 * @see LinkageErrorTests LinkageErrorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LinkageErrorClassTests<SUT extends LinkageError>
extends ErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkageError.class!",
                   LinkageError.class.isAssignableFrom(sut));
    }

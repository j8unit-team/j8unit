 ...
 * java.beans.beancontext.BeanContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanContextTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextTests BeanContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BeanContextClassTests<SUT extends java.beans.beancontext.BeanContext>
extends BeanContextChildClassTests<SUT>, org.j8unit.repository.java.util.CollectionClassTests<SUT>, org.j8unit.repository.java.beans.DesignModeClassTests<SUT>,
org.j8unit.repository.java.beans.VisibilityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContext.class!",
                   java.beans.beancontext.BeanContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanContext public
 * abstract interface java.beans.beancontext.BeanContext}.
 *
...
extends BeanContextChildClassTests<SUT>, CollectionClassTests<SUT>, DesignModeClassTests<SUT>, VisibilityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContext.class!",

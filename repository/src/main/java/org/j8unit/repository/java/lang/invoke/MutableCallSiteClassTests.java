 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MutableCallSite
...
public abstract interface MutableCallSiteClassTests<SUT extends MutableCallSite>
extends CallSiteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MutableCallSite.class!",
                   MutableCallSite.class.isAssignableFrom(sut));
    }

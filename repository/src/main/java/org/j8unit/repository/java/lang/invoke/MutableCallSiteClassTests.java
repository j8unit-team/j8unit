 ...
 * java.lang.invoke.MutableCallSite}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MutableCallSiteTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MutableCallSiteTests}.
 * </p>
 *
 * @see java.lang.invoke.MutableCallSite class java.lang.invoke.MutableCallSite (the hereby targeted class-under-test
 *      class)
 * @see MutableCallSiteTests MutableCallSiteTests (The complementary j8unit test interface containing the instance
...
extends CallSiteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.invoke.MutableCallSite.class!",
                   java.lang.invoke.MutableCallSite.class.isAssignableFrom(sut));
    }

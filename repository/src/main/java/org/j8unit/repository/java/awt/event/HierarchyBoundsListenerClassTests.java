...
public abstract interface HierarchyBoundsListenerClassTests<SUT extends HierarchyBoundsListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HierarchyBoundsListener.class!",
                   HierarchyBoundsListener.class.isAssignableFrom(sut));
    }

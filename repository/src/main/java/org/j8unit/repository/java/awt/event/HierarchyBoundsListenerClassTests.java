 ...
 * java.awt.event.HierarchyBoundsListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HierarchyBoundsListenerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link HierarchyBoundsListenerTests}.
 * </p>
 *
 * @see java.awt.event.HierarchyBoundsListener interface java.awt.event.HierarchyBoundsListener (the hereby targeted
 *      class-under-test class)
 * @see HierarchyBoundsListenerTests HierarchyBoundsListenerTests (The complementary j8unit test interface containing
...
public abstract interface HierarchyBoundsListenerClassTests<SUT extends java.awt.event.HierarchyBoundsListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.HierarchyBoundsListener.class!",
                   java.awt.event.HierarchyBoundsListener.class.isAssignableFrom(sut));
    }

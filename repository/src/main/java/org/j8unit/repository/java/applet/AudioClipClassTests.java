...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.applet.AudioClip interface java.applet.AudioClip}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AudioClipTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AudioClipTests}.
 * </p>
 *
 * @see java.applet.AudioClip interface java.applet.AudioClip (the hereby targeted class-under-test class)
 * @see AudioClipTests AudioClipTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AudioClipClassTests<SUT extends java.applet.AudioClip>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.applet.AudioClip.class!",
                   java.applet.AudioClip.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AudioClip public
 * abstract interface java.applet.AudioClip}.
 *
...
public abstract interface AudioClipClassTests<SUT extends AudioClip>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AudioClip.class!",
                   AudioClip.class.isAssignableFrom(sut));
    }

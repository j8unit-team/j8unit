...
public abstract interface UnmodifiableClassExceptionClassTests<SUT extends UnmodifiableClassException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnmodifiableClassException.class!",
                   UnmodifiableClassException.class.isAssignableFrom(sut));
    }

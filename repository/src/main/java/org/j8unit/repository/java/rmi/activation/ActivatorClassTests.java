 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ActivatorTests}.
 * </p>
 *
 * @see java.rmi.activation.Activator interface java.rmi.activation.Activator (the hereby targeted class-under-test
 *      class)
 * @see ActivatorTests ActivatorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.Activator.class!",
                   java.rmi.activation.Activator.class.isAssignableFrom(sut));
    }

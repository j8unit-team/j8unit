 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Activator public
 * abstract interface java.rmi.activation.Activator}.
 *
...
public abstract interface ActivatorClassTests<SUT extends Activator>
extends RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Activator.class!",

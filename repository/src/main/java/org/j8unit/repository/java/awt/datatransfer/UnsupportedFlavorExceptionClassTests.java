 ...
 * {@link UnsupportedFlavorException public class java.awt.datatransfer.UnsupportedFlavorException}.
 *
...
public abstract interface UnsupportedFlavorExceptionClassTests<SUT extends UnsupportedFlavorException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedFlavorException.class!",
                   UnsupportedFlavorException.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.interfaces.DSAKey interface
 * java.security.interfaces.DSAKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAKeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAKeyTests}.
 * </p>
 *
 * @see java.security.interfaces.DSAKey interface java.security.interfaces.DSAKey (the hereby targeted class-under-test
 *      class)
 * @see DSAKeyTests DSAKeyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DSAKeyClassTests<SUT extends java.security.interfaces.DSAKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.DSAKey.class!",
                   java.security.interfaces.DSAKey.class.isAssignableFrom(sut));
    }

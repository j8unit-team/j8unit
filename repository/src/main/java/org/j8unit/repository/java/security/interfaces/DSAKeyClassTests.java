 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAKey public
 * abstract interface java.security.interfaces.DSAKey}.
 *
...
public abstract interface DSAKeyClassTests<SUT extends DSAKey>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAKey.class!",
                   DSAKey.class.isAssignableFrom(sut));
    }

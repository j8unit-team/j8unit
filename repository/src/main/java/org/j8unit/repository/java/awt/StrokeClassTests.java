...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Stroke interface java.awt.Stroke}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StrokeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StrokeTests}.
 * </p>
 *
 * @see java.awt.Stroke interface java.awt.Stroke (the hereby targeted class-under-test class)
 * @see StrokeTests StrokeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface StrokeClassTests<SUT extends java.awt.Stroke>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Stroke.class!",
                   java.awt.Stroke.class.isAssignableFrom(sut));
    }

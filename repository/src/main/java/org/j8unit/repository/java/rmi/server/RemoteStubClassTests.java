 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RemoteStubTests}).
 * </p>
 *
 * <p>
 ...
 * @see RemoteStubTests RemoteStubTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RemoteStubClassTests<SUT extends java.rmi.server.RemoteStub>
extends RemoteObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RemoteStub.class!",
                   java.rmi.server.RemoteStub.class.isAssignableFrom(sut));
    }

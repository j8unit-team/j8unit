 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RemoteStub public
 * abstract class java.rmi.server.RemoteStub}.
 *
...
extends RemoteObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemoteStub.class!",
                   RemoteStub.class.isAssignableFrom(sut));
    }

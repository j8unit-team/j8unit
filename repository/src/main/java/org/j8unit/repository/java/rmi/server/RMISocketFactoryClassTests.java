 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RMISocketFactory
 * public abstract class java.rmi.server.RMISocketFactory}.
 *
...
public abstract interface RMISocketFactoryClassTests<SUT extends RMISocketFactory>
extends RMIClientSocketFactoryClassTests<SUT>, RMIServerSocketFactoryClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMISocketFactory.class!",

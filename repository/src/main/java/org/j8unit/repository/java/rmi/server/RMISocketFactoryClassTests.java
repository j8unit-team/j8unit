 ...
 * java.rmi.server.RMISocketFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RMISocketFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RMISocketFactoryTests}.
 * </p>
 *
 * @see java.rmi.server.RMISocketFactory class java.rmi.server.RMISocketFactory (the hereby targeted class-under-test
 *      class)
 * @see RMISocketFactoryTests RMISocketFactoryTests (The complementary j8unit test interface containing the instance
...
extends RMIClientSocketFactoryClassTests<SUT>, RMIServerSocketFactoryClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RMISocketFactory.class!",
                   java.rmi.server.RMISocketFactory.class.isAssignableFrom(sut));
    }

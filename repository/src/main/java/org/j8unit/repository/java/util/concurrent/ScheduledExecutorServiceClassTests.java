 ...
 * java.util.concurrent.ScheduledExecutorService}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ScheduledExecutorServiceTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see ScheduledExecutorServiceTests ScheduledExecutorServiceTests (The complementary j8unit test interface containing
...
public abstract interface ScheduledExecutorServiceClassTests<SUT extends java.util.concurrent.ScheduledExecutorService>
extends ExecutorServiceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ScheduledExecutorService.class!",
                   java.util.concurrent.ScheduledExecutorService.class.isAssignableFrom(sut));
    }

 ...
 * {@link InvalidClassException public class java.io.InvalidClassException}.
 *
...
public abstract interface InvalidClassExceptionClassTests<SUT extends InvalidClassException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidClassException.class!",
                   InvalidClassException.class.isAssignableFrom(sut));
    }

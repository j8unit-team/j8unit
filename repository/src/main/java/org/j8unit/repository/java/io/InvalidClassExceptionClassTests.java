 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidClassExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InvalidClassExceptionTests}.
 * </p>
 *
 * @see java.io.InvalidClassException class java.io.InvalidClassException (the hereby targeted class-under-test class)
 * @see InvalidClassExceptionTests InvalidClassExceptionTests (The complementary j8unit test interface containing the
...
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.InvalidClassException.class!",
                   java.io.InvalidClassException.class.isAssignableFrom(sut));
    }

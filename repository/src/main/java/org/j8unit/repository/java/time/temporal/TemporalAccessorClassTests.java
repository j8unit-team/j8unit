 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TemporalAccessor
 * public abstract interface java.time.temporal.TemporalAccessor}.
 *
...
public abstract interface TemporalAccessorClassTests<SUT extends TemporalAccessor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TemporalAccessor.class!",
                   TemporalAccessor.class.isAssignableFrom(sut));
    }

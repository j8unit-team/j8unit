...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.TemporalAccessor interface
 * java.time.temporal.TemporalAccessor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TemporalAccessorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TemporalAccessorTests}.
 * </p>
 *
 * @see java.time.temporal.TemporalAccessor interface java.time.temporal.TemporalAccessor (the hereby targeted
 *      class-under-test class)
 * @see TemporalAccessorTests TemporalAccessorTests (The complementary j8unit test interface containing the instance
...
public abstract interface TemporalAccessorClassTests<SUT extends java.time.temporal.TemporalAccessor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.TemporalAccessor.class!",
                   java.time.temporal.TemporalAccessor.class.isAssignableFrom(sut));
    }

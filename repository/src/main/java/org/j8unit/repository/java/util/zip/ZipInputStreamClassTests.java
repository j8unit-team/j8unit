 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.zip.ZipInputStream
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.util.zip.InflaterInputStreamClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.ZipInputStream#ZipInputStream(java.io.InputStream)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.ZipInputStream#ZipInputStream(java.io.InputStream, java.nio.charset.Charset)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ZipInputStream_InputStream_Charset()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.zip.ZipInputStream sut = null; // = new ZipInputStream(java.io.InputStream,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.zip.ZipInputStream#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

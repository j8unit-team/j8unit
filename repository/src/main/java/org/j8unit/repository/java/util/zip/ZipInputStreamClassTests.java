...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.ZipInputStream class java.util.zip.ZipInputStream},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZipInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.zip.ZipInputStream class java.util.zip.ZipInputStream (the hereby targeted class-under-test class)
 * @see ZipInputStreamTests ZipInputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface ZipInputStreamClassTests<SUT extends java.util.zip.ZipInputStream>
extends InflaterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.ZipInputStream.class!",
                   java.util.zip.ZipInputStream.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CookiePolicyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CookiePolicyTests}.
 * </p>
 *
 * @see java.net.CookiePolicy interface java.net.CookiePolicy (the hereby targeted class-under-test class)
 * @see CookiePolicyTests CookiePolicyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CookiePolicyClassTests<SUT extends java.net.CookiePolicy>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.CookiePolicy.class!",
                   java.net.CookiePolicy.class.isAssignableFrom(sut));
    }

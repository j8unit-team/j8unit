 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CookiePolicy public
 * abstract interface java.net.CookiePolicy}.
 *
...
public abstract interface CookiePolicyClassTests<SUT extends CookiePolicy>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CookiePolicy.class!",
                   CookiePolicy.class.isAssignableFrom(sut));
    }

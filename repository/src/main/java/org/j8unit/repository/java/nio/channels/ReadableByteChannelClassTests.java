...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.ReadableByteChannel interface
 * java.nio.channels.ReadableByteChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReadableByteChannelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReadableByteChannelTests}.
 * </p>
 *
 * @see java.nio.channels.ReadableByteChannel interface java.nio.channels.ReadableByteChannel (the hereby targeted
 *      class-under-test class)
 * @see ReadableByteChannelTests ReadableByteChannelTests (The complementary j8unit test interface containing the
...
public abstract interface ReadableByteChannelClassTests<SUT extends java.nio.channels.ReadableByteChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ReadableByteChannel.class!",
                   java.nio.channels.ReadableByteChannel.class.isAssignableFrom(sut));
    }

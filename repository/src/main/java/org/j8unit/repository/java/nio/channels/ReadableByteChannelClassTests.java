 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReadableByteChannel
 * public abstract interface java.nio.channels.ReadableByteChannel}.
 *
...
public abstract interface ReadableByteChannelClassTests<SUT extends ReadableByteChannel>
extends ChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReadableByteChannel.class!",
                   ReadableByteChannel.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.awt.font.MultipleMaster interface java.awt.font.MultipleMaster}, containing all instance
 ...
 * @since 0.9.0
 * @see org.j8unit.repository.java.awt.font.MultipleMasterClassTests
 */
@FunctionalInterface
...
extends J8UnitTest<SUT> {
    ...
    /**
     * <p>
     * Test method for {@link java.awt.font.MultipleMaster#deriveMMFont(float[],float,float,float,float) public abstract
    ...
    @Test
    @Category(Draft.class)
    public default void test_deriveMMFont_floatArray_float_float_float_float()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

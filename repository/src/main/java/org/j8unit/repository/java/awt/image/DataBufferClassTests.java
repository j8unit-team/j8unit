...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.DataBuffer class java.awt.image.DataBuffer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataBufferTests}.
 * </p>
 *
 * @see java.awt.image.DataBuffer class java.awt.image.DataBuffer (the hereby targeted class-under-test class)
 * @see DataBufferTests DataBufferTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DataBufferClassTests<SUT extends java.awt.image.DataBuffer>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DataBuffer.class!",
                   java.awt.image.DataBuffer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataBuffer public
 * abstract class java.awt.image.DataBuffer}.
 *
...
public abstract interface DataBufferClassTests<SUT extends DataBuffer>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBuffer.class!",
                   DataBuffer.class.isAssignableFrom(sut));
    }

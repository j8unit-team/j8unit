 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PKIXReasonTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PKIXReasonTests}.
 * </p>
 *
 * @see java.security.cert.PKIXReason class java.security.cert.PKIXReason (the hereby targeted class-under-test class)
 * @see PKIXReasonTests PKIXReasonTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends CertPathValidatorExceptionClassTests.ReasonClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PKIXReason.class!",
                   java.security.cert.PKIXReason.class.isAssignableFrom(sut));
    }

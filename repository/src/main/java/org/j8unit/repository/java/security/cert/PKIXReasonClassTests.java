 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PKIXReason public
 * final enum java.security.cert.PKIXReason}.
 *
...
public abstract interface PKIXReasonClassTests<SUT extends PKIXReason>
extends ReasonClassTests<SUT>, EnumClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.cert.PKIXReason]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKIXReason.class!",
                   PKIXReason.class.isAssignableFrom(sut));
    }

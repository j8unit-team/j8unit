...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.BasicStroke class java.awt.BasicStroke}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicStrokeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BasicStrokeTests}.
 * </p>
 *
 * @see java.awt.BasicStroke class java.awt.BasicStroke (the hereby targeted class-under-test class)
 * @see BasicStrokeTests BasicStrokeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends StrokeClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.BasicStroke.class!",
                   java.awt.BasicStroke.class.isAssignableFrom(sut));
    }

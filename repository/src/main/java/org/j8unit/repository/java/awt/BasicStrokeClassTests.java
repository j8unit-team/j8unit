 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BasicStroke public
...
public abstract interface BasicStrokeClassTests<SUT extends BasicStroke>
extends StrokeClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.BasicStroke]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicStroke.class!",
                   BasicStroke.class.isAssignableFrom(sut));
    }

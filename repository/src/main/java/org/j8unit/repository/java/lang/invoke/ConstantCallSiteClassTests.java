 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ConstantCallSite
 * public class java.lang.invoke.ConstantCallSite}.
 *
...
extends org.j8unit.repository.java.lang.invoke.CallSiteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConstantCallSite.class!",
                   ConstantCallSite.class.isAssignableFrom(sut));
    }

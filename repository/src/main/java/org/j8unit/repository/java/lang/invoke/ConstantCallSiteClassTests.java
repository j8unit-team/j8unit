 ...
 * java.lang.invoke.ConstantCallSite}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConstantCallSiteTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ConstantCallSiteTests ConstantCallSiteTests (The complementary j8unit test interface containing the instance
...
extends CallSiteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.invoke.ConstantCallSite.class!",
                   java.lang.invoke.ConstantCallSite.class.isAssignableFrom(sut));
    }

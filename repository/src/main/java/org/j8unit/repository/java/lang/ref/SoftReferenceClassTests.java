 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SoftReferenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SoftReferenceTests}.
 * </p>
 *
 * @see java.lang.ref.SoftReference class java.lang.ref.SoftReference (the hereby targeted class-under-test class)
 * @see SoftReferenceTests SoftReferenceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.ref.SoftReference.class!",
                   java.lang.ref.SoftReference.class.isAssignableFrom(sut));
    }

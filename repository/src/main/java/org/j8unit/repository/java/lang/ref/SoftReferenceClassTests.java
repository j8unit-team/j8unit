 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SoftReference
 * public class java.lang.ref.SoftReference<T>}.
 *
...
public abstract interface SoftReferenceClassTests<SUT extends SoftReference>
extends ReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SoftReference.class!",
                   SoftReference.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketImplFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketImplFactoryTests}.
 * </p>
 *
 * @see java.net.SocketImplFactory interface java.net.SocketImplFactory (the hereby targeted class-under-test class)
 * @see SocketImplFactoryTests SocketImplFactoryTests (The complementary j8unit test interface containing the instance
...
public abstract interface SocketImplFactoryClassTests<SUT extends java.net.SocketImplFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketImplFactory.class!",
                   java.net.SocketImplFactory.class.isAssignableFrom(sut));
    }

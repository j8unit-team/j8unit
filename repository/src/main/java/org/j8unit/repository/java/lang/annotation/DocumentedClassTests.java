 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Documented public
 * abstract @interface java.lang.annotation.Documented}.
 *
...
public abstract interface DocumentedClassTests<SUT extends Documented>
extends AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Documented.class!",
                   Documented.class.isAssignableFrom(sut));
    }

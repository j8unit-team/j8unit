 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DatagramSocket
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DatagramSocketTests}.
 * </p>
 *
 * <p>
...
public abstract interface DatagramSocketClassTests<SUT extends DatagramSocket>
extends CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatagramSocket.class!",
                   DatagramSocket.class.isAssignableFrom(sut));
    }

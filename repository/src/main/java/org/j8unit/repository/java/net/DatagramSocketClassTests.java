 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DatagramSocketTests}).
 * </p>
 *
 * <p>
 ...
 * @see DatagramSocketTests DatagramSocketTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.DatagramSocket.class!",
                   java.net.DatagramSocket.class.isAssignableFrom(sut));
    }

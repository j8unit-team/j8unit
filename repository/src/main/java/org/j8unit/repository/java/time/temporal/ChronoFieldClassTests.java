...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.ChronoField class java.time.temporal.ChronoField},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChronoFieldTests}).
 * </p>
 *
 * <p>
 ...
 * @see ChronoFieldTests ChronoFieldTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends TemporalFieldClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.ChronoField.class!",
                   java.time.temporal.ChronoField.class.isAssignableFrom(sut));
    }

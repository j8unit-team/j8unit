 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChronoField public
 * final enum java.time.temporal.ChronoField}.
 *
...
extends TemporalFieldClassTests<SUT>, EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChronoField.class!",
                   ChronoField.class.isAssignableFrom(sut));
    }

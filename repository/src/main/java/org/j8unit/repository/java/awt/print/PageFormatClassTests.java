...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.print.PageFormat class java.awt.print.PageFormat}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PageFormatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PageFormatTests}.
 * </p>
 *
 * @see java.awt.print.PageFormat class java.awt.print.PageFormat (the hereby targeted class-under-test class)
 * @see PageFormatTests PageFormatTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PageFormatClassTests<SUT extends java.awt.print.PageFormat>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.PageFormat.class!",
                   java.awt.print.PageFormat.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PageFormat public
...
public abstract interface PageFormatClassTests<SUT extends PageFormat>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PageFormat.class!",
                   PageFormat.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseInfoPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseInfoPeerTests}.
 * </p>
 *
 * @see java.awt.peer.MouseInfoPeer interface java.awt.peer.MouseInfoPeer (the hereby targeted class-under-test class)
 * @see MouseInfoPeerTests MouseInfoPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MouseInfoPeerClassTests<SUT extends java.awt.peer.MouseInfoPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.MouseInfoPeer.class!",
                   java.awt.peer.MouseInfoPeer.class.isAssignableFrom(sut));
    }

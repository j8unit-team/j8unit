...
public abstract interface AsynchronousFileChannelClassTests<SUT extends AsynchronousFileChannel>
extends AsynchronousChannelClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.nio.channels.AsynchronousFileChannel]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AsynchronousFileChannel.class!",
                   AsynchronousFileChannel.class.isAssignableFrom(sut));
    }

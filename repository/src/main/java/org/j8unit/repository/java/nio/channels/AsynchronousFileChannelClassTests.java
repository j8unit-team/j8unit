 ...
 * java.nio.channels.AsynchronousFileChannel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AsynchronousFileChannelTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link AsynchronousFileChannelTests}.
 * </p>
 *
 * @see java.nio.channels.AsynchronousFileChannel class java.nio.channels.AsynchronousFileChannel (the hereby targeted
 *      class-under-test class)
 * @see AsynchronousFileChannelTests AsynchronousFileChannelTests (The complementary j8unit test interface containing
...
extends AsynchronousChannelClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.AsynchronousFileChannel.class!",
                   java.nio.channels.AsynchronousFileChannel.class.isAssignableFrom(sut));
    }

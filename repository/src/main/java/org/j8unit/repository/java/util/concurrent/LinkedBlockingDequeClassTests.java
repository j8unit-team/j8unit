 ...
 * java.util.concurrent.LinkedBlockingDeque}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkedBlockingDequeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkedBlockingDequeTests}.
 * </p>
 *
 * @see java.util.concurrent.LinkedBlockingDeque class java.util.concurrent.LinkedBlockingDeque (the hereby targeted
 *      class-under-test class)
 * @see LinkedBlockingDequeTests LinkedBlockingDequeTests (The complementary j8unit test interface containing the
...
extends BlockingDequeClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.LinkedBlockingDeque.class!",
                   java.util.concurrent.LinkedBlockingDeque.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.util.AbstractQueueClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkedBlockingDeque
 * public class java.util.concurrent.LinkedBlockingDeque<E>}.
 *
...
public abstract interface LinkedBlockingDequeClassTests<SUT extends LinkedBlockingDeque>
extends BlockingDequeClassTests<SUT>, SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.concurrent.LinkedBlockingDeque]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkedBlockingDeque.class!",
                   LinkedBlockingDeque.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.concurrent.LinkedBlockingDeque]

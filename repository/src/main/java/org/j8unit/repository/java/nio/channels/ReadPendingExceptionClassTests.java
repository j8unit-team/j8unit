 ...
 * java.nio.channels.ReadPendingException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReadPendingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReadPendingExceptionTests}
 * .
 * </p>
 *
 * @see java.nio.channels.ReadPendingException class java.nio.channels.ReadPendingException (the hereby targeted
 *      class-under-test class)
 * @see ReadPendingExceptionTests ReadPendingExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ReadPendingException.class!",
                   java.nio.channels.ReadPendingException.class.isAssignableFrom(sut));
    }

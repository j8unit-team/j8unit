...
public abstract interface ReadPendingExceptionClassTests<SUT extends ReadPendingException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReadPendingException.class!",
                   ReadPendingException.class.isAssignableFrom(sut));
    }

 ...
 * @since 0.9.0
 * @see org.j8unit.repository.java.sql.DateClassTests
 */
...
extends org.j8unit.repository.java.util.DateTests<SUT>
{
    ...
    @Category(Draft.class)
    @Override
    public default void test_setMinutes_int() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Category(Draft.class)
    @Override
    public default void test_setSeconds_int() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }
    ...
    @Category(Draft.class)
    @Override
    public default void test_setHours_int() throws Exception {
        // query fresh subject-under-test
        SUT sut = this.createNewSUT();
        assert sut != null;
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.locks.Lock interface
 * java.util.concurrent.locks.Lock}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LockTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LockTests}.
 * </p>
 *
 * @see java.util.concurrent.locks.Lock interface java.util.concurrent.locks.Lock (the hereby targeted class-under-test
 *      class)
 * @see LockTests LockTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface LockClassTests<SUT extends java.util.concurrent.locks.Lock>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.locks.Lock.class!",
                   java.util.concurrent.locks.Lock.class.isAssignableFrom(sut));
    }

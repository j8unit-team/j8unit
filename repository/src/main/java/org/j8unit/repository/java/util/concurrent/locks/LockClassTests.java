 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Lock public
 * abstract interface java.util.concurrent.locks.Lock}.
 *
...
public abstract interface LockClassTests<SUT extends Lock>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Lock.class!", Lock.class.isAssignableFrom(sut));
    }

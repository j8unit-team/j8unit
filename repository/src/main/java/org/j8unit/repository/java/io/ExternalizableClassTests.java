 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Externalizable
...
public abstract interface ExternalizableClassTests<SUT extends Externalizable>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Externalizable.class!",
                   Externalizable.class.isAssignableFrom(sut));
    }

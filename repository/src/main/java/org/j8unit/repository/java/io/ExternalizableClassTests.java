 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExternalizableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExternalizableTests}.
 * </p>
 *
 * @see java.io.Externalizable interface java.io.Externalizable (the hereby targeted class-under-test class)
 * @see ExternalizableTests ExternalizableTests (The complementary j8unit test interface containing the instance
...
public abstract interface ExternalizableClassTests<SUT extends java.io.Externalizable>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.Externalizable.class!",
                   java.io.Externalizable.class.isAssignableFrom(sut));
    }

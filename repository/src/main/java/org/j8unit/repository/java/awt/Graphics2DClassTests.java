 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Graphics2D public
...
public abstract interface Graphics2DClassTests<SUT extends Graphics2D>
extends GraphicsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Graphics2D.class!",
                   Graphics2D.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Graphics2D class java.awt.Graphics2D}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Graphics2DTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link Graphics2DTests}.
 * </p>
 *
 * @see java.awt.Graphics2D class java.awt.Graphics2D (the hereby targeted class-under-test class)
 * @see Graphics2DTests Graphics2DTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface Graphics2DClassTests<SUT extends java.awt.Graphics2D>
extends GraphicsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Graphics2D.class!",
                   java.awt.Graphics2D.class.isAssignableFrom(sut));
    }

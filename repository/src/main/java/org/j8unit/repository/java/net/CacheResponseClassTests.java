 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CacheResponse
...
public abstract interface CacheResponseClassTests<SUT extends CacheResponse>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CacheResponse.class!",
                   CacheResponse.class.isAssignableFrom(sut));
    }

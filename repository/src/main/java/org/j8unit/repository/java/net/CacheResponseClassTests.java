...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.CacheResponse class java.net.CacheResponse}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CacheResponseTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CacheResponseTests}.
 * </p>
 *
 * @see java.net.CacheResponse class java.net.CacheResponse (the hereby targeted class-under-test class)
 * @see CacheResponseTests CacheResponseTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CacheResponseClassTests<SUT extends java.net.CacheResponse>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.CacheResponse.class!",
                   java.net.CacheResponse.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParseException
...
public abstract interface ParseExceptionClassTests<SUT extends ParseException>
extends ExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.text.ParseException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParseException.class!",
                   ParseException.class.isAssignableFrom(sut));
    }

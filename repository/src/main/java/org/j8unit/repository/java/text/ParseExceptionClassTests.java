 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParseExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParseExceptionTests}.
 * </p>
 *
 * @see java.text.ParseException class java.text.ParseException (the hereby targeted class-under-test class)
 * @see ParseExceptionTests ParseExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ParseExceptionClassTests<SUT extends java.text.ParseException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.ParseException.class!",
                   java.text.ParseException.class.isAssignableFrom(sut));
    }

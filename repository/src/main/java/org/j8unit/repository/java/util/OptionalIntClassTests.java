 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OptionalInt public
 * final class java.util.OptionalInt}.
 *
...
public abstract interface OptionalIntClassTests<SUT extends OptionalInt>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OptionalInt.class!",
                   OptionalInt.class.isAssignableFrom(sut));
    }

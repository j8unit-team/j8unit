 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OptionalIntTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OptionalIntTests}.
 * </p>
 *
 * @see java.util.OptionalInt class java.util.OptionalInt (the hereby targeted class-under-test class)
 * @see OptionalIntTests OptionalIntTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.OptionalInt.class!",
                   java.util.OptionalInt.class.isAssignableFrom(sut));
    }

 ...
 * java.util.concurrent.CompletionStage}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompletionStageTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompletionStageTests}.
 * </p>
 *
 * @see java.util.concurrent.CompletionStage interface java.util.concurrent.CompletionStage (the hereby targeted
 *      class-under-test class)
 * @see CompletionStageTests CompletionStageTests (The complementary j8unit test interface containing the instance
...
public abstract interface CompletionStageClassTests<SUT extends java.util.concurrent.CompletionStage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CompletionStage.class!",
                   java.util.concurrent.CompletionStage.class.isAssignableFrom(sut));
    }

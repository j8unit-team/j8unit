 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompletionStage
...
public abstract interface CompletionStageClassTests<SUT extends CompletionStage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompletionStage.class!",
                   CompletionStage.class.isAssignableFrom(sut));
    }

 ...
 * {@link TimeZoneNameProvider public abstract class java.util.spi.TimeZoneNameProvider}.
 *
 ...
 * {@link TimeZoneNameProviderTests}.
 * </p>
 *
 * <p>
...
public abstract interface TimeZoneNameProviderClassTests<SUT extends TimeZoneNameProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimeZoneNameProvider.class!",
                   TimeZoneNameProvider.class.isAssignableFrom(sut));
    }

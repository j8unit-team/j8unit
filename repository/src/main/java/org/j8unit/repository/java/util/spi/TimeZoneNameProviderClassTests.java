 ...
 * java.util.spi.TimeZoneNameProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimeZoneNameProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TimeZoneNameProviderTests}
 * .
 * </p>
 *
 * @see java.util.spi.TimeZoneNameProvider class java.util.spi.TimeZoneNameProvider (the hereby targeted
 *      class-under-test class)
 * @see TimeZoneNameProviderTests TimeZoneNameProviderTests (The complementary j8unit test interface containing the
...
public abstract interface TimeZoneNameProviderClassTests<SUT extends java.util.spi.TimeZoneNameProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.spi.TimeZoneNameProvider.class!",
                   java.util.spi.TimeZoneNameProvider.class.isAssignableFrom(sut));
    }

 ...
 * java.lang.annotation.Annotation}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AnnotationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AnnotationTests}.
 * </p>
 *
 * @see java.lang.annotation.Annotation interface java.lang.annotation.Annotation (the hereby targeted class-under-test
 *      class)
 * @see AnnotationTests AnnotationTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.annotation.Annotation.class!",
                   java.lang.annotation.Annotation.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceLoader
 * public final class java.util.ServiceLoader<S>}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServiceLoaderTests}.
 * </p>
 *
 * <p>
...
public abstract interface ServiceLoaderClassTests<SUT extends ServiceLoader>
extends IterableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceLoader.class!",
                   ServiceLoader.class.isAssignableFrom(sut));
    }

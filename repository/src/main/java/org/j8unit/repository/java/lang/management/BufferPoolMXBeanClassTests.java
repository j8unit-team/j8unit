 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferPoolMXBean
 * public abstract interface java.lang.management.BufferPoolMXBean}.
 *
...
public abstract interface BufferPoolMXBeanClassTests<SUT extends BufferPoolMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferPoolMXBean.class!",
                   BufferPoolMXBean.class.isAssignableFrom(sut));
    }

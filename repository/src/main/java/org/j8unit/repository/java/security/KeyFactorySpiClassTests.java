 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyFactorySpi
...
public abstract interface KeyFactorySpiClassTests<SUT extends KeyFactorySpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyFactorySpi.class!",
                   KeyFactorySpi.class.isAssignableFrom(sut));
    }

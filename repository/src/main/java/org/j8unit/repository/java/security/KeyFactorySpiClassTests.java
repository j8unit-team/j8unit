...
/**
 * <p>
 * Test class for {@link java.security.KeyFactorySpi class java.security.KeyFactorySpi},
 * containing all class relevant test methods (at least the test methods of accessible constructors and
 * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
 * methods is {@link org.j8unit.repository.java.security.KeyFactorySpiTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT>
{
    ...
    public default void create_KeyFactorySpi() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.security.KeyFactorySpi sut = null; // = new KeyFactorySpi();
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.security.KeyFactorySpi> sut = createNewSUT();

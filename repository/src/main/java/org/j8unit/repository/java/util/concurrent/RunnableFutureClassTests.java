 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RunnableFuture
 * public abstract interface java.util.concurrent.RunnableFuture<V>}.
 *
...
public abstract interface RunnableFutureClassTests<SUT extends RunnableFuture>
extends RunnableClassTests<SUT>, FutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RunnableFuture.class!",
                   RunnableFuture.class.isAssignableFrom(sut));
    }

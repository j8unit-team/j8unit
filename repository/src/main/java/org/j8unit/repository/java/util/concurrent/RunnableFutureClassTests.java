 ...
 * java.util.concurrent.RunnableFuture}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RunnableFutureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RunnableFutureTests}.
 * </p>
 *
 * @see java.util.concurrent.RunnableFuture interface java.util.concurrent.RunnableFuture (the hereby targeted
 *      class-under-test class)
 * @see RunnableFutureTests RunnableFutureTests (The complementary j8unit test interface containing the instance
...
public abstract interface RunnableFutureClassTests<SUT extends java.util.concurrent.RunnableFuture>
extends org.j8unit.repository.java.lang.RunnableClassTests<SUT>, FutureClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.RunnableFuture.class!",
                   java.util.concurrent.RunnableFuture.class.isAssignableFrom(sut));
    }

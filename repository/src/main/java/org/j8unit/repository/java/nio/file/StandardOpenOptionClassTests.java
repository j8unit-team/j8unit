 ...
 * java.nio.file.StandardOpenOption}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardOpenOptionTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see StandardOpenOptionTests StandardOpenOptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface StandardOpenOptionClassTests<SUT extends java.nio.file.StandardOpenOption>
extends OpenOptionClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.StandardOpenOption.class!",
                   java.nio.file.StandardOpenOption.class.isAssignableFrom(sut));
    }

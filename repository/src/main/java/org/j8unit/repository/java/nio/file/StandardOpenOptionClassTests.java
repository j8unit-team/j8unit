 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StandardOpenOption
 * public final enum java.nio.file.StandardOpenOption}.
 *
...
extends org.j8unit.repository.java.nio.file.OpenOptionClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StandardOpenOption.class!",
                   StandardOpenOption.class.isAssignableFrom(sut));
    }

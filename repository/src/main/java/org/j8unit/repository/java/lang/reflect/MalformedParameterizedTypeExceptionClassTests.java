 ...
 * {@link MalformedParameterizedTypeException public class java.lang.reflect.MalformedParameterizedTypeException}.
 *
...
public abstract interface MalformedParameterizedTypeExceptionClassTests<SUT extends MalformedParameterizedTypeException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MalformedParameterizedTypeException.class!",
                   MalformedParameterizedTypeException.class.isAssignableFrom(sut));
    }

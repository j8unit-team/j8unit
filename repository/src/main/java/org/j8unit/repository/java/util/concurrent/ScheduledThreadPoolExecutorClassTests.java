 ...
 * java.util.concurrent.ScheduledThreadPoolExecutor}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link ScheduledThreadPoolExecutorTests}).
 * </p>
 *
 * <p>
 ...
 * @see ScheduledThreadPoolExecutorTests ScheduledThreadPoolExecutorTests (The complementary j8unit test interface
...
extends ScheduledExecutorServiceClassTests<SUT>, ThreadPoolExecutorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ScheduledThreadPoolExecutor.class!",
                   java.util.concurrent.ScheduledThreadPoolExecutor.class.isAssignableFrom(sut));
    }

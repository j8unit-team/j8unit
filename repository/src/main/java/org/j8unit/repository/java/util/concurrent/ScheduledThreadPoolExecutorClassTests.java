...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain java.util.concurrent.ScheduledThreadPoolExecutor class
 * java.util.concurrent.ScheduledThreadPoolExecutor}, containing all class relevant test methods (at least the test
 * methods of accessible constructors and of accessible {@code static} methods). The counterpart J8Unit test interface
 * containing the instance relevant test methods is
 * {@link org.j8unit.repository.java.util.concurrent.ScheduledThreadPoolExecutorTests}.
 * </p>
 *
 * <p>
 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.concurrent.ScheduledThreadPoolExecutor
 */
@FunctionalInterface
...
org.j8unit.repository.java.util.concurrent.ThreadPoolExecutorClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ScheduledThreadPoolExecutor#ScheduledThreadPoolExecutor(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ScheduledThreadPoolExecutor_int()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public default void create_ScheduledThreadPoolExecutor_int_ThreadFactory()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.concurrent.ScheduledThreadPoolExecutor sut = null; // = new ScheduledThreadPoolExecutor(int,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.concurrent.ScheduledThreadPoolExecutor#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

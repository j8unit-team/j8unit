 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrinterGraphics
 * public abstract interface java.awt.print.PrinterGraphics}.
 *
...
public abstract interface PrinterGraphicsClassTests<SUT extends PrinterGraphics>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrinterGraphics.class!",
                   PrinterGraphics.class.isAssignableFrom(sut));
    }

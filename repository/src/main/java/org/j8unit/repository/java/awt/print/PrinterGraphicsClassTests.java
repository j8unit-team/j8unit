 ...
 * java.awt.print.PrinterGraphics}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrinterGraphicsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrinterGraphicsTests}.
 * </p>
 *
 * @see java.awt.print.PrinterGraphics interface java.awt.print.PrinterGraphics (the hereby targeted class-under-test
 *      class)
 * @see PrinterGraphicsTests PrinterGraphicsTests (The complementary j8unit test interface containing the instance
...
public abstract interface PrinterGraphicsClassTests<SUT extends java.awt.print.PrinterGraphics>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.PrinterGraphics.class!",
                   java.awt.print.PrinterGraphics.class.isAssignableFrom(sut));
    }

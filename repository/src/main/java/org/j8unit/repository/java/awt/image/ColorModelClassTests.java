 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ColorModel public
...
public abstract interface ColorModelClassTests<SUT extends ColorModel>
extends TransparencyClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ColorModel.class!",
                   ColorModel.class.isAssignableFrom(sut));
    }

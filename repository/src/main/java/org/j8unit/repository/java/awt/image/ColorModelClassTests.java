...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.ColorModel class java.awt.image.ColorModel}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ColorModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ColorModelTests}.
 * </p>
 *
 * @see java.awt.image.ColorModel class java.awt.image.ColorModel (the hereby targeted class-under-test class)
 * @see ColorModelTests ColorModelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.TransparencyClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ColorModel.class!",
                   java.awt.image.ColorModel.class.isAssignableFrom(sut));
    }

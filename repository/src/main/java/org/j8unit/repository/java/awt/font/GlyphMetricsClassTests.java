 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GlyphMetrics public
 * final class java.awt.font.GlyphMetrics}.
 *
...
public abstract interface GlyphMetricsClassTests<SUT extends GlyphMetrics>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GlyphMetrics.class!",
                   GlyphMetrics.class.isAssignableFrom(sut));
    }

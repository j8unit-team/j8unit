 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WeakReferenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WeakReferenceTests}.
 * </p>
 *
 * @see java.lang.ref.WeakReference class java.lang.ref.WeakReference (the hereby targeted class-under-test class)
 * @see WeakReferenceTests WeakReferenceTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends ReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.ref.WeakReference.class!",
                   java.lang.ref.WeakReference.class.isAssignableFrom(sut));
    }

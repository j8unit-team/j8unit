 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WeakReference
...
public abstract interface WeakReferenceClassTests<SUT extends WeakReference>
extends ReferenceClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WeakReference.class!",
                   WeakReference.class.isAssignableFrom(sut));
    }

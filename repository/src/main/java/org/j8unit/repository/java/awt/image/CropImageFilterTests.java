 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link CropImageFilter
...
extends org.j8unit.repository.java.awt.image.ImageFilterTests<SUT> {
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link CropImageFilter#setDimensions(int, int) public void
     ...
     * {@link CropImageFilter#setPixels(int, int, int, int, ColorModel, int[], int, int) public void
     ...
     * <p>
     * Test method for the hereby targeted method-under-test
     * {@link CropImageFilter#setPixels(int, int, int, int, ColorModel, byte[], int, int) public void
    ...
    /**
     * <p>
     * Test method for the hereby targeted method-under-test {@link CropImageFilter#setProperties(Hashtable) public void

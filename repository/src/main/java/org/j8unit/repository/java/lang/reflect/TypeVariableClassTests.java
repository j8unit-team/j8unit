 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeVariable public
 * abstract interface java.lang.reflect.TypeVariable<D>}.
 *
...
public abstract interface TypeVariableClassTests<SUT extends TypeVariable>
extends org.j8unit.repository.java.lang.reflect.TypeClassTests<SUT>, org.j8unit.repository.java.lang.reflect.AnnotatedElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeVariable.class!",
                   TypeVariable.class.isAssignableFrom(sut));
    }

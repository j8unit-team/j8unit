...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.TypeVariable interface
 * java.lang.reflect.TypeVariable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
...
public abstract interface TypeVariableClassTests<SUT extends java.lang.reflect.TypeVariable>
extends TypeClassTests<SUT>, AnnotatedElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.TypeVariable.class!",
                   java.lang.reflect.TypeVariable.class.isAssignableFrom(sut));
    }

 ...
 * {@link org.j8unit.repository.java.awt.dnd.InvalidDnDOperationExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface InvalidDnDOperationExceptionClassTests<SUT extends InvalidDnDOperationException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidDnDOperationException.class!",
                   InvalidDnDOperationException.class.isAssignableFrom(sut));
    }

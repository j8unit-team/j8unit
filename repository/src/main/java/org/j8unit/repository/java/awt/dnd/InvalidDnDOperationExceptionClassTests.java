 ...
 * java.awt.dnd.InvalidDnDOperationException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link InvalidDnDOperationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidDnDOperationExceptionTests InvalidDnDOperationExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.InvalidDnDOperationException.class!",
                   java.awt.dnd.InvalidDnDOperationException.class.isAssignableFrom(sut));
    }

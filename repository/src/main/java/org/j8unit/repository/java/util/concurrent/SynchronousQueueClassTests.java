 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SynchronousQueue
...
public abstract interface SynchronousQueueClassTests<SUT extends SynchronousQueue>
extends BlockingQueueClassTests<SUT>, SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SynchronousQueue.class!",

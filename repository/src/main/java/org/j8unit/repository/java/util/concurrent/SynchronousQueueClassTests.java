 ...
 * java.util.concurrent.SynchronousQueue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SynchronousQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SynchronousQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.SynchronousQueue class java.util.concurrent.SynchronousQueue (the hereby targeted
 *      class-under-test class)
 * @see SynchronousQueueTests SynchronousQueueTests (The complementary j8unit test interface containing the instance
...
extends BlockingQueueClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.SynchronousQueue.class!",
                   java.util.concurrent.SynchronousQueue.class.isAssignableFrom(sut));
    }

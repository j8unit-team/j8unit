...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.management.MemoryMXBean interface
 * java.lang.management.MemoryMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MemoryMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MemoryMXBeanTests}.
 * </p>
 *
 * @see java.lang.management.MemoryMXBean interface java.lang.management.MemoryMXBean (the hereby targeted
 *      class-under-test class)
 * @see MemoryMXBeanTests MemoryMXBeanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MemoryMXBeanClassTests<SUT extends java.lang.management.MemoryMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.MemoryMXBean.class!",
                   java.lang.management.MemoryMXBean.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MemoryMXBean public
 * abstract interface java.lang.management.MemoryMXBean}.
 *
...
public abstract interface MemoryMXBeanClassTests<SUT extends MemoryMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryMXBean.class!",

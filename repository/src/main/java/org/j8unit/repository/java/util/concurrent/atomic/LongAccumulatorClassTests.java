 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongAccumulator
...
public abstract interface LongAccumulatorClassTests<SUT extends LongAccumulator>
extends NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongAccumulator.class!",
                   LongAccumulator.class.isAssignableFrom(sut));
    }

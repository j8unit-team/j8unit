 ...
 * java.util.concurrent.atomic.LongAccumulator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongAccumulatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongAccumulatorTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.LongAccumulator class java.util.concurrent.atomic.LongAccumulator (the hereby
 *      targeted class-under-test class)
 * @see LongAccumulatorTests LongAccumulatorTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.LongAccumulator.class!",
                   java.util.concurrent.atomic.LongAccumulator.class.isAssignableFrom(sut));
    }

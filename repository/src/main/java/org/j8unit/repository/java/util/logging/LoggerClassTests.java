 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Logger public class
...
public abstract interface LoggerClassTests<SUT extends Logger>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Logger.class!",
                   Logger.class.isAssignableFrom(sut));
    }

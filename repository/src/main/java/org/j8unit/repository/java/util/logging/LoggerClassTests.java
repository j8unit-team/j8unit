 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LoggerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LoggerTests}.
 * </p>
 *
 * @see java.util.logging.Logger class java.util.logging.Logger (the hereby targeted class-under-test class)
 * @see LoggerTests LoggerTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.Logger.class!",
                   java.util.logging.Logger.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.time.ZoneOffset class java.time.ZoneOffset}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.time.ZoneOffsetTests}.
 * </p>
 *
 * <p>
...
org.j8unit.repository.java.time.ZoneIdClassTests<SUT> {
    ...
    /**
     * <p>
     * Test method for {@link java.time.ZoneOffset#of(java.lang.String) public static java.time.ZoneOffset
    ...
    @Test
    @Category(Draft.class)
    public default void test_ofHoursMinutes_int_int()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;

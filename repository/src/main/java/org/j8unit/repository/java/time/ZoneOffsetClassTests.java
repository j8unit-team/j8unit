...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.ZoneOffset class java.time.ZoneOffset}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ZoneOffsetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ZoneOffsetTests}.
 * </p>
 *
 * @see java.time.ZoneOffset class java.time.ZoneOffset (the hereby targeted class-under-test class)
 * @see ZoneOffsetTests ZoneOffsetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ZoneOffsetClassTests<SUT extends java.time.ZoneOffset>
...
org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, ZoneIdClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.ZoneOffset.class!",
                   java.time.ZoneOffset.class.isAssignableFrom(sut));
    }

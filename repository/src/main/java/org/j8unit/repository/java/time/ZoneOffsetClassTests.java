...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain java.time.ZoneOffset class java.time.ZoneOffset}, containing all class
...
org.j8unit.repository.java.time.ZoneIdClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.time.ZoneOffset#from(java.time.temporal.TemporalAccessor)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.time.ZoneOffset#of(java.lang.String)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.ZoneOffset#ofHours(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.ZoneOffset#ofHoursMinutes(int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    /**
     * <p>
     * Test method for {@link java.time.ZoneOffset#ofHoursMinutesSeconds(int, int, int) public static
     ...
     * </p>
     *
     * @j8unit.aim java.time.ZoneOffset#ofHoursMinutesSeconds(int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.ZoneOffset#ofTotalSeconds(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.time.ZoneOffset#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

 ...
 * java.awt.image.renderable.RenderContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RenderContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RenderContextTests}.
 * </p>
 *
 * @see java.awt.image.renderable.RenderContext class java.awt.image.renderable.RenderContext (the hereby targeted
 *      class-under-test class)
 * @see RenderContextTests RenderContextTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RenderContextClassTests<SUT extends java.awt.image.renderable.RenderContext>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.renderable.RenderContext.class!",
                   java.awt.image.renderable.RenderContext.class.isAssignableFrom(sut));
    }

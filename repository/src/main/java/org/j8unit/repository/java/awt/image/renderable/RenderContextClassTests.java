 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RenderContext
...
public abstract interface RenderContextClassTests<SUT extends RenderContext>
extends CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RenderContext.class!",
                   RenderContext.class.isAssignableFrom(sut));
    }

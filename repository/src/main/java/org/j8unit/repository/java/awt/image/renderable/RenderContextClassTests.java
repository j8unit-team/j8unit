...
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_RenderContext_AffineTransform_RenderingHints()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public default void create_RenderContext_AffineTransform_Shape_RenderingHints()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.renderable.RenderContext sut = null; // = new
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.awt.image.renderable.RenderContext> sut = createNewSUT();

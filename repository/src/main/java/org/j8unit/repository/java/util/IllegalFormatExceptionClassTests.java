...
public abstract interface IllegalFormatExceptionClassTests<SUT extends IllegalFormatException>
extends IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalFormatException.class!",
                   IllegalFormatException.class.isAssignableFrom(sut));
    }

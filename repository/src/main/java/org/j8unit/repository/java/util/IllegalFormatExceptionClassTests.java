...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.IllegalFormatException class
 * java.util.IllegalFormatException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IllegalFormatExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link IllegalFormatExceptionTests}.
 * </p>
 *
 * @see java.util.IllegalFormatException class java.util.IllegalFormatException (the hereby targeted class-under-test
 *      class)
 * @see IllegalFormatExceptionTests IllegalFormatExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface IllegalFormatExceptionClassTests<SUT extends java.util.IllegalFormatException>
extends org.j8unit.repository.java.lang.IllegalArgumentExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.IllegalFormatException.class!",
                   java.util.IllegalFormatException.class.isAssignableFrom(sut));
    }

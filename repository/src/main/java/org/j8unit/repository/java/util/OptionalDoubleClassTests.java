 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OptionalDouble
...
public abstract interface OptionalDoubleClassTests<SUT extends OptionalDouble>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.OptionalDouble]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OptionalDouble.class!",
                   OptionalDouble.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.OptionalDouble]

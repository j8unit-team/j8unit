...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.OptionalDouble class java.util.OptionalDouble}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OptionalDoubleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OptionalDoubleTests}.
 * </p>
 *
 * @see java.util.OptionalDouble class java.util.OptionalDouble (the hereby targeted class-under-test class)
 * @see OptionalDoubleTests OptionalDoubleTests (The complementary j8unit test interface containing the instance
...
public abstract interface OptionalDoubleClassTests<SUT extends java.util.OptionalDouble>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.OptionalDouble.class!",
                   java.util.OptionalDouble.class.isAssignableFrom(sut));
    }

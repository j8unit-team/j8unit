...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.ServerError class java.rmi.ServerError}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerErrorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServerErrorTests}.
 * </p>
 *
 * @see java.rmi.ServerError class java.rmi.ServerError (the hereby targeted class-under-test class)
 * @see ServerErrorTests ServerErrorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.ServerError.class!",
                   java.rmi.ServerError.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServerError public
...
public abstract interface ServerErrorClassTests<SUT extends ServerError>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerError.class!",
                   ServerError.class.isAssignableFrom(sut));
    }

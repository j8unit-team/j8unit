 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Dictionary public
 * abstract class java.util.Dictionary<K,V>}.
 *
...
public abstract interface DictionaryClassTests<SUT extends Dictionary>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Dictionary.class!",
                   Dictionary.class.isAssignableFrom(sut));
    }

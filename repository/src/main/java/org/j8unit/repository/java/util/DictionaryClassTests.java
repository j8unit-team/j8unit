...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Dictionary class java.util.Dictionary}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DictionaryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DictionaryTests}.
 * </p>
 *
 * @see java.util.Dictionary class java.util.Dictionary (the hereby targeted class-under-test class)
 * @see DictionaryTests DictionaryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Dictionary.class!",
                   java.util.Dictionary.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.net.CookieStore interface java.net.CookieStore}, containing all instance relevant test
...
extends J8UnitTest<SUT> {
    ...
    public default void test_add_URI_HttpCookie()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getCookies()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getURIs()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

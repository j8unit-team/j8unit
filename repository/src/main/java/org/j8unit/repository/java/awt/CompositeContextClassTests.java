 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompositeContext
 * public abstract interface java.awt.CompositeContext}.
 *
...
public abstract interface CompositeContextClassTests<SUT extends CompositeContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompositeContext.class!",

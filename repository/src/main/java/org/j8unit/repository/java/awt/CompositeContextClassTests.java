 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompositeContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompositeContextTests}.
 * </p>
 *
 * @see java.awt.CompositeContext interface java.awt.CompositeContext (the hereby targeted class-under-test class)
 * @see CompositeContextTests CompositeContextTests (The complementary j8unit test interface containing the instance
...
public abstract interface CompositeContextClassTests<SUT extends java.awt.CompositeContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.CompositeContext.class!",
                   java.awt.CompositeContext.class.isAssignableFrom(sut));
    }

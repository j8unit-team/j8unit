 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FocusEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FocusEventTests}.
 * </p>
 *
 * @see java.awt.event.FocusEvent class java.awt.event.FocusEvent (the hereby targeted class-under-test class)
 * @see FocusEventTests FocusEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.FocusEvent.class!",
                   java.awt.event.FocusEvent.class.isAssignableFrom(sut));
    }

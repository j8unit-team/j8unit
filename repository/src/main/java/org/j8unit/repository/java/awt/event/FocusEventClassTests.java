 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FocusEvent public
...
public abstract interface FocusEventClassTests<SUT extends FocusEvent>
extends ComponentEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FocusEvent.class!",
                   FocusEvent.class.isAssignableFrom(sut));
    }

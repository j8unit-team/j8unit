 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextListener public
 * abstract interface java.awt.event.TextListener}.
 *
...
public abstract interface TextListenerClassTests<SUT extends TextListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextListener.class!",
                   TextListener.class.isAssignableFrom(sut));
    }

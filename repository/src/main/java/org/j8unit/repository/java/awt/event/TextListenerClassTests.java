 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextListenerTests}.
 * </p>
 *
 * @see java.awt.event.TextListener interface java.awt.event.TextListener (the hereby targeted class-under-test class)
 * @see TextListenerTests TextListenerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TextListenerClassTests<SUT extends java.awt.event.TextListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.TextListener.class!",
                   java.awt.event.TextListener.class.isAssignableFrom(sut));
    }

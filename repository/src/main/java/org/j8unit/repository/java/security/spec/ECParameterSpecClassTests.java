 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECParameterSpec
...
public abstract interface ECParameterSpecClassTests<SUT extends ECParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.spec.ECParameterSpec]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECParameterSpec.class!",
                   ECParameterSpec.class.isAssignableFrom(sut));
    }

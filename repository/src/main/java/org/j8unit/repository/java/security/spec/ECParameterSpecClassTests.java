 ...
 * java.security.spec.ECParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECParameterSpecTests}.
 * </p>
 *
 * @see java.security.spec.ECParameterSpec class java.security.spec.ECParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see ECParameterSpecTests ECParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECParameterSpec.class!",
                   java.security.spec.ECParameterSpec.class.isAssignableFrom(sut));
    }

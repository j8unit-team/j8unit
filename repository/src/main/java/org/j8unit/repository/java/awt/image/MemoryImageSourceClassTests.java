 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MemoryImageSource
...
public abstract interface MemoryImageSourceClassTests<SUT extends MemoryImageSource>
extends org.j8unit.repository.java.awt.image.ImageProducerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MemoryImageSource.class!",
                   MemoryImageSource.class.isAssignableFrom(sut));
    }

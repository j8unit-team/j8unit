...
/**
 * <p>
 * Test class for {@link java.io.SequenceInputStream class java.io.SequenceInputStream}, containing all class relevant
...
extends org.j8unit.repository.java.io.InputStreamClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.io.SequenceInputStream sut = null; // = new
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.io.SequenceInputStream> sut = createNewSUT();

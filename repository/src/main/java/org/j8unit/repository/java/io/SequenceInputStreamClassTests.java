 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SequenceInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SequenceInputStreamTests}.
 * </p>
 *
 * @see java.io.SequenceInputStream class java.io.SequenceInputStream (the hereby targeted class-under-test class)
 * @see SequenceInputStreamTests SequenceInputStreamTests (The complementary j8unit test interface containing the
...
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.SequenceInputStream.class!",
                   java.io.SequenceInputStream.class.isAssignableFrom(sut));
    }

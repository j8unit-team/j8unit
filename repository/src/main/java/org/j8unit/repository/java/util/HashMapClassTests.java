 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HashMap public
...
public abstract interface HashMapClassTests<SUT extends HashMap>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, AbstractMapClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.HashMap]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HashMap.class!",
                   HashMap.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.HashMap]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.util.HashMap]

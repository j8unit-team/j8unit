...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.HashMap class java.util.HashMap}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HashMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HashMapTests}.
 * </p>
 *
 * @see java.util.HashMap class java.util.HashMap (the hereby targeted class-under-test class)
 * @see HashMapTests HashMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.HashMap.class!",
                   java.util.HashMap.class.isAssignableFrom(sut));
    }

 ...
 * methods is {@link org.j8unit.repository.java.util.HashMapTests}.
 * </p>
 *
 * <p>
        ...
        org.j8unit.repository.java.util.AbstractMapClassTests<SUT,K,V>
{
    ...
    public default void create_HashMap_int() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.HashMap<K,V> sut = null; // = new HashMap(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_HashMap() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.HashMap<K,V> sut = null; // = new HashMap();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_HashMap_Map() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.HashMap<K,V> sut = null; // = new HashMap(java.util.Map);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_HashMap_int_float() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.HashMap<K,V> sut = null; // = new HashMap(int,float);
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.util.HashMap<K,V>> sut = createNewSUT();

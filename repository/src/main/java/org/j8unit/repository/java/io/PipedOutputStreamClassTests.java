 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PipedOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PipedOutputStreamTests}.
 * </p>
 *
 * @see java.io.PipedOutputStream class java.io.PipedOutputStream (the hereby targeted class-under-test class)
 * @see PipedOutputStreamTests PipedOutputStreamTests (The complementary j8unit test interface containing the instance
...
extends OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PipedOutputStream.class!",
                   java.io.PipedOutputStream.class.isAssignableFrom(sut));
    }

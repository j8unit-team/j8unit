...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.ExecutorService interface
 * java.util.concurrent.ExecutorService}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExecutorServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExecutorServiceTests}.
 * </p>
 *
 * @see java.util.concurrent.ExecutorService interface java.util.concurrent.ExecutorService (the hereby targeted
 *      class-under-test class)
 * @see ExecutorServiceTests ExecutorServiceTests (The complementary j8unit test interface containing the instance
...
public abstract interface ExecutorServiceClassTests<SUT extends java.util.concurrent.ExecutorService>
extends ExecutorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ExecutorService.class!",
                   java.util.concurrent.ExecutorService.class.isAssignableFrom(sut));
    }

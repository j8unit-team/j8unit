 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExecutorService
 ...
 * {@link org.j8unit.repository.java.util.concurrent.ExecutorServiceTests}.
 * </p>
 *
 * <p>
...
public abstract interface ExecutorServiceClassTests<SUT extends ExecutorService>
extends org.j8unit.repository.java.util.concurrent.ExecutorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExecutorService.class!",
                   ExecutorService.class.isAssignableFrom(sut));
    }

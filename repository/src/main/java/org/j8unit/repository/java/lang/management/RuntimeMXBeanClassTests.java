 ...
 * java.lang.management.RuntimeMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RuntimeMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RuntimeMXBeanTests}.
 * </p>
 *
 * @see java.lang.management.RuntimeMXBean interface java.lang.management.RuntimeMXBean (the hereby targeted
 *      class-under-test class)
 * @see RuntimeMXBeanTests RuntimeMXBeanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RuntimeMXBeanClassTests<SUT extends java.lang.management.RuntimeMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.RuntimeMXBean.class!",
                   java.lang.management.RuntimeMXBean.class.isAssignableFrom(sut));
    }

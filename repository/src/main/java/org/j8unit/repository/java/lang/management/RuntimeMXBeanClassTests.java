 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RuntimeMXBean
...
public abstract interface RuntimeMXBeanClassTests<SUT extends RuntimeMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RuntimeMXBean.class!",
                   RuntimeMXBean.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChoiceFormat public
...
public abstract interface ChoiceFormatClassTests<SUT extends ChoiceFormat>
extends NumberFormatClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.text.ChoiceFormat]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChoiceFormat.class!",
                   ChoiceFormat.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChoiceFormatTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChoiceFormatTests}.
 * </p>
 *
 * @see java.text.ChoiceFormat class java.text.ChoiceFormat (the hereby targeted class-under-test class)
 * @see ChoiceFormatTests ChoiceFormatTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends NumberFormatClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.ChoiceFormat.class!",
                   java.text.ChoiceFormat.class.isAssignableFrom(sut));
    }

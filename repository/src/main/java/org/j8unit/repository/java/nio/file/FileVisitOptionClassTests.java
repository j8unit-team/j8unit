 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileVisitOption
 * public final enum java.nio.file.FileVisitOption}.
 *
...
public abstract interface FileVisitOptionClassTests<SUT extends FileVisitOption>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileVisitOption.class!",
                   FileVisitOption.class.isAssignableFrom(sut));
    }

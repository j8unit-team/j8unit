 ...
 * {@link GlyphJustificationInfo public final class java.awt.font.GlyphJustificationInfo}.
 *
...
public abstract interface GlyphJustificationInfoClassTests<SUT extends GlyphJustificationInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GlyphJustificationInfo.class!",
                   GlyphJustificationInfo.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.CompletionService interface
 * java.util.concurrent.CompletionService}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompletionServiceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompletionServiceTests}.
 * </p>
 *
 * @see java.util.concurrent.CompletionService interface java.util.concurrent.CompletionService (the hereby targeted
 *      class-under-test class)
 * @see CompletionServiceTests CompletionServiceTests (The complementary j8unit test interface containing the instance
...
public abstract interface CompletionServiceClassTests<SUT extends java.util.concurrent.CompletionService>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.CompletionService.class!",
                   java.util.concurrent.CompletionService.class.isAssignableFrom(sut));
    }

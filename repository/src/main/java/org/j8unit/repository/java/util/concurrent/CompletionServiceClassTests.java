 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompletionService
 * public abstract interface java.util.concurrent.CompletionService<V>}.
 *
...
public abstract interface CompletionServiceClassTests<SUT extends CompletionService>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompletionService.class!",
                   CompletionService.class.isAssignableFrom(sut));
    }

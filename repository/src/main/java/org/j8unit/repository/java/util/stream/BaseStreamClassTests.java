 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BaseStream public
 * abstract interface java.util.stream.BaseStream<T,S>}.
 *
...
public abstract interface BaseStreamClassTests<SUT extends BaseStream>
extends AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BaseStream.class!",

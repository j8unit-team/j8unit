...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.stream.BaseStream interface java.util.stream.BaseStream},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BaseStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BaseStreamTests}.
 * </p>
 *
 * @see java.util.stream.BaseStream interface java.util.stream.BaseStream (the hereby targeted class-under-test class)
 * @see BaseStreamTests BaseStreamTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BaseStreamClassTests<SUT extends java.util.stream.BaseStream>
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.BaseStream.class!",
                   java.util.stream.BaseStream.class.isAssignableFrom(sut));
    }

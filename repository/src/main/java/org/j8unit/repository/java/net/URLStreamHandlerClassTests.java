 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URLStreamHandler
...
public abstract interface URLStreamHandlerClassTests<SUT extends URLStreamHandler>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLStreamHandler.class!",
                   URLStreamHandler.class.isAssignableFrom(sut));
    }

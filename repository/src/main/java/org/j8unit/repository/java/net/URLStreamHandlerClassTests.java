 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLStreamHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URLStreamHandlerTests}.
 * </p>
 *
 * @see java.net.URLStreamHandler class java.net.URLStreamHandler (the hereby targeted class-under-test class)
 * @see URLStreamHandlerTests URLStreamHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface URLStreamHandlerClassTests<SUT extends java.net.URLStreamHandler>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URLStreamHandler.class!",
                   java.net.URLStreamHandler.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.spec.DSAGenParameterSpec class
 * java.security.spec.DSAGenParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAGenParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAGenParameterSpecTests}.
 * </p>
 *
 * @see java.security.spec.DSAGenParameterSpec class java.security.spec.DSAGenParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see DSAGenParameterSpecTests DSAGenParameterSpecTests (The complementary j8unit test interface containing the
...
public abstract interface DSAGenParameterSpecClassTests<SUT extends java.security.spec.DSAGenParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.DSAGenParameterSpec.class!",
                   java.security.spec.DSAGenParameterSpec.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAGenParameterSpec
 * public final class java.security.spec.DSAGenParameterSpec}.
 *
...
public abstract interface DSAGenParameterSpecClassTests<SUT extends DSAGenParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAGenParameterSpec.class!",
                   DSAGenParameterSpec.class.isAssignableFrom(sut));
    }

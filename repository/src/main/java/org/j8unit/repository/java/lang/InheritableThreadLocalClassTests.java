...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain InheritableThreadLocal class java.lang.InheritableThreadLocal},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InheritableThreadLocalTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see InheritableThreadLocal class java.lang.InheritableThreadLocal (the hereby targeted class-under-test class)
 * @see InheritableThreadLocalTests InheritableThreadLocalTests (The complementary j8unit test interface containing the
...
public abstract interface InheritableThreadLocalClassTests<SUT extends InheritableThreadLocal>
extends ThreadLocalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InheritableThreadLocal.class!",
                   InheritableThreadLocal.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.chrono.JapaneseChronology class
 * java.time.chrono.JapaneseChronology}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JapaneseChronologyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JapaneseChronologyTests}.
 * </p>
 *
 * @see java.time.chrono.JapaneseChronology class java.time.chrono.JapaneseChronology (the hereby targeted
 *      class-under-test class)
 * @see JapaneseChronologyTests JapaneseChronologyTests (The complementary j8unit test interface containing the instance
...
public abstract interface JapaneseChronologyClassTests<SUT extends java.time.chrono.JapaneseChronology>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractChronologyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.JapaneseChronology.class!",
                   java.time.chrono.JapaneseChronology.class.isAssignableFrom(sut));
    }

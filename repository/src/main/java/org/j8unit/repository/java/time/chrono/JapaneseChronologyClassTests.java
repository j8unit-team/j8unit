 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JapaneseChronology
 * public final class java.time.chrono.JapaneseChronology}.
 *
...
public abstract interface JapaneseChronologyClassTests<SUT extends JapaneseChronology>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.time.chrono.AbstractChronologyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JapaneseChronology.class!",
                   JapaneseChronology.class.isAssignableFrom(sut));
    }

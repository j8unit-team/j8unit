 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferedReader
...
public abstract interface BufferedReaderClassTests<SUT extends BufferedReader>
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferedReader.class!",
                   BufferedReader.class.isAssignableFrom(sut));
    }

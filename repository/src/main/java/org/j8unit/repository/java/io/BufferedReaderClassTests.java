...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.BufferedReader class java.io.BufferedReader}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferedReaderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferedReaderTests}.
 * </p>
 *
 * @see java.io.BufferedReader class java.io.BufferedReader (the hereby targeted class-under-test class)
 * @see BufferedReaderTests BufferedReaderTests (The complementary j8unit test interface containing the instance
...
public abstract interface BufferedReaderClassTests<SUT extends java.io.BufferedReader>
extends ReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.BufferedReader.class!",
                   java.io.BufferedReader.class.isAssignableFrom(sut));
    }

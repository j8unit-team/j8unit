 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExceptionListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExceptionListenerTests}.
 * </p>
 *
 * @see java.beans.ExceptionListener interface java.beans.ExceptionListener (the hereby targeted class-under-test class)
 * @see ExceptionListenerTests ExceptionListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ExceptionListenerClassTests<SUT extends java.beans.ExceptionListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.ExceptionListener.class!",
                   java.beans.ExceptionListener.class.isAssignableFrom(sut));
    }

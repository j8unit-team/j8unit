 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExceptionListener
 * public abstract interface java.beans.ExceptionListener}.
 *
...
public abstract interface ExceptionListenerClassTests<SUT extends ExceptionListener>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExceptionListener.class!",

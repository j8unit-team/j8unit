 ...
 * {@link StringBufferInputStream public class java.io.StringBufferInputStream}.
 *
...
public abstract interface StringBufferInputStreamClassTests<SUT extends StringBufferInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringBufferInputStream.class!",
                   StringBufferInputStream.class.isAssignableFrom(sut));
    }

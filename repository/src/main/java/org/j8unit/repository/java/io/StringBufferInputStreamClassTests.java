 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringBufferInputStreamTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link StringBufferInputStreamTests}.
 * </p>
 *
 * @see java.io.StringBufferInputStream class java.io.StringBufferInputStream (the hereby targeted class-under-test
 *      class)
 * @see StringBufferInputStreamTests StringBufferInputStreamTests (The complementary j8unit test interface containing
...
public abstract interface StringBufferInputStreamClassTests<SUT extends java.io.StringBufferInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.StringBufferInputStream.class!",
                   java.io.StringBufferInputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECPublicKeySpec
...
public abstract interface ECPublicKeySpecClassTests<SUT extends ECPublicKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECPublicKeySpec.class!",
                   ECPublicKeySpec.class.isAssignableFrom(sut));
    }

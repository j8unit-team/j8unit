 ...
 * java.security.spec.ECPublicKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECPublicKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ECPublicKeySpecTests}.
 * </p>
 *
 * @see java.security.spec.ECPublicKeySpec class java.security.spec.ECPublicKeySpec (the hereby targeted
 *      class-under-test class)
 * @see ECPublicKeySpecTests ECPublicKeySpecTests (The complementary j8unit test interface containing the instance
...
extends KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.ECPublicKeySpec.class!",
                   java.security.spec.ECPublicKeySpec.class.isAssignableFrom(sut));
    }

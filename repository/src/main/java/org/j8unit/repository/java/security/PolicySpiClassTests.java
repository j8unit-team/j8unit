 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicySpi public
 * abstract class java.security.PolicySpi}.
 *
...
public abstract interface PolicySpiClassTests<SUT extends PolicySpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicySpi.class!",
                   PolicySpi.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.PolicySpi]

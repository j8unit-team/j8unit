 ...
 * {@link PKIXCertPathValidatorResult public class java.security.cert.PKIXCertPathValidatorResult}.
 *
...
public abstract interface PKIXCertPathValidatorResultClassTests<SUT extends PKIXCertPathValidatorResult>
extends org.j8unit.repository.java.security.cert.CertPathValidatorResultClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKIXCertPathValidatorResult.class!",
                   PKIXCertPathValidatorResult.class.isAssignableFrom(sut));
    }

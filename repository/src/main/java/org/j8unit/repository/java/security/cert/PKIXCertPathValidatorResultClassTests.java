 ...
 * java.security.cert.PKIXCertPathValidatorResult}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link PKIXCertPathValidatorResultTests}).
 * </p>
 *
 * <p>
 ...
 * @see PKIXCertPathValidatorResultTests PKIXCertPathValidatorResultTests (The complementary j8unit test interface
...
extends CertPathValidatorResultClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PKIXCertPathValidatorResult.class!",
                   java.security.cert.PKIXCertPathValidatorResult.class.isAssignableFrom(sut));
    }

 ...
 * {@link AbstractOwnableSynchronizer public abstract class java.util.concurrent.locks.AbstractOwnableSynchronizer}.
 *
...
public abstract interface AbstractOwnableSynchronizerClassTests<SUT extends AbstractOwnableSynchronizer>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractOwnableSynchronizer.class!",
                   AbstractOwnableSynchronizer.class.isAssignableFrom(sut));
    }

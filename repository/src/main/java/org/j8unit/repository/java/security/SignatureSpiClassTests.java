 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SignatureSpi public
 * abstract class java.security.SignatureSpi}.
 *
...
public abstract interface SignatureSpiClassTests<SUT extends SignatureSpi>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.SignatureSpi]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignatureSpi.class!",
                   SignatureSpi.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.SignatureSpi]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.security.SignatureSpi]

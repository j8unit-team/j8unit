 ...
 * {@link TooManyListenersException public class java.util.TooManyListenersException}.
 *
...
public abstract interface TooManyListenersExceptionClassTests<SUT extends TooManyListenersException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TooManyListenersException.class!",
                   TooManyListenersException.class.isAssignableFrom(sut));
    }

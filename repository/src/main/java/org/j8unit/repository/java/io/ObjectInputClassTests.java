 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectInput public
 * abstract interface java.io.ObjectInput}.
 *
...
extends org.j8unit.repository.java.io.DataInputClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectInput.class!",
                   ObjectInput.class.isAssignableFrom(sut));
    }

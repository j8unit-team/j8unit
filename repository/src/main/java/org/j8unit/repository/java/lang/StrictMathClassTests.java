...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain StrictMath class java.lang.StrictMath}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StrictMathTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StrictMathTests}.
 * </p>
 *
 * @see StrictMath class java.lang.StrictMath (the hereby targeted class-under-test class)
 * @see StrictMathTests StrictMathTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface StrictMathClassTests<SUT extends StrictMath>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StrictMath.class!",
                   StrictMath.class.isAssignableFrom(sut));
    }

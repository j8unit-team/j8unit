...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.SocketOption interface java.net.SocketOption}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketOptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketOptionTests}.
 * </p>
 *
 * @see java.net.SocketOption interface java.net.SocketOption (the hereby targeted class-under-test class)
 * @see SocketOptionTests SocketOptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketOption.class!",
                   java.net.SocketOption.class.isAssignableFrom(sut));
    }

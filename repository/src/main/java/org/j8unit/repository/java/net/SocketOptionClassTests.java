 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketOption public
 * abstract interface java.net.SocketOption<T>}.
 *
...
public abstract interface SocketOptionClassTests<SUT extends SocketOption>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketOption.class!",
                   SocketOption.class.isAssignableFrom(sut));
    }

...
public abstract interface ActivateFailedExceptionClassTests<SUT extends ActivateFailedException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ActivateFailedException.class!",
                   ActivateFailedException.class.isAssignableFrom(sut));
    }

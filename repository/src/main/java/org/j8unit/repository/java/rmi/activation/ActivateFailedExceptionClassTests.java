 ...
 * java.rmi.activation.ActivateFailedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ActivateFailedExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ActivateFailedExceptionTests}.
 * </p>
 *
 * @see java.rmi.activation.ActivateFailedException class java.rmi.activation.ActivateFailedException (the hereby
 *      targeted class-under-test class)
 * @see ActivateFailedExceptionTests ActivateFailedExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.activation.ActivateFailedException.class!",
                   java.rmi.activation.ActivateFailedException.class.isAssignableFrom(sut));
    }

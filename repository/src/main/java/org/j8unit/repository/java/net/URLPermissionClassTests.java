 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URLPermissionTests}.
 * </p>
 *
 * @see java.net.URLPermission class java.net.URLPermission (the hereby targeted class-under-test class)
 * @see URLPermissionTests URLPermissionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.security.PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URLPermission.class!",
                   java.net.URLPermission.class.isAssignableFrom(sut));
    }

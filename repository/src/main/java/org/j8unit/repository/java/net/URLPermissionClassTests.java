 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URLPermission
 * public final class java.net.URLPermission}.
 *
...
public abstract interface URLPermissionClassTests<SUT extends URLPermission>
extends PermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLPermission.class!",
                   URLPermission.class.isAssignableFrom(sut));
    }

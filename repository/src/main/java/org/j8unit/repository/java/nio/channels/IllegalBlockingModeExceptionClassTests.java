 ...
 * {@link IllegalBlockingModeException public class java.nio.channels.IllegalBlockingModeException}.
 *
...
public abstract interface IllegalBlockingModeExceptionClassTests<SUT extends IllegalBlockingModeException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalBlockingModeException.class!",
                   IllegalBlockingModeException.class.isAssignableFrom(sut));
    }

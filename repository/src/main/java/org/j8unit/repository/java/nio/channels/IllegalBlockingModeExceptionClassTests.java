 ...
 * java.nio.channels.IllegalBlockingModeException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link IllegalBlockingModeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see IllegalBlockingModeExceptionTests IllegalBlockingModeExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.IllegalBlockingModeException.class!",
                   java.nio.channels.IllegalBlockingModeException.class.isAssignableFrom(sut));
    }

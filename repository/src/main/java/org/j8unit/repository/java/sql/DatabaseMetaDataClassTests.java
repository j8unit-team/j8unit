 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DatabaseMetaData
 * public abstract interface java.sql.DatabaseMetaData}.
 *
...
public abstract interface DatabaseMetaDataClassTests<SUT extends DatabaseMetaData>
extends WrapperClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatabaseMetaData.class!",
                   DatabaseMetaData.class.isAssignableFrom(sut));
    }

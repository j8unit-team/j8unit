 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DatabaseMetaDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DatabaseMetaDataTests}.
 * </p>
 *
 * @see java.sql.DatabaseMetaData interface java.sql.DatabaseMetaData (the hereby targeted class-under-test class)
 * @see DatabaseMetaDataTests DatabaseMetaDataTests (The complementary j8unit test interface containing the instance
...
public abstract interface DatabaseMetaDataClassTests<SUT extends java.sql.DatabaseMetaData>
extends WrapperClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.DatabaseMetaData.class!",
                   java.sql.DatabaseMetaData.class.isAssignableFrom(sut));
    }

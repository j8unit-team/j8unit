...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.cert.PolicyNode interface java.security.cert.PolicyNode}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyNodeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PolicyNodeTests}.
 * </p>
 *
 * @see java.security.cert.PolicyNode interface java.security.cert.PolicyNode (the hereby targeted class-under-test
 *      class)
 * @see PolicyNodeTests PolicyNodeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PolicyNodeClassTests<SUT extends java.security.cert.PolicyNode>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PolicyNode.class!",
                   java.security.cert.PolicyNode.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyNode public
 * abstract interface java.security.cert.PolicyNode}.
 *
...
public abstract interface PolicyNodeClassTests<SUT extends PolicyNode>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyNode.class!",
                   PolicyNode.class.isAssignableFrom(sut));
    }

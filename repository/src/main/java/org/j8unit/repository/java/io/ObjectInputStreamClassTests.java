 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see ObjectInputStreamTests ObjectInputStreamTests (The complementary j8unit test interface containing the instance
...
extends ObjectInputClassTests<SUT>, ObjectStreamConstantsClassTests<SUT>, InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectInputStream.class!",
                   java.io.ObjectInputStream.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.io.ObjectInputStream.GetField class
     * java.io.ObjectInputStream$GetField}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link ObjectInputStreamTests.GetFieldTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ObjectInputStreamTests.GetFieldTests ObjectInputStreamTests.GetFieldTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectInputStream.GetField.class!",
                       java.io.ObjectInputStream.GetField.class.isAssignableFrom(sut));
        }

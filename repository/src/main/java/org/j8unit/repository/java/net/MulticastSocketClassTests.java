 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.net.MulticastSocket
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.net.DatagramSocketClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.net.MulticastSocket#MulticastSocket()
     */
     ...
     * </p>
     *
     * @j8unit.aim java.net.MulticastSocket#MulticastSocket(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.net.MulticastSocket#MulticastSocket(java.net.SocketAddress)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.net.MulticastSocket#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.MulticastSocket class java.net.MulticastSocket}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MulticastSocketTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MulticastSocketTests}.
 * </p>
 *
 * @see java.net.MulticastSocket class java.net.MulticastSocket (the hereby targeted class-under-test class)
 * @see MulticastSocketTests MulticastSocketTests (The complementary j8unit test interface containing the instance
...
public abstract interface MulticastSocketClassTests<SUT extends java.net.MulticastSocket>
extends DatagramSocketClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.MulticastSocket.class!",
                   java.net.MulticastSocket.class.isAssignableFrom(sut));
    }

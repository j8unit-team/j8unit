 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MulticastSocket
...
public abstract interface MulticastSocketClassTests<SUT extends MulticastSocket>
extends DatagramSocketClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MulticastSocket.class!",
                   MulticastSocket.class.isAssignableFrom(sut));
    }

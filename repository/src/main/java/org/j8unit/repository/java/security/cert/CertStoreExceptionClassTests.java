 ...
 * java.security.cert.CertStoreException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertStoreExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertStoreExceptionTests}.
 * </p>
 *
 * @see java.security.cert.CertStoreException class java.security.cert.CertStoreException (the hereby targeted
 *      class-under-test class)
 * @see CertStoreExceptionTests CertStoreExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertStoreException.class!",
                   java.security.cert.CertStoreException.class.isAssignableFrom(sut));
    }

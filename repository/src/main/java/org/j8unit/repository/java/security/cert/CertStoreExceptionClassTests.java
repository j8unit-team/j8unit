 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertStoreException
...
public abstract interface CertStoreExceptionClassTests<SUT extends CertStoreException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertStoreException.class!",
                   CertStoreException.class.isAssignableFrom(sut));
    }

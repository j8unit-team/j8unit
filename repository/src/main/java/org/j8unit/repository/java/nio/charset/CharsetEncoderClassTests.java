 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CharsetEncoder
...
public abstract interface CharsetEncoderClassTests<SUT extends CharsetEncoder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharsetEncoder.class!",
                   CharsetEncoder.class.isAssignableFrom(sut));
    }

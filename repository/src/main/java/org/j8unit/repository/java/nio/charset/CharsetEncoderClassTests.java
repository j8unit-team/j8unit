...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.charset.CharsetEncoder class java.nio.charset.CharsetEncoder}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharsetEncoderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharsetEncoderTests}.
 * </p>
 *
 * @see java.nio.charset.CharsetEncoder class java.nio.charset.CharsetEncoder (the hereby targeted class-under-test
 *      class)
 * @see CharsetEncoderTests CharsetEncoderTests (The complementary j8unit test interface containing the instance
...
public abstract interface CharsetEncoderClassTests<SUT extends java.nio.charset.CharsetEncoder>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.charset.CharsetEncoder.class!",
                   java.nio.charset.CharsetEncoder.class.isAssignableFrom(sut));
    }

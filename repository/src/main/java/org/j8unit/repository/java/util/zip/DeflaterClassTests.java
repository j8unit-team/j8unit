...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.Deflater class java.util.zip.Deflater}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DeflaterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DeflaterTests}.
 * </p>
 *
 * @see java.util.zip.Deflater class java.util.zip.Deflater (the hereby targeted class-under-test class)
 * @see DeflaterTests DeflaterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DeflaterClassTests<SUT extends java.util.zip.Deflater>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.Deflater.class!",
                   java.util.zip.Deflater.class.isAssignableFrom(sut));
    }

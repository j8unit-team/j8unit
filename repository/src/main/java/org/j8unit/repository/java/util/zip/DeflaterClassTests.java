 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Deflater public
...
public abstract interface DeflaterClassTests<SUT extends Deflater>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Deflater.class!",
                   Deflater.class.isAssignableFrom(sut));
    }

 ...
 * {@link ReadOnlyFileSystemException public class java.nio.file.ReadOnlyFileSystemException}.
 *
...
extends UnsupportedOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReadOnlyFileSystemException.class!",
                   ReadOnlyFileSystemException.class.isAssignableFrom(sut));
    }

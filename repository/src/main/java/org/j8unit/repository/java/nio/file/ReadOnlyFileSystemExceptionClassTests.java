 ...
 * java.nio.file.ReadOnlyFileSystemException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see ReadOnlyFileSystemExceptionTests ReadOnlyFileSystemExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.UnsupportedOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.ReadOnlyFileSystemException.class!",
                   java.nio.file.ReadOnlyFileSystemException.class.isAssignableFrom(sut));
    }

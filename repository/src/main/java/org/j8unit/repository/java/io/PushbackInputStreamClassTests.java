 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PushbackInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PushbackInputStreamTests}.
 * </p>
 *
 * @see java.io.PushbackInputStream class java.io.PushbackInputStream (the hereby targeted class-under-test class)
 * @see PushbackInputStreamTests PushbackInputStreamTests (The complementary j8unit test interface containing the
...
extends FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.PushbackInputStream.class!",
                   java.io.PushbackInputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PushbackInputStream
...
public abstract interface PushbackInputStreamClassTests<SUT extends PushbackInputStream>
extends FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PushbackInputStream.class!",
                   PushbackInputStream.class.isAssignableFrom(sut));
    }

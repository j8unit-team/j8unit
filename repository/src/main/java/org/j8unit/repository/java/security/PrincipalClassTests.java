...
public abstract interface PrincipalClassTests<SUT extends java.security.Principal>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Principal.class!",
                   java.security.Principal.class.isAssignableFrom(sut));
    }

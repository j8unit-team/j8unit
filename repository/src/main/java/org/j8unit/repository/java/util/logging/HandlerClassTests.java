 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HandlerTests}.
 * </p>
 *
 * @see java.util.logging.Handler class java.util.logging.Handler (the hereby targeted class-under-test class)
 * @see HandlerTests HandlerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface HandlerClassTests<SUT extends java.util.logging.Handler>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.Handler.class!",
                   java.util.logging.Handler.class.isAssignableFrom(sut));
    }

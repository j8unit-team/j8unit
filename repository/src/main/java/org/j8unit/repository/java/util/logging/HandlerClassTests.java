 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Handler public
...
public abstract interface HandlerClassTests<SUT extends Handler>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Handler.class!",
                   Handler.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.beancontext.BeanContextProxy interface
 * java.beans.beancontext.BeanContextProxy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanContextProxyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BeanContextProxyTests}.
 * </p>
 *
 * @see java.beans.beancontext.BeanContextProxy interface java.beans.beancontext.BeanContextProxy (the hereby targeted
 *      class-under-test class)
 * @see BeanContextProxyTests BeanContextProxyTests (The complementary j8unit test interface containing the instance
...
public abstract interface BeanContextProxyClassTests<SUT extends java.beans.beancontext.BeanContextProxy>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextProxy.class!",
                   java.beans.beancontext.BeanContextProxy.class.isAssignableFrom(sut));
    }

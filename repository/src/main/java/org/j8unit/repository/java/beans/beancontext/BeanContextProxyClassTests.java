 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanContextProxy
 * public abstract interface java.beans.beancontext.BeanContextProxy}.
 *
...
public abstract interface BeanContextProxyClassTests<SUT extends BeanContextProxy>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextProxy.class!",
                   BeanContextProxy.class.isAssignableFrom(sut));
    }

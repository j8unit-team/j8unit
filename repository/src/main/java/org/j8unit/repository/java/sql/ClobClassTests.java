...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.Clob interface java.sql.Clob}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClobTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClobTests}.
 * </p>
 *
 * @see java.sql.Clob interface java.sql.Clob (the hereby targeted class-under-test class)
 * @see ClobTests ClobTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ClobClassTests<SUT extends java.sql.Clob>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.Clob.class!",
                   java.sql.Clob.class.isAssignableFrom(sut));
    }

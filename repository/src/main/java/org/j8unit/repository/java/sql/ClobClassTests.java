 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Clob public
 * abstract interface java.sql.Clob}.
 *
...
public abstract interface ClobClassTests<SUT extends Clob>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Clob.class!", Clob.class.isAssignableFrom(sut));
    }

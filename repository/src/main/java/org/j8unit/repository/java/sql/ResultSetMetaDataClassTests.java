 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResultSetMetaData
 * public abstract interface java.sql.ResultSetMetaData}.
 *
...
extends org.j8unit.repository.java.sql.WrapperClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResultSetMetaData.class!",

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResultSetMetaDataTests}).
 * </p>
 *
 * <p>
 ...
 * @see ResultSetMetaDataTests ResultSetMetaDataTests (The complementary j8unit test interface containing the instance
...
public abstract interface ResultSetMetaDataClassTests<SUT extends java.sql.ResultSetMetaData>
extends WrapperClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.ResultSetMetaData.class!",
                   java.sql.ResultSetMetaData.class.isAssignableFrom(sut));
    }

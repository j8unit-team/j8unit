 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PropertyPermissionTests}.
 * </p>
 *
 * @see java.util.PropertyPermission class java.util.PropertyPermission (the hereby targeted class-under-test class)
 * @see PropertyPermissionTests PropertyPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.PropertyPermission.class!",
                   java.util.PropertyPermission.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PropertyPermission
...
public abstract interface PropertyPermissionClassTests<SUT extends PropertyPermission>
extends BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyPermission.class!",
                   PropertyPermission.class.isAssignableFrom(sut));
    }

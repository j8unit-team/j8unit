 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProtectionDomain
...
public abstract interface ProtectionDomainClassTests<SUT extends ProtectionDomain>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProtectionDomain.class!",
                   ProtectionDomain.class.isAssignableFrom(sut));
    }

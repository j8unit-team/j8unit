 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProtectionDomainTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProtectionDomainTests}.
 * </p>
 *
 * @see java.security.ProtectionDomain class java.security.ProtectionDomain (the hereby targeted class-under-test class)
 * @see ProtectionDomainTests ProtectionDomainTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.ProtectionDomain.class!",
                   java.security.ProtectionDomain.class.isAssignableFrom(sut));
    }

 ...
 * {@link CertificateExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface CertificateExceptionClassTests<SUT extends CertificateException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertificateException.class!",
                   CertificateException.class.isAssignableFrom(sut));
    }

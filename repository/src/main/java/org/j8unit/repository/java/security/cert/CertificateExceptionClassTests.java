 ...
 * java.security.cert.CertificateException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see java.security.cert.CertificateException class java.security.cert.CertificateException (the hereby targeted
...
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateException.class!",
                   java.security.cert.CertificateException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DesignMode public
 * abstract interface java.beans.DesignMode}.
 *
...
public abstract interface DesignModeClassTests<SUT extends DesignMode>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DesignMode.class!",
                   DesignMode.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DesignModeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DesignModeTests}.
 * </p>
 *
 * @see java.beans.DesignMode interface java.beans.DesignMode (the hereby targeted class-under-test class)
 * @see DesignModeTests DesignModeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DesignModeClassTests<SUT extends java.beans.DesignMode>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.DesignMode.class!",
                   java.beans.DesignMode.class.isAssignableFrom(sut));
    }

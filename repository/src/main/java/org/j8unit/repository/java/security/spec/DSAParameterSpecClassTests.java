 ...
 * java.security.spec.DSAParameterSpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAParameterSpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAParameterSpecTests}.
 * </p>
 *
 * @see java.security.spec.DSAParameterSpec class java.security.spec.DSAParameterSpec (the hereby targeted
 *      class-under-test class)
 * @see DSAParameterSpecTests DSAParameterSpecTests (The complementary j8unit test interface containing the instance
...
extends AlgorithmParameterSpecClassTests<SUT>, org.j8unit.repository.java.security.interfaces.DSAParamsClassTests<SUT>,
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.DSAParameterSpec.class!",
                   java.security.spec.DSAParameterSpec.class.isAssignableFrom(sut));
    }

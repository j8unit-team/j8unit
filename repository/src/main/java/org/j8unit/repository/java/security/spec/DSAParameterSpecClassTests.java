...
import org.j8unit.repository.java.security.interfaces.DSAParamsClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAParameterSpec
...
public abstract interface DSAParameterSpecClassTests<SUT extends DSAParameterSpec>
extends AlgorithmParameterSpecClassTests<SUT>, DSAParamsClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAParameterSpec.class!",

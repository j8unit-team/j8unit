 ...
 * java.beans.beancontext.BeanContextServicesListener}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * </p>
 *
 * @see java.beans.beancontext.BeanContextServicesListener interface java.beans.beancontext.BeanContextServicesListener
 *      (the hereby targeted class-under-test class)
 * @see BeanContextServicesListenerTests BeanContextServicesListenerTests (The complementary j8unit test interface
...
public abstract interface BeanContextServicesListenerClassTests<SUT extends java.beans.beancontext.BeanContextServicesListener>
extends BeanContextServiceRevokedListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServicesListener.class!",
                   java.beans.beancontext.BeanContextServicesListener.class.isAssignableFrom(sut));
    }

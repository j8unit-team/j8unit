 ...
 * java.beans.beancontext.BeanContextServicesListener}, containing all class relevant test methods (at least the test
...
extends org.j8unit.repository.java.beans.beancontext.BeanContextServiceRevokedListenerClassTests<SUT> {
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.beans.beancontext.BeanContextServicesListener#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test
    ...
    throws Exception {
        ...
        assertTrue(java.beans.beancontext.BeanContextServicesListener.class.isAssignableFrom(sut));
    }

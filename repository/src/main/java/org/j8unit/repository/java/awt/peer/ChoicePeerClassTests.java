 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChoicePeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChoicePeerTests}.
 * </p>
 *
 * @see java.awt.peer.ChoicePeer interface java.awt.peer.ChoicePeer (the hereby targeted class-under-test class)
 * @see ChoicePeerTests ChoicePeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ChoicePeerClassTests<SUT extends java.awt.peer.ChoicePeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.ChoicePeer.class!",
                   java.awt.peer.ChoicePeer.class.isAssignableFrom(sut));
    }

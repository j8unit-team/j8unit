 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChoicePeer public
 * abstract interface java.awt.peer.ChoicePeer}.
 *
...
public abstract interface ChoicePeerClassTests<SUT extends ChoicePeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChoicePeer.class!",
                   ChoicePeer.class.isAssignableFrom(sut));
    }

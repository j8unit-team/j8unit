 ...
 * {@link PortUnreachableException public class java.net.PortUnreachableException}.
 *
...
public abstract interface PortUnreachableExceptionClassTests<SUT extends PortUnreachableException>
extends SocketExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PortUnreachableException.class!",
                   PortUnreachableException.class.isAssignableFrom(sut));
    }

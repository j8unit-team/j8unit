 ...
 * java.net.PortUnreachableException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PortUnreachableExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link PortUnreachableExceptionTests}.
 * </p>
 *
 * @see java.net.PortUnreachableException class java.net.PortUnreachableException (the hereby targeted class-under-test
 *      class)
 * @see PortUnreachableExceptionTests PortUnreachableExceptionTests (The complementary j8unit test interface containing
...
public abstract interface PortUnreachableExceptionClassTests<SUT extends java.net.PortUnreachableException>
extends SocketExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.PortUnreachableException.class!",
                   java.net.PortUnreachableException.class.isAssignableFrom(sut));
    }

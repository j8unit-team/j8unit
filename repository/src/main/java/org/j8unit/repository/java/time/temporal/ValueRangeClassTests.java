 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueRange public
 * final class java.time.temporal.ValueRange}.
 *
...
public abstract interface ValueRangeClassTests<SUT extends ValueRange>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueRange.class!",
                   ValueRange.class.isAssignableFrom(sut));
    }

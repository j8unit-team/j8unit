...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.ValueRange class java.time.temporal.ValueRange},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueRangeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValueRangeTests}.
 * </p>
 *
 * @see java.time.temporal.ValueRange class java.time.temporal.ValueRange (the hereby targeted class-under-test class)
 * @see ValueRangeTests ValueRangeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ValueRangeClassTests<SUT extends java.time.temporal.ValueRange>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.ValueRange.class!",
                   java.time.temporal.ValueRange.class.isAssignableFrom(sut));
    }

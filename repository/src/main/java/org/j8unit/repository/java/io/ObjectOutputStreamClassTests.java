 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see ObjectOutputStreamTests ObjectOutputStreamTests (The complementary j8unit test interface containing the instance
...
extends ObjectOutputClassTests<SUT>, ObjectStreamConstantsClassTests<SUT>, OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectOutputStream.class!",
                   java.io.ObjectOutputStream.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.io.ObjectOutputStream.PutField class
     * java.io.ObjectOutputStream$PutField}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link ObjectOutputStreamTests.PutFieldTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see ObjectOutputStreamTests.PutFieldTests ObjectOutputStreamTests.PutFieldTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectOutputStream.PutField.class!",
                       java.io.ObjectOutputStream.PutField.class.isAssignableFrom(sut));
        }

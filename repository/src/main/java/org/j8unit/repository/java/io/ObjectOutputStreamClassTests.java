 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectOutputStream
...
public abstract interface ObjectOutputStreamClassTests<SUT extends ObjectOutputStream>
extends ObjectOutputClassTests<SUT>, ObjectStreamConstantsClassTests<SUT>, OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectOutputStream.class!",
     ...
     * {@link PutField public abstract static class java.io.ObjectOutputStream$PutField}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface PutFieldClassTests<SUT extends PutField>

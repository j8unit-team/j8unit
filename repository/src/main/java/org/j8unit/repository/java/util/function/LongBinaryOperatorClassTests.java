 ...
 * java.util.function.LongBinaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongBinaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongBinaryOperatorTests}.
 * </p>
 *
 * @see java.util.function.LongBinaryOperator interface java.util.function.LongBinaryOperator (the hereby targeted
 *      class-under-test class)
 * @see LongBinaryOperatorTests LongBinaryOperatorTests (The complementary j8unit test interface containing the instance
...
public abstract interface LongBinaryOperatorClassTests<SUT extends java.util.function.LongBinaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongBinaryOperator.class!",
                   java.util.function.LongBinaryOperator.class.isAssignableFrom(sut));
    }

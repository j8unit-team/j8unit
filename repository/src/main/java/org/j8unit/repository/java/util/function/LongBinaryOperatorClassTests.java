 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongBinaryOperator
 * public abstract interface java.util.function.LongBinaryOperator}.
 *
...
public abstract interface LongBinaryOperatorClassTests<SUT extends LongBinaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongBinaryOperator.class!",
                   LongBinaryOperator.class.isAssignableFrom(sut));
    }

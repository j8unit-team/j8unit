...
public abstract interface ShutdownChannelGroupExceptionClassTests<SUT extends ShutdownChannelGroupException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ShutdownChannelGroupException.class!",
                   ShutdownChannelGroupException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.nio.channels.ShutdownChannelGroupException]

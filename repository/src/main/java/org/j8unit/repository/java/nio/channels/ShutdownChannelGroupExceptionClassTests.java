 ...
 * java.nio.channels.ShutdownChannelGroupException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link ShutdownChannelGroupExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see ShutdownChannelGroupExceptionTests ShutdownChannelGroupExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.ShutdownChannelGroupException.class!",
                   java.nio.channels.ShutdownChannelGroupException.class.isAssignableFrom(sut));
    }

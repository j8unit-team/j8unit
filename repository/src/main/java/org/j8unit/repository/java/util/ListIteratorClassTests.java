...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.ListIterator interface java.util.ListIterator}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ListIteratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ListIteratorTests}.
 * </p>
 *
 * @see java.util.ListIterator interface java.util.ListIterator (the hereby targeted class-under-test class)
 * @see ListIteratorTests ListIteratorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ListIteratorClassTests<SUT extends java.util.ListIterator>
extends IteratorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ListIterator.class!",
                   java.util.ListIterator.class.isAssignableFrom(sut));
    }

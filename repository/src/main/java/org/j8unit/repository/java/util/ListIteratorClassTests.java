 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ListIterator public
 * abstract interface java.util.ListIterator<E>}.
 *
...
public abstract interface ListIteratorClassTests<SUT extends ListIterator>
extends IteratorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ListIterator.class!",
                   ListIterator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CertStore public
...
public abstract interface CertStoreClassTests<SUT extends CertStore>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertStore.class!",
                   CertStore.class.isAssignableFrom(sut));
    }

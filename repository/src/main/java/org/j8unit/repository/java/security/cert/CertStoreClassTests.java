...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.cert.CertStore class java.security.cert.CertStore},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertStoreTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CertStoreTests}.
 * </p>
 *
 * @see java.security.cert.CertStore class java.security.cert.CertStore (the hereby targeted class-under-test class)
 * @see CertStoreTests CertStoreTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CertStoreClassTests<SUT extends java.security.cert.CertStore>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertStore.class!",
                   java.security.cert.CertStore.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShortLookupTableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ShortLookupTableTests}.
 * </p>
 *
 * @see java.awt.image.ShortLookupTable class java.awt.image.ShortLookupTable (the hereby targeted class-under-test
 *      class)
 * @see ShortLookupTableTests ShortLookupTableTests (The complementary j8unit test interface containing the instance
...
public abstract interface ShortLookupTableClassTests<SUT extends java.awt.image.ShortLookupTable>
extends LookupTableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ShortLookupTable.class!",
                   java.awt.image.ShortLookupTable.class.isAssignableFrom(sut));
    }

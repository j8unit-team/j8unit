 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ShortLookupTable
 * public class java.awt.image.ShortLookupTable}.
 *
...
public abstract interface ShortLookupTableClassTests<SUT extends ShortLookupTable>
extends LookupTableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ShortLookupTable.class!",
                   ShortLookupTable.class.isAssignableFrom(sut));
    }

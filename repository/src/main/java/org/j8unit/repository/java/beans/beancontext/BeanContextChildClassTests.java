...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.beancontext.BeanContextChild interface
 * java.beans.beancontext.BeanContextChild}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BeanContextChildTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.beans.beancontext.BeanContextChild interface java.beans.beancontext.BeanContextChild (the hereby targeted
 *      class-under-test class)
 * @see BeanContextChildTests BeanContextChildTests (The complementary j8unit test interface containing the instance
...
public abstract interface BeanContextChildClassTests<SUT extends java.beans.beancontext.BeanContextChild>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextChild.class!",
                   java.beans.beancontext.BeanContextChild.class.isAssignableFrom(sut));
    }

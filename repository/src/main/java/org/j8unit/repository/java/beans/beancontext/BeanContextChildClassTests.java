 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BeanContextChild
 * public abstract interface java.beans.beancontext.BeanContextChild}.
 *
...
public abstract interface BeanContextChildClassTests<SUT extends BeanContextChild>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextChild.class!",
                   BeanContextChild.class.isAssignableFrom(sut));
    }

 ...
 * {@link ResourceBundleControlProvider public abstract interface java.util.spi.ResourceBundleControlProvider}.
 *
...
public abstract interface ResourceBundleControlProviderClassTests<SUT extends ResourceBundleControlProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResourceBundleControlProvider.class!",
                   ResourceBundleControlProvider.class.isAssignableFrom(sut));
    }

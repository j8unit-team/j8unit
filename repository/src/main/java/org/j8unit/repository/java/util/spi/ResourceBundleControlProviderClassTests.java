 ...
 * java.util.spi.ResourceBundleControlProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link ResourceBundleControlProviderTests}).
 * </p>
 *
 * <p>
 ...
 * @see ResourceBundleControlProviderTests ResourceBundleControlProviderTests (The complementary j8unit test interface
...
public abstract interface ResourceBundleControlProviderClassTests<SUT extends java.util.spi.ResourceBundleControlProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.spi.ResourceBundleControlProvider.class!",
                   java.util.spi.ResourceBundleControlProvider.class.isAssignableFrom(sut));
    }

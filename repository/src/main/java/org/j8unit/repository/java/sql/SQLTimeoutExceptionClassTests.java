 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLTimeoutExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLTimeoutExceptionTests}.
 * </p>
 *
 * @see java.sql.SQLTimeoutException class java.sql.SQLTimeoutException (the hereby targeted class-under-test class)
 * @see SQLTimeoutExceptionTests SQLTimeoutExceptionTests (The complementary j8unit test interface containing the
...
extends SQLTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLTimeoutException.class!",
                   java.sql.SQLTimeoutException.class.isAssignableFrom(sut));
    }

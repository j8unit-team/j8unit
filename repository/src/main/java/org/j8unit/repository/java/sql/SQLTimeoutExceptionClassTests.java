 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLTimeoutException
...
public abstract interface SQLTimeoutExceptionClassTests<SUT extends SQLTimeoutException>
extends SQLTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLTimeoutException.class!",
                   SQLTimeoutException.class.isAssignableFrom(sut));
    }

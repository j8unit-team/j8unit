 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ErrorManager public
...
public abstract interface ErrorManagerClassTests<SUT extends ErrorManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ErrorManager.class!",
                   ErrorManager.class.isAssignableFrom(sut));
    }

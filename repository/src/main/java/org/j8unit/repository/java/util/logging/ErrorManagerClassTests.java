 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ErrorManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ErrorManagerTests}.
 * </p>
 *
 * @see java.util.logging.ErrorManager class java.util.logging.ErrorManager (the hereby targeted class-under-test class)
 * @see ErrorManagerTests ErrorManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ErrorManagerClassTests<SUT extends java.util.logging.ErrorManager>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.ErrorManager.class!",
                   java.util.logging.ErrorManager.class.isAssignableFrom(sut));
    }

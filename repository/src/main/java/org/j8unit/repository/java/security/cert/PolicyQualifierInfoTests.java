 ...
 * {@link PolicyQualifierInfo public class java.security.cert.PolicyQualifierInfo}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.security.cert.PolicyQualifierInfoClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface PolicyQualifierInfoTests<SUT extends PolicyQualifierInfo>

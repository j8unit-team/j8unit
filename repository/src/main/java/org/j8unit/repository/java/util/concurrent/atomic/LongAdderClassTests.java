...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.atomic.LongAdder class
 * java.util.concurrent.atomic.LongAdder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongAdderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongAdderTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.LongAdder class java.util.concurrent.atomic.LongAdder (the hereby targeted
 *      class-under-test class)
 * @see LongAdderTests LongAdderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LongAdderClassTests<SUT extends java.util.concurrent.atomic.LongAdder>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.LongAdder.class!",
                   java.util.concurrent.atomic.LongAdder.class.isAssignableFrom(sut));
    }

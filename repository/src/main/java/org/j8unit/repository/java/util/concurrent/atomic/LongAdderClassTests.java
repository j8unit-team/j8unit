 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongAdder public
...
public abstract interface LongAdderClassTests<SUT extends LongAdder>
extends NumberClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongAdder.class!",
                   LongAdder.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.concurrent.atomic.LongAdder]

 ...
 * java.security.SignatureException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SignatureExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SignatureExceptionTests}.
 * </p>
 *
 * @see java.security.SignatureException class java.security.SignatureException (the hereby targeted class-under-test
 *      class)
 * @see SignatureExceptionTests SignatureExceptionTests (The complementary j8unit test interface containing the instance
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.SignatureException.class!",
                   java.security.SignatureException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SignatureException
...
public abstract interface SignatureExceptionClassTests<SUT extends SignatureException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SignatureException.class!",
                   SignatureException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormatStyleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FormatStyleTests}.
 * </p>
 *
 * @see java.time.format.FormatStyle class java.time.format.FormatStyle (the hereby targeted class-under-test class)
 * @see FormatStyleTests FormatStyleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface FormatStyleClassTests<SUT extends java.time.format.FormatStyle>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.FormatStyle.class!",
                   java.time.format.FormatStyle.class.isAssignableFrom(sut));
    }

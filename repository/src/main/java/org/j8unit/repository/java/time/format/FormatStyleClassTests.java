 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FormatStyle public
 * final enum java.time.format.FormatStyle}.
 *
...
public abstract interface FormatStyleClassTests<SUT extends FormatStyle>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormatStyle.class!",
                   FormatStyle.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Enumeration public
 * abstract interface java.util.Enumeration<E>}.
 *
...
public abstract interface EnumerationClassTests<SUT extends Enumeration>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Enumeration.class!",
                   Enumeration.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Enumeration interface java.util.Enumeration}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EnumerationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EnumerationTests}.
 * </p>
 *
 * @see java.util.Enumeration interface java.util.Enumeration (the hereby targeted class-under-test class)
 * @see EnumerationTests EnumerationTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Enumeration.class!",
                   java.util.Enumeration.class.isAssignableFrom(sut));
    }

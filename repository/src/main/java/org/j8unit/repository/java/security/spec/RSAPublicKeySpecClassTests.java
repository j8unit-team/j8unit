 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RSAPublicKeySpec
...
public abstract interface RSAPublicKeySpecClassTests<SUT extends RSAPublicKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAPublicKeySpec.class!",
                   RSAPublicKeySpec.class.isAssignableFrom(sut));
    }

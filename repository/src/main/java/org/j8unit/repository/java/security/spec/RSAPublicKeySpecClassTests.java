 ...
 * java.security.spec.RSAPublicKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAPublicKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RSAPublicKeySpecTests}.
 * </p>
 *
 * @see java.security.spec.RSAPublicKeySpec class java.security.spec.RSAPublicKeySpec (the hereby targeted
 *      class-under-test class)
 * @see RSAPublicKeySpecTests RSAPublicKeySpecTests (The complementary j8unit test interface containing the instance
...
public abstract interface RSAPublicKeySpecClassTests<SUT extends java.security.spec.RSAPublicKeySpec>
extends KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.RSAPublicKeySpec.class!",
                   java.security.spec.RSAPublicKeySpec.class.isAssignableFrom(sut));
    }

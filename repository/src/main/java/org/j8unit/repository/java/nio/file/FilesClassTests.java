 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Files public final
...
public abstract interface FilesClassTests<SUT extends Files>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Files.class!", Files.class.isAssignableFrom(sut));
    }

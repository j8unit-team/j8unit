...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.ProtocolFamily interface java.net.ProtocolFamily}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProtocolFamilyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProtocolFamilyTests}.
 * </p>
 *
 * @see java.net.ProtocolFamily interface java.net.ProtocolFamily (the hereby targeted class-under-test class)
 * @see ProtocolFamilyTests ProtocolFamilyTests (The complementary j8unit test interface containing the instance
...
public abstract interface ProtocolFamilyClassTests<SUT extends java.net.ProtocolFamily>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.ProtocolFamily.class!",
                   java.net.ProtocolFamily.class.isAssignableFrom(sut));
    }

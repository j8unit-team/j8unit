 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProtocolFamily
 * public abstract interface java.net.ProtocolFamily}.
 *
...
public abstract interface ProtocolFamilyClassTests<SUT extends ProtocolFamily>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProtocolFamily.class!",
                   ProtocolFamily.class.isAssignableFrom(sut));
    }

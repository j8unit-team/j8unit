 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CacheRequestTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CacheRequestTests}.
 * </p>
 *
 * @see java.net.CacheRequest class java.net.CacheRequest (the hereby targeted class-under-test class)
 * @see CacheRequestTests CacheRequestTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CacheRequestClassTests<SUT extends java.net.CacheRequest>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.CacheRequest.class!",
                   java.net.CacheRequest.class.isAssignableFrom(sut));
    }

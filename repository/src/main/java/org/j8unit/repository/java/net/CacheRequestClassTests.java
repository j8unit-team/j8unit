 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CacheRequest public
 * abstract class java.net.CacheRequest}.
 *
...
public abstract interface CacheRequestClassTests<SUT extends CacheRequest>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CacheRequest.class!",
                   CacheRequest.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.net.CacheRequest]

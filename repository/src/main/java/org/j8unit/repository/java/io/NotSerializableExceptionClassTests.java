 ...
 * java.io.NotSerializableException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotSerializableExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NotSerializableExceptionTests}.
 * </p>
 *
 * @see java.io.NotSerializableException class java.io.NotSerializableException (the hereby targeted class-under-test
 *      class)
 * @see NotSerializableExceptionTests NotSerializableExceptionTests (The complementary j8unit test interface containing
...
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.NotSerializableException.class!",
                   java.io.NotSerializableException.class.isAssignableFrom(sut));
    }

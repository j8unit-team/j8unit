 ...
 * {@link NotSerializableException public class java.io.NotSerializableException}.
 *
...
public abstract interface NotSerializableExceptionClassTests<SUT extends NotSerializableException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotSerializableException.class!",
                   NotSerializableException.class.isAssignableFrom(sut));
    }

...
public abstract interface PriorityBlockingQueueClassTests<SUT extends PriorityBlockingQueue>
extends BlockingQueueClassTests<SUT>, SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PriorityBlockingQueue.class!",

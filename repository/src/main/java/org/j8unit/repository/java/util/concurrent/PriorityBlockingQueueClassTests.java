 ...
 * java.util.concurrent.PriorityBlockingQueue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PriorityBlockingQueueTests}).
 * </p>
 *
 * <p>
 ...
 * {@link PriorityBlockingQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.PriorityBlockingQueue class java.util.concurrent.PriorityBlockingQueue (the hereby targeted
 *      class-under-test class)
 * @see PriorityBlockingQueueTests PriorityBlockingQueueTests (The complementary j8unit test interface containing the
...
extends BlockingQueueClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.PriorityBlockingQueue.class!",
                   java.util.concurrent.PriorityBlockingQueue.class.isAssignableFrom(sut));
    }

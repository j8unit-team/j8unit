...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.FilenameFilter interface java.io.FilenameFilter}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilenameFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilenameFilterTests}.
 * </p>
 *
 * @see java.io.FilenameFilter interface java.io.FilenameFilter (the hereby targeted class-under-test class)
 * @see FilenameFilterTests FilenameFilterTests (The complementary j8unit test interface containing the instance
...
public abstract interface FilenameFilterClassTests<SUT extends java.io.FilenameFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FilenameFilter.class!",
                   java.io.FilenameFilter.class.isAssignableFrom(sut));
    }

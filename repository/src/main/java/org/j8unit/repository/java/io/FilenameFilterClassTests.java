 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FilenameFilter
...
public abstract interface FilenameFilterClassTests<SUT extends FilenameFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FilenameFilter.class!",
                   FilenameFilter.class.isAssignableFrom(sut));
    }

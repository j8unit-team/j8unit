 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConnectExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConnectExceptionTests}.
 * </p>
 *
 * @see java.net.ConnectException class java.net.ConnectException (the hereby targeted class-under-test class)
 * @see ConnectExceptionTests ConnectExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ConnectExceptionClassTests<SUT extends java.net.ConnectException>
extends SocketExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.ConnectException.class!",
                   java.net.ConnectException.class.isAssignableFrom(sut));
    }

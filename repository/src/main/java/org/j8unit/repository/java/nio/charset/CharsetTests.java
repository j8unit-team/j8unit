 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link Charset public
 ...
 * {@link org.j8unit.repository.java.nio.charset.CharsetClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface CharsetTests<SUT extends Charset>
extends org.j8unit.repository.java.lang.ComparableTests<SUT, Charset>, org.j8unit.repository.java.lang.ObjectTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_contains_Charset()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_displayName()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

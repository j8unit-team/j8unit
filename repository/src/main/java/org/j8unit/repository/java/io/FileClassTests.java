 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link File public class
 * java.io.File}.
 *
...
public abstract interface FileClassTests<SUT extends File>
extends SerializableClassTests<SUT>, ComparableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to File.class!", File.class.isAssignableFrom(sut));
    }

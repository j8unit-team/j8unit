...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.File class java.io.File}, containing all type relevant aspects
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileTests}.
 * </p>
 *
 * @see java.io.File class java.io.File (the hereby targeted class-under-test class)
 * @see FileTests FileTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.File.class!",
                   java.io.File.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseInfo public
...
public abstract interface MouseInfoClassTests<SUT extends MouseInfo>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.MouseInfo]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseInfo.class!",
                   MouseInfo.class.isAssignableFrom(sut));
    }

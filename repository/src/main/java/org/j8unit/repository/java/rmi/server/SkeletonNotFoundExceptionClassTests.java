 ...
 * {@link SkeletonNotFoundException public class java.rmi.server.SkeletonNotFoundException}.
 *
 ...
 * {@link SkeletonNotFoundExceptionTests}.
 * </p>
 *
 * <p>
...
public abstract interface SkeletonNotFoundExceptionClassTests<SUT extends SkeletonNotFoundException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SkeletonNotFoundException.class!",
                   SkeletonNotFoundException.class.isAssignableFrom(sut));
    }

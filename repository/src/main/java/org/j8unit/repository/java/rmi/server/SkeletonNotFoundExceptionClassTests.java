 ...
 * java.rmi.server.SkeletonNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see SkeletonNotFoundExceptionTests SkeletonNotFoundExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.SkeletonNotFoundException.class!",
                   java.rmi.server.SkeletonNotFoundException.class.isAssignableFrom(sut));
    }

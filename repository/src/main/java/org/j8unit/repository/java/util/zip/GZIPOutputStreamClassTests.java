 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GZIPOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GZIPOutputStreamTests}.
 * </p>
 *
 * @see java.util.zip.GZIPOutputStream class java.util.zip.GZIPOutputStream (the hereby targeted class-under-test class)
 * @see GZIPOutputStreamTests GZIPOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface GZIPOutputStreamClassTests<SUT extends java.util.zip.GZIPOutputStream>
extends DeflaterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.GZIPOutputStream.class!",
                   java.util.zip.GZIPOutputStream.class.isAssignableFrom(sut));
    }

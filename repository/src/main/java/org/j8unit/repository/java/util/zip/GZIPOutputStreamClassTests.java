 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GZIPOutputStream
...
public abstract interface GZIPOutputStreamClassTests<SUT extends GZIPOutputStream>
extends DeflaterOutputStreamClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.zip.GZIPOutputStream]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GZIPOutputStream.class!",
                   GZIPOutputStream.class.isAssignableFrom(sut));
    }

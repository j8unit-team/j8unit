 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotOwnerException
...
public abstract interface NotOwnerExceptionClassTests<SUT extends NotOwnerException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotOwnerException.class!",
                   NotOwnerException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.acl.NotOwnerException]

 ...
 * java.security.acl.NotOwnerException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotOwnerExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotOwnerExceptionTests}.
 * </p>
 *
 * @see java.security.acl.NotOwnerException class java.security.acl.NotOwnerException (the hereby targeted
 *      class-under-test class)
 * @see NotOwnerExceptionTests NotOwnerExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface NotOwnerExceptionClassTests<SUT extends java.security.acl.NotOwnerException>
extends org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.acl.NotOwnerException.class!",
                   java.security.acl.NotOwnerException.class.isAssignableFrom(sut));
    }

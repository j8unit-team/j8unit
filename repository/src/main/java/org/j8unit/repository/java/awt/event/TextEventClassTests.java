...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.TextEvent class java.awt.event.TextEvent}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextEventTests}.
 * </p>
 *
 * @see java.awt.event.TextEvent class java.awt.event.TextEvent (the hereby targeted class-under-test class)
 * @see TextEventTests TextEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TextEventClassTests<SUT extends java.awt.event.TextEvent>
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.TextEvent.class!",
                   java.awt.event.TextEvent.class.isAssignableFrom(sut));
    }

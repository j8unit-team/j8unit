 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TextEvent public
...
public abstract interface TextEventClassTests<SUT extends TextEvent>
extends AWTEventClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.event.TextEvent]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TextEvent.class!",
                   TextEvent.class.isAssignableFrom(sut));
    }

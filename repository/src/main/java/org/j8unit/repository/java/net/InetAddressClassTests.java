 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InetAddress public
...
public abstract interface InetAddressClassTests<SUT extends InetAddress>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.net.InetAddress]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InetAddress.class!",
                   InetAddress.class.isAssignableFrom(sut));
    }

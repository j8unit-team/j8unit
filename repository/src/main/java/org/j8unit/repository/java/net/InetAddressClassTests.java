...
/**
 * <p>
 * Test class for {@link java.net.InetAddress class java.net.InetAddress}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.net.InetAddressTests}.
 * </p>
 *
 * <p>

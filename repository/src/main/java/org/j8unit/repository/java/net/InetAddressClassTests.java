...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.InetAddress class java.net.InetAddress}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InetAddressTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InetAddressTests}.
 * </p>
 *
 * @see java.net.InetAddress class java.net.InetAddress (the hereby targeted class-under-test class)
 * @see InetAddressTests InetAddressTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.InetAddress.class!",
                   java.net.InetAddress.class.isAssignableFrom(sut));
    }

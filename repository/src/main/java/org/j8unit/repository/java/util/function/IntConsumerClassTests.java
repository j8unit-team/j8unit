...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.IntConsumer interface
 * java.util.function.IntConsumer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntConsumerTests}.
 * </p>
 *
 * @see java.util.function.IntConsumer interface java.util.function.IntConsumer (the hereby targeted class-under-test
 *      class)
 * @see IntConsumerTests IntConsumerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IntConsumerClassTests<SUT extends java.util.function.IntConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntConsumer.class!",
                   java.util.function.IntConsumer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntConsumer public
 * abstract interface java.util.function.IntConsumer}.
 *
...
public abstract interface IntConsumerClassTests<SUT extends IntConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntConsumer.class!",
                   IntConsumer.class.isAssignableFrom(sut));
    }

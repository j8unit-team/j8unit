...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.im.spi.InputMethod interface java.awt.im.spi.InputMethod},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputMethodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InputMethodTests}.
 * </p>
 *
 * @see java.awt.im.spi.InputMethod interface java.awt.im.spi.InputMethod (the hereby targeted class-under-test class)
 * @see InputMethodTests InputMethodTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InputMethodClassTests<SUT extends java.awt.im.spi.InputMethod>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.im.spi.InputMethod.class!",
                   java.awt.im.spi.InputMethod.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMethod public
 * abstract interface java.awt.im.spi.InputMethod}.
 *
...
public abstract interface InputMethodClassTests<SUT extends InputMethod>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMethod.class!",
                   InputMethod.class.isAssignableFrom(sut));
    }

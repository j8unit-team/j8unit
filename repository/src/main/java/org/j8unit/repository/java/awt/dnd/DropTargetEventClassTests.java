 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DropTargetEvent
 * public class java.awt.dnd.DropTargetEvent}.
 *
...
public abstract interface DropTargetEventClassTests<SUT extends DropTargetEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DropTargetEvent.class!",
                   DropTargetEvent.class.isAssignableFrom(sut));
    }

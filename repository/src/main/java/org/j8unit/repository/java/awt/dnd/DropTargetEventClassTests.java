 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DropTargetEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DropTargetEventTests}.
 * </p>
 *
 * @see java.awt.dnd.DropTargetEvent class java.awt.dnd.DropTargetEvent (the hereby targeted class-under-test class)
 * @see DropTargetEventTests DropTargetEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface DropTargetEventClassTests<SUT extends java.awt.dnd.DropTargetEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DropTargetEvent.class!",
                   java.awt.dnd.DropTargetEvent.class.isAssignableFrom(sut));
    }

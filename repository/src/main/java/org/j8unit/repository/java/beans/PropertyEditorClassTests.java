 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PropertyEditor
...
public abstract interface PropertyEditorClassTests<SUT extends PropertyEditor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PropertyEditor.class!",
                   PropertyEditor.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.PropertyEditor interface java.beans.PropertyEditor},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PropertyEditorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PropertyEditorTests}.
 * </p>
 *
 * @see java.beans.PropertyEditor interface java.beans.PropertyEditor (the hereby targeted class-under-test class)
 * @see PropertyEditorTests PropertyEditorTests (The complementary j8unit test interface containing the instance
...
public abstract interface PropertyEditorClassTests<SUT extends java.beans.PropertyEditor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.PropertyEditor.class!",
                   java.beans.PropertyEditor.class.isAssignableFrom(sut));
    }

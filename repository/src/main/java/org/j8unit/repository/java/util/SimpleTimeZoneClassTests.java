...
/**
 * <p>
 * Reusable J8Unit test interface for {@linkplain java.util.SimpleTimeZone class java.util.SimpleTimeZone}, containing
 * all class relevant test methods (at least the test methods of accessible constructors and of accessible
 * {@code static} methods). The counterpart J8Unit test interface containing the instance relevant test methods is
 * {@link org.j8unit.repository.java.util.SimpleTimeZoneTests}.
 * </p>
 *
 * <p>
 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.SimpleTimeZone
 */
@FunctionalInterface
@Category(J8UnitRepository.class)
public abstract interface SimpleTimeZoneClassTests<SUT extends java.util.SimpleTimeZone>
extends org.j8unit.repository.java.util.TimeZoneClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.SimpleTimeZone#SimpleTimeZone(int, java.lang.String)
     */
     ...
     * <p>
     * Test method for
     * {@link java.util.SimpleTimeZone#SimpleTimeZone(int, java.lang.String, int, int, int, int, int, int, int, int)
     ...
     * </p>
     *
     * @j8unit.aim java.util.SimpleTimeZone#SimpleTimeZone(int, java.lang.String, int, int, int, int, int, int, int,
     *             int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.SimpleTimeZone sut = null; // = new SimpleTimeZone(int, java.lang.String, int, int, int, int,
                                                   // int, int, int, int);
    }
     ...
     * <p>
     * Test method for
     * {@link java.util.SimpleTimeZone#SimpleTimeZone(int, java.lang.String, int, int, int, int, int, int, int, int, int)
    ...
    @Test
    @Category(Draft.class)
    public default void create_SimpleTimeZone_int_String_int_int_int_int_int_int_int_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.SimpleTimeZone sut = null; // = new SimpleTimeZone(int, java.lang.String, int, int, int, int,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.SimpleTimeZone#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

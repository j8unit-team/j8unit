 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleTimeZoneTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleTimeZoneTests}.
 * </p>
 *
 * @see java.util.SimpleTimeZone class java.util.SimpleTimeZone (the hereby targeted class-under-test class)
 * @see SimpleTimeZoneTests SimpleTimeZoneTests (The complementary j8unit test interface containing the instance
...
extends TimeZoneClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.SimpleTimeZone.class!",
                   java.util.SimpleTimeZone.class.isAssignableFrom(sut));
    }

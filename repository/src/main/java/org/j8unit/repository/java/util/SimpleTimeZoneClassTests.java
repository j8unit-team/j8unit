...
/**
 * <p>
 * Test class for {@link java.util.SimpleTimeZone class java.util.SimpleTimeZone}, containing all class relevant test
...
extends org.j8unit.repository.java.util.TimeZoneClassTests<SUT> {
    ...
    /**
     * Test method for
     * {@link java.util.SimpleTimeZone#SimpleTimeZone(int,java.lang.String,int,int,int,int,int,int,int,int,int) public

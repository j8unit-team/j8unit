 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardProtocolFamilyTests}).
 * </p>
 *
 * <p>
 ...
 * {@link StandardProtocolFamilyTests}.
 * </p>
 *
 * @see java.net.StandardProtocolFamily class java.net.StandardProtocolFamily (the hereby targeted class-under-test
 *      class)
 * @see StandardProtocolFamilyTests StandardProtocolFamilyTests (The complementary j8unit test interface containing the
...
public abstract interface StandardProtocolFamilyClassTests<SUT extends java.net.StandardProtocolFamily>
extends ProtocolFamilyClassTests<SUT>, org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.StandardProtocolFamily.class!",
                   java.net.StandardProtocolFamily.class.isAssignableFrom(sut));
    }

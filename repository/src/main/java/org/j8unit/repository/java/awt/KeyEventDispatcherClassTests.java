 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyEventDispatcher
 * public abstract interface java.awt.KeyEventDispatcher}.
 *
...
public abstract interface KeyEventDispatcherClassTests<SUT extends KeyEventDispatcher>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyEventDispatcher.class!",
                   KeyEventDispatcher.class.isAssignableFrom(sut));
    }

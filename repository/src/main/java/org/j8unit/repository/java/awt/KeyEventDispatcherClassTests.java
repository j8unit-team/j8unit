...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.KeyEventDispatcher interface java.awt.KeyEventDispatcher},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyEventDispatcherTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyEventDispatcherTests}.
 * </p>
 *
 * @see java.awt.KeyEventDispatcher interface java.awt.KeyEventDispatcher (the hereby targeted class-under-test class)
 * @see KeyEventDispatcherTests KeyEventDispatcherTests (The complementary j8unit test interface containing the instance
...
public abstract interface KeyEventDispatcherClassTests<SUT extends java.awt.KeyEventDispatcher>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.KeyEventDispatcher.class!",
                   java.awt.KeyEventDispatcher.class.isAssignableFrom(sut));
    }

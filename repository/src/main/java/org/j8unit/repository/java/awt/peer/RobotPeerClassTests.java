...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.RobotPeer interface java.awt.peer.RobotPeer}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RobotPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RobotPeerTests}.
 * </p>
 *
 * @see java.awt.peer.RobotPeer interface java.awt.peer.RobotPeer (the hereby targeted class-under-test class)
 * @see RobotPeerTests RobotPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RobotPeerClassTests<SUT extends java.awt.peer.RobotPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.RobotPeer.class!",
                   java.awt.peer.RobotPeer.class.isAssignableFrom(sut));
    }

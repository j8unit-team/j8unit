 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RobotPeer public
 * abstract interface java.awt.peer.RobotPeer}.
 *
...
public abstract interface RobotPeerClassTests<SUT extends RobotPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RobotPeer.class!",
                   RobotPeer.class.isAssignableFrom(sut));
    }

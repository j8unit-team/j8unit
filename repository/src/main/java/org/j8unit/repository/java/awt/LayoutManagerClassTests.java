 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LayoutManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LayoutManagerTests}.
 * </p>
 *
 * @see java.awt.LayoutManager interface java.awt.LayoutManager (the hereby targeted class-under-test class)
 * @see LayoutManagerTests LayoutManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LayoutManagerClassTests<SUT extends java.awt.LayoutManager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.LayoutManager.class!",
                   java.awt.LayoutManager.class.isAssignableFrom(sut));
    }

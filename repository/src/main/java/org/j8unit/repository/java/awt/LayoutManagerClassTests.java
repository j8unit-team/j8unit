 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LayoutManager
...
public abstract interface LayoutManagerClassTests<SUT extends LayoutManager>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LayoutManager.class!",
                   LayoutManager.class.isAssignableFrom(sut));
    }

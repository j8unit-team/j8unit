...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.LongBuffer class java.nio.LongBuffer}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongBufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongBufferTests}.
 * </p>
 *
 * @see java.nio.LongBuffer class java.nio.LongBuffer (the hereby targeted class-under-test class)
 * @see LongBufferTests LongBufferTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.LongBuffer.class!",
                   java.nio.LongBuffer.class.isAssignableFrom(sut));
    }

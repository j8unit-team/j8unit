 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongBuffer public
 * abstract class java.nio.LongBuffer}.
 *
...
public abstract interface LongBufferClassTests<SUT extends LongBuffer>
extends ComparableClassTests<SUT>, BufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongBuffer.class!",
                   LongBuffer.class.isAssignableFrom(sut));
    }

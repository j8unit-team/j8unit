 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Buffer public
...
public abstract interface BufferClassTests<SUT extends Buffer>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Buffer.class!",
                   Buffer.class.isAssignableFrom(sut));
    }

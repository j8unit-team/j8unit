...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.Buffer class java.nio.Buffer}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferTests}.
 * </p>
 *
 * @see java.nio.Buffer class java.nio.Buffer (the hereby targeted class-under-test class)
 * @see BufferTests BufferTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface BufferClassTests<SUT extends java.nio.Buffer>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.Buffer.class!",
                   java.nio.Buffer.class.isAssignableFrom(sut));
    }

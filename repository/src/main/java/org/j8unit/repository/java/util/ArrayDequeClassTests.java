...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.ArrayDeque class java.util.ArrayDeque}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ArrayDequeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ArrayDequeTests}.
 * </p>
 *
 * @see java.util.ArrayDeque class java.util.ArrayDeque (the hereby targeted class-under-test class)
 * @see ArrayDequeTests ArrayDequeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends DequeClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.ArrayDeque.class!",
                   java.util.ArrayDeque.class.isAssignableFrom(sut));
    }

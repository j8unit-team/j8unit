 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ArrayDeque public
...
public abstract interface ArrayDequeClassTests<SUT extends ArrayDeque>
extends DequeClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, AbstractCollectionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.ArrayDeque]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ArrayDeque.class!",
                   ArrayDeque.class.isAssignableFrom(sut));
    }

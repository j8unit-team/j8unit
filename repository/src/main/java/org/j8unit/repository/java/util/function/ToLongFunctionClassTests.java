...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.ToLongFunction interface
 * java.util.function.ToLongFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToLongFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToLongFunctionTests}.
 * </p>
 *
 * @see java.util.function.ToLongFunction interface java.util.function.ToLongFunction (the hereby targeted
 *      class-under-test class)
 * @see ToLongFunctionTests ToLongFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ToLongFunctionClassTests<SUT extends java.util.function.ToLongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ToLongFunction.class!",
                   java.util.function.ToLongFunction.class.isAssignableFrom(sut));
    }

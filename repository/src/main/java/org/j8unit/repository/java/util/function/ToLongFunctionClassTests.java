 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToLongFunction
 * public abstract interface java.util.function.ToLongFunction<T>}.
 *
...
public abstract interface ToLongFunctionClassTests<SUT extends ToLongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToLongFunction.class!",
                   ToLongFunction.class.isAssignableFrom(sut));
    }

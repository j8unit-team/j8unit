 ...
 * {@link DeflaterOutputStreamTests}.
 * </p>
 *
 * <p>
...
public abstract interface DeflaterOutputStreamClassTests<SUT extends DeflaterOutputStream>
extends FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DeflaterOutputStream.class!",
                   DeflaterOutputStream.class.isAssignableFrom(sut));
    }

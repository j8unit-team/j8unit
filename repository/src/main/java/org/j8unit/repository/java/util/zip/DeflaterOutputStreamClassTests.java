...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.zip.DeflaterOutputStream class
 * java.util.zip.DeflaterOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DeflaterOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DeflaterOutputStreamTests}
 * .
 * </p>
 *
 * @see java.util.zip.DeflaterOutputStream class java.util.zip.DeflaterOutputStream (the hereby targeted
 *      class-under-test class)
 * @see DeflaterOutputStreamTests DeflaterOutputStreamTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.DeflaterOutputStream.class!",
                   java.util.zip.DeflaterOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Printable public
...
public abstract interface PrintableClassTests<SUT extends Printable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Printable.class!",
                   Printable.class.isAssignableFrom(sut));
    }

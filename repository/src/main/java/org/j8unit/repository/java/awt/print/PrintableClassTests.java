 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PrintableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PrintableTests}.
 * </p>
 *
 * @see java.awt.print.Printable interface java.awt.print.Printable (the hereby targeted class-under-test class)
 * @see PrintableTests PrintableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PrintableClassTests<SUT extends java.awt.print.Printable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.Printable.class!",
                   java.awt.print.Printable.class.isAssignableFrom(sut));
    }

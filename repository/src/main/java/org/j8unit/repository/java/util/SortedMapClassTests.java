...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.SortedMap interface java.util.SortedMap}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SortedMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SortedMapTests}.
 * </p>
 *
 * @see java.util.SortedMap interface java.util.SortedMap (the hereby targeted class-under-test class)
 * @see SortedMapTests SortedMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends MapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.SortedMap.class!",
                   java.util.SortedMap.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SortedMap public
 * abstract interface java.util.SortedMap<K,V>}.
 *
...
public abstract interface SortedMapClassTests<SUT extends SortedMap>
extends MapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SortedMap.class!",
                   SortedMap.class.isAssignableFrom(sut));
    }

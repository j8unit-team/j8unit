...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.HeadlessException class java.awt.HeadlessException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HeadlessExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HeadlessExceptionTests}.
 * </p>
 *
 * @see java.awt.HeadlessException class java.awt.HeadlessException (the hereby targeted class-under-test class)
 * @see HeadlessExceptionTests HeadlessExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface HeadlessExceptionClassTests<SUT extends java.awt.HeadlessException>
extends org.j8unit.repository.java.lang.UnsupportedOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.HeadlessException.class!",
                   java.awt.HeadlessException.class.isAssignableFrom(sut));
    }

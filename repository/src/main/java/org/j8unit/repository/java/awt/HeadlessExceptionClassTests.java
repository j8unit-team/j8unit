 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HeadlessException
 * public class java.awt.HeadlessException}.
 *
...
public abstract interface HeadlessExceptionClassTests<SUT extends HeadlessException>
extends UnsupportedOperationExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HeadlessException.class!",
                   HeadlessException.class.isAssignableFrom(sut));
    }

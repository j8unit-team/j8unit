 ...
 * java.nio.file.attribute.UserPrincipalNotFoundException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UserPrincipalNotFoundExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UserPrincipalNotFoundExceptionTests UserPrincipalNotFoundExceptionTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.UserPrincipalNotFoundException.class!",
                   java.nio.file.attribute.UserPrincipalNotFoundException.class.isAssignableFrom(sut));
    }

...
public abstract interface UserPrincipalNotFoundExceptionClassTests<SUT extends UserPrincipalNotFoundException>
extends org.j8unit.repository.java.io.IOExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UserPrincipalNotFoundException.class!",
                   UserPrincipalNotFoundException.class.isAssignableFrom(sut));
    }

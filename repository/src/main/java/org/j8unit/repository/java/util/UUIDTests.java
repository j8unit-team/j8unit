...
/**
 * <p>
 * Test class for {@link java.util.UUID class java.util.UUID}, containing all instance relevant test methods
 ...
 * @since 0.9.0
 * @see org.j8unit.repository.java.util.UUIDClassTests
 */
@FunctionalInterface
...
org.j8unit.repository.java.lang.ObjectTests<SUT> {
    ...
    public default void test_clockSequence()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_compareTo_UUID()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link java.util.UUID#equals(java.lang.Object) public boolean
    ...
    @Test
    @Category(Draft.class)
    public default void test_getLeastSignificantBits()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getMostSignificantBits()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_timestamp()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_variant()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Customizer public
 * abstract interface java.beans.Customizer}.
 *
...
public abstract interface CustomizerClassTests<SUT extends Customizer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Customizer.class!",
                   Customizer.class.isAssignableFrom(sut));
    }

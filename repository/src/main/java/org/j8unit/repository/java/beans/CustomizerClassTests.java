...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.beans.Customizer interface java.beans.Customizer}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CustomizerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CustomizerTests}.
 * </p>
 *
 * @see java.beans.Customizer interface java.beans.Customizer (the hereby targeted class-under-test class)
 * @see CustomizerTests CustomizerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CustomizerClassTests<SUT extends java.beans.Customizer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.Customizer.class!",
                   java.beans.Customizer.class.isAssignableFrom(sut));
    }

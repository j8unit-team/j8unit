...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.SocketImpl class java.net.SocketImpl}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketImplTests}.
 * </p>
 *
 * @see java.net.SocketImpl class java.net.SocketImpl (the hereby targeted class-under-test class)
 * @see SocketImplTests SocketImplTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SocketImplClassTests<SUT extends java.net.SocketImpl>
extends SocketOptionsClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketImpl.class!",
                   java.net.SocketImpl.class.isAssignableFrom(sut));
    }

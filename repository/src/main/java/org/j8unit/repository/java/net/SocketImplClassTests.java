 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketImpl public
 * abstract class java.net.SocketImpl}.
 *
...
public abstract interface SocketImplClassTests<SUT extends SocketImpl>
extends org.j8unit.repository.java.net.SocketOptionsClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketImpl.class!",
                   SocketImpl.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.net.SocketImpl]

 ...
 * java.util.MissingResourceException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MissingResourceExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see MissingResourceExceptionTests MissingResourceExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.MissingResourceException.class!",
                   java.util.MissingResourceException.class.isAssignableFrom(sut));
    }

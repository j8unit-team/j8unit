...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Appendable interface java.lang.Appendable}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AppendableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AppendableTests}.
 * </p>
 *
 * @see Appendable interface java.lang.Appendable (the hereby targeted class-under-test class)
 * @see AppendableTests AppendableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AppendableClassTests<SUT extends Appendable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Appendable.class!",
                   Appendable.class.isAssignableFrom(sut));
    }

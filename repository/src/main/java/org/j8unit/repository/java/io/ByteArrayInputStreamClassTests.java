 ...
 * {@link ByteArrayInputStream public class java.io.ByteArrayInputStream}.
 *
...
public abstract interface ByteArrayInputStreamClassTests<SUT extends ByteArrayInputStream>
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ByteArrayInputStream.class!",
                   ByteArrayInputStream.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ByteArrayInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ByteArrayInputStreamTests}
 * .
 * </p>
 *
 * @see java.io.ByteArrayInputStream class java.io.ByteArrayInputStream (the hereby targeted class-under-test class)
 * @see ByteArrayInputStreamTests ByteArrayInputStreamTests (The complementary j8unit test interface containing the
...
extends InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ByteArrayInputStream.class!",
                   java.io.ByteArrayInputStream.class.isAssignableFrom(sut));
    }

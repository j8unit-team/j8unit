 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectStreamClassTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectStreamClassTests}.
 * </p>
 *
 * @see java.io.ObjectStreamClass class java.io.ObjectStreamClass (the hereby targeted class-under-test class)
 * @see ObjectStreamClassTests ObjectStreamClassTests (The complementary j8unit test interface containing the instance
...
public abstract interface ObjectStreamClassClassTests<SUT extends java.io.ObjectStreamClass>
extends SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectStreamClass.class!",
                   java.io.ObjectStreamClass.class.isAssignableFrom(sut));
    }

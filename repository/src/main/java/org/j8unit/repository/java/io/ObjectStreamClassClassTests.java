 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectStreamClass
...
public abstract interface ObjectStreamClassClassTests<SUT extends ObjectStreamClass>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.ObjectStreamClass]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectStreamClass.class!",
                   ObjectStreamClass.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URLConnection
...
public abstract interface URLConnectionClassTests<SUT extends URLConnection>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLConnection.class!",
                   URLConnection.class.isAssignableFrom(sut));
    }

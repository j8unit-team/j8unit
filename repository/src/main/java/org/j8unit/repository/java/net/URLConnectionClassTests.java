 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLConnectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URLConnectionTests}.
 * </p>
 *
 * @see java.net.URLConnection class java.net.URLConnection (the hereby targeted class-under-test class)
 * @see URLConnectionTests URLConnectionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URLConnection.class!",
                   java.net.URLConnection.class.isAssignableFrom(sut));
    }

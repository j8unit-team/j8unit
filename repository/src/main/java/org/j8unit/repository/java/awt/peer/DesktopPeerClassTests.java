 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DesktopPeer public
 * abstract interface java.awt.peer.DesktopPeer}.
 *
...
public abstract interface DesktopPeerClassTests<SUT extends DesktopPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DesktopPeer.class!",
                   DesktopPeer.class.isAssignableFrom(sut));
    }

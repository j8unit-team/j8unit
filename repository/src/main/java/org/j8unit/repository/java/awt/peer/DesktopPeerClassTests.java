...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.DesktopPeer interface java.awt.peer.DesktopPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DesktopPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DesktopPeerTests}.
 * </p>
 *
 * @see java.awt.peer.DesktopPeer interface java.awt.peer.DesktopPeer (the hereby targeted class-under-test class)
 * @see DesktopPeerTests DesktopPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DesktopPeerClassTests<SUT extends java.awt.peer.DesktopPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.DesktopPeer.class!",
                   java.awt.peer.DesktopPeer.class.isAssignableFrom(sut));
    }

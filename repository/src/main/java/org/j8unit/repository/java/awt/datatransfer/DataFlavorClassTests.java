 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataFlavor public
...
public abstract interface DataFlavorClassTests<SUT extends DataFlavor>
extends ExternalizableClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataFlavor.class!",
                   DataFlavor.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.datatransfer.DataFlavor]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferedWriter
...
public abstract interface BufferedWriterClassTests<SUT extends BufferedWriter>
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferedWriter.class!",
                   BufferedWriter.class.isAssignableFrom(sut));
    }

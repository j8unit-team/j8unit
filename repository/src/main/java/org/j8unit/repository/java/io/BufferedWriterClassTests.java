 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferedWriterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferedWriterTests}.
 * </p>
 *
 * @see java.io.BufferedWriter class java.io.BufferedWriter (the hereby targeted class-under-test class)
 * @see BufferedWriterTests BufferedWriterTests (The complementary j8unit test interface containing the instance
...
extends WriterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.BufferedWriter.class!",
                   java.io.BufferedWriter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateTimeException
 * public class java.time.DateTimeException}.
 *
...
public abstract interface DateTimeExceptionClassTests<SUT extends DateTimeException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateTimeException.class!",
                   DateTimeException.class.isAssignableFrom(sut));
    }

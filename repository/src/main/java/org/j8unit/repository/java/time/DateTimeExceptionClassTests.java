...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.DateTimeException class java.time.DateTimeException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTimeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateTimeExceptionTests}.
 * </p>
 *
 * @see java.time.DateTimeException class java.time.DateTimeException (the hereby targeted class-under-test class)
 * @see DateTimeExceptionTests DateTimeExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface DateTimeExceptionClassTests<SUT extends java.time.DateTimeException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.DateTimeException.class!",
                   java.time.DateTimeException.class.isAssignableFrom(sut));
    }

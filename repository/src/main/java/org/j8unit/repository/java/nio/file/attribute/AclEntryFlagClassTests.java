...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.attribute.AclEntryFlag class
 * java.nio.file.attribute.AclEntryFlag}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AclEntryFlagTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AclEntryFlagTests}.
 * </p>
 *
 * @see java.nio.file.attribute.AclEntryFlag class java.nio.file.attribute.AclEntryFlag (the hereby targeted
 *      class-under-test class)
 * @see AclEntryFlagTests AclEntryFlagTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AclEntryFlagClassTests<SUT extends java.nio.file.attribute.AclEntryFlag>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.AclEntryFlag.class!",
                   java.nio.file.attribute.AclEntryFlag.class.isAssignableFrom(sut));
    }

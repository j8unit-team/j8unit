 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AclEntryFlag public
 * final enum java.nio.file.attribute.AclEntryFlag}.
 *
...
public abstract interface AclEntryFlagClassTests<SUT extends AclEntryFlag>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AclEntryFlag.class!",
                   AclEntryFlag.class.isAssignableFrom(sut));
    }

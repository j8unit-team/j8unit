 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Group public
 * abstract interface java.security.acl.Group}.
 *
...
public abstract interface GroupClassTests<SUT extends Group>
extends PrincipalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Group.class!", Group.class.isAssignableFrom(sut));
    }

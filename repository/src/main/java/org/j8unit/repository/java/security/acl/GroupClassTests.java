 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GroupTests}).
 * </p>
 *
 * <p>
 ...
 * @see GroupTests GroupTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface GroupClassTests<SUT extends java.security.acl.Group>
extends org.j8unit.repository.java.security.PrincipalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.acl.Group.class!",
                   java.security.acl.Group.class.isAssignableFrom(sut));
    }

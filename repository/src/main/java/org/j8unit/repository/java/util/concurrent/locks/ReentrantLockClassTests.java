 ...
 * java.util.concurrent.locks.ReentrantLock}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReentrantLockTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ReentrantLockTests}.
 * </p>
 *
 * @see java.util.concurrent.locks.ReentrantLock class java.util.concurrent.locks.ReentrantLock (the hereby targeted
 *      class-under-test class)
 * @see ReentrantLockTests ReentrantLockTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ReentrantLockClassTests<SUT extends java.util.concurrent.locks.ReentrantLock>
extends LockClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.locks.ReentrantLock.class!",
                   java.util.concurrent.locks.ReentrantLock.class.isAssignableFrom(sut));
    }

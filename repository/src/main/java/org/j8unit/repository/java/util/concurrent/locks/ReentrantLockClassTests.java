 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ReentrantLock
...
public abstract interface ReentrantLockClassTests<SUT extends ReentrantLock>
extends LockClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.concurrent.locks.ReentrantLock]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ReentrantLock.class!",
                   ReentrantLock.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.concurrent.locks.ReentrantLock]

 ...
 * java.util.prefs.NodeChangeListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NodeChangeListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NodeChangeListenerTests}.
 * </p>
 *
 * @see java.util.prefs.NodeChangeListener interface java.util.prefs.NodeChangeListener (the hereby targeted
 *      class-under-test class)
 * @see NodeChangeListenerTests NodeChangeListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface NodeChangeListenerClassTests<SUT extends java.util.prefs.NodeChangeListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.NodeChangeListener.class!",
                   java.util.prefs.NodeChangeListener.class.isAssignableFrom(sut));
    }

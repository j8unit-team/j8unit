 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NodeChangeListener
 * public abstract interface java.util.prefs.NodeChangeListener}.
 *
...
public abstract interface NodeChangeListenerClassTests<SUT extends NodeChangeListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NodeChangeListener.class!",
                   NodeChangeListener.class.isAssignableFrom(sut));
    }

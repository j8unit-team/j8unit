 ...
 * java.awt.im.spi.InputMethodDescriptor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputMethodDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 * {@link InputMethodDescriptorTests}.
 * </p>
 *
 * @see java.awt.im.spi.InputMethodDescriptor interface java.awt.im.spi.InputMethodDescriptor (the hereby targeted
 *      class-under-test class)
 * @see InputMethodDescriptorTests InputMethodDescriptorTests (The complementary j8unit test interface containing the
...
public abstract interface InputMethodDescriptorClassTests<SUT extends java.awt.im.spi.InputMethodDescriptor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.im.spi.InputMethodDescriptor.class!",
                   java.awt.im.spi.InputMethodDescriptor.class.isAssignableFrom(sut));
    }

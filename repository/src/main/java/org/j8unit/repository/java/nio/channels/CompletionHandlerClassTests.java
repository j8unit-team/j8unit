 ...
 * java.nio.channels.CompletionHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompletionHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompletionHandlerTests}.
 * </p>
 *
 * @see java.nio.channels.CompletionHandler interface java.nio.channels.CompletionHandler (the hereby targeted
 *      class-under-test class)
 * @see CompletionHandlerTests CompletionHandlerTests (The complementary j8unit test interface containing the instance
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.CompletionHandler.class!",
                   java.nio.channels.CompletionHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompletionHandler
 * public abstract interface java.nio.channels.CompletionHandler<V,A>}.
 *
...
public abstract interface CompletionHandlerClassTests<SUT extends CompletionHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompletionHandler.class!",

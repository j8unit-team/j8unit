...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Formatter class java.util.Formatter}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FormatterTests}.
 * </p>
 *
 * @see java.util.Formatter class java.util.Formatter (the hereby targeted class-under-test class)
 * @see FormatterTests FormatterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Formatter.class!",
                   java.util.Formatter.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.Formatter.BigDecimalLayoutForm class
     * java.util.Formatter$BigDecimalLayoutForm}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link FormatterTests.BigDecimalLayoutFormTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.util.Formatter.BigDecimalLayoutForm class java.util.Formatter$BigDecimalLayoutForm (the hereby targeted
     *      class-under-test class)
     * @see FormatterTests.BigDecimalLayoutFormTests FormatterTests.BigDecimalLayoutFormTests (The complementary j8unit
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Formatter.BigDecimalLayoutForm.class!",
                       java.util.Formatter.BigDecimalLayoutForm.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RoundingMode public
 * final enum java.math.RoundingMode}.
 *
...
public abstract interface RoundingModeClassTests<SUT extends RoundingMode>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RoundingMode.class!",
                   RoundingMode.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RoundingModeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RoundingModeTests}.
 * </p>
 *
 * @see java.math.RoundingMode class java.math.RoundingMode (the hereby targeted class-under-test class)
 * @see RoundingModeTests RoundingModeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface RoundingModeClassTests<SUT extends java.math.RoundingMode>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.math.RoundingMode.class!",
                   java.math.RoundingMode.class.isAssignableFrom(sut));
    }

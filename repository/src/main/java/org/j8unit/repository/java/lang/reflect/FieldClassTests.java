 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Field public final
...
public abstract interface FieldClassTests<SUT extends Field>
extends org.j8unit.repository.java.lang.reflect.MemberClassTests<SUT>, org.j8unit.repository.java.lang.reflect.AccessibleObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Field.class!", Field.class.isAssignableFrom(sut));
    }

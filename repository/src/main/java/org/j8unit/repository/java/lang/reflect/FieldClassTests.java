 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FieldTests}).
 * </p>
 *
 * <p>
 ...
 * @see FieldTests FieldTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface FieldClassTests<SUT extends java.lang.reflect.Field>
extends MemberClassTests<SUT>, AccessibleObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.Field.class!",
                   java.lang.reflect.Field.class.isAssignableFrom(sut));
    }

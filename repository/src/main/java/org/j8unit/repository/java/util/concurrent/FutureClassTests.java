 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Future public
 * abstract interface java.util.concurrent.Future<V>}.
 *
...
public abstract interface FutureClassTests<SUT extends Future>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Future.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.Future interface java.util.concurrent.Future},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FutureTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FutureTests}.
 * </p>
 *
 * @see java.util.concurrent.Future interface java.util.concurrent.Future (the hereby targeted class-under-test class)
 * @see FutureTests FutureTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Future.class!",
                   java.util.concurrent.Future.class.isAssignableFrom(sut));
    }

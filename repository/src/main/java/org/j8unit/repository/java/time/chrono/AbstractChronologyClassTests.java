...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.chrono.AbstractChronology class
 * java.time.chrono.AbstractChronology}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractChronologyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractChronologyTests}.
 * </p>
 *
 * @see java.time.chrono.AbstractChronology class java.time.chrono.AbstractChronology (the hereby targeted
 *      class-under-test class)
 * @see AbstractChronologyTests AbstractChronologyTests (The complementary j8unit test interface containing the instance
...
public abstract interface AbstractChronologyClassTests<SUT extends java.time.chrono.AbstractChronology>
extends ChronologyClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.AbstractChronology.class!",
                   java.time.chrono.AbstractChronology.class.isAssignableFrom(sut));
    }

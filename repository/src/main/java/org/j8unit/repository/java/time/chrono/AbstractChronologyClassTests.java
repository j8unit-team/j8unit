 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractChronology
 * public abstract class java.time.chrono.AbstractChronology}.
 *
...
public abstract interface AbstractChronologyClassTests<SUT extends AbstractChronology>
extends org.j8unit.repository.java.time.chrono.ChronologyClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractChronology.class!",
                   AbstractChronology.class.isAssignableFrom(sut));
    }

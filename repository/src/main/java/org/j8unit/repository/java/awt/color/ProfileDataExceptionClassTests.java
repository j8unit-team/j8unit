...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.color.ProfileDataException class
 * java.awt.color.ProfileDataException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ProfileDataExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ProfileDataExceptionTests}
 * .
 * </p>
 *
 * @see java.awt.color.ProfileDataException class java.awt.color.ProfileDataException (the hereby targeted
 *      class-under-test class)
 * @see ProfileDataExceptionTests ProfileDataExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface ProfileDataExceptionClassTests<SUT extends java.awt.color.ProfileDataException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.color.ProfileDataException.class!",
                   java.awt.color.ProfileDataException.class.isAssignableFrom(sut));
    }

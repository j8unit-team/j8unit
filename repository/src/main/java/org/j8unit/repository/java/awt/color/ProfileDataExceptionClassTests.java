...
public abstract interface ProfileDataExceptionClassTests<SUT extends ProfileDataException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProfileDataException.class!",
                   ProfileDataException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Selector public
...
public abstract interface SelectorClassTests<SUT extends Selector>
extends CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Selector.class!",
                   Selector.class.isAssignableFrom(sut));
    }

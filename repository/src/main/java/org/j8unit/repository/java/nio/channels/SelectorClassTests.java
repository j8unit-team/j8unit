...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.channels.Selector class java.nio.channels.Selector},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SelectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SelectorTests}.
 * </p>
 *
 * @see java.nio.channels.Selector class java.nio.channels.Selector (the hereby targeted class-under-test class)
 * @see SelectorTests SelectorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SelectorClassTests<SUT extends java.nio.channels.Selector>
extends org.j8unit.repository.java.io.CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.Selector.class!",
                   java.nio.channels.Selector.class.isAssignableFrom(sut));
    }

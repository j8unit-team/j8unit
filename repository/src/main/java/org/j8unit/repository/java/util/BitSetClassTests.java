...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.BitSet class java.util.BitSet}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BitSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BitSetTests}.
 * </p>
 *
 * @see java.util.BitSet class java.util.BitSet (the hereby targeted class-under-test class)
 * @see BitSetTests BitSetTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.BitSet.class!",
                   java.util.BitSet.class.isAssignableFrom(sut));
    }

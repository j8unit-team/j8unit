 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BitSet public class
 * java.util.BitSet}.
 *
...
public abstract interface BitSetClassTests<SUT extends BitSet>
extends CloneableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BitSet.class!",
                   BitSet.class.isAssignableFrom(sut));
    }

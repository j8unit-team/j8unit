 ...
 * java.security.cert.CertificateParsingException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link CertificateParsingExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see CertificateParsingExceptionTests CertificateParsingExceptionTests (The complementary j8unit test interface
...
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateParsingException.class!",
                   java.security.cert.CertificateParsingException.class.isAssignableFrom(sut));
    }

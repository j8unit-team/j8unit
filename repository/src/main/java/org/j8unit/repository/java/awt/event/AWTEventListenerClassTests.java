 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AWTEventListener
 * public abstract interface java.awt.event.AWTEventListener}.
 *
...
public abstract interface AWTEventListenerClassTests<SUT extends AWTEventListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AWTEventListener.class!",
                   AWTEventListener.class.isAssignableFrom(sut));
    }

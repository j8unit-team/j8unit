 ...
 * java.awt.event.AWTEventListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AWTEventListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AWTEventListenerTests}.
 * </p>
 *
 * @see java.awt.event.AWTEventListener interface java.awt.event.AWTEventListener (the hereby targeted class-under-test
 *      class)
 * @see AWTEventListenerTests AWTEventListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface AWTEventListenerClassTests<SUT extends java.awt.event.AWTEventListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.AWTEventListener.class!",
                   java.awt.event.AWTEventListener.class.isAssignableFrom(sut));
    }

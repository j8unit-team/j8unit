...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.logging.Level class java.util.logging.Level}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LevelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LevelTests}.
 * </p>
 *
 * @see java.util.logging.Level class java.util.logging.Level (the hereby targeted class-under-test class)
 * @see LevelTests LevelTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface LevelClassTests<SUT extends java.util.logging.Level>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.Level.class!",
                   java.util.logging.Level.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Level public class
...
public abstract interface LevelClassTests<SUT extends Level>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Level.class!", Level.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.event.AWTEventListenerProxy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AWTEventListenerProxyTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AWTEventListenerProxyTests}.
 * </p>
 *
 * @see java.awt.event.AWTEventListenerProxy class java.awt.event.AWTEventListenerProxy (the hereby targeted
 *      class-under-test class)
 * @see AWTEventListenerProxyTests AWTEventListenerProxyTests (The complementary j8unit test interface containing the
...
extends AWTEventListenerClassTests<SUT>, org.j8unit.repository.java.util.EventListenerProxyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.AWTEventListenerProxy.class!",
                   java.awt.event.AWTEventListenerProxy.class.isAssignableFrom(sut));
    }

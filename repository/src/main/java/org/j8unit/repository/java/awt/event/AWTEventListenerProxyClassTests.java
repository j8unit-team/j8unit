...
public abstract interface AWTEventListenerProxyClassTests<SUT extends AWTEventListenerProxy>
extends AWTEventListenerClassTests<SUT>, EventListenerProxyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AWTEventListenerProxy.class!",
                   AWTEventListenerProxy.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.LinkedHashSet class java.util.LinkedHashSet}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkedHashSetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkedHashSetTests}.
 * </p>
 *
 * @see java.util.LinkedHashSet class java.util.LinkedHashSet (the hereby targeted class-under-test class)
 * @see LinkedHashSetTests LinkedHashSetTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SetClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
HashSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.LinkedHashSet.class!",
                   java.util.LinkedHashSet.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkedHashSet
 * public class java.util.LinkedHashSet<E>}.
 *
...
public abstract interface LinkedHashSetClassTests<SUT extends LinkedHashSet>
extends HashSetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkedHashSet.class!",

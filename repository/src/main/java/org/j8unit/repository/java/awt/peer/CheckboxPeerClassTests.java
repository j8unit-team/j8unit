 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CheckboxPeer public
 * abstract interface java.awt.peer.CheckboxPeer}.
 *
...
public abstract interface CheckboxPeerClassTests<SUT extends CheckboxPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CheckboxPeer.class!",
                   CheckboxPeer.class.isAssignableFrom(sut));
    }

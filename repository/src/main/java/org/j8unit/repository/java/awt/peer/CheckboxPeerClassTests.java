 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CheckboxPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CheckboxPeerTests}.
 * </p>
 *
 * @see java.awt.peer.CheckboxPeer interface java.awt.peer.CheckboxPeer (the hereby targeted class-under-test class)
 * @see CheckboxPeerTests CheckboxPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CheckboxPeerClassTests<SUT extends java.awt.peer.CheckboxPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.CheckboxPeer.class!",
                   java.awt.peer.CheckboxPeer.class.isAssignableFrom(sut));
    }

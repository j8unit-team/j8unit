 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GenericDeclaration
 * public abstract interface java.lang.reflect.GenericDeclaration}.
 *
...
public abstract interface GenericDeclarationClassTests<SUT extends GenericDeclaration>
extends AnnotatedElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GenericDeclaration.class!",
                   GenericDeclaration.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.reflect.GenericDeclaration interface
 * java.lang.reflect.GenericDeclaration}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GenericDeclarationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GenericDeclarationTests}.
 * </p>
 *
 * @see java.lang.reflect.GenericDeclaration interface java.lang.reflect.GenericDeclaration (the hereby targeted
 *      class-under-test class)
 * @see GenericDeclarationTests GenericDeclarationTests (The complementary j8unit test interface containing the instance
...
extends AnnotatedElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.reflect.GenericDeclaration.class!",
                   java.lang.reflect.GenericDeclaration.class.isAssignableFrom(sut));
    }

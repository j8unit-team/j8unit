 ...
 * java.util.spi.LocaleNameProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocaleNameProviderTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see LocaleNameProviderTests LocaleNameProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface LocaleNameProviderClassTests<SUT extends java.util.spi.LocaleNameProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.spi.LocaleNameProvider.class!",
                   java.util.spi.LocaleNameProvider.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LocaleNameProvider
 * public abstract class java.util.spi.LocaleNameProvider}.
 *
...
public abstract interface LocaleNameProviderClassTests<SUT extends LocaleNameProvider>
extends org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LocaleNameProvider.class!",
                   LocaleNameProvider.class.isAssignableFrom(sut));
    }

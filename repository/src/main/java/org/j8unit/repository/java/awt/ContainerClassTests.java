 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Container public
...
public abstract interface ContainerClassTests<SUT extends Container>
extends ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Container.class!",
                   Container.class.isAssignableFrom(sut));
    }

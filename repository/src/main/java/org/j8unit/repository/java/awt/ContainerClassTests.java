...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Container class java.awt.Container}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContainerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ContainerTests}.
 * </p>
 *
 * @see java.awt.Container class java.awt.Container (the hereby targeted class-under-test class)
 * @see ContainerTests ContainerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ContainerClassTests<SUT extends java.awt.Container>
extends ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Container.class!",
                   java.awt.Container.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.chrono.ChronoPeriod interface java.time.chrono.ChronoPeriod}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChronoPeriodTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChronoPeriodTests}.
 * </p>
 *
 * @see java.time.chrono.ChronoPeriod interface java.time.chrono.ChronoPeriod (the hereby targeted class-under-test
 *      class)
 * @see ChronoPeriodTests ChronoPeriodTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ChronoPeriodClassTests<SUT extends java.time.chrono.ChronoPeriod>
extends org.j8unit.repository.java.time.temporal.TemporalAmountClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.ChronoPeriod.class!",
                   java.time.chrono.ChronoPeriod.class.isAssignableFrom(sut));
    }

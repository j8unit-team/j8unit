 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChronoPeriod public
 * abstract interface java.time.chrono.ChronoPeriod}.
 *
...
public abstract interface ChronoPeriodClassTests<SUT extends ChronoPeriod>
extends TemporalAmountClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChronoPeriod.class!",
                   ChronoPeriod.class.isAssignableFrom(sut));
    }

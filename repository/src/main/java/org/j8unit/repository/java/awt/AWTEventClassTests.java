 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AWTEvent public
...
public abstract interface AWTEventClassTests<SUT extends AWTEvent>
extends EventObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.AWTEvent]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AWTEvent.class!",
                   AWTEvent.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.AWTEvent]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.awt.AWTEvent]

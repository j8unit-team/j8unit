...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.AWTEvent class java.awt.AWTEvent}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AWTEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AWTEventTests}.
 * </p>
 *
 * @see java.awt.AWTEvent class java.awt.AWTEvent (the hereby targeted class-under-test class)
 * @see AWTEventTests AWTEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface AWTEventClassTests<SUT extends java.awt.AWTEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.AWTEvent.class!",
                   java.awt.AWTEvent.class.isAssignableFrom(sut));
    }

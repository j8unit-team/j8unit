 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RegistryHandler
...
public abstract interface RegistryHandlerClassTests<SUT extends RegistryHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RegistryHandler.class!",
                   RegistryHandler.class.isAssignableFrom(sut));
    }

 ...
 * java.rmi.registry.RegistryHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RegistryHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RegistryHandlerTests}.
 * </p>
 *
 * @see java.rmi.registry.RegistryHandler interface java.rmi.registry.RegistryHandler (the hereby targeted
 *      class-under-test class)
 * @see RegistryHandlerTests RegistryHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface RegistryHandlerClassTests<SUT extends java.rmi.registry.RegistryHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.registry.RegistryHandler.class!",
                   java.rmi.registry.RegistryHandler.class.isAssignableFrom(sut));
    }

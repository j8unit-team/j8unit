...
public abstract interface AlgorithmParametersSpiClassTests<SUT extends AlgorithmParametersSpi>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlgorithmParametersSpi.class!",
                   AlgorithmParametersSpi.class.isAssignableFrom(sut));
    }

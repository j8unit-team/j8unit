...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.AlgorithmParametersSpi class
 * java.security.AlgorithmParametersSpi}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AlgorithmParametersSpiTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AlgorithmParametersSpiTests}.
 * </p>
 *
 * @see java.security.AlgorithmParametersSpi class java.security.AlgorithmParametersSpi (the hereby targeted
 *      class-under-test class)
 * @see AlgorithmParametersSpiTests AlgorithmParametersSpiTests (The complementary j8unit test interface containing the
...
public abstract interface AlgorithmParametersSpiClassTests<SUT extends java.security.AlgorithmParametersSpi>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.AlgorithmParametersSpi.class!",
                   java.security.AlgorithmParametersSpi.class.isAssignableFrom(sut));
    }

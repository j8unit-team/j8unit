 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileDialog public
...
public abstract interface FileDialogClassTests<SUT extends FileDialog>
extends DialogClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileDialog.class!",
                   FileDialog.class.isAssignableFrom(sut));
    }

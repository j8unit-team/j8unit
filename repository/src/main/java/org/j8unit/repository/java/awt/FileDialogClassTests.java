...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.FileDialog class java.awt.FileDialog}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileDialogTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileDialogTests}.
 * </p>
 *
 * @see java.awt.FileDialog class java.awt.FileDialog (the hereby targeted class-under-test class)
 * @see FileDialogTests FileDialogTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends DialogClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.FileDialog.class!",
                   java.awt.FileDialog.class.isAssignableFrom(sut));
    }

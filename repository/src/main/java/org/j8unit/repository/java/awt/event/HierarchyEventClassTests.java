 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.awt.event.HierarchyEvent
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.awt.event.HierarchyEvent#HierarchyEvent(java.awt.Component, int, java.awt.Component,
     *             java.awt.Container)
     */
    ...
    throws Exception {
        ...
        final java.awt.event.HierarchyEvent sut = null; // = new HierarchyEvent(java.awt.Component, int,
    ...
    throws Exception {
        ...
        @SuppressWarnings("unused")
        final java.awt.event.HierarchyEvent sut = null; // = new HierarchyEvent(java.awt.Component, int,
                                                        // java.awt.Component, java.awt.Container, long);
    }

    /**
     * @since 0.9.2
     *
     * @j8unit.aim java.awt.event.HierarchyEvent#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

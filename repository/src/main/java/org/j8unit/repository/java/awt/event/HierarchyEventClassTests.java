...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.HierarchyEvent class java.awt.event.HierarchyEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HierarchyEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see HierarchyEventTests HierarchyEventTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.HierarchyEvent.class!",
                   java.awt.event.HierarchyEvent.class.isAssignableFrom(sut));
    }

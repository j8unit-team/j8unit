 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HierarchyEvent
...
extends org.j8unit.repository.java.awt.AWTEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HierarchyEvent.class!",
                   HierarchyEvent.class.isAssignableFrom(sut));
    }

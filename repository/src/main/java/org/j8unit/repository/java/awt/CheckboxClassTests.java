...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Checkbox class java.awt.Checkbox}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CheckboxTests}).
 * </p>
 *
 * <p>
 ...
 * @see CheckboxTests CheckboxTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends ItemSelectableClassTests<SUT>, org.j8unit.repository.javax.accessibility.AccessibleClassTests<SUT>, ComponentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Checkbox.class!",
                   java.awt.Checkbox.class.isAssignableFrom(sut));
    }

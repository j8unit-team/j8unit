 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeyAdapter public
 * abstract class java.awt.event.KeyAdapter}.
 *
...
public abstract interface KeyAdapterClassTests<SUT extends KeyAdapter>
extends KeyListenerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeyAdapter.class!",

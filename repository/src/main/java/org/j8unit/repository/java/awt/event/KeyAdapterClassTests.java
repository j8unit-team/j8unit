 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyAdapterTests}.
 * </p>
 *
 * @see java.awt.event.KeyAdapter class java.awt.event.KeyAdapter (the hereby targeted class-under-test class)
 * @see KeyAdapterTests KeyAdapterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeyAdapterClassTests<SUT extends java.awt.event.KeyAdapter>
extends KeyListenerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.KeyAdapter.class!",
                   java.awt.event.KeyAdapter.class.isAssignableFrom(sut));
    }

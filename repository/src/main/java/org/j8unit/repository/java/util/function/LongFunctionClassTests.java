 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongFunction public
 * abstract interface java.util.function.LongFunction<R>}.
 *
...
public abstract interface LongFunctionClassTests<SUT extends LongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongFunction.class!",

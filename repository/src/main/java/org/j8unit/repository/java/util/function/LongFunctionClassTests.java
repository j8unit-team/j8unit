 ...
 * java.util.function.LongFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongFunctionTests}.
 * </p>
 *
 * @see java.util.function.LongFunction interface java.util.function.LongFunction (the hereby targeted class-under-test
 *      class)
 * @see LongFunctionTests LongFunctionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LongFunctionClassTests<SUT extends java.util.function.LongFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongFunction.class!",
                   java.util.function.LongFunction.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Base64 class java.util.Base64}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Base64Tests}).
 * </p>
 *
 * <p>
 ...
 * @see Base64Tests Base64Tests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface Base64ClassTests<SUT extends java.util.Base64>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Base64.class!",
                   java.util.Base64.class.isAssignableFrom(sut));
    }
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link Base64Tests.DecoderTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * {@link Base64Tests.DecoderTests}.
     * </p>
     *
     * @see java.util.Base64.Decoder class java.util.Base64$Decoder (the hereby targeted class-under-test class)
     * @see Base64Tests.DecoderTests Base64Tests.DecoderTests (The complementary j8unit test interface containing the
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface DecoderClassTests<SUT extends java.util.Base64.Decoder>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Base64.Decoder.class!",
                       java.util.Base64.Decoder.class.isAssignableFrom(sut));
        }
     ...
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see {@link Base64Tests.EncoderTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link Base64Tests.EncoderTests}.
     * </p>
     *
     * @see java.util.Base64.Encoder class java.util.Base64$Encoder (the hereby targeted class-under-test class)
     * @see Base64Tests.EncoderTests Base64Tests.EncoderTests (The complementary j8unit test interface containing the
     *      instance relevant test methods)
     *
     * @param SUT
     *            the class' type of the subject-under-test
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface EncoderClassTests<SUT extends java.util.Base64.Encoder>
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Base64.Encoder.class!",
                       java.util.Base64.Encoder.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleAdder public
...
public abstract interface DoubleAdderClassTests<SUT extends DoubleAdder>
extends NumberClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.concurrent.atomic.DoubleAdder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleAdder.class!",
                   DoubleAdder.class.isAssignableFrom(sut));
    }

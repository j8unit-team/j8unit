...
import org.j8unit.repository.java.rmi.RemoteExceptionClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ExportException
...
public abstract interface ExportExceptionClassTests<SUT extends ExportException>
extends RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExportException.class!",
                   ExportException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.rmi.server.ExportException]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExportExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExportExceptionTests}.
 * </p>
 *
 * @see java.rmi.server.ExportException class java.rmi.server.ExportException (the hereby targeted class-under-test
 *      class)
 * @see ExportExceptionTests ExportExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ExportExceptionClassTests<SUT extends java.rmi.server.ExportException>
extends org.j8unit.repository.java.rmi.RemoteExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.ExportException.class!",
                   java.rmi.server.ExportException.class.isAssignableFrom(sut));
    }

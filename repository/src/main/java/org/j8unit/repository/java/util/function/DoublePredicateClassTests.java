...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.DoublePredicate interface
 * java.util.function.DoublePredicate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoublePredicateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoublePredicateTests}.
 * </p>
 *
 * @see java.util.function.DoublePredicate interface java.util.function.DoublePredicate (the hereby targeted
 *      class-under-test class)
 * @see DoublePredicateTests DoublePredicateTests (The complementary j8unit test interface containing the instance
...
public abstract interface DoublePredicateClassTests<SUT extends java.util.function.DoublePredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoublePredicate.class!",
                   java.util.function.DoublePredicate.class.isAssignableFrom(sut));
    }

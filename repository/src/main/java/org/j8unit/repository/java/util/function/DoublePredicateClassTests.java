 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoublePredicate
 * public abstract interface java.util.function.DoublePredicate}.
 *
...
public abstract interface DoublePredicateClassTests<SUT extends DoublePredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoublePredicate.class!",

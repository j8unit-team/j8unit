 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkedBlockingQueue
...
public abstract interface LinkedBlockingQueueClassTests<SUT extends LinkedBlockingQueue>
extends BlockingQueueClassTests<SUT>, SerializableClassTests<SUT>, AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkedBlockingQueue.class!",
                   LinkedBlockingQueue.class.isAssignableFrom(sut));
    }

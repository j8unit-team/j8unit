 ...
 * java.util.concurrent.LinkedBlockingQueue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LinkedBlockingQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LinkedBlockingQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.LinkedBlockingQueue class java.util.concurrent.LinkedBlockingQueue (the hereby targeted
 *      class-under-test class)
 * @see LinkedBlockingQueueTests LinkedBlockingQueueTests (The complementary j8unit test interface containing the
...
extends BlockingQueueClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.AbstractQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.LinkedBlockingQueue.class!",
                   java.util.concurrent.LinkedBlockingQueue.class.isAssignableFrom(sut));
    }

...
public abstract interface ManagementPermissionClassTests<SUT extends ManagementPermission>
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ManagementPermission.class!",
                   ManagementPermission.class.isAssignableFrom(sut));
    }

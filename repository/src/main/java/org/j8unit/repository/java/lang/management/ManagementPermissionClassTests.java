 ...
 * java.lang.management.ManagementPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ManagementPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ManagementPermissionTests}
 * .
 * </p>
 *
 * @see java.lang.management.ManagementPermission class java.lang.management.ManagementPermission (the hereby targeted
 *      class-under-test class)
 * @see ManagementPermissionTests ManagementPermissionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.ManagementPermission.class!",
                   java.lang.management.ManagementPermission.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Calendar class java.util.Calendar}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CalendarTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CalendarTests}.
 * </p>
 *
 * @see java.util.Calendar class java.util.Calendar (the hereby targeted class-under-test class)
 * @see CalendarTests CalendarTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ComparableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Calendar.class!",
                   java.util.Calendar.class.isAssignableFrom(sut));
    }
     ...
     * {@link CalendarTests.BuilderTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * </p>
     *
     * @see java.util.Calendar.Builder class java.util.Calendar$Builder (the hereby targeted class-under-test class)
     * @see CalendarTests.BuilderTests CalendarTests.BuilderTests (The complementary j8unit test interface containing
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Calendar.Builder.class!",
                       java.util.Calendar.Builder.class.isAssignableFrom(sut));
        }

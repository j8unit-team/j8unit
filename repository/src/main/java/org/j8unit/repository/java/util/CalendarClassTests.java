 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Calendar public
...
public abstract interface CalendarClassTests<SUT extends Calendar>
extends SerializableClassTests<SUT>, CloneableClassTests<SUT>, ComparableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Calendar.class!",
     ...
     * {@link Builder public static class java.util.Calendar$Builder}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
     ...
     * {@link org.j8unit.repository.java.util.CalendarTests.BuilderTests}.
     * </p>
     *
     * <p>
     * <strong>What? Testing the class/the type itself? What is it good for?</strong>

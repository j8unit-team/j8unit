 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CRL public abstract
...
public abstract interface CRLClassTests<SUT extends CRL>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CRL.class!", CRL.class.isAssignableFrom(sut));
    }

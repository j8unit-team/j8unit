...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.cert.CRL class java.security.cert.CRL}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CRLTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CRLTests}.
 * </p>
 *
 * @see java.security.cert.CRL class java.security.cert.CRL (the hereby targeted class-under-test class)
 * @see CRLTests CRLTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface CRLClassTests<SUT extends java.security.cert.CRL>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CRL.class!",
                   java.security.cert.CRL.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataBufferDouble
 * public final class java.awt.image.DataBufferDouble}.
 *
...
public abstract interface DataBufferDoubleClassTests<SUT extends DataBufferDouble>
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBufferDouble.class!",
                   DataBufferDouble.class.isAssignableFrom(sut));
    }

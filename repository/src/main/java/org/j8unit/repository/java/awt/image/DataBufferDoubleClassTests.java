...
/**
 * <p>
 * Test class for {@link java.awt.image.DataBufferDouble class java.awt.image.DataBufferDouble}, containing all class
 * relevant test methods (at least the test methods of accessible constructors and of accessible {@code static}
 * methods). The counterpart test class containing the instance relevant test methods is
 * {@link org.j8unit.repository.java.awt.image.DataBufferDoubleTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.awt.image.DataBufferClassTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void create_DataBufferDouble_doubleArrayArray_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.DataBufferDouble sut = null; // = new DataBufferDouble(double[][],int);
    ...
    /**
     * Test method for {@link java.awt.image.DataBufferDouble#DataBufferDouble(int) public
     * java.awt.image.DataBufferDouble(int)}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_DataBufferDouble_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.DataBufferDouble sut = null; // = new DataBufferDouble(int);
    }

    /**
     * Test method for {@link java.awt.image.DataBufferDouble#DataBufferDouble(int,int) public
     * java.awt.image.DataBufferDouble(int,int)}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_DataBufferDouble_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

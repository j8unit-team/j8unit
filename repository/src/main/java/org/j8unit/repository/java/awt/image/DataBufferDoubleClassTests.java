...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.DataBufferDouble class java.awt.image.DataBufferDouble}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBufferDoubleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DataBufferDoubleTests}.
 * </p>
 *
 * @see java.awt.image.DataBufferDouble class java.awt.image.DataBufferDouble (the hereby targeted class-under-test
 *      class)
 * @see DataBufferDoubleTests DataBufferDoubleTests (The complementary j8unit test interface containing the instance
...
public abstract interface DataBufferDoubleClassTests<SUT extends java.awt.image.DataBufferDouble>
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DataBufferDouble.class!",
                   java.awt.image.DataBufferDouble.class.isAssignableFrom(sut));
    }

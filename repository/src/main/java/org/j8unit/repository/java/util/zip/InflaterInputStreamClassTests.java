 ...
 * java.util.zip.InflaterInputStream}, containing all class relevant test methods (at least the test methods of
 * accessible constructors and of accessible {@code static} methods). The counterpart J8Unit test interface containing
 * the instance relevant test methods is {@link org.j8unit.repository.java.util.zip.InflaterInputStreamTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.InflaterInputStream#InflaterInputStream(java.io.InputStream)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.zip.InflaterInputStream#InflaterInputStream(java.io.InputStream, java.util.zip.Inflater)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_InflaterInputStream_InputStream_Inflater()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.zip.InflaterInputStream sut = null; // = new InflaterInputStream(java.io.InputStream,
    ...
    @Test
    @Category(Draft.class)
    public default void create_InflaterInputStream_InputStream_Inflater_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.zip.InflaterInputStream sut = null; // = new InflaterInputStream(java.io.InputStream,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.zip.InflaterInputStream#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

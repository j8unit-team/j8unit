 ...
 * java.util.zip.InflaterInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InflaterInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InflaterInputStreamTests}.
 * </p>
 *
 * @see java.util.zip.InflaterInputStream class java.util.zip.InflaterInputStream (the hereby targeted class-under-test
 *      class)
 * @see InflaterInputStreamTests InflaterInputStreamTests (The complementary j8unit test interface containing the
...
public abstract interface InflaterInputStreamClassTests<SUT extends java.util.zip.InflaterInputStream>
extends org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.InflaterInputStream.class!",
                   java.util.zip.InflaterInputStream.class.isAssignableFrom(sut));
    }

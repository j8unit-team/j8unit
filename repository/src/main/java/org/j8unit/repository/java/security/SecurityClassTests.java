 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Security public
...
public abstract interface SecurityClassTests<SUT extends Security>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Security.class!",
                   Security.class.isAssignableFrom(sut));
    }

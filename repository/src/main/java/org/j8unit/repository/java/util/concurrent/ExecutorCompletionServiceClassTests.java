 ...
 * java.util.concurrent.ExecutorCompletionService}, containing all class relevant test methods (at least the test
...
extends org.j8unit.repository.java.util.concurrent.CompletionServiceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.concurrent.ExecutorCompletionService#ExecutorCompletionService(java.util.concurrent.
     *             Executor)
     */
     ...
     *
     * @j8unit.aim java.util.concurrent.ExecutorCompletionService#ExecutorCompletionService(java.util.concurrent.
     *             Executor, java.util.concurrent.BlockingQueue)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_ExecutorCompletionService_Executor_BlockingQueue()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.util.concurrent.ExecutorCompletionService<?> sut = null; // = new
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.concurrent.ExecutorCompletionService#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

 ...
 * java.util.concurrent.ExecutorCompletionService}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link ExecutorCompletionServiceTests}).
 * </p>
 *
 * <p>
 ...
 * @see ExecutorCompletionServiceTests ExecutorCompletionServiceTests (The complementary j8unit test interface
...
extends CompletionServiceClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ExecutorCompletionService.class!",
                   java.util.concurrent.ExecutorCompletionService.class.isAssignableFrom(sut));
    }

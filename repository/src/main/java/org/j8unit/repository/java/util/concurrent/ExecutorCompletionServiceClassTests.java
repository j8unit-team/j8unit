 ...
 * {@link ExecutorCompletionService public class java.util.concurrent.ExecutorCompletionService<V>}.
 *
 ...
 * {@link org.j8unit.repository.java.util.concurrent.ExecutorCompletionServiceTests}.
 * </p>
 *
 * <p>
...
public abstract interface ExecutorCompletionServiceClassTests<SUT extends ExecutorCompletionService>
extends CompletionServiceClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExecutorCompletionService.class!",
                   ExecutorCompletionService.class.isAssignableFrom(sut));
    }

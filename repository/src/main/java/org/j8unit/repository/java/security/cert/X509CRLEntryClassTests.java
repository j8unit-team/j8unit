 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509CRLEntry public
 * abstract class java.security.cert.X509CRLEntry}.
 *
...
extends X509ExtensionClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509CRLEntry.class!",
                   X509CRLEntry.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.cert.X509CRLEntry]

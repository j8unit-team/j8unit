 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509CRLEntryTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.security.cert.X509CRLEntry class java.security.cert.X509CRLEntry (the hereby targeted class-under-test
 *      class)
 * @see X509CRLEntryTests X509CRLEntryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface X509CRLEntryClassTests<SUT extends java.security.cert.X509CRLEntry>
extends X509ExtensionClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.X509CRLEntry.class!",
                   java.security.cert.X509CRLEntry.class.isAssignableFrom(sut));
    }

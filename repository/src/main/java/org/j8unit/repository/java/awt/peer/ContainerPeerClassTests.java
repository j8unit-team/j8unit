 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ContainerPeer
...
public abstract interface ContainerPeerClassTests<SUT extends ContainerPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContainerPeer.class!",
                   ContainerPeer.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContainerPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ContainerPeerTests}.
 * </p>
 *
 * @see java.awt.peer.ContainerPeer interface java.awt.peer.ContainerPeer (the hereby targeted class-under-test class)
 * @see ContainerPeerTests ContainerPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ContainerPeerClassTests<SUT extends java.awt.peer.ContainerPeer>
extends ComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.ContainerPeer.class!",
                   java.awt.peer.ContainerPeer.class.isAssignableFrom(sut));
    }

 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.awt.event.MouseWheelEvent
 */
@FunctionalInterface
...
extends org.j8unit.repository.java.awt.event.MouseEventClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.awt.event.MouseWheelEvent#MouseWheelEvent(java.awt.Component, int, long, int, int, int, int,
     *             boolean, int, int, int)
     */
    ...
    throws Exception {
        ...
        final java.awt.event.MouseWheelEvent sut = null; // = new MouseWheelEvent(java.awt.Component, int, long, int,
                                                         // int, int, int, boolean, int, int, int);
    }
    ...
    throws Exception {
        ...
        @SuppressWarnings("unused")
        final java.awt.event.MouseWheelEvent sut = null; // = new MouseWheelEvent(java.awt.Component, int, long, int,
                                                         // int, int, int, int, int, boolean, int, int, int);
    }
    ...
    throws Exception {
        ...
        @SuppressWarnings("unused")
        final java.awt.event.MouseWheelEvent sut = null; // = new MouseWheelEvent(java.awt.Component, int, long, int,
                                                         // int, int, int, int, int, boolean, int, int, int, double);
    }

    /**
     * @since 0.9.2
     *
     * @j8unit.aim java.awt.event.MouseWheelEvent#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.MouseWheelEvent class java.awt.event.MouseWheelEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MouseWheelEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MouseWheelEventTests}.
 * </p>
 *
 * @see java.awt.event.MouseWheelEvent class java.awt.event.MouseWheelEvent (the hereby targeted class-under-test class)
 * @see MouseWheelEventTests MouseWheelEventTests (The complementary j8unit test interface containing the instance
...
extends MouseEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.MouseWheelEvent.class!",
                   java.awt.event.MouseWheelEvent.class.isAssignableFrom(sut));
    }

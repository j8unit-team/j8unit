 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MouseWheelEvent
...
public abstract interface MouseWheelEventClassTests<SUT extends MouseWheelEvent>
extends MouseEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MouseWheelEvent.class!",
                   MouseWheelEvent.class.isAssignableFrom(sut));
    }

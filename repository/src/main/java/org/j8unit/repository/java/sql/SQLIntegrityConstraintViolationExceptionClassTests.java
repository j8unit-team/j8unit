...
extends org.j8unit.repository.java.sql.SQLNonTransientExceptionClassTests<SUT> {
    ...
    public default void create_SQLIntegrityConstraintViolationException()
    throws Exception {
        // create new instance
    ...
    @Test
    @Category(Draft.class)
    public default void create_SQLIntegrityConstraintViolationException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.sql.SQLIntegrityConstraintViolationException sut = null; // = new
    ...
    @Test
    @Category(Draft.class)
    public default void create_SQLIntegrityConstraintViolationException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.sql.SQLIntegrityConstraintViolationException sut = null; // = new
    ...
    @Test
    @Category(Draft.class)
    public default void create_SQLIntegrityConstraintViolationException_String_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.sql.SQLIntegrityConstraintViolationException sut = null; // = new

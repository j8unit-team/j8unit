...
public abstract interface SQLIntegrityConstraintViolationExceptionClassTests<SUT extends SQLIntegrityConstraintViolationException>
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLIntegrityConstraintViolationException.class!",
                   SQLIntegrityConstraintViolationException.class.isAssignableFrom(sut));
    }

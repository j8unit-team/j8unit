 ...
 * java.sql.SQLIntegrityConstraintViolationException}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link SQLIntegrityConstraintViolationExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see SQLIntegrityConstraintViolationExceptionTests SQLIntegrityConstraintViolationExceptionTests (The complementary
...
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLIntegrityConstraintViolationException.class!",
                   java.sql.SQLIntegrityConstraintViolationException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferedInputStream
...
public abstract interface BufferedInputStreamClassTests<SUT extends BufferedInputStream>
extends FilterInputStreamClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.BufferedInputStream]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferedInputStream.class!",
                   BufferedInputStream.class.isAssignableFrom(sut));
    }

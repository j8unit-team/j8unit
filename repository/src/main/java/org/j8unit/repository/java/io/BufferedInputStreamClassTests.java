 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferedInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferedInputStreamTests}.
 * </p>
 *
 * @see java.io.BufferedInputStream class java.io.BufferedInputStream (the hereby targeted class-under-test class)
 * @see BufferedInputStreamTests BufferedInputStreamTests (The complementary j8unit test interface containing the
...
public abstract interface BufferedInputStreamClassTests<SUT extends java.io.BufferedInputStream>
extends FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.BufferedInputStream.class!",
                   java.io.BufferedInputStream.class.isAssignableFrom(sut));
    }

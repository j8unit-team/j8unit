 ...
 * {@link NotYetConnectedException public class java.nio.channels.NotYetConnectedException}.
 *
...
public abstract interface NotYetConnectedExceptionClassTests<SUT extends NotYetConnectedException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotYetConnectedException.class!",
                   NotYetConnectedException.class.isAssignableFrom(sut));
    }

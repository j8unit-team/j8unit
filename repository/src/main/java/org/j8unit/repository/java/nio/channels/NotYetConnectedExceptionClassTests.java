...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT>
{
    ...
    /**
     * Test method for {@link java.nio.channels.NotYetConnectedException#NotYetConnectedException() public java.nio.channels.NotYetConnectedException()}.
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_NotYetConnectedException() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.nio.channels.NotYetConnectedException sut = null; // = new NotYetConnectedException();
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.nio.channels.NotYetConnectedException> sut = createNewSUT();

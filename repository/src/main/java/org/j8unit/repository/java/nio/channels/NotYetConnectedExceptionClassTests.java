 ...
 * java.nio.channels.NotYetConnectedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotYetConnectedExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NotYetConnectedExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.NotYetConnectedException class java.nio.channels.NotYetConnectedException (the hereby targeted
 *      class-under-test class)
 * @see NotYetConnectedExceptionTests NotYetConnectedExceptionTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.NotYetConnectedException.class!",
                   java.nio.channels.NotYetConnectedException.class.isAssignableFrom(sut));
    }

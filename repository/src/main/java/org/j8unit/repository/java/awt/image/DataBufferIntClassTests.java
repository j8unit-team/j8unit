 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataBufferIntTests}).
 * </p>
 *
 * <p>
 ...
 * @see DataBufferIntTests DataBufferIntTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DataBufferIntClassTests<SUT extends java.awt.image.DataBufferInt>
extends DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DataBufferInt.class!",
                   java.awt.image.DataBufferInt.class.isAssignableFrom(sut));
    }

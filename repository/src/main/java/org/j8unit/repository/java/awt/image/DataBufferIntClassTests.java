 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DataBufferInt
 * public final class java.awt.image.DataBufferInt}.
 *
...
extends org.j8unit.repository.java.awt.image.DataBufferClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DataBufferInt.class!",
                   DataBufferInt.class.isAssignableFrom(sut));
    }

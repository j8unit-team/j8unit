 ...
 * java.nio.file.attribute.BasicFileAttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BasicFileAttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 * @see BasicFileAttributeViewTests BasicFileAttributeViewTests (The complementary j8unit test interface containing the
...
public abstract interface BasicFileAttributeViewClassTests<SUT extends java.nio.file.attribute.BasicFileAttributeView>
extends FileAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.BasicFileAttributeView.class!",
                   java.nio.file.attribute.BasicFileAttributeView.class.isAssignableFrom(sut));
    }

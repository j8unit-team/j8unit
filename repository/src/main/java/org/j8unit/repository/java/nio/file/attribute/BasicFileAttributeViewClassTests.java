...
extends org.j8unit.repository.java.nio.file.attribute.FileAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BasicFileAttributeView.class!",
                   BasicFileAttributeView.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WeakHashMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WeakHashMapTests}.
 * </p>
 *
 * @see java.util.WeakHashMap class java.util.WeakHashMap (the hereby targeted class-under-test class)
 * @see WeakHashMapTests WeakHashMapTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends MapClassTests<SUT>, AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.WeakHashMap.class!",
                   java.util.WeakHashMap.class.isAssignableFrom(sut));
    }

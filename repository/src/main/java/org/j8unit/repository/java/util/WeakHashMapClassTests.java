 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WeakHashMap public
...
public abstract interface WeakHashMapClassTests<SUT extends WeakHashMap>
extends AbstractMapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WeakHashMap.class!",
                   WeakHashMap.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link java.util.WeakHashMap class java.util.WeakHashMap}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.java.util.WeakHashMapTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.util.MapClassTests<SUT, K, V>, org.j8unit.repository.java.util.AbstractMapClassTests<SUT, K, V> {
    ...
    throws Exception {
        // create new instance
        final Class<? extends java.util.WeakHashMap<K, V>> sut = createNewSUT();

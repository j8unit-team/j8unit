 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AtomicBoolean
...
public abstract interface AtomicBooleanClassTests<SUT extends AtomicBoolean>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AtomicBoolean.class!",
                   AtomicBoolean.class.isAssignableFrom(sut));
    }

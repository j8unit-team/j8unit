 ...
 * java.util.concurrent.atomic.AtomicBoolean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AtomicBooleanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AtomicBooleanTests}.
 * </p>
 *
 * @see java.util.concurrent.atomic.AtomicBoolean class java.util.concurrent.atomic.AtomicBoolean (the hereby targeted
 *      class-under-test class)
 * @see AtomicBooleanTests AtomicBooleanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AtomicBooleanClassTests<SUT extends java.util.concurrent.atomic.AtomicBoolean>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.atomic.AtomicBoolean.class!",
                   java.util.concurrent.atomic.AtomicBoolean.class.isAssignableFrom(sut));
    }

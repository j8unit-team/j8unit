 ...
 * {@link CancelledKeyException public class java.nio.channels.CancelledKeyException}.
 *
...
public abstract interface CancelledKeyExceptionClassTests<SUT extends CancelledKeyException>
extends IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CancelledKeyException.class!",
                   CancelledKeyException.class.isAssignableFrom(sut));
    }

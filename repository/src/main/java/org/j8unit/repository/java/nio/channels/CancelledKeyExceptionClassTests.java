 ...
 * java.nio.channels.CancelledKeyException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CancelledKeyExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link CancelledKeyExceptionTests}.
 * </p>
 *
 * @see java.nio.channels.CancelledKeyException class java.nio.channels.CancelledKeyException (the hereby targeted
 *      class-under-test class)
 * @see CancelledKeyExceptionTests CancelledKeyExceptionTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.IllegalStateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.CancelledKeyException.class!",
                   java.nio.channels.CancelledKeyException.class.isAssignableFrom(sut));
    }

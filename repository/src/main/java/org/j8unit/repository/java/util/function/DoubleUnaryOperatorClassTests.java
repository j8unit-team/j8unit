 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleUnaryOperator
 * public abstract interface java.util.function.DoubleUnaryOperator}.
 *
...
public abstract interface DoubleUnaryOperatorClassTests<SUT extends DoubleUnaryOperator>
extends RepositoryClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.function.DoubleUnaryOperator]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleUnaryOperator.class!",
                   DoubleUnaryOperator.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.util.function.DoubleUnaryOperator]

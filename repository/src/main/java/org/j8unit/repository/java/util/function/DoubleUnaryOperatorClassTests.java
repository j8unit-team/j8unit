 ...
 * java.util.function.DoubleUnaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleUnaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleUnaryOperatorTests}.
 * </p>
 *
 * @see java.util.function.DoubleUnaryOperator interface java.util.function.DoubleUnaryOperator (the hereby targeted
 *      class-under-test class)
 * @see DoubleUnaryOperatorTests DoubleUnaryOperatorTests (The complementary j8unit test interface containing the
...
public abstract interface DoubleUnaryOperatorClassTests<SUT extends java.util.function.DoubleUnaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoubleUnaryOperator.class!",
                   java.util.function.DoubleUnaryOperator.class.isAssignableFrom(sut));
    }

 ...
 * {@link FlatteningPathIterator public class java.awt.geom.FlatteningPathIterator}.
 *
...
public abstract interface FlatteningPathIteratorClassTests<SUT extends FlatteningPathIterator>
extends PathIteratorClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FlatteningPathIterator.class!",
                   FlatteningPathIterator.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.geom.FlatteningPathIterator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FlatteningPathIteratorTests}).
 * </p>
 *
 * <p>
 ...
 * {@link FlatteningPathIteratorTests}.
 * </p>
 *
 * @see java.awt.geom.FlatteningPathIterator class java.awt.geom.FlatteningPathIterator (the hereby targeted
 *      class-under-test class)
 * @see FlatteningPathIteratorTests FlatteningPathIteratorTests (The complementary j8unit test interface containing the
...
extends PathIteratorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.geom.FlatteningPathIterator.class!",
                   java.awt.geom.FlatteningPathIterator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CRLReason public
 * final enum java.security.cert.CRLReason}.
 *
...
public abstract interface CRLReasonClassTests<SUT extends CRLReason>
extends EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CRLReason.class!",
                   CRLReason.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CRLReasonTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CRLReasonTests}.
 * </p>
 *
 * @see java.security.cert.CRLReason class java.security.cert.CRLReason (the hereby targeted class-under-test class)
 * @see CRLReasonTests CRLReasonTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CRLReasonClassTests<SUT extends java.security.cert.CRLReason>
extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CRLReason.class!",
                   java.security.cert.CRLReason.class.isAssignableFrom(sut));
    }

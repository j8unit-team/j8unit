 ...
 * java.util.function.DoubleConsumer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DoubleConsumerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DoubleConsumerTests}.
 * </p>
 *
 * @see java.util.function.DoubleConsumer interface java.util.function.DoubleConsumer (the hereby targeted
 *      class-under-test class)
 * @see DoubleConsumerTests DoubleConsumerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DoubleConsumerClassTests<SUT extends java.util.function.DoubleConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.DoubleConsumer.class!",
                   java.util.function.DoubleConsumer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleConsumer
 * public abstract interface java.util.function.DoubleConsumer}.
 *
...
public abstract interface DoubleConsumerClassTests<SUT extends DoubleConsumer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleConsumer.class!",
                   DoubleConsumer.class.isAssignableFrom(sut));
    }

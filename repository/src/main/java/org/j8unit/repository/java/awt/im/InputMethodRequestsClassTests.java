 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputMethodRequests
 * public abstract interface java.awt.im.InputMethodRequests}.
 *
...
public abstract interface InputMethodRequestsClassTests<SUT extends InputMethodRequests>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputMethodRequests.class!",
                   InputMethodRequests.class.isAssignableFrom(sut));
    }

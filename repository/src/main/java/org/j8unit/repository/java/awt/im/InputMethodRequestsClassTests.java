 ...
 * java.awt.im.InputMethodRequests}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputMethodRequestsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InputMethodRequestsTests}.
 * </p>
 *
 * @see java.awt.im.InputMethodRequests interface java.awt.im.InputMethodRequests (the hereby targeted class-under-test
 *      class)
 * @see InputMethodRequestsTests InputMethodRequestsTests (The complementary j8unit test interface containing the
...
public abstract interface InputMethodRequestsClassTests<SUT extends java.awt.im.InputMethodRequests>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.im.InputMethodRequests.class!",
                   java.awt.im.InputMethodRequests.class.isAssignableFrom(sut));
    }

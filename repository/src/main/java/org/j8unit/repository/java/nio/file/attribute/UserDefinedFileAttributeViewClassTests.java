...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.attribute.UserDefinedFileAttributeView interface
 * java.nio.file.attribute.UserDefinedFileAttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link UserDefinedFileAttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.nio.file.attribute.UserDefinedFileAttributeView interface
 *      java.nio.file.attribute.UserDefinedFileAttributeView (the hereby targeted class-under-test class)
 * @see UserDefinedFileAttributeViewTests UserDefinedFileAttributeViewTests (The complementary j8unit test interface
...
public abstract interface UserDefinedFileAttributeViewClassTests<SUT extends java.nio.file.attribute.UserDefinedFileAttributeView>
extends FileAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.UserDefinedFileAttributeView.class!",
                   java.nio.file.attribute.UserDefinedFileAttributeView.class.isAssignableFrom(sut));
    }

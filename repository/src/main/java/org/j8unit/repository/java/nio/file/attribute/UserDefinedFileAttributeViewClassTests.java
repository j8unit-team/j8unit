 ...
 * {@link UserDefinedFileAttributeView public abstract interface java.nio.file.attribute.UserDefinedFileAttributeView}.
 *
...
public abstract interface UserDefinedFileAttributeViewClassTests<SUT extends UserDefinedFileAttributeView>
extends FileAttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UserDefinedFileAttributeView.class!",
                   UserDefinedFileAttributeView.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileAttributeView
 * public abstract interface java.nio.file.attribute.FileAttributeView}.
 *
...
public abstract interface FileAttributeViewClassTests<SUT extends FileAttributeView>
extends AttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileAttributeView.class!",
                   FileAttributeView.class.isAssignableFrom(sut));
    }

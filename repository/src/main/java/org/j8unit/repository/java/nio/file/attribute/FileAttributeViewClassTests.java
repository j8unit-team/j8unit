 ...
 * java.nio.file.attribute.FileAttributeView}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileAttributeViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileAttributeViewTests}.
 * </p>
 *
 * @see java.nio.file.attribute.FileAttributeView interface java.nio.file.attribute.FileAttributeView (the hereby
 *      targeted class-under-test class)
 * @see FileAttributeViewTests FileAttributeViewTests (The complementary j8unit test interface containing the instance
...
public abstract interface FileAttributeViewClassTests<SUT extends java.nio.file.attribute.FileAttributeView>
extends AttributeViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.FileAttributeView.class!",
                   java.nio.file.attribute.FileAttributeView.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.Reader class java.io.Reader}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ReaderTests}).
 * </p>
 *
 * <p>
 ...
 * @see ReaderTests ReaderTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ReadableClassTests<SUT>, CloseableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.Reader.class!",
                   java.io.Reader.class.isAssignableFrom(sut));
    }

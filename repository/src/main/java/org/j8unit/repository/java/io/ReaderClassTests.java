 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Reader public
...
public abstract interface ReaderClassTests<SUT extends Reader>
extends ReadableClassTests<SUT>, CloseableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Reader.class!",

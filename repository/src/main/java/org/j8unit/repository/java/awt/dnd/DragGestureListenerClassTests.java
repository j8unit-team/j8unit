 ...
 * java.awt.dnd.DragGestureListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragGestureListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DragGestureListenerTests}.
 * </p>
 *
 * @see java.awt.dnd.DragGestureListener interface java.awt.dnd.DragGestureListener (the hereby targeted
 *      class-under-test class)
 * @see DragGestureListenerTests DragGestureListenerTests (The complementary j8unit test interface containing the
...
public abstract interface DragGestureListenerClassTests<SUT extends java.awt.dnd.DragGestureListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragGestureListener.class!",
                   java.awt.dnd.DragGestureListener.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragGestureListener
 * public abstract interface java.awt.dnd.DragGestureListener}.
 *
...
public abstract interface DragGestureListenerClassTests<SUT extends DragGestureListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragGestureListener.class!",

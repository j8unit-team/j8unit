 ...
 * {@link CertPathValidatorResult public abstract interface java.security.cert.CertPathValidatorResult}.
 *
 ...
 * {@link org.j8unit.repository.java.security.cert.CertPathValidatorResultTests}.
 * </p>
 *
 * <p>
...
public abstract interface CertPathValidatorResultClassTests<SUT extends CertPathValidatorResult>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertPathValidatorResult.class!",
                   CertPathValidatorResult.class.isAssignableFrom(sut));
    }

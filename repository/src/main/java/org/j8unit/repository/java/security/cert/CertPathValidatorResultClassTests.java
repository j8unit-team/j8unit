 ...
 * java.security.cert.CertPathValidatorResult}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CertPathValidatorResultTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link CertPathValidatorResultTests}.
 * </p>
 *
 * @see java.security.cert.CertPathValidatorResult interface java.security.cert.CertPathValidatorResult (the hereby
 *      targeted class-under-test class)
 * @see CertPathValidatorResultTests CertPathValidatorResultTests (The complementary j8unit test interface containing
...
public abstract interface CertPathValidatorResultClassTests<SUT extends java.security.cert.CertPathValidatorResult>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertPathValidatorResult.class!",
                   java.security.cert.CertPathValidatorResult.class.isAssignableFrom(sut));
    }

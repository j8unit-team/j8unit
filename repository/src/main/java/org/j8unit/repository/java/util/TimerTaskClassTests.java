 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TimerTask public
...
public abstract interface TimerTaskClassTests<SUT extends TimerTask>
extends RunnableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TimerTask.class!",
                   TimerTask.class.isAssignableFrom(sut));
    }

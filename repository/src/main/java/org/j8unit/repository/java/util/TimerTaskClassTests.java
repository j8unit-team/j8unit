...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.TimerTask class java.util.TimerTask}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TimerTaskTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TimerTaskTests}.
 * </p>
 *
 * @see java.util.TimerTask class java.util.TimerTask (the hereby targeted class-under-test class)
 * @see TimerTaskTests TimerTaskTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TimerTaskClassTests<SUT extends java.util.TimerTask>
extends org.j8unit.repository.java.lang.RunnableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.TimerTask.class!",
                   java.util.TimerTask.class.isAssignableFrom(sut));
    }

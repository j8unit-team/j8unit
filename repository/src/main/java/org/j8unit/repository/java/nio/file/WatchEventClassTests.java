 ...
 * methods is {@link org.j8unit.repository.java.nio.file.WatchEventTests}.
 * </p>
 *
 * <p>
...
extends J8UnitTest<SUT>
{
    ...
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.nio.file.WatchEvent<T>> sut = createNewSUT();
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.nio.file.WatchEventTests.KindTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends J8UnitTest<SUT>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.nio.file.WatchEvent.Kind<T>> sut = createNewSUT();
            // assert assignability
     ...
     * containing all class relevant test methods (at least the test methods of accessible constructors and
     * of accessible {@code static} methods). The counterpart test class containing the instance relevant test
     * methods is {@link org.j8unit.repository.java.nio.file.WatchEventTests.ModifierTests}.
     * </p>
     *
     * <p>
     * In addition, there may be assertions concerning the class itself.
    ...
    extends J8UnitTest<SUT>
    {
        ...
        public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
            // create new instance
            Class<? extends java.nio.file.WatchEvent.Modifier> sut = createNewSUT();
            // assert assignability

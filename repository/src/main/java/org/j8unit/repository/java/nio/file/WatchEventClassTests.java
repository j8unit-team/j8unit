 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WatchEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see WatchEventTests WatchEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.WatchEvent.class!",
                   java.nio.file.WatchEvent.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.nio.file.WatchEvent.Modifier interface
     * java.nio.file.WatchEvent$Modifier}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * {@link WatchEventTests.ModifierTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see WatchEventTests.ModifierTests WatchEventTests.ModifierTests (The complementary j8unit test interface
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.WatchEvent.Modifier.class!",
                       java.nio.file.WatchEvent.Modifier.class.isAssignableFrom(sut));
        }
     ...
     * java.nio.file.WatchEvent$Kind}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     * further type specific requirements). (In addition, the runtime type of this j8unit test interface's generic type
     * is verified by {@link #verifyGenericType()}).
     * </p>
     *
     ...
     * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints.
     * For this purpose, j8unit provides this reusable test interface covering type relevant aspects as well as a
     * complementarySetup test interface containing the instance relevant aspects (see {@link WatchEventTests.KindTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * <p>
     * The complementary j8unit test interface containing the instance relevant aspects is
     * {@link WatchEventTests.KindTests}.
     * </p>
     *
     * @see java.nio.file.WatchEvent.Kind interface java.nio.file.WatchEvent$Kind (the hereby targeted class-under-test
     *      class)
     * @see WatchEventTests.KindTests WatchEventTests.KindTests (The complementary j8unit test interface containing the
    ...
    extends RepositoryClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.WatchEvent.Kind.class!",
                       java.nio.file.WatchEvent.Kind.class.isAssignableFrom(sut));
        }

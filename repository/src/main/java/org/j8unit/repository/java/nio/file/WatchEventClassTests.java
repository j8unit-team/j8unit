 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WatchEvent public
 * abstract interface java.nio.file.WatchEvent<T>}.
 *
...
public abstract interface WatchEventClassTests<SUT extends WatchEvent>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WatchEvent.class!",
     ...
     * {@link Modifier public abstract static interface java.nio.file.WatchEvent$Modifier}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ModifierClassTests<SUT extends Modifier>
    extends RepositoryClassTests<SUT> {
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link Kind public abstract static interface java.nio.file.WatchEvent$Kind<T>}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

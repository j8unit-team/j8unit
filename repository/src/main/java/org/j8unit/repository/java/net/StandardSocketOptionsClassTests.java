 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StandardSocketOptionsTests}).
 * </p>
 *
 * <p>
 ...
 * {@link StandardSocketOptionsTests}.
 * </p>
 *
 * @see java.net.StandardSocketOptions class java.net.StandardSocketOptions (the hereby targeted class-under-test class)
 * @see StandardSocketOptionsTests StandardSocketOptionsTests (The complementary j8unit test interface containing the
...
public abstract interface StandardSocketOptionsClassTests<SUT extends java.net.StandardSocketOptions>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.StandardSocketOptions.class!",
                   java.net.StandardSocketOptions.class.isAssignableFrom(sut));
    }

 ...
 * {@link StandardSocketOptions public final class java.net.StandardSocketOptions}.
 *
...
public abstract interface StandardSocketOptionsClassTests<SUT extends StandardSocketOptions>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StandardSocketOptions.class!",
                   StandardSocketOptions.class.isAssignableFrom(sut));
    }

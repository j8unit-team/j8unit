 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509CertSelector
...
public abstract interface X509CertSelectorClassTests<SUT extends X509CertSelector>
extends org.j8unit.repository.java.security.cert.CertSelectorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509CertSelector.class!",
                   X509CertSelector.class.isAssignableFrom(sut));
    }

 ...
 * java.security.cert.X509CertSelector}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509CertSelectorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509CertSelectorTests}.
 * </p>
 *
 * @see java.security.cert.X509CertSelector class java.security.cert.X509CertSelector (the hereby targeted
 *      class-under-test class)
 * @see X509CertSelectorTests X509CertSelectorTests (The complementary j8unit test interface containing the instance
...
extends CertSelectorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.X509CertSelector.class!",
                   java.security.cert.X509CertSelector.class.isAssignableFrom(sut));
    }

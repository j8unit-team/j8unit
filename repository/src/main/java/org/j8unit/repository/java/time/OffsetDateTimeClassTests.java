 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OffsetDateTimeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OffsetDateTimeTests}.
 * </p>
 *
 * @see java.time.OffsetDateTime class java.time.OffsetDateTime (the hereby targeted class-under-test class)
 * @see OffsetDateTimeTests OffsetDateTimeTests (The complementary j8unit test interface containing the instance
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.OffsetDateTime.class!",
                   java.time.OffsetDateTime.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SimpleFormatter
...
public abstract interface SimpleFormatterClassTests<SUT extends SimpleFormatter>
extends FormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SimpleFormatter.class!",
                   SimpleFormatter.class.isAssignableFrom(sut));
    }

 ...
 * java.util.logging.SimpleFormatter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SimpleFormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SimpleFormatterTests}.
 * </p>
 *
 * @see java.util.logging.SimpleFormatter class java.util.logging.SimpleFormatter (the hereby targeted class-under-test
 *      class)
 * @see SimpleFormatterTests SimpleFormatterTests (The complementary j8unit test interface containing the instance
...
extends FormatterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.SimpleFormatter.class!",
                   java.util.logging.SimpleFormatter.class.isAssignableFrom(sut));
    }

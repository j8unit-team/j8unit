...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.im.InputSubset class java.awt.im.InputSubset}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputSubsetTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.im.InputSubset class java.awt.im.InputSubset (the hereby targeted class-under-test class)
 * @see InputSubsetTests InputSubsetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.CharacterClassTests.SubsetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.im.InputSubset.class!",
                   java.awt.im.InputSubset.class.isAssignableFrom(sut));
    }

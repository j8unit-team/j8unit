 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputSubset public
 * final class java.awt.im.InputSubset}.
 *
...
extends org.j8unit.repository.java.lang.CharacterClassTests.SubsetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputSubset.class!",
                   InputSubset.class.isAssignableFrom(sut));
    }

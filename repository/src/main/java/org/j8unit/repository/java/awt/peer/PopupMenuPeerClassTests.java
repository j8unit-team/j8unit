 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PopupMenuPeer
...
public abstract interface PopupMenuPeerClassTests<SUT extends PopupMenuPeer>
extends MenuPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PopupMenuPeer.class!",
                   PopupMenuPeer.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PopupMenuPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PopupMenuPeerTests}.
 * </p>
 *
 * @see java.awt.peer.PopupMenuPeer interface java.awt.peer.PopupMenuPeer (the hereby targeted class-under-test class)
 * @see PopupMenuPeerTests PopupMenuPeerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PopupMenuPeerClassTests<SUT extends java.awt.peer.PopupMenuPeer>
extends MenuPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.PopupMenuPeer.class!",
                   java.awt.peer.PopupMenuPeer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ThreadFactory
...
public abstract interface ThreadFactoryClassTests<SUT extends ThreadFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadFactory.class!",
                   ThreadFactory.class.isAssignableFrom(sut));
    }

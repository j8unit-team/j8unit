...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.concurrent.ThreadFactory interface
 * java.util.concurrent.ThreadFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ThreadFactoryTests}.
 * </p>
 *
 * @see java.util.concurrent.ThreadFactory interface java.util.concurrent.ThreadFactory (the hereby targeted
 *      class-under-test class)
 * @see ThreadFactoryTests ThreadFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ThreadFactoryClassTests<SUT extends java.util.concurrent.ThreadFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ThreadFactory.class!",
                   java.util.concurrent.ThreadFactory.class.isAssignableFrom(sut));
    }

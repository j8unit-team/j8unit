 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Array public final
...
public abstract interface ArrayClassTests<SUT extends Array>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.lang.reflect.Array]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Array.class!", Array.class.isAssignableFrom(sut));
    }

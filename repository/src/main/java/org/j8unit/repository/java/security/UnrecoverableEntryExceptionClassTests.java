 ...
 * java.security.UnrecoverableEntryException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link UnrecoverableEntryExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnrecoverableEntryExceptionTests UnrecoverableEntryExceptionTests (The complementary j8unit test interface
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.UnrecoverableEntryException.class!",
                   java.security.UnrecoverableEntryException.class.isAssignableFrom(sut));
    }

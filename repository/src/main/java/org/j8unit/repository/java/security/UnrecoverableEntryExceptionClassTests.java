...
public abstract interface UnrecoverableEntryExceptionClassTests<SUT extends UnrecoverableEntryException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnrecoverableEntryException.class!",
                   UnrecoverableEntryException.class.isAssignableFrom(sut));
    }

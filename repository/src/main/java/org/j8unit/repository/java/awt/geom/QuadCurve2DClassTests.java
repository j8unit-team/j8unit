 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link QuadCurve2D public
 * abstract class java.awt.geom.QuadCurve2D}.
 *
...
public abstract interface QuadCurve2DClassTests<SUT extends QuadCurve2D>
extends ShapeClassTests<SUT>, CloneableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to QuadCurve2D.class!",
                   QuadCurve2D.class.isAssignableFrom(sut));
    }
     ...
     * {@link Float public static class java.awt.geom.QuadCurve2D$Float}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.QuadCurve2DClassTests<SUT> {
     ...
     * Reusable j8unit test interface containing the type relevant aspects &ndash;&nbsp;i.&thinsp;e., runtime
     * constraints and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test
     * {@link Double public static class java.awt.geom.QuadCurve2D$Double}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

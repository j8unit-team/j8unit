 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileOutputStreamTests FileOutputStreamTests (The complementary j8unit test interface containing the instance
...
extends OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FileOutputStream.class!",
                   java.io.FileOutputStream.class.isAssignableFrom(sut));
    }

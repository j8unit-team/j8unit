 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileOutputStream
...
extends OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileOutputStream.class!",
                   FileOutputStream.class.isAssignableFrom(sut));
    }

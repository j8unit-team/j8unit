 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Chronology public
 * abstract interface java.time.chrono.Chronology}.
 *
...
public abstract interface ChronologyClassTests<SUT extends Chronology>
extends ComparableClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.chrono.Chronology]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Chronology.class!",
                   Chronology.class.isAssignableFrom(sut));
    }

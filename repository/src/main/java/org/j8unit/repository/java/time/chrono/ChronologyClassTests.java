...
public abstract interface ChronologyClassTests<SUT extends java.time.chrono.Chronology>
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.Chronology#from(java.time.temporal.TemporalAccessor)
     */
    ...
    /**
     * <p>
     * Test method for {@link java.time.chrono.Chronology#getAvailableChronologies() public static java.util.Set
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.Chronology#getAvailableChronologies()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void test_getAvailableChronologies()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.Chronology#of(java.lang.String)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.time.chrono.Chronology#ofLocale(java.util.Locale)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void test_ofLocale_Locale()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.time.chrono.Chronology#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

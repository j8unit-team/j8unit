 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChronologyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChronologyTests}.
 * </p>
 *
 * @see java.time.chrono.Chronology interface java.time.chrono.Chronology (the hereby targeted class-under-test class)
 * @see ChronologyTests ChronologyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.Chronology.class!",
                   java.time.chrono.Chronology.class.isAssignableFrom(sut));
    }

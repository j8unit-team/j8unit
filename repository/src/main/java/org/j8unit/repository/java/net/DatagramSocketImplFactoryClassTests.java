...
public abstract interface DatagramSocketImplFactoryClassTests<SUT extends DatagramSocketImplFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DatagramSocketImplFactory.class!",
                   DatagramSocketImplFactory.class.isAssignableFrom(sut));
    }

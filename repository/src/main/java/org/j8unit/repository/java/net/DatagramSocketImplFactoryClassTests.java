 ...
 * java.net.DatagramSocketImplFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link DatagramSocketImplFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * @see DatagramSocketImplFactoryTests DatagramSocketImplFactoryTests (The complementary j8unit test interface
...
public abstract interface DatagramSocketImplFactoryClassTests<SUT extends java.net.DatagramSocketImplFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.DatagramSocketImplFactory.class!",
                   java.net.DatagramSocketImplFactory.class.isAssignableFrom(sut));
    }

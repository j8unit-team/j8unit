...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.sql.PreparedStatement interface java.sql.PreparedStatement},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PreparedStatementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PreparedStatementTests}.
 * </p>
 *
 * @see java.sql.PreparedStatement interface java.sql.PreparedStatement (the hereby targeted class-under-test class)
 * @see PreparedStatementTests PreparedStatementTests (The complementary j8unit test interface containing the instance
...
extends StatementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.PreparedStatement.class!",
                   java.sql.PreparedStatement.class.isAssignableFrom(sut));
    }

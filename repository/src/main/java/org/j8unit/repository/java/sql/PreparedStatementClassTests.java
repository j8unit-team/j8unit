 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PreparedStatement
 * public abstract interface java.sql.PreparedStatement}.
 *
...
public abstract interface PreparedStatementClassTests<SUT extends PreparedStatement>
extends StatementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PreparedStatement.class!",
                   PreparedStatement.class.isAssignableFrom(sut));
    }

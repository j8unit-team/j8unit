...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain UnsupportedClassVersionError class
 * java.lang.UnsupportedClassVersionError}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * {@link UnsupportedClassVersionErrorTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see UnsupportedClassVersionError class java.lang.UnsupportedClassVersionError (the hereby targeted class-under-test
 *      class)
 * @see UnsupportedClassVersionErrorTests UnsupportedClassVersionErrorTests (The complementary j8unit test interface
...
public abstract interface UnsupportedClassVersionErrorClassTests<SUT extends UnsupportedClassVersionError>
extends ClassFormatErrorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnsupportedClassVersionError.class!",
                   UnsupportedClassVersionError.class.isAssignableFrom(sut));
    }

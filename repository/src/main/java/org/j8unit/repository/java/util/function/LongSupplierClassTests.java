...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.LongSupplier interface
 * java.util.function.LongSupplier}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongSupplierTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongSupplierTests}.
 * </p>
 *
 * @see java.util.function.LongSupplier interface java.util.function.LongSupplier (the hereby targeted class-under-test
 *      class)
 * @see LongSupplierTests LongSupplierTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LongSupplierClassTests<SUT extends java.util.function.LongSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongSupplier.class!",
                   java.util.function.LongSupplier.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongSupplier public
 * abstract interface java.util.function.LongSupplier}.
 *
...
public abstract interface LongSupplierClassTests<SUT extends LongSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongSupplier.class!",
                   LongSupplier.class.isAssignableFrom(sut));
    }

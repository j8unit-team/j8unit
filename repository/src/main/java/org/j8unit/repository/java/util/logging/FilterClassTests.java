 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FilterTests}.
 * </p>
 *
 * @see java.util.logging.Filter interface java.util.logging.Filter (the hereby targeted class-under-test class)
 * @see FilterTests FilterTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface FilterClassTests<SUT extends java.util.logging.Filter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.Filter.class!",
                   java.util.logging.Filter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Filter public
 * abstract interface java.util.logging.Filter}.
 *
...
public abstract interface FilterClassTests<SUT extends Filter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Filter.class!",

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ConvolveOp public
...
public abstract interface ConvolveOpClassTests<SUT extends ConvolveOp>
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.ConvolveOp]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ConvolveOp.class!",
                   ConvolveOp.class.isAssignableFrom(sut));
    }

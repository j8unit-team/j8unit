...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.ConvolveOp class java.awt.image.ConvolveOp}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConvolveOpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ConvolveOpTests}.
 * </p>
 *
 * @see java.awt.image.ConvolveOp class java.awt.image.ConvolveOp (the hereby targeted class-under-test class)
 * @see ConvolveOpTests ConvolveOpTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ConvolveOpClassTests<SUT extends java.awt.image.ConvolveOp>
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.ConvolveOp.class!",
                   java.awt.image.ConvolveOp.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OffsetTime public
 * final class java.time.OffsetTime}.
 *
...
public abstract interface OffsetTimeClassTests<SUT extends OffsetTime>
extends TemporalClassTests<SUT>, TemporalAdjusterClassTests<SUT>, ComparableClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OffsetTime.class!",

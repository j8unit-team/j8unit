...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.OffsetTime class java.time.OffsetTime}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OffsetTimeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OffsetTimeTests}.
 * </p>
 *
 * @see java.time.OffsetTime class java.time.OffsetTime (the hereby targeted class-under-test class)
 * @see OffsetTimeTests OffsetTimeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.OffsetTime.class!",
                   java.time.OffsetTime.class.isAssignableFrom(sut));
    }

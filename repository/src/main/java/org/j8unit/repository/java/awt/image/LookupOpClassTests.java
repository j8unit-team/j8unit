 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LookupOpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LookupOpTests}.
 * </p>
 *
 * @see java.awt.image.LookupOp class java.awt.image.LookupOp (the hereby targeted class-under-test class)
 * @see LookupOpTests LookupOpTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LookupOpClassTests<SUT extends java.awt.image.LookupOp>
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.LookupOp.class!",
                   java.awt.image.LookupOp.class.isAssignableFrom(sut));
    }

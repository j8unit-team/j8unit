 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LookupOp public
...
public abstract interface LookupOpClassTests<SUT extends LookupOp>
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LookupOp.class!",
                   LookupOp.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.awt.image.LookupOp]

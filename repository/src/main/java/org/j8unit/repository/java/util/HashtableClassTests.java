...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.Hashtable class java.util.Hashtable}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HashtableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HashtableTests}.
 * </p>
 *
 * @see java.util.Hashtable class java.util.Hashtable (the hereby targeted class-under-test class)
 * @see HashtableTests HashtableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends MapClassTests<SUT>, org.j8unit.repository.java.lang.CloneableClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>,
DictionaryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.Hashtable.class!",
                   java.util.Hashtable.class.isAssignableFrom(sut));
    }

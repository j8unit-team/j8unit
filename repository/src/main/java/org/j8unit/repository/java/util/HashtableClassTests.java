 ...
 * methods is {@link org.j8unit.repository.java.util.HashtableTests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.java.util.MapClassTests<SUT,K,V>,
        ...
        org.j8unit.repository.java.util.DictionaryClassTests<SUT,K,V>
{
    ...
    public default void create_Hashtable_Map() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.Hashtable<K,V> sut = null; // = new Hashtable(java.util.Map);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_Hashtable() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.Hashtable<K,V> sut = null; // = new Hashtable();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_Hashtable_int() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.Hashtable<K,V> sut = null; // = new Hashtable(int);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_Hashtable_int_float() throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        java.util.Hashtable<K,V> sut = null; // = new Hashtable(int,float);
    }

    @Test
    public default void testBaseTypeIsAssignableFromCurrentType() throws Exception {
        // create new instance
        Class<? extends java.util.Hashtable<K,V>> sut = createNewSUT();

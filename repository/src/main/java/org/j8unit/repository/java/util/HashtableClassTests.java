 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Hashtable public
...
public abstract interface HashtableClassTests<SUT extends Hashtable>
extends MapClassTests<SUT>, CloneableClassTests<SUT>, SerializableClassTests<SUT>, DictionaryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Hashtable.class!",
                   Hashtable.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.event.WindowFocusListener interface
 * java.awt.event.WindowFocusListener}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WindowFocusListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WindowFocusListenerTests}.
 * </p>
 *
 * @see java.awt.event.WindowFocusListener interface java.awt.event.WindowFocusListener (the hereby targeted
 *      class-under-test class)
 * @see WindowFocusListenerTests WindowFocusListenerTests (The complementary j8unit test interface containing the
...
public abstract interface WindowFocusListenerClassTests<SUT extends java.awt.event.WindowFocusListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.WindowFocusListener.class!",
                   java.awt.event.WindowFocusListener.class.isAssignableFrom(sut));
    }

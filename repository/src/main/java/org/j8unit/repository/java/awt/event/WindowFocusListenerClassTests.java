 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WindowFocusListener
 * public abstract interface java.awt.event.WindowFocusListener}.
 *
...
public abstract interface WindowFocusListenerClassTests<SUT extends WindowFocusListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WindowFocusListener.class!",
                   WindowFocusListener.class.isAssignableFrom(sut));
    }

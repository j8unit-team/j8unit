...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.applet.Applet class java.applet.Applet}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AppletTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AppletTests}.
 * </p>
 *
 * @see java.applet.Applet class java.applet.Applet (the hereby targeted class-under-test class)
 * @see AppletTests AppletTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.awt.PanelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.applet.Applet.class!",
                   java.applet.Applet.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.awt.PanelClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Applet public class
 * java.applet.Applet}.
 *
...
public abstract interface AppletClassTests<SUT extends Applet>
extends PanelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Applet.class!",
                   Applet.class.isAssignableFrom(sut));
    }

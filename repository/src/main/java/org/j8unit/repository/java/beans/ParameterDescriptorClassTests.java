 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParameterDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParameterDescriptorTests}.
 * </p>
 *
 * @see java.beans.ParameterDescriptor class java.beans.ParameterDescriptor (the hereby targeted class-under-test class)
 * @see ParameterDescriptorTests ParameterDescriptorTests (The complementary j8unit test interface containing the
...
public abstract interface ParameterDescriptorClassTests<SUT extends java.beans.ParameterDescriptor>
extends FeatureDescriptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.ParameterDescriptor.class!",
                   java.beans.ParameterDescriptor.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParameterDescriptor
...
public abstract interface ParameterDescriptorClassTests<SUT extends ParameterDescriptor>
extends FeatureDescriptorClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.beans.ParameterDescriptor]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParameterDescriptor.class!",
                   ParameterDescriptor.class.isAssignableFrom(sut));
    }

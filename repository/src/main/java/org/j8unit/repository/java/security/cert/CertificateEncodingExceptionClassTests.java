 ...
 * {@link CertificateEncodingException public class java.security.cert.CertificateEncodingException}.
 *
...
public abstract interface CertificateEncodingExceptionClassTests<SUT extends CertificateEncodingException>
extends org.j8unit.repository.java.security.cert.CertificateExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.security.cert.CertificateEncodingException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CertificateEncodingException.class!",
                   CertificateEncodingException.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.cert.CertificateEncodingException]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.security.cert.CertificateEncodingException]

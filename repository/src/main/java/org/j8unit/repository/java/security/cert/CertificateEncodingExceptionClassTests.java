 ...
 * java.security.cert.CertificateEncodingException}, containing all type relevant aspects (e.&thinsp;g., runtime
...
extends CertificateExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CertificateEncodingException.class!",
                   java.security.cert.CertificateEncodingException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SwitchPoint public
...
public abstract interface SwitchPointClassTests<SUT extends SwitchPoint>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SwitchPoint.class!",
                   SwitchPoint.class.isAssignableFrom(sut));
    }

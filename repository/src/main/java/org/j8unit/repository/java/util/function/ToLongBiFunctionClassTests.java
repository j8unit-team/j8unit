 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ToLongBiFunction
 * public abstract interface java.util.function.ToLongBiFunction<T,U>}.
 *
...
public abstract interface ToLongBiFunctionClassTests<SUT extends ToLongBiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ToLongBiFunction.class!",
                   ToLongBiFunction.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.ToLongBiFunction interface
 * java.util.function.ToLongBiFunction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ToLongBiFunctionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ToLongBiFunctionTests}.
 * </p>
 *
 * @see java.util.function.ToLongBiFunction interface java.util.function.ToLongBiFunction (the hereby targeted
 *      class-under-test class)
 * @see ToLongBiFunctionTests ToLongBiFunctionTests (The complementary j8unit test interface containing the instance
...
public abstract interface ToLongBiFunctionClassTests<SUT extends java.util.function.ToLongBiFunction>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.ToLongBiFunction.class!",
                   java.util.function.ToLongBiFunction.class.isAssignableFrom(sut));
    }

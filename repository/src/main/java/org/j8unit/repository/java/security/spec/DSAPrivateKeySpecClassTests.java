 ...
 * java.security.spec.DSAPrivateKeySpec}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DSAPrivateKeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DSAPrivateKeySpecTests}.
 * </p>
 *
 * @see java.security.spec.DSAPrivateKeySpec class java.security.spec.DSAPrivateKeySpec (the hereby targeted
 *      class-under-test class)
 * @see DSAPrivateKeySpecTests DSAPrivateKeySpecTests (The complementary j8unit test interface containing the instance
...
public abstract interface DSAPrivateKeySpecClassTests<SUT extends java.security.spec.DSAPrivateKeySpec>
extends KeySpecClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.DSAPrivateKeySpec.class!",
                   java.security.spec.DSAPrivateKeySpec.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DSAPrivateKeySpec
...
public abstract interface DSAPrivateKeySpecClassTests<SUT extends DSAPrivateKeySpec>
extends KeySpecClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DSAPrivateKeySpec.class!",
                   DSAPrivateKeySpec.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.security.spec.DSAPrivateKeySpec]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLExceptionTests}.
 * </p>
 *
 * @see java.sql.SQLException class java.sql.SQLException (the hereby targeted class-under-test class)
 * @see SQLExceptionTests SQLExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.IterableClassTests<SUT>, org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLException.class!",
                   java.sql.SQLException.class.isAssignableFrom(sut));
    }

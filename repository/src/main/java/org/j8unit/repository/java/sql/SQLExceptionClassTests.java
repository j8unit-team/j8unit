 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLException public
...
public abstract interface SQLExceptionClassTests<SUT extends SQLException>
extends IterableClassTests<SUT>, ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLException.class!",
                   SQLException.class.isAssignableFrom(sut));
    }

 ...
 * java.util.function.IntUnaryOperator}, containing all instance relevant test methods (i.&thinsp;e., test methods of
 ...
 * @since 0.9.0
 *
 * @j8unit.aim java.util.function.IntUnaryOperator
 */
@FunctionalInterface
...
extends RepositoryTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.util.function.IntUnaryOperator#andThen(java.util.function.IntUnaryOperator)
     */
     ...
     * </p>
     *
     * @j8unit.aim java.util.function.IntUnaryOperator#applyAsInt(int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void test_applyAsInt_int()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
     ...
     * </p>
     *
     * @j8unit.aim java.util.function.IntUnaryOperator#compose(java.util.function.IntUnaryOperator)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)

 ...
 * java.util.concurrent.ConcurrentMap}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ConcurrentMapTests}).
 * </p>
 *
 * <p>
 ...
 * @see ConcurrentMapTests ConcurrentMapTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ConcurrentMapClassTests<SUT extends java.util.concurrent.ConcurrentMap>
extends org.j8unit.repository.java.util.MapClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.ConcurrentMap.class!",
                   java.util.concurrent.ConcurrentMap.class.isAssignableFrom(sut));
    }

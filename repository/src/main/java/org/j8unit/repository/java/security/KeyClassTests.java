...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.Key interface java.security.Key}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeyTests}.
 * </p>
 *
 * @see java.security.Key interface java.security.Key (the hereby targeted class-under-test class)
 * @see KeyTests KeyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface KeyClassTests<SUT extends java.security.Key>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.Key.class!",
                   java.security.Key.class.isAssignableFrom(sut));
    }

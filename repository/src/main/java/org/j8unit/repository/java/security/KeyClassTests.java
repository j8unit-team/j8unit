 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Key public abstract
...
public abstract interface KeyClassTests<SUT extends Key>
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Key.class!", Key.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CRLExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CRLExceptionTests}.
 * </p>
 *
 * @see java.security.cert.CRLException class java.security.cert.CRLException (the hereby targeted class-under-test
 *      class)
 * @see CRLExceptionTests CRLExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CRLExceptionClassTests<SUT extends java.security.cert.CRLException>
extends org.j8unit.repository.java.security.GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.CRLException.class!",
                   java.security.cert.CRLException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CRLException public
...
public abstract interface CRLExceptionClassTests<SUT extends CRLException>
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CRLException.class!",
                   CRLException.class.isAssignableFrom(sut));
    }

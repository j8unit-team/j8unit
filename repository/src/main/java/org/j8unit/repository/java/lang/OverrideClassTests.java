...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain Override interface java.lang.Override}, containing all type relevant
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OverrideTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OverrideTests}.
 * </p>
 *
 * @see Override interface java.lang.Override (the hereby targeted class-under-test class)
 * @see OverrideTests OverrideTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface OverrideClassTests<SUT extends Override>
extends org.j8unit.repository.java.lang.annotation.AnnotationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Override.class!",
                   Override.class.isAssignableFrom(sut));
    }

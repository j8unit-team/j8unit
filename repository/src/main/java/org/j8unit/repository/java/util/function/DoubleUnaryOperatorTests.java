 ...
 * {@link DoubleUnaryOperator public abstract interface java.util.function.DoubleUnaryOperator}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.util.function.DoubleUnaryOperatorClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface DoubleUnaryOperatorTests<SUT extends DoubleUnaryOperator>
extends RepositoryTests<SUT> {
    ...
    public default void test_andThen_DoubleUnaryOperator()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_applyAsDouble_double()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_compose_DoubleUnaryOperator()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.LongPredicate interface
 * java.util.function.LongPredicate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongPredicateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongPredicateTests}.
 * </p>
 *
 * @see java.util.function.LongPredicate interface java.util.function.LongPredicate (the hereby targeted
 *      class-under-test class)
 * @see LongPredicateTests LongPredicateTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LongPredicateClassTests<SUT extends java.util.function.LongPredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.LongPredicate.class!",
                   java.util.function.LongPredicate.class.isAssignableFrom(sut));
    }

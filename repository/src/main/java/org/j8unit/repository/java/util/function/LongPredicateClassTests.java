 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongPredicate
...
public abstract interface LongPredicateClassTests<SUT extends LongPredicate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongPredicate.class!",
                   LongPredicate.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link JulianFields public
 * final class java.time.temporal.JulianFields}.
 *
...
public abstract interface JulianFieldsClassTests<SUT extends JulianFields>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.temporal.JulianFields]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to JulianFields.class!",
                   JulianFields.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.time.temporal.JulianFields]

    // J8UNIT-MARKER-[END]-[CLASS]-[java.time.temporal.JulianFields]

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.time.temporal.JulianFields class java.time.temporal.JulianFields}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link JulianFieldsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link JulianFieldsTests}.
 * </p>
 *
 * @see java.time.temporal.JulianFields class java.time.temporal.JulianFields (the hereby targeted class-under-test
 *      class)
 * @see JulianFieldsTests JulianFieldsTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface JulianFieldsClassTests<SUT extends java.time.temporal.JulianFields>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.temporal.JulianFields.class!",
                   java.time.temporal.JulianFields.class.isAssignableFrom(sut));
    }

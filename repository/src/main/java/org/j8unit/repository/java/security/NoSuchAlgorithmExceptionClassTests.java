 ...
 * java.security.NoSuchAlgorithmException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoSuchAlgorithmExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NoSuchAlgorithmExceptionTests}.
 * </p>
 *
 * @see java.security.NoSuchAlgorithmException class java.security.NoSuchAlgorithmException (the hereby targeted
 *      class-under-test class)
 * @see NoSuchAlgorithmExceptionTests NoSuchAlgorithmExceptionTests (The complementary j8unit test interface containing
...
extends GeneralSecurityExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.NoSuchAlgorithmException.class!",
                   java.security.NoSuchAlgorithmException.class.isAssignableFrom(sut));
    }

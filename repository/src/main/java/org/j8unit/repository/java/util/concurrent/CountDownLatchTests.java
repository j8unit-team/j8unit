 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link CountDownLatch
 ...
 * {@link org.j8unit.repository.java.util.concurrent.CountDownLatchClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface CountDownLatchTests<SUT extends CountDownLatch>
extends org.j8unit.repository.java.lang.ObjectTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_countDown()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

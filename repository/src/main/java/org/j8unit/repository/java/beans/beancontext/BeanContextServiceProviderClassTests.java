...
public abstract interface BeanContextServiceProviderClassTests<SUT extends BeanContextServiceProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextServiceProvider.class!",
                   BeanContextServiceProvider.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[java.beans.beancontext.BeanContextServiceProvider]

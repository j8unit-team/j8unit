 ...
 * java.beans.beancontext.BeanContextServiceProvider}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextServiceProviderTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextServiceProviderTests BeanContextServiceProviderTests (The complementary j8unit test interface
...
public abstract interface BeanContextServiceProviderClassTests<SUT extends java.beans.beancontext.BeanContextServiceProvider>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServiceProvider.class!",
                   java.beans.beancontext.BeanContextServiceProvider.class.isAssignableFrom(sut));
    }

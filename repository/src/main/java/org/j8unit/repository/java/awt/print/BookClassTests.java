...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.print.Book class java.awt.print.Book}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BookTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BookTests}.
 * </p>
 *
 * @see java.awt.print.Book class java.awt.print.Book (the hereby targeted class-under-test class)
 * @see BookTests BookTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface BookClassTests<SUT extends java.awt.print.Book>
extends PageableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.print.Book.class!",
                   java.awt.print.Book.class.isAssignableFrom(sut));
    }

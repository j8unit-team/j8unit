 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RemoteServer public
...
public abstract interface RemoteServerClassTests<SUT extends RemoteServer>
extends RemoteObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemoteServer.class!",
                   RemoteServer.class.isAssignableFrom(sut));
    }

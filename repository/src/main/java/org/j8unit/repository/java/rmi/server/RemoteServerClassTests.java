 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RemoteServerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RemoteServerTests}.
 * </p>
 *
 * @see java.rmi.server.RemoteServer class java.rmi.server.RemoteServer (the hereby targeted class-under-test class)
 * @see RemoteServerTests RemoteServerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends RemoteObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.server.RemoteServer.class!",
                   java.rmi.server.RemoteServer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FutureTask public
 * class java.util.concurrent.FutureTask<V>}.
 *
...
public abstract interface FutureTaskClassTests<SUT extends FutureTask>
extends RunnableFutureClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FutureTask.class!",
                   FutureTask.class.isAssignableFrom(sut));
    }

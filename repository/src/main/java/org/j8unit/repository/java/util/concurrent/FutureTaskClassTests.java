 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FutureTaskTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FutureTaskTests}.
 * </p>
 *
 * @see java.util.concurrent.FutureTask class java.util.concurrent.FutureTask (the hereby targeted class-under-test
 *      class)
 * @see FutureTaskTests FutureTaskTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RunnableFutureClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.FutureTask.class!",
                   java.util.concurrent.FutureTask.class.isAssignableFrom(sut));
    }

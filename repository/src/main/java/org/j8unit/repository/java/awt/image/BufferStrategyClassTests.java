...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.image.BufferStrategy class java.awt.image.BufferStrategy},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BufferStrategyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BufferStrategyTests}.
 * </p>
 *
 * @see java.awt.image.BufferStrategy class java.awt.image.BufferStrategy (the hereby targeted class-under-test class)
 * @see BufferStrategyTests BufferStrategyTests (The complementary j8unit test interface containing the instance
...
public abstract interface BufferStrategyClassTests<SUT extends java.awt.image.BufferStrategy>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.BufferStrategy.class!",
                   java.awt.image.BufferStrategy.class.isAssignableFrom(sut));
    }

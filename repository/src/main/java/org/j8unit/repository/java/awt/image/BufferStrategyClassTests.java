 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BufferStrategy
 * public abstract class java.awt.image.BufferStrategy}.
 *
...
public abstract interface BufferStrategyClassTests<SUT extends BufferStrategy>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.image.BufferStrategy]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BufferStrategy.class!",
                   BufferStrategy.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollatorProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CollatorProviderTests}.
 * </p>
 *
 * @see java.text.spi.CollatorProvider class java.text.spi.CollatorProvider (the hereby targeted class-under-test class)
 * @see CollatorProviderTests CollatorProviderTests (The complementary j8unit test interface containing the instance
...
public abstract interface CollatorProviderClassTests<SUT extends java.text.spi.CollatorProvider>
extends org.j8unit.repository.java.util.spi.LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.text.spi.CollatorProvider.class!",
                   java.text.spi.CollatorProvider.class.isAssignableFrom(sut));
    }

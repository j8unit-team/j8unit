 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CollatorProvider
 * public abstract class java.text.spi.CollatorProvider}.
 *
...
public abstract interface CollatorProviderClassTests<SUT extends CollatorProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CollatorProvider.class!",
                   CollatorProvider.class.isAssignableFrom(sut));
    }

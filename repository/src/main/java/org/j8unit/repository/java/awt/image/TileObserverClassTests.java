 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TileObserver public
 * abstract interface java.awt.image.TileObserver}.
 *
...
public abstract interface TileObserverClassTests<SUT extends TileObserver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TileObserver.class!",
                   TileObserver.class.isAssignableFrom(sut));
    }

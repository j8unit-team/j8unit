 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TileObserverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TileObserverTests}.
 * </p>
 *
 * @see java.awt.image.TileObserver interface java.awt.image.TileObserver (the hereby targeted class-under-test class)
 * @see TileObserverTests TileObserverTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TileObserverClassTests<SUT extends java.awt.image.TileObserver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.TileObserver.class!",
                   java.awt.image.TileObserver.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Transparency interface java.awt.Transparency}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransparencyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransparencyTests}.
 * </p>
 *
 * @see java.awt.Transparency interface java.awt.Transparency (the hereby targeted class-under-test class)
 * @see TransparencyTests TransparencyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TransparencyClassTests<SUT extends java.awt.Transparency>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Transparency.class!",
                   java.awt.Transparency.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Transparency public
 * abstract interface java.awt.Transparency}.
 *
...
public abstract interface TransparencyClassTests<SUT extends Transparency>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Transparency.class!",
                   Transparency.class.isAssignableFrom(sut));
    }

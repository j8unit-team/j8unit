 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntSupplier public
 * abstract interface java.util.function.IntSupplier}.
 *
...
public abstract interface IntSupplierClassTests<SUT extends IntSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntSupplier.class!",
                   IntSupplier.class.isAssignableFrom(sut));
    }

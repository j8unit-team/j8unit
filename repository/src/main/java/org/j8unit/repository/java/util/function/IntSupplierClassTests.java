 ...
 * java.util.function.IntSupplier}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntSupplierTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntSupplierTests}.
 * </p>
 *
 * @see java.util.function.IntSupplier interface java.util.function.IntSupplier (the hereby targeted class-under-test
 *      class)
 * @see IntSupplierTests IntSupplierTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IntSupplierClassTests<SUT extends java.util.function.IntSupplier>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntSupplier.class!",
                   java.util.function.IntSupplier.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link URLDecoder public
...
public abstract interface URLDecoderClassTests<SUT extends URLDecoder>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to URLDecoder.class!",
                   URLDecoder.class.isAssignableFrom(sut));
    }

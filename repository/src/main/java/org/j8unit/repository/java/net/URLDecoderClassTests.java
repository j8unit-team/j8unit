...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.URLDecoder class java.net.URLDecoder}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link URLDecoderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link URLDecoderTests}.
 * </p>
 *
 * @see java.net.URLDecoder class java.net.URLDecoder (the hereby targeted class-under-test class)
 * @see URLDecoderTests URLDecoderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.URLDecoder.class!",
                   java.net.URLDecoder.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.rmi.Remote interface java.rmi.Remote}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RemoteTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RemoteTests}.
 * </p>
 *
 * @see java.rmi.Remote interface java.rmi.Remote (the hereby targeted class-under-test class)
 * @see RemoteTests RemoteTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface RemoteClassTests<SUT extends java.rmi.Remote>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.Remote.class!",
                   java.rmi.Remote.class.isAssignableFrom(sut));
    }

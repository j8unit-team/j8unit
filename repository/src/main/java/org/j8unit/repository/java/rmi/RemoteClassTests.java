 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Remote public
...
public abstract interface RemoteClassTests<SUT extends Remote>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Remote.class!",
                   Remote.class.isAssignableFrom(sut));
    }

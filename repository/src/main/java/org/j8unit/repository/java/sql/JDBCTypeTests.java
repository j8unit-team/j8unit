 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link JDBCType public
 * final enum java.sql.JDBCType}.
 * </p>
 *
 * <p>
 * j8unit strongly encourages you to not only test the instances behaviour but also to test the type constraints. For
 * this purpose, j8unit also provides a complementary test interface containing the class/type relevant aspects (see
 * {@link org.j8unit.repository.java.sql.JDBCTypeClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface JDBCTypeTests<SUT extends JDBCType>
extends org.j8unit.repository.java.sql.SQLTypeTests<SUT>, org.j8unit.repository.java.lang.EnumTests<SUT, JDBCType> {

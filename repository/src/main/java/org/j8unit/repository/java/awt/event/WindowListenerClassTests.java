 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WindowListenerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WindowListenerTests}.
 * </p>
 *
 * @see java.awt.event.WindowListener interface java.awt.event.WindowListener (the hereby targeted class-under-test
 *      class)
 * @see WindowListenerTests WindowListenerTests (The complementary j8unit test interface containing the instance
...
public abstract interface WindowListenerClassTests<SUT extends java.awt.event.WindowListener>
extends org.j8unit.repository.java.util.EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.event.WindowListener.class!",
                   java.awt.event.WindowListener.class.isAssignableFrom(sut));
    }

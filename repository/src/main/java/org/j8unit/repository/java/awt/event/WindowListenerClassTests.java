 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WindowListener
...
public abstract interface WindowListenerClassTests<SUT extends WindowListener>
extends EventListenerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WindowListener.class!",
                   WindowListener.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.prefs.AbstractPreferences class
 * java.util.prefs.AbstractPreferences}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractPreferencesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractPreferencesTests}.
 * </p>
 *
 * @see java.util.prefs.AbstractPreferences class java.util.prefs.AbstractPreferences (the hereby targeted
 *      class-under-test class)
 * @see AbstractPreferencesTests AbstractPreferencesTests (The complementary j8unit test interface containing the
...
public abstract interface AbstractPreferencesClassTests<SUT extends java.util.prefs.AbstractPreferences>
extends PreferencesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.prefs.AbstractPreferences.class!",
                   java.util.prefs.AbstractPreferences.class.isAssignableFrom(sut));
    }

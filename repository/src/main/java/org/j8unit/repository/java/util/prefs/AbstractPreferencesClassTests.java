 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractPreferences
...
public abstract interface AbstractPreferencesClassTests<SUT extends AbstractPreferences>
extends PreferencesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractPreferences.class!",
                   AbstractPreferences.class.isAssignableFrom(sut));
    }

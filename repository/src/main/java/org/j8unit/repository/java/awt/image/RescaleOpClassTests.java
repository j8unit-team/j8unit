 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RescaleOpTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RescaleOpTests}.
 * </p>
 *
 * @see java.awt.image.RescaleOp class java.awt.image.RescaleOp (the hereby targeted class-under-test class)
 * @see RescaleOpTests RescaleOpTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RescaleOpClassTests<SUT extends java.awt.image.RescaleOp>
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.RescaleOp.class!",
                   java.awt.image.RescaleOp.class.isAssignableFrom(sut));
    }

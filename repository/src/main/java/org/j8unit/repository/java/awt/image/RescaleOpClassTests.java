 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RescaleOp public
...
public abstract interface RescaleOpClassTests<SUT extends RescaleOp>
extends BufferedImageOpClassTests<SUT>, RasterOpClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RescaleOp.class!",
                   RescaleOp.class.isAssignableFrom(sut));
    }

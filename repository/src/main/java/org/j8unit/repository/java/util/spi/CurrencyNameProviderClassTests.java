 ...
 * java.util.spi.CurrencyNameProvider}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CurrencyNameProviderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CurrencyNameProviderTests}
 * .
 * </p>
 *
 * @see java.util.spi.CurrencyNameProvider class java.util.spi.CurrencyNameProvider (the hereby targeted
 *      class-under-test class)
 * @see CurrencyNameProviderTests CurrencyNameProviderTests (The complementary j8unit test interface containing the
...
public abstract interface CurrencyNameProviderClassTests<SUT extends java.util.spi.CurrencyNameProvider>
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.spi.CurrencyNameProvider.class!",
                   java.util.spi.CurrencyNameProvider.class.isAssignableFrom(sut));
    }

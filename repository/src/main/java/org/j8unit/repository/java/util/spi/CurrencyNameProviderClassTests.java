 ...
 * {@link CurrencyNameProvider public abstract class java.util.spi.CurrencyNameProvider}.
 *
...
extends LocaleServiceProviderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CurrencyNameProvider.class!",
                   CurrencyNameProvider.class.isAssignableFrom(sut));
    }

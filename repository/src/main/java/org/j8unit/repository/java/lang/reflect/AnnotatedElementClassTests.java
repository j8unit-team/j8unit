 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnnotatedElement
 * public abstract interface java.lang.reflect.AnnotatedElement}.
 *
...
public abstract interface AnnotatedElementClassTests<SUT extends AnnotatedElement>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnnotatedElement.class!",
                   AnnotatedElement.class.isAssignableFrom(sut));
    }

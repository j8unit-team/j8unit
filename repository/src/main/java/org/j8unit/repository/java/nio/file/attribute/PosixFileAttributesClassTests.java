 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PosixFileAttributes
 * public abstract interface java.nio.file.attribute.PosixFileAttributes}.
 *
...
public abstract interface PosixFileAttributesClassTests<SUT extends PosixFileAttributes>
extends org.j8unit.repository.java.nio.file.attribute.BasicFileAttributesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PosixFileAttributes.class!",
                   PosixFileAttributes.class.isAssignableFrom(sut));
    }

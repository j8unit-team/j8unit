 ...
 * java.nio.file.attribute.PosixFileAttributes}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PosixFileAttributesTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PosixFileAttributesTests}.
 * </p>
 *
 * @see java.nio.file.attribute.PosixFileAttributes interface java.nio.file.attribute.PosixFileAttributes (the hereby
 *      targeted class-under-test class)
 * @see PosixFileAttributesTests PosixFileAttributesTests (The complementary j8unit test interface containing the
...
public abstract interface PosixFileAttributesClassTests<SUT extends java.nio.file.attribute.PosixFileAttributes>
extends BasicFileAttributesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.PosixFileAttributes.class!",
                   java.nio.file.attribute.PosixFileAttributes.class.isAssignableFrom(sut));
    }

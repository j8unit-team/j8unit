 ...
 * java.nio.channels.spi.AbstractSelectableChannel}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AbstractSelectableChannelTests}).
 * </p>
 *
 * <p>
 ...
 * @see AbstractSelectableChannelTests AbstractSelectableChannelTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.nio.channels.SelectableChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.spi.AbstractSelectableChannel.class!",
                   java.nio.channels.spi.AbstractSelectableChannel.class.isAssignableFrom(sut));
    }

 ...
 * java.time.format.DateTimeFormatter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DateTimeFormatterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DateTimeFormatterTests}.
 * </p>
 *
 * @see java.time.format.DateTimeFormatter class java.time.format.DateTimeFormatter (the hereby targeted
 *      class-under-test class)
 * @see DateTimeFormatterTests DateTimeFormatterTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.format.DateTimeFormatter.class!",
                   java.time.format.DateTimeFormatter.class.isAssignableFrom(sut));
    }

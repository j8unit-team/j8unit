 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DateTimeFormatter
...
public abstract interface DateTimeFormatterClassTests<SUT extends DateTimeFormatter>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.time.format.DateTimeFormatter]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DateTimeFormatter.class!",
                   DateTimeFormatter.class.isAssignableFrom(sut));
    }

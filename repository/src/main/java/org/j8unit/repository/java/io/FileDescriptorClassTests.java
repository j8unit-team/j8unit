 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileDescriptor
...
public abstract interface FileDescriptorClassTests<SUT extends FileDescriptor>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.io.FileDescriptor]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileDescriptor.class!",
                   FileDescriptor.class.isAssignableFrom(sut));
    }

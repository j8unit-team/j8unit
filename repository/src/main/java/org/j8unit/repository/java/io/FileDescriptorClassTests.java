 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileDescriptorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link FileDescriptorTests}.
 * </p>
 *
 * @see java.io.FileDescriptor class java.io.FileDescriptor (the hereby targeted class-under-test class)
 * @see FileDescriptorTests FileDescriptorTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.FileDescriptor.class!",
                   java.io.FileDescriptor.class.isAssignableFrom(sut));
    }

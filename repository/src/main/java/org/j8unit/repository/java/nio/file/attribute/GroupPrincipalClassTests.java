 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GroupPrincipal
...
public abstract interface GroupPrincipalClassTests<SUT extends GroupPrincipal>
extends UserPrincipalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GroupPrincipal.class!",

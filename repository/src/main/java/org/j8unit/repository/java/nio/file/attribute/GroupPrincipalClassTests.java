 ...
 * java.nio.file.attribute.GroupPrincipal}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GroupPrincipalTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GroupPrincipalTests}.
 * </p>
 *
 * @see java.nio.file.attribute.GroupPrincipal interface java.nio.file.attribute.GroupPrincipal (the hereby targeted
 *      class-under-test class)
 * @see GroupPrincipalTests GroupPrincipalTests (The complementary j8unit test interface containing the instance
...
public abstract interface GroupPrincipalClassTests<SUT extends java.nio.file.attribute.GroupPrincipal>
extends UserPrincipalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.attribute.GroupPrincipal.class!",
                   java.nio.file.attribute.GroupPrincipal.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.datatransfer.ClipboardOwner}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClipboardOwnerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ClipboardOwnerTests}.
 * </p>
 *
 * @see java.awt.datatransfer.ClipboardOwner interface java.awt.datatransfer.ClipboardOwner (the hereby targeted
 *      class-under-test class)
 * @see ClipboardOwnerTests ClipboardOwnerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ClipboardOwnerClassTests<SUT extends java.awt.datatransfer.ClipboardOwner>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.datatransfer.ClipboardOwner.class!",
                   java.awt.datatransfer.ClipboardOwner.class.isAssignableFrom(sut));
    }

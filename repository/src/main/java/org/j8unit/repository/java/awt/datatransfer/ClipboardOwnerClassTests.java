 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ClipboardOwner
...
public abstract interface ClipboardOwnerClassTests<SUT extends ClipboardOwner>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClipboardOwner.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.SocketOptions interface java.net.SocketOptions}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SocketOptionsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SocketOptionsTests}.
 * </p>
 *
 * @see java.net.SocketOptions interface java.net.SocketOptions (the hereby targeted class-under-test class)
 * @see SocketOptionsTests SocketOptionsTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface SocketOptionsClassTests<SUT extends java.net.SocketOptions>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.SocketOptions.class!",
                   java.net.SocketOptions.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SocketOptions
 * public abstract interface java.net.SocketOptions}.
 *
...
public abstract interface SocketOptionsClassTests<SUT extends SocketOptions>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SocketOptions.class!",
                   SocketOptions.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CheckboxMenuItem
...
public abstract interface CheckboxMenuItemClassTests<SUT extends CheckboxMenuItem>
extends org.j8unit.repository.java.awt.ItemSelectableClassTests<SUT>, org.j8unit.repository.java.awt.MenuItemClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CheckboxMenuItem.class!",
                   CheckboxMenuItem.class.isAssignableFrom(sut));
    }

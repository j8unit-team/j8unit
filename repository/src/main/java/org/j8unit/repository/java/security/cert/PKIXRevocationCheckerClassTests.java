 ...
 * java.security.cert.PKIXRevocationChecker}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PKIXRevocationCheckerTests}).
 * </p>
 *
 * <p>
 ...
 * @see PKIXRevocationCheckerTests PKIXRevocationCheckerTests (The complementary j8unit test interface containing the
...
extends PKIXCertPathCheckerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PKIXRevocationChecker.class!",
                   java.security.cert.PKIXRevocationChecker.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.security.cert.PKIXRevocationChecker.Option class
     * java.security.cert.PKIXRevocationChecker$Option}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link PKIXRevocationCheckerTests.OptionTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see PKIXRevocationCheckerTests.OptionTests PKIXRevocationCheckerTests.OptionTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PKIXRevocationChecker.Option.class!",
                       java.security.cert.PKIXRevocationChecker.Option.class.isAssignableFrom(sut));
        }

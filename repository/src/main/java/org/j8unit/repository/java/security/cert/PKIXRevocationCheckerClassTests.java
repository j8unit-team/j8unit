...
extends PKIXCertPathCheckerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKIXRevocationChecker.class!",
     ...
     * {@link Option public static final enum java.security.cert.PKIXRevocationChecker$Option}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

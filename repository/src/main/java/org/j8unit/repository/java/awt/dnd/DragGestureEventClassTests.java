...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.dnd.DragGestureEvent class java.awt.dnd.DragGestureEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DragGestureEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DragGestureEventTests}.
 * </p>
 *
 * @see java.awt.dnd.DragGestureEvent class java.awt.dnd.DragGestureEvent (the hereby targeted class-under-test class)
 * @see DragGestureEventTests DragGestureEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface DragGestureEventClassTests<SUT extends java.awt.dnd.DragGestureEvent>
extends org.j8unit.repository.java.util.EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.dnd.DragGestureEvent.class!",
                   java.awt.dnd.DragGestureEvent.class.isAssignableFrom(sut));
    }

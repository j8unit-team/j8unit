 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragGestureEvent
 * public class java.awt.dnd.DragGestureEvent}.
 *
...
public abstract interface DragGestureEventClassTests<SUT extends DragGestureEvent>
extends EventObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragGestureEvent.class!",
                   DragGestureEvent.class.isAssignableFrom(sut));
    }

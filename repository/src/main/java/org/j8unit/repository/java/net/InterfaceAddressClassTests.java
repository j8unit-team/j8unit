...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.net.InterfaceAddress class java.net.InterfaceAddress}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InterfaceAddressTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InterfaceAddressTests}.
 * </p>
 *
 * @see java.net.InterfaceAddress class java.net.InterfaceAddress (the hereby targeted class-under-test class)
 * @see InterfaceAddressTests InterfaceAddressTests (The complementary j8unit test interface containing the instance
...
public abstract interface InterfaceAddressClassTests<SUT extends java.net.InterfaceAddress>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.net.InterfaceAddress.class!",
                   java.net.InterfaceAddress.class.isAssignableFrom(sut));
    }

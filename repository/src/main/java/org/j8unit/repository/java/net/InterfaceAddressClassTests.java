 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InterfaceAddress
...
public abstract interface InterfaceAddressClassTests<SUT extends InterfaceAddress>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InterfaceAddress.class!",
                   InterfaceAddress.class.isAssignableFrom(sut));
    }

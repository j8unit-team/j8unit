 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BinaryOperator
 * public abstract interface java.util.function.BinaryOperator<T>}.
 *
...
public abstract interface BinaryOperatorClassTests<SUT extends BinaryOperator>
extends BiFunctionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.function.BinaryOperator]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BinaryOperator.class!",
                   BinaryOperator.class.isAssignableFrom(sut));
    }

 ...
 * java.util.function.BinaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BinaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BinaryOperatorTests}.
 * </p>
 *
 * @see java.util.function.BinaryOperator interface java.util.function.BinaryOperator (the hereby targeted
 *      class-under-test class)
 * @see BinaryOperatorTests BinaryOperatorTests (The complementary j8unit test interface containing the instance
...
extends BiFunctionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.BinaryOperator.class!",
                   java.util.function.BinaryOperator.class.isAssignableFrom(sut));
    }

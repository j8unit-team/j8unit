 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SQLDataException
...
public abstract interface SQLDataExceptionClassTests<SUT extends SQLDataException>
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLDataException.class!",
                   SQLDataException.class.isAssignableFrom(sut));
    }

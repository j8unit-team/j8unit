 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLDataExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SQLDataExceptionTests}.
 * </p>
 *
 * @see java.sql.SQLDataException class java.sql.SQLDataException (the hereby targeted class-under-test class)
 * @see SQLDataExceptionTests SQLDataExceptionTests (The complementary j8unit test interface containing the instance
...
public abstract interface SQLDataExceptionClassTests<SUT extends java.sql.SQLDataException>
extends SQLNonTransientExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLDataException.class!",
                   java.sql.SQLDataException.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.java.sql.SQLNonTransientExceptionClassTests<SUT> {
    ...
    public default void create_SQLDataException()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.sql.SQLDataException sut = null; // = new SQLDataException();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_SQLDataException_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.sql.SQLDataException sut = null; // = new SQLDataException(java.lang.String);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_SQLDataException_String_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public default void create_SQLDataException_String_String_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

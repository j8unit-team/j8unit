 ...
 * {@link InflaterOutputStreamTests}.
 * </p>
 *
 * <p>
...
public abstract interface InflaterOutputStreamClassTests<SUT extends InflaterOutputStream>
extends FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InflaterOutputStream.class!",
                   InflaterOutputStream.class.isAssignableFrom(sut));
    }

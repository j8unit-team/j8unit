 ...
 * java.util.zip.InflaterOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InflaterOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InflaterOutputStreamTests}
 * .
 * </p>
 *
 * @see java.util.zip.InflaterOutputStream class java.util.zip.InflaterOutputStream (the hereby targeted
 *      class-under-test class)
 * @see InflaterOutputStreamTests InflaterOutputStreamTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.io.FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.InflaterOutputStream.class!",
                   java.util.zip.InflaterOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * java.security.AlgorithmConstraints}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AlgorithmConstraintsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AlgorithmConstraintsTests}
 * .
 * </p>
 *
 * @see java.security.AlgorithmConstraints interface java.security.AlgorithmConstraints (the hereby targeted
 *      class-under-test class)
 * @see AlgorithmConstraintsTests AlgorithmConstraintsTests (The complementary j8unit test interface containing the
...
public abstract interface AlgorithmConstraintsClassTests<SUT extends java.security.AlgorithmConstraints>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.AlgorithmConstraints.class!",
                   java.security.AlgorithmConstraints.class.isAssignableFrom(sut));
    }

 ...
 * {@link AlgorithmConstraintsTests}.
 * </p>
 *
 * <p>
...
public abstract interface AlgorithmConstraintsClassTests<SUT extends AlgorithmConstraints>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlgorithmConstraints.class!",
                   AlgorithmConstraints.class.isAssignableFrom(sut));
    }

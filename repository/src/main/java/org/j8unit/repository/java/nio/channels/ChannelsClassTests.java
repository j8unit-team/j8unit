 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Channels public
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ChannelsTests}.
 * </p>
 *
 * <p>
...
public abstract interface ChannelsClassTests<SUT extends Channels>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Channels.class!",
                   Channels.class.isAssignableFrom(sut));
    }

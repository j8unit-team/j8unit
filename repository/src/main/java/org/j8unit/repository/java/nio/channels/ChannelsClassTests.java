 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChannelsTests}).
 * </p>
 *
 * <p>
 ...
 * @see ChannelsTests ChannelsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.Channels.class!",
                   java.nio.channels.Channels.class.isAssignableFrom(sut));
    }

...
public abstract interface SQLClientInfoExceptionClassTests<SUT extends SQLClientInfoException>
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SQLClientInfoException.class!",

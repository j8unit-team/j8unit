 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SQLClientInfoExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link SQLClientInfoExceptionTests}.
 * </p>
 *
 * @see java.sql.SQLClientInfoException class java.sql.SQLClientInfoException (the hereby targeted class-under-test
 *      class)
 * @see SQLClientInfoExceptionTests SQLClientInfoExceptionTests (The complementary j8unit test interface containing the
...
extends SQLExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.sql.SQLClientInfoException.class!",
                   java.sql.SQLClientInfoException.class.isAssignableFrom(sut));
    }

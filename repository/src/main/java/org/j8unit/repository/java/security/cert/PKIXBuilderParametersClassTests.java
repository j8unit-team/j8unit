 ...
 * {@link PKIXBuilderParameters public class java.security.cert.PKIXBuilderParameters}.
 *
...
extends org.j8unit.repository.java.security.cert.PKIXParametersClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKIXBuilderParameters.class!",
                   PKIXBuilderParameters.class.isAssignableFrom(sut));
    }

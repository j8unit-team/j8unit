 ...
 * java.security.cert.PKIXBuilderParameters}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PKIXBuilderParametersTests}).
 * </p>
 *
 * <p>
 ...
 * @see PKIXBuilderParametersTests PKIXBuilderParametersTests (The complementary j8unit test interface containing the
...
extends PKIXParametersClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.PKIXBuilderParameters.class!",
                   java.security.cert.PKIXBuilderParameters.class.isAssignableFrom(sut));
    }

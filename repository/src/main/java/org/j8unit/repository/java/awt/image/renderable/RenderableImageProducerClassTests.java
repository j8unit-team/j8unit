 ...
 * java.awt.image.renderable.RenderableImageProducer}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RenderableImageProducerTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.image.renderable.RenderableImageProducer class java.awt.image.renderable.RenderableImageProducer (the
 *      hereby targeted class-under-test class)
 * @see RenderableImageProducerTests RenderableImageProducerTests (The complementary j8unit test interface containing
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.renderable.RenderableImageProducer.class!",
                   java.awt.image.renderable.RenderableImageProducer.class.isAssignableFrom(sut));
    }

 ...
 * java.awt.peer.MenuComponentPeer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuComponentPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuComponentPeerTests}.
 * </p>
 *
 * @see java.awt.peer.MenuComponentPeer interface java.awt.peer.MenuComponentPeer (the hereby targeted class-under-test
 *      class)
 * @see MenuComponentPeerTests MenuComponentPeerTests (The complementary j8unit test interface containing the instance
...
public abstract interface MenuComponentPeerClassTests<SUT extends java.awt.peer.MenuComponentPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.MenuComponentPeer.class!",
                   java.awt.peer.MenuComponentPeer.class.isAssignableFrom(sut));
    }

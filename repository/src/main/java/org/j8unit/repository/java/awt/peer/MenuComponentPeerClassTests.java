 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuComponentPeer
...
public abstract interface MenuComponentPeerClassTests<SUT extends MenuComponentPeer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuComponentPeer.class!",
                   MenuComponentPeer.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractListTests}.
 * </p>
 *
 * @see java.util.AbstractList class java.util.AbstractList (the hereby targeted class-under-test class)
 * @see AbstractListTests AbstractListTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AbstractListClassTests<SUT extends java.util.AbstractList>
extends ListClassTests<SUT>, AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.AbstractList.class!",
                   java.util.AbstractList.class.isAssignableFrom(sut));
    }

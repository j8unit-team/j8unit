 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractList public
...
public abstract interface AbstractListClassTests<SUT extends AbstractList>
extends org.j8unit.repository.java.util.ListClassTests<SUT>, org.j8unit.repository.java.util.AbstractCollectionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractList.class!",
                   AbstractList.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DirectColorModel
...
public abstract interface DirectColorModelClassTests<SUT extends DirectColorModel>
extends PackedColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DirectColorModel.class!",
                   DirectColorModel.class.isAssignableFrom(sut));
    }

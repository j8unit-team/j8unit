 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DirectColorModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DirectColorModelTests}.
 * </p>
 *
 * @see java.awt.image.DirectColorModel class java.awt.image.DirectColorModel (the hereby targeted class-under-test
 *      class)
 * @see DirectColorModelTests DirectColorModelTests (The complementary j8unit test interface containing the instance
...
extends PackedColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.DirectColorModel.class!",
                   java.awt.image.DirectColorModel.class.isAssignableFrom(sut));
    }

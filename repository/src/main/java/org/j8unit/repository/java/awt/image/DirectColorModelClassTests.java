...
extends org.j8unit.repository.java.awt.image.PackedColorModelClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.awt.image.DirectColorModel#DirectColorModel(java.awt.color.ColorSpace, int, int, int, int, int,
     *             boolean, int)
     */
    ...
    throws Exception {
        ...
        final java.awt.image.DirectColorModel sut = null; // = new DirectColorModel(java.awt.color.ColorSpace, int, int,
     ...
     * </p>
     *
     * @j8unit.aim java.awt.image.DirectColorModel#DirectColorModel(int, int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.awt.image.DirectColorModel#DirectColorModel(int, int, int, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.awt.image.DirectColorModel#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

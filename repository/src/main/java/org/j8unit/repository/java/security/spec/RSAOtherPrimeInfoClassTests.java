 ...
 * java.security.spec.RSAOtherPrimeInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RSAOtherPrimeInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RSAOtherPrimeInfoTests}.
 * </p>
 *
 * @see java.security.spec.RSAOtherPrimeInfo class java.security.spec.RSAOtherPrimeInfo (the hereby targeted
 *      class-under-test class)
 * @see RSAOtherPrimeInfoTests RSAOtherPrimeInfoTests (The complementary j8unit test interface containing the instance
...
public abstract interface RSAOtherPrimeInfoClassTests<SUT extends java.security.spec.RSAOtherPrimeInfo>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.RSAOtherPrimeInfo.class!",
                   java.security.spec.RSAOtherPrimeInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RSAOtherPrimeInfo
...
public abstract interface RSAOtherPrimeInfoClassTests<SUT extends RSAOtherPrimeInfo>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RSAOtherPrimeInfo.class!",
                   RSAOtherPrimeInfo.class.isAssignableFrom(sut));
    }

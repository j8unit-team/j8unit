...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.Dimension class java.awt.Dimension}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DimensionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DimensionTests}.
 * </p>
 *
 * @see java.awt.Dimension class java.awt.Dimension (the hereby targeted class-under-test class)
 * @see DimensionTests DimensionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DimensionClassTests<SUT extends java.awt.Dimension>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.awt.geom.Dimension2DClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.Dimension.class!",
                   java.awt.Dimension.class.isAssignableFrom(sut));
    }

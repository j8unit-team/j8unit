...
import org.j8unit.repository.java.awt.geom.Dimension2DClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Dimension public
...
public abstract interface DimensionClassTests<SUT extends Dimension>
extends SerializableClassTests<SUT>, Dimension2DClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Dimension.class!",
                   Dimension.class.isAssignableFrom(sut));
    }

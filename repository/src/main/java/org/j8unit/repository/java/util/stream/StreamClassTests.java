...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.stream.Stream interface java.util.stream.Stream}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamTests}.
 * </p>
 *
 * @see java.util.stream.Stream interface java.util.stream.Stream (the hereby targeted class-under-test class)
 * @see StreamTests StreamTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends BaseStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.Stream.class!",
                   java.util.stream.Stream.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.stream.Stream.Builder interface
     * java.util.stream.Stream$Builder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
     ...
     * complementarySetup test interface containing the instance relevant aspects (see {@link StreamTests.BuilderTests}
     * ).
     * </p>
     *
     * <p>
     ...
     * {@link StreamTests.BuilderTests}.
     * </p>
     *
     * @see java.util.stream.Stream.Builder interface java.util.stream.Stream$Builder (the hereby targeted
     *      class-under-test class)
     * @see StreamTests.BuilderTests StreamTests.BuilderTests (The complementary j8unit test interface containing the
    ...
    extends org.j8unit.repository.java.util.function.ConsumerClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.Stream.Builder.class!",
                       java.util.stream.Stream.Builder.class.isAssignableFrom(sut));
        }

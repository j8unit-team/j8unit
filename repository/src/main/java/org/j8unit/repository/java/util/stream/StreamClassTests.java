...
extends org.j8unit.repository.java.util.stream.BaseStreamClassTests<SUT> {
     ...
     * java.util.stream.Stream$Builder}, containing all class relevant test methods (at least the test methods of
    ...
    extends org.j8unit.repository.java.util.function.ConsumerClassTests<SUT> {
         ...
         * @since 0.9.2
         *
         * @j8unit.aim java.util.stream.Stream.Builder#isAssignableFrom(java.lang.Class)
         */
        @Override
        @Test
     ...
     * </p>
     *
     * @j8unit.aim java.util.stream.Stream#concat(java.util.stream.Stream, java.util.stream.Stream)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.stream.Stream#empty()
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.stream.Stream#generate(java.util.function.Supplier)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.stream.Stream#iterate(java.lang.Object, java.util.function.UnaryOperator)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @j8unit.aim java.util.stream.Stream#of(java.lang.Object)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.stream.Stream#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test
    public default void testBaseTypeIsAssignableFromCurrentType()

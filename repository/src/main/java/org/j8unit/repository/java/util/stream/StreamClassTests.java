...
import org.j8unit.repository.java.util.function.ConsumerClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Stream public
...
public abstract interface StreamClassTests<SUT extends Stream>
extends BaseStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Stream.class!",
                   Stream.class.isAssignableFrom(sut));
    }
     ...
     * {@link Builder public abstract static interface java.util.stream.Stream$Builder<T>}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    extends ConsumerClassTests<SUT> {

        // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.util.stream.Stream$Builder]
        /**
         * @see Class#isAssignableFrom(Class) public native boolean java.lang.Class.isAssignableFrom(java.lang.Class<?>)
         *      (the hereby targeted method-under-test)
         *

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ThreadMXBean public
 * abstract interface java.lang.management.ThreadMXBean}.
 *
...
public abstract interface ThreadMXBeanClassTests<SUT extends ThreadMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadMXBean.class!",
                   ThreadMXBean.class.isAssignableFrom(sut));
    }

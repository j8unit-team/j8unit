...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.lang.management.ThreadMXBean interface
 * java.lang.management.ThreadMXBean}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadMXBeanTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ThreadMXBeanTests}.
 * </p>
 *
 * @see java.lang.management.ThreadMXBean interface java.lang.management.ThreadMXBean (the hereby targeted
 *      class-under-test class)
 * @see ThreadMXBeanTests ThreadMXBeanTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ThreadMXBeanClassTests<SUT extends java.lang.management.ThreadMXBean>
extends PlatformManagedObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.lang.management.ThreadMXBean.class!",
                   java.lang.management.ThreadMXBean.class.isAssignableFrom(sut));
    }

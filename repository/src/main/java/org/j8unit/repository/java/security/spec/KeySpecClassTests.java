 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link KeySpec public
 * abstract interface java.security.spec.KeySpec}.
 *
...
public abstract interface KeySpecClassTests<SUT extends KeySpec>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to KeySpec.class!",
                   KeySpec.class.isAssignableFrom(sut));
    }

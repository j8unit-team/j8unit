 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link KeySpecTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link KeySpecTests}.
 * </p>
 *
 * @see java.security.spec.KeySpec interface java.security.spec.KeySpec (the hereby targeted class-under-test class)
 * @see KeySpecTests KeySpecTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface KeySpecClassTests<SUT extends java.security.spec.KeySpec>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.spec.KeySpec.class!",
                   java.security.spec.KeySpec.class.isAssignableFrom(sut));
    }

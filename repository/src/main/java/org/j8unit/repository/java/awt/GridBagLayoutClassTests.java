 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GridBagLayout
...
public abstract interface GridBagLayoutClassTests<SUT extends GridBagLayout>
extends LayoutManager2ClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[java.awt.GridBagLayout]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GridBagLayout.class!",
                   GridBagLayout.class.isAssignableFrom(sut));
    }

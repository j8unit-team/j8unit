...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.GridBagLayout class java.awt.GridBagLayout}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GridBagLayoutTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GridBagLayoutTests}.
 * </p>
 *
 * @see java.awt.GridBagLayout class java.awt.GridBagLayout (the hereby targeted class-under-test class)
 * @see GridBagLayoutTests GridBagLayoutTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface GridBagLayoutClassTests<SUT extends java.awt.GridBagLayout>
extends LayoutManager2ClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.GridBagLayout.class!",
                   java.awt.GridBagLayout.class.isAssignableFrom(sut));
    }

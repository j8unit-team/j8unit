 ...
 * java.nio.file.AccessDeniedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AccessDeniedExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link AccessDeniedExceptionTests}.
 * </p>
 *
 * @see java.nio.file.AccessDeniedException class java.nio.file.AccessDeniedException (the hereby targeted
 *      class-under-test class)
 * @see AccessDeniedExceptionTests AccessDeniedExceptionTests (The complementary j8unit test interface containing the
...
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.AccessDeniedException.class!",
                   java.nio.file.AccessDeniedException.class.isAssignableFrom(sut));
    }

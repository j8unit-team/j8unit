...
public abstract interface AccessDeniedExceptionClassTests<SUT extends AccessDeniedException>
extends FileSystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AccessDeniedException.class!",
                   AccessDeniedException.class.isAssignableFrom(sut));
    }

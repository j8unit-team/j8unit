 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectOutputTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectOutputTests}.
 * </p>
 *
 * @see java.io.ObjectOutput interface java.io.ObjectOutput (the hereby targeted class-under-test class)
 * @see ObjectOutputTests ObjectOutputTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ObjectOutputClassTests<SUT extends java.io.ObjectOutput>
extends DataOutputClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.ObjectOutput.class!",
                   java.io.ObjectOutput.class.isAssignableFrom(sut));
    }

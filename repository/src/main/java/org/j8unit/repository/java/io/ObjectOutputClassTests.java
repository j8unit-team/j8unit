 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectOutput public
 * abstract interface java.io.ObjectOutput}.
 *
 ...
 * {@link org.j8unit.repository.java.io.ObjectOutputTests}.
 * </p>
 *
 * <p>
...
public abstract interface ObjectOutputClassTests<SUT extends ObjectOutput>
extends org.j8unit.repository.java.io.DataOutputClassTests<SUT>, org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectOutput.class!",
                   ObjectOutput.class.isAssignableFrom(sut));
    }

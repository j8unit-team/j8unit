...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain IllegalStateException class java.lang.IllegalStateException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IllegalStateExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * {@link IllegalStateExceptionTests}.
 * </p>
 *
 * @see IllegalStateException class java.lang.IllegalStateException (the hereby targeted class-under-test class)
 * @see IllegalStateExceptionTests IllegalStateExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface IllegalStateExceptionClassTests<SUT extends IllegalStateException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IllegalStateException.class!",
                   IllegalStateException.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CollectorTests}).
 * </p>
 *
 * <p>
 ...
 * @see CollectorTests CollectorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.Collector.class!",
                   java.util.stream.Collector.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.util.stream.Collector.Characteristics class
     * java.util.stream.Collector$Characteristics}, containing all type relevant aspects (e.&thinsp;g., runtime
     ...
     * {@link CollectorTests.CharacteristicsTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see CollectorTests.CharacteristicsTests CollectorTests.CharacteristicsTests (The complementary j8unit test
    ...
    extends org.j8unit.repository.java.lang.EnumClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.stream.Collector.Characteristics.class!",
                       java.util.stream.Collector.Characteristics.class.isAssignableFrom(sut));
        }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Collector public
 * abstract interface java.util.stream.Collector<T,A,R>}.
 *
...
public abstract interface CollectorClassTests<SUT extends Collector>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Collector.class!",
     ...
     * {@link Characteristics public static final enum java.util.stream.Collector$Characteristics}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface CharacteristicsClassTests<SUT extends Characteristics>

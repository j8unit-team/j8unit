 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PackedColorModelTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PackedColorModelTests}.
 * </p>
 *
 * @see java.awt.image.PackedColorModel class java.awt.image.PackedColorModel (the hereby targeted class-under-test
 *      class)
 * @see PackedColorModelTests PackedColorModelTests (The complementary j8unit test interface containing the instance
...
public abstract interface PackedColorModelClassTests<SUT extends java.awt.image.PackedColorModel>
extends ColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.PackedColorModel.class!",
                   java.awt.image.PackedColorModel.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PackedColorModel
 * public abstract class java.awt.image.PackedColorModel}.
 *
...
public abstract interface PackedColorModelClassTests<SUT extends PackedColorModel>
extends ColorModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PackedColorModel.class!",
                   PackedColorModel.class.isAssignableFrom(sut));
    }

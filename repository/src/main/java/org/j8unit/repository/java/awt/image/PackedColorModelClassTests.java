...
extends org.j8unit.repository.java.awt.image.ColorModelClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim java.awt.image.PackedColorModel#PackedColorModel(java.awt.color.ColorSpace, int, int, int, int, int,
     *             boolean, int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    public default void create_PackedColorModel_ColorSpace_int_int_int_int_int_boolean_int_int()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.PackedColorModel sut = null; // = new PackedColorModel(java.awt.color.ColorSpace, int, int,
     ...
     * </p>
     *
     * @j8unit.aim java.awt.image.PackedColorModel#PackedColorModel(java.awt.color.ColorSpace, int, int[], int, boolean,
     *             int, int)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final java.awt.image.PackedColorModel sut = null; // = new PackedColorModel(java.awt.color.ColorSpace, int,
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.awt.image.PackedColorModel#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

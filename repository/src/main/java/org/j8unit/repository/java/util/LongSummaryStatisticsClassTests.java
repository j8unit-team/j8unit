...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.LongSummaryStatistics class java.util.LongSummaryStatistics}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongSummaryStatisticsTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.util.LongSummaryStatistics class java.util.LongSummaryStatistics (the hereby targeted class-under-test
 *      class)
 * @see LongSummaryStatisticsTests LongSummaryStatisticsTests (The complementary j8unit test interface containing the
...
public abstract interface LongSummaryStatisticsClassTests<SUT extends java.util.LongSummaryStatistics>
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.LongSummaryStatistics.class!",
                   java.util.LongSummaryStatistics.class.isAssignableFrom(sut));
    }

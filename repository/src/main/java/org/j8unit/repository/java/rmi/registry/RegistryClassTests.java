 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Registry public
 * abstract interface java.rmi.registry.Registry}.
 *
...
public abstract interface RegistryClassTests<SUT extends Registry>
extends RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Registry.class!",

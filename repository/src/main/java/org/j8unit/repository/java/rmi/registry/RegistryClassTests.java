 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RegistryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RegistryTests}.
 * </p>
 *
 * @see java.rmi.registry.Registry interface java.rmi.registry.Registry (the hereby targeted class-under-test class)
 * @see RegistryTests RegistryTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.rmi.registry.Registry.class!",
                   java.rmi.registry.Registry.class.isAssignableFrom(sut));
    }

 ...
 * {@link StreamCorruptedException public class java.io.StreamCorruptedException}.
 *
...
public abstract interface StreamCorruptedExceptionClassTests<SUT extends StreamCorruptedException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamCorruptedException.class!",

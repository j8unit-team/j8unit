...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.StreamCorruptedException class
 * java.io.StreamCorruptedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamCorruptedExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link StreamCorruptedExceptionTests}.
 * </p>
 *
 * @see java.io.StreamCorruptedException class java.io.StreamCorruptedException (the hereby targeted class-under-test
 *      class)
 * @see StreamCorruptedExceptionTests StreamCorruptedExceptionTests (The complementary j8unit test interface containing
...
public abstract interface StreamCorruptedExceptionClassTests<SUT extends java.io.StreamCorruptedException>
extends ObjectStreamExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.StreamCorruptedException.class!",
                   java.io.StreamCorruptedException.class.isAssignableFrom(sut));
    }

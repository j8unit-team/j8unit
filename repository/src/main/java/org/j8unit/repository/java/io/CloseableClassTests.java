 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Closeable public
 * abstract interface java.io.Closeable}.
 *
...
public abstract interface CloseableClassTests<SUT extends Closeable>
extends AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Closeable.class!",
                   Closeable.class.isAssignableFrom(sut));
    }

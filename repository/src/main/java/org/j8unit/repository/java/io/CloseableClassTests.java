...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.io.Closeable interface java.io.Closeable}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CloseableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CloseableTests}.
 * </p>
 *
 * @see java.io.Closeable interface java.io.Closeable (the hereby targeted class-under-test class)
 * @see CloseableTests CloseableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CloseableClassTests<SUT extends java.io.Closeable>
extends org.j8unit.repository.java.lang.AutoCloseableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.io.Closeable.class!",
                   java.io.Closeable.class.isAssignableFrom(sut));
    }

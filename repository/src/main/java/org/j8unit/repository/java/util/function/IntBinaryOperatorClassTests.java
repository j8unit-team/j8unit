...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.util.function.IntBinaryOperator interface
 * java.util.function.IntBinaryOperator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntBinaryOperatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntBinaryOperatorTests}.
 * </p>
 *
 * @see java.util.function.IntBinaryOperator interface java.util.function.IntBinaryOperator (the hereby targeted
 *      class-under-test class)
 * @see IntBinaryOperatorTests IntBinaryOperatorTests (The complementary j8unit test interface containing the instance
...
public abstract interface IntBinaryOperatorClassTests<SUT extends java.util.function.IntBinaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.function.IntBinaryOperator.class!",
                   java.util.function.IntBinaryOperator.class.isAssignableFrom(sut));
    }

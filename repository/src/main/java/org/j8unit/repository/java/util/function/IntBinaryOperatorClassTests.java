 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntBinaryOperator
 * public abstract interface java.util.function.IntBinaryOperator}.
 *
...
public abstract interface IntBinaryOperatorClassTests<SUT extends IntBinaryOperator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntBinaryOperator.class!",
                   IntBinaryOperator.class.isAssignableFrom(sut));
    }

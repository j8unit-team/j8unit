 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BandedSampleModel
 * public final class java.awt.image.BandedSampleModel}.
 *
...
extends ComponentSampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BandedSampleModel.class!",
                   BandedSampleModel.class.isAssignableFrom(sut));
    }

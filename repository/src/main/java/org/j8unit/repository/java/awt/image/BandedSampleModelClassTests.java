 ...
 * java.awt.image.BandedSampleModel}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BandedSampleModelTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.awt.image.BandedSampleModel class java.awt.image.BandedSampleModel (the hereby targeted class-under-test
 *      class)
 * @see BandedSampleModelTests BandedSampleModelTests (The complementary j8unit test interface containing the instance
...
extends ComponentSampleModelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.image.BandedSampleModel.class!",
                   java.awt.image.BandedSampleModel.class.isAssignableFrom(sut));
    }

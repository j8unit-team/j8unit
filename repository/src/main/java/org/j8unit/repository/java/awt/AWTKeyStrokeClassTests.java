 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AWTKeyStroke public
...
public abstract interface AWTKeyStrokeClassTests<SUT extends AWTKeyStroke>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AWTKeyStroke.class!",
                   AWTKeyStroke.class.isAssignableFrom(sut));
    }

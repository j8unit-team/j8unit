 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link X509CRL public
...
public abstract interface X509CRLClassTests<SUT extends X509CRL>
extends org.j8unit.repository.java.security.cert.X509ExtensionClassTests<SUT>, org.j8unit.repository.java.security.cert.CRLClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to X509CRL.class!",
                   X509CRL.class.isAssignableFrom(sut));
    }

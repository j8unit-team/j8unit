 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link X509CRLTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link X509CRLTests}.
 * </p>
 *
 * @see java.security.cert.X509CRL class java.security.cert.X509CRL (the hereby targeted class-under-test class)
 * @see X509CRLTests X509CRLTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface X509CRLClassTests<SUT extends java.security.cert.X509CRL>
extends X509ExtensionClassTests<SUT>, CRLClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.cert.X509CRL.class!",
                   java.security.cert.X509CRL.class.isAssignableFrom(sut));
    }

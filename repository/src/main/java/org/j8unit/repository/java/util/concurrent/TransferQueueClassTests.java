 ...
 * java.util.concurrent.TransferQueue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransferQueueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TransferQueueTests}.
 * </p>
 *
 * @see java.util.concurrent.TransferQueue interface java.util.concurrent.TransferQueue (the hereby targeted
 *      class-under-test class)
 * @see TransferQueueTests TransferQueueTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TransferQueueClassTests<SUT extends java.util.concurrent.TransferQueue>
extends BlockingQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.TransferQueue.class!",
                   java.util.concurrent.TransferQueue.class.isAssignableFrom(sut));
    }

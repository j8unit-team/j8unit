 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TransferQueue
 * public abstract interface java.util.concurrent.TransferQueue<E>}.
 *
...
public abstract interface TransferQueueClassTests<SUT extends TransferQueue>
extends BlockingQueueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransferQueue.class!",
                   TransferQueue.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DigestOutputStream
...
public abstract interface DigestOutputStreamClassTests<SUT extends DigestOutputStream>
extends FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DigestOutputStream.class!",
                   DigestOutputStream.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.DigestOutputStream class
 * java.security.DigestOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DigestOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DigestOutputStreamTests}.
 * </p>
 *
 * @see java.security.DigestOutputStream class java.security.DigestOutputStream (the hereby targeted class-under-test
 *      class)
 * @see DigestOutputStreamTests DigestOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface DigestOutputStreamClassTests<SUT extends java.security.DigestOutputStream>
extends org.j8unit.repository.java.io.FilterOutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.DigestOutputStream.class!",
                   java.security.DigestOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * java.beans.beancontext.BeanContextServiceAvailableEvent}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link BeanContextServiceAvailableEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see BeanContextServiceAvailableEventTests BeanContextServiceAvailableEventTests (The complementary j8unit test
...
extends BeanContextEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.beans.beancontext.BeanContextServiceAvailableEvent.class!",
                   java.beans.beancontext.BeanContextServiceAvailableEvent.class.isAssignableFrom(sut));
    }

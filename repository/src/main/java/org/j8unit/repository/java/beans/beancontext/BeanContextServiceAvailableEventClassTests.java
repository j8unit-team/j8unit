 ...
 * {@link BeanContextServiceAvailableEvent public class java.beans.beancontext.BeanContextServiceAvailableEvent}.
 *
...
public abstract interface BeanContextServiceAvailableEventClassTests<SUT extends BeanContextServiceAvailableEvent>
extends BeanContextEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BeanContextServiceAvailableEvent.class!",
                   BeanContextServiceAvailableEvent.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.PKCS12Attribute class java.security.PKCS12Attribute},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PKCS12AttributeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PKCS12AttributeTests}.
 * </p>
 *
 * @see java.security.PKCS12Attribute class java.security.PKCS12Attribute (the hereby targeted class-under-test class)
 * @see PKCS12AttributeTests PKCS12AttributeTests (The complementary j8unit test interface containing the instance
...
extends KeyStoreClassTests.EntryClassTests.AttributeClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.PKCS12Attribute.class!",
                   java.security.PKCS12Attribute.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.java.security.KeyStoreClassTests.EntryClassTests.AttributeClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PKCS12Attribute
...
public abstract interface PKCS12AttributeClassTests<SUT extends PKCS12Attribute>
extends AttributeClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PKCS12Attribute.class!",

 ...
 * java.util.zip.CheckedInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CheckedInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CheckedInputStreamTests}.
 * </p>
 *
 * @see java.util.zip.CheckedInputStream class java.util.zip.CheckedInputStream (the hereby targeted class-under-test
 *      class)
 * @see CheckedInputStreamTests CheckedInputStreamTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.io.FilterInputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.zip.CheckedInputStream.class!",
                   java.util.zip.CheckedInputStream.class.isAssignableFrom(sut));
    }

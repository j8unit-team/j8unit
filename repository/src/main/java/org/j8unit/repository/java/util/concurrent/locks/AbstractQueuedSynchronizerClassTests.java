 ...
 * java.util.concurrent.locks.AbstractQueuedSynchronizer}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link AbstractQueuedSynchronizerTests}).
 * </p>
 *
 * <p>
 ...
 * @see AbstractQueuedSynchronizerTests AbstractQueuedSynchronizerTests (The complementary j8unit test interface
...
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, AbstractOwnableSynchronizerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.locks.AbstractQueuedSynchronizer.class!",
                   java.util.concurrent.locks.AbstractQueuedSynchronizer.class.isAssignableFrom(sut));
    }
     ...
     * java.util.concurrent.locks.AbstractQueuedSynchronizer$ConditionObject}, containing all type relevant aspects
     ...
     * complementarySetup test interface containing the instance relevant aspects (see
     * {@link AbstractQueuedSynchronizerTests.ConditionObjectTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     *      class)
     * @see AbstractQueuedSynchronizerTests.ConditionObjectTests AbstractQueuedSynchronizerTests.ConditionObjectTests
    ...
    extends ConditionClassTests<SUT>, org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.locks.AbstractQueuedSynchronizer.ConditionObject.class!",
                       java.util.concurrent.locks.AbstractQueuedSynchronizer.ConditionObject.class.isAssignableFrom(sut));
        }

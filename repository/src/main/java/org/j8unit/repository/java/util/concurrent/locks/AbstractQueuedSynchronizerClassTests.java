 ...
 * java.util.concurrent.locks.AbstractQueuedSynchronizer}, containing all class relevant test methods (at least the test
...
public abstract interface AbstractQueuedSynchronizerClassTests<SUT extends java.util.concurrent.locks.AbstractQueuedSynchronizer>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT>, org.j8unit.repository.java.util.concurrent.locks.AbstractOwnableSynchronizerClassTests<SUT> {
     ...
     * java.util.concurrent.locks.AbstractQueuedSynchronizer$ConditionObject}, containing all class relevant test
    ...
    @FunctionalInterface
    @Category(J8UnitRepository.class)
    public static abstract interface ConditionObjectClassTests<SUT extends java.util.concurrent.locks.AbstractQueuedSynchronizer.ConditionObject>
    ...
    org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
         ...
         * </p>
         *
         * @j8unit.aim java.util.concurrent.locks.AbstractQueuedSynchronizer.ConditionObject#ConditionObject(java.util.
         *             concurrent.locks.AbstractQueuedSynchronizer)
         */
        @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
        @Test
        @Category(Draft.class)
        public default void create_ConditionObject_AbstractQueuedSynchronizer()
        throws Exception {
            // create new instance
            @SuppressWarnings("unused")
            final java.util.concurrent.locks.AbstractQueuedSynchronizer.ConditionObject sut = null; // = new
         ...
         * @since 0.9.2
         *
         * @j8unit.aim java.util.concurrent.locks.AbstractQueuedSynchronizer.ConditionObject#isAssignableFrom(java.lang.
         *             Class)
         */
        @Override
        @Test
     ...
     * @since 0.9.2
     *
     * @j8unit.aim java.util.concurrent.locks.AbstractQueuedSynchronizer#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test
    public default void testBaseTypeIsAssignableFromCurrentType()

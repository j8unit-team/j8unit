...
public abstract interface AbstractQueuedSynchronizerClassTests<SUT extends AbstractQueuedSynchronizer>
extends AbstractOwnableSynchronizerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractQueuedSynchronizer.class!",

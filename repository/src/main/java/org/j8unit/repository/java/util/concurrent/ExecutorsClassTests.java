 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExecutorsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ExecutorsTests}.
 * </p>
 *
 * @see java.util.concurrent.Executors class java.util.concurrent.Executors (the hereby targeted class-under-test class)
 * @see ExecutorsTests ExecutorsTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ExecutorsClassTests<SUT extends java.util.concurrent.Executors>
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.concurrent.Executors.class!",
                   java.util.concurrent.Executors.class.isAssignableFrom(sut));
    }

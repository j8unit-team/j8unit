 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Executors public
...
public abstract interface ExecutorsClassTests<SUT extends Executors>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Executors.class!",
                   Executors.class.isAssignableFrom(sut));
    }

 ...
 * java.util.logging.LoggingPermission}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LoggingPermissionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LoggingPermissionTests}.
 * </p>
 *
 * @see java.util.logging.LoggingPermission class java.util.logging.LoggingPermission (the hereby targeted
 *      class-under-test class)
 * @see LoggingPermissionTests LoggingPermissionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.security.BasicPermissionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.util.logging.LoggingPermission.class!",
                   java.util.logging.LoggingPermission.class.isAssignableFrom(sut));
    }

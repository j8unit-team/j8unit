 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MenuBarPeer public
 * abstract interface java.awt.peer.MenuBarPeer}.
 *
...
public abstract interface MenuBarPeerClassTests<SUT extends MenuBarPeer>
extends MenuComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MenuBarPeer.class!",
                   MenuBarPeer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.awt.peer.MenuBarPeer interface java.awt.peer.MenuBarPeer},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MenuBarPeerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MenuBarPeerTests}.
 * </p>
 *
 * @see java.awt.peer.MenuBarPeer interface java.awt.peer.MenuBarPeer (the hereby targeted class-under-test class)
 * @see MenuBarPeerTests MenuBarPeerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MenuBarPeerClassTests<SUT extends java.awt.peer.MenuBarPeer>
extends MenuComponentPeerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.awt.peer.MenuBarPeer.class!",
                   java.awt.peer.MenuBarPeer.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FileChannel public
 * abstract class java.nio.channels.FileChannel}.
 *
...
AbstractInterruptibleChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FileChannel.class!",
     ...
     * {@link MapMode public static class java.nio.channels.FileChannel$MapMode}.
     *
     * (In addition, the runtime type of this j8unit test interface's generic type is verified by
     * {@link #verifyGenericType()}).
     * </p>

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FileChannelTests}).
 * </p>
 *
 * <p>
 ...
 * @see FileChannelTests FileChannelTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
org.j8unit.repository.java.nio.channels.spi.AbstractInterruptibleChannelClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.FileChannel.class!",
                   java.nio.channels.FileChannel.class.isAssignableFrom(sut));
    }

    /**
     * <p>
     * Reusable j8unit test interface for {@linkplain java.nio.channels.FileChannel.MapMode class
     * java.nio.channels.FileChannel$MapMode}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
     ...
     * {@link FileChannelTests.MapModeTests}).
     * </p>
     *
     * <p>
     * <strong>What? Testing the class itself? What is it good for?</strong>
     ...
     * @see FileChannelTests.MapModeTests FileChannelTests.MapModeTests (The complementary j8unit test interface
    ...
    extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
        ...
        throws Exception {
            ...
            final Class<SUT> sut = createNewSUT();
            // assert assignability
            assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.channels.FileChannel.MapMode.class!",
                       java.nio.channels.FileChannel.MapMode.class.isAssignableFrom(sut));
        }

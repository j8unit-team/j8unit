 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChronoZonedDateTime
 * public abstract interface java.time.chrono.ChronoZonedDateTime<D>}.
 *
...
extends TemporalClassTests<SUT>, ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChronoZonedDateTime.class!",
                   ChronoZonedDateTime.class.isAssignableFrom(sut));
    }

 ...
 * java.time.chrono.ChronoZonedDateTime}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ChronoZonedDateTimeTests}).
 * </p>
 *
 * <p>
 ...
 * @see ChronoZonedDateTimeTests ChronoZonedDateTimeTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.time.temporal.TemporalClassTests<SUT>, org.j8unit.repository.java.lang.ComparableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.time.chrono.ChronoZonedDateTime.class!",
                   java.time.chrono.ChronoZonedDateTime.class.isAssignableFrom(sut));
    }

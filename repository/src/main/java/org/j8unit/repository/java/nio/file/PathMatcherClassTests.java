 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PathMatcher public
 * abstract interface java.nio.file.PathMatcher}.
 *
...
public abstract interface PathMatcherClassTests<SUT extends PathMatcher>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PathMatcher.class!",
                   PathMatcher.class.isAssignableFrom(sut));
    }

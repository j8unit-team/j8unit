...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.nio.file.PathMatcher interface java.nio.file.PathMatcher},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PathMatcherTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PathMatcherTests}.
 * </p>
 *
 * @see java.nio.file.PathMatcher interface java.nio.file.PathMatcher (the hereby targeted class-under-test class)
 * @see PathMatcherTests PathMatcherTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PathMatcherClassTests<SUT extends java.nio.file.PathMatcher>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.nio.file.PathMatcher.class!",
                   java.nio.file.PathMatcher.class.isAssignableFrom(sut));
    }

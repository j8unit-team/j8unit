...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain java.security.interfaces.ECPublicKey interface
 * java.security.interfaces.ECPublicKey}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ECPublicKeyTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see java.security.interfaces.ECPublicKey interface java.security.interfaces.ECPublicKey (the hereby targeted
 *      class-under-test class)
 * @see ECPublicKeyTests ECPublicKeyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ECPublicKeyClassTests<SUT extends java.security.interfaces.ECPublicKey>
extends org.j8unit.repository.java.security.PublicKeyClassTests<SUT>, ECKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to java.security.interfaces.ECPublicKey.class!",
                   java.security.interfaces.ECPublicKey.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ECPublicKey public
 * abstract interface java.security.interfaces.ECPublicKey}.
 *
...
extends PublicKeyClassTests<SUT>, ECKeyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ECPublicKey.class!",

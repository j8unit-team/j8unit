 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SecureRandomSpi
...
public abstract interface SecureRandomSpiClassTests<SUT extends SecureRandomSpi>
extends SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SecureRandomSpi.class!",
                   SecureRandomSpi.class.isAssignableFrom(sut));
    }

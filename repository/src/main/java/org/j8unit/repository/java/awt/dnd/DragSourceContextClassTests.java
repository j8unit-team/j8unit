 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DragSourceContext
 * public class java.awt.dnd.DragSourceContext}.
 *
...
public abstract interface DragSourceContextClassTests<SUT extends DragSourceContext>
extends DragSourceListenerClassTests<SUT>, DragSourceMotionListenerClassTests<SUT>, SerializableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DragSourceContext.class!",
                   DragSourceContext.class.isAssignableFrom(sut));
    }

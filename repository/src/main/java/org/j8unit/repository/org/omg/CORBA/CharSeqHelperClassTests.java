 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CharSeqHelper
 * public abstract class org.omg.CORBA.CharSeqHelper}.
 *
...
public abstract interface CharSeqHelperClassTests<SUT extends CharSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharSeqHelper.class!",
                   CharSeqHelper.class.isAssignableFrom(sut));
    }

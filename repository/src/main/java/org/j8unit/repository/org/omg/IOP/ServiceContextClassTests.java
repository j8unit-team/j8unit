 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceContext
 * public final class org.omg.IOP.ServiceContext}.
 *
...
public abstract interface ServiceContextClassTests<SUT extends ServiceContext>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceContext.class!",
                   ServiceContext.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FieldNameHelper
 * public abstract class org.omg.DynamicAny.FieldNameHelper}.
 *
...
public abstract interface FieldNameHelperClassTests<SUT extends FieldNameHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FieldNameHelper.class!",
                   FieldNameHelper.class.isAssignableFrom(sut));
    }

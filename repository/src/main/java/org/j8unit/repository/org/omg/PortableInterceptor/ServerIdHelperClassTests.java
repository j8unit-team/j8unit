 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServerIdHelper
 * public abstract class org.omg.PortableInterceptor.ServerIdHelper}.
 *
...
public abstract interface ServerIdHelperClassTests<SUT extends ServerIdHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerIdHelper.class!",
                   ServerIdHelper.class.isAssignableFrom(sut));
    }

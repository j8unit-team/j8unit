 ...
 * org.w3c.dom.html.HTMLMapElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLMapElementTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see HTMLMapElementTests HTMLMapElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface HTMLMapElementClassTests<SUT extends org.w3c.dom.html.HTMLMapElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLMapElement.class!",
                   org.w3c.dom.html.HTMLMapElement.class.isAssignableFrom(sut));
    }

 ...
 * {@link HTMLTableSectionElement public abstract interface org.w3c.dom.html.HTMLTableSectionElement}.
 *
...
public abstract interface HTMLTableSectionElementClassTests<SUT extends HTMLTableSectionElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLTableSectionElement.class!",
                   HTMLTableSectionElement.class.isAssignableFrom(sut));
    }

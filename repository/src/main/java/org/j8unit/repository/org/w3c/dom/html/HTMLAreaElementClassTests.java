 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLAreaElement
 * public abstract interface org.w3c.dom.html.HTMLAreaElement}.
 *
...
public abstract interface HTMLAreaElementClassTests<SUT extends HTMLAreaElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLAreaElement.class!",
                   HTMLAreaElement.class.isAssignableFrom(sut));
    }

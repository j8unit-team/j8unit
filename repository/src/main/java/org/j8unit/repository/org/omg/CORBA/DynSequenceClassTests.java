...
public abstract interface DynSequenceClassTests<SUT extends org.omg.CORBA.DynSequence>
extends ObjectClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynSequence.class!",
                   org.omg.CORBA.DynSequence.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.TAG_CODE_SETS interface org.omg.IOP.TAG_CODE_SETS},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TAG_CODE_SETSTests}).
 * </p>
 *
 * <p>
 ...
 * @see TAG_CODE_SETSTests TAG_CODE_SETSTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TAG_CODE_SETSClassTests<SUT extends org.omg.IOP.TAG_CODE_SETS>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TAG_CODE_SETS.class!",
                   org.omg.IOP.TAG_CODE_SETS.class.isAssignableFrom(sut));
    }

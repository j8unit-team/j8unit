 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TAG_CODE_SETS
...
public abstract interface TAG_CODE_SETSClassTests<SUT extends TAG_CODE_SETS>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TAG_CODE_SETS.class!",
                   TAG_CODE_SETS.class.isAssignableFrom(sut));
    }

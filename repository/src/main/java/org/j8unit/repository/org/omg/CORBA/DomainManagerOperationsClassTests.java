...
public abstract interface DomainManagerOperationsClassTests<SUT extends DomainManagerOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DomainManagerOperations.class!",
                   DomainManagerOperations.class.isAssignableFrom(sut));
    }

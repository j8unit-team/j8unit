 ...
 * org.omg.CORBA.TRANSACTION_ROLLEDBACK}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TRANSACTION_ROLLEDBACKTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.TRANSACTION_ROLLEDBACK class org.omg.CORBA.TRANSACTION_ROLLEDBACK (the hereby targeted
 *      class-under-test class)
 * @see TRANSACTION_ROLLEDBACKTests TRANSACTION_ROLLEDBACKTests (The complementary j8unit test interface containing the
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.TRANSACTION_ROLLEDBACK.class!",
                   org.omg.CORBA.TRANSACTION_ROLLEDBACK.class.isAssignableFrom(sut));
    }

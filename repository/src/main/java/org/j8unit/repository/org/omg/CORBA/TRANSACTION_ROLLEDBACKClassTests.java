...
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TRANSACTION_ROLLEDBACK.class!",
                   TRANSACTION_ROLLEDBACK.class.isAssignableFrom(sut));
    }

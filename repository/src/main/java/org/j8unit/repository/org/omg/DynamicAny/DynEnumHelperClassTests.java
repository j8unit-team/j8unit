 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynEnumHelper
...
public abstract interface DynEnumHelperClassTests<SUT extends DynEnumHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynEnumHelper.class!",
                   DynEnumHelper.class.isAssignableFrom(sut));
    }

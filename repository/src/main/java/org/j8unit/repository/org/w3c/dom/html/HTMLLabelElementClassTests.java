 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLLabelElement
 * public abstract interface org.w3c.dom.html.HTMLLabelElement}.
 *
...
public abstract interface HTMLLabelElementClassTests<SUT extends HTMLLabelElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLLabelElement.class!",
                   HTMLLabelElement.class.isAssignableFrom(sut));
    }

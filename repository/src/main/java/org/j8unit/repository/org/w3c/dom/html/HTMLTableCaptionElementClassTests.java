...
public abstract interface HTMLTableCaptionElementClassTests<SUT extends HTMLTableCaptionElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLTableCaptionElement.class!",
                   HTMLTableCaptionElement.class.isAssignableFrom(sut));
    }

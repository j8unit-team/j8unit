...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.html.HTMLTableCaptionElement interface
 * org.w3c.dom.html.HTMLTableCaptionElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLTableCaptionElementTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see HTMLTableCaptionElementTests HTMLTableCaptionElementTests (The complementary j8unit test interface containing
...
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLTableCaptionElement.class!",
                   org.w3c.dom.html.HTMLTableCaptionElement.class.isAssignableFrom(sut));
    }

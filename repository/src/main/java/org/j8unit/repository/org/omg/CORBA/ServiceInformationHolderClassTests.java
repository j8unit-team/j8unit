 ...
 * org.omg.CORBA.ServiceInformationHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceInformationHolderTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see ServiceInformationHolderTests ServiceInformationHolderTests (The complementary j8unit test interface containing
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ServiceInformationHolder.class!",
                   org.omg.CORBA.ServiceInformationHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CannotProceedHolder
 * public final class org.omg.CosNaming.NamingContextPackage.CannotProceedHolder}.
 *
...
public abstract interface CannotProceedHolderClassTests<SUT extends CannotProceedHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CannotProceedHolder.class!",
                   CannotProceedHolder.class.isAssignableFrom(sut));
    }

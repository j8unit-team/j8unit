 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ComponentIdHelper
 * public abstract class org.omg.IOP.ComponentIdHelper}.
 *
...
public abstract interface ComponentIdHelperClassTests<SUT extends ComponentIdHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ComponentIdHelper.class!",
                   ComponentIdHelper.class.isAssignableFrom(sut));
    }

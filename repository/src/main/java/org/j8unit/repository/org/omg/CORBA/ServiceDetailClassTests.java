 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceDetail
 * public final class org.omg.CORBA.ServiceDetail}.
 *
...
public abstract interface ServiceDetailClassTests<SUT extends ServiceDetail>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceDetail.class!",
                   ServiceDetail.class.isAssignableFrom(sut));
    }

 ...
 * {@link ID_UNIQUENESS_POLICY_ID public abstract interface org.omg.PortableServer.ID_UNIQUENESS_POLICY_ID}.
 *
...
public abstract interface ID_UNIQUENESS_POLICY_IDClassTests<SUT extends ID_UNIQUENESS_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ID_UNIQUENESS_POLICY_ID.class!",
                   ID_UNIQUENESS_POLICY_ID.class.isAssignableFrom(sut));
    }

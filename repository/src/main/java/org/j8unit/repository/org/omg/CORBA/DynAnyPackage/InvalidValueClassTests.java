 ...
 * org.omg.CORBA.DynAnyPackage.InvalidValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidValueTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidValueTests InvalidValueTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynAnyPackage.InvalidValue.class!",
                   org.omg.CORBA.DynAnyPackage.InvalidValue.class.isAssignableFrom(sut));
    }

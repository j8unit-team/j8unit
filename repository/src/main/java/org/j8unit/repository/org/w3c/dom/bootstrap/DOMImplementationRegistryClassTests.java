...
public abstract interface DOMImplementationRegistryClassTests<SUT extends DOMImplementationRegistry>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.w3c.dom.bootstrap.DOMImplementationRegistry]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMImplementationRegistry.class!",
                   DOMImplementationRegistry.class.isAssignableFrom(sut));
    }

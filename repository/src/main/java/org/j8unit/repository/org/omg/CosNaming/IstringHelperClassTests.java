 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IstringHelperTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CosNaming.IstringHelper class org.omg.CosNaming.IstringHelper (the hereby targeted class-under-test
 *      class)
 * @see IstringHelperTests IstringHelperTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.IstringHelper.class!",
                   org.omg.CosNaming.IstringHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IstringHelper
 * public abstract class org.omg.CosNaming.IstringHelper}.
 *
...
public abstract interface IstringHelperClassTests<SUT extends IstringHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CosNaming.IstringHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IstringHelper.class!",
                   IstringHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CosNaming.IstringHelper]

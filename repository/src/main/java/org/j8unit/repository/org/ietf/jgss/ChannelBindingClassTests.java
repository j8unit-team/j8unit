 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ChannelBinding
...
public abstract interface ChannelBindingClassTests<SUT extends ChannelBinding>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ChannelBinding.class!",
                   ChannelBinding.class.isAssignableFrom(sut));
    }

 ...
 * {@link CompletionStatusHelper public abstract class org.omg.CORBA.CompletionStatusHelper}.
 *
...
public abstract interface CompletionStatusHelperClassTests<SUT extends CompletionStatusHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompletionStatusHelper.class!",
                   CompletionStatusHelper.class.isAssignableFrom(sut));
    }

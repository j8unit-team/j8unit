 ...
 * org.xml.sax.helpers.XMLFilterImpl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLFilterImplTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see XMLFilterImplTests XMLFilterImplTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.org.xml.sax.ErrorHandlerClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.helpers.XMLFilterImpl.class!",
                   org.xml.sax.helpers.XMLFilterImpl.class.isAssignableFrom(sut));
    }

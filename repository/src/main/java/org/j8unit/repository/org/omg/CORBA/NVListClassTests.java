 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NVList public
 * abstract class org.omg.CORBA.NVList}.
 *
...
public abstract interface NVListClassTests<SUT extends NVList>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.NVList]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NVList.class!",
                   NVList.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.NVList]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.NVList]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleHolder public
 * final class org.omg.CORBA.DoubleHolder}.
 *
...
public abstract interface DoubleHolderClassTests<SUT extends DoubleHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleHolder.class!",
                   DoubleHolder.class.isAssignableFrom(sut));
    }

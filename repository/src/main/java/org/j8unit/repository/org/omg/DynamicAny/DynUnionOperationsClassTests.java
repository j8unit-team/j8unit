...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.DynamicAny.DynUnionOperations interface
 * org.omg.DynamicAny.DynUnionOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynUnionOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynUnionOperationsTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynUnionOperations interface org.omg.DynamicAny.DynUnionOperations (the hereby targeted
 *      class-under-test class)
 * @see DynUnionOperationsTests DynUnionOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface DynUnionOperationsClassTests<SUT extends org.omg.DynamicAny.DynUnionOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynUnionOperations.class!",
                   org.omg.DynamicAny.DynUnionOperations.class.isAssignableFrom(sut));
    }

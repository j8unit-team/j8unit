 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynUnionOperations
 * public abstract interface org.omg.DynamicAny.DynUnionOperations}.
 *
...
public abstract interface DynUnionOperationsClassTests<SUT extends DynUnionOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynUnionOperations.class!",
                   DynUnionOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AlreadyBound public
 * final class org.omg.CosNaming.NamingContextPackage.AlreadyBound}.
 *
...
public abstract interface AlreadyBoundClassTests<SUT extends AlreadyBound>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlreadyBound.class!",
                   AlreadyBound.class.isAssignableFrom(sut));
    }

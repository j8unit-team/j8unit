...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer._ServantActivatorStub class
 * org.omg.PortableServer._ServantActivatorStub}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _ServantActivatorStubTests}).
 * </p>
 *
 * <p>
 ...
 * {@link _ServantActivatorStubTests}.
 * </p>
 *
 * @see org.omg.PortableServer._ServantActivatorStub class org.omg.PortableServer._ServantActivatorStub (the hereby
 *      targeted class-under-test class)
 * @see _ServantActivatorStubTests _ServantActivatorStubTests (The complementary j8unit test interface containing the
...
extends ServantActivatorClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer._ServantActivatorStub.class!",
                   org.omg.PortableServer._ServantActivatorStub.class.isAssignableFrom(sut));
    }

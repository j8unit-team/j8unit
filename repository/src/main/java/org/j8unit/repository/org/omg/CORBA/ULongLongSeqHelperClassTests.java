 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ULongLongSeqHelper
 * public abstract class org.omg.CORBA.ULongLongSeqHelper}.
 *
...
public abstract interface ULongLongSeqHelperClassTests<SUT extends ULongLongSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ULongLongSeqHelper.class!",
                   ULongLongSeqHelper.class.isAssignableFrom(sut));
    }

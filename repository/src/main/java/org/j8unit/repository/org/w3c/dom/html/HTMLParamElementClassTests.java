 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLParamElement
 * public abstract interface org.w3c.dom.html.HTMLParamElement}.
 *
...
public abstract interface HTMLParamElementClassTests<SUT extends HTMLParamElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLParamElement.class!",
                   HTMLParamElement.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidNameHolder
 * public final class org.omg.CosNaming.NamingContextPackage.InvalidNameHolder}.
 *
...
public abstract interface InvalidNameHolderClassTests<SUT extends InvalidNameHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidNameHolder.class!",
                   InvalidNameHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StructMember public
 * final class org.omg.CORBA.StructMember}.
 *
...
public abstract interface StructMemberClassTests<SUT extends StructMember>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StructMember.class!",
                   StructMember.class.isAssignableFrom(sut));
    }

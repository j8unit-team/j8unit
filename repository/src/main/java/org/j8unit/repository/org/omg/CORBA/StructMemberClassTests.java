 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StructMemberTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StructMemberTests}.
 * </p>
 *
 * @see org.omg.CORBA.StructMember class org.omg.CORBA.StructMember (the hereby targeted class-under-test class)
 * @see StructMemberTests StructMemberTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.StructMember.class!",
                   org.omg.CORBA.StructMember.class.isAssignableFrom(sut));
    }

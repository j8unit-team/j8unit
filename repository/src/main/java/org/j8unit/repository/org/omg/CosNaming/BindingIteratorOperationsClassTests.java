 ...
 * {@link BindingIteratorOperations public abstract interface org.omg.CosNaming.BindingIteratorOperations}.
 *
...
public abstract interface BindingIteratorOperationsClassTests<SUT extends BindingIteratorOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingIteratorOperations.class!",
                   BindingIteratorOperations.class.isAssignableFrom(sut));
    }

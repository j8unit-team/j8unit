 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IntHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IntHolderTests}.
 * </p>
 *
 * @see org.omg.CORBA.IntHolder class org.omg.CORBA.IntHolder (the hereby targeted class-under-test class)
 * @see IntHolderTests IntHolderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.IntHolder.class!",
                   org.omg.CORBA.IntHolder.class.isAssignableFrom(sut));
    }

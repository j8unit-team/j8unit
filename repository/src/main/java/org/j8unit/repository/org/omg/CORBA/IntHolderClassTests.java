 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IntHolder public
 * final class org.omg.CORBA.IntHolder}.
 *
...
public abstract interface IntHolderClassTests<SUT extends IntHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.IntHolder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IntHolder.class!",
                   IntHolder.class.isAssignableFrom(sut));
    }

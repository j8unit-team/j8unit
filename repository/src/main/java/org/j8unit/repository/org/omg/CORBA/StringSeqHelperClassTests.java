 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringSeqHelper
 * public abstract class org.omg.CORBA.StringSeqHelper}.
 *
...
public abstract interface StringSeqHelperClassTests<SUT extends StringSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringSeqHelper.class!",
                   StringSeqHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.StringSeqHelper]

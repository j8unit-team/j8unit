...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.html.HTMLDivElement interface
 * org.w3c.dom.html.HTMLDivElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLDivElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTMLDivElementTests}.
 * </p>
 *
 * @see org.w3c.dom.html.HTMLDivElement interface org.w3c.dom.html.HTMLDivElement (the hereby targeted class-under-test
 *      class)
 * @see HTMLDivElementTests HTMLDivElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface HTMLDivElementClassTests<SUT extends org.w3c.dom.html.HTMLDivElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLDivElement.class!",
                   org.w3c.dom.html.HTMLDivElement.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLBRElement
...
public abstract interface HTMLBRElementClassTests<SUT extends HTMLBRElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLBRElement.class!",
                   HTMLBRElement.class.isAssignableFrom(sut));
    }

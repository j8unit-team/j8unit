 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UShortSeqHelper
 * public abstract class org.omg.CORBA.UShortSeqHelper}.
 *
...
public abstract interface UShortSeqHelperClassTests<SUT extends UShortSeqHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.UShortSeqHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UShortSeqHelper.class!",
                   UShortSeqHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.UShortSeqHelper]

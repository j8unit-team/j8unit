 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventTarget public
 * abstract interface org.w3c.dom.events.EventTarget}.
 *
...
public abstract interface EventTargetClassTests<SUT extends EventTarget>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventTarget.class!",
                   EventTarget.class.isAssignableFrom(sut));
    }

 ...
 * org.w3c.dom.events.EventTarget}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventTargetTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventTargetTests}.
 * </p>
 *
 * @see org.w3c.dom.events.EventTarget interface org.w3c.dom.events.EventTarget (the hereby targeted class-under-test
 *      class)
 * @see EventTargetTests EventTargetTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface EventTargetClassTests<SUT extends org.w3c.dom.events.EventTarget>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.events.EventTarget.class!",
                   org.w3c.dom.events.EventTarget.class.isAssignableFrom(sut));
    }

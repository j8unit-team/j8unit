 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TCKind public class
...
public abstract interface TCKindClassTests<SUT extends TCKind>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.TCKind]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TCKind.class!",

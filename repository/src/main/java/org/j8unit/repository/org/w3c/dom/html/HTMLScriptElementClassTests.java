 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLScriptElement
 * public abstract interface org.w3c.dom.html.HTMLScriptElement}.
 *
...
public abstract interface HTMLScriptElementClassTests<SUT extends HTMLScriptElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLScriptElement.class!",
                   HTMLScriptElement.class.isAssignableFrom(sut));
    }

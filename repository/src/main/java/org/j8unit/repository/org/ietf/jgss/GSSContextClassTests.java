 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GSSContext public
 * abstract interface org.ietf.jgss.GSSContext}.
 *
...
public abstract interface GSSContextClassTests<SUT extends GSSContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GSSContext.class!",
                   GSSContext.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GSSContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GSSContextTests}.
 * </p>
 *
 * @see org.ietf.jgss.GSSContext interface org.ietf.jgss.GSSContext (the hereby targeted class-under-test class)
 * @see GSSContextTests GSSContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface GSSContextClassTests<SUT extends org.ietf.jgss.GSSContext>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.ietf.jgss.GSSContext.class!",
                   org.ietf.jgss.GSSContext.class.isAssignableFrom(sut));
    }

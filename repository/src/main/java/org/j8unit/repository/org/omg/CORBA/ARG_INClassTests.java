...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.ARG_IN interface org.omg.CORBA.ARG_IN}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ARG_INTests}).
 * </p>
 *
 * <p>
 ...
 * @see ARG_INTests ARG_INTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ARG_INClassTests<SUT extends org.omg.CORBA.ARG_IN>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ARG_IN.class!",
                   org.omg.CORBA.ARG_IN.class.isAssignableFrom(sut));
    }

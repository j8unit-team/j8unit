 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ARG_IN public
...
public abstract interface ARG_INClassTests<SUT extends ARG_IN>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ARG_IN.class!",
                   ARG_IN.class.isAssignableFrom(sut));
    }

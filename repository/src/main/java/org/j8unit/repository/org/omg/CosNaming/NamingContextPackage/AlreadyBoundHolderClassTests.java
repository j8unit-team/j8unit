 ...
 * org.omg.CosNaming.NamingContextPackage.AlreadyBoundHolder}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AlreadyBoundHolderTests}).
 * </p>
 *
 * <p>
 ...
 * @see AlreadyBoundHolderTests AlreadyBoundHolderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPackage.AlreadyBoundHolder.class!",
                   org.omg.CosNaming.NamingContextPackage.AlreadyBoundHolder.class.isAssignableFrom(sut));
    }

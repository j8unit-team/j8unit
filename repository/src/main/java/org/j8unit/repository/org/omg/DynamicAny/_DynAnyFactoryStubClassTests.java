 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _DynAnyFactoryStub
 * public class org.omg.DynamicAny._DynAnyFactoryStub}.
 *
...
public abstract interface _DynAnyFactoryStubClassTests<SUT extends _DynAnyFactoryStub>
extends org.j8unit.repository.org.omg.DynamicAny.DynAnyFactoryClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _DynAnyFactoryStub.class!",
                   _DynAnyFactoryStub.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.DynamicAny._DynAnyFactoryStub]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.DynamicAny._DynAnyFactoryStub]

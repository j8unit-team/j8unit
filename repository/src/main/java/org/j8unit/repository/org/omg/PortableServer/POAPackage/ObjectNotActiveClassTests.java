 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectNotActive
...
public abstract interface ObjectNotActiveClassTests<SUT extends ObjectNotActive>
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectNotActive.class!",
                   ObjectNotActive.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLFieldSetElement
 * public abstract interface org.w3c.dom.html.HTMLFieldSetElement}.
 *
...
public abstract interface HTMLFieldSetElementClassTests<SUT extends HTMLFieldSetElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLFieldSetElement.class!",
                   HTMLFieldSetElement.class.isAssignableFrom(sut));
    }

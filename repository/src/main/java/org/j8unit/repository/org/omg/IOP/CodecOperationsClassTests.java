 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CodecOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CodecOperationsTests}.
 * </p>
 *
 * @see org.omg.IOP.CodecOperations interface org.omg.IOP.CodecOperations (the hereby targeted class-under-test class)
 * @see CodecOperationsTests CodecOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface CodecOperationsClassTests<SUT extends org.omg.IOP.CodecOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.CodecOperations.class!",
                   org.omg.IOP.CodecOperations.class.isAssignableFrom(sut));
    }

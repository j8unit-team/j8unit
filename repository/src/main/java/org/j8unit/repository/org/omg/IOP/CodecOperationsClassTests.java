 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CodecOperations
...
public abstract interface CodecOperationsClassTests<SUT extends CodecOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CodecOperations.class!",
                   CodecOperations.class.isAssignableFrom(sut));
    }

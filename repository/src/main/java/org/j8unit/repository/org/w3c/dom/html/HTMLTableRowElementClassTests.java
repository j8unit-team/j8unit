 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLTableRowElement
 * public abstract interface org.w3c.dom.html.HTMLTableRowElement}.
 *
...
public abstract interface HTMLTableRowElementClassTests<SUT extends HTMLTableRowElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLTableRowElement.class!",
                   HTMLTableRowElement.class.isAssignableFrom(sut));
    }

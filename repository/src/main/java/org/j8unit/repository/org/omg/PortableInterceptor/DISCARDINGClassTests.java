 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DISCARDING public
 * abstract interface org.omg.PortableInterceptor.DISCARDING}.
 *
...
public abstract interface DISCARDINGClassTests<SUT extends DISCARDING>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DISCARDING.class!",
                   DISCARDING.class.isAssignableFrom(sut));
    }

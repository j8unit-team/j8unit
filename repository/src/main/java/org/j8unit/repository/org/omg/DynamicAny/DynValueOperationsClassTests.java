...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.DynamicAny.DynValueOperations interface
 * org.omg.DynamicAny.DynValueOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynValueOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * @see DynValueOperationsTests DynValueOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface DynValueOperationsClassTests<SUT extends org.omg.DynamicAny.DynValueOperations>
extends DynValueCommonOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynValueOperations.class!",
                   org.omg.DynamicAny.DynValueOperations.class.isAssignableFrom(sut));
    }

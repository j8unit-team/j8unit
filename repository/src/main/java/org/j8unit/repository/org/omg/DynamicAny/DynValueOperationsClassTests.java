 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynValueOperations
 * public abstract interface org.omg.DynamicAny.DynValueOperations}.
 *
...
extends org.j8unit.repository.org.omg.DynamicAny.DynValueCommonOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynValueOperations.class!",
                   DynValueOperations.class.isAssignableFrom(sut));
    }

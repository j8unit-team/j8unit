...
public abstract interface ServerRequestInterceptorClassTests<SUT extends ServerRequestInterceptor>
...
org.j8unit.repository.org.omg.PortableInterceptor.InterceptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerRequestInterceptor.class!",
                   ServerRequestInterceptor.class.isAssignableFrom(sut));
    }

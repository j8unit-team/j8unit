 ...
 * org.omg.PortableInterceptor.ServerRequestInterceptor}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServerRequestInterceptorTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see ServerRequestInterceptorTests ServerRequestInterceptorTests (The complementary j8unit test interface containing
...
public abstract interface ServerRequestInterceptorClassTests<SUT extends org.omg.PortableInterceptor.ServerRequestInterceptor>
extends ServerRequestInterceptorOperationsClassTests<SUT>, InterceptorClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ServerRequestInterceptor.class!",
                   org.omg.PortableInterceptor.ServerRequestInterceptor.class.isAssignableFrom(sut));
    }

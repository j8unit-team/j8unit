 ...
 * {@link ServantRetentionPolicyValue public class org.omg.PortableServer.ServantRetentionPolicyValue}.
 *
...
public abstract interface ServantRetentionPolicyValueClassTests<SUT extends ServantRetentionPolicyValue>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantRetentionPolicyValue.class!",
                   ServantRetentionPolicyValue.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLTableElement
 * public abstract interface org.w3c.dom.html.HTMLTableElement}.
 *
...
public abstract interface HTMLTableElementClassTests<SUT extends HTMLTableElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLTableElement.class!",
                   HTMLTableElement.class.isAssignableFrom(sut));
    }

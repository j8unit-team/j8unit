 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameValuePairHelper
 * public abstract class org.omg.DynamicAny.NameValuePairHelper}.
 *
...
public abstract interface NameValuePairHelperClassTests<SUT extends NameValuePairHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameValuePairHelper.class!",
                   NameValuePairHelper.class.isAssignableFrom(sut));
    }

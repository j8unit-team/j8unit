...
public abstract interface DynArrayClassTests<SUT extends org.omg.DynamicAny.DynArray>
extends DynArrayOperationsClassTests<SUT>, DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynArray.class!",
                   org.omg.DynamicAny.DynArray.class.isAssignableFrom(sut));
    }

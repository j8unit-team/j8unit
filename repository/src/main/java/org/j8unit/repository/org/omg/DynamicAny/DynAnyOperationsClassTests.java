 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynAnyOperations
 * public abstract interface org.omg.DynamicAny.DynAnyOperations}.
 *
...
public abstract interface DynAnyOperationsClassTests<SUT extends DynAnyOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynAnyOperations.class!",
                   DynAnyOperations.class.isAssignableFrom(sut));
    }

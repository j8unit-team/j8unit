...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.UserException class org.omg.CORBA.UserException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UserExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see UserExceptionTests UserExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface UserExceptionClassTests<SUT extends org.omg.CORBA.UserException>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.UserException.class!",
                   org.omg.CORBA.UserException.class.isAssignableFrom(sut));
    }

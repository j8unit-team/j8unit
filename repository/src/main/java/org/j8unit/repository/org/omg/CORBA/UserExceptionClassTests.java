 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UserException
...
public abstract interface UserExceptionClassTests<SUT extends UserException>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UserException.class!",
                   UserException.class.isAssignableFrom(sut));
    }

...
public abstract interface ID_ASSIGNMENT_POLICY_IDClassTests<SUT extends ID_ASSIGNMENT_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ID_ASSIGNMENT_POLICY_ID.class!",

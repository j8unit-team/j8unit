 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INV_FLAG public
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INV_FLAG.class!",
                   INV_FLAG.class.isAssignableFrom(sut));
    }

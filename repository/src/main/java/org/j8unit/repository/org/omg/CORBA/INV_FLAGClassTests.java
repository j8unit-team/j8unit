 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INV_FLAGTests}).
 * </p>
 *
 * <p>
 ...
 * @see INV_FLAGTests INV_FLAGTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INV_FLAG.class!",
                   org.omg.CORBA.INV_FLAG.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WStringSeqHelper
 * public abstract class org.omg.CORBA.WStringSeqHelper}.
 *
...
public abstract interface WStringSeqHelperClassTests<SUT extends WStringSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WStringSeqHelper.class!",
                   WStringSeqHelper.class.isAssignableFrom(sut));
    }

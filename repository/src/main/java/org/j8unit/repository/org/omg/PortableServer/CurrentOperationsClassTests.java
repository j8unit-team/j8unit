...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.CurrentOperations interface
 * org.omg.PortableServer.CurrentOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
...
public abstract interface CurrentOperationsClassTests<SUT extends org.omg.PortableServer.CurrentOperations>
extends org.j8unit.repository.org.omg.CORBA.CurrentOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.CurrentOperations.class!",
                   org.omg.PortableServer.CurrentOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_CONTEXT public
 * final class org.omg.CORBA.BAD_CONTEXT}.
 *
...
public abstract interface BAD_CONTEXTClassTests<SUT extends BAD_CONTEXT>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_CONTEXT.class!",
                   BAD_CONTEXT.class.isAssignableFrom(sut));
    }

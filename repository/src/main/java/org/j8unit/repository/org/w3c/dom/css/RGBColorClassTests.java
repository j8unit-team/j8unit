 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RGBColor public
 * abstract interface org.w3c.dom.css.RGBColor}.
 *
...
public abstract interface RGBColorClassTests<SUT extends RGBColor>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RGBColor.class!",
                   RGBColor.class.isAssignableFrom(sut));
    }

 ...
 * {@link WrongTransactionHelper public abstract class org.omg.CORBA.WrongTransactionHelper}.
 *
...
public abstract interface WrongTransactionHelperClassTests<SUT extends WrongTransactionHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WrongTransactionHelper.class!",
                   WrongTransactionHelper.class.isAssignableFrom(sut));
    }

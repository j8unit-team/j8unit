...
public abstract interface ServiceContextHolderClassTests<SUT extends ServiceContextHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceContextHolder.class!",
                   ServiceContextHolder.class.isAssignableFrom(sut));
    }

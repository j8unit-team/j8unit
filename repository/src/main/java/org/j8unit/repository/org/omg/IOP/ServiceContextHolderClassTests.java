 ...
 * org.omg.IOP.ServiceContextHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceContextHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServiceContextHolderTests}
 * .
 * </p>
 *
 * @see org.omg.IOP.ServiceContextHolder class org.omg.IOP.ServiceContextHolder (the hereby targeted class-under-test
 *      class)
 * @see ServiceContextHolderTests ServiceContextHolderTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.ServiceContextHolder.class!",
                   org.omg.IOP.ServiceContextHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynArrayHelper
...
public abstract interface DynArrayHelperClassTests<SUT extends DynArrayHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynArrayHelper.class!",
                   DynArrayHelper.class.isAssignableFrom(sut));
    }

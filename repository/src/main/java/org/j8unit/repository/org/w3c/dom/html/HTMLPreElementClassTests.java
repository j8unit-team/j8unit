 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLPreElement
...
public abstract interface HTMLPreElementClassTests<SUT extends HTMLPreElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLPreElement.class!",
                   HTMLPreElement.class.isAssignableFrom(sut));
    }

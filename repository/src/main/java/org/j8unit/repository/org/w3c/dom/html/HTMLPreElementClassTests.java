 ...
 * org.w3c.dom.html.HTMLPreElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLPreElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTMLPreElementTests}.
 * </p>
 *
 * @see org.w3c.dom.html.HTMLPreElement interface org.w3c.dom.html.HTMLPreElement (the hereby targeted class-under-test
 *      class)
 * @see HTMLPreElementTests HTMLPreElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface HTMLPreElementClassTests<SUT extends org.w3c.dom.html.HTMLPreElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLPreElement.class!",
                   org.w3c.dom.html.HTMLPreElement.class.isAssignableFrom(sut));
    }

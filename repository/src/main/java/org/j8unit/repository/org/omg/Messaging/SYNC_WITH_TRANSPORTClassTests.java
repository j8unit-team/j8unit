 ...
 * org.omg.Messaging.SYNC_WITH_TRANSPORT}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SYNC_WITH_TRANSPORTTests}).
 * </p>
 *
 * <p>
 ...
 * @see SYNC_WITH_TRANSPORTTests SYNC_WITH_TRANSPORTTests (The complementary j8unit test interface containing the
...
public abstract interface SYNC_WITH_TRANSPORTClassTests<SUT extends org.omg.Messaging.SYNC_WITH_TRANSPORT>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.Messaging.SYNC_WITH_TRANSPORT.class!",
                   org.omg.Messaging.SYNC_WITH_TRANSPORT.class.isAssignableFrom(sut));
    }

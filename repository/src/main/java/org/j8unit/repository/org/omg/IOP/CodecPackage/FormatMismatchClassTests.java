 ...
 * org.omg.IOP.CodecPackage.FormatMismatch}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link FormatMismatchTests}).
 * </p>
 *
 * <p>
 ...
 * @see FormatMismatchTests FormatMismatchTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.CodecPackage.FormatMismatch.class!",
                   org.omg.IOP.CodecPackage.FormatMismatch.class.isAssignableFrom(sut));
    }

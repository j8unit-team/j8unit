 ...
 * {@link SERVANT_RETENTION_POLICY_ID public abstract interface org.omg.PortableServer.SERVANT_RETENTION_POLICY_ID}.
 *
...
public abstract interface SERVANT_RETENTION_POLICY_IDClassTests<SUT extends SERVANT_RETENTION_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SERVANT_RETENTION_POLICY_ID.class!",
                   SERVANT_RETENTION_POLICY_ID.class.isAssignableFrom(sut));
    }

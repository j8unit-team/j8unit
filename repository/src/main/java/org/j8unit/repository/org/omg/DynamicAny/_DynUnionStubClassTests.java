 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _DynUnionStub
...
public abstract interface _DynUnionStubClassTests<SUT extends _DynUnionStub>
extends org.j8unit.repository.org.omg.DynamicAny.DynUnionClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.DynamicAny._DynUnionStub]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _DynUnionStub.class!",
                   _DynUnionStub.class.isAssignableFrom(sut));
    }

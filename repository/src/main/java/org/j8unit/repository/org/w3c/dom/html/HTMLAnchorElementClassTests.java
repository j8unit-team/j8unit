 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLAnchorElement
 * public abstract interface org.w3c.dom.html.HTMLAnchorElement}.
 *
...
public abstract interface HTMLAnchorElementClassTests<SUT extends HTMLAnchorElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLAnchorElement.class!",
                   HTMLAnchorElement.class.isAssignableFrom(sut));
    }

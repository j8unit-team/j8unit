 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FixedHolder public
 * final class org.omg.CORBA.FixedHolder}.
 *
...
public abstract interface FixedHolderClassTests<SUT extends FixedHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FixedHolder.class!",
                   FixedHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TransactionService
 * public abstract interface org.omg.IOP.TransactionService}.
 *
...
public abstract interface TransactionServiceClassTests<SUT extends TransactionService>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TransactionService.class!",
                   TransactionService.class.isAssignableFrom(sut));
    }

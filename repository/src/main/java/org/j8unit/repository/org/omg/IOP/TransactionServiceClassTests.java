 ...
 * org.omg.IOP.TransactionService}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TransactionServiceTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see TransactionServiceTests TransactionServiceTests (The complementary j8unit test interface containing the instance
...
public abstract interface TransactionServiceClassTests<SUT extends org.omg.IOP.TransactionService>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TransactionService.class!",
                   org.omg.IOP.TransactionService.class.isAssignableFrom(sut));
    }

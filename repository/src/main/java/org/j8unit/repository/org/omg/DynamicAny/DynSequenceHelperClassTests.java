 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynSequenceHelper
 * public abstract class org.omg.DynamicAny.DynSequenceHelper}.
 *
...
public abstract interface DynSequenceHelperClassTests<SUT extends DynSequenceHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynSequenceHelper.class!",
                   DynSequenceHelper.class.isAssignableFrom(sut));
    }

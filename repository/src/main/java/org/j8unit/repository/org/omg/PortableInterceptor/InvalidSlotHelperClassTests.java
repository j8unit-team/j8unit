 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidSlotHelper
 * public abstract class org.omg.PortableInterceptor.InvalidSlotHelper}.
 *
...
public abstract interface InvalidSlotHelperClassTests<SUT extends InvalidSlotHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableInterceptor.InvalidSlotHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidSlotHelper.class!",
                   InvalidSlotHelper.class.isAssignableFrom(sut));
    }

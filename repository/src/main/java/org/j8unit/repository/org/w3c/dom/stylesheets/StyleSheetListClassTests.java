 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StyleSheetList
...
public abstract interface StyleSheetListClassTests<SUT extends StyleSheetList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StyleSheetList.class!",
                   StyleSheetList.class.isAssignableFrom(sut));
    }

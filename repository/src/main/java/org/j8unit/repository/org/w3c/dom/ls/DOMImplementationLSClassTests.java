 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMImplementationLS
 * public abstract interface org.w3c.dom.ls.DOMImplementationLS}.
 *
...
public abstract interface DOMImplementationLSClassTests<SUT extends DOMImplementationLS>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMImplementationLS.class!",
                   DOMImplementationLS.class.isAssignableFrom(sut));
    }

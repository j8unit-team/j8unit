 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Request public
...
public abstract interface RequestClassTests<SUT extends Request>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Request.class!",
                   Request.class.isAssignableFrom(sut));
    }

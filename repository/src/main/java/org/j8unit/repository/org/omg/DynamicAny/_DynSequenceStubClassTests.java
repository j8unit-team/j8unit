 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _DynSequenceStub
 * public class org.omg.DynamicAny._DynSequenceStub}.
 *
...
public abstract interface _DynSequenceStubClassTests<SUT extends _DynSequenceStub>
extends DynSequenceClassTests<SUT>, ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _DynSequenceStub.class!",
                   _DynSequenceStub.class.isAssignableFrom(sut));
    }

...
public abstract interface ObjectReferenceTemplateSeqHolderClassTests<SUT extends ObjectReferenceTemplateSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectReferenceTemplateSeqHolder.class!",
                   ObjectReferenceTemplateSeqHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TRANSPORT_RETRY
 * public abstract interface org.omg.PortableInterceptor.TRANSPORT_RETRY}.
 *
...
public abstract interface TRANSPORT_RETRYClassTests<SUT extends TRANSPORT_RETRY>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TRANSPORT_RETRY.class!",
                   TRANSPORT_RETRY.class.isAssignableFrom(sut));
    }

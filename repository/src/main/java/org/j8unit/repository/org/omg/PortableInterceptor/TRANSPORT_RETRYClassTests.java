...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.TRANSPORT_RETRY interface
 * org.omg.PortableInterceptor.TRANSPORT_RETRY}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TRANSPORT_RETRYTests}).
 * </p>
 *
 * <p>
 ...
 * @see TRANSPORT_RETRYTests TRANSPORT_RETRYTests (The complementary j8unit test interface containing the instance
...
public abstract interface TRANSPORT_RETRYClassTests<SUT extends org.omg.PortableInterceptor.TRANSPORT_RETRY>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.TRANSPORT_RETRY.class!",
                   org.omg.PortableInterceptor.TRANSPORT_RETRY.class.isAssignableFrom(sut));
    }

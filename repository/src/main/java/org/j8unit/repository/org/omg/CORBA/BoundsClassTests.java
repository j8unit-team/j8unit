...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.Bounds class org.omg.CORBA.Bounds}, containing all type
 ...
 * </p>
 *
 * @see org.omg.CORBA.Bounds class org.omg.CORBA.Bounds (the hereby targeted class-under-test class)
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.Bounds.class!",
                   org.omg.CORBA.Bounds.class.isAssignableFrom(sut));
    }

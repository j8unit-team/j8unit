 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WrongPolicy public
 * final class org.omg.PortableServer.POAPackage.WrongPolicy}.
 *
...
public abstract interface WrongPolicyClassTests<SUT extends WrongPolicy>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WrongPolicy.class!",
                   WrongPolicy.class.isAssignableFrom(sut));
    }

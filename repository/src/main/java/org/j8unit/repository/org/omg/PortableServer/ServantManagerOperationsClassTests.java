...
public abstract interface ServantManagerOperationsClassTests<SUT extends ServantManagerOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantManagerOperations.class!",
                   ServantManagerOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LOCATION_FORWARD
 * public abstract interface org.omg.PortableInterceptor.LOCATION_FORWARD}.
 *
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LOCATION_FORWARD.class!",
                   LOCATION_FORWARD.class.isAssignableFrom(sut));
    }

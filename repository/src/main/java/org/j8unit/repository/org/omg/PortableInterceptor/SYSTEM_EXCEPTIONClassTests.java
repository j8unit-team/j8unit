 ...
 * org.omg.PortableInterceptor.SYSTEM_EXCEPTION}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SYSTEM_EXCEPTIONTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SYSTEM_EXCEPTIONTests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.SYSTEM_EXCEPTION interface org.omg.PortableInterceptor.SYSTEM_EXCEPTION (the hereby
 *      targeted class-under-test class)
 * @see SYSTEM_EXCEPTIONTests SYSTEM_EXCEPTIONTests (The complementary j8unit test interface containing the instance
...
public abstract interface SYSTEM_EXCEPTIONClassTests<SUT extends org.omg.PortableInterceptor.SYSTEM_EXCEPTION>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.SYSTEM_EXCEPTION.class!",
                   org.omg.PortableInterceptor.SYSTEM_EXCEPTION.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLIsIndexElement
 * public abstract interface org.w3c.dom.html.HTMLIsIndexElement}.
 *
...
public abstract interface HTMLIsIndexElementClassTests<SUT extends HTMLIsIndexElement>
extends HTMLElementClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.w3c.dom.html.HTMLIsIndexElement]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLIsIndexElement.class!",
                   HTMLIsIndexElement.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.w3c.dom.html.HTMLIsIndexElement]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.w3c.dom.html.HTMLIsIndexElement]

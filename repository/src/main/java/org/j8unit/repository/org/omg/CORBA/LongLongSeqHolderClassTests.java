 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongLongSeqHolder
 * public final class org.omg.CORBA.LongLongSeqHolder}.
 *
...
public abstract interface LongLongSeqHolderClassTests<SUT extends LongLongSeqHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongLongSeqHolder.class!",
                   LongLongSeqHolder.class.isAssignableFrom(sut));
    }

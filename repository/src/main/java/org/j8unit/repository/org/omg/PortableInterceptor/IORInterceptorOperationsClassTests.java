 ...
 * org.omg.PortableInterceptor.IORInterceptorOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IORInterceptorOperationsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see IORInterceptorOperationsTests IORInterceptorOperationsTests (The complementary j8unit test interface containing
...
public abstract interface IORInterceptorOperationsClassTests<SUT extends org.omg.PortableInterceptor.IORInterceptorOperations>
extends InterceptorOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.IORInterceptorOperations.class!",
                   org.omg.PortableInterceptor.IORInterceptorOperations.class.isAssignableFrom(sut));
    }

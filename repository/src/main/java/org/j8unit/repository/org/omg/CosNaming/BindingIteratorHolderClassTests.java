 ...
 * org.omg.CosNaming.BindingIteratorHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingIteratorHolderTests}).
 * </p>
 *
 * <p>
 ...
 * {@link BindingIteratorHolderTests}.
 * </p>
 *
 * @see org.omg.CosNaming.BindingIteratorHolder class org.omg.CosNaming.BindingIteratorHolder (the hereby targeted
 *      class-under-test class)
 * @see BindingIteratorHolderTests BindingIteratorHolderTests (The complementary j8unit test interface containing the
...
public abstract interface BindingIteratorHolderClassTests<SUT extends org.omg.CosNaming.BindingIteratorHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.BindingIteratorHolder.class!",
                   org.omg.CosNaming.BindingIteratorHolder.class.isAssignableFrom(sut));
    }

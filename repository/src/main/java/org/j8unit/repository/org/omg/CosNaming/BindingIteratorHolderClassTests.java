...
public abstract interface BindingIteratorHolderClassTests<SUT extends BindingIteratorHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingIteratorHolder.class!",
                   BindingIteratorHolder.class.isAssignableFrom(sut));
    }

...
public abstract interface DataInputStreamClassTests<SUT extends org.omg.CORBA.DataInputStream>
extends org.j8unit.repository.org.omg.CORBA.portable.ValueBaseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DataInputStream.class!",
                   org.omg.CORBA.DataInputStream.class.isAssignableFrom(sut));
    }

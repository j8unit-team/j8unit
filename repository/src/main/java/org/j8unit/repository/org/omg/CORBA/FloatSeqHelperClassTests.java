 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FloatSeqHelper
 * public abstract class org.omg.CORBA.FloatSeqHelper}.
 *
...
public abstract interface FloatSeqHelperClassTests<SUT extends FloatSeqHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.FloatSeqHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FloatSeqHelper.class!",
                   FloatSeqHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.FloatSeqHelper]

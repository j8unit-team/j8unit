 ...
 * {@link InvalidTypeForEncodingHelper public abstract class org.omg.IOP.CodecPackage.InvalidTypeForEncodingHelper}.
 *
...
public abstract interface InvalidTypeForEncodingHelperClassTests<SUT extends InvalidTypeForEncodingHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidTypeForEncodingHelper.class!",
                   InvalidTypeForEncodingHelper.class.isAssignableFrom(sut));
    }

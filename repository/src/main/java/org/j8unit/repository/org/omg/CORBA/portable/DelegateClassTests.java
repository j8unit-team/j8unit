 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Delegate public
...
public abstract interface DelegateClassTests<SUT extends Delegate>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Delegate.class!",
                   Delegate.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.portable.Delegate]

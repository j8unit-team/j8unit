 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringHolder public
 * final class org.omg.CORBA.StringHolder}.
 *
...
public abstract interface StringHolderClassTests<SUT extends StringHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringHolder.class!",
                   StringHolder.class.isAssignableFrom(sut));
    }

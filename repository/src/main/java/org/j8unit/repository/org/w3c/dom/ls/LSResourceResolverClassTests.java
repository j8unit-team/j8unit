 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSResourceResolver
 * public abstract interface org.w3c.dom.ls.LSResourceResolver}.
 *
...
public abstract interface LSResourceResolverClassTests<SUT extends LSResourceResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSResourceResolver.class!",
                   LSResourceResolver.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.ENCODING_CDR_ENCAPS interface
 * org.omg.IOP.ENCODING_CDR_ENCAPS}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ENCODING_CDR_ENCAPSTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ENCODING_CDR_ENCAPSTests ENCODING_CDR_ENCAPSTests (The complementary j8unit test interface containing the
...
public abstract interface ENCODING_CDR_ENCAPSClassTests<SUT extends org.omg.IOP.ENCODING_CDR_ENCAPS>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.ENCODING_CDR_ENCAPS.class!",
                   org.omg.IOP.ENCODING_CDR_ENCAPS.class.isAssignableFrom(sut));
    }

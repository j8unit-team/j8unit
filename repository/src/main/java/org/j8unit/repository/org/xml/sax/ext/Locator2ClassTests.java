 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Locator2 public
...
extends org.j8unit.repository.org.xml.sax.LocatorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Locator2.class!",
                   Locator2.class.isAssignableFrom(sut));
    }

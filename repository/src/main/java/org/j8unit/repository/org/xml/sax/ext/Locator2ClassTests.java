 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Locator2Tests}).
 * </p>
 *
 * <p>
 ...
 * @see Locator2Tests Locator2Tests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface Locator2ClassTests<SUT extends org.xml.sax.ext.Locator2>
extends org.j8unit.repository.org.xml.sax.LocatorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.Locator2.class!",
                   org.xml.sax.ext.Locator2.class.isAssignableFrom(sut));
    }

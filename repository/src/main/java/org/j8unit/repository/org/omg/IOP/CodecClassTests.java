...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.Codec interface org.omg.IOP.Codec}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CodecTests}).
 * </p>
 *
 * <p>
 ...
 * @see CodecTests CodecTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends CodecOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.Codec.class!",
                   org.omg.IOP.Codec.class.isAssignableFrom(sut));
    }

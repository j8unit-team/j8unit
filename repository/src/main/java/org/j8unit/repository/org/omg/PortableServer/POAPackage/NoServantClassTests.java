 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NoServant public
 * final class org.omg.PortableServer.POAPackage.NoServant}.
 *
...
public abstract interface NoServantClassTests<SUT extends NoServant>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoServant.class!",
                   NoServant.class.isAssignableFrom(sut));
    }

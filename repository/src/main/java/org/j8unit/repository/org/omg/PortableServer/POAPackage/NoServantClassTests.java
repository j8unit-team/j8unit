 ...
 * org.omg.PortableServer.POAPackage.NoServant}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoServantTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NoServantTests}.
 * </p>
 *
 * @see org.omg.PortableServer.POAPackage.NoServant class org.omg.PortableServer.POAPackage.NoServant (the hereby
 *      targeted class-under-test class)
 * @see NoServantTests NoServantTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.NoServant.class!",
                   org.omg.PortableServer.POAPackage.NoServant.class.isAssignableFrom(sut));
    }

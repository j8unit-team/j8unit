 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefaultHandler2Tests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see DefaultHandler2Tests DefaultHandler2Tests (The complementary j8unit test interface containing the instance
...
extends LexicalHandlerClassTests<SUT>, DeclHandlerClassTests<SUT>, EntityResolver2ClassTests<SUT>,
org.j8unit.repository.org.xml.sax.helpers.DefaultHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.DefaultHandler2.class!",
                   org.xml.sax.ext.DefaultHandler2.class.isAssignableFrom(sut));
    }

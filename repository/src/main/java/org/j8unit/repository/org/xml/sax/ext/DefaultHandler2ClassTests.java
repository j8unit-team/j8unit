 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefaultHandler2
...
extends LexicalHandlerClassTests<SUT>, DeclHandlerClassTests<SUT>, EntityResolver2ClassTests<SUT>, DefaultHandlerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefaultHandler2.class!",
                   DefaultHandler2.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BooleanHolder
...
public abstract interface BooleanHolderClassTests<SUT extends BooleanHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BooleanHolder.class!",
                   BooleanHolder.class.isAssignableFrom(sut));
    }

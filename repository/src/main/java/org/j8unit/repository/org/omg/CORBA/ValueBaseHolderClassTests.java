 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueBaseHolder
...
public abstract interface ValueBaseHolderClassTests<SUT extends ValueBaseHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueBaseHolder.class!",
                   ValueBaseHolder.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _IDLTypeStubTests}).
 * </p>
 *
 * <p>
 ...
 * @see _IDLTypeStubTests _IDLTypeStubTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends IDLTypeClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA._IDLTypeStub.class!",
                   org.omg.CORBA._IDLTypeStub.class.isAssignableFrom(sut));
    }

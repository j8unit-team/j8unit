 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _IDLTypeStub public
...
public abstract interface _IDLTypeStubClassTests<SUT extends _IDLTypeStub>
extends IDLTypeClassTests<SUT>, ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _IDLTypeStub.class!",
                   _IDLTypeStub.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA._IDLTypeStub]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link POAManager public
 * abstract interface org.omg.PortableServer.POAManager}.
 *
...
public abstract interface POAManagerClassTests<SUT extends POAManager>
extends POAManagerOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to POAManager.class!",
                   POAManager.class.isAssignableFrom(sut));
    }

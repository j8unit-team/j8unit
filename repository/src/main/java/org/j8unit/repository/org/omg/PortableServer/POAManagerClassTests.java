 ...
 * org.omg.PortableServer.POAManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link POAManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link POAManagerTests}.
 * </p>
 *
 * @see org.omg.PortableServer.POAManager interface org.omg.PortableServer.POAManager (the hereby targeted
 *      class-under-test class)
 * @see POAManagerTests POAManagerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface POAManagerClassTests<SUT extends org.omg.PortableServer.POAManager>
extends POAManagerOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAManager.class!",
                   org.omg.PortableServer.POAManager.class.isAssignableFrom(sut));
    }

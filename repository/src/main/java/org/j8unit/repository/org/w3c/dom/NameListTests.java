 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link NameList public
 ...
 * {@link org.j8unit.repository.org.w3c.dom.NameListClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface NameListTests<SUT extends NameList>
extends RepositoryTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_containsNS_String_String()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

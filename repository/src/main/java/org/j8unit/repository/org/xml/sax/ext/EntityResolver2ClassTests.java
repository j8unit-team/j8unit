 ...
 * org.xml.sax.ext.EntityResolver2}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EntityResolver2Tests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see EntityResolver2Tests EntityResolver2Tests (The complementary j8unit test interface containing the instance
...
public abstract interface EntityResolver2ClassTests<SUT extends org.xml.sax.ext.EntityResolver2>
extends org.j8unit.repository.org.xml.sax.EntityResolverClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.EntityResolver2.class!",
                   org.xml.sax.ext.EntityResolver2.class.isAssignableFrom(sut));
    }

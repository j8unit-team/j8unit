 ...
 * org.xml.sax.ext.EntityResolver2}, containing all class relevant test methods (at least the test methods of accessible
 * constructors and of accessible {@code static} methods). The counterpart J8Unit test interface containing the instance
 * relevant test methods is {@link org.j8unit.repository.org.xml.sax.ext.EntityResolver2Tests}.
 * </p>
 *
 * <p>
...
extends org.j8unit.repository.org.xml.sax.EntityResolverClassTests<SUT> {
     ...
     * @since 0.9.2
     *
     * @j8unit.aim org.xml.sax.ext.EntityResolver2#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

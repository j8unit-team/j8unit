 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _Remote_Stub public
 * final class org.omg.stub.java.rmi._Remote_Stub}.
 *
...
public abstract interface _Remote_StubClassTests<SUT extends _Remote_Stub>
extends RemoteClassTests<SUT>, StubClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.stub.java.rmi._Remote_Stub]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _Remote_Stub.class!",

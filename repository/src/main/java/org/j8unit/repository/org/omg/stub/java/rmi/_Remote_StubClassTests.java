 ...
 * org.omg.stub.java.rmi._Remote_Stub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _Remote_StubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link _Remote_StubTests}.
 * </p>
 *
 * @see org.omg.stub.java.rmi._Remote_Stub class org.omg.stub.java.rmi._Remote_Stub (the hereby targeted
 *      class-under-test class)
 * @see _Remote_StubTests _Remote_StubTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface _Remote_StubClassTests<SUT extends org.omg.stub.java.rmi._Remote_Stub>
extends org.j8unit.repository.java.rmi.RemoteClassTests<SUT>, org.j8unit.repository.javax.rmi.CORBA.StubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.stub.java.rmi._Remote_Stub.class!",
                   org.omg.stub.java.rmi._Remote_Stub.class.isAssignableFrom(sut));
    }

 ...
 * non-{@code static} methods) of {@linkplain org.omg.CORBA.DynValue interface org.omg.CORBA.DynValue}. The
 * complementary j8unit test interface containing the class relevant aspects is {@link DynValueClassTests}.
 * </p>
 *
 * @see org.omg.CORBA.DynValue interface org.omg.CORBA.DynValue (the hereby targeted class-under-test class)
...
extends ObjectTests<SUT>, DynAnyTests<SUT> {
     ...
     * </p>
     *
     * @see org.omg.CORBA.DynValue#current_member_name() public abstract java.lang.String
     *      org.omg.CORBA.DynValue.current_member_name() (the hereby targeted method-under-test)
     */
     ...
     * </p>
     *
     * @see org.omg.CORBA.DynValue#set_members(org.omg.CORBA.NameValuePair[]) public abstract void
     *      org.omg.CORBA.DynValue.set_members(org.omg.CORBA.NameValuePair[]) throws
     ...
     * </p>
     *
     * @see org.omg.CORBA.DynValue#current_member_kind() public abstract org.omg.CORBA.TCKind
     *      org.omg.CORBA.DynValue.current_member_kind() (the hereby targeted method-under-test)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
     ...
     * </p>
     *
     * @see org.omg.CORBA.DynValue#get_members() public abstract org.omg.CORBA.NameValuePair[]
     *      org.omg.CORBA.DynValue.get_members() (the hereby targeted method-under-test)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)

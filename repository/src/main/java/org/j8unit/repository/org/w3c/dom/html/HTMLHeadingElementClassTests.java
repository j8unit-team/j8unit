 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLHeadingElement
 * public abstract interface org.w3c.dom.html.HTMLHeadingElement}.
 *
...
public abstract interface HTMLHeadingElementClassTests<SUT extends HTMLHeadingElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLHeadingElement.class!",
                   HTMLHeadingElement.class.isAssignableFrom(sut));
    }

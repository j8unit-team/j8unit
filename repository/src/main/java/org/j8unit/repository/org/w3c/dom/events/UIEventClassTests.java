 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UIEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UIEventTests}.
 * </p>
 *
 * @see org.w3c.dom.events.UIEvent interface org.w3c.dom.events.UIEvent (the hereby targeted class-under-test class)
 * @see UIEventTests UIEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface UIEventClassTests<SUT extends org.w3c.dom.events.UIEvent>
extends EventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.events.UIEvent.class!",
                   org.w3c.dom.events.UIEvent.class.isAssignableFrom(sut));
    }

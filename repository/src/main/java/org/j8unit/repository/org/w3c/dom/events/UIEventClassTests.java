 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UIEvent public
 * abstract interface org.w3c.dom.events.UIEvent}.
 *
...
public abstract interface UIEventClassTests<SUT extends UIEvent>
extends EventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UIEvent.class!",

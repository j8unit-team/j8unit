 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynValueBox public
 * abstract interface org.omg.DynamicAny.DynValueBox}.
 *
...
public abstract interface DynValueBoxClassTests<SUT extends DynValueBox>
extends DynValueBoxOperationsClassTests<SUT>, DynValueCommonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynValueBox.class!",
                   DynValueBox.class.isAssignableFrom(sut));
    }

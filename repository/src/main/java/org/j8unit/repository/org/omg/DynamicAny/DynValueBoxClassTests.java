 ...
 * org.omg.DynamicAny.DynValueBox}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynValueBoxTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see DynValueBoxTests DynValueBoxTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynValueBoxClassTests<SUT extends org.omg.DynamicAny.DynValueBox>
extends DynValueBoxOperationsClassTests<SUT>, DynValueCommonClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynValueBox.class!",
                   org.omg.DynamicAny.DynValueBox.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidPolicyHelper
 * public abstract class org.omg.PortableServer.POAPackage.InvalidPolicyHelper}.
 *
...
public abstract interface InvalidPolicyHelperClassTests<SUT extends InvalidPolicyHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.POAPackage.InvalidPolicyHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidPolicyHelper.class!",
                   InvalidPolicyHelper.class.isAssignableFrom(sut));
    }

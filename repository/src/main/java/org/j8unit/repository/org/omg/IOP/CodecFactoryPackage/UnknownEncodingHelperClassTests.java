 ...
 * org.omg.IOP.CodecFactoryPackage.UnknownEncodingHelper}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownEncodingHelperTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.IOP.CodecFactoryPackage.UnknownEncodingHelper class
 *      org.omg.IOP.CodecFactoryPackage.UnknownEncodingHelper (the hereby targeted class-under-test class)
 * @see UnknownEncodingHelperTests UnknownEncodingHelperTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.CodecFactoryPackage.UnknownEncodingHelper.class!",
                   org.omg.IOP.CodecFactoryPackage.UnknownEncodingHelper.class.isAssignableFrom(sut));
    }

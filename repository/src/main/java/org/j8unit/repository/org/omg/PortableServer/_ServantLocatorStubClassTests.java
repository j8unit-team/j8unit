 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _ServantLocatorStub
 * public class org.omg.PortableServer._ServantLocatorStub}.
 *
...
public abstract interface _ServantLocatorStubClassTests<SUT extends _ServantLocatorStub>
extends org.j8unit.repository.org.omg.PortableServer.ServantLocatorClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _ServantLocatorStub.class!",
                   _ServantLocatorStub.class.isAssignableFrom(sut));
    }

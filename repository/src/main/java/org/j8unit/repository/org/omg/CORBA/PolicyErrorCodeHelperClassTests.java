...
public abstract interface PolicyErrorCodeHelperClassTests<SUT extends PolicyErrorCodeHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyErrorCodeHelper.class!",
                   PolicyErrorCodeHelper.class.isAssignableFrom(sut));
    }

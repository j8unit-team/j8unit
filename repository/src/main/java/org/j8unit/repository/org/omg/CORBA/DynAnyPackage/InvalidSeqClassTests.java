 ...
 * org.omg.CORBA.DynAnyPackage.InvalidSeq}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidSeqTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvalidSeqTests}.
 * </p>
 *
 * @see org.omg.CORBA.DynAnyPackage.InvalidSeq class org.omg.CORBA.DynAnyPackage.InvalidSeq (the hereby targeted
 *      class-under-test class)
 * @see InvalidSeqTests InvalidSeqTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynAnyPackage.InvalidSeq.class!",
                   org.omg.CORBA.DynAnyPackage.InvalidSeq.class.isAssignableFrom(sut));
    }

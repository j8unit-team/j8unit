 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidSeq public
 * final class org.omg.CORBA.DynAnyPackage.InvalidSeq}.
 *
...
public abstract interface InvalidSeqClassTests<SUT extends InvalidSeq>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidSeq.class!",
                   InvalidSeq.class.isAssignableFrom(sut));
    }

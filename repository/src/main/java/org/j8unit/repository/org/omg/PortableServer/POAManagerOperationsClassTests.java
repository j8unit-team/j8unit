 ...
 * org.omg.PortableServer.POAManagerOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link POAManagerOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link POAManagerOperationsTests}
 * .
 * </p>
 *
 * @see org.omg.PortableServer.POAManagerOperations interface org.omg.PortableServer.POAManagerOperations (the hereby
 *      targeted class-under-test class)
 * @see POAManagerOperationsTests POAManagerOperationsTests (The complementary j8unit test interface containing the
...
public abstract interface POAManagerOperationsClassTests<SUT extends org.omg.PortableServer.POAManagerOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAManagerOperations.class!",
                   org.omg.PortableServer.POAManagerOperations.class.isAssignableFrom(sut));
    }

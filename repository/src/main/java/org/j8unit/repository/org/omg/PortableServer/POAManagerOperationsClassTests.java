...
public abstract interface POAManagerOperationsClassTests<SUT extends POAManagerOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to POAManagerOperations.class!",
                   POAManagerOperations.class.isAssignableFrom(sut));
    }

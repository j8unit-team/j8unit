 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IRObject public
...
extends IRObjectOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IRObject.class!",

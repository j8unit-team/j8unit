 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IRObjectTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IRObjectTests}.
 * </p>
 *
 * @see org.omg.CORBA.IRObject interface org.omg.CORBA.IRObject (the hereby targeted class-under-test class)
 * @see IRObjectTests IRObjectTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IRObjectClassTests<SUT extends org.omg.CORBA.IRObject>
extends IRObjectOperationsClassTests<SUT>, ObjectClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.IRObject.class!",
                   org.omg.CORBA.IRObject.class.isAssignableFrom(sut));
    }

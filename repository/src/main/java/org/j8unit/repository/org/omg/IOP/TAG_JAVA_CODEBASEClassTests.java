...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.TAG_JAVA_CODEBASE interface org.omg.IOP.TAG_JAVA_CODEBASE}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TAG_JAVA_CODEBASETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TAG_JAVA_CODEBASETests}.
 * </p>
 *
 * @see org.omg.IOP.TAG_JAVA_CODEBASE interface org.omg.IOP.TAG_JAVA_CODEBASE (the hereby targeted class-under-test
 *      class)
 * @see TAG_JAVA_CODEBASETests TAG_JAVA_CODEBASETests (The complementary j8unit test interface containing the instance
...
public abstract interface TAG_JAVA_CODEBASEClassTests<SUT extends org.omg.IOP.TAG_JAVA_CODEBASE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TAG_JAVA_CODEBASE.class!",
                   org.omg.IOP.TAG_JAVA_CODEBASE.class.isAssignableFrom(sut));
    }

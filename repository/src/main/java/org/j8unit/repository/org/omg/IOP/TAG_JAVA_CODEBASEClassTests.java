 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TAG_JAVA_CODEBASE
 * public abstract interface org.omg.IOP.TAG_JAVA_CODEBASE}.
 *
...
public abstract interface TAG_JAVA_CODEBASEClassTests<SUT extends TAG_JAVA_CODEBASE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TAG_JAVA_CODEBASE.class!",
                   TAG_JAVA_CODEBASE.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _RMIServer_Stub
...
extends RMIServerClassTests<SUT>, StubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _RMIServer_Stub.class!",
                   _RMIServer_Stub.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.stub.javax.management.remote.rmi._RMIServer_Stub]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.stub.javax.management.remote.rmi._RMIServer_Stub]

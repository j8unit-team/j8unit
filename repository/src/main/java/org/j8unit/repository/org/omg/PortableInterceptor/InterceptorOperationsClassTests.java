 ...
 * {@link InterceptorOperations public abstract interface org.omg.PortableInterceptor.InterceptorOperations}.
 *
...
public abstract interface InterceptorOperationsClassTests<SUT extends InterceptorOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InterceptorOperations.class!",
                   InterceptorOperations.class.isAssignableFrom(sut));
    }

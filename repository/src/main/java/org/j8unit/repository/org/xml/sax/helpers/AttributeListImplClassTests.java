 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AttributeListImpl
...
extends org.j8unit.repository.org.xml.sax.AttributeListClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AttributeListImpl.class!",
                   AttributeListImpl.class.isAssignableFrom(sut));
    }

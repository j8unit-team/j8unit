 ...
 * org.xml.sax.helpers.AttributeListImpl}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttributeListImplTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.xml.sax.helpers.AttributeListImpl class org.xml.sax.helpers.AttributeListImpl (the hereby targeted
 *      class-under-test class)
 * @see AttributeListImplTests AttributeListImplTests (The complementary j8unit test interface containing the instance
...
public abstract interface AttributeListImplClassTests<SUT extends org.xml.sax.helpers.AttributeListImpl>
extends org.j8unit.repository.org.xml.sax.AttributeListClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.helpers.AttributeListImpl.class!",
                   org.xml.sax.helpers.AttributeListImpl.class.isAssignableFrom(sut));
    }

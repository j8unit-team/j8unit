 ...
 * org.omg.PortableServer.POAPackage.AdapterAlreadyExists}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AdapterAlreadyExistsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AdapterAlreadyExistsTests}
 * .
 * </p>
 *
 * @see org.omg.PortableServer.POAPackage.AdapterAlreadyExists class
 *      org.omg.PortableServer.POAPackage.AdapterAlreadyExists (the hereby targeted class-under-test class)
 * @see AdapterAlreadyExistsTests AdapterAlreadyExistsTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.AdapterAlreadyExists.class!",
                   org.omg.PortableServer.POAPackage.AdapterAlreadyExists.class.isAssignableFrom(sut));
    }

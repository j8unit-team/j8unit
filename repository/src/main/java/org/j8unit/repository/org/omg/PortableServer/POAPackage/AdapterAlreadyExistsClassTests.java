 ...
 * {@link AdapterAlreadyExists public final class org.omg.PortableServer.POAPackage.AdapterAlreadyExists}.
 *
...
public abstract interface AdapterAlreadyExistsClassTests<SUT extends AdapterAlreadyExists>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterAlreadyExists.class!",
                   AdapterAlreadyExists.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.xml.sax.DocumentHandler interface org.xml.sax.DocumentHandler},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocumentHandlerTests}.
 * </p>
 *
 * @see org.xml.sax.DocumentHandler interface org.xml.sax.DocumentHandler (the hereby targeted class-under-test class)
 * @see DocumentHandlerTests DocumentHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface DocumentHandlerClassTests<SUT extends org.xml.sax.DocumentHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.DocumentHandler.class!",
                   org.xml.sax.DocumentHandler.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentHandler
 * public abstract interface org.xml.sax.DocumentHandler}.
 *
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentHandler.class!",

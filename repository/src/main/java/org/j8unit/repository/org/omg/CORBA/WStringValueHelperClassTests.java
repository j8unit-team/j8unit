 ...
 * org.omg.CORBA.WStringValueHelper}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WStringValueHelperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WStringValueHelperTests}.
 * </p>
 *
 * @see org.omg.CORBA.WStringValueHelper class org.omg.CORBA.WStringValueHelper (the hereby targeted class-under-test
 *      class)
 * @see WStringValueHelperTests WStringValueHelperTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.portable.BoxedValueHelperClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.WStringValueHelper.class!",
                   org.omg.CORBA.WStringValueHelper.class.isAssignableFrom(sut));
    }

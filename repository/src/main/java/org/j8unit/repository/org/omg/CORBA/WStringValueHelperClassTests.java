 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WStringValueHelper
 * public class org.omg.CORBA.WStringValueHelper}.
 *
...
public abstract interface WStringValueHelperClassTests<SUT extends WStringValueHelper>
extends BoxedValueHelperClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.WStringValueHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WStringValueHelper.class!",
                   WStringValueHelper.class.isAssignableFrom(sut));
    }

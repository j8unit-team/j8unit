 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TaggedProfileHolder
 * public final class org.omg.IOP.TaggedProfileHolder}.
 *
...
public abstract interface TaggedProfileHolderClassTests<SUT extends TaggedProfileHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TaggedProfileHolder.class!",
                   TaggedProfileHolder.class.isAssignableFrom(sut));
    }

...
public abstract interface InvalidAddressHelperClassTests<SUT extends InvalidAddressHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidAddressHelper.class!",
                   InvalidAddressHelper.class.isAssignableFrom(sut));
    }

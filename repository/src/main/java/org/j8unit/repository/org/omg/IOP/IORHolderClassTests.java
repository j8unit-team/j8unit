 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IORHolder public
 * final class org.omg.IOP.IORHolder}.
 *
...
public abstract interface IORHolderClassTests<SUT extends IORHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORHolder.class!",
                   IORHolder.class.isAssignableFrom(sut));
    }

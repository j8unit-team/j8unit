 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IORHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IORHolderTests}.
 * </p>
 *
 * @see org.omg.IOP.IORHolder class org.omg.IOP.IORHolder (the hereby targeted class-under-test class)
 * @see IORHolderTests IORHolderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.IORHolder.class!",
                   org.omg.IOP.IORHolder.class.isAssignableFrom(sut));
    }

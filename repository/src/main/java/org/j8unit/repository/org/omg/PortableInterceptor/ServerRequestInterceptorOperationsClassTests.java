 ...
 * {@link ServerRequestInterceptorOperations public abstract interface
...
public abstract interface ServerRequestInterceptorOperationsClassTests<SUT extends ServerRequestInterceptorOperations>
extends InterceptorOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerRequestInterceptorOperations.class!",
                   ServerRequestInterceptorOperations.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.InvalidSlot class
 * org.omg.PortableInterceptor.InvalidSlot}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidSlotTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvalidSlotTests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.InvalidSlot class org.omg.PortableInterceptor.InvalidSlot (the hereby targeted
 *      class-under-test class)
 * @see InvalidSlotTests InvalidSlotTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InvalidSlotClassTests<SUT extends org.omg.PortableInterceptor.InvalidSlot>
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.InvalidSlot.class!",
                   org.omg.PortableInterceptor.InvalidSlot.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidSlot public
 * final class org.omg.PortableInterceptor.InvalidSlot}.
 *
...
public abstract interface InvalidSlotClassTests<SUT extends InvalidSlot>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidSlot.class!",
                   InvalidSlot.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindingTypeHolder
 * public final class org.omg.CosNaming.BindingTypeHolder}.
 *
...
public abstract interface BindingTypeHolderClassTests<SUT extends BindingTypeHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingTypeHolder.class!",
                   BindingTypeHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectHolder public
 * final class org.omg.CORBA.ObjectHolder}.
 *
...
public abstract interface ObjectHolderClassTests<SUT extends ObjectHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectHolder.class!",
                   ObjectHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringValueHelper
 * public class org.omg.CORBA.StringValueHelper}.
 *
...
extends BoxedValueHelperClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringValueHelper.class!",
                   StringValueHelper.class.isAssignableFrom(sut));
    }

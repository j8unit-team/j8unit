 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StringValueHelperTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see StringValueHelperTests StringValueHelperTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.portable.BoxedValueHelperClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.StringValueHelper.class!",
                   org.omg.CORBA.StringValueHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AdapterStateHelper
 * public abstract class org.omg.PortableInterceptor.AdapterStateHelper}.
 *
...
public abstract interface AdapterStateHelperClassTests<SUT extends AdapterStateHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterStateHelper.class!",
                   AdapterStateHelper.class.isAssignableFrom(sut));
    }

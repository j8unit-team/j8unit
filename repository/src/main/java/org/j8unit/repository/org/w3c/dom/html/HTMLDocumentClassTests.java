...
extends org.j8unit.repository.org.w3c.dom.DocumentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLDocument.class!",
                   org.w3c.dom.html.HTMLDocument.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CORBA.INVALID_TRANSACTION}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INVALID_TRANSACTIONTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see INVALID_TRANSACTIONTests INVALID_TRANSACTIONTests (The complementary j8unit test interface containing the
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INVALID_TRANSACTION.class!",
                   org.omg.CORBA.INVALID_TRANSACTION.class.isAssignableFrom(sut));
    }

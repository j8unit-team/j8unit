 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INVALID_TRANSACTION
 * public final class org.omg.CORBA.INVALID_TRANSACTION}.
 *
...
public abstract interface INVALID_TRANSACTIONClassTests<SUT extends INVALID_TRANSACTION>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INVALID_TRANSACTION.class!",
                   INVALID_TRANSACTION.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OBJECT_NOT_EXIST
 * public final class org.omg.CORBA.OBJECT_NOT_EXIST}.
 *
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OBJECT_NOT_EXIST.class!",
                   OBJECT_NOT_EXIST.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OBJECT_NOT_EXISTTests}).
 * </p>
 *
 * <p>
 ...
 * @see OBJECT_NOT_EXISTTests OBJECT_NOT_EXISTTests (The complementary j8unit test interface containing the instance
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.OBJECT_NOT_EXIST.class!",
                   org.omg.CORBA.OBJECT_NOT_EXIST.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DuplicateNameHelper
 * public abstract class org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateNameHelper}.
 *
...
public abstract interface DuplicateNameHelperClassTests<SUT extends DuplicateNameHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateNameHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DuplicateNameHelper.class!",
                   DuplicateNameHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateNameHelper]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LifespanPolicyValue
 * public class org.omg.PortableServer.LifespanPolicyValue}.
 *
...
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LifespanPolicyValue.class!",
                   LifespanPolicyValue.class.isAssignableFrom(sut));
    }

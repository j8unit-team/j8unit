 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyErrorHelper
 * public abstract class org.omg.CORBA.PolicyErrorHelper}.
 *
...
public abstract interface PolicyErrorHelperClassTests<SUT extends PolicyErrorHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyErrorHelper.class!",
                   PolicyErrorHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.PolicyErrorHelper]

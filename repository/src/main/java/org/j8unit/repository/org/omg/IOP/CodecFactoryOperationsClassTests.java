 ...
 * {@link CodecFactoryOperations public abstract interface org.omg.IOP.CodecFactoryOperations}.
 *
...
public abstract interface CodecFactoryOperationsClassTests<SUT extends CodecFactoryOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CodecFactoryOperations.class!",
                   CodecFactoryOperations.class.isAssignableFrom(sut));
    }

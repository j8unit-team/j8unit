 ...
 * org.omg.IOP.CodecFactoryOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CodecFactoryOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * {@link CodecFactoryOperationsTests}.
 * </p>
 *
 * @see org.omg.IOP.CodecFactoryOperations interface org.omg.IOP.CodecFactoryOperations (the hereby targeted
 *      class-under-test class)
 * @see CodecFactoryOperationsTests CodecFactoryOperationsTests (The complementary j8unit test interface containing the
...
public abstract interface CodecFactoryOperationsClassTests<SUT extends org.omg.IOP.CodecFactoryOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.CodecFactoryOperations.class!",
                   org.omg.IOP.CodecFactoryOperations.class.isAssignableFrom(sut));
    }

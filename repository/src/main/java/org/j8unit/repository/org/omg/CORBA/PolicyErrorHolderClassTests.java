 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyErrorHolder
 * public final class org.omg.CORBA.PolicyErrorHolder}.
 *
...
public abstract interface PolicyErrorHolderClassTests<SUT extends PolicyErrorHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyErrorHolder.class!",
                   PolicyErrorHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GSSCredential
...
public abstract interface GSSCredentialClassTests<SUT extends GSSCredential>
extends CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GSSCredential.class!",
                   GSSCredential.class.isAssignableFrom(sut));
    }

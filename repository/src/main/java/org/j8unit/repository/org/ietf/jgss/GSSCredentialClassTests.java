 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GSSCredentialTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link GSSCredentialTests}.
 * </p>
 *
 * @see org.ietf.jgss.GSSCredential interface org.ietf.jgss.GSSCredential (the hereby targeted class-under-test class)
 * @see GSSCredentialTests GSSCredentialTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface GSSCredentialClassTests<SUT extends org.ietf.jgss.GSSCredential>
extends org.j8unit.repository.java.lang.CloneableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.ietf.jgss.GSSCredential.class!",
                   org.ietf.jgss.GSSCredential.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.PRIVATE_MEMBER interface org.omg.CORBA.PRIVATE_MEMBER},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PRIVATE_MEMBERTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PRIVATE_MEMBERTests}.
 * </p>
 *
 * @see org.omg.CORBA.PRIVATE_MEMBER interface org.omg.CORBA.PRIVATE_MEMBER (the hereby targeted class-under-test class)
 * @see PRIVATE_MEMBERTests PRIVATE_MEMBERTests (The complementary j8unit test interface containing the instance
...
public abstract interface PRIVATE_MEMBERClassTests<SUT extends org.omg.CORBA.PRIVATE_MEMBER>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.PRIVATE_MEMBER.class!",
                   org.omg.CORBA.PRIVATE_MEMBER.class.isAssignableFrom(sut));
    }

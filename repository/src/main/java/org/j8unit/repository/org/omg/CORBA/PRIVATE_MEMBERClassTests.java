 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PRIVATE_MEMBER
 * public abstract interface org.omg.CORBA.PRIVATE_MEMBER}.
 *
...
public abstract interface PRIVATE_MEMBERClassTests<SUT extends PRIVATE_MEMBER>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PRIVATE_MEMBER.class!",
                   PRIVATE_MEMBER.class.isAssignableFrom(sut));
    }

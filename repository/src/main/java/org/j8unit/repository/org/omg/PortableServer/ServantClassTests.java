 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Servant public
...
public abstract interface ServantClassTests<SUT extends Servant>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Servant.class!",
                   Servant.class.isAssignableFrom(sut));
    }

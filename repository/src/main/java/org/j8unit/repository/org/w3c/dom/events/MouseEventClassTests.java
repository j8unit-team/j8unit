...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.events.MouseEvent interface org.w3c.dom.events.MouseEvent}
 ...
 * </p>
 *
 * @see org.w3c.dom.events.MouseEvent interface org.w3c.dom.events.MouseEvent (the hereby targeted class-under-test
 *      class)
...
public abstract interface MouseEventClassTests<SUT extends org.w3c.dom.events.MouseEvent>
extends UIEventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.events.MouseEvent.class!",
                   org.w3c.dom.events.MouseEvent.class.isAssignableFrom(sut));
    }

 ...
 * </p>
 *
 * @see org.omg.CORBA.Policy interface org.omg.CORBA.Policy (the hereby targeted class-under-test class)
...
public abstract interface PolicyClassTests<SUT extends org.omg.CORBA.Policy>
extends PolicyOperationsClassTests<SUT>, ObjectClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.Policy.class!",
                   org.omg.CORBA.Policy.class.isAssignableFrom(sut));
    }

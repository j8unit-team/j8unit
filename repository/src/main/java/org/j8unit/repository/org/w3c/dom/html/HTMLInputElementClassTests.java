 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLInputElement
 * public abstract interface org.w3c.dom.html.HTMLInputElement}.
 *
...
public abstract interface HTMLInputElementClassTests<SUT extends HTMLInputElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLInputElement.class!",
                   HTMLInputElement.class.isAssignableFrom(sut));
    }

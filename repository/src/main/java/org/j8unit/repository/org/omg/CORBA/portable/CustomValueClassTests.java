 ...
 * org.omg.CORBA.portable.CustomValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CustomValueTests}).
 * </p>
 *
 * <p>
 ...
 * @see CustomValueTests CustomValueTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CustomValueClassTests<SUT extends org.omg.CORBA.portable.CustomValue>
extends ValueBaseClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.CustomMarshalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.CustomValue.class!",
                   org.omg.CORBA.portable.CustomValue.class.isAssignableFrom(sut));
    }

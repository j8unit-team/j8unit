 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CustomValue public
 * abstract interface org.omg.CORBA.portable.CustomValue}.
 *
...
extends ValueBaseClassTests<SUT>, CustomMarshalClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CustomValue.class!",
                   CustomValue.class.isAssignableFrom(sut));
    }

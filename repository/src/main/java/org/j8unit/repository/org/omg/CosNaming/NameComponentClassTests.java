 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameComponent
...
public abstract interface NameComponentClassTests<SUT extends NameComponent>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameComponent.class!",
                   NameComponent.class.isAssignableFrom(sut));
    }

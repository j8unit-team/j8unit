 ...
 * org.omg.CORBA.DynAnyPackage.TypeMismatch}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * </p>
 *
 * @see org.omg.CORBA.DynAnyPackage.TypeMismatch class org.omg.CORBA.DynAnyPackage.TypeMismatch (the hereby targeted
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynAnyPackage.TypeMismatch.class!",
                   org.omg.CORBA.DynAnyPackage.TypeMismatch.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Environment public
 * abstract class org.omg.CORBA.Environment}.
 *
...
public abstract interface EnvironmentClassTests<SUT extends Environment>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Environment.class!",
                   Environment.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EnvironmentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EnvironmentTests}.
 * </p>
 *
 * @see org.omg.CORBA.Environment class org.omg.CORBA.Environment (the hereby targeted class-under-test class)
 * @see EnvironmentTests EnvironmentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.Environment.class!",
                   org.omg.CORBA.Environment.class.isAssignableFrom(sut));
    }

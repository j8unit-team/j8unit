 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TAG_INTERNET_IOP
 * public abstract interface org.omg.IOP.TAG_INTERNET_IOP}.
 *
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TAG_INTERNET_IOP.class!",
                   TAG_INTERNET_IOP.class.isAssignableFrom(sut));
    }

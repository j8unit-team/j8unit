 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OctetSeqHolder
...
public abstract interface OctetSeqHolderClassTests<SUT extends OctetSeqHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OctetSeqHolder.class!",
                   OctetSeqHolder.class.isAssignableFrom(sut));
    }

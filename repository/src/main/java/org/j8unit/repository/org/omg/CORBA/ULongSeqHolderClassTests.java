 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ULongSeqHolder
...
public abstract interface ULongSeqHolderClassTests<SUT extends ULongSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ULongSeqHolder.class!",
                   ULongSeqHolder.class.isAssignableFrom(sut));
    }

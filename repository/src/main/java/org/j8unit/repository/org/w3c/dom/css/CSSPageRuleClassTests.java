 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSPageRule public
 * abstract interface org.w3c.dom.css.CSSPageRule}.
 *
...
public abstract interface CSSPageRuleClassTests<SUT extends CSSPageRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSPageRule.class!",
                   CSSPageRule.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.w3c.dom.css.CSSPageRule]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.w3c.dom.css.CSSPageRule]

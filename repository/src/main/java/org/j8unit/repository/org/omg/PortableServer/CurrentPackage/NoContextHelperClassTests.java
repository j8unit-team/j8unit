 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NoContextHelper
 * public abstract class org.omg.PortableServer.CurrentPackage.NoContextHelper}.
 *
...
public abstract interface NoContextHelperClassTests<SUT extends NoContextHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoContextHelper.class!",
                   NoContextHelper.class.isAssignableFrom(sut));
    }

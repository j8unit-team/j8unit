 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeMismatchHelper
 * public abstract class org.omg.DynamicAny.DynAnyPackage.TypeMismatchHelper}.
 *
...
public abstract interface TypeMismatchHelperClassTests<SUT extends TypeMismatchHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeMismatchHelper.class!",
                   TypeMismatchHelper.class.isAssignableFrom(sut));
    }

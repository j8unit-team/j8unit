 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INV_OBJREF public
 * final class org.omg.CORBA.INV_OBJREF}.
 *
...
public abstract interface INV_OBJREFClassTests<SUT extends INV_OBJREF>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INV_OBJREF.class!",
                   INV_OBJREF.class.isAssignableFrom(sut));
    }

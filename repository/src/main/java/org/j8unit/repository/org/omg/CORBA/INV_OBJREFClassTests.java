 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INV_OBJREFTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.INV_OBJREF class org.omg.CORBA.INV_OBJREF (the hereby targeted class-under-test class)
 * @see INV_OBJREFTests INV_OBJREFTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INV_OBJREF.class!",
                   org.omg.CORBA.INV_OBJREF.class.isAssignableFrom(sut));
    }

...
import org.j8unit.repository.org.w3c.dom.stylesheets.StyleSheetClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSStyleSheet
 * public abstract interface org.w3c.dom.css.CSSStyleSheet}.
 *
...
public abstract interface CSSStyleSheetClassTests<SUT extends CSSStyleSheet>
extends StyleSheetClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.w3c.dom.css.CSSStyleSheet]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSStyleSheet.class!",
                   CSSStyleSheet.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.w3c.dom.css.CSSStyleSheet]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.w3c.dom.css.CSSStyleSheet]

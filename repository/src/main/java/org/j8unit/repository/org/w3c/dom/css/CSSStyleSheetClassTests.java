 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSStyleSheetTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see CSSStyleSheetTests CSSStyleSheetTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CSSStyleSheetClassTests<SUT extends org.w3c.dom.css.CSSStyleSheet>
extends org.j8unit.repository.org.w3c.dom.stylesheets.StyleSheetClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSStyleSheet.class!",
                   org.w3c.dom.css.CSSStyleSheet.class.isAssignableFrom(sut));
    }

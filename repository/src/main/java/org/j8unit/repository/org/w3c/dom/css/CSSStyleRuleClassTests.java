 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSStyleRule public
 * abstract interface org.w3c.dom.css.CSSStyleRule}.
 *
...
public abstract interface CSSStyleRuleClassTests<SUT extends CSSStyleRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSStyleRule.class!",
                   CSSStyleRule.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.css.CSSStyleRule interface org.w3c.dom.css.CSSStyleRule},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSStyleRuleTests}).
 * </p>
 *
 * <p>
 ...
 * @see CSSStyleRuleTests CSSStyleRuleTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CSSStyleRuleClassTests<SUT extends org.w3c.dom.css.CSSStyleRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSStyleRule.class!",
                   org.w3c.dom.css.CSSStyleRule.class.isAssignableFrom(sut));
    }

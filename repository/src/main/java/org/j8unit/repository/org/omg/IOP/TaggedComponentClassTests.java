 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TaggedComponentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TaggedComponentTests}.
 * </p>
 *
 * @see org.omg.IOP.TaggedComponent class org.omg.IOP.TaggedComponent (the hereby targeted class-under-test class)
 * @see TaggedComponentTests TaggedComponentTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TaggedComponent.class!",
                   org.omg.IOP.TaggedComponent.class.isAssignableFrom(sut));
    }

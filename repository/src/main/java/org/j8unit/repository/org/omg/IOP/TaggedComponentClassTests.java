 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TaggedComponent
 * public final class org.omg.IOP.TaggedComponent}.
 *
...
public abstract interface TaggedComponentClassTests<SUT extends TaggedComponent>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TaggedComponent.class!",
                   TaggedComponent.class.isAssignableFrom(sut));
    }

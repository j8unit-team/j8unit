 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamedValue public
 * abstract class org.omg.CORBA.NamedValue}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamedValueTests}.
 * </p>
 *
 * <p>
...
public abstract interface NamedValueClassTests<SUT extends NamedValue>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.NamedValue]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamedValue.class!",
                   NamedValue.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.NamedValue]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.NamedValue]

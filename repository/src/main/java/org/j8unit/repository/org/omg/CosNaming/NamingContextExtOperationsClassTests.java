 ...
 * org.omg.CosNaming.NamingContextExtOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * @see NamingContextExtOperationsTests NamingContextExtOperationsTests (The complementary j8unit test interface
...
public abstract interface NamingContextExtOperationsClassTests<SUT extends org.omg.CosNaming.NamingContextExtOperations>
extends NamingContextOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextExtOperations.class!",
                   org.omg.CosNaming.NamingContextExtOperations.class.isAssignableFrom(sut));
    }

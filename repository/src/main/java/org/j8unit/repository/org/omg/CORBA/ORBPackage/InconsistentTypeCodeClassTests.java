 ...
 * {@link InconsistentTypeCode public final class org.omg.CORBA.ORBPackage.InconsistentTypeCode}.
 *
...
public abstract interface InconsistentTypeCodeClassTests<SUT extends InconsistentTypeCode>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InconsistentTypeCode.class!",
                   InconsistentTypeCode.class.isAssignableFrom(sut));
    }

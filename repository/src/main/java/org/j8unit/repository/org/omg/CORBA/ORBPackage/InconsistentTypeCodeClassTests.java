 ...
 * org.omg.CORBA.ORBPackage.InconsistentTypeCode}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InconsistentTypeCodeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InconsistentTypeCodeTests}
 * .
 * </p>
 *
 * @see org.omg.CORBA.ORBPackage.InconsistentTypeCode class org.omg.CORBA.ORBPackage.InconsistentTypeCode (the hereby
 *      targeted class-under-test class)
 * @see InconsistentTypeCodeTests InconsistentTypeCodeTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ORBPackage.InconsistentTypeCode.class!",
                   org.omg.CORBA.ORBPackage.InconsistentTypeCode.class.isAssignableFrom(sut));
    }

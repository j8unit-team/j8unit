...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHolder class
 * org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHolder}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidAddressHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvalidAddressHolderTests}
 * .
 * </p>
 *
 ...
 * @see InvalidAddressHolderTests InvalidAddressHolderTests (The complementary j8unit test interface containing the
...
public abstract interface InvalidAddressHolderClassTests<SUT extends org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHolder.class!",
                   org.omg.CosNaming.NamingContextExtPackage.InvalidAddressHolder.class.isAssignableFrom(sut));
    }

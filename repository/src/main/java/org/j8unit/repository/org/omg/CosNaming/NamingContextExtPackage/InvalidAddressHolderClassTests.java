 ...
 * {@link InvalidAddressHolderTests}.
 * </p>
 *
 * <p>
...
public abstract interface InvalidAddressHolderClassTests<SUT extends InvalidAddressHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidAddressHolder.class!",
                   InvalidAddressHolder.class.isAssignableFrom(sut));
    }

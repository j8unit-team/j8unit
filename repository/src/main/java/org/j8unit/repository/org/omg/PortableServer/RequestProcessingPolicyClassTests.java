...
extends RequestProcessingPolicyOperationsClassTests<SUT>, PolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RequestProcessingPolicy.class!",
                   RequestProcessingPolicy.class.isAssignableFrom(sut));
    }

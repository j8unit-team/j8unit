 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UNKNOWN public
 * final class org.omg.CORBA.UNKNOWN}.
 *
...
public abstract interface UNKNOWNClassTests<SUT extends UNKNOWN>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UNKNOWN.class!",
                   UNKNOWN.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UNKNOWNTests}).
 * </p>
 *
 * <p>
 ...
 * @see UNKNOWNTests UNKNOWNTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.UNKNOWN.class!",
                   org.omg.CORBA.UNKNOWN.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSMediaRule public
 * abstract interface org.w3c.dom.css.CSSMediaRule}.
 *
...
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSMediaRule.class!",
                   CSSMediaRule.class.isAssignableFrom(sut));
    }

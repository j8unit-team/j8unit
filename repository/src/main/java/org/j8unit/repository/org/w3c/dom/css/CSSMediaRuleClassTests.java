 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSMediaRuleTests}).
 * </p>
 *
 * <p>
 ...
 * @see CSSMediaRuleTests CSSMediaRuleTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CSSMediaRuleClassTests<SUT extends org.w3c.dom.css.CSSMediaRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSMediaRule.class!",
                   org.w3c.dom.css.CSSMediaRule.class.isAssignableFrom(sut));
    }

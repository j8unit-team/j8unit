...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.xml.sax.ContentHandler interface org.xml.sax.ContentHandler},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ContentHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ContentHandlerTests}.
 * </p>
 *
 * @see org.xml.sax.ContentHandler interface org.xml.sax.ContentHandler (the hereby targeted class-under-test class)
 * @see ContentHandlerTests ContentHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ContentHandlerClassTests<SUT extends org.xml.sax.ContentHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ContentHandler.class!",
                   org.xml.sax.ContentHandler.class.isAssignableFrom(sut));
    }

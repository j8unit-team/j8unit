 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LocatorTests}.
 * </p>
 *
 * @see org.xml.sax.Locator interface org.xml.sax.Locator (the hereby targeted class-under-test class)
 * @see LocatorTests LocatorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LocatorClassTests<SUT extends org.xml.sax.Locator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.Locator.class!",
                   org.xml.sax.Locator.class.isAssignableFrom(sut));
    }

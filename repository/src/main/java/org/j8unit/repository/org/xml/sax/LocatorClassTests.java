 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Locator public
 * abstract interface org.xml.sax.Locator}.
 *
...
public abstract interface LocatorClassTests<SUT extends Locator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Locator.class!",
                   Locator.class.isAssignableFrom(sut));
    }

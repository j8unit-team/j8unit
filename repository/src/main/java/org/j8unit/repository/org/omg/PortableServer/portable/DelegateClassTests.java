 ...
 * org.omg.PortableServer.portable.Delegate}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DelegateTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DelegateTests}.
 * </p>
 *
 * @see org.omg.PortableServer.portable.Delegate interface org.omg.PortableServer.portable.Delegate (the hereby targeted
 *      class-under-test class)
 * @see DelegateTests DelegateTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DelegateClassTests<SUT extends org.omg.PortableServer.portable.Delegate>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.portable.Delegate.class!",
                   org.omg.PortableServer.portable.Delegate.class.isAssignableFrom(sut));
    }

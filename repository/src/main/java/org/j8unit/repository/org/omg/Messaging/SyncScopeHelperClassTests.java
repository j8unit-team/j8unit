 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SyncScopeHelper
 * public abstract class org.omg.Messaging.SyncScopeHelper}.
 *
...
public abstract interface SyncScopeHelperClassTests<SUT extends SyncScopeHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.Messaging.SyncScopeHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SyncScopeHelper.class!",
                   SyncScopeHelper.class.isAssignableFrom(sut));
    }

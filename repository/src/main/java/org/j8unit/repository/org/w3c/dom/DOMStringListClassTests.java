 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMStringList
...
public abstract interface DOMStringListClassTests<SUT extends DOMStringList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMStringList.class!",
                   DOMStringList.class.isAssignableFrom(sut));
    }

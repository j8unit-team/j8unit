...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.DOMStringList interface org.w3c.dom.DOMStringList},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMStringListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DOMStringListTests}.
 * </p>
 *
 * @see org.w3c.dom.DOMStringList interface org.w3c.dom.DOMStringList (the hereby targeted class-under-test class)
 * @see DOMStringListTests DOMStringListTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DOMStringListClassTests<SUT extends org.w3c.dom.DOMStringList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.DOMStringList.class!",
                   org.w3c.dom.DOMStringList.class.isAssignableFrom(sut));
    }

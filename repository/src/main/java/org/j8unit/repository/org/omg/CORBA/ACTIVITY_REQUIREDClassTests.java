 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ACTIVITY_REQUIRED
 * public final class org.omg.CORBA.ACTIVITY_REQUIRED}.
 *
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ACTIVITY_REQUIRED.class!",
                   ACTIVITY_REQUIRED.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ACTIVITY_REQUIREDTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ACTIVITY_REQUIREDTests ACTIVITY_REQUIREDTests (The complementary j8unit test interface containing the instance
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ACTIVITY_REQUIRED.class!",
                   org.omg.CORBA.ACTIVITY_REQUIRED.class.isAssignableFrom(sut));
    }

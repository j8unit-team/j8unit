...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.portable.IndirectionException class
 * org.omg.CORBA.portable.IndirectionException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IndirectionExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IndirectionExceptionTests}
 * .
 * </p>
 *
 * @see org.omg.CORBA.portable.IndirectionException class org.omg.CORBA.portable.IndirectionException (the hereby
 *      targeted class-under-test class)
 * @see IndirectionExceptionTests IndirectionExceptionTests (The complementary j8unit test interface containing the
...
public abstract interface IndirectionExceptionClassTests<SUT extends org.omg.CORBA.portable.IndirectionException>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.IndirectionException.class!",
                   org.omg.CORBA.portable.IndirectionException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServantActivatorPOA
 * public abstract class org.omg.PortableServer.ServantActivatorPOA}.
 *
...
public abstract interface ServantActivatorPOAClassTests<SUT extends ServantActivatorPOA>
extends ServantActivatorOperationsClassTests<SUT>, InvokeHandlerClassTests<SUT>, ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantActivatorPOA.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.ServantActivatorPOA class
 * org.omg.PortableServer.ServantActivatorPOA}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServantActivatorPOATests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServantActivatorPOATests}.
 * </p>
 *
 * @see org.omg.PortableServer.ServantActivatorPOA class org.omg.PortableServer.ServantActivatorPOA (the hereby targeted
 *      class-under-test class)
 * @see ServantActivatorPOATests ServantActivatorPOATests (The complementary j8unit test interface containing the
...
public abstract interface ServantActivatorPOAClassTests<SUT extends org.omg.PortableServer.ServantActivatorPOA>
extends ServantActivatorOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.InvokeHandlerClassTests<SUT>, ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ServantActivatorPOA.class!",
                   org.omg.PortableServer.ServantActivatorPOA.class.isAssignableFrom(sut));
    }

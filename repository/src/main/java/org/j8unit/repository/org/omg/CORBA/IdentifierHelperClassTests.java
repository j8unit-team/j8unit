 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IdentifierHelper
 * public abstract class org.omg.CORBA.IdentifierHelper}.
 *
...
public abstract interface IdentifierHelperClassTests<SUT extends IdentifierHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.IdentifierHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdentifierHelper.class!",
                   IdentifierHelper.class.isAssignableFrom(sut));
    }

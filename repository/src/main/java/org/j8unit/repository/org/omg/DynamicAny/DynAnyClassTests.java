...
public abstract interface DynAnyClassTests<SUT extends org.omg.DynamicAny.DynAny>
extends DynAnyOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynAny.class!",
                   org.omg.DynamicAny.DynAny.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.DynamicAny.NameValuePair}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.NameValuePair.class!",
                   org.omg.DynamicAny.NameValuePair.class.isAssignableFrom(sut));
    }

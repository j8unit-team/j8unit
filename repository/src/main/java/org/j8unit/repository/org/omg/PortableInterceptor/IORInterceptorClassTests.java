 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IORInterceptor
...
public abstract interface IORInterceptorClassTests<SUT extends IORInterceptor>
extends IORInterceptorOperationsClassTests<SUT>, InterceptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORInterceptor.class!",

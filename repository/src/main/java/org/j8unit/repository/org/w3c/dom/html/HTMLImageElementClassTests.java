 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLImageElement
 * public abstract interface org.w3c.dom.html.HTMLImageElement}.
 *
...
public abstract interface HTMLImageElementClassTests<SUT extends HTMLImageElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLImageElement.class!",
                   HTMLImageElement.class.isAssignableFrom(sut));
    }

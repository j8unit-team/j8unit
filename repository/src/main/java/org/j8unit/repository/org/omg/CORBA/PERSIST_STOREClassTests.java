 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PERSIST_STORETests}).
 * </p>
 *
 * <p>
 ...
 * @see PERSIST_STORETests PERSIST_STORETests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.PERSIST_STORE.class!",
                   org.omg.CORBA.PERSIST_STORE.class.isAssignableFrom(sut));
    }

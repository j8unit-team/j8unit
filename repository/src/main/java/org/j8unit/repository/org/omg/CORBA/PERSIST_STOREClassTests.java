 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PERSIST_STORE
 * public final class org.omg.CORBA.PERSIST_STORE}.
 *
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PERSIST_STORE.class!",
                   PERSIST_STORE.class.isAssignableFrom(sut));
    }

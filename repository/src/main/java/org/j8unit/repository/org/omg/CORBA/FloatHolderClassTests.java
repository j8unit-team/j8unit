 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FloatHolder public
 * final class org.omg.CORBA.FloatHolder}.
 *
...
public abstract interface FloatHolderClassTests<SUT extends FloatHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FloatHolder.class!",
                   FloatHolder.class.isAssignableFrom(sut));
    }

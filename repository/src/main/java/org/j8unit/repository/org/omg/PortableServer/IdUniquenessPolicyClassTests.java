 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IdUniquenessPolicy
 * public abstract interface org.omg.PortableServer.IdUniquenessPolicy}.
 *
...
extends IdUniquenessPolicyOperationsClassTests<SUT>, PolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdUniquenessPolicy.class!",

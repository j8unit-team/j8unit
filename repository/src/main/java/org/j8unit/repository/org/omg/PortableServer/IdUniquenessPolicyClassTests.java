 ...
 * org.omg.PortableServer.IdUniquenessPolicy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IdUniquenessPolicyTests}).
 * </p>
 *
 * <p>
 ...
 * @see IdUniquenessPolicyTests IdUniquenessPolicyTests (The complementary j8unit test interface containing the instance
...
public abstract interface IdUniquenessPolicyClassTests<SUT extends org.omg.PortableServer.IdUniquenessPolicy>
extends IdUniquenessPolicyOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.IdUniquenessPolicy.class!",
                   org.omg.PortableServer.IdUniquenessPolicy.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ARG_OUTTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ARG_OUTTests}.
 * </p>
 *
 * @see org.omg.CORBA.ARG_OUT interface org.omg.CORBA.ARG_OUT (the hereby targeted class-under-test class)
 * @see ARG_OUTTests ARG_OUTTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ARG_OUTClassTests<SUT extends org.omg.CORBA.ARG_OUT>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ARG_OUT.class!",
                   org.omg.CORBA.ARG_OUT.class.isAssignableFrom(sut));
    }

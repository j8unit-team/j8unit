 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ARG_OUT public
 * abstract interface org.omg.CORBA.ARG_OUT}.
 *
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ARG_OUT.class!",
                   ARG_OUT.class.isAssignableFrom(sut));
    }

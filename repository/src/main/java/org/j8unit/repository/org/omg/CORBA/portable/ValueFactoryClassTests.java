 ...
 * org.omg.CORBA.portable.ValueFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValueFactoryTests}.
 * </p>
 *
 * @see org.omg.CORBA.portable.ValueFactory interface org.omg.CORBA.portable.ValueFactory (the hereby targeted
 *      class-under-test class)
 * @see ValueFactoryTests ValueFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ValueFactoryClassTests<SUT extends org.omg.CORBA.portable.ValueFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.ValueFactory.class!",
                   org.omg.CORBA.portable.ValueFactory.class.isAssignableFrom(sut));
    }

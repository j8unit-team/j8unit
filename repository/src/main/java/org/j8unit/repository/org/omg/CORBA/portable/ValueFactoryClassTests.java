 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueFactory public
 * abstract interface org.omg.CORBA.portable.ValueFactory}.
 *
...
public abstract interface ValueFactoryClassTests<SUT extends ValueFactory>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueFactory.class!",
                   ValueFactory.class.isAssignableFrom(sut));
    }

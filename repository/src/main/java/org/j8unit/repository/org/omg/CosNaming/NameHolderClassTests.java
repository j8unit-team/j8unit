 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameHolder public
 * final class org.omg.CosNaming.NameHolder}.
 *
...
public abstract interface NameHolderClassTests<SUT extends NameHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameHolder.class!",
                   NameHolder.class.isAssignableFrom(sut));
    }

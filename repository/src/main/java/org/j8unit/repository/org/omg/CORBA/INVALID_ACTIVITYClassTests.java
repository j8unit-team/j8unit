 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INVALID_ACTIVITY
 * public final class org.omg.CORBA.INVALID_ACTIVITY}.
 *
...
public abstract interface INVALID_ACTIVITYClassTests<SUT extends INVALID_ACTIVITY>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INVALID_ACTIVITY.class!",
                   INVALID_ACTIVITY.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INVALID_ACTIVITYTests}).
 * </p>
 *
 * <p>
 ...
 * @see INVALID_ACTIVITYTests INVALID_ACTIVITYTests (The complementary j8unit test interface containing the instance
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INVALID_ACTIVITY.class!",
                   org.omg.CORBA.INVALID_ACTIVITY.class.isAssignableFrom(sut));
    }

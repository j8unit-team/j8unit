 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ForwardRequest
 * public final class org.omg.PortableInterceptor.ForwardRequest}.
 *
...
public abstract interface ForwardRequestClassTests<SUT extends ForwardRequest>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ForwardRequest.class!",
                   ForwardRequest.class.isAssignableFrom(sut));
    }

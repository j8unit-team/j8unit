 ...
 * org.omg.PortableInterceptor.ForwardRequest}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ForwardRequestTests}).
 * </p>
 *
 * <p>
 ...
 * @see ForwardRequestTests ForwardRequestTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ForwardRequest.class!",
                   org.omg.PortableInterceptor.ForwardRequest.class.isAssignableFrom(sut));
    }

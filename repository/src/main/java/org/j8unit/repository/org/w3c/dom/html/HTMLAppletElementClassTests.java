 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLAppletElement
 * public abstract interface org.w3c.dom.html.HTMLAppletElement}.
 *
...
public abstract interface HTMLAppletElementClassTests<SUT extends HTMLAppletElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLAppletElement.class!",
                   HTMLAppletElement.class.isAssignableFrom(sut));
    }

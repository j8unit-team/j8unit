 ...
 * org.w3c.dom.html.HTMLOptionElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLOptionElementTests}).
 * </p>
 *
 * <p>
 ...
 * @see HTMLOptionElementTests HTMLOptionElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface HTMLOptionElementClassTests<SUT extends org.w3c.dom.html.HTMLOptionElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLOptionElement.class!",
                   org.w3c.dom.html.HTMLOptionElement.class.isAssignableFrom(sut));
    }

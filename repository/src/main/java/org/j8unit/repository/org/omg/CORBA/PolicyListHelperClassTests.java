 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyListHelper
 * public abstract class org.omg.CORBA.PolicyListHelper}.
 *
...
public abstract interface PolicyListHelperClassTests<SUT extends PolicyListHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyListHelper.class!",
                   PolicyListHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HandlerBase public
...
extends EntityResolverClassTests<SUT>, DTDHandlerClassTests<SUT>, DocumentHandlerClassTests<SUT>, ErrorHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HandlerBase.class!",

 ...
 * org.xml.sax.helpers.ParserAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParserAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ParserAdapterTests ParserAdapterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.helpers.ParserAdapter.class!",
                   org.xml.sax.helpers.ParserAdapter.class.isAssignableFrom(sut));
    }

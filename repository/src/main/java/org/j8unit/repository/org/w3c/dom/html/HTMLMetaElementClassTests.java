 ...
 * org.w3c.dom.html.HTMLMetaElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLMetaElementTests}).
 * </p>
 *
 * <p>
 ...
 * @see HTMLMetaElementTests HTMLMetaElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface HTMLMetaElementClassTests<SUT extends org.w3c.dom.html.HTMLMetaElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLMetaElement.class!",
                   org.w3c.dom.html.HTMLMetaElement.class.isAssignableFrom(sut));
    }

 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link GSSException
 ...
 * {@link org.j8unit.repository.org.ietf.jgss.GSSExceptionClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface GSSExceptionTests<SUT extends GSSException>
extends ExceptionTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getMajor()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getMinor()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

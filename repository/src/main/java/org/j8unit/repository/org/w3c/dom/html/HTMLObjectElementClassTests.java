 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLObjectElement
 * public abstract interface org.w3c.dom.html.HTMLObjectElement}.
 *
...
public abstract interface HTMLObjectElementClassTests<SUT extends HTMLObjectElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLObjectElement.class!",
                   HTMLObjectElement.class.isAssignableFrom(sut));
    }

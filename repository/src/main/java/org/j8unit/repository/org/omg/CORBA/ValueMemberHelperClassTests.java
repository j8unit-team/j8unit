 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueMemberHelper
 * public abstract class org.omg.CORBA.ValueMemberHelper}.
 *
...
public abstract interface ValueMemberHelperClassTests<SUT extends ValueMemberHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueMemberHelper.class!",
                   ValueMemberHelper.class.isAssignableFrom(sut));
    }

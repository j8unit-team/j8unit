 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynFixedTests}).
 * </p>
 *
 * <p>
 ...
 * @see DynFixedTests DynFixedTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynFixedClassTests<SUT extends org.omg.DynamicAny.DynFixed>
extends DynFixedOperationsClassTests<SUT>, DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynFixed.class!",
                   org.omg.DynamicAny.DynFixed.class.isAssignableFrom(sut));
    }

 ...
 * {@link AdapterNonExistentHelper public abstract class org.omg.PortableServer.POAPackage.AdapterNonExistentHelper}.
 *
...
public abstract interface AdapterNonExistentHelperClassTests<SUT extends AdapterNonExistentHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterNonExistentHelper.class!",
                   AdapterNonExistentHelper.class.isAssignableFrom(sut));
    }

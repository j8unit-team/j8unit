...
import org.j8unit.repository.javax.management.remote.rmi.RMIConnectionClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _RMIConnection_Stub
 * public class org.omg.stub.javax.management.remote.rmi._RMIConnection_Stub}.
 *
...
extends RMIConnectionClassTests<SUT>, StubClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _RMIConnection_Stub.class!",
                   _RMIConnection_Stub.class.isAssignableFrom(sut));
    }

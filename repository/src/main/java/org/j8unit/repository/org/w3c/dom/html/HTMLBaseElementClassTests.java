 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLBaseElement
...
public abstract interface HTMLBaseElementClassTests<SUT extends HTMLBaseElement>
extends HTMLElementClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.w3c.dom.html.HTMLBaseElement]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLBaseElement.class!",
                   HTMLBaseElement.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.w3c.dom.html.HTMLBaseElement]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.w3c.dom.html.HTMLBaseElement]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ContextList public
 * abstract class org.omg.CORBA.ContextList}.
 *
...
public abstract interface ContextListClassTests<SUT extends ContextList>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ContextList.class!",
                   ContextList.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServantObject
...
public abstract interface ServantObjectClassTests<SUT extends ServantObject>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantObject.class!",
                   ServantObject.class.isAssignableFrom(sut));
    }

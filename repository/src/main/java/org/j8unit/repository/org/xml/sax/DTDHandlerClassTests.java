 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DTDHandlerTests}).
 * </p>
 *
 * <p>
 ...
 * @see DTDHandlerTests DTDHandlerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DTDHandlerClassTests<SUT extends org.xml.sax.DTDHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.DTDHandler.class!",
                   org.xml.sax.DTDHandler.class.isAssignableFrom(sut));
    }

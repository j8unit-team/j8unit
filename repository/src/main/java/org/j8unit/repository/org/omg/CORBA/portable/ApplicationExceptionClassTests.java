...
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ApplicationException.class!",
                   ApplicationException.class.isAssignableFrom(sut));
    }

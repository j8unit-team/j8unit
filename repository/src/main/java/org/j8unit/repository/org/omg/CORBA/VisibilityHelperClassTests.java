 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VisibilityHelper
 * public abstract class org.omg.CORBA.VisibilityHelper}.
 *
...
public abstract interface VisibilityHelperClassTests<SUT extends VisibilityHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VisibilityHelper.class!",
                   VisibilityHelper.class.isAssignableFrom(sut));
    }

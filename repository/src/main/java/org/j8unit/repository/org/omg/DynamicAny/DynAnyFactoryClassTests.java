 ...
 * org.omg.DynamicAny.DynAnyFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynAnyFactoryTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynAnyFactoryTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynAnyFactory interface org.omg.DynamicAny.DynAnyFactory (the hereby targeted
 *      class-under-test class)
 * @see DynAnyFactoryTests DynAnyFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DynAnyFactoryClassTests<SUT extends org.omg.DynamicAny.DynAnyFactory>
extends DynAnyFactoryOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynAnyFactory.class!",
                   org.omg.DynamicAny.DynAnyFactory.class.isAssignableFrom(sut));
    }

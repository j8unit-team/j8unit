 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynAnyFactory
...
public abstract interface DynAnyFactoryClassTests<SUT extends DynAnyFactory>
extends DynAnyFactoryOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynAnyFactory.class!",

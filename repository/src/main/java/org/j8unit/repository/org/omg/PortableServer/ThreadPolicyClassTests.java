...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.ThreadPolicy interface
 * org.omg.PortableServer.ThreadPolicy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadPolicyTests}).
 * </p>
 *
 * <p>
 ...
 * @see ThreadPolicyTests ThreadPolicyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ThreadPolicyClassTests<SUT extends org.omg.PortableServer.ThreadPolicy>
extends ThreadPolicyOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ThreadPolicy.class!",
                   org.omg.PortableServer.ThreadPolicy.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ThreadPolicy public
 * abstract interface org.omg.PortableServer.ThreadPolicy}.
 *
...
extends org.j8unit.repository.org.omg.PortableServer.ThreadPolicyOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadPolicy.class!",
                   ThreadPolicy.class.isAssignableFrom(sut));
    }

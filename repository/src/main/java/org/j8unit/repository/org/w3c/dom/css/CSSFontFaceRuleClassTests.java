 ...
 * org.w3c.dom.css.CSSFontFaceRule}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSFontFaceRuleTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see CSSFontFaceRuleTests CSSFontFaceRuleTests (The complementary j8unit test interface containing the instance
...
public abstract interface CSSFontFaceRuleClassTests<SUT extends org.w3c.dom.css.CSSFontFaceRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSFontFaceRule.class!",
                   org.w3c.dom.css.CSSFontFaceRule.class.isAssignableFrom(sut));
    }

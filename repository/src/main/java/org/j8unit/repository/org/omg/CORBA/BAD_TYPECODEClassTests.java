 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_TYPECODE public
 * final class org.omg.CORBA.BAD_TYPECODE}.
 *
...
public abstract interface BAD_TYPECODEClassTests<SUT extends BAD_TYPECODE>
extends SystemExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.BAD_TYPECODE]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_TYPECODE.class!",
                   BAD_TYPECODE.class.isAssignableFrom(sut));
    }

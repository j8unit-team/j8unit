 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_TYPECODETests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.BAD_TYPECODE class org.omg.CORBA.BAD_TYPECODE (the hereby targeted class-under-test class)
 * @see BAD_TYPECODETests BAD_TYPECODETests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_TYPECODE.class!",
                   org.omg.CORBA.BAD_TYPECODE.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ProfileIdHelper
...
public abstract interface ProfileIdHelperClassTests<SUT extends ProfileIdHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ProfileIdHelper.class!",
                   ProfileIdHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.IOP.ProfileIdHelper]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DeclHandlerTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.xml.sax.ext.DeclHandler interface org.xml.sax.ext.DeclHandler (the hereby targeted class-under-test class)
 * @see DeclHandlerTests DeclHandlerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DeclHandlerClassTests<SUT extends org.xml.sax.ext.DeclHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.DeclHandler.class!",
                   org.xml.sax.ext.DeclHandler.class.isAssignableFrom(sut));
    }

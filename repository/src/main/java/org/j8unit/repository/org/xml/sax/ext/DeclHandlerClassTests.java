 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DeclHandler public
 * abstract interface org.xml.sax.ext.DeclHandler}.
 *
...
public abstract interface DeclHandlerClassTests<SUT extends DeclHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DeclHandler.class!",
                   DeclHandler.class.isAssignableFrom(sut));
    }

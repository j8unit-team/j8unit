...
public abstract interface ObjectAlreadyActiveHelperClassTests<SUT extends ObjectAlreadyActiveHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectAlreadyActiveHelper.class!",
                   ObjectAlreadyActiveHelper.class.isAssignableFrom(sut));
    }

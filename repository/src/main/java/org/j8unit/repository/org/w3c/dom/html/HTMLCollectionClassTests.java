 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLCollection
...
public abstract interface HTMLCollectionClassTests<SUT extends HTMLCollection>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLCollection.class!",
                   HTMLCollection.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLUListElement
 * public abstract interface org.w3c.dom.html.HTMLUListElement}.
 *
...
public abstract interface HTMLUListElementClassTests<SUT extends HTMLUListElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLUListElement.class!",
                   HTMLUListElement.class.isAssignableFrom(sut));
    }

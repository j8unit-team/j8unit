 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INITIALIZE public
 * final class org.omg.CORBA.INITIALIZE}.
 *
...
public abstract interface INITIALIZEClassTests<SUT extends INITIALIZE>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INITIALIZE.class!",
                   INITIALIZE.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INITIALIZETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link INITIALIZETests}.
 * </p>
 *
 * @see org.omg.CORBA.INITIALIZE class org.omg.CORBA.INITIALIZE (the hereby targeted class-under-test class)
 * @see INITIALIZETests INITIALIZETests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INITIALIZE.class!",
                   org.omg.CORBA.INITIALIZE.class.isAssignableFrom(sut));
    }

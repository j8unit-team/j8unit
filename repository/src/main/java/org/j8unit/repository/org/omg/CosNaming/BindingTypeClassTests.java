...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CosNaming.BindingType class org.omg.CosNaming.BindingType},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BindingTypeTests}.
 * </p>
 *
 * @see org.omg.CosNaming.BindingType class org.omg.CosNaming.BindingType (the hereby targeted class-under-test class)
 * @see BindingTypeTests BindingTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BindingTypeClassTests<SUT extends org.omg.CosNaming.BindingType>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.BindingType.class!",
                   org.omg.CosNaming.BindingType.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.traversal.TreeWalker interface
 * org.w3c.dom.traversal.TreeWalker}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TreeWalkerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TreeWalkerTests}.
 * </p>
 *
 * @see org.w3c.dom.traversal.TreeWalker interface org.w3c.dom.traversal.TreeWalker (the hereby targeted
 *      class-under-test class)
 * @see TreeWalkerTests TreeWalkerTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TreeWalkerClassTests<SUT extends org.w3c.dom.traversal.TreeWalker>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.traversal.TreeWalker.class!",
                   org.w3c.dom.traversal.TreeWalker.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TreeWalker public
 * abstract interface org.w3c.dom.traversal.TreeWalker}.
 *
...
public abstract interface TreeWalkerClassTests<SUT extends TreeWalker>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TreeWalker.class!",
                   TreeWalker.class.isAssignableFrom(sut));
    }

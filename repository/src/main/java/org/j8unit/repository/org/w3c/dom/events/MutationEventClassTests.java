 ...
 * org.w3c.dom.events.MutationEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MutationEventTests}).
 * </p>
 *
 * <p>
 ...
 * @see MutationEventTests MutationEventTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface MutationEventClassTests<SUT extends org.w3c.dom.events.MutationEvent>
extends EventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.events.MutationEvent.class!",
                   org.w3c.dom.events.MutationEvent.class.isAssignableFrom(sut));
    }

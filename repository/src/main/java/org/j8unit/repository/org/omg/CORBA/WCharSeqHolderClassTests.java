 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WCharSeqHolder
...
public abstract interface WCharSeqHolderClassTests<SUT extends WCharSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WCharSeqHolder.class!",
                   WCharSeqHolder.class.isAssignableFrom(sut));
    }

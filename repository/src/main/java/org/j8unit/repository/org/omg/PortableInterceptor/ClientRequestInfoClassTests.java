 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ClientRequestInfo
 * public abstract interface org.omg.PortableInterceptor.ClientRequestInfo}.
 *
...
public abstract interface ClientRequestInfoClassTests<SUT extends ClientRequestInfo>
extends org.j8unit.repository.org.omg.PortableInterceptor.ClientRequestInfoOperationsClassTests<SUT>,
org.j8unit.repository.org.omg.PortableInterceptor.RequestInfoClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClientRequestInfo.class!",
                   ClientRequestInfo.class.isAssignableFrom(sut));
    }

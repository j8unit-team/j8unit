 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLFrameElement
 * public abstract interface org.w3c.dom.html.HTMLFrameElement}.
 *
...
public abstract interface HTMLFrameElementClassTests<SUT extends HTMLFrameElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLFrameElement.class!",
                   HTMLFrameElement.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BooleanSeqHelper
 * public abstract class org.omg.CORBA.BooleanSeqHelper}.
 *
...
public abstract interface BooleanSeqHelperClassTests<SUT extends BooleanSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BooleanSeqHelper.class!",
                   BooleanSeqHelper.class.isAssignableFrom(sut));
    }

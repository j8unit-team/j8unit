 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSUnknownRule
...
public abstract interface CSSUnknownRuleClassTests<SUT extends CSSUnknownRule>
extends org.j8unit.repository.org.w3c.dom.css.CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSUnknownRule.class!",
                   CSSUnknownRule.class.isAssignableFrom(sut));
    }

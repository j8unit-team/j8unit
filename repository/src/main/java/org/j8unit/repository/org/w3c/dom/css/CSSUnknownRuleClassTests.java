...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.css.CSSUnknownRule interface
 * org.w3c.dom.css.CSSUnknownRule}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSUnknownRuleTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see CSSUnknownRuleTests CSSUnknownRuleTests (The complementary j8unit test interface containing the instance
...
public abstract interface CSSUnknownRuleClassTests<SUT extends org.w3c.dom.css.CSSUnknownRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSUnknownRule.class!",
                   org.w3c.dom.css.CSSUnknownRule.class.isAssignableFrom(sut));
    }

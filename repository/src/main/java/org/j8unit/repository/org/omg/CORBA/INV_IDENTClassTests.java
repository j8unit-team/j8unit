 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INV_IDENTTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link INV_IDENTTests}.
 * </p>
 *
 * @see org.omg.CORBA.INV_IDENT class org.omg.CORBA.INV_IDENT (the hereby targeted class-under-test class)
 * @see INV_IDENTTests INV_IDENTTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INV_IDENT.class!",
                   org.omg.CORBA.INV_IDENT.class.isAssignableFrom(sut));
    }

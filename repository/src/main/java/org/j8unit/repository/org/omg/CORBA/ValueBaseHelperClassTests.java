 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueBaseHelper
...
public abstract interface ValueBaseHelperClassTests<SUT extends ValueBaseHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.ValueBaseHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueBaseHelper.class!",
                   ValueBaseHelper.class.isAssignableFrom(sut));
    }

...
public abstract interface IORInterceptor_3_0OperationsClassTests<SUT extends IORInterceptor_3_0Operations>
extends IORInterceptorOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORInterceptor_3_0Operations.class!",
                   IORInterceptor_3_0Operations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Notation public
 * abstract interface org.w3c.dom.Notation}.
 *
...
public abstract interface NotationClassTests<SUT extends Notation>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Notation.class!",
                   Notation.class.isAssignableFrom(sut));
    }

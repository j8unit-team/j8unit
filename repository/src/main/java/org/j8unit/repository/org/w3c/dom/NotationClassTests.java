 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotationTests}.
 * </p>
 *
 * @see org.w3c.dom.Notation interface org.w3c.dom.Notation (the hereby targeted class-under-test class)
 * @see NotationTests NotationTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NotationClassTests<SUT extends org.w3c.dom.Notation>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.Notation.class!",
                   org.w3c.dom.Notation.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.PortableServer.ThreadPolicyOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadPolicyOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * {@link ThreadPolicyOperationsTests}.
 * </p>
 *
 * @see org.omg.PortableServer.ThreadPolicyOperations interface org.omg.PortableServer.ThreadPolicyOperations (the
 *      hereby targeted class-under-test class)
 * @see ThreadPolicyOperationsTests ThreadPolicyOperationsTests (The complementary j8unit test interface containing the
...
public abstract interface ThreadPolicyOperationsClassTests<SUT extends org.omg.PortableServer.ThreadPolicyOperations>
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ThreadPolicyOperations.class!",
                   org.omg.PortableServer.ThreadPolicyOperations.class.isAssignableFrom(sut));
    }

 ...
 * {@link ThreadPolicyOperations public abstract interface org.omg.PortableServer.ThreadPolicyOperations}.
 *
...
public abstract interface ThreadPolicyOperationsClassTests<SUT extends ThreadPolicyOperations>
extends PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadPolicyOperations.class!",
                   ThreadPolicyOperations.class.isAssignableFrom(sut));
    }

 ...
 * </p>
 *
 * @see org.w3c.dom.EntityReference interface org.w3c.dom.EntityReference (the hereby targeted class-under-test class)
...
public abstract interface EntityReferenceClassTests<SUT extends org.w3c.dom.EntityReference>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.EntityReference.class!",
                   org.w3c.dom.EntityReference.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentStyle
 * public abstract interface org.w3c.dom.stylesheets.DocumentStyle}.
 *
...
public abstract interface DocumentStyleClassTests<SUT extends DocumentStyle>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentStyle.class!",
                   DocumentStyle.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CDATASectionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CDATASectionTests}.
 * </p>
 *
 * @see org.w3c.dom.CDATASection interface org.w3c.dom.CDATASection (the hereby targeted class-under-test class)
 * @see CDATASectionTests CDATASectionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CDATASectionClassTests<SUT extends org.w3c.dom.CDATASection>
extends TextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.CDATASection.class!",
                   org.w3c.dom.CDATASection.class.isAssignableFrom(sut));
    }

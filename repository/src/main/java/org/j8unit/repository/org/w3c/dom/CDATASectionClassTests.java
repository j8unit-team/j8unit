 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CDATASection public
 * abstract interface org.w3c.dom.CDATASection}.
 *
...
public abstract interface CDATASectionClassTests<SUT extends CDATASection>
extends TextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CDATASection.class!",
                   CDATASection.class.isAssignableFrom(sut));
    }

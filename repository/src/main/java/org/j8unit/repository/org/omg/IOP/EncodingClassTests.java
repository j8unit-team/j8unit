...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.Encoding class org.omg.IOP.Encoding}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EncodingTests}).
 * </p>
 *
 * <p>
 ...
 * @see EncodingTests EncodingTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.Encoding.class!",
                   org.omg.IOP.Encoding.class.isAssignableFrom(sut));
    }

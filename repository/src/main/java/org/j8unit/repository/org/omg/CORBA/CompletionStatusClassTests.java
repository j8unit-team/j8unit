 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CompletionStatus
 * public final class org.omg.CORBA.CompletionStatus}.
 *
...
public abstract interface CompletionStatusClassTests<SUT extends CompletionStatus>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CompletionStatus.class!",
                   CompletionStatus.class.isAssignableFrom(sut));
    }

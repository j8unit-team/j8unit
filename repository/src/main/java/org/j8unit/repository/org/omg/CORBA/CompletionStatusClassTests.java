...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.CompletionStatus class org.omg.CORBA.CompletionStatus},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CompletionStatusTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CompletionStatusTests}.
 * </p>
 *
 * @see org.omg.CORBA.CompletionStatus class org.omg.CORBA.CompletionStatus (the hereby targeted class-under-test class)
 * @see CompletionStatusTests CompletionStatusTests (The complementary j8unit test interface containing the instance
...
public abstract interface CompletionStatusClassTests<SUT extends org.omg.CORBA.CompletionStatus>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.CompletionStatus.class!",
                   org.omg.CORBA.CompletionStatus.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IDLTypeHelper
 * public abstract class org.omg.CORBA.IDLTypeHelper}.
 *
...
public abstract interface IDLTypeHelperClassTests<SUT extends IDLTypeHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.IDLTypeHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IDLTypeHelper.class!",
                   IDLTypeHelper.class.isAssignableFrom(sut));
    }

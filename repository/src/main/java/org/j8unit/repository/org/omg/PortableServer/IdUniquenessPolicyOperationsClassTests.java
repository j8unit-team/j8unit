...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.IdUniquenessPolicyOperations interface
 * org.omg.PortableServer.IdUniquenessPolicyOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link IdUniquenessPolicyOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableServer.IdUniquenessPolicyOperations interface
 *      org.omg.PortableServer.IdUniquenessPolicyOperations (the hereby targeted class-under-test class)
 * @see IdUniquenessPolicyOperationsTests IdUniquenessPolicyOperationsTests (The complementary j8unit test interface
...
public abstract interface IdUniquenessPolicyOperationsClassTests<SUT extends org.omg.PortableServer.IdUniquenessPolicyOperations>
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.IdUniquenessPolicyOperations.class!",
                   org.omg.PortableServer.IdUniquenessPolicyOperations.class.isAssignableFrom(sut));
    }

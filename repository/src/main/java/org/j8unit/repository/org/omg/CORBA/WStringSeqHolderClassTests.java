 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WStringSeqHolder
 * public final class org.omg.CORBA.WStringSeqHolder}.
 *
...
public abstract interface WStringSeqHolderClassTests<SUT extends WStringSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WStringSeqHolder.class!",
                   WStringSeqHolder.class.isAssignableFrom(sut));
    }

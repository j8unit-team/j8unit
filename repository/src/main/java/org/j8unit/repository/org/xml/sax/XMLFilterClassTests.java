 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link XMLFilterTests}).
 * </p>
 *
 * <p>
 ...
 * @see XMLFilterTests XMLFilterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface XMLFilterClassTests<SUT extends org.xml.sax.XMLFilter>
extends XMLReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.XMLFilter.class!",
                   org.xml.sax.XMLFilter.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLFilter public
 * abstract interface org.xml.sax.XMLFilter}.
 *
...
extends org.j8unit.repository.org.xml.sax.XMLReaderClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLFilter.class!",
                   XMLFilter.class.isAssignableFrom(sut));
    }

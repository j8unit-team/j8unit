...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.UnionMember class org.omg.CORBA.UnionMember}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnionMemberTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnionMemberTests}.
 * </p>
 *
 * @see org.omg.CORBA.UnionMember class org.omg.CORBA.UnionMember (the hereby targeted class-under-test class)
 * @see UnionMemberTests UnionMemberTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.UnionMember.class!",
                   org.omg.CORBA.UnionMember.class.isAssignableFrom(sut));
    }

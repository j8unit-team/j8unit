 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnionMember public
 * final class org.omg.CORBA.UnionMember}.
 *
...
public abstract interface UnionMemberClassTests<SUT extends UnionMember>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnionMember.class!",
                   UnionMember.class.isAssignableFrom(sut));
    }

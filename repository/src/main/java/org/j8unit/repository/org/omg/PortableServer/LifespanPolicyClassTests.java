...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.LifespanPolicy interface
 * org.omg.PortableServer.LifespanPolicy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LifespanPolicyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LifespanPolicyTests}.
 * </p>
 *
 * @see org.omg.PortableServer.LifespanPolicy interface org.omg.PortableServer.LifespanPolicy (the hereby targeted
 *      class-under-test class)
 * @see LifespanPolicyTests LifespanPolicyTests (The complementary j8unit test interface containing the instance
...
public abstract interface LifespanPolicyClassTests<SUT extends org.omg.PortableServer.LifespanPolicy>
extends LifespanPolicyOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.LifespanPolicy.class!",
                   org.omg.PortableServer.LifespanPolicy.class.isAssignableFrom(sut));
    }

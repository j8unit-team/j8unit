 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NoServantHelper
 * public abstract class org.omg.PortableServer.POAPackage.NoServantHelper}.
 *
...
public abstract interface NoServantHelperClassTests<SUT extends NoServantHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.POAPackage.NoServantHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoServantHelper.class!",
                   NoServantHelper.class.isAssignableFrom(sut));
    }

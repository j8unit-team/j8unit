 ...
 * {@link UnknownUserExceptionHelper public abstract class org.omg.CORBA.UnknownUserExceptionHelper}.
 *
...
public abstract interface UnknownUserExceptionHelperClassTests<SUT extends UnknownUserExceptionHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.UnknownUserExceptionHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownUserExceptionHelper.class!",
                   UnknownUserExceptionHelper.class.isAssignableFrom(sut));
    }

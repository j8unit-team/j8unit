 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AdapterNameHelper
 * public abstract class org.omg.PortableInterceptor.AdapterNameHelper}.
 *
...
public abstract interface AdapterNameHelperClassTests<SUT extends AdapterNameHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterNameHelper.class!",
                   AdapterNameHelper.class.isAssignableFrom(sut));
    }

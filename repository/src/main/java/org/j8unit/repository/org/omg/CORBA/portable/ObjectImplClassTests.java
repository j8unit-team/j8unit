 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectImpl public
 * abstract class org.omg.CORBA.portable.ObjectImpl}.
 *
...
extends ObjectClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectImpl.class!",
                   ObjectImpl.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.portable.ObjectImpl]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.portable.ObjectImpl]

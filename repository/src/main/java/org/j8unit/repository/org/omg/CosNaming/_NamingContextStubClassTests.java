 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _NamingContextStub
 * public class org.omg.CosNaming._NamingContextStub}.
 *
...
extends NamingContextClassTests<SUT>, ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _NamingContextStub.class!",

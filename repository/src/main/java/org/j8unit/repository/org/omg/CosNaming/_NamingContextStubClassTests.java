 ...
 * org.omg.CosNaming._NamingContextStub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _NamingContextStubTests}).
 * </p>
 *
 * <p>
 ...
 * @see _NamingContextStubTests _NamingContextStubTests (The complementary j8unit test interface containing the instance
...
public abstract interface _NamingContextStubClassTests<SUT extends org.omg.CosNaming._NamingContextStub>
extends NamingContextClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming._NamingContextStub.class!",
                   org.omg.CosNaming._NamingContextStub.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceIdHelper
 * public abstract class org.omg.IOP.ServiceIdHelper}.
 *
...
public abstract interface ServiceIdHelperClassTests<SUT extends ServiceIdHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceIdHelper.class!",
                   ServiceIdHelper.class.isAssignableFrom(sut));
    }

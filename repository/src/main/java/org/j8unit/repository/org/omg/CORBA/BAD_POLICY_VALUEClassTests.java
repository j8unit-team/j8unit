 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_POLICY_VALUE
 * public abstract interface org.omg.CORBA.BAD_POLICY_VALUE}.
 *
...
public abstract interface BAD_POLICY_VALUEClassTests<SUT extends BAD_POLICY_VALUE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_POLICY_VALUE.class!",
                   BAD_POLICY_VALUE.class.isAssignableFrom(sut));
    }

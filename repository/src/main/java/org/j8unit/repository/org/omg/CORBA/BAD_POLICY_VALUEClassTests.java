...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.BAD_POLICY_VALUE interface
 * org.omg.CORBA.BAD_POLICY_VALUE}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_POLICY_VALUETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BAD_POLICY_VALUETests}.
 * </p>
 *
 * @see org.omg.CORBA.BAD_POLICY_VALUE interface org.omg.CORBA.BAD_POLICY_VALUE (the hereby targeted class-under-test
 *      class)
 * @see BAD_POLICY_VALUETests BAD_POLICY_VALUETests (The complementary j8unit test interface containing the instance
...
public abstract interface BAD_POLICY_VALUEClassTests<SUT extends org.omg.CORBA.BAD_POLICY_VALUE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_POLICY_VALUE.class!",
                   org.omg.CORBA.BAD_POLICY_VALUE.class.isAssignableFrom(sut));
    }

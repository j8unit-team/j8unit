 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * @see DOMExceptionTests DOMExceptionTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DOMExceptionClassTests<SUT extends org.w3c.dom.DOMException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.DOMException.class!",
                   org.w3c.dom.DOMException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WrongAdapterHelper
 * public abstract class org.omg.PortableServer.POAPackage.WrongAdapterHelper}.
 *
...
public abstract interface WrongAdapterHelperClassTests<SUT extends WrongAdapterHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.POAPackage.WrongAdapterHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WrongAdapterHelper.class!",
                   WrongAdapterHelper.class.isAssignableFrom(sut));
    }

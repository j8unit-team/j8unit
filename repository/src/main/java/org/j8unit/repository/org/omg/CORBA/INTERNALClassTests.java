 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INTERNALTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link INTERNALTests}.
 * </p>
 *
 * @see org.omg.CORBA.INTERNAL class org.omg.CORBA.INTERNAL (the hereby targeted class-under-test class)
 * @see INTERNALTests INTERNALTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INTERNAL.class!",
                   org.omg.CORBA.INTERNAL.class.isAssignableFrom(sut));
    }

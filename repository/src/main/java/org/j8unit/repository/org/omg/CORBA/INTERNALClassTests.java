 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INTERNAL public
 * final class org.omg.CORBA.INTERNAL}.
 *
...
public abstract interface INTERNALClassTests<SUT extends INTERNAL>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INTERNAL.class!",
                   INTERNAL.class.isAssignableFrom(sut));
    }

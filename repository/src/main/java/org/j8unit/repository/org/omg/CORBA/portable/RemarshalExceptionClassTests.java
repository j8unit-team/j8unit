 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RemarshalException
 * public final class org.omg.CORBA.portable.RemarshalException}.
 *
...
public abstract interface RemarshalExceptionClassTests<SUT extends RemarshalException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RemarshalException.class!",
                   RemarshalException.class.isAssignableFrom(sut));
    }

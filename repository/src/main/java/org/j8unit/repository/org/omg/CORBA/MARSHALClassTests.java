 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MARSHALTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MARSHALTests}.
 * </p>
 *
 * @see org.omg.CORBA.MARSHAL class org.omg.CORBA.MARSHAL (the hereby targeted class-under-test class)
 * @see MARSHALTests MARSHALTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.MARSHAL.class!",
                   org.omg.CORBA.MARSHAL.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MARSHAL public
...
public abstract interface MARSHALClassTests<SUT extends MARSHAL>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MARSHAL.class!",
                   MARSHAL.class.isAssignableFrom(sut));
    }

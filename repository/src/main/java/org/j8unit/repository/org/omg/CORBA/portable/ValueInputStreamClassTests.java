 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueInputStream
 * public abstract interface org.omg.CORBA.portable.ValueInputStream}.
 *
...
public abstract interface ValueInputStreamClassTests<SUT extends ValueInputStream>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueInputStream.class!",
                   ValueInputStream.class.isAssignableFrom(sut));
    }

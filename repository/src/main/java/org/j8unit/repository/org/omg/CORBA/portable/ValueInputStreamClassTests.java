 ...
 * org.omg.CORBA.portable.ValueInputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueInputStreamTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ValueInputStreamTests}.
 * </p>
 *
 * @see org.omg.CORBA.portable.ValueInputStream interface org.omg.CORBA.portable.ValueInputStream (the hereby targeted
 *      class-under-test class)
 * @see ValueInputStreamTests ValueInputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface ValueInputStreamClassTests<SUT extends org.omg.CORBA.portable.ValueInputStream>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.ValueInputStream.class!",
                   org.omg.CORBA.portable.ValueInputStream.class.isAssignableFrom(sut));
    }

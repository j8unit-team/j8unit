 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringNameHelper
 * public abstract class org.omg.CosNaming.NamingContextExtPackage.StringNameHelper}.
 *
...
public abstract interface StringNameHelperClassTests<SUT extends StringNameHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringNameHelper.class!",
                   StringNameHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BooleanSeqHolder
 * public final class org.omg.CORBA.BooleanSeqHolder}.
 *
...
public abstract interface BooleanSeqHolderClassTests<SUT extends BooleanSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BooleanSeqHolder.class!",
                   BooleanSeqHolder.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.ParameterMode class org.omg.CORBA.ParameterMode},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParameterModeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ParameterModeTests}.
 * </p>
 *
 * @see org.omg.CORBA.ParameterMode class org.omg.CORBA.ParameterMode (the hereby targeted class-under-test class)
 * @see ParameterModeTests ParameterModeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ParameterModeClassTests<SUT extends org.omg.CORBA.ParameterMode>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ParameterMode.class!",
                   org.omg.CORBA.ParameterMode.class.isAssignableFrom(sut));
    }

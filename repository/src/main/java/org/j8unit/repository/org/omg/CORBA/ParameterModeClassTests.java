 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParameterMode
...
public abstract interface ParameterModeClassTests<SUT extends ParameterMode>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.ParameterMode]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParameterMode.class!",
                   ParameterMode.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.ParameterMode]

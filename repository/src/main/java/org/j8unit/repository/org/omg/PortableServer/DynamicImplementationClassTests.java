 ...
 * org.omg.PortableServer.DynamicImplementation}, containing all type relevant aspects (e.&thinsp;g., runtime
...
extends ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.DynamicImplementation.class!",
                   org.omg.PortableServer.DynamicImplementation.class.isAssignableFrom(sut));
    }

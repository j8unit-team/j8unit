 ...
 * {@link DynamicImplementation public abstract class org.omg.PortableServer.DynamicImplementation}.
 *
...
extends ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynamicImplementation.class!",
                   DynamicImplementation.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.PortableServer.ServantLocatorPOA}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServantLocatorPOATests}).
 * </p>
 *
 * <p>
 ...
 * @see ServantLocatorPOATests ServantLocatorPOATests (The complementary j8unit test interface containing the instance
...
public abstract interface ServantLocatorPOAClassTests<SUT extends org.omg.PortableServer.ServantLocatorPOA>
extends ServantLocatorOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.InvokeHandlerClassTests<SUT>, ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ServantLocatorPOA.class!",
                   org.omg.PortableServer.ServantLocatorPOA.class.isAssignableFrom(sut));
    }

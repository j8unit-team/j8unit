 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServantLocatorPOA
 * public abstract class org.omg.PortableServer.ServantLocatorPOA}.
 *
...
extends ServantLocatorOperationsClassTests<SUT>, InvokeHandlerClassTests<SUT>, ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantLocatorPOA.class!",

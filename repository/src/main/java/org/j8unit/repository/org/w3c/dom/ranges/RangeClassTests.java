 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RangeTests}).
 * </p>
 *
 * <p>
 ...
 * @see RangeTests RangeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface RangeClassTests<SUT extends org.w3c.dom.ranges.Range>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ranges.Range.class!",
                   org.w3c.dom.ranges.Range.class.isAssignableFrom(sut));
    }

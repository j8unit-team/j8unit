 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Range public
...
public abstract interface RangeClassTests<SUT extends Range>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Range.class!", Range.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link POATests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link POATests}.
 * </p>
 *
 * @see org.omg.PortableServer.POA interface org.omg.PortableServer.POA (the hereby targeted class-under-test class)
 * @see POATests POATests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface POAClassTests<SUT extends org.omg.PortableServer.POA>
extends POAOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POA.class!",
                   org.omg.PortableServer.POA.class.isAssignableFrom(sut));
    }

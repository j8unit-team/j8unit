 ...
 * org.omg.IOP.TaggedComponentHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TaggedComponentHolderTests}).
 * </p>
 *
 * <p>
 ...
 * {@link TaggedComponentHolderTests}.
 * </p>
 *
 * @see org.omg.IOP.TaggedComponentHolder class org.omg.IOP.TaggedComponentHolder (the hereby targeted class-under-test
 *      class)
 * @see TaggedComponentHolderTests TaggedComponentHolderTests (The complementary j8unit test interface containing the
...
public abstract interface TaggedComponentHolderClassTests<SUT extends org.omg.IOP.TaggedComponentHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TaggedComponentHolder.class!",
                   org.omg.IOP.TaggedComponentHolder.class.isAssignableFrom(sut));
    }

...
public abstract interface TaggedComponentHolderClassTests<SUT extends TaggedComponentHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TaggedComponentHolder.class!",
                   TaggedComponentHolder.class.isAssignableFrom(sut));
    }

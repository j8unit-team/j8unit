 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyErrorTests}).
 * </p>
 *
 * <p>
 ...
 * @see PolicyErrorTests PolicyErrorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface PolicyErrorClassTests<SUT extends org.omg.CORBA.PolicyError>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.PolicyError.class!",
                   org.omg.CORBA.PolicyError.class.isAssignableFrom(sut));
    }

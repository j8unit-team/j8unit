 ...
 * org.omg.CosNaming._NamingContextExtStub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _NamingContextExtStubTests}).
 * </p>
 *
 * <p>
 ...
 * {@link _NamingContextExtStubTests}.
 * </p>
 *
 * @see org.omg.CosNaming._NamingContextExtStub class org.omg.CosNaming._NamingContextExtStub (the hereby targeted
 *      class-under-test class)
 * @see _NamingContextExtStubTests _NamingContextExtStubTests (The complementary j8unit test interface containing the
...
extends NamingContextExtClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming._NamingContextExtStub.class!",
                   org.omg.CosNaming._NamingContextExtStub.class.isAssignableFrom(sut));
    }

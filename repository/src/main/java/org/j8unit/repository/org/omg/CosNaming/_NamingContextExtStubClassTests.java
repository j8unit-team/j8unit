...
public abstract interface _NamingContextExtStubClassTests<SUT extends _NamingContextExtStub>
extends NamingContextExtClassTests<SUT>, ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _NamingContextExtStub.class!",
                   _NamingContextExtStub.class.isAssignableFrom(sut));
    }

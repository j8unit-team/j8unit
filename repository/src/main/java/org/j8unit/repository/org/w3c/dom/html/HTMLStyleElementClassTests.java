 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLStyleElement
 * public abstract interface org.w3c.dom.html.HTMLStyleElement}.
 *
...
public abstract interface HTMLStyleElementClassTests<SUT extends HTMLStyleElement>
extends HTMLElementClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.w3c.dom.html.HTMLStyleElement]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLStyleElement.class!",
                   HTMLStyleElement.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.w3c.dom.html.HTMLStyleElement]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.w3c.dom.html.HTMLStyleElement]

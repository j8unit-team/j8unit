 ...
 * org.omg.IOP.CodecPackage.TypeMismatch}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see org.omg.IOP.CodecPackage.TypeMismatch class org.omg.IOP.CodecPackage.TypeMismatch (the hereby targeted
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.CodecPackage.TypeMismatch.class!",
                   org.omg.IOP.CodecPackage.TypeMismatch.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IORInfo public
...
public abstract interface IORInfoClassTests<SUT extends IORInfo>
...
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORInfo.class!",
                   IORInfo.class.isAssignableFrom(sut));
    }

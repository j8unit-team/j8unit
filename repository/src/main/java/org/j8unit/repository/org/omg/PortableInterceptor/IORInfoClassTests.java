 ...
 * org.omg.PortableInterceptor.IORInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IORInfoTests}).
 * </p>
 *
 * <p>
 ...
 * @see IORInfoTests IORInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IORInfoClassTests<SUT extends org.omg.PortableInterceptor.IORInfo>
extends IORInfoOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.IORInfo.class!",
                   org.omg.PortableInterceptor.IORInfo.class.isAssignableFrom(sut));
    }

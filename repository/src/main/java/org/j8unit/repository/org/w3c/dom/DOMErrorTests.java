 ...
 * targeting the non-{@code static} behaviour&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMError public
 ...
 * {@link org.j8unit.repository.org.w3c.dom.DOMErrorClassTests}).
 * </p>
 *
 * @param SUT
...
public abstract interface DOMErrorTests<SUT extends DOMError>
extends RepositoryTests<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getRelatedData()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_getRelatedException()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

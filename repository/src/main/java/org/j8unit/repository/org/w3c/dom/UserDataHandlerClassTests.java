 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UserDataHandler
...
public abstract interface UserDataHandlerClassTests<SUT extends UserDataHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UserDataHandler.class!",

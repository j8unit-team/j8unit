...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.ORBPackage.InvalidName class
 * org.omg.CORBA.ORBPackage.InvalidName}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see org.omg.CORBA.ORBPackage.InvalidName class org.omg.CORBA.ORBPackage.InvalidName (the hereby targeted
...
public abstract interface InvalidNameClassTests<SUT extends org.omg.CORBA.ORBPackage.InvalidName>
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ORBPackage.InvalidName.class!",
                   org.omg.CORBA.ORBPackage.InvalidName.class.isAssignableFrom(sut));
    }

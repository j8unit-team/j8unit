 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongSeqHelper
 * public abstract class org.omg.CORBA.LongSeqHelper}.
 *
...
public abstract interface LongSeqHelperClassTests<SUT extends LongSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongSeqHelper.class!",
                   LongSeqHelper.class.isAssignableFrom(sut));
    }

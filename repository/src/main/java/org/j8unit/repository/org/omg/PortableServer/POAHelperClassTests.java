...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.POAHelper class
 * org.omg.PortableServer.POAHelper}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link POAHelperTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link POAHelperTests}.
 * </p>
 *
 * @see org.omg.PortableServer.POAHelper class org.omg.PortableServer.POAHelper (the hereby targeted class-under-test
 *      class)
 * @see POAHelperTests POAHelperTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAHelper.class!",
                   org.omg.PortableServer.POAHelper.class.isAssignableFrom(sut));
    }

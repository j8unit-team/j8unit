 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link POAHelper public
 * abstract class org.omg.PortableServer.POAHelper}.
 *
...
public abstract interface POAHelperClassTests<SUT extends POAHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to POAHelper.class!",
                   POAHelper.class.isAssignableFrom(sut));
    }

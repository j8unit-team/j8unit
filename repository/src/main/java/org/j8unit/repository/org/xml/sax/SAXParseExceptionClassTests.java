 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SAXParseExceptionTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.xml.sax.SAXParseException class org.xml.sax.SAXParseException (the hereby targeted class-under-test class)
 * @see SAXParseExceptionTests SAXParseExceptionTests (The complementary j8unit test interface containing the instance
...
extends SAXExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.SAXParseException.class!",
                   org.xml.sax.SAXParseException.class.isAssignableFrom(sut));
    }

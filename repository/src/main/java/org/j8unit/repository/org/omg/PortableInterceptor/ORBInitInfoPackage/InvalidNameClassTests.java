 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidName public
 * final class org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName}.
 *
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidName.class!",
                   InvalidName.class.isAssignableFrom(sut));
    }

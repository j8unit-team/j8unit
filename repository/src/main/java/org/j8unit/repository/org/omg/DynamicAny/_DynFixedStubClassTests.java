 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _DynFixedStub
...
public abstract interface _DynFixedStubClassTests<SUT extends _DynFixedStub>
extends DynFixedClassTests<SUT>, ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _DynFixedStub.class!",
                   _DynFixedStub.class.isAssignableFrom(sut));
    }

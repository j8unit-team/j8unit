 ...
 * org.omg.DynamicAny._DynFixedStub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _DynFixedStubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link _DynFixedStubTests}.
 * </p>
 *
 * @see org.omg.DynamicAny._DynFixedStub class org.omg.DynamicAny._DynFixedStub (the hereby targeted class-under-test
 *      class)
 * @see _DynFixedStubTests _DynFixedStubTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface _DynFixedStubClassTests<SUT extends org.omg.DynamicAny._DynFixedStub>
extends DynFixedClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny._DynFixedStub.class!",
                   org.omg.DynamicAny._DynFixedStub.class.isAssignableFrom(sut));
    }

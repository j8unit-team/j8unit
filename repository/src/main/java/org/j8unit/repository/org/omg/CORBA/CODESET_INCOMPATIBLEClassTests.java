 ...
 * org.omg.CORBA.CODESET_INCOMPATIBLE}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CODESET_INCOMPATIBLETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CODESET_INCOMPATIBLETests}
 * .
 * </p>
 *
 * @see org.omg.CORBA.CODESET_INCOMPATIBLE class org.omg.CORBA.CODESET_INCOMPATIBLE (the hereby targeted
 *      class-under-test class)
 * @see CODESET_INCOMPATIBLETests CODESET_INCOMPATIBLETests (The complementary j8unit test interface containing the
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.CODESET_INCOMPATIBLE.class!",
                   org.omg.CORBA.CODESET_INCOMPATIBLE.class.isAssignableFrom(sut));
    }

 ...
 * {@link CODESET_INCOMPATIBLE public final class org.omg.CORBA.CODESET_INCOMPATIBLE}.
 *
...
public abstract interface CODESET_INCOMPATIBLEClassTests<SUT extends CODESET_INCOMPATIBLE>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CODESET_INCOMPATIBLE.class!",
                   CODESET_INCOMPATIBLE.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BindingHolderTests}.
 * </p>
 *
 * @see org.omg.CosNaming.BindingHolder class org.omg.CosNaming.BindingHolder (the hereby targeted class-under-test
 *      class)
 * @see BindingHolderTests BindingHolderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.BindingHolder.class!",
                   org.omg.CosNaming.BindingHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueMember public
 * final class org.omg.CORBA.ValueMember}.
 *
...
public abstract interface ValueMemberClassTests<SUT extends ValueMember>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueMember.class!",
                   ValueMember.class.isAssignableFrom(sut));
    }

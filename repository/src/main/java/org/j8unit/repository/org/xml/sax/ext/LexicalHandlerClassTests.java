...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.xml.sax.ext.LexicalHandler interface
 * org.xml.sax.ext.LexicalHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LexicalHandlerTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.xml.sax.ext.LexicalHandler interface org.xml.sax.ext.LexicalHandler (the hereby targeted class-under-test
 *      class)
 * @see LexicalHandlerTests LexicalHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface LexicalHandlerClassTests<SUT extends org.xml.sax.ext.LexicalHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.LexicalHandler.class!",
                   org.xml.sax.ext.LexicalHandler.class.isAssignableFrom(sut));
    }

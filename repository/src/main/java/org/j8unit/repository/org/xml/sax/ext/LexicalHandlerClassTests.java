 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LexicalHandler
...
public abstract interface LexicalHandlerClassTests<SUT extends LexicalHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LexicalHandler.class!",
                   LexicalHandler.class.isAssignableFrom(sut));
    }

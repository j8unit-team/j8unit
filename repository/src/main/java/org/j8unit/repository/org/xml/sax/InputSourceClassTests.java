 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InputSourceTests}).
 * </p>
 *
 * <p>
 ...
 * @see InputSourceTests InputSourceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.InputSource.class!",
                   org.xml.sax.InputSource.class.isAssignableFrom(sut));
    }

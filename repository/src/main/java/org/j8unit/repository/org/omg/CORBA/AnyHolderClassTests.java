 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnyHolder public
 * final class org.omg.CORBA.AnyHolder}.
 *
...
public abstract interface AnyHolderClassTests<SUT extends AnyHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnyHolder.class!",
                   AnyHolder.class.isAssignableFrom(sut));
    }

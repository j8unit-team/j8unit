 ...
 * org.omg.CORBA.IDLTypeOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IDLTypeOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see IDLTypeOperationsTests IDLTypeOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface IDLTypeOperationsClassTests<SUT extends org.omg.CORBA.IDLTypeOperations>
extends IRObjectOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.IDLTypeOperations.class!",
                   org.omg.CORBA.IDLTypeOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IDLTypeOperations
 * public abstract interface org.omg.CORBA.IDLTypeOperations}.
 *
...
extends IRObjectOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IDLTypeOperations.class!",
                   IDLTypeOperations.class.isAssignableFrom(sut));
    }

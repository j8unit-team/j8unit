 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IORInterceptor_3_0
 * public abstract interface org.omg.PortableInterceptor.IORInterceptor_3_0}.
 *
...
public abstract interface IORInterceptor_3_0ClassTests<SUT extends IORInterceptor_3_0>
extends org.j8unit.repository.org.omg.PortableInterceptor.IORInterceptor_3_0OperationsClassTests<SUT>,
org.j8unit.repository.org.omg.PortableInterceptor.IORInterceptorClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableInterceptor.IORInterceptor_3_0]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORInterceptor_3_0.class!",
                   IORInterceptor_3_0.class.isAssignableFrom(sut));
    }

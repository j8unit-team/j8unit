...
public abstract interface MultipleComponentProfileHolderClassTests<SUT extends MultipleComponentProfileHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MultipleComponentProfileHolder.class!",
                   MultipleComponentProfileHolder.class.isAssignableFrom(sut));
    }

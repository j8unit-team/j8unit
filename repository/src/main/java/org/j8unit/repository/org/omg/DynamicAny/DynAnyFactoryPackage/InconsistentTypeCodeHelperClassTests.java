...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    public default void create_InconsistentTypeCodeHelper()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.DynamicAny.DynAnyFactoryPackage.InconsistentTypeCodeHelper sut = null; // = new
    ...
    @Test
    @Category(Draft.class)
    public default void test_insert_Any_InconsistentTypeCode()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_write_OutputStream_InconsistentTypeCode()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindingListHelper
 * public abstract class org.omg.CosNaming.BindingListHelper}.
 *
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingListHelper.class!",
                   BindingListHelper.class.isAssignableFrom(sut));
    }

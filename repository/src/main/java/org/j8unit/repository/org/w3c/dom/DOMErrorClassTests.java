 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMErrorTests}).
 * </p>
 *
 * <p>
 ...
 * @see DOMErrorTests DOMErrorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DOMErrorClassTests<SUT extends org.w3c.dom.DOMError>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.DOMError.class!",
                   org.w3c.dom.DOMError.class.isAssignableFrom(sut));
    }

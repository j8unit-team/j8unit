 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMError public
 * abstract interface org.w3c.dom.DOMError}.
 *
...
public abstract interface DOMErrorClassTests<SUT extends DOMError>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMError.class!",
                   DOMError.class.isAssignableFrom(sut));
    }

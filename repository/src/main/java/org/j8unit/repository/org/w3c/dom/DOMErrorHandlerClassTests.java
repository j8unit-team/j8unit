 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMErrorHandler
 * public abstract interface org.w3c.dom.DOMErrorHandler}.
 *
...
public abstract interface DOMErrorHandlerClassTests<SUT extends DOMErrorHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMErrorHandler.class!",
                   DOMErrorHandler.class.isAssignableFrom(sut));
    }

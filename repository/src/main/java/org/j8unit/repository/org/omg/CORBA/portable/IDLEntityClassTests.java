 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IDLEntity public
 * abstract interface org.omg.CORBA.portable.IDLEntity}.
 *
...
extends SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IDLEntity.class!",
                   IDLEntity.class.isAssignableFrom(sut));
    }

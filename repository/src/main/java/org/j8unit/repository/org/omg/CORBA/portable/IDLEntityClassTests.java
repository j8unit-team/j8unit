 ...
 * org.omg.CORBA.portable.IDLEntity}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IDLEntityTests}).
 * </p>
 *
 * <p>
 ...
 * @see IDLEntityTests IDLEntityTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IDLEntityClassTests<SUT extends org.omg.CORBA.portable.IDLEntity>
extends org.j8unit.repository.java.io.SerializableClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.IDLEntity.class!",
                   org.omg.CORBA.portable.IDLEntity.class.isAssignableFrom(sut));
    }

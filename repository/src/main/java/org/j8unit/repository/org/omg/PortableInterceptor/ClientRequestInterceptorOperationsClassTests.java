...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.ClientRequestInterceptorOperations
 * interface org.omg.PortableInterceptor.ClientRequestInterceptorOperations}, containing all type relevant aspects
 ...
 * {@link ClientRequestInterceptorOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * @see ClientRequestInterceptorOperationsTests ClientRequestInterceptorOperationsTests (The complementary j8unit test
...
public abstract interface ClientRequestInterceptorOperationsClassTests<SUT extends org.omg.PortableInterceptor.ClientRequestInterceptorOperations>
extends InterceptorOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ClientRequestInterceptorOperations.class!",
                   org.omg.PortableInterceptor.ClientRequestInterceptorOperations.class.isAssignableFrom(sut));
    }

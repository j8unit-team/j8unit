...
public abstract interface ImplicitActivationPolicyClassTests<SUT extends ImplicitActivationPolicy>
extends ImplicitActivationPolicyOperationsClassTests<SUT>, PolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImplicitActivationPolicy.class!",
                   ImplicitActivationPolicy.class.isAssignableFrom(sut));
    }

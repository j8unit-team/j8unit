 ...
 * org.omg.PortableServer.ImplicitActivationPolicy}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ImplicitActivationPolicyTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link ImplicitActivationPolicyTests}.
 * </p>
 *
 * @see org.omg.PortableServer.ImplicitActivationPolicy interface org.omg.PortableServer.ImplicitActivationPolicy (the
 *      hereby targeted class-under-test class)
 * @see ImplicitActivationPolicyTests ImplicitActivationPolicyTests (The complementary j8unit test interface containing
...
public abstract interface ImplicitActivationPolicyClassTests<SUT extends org.omg.PortableServer.ImplicitActivationPolicy>
extends ImplicitActivationPolicyOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ImplicitActivationPolicy.class!",
                   org.omg.PortableServer.ImplicitActivationPolicy.class.isAssignableFrom(sut));
    }

...
public abstract interface ORBInitInfoOperationsClassTests<SUT extends ORBInitInfoOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ORBInitInfoOperations.class!",
                   ORBInitInfoOperations.class.isAssignableFrom(sut));
    }

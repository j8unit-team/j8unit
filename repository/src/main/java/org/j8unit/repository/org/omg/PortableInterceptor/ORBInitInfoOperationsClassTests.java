 ...
 * org.omg.PortableInterceptor.ORBInitInfoOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ORBInitInfoOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * @see ORBInitInfoOperationsTests ORBInitInfoOperationsTests (The complementary j8unit test interface containing the
...
public abstract interface ORBInitInfoOperationsClassTests<SUT extends org.omg.PortableInterceptor.ORBInitInfoOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ORBInitInfoOperations.class!",
                   org.omg.PortableInterceptor.ORBInitInfoOperations.class.isAssignableFrom(sut));
    }

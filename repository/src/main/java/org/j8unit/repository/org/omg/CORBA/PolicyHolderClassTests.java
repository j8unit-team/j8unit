 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyHolder public
 * final class org.omg.CORBA.PolicyHolder}.
 *
...
public abstract interface PolicyHolderClassTests<SUT extends PolicyHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyHolder.class!",
                   PolicyHolder.class.isAssignableFrom(sut));
    }

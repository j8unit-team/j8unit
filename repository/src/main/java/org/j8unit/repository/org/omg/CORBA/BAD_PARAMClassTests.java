 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_PARAMTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.BAD_PARAM class org.omg.CORBA.BAD_PARAM (the hereby targeted class-under-test class)
 * @see BAD_PARAMTests BAD_PARAMTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_PARAM.class!",
                   org.omg.CORBA.BAD_PARAM.class.isAssignableFrom(sut));
    }

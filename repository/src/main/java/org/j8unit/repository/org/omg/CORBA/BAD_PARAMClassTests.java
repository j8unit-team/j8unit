 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_PARAM public
 * final class org.omg.CORBA.BAD_PARAM}.
 *
...
public abstract interface BAD_PARAMClassTests<SUT extends BAD_PARAM>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_PARAM.class!",
                   BAD_PARAM.class.isAssignableFrom(sut));
    }

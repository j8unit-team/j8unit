 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ByteHolder public
 * final class org.omg.CORBA.ByteHolder}.
 *
...
public abstract interface ByteHolderClassTests<SUT extends ByteHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ByteHolder.class!",
                   ByteHolder.class.isAssignableFrom(sut));
    }

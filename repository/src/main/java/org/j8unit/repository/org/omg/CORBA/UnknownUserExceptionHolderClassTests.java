 ...
 * org.omg.CORBA.UnknownUserExceptionHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * {@link UnknownUserExceptionHolderTests}).
 * </p>
 *
 * <p>
 ...
 * @see UnknownUserExceptionHolderTests UnknownUserExceptionHolderTests (The complementary j8unit test interface
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.UnknownUserExceptionHolder.class!",
                   org.omg.CORBA.UnknownUserExceptionHolder.class.isAssignableFrom(sut));
    }

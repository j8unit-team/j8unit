...
public abstract interface UnknownUserExceptionHolderClassTests<SUT extends UnknownUserExceptionHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownUserExceptionHolder.class!",
                   UnknownUserExceptionHolder.class.isAssignableFrom(sut));
    }

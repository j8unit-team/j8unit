...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CosNaming.NamingContextHolder class
 * org.omg.CosNaming.NamingContextHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingContextHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingContextHolderTests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextHolder class org.omg.CosNaming.NamingContextHolder (the hereby targeted
 *      class-under-test class)
 * @see NamingContextHolderTests NamingContextHolderTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextHolder.class!",
                   org.omg.CosNaming.NamingContextHolder.class.isAssignableFrom(sut));
    }

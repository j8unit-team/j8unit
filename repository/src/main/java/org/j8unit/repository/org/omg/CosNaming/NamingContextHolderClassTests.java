 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingContextHolder
 * public final class org.omg.CosNaming.NamingContextHolder}.
 *
...
public abstract interface NamingContextHolderClassTests<SUT extends NamingContextHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CosNaming.NamingContextHolder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContextHolder.class!",
                   NamingContextHolder.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.Current interface org.omg.CORBA.Current}, containing all
...
public abstract interface CurrentClassTests<SUT extends org.omg.CORBA.Current>
extends CurrentOperationsClassTests<SUT>, ObjectClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.Current.class!",
                   org.omg.CORBA.Current.class.isAssignableFrom(sut));
    }

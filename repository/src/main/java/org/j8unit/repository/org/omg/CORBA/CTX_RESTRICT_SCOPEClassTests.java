 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CTX_RESTRICT_SCOPE
 * public abstract interface org.omg.CORBA.CTX_RESTRICT_SCOPE}.
 *
...
public abstract interface CTX_RESTRICT_SCOPEClassTests<SUT extends CTX_RESTRICT_SCOPE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CTX_RESTRICT_SCOPE.class!",
                   CTX_RESTRICT_SCOPE.class.isAssignableFrom(sut));
    }

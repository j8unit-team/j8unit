 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynValueCommon
...
public abstract interface DynValueCommonClassTests<SUT extends DynValueCommon>
extends DynValueCommonOperationsClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynValueCommon.class!",
                   DynValueCommon.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.BAD_INV_ORDER class org.omg.CORBA.BAD_INV_ORDER},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_INV_ORDERTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BAD_INV_ORDERTests}.
 * </p>
 *
 * @see org.omg.CORBA.BAD_INV_ORDER class org.omg.CORBA.BAD_INV_ORDER (the hereby targeted class-under-test class)
 * @see BAD_INV_ORDERTests BAD_INV_ORDERTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface BAD_INV_ORDERClassTests<SUT extends org.omg.CORBA.BAD_INV_ORDER>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_INV_ORDER.class!",
                   org.omg.CORBA.BAD_INV_ORDER.class.isAssignableFrom(sut));
    }

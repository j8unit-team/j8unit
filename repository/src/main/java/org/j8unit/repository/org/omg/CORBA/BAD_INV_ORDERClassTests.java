 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_INV_ORDER
 * public final class org.omg.CORBA.BAD_INV_ORDER}.
 *
...
public abstract interface BAD_INV_ORDERClassTests<SUT extends BAD_INV_ORDER>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_INV_ORDER.class!",
                   BAD_INV_ORDER.class.isAssignableFrom(sut));
    }

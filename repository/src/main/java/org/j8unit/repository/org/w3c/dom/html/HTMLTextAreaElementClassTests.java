 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLTextAreaElement
 * public abstract interface org.w3c.dom.html.HTMLTextAreaElement}.
 *
...
public abstract interface HTMLTextAreaElementClassTests<SUT extends HTMLTextAreaElement>
extends org.j8unit.repository.org.w3c.dom.html.HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLTextAreaElement.class!",
                   HTMLTextAreaElement.class.isAssignableFrom(sut));
    }

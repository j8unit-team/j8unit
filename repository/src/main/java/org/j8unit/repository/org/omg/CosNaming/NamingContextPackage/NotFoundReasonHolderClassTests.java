 ...
 * {@link NotFoundReasonHolder public final class org.omg.CosNaming.NamingContextPackage.NotFoundReasonHolder}.
 *
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotFoundReasonHolder.class!",
                   NotFoundReasonHolder.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CosNaming.NamingContextPackage.NotFoundReasonHolder}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotFoundReasonHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotFoundReasonHolderTests}
 * .
 * </p>
 *
 ...
 * @see NotFoundReasonHolderTests NotFoundReasonHolderTests (The complementary j8unit test interface containing the
...
public abstract interface NotFoundReasonHolderClassTests<SUT extends org.omg.CosNaming.NamingContextPackage.NotFoundReasonHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPackage.NotFoundReasonHolder.class!",
                   org.omg.CosNaming.NamingContextPackage.NotFoundReasonHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyHelper public
 * abstract class org.omg.CORBA.PolicyHelper}.
 *
...
public abstract interface PolicyHelperClassTests<SUT extends PolicyHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyHelper.class!",
                   PolicyHelper.class.isAssignableFrom(sut));
    }

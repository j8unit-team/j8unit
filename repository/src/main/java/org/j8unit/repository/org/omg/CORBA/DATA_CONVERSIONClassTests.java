 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DATA_CONVERSIONTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.DATA_CONVERSION class org.omg.CORBA.DATA_CONVERSION (the hereby targeted class-under-test class)
 * @see DATA_CONVERSIONTests DATA_CONVERSIONTests (The complementary j8unit test interface containing the instance
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DATA_CONVERSION.class!",
                   org.omg.CORBA.DATA_CONVERSION.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DATA_CONVERSION
...
public abstract interface DATA_CONVERSIONClassTests<SUT extends DATA_CONVERSION>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DATA_CONVERSION.class!",
                   DATA_CONVERSION.class.isAssignableFrom(sut));
    }

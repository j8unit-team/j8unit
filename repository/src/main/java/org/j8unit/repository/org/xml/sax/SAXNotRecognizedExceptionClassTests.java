 ...
 * org.xml.sax.SAXNotRecognizedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see org.xml.sax.SAXNotRecognizedException class org.xml.sax.SAXNotRecognizedException (the hereby targeted
 *      class-under-test class)
 * @see SAXNotRecognizedExceptionTests SAXNotRecognizedExceptionTests (The complementary j8unit test interface
...
extends SAXExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.SAXNotRecognizedException.class!",
                   org.xml.sax.SAXNotRecognizedException.class.isAssignableFrom(sut));
    }

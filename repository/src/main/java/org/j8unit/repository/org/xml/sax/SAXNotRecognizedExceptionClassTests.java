...
public abstract interface SAXNotRecognizedExceptionClassTests<SUT extends SAXNotRecognizedException>
extends SAXExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXNotRecognizedException.class!",
                   SAXNotRecognizedException.class.isAssignableFrom(sut));
    }

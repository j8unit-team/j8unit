 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSSerializerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LSSerializerTests}.
 * </p>
 *
 * @see org.w3c.dom.ls.LSSerializer interface org.w3c.dom.ls.LSSerializer (the hereby targeted class-under-test class)
 * @see LSSerializerTests LSSerializerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface LSSerializerClassTests<SUT extends org.w3c.dom.ls.LSSerializer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSSerializer.class!",
                   org.w3c.dom.ls.LSSerializer.class.isAssignableFrom(sut));
    }

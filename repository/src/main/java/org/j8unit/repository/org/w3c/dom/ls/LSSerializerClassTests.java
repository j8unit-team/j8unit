 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSSerializer public
 * abstract interface org.w3c.dom.ls.LSSerializer}.
 *
...
public abstract interface LSSerializerClassTests<SUT extends LSSerializer>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSSerializer.class!",
                   LSSerializer.class.isAssignableFrom(sut));
    }

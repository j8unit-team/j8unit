 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynFixedHelper
 * public abstract class org.omg.DynamicAny.DynFixedHelper}.
 *
...
public abstract interface DynFixedHelperClassTests<SUT extends DynFixedHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynFixedHelper.class!",
                   DynFixedHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyOperations
 * public abstract interface org.omg.CORBA.PolicyOperations}.
 *
...
public abstract interface PolicyOperationsClassTests<SUT extends PolicyOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyOperations.class!",
                   PolicyOperations.class.isAssignableFrom(sut));
    }

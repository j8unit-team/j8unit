 ...
 * org.omg.CORBA.PolicyOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PolicyOperationsTests}.
 * </p>
 *
 * @see org.omg.CORBA.PolicyOperations interface org.omg.CORBA.PolicyOperations (the hereby targeted class-under-test
 *      class)
 * @see PolicyOperationsTests PolicyOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface PolicyOperationsClassTests<SUT extends org.omg.CORBA.PolicyOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.PolicyOperations.class!",
                   org.omg.CORBA.PolicyOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameComponentHelper
 * public abstract class org.omg.CosNaming.NameComponentHelper}.
 *
...
public abstract interface NameComponentHelperClassTests<SUT extends NameComponentHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameComponentHelper.class!",
                   NameComponentHelper.class.isAssignableFrom(sut));
    }

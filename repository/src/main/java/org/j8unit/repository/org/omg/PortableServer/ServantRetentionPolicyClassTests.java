...
public abstract interface ServantRetentionPolicyClassTests<SUT extends ServantRetentionPolicy>
...
org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantRetentionPolicy.class!",
                   ServantRetentionPolicy.class.isAssignableFrom(sut));
    }

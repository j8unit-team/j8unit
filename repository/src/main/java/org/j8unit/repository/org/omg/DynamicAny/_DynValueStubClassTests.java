 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _DynValueStub
...
public abstract interface _DynValueStubClassTests<SUT extends _DynValueStub>
extends org.j8unit.repository.org.omg.DynamicAny.DynValueClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.DynamicAny._DynValueStub]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _DynValueStub.class!",
                   _DynValueStub.class.isAssignableFrom(sut));
    }

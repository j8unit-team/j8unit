 ...
 * org.omg.DynamicAny._DynValueStub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _DynValueStubTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see _DynValueStubTests _DynValueStubTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends DynValueClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny._DynValueStub.class!",
                   org.omg.DynamicAny._DynValueStub.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CORBA.TRANSACTION_UNAVAILABLE}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TRANSACTION_UNAVAILABLETests}
 * ).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.TRANSACTION_UNAVAILABLE class org.omg.CORBA.TRANSACTION_UNAVAILABLE (the hereby targeted
 *      class-under-test class)
 * @see TRANSACTION_UNAVAILABLETests TRANSACTION_UNAVAILABLETests (The complementary j8unit test interface containing
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.TRANSACTION_UNAVAILABLE.class!",
                   org.omg.CORBA.TRANSACTION_UNAVAILABLE.class.isAssignableFrom(sut));
    }

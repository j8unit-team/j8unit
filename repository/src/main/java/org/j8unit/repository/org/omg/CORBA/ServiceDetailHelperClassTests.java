 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceDetailHelper
 * public abstract class org.omg.CORBA.ServiceDetailHelper}.
 *
...
public abstract interface ServiceDetailHelperClassTests<SUT extends ServiceDetailHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceDetailHelper.class!",
                   ServiceDetailHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.ServiceDetailHelper]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Rect public
 * abstract interface org.w3c.dom.css.Rect}.
 *
...
public abstract interface RectClassTests<SUT extends Rect>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Rect.class!", Rect.class.isAssignableFrom(sut));
    }

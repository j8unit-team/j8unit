 ...
 * org.omg.DynamicAny.DynArrayOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynArrayOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynArrayOperationsTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynArrayOperations interface org.omg.DynamicAny.DynArrayOperations (the hereby targeted
 *      class-under-test class)
 * @see DynArrayOperationsTests DynArrayOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface DynArrayOperationsClassTests<SUT extends org.omg.DynamicAny.DynArrayOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynArrayOperations.class!",
                   org.omg.DynamicAny.DynArrayOperations.class.isAssignableFrom(sut));
    }

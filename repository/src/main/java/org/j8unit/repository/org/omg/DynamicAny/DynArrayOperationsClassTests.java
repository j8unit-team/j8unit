 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynArrayOperations
 * public abstract interface org.omg.DynamicAny.DynArrayOperations}.
 *
...
public abstract interface DynArrayOperationsClassTests<SUT extends DynArrayOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynArrayOperations.class!",
                   DynArrayOperations.class.isAssignableFrom(sut));
    }

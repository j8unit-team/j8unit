 ...
 * {@link AdapterInactiveHelper public abstract class org.omg.PortableServer.POAManagerPackage.AdapterInactiveHelper}.
 *
...
public abstract interface AdapterInactiveHelperClassTests<SUT extends AdapterInactiveHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterInactiveHelper.class!",
                   AdapterInactiveHelper.class.isAssignableFrom(sut));
    }

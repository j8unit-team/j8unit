 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynValueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynValueTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynValue interface org.omg.DynamicAny.DynValue (the hereby targeted class-under-test class)
 * @see DynValueTests DynValueTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynValueClassTests<SUT extends org.omg.DynamicAny.DynValue>
extends DynValueOperationsClassTests<SUT>, DynValueCommonClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynValue.class!",
                   org.omg.DynamicAny.DynValue.class.isAssignableFrom(sut));
    }

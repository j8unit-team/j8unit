 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynValue public
...
public abstract interface DynValueClassTests<SUT extends DynValue>
extends org.j8unit.repository.org.omg.DynamicAny.DynValueOperationsClassTests<SUT>, org.j8unit.repository.org.omg.DynamicAny.DynValueCommonClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynValue.class!",
                   DynValue.class.isAssignableFrom(sut));
    }

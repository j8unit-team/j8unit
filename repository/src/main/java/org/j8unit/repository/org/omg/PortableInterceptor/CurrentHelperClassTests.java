 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CurrentHelper
 * public abstract class org.omg.PortableInterceptor.CurrentHelper}.
 *
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CurrentHelper.class!",
                   CurrentHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.PortableInterceptor.CurrentHelper]

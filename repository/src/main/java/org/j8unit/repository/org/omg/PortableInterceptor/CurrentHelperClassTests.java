 ...
 * org.omg.PortableInterceptor.CurrentHelper}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CurrentHelperTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableInterceptor.CurrentHelper class org.omg.PortableInterceptor.CurrentHelper (the hereby targeted
 *      class-under-test class)
 * @see CurrentHelperTests CurrentHelperTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.CurrentHelper.class!",
                   org.omg.PortableInterceptor.CurrentHelper.class.isAssignableFrom(sut));
    }

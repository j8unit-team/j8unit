...
public abstract interface ServiceContextListHolderClassTests<SUT extends ServiceContextListHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceContextListHolder.class!",
                   ServiceContextListHolder.class.isAssignableFrom(sut));
    }

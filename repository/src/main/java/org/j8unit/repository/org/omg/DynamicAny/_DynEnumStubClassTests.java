 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _DynEnumStubTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see _DynEnumStubTests _DynEnumStubTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface _DynEnumStubClassTests<SUT extends org.omg.DynamicAny._DynEnumStub>
extends DynEnumClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny._DynEnumStub.class!",
                   org.omg.DynamicAny._DynEnumStub.class.isAssignableFrom(sut));
    }

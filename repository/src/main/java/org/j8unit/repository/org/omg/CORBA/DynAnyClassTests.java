 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynAny public
...
extends org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynAny.class!",
                   DynAny.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynAnyTests}).
 * </p>
 *
 * <p>
 ...
 * @see DynAnyTests DynAnyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface DynAnyClassTests<SUT extends org.omg.CORBA.DynAny>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynAny.class!",
                   org.omg.CORBA.DynAny.class.isAssignableFrom(sut));
    }

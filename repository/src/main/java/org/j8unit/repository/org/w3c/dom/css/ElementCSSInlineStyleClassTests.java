...
public abstract interface ElementCSSInlineStyleClassTests<SUT extends ElementCSSInlineStyle>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ElementCSSInlineStyle.class!",
                   ElementCSSInlineStyle.class.isAssignableFrom(sut));
    }

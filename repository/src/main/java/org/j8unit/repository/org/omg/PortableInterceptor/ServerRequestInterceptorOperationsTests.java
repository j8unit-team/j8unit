 ...
 * org.omg.PortableInterceptor.ServerRequestInterceptorOperations}, containing all instance relevant test methods
...
extends org.j8unit.repository.org.omg.PortableInterceptor.InterceptorOperationsTests<SUT> {
    ...
    public default void test_receive_request_ServerRequestInfo()
    throws Exception {
    ...
    @Test
    @Category(Draft.class)
    public default void test_send_exception_ServerRequestInfo()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_send_reply_ServerRequestInfo()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

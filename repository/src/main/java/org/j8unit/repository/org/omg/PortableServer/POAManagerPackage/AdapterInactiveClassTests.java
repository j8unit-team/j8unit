 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AdapterInactive
 * public final class org.omg.PortableServer.POAManagerPackage.AdapterInactive}.
 *
...
public abstract interface AdapterInactiveClassTests<SUT extends AdapterInactive>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterInactive.class!",
                   AdapterInactive.class.isAssignableFrom(sut));
    }

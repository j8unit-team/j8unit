...
public abstract interface IORInterceptor_3_0HolderClassTests<SUT extends IORInterceptor_3_0Holder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableInterceptor.IORInterceptor_3_0Holder]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORInterceptor_3_0Holder.class!",
                   IORInterceptor_3_0Holder.class.isAssignableFrom(sut));
    }

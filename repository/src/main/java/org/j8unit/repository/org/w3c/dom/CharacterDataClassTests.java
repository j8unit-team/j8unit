 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CharacterData
...
public abstract interface CharacterDataClassTests<SUT extends CharacterData>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharacterData.class!",
                   CharacterData.class.isAssignableFrom(sut));
    }

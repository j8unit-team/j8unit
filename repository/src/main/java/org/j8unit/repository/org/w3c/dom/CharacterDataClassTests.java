 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CharacterDataTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CharacterDataTests}.
 * </p>
 *
 * @see org.w3c.dom.CharacterData interface org.w3c.dom.CharacterData (the hereby targeted class-under-test class)
 * @see CharacterDataTests CharacterDataTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CharacterDataClassTests<SUT extends org.w3c.dom.CharacterData>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.CharacterData.class!",
                   org.w3c.dom.CharacterData.class.isAssignableFrom(sut));
    }

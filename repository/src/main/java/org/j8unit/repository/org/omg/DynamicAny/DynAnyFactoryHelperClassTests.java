 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynAnyFactoryHelper
 * public abstract class org.omg.DynamicAny.DynAnyFactoryHelper}.
 *
...
public abstract interface DynAnyFactoryHelperClassTests<SUT extends DynAnyFactoryHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynAnyFactoryHelper.class!",
                   DynAnyFactoryHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AlreadyBoundHelper
 * public abstract class org.omg.CosNaming.NamingContextPackage.AlreadyBoundHelper}.
 *
...
public abstract interface AlreadyBoundHelperClassTests<SUT extends AlreadyBoundHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AlreadyBoundHelper.class!",
                   AlreadyBoundHelper.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.xml.sax.helpers.LocatorImpl class org.xml.sax.helpers.LocatorImpl}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocatorImplTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see LocatorImplTests LocatorImplTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.xml.sax.LocatorClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.helpers.LocatorImpl.class!",
                   org.xml.sax.helpers.LocatorImpl.class.isAssignableFrom(sut));
    }

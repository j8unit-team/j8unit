 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LocatorImpl public
...
extends LocatorClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LocatorImpl.class!",
                   LocatorImpl.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.xml.sax.helpers.LocatorImpl]

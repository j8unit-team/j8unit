 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TaggedProfileHelper
 * public abstract class org.omg.IOP.TaggedProfileHelper}.
 *
...
public abstract interface TaggedProfileHelperClassTests<SUT extends TaggedProfileHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.IOP.TaggedProfileHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TaggedProfileHelper.class!",
                   TaggedProfileHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ULongLongSeqHolder
 * public final class org.omg.CORBA.ULongLongSeqHolder}.
 *
...
public abstract interface ULongLongSeqHolderClassTests<SUT extends ULongLongSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ULongLongSeqHolder.class!",
                   ULongLongSeqHolder.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.ULongLongSeqHolder]

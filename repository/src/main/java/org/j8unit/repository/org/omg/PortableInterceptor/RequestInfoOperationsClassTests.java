...
public abstract interface RequestInfoOperationsClassTests<SUT extends RequestInfoOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RequestInfoOperations.class!",
                   RequestInfoOperations.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Attributes2Tests}).
 * </p>
 *
 * <p>
 ...
 * @see Attributes2Tests Attributes2Tests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.xml.sax.AttributesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.Attributes2.class!",
                   org.xml.sax.ext.Attributes2.class.isAssignableFrom(sut));
    }

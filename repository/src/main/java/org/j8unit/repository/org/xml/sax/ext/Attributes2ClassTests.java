 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Attributes2 public
 * abstract interface org.xml.sax.ext.Attributes2}.
 *
...
extends org.j8unit.repository.org.xml.sax.AttributesClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Attributes2.class!",
                   Attributes2.class.isAssignableFrom(sut));
    }

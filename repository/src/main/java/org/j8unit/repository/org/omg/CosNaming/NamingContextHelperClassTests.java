 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingContextHelper
 * public abstract class org.omg.CosNaming.NamingContextHelper}.
 *
...
public abstract interface NamingContextHelperClassTests<SUT extends NamingContextHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContextHelper.class!",
                   NamingContextHelper.class.isAssignableFrom(sut));
    }

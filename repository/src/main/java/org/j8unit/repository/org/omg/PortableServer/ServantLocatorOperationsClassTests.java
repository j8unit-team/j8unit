 ...
 * org.omg.PortableServer.ServantLocatorOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServantLocatorOperationsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see ServantLocatorOperationsTests ServantLocatorOperationsTests (The complementary j8unit test interface containing
...
public abstract interface ServantLocatorOperationsClassTests<SUT extends org.omg.PortableServer.ServantLocatorOperations>
extends ServantManagerOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ServantLocatorOperations.class!",
                   org.omg.PortableServer.ServantLocatorOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLFrameSetElement
 * public abstract interface org.w3c.dom.html.HTMLFrameSetElement}.
 *
...
public abstract interface HTMLFrameSetElementClassTests<SUT extends HTMLFrameSetElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLFrameSetElement.class!",
                   HTMLFrameSetElement.class.isAssignableFrom(sut));
    }

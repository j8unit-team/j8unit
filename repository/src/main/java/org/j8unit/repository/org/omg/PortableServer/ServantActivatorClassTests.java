 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServantActivator
 * public abstract interface org.omg.PortableServer.ServantActivator}.
 *
...
org.j8unit.repository.org.omg.PortableServer.ServantManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantActivator.class!",

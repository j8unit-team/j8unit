...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.ThreadPolicyValue class
 * org.omg.PortableServer.ThreadPolicyValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ThreadPolicyValueTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ThreadPolicyValueTests}.
 * </p>
 *
 * @see org.omg.PortableServer.ThreadPolicyValue class org.omg.PortableServer.ThreadPolicyValue (the hereby targeted
 *      class-under-test class)
 * @see ThreadPolicyValueTests ThreadPolicyValueTests (The complementary j8unit test interface containing the instance
...
public abstract interface ThreadPolicyValueClassTests<SUT extends org.omg.PortableServer.ThreadPolicyValue>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ThreadPolicyValue.class!",
                   org.omg.PortableServer.ThreadPolicyValue.class.isAssignableFrom(sut));
    }

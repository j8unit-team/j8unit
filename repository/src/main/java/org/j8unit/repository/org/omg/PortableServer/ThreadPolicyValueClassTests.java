 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ThreadPolicyValue
 * public class org.omg.PortableServer.ThreadPolicyValue}.
 *
...
public abstract interface ThreadPolicyValueClassTests<SUT extends ThreadPolicyValue>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ThreadPolicyValue.class!",
                   ThreadPolicyValue.class.isAssignableFrom(sut));
    }

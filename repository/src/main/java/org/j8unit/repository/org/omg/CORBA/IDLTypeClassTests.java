 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IDLTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IDLTypeTests}.
 * </p>
 *
 * @see org.omg.CORBA.IDLType interface org.omg.CORBA.IDLType (the hereby targeted class-under-test class)
 * @see IDLTypeTests IDLTypeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface IDLTypeClassTests<SUT extends org.omg.CORBA.IDLType>
extends IDLTypeOperationsClassTests<SUT>, IRObjectClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.IDLType.class!",
                   org.omg.CORBA.IDLType.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IDLType public
...
public abstract interface IDLTypeClassTests<SUT extends IDLType>
extends org.j8unit.repository.org.omg.CORBA.IDLTypeOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.IRObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IDLType.class!",
                   IDLType.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLDListElement
 * public abstract interface org.w3c.dom.html.HTMLDListElement}.
 *
...
public abstract interface HTMLDListElementClassTests<SUT extends HTMLDListElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLDListElement.class!",
                   HTMLDListElement.class.isAssignableFrom(sut));
    }

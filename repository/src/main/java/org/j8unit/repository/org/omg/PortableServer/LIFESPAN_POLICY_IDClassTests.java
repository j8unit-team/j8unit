 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LIFESPAN_POLICY_ID
 * public abstract interface org.omg.PortableServer.LIFESPAN_POLICY_ID}.
 *
...
public abstract interface LIFESPAN_POLICY_IDClassTests<SUT extends LIFESPAN_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LIFESPAN_POLICY_ID.class!",
                   LIFESPAN_POLICY_ID.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.LIFESPAN_POLICY_ID interface
 * org.omg.PortableServer.LIFESPAN_POLICY_ID}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LIFESPAN_POLICY_IDTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableServer.LIFESPAN_POLICY_ID interface org.omg.PortableServer.LIFESPAN_POLICY_ID (the hereby
 *      targeted class-under-test class)
 * @see LIFESPAN_POLICY_IDTests LIFESPAN_POLICY_IDTests (The complementary j8unit test interface containing the instance
...
public abstract interface LIFESPAN_POLICY_IDClassTests<SUT extends org.omg.PortableServer.LIFESPAN_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.LIFESPAN_POLICY_ID.class!",
                   org.omg.PortableServer.LIFESPAN_POLICY_ID.class.isAssignableFrom(sut));
    }

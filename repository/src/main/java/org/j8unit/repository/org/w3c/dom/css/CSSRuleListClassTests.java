 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSRuleList public
 * abstract interface org.w3c.dom.css.CSSRuleList}.
 *
...
public abstract interface CSSRuleListClassTests<SUT extends CSSRuleList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSRuleList.class!",
                   CSSRuleList.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Locator2ImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link Locator2ImplTests}.
 * </p>
 *
 * @see org.xml.sax.ext.Locator2Impl class org.xml.sax.ext.Locator2Impl (the hereby targeted class-under-test class)
 * @see Locator2ImplTests Locator2ImplTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends Locator2ClassTests<SUT>, org.j8unit.repository.org.xml.sax.helpers.LocatorImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.Locator2Impl.class!",
                   org.xml.sax.ext.Locator2Impl.class.isAssignableFrom(sut));
    }

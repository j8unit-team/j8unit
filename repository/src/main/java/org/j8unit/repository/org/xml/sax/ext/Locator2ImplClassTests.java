 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Locator2Impl public
...
public abstract interface Locator2ImplClassTests<SUT extends Locator2Impl>
extends org.j8unit.repository.org.xml.sax.ext.Locator2ClassTests<SUT>, org.j8unit.repository.org.xml.sax.helpers.LocatorImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Locator2Impl.class!",

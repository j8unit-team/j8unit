 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongHolder public
 * final class org.omg.CORBA.LongHolder}.
 *
...
public abstract interface LongHolderClassTests<SUT extends LongHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongHolder.class!",
                   LongHolder.class.isAssignableFrom(sut));
    }

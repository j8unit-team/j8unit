...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.LongHolder class org.omg.CORBA.LongHolder}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LongHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LongHolderTests}.
 * </p>
 *
 * @see org.omg.CORBA.LongHolder class org.omg.CORBA.LongHolder (the hereby targeted class-under-test class)
 * @see LongHolderTests LongHolderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LongHolderClassTests<SUT extends org.omg.CORBA.LongHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.LongHolder.class!",
                   org.omg.CORBA.LongHolder.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link COMM_FAILURETests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.COMM_FAILURE class org.omg.CORBA.COMM_FAILURE (the hereby targeted class-under-test class)
 * @see COMM_FAILURETests COMM_FAILURETests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.COMM_FAILURE.class!",
                   org.omg.CORBA.COMM_FAILURE.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link COMM_FAILURE public
 * final class org.omg.CORBA.COMM_FAILURE}.
 *
...
public abstract interface COMM_FAILUREClassTests<SUT extends COMM_FAILURE>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to COMM_FAILURE.class!",
                   COMM_FAILURE.class.isAssignableFrom(sut));
    }

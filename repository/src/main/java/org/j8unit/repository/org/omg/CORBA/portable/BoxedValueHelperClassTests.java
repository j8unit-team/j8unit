 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BoxedValueHelper
 * public abstract interface org.omg.CORBA.portable.BoxedValueHelper}.
 *
...
public abstract interface BoxedValueHelperClassTests<SUT extends BoxedValueHelper>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BoxedValueHelper.class!",
                   BoxedValueHelper.class.isAssignableFrom(sut));
    }

 ...
 * {@link IdUniquenessPolicyValue public class org.omg.PortableServer.IdUniquenessPolicyValue}.
 *
...
public abstract interface IdUniquenessPolicyValueClassTests<SUT extends IdUniquenessPolicyValue>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdUniquenessPolicyValue.class!",
                   IdUniquenessPolicyValue.class.isAssignableFrom(sut));
    }

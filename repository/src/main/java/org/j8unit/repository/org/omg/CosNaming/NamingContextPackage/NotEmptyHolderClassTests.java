 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotEmptyHolder
...
public abstract interface NotEmptyHolderClassTests<SUT extends NotEmptyHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotEmptyHolder.class!",
                   NotEmptyHolder.class.isAssignableFrom(sut));
    }

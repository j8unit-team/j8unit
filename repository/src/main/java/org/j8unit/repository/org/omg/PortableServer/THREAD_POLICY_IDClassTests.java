...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.THREAD_POLICY_ID interface
 * org.omg.PortableServer.THREAD_POLICY_ID}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link THREAD_POLICY_IDTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link THREAD_POLICY_IDTests}.
 * </p>
 *
 * @see org.omg.PortableServer.THREAD_POLICY_ID interface org.omg.PortableServer.THREAD_POLICY_ID (the hereby targeted
 *      class-under-test class)
 * @see THREAD_POLICY_IDTests THREAD_POLICY_IDTests (The complementary j8unit test interface containing the instance
...
public abstract interface THREAD_POLICY_IDClassTests<SUT extends org.omg.PortableServer.THREAD_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.THREAD_POLICY_ID.class!",
                   org.omg.PortableServer.THREAD_POLICY_ID.class.isAssignableFrom(sut));
    }

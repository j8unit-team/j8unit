 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link THREAD_POLICY_ID
 * public abstract interface org.omg.PortableServer.THREAD_POLICY_ID}.
 *
...
public abstract interface THREAD_POLICY_IDClassTests<SUT extends THREAD_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to THREAD_POLICY_ID.class!",
                   THREAD_POLICY_ID.class.isAssignableFrom(sut));
    }

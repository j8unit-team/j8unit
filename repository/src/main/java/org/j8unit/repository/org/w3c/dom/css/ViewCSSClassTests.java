...
import org.j8unit.repository.org.w3c.dom.views.AbstractViewClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ViewCSS public
...
public abstract interface ViewCSSClassTests<SUT extends ViewCSS>
extends AbstractViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ViewCSS.class!",

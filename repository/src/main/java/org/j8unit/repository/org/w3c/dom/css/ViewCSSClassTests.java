 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ViewCSSTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ViewCSSTests}.
 * </p>
 *
 * @see org.w3c.dom.css.ViewCSS interface org.w3c.dom.css.ViewCSS (the hereby targeted class-under-test class)
 * @see ViewCSSTests ViewCSSTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ViewCSSClassTests<SUT extends org.w3c.dom.css.ViewCSS>
extends org.j8unit.repository.org.w3c.dom.views.AbstractViewClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.ViewCSS.class!",
                   org.w3c.dom.css.ViewCSS.class.isAssignableFrom(sut));
    }

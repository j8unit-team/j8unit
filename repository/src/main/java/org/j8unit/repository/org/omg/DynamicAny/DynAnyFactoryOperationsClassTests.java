 ...
 * org.omg.DynamicAny.DynAnyFactoryOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynAnyFactoryOperationsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link DynAnyFactoryOperationsTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynAnyFactoryOperations interface org.omg.DynamicAny.DynAnyFactoryOperations (the hereby
 *      targeted class-under-test class)
 * @see DynAnyFactoryOperationsTests DynAnyFactoryOperationsTests (The complementary j8unit test interface containing
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynAnyFactoryOperations.class!",
                   org.omg.DynamicAny.DynAnyFactoryOperations.class.isAssignableFrom(sut));
    }

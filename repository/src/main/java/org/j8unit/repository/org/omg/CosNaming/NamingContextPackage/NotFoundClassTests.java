 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotFound public
 * final class org.omg.CosNaming.NamingContextPackage.NotFound}.
 *
...
public abstract interface NotFoundClassTests<SUT extends NotFound>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotFound.class!",
                   NotFound.class.isAssignableFrom(sut));
    }

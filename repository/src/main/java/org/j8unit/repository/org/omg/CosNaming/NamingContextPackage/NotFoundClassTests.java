 ...
 * org.omg.CosNaming.NamingContextPackage.NotFound}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotFoundTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotFoundTests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextPackage.NotFound class org.omg.CosNaming.NamingContextPackage.NotFound (the
 *      hereby targeted class-under-test class)
 * @see NotFoundTests NotFoundTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPackage.NotFound.class!",
                   org.omg.CosNaming.NamingContextPackage.NotFound.class.isAssignableFrom(sut));
    }

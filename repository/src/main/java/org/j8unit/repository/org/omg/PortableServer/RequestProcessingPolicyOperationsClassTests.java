...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.RequestProcessingPolicyOperations interface
 * org.omg.PortableServer.RequestProcessingPolicyOperations}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * </p>
 *
 * @see org.omg.PortableServer.RequestProcessingPolicyOperations interface
 *      org.omg.PortableServer.RequestProcessingPolicyOperations (the hereby targeted class-under-test class)
 * @see RequestProcessingPolicyOperationsTests RequestProcessingPolicyOperationsTests (The complementary j8unit test
...
public abstract interface RequestProcessingPolicyOperationsClassTests<SUT extends org.omg.PortableServer.RequestProcessingPolicyOperations>
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.RequestProcessingPolicyOperations.class!",
                   org.omg.PortableServer.RequestProcessingPolicyOperations.class.isAssignableFrom(sut));
    }

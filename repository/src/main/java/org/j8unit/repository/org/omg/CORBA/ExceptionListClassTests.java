...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.ExceptionList class org.omg.CORBA.ExceptionList},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExceptionListTests}).
 * </p>
 *
 * <p>
 ...
 * @see ExceptionListTests ExceptionListTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ExceptionList.class!",
                   org.omg.CORBA.ExceptionList.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.PortableServer.ImplicitActivationPolicyOperations}, containing all class relevant test methods (at least the
...
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
     ...
     * @since 0.9.2
     *
     * @j8unit.aim org.omg.PortableServer.ImplicitActivationPolicyOperations#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test
    ...
    throws Exception {
        ...
        assertTrue(org.omg.PortableServer.ImplicitActivationPolicyOperations.class.isAssignableFrom(sut));
    }

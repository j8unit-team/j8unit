 ...
 * org.omg.PortableServer.ImplicitActivationPolicyOperations}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * {@link ImplicitActivationPolicyOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * @see ImplicitActivationPolicyOperationsTests ImplicitActivationPolicyOperationsTests (The complementary j8unit test
...
public abstract interface ImplicitActivationPolicyOperationsClassTests<SUT extends org.omg.PortableServer.ImplicitActivationPolicyOperations>
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ImplicitActivationPolicyOperations.class!",
                   org.omg.PortableServer.ImplicitActivationPolicyOperations.class.isAssignableFrom(sut));
    }

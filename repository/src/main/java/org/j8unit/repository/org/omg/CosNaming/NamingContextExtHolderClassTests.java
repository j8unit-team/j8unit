 ...
 * org.omg.CosNaming.NamingContextExtHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingContextExtHolderTests}).
 * </p>
 *
 * <p>
 ...
 * {@link NamingContextExtHolderTests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextExtHolder class org.omg.CosNaming.NamingContextExtHolder (the hereby targeted
 *      class-under-test class)
 * @see NamingContextExtHolderTests NamingContextExtHolderTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextExtHolder.class!",
                   org.omg.CosNaming.NamingContextExtHolder.class.isAssignableFrom(sut));
    }

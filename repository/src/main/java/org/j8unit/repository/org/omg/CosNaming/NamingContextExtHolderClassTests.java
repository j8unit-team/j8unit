...
public abstract interface NamingContextExtHolderClassTests<SUT extends NamingContextExtHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContextExtHolder.class!",
                   NamingContextExtHolder.class.isAssignableFrom(sut));
    }

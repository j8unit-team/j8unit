 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StreamableValue
...
extends StreamableClassTests<SUT>, ValueBaseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StreamableValue.class!",
                   StreamableValue.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CORBA.portable.StreamableValue}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamableValueTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.portable.StreamableValue interface org.omg.CORBA.portable.StreamableValue (the hereby targeted
 *      class-under-test class)
 * @see StreamableValueTests StreamableValueTests (The complementary j8unit test interface containing the instance
...
public abstract interface StreamableValueClassTests<SUT extends org.omg.CORBA.portable.StreamableValue>
extends StreamableClassTests<SUT>, ValueBaseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.StreamableValue.class!",
                   org.omg.CORBA.portable.StreamableValue.class.isAssignableFrom(sut));
    }

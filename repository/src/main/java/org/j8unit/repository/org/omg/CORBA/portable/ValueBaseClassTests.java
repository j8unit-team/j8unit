 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ValueBase public
 * abstract interface org.omg.CORBA.portable.ValueBase}.
 *
...
public abstract interface ValueBaseClassTests<SUT extends ValueBase>
extends IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ValueBase.class!",
                   ValueBase.class.isAssignableFrom(sut));
    }

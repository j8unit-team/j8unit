 ...
 * org.omg.CORBA.portable.ValueBase}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueBaseTests}).
 * </p>
 *
 * <p>
 ...
 * @see ValueBaseTests ValueBaseTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ValueBaseClassTests<SUT extends org.omg.CORBA.portable.ValueBase>
extends IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.ValueBase.class!",
                   org.omg.CORBA.portable.ValueBase.class.isAssignableFrom(sut));
    }

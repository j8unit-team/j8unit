 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServantNotActive
 * public final class org.omg.PortableServer.POAPackage.ServantNotActive}.
 *
...
public abstract interface ServantNotActiveClassTests<SUT extends ServantNotActive>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantNotActive.class!",
                   ServantNotActive.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.PortableServer.POAPackage.ServantNotActive]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.PortableServer.POAPackage.ServantNotActive]

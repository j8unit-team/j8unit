 ...
 * org.omg.PortableServer.POAPackage.ServantNotActive}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServantNotActiveTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServantNotActiveTests}.
 * </p>
 *
 ...
 * @see ServantNotActiveTests ServantNotActiveTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.ServantNotActive.class!",
                   org.omg.PortableServer.POAPackage.ServantNotActive.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link org.w3c.dom.ls.LSParser interface org.w3c.dom.ls.LSParser}, containing all instance relevant
...
extends J8UnitTest<SUT> {
    ...
    @Test
    @Category(Draft.class)
    public default void test_getBusy()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;
    ...
    /**
     * <p>
     * Test method for {@link org.w3c.dom.ls.LSParser#parseURI(java.lang.String) public abstract org.w3c.dom.Document
    ...
    @Test
    @Category(Draft.class)
    public default void test_setFilter_LSParserFilter()
    throws Exception {
        // query fresh subject-under-test
        final SUT sut = this.createNewSUT();
        assert sut != null;

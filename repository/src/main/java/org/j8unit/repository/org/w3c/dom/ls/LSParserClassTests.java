...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.ls.LSParser interface org.w3c.dom.ls.LSParser}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSParserTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LSParserTests}.
 * </p>
 *
 * @see org.w3c.dom.ls.LSParser interface org.w3c.dom.ls.LSParser (the hereby targeted class-under-test class)
 * @see LSParserTests LSParserTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LSParserClassTests<SUT extends org.w3c.dom.ls.LSParser>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSParser.class!",
                   org.w3c.dom.ls.LSParser.class.isAssignableFrom(sut));
    }

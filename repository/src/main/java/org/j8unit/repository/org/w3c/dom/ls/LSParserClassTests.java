 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSParser public
...
public abstract interface LSParserClassTests<SUT extends LSParser>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSParser.class!",
                   LSParser.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NO_RESOURCESTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NO_RESOURCESTests}.
 * </p>
 *
 * @see org.omg.CORBA.NO_RESOURCES class org.omg.CORBA.NO_RESOURCES (the hereby targeted class-under-test class)
 * @see NO_RESOURCESTests NO_RESOURCESTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NO_RESOURCESClassTests<SUT extends org.omg.CORBA.NO_RESOURCES>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.NO_RESOURCES.class!",
                   org.omg.CORBA.NO_RESOURCES.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NO_RESOURCES public
 * final class org.omg.CORBA.NO_RESOURCES}.
 *
...
public abstract interface NO_RESOURCESClassTests<SUT extends NO_RESOURCES>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NO_RESOURCES.class!",
                   NO_RESOURCES.class.isAssignableFrom(sut));
    }

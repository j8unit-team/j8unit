 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Context public
...
public abstract interface ContextClassTests<SUT extends Context>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.Context]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Context.class!",
                   Context.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.Context]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.Context]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLElement public
 * abstract interface org.w3c.dom.html.HTMLElement}.
 *
...
public abstract interface HTMLElementClassTests<SUT extends HTMLElement>
extends ElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLElement.class!",
                   HTMLElement.class.isAssignableFrom(sut));
    }

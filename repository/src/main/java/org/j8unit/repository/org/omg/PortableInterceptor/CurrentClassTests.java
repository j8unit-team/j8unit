 ...
 * org.omg.PortableInterceptor.Current}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.Current.class!",
                   org.omg.PortableInterceptor.Current.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Current public
...
extends org.j8unit.repository.org.omg.PortableInterceptor.CurrentOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.CurrentClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Current.class!",
                   Current.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DOMImplementationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DOMImplementationTests}.
 * </p>
 *
 * @see org.w3c.dom.DOMImplementation interface org.w3c.dom.DOMImplementation (the hereby targeted class-under-test
 *      class)
 * @see DOMImplementationTests DOMImplementationTests (The complementary j8unit test interface containing the instance
...
public abstract interface DOMImplementationClassTests<SUT extends org.w3c.dom.DOMImplementation>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.DOMImplementation.class!",
                   org.w3c.dom.DOMImplementation.class.isAssignableFrom(sut));
    }

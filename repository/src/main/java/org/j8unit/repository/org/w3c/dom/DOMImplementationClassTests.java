 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMImplementation
 * public abstract interface org.w3c.dom.DOMImplementation}.
 *
...
public abstract interface DOMImplementationClassTests<SUT extends DOMImplementation>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMImplementation.class!",
                   DOMImplementation.class.isAssignableFrom(sut));
    }

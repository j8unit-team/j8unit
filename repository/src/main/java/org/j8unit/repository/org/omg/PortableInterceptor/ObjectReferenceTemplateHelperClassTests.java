...
public abstract interface ObjectReferenceTemplateHelperClassTests<SUT extends ObjectReferenceTemplateHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectReferenceTemplateHelper.class!",
                   ObjectReferenceTemplateHelper.class.isAssignableFrom(sut));
    }

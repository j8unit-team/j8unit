 ...
 * {@link FormatMismatchHelper public abstract class org.omg.IOP.CodecPackage.FormatMismatchHelper}.
 *
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FormatMismatchHelper.class!",
                   FormatMismatchHelper.class.isAssignableFrom(sut));
    }

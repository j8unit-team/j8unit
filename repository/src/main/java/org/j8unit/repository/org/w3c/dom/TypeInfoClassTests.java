 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TypeInfoTests}.
 * </p>
 *
 * @see org.w3c.dom.TypeInfo interface org.w3c.dom.TypeInfo (the hereby targeted class-under-test class)
 * @see TypeInfoTests TypeInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TypeInfoClassTests<SUT extends org.w3c.dom.TypeInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.TypeInfo.class!",
                   org.w3c.dom.TypeInfo.class.isAssignableFrom(sut));
    }

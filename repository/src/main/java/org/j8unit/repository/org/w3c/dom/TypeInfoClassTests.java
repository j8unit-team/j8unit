 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeInfo public
 * abstract interface org.w3c.dom.TypeInfo}.
 *
...
public abstract interface TypeInfoClassTests<SUT extends TypeInfo>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeInfo.class!",
                   TypeInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSPrimitiveValue
 * public abstract interface org.w3c.dom.css.CSSPrimitiveValue}.
 *
...
extends CSSValueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSPrimitiveValue.class!",
                   CSSPrimitiveValue.class.isAssignableFrom(sut));
    }

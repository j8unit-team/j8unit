 ...
 * org.omg.DynamicAny.DynValueBoxOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynValueBoxOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * {@link DynValueBoxOperationsTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynValueBoxOperations interface org.omg.DynamicAny.DynValueBoxOperations (the hereby targeted
 *      class-under-test class)
 * @see DynValueBoxOperationsTests DynValueBoxOperationsTests (The complementary j8unit test interface containing the
...
public abstract interface DynValueBoxOperationsClassTests<SUT extends org.omg.DynamicAny.DynValueBoxOperations>
extends DynValueCommonOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynValueBoxOperations.class!",
                   org.omg.DynamicAny.DynValueBoxOperations.class.isAssignableFrom(sut));
    }

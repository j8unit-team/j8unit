...
public abstract interface DynValueBoxOperationsClassTests<SUT extends DynValueBoxOperations>
extends DynValueCommonOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynValueBoxOperations.class!",
                   DynValueBoxOperations.class.isAssignableFrom(sut));
    }

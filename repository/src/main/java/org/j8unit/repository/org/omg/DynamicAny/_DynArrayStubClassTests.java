 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _DynArrayStub
...
public abstract interface _DynArrayStubClassTests<SUT extends _DynArrayStub>
extends DynArrayClassTests<SUT>, ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _DynArrayStub.class!",

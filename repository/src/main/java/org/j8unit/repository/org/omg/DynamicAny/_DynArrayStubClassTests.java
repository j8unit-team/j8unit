 ...
 * org.omg.DynamicAny._DynArrayStub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _DynArrayStubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link _DynArrayStubTests}.
 * </p>
 *
 * @see org.omg.DynamicAny._DynArrayStub class org.omg.DynamicAny._DynArrayStub (the hereby targeted class-under-test
 *      class)
 * @see _DynArrayStubTests _DynArrayStubTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends DynArrayClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny._DynArrayStub.class!",
                   org.omg.DynamicAny._DynArrayStub.class.isAssignableFrom(sut));
    }

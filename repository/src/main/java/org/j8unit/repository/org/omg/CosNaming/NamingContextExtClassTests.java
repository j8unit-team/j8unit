 ...
 * org.omg.CosNaming.NamingContextExt}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingContextExtTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingContextExtTests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextExt interface org.omg.CosNaming.NamingContextExt (the hereby targeted
 *      class-under-test class)
 * @see NamingContextExtTests NamingContextExtTests (The complementary j8unit test interface containing the instance
...
extends NamingContextExtOperationsClassTests<SUT>, NamingContextClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextExt.class!",
                   org.omg.CosNaming.NamingContextExt.class.isAssignableFrom(sut));
    }

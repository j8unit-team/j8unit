 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingContextExt
 * public abstract interface org.omg.CosNaming.NamingContextExt}.
 *
...
public abstract interface NamingContextExtClassTests<SUT extends NamingContextExt>
extends NamingContextExtOperationsClassTests<SUT>, NamingContextClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContextExt.class!",
                   NamingContextExt.class.isAssignableFrom(sut));
    }

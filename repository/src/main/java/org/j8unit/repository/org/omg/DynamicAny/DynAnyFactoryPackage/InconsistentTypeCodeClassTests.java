 ...
 * org.omg.DynamicAny.DynAnyFactoryPackage.InconsistentTypeCode}, containing all type relevant aspects (e.&thinsp;g.,
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynAnyFactoryPackage.InconsistentTypeCode.class!",
                   org.omg.DynamicAny.DynAnyFactoryPackage.InconsistentTypeCode.class.isAssignableFrom(sut));
    }

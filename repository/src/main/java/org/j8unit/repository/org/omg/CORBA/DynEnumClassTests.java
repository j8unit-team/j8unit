...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.DynEnum interface org.omg.CORBA.DynEnum}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynEnumTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynEnumTests}.
 * </p>
 *
 * @see org.omg.CORBA.DynEnum interface org.omg.CORBA.DynEnum (the hereby targeted class-under-test class)
 * @see DynEnumTests DynEnumTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynEnumClassTests<SUT extends org.omg.CORBA.DynEnum>
extends ObjectClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynEnum.class!",
                   org.omg.CORBA.DynEnum.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynEnum public
 * abstract interface org.omg.CORBA.DynEnum}.
 *
...
public abstract interface DynEnumClassTests<SUT extends DynEnum>
extends DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynEnum.class!",

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingContext
...
public abstract interface NamingContextClassTests<SUT extends NamingContext>
extends NamingContextOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContext.class!",
                   NamingContext.class.isAssignableFrom(sut));
    }

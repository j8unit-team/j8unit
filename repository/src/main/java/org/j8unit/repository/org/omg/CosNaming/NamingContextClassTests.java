 ...
 * org.omg.CosNaming.NamingContext}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingContextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingContextTests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContext interface org.omg.CosNaming.NamingContext (the hereby targeted class-under-test
 *      class)
 * @see NamingContextTests NamingContextTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NamingContextClassTests<SUT extends org.omg.CosNaming.NamingContext>
extends NamingContextOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContext.class!",
                   org.omg.CosNaming.NamingContext.class.isAssignableFrom(sut));
    }

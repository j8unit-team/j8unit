 ...
 * org.omg.CORBA.portable.Streamable}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StreamableTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link StreamableTests}.
 * </p>
 *
 * @see org.omg.CORBA.portable.Streamable interface org.omg.CORBA.portable.Streamable (the hereby targeted
 *      class-under-test class)
 * @see StreamableTests StreamableTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface StreamableClassTests<SUT extends org.omg.CORBA.portable.Streamable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.Streamable.class!",
                   org.omg.CORBA.portable.Streamable.class.isAssignableFrom(sut));
    }

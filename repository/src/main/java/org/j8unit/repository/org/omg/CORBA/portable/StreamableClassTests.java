 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Streamable public
 * abstract interface org.omg.CORBA.portable.Streamable}.
 *
...
public abstract interface StreamableClassTests<SUT extends Streamable>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Streamable.class!",
                   Streamable.class.isAssignableFrom(sut));
    }

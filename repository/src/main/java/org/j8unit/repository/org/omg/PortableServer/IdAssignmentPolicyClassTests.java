 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IdAssignmentPolicy
 * public abstract interface org.omg.PortableServer.IdAssignmentPolicy}.
 *
...
extends IdAssignmentPolicyOperationsClassTests<SUT>, PolicyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdAssignmentPolicy.class!",
                   IdAssignmentPolicy.class.isAssignableFrom(sut));
    }

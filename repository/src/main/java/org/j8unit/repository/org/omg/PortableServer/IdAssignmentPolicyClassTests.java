 ...
 * org.omg.PortableServer.IdAssignmentPolicy}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IdAssignmentPolicyTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableServer.IdAssignmentPolicy interface org.omg.PortableServer.IdAssignmentPolicy (the hereby
 *      targeted class-under-test class)
 * @see IdAssignmentPolicyTests IdAssignmentPolicyTests (The complementary j8unit test interface containing the instance
...
public abstract interface IdAssignmentPolicyClassTests<SUT extends org.omg.PortableServer.IdAssignmentPolicy>
extends IdAssignmentPolicyOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.IdAssignmentPolicy.class!",
                   org.omg.PortableServer.IdAssignmentPolicy.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CosNaming.NamingContextPackage.NotEmpty}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotEmptyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotEmptyTests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextPackage.NotEmpty class org.omg.CosNaming.NamingContextPackage.NotEmpty (the
 *      hereby targeted class-under-test class)
 * @see NotEmptyTests NotEmptyTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPackage.NotEmpty.class!",
                   org.omg.CosNaming.NamingContextPackage.NotEmpty.class.isAssignableFrom(sut));
    }

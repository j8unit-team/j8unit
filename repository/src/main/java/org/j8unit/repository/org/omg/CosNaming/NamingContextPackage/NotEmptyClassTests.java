 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotEmpty public
 * final class org.omg.CosNaming.NamingContextPackage.NotEmpty}.
 *
...
public abstract interface NotEmptyClassTests<SUT extends NotEmpty>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotEmpty.class!",
                   NotEmpty.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StructMemberHelper
 * public abstract class org.omg.CORBA.StructMemberHelper}.
 *
...
public abstract interface StructMemberHelperClassTests<SUT extends StructMemberHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StructMemberHelper.class!",
                   StructMemberHelper.class.isAssignableFrom(sut));
    }

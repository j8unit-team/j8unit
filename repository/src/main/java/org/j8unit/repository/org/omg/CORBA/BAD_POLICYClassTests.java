 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_POLICY public
 * abstract interface org.omg.CORBA.BAD_POLICY}.
 *
...
public abstract interface BAD_POLICYClassTests<SUT extends BAD_POLICY>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_POLICY.class!",
                   BAD_POLICY.class.isAssignableFrom(sut));
    }

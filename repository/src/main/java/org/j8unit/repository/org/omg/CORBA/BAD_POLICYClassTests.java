...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.BAD_POLICY interface org.omg.CORBA.BAD_POLICY},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_POLICYTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.BAD_POLICY interface org.omg.CORBA.BAD_POLICY (the hereby targeted class-under-test class)
 * @see BAD_POLICYTests BAD_POLICYTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface BAD_POLICYClassTests<SUT extends org.omg.CORBA.BAD_POLICY>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_POLICY.class!",
                   org.omg.CORBA.BAD_POLICY.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.Attr interface org.w3c.dom.Attr}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AttrTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AttrTests}.
 * </p>
 *
 * @see org.w3c.dom.Attr interface org.w3c.dom.Attr (the hereby targeted class-under-test class)
 * @see AttrTests AttrTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface AttrClassTests<SUT extends org.w3c.dom.Attr>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.Attr.class!",
                   org.w3c.dom.Attr.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Attr public
 * abstract interface org.w3c.dom.Attr}.
 *
...
public abstract interface AttrClassTests<SUT extends Attr>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Attr.class!", Attr.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.Node interface org.w3c.dom.Node}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NodeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NodeTests}.
 * </p>
 *
 * @see org.w3c.dom.Node interface org.w3c.dom.Node (the hereby targeted class-under-test class)
 * @see NodeTests NodeTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface NodeClassTests<SUT extends org.w3c.dom.Node>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.Node.class!",
                   org.w3c.dom.Node.class.isAssignableFrom(sut));
    }

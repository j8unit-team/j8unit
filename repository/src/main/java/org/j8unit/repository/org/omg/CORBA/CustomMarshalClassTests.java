 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CustomMarshal
...
public abstract interface CustomMarshalClassTests<SUT extends CustomMarshal>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CustomMarshal.class!",
                   CustomMarshal.class.isAssignableFrom(sut));
    }

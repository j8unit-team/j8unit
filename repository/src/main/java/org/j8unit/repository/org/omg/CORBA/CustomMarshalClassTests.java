 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CustomMarshalTests}).
 * </p>
 *
 * <p>
 ...
 * @see CustomMarshalTests CustomMarshalTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CustomMarshalClassTests<SUT extends org.omg.CORBA.CustomMarshal>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.CustomMarshal.class!",
                   org.omg.CORBA.CustomMarshal.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TRANSIENT public
 * final class org.omg.CORBA.TRANSIENT}.
 *
...
public abstract interface TRANSIENTClassTests<SUT extends TRANSIENT>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TRANSIENT.class!",
                   TRANSIENT.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.TRANSIENT]

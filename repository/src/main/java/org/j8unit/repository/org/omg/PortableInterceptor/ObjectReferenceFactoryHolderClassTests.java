...
public abstract interface ObjectReferenceFactoryHolderClassTests<SUT extends ObjectReferenceFactoryHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectReferenceFactoryHolder.class!",
                   ObjectReferenceFactoryHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLTitleElement
 * public abstract interface org.w3c.dom.html.HTMLTitleElement}.
 *
...
public abstract interface HTMLTitleElementClassTests<SUT extends HTMLTitleElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLTitleElement.class!",
                   HTMLTitleElement.class.isAssignableFrom(sut));
    }

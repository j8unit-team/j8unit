 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidNameHelper
 * public abstract class org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidNameHelper}.
 *
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidNameHelper.class!",
                   InvalidNameHelper.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CORBA.TypeCodePackage.BadKind}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BadKindTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.TypeCodePackage.BadKind class org.omg.CORBA.TypeCodePackage.BadKind (the hereby targeted
 *      class-under-test class)
 * @see BadKindTests BadKindTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.TypeCodePackage.BadKind.class!",
                   org.omg.CORBA.TypeCodePackage.BadKind.class.isAssignableFrom(sut));
    }

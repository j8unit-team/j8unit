 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BadKind public
...
public abstract interface BadKindClassTests<SUT extends BadKind>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BadKind.class!",
                   BadKind.class.isAssignableFrom(sut));
    }

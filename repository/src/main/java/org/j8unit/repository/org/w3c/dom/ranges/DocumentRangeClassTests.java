 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentRange
 * public abstract interface org.w3c.dom.ranges.DocumentRange}.
 *
...
public abstract interface DocumentRangeClassTests<SUT extends DocumentRange>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentRange.class!",
                   DocumentRange.class.isAssignableFrom(sut));
    }

...
public abstract interface RMICustomMaxStreamFormatClassTests<SUT extends RMICustomMaxStreamFormat>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RMICustomMaxStreamFormat.class!",
                   RMICustomMaxStreamFormat.class.isAssignableFrom(sut));
    }

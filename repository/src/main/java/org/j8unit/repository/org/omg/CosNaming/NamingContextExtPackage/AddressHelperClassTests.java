 ...
 * org.omg.CosNaming.NamingContextExtPackage.AddressHelper}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AddressHelperTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextExtPackage.AddressHelper class
 *      org.omg.CosNaming.NamingContextExtPackage.AddressHelper (the hereby targeted class-under-test class)
 * @see AddressHelperTests AddressHelperTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextExtPackage.AddressHelper.class!",
                   org.omg.CosNaming.NamingContextExtPackage.AddressHelper.class.isAssignableFrom(sut));
    }

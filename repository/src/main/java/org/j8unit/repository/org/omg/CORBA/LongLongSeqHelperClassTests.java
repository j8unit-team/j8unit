 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongLongSeqHelper
 * public abstract class org.omg.CORBA.LongLongSeqHelper}.
 *
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongLongSeqHelper.class!",
                   LongLongSeqHelper.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CORBA.DynamicImplementation}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynamicImplementationTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.DynamicImplementation class org.omg.CORBA.DynamicImplementation (the hereby targeted
 *      class-under-test class)
 * @see DynamicImplementationTests DynamicImplementationTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynamicImplementation.class!",
                   org.omg.CORBA.DynamicImplementation.class.isAssignableFrom(sut));
    }

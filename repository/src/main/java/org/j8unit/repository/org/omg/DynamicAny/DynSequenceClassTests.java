 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynSequence public
 * abstract interface org.omg.DynamicAny.DynSequence}.
 *
...
extends DynSequenceOperationsClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynSequence.class!",
                   DynSequence.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.DynamicAny.DynSequence}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynSequenceTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynSequenceTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynSequence interface org.omg.DynamicAny.DynSequence (the hereby targeted class-under-test
 *      class)
 * @see DynSequenceTests DynSequenceTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynSequenceClassTests<SUT extends org.omg.DynamicAny.DynSequence>
extends DynSequenceOperationsClassTests<SUT>, DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynSequence.class!",
                   org.omg.DynamicAny.DynSequence.class.isAssignableFrom(sut));
    }

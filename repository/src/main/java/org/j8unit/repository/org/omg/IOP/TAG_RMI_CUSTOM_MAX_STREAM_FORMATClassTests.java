 ...
 * {@link TAG_RMI_CUSTOM_MAX_STREAM_FORMAT public abstract interface org.omg.IOP.TAG_RMI_CUSTOM_MAX_STREAM_FORMAT}.
 *
...
public abstract interface TAG_RMI_CUSTOM_MAX_STREAM_FORMATClassTests<SUT extends TAG_RMI_CUSTOM_MAX_STREAM_FORMAT>
extends RepositoryClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.IOP.TAG_RMI_CUSTOM_MAX_STREAM_FORMAT]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TAG_RMI_CUSTOM_MAX_STREAM_FORMAT.class!",
                   TAG_RMI_CUSTOM_MAX_STREAM_FORMAT.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotFoundHelper
 * public abstract class org.omg.CosNaming.NamingContextPackage.NotFoundHelper}.
 *
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotFoundHelper.class!",
                   NotFoundHelper.class.isAssignableFrom(sut));
    }

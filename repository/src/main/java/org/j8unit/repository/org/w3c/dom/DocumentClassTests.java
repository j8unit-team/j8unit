...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.Document interface org.w3c.dom.Document}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentTests}).
 * </p>
 *
 * <p>
 ...
 * @see DocumentTests DocumentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DocumentClassTests<SUT extends org.w3c.dom.Document>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.Document.class!",
                   org.w3c.dom.Document.class.isAssignableFrom(sut));
    }

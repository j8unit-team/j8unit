 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Document public
...
public abstract interface DocumentClassTests<SUT extends Document>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Document.class!",
                   Document.class.isAssignableFrom(sut));
    }

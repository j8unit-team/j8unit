 ...
 * {@link IdAssignmentPolicyValue public class org.omg.PortableServer.IdAssignmentPolicyValue}.
 *
...
public abstract interface IdAssignmentPolicyValueClassTests<SUT extends IdAssignmentPolicyValue>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdAssignmentPolicyValue.class!",
                   IdAssignmentPolicyValue.class.isAssignableFrom(sut));
    }

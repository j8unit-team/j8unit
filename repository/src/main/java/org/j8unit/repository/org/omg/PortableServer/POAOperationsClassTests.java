 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link POAOperations
...
public abstract interface POAOperationsClassTests<SUT extends POAOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to POAOperations.class!",
                   POAOperations.class.isAssignableFrom(sut));
    }

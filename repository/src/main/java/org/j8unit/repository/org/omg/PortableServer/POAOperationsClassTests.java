 ...
 * org.omg.PortableServer.POAOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link POAOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link POAOperationsTests}.
 * </p>
 *
 * @see org.omg.PortableServer.POAOperations interface org.omg.PortableServer.POAOperations (the hereby targeted
 *      class-under-test class)
 * @see POAOperationsTests POAOperationsTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface POAOperationsClassTests<SUT extends org.omg.PortableServer.POAOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAOperations.class!",
                   org.omg.PortableServer.POAOperations.class.isAssignableFrom(sut));
    }

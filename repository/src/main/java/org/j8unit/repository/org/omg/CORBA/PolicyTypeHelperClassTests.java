 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyTypeHelper
 * public abstract class org.omg.CORBA.PolicyTypeHelper}.
 *
...
public abstract interface PolicyTypeHelperClassTests<SUT extends PolicyTypeHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.PolicyTypeHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyTypeHelper.class!",
                   PolicyTypeHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.PolicyTypeHelper]

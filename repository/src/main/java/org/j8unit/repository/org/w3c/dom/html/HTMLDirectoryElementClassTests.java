...
public abstract interface HTMLDirectoryElementClassTests<SUT extends HTMLDirectoryElement>
extends org.j8unit.repository.org.w3c.dom.html.HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLDirectoryElement.class!",
                   HTMLDirectoryElement.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSImportRule
 * public abstract interface org.w3c.dom.css.CSSImportRule}.
 *
...
public abstract interface CSSImportRuleClassTests<SUT extends CSSImportRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSImportRule.class!",
                   CSSImportRule.class.isAssignableFrom(sut));
    }

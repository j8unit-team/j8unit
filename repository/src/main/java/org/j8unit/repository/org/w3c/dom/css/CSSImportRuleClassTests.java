 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSImportRuleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CSSImportRuleTests}.
 * </p>
 *
 * @see org.w3c.dom.css.CSSImportRule interface org.w3c.dom.css.CSSImportRule (the hereby targeted class-under-test
 *      class)
 * @see CSSImportRuleTests CSSImportRuleTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CSSImportRuleClassTests<SUT extends org.w3c.dom.css.CSSImportRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSImportRule.class!",
                   org.w3c.dom.css.CSSImportRule.class.isAssignableFrom(sut));
    }

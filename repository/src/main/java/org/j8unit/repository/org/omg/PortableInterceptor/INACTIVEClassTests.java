...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.INACTIVE interface
 * org.omg.PortableInterceptor.INACTIVE}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INACTIVETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link INACTIVETests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.INACTIVE interface org.omg.PortableInterceptor.INACTIVE (the hereby targeted
 *      class-under-test class)
 * @see INACTIVETests INACTIVETests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface INACTIVEClassTests<SUT extends org.omg.PortableInterceptor.INACTIVE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.INACTIVE.class!",
                   org.omg.PortableInterceptor.INACTIVE.class.isAssignableFrom(sut));
    }

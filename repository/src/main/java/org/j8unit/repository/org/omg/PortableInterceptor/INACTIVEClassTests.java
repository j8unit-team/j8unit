 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INACTIVE public
...
public abstract interface INACTIVEClassTests<SUT extends INACTIVE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INACTIVE.class!",
                   INACTIVE.class.isAssignableFrom(sut));
    }

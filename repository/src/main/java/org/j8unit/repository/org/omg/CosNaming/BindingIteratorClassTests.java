 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindingIterator
 * public abstract interface org.omg.CosNaming.BindingIterator}.
 *
...
public abstract interface BindingIteratorClassTests<SUT extends BindingIterator>
...
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingIterator.class!",
                   BindingIterator.class.isAssignableFrom(sut));
    }

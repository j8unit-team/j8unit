 ...
 * org.omg.CosNaming.BindingIterator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingIteratorTests}).
 * </p>
 *
 * <p>
 ...
 * @see BindingIteratorTests BindingIteratorTests (The complementary j8unit test interface containing the instance
...
public abstract interface BindingIteratorClassTests<SUT extends org.omg.CosNaming.BindingIterator>
extends BindingIteratorOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.BindingIterator.class!",
                   org.omg.CosNaming.BindingIterator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLLegendElement
 * public abstract interface org.w3c.dom.html.HTMLLegendElement}.
 *
...
public abstract interface HTMLLegendElementClassTests<SUT extends HTMLLegendElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLLegendElement.class!",
                   HTMLLegendElement.class.isAssignableFrom(sut));
    }

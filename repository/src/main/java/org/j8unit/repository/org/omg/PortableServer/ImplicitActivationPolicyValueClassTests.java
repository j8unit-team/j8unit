 ...
 * {@link ImplicitActivationPolicyValue public class org.omg.PortableServer.ImplicitActivationPolicyValue}.
 *
...
public abstract interface ImplicitActivationPolicyValueClassTests<SUT extends ImplicitActivationPolicyValue>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ImplicitActivationPolicyValue.class!",
                   ImplicitActivationPolicyValue.class.isAssignableFrom(sut));
    }

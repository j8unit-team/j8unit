 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServantLocator
 * public abstract interface org.omg.PortableServer.ServantLocator}.
 *
...
public abstract interface ServantLocatorClassTests<SUT extends ServantLocator>
extends ServantLocatorOperationsClassTests<SUT>, ServantManagerClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantLocator.class!",
                   ServantLocator.class.isAssignableFrom(sut));
    }

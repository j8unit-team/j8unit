 ...
 * org.omg.PortableServer.ServantLocator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServantLocatorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServantLocatorTests}.
 * </p>
 *
 * @see org.omg.PortableServer.ServantLocator interface org.omg.PortableServer.ServantLocator (the hereby targeted
 *      class-under-test class)
 * @see ServantLocatorTests ServantLocatorTests (The complementary j8unit test interface containing the instance
...
public abstract interface ServantLocatorClassTests<SUT extends org.omg.PortableServer.ServantLocator>
extends ServantLocatorOperationsClassTests<SUT>, ServantManagerClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ServantLocator.class!",
                   org.omg.PortableServer.ServantLocator.class.isAssignableFrom(sut));
    }

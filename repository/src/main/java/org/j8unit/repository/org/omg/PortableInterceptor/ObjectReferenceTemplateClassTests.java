 ...
 * org.omg.PortableInterceptor.ObjectReferenceTemplate}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectReferenceTemplateTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see ObjectReferenceTemplateTests ObjectReferenceTemplateTests (The complementary j8unit test interface containing
...
extends ObjectReferenceFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ObjectReferenceTemplate.class!",
                   org.omg.PortableInterceptor.ObjectReferenceTemplate.class.isAssignableFrom(sut));
    }

 ...
 * {@link ObjectReferenceTemplate public abstract interface org.omg.PortableInterceptor.ObjectReferenceTemplate}.
 *
...
extends ObjectReferenceFactoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectReferenceTemplate.class!",
                   ObjectReferenceTemplate.class.isAssignableFrom(sut));
    }

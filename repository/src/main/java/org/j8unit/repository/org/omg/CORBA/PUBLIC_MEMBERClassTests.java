...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.PUBLIC_MEMBER interface org.omg.CORBA.PUBLIC_MEMBER},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PUBLIC_MEMBERTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PUBLIC_MEMBERTests}.
 * </p>
 *
 * @see org.omg.CORBA.PUBLIC_MEMBER interface org.omg.CORBA.PUBLIC_MEMBER (the hereby targeted class-under-test class)
 * @see PUBLIC_MEMBERTests PUBLIC_MEMBERTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PUBLIC_MEMBERClassTests<SUT extends org.omg.CORBA.PUBLIC_MEMBER>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.PUBLIC_MEMBER.class!",
                   org.omg.CORBA.PUBLIC_MEMBER.class.isAssignableFrom(sut));
    }

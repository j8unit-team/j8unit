 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PUBLIC_MEMBER
...
public abstract interface PUBLIC_MEMBERClassTests<SUT extends PUBLIC_MEMBER>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PUBLIC_MEMBER.class!",
                   PUBLIC_MEMBER.class.isAssignableFrom(sut));
    }

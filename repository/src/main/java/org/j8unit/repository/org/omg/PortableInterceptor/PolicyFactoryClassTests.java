 ...
 * org.omg.PortableInterceptor.PolicyFactory}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * @see PolicyFactoryTests PolicyFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface PolicyFactoryClassTests<SUT extends org.omg.PortableInterceptor.PolicyFactory>
extends PolicyFactoryOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.PolicyFactory.class!",
                   org.omg.PortableInterceptor.PolicyFactory.class.isAssignableFrom(sut));
    }

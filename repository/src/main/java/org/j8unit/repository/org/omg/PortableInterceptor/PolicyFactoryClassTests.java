 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyFactory
...
public abstract interface PolicyFactoryClassTests<SUT extends PolicyFactory>
...
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyFactory.class!",
                   PolicyFactory.class.isAssignableFrom(sut));
    }

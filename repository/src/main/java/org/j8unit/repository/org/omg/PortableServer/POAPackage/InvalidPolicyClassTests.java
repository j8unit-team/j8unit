...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    public default void create_InvalidPolicy()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.PortableServer.POAPackage.InvalidPolicy sut = null; // = new InvalidPolicy();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_InvalidPolicy_short()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.PortableServer.POAPackage.InvalidPolicy sut = null; // = new InvalidPolicy(short);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_InvalidPolicy_String_short()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")

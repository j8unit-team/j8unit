 ...
 * org.omg.PortableServer.POAPackage.InvalidPolicy}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidPolicyTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableServer.POAPackage.InvalidPolicy class org.omg.PortableServer.POAPackage.InvalidPolicy (the
 *      hereby targeted class-under-test class)
 * @see InvalidPolicyTests InvalidPolicyTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface InvalidPolicyClassTests<SUT extends org.omg.PortableServer.POAPackage.InvalidPolicy>
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.InvalidPolicy.class!",
                   org.omg.PortableServer.POAPackage.InvalidPolicy.class.isAssignableFrom(sut));
    }

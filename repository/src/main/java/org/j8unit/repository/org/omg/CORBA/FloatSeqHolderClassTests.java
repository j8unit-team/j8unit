 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link FloatSeqHolder
...
public abstract interface FloatSeqHolderClassTests<SUT extends FloatSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to FloatSeqHolder.class!",
                   FloatSeqHolder.class.isAssignableFrom(sut));
    }

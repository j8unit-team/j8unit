 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynAnySeqHelper
 * public abstract class org.omg.DynamicAny.DynAnySeqHelper}.
 *
...
public abstract interface DynAnySeqHelperClassTests<SUT extends DynAnySeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynAnySeqHelper.class!",
                   DynAnySeqHelper.class.isAssignableFrom(sut));
    }

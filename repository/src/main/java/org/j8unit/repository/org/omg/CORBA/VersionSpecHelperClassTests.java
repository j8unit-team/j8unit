 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VersionSpecHelper
 * public abstract class org.omg.CORBA.VersionSpecHelper}.
 *
...
public abstract interface VersionSpecHelperClassTests<SUT extends VersionSpecHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VersionSpecHelper.class!",
                   VersionSpecHelper.class.isAssignableFrom(sut));
    }

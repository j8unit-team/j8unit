 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SystemException
...
public abstract interface SystemExceptionClassTests<SUT extends SystemException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SystemException.class!",
                   SystemException.class.isAssignableFrom(sut));
    }

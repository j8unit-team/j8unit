...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.SystemException class org.omg.CORBA.SystemException},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SystemExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SystemExceptionTests}.
 * </p>
 *
 * @see org.omg.CORBA.SystemException class org.omg.CORBA.SystemException (the hereby targeted class-under-test class)
 * @see SystemExceptionTests SystemExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.SystemException.class!",
                   org.omg.CORBA.SystemException.class.isAssignableFrom(sut));
    }

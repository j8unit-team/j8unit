...
public abstract interface DynSequenceOperationsClassTests<SUT extends DynSequenceOperations>
extends org.j8unit.repository.org.omg.DynamicAny.DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynSequenceOperations.class!",
                   DynSequenceOperations.class.isAssignableFrom(sut));
    }

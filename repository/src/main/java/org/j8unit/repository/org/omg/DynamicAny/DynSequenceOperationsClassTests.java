 ...
 * org.omg.DynamicAny.DynSequenceOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynSequenceOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * @see DynSequenceOperationsTests DynSequenceOperationsTests (The complementary j8unit test interface containing the
...
public abstract interface DynSequenceOperationsClassTests<SUT extends org.omg.DynamicAny.DynSequenceOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynSequenceOperations.class!",
                   org.omg.DynamicAny.DynSequenceOperations.class.isAssignableFrom(sut));
    }

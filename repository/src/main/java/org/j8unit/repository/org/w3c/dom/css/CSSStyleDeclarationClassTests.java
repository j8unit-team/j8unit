 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSStyleDeclaration
 * public abstract interface org.w3c.dom.css.CSSStyleDeclaration}.
 *
...
public abstract interface CSSStyleDeclarationClassTests<SUT extends CSSStyleDeclaration>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSStyleDeclaration.class!",
                   CSSStyleDeclaration.class.isAssignableFrom(sut));
    }

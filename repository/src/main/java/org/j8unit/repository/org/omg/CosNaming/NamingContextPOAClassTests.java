 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingContextPOA
 * public abstract class org.omg.CosNaming.NamingContextPOA}.
 *
...
public abstract interface NamingContextPOAClassTests<SUT extends NamingContextPOA>
extends NamingContextOperationsClassTests<SUT>, InvokeHandlerClassTests<SUT>, ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContextPOA.class!",
                   NamingContextPOA.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CosNaming.NamingContextPOA]

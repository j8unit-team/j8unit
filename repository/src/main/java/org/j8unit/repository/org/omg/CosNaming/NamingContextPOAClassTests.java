 ...
 * org.omg.CosNaming.NamingContextPOA}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingContextPOATests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamingContextPOATests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextPOA class org.omg.CosNaming.NamingContextPOA (the hereby targeted
 *      class-under-test class)
 * @see NamingContextPOATests NamingContextPOATests (The complementary j8unit test interface containing the instance
...
public abstract interface NamingContextPOAClassTests<SUT extends org.omg.CosNaming.NamingContextPOA>
extends NamingContextOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.InvokeHandlerClassTests<SUT>,
org.j8unit.repository.org.omg.PortableServer.ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPOA.class!",
                   org.omg.CosNaming.NamingContextPOA.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TaggedProfileTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TaggedProfileTests}.
 * </p>
 *
 * @see org.omg.IOP.TaggedProfile class org.omg.IOP.TaggedProfile (the hereby targeted class-under-test class)
 * @see TaggedProfileTests TaggedProfileTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TaggedProfile.class!",
                   org.omg.IOP.TaggedProfile.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TaggedProfile
...
public abstract interface TaggedProfileClassTests<SUT extends TaggedProfile>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TaggedProfile.class!",
                   TaggedProfile.class.isAssignableFrom(sut));
    }

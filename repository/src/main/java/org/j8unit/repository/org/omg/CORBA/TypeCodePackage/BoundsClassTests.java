 ...
 * org.omg.CORBA.TypeCodePackage.Bounds}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BoundsTests}).
 * </p>
 *
 * <p>
 ...
 * @see BoundsTests BoundsTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.TypeCodePackage.Bounds.class!",
                   org.omg.CORBA.TypeCodePackage.Bounds.class.isAssignableFrom(sut));
    }

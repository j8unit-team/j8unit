 ...
 * org.omg.PortableServer.POAPackage.WrongAdapter}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WrongAdapterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WrongAdapterTests}.
 * </p>
 *
 * @see org.omg.PortableServer.POAPackage.WrongAdapter class org.omg.PortableServer.POAPackage.WrongAdapter (the hereby
 *      targeted class-under-test class)
 * @see WrongAdapterTests WrongAdapterTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.WrongAdapter.class!",
                   org.omg.PortableServer.POAPackage.WrongAdapter.class.isAssignableFrom(sut));
    }

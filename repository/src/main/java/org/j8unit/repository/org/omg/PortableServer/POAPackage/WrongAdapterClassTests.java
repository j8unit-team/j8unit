 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WrongAdapter public
 * final class org.omg.PortableServer.POAPackage.WrongAdapter}.
 *
...
public abstract interface WrongAdapterClassTests<SUT extends WrongAdapter>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WrongAdapter.class!",
                   WrongAdapter.class.isAssignableFrom(sut));
    }

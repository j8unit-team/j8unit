...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.IMPLICIT_ACTIVATION_POLICY_ID interface
 * org.omg.PortableServer.IMPLICIT_ACTIVATION_POLICY_ID}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * </p>
 *
 * @see org.omg.PortableServer.IMPLICIT_ACTIVATION_POLICY_ID interface
 *      org.omg.PortableServer.IMPLICIT_ACTIVATION_POLICY_ID (the hereby targeted class-under-test class)
 * @see IMPLICIT_ACTIVATION_POLICY_IDTests IMPLICIT_ACTIVATION_POLICY_IDTests (The complementary j8unit test interface
...
public abstract interface IMPLICIT_ACTIVATION_POLICY_IDClassTests<SUT extends org.omg.PortableServer.IMPLICIT_ACTIVATION_POLICY_ID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.IMPLICIT_ACTIVATION_POLICY_ID.class!",
                   org.omg.PortableServer.IMPLICIT_ACTIVATION_POLICY_ID.class.isAssignableFrom(sut));
    }

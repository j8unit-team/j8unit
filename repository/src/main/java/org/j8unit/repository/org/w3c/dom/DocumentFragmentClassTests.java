 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentFragment
 * public abstract interface org.w3c.dom.DocumentFragment}.
 *
...
extends org.j8unit.repository.org.w3c.dom.NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentFragment.class!",
                   DocumentFragment.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentFragmentTests}).
 * </p>
 *
 * <p>
 ...
 * @see DocumentFragmentTests DocumentFragmentTests (The complementary j8unit test interface containing the instance
...
public abstract interface DocumentFragmentClassTests<SUT extends org.w3c.dom.DocumentFragment>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.DocumentFragment.class!",
                   org.w3c.dom.DocumentFragment.class.isAssignableFrom(sut));
    }

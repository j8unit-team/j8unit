...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.ExceptionDetailMessage interface
 * org.omg.IOP.ExceptionDetailMessage}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ExceptionDetailMessageTests}).
 * </p>
 *
 * <p>
 ...
 * @see ExceptionDetailMessageTests ExceptionDetailMessageTests (The complementary j8unit test interface containing the
...
public abstract interface ExceptionDetailMessageClassTests<SUT extends org.omg.IOP.ExceptionDetailMessage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.ExceptionDetailMessage.class!",
                   org.omg.IOP.ExceptionDetailMessage.class.isAssignableFrom(sut));
    }

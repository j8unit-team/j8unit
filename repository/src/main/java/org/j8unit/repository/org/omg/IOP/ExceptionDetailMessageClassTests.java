...
public abstract interface ExceptionDetailMessageClassTests<SUT extends ExceptionDetailMessage>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ExceptionDetailMessage.class!",
                   ExceptionDetailMessage.class.isAssignableFrom(sut));
    }

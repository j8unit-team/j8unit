...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TRANSACTION_REQUIRED.class!",
                   TRANSACTION_REQUIRED.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CORBA.TRANSACTION_REQUIRED}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TRANSACTION_REQUIREDTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TRANSACTION_REQUIREDTests}
 * .
 * </p>
 *
 * @see org.omg.CORBA.TRANSACTION_REQUIRED class org.omg.CORBA.TRANSACTION_REQUIRED (the hereby targeted
 *      class-under-test class)
 * @see TRANSACTION_REQUIREDTests TRANSACTION_REQUIREDTests (The complementary j8unit test interface containing the
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.TRANSACTION_REQUIRED.class!",
                   org.omg.CORBA.TRANSACTION_REQUIRED.class.isAssignableFrom(sut));
    }

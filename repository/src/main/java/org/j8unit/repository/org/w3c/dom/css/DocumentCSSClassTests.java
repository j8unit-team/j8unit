...
import org.j8unit.repository.org.w3c.dom.stylesheets.DocumentStyleClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentCSS public
 * abstract interface org.w3c.dom.css.DocumentCSS}.
 *
...
public abstract interface DocumentCSSClassTests<SUT extends DocumentCSS>
extends DocumentStyleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentCSS.class!",
                   DocumentCSS.class.isAssignableFrom(sut));
    }

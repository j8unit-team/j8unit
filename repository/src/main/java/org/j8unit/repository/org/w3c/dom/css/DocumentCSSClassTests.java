...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.css.DocumentCSS interface org.w3c.dom.css.DocumentCSS},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentCSSTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocumentCSSTests}.
 * </p>
 *
 * @see org.w3c.dom.css.DocumentCSS interface org.w3c.dom.css.DocumentCSS (the hereby targeted class-under-test class)
 * @see DocumentCSSTests DocumentCSSTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.w3c.dom.stylesheets.DocumentStyleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.DocumentCSS.class!",
                   org.w3c.dom.css.DocumentCSS.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamingContextExtPOA
 * public abstract class org.omg.CosNaming.NamingContextExtPOA}.
 *
...
extends NamingContextExtOperationsClassTests<SUT>, InvokeHandlerClassTests<SUT>, ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContextExtPOA.class!",
                   NamingContextExtPOA.class.isAssignableFrom(sut));
    }

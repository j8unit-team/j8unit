 ...
 * org.omg.CosNaming.NamingContextExtPOA}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingContextExtPOATests}).
 * </p>
 *
 * <p>
 ...
 * @see NamingContextExtPOATests NamingContextExtPOATests (The complementary j8unit test interface containing the
...
extends NamingContextExtOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.InvokeHandlerClassTests<SUT>,
org.j8unit.repository.org.omg.PortableServer.ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextExtPOA.class!",
                   org.omg.CosNaming.NamingContextExtPOA.class.isAssignableFrom(sut));
    }

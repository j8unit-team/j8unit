 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLIFrameElement
 * public abstract interface org.w3c.dom.html.HTMLIFrameElement}.
 *
...
public abstract interface HTMLIFrameElementClassTests<SUT extends HTMLIFrameElement>
extends HTMLElementClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.w3c.dom.html.HTMLIFrameElement]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLIFrameElement.class!",
                   HTMLIFrameElement.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.w3c.dom.html.HTMLIFrameElement]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.w3c.dom.html.HTMLIFrameElement]

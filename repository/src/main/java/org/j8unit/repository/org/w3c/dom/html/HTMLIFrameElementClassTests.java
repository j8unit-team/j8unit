...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.html.HTMLIFrameElement interface
 * org.w3c.dom.html.HTMLIFrameElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLIFrameElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTMLIFrameElementTests}.
 * </p>
 *
 * @see org.w3c.dom.html.HTMLIFrameElement interface org.w3c.dom.html.HTMLIFrameElement (the hereby targeted
 *      class-under-test class)
 * @see HTMLIFrameElementTests HTMLIFrameElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface HTMLIFrameElementClassTests<SUT extends org.w3c.dom.html.HTMLIFrameElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLIFrameElement.class!",
                   org.w3c.dom.html.HTMLIFrameElement.class.isAssignableFrom(sut));
    }

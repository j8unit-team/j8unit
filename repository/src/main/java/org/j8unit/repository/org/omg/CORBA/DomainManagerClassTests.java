 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DomainManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DomainManagerTests}.
 * </p>
 *
 * @see org.omg.CORBA.DomainManager interface org.omg.CORBA.DomainManager (the hereby targeted class-under-test class)
 * @see DomainManagerTests DomainManagerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DomainManagerClassTests<SUT extends org.omg.CORBA.DomainManager>
extends DomainManagerOperationsClassTests<SUT>, ObjectClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DomainManager.class!",
                   org.omg.CORBA.DomainManager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DomainManager
...
public abstract interface DomainManagerClassTests<SUT extends DomainManager>
extends DomainManagerOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DomainManager.class!",
                   DomainManager.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.Text interface org.w3c.dom.Text}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TextTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TextTests}.
 * </p>
 *
 * @see org.w3c.dom.Text interface org.w3c.dom.Text (the hereby targeted class-under-test class)
 * @see TextTests TextTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface TextClassTests<SUT extends org.w3c.dom.Text>
extends CharacterDataClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.Text.class!",
                   org.w3c.dom.Text.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.POAManagerPackage.State class
 * org.omg.PortableServer.POAManagerPackage.State}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link StateTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableServer.POAManagerPackage.State class org.omg.PortableServer.POAManagerPackage.State (the hereby
 *      targeted class-under-test class)
 * @see StateTests StateTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface StateClassTests<SUT extends org.omg.PortableServer.POAManagerPackage.State>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAManagerPackage.State.class!",
                   org.omg.PortableServer.POAManagerPackage.State.class.isAssignableFrom(sut));
    }

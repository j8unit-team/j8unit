 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NoContext public
 * final class org.omg.PortableServer.CurrentPackage.NoContext}.
 *
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NoContext.class!",
                   NoContext.class.isAssignableFrom(sut));
    }

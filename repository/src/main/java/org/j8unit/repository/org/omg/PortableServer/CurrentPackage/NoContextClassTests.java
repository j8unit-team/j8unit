 ...
 * org.omg.PortableServer.CurrentPackage.NoContext}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NoContextTests}).
 * </p>
 *
 * <p>
 ...
 * @see NoContextTests NoContextTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.CurrentPackage.NoContext.class!",
                   org.omg.PortableServer.CurrentPackage.NoContext.class.isAssignableFrom(sut));
    }

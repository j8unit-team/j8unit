 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServiceInformation
 * public final class org.omg.CORBA.ServiceInformation}.
 *
...
public abstract interface ServiceInformationClassTests<SUT extends ServiceInformation>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceInformation.class!",
                   ServiceInformation.class.isAssignableFrom(sut));
    }

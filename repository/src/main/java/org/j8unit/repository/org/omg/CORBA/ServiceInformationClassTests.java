...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.ServiceInformation class
 * org.omg.CORBA.ServiceInformation}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServiceInformationTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServiceInformationTests}.
 * </p>
 *
 * @see org.omg.CORBA.ServiceInformation class org.omg.CORBA.ServiceInformation (the hereby targeted class-under-test
 *      class)
 * @see ServiceInformationTests ServiceInformationTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ServiceInformation.class!",
                   org.omg.CORBA.ServiceInformation.class.isAssignableFrom(sut));
    }

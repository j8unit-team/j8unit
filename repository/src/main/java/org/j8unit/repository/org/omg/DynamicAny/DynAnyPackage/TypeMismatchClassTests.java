 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeMismatch public
 * final class org.omg.DynamicAny.DynAnyPackage.TypeMismatch}.
 *
...
public abstract interface TypeMismatchClassTests<SUT extends TypeMismatch>
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeMismatch.class!",
                   TypeMismatch.class.isAssignableFrom(sut));
    }

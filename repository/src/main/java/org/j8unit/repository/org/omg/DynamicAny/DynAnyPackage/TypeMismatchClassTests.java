 ...
 * org.omg.DynamicAny.DynAnyPackage.TypeMismatch}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeMismatchTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.DynamicAny.DynAnyPackage.TypeMismatch class org.omg.DynamicAny.DynAnyPackage.TypeMismatch (the hereby
 *      targeted class-under-test class)
 * @see TypeMismatchTests TypeMismatchTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynAnyPackage.TypeMismatch.class!",
                   org.omg.DynamicAny.DynAnyPackage.TypeMismatch.class.isAssignableFrom(sut));
    }

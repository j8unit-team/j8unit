 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Any public abstract
...
public abstract interface AnyClassTests<SUT extends Any>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Any.class!", Any.class.isAssignableFrom(sut));
    }

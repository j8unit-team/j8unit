...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.Any class org.omg.CORBA.Any}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AnyTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AnyTests}.
 * </p>
 *
 * @see org.omg.CORBA.Any class org.omg.CORBA.Any (the hereby targeted class-under-test class)
 * @see AnyTests AnyTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface AnyClassTests<SUT extends org.omg.CORBA.Any>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.Any.class!",
                   org.omg.CORBA.Any.class.isAssignableFrom(sut));
    }

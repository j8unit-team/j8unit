 ...
 * org.omg.PortableServer.POAPackage.ServantAlreadyActive}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServantAlreadyActiveTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServantAlreadyActiveTests}
 * .
 * </p>
 *
 * @see org.omg.PortableServer.POAPackage.ServantAlreadyActive class
 *      org.omg.PortableServer.POAPackage.ServantAlreadyActive (the hereby targeted class-under-test class)
 * @see ServantAlreadyActiveTests ServantAlreadyActiveTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.ServantAlreadyActive.class!",
                   org.omg.PortableServer.POAPackage.ServantAlreadyActive.class.isAssignableFrom(sut));
    }

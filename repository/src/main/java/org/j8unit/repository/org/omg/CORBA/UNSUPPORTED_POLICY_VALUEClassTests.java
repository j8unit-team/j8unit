 ...
 * {@link UNSUPPORTED_POLICY_VALUE public abstract interface org.omg.CORBA.UNSUPPORTED_POLICY_VALUE}.
 *
...
public abstract interface UNSUPPORTED_POLICY_VALUEClassTests<SUT extends UNSUPPORTED_POLICY_VALUE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UNSUPPORTED_POLICY_VALUE.class!",
                   UNSUPPORTED_POLICY_VALUE.class.isAssignableFrom(sut));
    }

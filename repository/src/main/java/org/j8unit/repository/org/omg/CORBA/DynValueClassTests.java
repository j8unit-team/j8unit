...
public abstract interface DynValueClassTests<SUT extends org.omg.CORBA.DynValue>
extends ObjectClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynValue.class!",
                   org.omg.CORBA.DynValue.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindingListHolder
 * public final class org.omg.CosNaming.BindingListHolder}.
 *
...
public abstract interface BindingListHolderClassTests<SUT extends BindingListHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingListHolder.class!",
                   BindingListHolder.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.CurrentOperations interface
 * org.omg.CORBA.CurrentOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CurrentOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.CurrentOperations interface org.omg.CORBA.CurrentOperations (the hereby targeted class-under-test
 *      class)
 * @see CurrentOperationsTests CurrentOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface CurrentOperationsClassTests<SUT extends org.omg.CORBA.CurrentOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.CurrentOperations.class!",
                   org.omg.CORBA.CurrentOperations.class.isAssignableFrom(sut));
    }

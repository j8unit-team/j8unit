...
public abstract interface ObjectReferenceTemplateHolderClassTests<SUT extends ObjectReferenceTemplateHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectReferenceTemplateHolder.class!",
                   ObjectReferenceTemplateHolder.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.PortableInterceptor.ObjectReferenceTemplateHolder]

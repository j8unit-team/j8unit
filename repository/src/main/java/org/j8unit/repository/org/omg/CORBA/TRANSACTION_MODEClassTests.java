 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TRANSACTION_MODETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TRANSACTION_MODETests}.
 * </p>
 *
 * @see org.omg.CORBA.TRANSACTION_MODE class org.omg.CORBA.TRANSACTION_MODE (the hereby targeted class-under-test class)
 * @see TRANSACTION_MODETests TRANSACTION_MODETests (The complementary j8unit test interface containing the instance
...
public abstract interface TRANSACTION_MODEClassTests<SUT extends org.omg.CORBA.TRANSACTION_MODE>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.TRANSACTION_MODE.class!",
                   org.omg.CORBA.TRANSACTION_MODE.class.isAssignableFrom(sut));
    }

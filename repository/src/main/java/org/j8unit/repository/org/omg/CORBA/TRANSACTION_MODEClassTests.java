 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TRANSACTION_MODE
 * public final class org.omg.CORBA.TRANSACTION_MODE}.
 *
...
public abstract interface TRANSACTION_MODEClassTests<SUT extends TRANSACTION_MODE>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TRANSACTION_MODE.class!",
                   TRANSACTION_MODE.class.isAssignableFrom(sut));
    }

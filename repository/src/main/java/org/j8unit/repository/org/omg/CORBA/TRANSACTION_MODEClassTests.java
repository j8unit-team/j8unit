...
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    public default void create_TRANSACTION_MODE()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.CORBA.TRANSACTION_MODE sut = null; // = new TRANSACTION_MODE();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_TRANSACTION_MODE_int_CompletionStatus()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    @Test
    @Category(Draft.class)
    public default void create_TRANSACTION_MODE_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.CORBA.TRANSACTION_MODE sut = null; // = new TRANSACTION_MODE(java.lang.String);
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_TRANSACTION_MODE_String_int_CompletionStatus()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    throws Exception {
        // create new instance
        final Class<? extends org.omg.CORBA.TRANSACTION_MODE> sut = createNewSUT();

...
public abstract interface ServantActivatorOperationsClassTests<SUT extends ServantActivatorOperations>
extends org.j8unit.repository.org.omg.PortableServer.ServantManagerOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantActivatorOperations.class!",
                   ServantActivatorOperations.class.isAssignableFrom(sut));
    }

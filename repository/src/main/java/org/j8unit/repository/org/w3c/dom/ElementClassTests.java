...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.Element interface org.w3c.dom.Element}, containing all
...
public abstract interface ElementClassTests<SUT extends org.w3c.dom.Element>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.Element.class!",
                   org.w3c.dom.Element.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynStruct public
 * abstract interface org.omg.DynamicAny.DynStruct}.
 *
...
public abstract interface DynStructClassTests<SUT extends DynStruct>
extends org.j8unit.repository.org.omg.DynamicAny.DynStructOperationsClassTests<SUT>, org.j8unit.repository.org.omg.DynamicAny.DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynStruct.class!",
                   DynStruct.class.isAssignableFrom(sut));
    }

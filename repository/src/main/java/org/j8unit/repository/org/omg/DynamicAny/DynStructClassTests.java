 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynStructTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynStructTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynStruct interface org.omg.DynamicAny.DynStruct (the hereby targeted class-under-test class)
 * @see DynStructTests DynStructTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynStructClassTests<SUT extends org.omg.DynamicAny.DynStruct>
extends DynStructOperationsClassTests<SUT>, DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynStruct.class!",
                   org.omg.DynamicAny.DynStruct.class.isAssignableFrom(sut));
    }

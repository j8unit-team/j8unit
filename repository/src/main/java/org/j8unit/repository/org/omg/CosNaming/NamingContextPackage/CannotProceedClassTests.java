 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CannotProceed
 * public final class org.omg.CosNaming.NamingContextPackage.CannotProceed}.
 *
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CannotProceed.class!",
                   CannotProceed.class.isAssignableFrom(sut));
    }

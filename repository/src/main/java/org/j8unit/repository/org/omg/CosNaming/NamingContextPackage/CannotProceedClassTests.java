...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CosNaming.NamingContextPackage.CannotProceed class
 * org.omg.CosNaming.NamingContextPackage.CannotProceed}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CannotProceedTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextPackage.CannotProceed class org.omg.CosNaming.NamingContextPackage.CannotProceed
 *      (the hereby targeted class-under-test class)
 * @see CannotProceedTests CannotProceedTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CannotProceedClassTests<SUT extends org.omg.CosNaming.NamingContextPackage.CannotProceed>
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPackage.CannotProceed.class!",
                   org.omg.CosNaming.NamingContextPackage.CannotProceed.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CannotProceedHelper
 * public abstract class org.omg.CosNaming.NamingContextPackage.CannotProceedHelper}.
 *
...
public abstract interface CannotProceedHelperClassTests<SUT extends CannotProceedHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CosNaming.NamingContextPackage.CannotProceedHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CannotProceedHelper.class!",
                   CannotProceedHelper.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UShortSeqHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UShortSeqHolderTests}.
 * </p>
 *
 * @see org.omg.CORBA.UShortSeqHolder class org.omg.CORBA.UShortSeqHolder (the hereby targeted class-under-test class)
 * @see UShortSeqHolderTests UShortSeqHolderTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.UShortSeqHolder.class!",
                   org.omg.CORBA.UShortSeqHolder.class.isAssignableFrom(sut));
    }

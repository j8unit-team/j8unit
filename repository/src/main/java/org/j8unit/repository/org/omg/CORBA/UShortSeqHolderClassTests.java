 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UShortSeqHolder
...
public abstract interface UShortSeqHolderClassTests<SUT extends UShortSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UShortSeqHolder.class!",
                   UShortSeqHolder.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.UShortSeqHolder]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.UShortSeqHolder]

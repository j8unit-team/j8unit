 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSOutput public
 * abstract interface org.w3c.dom.ls.LSOutput}.
 *
...
public abstract interface LSOutputClassTests<SUT extends LSOutput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSOutput.class!",
                   LSOutput.class.isAssignableFrom(sut));
    }

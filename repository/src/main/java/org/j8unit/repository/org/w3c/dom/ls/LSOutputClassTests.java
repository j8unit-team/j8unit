...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.ls.LSOutput interface org.w3c.dom.ls.LSOutput}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSOutputTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LSOutputTests}.
 * </p>
 *
 * @see org.w3c.dom.ls.LSOutput interface org.w3c.dom.ls.LSOutput (the hereby targeted class-under-test class)
 * @see LSOutputTests LSOutputTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LSOutputClassTests<SUT extends org.w3c.dom.ls.LSOutput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSOutput.class!",
                   org.w3c.dom.ls.LSOutput.class.isAssignableFrom(sut));
    }

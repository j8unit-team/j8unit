 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CharHolder public
 * final class org.omg.CORBA.CharHolder}.
 *
...
public abstract interface CharHolderClassTests<SUT extends CharHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CharHolder.class!",
                   CharHolder.class.isAssignableFrom(sut));
    }

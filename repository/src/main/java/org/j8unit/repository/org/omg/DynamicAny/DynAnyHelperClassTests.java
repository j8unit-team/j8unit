 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynAnyHelper public
 * abstract class org.omg.DynamicAny.DynAnyHelper}.
 *
...
public abstract interface DynAnyHelperClassTests<SUT extends DynAnyHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynAnyHelper.class!",
                   DynAnyHelper.class.isAssignableFrom(sut));
    }

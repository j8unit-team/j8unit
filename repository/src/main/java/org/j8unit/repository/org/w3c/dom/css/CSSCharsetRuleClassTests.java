 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSCharsetRule
 * public abstract interface org.w3c.dom.css.CSSCharsetRule}.
 *
...
extends org.j8unit.repository.org.w3c.dom.css.CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSCharsetRule.class!",
                   CSSCharsetRule.class.isAssignableFrom(sut));
    }

 ...
 * org.w3c.dom.css.CSSCharsetRule}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSCharsetRuleTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see CSSCharsetRuleTests CSSCharsetRuleTests (The complementary j8unit test interface containing the instance
...
public abstract interface CSSCharsetRuleClassTests<SUT extends org.w3c.dom.css.CSSCharsetRule>
extends CSSRuleClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSCharsetRule.class!",
                   org.w3c.dom.css.CSSCharsetRule.class.isAssignableFrom(sut));
    }

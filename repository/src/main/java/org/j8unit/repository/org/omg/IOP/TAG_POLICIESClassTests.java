 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TAG_POLICIES public
 * abstract interface org.omg.IOP.TAG_POLICIES}.
 *
...
public abstract interface TAG_POLICIESClassTests<SUT extends TAG_POLICIES>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TAG_POLICIES.class!",

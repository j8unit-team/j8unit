...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.TAG_POLICIES interface org.omg.IOP.TAG_POLICIES},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TAG_POLICIESTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TAG_POLICIESTests}.
 * </p>
 *
 * @see org.omg.IOP.TAG_POLICIES interface org.omg.IOP.TAG_POLICIES (the hereby targeted class-under-test class)
 * @see TAG_POLICIESTests TAG_POLICIESTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TAG_POLICIESClassTests<SUT extends org.omg.IOP.TAG_POLICIES>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TAG_POLICIES.class!",
                   org.omg.IOP.TAG_POLICIES.class.isAssignableFrom(sut));
    }

...
public abstract interface DynStructClassTests<SUT extends org.omg.CORBA.DynStruct>
extends ObjectClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynStruct.class!",
                   org.omg.CORBA.DynStruct.class.isAssignableFrom(sut));
    }

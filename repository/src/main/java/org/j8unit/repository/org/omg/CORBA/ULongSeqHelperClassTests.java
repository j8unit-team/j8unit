 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ULongSeqHelper
 * public abstract class org.omg.CORBA.ULongSeqHelper}.
 *
...
public abstract interface ULongSeqHelperClassTests<SUT extends ULongSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ULongSeqHelper.class!",
                   ULongSeqHelper.class.isAssignableFrom(sut));
    }

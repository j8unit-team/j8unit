...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.traversal.NodeIterator interface
 * org.w3c.dom.traversal.NodeIterator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NodeIteratorTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NodeIteratorTests}.
 * </p>
 *
 * @see org.w3c.dom.traversal.NodeIterator interface org.w3c.dom.traversal.NodeIterator (the hereby targeted
 *      class-under-test class)
 * @see NodeIteratorTests NodeIteratorTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NodeIteratorClassTests<SUT extends org.w3c.dom.traversal.NodeIterator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.traversal.NodeIterator.class!",
                   org.w3c.dom.traversal.NodeIterator.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NodeIterator public
 * abstract interface org.w3c.dom.traversal.NodeIterator}.
 *
...
public abstract interface NodeIteratorClassTests<SUT extends NodeIterator>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NodeIterator.class!",
                   NodeIterator.class.isAssignableFrom(sut));
    }

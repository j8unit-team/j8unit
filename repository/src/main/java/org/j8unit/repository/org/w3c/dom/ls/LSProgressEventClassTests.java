...
import org.j8unit.repository.org.w3c.dom.events.EventClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSProgressEvent
 * public abstract interface org.w3c.dom.ls.LSProgressEvent}.
 *
...
public abstract interface LSProgressEventClassTests<SUT extends LSProgressEvent>
extends EventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSProgressEvent.class!",
                   LSProgressEvent.class.isAssignableFrom(sut));
    }

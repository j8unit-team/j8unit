 ...
 * org.w3c.dom.ls.LSProgressEvent}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSProgressEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LSProgressEventTests}.
 * </p>
 *
 * @see org.w3c.dom.ls.LSProgressEvent interface org.w3c.dom.ls.LSProgressEvent (the hereby targeted class-under-test
 *      class)
 * @see LSProgressEventTests LSProgressEventTests (The complementary j8unit test interface containing the instance
...
public abstract interface LSProgressEventClassTests<SUT extends org.w3c.dom.ls.LSProgressEvent>
extends org.j8unit.repository.org.w3c.dom.events.EventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSProgressEvent.class!",
                   org.w3c.dom.ls.LSProgressEvent.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSValue public
...
public abstract interface CSSValueClassTests<SUT extends CSSValue>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSValue.class!",
                   CSSValue.class.isAssignableFrom(sut));
    }

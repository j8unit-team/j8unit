...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.ServerRequestInfoOperations interface
 * org.omg.PortableInterceptor.ServerRequestInfoOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * </p>
 *
 * @see org.omg.PortableInterceptor.ServerRequestInfoOperations interface
 *      org.omg.PortableInterceptor.ServerRequestInfoOperations (the hereby targeted class-under-test class)
 * @see ServerRequestInfoOperationsTests ServerRequestInfoOperationsTests (The complementary j8unit test interface
...
public abstract interface ServerRequestInfoOperationsClassTests<SUT extends org.omg.PortableInterceptor.ServerRequestInfoOperations>
extends RequestInfoOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ServerRequestInfoOperations.class!",
                   org.omg.PortableInterceptor.ServerRequestInfoOperations.class.isAssignableFrom(sut));
    }

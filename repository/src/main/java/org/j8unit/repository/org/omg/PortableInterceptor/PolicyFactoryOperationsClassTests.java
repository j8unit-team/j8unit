...
public abstract interface PolicyFactoryOperationsClassTests<SUT extends PolicyFactoryOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyFactoryOperations.class!",
                   PolicyFactoryOperations.class.isAssignableFrom(sut));
    }

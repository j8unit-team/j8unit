...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.PolicyFactoryOperations interface
 * org.omg.PortableInterceptor.PolicyFactoryOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyFactoryOperationsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link PolicyFactoryOperationsTests}.
 * </p>
 *
 ...
 * @see PolicyFactoryOperationsTests PolicyFactoryOperationsTests (The complementary j8unit test interface containing
...
public abstract interface PolicyFactoryOperationsClassTests<SUT extends org.omg.PortableInterceptor.PolicyFactoryOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.PolicyFactoryOperations.class!",
                   org.omg.PortableInterceptor.PolicyFactoryOperations.class.isAssignableFrom(sut));
    }

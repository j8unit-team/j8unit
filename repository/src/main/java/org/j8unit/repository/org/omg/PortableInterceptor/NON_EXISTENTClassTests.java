 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NON_EXISTENT public
 * abstract interface org.omg.PortableInterceptor.NON_EXISTENT}.
 *
...
public abstract interface NON_EXISTENTClassTests<SUT extends NON_EXISTENT>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NON_EXISTENT.class!",
                   NON_EXISTENT.class.isAssignableFrom(sut));
    }

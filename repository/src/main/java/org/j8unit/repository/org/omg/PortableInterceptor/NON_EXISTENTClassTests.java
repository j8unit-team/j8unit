...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.NON_EXISTENT interface
 * org.omg.PortableInterceptor.NON_EXISTENT}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NON_EXISTENTTests}).
 * </p>
 *
 * <p>
 ...
 * @see NON_EXISTENTTests NON_EXISTENTTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NON_EXISTENTClassTests<SUT extends org.omg.PortableInterceptor.NON_EXISTENT>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.NON_EXISTENT.class!",
                   org.omg.PortableInterceptor.NON_EXISTENT.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.PortableInterceptor.ClientRequestInterceptor}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ClientRequestInterceptorTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see ClientRequestInterceptorTests ClientRequestInterceptorTests (The complementary j8unit test interface containing
...
public abstract interface ClientRequestInterceptorClassTests<SUT extends org.omg.PortableInterceptor.ClientRequestInterceptor>
extends ClientRequestInterceptorOperationsClassTests<SUT>, InterceptorClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ClientRequestInterceptor.class!",
                   org.omg.PortableInterceptor.ClientRequestInterceptor.class.isAssignableFrom(sut));
    }

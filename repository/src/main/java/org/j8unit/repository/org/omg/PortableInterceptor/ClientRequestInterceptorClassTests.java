...
extends ClientRequestInterceptorOperationsClassTests<SUT>, InterceptorClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClientRequestInterceptor.class!",
                   ClientRequestInterceptor.class.isAssignableFrom(sut));
    }

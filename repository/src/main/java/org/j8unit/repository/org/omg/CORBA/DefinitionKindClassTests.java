...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.DefinitionKind class org.omg.CORBA.DefinitionKind},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DefinitionKindTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DefinitionKindTests}.
 * </p>
 *
 * @see org.omg.CORBA.DefinitionKind class org.omg.CORBA.DefinitionKind (the hereby targeted class-under-test class)
 * @see DefinitionKindTests DefinitionKindTests (The complementary j8unit test interface containing the instance
...
public abstract interface DefinitionKindClassTests<SUT extends org.omg.CORBA.DefinitionKind>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DefinitionKind.class!",
                   org.omg.CORBA.DefinitionKind.class.isAssignableFrom(sut));
    }

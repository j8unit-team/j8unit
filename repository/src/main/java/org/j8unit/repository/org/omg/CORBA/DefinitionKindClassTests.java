 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DefinitionKind
 * public class org.omg.CORBA.DefinitionKind}.
 *
...
public abstract interface DefinitionKindClassTests<SUT extends DefinitionKind>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DefinitionKind.class!",
                   DefinitionKind.class.isAssignableFrom(sut));
    }

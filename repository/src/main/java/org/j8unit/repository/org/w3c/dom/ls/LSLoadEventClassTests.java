...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.ls.LSLoadEvent interface org.w3c.dom.ls.LSLoadEvent},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSLoadEventTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LSLoadEventTests}.
 * </p>
 *
 * @see org.w3c.dom.ls.LSLoadEvent interface org.w3c.dom.ls.LSLoadEvent (the hereby targeted class-under-test class)
 * @see LSLoadEventTests LSLoadEventTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LSLoadEventClassTests<SUT extends org.w3c.dom.ls.LSLoadEvent>
extends org.j8unit.repository.org.w3c.dom.events.EventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSLoadEvent.class!",
                   org.w3c.dom.ls.LSLoadEvent.class.isAssignableFrom(sut));
    }

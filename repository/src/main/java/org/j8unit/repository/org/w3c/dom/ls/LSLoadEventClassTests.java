 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSLoadEvent public
 * abstract interface org.w3c.dom.ls.LSLoadEvent}.
 *
...
public abstract interface LSLoadEventClassTests<SUT extends LSLoadEvent>
extends EventClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSLoadEvent.class!",
                   LSLoadEvent.class.isAssignableFrom(sut));
    }

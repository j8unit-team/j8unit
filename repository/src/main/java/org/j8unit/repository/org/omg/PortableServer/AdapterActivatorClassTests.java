 ...
 * org.omg.PortableServer.AdapterActivator}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AdapterActivatorTests}).
 * </p>
 *
 * <p>
 ...
 * @see AdapterActivatorTests AdapterActivatorTests (The complementary j8unit test interface containing the instance
...
public abstract interface AdapterActivatorClassTests<SUT extends org.omg.PortableServer.AdapterActivator>
extends AdapterActivatorOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.AdapterActivator.class!",
                   org.omg.PortableServer.AdapterActivator.class.isAssignableFrom(sut));
    }

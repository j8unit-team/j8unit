 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AdapterActivator
 * public abstract interface org.omg.PortableServer.AdapterActivator}.
 *
...
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterActivator.class!",
                   AdapterActivator.class.isAssignableFrom(sut));
    }

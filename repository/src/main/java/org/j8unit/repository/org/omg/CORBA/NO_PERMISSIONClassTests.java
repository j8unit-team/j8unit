 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NO_PERMISSION
...
public abstract interface NO_PERMISSIONClassTests<SUT extends NO_PERMISSION>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NO_PERMISSION.class!",
                   NO_PERMISSION.class.isAssignableFrom(sut));
    }

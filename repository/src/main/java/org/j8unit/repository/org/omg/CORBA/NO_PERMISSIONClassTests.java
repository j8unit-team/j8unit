 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NO_PERMISSIONTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.NO_PERMISSION class org.omg.CORBA.NO_PERMISSION (the hereby targeted class-under-test class)
 * @see NO_PERMISSIONTests NO_PERMISSIONTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.NO_PERMISSION.class!",
                   org.omg.CORBA.NO_PERMISSION.class.isAssignableFrom(sut));
    }

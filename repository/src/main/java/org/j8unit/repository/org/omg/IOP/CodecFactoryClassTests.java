 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CodecFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.IOP.CodecFactory interface org.omg.IOP.CodecFactory (the hereby targeted class-under-test class)
 * @see CodecFactoryTests CodecFactoryTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends CodecFactoryOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.CodecFactory.class!",
                   org.omg.IOP.CodecFactory.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CodecFactory public
 * abstract interface org.omg.IOP.CodecFactory}.
 *
...
extends CodecFactoryOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CodecFactory.class!",
                   CodecFactory.class.isAssignableFrom(sut));
    }

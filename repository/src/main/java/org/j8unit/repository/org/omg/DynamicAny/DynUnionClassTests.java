...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.DynamicAny.DynUnion interface org.omg.DynamicAny.DynUnion},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynUnionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynUnionTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynUnion interface org.omg.DynamicAny.DynUnion (the hereby targeted class-under-test class)
 * @see DynUnionTests DynUnionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynUnionClassTests<SUT extends org.omg.DynamicAny.DynUnion>
extends DynUnionOperationsClassTests<SUT>, DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynUnion.class!",
                   org.omg.DynamicAny.DynUnion.class.isAssignableFrom(sut));
    }

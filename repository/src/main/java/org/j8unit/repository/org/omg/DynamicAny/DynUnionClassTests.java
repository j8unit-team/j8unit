 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynUnion public
 * abstract interface org.omg.DynamicAny.DynUnion}.
 *
...
extends org.j8unit.repository.org.omg.DynamicAny.DynUnionOperationsClassTests<SUT>, org.j8unit.repository.org.omg.DynamicAny.DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynUnion.class!",
                   DynUnion.class.isAssignableFrom(sut));
    }

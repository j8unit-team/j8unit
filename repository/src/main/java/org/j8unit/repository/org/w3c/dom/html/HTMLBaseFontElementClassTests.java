 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLBaseFontElement
 * public abstract interface org.w3c.dom.html.HTMLBaseFontElement}.
 *
...
public abstract interface HTMLBaseFontElementClassTests<SUT extends HTMLBaseFontElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLBaseFontElement.class!",
                   HTMLBaseFontElement.class.isAssignableFrom(sut));
    }

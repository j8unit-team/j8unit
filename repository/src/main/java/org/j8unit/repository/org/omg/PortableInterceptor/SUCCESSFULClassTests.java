 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SUCCESSFUL public
 * abstract interface org.omg.PortableInterceptor.SUCCESSFUL}.
 *
...
public abstract interface SUCCESSFULClassTests<SUT extends SUCCESSFUL>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SUCCESSFUL.class!",
                   SUCCESSFUL.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.SUCCESSFUL interface
 * org.omg.PortableInterceptor.SUCCESSFUL}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SUCCESSFULTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SUCCESSFULTests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.SUCCESSFUL interface org.omg.PortableInterceptor.SUCCESSFUL (the hereby targeted
 *      class-under-test class)
 * @see SUCCESSFULTests SUCCESSFULTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface SUCCESSFULClassTests<SUT extends org.omg.PortableInterceptor.SUCCESSFUL>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.SUCCESSFUL.class!",
                   org.omg.PortableInterceptor.SUCCESSFUL.class.isAssignableFrom(sut));
    }

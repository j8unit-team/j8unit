 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Counter public
 * abstract interface org.w3c.dom.css.Counter}.
 *
...
public abstract interface CounterClassTests<SUT extends Counter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Counter.class!",
                   Counter.class.isAssignableFrom(sut));
    }

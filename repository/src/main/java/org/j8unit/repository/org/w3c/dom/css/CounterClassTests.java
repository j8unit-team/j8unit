 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CounterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CounterTests}.
 * </p>
 *
 * @see org.w3c.dom.css.Counter interface org.w3c.dom.css.Counter (the hereby targeted class-under-test class)
 * @see CounterTests CounterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CounterClassTests<SUT extends org.w3c.dom.css.Counter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.Counter.class!",
                   org.w3c.dom.css.Counter.class.isAssignableFrom(sut));
    }

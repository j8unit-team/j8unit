 ...
 * {@link UnknownUserException public final class org.omg.CORBA.UnknownUserException}.
 *
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownUserException.class!",
                   UnknownUserException.class.isAssignableFrom(sut));
    }

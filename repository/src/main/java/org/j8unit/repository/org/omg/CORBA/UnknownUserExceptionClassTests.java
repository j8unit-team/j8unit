 ...
 * org.omg.CORBA.UnknownUserException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownUserExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnknownUserExceptionTests}
 * .
 * </p>
 *
 * @see org.omg.CORBA.UnknownUserException class org.omg.CORBA.UnknownUserException (the hereby targeted
 *      class-under-test class)
 * @see UnknownUserExceptionTests UnknownUserExceptionTests (The complementary j8unit test interface containing the
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.UnknownUserException.class!",
                   org.omg.CORBA.UnknownUserException.class.isAssignableFrom(sut));
    }

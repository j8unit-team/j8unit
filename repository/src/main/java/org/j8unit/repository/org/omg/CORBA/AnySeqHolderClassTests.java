 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnySeqHolder public
 * final class org.omg.CORBA.AnySeqHolder}.
 *
...
public abstract interface AnySeqHolderClassTests<SUT extends AnySeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnySeqHolder.class!",
                   AnySeqHolder.class.isAssignableFrom(sut));
    }

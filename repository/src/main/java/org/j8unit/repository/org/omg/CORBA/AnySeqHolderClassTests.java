 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AnySeqHolderTests}).
 * </p>
 *
 * <p>
 ...
 * @see AnySeqHolderTests AnySeqHolderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.AnySeqHolder.class!",
                   org.omg.CORBA.AnySeqHolder.class.isAssignableFrom(sut));
    }

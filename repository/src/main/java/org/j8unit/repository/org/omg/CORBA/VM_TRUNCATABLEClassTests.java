 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VM_TRUNCATABLE
...
public abstract interface VM_TRUNCATABLEClassTests<SUT extends VM_TRUNCATABLE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VM_TRUNCATABLE.class!",
                   VM_TRUNCATABLE.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.VM_TRUNCATABLE interface org.omg.CORBA.VM_TRUNCATABLE},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VM_TRUNCATABLETests}).
 * </p>
 *
 * <p>
 ...
 * @see VM_TRUNCATABLETests VM_TRUNCATABLETests (The complementary j8unit test interface containing the instance
...
public abstract interface VM_TRUNCATABLEClassTests<SUT extends org.omg.CORBA.VM_TRUNCATABLE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.VM_TRUNCATABLE.class!",
                   org.omg.CORBA.VM_TRUNCATABLE.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.DynamicAny.DynAnyPackage.InvalidValue}, containing all type relevant aspects (e.&thinsp;g., runtime
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynAnyPackage.InvalidValue.class!",
                   org.omg.DynamicAny.DynAnyPackage.InvalidValue.class.isAssignableFrom(sut));
    }

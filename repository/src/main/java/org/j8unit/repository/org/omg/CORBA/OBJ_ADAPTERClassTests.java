 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OBJ_ADAPTER public
 * final class org.omg.CORBA.OBJ_ADAPTER}.
 *
...
public abstract interface OBJ_ADAPTERClassTests<SUT extends OBJ_ADAPTER>
extends SystemExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.OBJ_ADAPTER]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OBJ_ADAPTER.class!",
                   OBJ_ADAPTER.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OBJ_ADAPTERTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link OBJ_ADAPTERTests}.
 * </p>
 *
 * @see org.omg.CORBA.OBJ_ADAPTER class org.omg.CORBA.OBJ_ADAPTER (the hereby targeted class-under-test class)
 * @see OBJ_ADAPTERTests OBJ_ADAPTERTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.OBJ_ADAPTER.class!",
                   org.omg.CORBA.OBJ_ADAPTER.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RunTimeOperations
 * public abstract interface org.omg.SendingContext.RunTimeOperations}.
 *
...
public abstract interface RunTimeOperationsClassTests<SUT extends RunTimeOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RunTimeOperations.class!",
                   RunTimeOperations.class.isAssignableFrom(sut));
    }

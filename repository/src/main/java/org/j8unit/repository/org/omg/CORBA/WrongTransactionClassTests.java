 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link WrongTransactionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link WrongTransactionTests}.
 * </p>
 *
 * @see org.omg.CORBA.WrongTransaction class org.omg.CORBA.WrongTransaction (the hereby targeted class-under-test class)
 * @see WrongTransactionTests WrongTransactionTests (The complementary j8unit test interface containing the instance
...
public abstract interface WrongTransactionClassTests<SUT extends org.omg.CORBA.WrongTransaction>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.WrongTransaction.class!",
                   org.omg.CORBA.WrongTransaction.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    public default void create_WrongTransaction()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.CORBA.WrongTransaction sut = null; // = new WrongTransaction();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void create_WrongTransaction_String()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
    ...
    throws Exception {
        // create new instance
        final Class<? extends org.omg.CORBA.WrongTransaction> sut = createNewSUT();

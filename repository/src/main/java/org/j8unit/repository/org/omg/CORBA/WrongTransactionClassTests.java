 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WrongTransaction
 * public final class org.omg.CORBA.WrongTransaction}.
 *
...
public abstract interface WrongTransactionClassTests<SUT extends WrongTransaction>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WrongTransaction.class!",
                   WrongTransaction.class.isAssignableFrom(sut));
    }

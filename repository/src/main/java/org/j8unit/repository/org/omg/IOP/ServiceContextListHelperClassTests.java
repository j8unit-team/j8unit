 ...
 * {@link ServiceContextListHelper public abstract class org.omg.IOP.ServiceContextListHelper}.
 *
...
public abstract interface ServiceContextListHelperClassTests<SUT extends ServiceContextListHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceContextListHelper.class!",
                   ServiceContextListHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.IOP.ServiceContextListHelper]

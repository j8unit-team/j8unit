 ...
 * {@link SAXNotSupportedException public class org.xml.sax.SAXNotSupportedException}.
 *
...
public abstract interface SAXNotSupportedExceptionClassTests<SUT extends SAXNotSupportedException>
extends SAXExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXNotSupportedException.class!",
                   SAXNotSupportedException.class.isAssignableFrom(sut));
    }

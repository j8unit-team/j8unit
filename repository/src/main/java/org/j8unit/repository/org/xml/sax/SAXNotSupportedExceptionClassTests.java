...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.xml.sax.SAXNotSupportedException class
 * org.xml.sax.SAXNotSupportedException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SAXNotSupportedExceptionTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link SAXNotSupportedExceptionTests}.
 * </p>
 *
 * @see org.xml.sax.SAXNotSupportedException class org.xml.sax.SAXNotSupportedException (the hereby targeted
 *      class-under-test class)
 * @see SAXNotSupportedExceptionTests SAXNotSupportedExceptionTests (The complementary j8unit test interface containing
...
public abstract interface SAXNotSupportedExceptionClassTests<SUT extends org.xml.sax.SAXNotSupportedException>
extends SAXExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.SAXNotSupportedException.class!",
                   org.xml.sax.SAXNotSupportedException.class.isAssignableFrom(sut));
    }

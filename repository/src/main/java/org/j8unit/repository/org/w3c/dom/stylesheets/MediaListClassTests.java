...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.stylesheets.MediaList interface
 * org.w3c.dom.stylesheets.MediaList}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link MediaListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link MediaListTests}.
 * </p>
 *
 * @see org.w3c.dom.stylesheets.MediaList interface org.w3c.dom.stylesheets.MediaList (the hereby targeted
 *      class-under-test class)
 * @see MediaListTests MediaListTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface MediaListClassTests<SUT extends org.w3c.dom.stylesheets.MediaList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.stylesheets.MediaList.class!",
                   org.w3c.dom.stylesheets.MediaList.class.isAssignableFrom(sut));
    }

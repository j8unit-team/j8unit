 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link MediaList public
 * abstract interface org.w3c.dom.stylesheets.MediaList}.
 *
...
public abstract interface MediaListClassTests<SUT extends MediaList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to MediaList.class!",
                   MediaList.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_POLICY_TYPE
...
public abstract interface BAD_POLICY_TYPEClassTests<SUT extends BAD_POLICY_TYPE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_POLICY_TYPE.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.BAD_POLICY_TYPE interface org.omg.CORBA.BAD_POLICY_TYPE}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_POLICY_TYPETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BAD_POLICY_TYPETests}.
 * </p>
 *
 * @see org.omg.CORBA.BAD_POLICY_TYPE interface org.omg.CORBA.BAD_POLICY_TYPE (the hereby targeted class-under-test
 *      class)
 * @see BAD_POLICY_TYPETests BAD_POLICY_TYPETests (The complementary j8unit test interface containing the instance
...
public abstract interface BAD_POLICY_TYPEClassTests<SUT extends org.omg.CORBA.BAD_POLICY_TYPE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_POLICY_TYPE.class!",
                   org.omg.CORBA.BAD_POLICY_TYPE.class.isAssignableFrom(sut));
    }

 ...
 * org.w3c.dom.html.HTMLModElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLModElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTMLModElementTests}.
 * </p>
 *
 * @see org.w3c.dom.html.HTMLModElement interface org.w3c.dom.html.HTMLModElement (the hereby targeted class-under-test
 *      class)
 * @see HTMLModElementTests HTMLModElementTests (The complementary j8unit test interface containing the instance
...
public abstract interface HTMLModElementClassTests<SUT extends org.w3c.dom.html.HTMLModElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLModElement.class!",
                   org.w3c.dom.html.HTMLModElement.class.isAssignableFrom(sut));
    }

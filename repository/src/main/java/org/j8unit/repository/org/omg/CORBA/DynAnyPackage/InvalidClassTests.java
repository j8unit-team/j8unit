...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.DynAnyPackage.Invalid class
 * org.omg.CORBA.DynAnyPackage.Invalid}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvalidTests}.
 * </p>
 *
 * @see org.omg.CORBA.DynAnyPackage.Invalid class org.omg.CORBA.DynAnyPackage.Invalid (the hereby targeted
 *      class-under-test class)
 * @see InvalidTests InvalidTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynAnyPackage.Invalid.class!",
                   org.omg.CORBA.DynAnyPackage.Invalid.class.isAssignableFrom(sut));
    }

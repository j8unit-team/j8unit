 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameComponentHolder
 * public final class org.omg.CosNaming.NameComponentHolder}.
 *
...
public abstract interface NameComponentHolderClassTests<SUT extends NameComponentHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameComponentHolder.class!",
                   NameComponentHolder.class.isAssignableFrom(sut));
    }

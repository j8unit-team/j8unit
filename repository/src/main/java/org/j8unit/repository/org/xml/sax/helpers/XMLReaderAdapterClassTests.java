 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link XMLReaderAdapter
...
extends ParserClassTests<SUT>, ContentHandlerClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to XMLReaderAdapter.class!",
                   XMLReaderAdapter.class.isAssignableFrom(sut));
    }

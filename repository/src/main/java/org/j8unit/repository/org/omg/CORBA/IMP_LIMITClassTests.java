 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IMP_LIMITTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.IMP_LIMIT class org.omg.CORBA.IMP_LIMIT (the hereby targeted class-under-test class)
 * @see IMP_LIMITTests IMP_LIMITTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.IMP_LIMIT.class!",
                   org.omg.CORBA.IMP_LIMIT.class.isAssignableFrom(sut));
    }

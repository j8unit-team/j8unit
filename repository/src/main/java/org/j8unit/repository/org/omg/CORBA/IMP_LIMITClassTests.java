 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IMP_LIMIT public
 * final class org.omg.CORBA.IMP_LIMIT}.
 *
...
public abstract interface IMP_LIMITClassTests<SUT extends IMP_LIMIT>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IMP_LIMIT.class!",
                   IMP_LIMIT.class.isAssignableFrom(sut));
    }

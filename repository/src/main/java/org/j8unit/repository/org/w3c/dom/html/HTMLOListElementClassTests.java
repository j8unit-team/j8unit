 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLOListElement
 * public abstract interface org.w3c.dom.html.HTMLOListElement}.
 *
...
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLOListElement.class!",
                   HTMLOListElement.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PolicyListHolder
 * public final class org.omg.CORBA.PolicyListHolder}.
 *
...
public abstract interface PolicyListHolderClassTests<SUT extends PolicyListHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PolicyListHolder.class!",
                   PolicyListHolder.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link PolicyListHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link PolicyListHolderTests}.
 * </p>
 *
 * @see org.omg.CORBA.PolicyListHolder class org.omg.CORBA.PolicyListHolder (the hereby targeted class-under-test class)
 * @see PolicyListHolderTests PolicyListHolderTests (The complementary j8unit test interface containing the instance
...
public abstract interface PolicyListHolderClassTests<SUT extends org.omg.CORBA.PolicyListHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.PolicyListHolder.class!",
                   org.omg.CORBA.PolicyListHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServerRequest
...
public abstract interface ServerRequestClassTests<SUT extends ServerRequest>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServerRequest.class!",
                   ServerRequest.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.ServerRequest]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.ServerRequest]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LinkStyle public
 * abstract interface org.w3c.dom.stylesheets.LinkStyle}.
 *
...
public abstract interface LinkStyleClassTests<SUT extends LinkStyle>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LinkStyle.class!",
                   LinkStyle.class.isAssignableFrom(sut));
    }

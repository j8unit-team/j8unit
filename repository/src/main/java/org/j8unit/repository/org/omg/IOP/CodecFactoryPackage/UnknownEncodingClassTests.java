 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnknownEncoding
 * public final class org.omg.IOP.CodecFactoryPackage.UnknownEncoding}.
 *
...
public abstract interface UnknownEncodingClassTests<SUT extends UnknownEncoding>
extends UserExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.IOP.CodecFactoryPackage.UnknownEncoding]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownEncoding.class!",
                   UnknownEncoding.class.isAssignableFrom(sut));
    }

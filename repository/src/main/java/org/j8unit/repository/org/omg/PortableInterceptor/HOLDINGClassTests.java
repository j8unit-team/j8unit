...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.HOLDING interface
 * org.omg.PortableInterceptor.HOLDING}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HOLDINGTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HOLDINGTests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.HOLDING interface org.omg.PortableInterceptor.HOLDING (the hereby targeted
 *      class-under-test class)
 * @see HOLDINGTests HOLDINGTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface HOLDINGClassTests<SUT extends org.omg.PortableInterceptor.HOLDING>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.HOLDING.class!",
                   org.omg.PortableInterceptor.HOLDING.class.isAssignableFrom(sut));
    }

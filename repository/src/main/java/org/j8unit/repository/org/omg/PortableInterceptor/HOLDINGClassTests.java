 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HOLDING public
 * abstract interface org.omg.PortableInterceptor.HOLDING}.
 *
...
public abstract interface HOLDINGClassTests<SUT extends HOLDING>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HOLDING.class!",
                   HOLDING.class.isAssignableFrom(sut));
    }

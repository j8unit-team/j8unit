 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link PrincipalHolder
...
public abstract interface PrincipalHolderClassTests<SUT extends PrincipalHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to PrincipalHolder.class!",
                   PrincipalHolder.class.isAssignableFrom(sut));
    }

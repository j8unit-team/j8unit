 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TIMEOUT public
 * final class org.omg.CORBA.TIMEOUT}.
 *
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TIMEOUTTests}.
 * </p>
 *
 * <p>
...
public abstract interface TIMEOUTClassTests<SUT extends TIMEOUT>
extends SystemExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.TIMEOUT]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TIMEOUT.class!",
                   TIMEOUT.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.TIMEOUT]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.TIMEOUT]

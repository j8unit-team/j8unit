 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSRuleTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CSSRuleTests}.
 * </p>
 *
 * @see org.w3c.dom.css.CSSRule interface org.w3c.dom.css.CSSRule (the hereby targeted class-under-test class)
 * @see CSSRuleTests CSSRuleTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CSSRuleClassTests<SUT extends org.w3c.dom.css.CSSRule>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSRule.class!",
                   org.w3c.dom.css.CSSRule.class.isAssignableFrom(sut));
    }

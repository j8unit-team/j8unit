 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSRule public
 * abstract interface org.w3c.dom.css.CSSRule}.
 *
...
public abstract interface CSSRuleClassTests<SUT extends CSSRule>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSRule.class!",
                   CSSRule.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GSSManager public
 * abstract class org.ietf.jgss.GSSManager}.
 *
...
public abstract interface GSSManagerClassTests<SUT extends GSSManager>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GSSManager.class!",
                   GSSManager.class.isAssignableFrom(sut));
    }

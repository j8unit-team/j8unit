 ...
 * org.omg.PortableInterceptor.Interceptor}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InterceptorTests}).
 * </p>
 *
 * <p>
 ...
 * @see InterceptorTests InterceptorTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface InterceptorClassTests<SUT extends org.omg.PortableInterceptor.Interceptor>
extends InterceptorOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.Interceptor.class!",
                   org.omg.PortableInterceptor.Interceptor.class.isAssignableFrom(sut));
    }

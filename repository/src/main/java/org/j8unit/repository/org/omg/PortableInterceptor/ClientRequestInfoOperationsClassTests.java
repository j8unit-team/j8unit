...
public abstract interface ClientRequestInfoOperationsClassTests<SUT extends ClientRequestInfoOperations>
extends org.j8unit.repository.org.omg.PortableInterceptor.RequestInfoOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ClientRequestInfoOperations.class!",
                   ClientRequestInfoOperations.class.isAssignableFrom(sut));
    }

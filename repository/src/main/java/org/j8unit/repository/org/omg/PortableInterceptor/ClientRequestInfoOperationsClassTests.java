...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.ClientRequestInfoOperations interface
 * org.omg.PortableInterceptor.ClientRequestInfoOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * </p>
 *
 * @see org.omg.PortableInterceptor.ClientRequestInfoOperations interface
 *      org.omg.PortableInterceptor.ClientRequestInfoOperations (the hereby targeted class-under-test class)
 * @see ClientRequestInfoOperationsTests ClientRequestInfoOperationsTests (The complementary j8unit test interface
...
public abstract interface ClientRequestInfoOperationsClassTests<SUT extends org.omg.PortableInterceptor.ClientRequestInfoOperations>
extends RequestInfoOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ClientRequestInfoOperations.class!",
                   org.omg.PortableInterceptor.ClientRequestInfoOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IORInfoOperations
 * public abstract interface org.omg.PortableInterceptor.IORInfoOperations}.
 *
...
public abstract interface IORInfoOperationsClassTests<SUT extends IORInfoOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORInfoOperations.class!",
                   IORInfoOperations.class.isAssignableFrom(sut));
    }

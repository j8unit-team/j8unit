 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLButtonElement
 * public abstract interface org.w3c.dom.html.HTMLButtonElement}.
 *
...
public abstract interface HTMLButtonElementClassTests<SUT extends HTMLButtonElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLButtonElement.class!",
                   HTMLButtonElement.class.isAssignableFrom(sut));
    }

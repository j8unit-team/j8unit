 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link INTF_REPOSTests}).
 * </p>
 *
 * <p>
 ...
 * @see INTF_REPOSTests INTF_REPOSTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.INTF_REPOS.class!",
                   org.omg.CORBA.INTF_REPOS.class.isAssignableFrom(sut));
    }

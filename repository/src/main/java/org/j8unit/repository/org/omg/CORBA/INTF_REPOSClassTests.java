 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link INTF_REPOS public
 * final class org.omg.CORBA.INTF_REPOS}.
 *
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to INTF_REPOS.class!",
                   INTF_REPOS.class.isAssignableFrom(sut));
    }

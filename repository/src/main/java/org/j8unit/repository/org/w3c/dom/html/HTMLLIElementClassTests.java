 ...
 * org.w3c.dom.html.HTMLLIElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLLIElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTMLLIElementTests}.
 * </p>
 *
 * @see org.w3c.dom.html.HTMLLIElement interface org.w3c.dom.html.HTMLLIElement (the hereby targeted class-under-test
 *      class)
 * @see HTMLLIElementTests HTMLLIElementTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface HTMLLIElementClassTests<SUT extends org.w3c.dom.html.HTMLLIElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLLIElement.class!",
                   org.w3c.dom.html.HTMLLIElement.class.isAssignableFrom(sut));
    }

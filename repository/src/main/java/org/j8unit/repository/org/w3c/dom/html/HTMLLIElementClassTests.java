 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLLIElement
...
public abstract interface HTMLLIElementClassTests<SUT extends HTMLLIElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLLIElement.class!",
                   HTMLLIElement.class.isAssignableFrom(sut));
    }

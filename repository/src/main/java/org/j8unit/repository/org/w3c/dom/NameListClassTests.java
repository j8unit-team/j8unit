 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NameListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NameListTests}.
 * </p>
 *
 * @see org.w3c.dom.NameList interface org.w3c.dom.NameList (the hereby targeted class-under-test class)
 * @see NameListTests NameListTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NameListClassTests<SUT extends org.w3c.dom.NameList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.NameList.class!",
                   org.w3c.dom.NameList.class.isAssignableFrom(sut));
    }

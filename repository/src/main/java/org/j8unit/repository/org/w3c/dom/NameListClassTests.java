 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameList public
 * abstract interface org.w3c.dom.NameList}.
 *
...
public abstract interface NameListClassTests<SUT extends NameList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameList.class!",
                   NameList.class.isAssignableFrom(sut));
    }

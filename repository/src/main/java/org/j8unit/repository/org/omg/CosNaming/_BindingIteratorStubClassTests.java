...
public abstract interface _BindingIteratorStubClassTests<SUT extends _BindingIteratorStub>
extends org.j8unit.repository.org.omg.CosNaming.BindingIteratorClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _BindingIteratorStub.class!",
                   _BindingIteratorStub.class.isAssignableFrom(sut));
    }

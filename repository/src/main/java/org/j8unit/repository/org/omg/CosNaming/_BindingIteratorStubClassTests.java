 ...
 * org.omg.CosNaming._BindingIteratorStub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _BindingIteratorStubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link _BindingIteratorStubTests}
 * .
 * </p>
 *
 * @see org.omg.CosNaming._BindingIteratorStub class org.omg.CosNaming._BindingIteratorStub (the hereby targeted
 *      class-under-test class)
 * @see _BindingIteratorStubTests _BindingIteratorStubTests (The complementary j8unit test interface containing the
...
extends BindingIteratorClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming._BindingIteratorStub.class!",
                   org.omg.CosNaming._BindingIteratorStub.class.isAssignableFrom(sut));
    }

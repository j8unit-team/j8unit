...
public abstract interface ServiceInformationHelperClassTests<SUT extends ServiceInformationHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceInformationHelper.class!",
                   ServiceInformationHelper.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentTypeTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.w3c.dom.DocumentType interface org.w3c.dom.DocumentType (the hereby targeted class-under-test class)
 * @see DocumentTypeTests DocumentTypeTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.DocumentType.class!",
                   org.w3c.dom.DocumentType.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentType public
 * abstract interface org.w3c.dom.DocumentType}.
 *
...
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentType.class!",
                   DocumentType.class.isAssignableFrom(sut));
    }

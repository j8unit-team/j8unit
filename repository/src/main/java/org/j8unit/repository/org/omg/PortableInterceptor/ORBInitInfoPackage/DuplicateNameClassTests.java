 ...
 * org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DuplicateNameTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName class
 *      org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName (the hereby targeted class-under-test class)
 * @see DuplicateNameTests DuplicateNameTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName.class!",
                   org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName.class.isAssignableFrom(sut));
    }

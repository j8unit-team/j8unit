 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DuplicateName
 * public final class org.omg.PortableInterceptor.ORBInitInfoPackage.DuplicateName}.
 *
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DuplicateName.class!",
                   DuplicateName.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.TypeCode class org.omg.CORBA.TypeCode}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TypeCodeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TypeCodeTests}.
 * </p>
 *
 * @see org.omg.CORBA.TypeCode class org.omg.CORBA.TypeCode (the hereby targeted class-under-test class)
 * @see TypeCodeTests TypeCodeTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface TypeCodeClassTests<SUT extends org.omg.CORBA.TypeCode>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.TypeCode.class!",
                   org.omg.CORBA.TypeCode.class.isAssignableFrom(sut));
    }

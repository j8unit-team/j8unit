 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TypeCode public
...
public abstract interface TypeCodeClassTests<SUT extends TypeCode>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TypeCode.class!",
                   TypeCode.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.PortableServer.POAPackage.ObjectAlreadyActive}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectAlreadyActiveTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ObjectAlreadyActiveTests}.
 * </p>
 *
 ...
 * @see ObjectAlreadyActiveTests ObjectAlreadyActiveTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.ObjectAlreadyActive.class!",
                   org.omg.PortableServer.POAPackage.ObjectAlreadyActive.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ObjectAlreadyActive
 * public final class org.omg.PortableServer.POAPackage.ObjectAlreadyActive}.
 *
...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectAlreadyActive.class!",
                   ObjectAlreadyActive.class.isAssignableFrom(sut));
    }

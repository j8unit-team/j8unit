 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link WrongPolicyHelper
 * public abstract class org.omg.PortableServer.POAPackage.WrongPolicyHelper}.
 *
...
public abstract interface WrongPolicyHelperClassTests<SUT extends WrongPolicyHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.POAPackage.WrongPolicyHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to WrongPolicyHelper.class!",
                   WrongPolicyHelper.class.isAssignableFrom(sut));
    }

...
public abstract interface ServantNotActiveHelperClassTests<SUT extends ServantNotActiveHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantNotActiveHelper.class!",
                   ServantNotActiveHelper.class.isAssignableFrom(sut));
    }

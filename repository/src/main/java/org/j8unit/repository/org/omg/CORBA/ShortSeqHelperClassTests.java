 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ShortSeqHelper
...
public abstract interface ShortSeqHelperClassTests<SUT extends ShortSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ShortSeqHelper.class!",
                   ShortSeqHelper.class.isAssignableFrom(sut));
    }

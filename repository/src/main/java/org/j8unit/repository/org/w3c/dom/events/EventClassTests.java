...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.events.Event interface org.w3c.dom.events.Event},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.w3c.dom.events.Event interface org.w3c.dom.events.Event (the hereby targeted class-under-test class)
 * @see EventTests EventTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface EventClassTests<SUT extends org.w3c.dom.events.Event>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.events.Event.class!",
                   org.w3c.dom.events.Event.class.isAssignableFrom(sut));
    }

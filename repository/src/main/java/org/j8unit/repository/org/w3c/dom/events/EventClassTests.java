 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Event public
...
public abstract interface EventClassTests<SUT extends Event>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Event.class!", Event.class.isAssignableFrom(sut));
    }

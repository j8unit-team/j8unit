 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link REBIND public final
...
public abstract interface REBINDClassTests<SUT extends REBIND>
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to REBIND.class!",
                   REBIND.class.isAssignableFrom(sut));
    }

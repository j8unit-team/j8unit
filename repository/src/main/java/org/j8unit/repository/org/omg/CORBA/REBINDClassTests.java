...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.REBIND class org.omg.CORBA.REBIND}, containing all type
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link REBINDTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.REBIND class org.omg.CORBA.REBIND (the hereby targeted class-under-test class)
 * @see REBINDTests REBINDTests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface REBINDClassTests<SUT extends org.omg.CORBA.REBIND>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.REBIND.class!",
                   org.omg.CORBA.REBIND.class.isAssignableFrom(sut));
    }

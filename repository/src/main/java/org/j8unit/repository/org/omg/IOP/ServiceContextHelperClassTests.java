 ...
 * {@link ServiceContextHelper public abstract class org.omg.IOP.ServiceContextHelper}.
 *
...
public abstract interface ServiceContextHelperClassTests<SUT extends ServiceContextHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServiceContextHelper.class!",
                   ServiceContextHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynStructOperations
 * public abstract interface org.omg.DynamicAny.DynStructOperations}.
 *
...
public abstract interface DynStructOperationsClassTests<SUT extends DynStructOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynStructOperations.class!",
                   DynStructOperations.class.isAssignableFrom(sut));
    }

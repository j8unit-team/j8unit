...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.DynamicAny.DynStructOperations interface
 * org.omg.DynamicAny.DynStructOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynStructOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynStructOperationsTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynStructOperations interface org.omg.DynamicAny.DynStructOperations (the hereby targeted
 *      class-under-test class)
 * @see DynStructOperationsTests DynStructOperationsTests (The complementary j8unit test interface containing the
...
public abstract interface DynStructOperationsClassTests<SUT extends org.omg.DynamicAny.DynStructOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynStructOperations.class!",
                   org.omg.DynamicAny.DynStructOperations.class.isAssignableFrom(sut));
    }

 ...
 * {@link ORBInitializerOperations public abstract interface org.omg.PortableInterceptor.ORBInitializerOperations}.
 *
...
public abstract interface ORBInitializerOperationsClassTests<SUT extends ORBInitializerOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ORBInitializerOperations.class!",
                   ORBInitializerOperations.class.isAssignableFrom(sut));
    }

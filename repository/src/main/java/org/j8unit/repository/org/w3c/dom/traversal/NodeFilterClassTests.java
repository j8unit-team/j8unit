 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NodeFilter public
 * abstract interface org.w3c.dom.traversal.NodeFilter}.
 *
...
public abstract interface NodeFilterClassTests<SUT extends NodeFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NodeFilter.class!",
                   NodeFilter.class.isAssignableFrom(sut));
    }

 ...
 * org.w3c.dom.traversal.NodeFilter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NodeFilterTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NodeFilterTests}.
 * </p>
 *
 * @see org.w3c.dom.traversal.NodeFilter interface org.w3c.dom.traversal.NodeFilter (the hereby targeted
 *      class-under-test class)
 * @see NodeFilterTests NodeFilterTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NodeFilterClassTests<SUT extends org.w3c.dom.traversal.NodeFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.traversal.NodeFilter.class!",
                   org.w3c.dom.traversal.NodeFilter.class.isAssignableFrom(sut));
    }

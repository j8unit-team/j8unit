 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link GSSException public
...
public abstract interface GSSExceptionClassTests<SUT extends GSSException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to GSSException.class!",
                   GSSException.class.isAssignableFrom(sut));
    }

 ...
 * org.w3c.dom.html.HTMLHRElement}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link HTMLHRElementTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link HTMLHRElementTests}.
 * </p>
 *
 * @see org.w3c.dom.html.HTMLHRElement interface org.w3c.dom.html.HTMLHRElement (the hereby targeted class-under-test
 *      class)
 * @see HTMLHRElementTests HTMLHRElementTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface HTMLHRElementClassTests<SUT extends org.w3c.dom.html.HTMLHRElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.html.HTMLHRElement.class!",
                   org.w3c.dom.html.HTMLHRElement.class.isAssignableFrom(sut));
    }

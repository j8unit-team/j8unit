 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLHRElement
 * public abstract interface org.w3c.dom.html.HTMLHRElement}.
 *
...
public abstract interface HTMLHRElementClassTests<SUT extends HTMLHRElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLHRElement.class!",
                   HTMLHRElement.class.isAssignableFrom(sut));
    }

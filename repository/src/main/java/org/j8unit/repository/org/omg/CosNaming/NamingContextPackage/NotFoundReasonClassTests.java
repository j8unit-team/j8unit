 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotFoundReason
 * public class org.omg.CosNaming.NamingContextPackage.NotFoundReason}.
 *
...
public abstract interface NotFoundReasonClassTests<SUT extends NotFoundReason>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CosNaming.NamingContextPackage.NotFoundReason]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotFoundReason.class!",
                   NotFoundReason.class.isAssignableFrom(sut));
    }

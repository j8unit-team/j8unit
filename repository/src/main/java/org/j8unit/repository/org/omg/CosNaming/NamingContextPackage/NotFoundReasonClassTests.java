 ...
 * org.omg.CosNaming.NamingContextPackage.NotFoundReason}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotFoundReasonTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotFoundReasonTests}.
 * </p>
 *
 ...
 * @see NotFoundReasonTests NotFoundReasonTests (The complementary j8unit test interface containing the instance
...
public abstract interface NotFoundReasonClassTests<SUT extends org.omg.CosNaming.NamingContextPackage.NotFoundReason>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPackage.NotFoundReason.class!",
                   org.omg.CosNaming.NamingContextPackage.NotFoundReason.class.isAssignableFrom(sut));
    }

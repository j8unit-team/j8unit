 ...
 * {@link ForwardRequestHelper public abstract class org.omg.PortableInterceptor.ForwardRequestHelper}.
 *
...
public abstract interface ForwardRequestHelperClassTests<SUT extends ForwardRequestHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ForwardRequestHelper.class!",
                   ForwardRequestHelper.class.isAssignableFrom(sut));
    }

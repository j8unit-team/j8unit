 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotEmptyHelper
 * public abstract class org.omg.CosNaming.NamingContextPackage.NotEmptyHelper}.
 *
...
public abstract interface NotEmptyHelperClassTests<SUT extends NotEmptyHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotEmptyHelper.class!",
                   NotEmptyHelper.class.isAssignableFrom(sut));
    }

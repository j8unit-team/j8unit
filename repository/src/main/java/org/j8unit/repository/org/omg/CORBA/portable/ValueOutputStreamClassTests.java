...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.portable.ValueOutputStream interface
 * org.omg.CORBA.portable.ValueOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ValueOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * @see ValueOutputStreamTests ValueOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface ValueOutputStreamClassTests<SUT extends org.omg.CORBA.portable.ValueOutputStream>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.ValueOutputStream.class!",
                   org.omg.CORBA.portable.ValueOutputStream.class.isAssignableFrom(sut));
    }

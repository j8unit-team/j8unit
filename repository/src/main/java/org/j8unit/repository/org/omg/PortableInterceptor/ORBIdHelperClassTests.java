 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ORBIdHelper public
 * abstract class org.omg.PortableInterceptor.ORBIdHelper}.
 *
...
public abstract interface ORBIdHelperClassTests<SUT extends ORBIdHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ORBIdHelper.class!",
                   ORBIdHelper.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LocalObjectTests}).
 * </p>
 *
 * <p>
 ...
 * @see LocalObjectTests LocalObjectTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LocalObjectClassTests<SUT extends org.omg.CORBA.LocalObject>
extends ObjectClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.LocalObject.class!",
                   org.omg.CORBA.LocalObject.class.isAssignableFrom(sut));
    }

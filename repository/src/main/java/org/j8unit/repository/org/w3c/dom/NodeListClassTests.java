 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NodeList public
...
public abstract interface NodeListClassTests<SUT extends NodeList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NodeList.class!",
                   NodeList.class.isAssignableFrom(sut));
    }

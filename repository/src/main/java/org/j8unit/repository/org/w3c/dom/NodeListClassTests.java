...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.NodeList interface org.w3c.dom.NodeList}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NodeListTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.w3c.dom.NodeList interface org.w3c.dom.NodeList (the hereby targeted class-under-test class)
 * @see NodeListTests NodeListTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface NodeListClassTests<SUT extends org.w3c.dom.NodeList>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.NodeList.class!",
                   org.w3c.dom.NodeList.class.isAssignableFrom(sut));
    }

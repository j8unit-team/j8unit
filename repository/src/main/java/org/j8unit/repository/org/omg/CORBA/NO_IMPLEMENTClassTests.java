 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NO_IMPLEMENTTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NO_IMPLEMENTTests}.
 * </p>
 *
 * @see org.omg.CORBA.NO_IMPLEMENT class org.omg.CORBA.NO_IMPLEMENT (the hereby targeted class-under-test class)
 * @see NO_IMPLEMENTTests NO_IMPLEMENTTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.NO_IMPLEMENT.class!",
                   org.omg.CORBA.NO_IMPLEMENT.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NO_IMPLEMENT public
 * final class org.omg.CORBA.NO_IMPLEMENT}.
 *
...
public abstract interface NO_IMPLEMENTClassTests<SUT extends NO_IMPLEMENT>
extends SystemExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.NO_IMPLEMENT]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NO_IMPLEMENT.class!",
                   NO_IMPLEMENT.class.isAssignableFrom(sut));
    }

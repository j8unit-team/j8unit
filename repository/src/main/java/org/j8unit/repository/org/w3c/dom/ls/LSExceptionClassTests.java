 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LSExceptionTests}.
 * </p>
 *
 * @see org.w3c.dom.ls.LSException class org.w3c.dom.ls.LSException (the hereby targeted class-under-test class)
 * @see LSExceptionTests LSExceptionTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LSExceptionClassTests<SUT extends org.w3c.dom.ls.LSException>
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSException.class!",
                   org.w3c.dom.ls.LSException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSException public
...
public abstract interface LSExceptionClassTests<SUT extends LSException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSException.class!",
                   LSException.class.isAssignableFrom(sut));
    }

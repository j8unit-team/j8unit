 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SAXException public
...
public abstract interface SAXExceptionClassTests<SUT extends SAXException>
extends ExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SAXException.class!",
                   SAXException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CodeSets public
...
public abstract interface CodeSetsClassTests<SUT extends CodeSets>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CodeSets.class!",
                   CodeSets.class.isAssignableFrom(sut));
    }

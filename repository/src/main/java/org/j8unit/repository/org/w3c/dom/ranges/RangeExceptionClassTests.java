 ...
 * org.w3c.dom.ranges.RangeException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RangeExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RangeExceptionTests}.
 * </p>
 *
 * @see org.w3c.dom.ranges.RangeException class org.w3c.dom.ranges.RangeException (the hereby targeted class-under-test
 *      class)
 * @see RangeExceptionTests RangeExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ranges.RangeException.class!",
                   org.w3c.dom.ranges.RangeException.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RangeException
...
public abstract interface RangeExceptionClassTests<SUT extends RangeException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RangeException.class!",
                   RangeException.class.isAssignableFrom(sut));
    }

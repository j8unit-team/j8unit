 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamedNodeMapTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NamedNodeMapTests}.
 * </p>
 *
 * @see org.w3c.dom.NamedNodeMap interface org.w3c.dom.NamedNodeMap (the hereby targeted class-under-test class)
 * @see NamedNodeMapTests NamedNodeMapTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface NamedNodeMapClassTests<SUT extends org.w3c.dom.NamedNodeMap>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.NamedNodeMap.class!",
                   org.w3c.dom.NamedNodeMap.class.isAssignableFrom(sut));
    }

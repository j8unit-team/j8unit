 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NamedNodeMap public
 * abstract interface org.w3c.dom.NamedNodeMap}.
 *
...
public abstract interface NamedNodeMapClassTests<SUT extends NamedNodeMap>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamedNodeMap.class!",
                   NamedNodeMap.class.isAssignableFrom(sut));
    }

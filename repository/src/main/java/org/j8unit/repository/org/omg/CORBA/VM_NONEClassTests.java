...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.VM_NONE interface org.omg.CORBA.VM_NONE}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VM_NONETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link VM_NONETests}.
 * </p>
 *
 * @see org.omg.CORBA.VM_NONE interface org.omg.CORBA.VM_NONE (the hereby targeted class-under-test class)
 * @see VM_NONETests VM_NONETests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface VM_NONEClassTests<SUT extends org.omg.CORBA.VM_NONE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.VM_NONE.class!",
                   org.omg.CORBA.VM_NONE.class.isAssignableFrom(sut));
    }

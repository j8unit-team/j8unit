 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VM_NONE public
...
public abstract interface VM_NONEClassTests<SUT extends VM_NONE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VM_NONE.class!",
                   VM_NONE.class.isAssignableFrom(sut));
    }

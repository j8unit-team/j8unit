 ...
 * org.omg.PortableServer.ServantManager}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ServantManagerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ServantManagerTests}.
 * </p>
 *
 * @see org.omg.PortableServer.ServantManager interface org.omg.PortableServer.ServantManager (the hereby targeted
 *      class-under-test class)
 * @see ServantManagerTests ServantManagerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ServantManagerClassTests<SUT extends org.omg.PortableServer.ServantManager>
extends ServantManagerOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ServantManager.class!",
                   org.omg.PortableServer.ServantManager.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ServantManager
 * public abstract interface org.omg.PortableServer.ServantManager}.
 *
...
public abstract interface ServantManagerClassTests<SUT extends ServantManager>
extends ServantManagerOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ServantManager.class!",

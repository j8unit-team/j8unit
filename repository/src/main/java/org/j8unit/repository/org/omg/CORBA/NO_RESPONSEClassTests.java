 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NO_RESPONSE public
 * final class org.omg.CORBA.NO_RESPONSE}.
 *
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NO_RESPONSE.class!",
                   NO_RESPONSE.class.isAssignableFrom(sut));
    }

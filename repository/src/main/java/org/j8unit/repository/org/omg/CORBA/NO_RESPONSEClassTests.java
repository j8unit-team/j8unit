 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NO_RESPONSETests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.NO_RESPONSE class org.omg.CORBA.NO_RESPONSE (the hereby targeted class-under-test class)
 * @see NO_RESPONSETests NO_RESPONSETests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.NO_RESPONSE.class!",
                   org.omg.CORBA.NO_RESPONSE.class.isAssignableFrom(sut));
    }

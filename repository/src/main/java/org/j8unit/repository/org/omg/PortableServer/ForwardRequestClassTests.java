 ...
 * org.omg.PortableServer.ForwardRequest}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see org.omg.PortableServer.ForwardRequest class org.omg.PortableServer.ForwardRequest (the hereby targeted
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ForwardRequest.class!",
                   org.omg.PortableServer.ForwardRequest.class.isAssignableFrom(sut));
    }

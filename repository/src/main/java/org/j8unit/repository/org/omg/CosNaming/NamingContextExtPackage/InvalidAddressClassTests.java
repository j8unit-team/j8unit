...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CosNaming.NamingContextExtPackage.InvalidAddress class
 * org.omg.CosNaming.NamingContextExtPackage.InvalidAddress}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidAddressTests}).
 * </p>
 *
 * <p>
 ...
 * @see InvalidAddressTests InvalidAddressTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextExtPackage.InvalidAddress.class!",
                   org.omg.CosNaming.NamingContextExtPackage.InvalidAddress.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvalidAddress
 * public final class org.omg.CosNaming.NamingContextExtPackage.InvalidAddress}.
 *
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidAddress.class!",

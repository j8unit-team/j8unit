 ...
 * org.omg.DynamicAny._DynStructStub}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _DynStructStubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link _DynStructStubTests}.
 * </p>
 *
 * @see org.omg.DynamicAny._DynStructStub class org.omg.DynamicAny._DynStructStub (the hereby targeted class-under-test
 *      class)
 * @see _DynStructStubTests _DynStructStubTests (The complementary j8unit test interface containing the instance
...
extends DynStructClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny._DynStructStub.class!",
                   org.omg.DynamicAny._DynStructStub.class.isAssignableFrom(sut));
    }

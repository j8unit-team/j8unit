 ...
 * @since 0.9.0
 *
 * @j8unit.aim org.omg.CosNaming.Binding
 */
@FunctionalInterface
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
     ...
     * </p>
     *
     * @j8unit.aim org.omg.CosNaming.Binding#Binding()
     */
     ...
     * </p>
     *
     * @j8unit.aim org.omg.CosNaming.Binding#Binding(org.omg.CosNaming.NameComponent[], org.omg.CosNaming.BindingType)
     */
    @Ignore("With your help at http://www.j8unit.org this marker method will be replaced by meaningful test methods soon.")
    @Test
    @Category(Draft.class)
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.CosNaming.Binding sut = null; // = new Binding(org.omg.CosNaming.NameComponent[],
     ...
     * @since 0.9.2
     *
     * @j8unit.aim org.omg.CosNaming.Binding#isAssignableFrom(java.lang.Class)
     */
    @Override
    @Test

...
public abstract interface AdapterActivatorOperationsClassTests<SUT extends AdapterActivatorOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterActivatorOperations.class!",
                   AdapterActivatorOperations.class.isAssignableFrom(sut));
    }

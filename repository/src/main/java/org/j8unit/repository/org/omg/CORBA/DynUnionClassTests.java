...
public abstract interface DynUnionClassTests<SUT extends org.omg.CORBA.DynUnion>
extends ObjectClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynUnion.class!",
                   org.omg.CORBA.DynUnion.class.isAssignableFrom(sut));
    }

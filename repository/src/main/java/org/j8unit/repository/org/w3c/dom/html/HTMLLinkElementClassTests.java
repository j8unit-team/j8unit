 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLLinkElement
 * public abstract interface org.w3c.dom.html.HTMLLinkElement}.
 *
...
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLLinkElement.class!",
                   HTMLLinkElement.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CodecFactoryHelper
 * public abstract class org.omg.IOP.CodecFactoryHelper}.
 *
...
public abstract interface CodecFactoryHelperClassTests<SUT extends CodecFactoryHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.IOP.CodecFactoryHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CodecFactoryHelper.class!",
                   CodecFactoryHelper.class.isAssignableFrom(sut));
    }

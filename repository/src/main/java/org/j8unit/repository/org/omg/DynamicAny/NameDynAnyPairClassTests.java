 ...
 * org.omg.DynamicAny.NameDynAnyPair}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NameDynAnyPairTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NameDynAnyPairTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.NameDynAnyPair class org.omg.DynamicAny.NameDynAnyPair (the hereby targeted class-under-test
 *      class)
 * @see NameDynAnyPairTests NameDynAnyPairTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.NameDynAnyPair.class!",
                   org.omg.DynamicAny.NameDynAnyPair.class.isAssignableFrom(sut));
    }

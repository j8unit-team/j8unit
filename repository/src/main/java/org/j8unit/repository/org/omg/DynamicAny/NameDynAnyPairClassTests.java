 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameDynAnyPair
...
public abstract interface NameDynAnyPairClassTests<SUT extends NameDynAnyPair>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameDynAnyPair.class!",
                   NameDynAnyPair.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InvokeHandler
 * public abstract interface org.omg.CORBA.portable.InvokeHandler}.
 *
...
public abstract interface InvokeHandlerClassTests<SUT extends InvokeHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvokeHandler.class!",
                   InvokeHandler.class.isAssignableFrom(sut));
    }

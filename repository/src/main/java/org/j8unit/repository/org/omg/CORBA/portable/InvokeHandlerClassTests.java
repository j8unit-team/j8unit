 ...
 * org.omg.CORBA.portable.InvokeHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvokeHandlerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link InvokeHandlerTests}.
 * </p>
 *
 * @see org.omg.CORBA.portable.InvokeHandler interface org.omg.CORBA.portable.InvokeHandler (the hereby targeted
 *      class-under-test class)
 * @see InvokeHandlerTests InvokeHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface InvokeHandlerClassTests<SUT extends org.omg.CORBA.portable.InvokeHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.InvokeHandler.class!",
                   org.omg.CORBA.portable.InvokeHandler.class.isAssignableFrom(sut));
    }

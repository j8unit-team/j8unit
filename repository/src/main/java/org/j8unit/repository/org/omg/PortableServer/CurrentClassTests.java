 ...
 * org.omg.PortableServer.Current}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CurrentTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableServer.Current interface org.omg.PortableServer.Current (the hereby targeted class-under-test
 *      class)
 * @see CurrentTests CurrentTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface CurrentClassTests<SUT extends org.omg.PortableServer.Current>
...
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.Current.class!",
                   org.omg.PortableServer.Current.class.isAssignableFrom(sut));
    }

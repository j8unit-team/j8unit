 ...
 * org.omg.DynamicAny.DynEnumOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynEnumOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * @see DynEnumOperationsTests DynEnumOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface DynEnumOperationsClassTests<SUT extends org.omg.DynamicAny.DynEnumOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynEnumOperations.class!",
                   org.omg.DynamicAny.DynEnumOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynEnumOperations
 * public abstract interface org.omg.DynamicAny.DynEnumOperations}.
 *
...
extends org.j8unit.repository.org.omg.DynamicAny.DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynEnumOperations.class!",
                   DynEnumOperations.class.isAssignableFrom(sut));
    }

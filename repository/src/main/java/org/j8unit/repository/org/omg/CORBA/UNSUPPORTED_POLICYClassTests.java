...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.UNSUPPORTED_POLICY interface
 * org.omg.CORBA.UNSUPPORTED_POLICY}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UNSUPPORTED_POLICYTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.UNSUPPORTED_POLICY interface org.omg.CORBA.UNSUPPORTED_POLICY (the hereby targeted
 *      class-under-test class)
 * @see UNSUPPORTED_POLICYTests UNSUPPORTED_POLICYTests (The complementary j8unit test interface containing the instance
...
public abstract interface UNSUPPORTED_POLICYClassTests<SUT extends org.omg.CORBA.UNSUPPORTED_POLICY>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.UNSUPPORTED_POLICY.class!",
                   org.omg.CORBA.UNSUPPORTED_POLICY.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UNSUPPORTED_POLICY
 * public abstract interface org.omg.CORBA.UNSUPPORTED_POLICY}.
 *
...
public abstract interface UNSUPPORTED_POLICYClassTests<SUT extends UNSUPPORTED_POLICY>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UNSUPPORTED_POLICY.class!",
                   UNSUPPORTED_POLICY.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OctetSeqHelper
 * public abstract class org.omg.CORBA.OctetSeqHelper}.
 *
...
public abstract interface OctetSeqHelperClassTests<SUT extends OctetSeqHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.OctetSeqHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OctetSeqHelper.class!",
                   OctetSeqHelper.class.isAssignableFrom(sut));
    }

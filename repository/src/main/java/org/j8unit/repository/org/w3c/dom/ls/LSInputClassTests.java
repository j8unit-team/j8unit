 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSInput public
 * abstract interface org.w3c.dom.ls.LSInput}.
 *
...
public abstract interface LSInputClassTests<SUT extends LSInput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSInput.class!",
                   LSInput.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSInputTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link LSInputTests}.
 * </p>
 *
 * @see org.w3c.dom.ls.LSInput interface org.w3c.dom.ls.LSInput (the hereby targeted class-under-test class)
 * @see LSInputTests LSInputTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface LSInputClassTests<SUT extends org.w3c.dom.ls.LSInput>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSInput.class!",
                   org.w3c.dom.ls.LSInput.class.isAssignableFrom(sut));
    }

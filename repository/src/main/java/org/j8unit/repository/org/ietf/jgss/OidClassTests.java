 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Oid public class
 * org.ietf.jgss.Oid}.
 *
...
public abstract interface OidClassTests<SUT extends Oid>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Oid.class!", Oid.class.isAssignableFrom(sut));
    }

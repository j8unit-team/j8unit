 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link InputStream public
 * abstract class org.omg.CORBA.portable.InputStream}.
 *
...
public abstract interface InputStreamClassTests<SUT extends InputStream>
extends org.j8unit.repository.java.io.InputStreamClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.portable.InputStream]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InputStream.class!",
                   InputStream.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.portable.InputStream]

    // J8UNIT-MARKER-[END]-[CLASS]-[org.omg.CORBA.portable.InputStream]

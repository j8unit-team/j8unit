 ...
 * org.omg.CORBA.portable.InputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
extends org.j8unit.repository.java.io.InputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.InputStream.class!",
                   org.omg.CORBA.portable.InputStream.class.isAssignableFrom(sut));
    }

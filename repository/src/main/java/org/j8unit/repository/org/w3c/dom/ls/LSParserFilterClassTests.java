 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSParserFilter
 * public abstract interface org.w3c.dom.ls.LSParserFilter}.
 *
...
public abstract interface LSParserFilterClassTests<SUT extends LSParserFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSParserFilter.class!",
                   LSParserFilter.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.ls.LSParserFilter interface org.w3c.dom.ls.LSParserFilter}
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSParserFilterTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see LSParserFilterTests LSParserFilterTests (The complementary j8unit test interface containing the instance
...
public abstract interface LSParserFilterClassTests<SUT extends org.w3c.dom.ls.LSParserFilter>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSParserFilter.class!",
                   org.w3c.dom.ls.LSParserFilter.class.isAssignableFrom(sut));
    }

 ...
 * org.w3c.dom.events.EventException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EventExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EventExceptionTests}.
 * </p>
 *
 * @see org.w3c.dom.events.EventException class org.w3c.dom.events.EventException (the hereby targeted class-under-test
 *      class)
 * @see EventExceptionTests EventExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.java.lang.RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.events.EventException.class!",
                   org.w3c.dom.events.EventException.class.isAssignableFrom(sut));
    }

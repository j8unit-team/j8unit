 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EventException
...
public abstract interface EventExceptionClassTests<SUT extends EventException>
extends RuntimeExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EventException.class!",

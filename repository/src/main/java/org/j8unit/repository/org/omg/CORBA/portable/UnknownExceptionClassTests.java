 ...
 * org.omg.CORBA.portable.UnknownException}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link UnknownExceptionTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link UnknownExceptionTests}.
 * </p>
 *
 * @see org.omg.CORBA.portable.UnknownException class org.omg.CORBA.portable.UnknownException (the hereby targeted
 *      class-under-test class)
 * @see UnknownExceptionTests UnknownExceptionTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.UnknownException.class!",
                   org.omg.CORBA.portable.UnknownException.class.isAssignableFrom(sut));
    }

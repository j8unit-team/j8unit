 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnknownException
 * public class org.omg.CORBA.portable.UnknownException}.
 *
...
public abstract interface UnknownExceptionClassTests<SUT extends UnknownException>
extends SystemExceptionClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.CORBA.portable.UnknownException]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnknownException.class!",
                   UnknownException.class.isAssignableFrom(sut));
    }

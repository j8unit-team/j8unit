...
import org.j8unit.repository.org.xml.sax.helpers.AttributesImplClassTests;
 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Attributes2Impl
...
public abstract interface Attributes2ImplClassTests<SUT extends Attributes2Impl>
extends Attributes2ClassTests<SUT>, AttributesImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Attributes2Impl.class!",
                   Attributes2Impl.class.isAssignableFrom(sut));
    }

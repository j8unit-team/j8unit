 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link Attributes2ImplTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link Attributes2ImplTests}.
 * </p>
 *
 * @see org.xml.sax.ext.Attributes2Impl class org.xml.sax.ext.Attributes2Impl (the hereby targeted class-under-test
 *      class)
 * @see Attributes2ImplTests Attributes2ImplTests (The complementary j8unit test interface containing the instance
...
extends Attributes2ClassTests<SUT>, org.j8unit.repository.org.xml.sax.helpers.AttributesImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ext.Attributes2Impl.class!",
                   org.xml.sax.ext.Attributes2Impl.class.isAssignableFrom(sut));
    }

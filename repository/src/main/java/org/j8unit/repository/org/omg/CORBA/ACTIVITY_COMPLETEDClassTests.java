 ...
 * org.omg.CORBA.ACTIVITY_COMPLETED}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ACTIVITY_COMPLETEDTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.ACTIVITY_COMPLETED class org.omg.CORBA.ACTIVITY_COMPLETED (the hereby targeted class-under-test
 *      class)
 * @see ACTIVITY_COMPLETEDTests ACTIVITY_COMPLETEDTests (The complementary j8unit test interface containing the instance
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ACTIVITY_COMPLETED.class!",
                   org.omg.CORBA.ACTIVITY_COMPLETED.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ACTIVITY_COMPLETED
 * public final class org.omg.CORBA.ACTIVITY_COMPLETED}.
 *
...
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ACTIVITY_COMPLETED.class!",
                   ACTIVITY_COMPLETED.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynArrayTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.DynArray interface org.omg.CORBA.DynArray (the hereby targeted class-under-test class)
 * @see DynArrayTests DynArrayTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface DynArrayClassTests<SUT extends org.omg.CORBA.DynArray>
extends ObjectClassTests<SUT>, DynAnyClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DynArray.class!",
                   org.omg.CORBA.DynArray.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CORBA.portable.ResponseHandler}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ResponseHandlerTests}).
 * </p>
 *
 * <p>
 ...
 * @see ResponseHandlerTests ResponseHandlerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ResponseHandlerClassTests<SUT extends org.omg.CORBA.portable.ResponseHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.ResponseHandler.class!",
                   org.omg.CORBA.portable.ResponseHandler.class.isAssignableFrom(sut));
    }

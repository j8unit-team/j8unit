 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ResponseHandler
...
public abstract interface ResponseHandlerClassTests<SUT extends ResponseHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ResponseHandler.class!",
                   ResponseHandler.class.isAssignableFrom(sut));
    }

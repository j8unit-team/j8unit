...
public abstract interface AdapterAlreadyExistsHelperClassTests<SUT extends AdapterAlreadyExistsHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.PortableServer.POAPackage.AdapterAlreadyExistsHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterAlreadyExistsHelper.class!",
                   AdapterAlreadyExistsHelper.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NameValuePairTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.NameValuePair class org.omg.CORBA.NameValuePair (the hereby targeted class-under-test class)
 * @see NameValuePairTests NameValuePairTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.NameValuePair.class!",
                   org.omg.CORBA.NameValuePair.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameValuePair
 * public final class org.omg.CORBA.NameValuePair}.
 *
...
public abstract interface NameValuePairClassTests<SUT extends NameValuePair>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameValuePair.class!",
                   NameValuePair.class.isAssignableFrom(sut));
    }

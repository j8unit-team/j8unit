 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link StringSeqHolder
 * public final class org.omg.CORBA.StringSeqHolder}.
 *
...
public abstract interface StringSeqHolderClassTests<SUT extends StringSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to StringSeqHolder.class!",
                   StringSeqHolder.class.isAssignableFrom(sut));
    }

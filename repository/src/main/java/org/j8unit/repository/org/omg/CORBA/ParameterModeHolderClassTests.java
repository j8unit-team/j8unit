 ...
 * org.omg.CORBA.ParameterModeHolder}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ParameterModeHolderTests}).
 * </p>
 *
 * <p>
 ...
 *      class)
 * @see ParameterModeHolderTests ParameterModeHolderTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ParameterModeHolder.class!",
                   org.omg.CORBA.ParameterModeHolder.class.isAssignableFrom(sut));
    }

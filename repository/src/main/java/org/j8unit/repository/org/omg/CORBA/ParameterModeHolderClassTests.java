 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParameterModeHolder
 * public final class org.omg.CORBA.ParameterModeHolder}.
 *
...
public abstract interface ParameterModeHolderClassTests<SUT extends ParameterModeHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParameterModeHolder.class!",
                   ParameterModeHolder.class.isAssignableFrom(sut));
    }

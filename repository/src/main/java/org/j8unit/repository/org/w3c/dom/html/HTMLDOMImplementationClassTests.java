...
public abstract interface HTMLDOMImplementationClassTests<SUT extends HTMLDOMImplementation>
extends DOMImplementationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLDOMImplementation.class!",
                   HTMLDOMImplementation.class.isAssignableFrom(sut));
    }

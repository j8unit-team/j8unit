...
public abstract interface RequestProcessingPolicyValueClassTests<SUT extends RequestProcessingPolicyValue>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RequestProcessingPolicyValue.class!",
                   RequestProcessingPolicyValue.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DocumentView public
 * abstract interface org.w3c.dom.views.DocumentView}.
 *
...
public abstract interface DocumentViewClassTests<SUT extends DocumentView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DocumentView.class!",
                   DocumentView.class.isAssignableFrom(sut));
    }

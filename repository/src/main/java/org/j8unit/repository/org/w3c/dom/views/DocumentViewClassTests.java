...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.views.DocumentView interface
 * org.w3c.dom.views.DocumentView}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DocumentViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DocumentViewTests}.
 * </p>
 *
 * @see org.w3c.dom.views.DocumentView interface org.w3c.dom.views.DocumentView (the hereby targeted class-under-test
 *      class)
 * @see DocumentViewTests DocumentViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface DocumentViewClassTests<SUT extends org.w3c.dom.views.DocumentView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.views.DocumentView.class!",
                   org.w3c.dom.views.DocumentView.class.isAssignableFrom(sut));
    }

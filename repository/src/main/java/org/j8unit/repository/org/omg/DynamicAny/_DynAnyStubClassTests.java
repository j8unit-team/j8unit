 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _DynAnyStubTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link _DynAnyStubTests}.
 * </p>
 *
 * @see org.omg.DynamicAny._DynAnyStub class org.omg.DynamicAny._DynAnyStub (the hereby targeted class-under-test class)
 * @see _DynAnyStubTests _DynAnyStubTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface _DynAnyStubClassTests<SUT extends org.omg.DynamicAny._DynAnyStub>
extends DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny._DynAnyStub.class!",
                   org.omg.DynamicAny._DynAnyStub.class.isAssignableFrom(sut));
    }

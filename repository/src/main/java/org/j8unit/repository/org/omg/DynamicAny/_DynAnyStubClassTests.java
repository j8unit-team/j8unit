 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _DynAnyStub public
...
public abstract interface _DynAnyStubClassTests<SUT extends _DynAnyStub>
extends org.j8unit.repository.org.omg.DynamicAny.DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _DynAnyStub.class!",
                   _DynAnyStub.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CSSValueListTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CSSValueListTests}.
 * </p>
 *
 * @see org.w3c.dom.css.CSSValueList interface org.w3c.dom.css.CSSValueList (the hereby targeted class-under-test class)
 * @see CSSValueListTests CSSValueListTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CSSValueListClassTests<SUT extends org.w3c.dom.css.CSSValueList>
extends CSSValueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.css.CSSValueList.class!",
                   org.w3c.dom.css.CSSValueList.class.isAssignableFrom(sut));
    }

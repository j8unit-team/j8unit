 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CSSValueList public
 * abstract interface org.w3c.dom.css.CSSValueList}.
 *
...
public abstract interface CSSValueListClassTests<SUT extends CSSValueList>
extends CSSValueClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CSSValueList.class!",
                   CSSValueList.class.isAssignableFrom(sut));
    }

...
public abstract interface DynEnumClassTests<SUT extends org.omg.DynamicAny.DynEnum>
extends DynEnumOperationsClassTests<SUT>, DynAnyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynEnum.class!",
                   org.omg.DynamicAny.DynEnum.class.isAssignableFrom(sut));
    }

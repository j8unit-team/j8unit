 ...
 * org.w3c.dom.ProcessingInstruction}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
...
public abstract interface ProcessingInstructionClassTests<SUT extends org.w3c.dom.ProcessingInstruction>
extends NodeClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ProcessingInstruction.class!",
                   org.w3c.dom.ProcessingInstruction.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VM_CUSTOM public
 * abstract interface org.omg.CORBA.VM_CUSTOM}.
 *
...
public abstract interface VM_CUSTOMClassTests<SUT extends VM_CUSTOM>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VM_CUSTOM.class!",

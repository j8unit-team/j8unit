 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VM_CUSTOMTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link VM_CUSTOMTests}.
 * </p>
 *
 * @see org.omg.CORBA.VM_CUSTOM interface org.omg.CORBA.VM_CUSTOM (the hereby targeted class-under-test class)
 * @see VM_CUSTOMTests VM_CUSTOMTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface VM_CUSTOMClassTests<SUT extends org.omg.CORBA.VM_CUSTOM>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.VM_CUSTOM.class!",
                   org.omg.CORBA.VM_CUSTOM.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.ietf.jgss.GSSName interface org.ietf.jgss.GSSName}, containing all
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link GSSNameTests}).
 * </p>
 *
 * <p>
 ...
 * @see GSSNameTests GSSNameTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface GSSNameClassTests<SUT extends org.ietf.jgss.GSSName>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.ietf.jgss.GSSName.class!",
                   org.ietf.jgss.GSSName.class.isAssignableFrom(sut));
    }

...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    public default void create_ObjectNotActiveHelper()
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.PortableServer.POAPackage.ObjectNotActiveHelper sut = null; // = new ObjectNotActiveHelper();
    }
    ...
    @Test
    @Category(Draft.class)
    public default void test_insert_Any_ObjectNotActive()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;
    ...
    @Test
    @Category(Draft.class)
    public default void test_write_OutputStream_ObjectNotActive()
    throws Exception {
        // query fresh subject-under-test
        final Class<SUT> sut = this.createNewSUT();
        assert sut != null;

 ...
 * {@link ObjectNotActiveHelper public abstract class org.omg.PortableServer.POAPackage.ObjectNotActiveHelper}.
 *
...
public abstract interface ObjectNotActiveHelperClassTests<SUT extends ObjectNotActiveHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectNotActiveHelper.class!",
                   ObjectNotActiveHelper.class.isAssignableFrom(sut));
    }

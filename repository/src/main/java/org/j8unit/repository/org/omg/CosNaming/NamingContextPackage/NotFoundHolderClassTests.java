 ...
 * org.omg.CosNaming.NamingContextPackage.NotFoundHolder}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NotFoundHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link NotFoundHolderTests}.
 * </p>
 *
 ...
 * @see NotFoundHolderTests NotFoundHolderTests (The complementary j8unit test interface containing the instance
...
public abstract interface NotFoundHolderClassTests<SUT extends org.omg.CosNaming.NamingContextPackage.NotFoundHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextPackage.NotFoundHolder.class!",
                   org.omg.CosNaming.NamingContextPackage.NotFoundHolder.class.isAssignableFrom(sut));
    }

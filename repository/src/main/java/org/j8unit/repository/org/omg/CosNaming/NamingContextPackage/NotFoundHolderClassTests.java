 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NotFoundHolder
...
public abstract interface NotFoundHolderClassTests<SUT extends NotFoundHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NotFoundHolder.class!",
                   NotFoundHolder.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CurrentOperations
 * public abstract interface org.omg.PortableInterceptor.CurrentOperations}.
 *
...
public abstract interface CurrentOperationsClassTests<SUT extends CurrentOperations>
extends org.j8unit.repository.org.omg.CORBA.CurrentOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CurrentOperations.class!",
                   CurrentOperations.class.isAssignableFrom(sut));
    }

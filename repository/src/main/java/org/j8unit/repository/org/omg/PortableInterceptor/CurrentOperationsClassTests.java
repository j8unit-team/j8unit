 ...
 * org.omg.PortableInterceptor.CurrentOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
...
public abstract interface CurrentOperationsClassTests<SUT extends org.omg.PortableInterceptor.CurrentOperations>
extends org.j8unit.repository.org.omg.CORBA.CurrentOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.CurrentOperations.class!",
                   org.omg.PortableInterceptor.CurrentOperations.class.isAssignableFrom(sut));
    }

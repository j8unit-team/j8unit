 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleSeqHolder
...
public abstract interface DoubleSeqHolderClassTests<SUT extends DoubleSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleSeqHolder.class!",
                   DoubleSeqHolder.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.DoubleSeqHolder]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link USER_EXCEPTION
 * public abstract interface org.omg.PortableInterceptor.USER_EXCEPTION}.
 *
...
public abstract interface USER_EXCEPTIONClassTests<SUT extends USER_EXCEPTION>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to USER_EXCEPTION.class!",
                   USER_EXCEPTION.class.isAssignableFrom(sut));
    }

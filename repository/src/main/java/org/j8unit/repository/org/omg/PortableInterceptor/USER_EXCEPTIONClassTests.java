...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.USER_EXCEPTION interface
 * org.omg.PortableInterceptor.USER_EXCEPTION}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link USER_EXCEPTIONTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link USER_EXCEPTIONTests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.USER_EXCEPTION interface org.omg.PortableInterceptor.USER_EXCEPTION (the hereby
 *      targeted class-under-test class)
 * @see USER_EXCEPTIONTests USER_EXCEPTIONTests (The complementary j8unit test interface containing the instance
...
public abstract interface USER_EXCEPTIONClassTests<SUT extends org.omg.PortableInterceptor.USER_EXCEPTION>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.USER_EXCEPTION.class!",
                   org.omg.PortableInterceptor.USER_EXCEPTION.class.isAssignableFrom(sut));
    }

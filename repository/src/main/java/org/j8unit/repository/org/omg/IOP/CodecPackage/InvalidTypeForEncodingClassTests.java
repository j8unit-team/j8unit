 ...
 * org.omg.IOP.CodecPackage.InvalidTypeForEncoding}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link InvalidTypeForEncodingTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.IOP.CodecPackage.InvalidTypeForEncoding class org.omg.IOP.CodecPackage.InvalidTypeForEncoding (the
 *      hereby targeted class-under-test class)
 * @see InvalidTypeForEncodingTests InvalidTypeForEncodingTests (The complementary j8unit test interface containing the
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.CodecPackage.InvalidTypeForEncoding.class!",
                   org.omg.IOP.CodecPackage.InvalidTypeForEncoding.class.isAssignableFrom(sut));
    }

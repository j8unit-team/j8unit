...
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to InvalidTypeForEncoding.class!",
                   InvalidTypeForEncoding.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.LifespanPolicyOperations interface
 * org.omg.PortableServer.LifespanPolicyOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LifespanPolicyOperationsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see LifespanPolicyOperationsTests LifespanPolicyOperationsTests (The complementary j8unit test interface containing
...
public abstract interface LifespanPolicyOperationsClassTests<SUT extends org.omg.PortableServer.LifespanPolicyOperations>
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.LifespanPolicyOperations.class!",
                   org.omg.PortableServer.LifespanPolicyOperations.class.isAssignableFrom(sut));
    }

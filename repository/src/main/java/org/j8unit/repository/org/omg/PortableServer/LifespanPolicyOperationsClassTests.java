...
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LifespanPolicyOperations.class!",
                   LifespanPolicyOperations.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IRObjectOperations
 * public abstract interface org.omg.CORBA.IRObjectOperations}.
 *
...
public abstract interface IRObjectOperationsClassTests<SUT extends IRObjectOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IRObjectOperations.class!",
                   IRObjectOperations.class.isAssignableFrom(sut));
    }

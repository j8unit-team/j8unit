...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.IRObjectOperations interface
 * org.omg.CORBA.IRObjectOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IRObjectOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link IRObjectOperationsTests}.
 * </p>
 *
 * @see org.omg.CORBA.IRObjectOperations interface org.omg.CORBA.IRObjectOperations (the hereby targeted
 *      class-under-test class)
 * @see IRObjectOperationsTests IRObjectOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface IRObjectOperationsClassTests<SUT extends org.omg.CORBA.IRObjectOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.IRObjectOperations.class!",
                   org.omg.CORBA.IRObjectOperations.class.isAssignableFrom(sut));
    }

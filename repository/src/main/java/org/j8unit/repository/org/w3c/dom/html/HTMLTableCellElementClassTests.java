...
public abstract interface HTMLTableCellElementClassTests<SUT extends HTMLTableCellElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLTableCellElement.class!",
                   HTMLTableCellElement.class.isAssignableFrom(sut));
    }

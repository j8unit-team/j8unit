...
public abstract interface CommentClassTests<SUT extends org.w3c.dom.Comment>
extends CharacterDataClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.Comment.class!",
                   org.w3c.dom.Comment.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link Comment public
 * abstract interface org.w3c.dom.Comment}.
 *
...
public abstract interface CommentClassTests<SUT extends Comment>
extends CharacterDataClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to Comment.class!",
                   Comment.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.w3c.dom.Comment]

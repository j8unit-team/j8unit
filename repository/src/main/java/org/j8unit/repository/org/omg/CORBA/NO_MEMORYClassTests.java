 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NO_MEMORYTests}).
 * </p>
 *
 * <p>
 ...
 * @see NO_MEMORYTests NO_MEMORYTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.NO_MEMORY.class!",
                   org.omg.CORBA.NO_MEMORY.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NO_MEMORY public
 * final class org.omg.CORBA.NO_MEMORY}.
 *
...
public abstract interface NO_MEMORYClassTests<SUT extends NO_MEMORY>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NO_MEMORY.class!",
                   NO_MEMORY.class.isAssignableFrom(sut));
    }

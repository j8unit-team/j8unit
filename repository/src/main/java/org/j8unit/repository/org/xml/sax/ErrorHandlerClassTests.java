 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ErrorHandlerTests}).
 * </p>
 *
 * <p>
 ...
 * @see ErrorHandlerTests ErrorHandlerTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface ErrorHandlerClassTests<SUT extends org.xml.sax.ErrorHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.ErrorHandler.class!",
                   org.xml.sax.ErrorHandler.class.isAssignableFrom(sut));
    }

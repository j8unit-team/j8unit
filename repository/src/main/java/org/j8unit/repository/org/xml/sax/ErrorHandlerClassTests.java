 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ErrorHandler public
 * abstract interface org.xml.sax.ErrorHandler}.
 *
...
public abstract interface ErrorHandlerClassTests<SUT extends ErrorHandler>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ErrorHandler.class!",

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLSelectElement
 * public abstract interface org.w3c.dom.html.HTMLSelectElement}.
 *
...
public abstract interface HTMLSelectElementClassTests<SUT extends HTMLSelectElement>
extends HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLSelectElement.class!",
                   HTMLSelectElement.class.isAssignableFrom(sut));
    }

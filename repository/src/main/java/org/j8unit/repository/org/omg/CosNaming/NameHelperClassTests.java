 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link NameHelper public
 * abstract class org.omg.CosNaming.NameHelper}.
 *
...
public abstract interface NameHelperClassTests<SUT extends NameHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NameHelper.class!",
                   NameHelper.class.isAssignableFrom(sut));
    }

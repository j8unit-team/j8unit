 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ParameterModeHelper
 * public abstract class org.omg.CORBA.ParameterModeHelper}.
 *
...
public abstract interface ParameterModeHelperClassTests<SUT extends ParameterModeHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ParameterModeHelper.class!",
                   ParameterModeHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DOMConfiguration
 * public abstract interface org.w3c.dom.DOMConfiguration}.
 *
...
public abstract interface DOMConfigurationClassTests<SUT extends DOMConfiguration>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DOMConfiguration.class!",
                   DOMConfiguration.class.isAssignableFrom(sut));
    }

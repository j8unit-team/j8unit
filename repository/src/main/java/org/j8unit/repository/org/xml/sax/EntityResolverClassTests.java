 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link EntityResolver
 * public abstract interface org.xml.sax.EntityResolver}.
 *
...
public abstract interface EntityResolverClassTests<SUT extends EntityResolver>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to EntityResolver.class!",
                   EntityResolver.class.isAssignableFrom(sut));
    }

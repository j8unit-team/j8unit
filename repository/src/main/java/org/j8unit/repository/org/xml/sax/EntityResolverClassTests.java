 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link EntityResolverTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link EntityResolverTests}.
 * </p>
 *
 * @see org.xml.sax.EntityResolver interface org.xml.sax.EntityResolver (the hereby targeted class-under-test class)
 * @see EntityResolverTests EntityResolverTests (The complementary j8unit test interface containing the instance
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.xml.sax.EntityResolver.class!",
                   org.xml.sax.EntityResolver.class.isAssignableFrom(sut));
    }

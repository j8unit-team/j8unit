...
/**
 * <p>
 * Test class for {@link org.omg.CORBA.BAD_OPERATION class org.omg.CORBA.BAD_OPERATION}, containing all class relevant
...
extends org.j8unit.repository.org.omg.CORBA.SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        // create new instance
        @SuppressWarnings("unused")
        final org.omg.CORBA.BAD_OPERATION sut = null; // = new
                                                      // BAD_OPERATION(java.lang.String,int,org.omg.CORBA.CompletionStatus);
    }

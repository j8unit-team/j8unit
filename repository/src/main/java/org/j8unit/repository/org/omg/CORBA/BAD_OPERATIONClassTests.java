 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_OPERATION
...
public abstract interface BAD_OPERATIONClassTests<SUT extends BAD_OPERATION>
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_OPERATION.class!",
                   BAD_OPERATION.class.isAssignableFrom(sut));
    }

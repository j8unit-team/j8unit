 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_OPERATIONTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link BAD_OPERATIONTests}.
 * </p>
 *
 * @see org.omg.CORBA.BAD_OPERATION class org.omg.CORBA.BAD_OPERATION (the hereby targeted class-under-test class)
 * @see BAD_OPERATIONTests BAD_OPERATIONTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_OPERATION.class!",
                   org.omg.CORBA.BAD_OPERATION.class.isAssignableFrom(sut));
    }

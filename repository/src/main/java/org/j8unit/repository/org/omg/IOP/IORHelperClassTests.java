 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link IORHelper public
 * abstract class org.omg.IOP.IORHelper}.
 *
...
public abstract interface IORHelperClassTests<SUT extends IORHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IORHelper.class!",
                   IORHelper.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Test class for {@link org.omg.IOP.IORHelper class org.omg.IOP.IORHelper}, containing all class relevant test methods
 * (at least the test methods of accessible constructors and of accessible {@code static} methods). The counterpart test
 * class containing the instance relevant test methods is {@link org.j8unit.repository.org.omg.IOP.IORHelperTests}.
 * </p>
 *
 * <p>

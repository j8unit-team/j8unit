 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link IORHelperTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.IOP.IORHelper class org.omg.IOP.IORHelper (the hereby targeted class-under-test class)
 * @see IORHelperTests IORHelperTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.IORHelper.class!",
                   org.omg.IOP.IORHelper.class.isAssignableFrom(sut));
    }

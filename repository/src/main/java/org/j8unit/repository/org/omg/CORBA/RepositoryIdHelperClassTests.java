 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RepositoryIdHelper
 * public abstract class org.omg.CORBA.RepositoryIdHelper}.
 *
...
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RepositoryIdHelper.class!",
                   RepositoryIdHelper.class.isAssignableFrom(sut));
    }

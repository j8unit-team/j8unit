 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link UnionMemberHelper
 * public abstract class org.omg.CORBA.UnionMemberHelper}.
 *
...
public abstract interface UnionMemberHelperClassTests<SUT extends UnionMemberHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to UnionMemberHelper.class!",
                   UnionMemberHelper.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DoubleSeqHelper
...
public abstract interface DoubleSeqHelperClassTests<SUT extends DoubleSeqHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DoubleSeqHelper.class!",
                   DoubleSeqHelper.class.isAssignableFrom(sut));
    }

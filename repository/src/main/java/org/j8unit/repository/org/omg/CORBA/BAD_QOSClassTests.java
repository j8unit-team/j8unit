 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BAD_QOSTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.BAD_QOS class org.omg.CORBA.BAD_QOS (the hereby targeted class-under-test class)
 * @see BAD_QOSTests BAD_QOSTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.BAD_QOS.class!",
                   org.omg.CORBA.BAD_QOS.class.isAssignableFrom(sut));
    }

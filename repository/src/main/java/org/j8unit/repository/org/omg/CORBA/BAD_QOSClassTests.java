 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BAD_QOS public
 * final class org.omg.CORBA.BAD_QOS}.
 *
...
extends SystemExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BAD_QOS.class!",
                   BAD_QOS.class.isAssignableFrom(sut));
    }

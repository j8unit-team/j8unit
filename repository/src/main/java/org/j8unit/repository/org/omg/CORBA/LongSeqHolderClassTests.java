 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LongSeqHolder
...
public abstract interface LongSeqHolderClassTests<SUT extends LongSeqHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LongSeqHolder.class!",
                   LongSeqHolder.class.isAssignableFrom(sut));
    }

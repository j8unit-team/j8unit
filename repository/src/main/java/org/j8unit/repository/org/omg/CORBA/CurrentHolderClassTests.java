 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CurrentHolder
...
public abstract interface CurrentHolderClassTests<SUT extends CurrentHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CurrentHolder.class!",
                   CurrentHolder.class.isAssignableFrom(sut));
    }

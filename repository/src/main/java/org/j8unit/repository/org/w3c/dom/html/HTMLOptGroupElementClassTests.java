 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link HTMLOptGroupElement
 * public abstract interface org.w3c.dom.html.HTMLOptGroupElement}.
 *
...
public abstract interface HTMLOptGroupElementClassTests<SUT extends HTMLOptGroupElement>
extends org.j8unit.repository.org.w3c.dom.html.HTMLElementClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to HTMLOptGroupElement.class!",
                   HTMLOptGroupElement.class.isAssignableFrom(sut));
    }

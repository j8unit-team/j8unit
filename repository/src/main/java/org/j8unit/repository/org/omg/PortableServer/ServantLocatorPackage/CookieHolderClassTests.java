 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link CookieHolder public
 * final class org.omg.PortableServer.ServantLocatorPackage.CookieHolder}.
 *
...
public abstract interface CookieHolderClassTests<SUT extends CookieHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to CookieHolder.class!",
                   CookieHolder.class.isAssignableFrom(sut));
    }

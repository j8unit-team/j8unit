...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableServer.ServantLocatorPackage.CookieHolder class
 * org.omg.PortableServer.ServantLocatorPackage.CookieHolder}, containing all type relevant aspects (e.&thinsp;g.,
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link CookieHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link CookieHolderTests}.
 * </p>
 *
 ...
 * @see CookieHolderTests CookieHolderTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface CookieHolderClassTests<SUT extends org.omg.PortableServer.ServantLocatorPackage.CookieHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.ServantLocatorPackage.CookieHolder.class!",
                   org.omg.PortableServer.ServantLocatorPackage.CookieHolder.class.isAssignableFrom(sut));
    }

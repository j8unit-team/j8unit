 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link TAG_ORB_TYPE public
 * abstract interface org.omg.IOP.TAG_ORB_TYPE}.
 *
...
public abstract interface TAG_ORB_TYPEClassTests<SUT extends TAG_ORB_TYPE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to TAG_ORB_TYPE.class!",

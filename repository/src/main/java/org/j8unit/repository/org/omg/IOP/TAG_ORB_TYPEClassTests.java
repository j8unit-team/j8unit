...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.IOP.TAG_ORB_TYPE interface org.omg.IOP.TAG_ORB_TYPE},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link TAG_ORB_TYPETests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link TAG_ORB_TYPETests}.
 * </p>
 *
 * @see org.omg.IOP.TAG_ORB_TYPE interface org.omg.IOP.TAG_ORB_TYPE (the hereby targeted class-under-test class)
 * @see TAG_ORB_TYPETests TAG_ORB_TYPETests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface TAG_ORB_TYPEClassTests<SUT extends org.omg.IOP.TAG_ORB_TYPE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.IOP.TAG_ORB_TYPE.class!",
                   org.omg.IOP.TAG_ORB_TYPE.class.isAssignableFrom(sut));
    }

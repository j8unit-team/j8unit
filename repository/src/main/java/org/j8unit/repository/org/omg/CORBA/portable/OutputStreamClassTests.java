 ...
 * org.omg.CORBA.portable.OutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * </p>
 *
 * @see org.omg.CORBA.portable.OutputStream class org.omg.CORBA.portable.OutputStream (the hereby targeted
...
public abstract interface OutputStreamClassTests<SUT extends org.omg.CORBA.portable.OutputStream>
extends org.j8unit.repository.java.io.OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.portable.OutputStream.class!",
                   org.omg.CORBA.portable.OutputStream.class.isAssignableFrom(sut));
    }

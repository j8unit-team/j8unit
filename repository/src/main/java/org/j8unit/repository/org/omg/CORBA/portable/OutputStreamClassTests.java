 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OutputStream public
 * abstract class org.omg.CORBA.portable.OutputStream}.
 *
...
public abstract interface OutputStreamClassTests<SUT extends OutputStream>
extends org.j8unit.repository.java.io.OutputStreamClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OutputStream.class!",
                   OutputStream.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.CORBA.portable.OutputStream]

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ShortHolderTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ShortHolderTests}.
 * </p>
 *
 * @see org.omg.CORBA.ShortHolder class org.omg.CORBA.ShortHolder (the hereby targeted class-under-test class)
 * @see ShortHolderTests ShortHolderTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ShortHolderClassTests<SUT extends org.omg.CORBA.ShortHolder>
extends org.j8unit.repository.org.omg.CORBA.portable.StreamableClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ShortHolder.class!",
                   org.omg.CORBA.ShortHolder.class.isAssignableFrom(sut));
    }

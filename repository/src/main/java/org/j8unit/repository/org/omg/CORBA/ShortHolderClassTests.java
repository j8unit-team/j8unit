 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ShortHolder public
 * final class org.omg.CORBA.ShortHolder}.
 *
...
public abstract interface ShortHolderClassTests<SUT extends ShortHolder>
extends StreamableClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ShortHolder.class!",
                   ShortHolder.class.isAssignableFrom(sut));
    }

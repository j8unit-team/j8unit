 ...
 * org.omg.CORBA.DataOutputStream}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DataOutputStreamTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.CORBA.DataOutputStream interface org.omg.CORBA.DataOutputStream (the hereby targeted class-under-test
 *      class)
 * @see DataOutputStreamTests DataOutputStreamTests (The complementary j8unit test interface containing the instance
...
public abstract interface DataOutputStreamClassTests<SUT extends org.omg.CORBA.DataOutputStream>
extends org.j8unit.repository.org.omg.CORBA.portable.ValueBaseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.DataOutputStream.class!",
                   org.omg.CORBA.DataOutputStream.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link LSSerializerFilter
 * public abstract interface org.w3c.dom.ls.LSSerializerFilter}.
 *
...
extends NodeFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to LSSerializerFilter.class!",
                   LSSerializerFilter.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.ls.LSSerializerFilter interface
 * org.w3c.dom.ls.LSSerializerFilter}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link LSSerializerFilterTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.w3c.dom.ls.LSSerializerFilter interface org.w3c.dom.ls.LSSerializerFilter (the hereby targeted
 *      class-under-test class)
 * @see LSSerializerFilterTests LSSerializerFilterTests (The complementary j8unit test interface containing the instance
...
public abstract interface LSSerializerFilterClassTests<SUT extends org.w3c.dom.ls.LSSerializerFilter>
extends org.j8unit.repository.org.w3c.dom.traversal.NodeFilterClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.ls.LSSerializerFilter.class!",
                   org.w3c.dom.ls.LSSerializerFilter.class.isAssignableFrom(sut));
    }

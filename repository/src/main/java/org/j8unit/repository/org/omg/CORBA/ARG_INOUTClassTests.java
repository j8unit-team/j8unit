 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ARG_INOUTTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ARG_INOUTTests}.
 * </p>
 *
 * @see org.omg.CORBA.ARG_INOUT interface org.omg.CORBA.ARG_INOUT (the hereby targeted class-under-test class)
 * @see ARG_INOUTTests ARG_INOUTTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.ARG_INOUT.class!",
                   org.omg.CORBA.ARG_INOUT.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ARG_INOUT public
 * abstract interface org.omg.CORBA.ARG_INOUT}.
 *
...
public abstract interface ARG_INOUTClassTests<SUT extends ARG_INOUT>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ARG_INOUT.class!",

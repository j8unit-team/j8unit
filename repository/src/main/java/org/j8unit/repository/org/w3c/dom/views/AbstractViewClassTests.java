...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.w3c.dom.views.AbstractView interface
 * org.w3c.dom.views.AbstractView}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and further
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AbstractViewTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AbstractViewTests}.
 * </p>
 *
 * @see org.w3c.dom.views.AbstractView interface org.w3c.dom.views.AbstractView (the hereby targeted class-under-test
 *      class)
 * @see AbstractViewTests AbstractViewTests (The complementary j8unit test interface containing the instance relevant
 *      test methods)
 *
 * @param SUT
...
public abstract interface AbstractViewClassTests<SUT extends org.w3c.dom.views.AbstractView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.w3c.dom.views.AbstractView.class!",
                   org.w3c.dom.views.AbstractView.class.isAssignableFrom(sut));
    }

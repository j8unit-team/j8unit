 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AbstractView public
 * abstract interface org.w3c.dom.views.AbstractView}.
 *
...
public abstract interface AbstractViewClassTests<SUT extends AbstractView>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AbstractView.class!",
                   AbstractView.class.isAssignableFrom(sut));
    }

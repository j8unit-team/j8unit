 ...
 * org.omg.CosNaming._BindingIteratorImplBase}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * @see _BindingIteratorImplBaseTests _BindingIteratorImplBaseTests (The complementary j8unit test interface containing
...
extends BindingIteratorClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.DynamicImplementationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming._BindingIteratorImplBase.class!",
                   org.omg.CosNaming._BindingIteratorImplBase.class.isAssignableFrom(sut));
    }

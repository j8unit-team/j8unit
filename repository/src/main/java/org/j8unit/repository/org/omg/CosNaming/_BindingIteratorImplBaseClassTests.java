...
extends BindingIteratorClassTests<SUT>, DynamicImplementationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _BindingIteratorImplBase.class!",
                   _BindingIteratorImplBase.class.isAssignableFrom(sut));
    }

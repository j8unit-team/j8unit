 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AdapterNonExistent
 * public final class org.omg.PortableServer.POAPackage.AdapterNonExistent}.
 *
...
public abstract interface AdapterNonExistentClassTests<SUT extends AdapterNonExistent>
extends UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AdapterNonExistent.class!",

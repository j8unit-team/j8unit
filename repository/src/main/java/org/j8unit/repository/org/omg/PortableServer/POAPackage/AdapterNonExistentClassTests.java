 ...
 * org.omg.PortableServer.POAPackage.AdapterNonExistent}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link AdapterNonExistentTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link AdapterNonExistentTests}.
 * </p>
 *
 ...
 * @see AdapterNonExistentTests AdapterNonExistentTests (The complementary j8unit test interface containing the instance
...
extends org.j8unit.repository.org.omg.CORBA.UserExceptionClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.POAPackage.AdapterNonExistent.class!",
                   org.omg.PortableServer.POAPackage.AdapterNonExistent.class.isAssignableFrom(sut));
    }

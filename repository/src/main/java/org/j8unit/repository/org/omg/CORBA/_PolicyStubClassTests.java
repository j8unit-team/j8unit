 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link _PolicyStub public
...
public abstract interface _PolicyStubClassTests<SUT extends _PolicyStub>
extends org.j8unit.repository.org.omg.CORBA.PolicyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _PolicyStub.class!",
                   _PolicyStub.class.isAssignableFrom(sut));
    }

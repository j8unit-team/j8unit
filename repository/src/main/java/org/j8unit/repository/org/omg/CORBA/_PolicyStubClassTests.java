 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _PolicyStubTests}).
 * </p>
 *
 * <p>
 ...
 * @see _PolicyStubTests _PolicyStubTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
extends PolicyClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.ObjectImplClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA._PolicyStub.class!",
                   org.omg.CORBA._PolicyStub.class.isAssignableFrom(sut));
    }

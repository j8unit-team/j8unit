 ...
 * org.omg.DynamicAny.DynValueCommonOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynValueCommonOperationsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * @see DynValueCommonOperationsTests DynValueCommonOperationsTests (The complementary j8unit test interface containing
...
public abstract interface DynValueCommonOperationsClassTests<SUT extends org.omg.DynamicAny.DynValueCommonOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynValueCommonOperations.class!",
                   org.omg.DynamicAny.DynValueCommonOperations.class.isAssignableFrom(sut));
    }

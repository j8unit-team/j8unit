 ...
 * {@link DynValueCommonOperations public abstract interface org.omg.DynamicAny.DynValueCommonOperations}.
 *
...
public abstract interface DynValueCommonOperationsClassTests<SUT extends DynValueCommonOperations>
extends org.j8unit.repository.org.omg.DynamicAny.DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynValueCommonOperations.class!",
                   DynValueCommonOperations.class.isAssignableFrom(sut));
    }

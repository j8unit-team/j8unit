...
extends NamingContextClassTests<SUT>, DynamicImplementationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to _NamingContextImplBase.class!",
                   _NamingContextImplBase.class.isAssignableFrom(sut));
    }

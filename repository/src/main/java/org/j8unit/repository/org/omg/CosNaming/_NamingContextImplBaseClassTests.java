...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CosNaming._NamingContextImplBase class
 * org.omg.CosNaming._NamingContextImplBase}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link _NamingContextImplBaseTests}).
 * </p>
 *
 * <p>
 ...
 * @see _NamingContextImplBaseTests _NamingContextImplBaseTests (The complementary j8unit test interface containing the
...
public abstract interface _NamingContextImplBaseClassTests<SUT extends org.omg.CosNaming._NamingContextImplBase>
extends NamingContextClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.DynamicImplementationClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming._NamingContextImplBase.class!",
                   org.omg.CosNaming._NamingContextImplBase.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynFixedOperations
 * public abstract interface org.omg.DynamicAny.DynFixedOperations}.
 *
...
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynFixedOperations.class!",
                   DynFixedOperations.class.isAssignableFrom(sut));
    }

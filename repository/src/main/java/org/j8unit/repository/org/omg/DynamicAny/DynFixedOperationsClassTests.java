 ...
 * org.omg.DynamicAny.DynFixedOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link DynFixedOperationsTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link DynFixedOperationsTests}.
 * </p>
 *
 * @see org.omg.DynamicAny.DynFixedOperations interface org.omg.DynamicAny.DynFixedOperations (the hereby targeted
 *      class-under-test class)
 * @see DynFixedOperationsTests DynFixedOperationsTests (The complementary j8unit test interface containing the instance
...
public abstract interface DynFixedOperationsClassTests<SUT extends org.omg.DynamicAny.DynFixedOperations>
extends DynAnyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.DynamicAny.DynFixedOperations.class!",
                   org.omg.DynamicAny.DynFixedOperations.class.isAssignableFrom(sut));
    }

...
extends ValueBaseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ObjectReferenceFactory.class!",
                   ObjectReferenceFactory.class.isAssignableFrom(sut));
    }

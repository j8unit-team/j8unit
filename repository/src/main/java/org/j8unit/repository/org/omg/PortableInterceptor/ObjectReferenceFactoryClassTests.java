 ...
 * org.omg.PortableInterceptor.ObjectReferenceFactory}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ObjectReferenceFactoryTests}).
 * </p>
 *
 * <p>
 ...
 * @see ObjectReferenceFactoryTests ObjectReferenceFactoryTests (The complementary j8unit test interface containing the
...
public abstract interface ObjectReferenceFactoryClassTests<SUT extends org.omg.PortableInterceptor.ObjectReferenceFactory>
extends org.j8unit.repository.org.omg.CORBA.portable.ValueBaseClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ObjectReferenceFactory.class!",
                   org.omg.PortableInterceptor.ObjectReferenceFactory.class.isAssignableFrom(sut));
    }

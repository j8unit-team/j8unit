 ...
 * org.omg.PortableInterceptor.ORBInitInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ORBInitInfoTests}).
 * </p>
 *
 * <p>
 ...
 * </p>
 *
 * @see org.omg.PortableInterceptor.ORBInitInfo interface org.omg.PortableInterceptor.ORBInitInfo (the hereby targeted
 *      class-under-test class)
 * @see ORBInitInfoTests ORBInitInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface ORBInitInfoClassTests<SUT extends org.omg.PortableInterceptor.ORBInitInfo>
extends ORBInitInfoOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ORBInitInfo.class!",
                   org.omg.PortableInterceptor.ORBInitInfo.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ORBInitInfo public
 * abstract interface org.omg.PortableInterceptor.ORBInitInfo}.
 *
...
extends ORBInitInfoOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ORBInitInfo.class!",
                   ORBInitInfo.class.isAssignableFrom(sut));
    }

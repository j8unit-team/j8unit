 ...
 * org.omg.CosNaming.BindingIteratorPOA}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link BindingIteratorPOATests}).
 * </p>
 *
 * <p>
 ...
 * @see BindingIteratorPOATests BindingIteratorPOATests (The complementary j8unit test interface containing the instance
...
extends BindingIteratorOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.portable.InvokeHandlerClassTests<SUT>,
org.j8unit.repository.org.omg.PortableServer.ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.BindingIteratorPOA.class!",
                   org.omg.CosNaming.BindingIteratorPOA.class.isAssignableFrom(sut));
    }

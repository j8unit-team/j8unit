 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link BindingIteratorPOA
 * public abstract class org.omg.CosNaming.BindingIteratorPOA}.
 *
...
extends BindingIteratorOperationsClassTests<SUT>, InvokeHandlerClassTests<SUT>, ServantClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to BindingIteratorPOA.class!",
                   BindingIteratorPOA.class.isAssignableFrom(sut));
    }

 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link VM_ABSTRACTTests}).
 * </p>
 *
 * <p>
 ...
 * @see VM_ABSTRACTTests VM_ABSTRACTTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface VM_ABSTRACTClassTests<SUT extends org.omg.CORBA.VM_ABSTRACT>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.VM_ABSTRACT.class!",
                   org.omg.CORBA.VM_ABSTRACT.class.isAssignableFrom(sut));
    }

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link VM_ABSTRACT public
 * abstract interface org.omg.CORBA.VM_ABSTRACT}.
 *
...
public abstract interface VM_ABSTRACTClassTests<SUT extends VM_ABSTRACT>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to VM_ABSTRACT.class!",
                   VM_ABSTRACT.class.isAssignableFrom(sut));
    }

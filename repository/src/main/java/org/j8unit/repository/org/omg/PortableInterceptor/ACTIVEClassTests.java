 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ACTIVE public
 * abstract interface org.omg.PortableInterceptor.ACTIVE}.
 *
...
public abstract interface ACTIVEClassTests<SUT extends ACTIVE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ACTIVE.class!",

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.PortableInterceptor.ACTIVE interface
 * org.omg.PortableInterceptor.ACTIVE}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ACTIVETests}).
 * </p>
 *
 * <p>
 ...
 * @see ACTIVETests ACTIVETests (The complementary j8unit test interface containing the instance relevant test methods)
 *
 * @param SUT
...
public abstract interface ACTIVEClassTests<SUT extends org.omg.PortableInterceptor.ACTIVE>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ACTIVE.class!",
                   org.omg.PortableInterceptor.ACTIVE.class.isAssignableFrom(sut));
    }

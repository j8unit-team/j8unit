 ...
 * org.omg.PortableInterceptor.RequestInfo}, containing all type relevant aspects (e.&thinsp;g., runtime constraints and
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link RequestInfoTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link RequestInfoTests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.RequestInfo interface org.omg.PortableInterceptor.RequestInfo (the hereby targeted
 *      class-under-test class)
 * @see RequestInfoTests RequestInfoTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface RequestInfoClassTests<SUT extends org.omg.PortableInterceptor.RequestInfo>
extends RequestInfoOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.RequestInfo.class!",
                   org.omg.PortableInterceptor.RequestInfo.class.isAssignableFrom(sut));
    }

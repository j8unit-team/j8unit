 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link RequestInfo public
 * abstract interface org.omg.PortableInterceptor.RequestInfo}.
 *
...
public abstract interface RequestInfoClassTests<SUT extends RequestInfo>
extends RequestInfoOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to RequestInfo.class!",
                   RequestInfo.class.isAssignableFrom(sut));
    }

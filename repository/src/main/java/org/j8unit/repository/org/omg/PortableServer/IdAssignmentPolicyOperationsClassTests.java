...
public abstract interface IdAssignmentPolicyOperationsClassTests<SUT extends IdAssignmentPolicyOperations>
extends PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to IdAssignmentPolicyOperations.class!",
                   IdAssignmentPolicyOperations.class.isAssignableFrom(sut));
    }

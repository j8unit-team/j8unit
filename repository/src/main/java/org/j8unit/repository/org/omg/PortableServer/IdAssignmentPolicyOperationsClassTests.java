 ...
 * org.omg.PortableServer.IdAssignmentPolicyOperations}, containing all type relevant aspects (e.&thinsp;g., runtime
 ...
 * {@link IdAssignmentPolicyOperationsTests}).
 * </p>
 *
 * <p>
 ...
 * @see IdAssignmentPolicyOperationsTests IdAssignmentPolicyOperationsTests (The complementary j8unit test interface
...
extends org.j8unit.repository.org.omg.CORBA.PolicyOperationsClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableServer.IdAssignmentPolicyOperations.class!",
                   org.omg.PortableServer.IdAssignmentPolicyOperations.class.isAssignableFrom(sut));
    }

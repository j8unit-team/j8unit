 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link DynUnionHelper
...
public abstract interface DynUnionHelperClassTests<SUT extends DynUnionHelper>
extends ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to DynUnionHelper.class!",
                   DynUnionHelper.class.isAssignableFrom(sut));
    }

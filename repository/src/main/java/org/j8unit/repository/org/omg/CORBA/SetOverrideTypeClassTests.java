...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.SetOverrideType class org.omg.CORBA.SetOverrideType},
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link SetOverrideTypeTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link SetOverrideTypeTests}.
 * </p>
 *
 * @see org.omg.CORBA.SetOverrideType class org.omg.CORBA.SetOverrideType (the hereby targeted class-under-test class)
 * @see SetOverrideTypeTests SetOverrideTypeTests (The complementary j8unit test interface containing the instance
...
public abstract interface SetOverrideTypeClassTests<SUT extends org.omg.CORBA.SetOverrideType>
extends org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT>, org.j8unit.repository.java.lang.ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.SetOverrideType.class!",
                   org.omg.CORBA.SetOverrideType.class.isAssignableFrom(sut));
    }

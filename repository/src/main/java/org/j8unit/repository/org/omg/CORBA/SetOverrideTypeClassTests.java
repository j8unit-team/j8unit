 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link SetOverrideType
 * public class org.omg.CORBA.SetOverrideType}.
 *
...
public abstract interface SetOverrideTypeClassTests<SUT extends SetOverrideType>
extends IDLEntityClassTests<SUT>, ObjectClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to SetOverrideType.class!",
                   SetOverrideType.class.isAssignableFrom(sut));
    }

 ...
 * org.omg.CosNaming.NamingContextOperations}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link NamingContextOperationsTests}
 * ).
 * </p>
 *
 * <p>
 ...
 * {@link NamingContextOperationsTests}.
 * </p>
 *
 * @see org.omg.CosNaming.NamingContextOperations interface org.omg.CosNaming.NamingContextOperations (the hereby
 *      targeted class-under-test class)
 * @see NamingContextOperationsTests NamingContextOperationsTests (The complementary j8unit test interface containing
...
public abstract interface NamingContextOperationsClassTests<SUT extends org.omg.CosNaming.NamingContextOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CosNaming.NamingContextOperations.class!",
                   org.omg.CosNaming.NamingContextOperations.class.isAssignableFrom(sut));
    }

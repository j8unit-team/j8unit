...
public abstract interface NamingContextOperationsClassTests<SUT extends NamingContextOperations>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to NamingContextOperations.class!",
                   NamingContextOperations.class.isAssignableFrom(sut));
    }

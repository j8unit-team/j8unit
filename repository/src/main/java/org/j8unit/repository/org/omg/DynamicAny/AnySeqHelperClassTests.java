 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link AnySeqHelper public
 * abstract class org.omg.DynamicAny.AnySeqHelper}.
 *
...
public abstract interface AnySeqHelperClassTests<SUT extends AnySeqHelper>
extends ObjectClassTests<SUT> {

    // J8UNIT-MARKER-[BEGIN]-[CLASS]-[org.omg.DynamicAny.AnySeqHelper]
    /**
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to AnySeqHelper.class!",
                   AnySeqHelper.class.isAssignableFrom(sut));
    }

    // J8UNIT-MARKER-[MANUAL]-[CLASS]-[org.omg.DynamicAny.AnySeqHelper]

 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link ORBInitializer
...
public abstract interface ORBInitializerClassTests<SUT extends ORBInitializer>
extends ORBInitializerOperationsClassTests<SUT>, ObjectClassTests<SUT>, IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to ORBInitializer.class!",
                   ORBInitializer.class.isAssignableFrom(sut));
    }

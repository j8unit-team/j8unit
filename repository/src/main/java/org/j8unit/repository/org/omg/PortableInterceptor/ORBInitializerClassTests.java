 ...
 * org.omg.PortableInterceptor.ORBInitializer}, containing all type relevant aspects (e.&thinsp;g., runtime constraints
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link ORBInitializerTests}).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The complementary j8unit test interface containing the instance relevant aspects is {@link ORBInitializerTests}.
 * </p>
 *
 * @see org.omg.PortableInterceptor.ORBInitializer interface org.omg.PortableInterceptor.ORBInitializer (the hereby
 *      targeted class-under-test class)
 * @see ORBInitializerTests ORBInitializerTests (The complementary j8unit test interface containing the instance
...
public abstract interface ORBInitializerClassTests<SUT extends org.omg.PortableInterceptor.ORBInitializer>
extends ORBInitializerOperationsClassTests<SUT>, org.j8unit.repository.org.omg.CORBA.ObjectClassTests<SUT>,
org.j8unit.repository.org.omg.CORBA.portable.IDLEntityClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.PortableInterceptor.ORBInitializer.class!",
                   org.omg.PortableInterceptor.ORBInitializer.class.isAssignableFrom(sut));
    }

...
/**
 * <p>
 * Reusable j8unit test interface for {@linkplain org.omg.CORBA.OMGVMCID interface org.omg.CORBA.OMGVMCID}, containing
 ...
 * complementarySetup test interface containing the instance relevant aspects (see {@link OMGVMCIDTests}).
 * </p>
 *
 * <p>
 ...
 * @see OMGVMCIDTests OMGVMCIDTests (The complementary j8unit test interface containing the instance relevant test
 *      methods)
 *
 * @param SUT
...
public abstract interface OMGVMCIDClassTests<SUT extends org.omg.CORBA.OMGVMCID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to org.omg.CORBA.OMGVMCID.class!",
                   org.omg.CORBA.OMGVMCID.class.isAssignableFrom(sut));
    }

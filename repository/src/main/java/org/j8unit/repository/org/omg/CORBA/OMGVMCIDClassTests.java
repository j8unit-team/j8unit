 ...
 * and further type specific requirements&nbsp;&ndash; of the hereby targeted type-under-test {@link OMGVMCID public
...
public abstract interface OMGVMCIDClassTests<SUT extends OMGVMCID>
extends RepositoryClassTests<SUT> {
    ...
    throws Exception {
        ...
        assertTrue("This j8unit test interface is used with a generic type that is illegaly not assignable to OMGVMCID.class!",
                   OMGVMCID.class.isAssignableFrom(sut));
    }

...
public class PackedColorModelClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PackedColorModel.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PackedColorModel.class, equalsMethod.getDeclaringClass());
        ...
        PackedColorModel.class.getDeclaredMethod("hashCode");
    }

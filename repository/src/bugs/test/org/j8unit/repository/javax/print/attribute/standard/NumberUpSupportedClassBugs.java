 ...
 * @since 0.9.7
 */
public class NumberUpSupportedClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = NumberUpSupported.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(NumberUpSupported.class, equalsMethod.getDeclaringClass());
        ...
        NumberUpSupported.class.getDeclaredMethod("hashCode");
    }

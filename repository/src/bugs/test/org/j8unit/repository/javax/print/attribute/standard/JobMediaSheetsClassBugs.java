 ...
 * @since 0.9.7
 */
public class JobMediaSheetsClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = JobMediaSheets.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(JobMediaSheets.class, equalsMethod.getDeclaringClass());
        ...
        JobMediaSheets.class.getDeclaredMethod("hashCode");
    }

 ...
 * @since 0.9.7
 */
public class NumberOfDocumentsClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = NumberOfDocuments.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(NumberOfDocuments.class, equalsMethod.getDeclaringClass());
        ...
        NumberOfDocuments.class.getDeclaredMethod("hashCode");
    }

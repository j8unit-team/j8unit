 ...
 * @since 0.9.7
 */
public class MediaSizeClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = MediaSize.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(MediaSize.class, equalsMethod.getDeclaringClass());
        ...
        MediaSize.class.getDeclaredMethod("hashCode");
    }

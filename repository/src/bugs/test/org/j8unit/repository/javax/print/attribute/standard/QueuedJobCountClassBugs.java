 ...
 * @since 0.9.7
 */
public class QueuedJobCountClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = QueuedJobCount.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(QueuedJobCount.class, equalsMethod.getDeclaringClass());
        ...
        QueuedJobCount.class.getDeclaredMethod("hashCode");
    }

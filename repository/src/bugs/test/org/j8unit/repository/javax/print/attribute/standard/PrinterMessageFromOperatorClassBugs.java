 ...
 * @since 0.9.7
 */
public class PrinterMessageFromOperatorClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PrinterMessageFromOperator.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PrinterMessageFromOperator.class, equalsMethod.getDeclaringClass());
        ...
        PrinterMessageFromOperator.class.getDeclaredMethod("hashCode");
    }

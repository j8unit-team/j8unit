 ...
 * @since 0.9.7
 */
public class PagesPerMinuteClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PagesPerMinute.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PagesPerMinute.class, equalsMethod.getDeclaringClass());
        ...
        PagesPerMinute.class.getDeclaredMethod("hashCode");
    }

 ...
 * @since 0.9.7
 */
public class PrinterLocationClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PrinterLocation.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PrinterLocation.class, equalsMethod.getDeclaringClass());
        ...
        PrinterLocation.class.getDeclaredMethod("hashCode");
    }

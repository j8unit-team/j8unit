 ...
 * @since 0.9.7
 */
public class JobPriorityClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = JobPriority.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(JobPriority.class, equalsMethod.getDeclaringClass());
        ...
        JobPriority.class.getDeclaredMethod("hashCode");
    }

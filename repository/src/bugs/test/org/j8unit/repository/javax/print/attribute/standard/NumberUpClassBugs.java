 ...
 * @since 0.9.7
 */
public class NumberUpClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = NumberUp.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(NumberUp.class, equalsMethod.getDeclaringClass());
        ...
        NumberUp.class.getDeclaredMethod("hashCode");
    }

 ...
 * @since 0.9.7
 */
public class PrinterMoreInfoClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PrinterMoreInfo.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PrinterMoreInfo.class, equalsMethod.getDeclaringClass());
        ...
        PrinterMoreInfo.class.getDeclaredMethod("hashCode");
    }

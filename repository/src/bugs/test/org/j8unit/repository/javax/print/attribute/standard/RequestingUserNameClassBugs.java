 ...
 * @since 0.9.7
 */
public class RequestingUserNameClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = RequestingUserName.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(RequestingUserName.class, equalsMethod.getDeclaringClass());
        ...
        RequestingUserName.class.getDeclaredMethod("hashCode");
    }

 ...
 * @since 0.9.7
 */
public class PagesPerMinuteColorClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PagesPerMinuteColor.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PagesPerMinuteColor.class, equalsMethod.getDeclaringClass());
        ...
        PagesPerMinuteColor.class.getDeclaredMethod("hashCode");
    }

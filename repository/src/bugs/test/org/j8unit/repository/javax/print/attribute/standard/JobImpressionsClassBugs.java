 ...
 * @since 0.9.7
 */
public class JobImpressionsClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = JobImpressions.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(JobImpressions.class, equalsMethod.getDeclaringClass());
        ...
        JobImpressions.class.getDeclaredMethod("hashCode");
    }

 ...
 * @since 0.9.7
 */
public class PrinterURIClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PrinterURI.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PrinterURI.class, equalsMethod.getDeclaringClass());
        ...
        PrinterURI.class.getDeclaredMethod("hashCode");
    }

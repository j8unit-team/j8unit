 ...
 * @since 0.9.7
 */
public class DocumentNameClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = DocumentName.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(DocumentName.class, equalsMethod.getDeclaringClass());
        ...
        DocumentName.class.getDeclaredMethod("hashCode");
    }

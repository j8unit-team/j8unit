 ...
 * @since 0.9.7
 */
public class JobImpressionsSupportedClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = JobImpressionsSupported.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(JobImpressionsSupported.class, equalsMethod.getDeclaringClass());
        ...
        JobImpressionsSupported.class.getDeclaredMethod("hashCode");
    }

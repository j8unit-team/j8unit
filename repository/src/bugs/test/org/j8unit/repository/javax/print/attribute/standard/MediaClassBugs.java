...
public class MediaClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = Media.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(Media.class, equalsMethod.getDeclaringClass());
        ...
        Media.class.getDeclaredMethod("hashCode");
    }

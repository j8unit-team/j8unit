 ...
 * @since 0.9.7
 */
public class OutputDeviceAssignedClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = OutputDeviceAssigned.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(OutputDeviceAssigned.class, equalsMethod.getDeclaringClass());
        ...
        OutputDeviceAssigned.class.getDeclaredMethod("hashCode");
    }

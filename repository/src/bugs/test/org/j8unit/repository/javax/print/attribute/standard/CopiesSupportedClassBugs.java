 ...
 * @since 0.9.7
 */
public class CopiesSupportedClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = CopiesSupported.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(CopiesSupported.class, equalsMethod.getDeclaringClass());
        ...
        CopiesSupported.class.getDeclaredMethod("hashCode");
    }

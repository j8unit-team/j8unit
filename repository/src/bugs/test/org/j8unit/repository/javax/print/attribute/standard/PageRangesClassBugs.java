 ...
 * @since 0.9.7
 */
public class PageRangesClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PageRanges.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PageRanges.class, equalsMethod.getDeclaringClass());
        ...
        PageRanges.class.getDeclaredMethod("hashCode");
    }

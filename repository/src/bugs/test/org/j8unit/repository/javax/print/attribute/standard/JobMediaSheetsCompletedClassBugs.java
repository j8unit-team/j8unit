 ...
 * @since 0.9.7
 */
public class JobMediaSheetsCompletedClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = JobMediaSheetsCompleted.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(JobMediaSheetsCompleted.class, equalsMethod.getDeclaringClass());
        ...
        JobMediaSheetsCompleted.class.getDeclaredMethod("hashCode");
    }

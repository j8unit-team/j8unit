 ...
 * @since 0.9.7
 */
public class PrinterMoreInfoManufacturerClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = PrinterMoreInfoManufacturer.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(PrinterMoreInfoManufacturer.class, equalsMethod.getDeclaringClass());
        ...
        PrinterMoreInfoManufacturer.class.getDeclaredMethod("hashCode");
    }

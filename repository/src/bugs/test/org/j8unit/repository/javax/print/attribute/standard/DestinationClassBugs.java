 ...
 * @since 0.9.7
 */
public class DestinationClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = Destination.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(Destination.class, equalsMethod.getDeclaringClass());
        ...
        Destination.class.getDeclaredMethod("hashCode");
    }

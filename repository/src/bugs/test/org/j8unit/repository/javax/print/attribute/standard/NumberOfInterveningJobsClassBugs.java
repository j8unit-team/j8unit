 ...
 * @since 0.9.7
 */
public class NumberOfInterveningJobsClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = NumberOfInterveningJobs.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(NumberOfInterveningJobs.class, equalsMethod.getDeclaringClass());
        ...
        NumberOfInterveningJobs.class.getDeclaredMethod("hashCode");
    }

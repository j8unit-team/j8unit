 ...
 * @since 0.9.7
 */
public class JobKOctetsSupportedClassBugs {
    ...
    throws Exception {
        ...
        try {
            final Method equalsMethod = JobKOctetsSupported.class.getDeclaredMethod("equals", Object.class);
            assert equalsMethod != null;
            assertEquals(JobKOctetsSupported.class, equalsMethod.getDeclaringClass());
        ...
        JobKOctetsSupported.class.getDeclaredMethod("hashCode");
    }
